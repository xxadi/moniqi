    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP扫描指令下发下发信息", "form")'>新增IP扫描指令下发下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入IP扫描指令下发请求任务", "receive")'>输入IP扫描指令下发请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出IP扫描指令下发反馈信息", "feedback")'>输出IP扫描指令下发反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控IP扫描指令下发状态信息", "log")'>监控IP扫描指令下发状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计IP扫描指令下发调用信息", "statistics")'>统计IP扫描指令下发调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
