    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案验证结果数据提取", "data_extract")'>备案验证结果数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案验证结果数据识别", "data_recognition")'>备案验证结果数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案验证结果分级", "grading")'>备案验证结果分级</el-button>
          <el-button plain type="primary" icon="el-icon-time" @click='handleFunction("备案验证结果实时计算", "realtime_compute")'>备案验证结果实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案验证结果聚合", "validate")'>备案验证结果聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("备案验证结果可视化展示", "visualization")'>备案验证结果可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案验证结果数据审查", "data_review")'>备案验证结果数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
