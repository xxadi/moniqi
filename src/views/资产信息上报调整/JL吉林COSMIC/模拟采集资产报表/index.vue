    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产实时计算", "collection")'>模拟采集资产实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产聚合", "monitor")'>模拟采集资产聚合</el-button>
