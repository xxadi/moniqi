    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增模拟采集资产信息", "form")'>新增模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看模拟采集资产信息", "detail")'>查看模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据提取", "data_extract")'>模拟采集资产数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据识别", "data_recognition")'>模拟采集资产数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产分级", "grading")'>模拟采集资产分级</el-button>
          <el-button plain type="primary" icon="el-icon-time" @click='handleFunction("模拟采集资产实时计算", "realtime_compute")'>模拟采集资产实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产聚合", "validate")'>模拟采集资产聚合</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产可视化展示", "visualization")'>模拟采集资产可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据审查", "data_review")'>模拟采集资产数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      ...
      exportXLSX(rows, functionName || "模拟采集资产报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志/.test(functionName)) {
        return [
          ...
          { 名称: "模拟采集资产报表任务调度", 状态: "执行中", 日志: "正在等待节点返回执行结果" },
          { 名称: "模拟采集资产报表异常检查", 状态: "已告警", 日志: "发现1条超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "模拟采集资产报表业务记录", 业务状态: "已处理", 处理时间: this.now(), 说明: "模拟业务记录" },
        { 业务名称: "模拟采集资产报表复核记录", 业务状态: "待复核", 处理时间: this.now(), 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
