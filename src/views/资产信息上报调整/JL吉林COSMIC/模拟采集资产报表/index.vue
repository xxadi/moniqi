    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据提取", "transform")'>模拟采集资产数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据识别", "monitor")'>模拟采集资产数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产分级", "statistics")'>模拟采集资产分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产实时计算", "analysis")'>模拟采集资产实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产聚合", "alert")'>模拟采集资产聚合</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产可视化展示", "audit")'>模拟采集资产可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("模拟采集资产数据审查", "workflow")'>模拟采集资产数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
