    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管数据提取", "validate")'>虚拟资产纳管数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管数据识别", "monitor")'>虚拟资产纳管数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管分级", "statistics")'>虚拟资产纳管分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管实时计算", "analysis")'>虚拟资产纳管实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管聚合", "alert")'>虚拟资产纳管聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资产纳管可视化展示", "operation")'>虚拟资产纳管可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管数据审查", "audit")'>虚拟资产纳管数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
