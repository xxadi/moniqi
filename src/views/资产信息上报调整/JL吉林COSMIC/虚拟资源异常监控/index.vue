    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控运行效果评估", "log")'>虚拟资源异常监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控分析", "monitor")'>虚拟资源异常监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控分析结果展示", "statistics")'>虚拟资源异常监控分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
