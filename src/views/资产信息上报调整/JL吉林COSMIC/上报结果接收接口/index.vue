    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入上报结果接收请求任务", "receive")'>输入上报结果接收请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出上报结果接收反馈信息", "feedback")'>输出上报结果接收反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控上报结果接收状态信息", "log")'>监控上报结果接收状态信息</el-button>
