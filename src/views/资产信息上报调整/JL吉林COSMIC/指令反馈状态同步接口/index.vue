    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("指令反馈状态同步接口", "sync")'>指令反馈状态同步接口</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入指令反馈状态同步请求任务", "receive")'>输入指令反馈状态同步请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出指令反馈状态同步反馈信息", "feedback")'>输出指令反馈状态同步反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控指令反馈状态同步状态信息", "log")'>监控指令反馈状态同步状态信息</el-button>
