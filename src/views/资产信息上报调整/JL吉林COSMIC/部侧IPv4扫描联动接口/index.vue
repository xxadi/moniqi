    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入部侧IPv4扫描联动请求任务", "receive")'>输入部侧IPv4扫描联动请求任务</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控部侧IPv4扫描联动状态信息", "log")'>监控部侧IPv4扫描联动状态信息</el-button>
