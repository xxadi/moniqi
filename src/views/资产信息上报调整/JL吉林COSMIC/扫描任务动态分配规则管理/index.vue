    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("扫描任务动态分配失败告警", "alert")'>扫描任务动态分配失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务动态分配数据提取", "validate")'>扫描任务动态分配数据提取</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务动态分配规则分析结果展示", "monitor")'>扫描任务动态分配规则分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
