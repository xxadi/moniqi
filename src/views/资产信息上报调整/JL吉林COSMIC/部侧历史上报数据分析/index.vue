    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("部侧历史上报数据获取", "operation")'>部侧历史上报数据获取</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧历史上报数据数据审查", "form")'>部侧历史上报数据数据审查</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧历史上报数据数据提取", "detail")'>部侧历史上报数据数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看部侧历史上报数据信息", "monitor")'>查看部侧历史上报数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧历史上报数据采集监控", "statistics")'>部侧历史上报数据采集监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧历史上报数据运行监控", "alert")'>部侧历史上报数据运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧历史上报数据异常监控", "log")'>部侧历史上报数据异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧历史上报数据模型运行效果评估", "audit")'>部侧历史上报数据模型运行效果评估</el-button>
        </div>
      </div>
      <cs-pagetable
