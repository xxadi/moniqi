    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("内网采集资产模拟校验失败告警", "alert")'>内网采集资产模拟校验失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网采集资产模拟校验数据提取", "transform")'>内网采集资产模拟校验数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网采集资产模拟校验运行分析", "analysis")'>内网采集资产模拟校验运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网采集资产模拟校验分析结果展示", "monitor")'>内网采集资产模拟校验分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
