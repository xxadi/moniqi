    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产归属与位置校验规则分析", "data_analysis")'>资产归属与位置校验规则分析</el-button>
