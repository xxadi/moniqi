    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("暴露面资产纳管对比失败告警", "alert")'>暴露面资产纳管对比失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管对比数据提取", "validate")'>暴露面资产纳管对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管对比运行分析", "analysis")'>暴露面资产纳管对比运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管对比分析结果展示", "monitor")'>暴露面资产纳管对比分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
