    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失数据提取", "validate")'>资产类别缺失数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失数据识别", "monitor")'>资产类别缺失数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失分级", "statistics")'>资产类别缺失分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失实时计算", "analysis")'>资产类别缺失实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失聚合", "alert")'>资产类别缺失聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失可视化展示", "operation")'>资产类别缺失可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失数据审查", "audit")'>资产类别缺失数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
