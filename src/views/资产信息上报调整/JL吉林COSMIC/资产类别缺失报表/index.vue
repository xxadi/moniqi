    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失实时计算", "validate")'>资产类别缺失实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类别缺失聚合", "monitor")'>资产类别缺失聚合</el-button>
