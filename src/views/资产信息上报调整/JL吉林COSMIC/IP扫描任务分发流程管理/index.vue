    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP扫描任务分发指派信息", "form")'>新增IP扫描任务分发指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP扫描任务分发流程节点", "detail")'>新增IP扫描任务分发流程节点</el-button>
