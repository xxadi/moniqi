    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控运行效果评估", "log")'>SFTP传输通道监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控分析", "monitor")'>SFTP传输通道监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控分析结果展示", "statistics")'>SFTP传输通道监控分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
