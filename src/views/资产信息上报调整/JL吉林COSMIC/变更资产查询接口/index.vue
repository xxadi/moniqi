    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("变更资产查询数据分析", "analysis")'>变更资产查询数据分析</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入变更资产查询请求任务", "receive")'>输入变更资产查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出变更资产查询反馈信息", "feedback")'>输出变更资产查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控变更资产查询状态信息", "log")'>监控变更资产查询状态信息</el-button>
