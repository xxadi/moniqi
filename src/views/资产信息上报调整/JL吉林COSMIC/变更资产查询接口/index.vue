    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("变更资产查询接口", "api")'>变更资产查询接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("变更资产查询数据分析", "data_analysis")'>变更资产查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看变更资产查询信息", "detail")'>查看变更资产查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增变更资产查询下发信息", "form")'>新增变更资产查询下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入变更资产查询请求任务", "input_request")'>输入变更资产查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出变更资产查询反馈信息", "feedback")'>输出变更资产查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控变更资产查询状态信息", "monitor")'>监控变更资产查询状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计变更资产查询调用信息", "statistics")'>统计变更资产查询调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const importTemplateRow = {
  ...
  "资产归属": "资产归属导入值",
  "接口名称": "变更资产查询接口导入记录",
  "修改时间": "2026-06-29 02:55:41",
  "接口编号": "IMP-741671",
  "处理人": "张晓峰",
  "导入来源": "变更资产查询接口导入模板.xlsx"
};
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      ...
      exportXLSX(rows, functionName || "变更资产查询接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志/.test(functionName)) {
        return [
          ...
          { 名称: "变更资产查询接口任务调度", 状态: "执行中", 日志: "正在等待节点返回执行结果" },
          { 名称: "变更资产查询接口异常检查", 状态: "已告警", 日志: "发现1条超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "变更资产查询接口业务记录", 业务状态: "已处理", 处理时间: this.now(), 说明: "模拟业务记录" },
        { 业务名称: "变更资产查询接口复核记录", 业务状态: "待复核", 处理时间: this.now(), 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
