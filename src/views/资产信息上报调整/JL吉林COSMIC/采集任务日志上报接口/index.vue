    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("采集任务日志上报接口", "transform")'>采集任务日志上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("采集任务日志上报数据分析", "analysis")'>采集任务日志上报数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看采集任务日志上报信息", "detail")'>查看采集任务日志上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入采集任务日志上报请求任务", "receive")'>输入采集任务日志上报请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出采集任务日志上报反馈信息", "feedback")'>输出采集任务日志上报反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控采集任务日志上报状态信息", "log")'>监控采集任务日志上报状态信息</el-button>
