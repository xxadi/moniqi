    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入指令上报接口请求任务", "receive")'>输入指令上报接口请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出指令上报接口反馈信息", "feedback")'>输出指令上报接口反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控指令上报接口状态信息", "log")'>监控指令上报接口状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计指令上报接口调用信息", "statistics")'>统计指令上报接口调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
