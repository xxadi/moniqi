    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型分析", "monitor")'>内网资产识别模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型分析结果展示", "statistics")'>内网资产识别模型分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
