    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产分类信息同步接口", "sync")'>资产分类信息同步接口</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入资产分类信息同步请求任务", "receive")'>输入资产分类信息同步请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出资产分类信息同步反馈信息", "feedback")'>输出资产分类信息同步反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控资产分类信息同步状态信息", "log")'>监控资产分类信息同步状态信息</el-button>
