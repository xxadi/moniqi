    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入调度平台成功消息上传请求任务", "receive")'>输入调度平台成功消息上传请求任务</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控调度平台成功消息上传状态信息", "log")'>监控调度平台成功消息上传状态信息</el-button>
