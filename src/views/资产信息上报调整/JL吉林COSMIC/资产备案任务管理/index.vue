    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产备案失败告警", "alert")'>资产备案失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案数据提取", "validate")'>资产备案数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案运行分析", "analysis")'>资产备案运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案分析结果展示", "monitor")'>资产备案分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
