    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("IP端口扫描准确性校验失败告警", "alert")'>IP端口扫描准确性校验失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP端口扫描准确性校验数据提取", "validate")'>IP端口扫描准确性校验数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP端口扫描准确性校验运行分析", "analysis")'>IP端口扫描准确性校验运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP端口扫描准确性校验分析结果展示", "monitor")'>IP端口扫描准确性校验分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
