    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比数据提取", "validate")'>IP纳管对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比数据识别", "monitor")'>IP纳管对比数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比分级", "statistics")'>IP纳管对比分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比实时计算", "analysis")'>IP纳管对比实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比聚合", "alert")'>IP纳管对比聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比可视化展示", "operation")'>IP纳管对比可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP纳管对比数据审查", "audit")'>IP纳管对比数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
