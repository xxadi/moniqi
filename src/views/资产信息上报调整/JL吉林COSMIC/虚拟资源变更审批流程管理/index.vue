    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起虚拟资源变更审批流程", "workflow")'>发起虚拟资源变更审批流程</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程数据分析", "analysis")'>虚拟资源变更审批流程数据分析</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增虚拟资源变更审批指派信息", "alert")'>新增虚拟资源变更审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增虚拟资源变更审批流程节点", "dispatch")'>新增虚拟资源变更审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程节点查询", "receive")'>虚拟资源变更审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程通知", "feedback")'>虚拟资源变更审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批结果逐级审批", "export")'>虚拟资源变更审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批结果拒绝和驳回", "api")'>虚拟资源变更审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
