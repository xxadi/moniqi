    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程催办", "form")'>虚拟资源变更审批流程催办</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程处理结果通知", "monitor")'>虚拟资源变更审批流程处理结果通知</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("虚拟资源变更审批流程数据分析结果推送", "statistics")'>虚拟资源变更审批流程数据分析结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增虚拟资源变更审批指派信息", "analysis")'>新增虚拟资源变更审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增虚拟资源变更审批流程节点", "alert")'>新增虚拟资源变更审批流程节点</el-button>
