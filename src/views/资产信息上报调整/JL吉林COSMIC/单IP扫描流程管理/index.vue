    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起单IP扫描流程", "workflow")'>发起单IP扫描流程</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("单IP扫描流程节点查询", "operation")'>单IP扫描流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上传单IP扫描信息", "monitor")'>上传单IP扫描信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("单IP扫描流程通知", "audit")'>单IP扫描流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("单IP扫描结果逐级审批", "statistics")'>单IP扫描结果逐级审批</el-button>
        </div>
      </div>
      <cs-pagetable
