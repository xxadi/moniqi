    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面资产未纳管预警结果推送", "audit")'>暴露面资产未纳管预警结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上传暴露面资产未纳管预警信息", "operation")'>上传暴露面资产未纳管预警信息</el-button>
