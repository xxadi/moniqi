    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("下发处置工单信息", "operation")'>下发处置工单信息</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("处置下发工单监控", "log")'>处置下发工单监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("处置下发工单监控告警", "alert")'>处置下发工单监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("处置下发流程图查看", "monitor")'>处置下发流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("处置下发流程通知", "audit")'>处置下发流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("处置下发结果逐级审批", "statistics")'>处置下发结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("处置下发结果拒绝和驳回", "analysis")'>处置下发结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
