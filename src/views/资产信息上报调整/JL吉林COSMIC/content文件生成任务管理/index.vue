    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("content文件生成失败告警", "alert")'>content文件生成失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("content文件生成数据提取", "validate")'>content文件生成数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("content文件生成运行分析", "analysis")'>content文件生成运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("content文件生成分析结果展示", "monitor")'>content文件生成分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
