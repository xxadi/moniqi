    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("指令接收任务调度结果监控告警", "alert")'>指令接收任务调度结果监控告警</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令接收任务调度数据采集", "transform")'>指令接收任务调度数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令接收任务调度数据转换", "detail")'>指令接收任务调度数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令接收任务调度数据预处理", "analysis")'>指令接收任务调度数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
