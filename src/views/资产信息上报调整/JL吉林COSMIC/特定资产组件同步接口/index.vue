    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("特定资产组件同步接口", "sync")'>特定资产组件同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("特定资产组件同步数据分析", "analysis")'>特定资产组件同步数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看特定资产组件同步信息", "detail")'>查看特定资产组件同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入特定资产组件同步请求任务", "receive")'>输入特定资产组件同步请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出特定资产组件同步反馈信息", "feedback")'>输出特定资产组件同步反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控特定资产组件同步状态信息", "log")'>监控特定资产组件同步状态信息</el-button>
