    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部内网采集联动接口", "transform")'>工信部内网采集联动接口</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入工信部内网采集联动请求任务", "receive")'>输入工信部内网采集联动请求任务</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控工信部内网采集联动状态信息", "log")'>监控工信部内网采集联动状态信息</el-button>
