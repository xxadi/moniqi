    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备份规则运行效果评估", "analysis")'>资产备份规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备份规则分析", "monitor")'>资产备份规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备份规则分析结果展示", "statistics")'>资产备份规则分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
