    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表实时计算", "report")'>暴露面资产纳管报表实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表聚合", "monitor")'>暴露面资产纳管报表聚合</el-button>
