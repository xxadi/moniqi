    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表数据提取", "validate")'>暴露面资产纳管报表数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表数据识别", "monitor")'>暴露面资产纳管报表数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表分级", "statistics")'>暴露面资产纳管报表分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表实时计算", "analysis")'>暴露面资产纳管报表实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表聚合", "alert")'>暴露面资产纳管报表聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("暴露面资产纳管报表可视化展示", "report")'>暴露面资产纳管报表可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面资产纳管报表数据审查", "audit")'>暴露面资产纳管报表数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
