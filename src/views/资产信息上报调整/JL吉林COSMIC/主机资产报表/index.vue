    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表数据提取", "validate")'>主机资产报表数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表数据识别", "monitor")'>主机资产报表数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表分级", "statistics")'>主机资产报表分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表实时计算", "analysis")'>主机资产报表实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表聚合", "alert")'>主机资产报表聚合</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("主机资产报表可视化展示", "report")'>主机资产报表可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("主机资产报表数据审查", "audit")'>主机资产报表数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
