    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产组件状态查询数据分析", "analysis")'>资产组件状态查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产组件状态查询信息", "detail")'>查看资产组件状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入资产组件状态查询请求任务", "receive")'>输入资产组件状态查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出资产组件状态查询反馈信息", "feedback")'>输出资产组件状态查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控资产组件状态查询状态信息", "log")'>监控资产组件状态查询状态信息</el-button>
