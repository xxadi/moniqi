    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产分类结构解析失败告警", "alert")'>资产分类结构解析失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构解析数据提取", "validate")'>资产分类结构解析数据提取</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构解析规则分析结果展示", "monitor")'>资产分类结构解析规则分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
