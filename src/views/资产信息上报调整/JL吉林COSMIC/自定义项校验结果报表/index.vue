    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自定义项校验结果信息", "form")'>新增自定义项校验结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看自定义项校验结果信息", "detail")'>查看自定义项校验结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据提取", "data_extract")'>自定义项校验结果数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据识别", "data_recognition")'>自定义项校验结果数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果分级", "grading")'>自定义项校验结果分级</el-button>
          <el-button plain type="primary" icon="el-icon-time" @click='handleFunction("自定义项校验结果实时计算", "realtime_compute")'>自定义项校验结果实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果聚合", "validate")'>自定义项校验结果聚合</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果可视化展示", "visualization")'>自定义项校验结果可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据审查", "data_review")'>自定义项校验结果数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "报表编号": "RPT-61367",
    "上报通道": "文件传输",
    "生效时间": "2026-05-08 16:08:25",
    "创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "导出次数": 0,
    "统计周期": "2026-05-01~2026-05-15",
    "更新频率": "实时",
    "报表类型": "汇总报表",
    "报表编号": "RPT-65214",
    "上报通道": "HTTP接口",
    "生效时间": "2026-05-09 08:33:11",
    "创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "导出次数": 1,
    ...
    "报表编号": "RPT-69061",
    "上报通道": "SFTP",
    "生效时间": "2026-05-09 09:47:56",
    "创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "导出次数": 3,
    ...
    "报表编号": "RPT-72908",
    "上报通道": "MQ消息",
    "生效时间": "2026-05-08 09:12:18",
    "创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "导出次数": 5,
    ...
    "报表编号": "RPT-76755",
    "上报通道": "API网关",
    "生效时间": "2026-05-08 09:35:44",
    "创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "导出次数": 12,
    ...
    "报表编号": "RPT-80602",
    "上报通道": "数据总线",
    "生效时间": "2026-05-08 10:08:06",
    "创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "导出次数": 28,
    ...
    "报表编号": "RPT-84449",
    "上报通道": "文件传输",
    "生效时间": "2026-05-08 10:42:31",
    "创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "导出次数": 0,
    ...
    "报表编号": "RPT-88296",
    "上报通道": "HTTP接口",
    "生效时间": "2026-05-08 11:16:09",
    "创建时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
...
const importTemplateRow = {
  ...
  "报表编号": "IMP-741953",
  "上报通道": "上报通道导入值",
  "生效时间": "2026-06-29 02:55:41",
  "创建时间": "2026-06-29 02:55:41",
  "导入来源": "自定义项校验结果报表导入模板.xlsx"
};
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      ...
      exportXLSX(rows, functionName || "自定义项校验结果报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志/.test(functionName)) {
        return [
          ...
          { 名称: "自定义项校验结果报表任务调度", 状态: "执行中", 日志: "正在等待节点返回执行结果" },
          { 名称: "自定义项校验结果报表异常检查", 状态: "已告警", 日志: "发现1条超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "自定义项校验结果报表业务记录", 业务状态: "已处理", 处理时间: this.now(), 说明: "模拟业务记录" },
        { 业务名称: "自定义项校验结果报表复核记录", 业务状态: "待复核", 处理时间: this.now(), 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
