    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果实时计算", "validate")'>自定义项校验结果实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果聚合", "monitor")'>自定义项校验结果聚合</el-button>
...
const importTemplateRow = {
  ...
  "报表编号": "IMP-850476",
  "上报通道": "上报通道导入值",
  "生效时间": "2026-06-26 09:40:50",
  "创建时间": "2026-06-26 09:40:50",
