    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据提取", "validate")'>自定义项校验结果数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据识别", "monitor")'>自定义项校验结果数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果分级", "statistics")'>自定义项校验结果分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果实时计算", "analysis")'>自定义项校验结果实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果聚合", "alert")'>自定义项校验结果聚合</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果可视化展示", "audit")'>自定义项校验结果可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自定义项校验结果数据审查", "workflow")'>自定义项校验结果数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
