    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("重点网络设备结果上报数据分析", "analysis")'>重点网络设备结果上报数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看重点网络设备结果上报信息", "detail")'>查看重点网络设备结果上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入重点网络设备结果上报请求任务", "receive")'>输入重点网络设备结果上报请求任务</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控重点网络设备结果上报状态信息", "log")'>监控重点网络设备结果上报状态信息</el-button>
