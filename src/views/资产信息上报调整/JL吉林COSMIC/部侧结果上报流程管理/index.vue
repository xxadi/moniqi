    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起部侧结果上报流程", "workflow")'>发起部侧结果上报流程</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧结果上报流程节点查询", "operation")'>部侧结果上报流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上传部侧结果上报附件", "monitor")'>上传部侧结果上报附件</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("部侧结果上报流程通知", "audit")'>部侧结果上报流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("部侧结果上报结果逐级审批", "statistics")'>部侧结果上报结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("部侧结果上报结果拒绝和驳回", "analysis")'>部侧结果上报结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
