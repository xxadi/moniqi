    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增部侧结果上报指派信息", "assign")'>新增部侧结果上报指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增部侧结果上报流程节点", "form")'>新增部侧结果上报流程节点</el-button>
