    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报失败原因获取", "operation")'>上报失败原因获取</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因数据审查", "form")'>上报失败原因数据审查</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因数据提取", "detail")'>上报失败原因数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看上报失败原因信息", "monitor")'>查看上报失败原因信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因采集监控", "statistics")'>上报失败原因采集监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因运行监控", "alert")'>上报失败原因运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因异常监控", "log")'>上报失败原因异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因模型运行效果评估", "audit")'>上报失败原因模型运行效果评估</el-button>
        </div>
      </div>
      <cs-pagetable
