    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报失败原因获取", "api")'>上报失败原因获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因信息研判", "validate")'>上报失败原因信息研判</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因关联分析", "data_analysis")'>上报失败原因关联分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因数据审查", "data_review")'>上报失败原因数据审查</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因数据提取", "data_extract")'>上报失败原因数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看上报失败原因信息", "detail")'>查看上报失败原因信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因采集监控", "monitor")'>上报失败原因采集监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因运行监控", "form")'>上报失败原因运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报失败原因异常监控", "log")'>上报失败原因异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报失败原因模型运行效果评估", "run_evaluation")'>上报失败原因模型运行效果评估</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "失败原因": "对端拒绝",
    "上报通道": "数据总线",
    "上报时间": "2026-05-08 11:16:09",
    "重试次数": 5,
    "接收时间": "2026-05-08 11:16:09",
    "资产编号": "ASSET-40954",
    "不一致数": 56
  },
  {
    ...
    "失败原因": "通道不可用",
    "上报通道": "文件传输",
    "上报时间": "2026-05-08 14:03:52",
    "重试次数": 8,
    "接收时间": "2026-05-08 14:03:52",
    "资产编号": "ASSET-44255",
    "不一致数": 120
  },
  {
    ...
    "失败原因": "网络超时",
    "上报通道": "HTTP接口",
    "上报时间": "2026-05-08 15:21:37",
    "重试次数": 0,
    "接收时间": "2026-05-08 15:21:37",
    "资产编号": "ASSET-47556",
    "不一致数": 0
  },
  {
    ...
    "失败原因": "格式错误",
    "上报通道": "SFTP",
    "上报时间": "2026-05-08 16:08:25",
    "重试次数": 1,
    "接收时间": "2026-05-08 16:08:25",
    "资产编号": "ASSET-50857",
    "不一致数": 3
  },
  {
    ...
    "失败原因": "鉴权失败",
    "上报通道": "MQ消息",
    "上报时间": "2026-05-09 08:33:11",
    "重试次数": 2,
    "接收时间": "2026-05-09 08:33:11",
    "资产编号": "ASSET-54158",
    "不一致数": 12
  },
  {
    ...
    "失败原因": "数据校验失败",
    "上报通道": "API网关",
    "上报时间": "2026-05-09 09:47:56",
    "重试次数": 3,
    "接收时间": "2026-05-09 09:47:56",
    "资产编号": "ASSET-57459",
    "不一致数": 28
  },
  {
    ...
    "失败原因": "对端拒绝",
    "上报通道": "数据总线",
    "上报时间": "2026-05-08 09:12:18",
    "重试次数": 5,
    "接收时间": "2026-05-08 09:12:18",
    "资产编号": "ASSET-60760",
    "不一致数": 56
  },
  {
    ...
    "失败原因": "通道不可用",
    "上报通道": "文件传输",
    "上报时间": "2026-05-08 09:35:44",
    "重试次数": 8,
    "接收时间": "2026-05-08 09:35:44",
    "资产编号": "ASSET-64061",
    "不一致数": 120
  },
  {
    ...
    "失败原因": "网络超时",
    "上报通道": "HTTP接口",
    "上报时间": "2026-05-08 10:08:06",
    "重试次数": 0,
    "接收时间": "2026-05-08 10:08:06",
    "资产编号": "ASSET-67362",
    "不一致数": 0
  },
  {
    ...
    "失败原因": "格式错误",
    "上报通道": "SFTP",
    "上报时间": "2026-05-08 10:42:31",
    "重试次数": 1,
    "接收时间": "2026-05-08 10:42:31",
    "资产编号": "ASSET-70663",
    "不一致数": 3
  }
];
...
const importTemplateRow = {
  "失败原因": "失败原因导入值",
  "上报通道": "上报通道导入值",
  "上报时间": "2026-06-29 02:55:41",
  "重试次数": 65,
  "接收时间": "2026-06-29 02:55:41",
  "资产编号": "IMP-741743",
  "不一致数": "不一致数导入值",
  "导入来源": "上报失败原因分析导入模板.xlsx"
};
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      ...
      exportXLSX(rows, functionName || "上报失败原因分析导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志/.test(functionName)) {
        return [
          ...
          { 名称: "上报失败原因分析任务调度", 状态: "执行中", 日志: "正在等待节点返回执行结果" },
          { 名称: "上报失败原因分析异常检查", 状态: "已告警", 日志: "发现1条超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "上报失败原因分析业务记录", 业务状态: "已处理", 处理时间: this.now(), 说明: "模拟业务记录" },
        { 业务名称: "上报失败原因分析复核记录", 业务状态: "待复核", 处理时间: this.now(), 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
