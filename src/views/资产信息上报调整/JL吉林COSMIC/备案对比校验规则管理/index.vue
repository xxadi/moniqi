    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("备案对比校验失败告警", "alert")'>备案对比校验失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比校验数据提取", "validate")'>备案对比校验数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比校验规则分析", "analysis")'>备案对比校验规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比校验规则分析结果展示", "monitor")'>备案对比校验规则分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
