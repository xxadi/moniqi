    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("输入IP资产组件反馈请求任务", "receive")'>输入IP资产组件反馈请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("输出IP资产组件反馈反馈信息", "feedback")'>输出IP资产组件反馈反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控IP资产组件反馈状态信息", "log")'>监控IP资产组件反馈状态信息</el-button>
