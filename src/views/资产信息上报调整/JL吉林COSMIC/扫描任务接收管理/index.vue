    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("扫描任务接收结果监控告警", "alert")'>扫描任务接收结果监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("扫描任务接收结果稽核", "audit")'>扫描任务接收结果稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务接收数据采集", "transform")'>扫描任务接收数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务接收数据转换", "detail")'>扫描任务接收数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务接收数据预处理", "statistics")'>扫描任务接收数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
