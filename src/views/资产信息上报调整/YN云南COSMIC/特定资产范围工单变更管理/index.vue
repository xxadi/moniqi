    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增特定资产范围工单信息", "form")'>新增特定资产范围工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改特定资产范围工单信息", "config")'>修改特定资产范围工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除特定资产范围工单信息")'>删除特定资产范围工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看特定资产范围工单信息", "detail")'>查看特定资产范围工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("特定资产范围工单附件文件上传", "form")'>特定资产范围工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("特定资产范围工单附件文件删除", "operation")'>特定资产范围工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("特定资产范围工单信息审批", "audit")'>特定资产范围工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("特定资产范围工单信息撤回", "operation")'>特定资产范围工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("特定资产范围工单信息终止", "operation")'>特定资产范围工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("特定资产范围工单信息派发提醒", "audit")'>特定资产范围工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "特定资产范围ID": "W-93414",
    "特定资产范围编号": "W-93414",
    "特定资产范围名称": "特定资产范围工单变更管理-1",
    "新增特定资产范围状态": "排队中",
    "新增特定资产范围时间": "2026-05-08 11:16:09",
    "特定资产范围属性": "排队中",
    "特定资产范围创建时间": "2026-05-08 11:16:09",
    "特定资产范围所属部门": "安全运维部",
    "特定资产范围负责人": "张三",
    "特定资产范围类型": "排队中",
    "特定资产范围规则": "排队中",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-101333",
    "特定资产范围编号": "W-101333",
    "特定资产范围名称": "特定资产范围工单变更管理-2",
    "新增特定资产范围状态": "部分完成",
    "新增特定资产范围时间": "2026-05-08 14:03:52",
    "特定资产范围属性": "部分完成",
    "特定资产范围创建时间": "2026-05-08 14:03:52",
    "特定资产范围所属部门": "网络管理部",
    "特定资产范围负责人": "李四",
    "特定资产范围类型": "部分完成",
    "特定资产范围规则": "部分完成",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-109252",
    "特定资产范围编号": "W-109252",
    "特定资产范围名称": "特定资产范围工单变更管理-3",
    "新增特定资产范围状态": "已启用",
    "新增特定资产范围时间": "2026-05-08 15:21:37",
    "特定资产范围属性": "已启用",
    "特定资产范围创建时间": "2026-05-08 15:21:37",
    "特定资产范围所属部门": "资产管理部",
    "特定资产范围负责人": "王五",
    "特定资产范围类型": "已启用",
    "特定资产范围规则": "已启用",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-117171",
    "特定资产范围编号": "W-117171",
    "特定资产范围名称": "特定资产范围工单变更管理-4",
    "新增特定资产范围状态": "已停用",
    "新增特定资产范围时间": "2026-05-08 16:08:25",
    "特定资产范围属性": "已停用",
    "特定资产范围创建时间": "2026-05-08 16:08:25",
    "特定资产范围所属部门": "信息安全部",
    "特定资产范围负责人": "赵六",
    "特定资产范围类型": "已停用",
    "特定资产范围规则": "已停用",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-125090",
    "特定资产范围编号": "W-125090",
    "特定资产范围名称": "特定资产范围工单变更管理-5",
    "新增特定资产范围状态": "正常",
    "新增特定资产范围时间": "2026-05-09 08:33:11",
    "特定资产范围属性": "正常",
    "特定资产范围创建时间": "2026-05-09 08:33:11",
    "特定资产范围所属部门": "系统运维部",
    "特定资产范围负责人": "system",
    "特定资产范围类型": "正常",
    "特定资产范围规则": "正常",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-133009",
    "特定资产范围编号": "W-133009",
    "特定资产范围名称": "特定资产范围工单变更管理-6",
    "新增特定资产范围状态": "异常",
    "新增特定资产范围时间": "2026-05-09 09:47:56",
    "特定资产范围属性": "异常",
    "特定资产范围创建时间": "2026-05-09 09:47:56",
    "特定资产范围所属部门": "数据管理部",
    "特定资产范围负责人": "admin",
    "特定资产范围类型": "异常",
    "特定资产范围规则": "异常",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-140928",
    "特定资产范围编号": "W-140928",
    "特定资产范围名称": "特定资产范围工单变更管理-7",
    "新增特定资产范围状态": "超时",
    "新增特定资产范围时间": "2026-05-08 09:12:18",
    "特定资产范围属性": "超时",
    "特定资产范围创建时间": "2026-05-08 09:12:18",
    "特定资产范围所属部门": "安全运维部",
    "特定资产范围负责人": "张三",
    "特定资产范围类型": "超时",
    "特定资产范围规则": "超时",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-148847",
    "特定资产范围编号": "W-148847",
    "特定资产范围名称": "特定资产范围工单变更管理-8",
    "新增特定资产范围状态": "已取消",
    "新增特定资产范围时间": "2026-05-08 09:35:44",
    "特定资产范围属性": "已取消",
    "特定资产范围创建时间": "2026-05-08 09:35:44",
    "特定资产范围所属部门": "网络管理部",
    "特定资产范围负责人": "李四",
    "特定资产范围类型": "已取消",
    "特定资产范围规则": "已取消",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-156766",
    "特定资产范围编号": "W-156766",
    "特定资产范围名称": "特定资产范围工单变更管理-9",
    "新增特定资产范围状态": "已驳回",
    "新增特定资产范围时间": "2026-05-08 10:08:06",
    "特定资产范围属性": "已驳回",
    "特定资产范围创建时间": "2026-05-08 10:08:06",
    "特定资产范围所属部门": "资产管理部",
    "特定资产范围负责人": "王五",
    "特定资产范围类型": "已驳回",
    "特定资产范围规则": "已驳回",
  ...
  },
  {
    ...
    "特定资产范围ID": "W-164685",
    "特定资产范围编号": "W-164685",
    "特定资产范围名称": "特定资产范围工单变更管理-10",
    "新增特定资产范围状态": "待审核",
    "新增特定资产范围时间": "2026-05-08 10:42:31",
    "特定资产范围属性": "待审核",
    "特定资产范围创建时间": "2026-05-08 10:42:31",
    "特定资产范围所属部门": "信息安全部",
    "特定资产范围负责人": "赵六",
    "特定资产范围类型": "待审核",
    "特定资产范围规则": "待审核",
