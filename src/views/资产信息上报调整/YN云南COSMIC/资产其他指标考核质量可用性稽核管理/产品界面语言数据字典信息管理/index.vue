    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增产品界面语言数据考核质量可用性字典信息')">新增产品界面语言数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改产品界面语言数据考核质量可用性字典信息')">修改产品界面语言数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除产品界面语言数据考核质量可用性字典信息')">删除产品界面语言数据考核质量可用性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "CJD-001", 字典名称: "简体中文", 字典类型: "产品界面语言", 字典值: "zh-CN", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "CJD-002", 字典名称: "English", 字典类型: "产品界面语言", 字典值: "en-US", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "CJD-003", 字典名称: "日本語", 字典类型: "产品界面语言", 字典值: "ja-JP", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "CJD-004", 字典名称: "한국어", 字典类型: "产品界面语言", 字典值: "ko-KR", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "CJD-005", 字典名称: "Français", 字典类型: "产品界面语言", 字典值: "fr-FR", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "产品界面语言", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_ChanPinJieMianYuYan_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
