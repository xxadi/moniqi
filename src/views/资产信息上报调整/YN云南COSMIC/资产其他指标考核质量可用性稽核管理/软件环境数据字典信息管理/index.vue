    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增软件环境数据考核质量可用性字典信息')">新增软件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改软件环境数据考核质量可用性字典信息')">修改软件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除软件环境数据考核质量可用性字典信息')">删除软件环境数据考核质量可用性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "SWD-001", 字典名称: "JDK版本", 字典类型: "软件环境", 字典值: "JDK 17 LTS", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "SWD-002", 字典名称: "Python版本", 字典类型: "软件环境", 字典值: "Python 3.11", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "SWD-003", 字典名称: "Node.js版本", 字典类型: "软件环境", 字典值: "Node.js 20 LTS", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "SWD-004", 字典名称: "MySQL版本", 字典类型: "软件环境", 字典值: "MySQL 8.0", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "SWD-005", 字典名称: "Redis版本", 字典类型: "软件环境", 字典值: "Redis 7.2", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "软件环境", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_RuanJianHuanJing_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
