    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增操作系统类型数据考核质量可用性字典信息')">新增操作系统类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改操作系统类型数据考核质量可用性字典信息')">修改操作系统类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除操作系统类型数据考核质量可用性字典信息')">删除操作系统类型数据考核质量可用性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "OSD-001", 字典名称: "Windows", 字典类型: "操作系统类型", 字典值: "windows", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "OSD-002", 字典名称: "Linux", 字典类型: "操作系统类型", 字典值: "linux", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "OSD-003", 字典名称: "macOS", 字典类型: "操作系统类型", 字典值: "macos", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "OSD-004", 字典名称: "Android", 字典类型: "操作系统类型", 字典值: "android", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "OSD-005", 字典名称: "iOS", 字典类型: "操作系统类型", 字典值: "ios", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "操作系统类型", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_CaoZuoXiTongLeiXing_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
