    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增定级对象名称考核质量可用性上传任务')">新增定级对象名称考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除定级对象名称考核质量可用性上传任务')">删除定级对象名称考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改定级对象名称考核质量可用性上传任务')">修改定级对象名称考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-search" @click="handleFunction('查询定级对象名称考核质量可用性上传任务')">查询定级对象名称考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-refresh" @click="handleFunction('定级对象名称考核质量可用性上传任务启用/禁用')">定级对象名称考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-upload" @click="handleFunction('定级对象名称考核质量可用性稽核数据上传')">定级对象名称考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-monitor" @click="handleFunction('定级对象名称考核质量可用性稽核数据接口监控')">定级对象名称考核质量可用性稽核数据接口监控</el-button>
        </div>
...
const rows = [
  { ID: 1, 任务编号: "DJR-001", 任务名称: "React开源框架数据采集上传", 上传状态: "已完成", 上传时间: "2026-06-01 10:00:00", 数据量: "12580", 负责人: "张明" },
  { ID: 2, 任务编号: "DJR-002", 任务名称: "Vue.js开源框架数据采集上传", 上传状态: "上传中", 上传时间: "2026-06-02 14:30:00", 数据量: "9832", 负责人: "李华" },
  { ID: 3, 任务编号: "DJR-003", 任务名称: "Angular开源框架数据采集上传", 上传状态: "待上传", 上传时间: "2026-06-03 09:15:00", 数据量: "7654", 负责人: "王芳" },
  { ID: 4, 任务编号: "DJR-004", 任务名称: "Spring Boot开源框架数据采集上传", 上传状态: "失败", 上传时间: "2026-06-04 16:20:00", 数据量: "5421", 负责人: "赵强" },
  { ID: 5, 任务编号: "DJR-005", 任务名称: "Django开源框架数据采集上传", 上传状态: "已完成", 上传时间: "2026-06-05 08:45:00", 数据量: "3210", 负责人: "刘洋" },
];
const cols = [
...
export default {
  name: "XiangMuWanZhengXing_DingJiDuiXiangMingCheng_ShangChuanRenWu",
  data() {
    return {
      searchData: {},
      searchConfig: [],
  ...
  methods: {
    ...
    handleFunction(name) {
      ...
      if (/新增/.test(name)) {
        ...
        this.$message.success("定级对象名称考核质量可用性稽核数据上传 - 上传演示成功，数据已提交处理");
      } else if (/监控/.test(name)) {
        this.$message.info("定级对象名称考核质量可用性稽核数据接口监控 - 接口监控演示：当前监控接口3个，全部正常运行");
      } else {
