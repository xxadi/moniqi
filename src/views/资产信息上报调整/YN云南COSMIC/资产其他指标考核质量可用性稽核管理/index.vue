    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架考核质量可用性稽核规则", "form")'>新增开源框架考核质量可用性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架考核质量可用性上传任务", "form")'>新增开源框架考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除开源框架考核质量可用性上传任务")'>删除开源框架考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改开源框架考核质量可用性上传任务", "config")'>修改开源框架考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询开源框架考核质量可用性上传任务", "detail")'>查询开源框架考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("开源框架考核质量可用性上传任务启用/禁用", "form")'>开源框架考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("开源框架考核质量可用性稽核数据上传", "form")'>开源框架考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("开源框架考核质量可用性稽核数据接口监控", "log")'>开源框架考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架数据考核质量可用性字典信息", "form")'>新增开源框架数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改开源框架数据考核质量可用性字典信息", "config")'>修改开源框架数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除开源框架数据考核质量可用性字典信息")'>删除开源框架数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增产品界面语言考核质量可用性稽核规则", "form")'>新增产品界面语言考核质量可用性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增产品界面语言数据考核质量可用性字典信息", "form")'>新增产品界面语言数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改产品界面语言数据考核质量可用性字典信息", "config")'>修改产品界面语言数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除产品界面语言数据考核质量可用性字典信息")'>删除产品界面语言数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增操作系统类型数据考核质量可用性字典信息", "form")'>新增操作系统类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改操作系统类型数据考核质量可用性字典信息", "config")'>修改操作系统类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除操作系统类型数据考核质量可用性字典信息")'>删除操作系统类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增硬件环境数据考核质量可用性字典信息", "form")'>新增硬件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改硬件环境数据考核质量可用性字典信息", "config")'>修改硬件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除硬件环境数据考核质量可用性字典信息")'>删除硬件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增软件环境数据考核质量可用性字典信息", "form")'>新增软件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改软件环境数据考核质量可用性字典信息", "config")'>修改软件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除软件环境数据考核质量可用性字典信息")'>删除软件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增网络单元类型数据考核质量可用性字典信息", "form")'>新增网络单元类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络单元类型数据考核质量可用性字典信息", "config")'>修改网络单元类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除网络单元类型数据考核质量可用性字典信息")'>删除网络单元类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象名称数据考核质量可用性字典信息", "form")'>新增定级对象名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象名称数据考核质量可用性字典信息", "config")'>修改定级对象名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除定级对象名称数据考核质量可用性字典信息")'>删除定级对象名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象名称考核质量可用性稽核数据上传", "form")'>定级对象名称考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定级对象名称考核质量可用性稽核数据接口监控", "log")'>定级对象名称考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增所属安全域数据考核质量可用性字典信息", "form")'>新增所属安全域数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改所属安全域数据考核质量可用性字典信息", "config")'>修改所属安全域数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除所属安全域数据考核质量可用性字典信息")'>删除所属安全域数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增所属安全域考核质量可用性上传任务", "form")'>新增所属安全域考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除所属安全域考核质量可用性上传任务")'>删除所属安全域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改所属安全域考核质量可用性上传任务", "config")'>修改所属安全域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询所属安全域考核质量可用性上传任务", "detail")'>查询所属安全域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("所属安全域考核质量可用性上传任务启用/禁用", "form")'>所属安全域考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("所属安全域考核质量可用性稽核数据上传", "form")'>所属安全域考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("所属安全域考核质量可用性稽核数据接口监控", "log")'>所属安全域考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "开源框架考核质量可用性稽核ID": "P-22479",
    "开源框架考核质量可用性稽核编号": "P-22479",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-1",
    "新增开源框架考核质量可用性稽核状态": "待审核",
    "新增开源框架考核质量可用性稽核时间": "2026-05-09 09:47:56",
    "开源框架考核质量可用性稽核属性": "待审核",
    "开源框架考核质量可用性稽核创建时间": "2026-05-09 09:47:56",
    "开源框架考核质量可用性稽核所属部门": "信息安全部",
    "开源框架考核质量可用性稽核负责人": "赵六",
    "开源框架考核质量可用性稽核类型": "待审核",
    "开源框架考核质量可用性稽核规则": "待审核",
    "开源框架考核质量可用性校验ID": "P-22479"
  },
  {
    "ID": 2,
    "开源框架考核质量可用性稽核ID": "P-30398",
    "开源框架考核质量可用性稽核编号": "P-30398",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-2",
    "新增开源框架考核质量可用性稽核状态": "已处理",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 09:12:18",
    "开源框架考核质量可用性稽核属性": "已处理",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 09:12:18",
    "开源框架考核质量可用性稽核所属部门": "系统运维部",
    "开源框架考核质量可用性稽核负责人": "system",
    "开源框架考核质量可用性稽核类型": "已处理",
    "开源框架考核质量可用性稽核规则": "已处理",
    "开源框架考核质量可用性校验ID": "P-30398"
  },
  {
    "ID": 3,
    "开源框架考核质量可用性稽核ID": "P-38317",
    "开源框架考核质量可用性稽核编号": "P-38317",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-3",
    "新增开源框架考核质量可用性稽核状态": "处理中",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 09:35:44",
    "开源框架考核质量可用性稽核属性": "处理中",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 09:35:44",
    "开源框架考核质量可用性稽核所属部门": "数据管理部",
    "开源框架考核质量可用性稽核负责人": "admin",
    "开源框架考核质量可用性稽核类型": "处理中",
    "开源框架考核质量可用性稽核规则": "处理中",
    "开源框架考核质量可用性校验ID": "P-38317"
  },
  {
    "ID": 4,
    "开源框架考核质量可用性稽核ID": "P-46236",
    "开源框架考核质量可用性稽核编号": "P-46236",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-4",
    "新增开源框架考核质量可用性稽核状态": "待处理",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 10:08:06",
    "开源框架考核质量可用性稽核属性": "待处理",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 10:08:06",
    "开源框架考核质量可用性稽核所属部门": "安全运维部",
    "开源框架考核质量可用性稽核负责人": "张三",
    "开源框架考核质量可用性稽核类型": "待处理",
    "开源框架考核质量可用性稽核规则": "待处理",
    "开源框架考核质量可用性校验ID": "P-46236"
  },
  {
    "ID": 5,
    "开源框架考核质量可用性稽核ID": "P-54155",
    "开源框架考核质量可用性稽核编号": "P-54155",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-5",
    "新增开源框架考核质量可用性稽核状态": "处理失败",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 10:42:31",
    "开源框架考核质量可用性稽核属性": "处理失败",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 10:42:31",
    "开源框架考核质量可用性稽核所属部门": "网络管理部",
    "开源框架考核质量可用性稽核负责人": "李四",
    "开源框架考核质量可用性稽核类型": "处理失败",
    "开源框架考核质量可用性稽核规则": "处理失败",
    "开源框架考核质量可用性校验ID": "P-54155"
  },
  {
    "ID": 6,
    "开源框架考核质量可用性稽核ID": "P-62074",
    "开源框架考核质量可用性稽核编号": "P-62074",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-6",
    "新增开源框架考核质量可用性稽核状态": "已暂停",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 11:16:09",
    "开源框架考核质量可用性稽核属性": "已暂停",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 11:16:09",
    "开源框架考核质量可用性稽核所属部门": "资产管理部",
    "开源框架考核质量可用性稽核负责人": "王五",
    "开源框架考核质量可用性稽核类型": "已暂停",
    "开源框架考核质量可用性稽核规则": "已暂停",
    "开源框架考核质量可用性校验ID": "P-62074"
  },
  {
    "ID": 7,
    "开源框架考核质量可用性稽核ID": "P-69993",
    "开源框架考核质量可用性稽核编号": "P-69993",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-7",
    "新增开源框架考核质量可用性稽核状态": "已完成",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 14:03:52",
    "开源框架考核质量可用性稽核属性": "已完成",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 14:03:52",
    "开源框架考核质量可用性稽核所属部门": "信息安全部",
    "开源框架考核质量可用性稽核负责人": "赵六",
    "开源框架考核质量可用性稽核类型": "已完成",
    "开源框架考核质量可用性稽核规则": "已完成",
    "开源框架考核质量可用性校验ID": "P-69993"
  },
  {
    "ID": 8,
    "开源框架考核质量可用性稽核ID": "P-77912",
    "开源框架考核质量可用性稽核编号": "P-77912",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-8",
    "新增开源框架考核质量可用性稽核状态": "排队中",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 15:21:37",
    "开源框架考核质量可用性稽核属性": "排队中",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 15:21:37",
    "开源框架考核质量可用性稽核所属部门": "系统运维部",
    "开源框架考核质量可用性稽核负责人": "system",
    "开源框架考核质量可用性稽核类型": "排队中",
    "开源框架考核质量可用性稽核规则": "排队中",
    "开源框架考核质量可用性校验ID": "P-77912"
  },
  {
    "ID": 9,
    "开源框架考核质量可用性稽核ID": "P-85831",
    "开源框架考核质量可用性稽核编号": "P-85831",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-9",
    "新增开源框架考核质量可用性稽核状态": "部分完成",
    "新增开源框架考核质量可用性稽核时间": "2026-05-08 16:08:25",
    "开源框架考核质量可用性稽核属性": "部分完成",
    "开源框架考核质量可用性稽核创建时间": "2026-05-08 16:08:25",
    "开源框架考核质量可用性稽核所属部门": "数据管理部",
    "开源框架考核质量可用性稽核负责人": "admin",
    "开源框架考核质量可用性稽核类型": "部分完成",
    "开源框架考核质量可用性稽核规则": "部分完成",
    "开源框架考核质量可用性校验ID": "P-85831"
  },
  {
    "ID": 10,
    "开源框架考核质量可用性稽核ID": "P-93750",
    "开源框架考核质量可用性稽核编号": "P-93750",
    "开源框架考核质量可用性稽核名称": "资产其他指标考核质量可用性稽核管理-10",
    "新增开源框架考核质量可用性稽核状态": "已启用",
    "新增开源框架考核质量可用性稽核时间": "2026-05-09 08:33:11",
    "开源框架考核质量可用性稽核属性": "已启用",
    "开源框架考核质量可用性稽核创建时间": "2026-05-09 08:33:11",
    "开源框架考核质量可用性稽核所属部门": "安全运维部",
    "开源框架考核质量可用性稽核负责人": "张三",
    "开源框架考核质量可用性稽核类型": "已启用",
    "开源框架考核质量可用性稽核规则": "已启用",
    "开源框架考核质量可用性校验ID": "P-93750"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "开源框架考核质量可用性稽核ID",
    "label": "开源框架考核质量可用性稽核ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核编号",
    "label": "开源框架考核质量可用性稽核编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核名称",
    "label": "开源框架考核质量可用性稽核名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增开源框架考核质量可用性稽核状态",
    "label": "新增开源框架考核质量可用性稽核状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增开源框架考核质量可用性稽核时间",
    "label": "新增开源框架考核质量可用性稽核时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "开源框架考核质量可用性稽核属性",
    "label": "开源框架考核质量可用性稽核属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核创建时间",
    "label": "开源框架考核质量可用性稽核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "开源框架考核质量可用性稽核所属部门",
    "label": "开源框架考核质量可用性稽核所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核负责人",
    "label": "开源框架考核质量可用性稽核负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核类型",
    "label": "开源框架考核质量可用性稽核类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性稽核规则",
    "label": "开源框架考核质量可用性稽核规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核质量可用性校验ID",
    "label": "开源框架考核质量可用性校验ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "开源框架考核质量可用性稽核规则": "",
  "开源框架考核质量可用性校验ID": "",
  "导入来源": "资产其他指标考核质量可用性稽核管理导入模板.xlsx"
};
