    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增开源框架数据考核质量可用性字典信息')">新增开源框架数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改开源框架数据考核质量可用性字典信息')">修改开源框架数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除开源框架数据考核质量可用性字典信息')">删除开源框架数据考核质量可用性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "KYD-001", 字典名称: "前端框架React", 字典类型: "开源框架", 字典值: "React", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "KYD-002", 字典名称: "前端框架Vue", 字典类型: "开源框架", 字典值: "Vue.js", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "KYD-003", 字典名称: "前端框架Angular", 字典类型: "开源框架", 字典值: "Angular", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "KYD-004", 字典名称: "后端框架Spring", 字典类型: "开源框架", 字典值: "Spring Boot", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "KYD-005", 字典名称: "后端框架Django", 字典类型: "开源框架", 字典值: "Django", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "开源框架", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_KaiYuanKuangJia_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
