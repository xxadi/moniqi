    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增硬件环境数据考核质量可用性字典信息')">新增硬件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改硬件环境数据考核质量可用性字典信息')">修改硬件环境数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除硬件环境数据考核质量可用性字典信息')">删除硬件环境数据考核质量可用性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "HWD-001", 字典名称: "CPU型号Intel Xeon", 字典类型: "硬件环境", 字典值: "Intel Xeon E5-2680", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "HWD-002", 字典名称: "内存规格DDR4", 字典类型: "硬件环境", 字典值: "DDR4 32GB", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "HWD-003", 字典名称: "磁盘类型SSD", 字典类型: "硬件环境", 字典值: "NVMe SSD 1TB", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "HWD-004", 字典名称: "网卡型号Intel", 字典类型: "硬件环境", 字典值: "Intel I350-T4", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "HWD-005", 字典名称: "显卡型号NVIDIA", 字典类型: "硬件环境", 字典值: "NVIDIA Tesla V100", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "硬件环境", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_YingJianHuanJing_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
