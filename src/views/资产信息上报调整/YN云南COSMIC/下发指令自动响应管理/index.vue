    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令自动响应信息", "form")'>新增下发指令自动响应信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令自动响应信息", "config")'>修改下发指令自动响应信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令自动响应信息")'>删除下发指令自动响应信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("下发指令自动响应数据采集", "transform")'>下发指令自动响应数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("下发指令自动响应数据预处理", "transform")'>下发指令自动响应数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询下发指令自动响应汇总报表详情", "detail")'>查询下发指令自动响应汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询下发指令自动响应明细报表详情", "detail")'>查询下发指令自动响应明细报表详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "下发指令自动响应ID": "V-6573",
    "下发指令自动响应编号": "V-6573",
    "下发指令自动响应名称": "下发指令自动响应管理-1",
    "新增下发指令自动响应状态": "已取消",
    "新增下发指令自动响应时间": "2026-05-08 10:42:31",
    "下发指令自动响应属性": "已取消",
    "下发指令自动响应创建时间": "2026-05-08 10:42:31",
    "下发指令自动响应所属部门": "信息安全部",
    "下发指令自动响应负责人": "赵六",
    "下发指令自动响应类型": "已取消",
    "下发指令自动响应规则": "已取消",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-14492",
    "下发指令自动响应编号": "V-14492",
    "下发指令自动响应名称": "下发指令自动响应管理-2",
    "新增下发指令自动响应状态": "已驳回",
    "新增下发指令自动响应时间": "2026-05-08 11:16:09",
    "下发指令自动响应属性": "已驳回",
    "下发指令自动响应创建时间": "2026-05-08 11:16:09",
    "下发指令自动响应所属部门": "系统运维部",
    "下发指令自动响应负责人": "system",
    "下发指令自动响应类型": "已驳回",
    "下发指令自动响应规则": "已驳回",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-22411",
    "下发指令自动响应编号": "V-22411",
    "下发指令自动响应名称": "下发指令自动响应管理-3",
    "新增下发指令自动响应状态": "待审核",
    "新增下发指令自动响应时间": "2026-05-08 14:03:52",
    "下发指令自动响应属性": "待审核",
    "下发指令自动响应创建时间": "2026-05-08 14:03:52",
    "下发指令自动响应所属部门": "数据管理部",
    "下发指令自动响应负责人": "admin",
    "下发指令自动响应类型": "待审核",
    "下发指令自动响应规则": "待审核",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-30330",
    "下发指令自动响应编号": "V-30330",
    "下发指令自动响应名称": "下发指令自动响应管理-4",
    "新增下发指令自动响应状态": "已处理",
    "新增下发指令自动响应时间": "2026-05-08 15:21:37",
    "下发指令自动响应属性": "已处理",
    "下发指令自动响应创建时间": "2026-05-08 15:21:37",
    "下发指令自动响应所属部门": "安全运维部",
    "下发指令自动响应负责人": "张三",
    "下发指令自动响应类型": "已处理",
    "下发指令自动响应规则": "已处理",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-38249",
    "下发指令自动响应编号": "V-38249",
    "下发指令自动响应名称": "下发指令自动响应管理-5",
    "新增下发指令自动响应状态": "处理中",
    "新增下发指令自动响应时间": "2026-05-08 16:08:25",
    "下发指令自动响应属性": "处理中",
    "下发指令自动响应创建时间": "2026-05-08 16:08:25",
    "下发指令自动响应所属部门": "网络管理部",
    "下发指令自动响应负责人": "李四",
    "下发指令自动响应类型": "处理中",
    "下发指令自动响应规则": "处理中",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-46168",
    "下发指令自动响应编号": "V-46168",
    "下发指令自动响应名称": "下发指令自动响应管理-6",
    "新增下发指令自动响应状态": "待处理",
    "新增下发指令自动响应时间": "2026-05-09 08:33:11",
    "下发指令自动响应属性": "待处理",
    "下发指令自动响应创建时间": "2026-05-09 08:33:11",
    "下发指令自动响应所属部门": "资产管理部",
    "下发指令自动响应负责人": "王五",
    "下发指令自动响应类型": "待处理",
    "下发指令自动响应规则": "待处理",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-54087",
    "下发指令自动响应编号": "V-54087",
    "下发指令自动响应名称": "下发指令自动响应管理-7",
    "新增下发指令自动响应状态": "处理失败",
    "新增下发指令自动响应时间": "2026-05-09 09:47:56",
    "下发指令自动响应属性": "处理失败",
    "下发指令自动响应创建时间": "2026-05-09 09:47:56",
    "下发指令自动响应所属部门": "信息安全部",
    "下发指令自动响应负责人": "赵六",
    "下发指令自动响应类型": "处理失败",
    "下发指令自动响应规则": "处理失败",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-62006",
    "下发指令自动响应编号": "V-62006",
    "下发指令自动响应名称": "下发指令自动响应管理-8",
    "新增下发指令自动响应状态": "已暂停",
    "新增下发指令自动响应时间": "2026-05-08 09:12:18",
    "下发指令自动响应属性": "已暂停",
    "下发指令自动响应创建时间": "2026-05-08 09:12:18",
    "下发指令自动响应所属部门": "系统运维部",
    "下发指令自动响应负责人": "system",
    "下发指令自动响应类型": "已暂停",
    "下发指令自动响应规则": "已暂停",
  ...
  },
  {
    ...
    "下发指令自动响应ID": "V-69925",
    "下发指令自动响应编号": "V-69925",
    "下发指令自动响应名称": "下发指令自动响应管理-9",
    "新增下发指令自动响应状态": "已完成",
    "新增下发指令自动响应时间": "2026-05-08 09:35:44",
    "下发指令自动响应属性": "已完成",
    "下发指令自动响应创建时间": "2026-05-08 09:35:44",
    "下发指令自动响应所属部门": "数据管理部",
    "下发指令自动响应负责人": "admin",
    "下发指令自动响应类型": "已完成",
    "下发指令自动响应规则": "已完成",
