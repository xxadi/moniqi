    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产合规信息", "form")'>新增工信部资产合规信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产合规信息", "config")'>修改工信部资产合规信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产合规信息")'>删除工信部资产合规信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产合规数据采集", "transform")'>工信部资产合规数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产合规数据转换", "transform")'>工信部资产合规数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产合规数据预处理", "transform")'>工信部资产合规数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产合规汇总报表详情", "detail")'>查询工信部资产合规汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产合规明细报表详情", "detail")'>查询工信部资产合规明细报表详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产合规ID": "C-54992",
    "工信部资产合规编号": "C-54992",
    "工信部资产合规名称": "工信部资产合规管理-1",
    "新增工信部资产合规状态": "已处理",
    "新增工信部资产合规时间": "2026-05-08 10:08:06",
    "工信部资产合规属性": "已处理",
    "工信部资产合规创建时间": "2026-05-08 10:08:06",
    "工信部资产合规所属部门": "资产管理部",
    "工信部资产合规负责人": "王五",
    "工信部资产合规类型": "已处理",
    "工信部资产合规规则": "已处理",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-62911",
    "工信部资产合规编号": "C-62911",
    "工信部资产合规名称": "工信部资产合规管理-2",
    "新增工信部资产合规状态": "处理中",
    "新增工信部资产合规时间": "2026-05-08 10:42:31",
    "工信部资产合规属性": "处理中",
    "工信部资产合规创建时间": "2026-05-08 10:42:31",
    "工信部资产合规所属部门": "信息安全部",
    "工信部资产合规负责人": "赵六",
    "工信部资产合规类型": "处理中",
    "工信部资产合规规则": "处理中",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-70830",
    "工信部资产合规编号": "C-70830",
    "工信部资产合规名称": "工信部资产合规管理-3",
    "新增工信部资产合规状态": "待处理",
    "新增工信部资产合规时间": "2026-05-08 11:16:09",
    "工信部资产合规属性": "待处理",
    "工信部资产合规创建时间": "2026-05-08 11:16:09",
    "工信部资产合规所属部门": "系统运维部",
    "工信部资产合规负责人": "system",
    "工信部资产合规类型": "待处理",
    "工信部资产合规规则": "待处理",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-78749",
    "工信部资产合规编号": "C-78749",
    "工信部资产合规名称": "工信部资产合规管理-4",
    "新增工信部资产合规状态": "处理失败",
    "新增工信部资产合规时间": "2026-05-08 14:03:52",
    "工信部资产合规属性": "处理失败",
    "工信部资产合规创建时间": "2026-05-08 14:03:52",
    "工信部资产合规所属部门": "数据管理部",
    "工信部资产合规负责人": "admin",
    "工信部资产合规类型": "处理失败",
    "工信部资产合规规则": "处理失败",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-86668",
    "工信部资产合规编号": "C-86668",
    "工信部资产合规名称": "工信部资产合规管理-5",
    "新增工信部资产合规状态": "已暂停",
    "新增工信部资产合规时间": "2026-05-08 15:21:37",
    "工信部资产合规属性": "已暂停",
    "工信部资产合规创建时间": "2026-05-08 15:21:37",
    "工信部资产合规所属部门": "安全运维部",
    "工信部资产合规负责人": "张三",
    "工信部资产合规类型": "已暂停",
    "工信部资产合规规则": "已暂停",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-94587",
    "工信部资产合规编号": "C-94587",
    "工信部资产合规名称": "工信部资产合规管理-6",
    "新增工信部资产合规状态": "已完成",
    "新增工信部资产合规时间": "2026-05-08 16:08:25",
    "工信部资产合规属性": "已完成",
    "工信部资产合规创建时间": "2026-05-08 16:08:25",
    "工信部资产合规所属部门": "网络管理部",
    "工信部资产合规负责人": "李四",
    "工信部资产合规类型": "已完成",
    "工信部资产合规规则": "已完成",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-102506",
    "工信部资产合规编号": "C-102506",
    "工信部资产合规名称": "工信部资产合规管理-7",
    "新增工信部资产合规状态": "排队中",
    "新增工信部资产合规时间": "2026-05-09 08:33:11",
    "工信部资产合规属性": "排队中",
    "工信部资产合规创建时间": "2026-05-09 08:33:11",
    "工信部资产合规所属部门": "资产管理部",
    "工信部资产合规负责人": "王五",
    "工信部资产合规类型": "排队中",
    "工信部资产合规规则": "排队中",
  ...
  },
  {
    ...
    "工信部资产合规ID": "C-110425",
    "工信部资产合规编号": "C-110425",
    "工信部资产合规名称": "工信部资产合规管理-8",
    "新增工信部资产合规状态": "部分完成",
    "新增工信部资产合规时间": "2026-05-09 09:47:56",
    "工信部资产合规属性": "部分完成",
    "工信部资产合规创建时间": "2026-05-09 09:47:56",
    "工信部资产合规所属部门": "信息安全部",
    "工信部资产合规负责人": "赵六",
    "工信部资产合规类型": "部分完成",
    "工信部资产合规规则": "部分完成",
