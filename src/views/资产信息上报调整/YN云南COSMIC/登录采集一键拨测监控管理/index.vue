    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集一键拨测监控任务", "form")'>新增登录采集一键拨测监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集一键拨监控设置信息", "form")'>新增登录采集一键拨监控设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改登录采集一键拨监控设置信息", "config")'>修改登录采集一键拨监控设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除登录采集一键拨监控设置信息")'>删除登录采集一键拨监控设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨监控错误信息监控", "log")'>登录采集一键拨监控错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨监控错误事件通知", "log")'>登录采集一键拨监控错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨监控错误事件通知删除", "log")'>登录采集一键拨监控错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨监控错误事件通知查询", "log")'>登录采集一键拨监控错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集一键拨测监控模型", "form")'>新增登录采集一键拨测监控模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改登录采集一键拨测监控模型", "config")'>修改登录采集一键拨测监控模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除登录采集一键拨测监控模型")'>删除登录采集一键拨测监控模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨测监控查询", "log")'>登录采集一键拨测监控查询</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("登录采集一键拨测监控可视化展示", "log")'>登录采集一键拨测监控可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "登录采集一键拨测监控ID": "R-29189",
    "登录采集一键拨测监控编号": "R-29189",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-1",
    "新增登录采集一键拨测监控状态": "已完成",
    "登录采集一键拨测监控任务ID": "R-29189",
    "新增登录采集一键拨测监控时间": "2026-05-09 09:47:56",
    "登录采集一键拨测监控属性": "已完成",
    "登录采集一键拨测监控创建时间": "2026-05-09 09:47:56",
    "读取登录采集一键拨测监控任务状态": "已完成",
    "登录采集一键拨测监控所属部门": "数据管理部",
    "登录采集一键拨测监控负责人": "admin",
    "登录采集一键拨测监控类型": "已完成"
  },
  {
    "ID": 2,
    "登录采集一键拨测监控ID": "R-37108",
    "登录采集一键拨测监控编号": "R-37108",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-2",
    "新增登录采集一键拨测监控状态": "排队中",
    "登录采集一键拨测监控任务ID": "R-37108",
    "新增登录采集一键拨测监控时间": "2026-05-08 09:12:18",
    "登录采集一键拨测监控属性": "排队中",
    "登录采集一键拨测监控创建时间": "2026-05-08 09:12:18",
    "读取登录采集一键拨测监控任务状态": "排队中",
    "登录采集一键拨测监控所属部门": "安全运维部",
    "登录采集一键拨测监控负责人": "张三",
    "登录采集一键拨测监控类型": "排队中"
  },
  {
    "ID": 3,
    "登录采集一键拨测监控ID": "R-45027",
    "登录采集一键拨测监控编号": "R-45027",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-3",
    "新增登录采集一键拨测监控状态": "部分完成",
    "登录采集一键拨测监控任务ID": "R-45027",
    "新增登录采集一键拨测监控时间": "2026-05-08 09:35:44",
    "登录采集一键拨测监控属性": "部分完成",
    "登录采集一键拨测监控创建时间": "2026-05-08 09:35:44",
    "读取登录采集一键拨测监控任务状态": "部分完成",
    "登录采集一键拨测监控所属部门": "网络管理部",
    "登录采集一键拨测监控负责人": "李四",
    "登录采集一键拨测监控类型": "部分完成"
  },
  {
    "ID": 4,
    "登录采集一键拨测监控ID": "R-52946",
    "登录采集一键拨测监控编号": "R-52946",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-4",
    "新增登录采集一键拨测监控状态": "已启用",
    "登录采集一键拨测监控任务ID": "R-52946",
    "新增登录采集一键拨测监控时间": "2026-05-08 10:08:06",
    "登录采集一键拨测监控属性": "已启用",
    "登录采集一键拨测监控创建时间": "2026-05-08 10:08:06",
    "读取登录采集一键拨测监控任务状态": "已启用",
    "登录采集一键拨测监控所属部门": "资产管理部",
    "登录采集一键拨测监控负责人": "王五",
    "登录采集一键拨测监控类型": "已启用"
  },
  {
    "ID": 5,
    "登录采集一键拨测监控ID": "R-60865",
    "登录采集一键拨测监控编号": "R-60865",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-5",
    "新增登录采集一键拨测监控状态": "已停用",
    "登录采集一键拨测监控任务ID": "R-60865",
    "新增登录采集一键拨测监控时间": "2026-05-08 10:42:31",
    "登录采集一键拨测监控属性": "已停用",
    "登录采集一键拨测监控创建时间": "2026-05-08 10:42:31",
    "读取登录采集一键拨测监控任务状态": "已停用",
    "登录采集一键拨测监控所属部门": "信息安全部",
    "登录采集一键拨测监控负责人": "赵六",
    "登录采集一键拨测监控类型": "已停用"
  },
  {
    "ID": 6,
    "登录采集一键拨测监控ID": "R-68784",
    "登录采集一键拨测监控编号": "R-68784",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-6",
    "新增登录采集一键拨测监控状态": "正常",
    "登录采集一键拨测监控任务ID": "R-68784",
    "新增登录采集一键拨测监控时间": "2026-05-08 11:16:09",
    "登录采集一键拨测监控属性": "正常",
    "登录采集一键拨测监控创建时间": "2026-05-08 11:16:09",
    "读取登录采集一键拨测监控任务状态": "正常",
    "登录采集一键拨测监控所属部门": "系统运维部",
    "登录采集一键拨测监控负责人": "system",
    "登录采集一键拨测监控类型": "正常"
  },
  {
    "ID": 7,
    "登录采集一键拨测监控ID": "R-76703",
    "登录采集一键拨测监控编号": "R-76703",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-7",
    "新增登录采集一键拨测监控状态": "异常",
    "登录采集一键拨测监控任务ID": "R-76703",
    "新增登录采集一键拨测监控时间": "2026-05-08 14:03:52",
    "登录采集一键拨测监控属性": "异常",
    "登录采集一键拨测监控创建时间": "2026-05-08 14:03:52",
    "读取登录采集一键拨测监控任务状态": "异常",
    "登录采集一键拨测监控所属部门": "数据管理部",
    "登录采集一键拨测监控负责人": "admin",
    "登录采集一键拨测监控类型": "异常"
  ...
  {
    "ID": 8,
    "登录采集一键拨测监控ID": "R-84622",
    "登录采集一键拨测监控编号": "R-84622",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-8",
    "新增登录采集一键拨测监控状态": "超时",
    "登录采集一键拨测监控任务ID": "R-84622",
    "新增登录采集一键拨测监控时间": "2026-05-08 15:21:37",
    "登录采集一键拨测监控属性": "超时",
    "登录采集一键拨测监控创建时间": "2026-05-08 15:21:37",
    "读取登录采集一键拨测监控任务状态": "超时",
    "登录采集一键拨测监控所属部门": "安全运维部",
    "登录采集一键拨测监控负责人": "张三",
    "登录采集一键拨测监控类型": "超时"
  ...
  {
    "ID": 9,
    "登录采集一键拨测监控ID": "R-92541",
    "登录采集一键拨测监控编号": "R-92541",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-9",
    "新增登录采集一键拨测监控状态": "已取消",
    "登录采集一键拨测监控任务ID": "R-92541",
    "新增登录采集一键拨测监控时间": "2026-05-08 16:08:25",
    "登录采集一键拨测监控属性": "已取消",
    "登录采集一键拨测监控创建时间": "2026-05-08 16:08:25",
    "读取登录采集一键拨测监控任务状态": "已取消",
    "登录采集一键拨测监控所属部门": "网络管理部",
    "登录采集一键拨测监控负责人": "李四",
    "登录采集一键拨测监控类型": "已取消"
  },
  {
    "ID": 10,
    "登录采集一键拨测监控ID": "R-100460",
    "登录采集一键拨测监控编号": "R-100460",
    "登录采集一键拨测监控名称": "登录采集一键拨测监控管理-10",
    "新增登录采集一键拨测监控状态": "已驳回",
    "登录采集一键拨测监控任务ID": "R-100460",
    "新增登录采集一键拨测监控时间": "2026-05-09 08:33:11",
    "登录采集一键拨测监控属性": "已驳回",
    "登录采集一键拨测监控创建时间": "2026-05-09 08:33:11",
    "读取登录采集一键拨测监控任务状态": "已驳回",
    "登录采集一键拨测监控所属部门": "资产管理部",
    "登录采集一键拨测监控负责人": "王五",
    "登录采集一键拨测监控类型": "已驳回"
  }
...
const tableColumns = [
  ...
  {
    "prop": "读取登录采集一键拨测监控任务状态",
    "label": "读取登录采集一键拨测监控任务状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
