    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产清单信息", "form")'>新增资产清单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产清单信息", "config")'>修改资产清单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产清单信息")'>删除资产清单信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产清单数据采集", "transform")'>资产清单数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产清单数据转换", "transform")'>资产清单数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产清单数据预处理", "transform")'>资产清单数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产清单汇总报表详情", "detail")'>查询资产清单汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产清单明细报表详情", "detail")'>查询资产清单明细报表详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产清单名称": "工信部资产清单管理-1",
    "新增资产清单状态": "已暂停",
    "新增资产清单时间": "2026-05-08 09:12:18",
    "资产清单属性": "已暂停",
    "资产清单创建时间": "2026-05-08 09:12:18",
    "新增资产清单状态告警时间": "2026-05-08 09:12:18",
    "告警用户": "system",
    "告警系统": "已暂停",
    "资产ip": "已暂停",
    "资产清单所属部门": "系统运维部"
  },
  {
    ...
    "资产清单名称": "工信部资产清单管理-2",
    "新增资产清单状态": "已完成",
    "新增资产清单时间": "2026-05-08 09:35:44",
    "资产清单属性": "已完成",
    "资产清单创建时间": "2026-05-08 09:35:44",
    "新增资产清单状态告警时间": "2026-05-08 09:35:44",
    "告警用户": "admin",
    "告警系统": "已完成",
    "资产ip": "已完成",
    "资产清单所属部门": "数据管理部"
  },
  {
    ...
    "资产清单名称": "工信部资产清单管理-3",
    "新增资产清单状态": "排队中",
    "新增资产清单时间": "2026-05-08 10:08:06",
    "资产清单属性": "排队中",
    "资产清单创建时间": "2026-05-08 10:08:06",
    "新增资产清单状态告警时间": "2026-05-08 10:08:06",
    "告警用户": "张三",
    "告警系统": "排队中",
    "资产ip": "排队中",
    "资产清单所属部门": "安全运维部"
  },
  {
    ...
    "资产清单名称": "工信部资产清单管理-4",
    "新增资产清单状态": "部分完成",
    "新增资产清单时间": "2026-05-08 10:42:31",
    "资产清单属性": "部分完成",
    "资产清单创建时间": "2026-05-08 10:42:31",
    "新增资产清单状态告警时间": "2026-05-08 10:42:31",
    "告警用户": "李四",
    "告警系统": "部分完成",
    "资产ip": "部分完成",
    "资产清单所属部门": "网络管理部"
  },
  {
    ...
    "资产清单名称": "工信部资产清单管理-5",
    "新增资产清单状态": "已启用",
    "新增资产清单时间": "2026-05-08 11:16:09",
    "资产清单属性": "已启用",
    "资产清单创建时间": "2026-05-08 11:16:09",
    "新增资产清单状态告警时间": "2026-05-08 11:16:09",
    "告警用户": "王五",
    "告警系统": "已启用",
    "资产ip": "已启用",
    "资产清单所属部门": "资产管理部"
  },
  {
    ...
    "资产清单名称": "工信部资产清单管理-6",
    "新增资产清单状态": "已停用",
    "新增资产清单时间": "2026-05-08 14:03:52",
    "资产清单属性": "已停用",
    "资产清单创建时间": "2026-05-08 14:03:52",
    "新增资产清单状态告警时间": "2026-05-08 14:03:52",
    "告警用户": "赵六",
    "告警系统": "已停用",
    "资产ip": "已停用",
    "资产清单所属部门": "信息安全部"
