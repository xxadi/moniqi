    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集入库审核流程", "form")'>新增登录采集入库审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改登录采集入库审核流程信息", "config")'>修改登录采集入库审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库审核流程删除", "operation")'>登录采集入库审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库审核流程查询", "detail")'>登录采集入库审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库审核附件上传", "form")'>登录采集入库审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库审核流程图查看", "preview")'>登录采集入库审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("登录采集入库审核流程通知", "transform")'>登录采集入库审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("登录采集入库审核结果逐级审批", "transform")'>登录采集入库审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("登录采集入库审核结果拒绝和驳回", "approval")'>登录采集入库审核结果拒绝和驳回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描采集信息表", "transform")'>远程扫描采集信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描采集任务", "form")'>新增远程扫描采集任务</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "登录采集入库审核用户": "赵六",
    "登录采集入库审核编号": "F-52941",
    "登录采集入库审核名称": "登录采集入库审核流程管理-1",
    "新增登录采集入库审核状态": "已取消",
    "新增登录采集入库审核时间": "2026-05-08 09:35:44",
    "审核属性": "已取消",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 09:35:44",
    "登录采集入库审核ID": "F-52941",
    "登录采集入库审核部门": "信息安全部",
    "登录采集入库审核负责人": "赵六",
    "登录采集入库审核类型": "已取消"
  },
  {
    ...
    "登录采集入库审核用户": "system",
    "登录采集入库审核编号": "F-60860",
    "登录采集入库审核名称": "登录采集入库审核流程管理-2",
    "新增登录采集入库审核状态": "已驳回",
    "新增登录采集入库审核时间": "2026-05-08 10:08:06",
    "审核属性": "已驳回",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 10:08:06",
    "登录采集入库审核ID": "F-60860",
    "登录采集入库审核部门": "系统运维部",
    "登录采集入库审核负责人": "system",
    "登录采集入库审核类型": "已驳回"
  },
  {
    ...
    "登录采集入库审核用户": "admin",
    "登录采集入库审核编号": "F-68779",
    "登录采集入库审核名称": "登录采集入库审核流程管理-3",
    "新增登录采集入库审核状态": "待审核",
    "新增登录采集入库审核时间": "2026-05-08 10:42:31",
    "审核属性": "待审核",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 10:42:31",
    "登录采集入库审核ID": "F-68779",
    "登录采集入库审核部门": "数据管理部",
    "登录采集入库审核负责人": "admin",
    "登录采集入库审核类型": "待审核"
  },
  {
    ...
    "登录采集入库审核用户": "张三",
    "登录采集入库审核编号": "F-76698",
    "登录采集入库审核名称": "登录采集入库审核流程管理-4",
    "新增登录采集入库审核状态": "已处理",
    "新增登录采集入库审核时间": "2026-05-08 11:16:09",
    "审核属性": "已处理",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 11:16:09",
    "登录采集入库审核ID": "F-76698",
    "登录采集入库审核部门": "安全运维部",
    "登录采集入库审核负责人": "张三",
    "登录采集入库审核类型": "已处理"
  },
  {
    ...
    "登录采集入库审核用户": "李四",
    "登录采集入库审核编号": "F-84617",
    "登录采集入库审核名称": "登录采集入库审核流程管理-5",
    "新增登录采集入库审核状态": "处理中",
    "新增登录采集入库审核时间": "2026-05-08 14:03:52",
    "审核属性": "处理中",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 14:03:52",
    "登录采集入库审核ID": "F-84617",
    "登录采集入库审核部门": "网络管理部",
    "登录采集入库审核负责人": "李四",
    "登录采集入库审核类型": "处理中"
  },
  {
    ...
    "登录采集入库审核用户": "王五",
    "登录采集入库审核编号": "F-92536",
    "登录采集入库审核名称": "登录采集入库审核流程管理-6",
    "新增登录采集入库审核状态": "待处理",
    "新增登录采集入库审核时间": "2026-05-08 15:21:37",
    "审核属性": "待处理",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 15:21:37",
    "登录采集入库审核ID": "F-92536",
    "登录采集入库审核部门": "资产管理部",
    "登录采集入库审核负责人": "王五",
    "登录采集入库审核类型": "待处理"
  },
  {
    ...
    "登录采集入库审核用户": "赵六",
    "登录采集入库审核编号": "F-100455",
    "登录采集入库审核名称": "登录采集入库审核流程管理-7",
    "新增登录采集入库审核状态": "处理失败",
    "新增登录采集入库审核时间": "2026-05-08 16:08:25",
    "审核属性": "处理失败",
    "登录采集入库审核时间_登录采集入库审核创建时间": "2026-05-08 16:08:25",
    "登录采集入库审核ID": "F-100455",
    "登录采集入库审核部门": "信息安全部",
    "登录采集入库审核负责人": "赵六",
    "登录采集入库审核类型": "处理失败"
...
const tableColumns = [
  ...
  {
    "prop": "登录采集入库审核时间_登录采集入库审核创建时间",
    "label": "登录采集入库审核时间。登录采集入库审核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
