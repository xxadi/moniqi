    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产拨测结果信息", "form")'>新增工信部资产拨测结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产拨测结果信息", "config")'>修改工信部资产拨测结果信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产拨测结果信息")'>删除工信部资产拨测结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产拨测结果列表", "detail")'>查询工信部资产拨测结果列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产拨测结果详情", "detail")'>查询工信部资产拨测结果详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入工信部资产拨测结果")'>批量导入工信部资产拨测结果</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("工信部资产拨测结果导出")'>工信部资产拨测结果导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产拨测结果名称": "已处理",
    "新增工信部资产拨测结果状态": "已处理",
    "新增工信部资产拨测结果时间": "2026-05-08 10:08:06",
    "工信部资产拨测结果属性": "已处理",
    "工信部资产拨测结果创建时间": "2026-05-08 10:08:06",
    "工信部资产拨测结果所属部门": "已处理",
    "工信部资产拨测结果负责人": "已处理",
    "工信部资产拨测结果类型": "已处理",
    "工信部资产拨测结果规则": "已处理",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "处理中",
    "新增工信部资产拨测结果状态": "处理中",
    "新增工信部资产拨测结果时间": "2026-05-08 10:42:31",
    "工信部资产拨测结果属性": "处理中",
    "工信部资产拨测结果创建时间": "2026-05-08 10:42:31",
    "工信部资产拨测结果所属部门": "处理中",
    "工信部资产拨测结果负责人": "处理中",
    "工信部资产拨测结果类型": "处理中",
    "工信部资产拨测结果规则": "处理中",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "待处理",
    "新增工信部资产拨测结果状态": "待处理",
    "新增工信部资产拨测结果时间": "2026-05-08 11:16:09",
    "工信部资产拨测结果属性": "待处理",
    "工信部资产拨测结果创建时间": "2026-05-08 11:16:09",
    "工信部资产拨测结果所属部门": "待处理",
    "工信部资产拨测结果负责人": "待处理",
    "工信部资产拨测结果类型": "待处理",
    "工信部资产拨测结果规则": "待处理",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "处理失败",
    "新增工信部资产拨测结果状态": "处理失败",
    "新增工信部资产拨测结果时间": "2026-05-08 14:03:52",
    "工信部资产拨测结果属性": "处理失败",
    "工信部资产拨测结果创建时间": "2026-05-08 14:03:52",
    "工信部资产拨测结果所属部门": "处理失败",
    "工信部资产拨测结果负责人": "处理失败",
    "工信部资产拨测结果类型": "处理失败",
    "工信部资产拨测结果规则": "处理失败",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "已暂停",
    "新增工信部资产拨测结果状态": "已暂停",
    "新增工信部资产拨测结果时间": "2026-05-08 15:21:37",
    "工信部资产拨测结果属性": "已暂停",
    "工信部资产拨测结果创建时间": "2026-05-08 15:21:37",
    "工信部资产拨测结果所属部门": "已暂停",
    "工信部资产拨测结果负责人": "已暂停",
    "工信部资产拨测结果类型": "已暂停",
    "工信部资产拨测结果规则": "已暂停",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "已完成",
    "新增工信部资产拨测结果状态": "已完成",
    "新增工信部资产拨测结果时间": "2026-05-08 16:08:25",
    "工信部资产拨测结果属性": "已完成",
    "工信部资产拨测结果创建时间": "2026-05-08 16:08:25",
    "工信部资产拨测结果所属部门": "已完成",
    "工信部资产拨测结果负责人": "已完成",
    "工信部资产拨测结果类型": "已完成",
    "工信部资产拨测结果规则": "已完成",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "排队中",
    "新增工信部资产拨测结果状态": "排队中",
    "新增工信部资产拨测结果时间": "2026-05-09 08:33:11",
    "工信部资产拨测结果属性": "排队中",
    "工信部资产拨测结果创建时间": "2026-05-09 08:33:11",
    "工信部资产拨测结果所属部门": "排队中",
    "工信部资产拨测结果负责人": "排队中",
    "工信部资产拨测结果类型": "排队中",
    "工信部资产拨测结果规则": "排队中",
  ...
  },
  {
    ...
    "工信部资产拨测结果名称": "部分完成",
    "新增工信部资产拨测结果状态": "部分完成",
    "新增工信部资产拨测结果时间": "2026-05-09 09:47:56",
    "工信部资产拨测结果属性": "部分完成",
    "工信部资产拨测结果创建时间": "2026-05-09 09:47:56",
    "工信部资产拨测结果所属部门": "部分完成",
    "工信部资产拨测结果负责人": "部分完成",
    "工信部资产拨测结果类型": "部分完成",
    "工信部资产拨测结果规则": "部分完成",
