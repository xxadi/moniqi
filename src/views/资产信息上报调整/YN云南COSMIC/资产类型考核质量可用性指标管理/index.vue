    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类型考核质量可用性信息表", "operation")'>资产类型考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产类型考核质量可用性稽核数据上传", "form")'>资产类型考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类型考核质量可用性稽核数据接口监控", "log")'>资产类型考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产标签考核质量可用性信息表", "operation")'>资产标签考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产标签考核质量可用性稽核数据上传", "form")'>资产标签考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产标签考核质量可用性稽核数据接口监控", "log")'>资产标签考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产型号考核质量可用性信息表", "operation")'>资产型号考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产型号考核质量可用性稽核数据上传", "form")'>资产型号考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号考核质量可用性稽核数据接口监控", "log")'>资产型号考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产类型考核质量可用性ID": "G-75588",
    "资产类型考核质量可用性编号": "G-75588",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-1",
    "资产类型考核质量可用性状态": "已暂停",
    "资产类型考核质量可用性时间": "2026-05-09 08:33:11",
    "资产类型考核质量可用性属性": "已暂停",
    "资产类型考核质量可用性创建时间": "2026-05-09 08:33:11",
    "资产类型考核质量可用性所属部门": "安全运维部",
    "资产类型考核质量可用性负责人": "张三",
    "资产类型考核质量可用性类型": "已暂停",
    "资产类型考核质量可用性规则": "已暂停",
    "数据上传资源编码": "已暂停"
  ...
  {
    "ID": 2,
    "资产类型考核质量可用性ID": "G-83507",
    "资产类型考核质量可用性编号": "G-83507",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-2",
    "资产类型考核质量可用性状态": "已完成",
    "资产类型考核质量可用性时间": "2026-05-09 09:47:56",
    "资产类型考核质量可用性属性": "已完成",
    "资产类型考核质量可用性创建时间": "2026-05-09 09:47:56",
    "资产类型考核质量可用性所属部门": "网络管理部",
    "资产类型考核质量可用性负责人": "李四",
    "资产类型考核质量可用性类型": "已完成",
    "资产类型考核质量可用性规则": "已完成",
    "数据上传资源编码": "已完成"
  ...
  {
    "ID": 3,
    "资产类型考核质量可用性ID": "G-91426",
    "资产类型考核质量可用性编号": "G-91426",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-3",
    "资产类型考核质量可用性状态": "排队中",
    "资产类型考核质量可用性时间": "2026-05-08 09:12:18",
    "资产类型考核质量可用性属性": "排队中",
    "资产类型考核质量可用性创建时间": "2026-05-08 09:12:18",
    "资产类型考核质量可用性所属部门": "资产管理部",
    "资产类型考核质量可用性负责人": "王五",
    "资产类型考核质量可用性类型": "排队中",
    "资产类型考核质量可用性规则": "排队中",
    "数据上传资源编码": "排队中"
  ...
  {
    "ID": 4,
    "资产类型考核质量可用性ID": "G-99345",
    "资产类型考核质量可用性编号": "G-99345",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-4",
    "资产类型考核质量可用性状态": "部分完成",
    "资产类型考核质量可用性时间": "2026-05-08 09:35:44",
    "资产类型考核质量可用性属性": "部分完成",
    "资产类型考核质量可用性创建时间": "2026-05-08 09:35:44",
    "资产类型考核质量可用性所属部门": "信息安全部",
    "资产类型考核质量可用性负责人": "赵六",
    "资产类型考核质量可用性类型": "部分完成",
    "资产类型考核质量可用性规则": "部分完成",
    "数据上传资源编码": "部分完成"
  ...
  {
    "ID": 5,
    "资产类型考核质量可用性ID": "G-107264",
    "资产类型考核质量可用性编号": "G-107264",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-5",
    "资产类型考核质量可用性状态": "已启用",
    "资产类型考核质量可用性时间": "2026-05-08 10:08:06",
    "资产类型考核质量可用性属性": "已启用",
    "资产类型考核质量可用性创建时间": "2026-05-08 10:08:06",
    "资产类型考核质量可用性所属部门": "系统运维部",
    "资产类型考核质量可用性负责人": "system",
    "资产类型考核质量可用性类型": "已启用",
    "资产类型考核质量可用性规则": "已启用",
    "数据上传资源编码": "已启用"
  },
  {
    "ID": 6,
    "资产类型考核质量可用性ID": "G-115183",
    "资产类型考核质量可用性编号": "G-115183",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-6",
    "资产类型考核质量可用性状态": "已停用",
    "资产类型考核质量可用性时间": "2026-05-08 10:42:31",
    "资产类型考核质量可用性属性": "已停用",
    "资产类型考核质量可用性创建时间": "2026-05-08 10:42:31",
    "资产类型考核质量可用性所属部门": "数据管理部",
    "资产类型考核质量可用性负责人": "admin",
    "资产类型考核质量可用性类型": "已停用",
    "资产类型考核质量可用性规则": "已停用",
    "数据上传资源编码": "已停用"
  },
  {
    "ID": 7,
    "资产类型考核质量可用性ID": "G-123102",
    "资产类型考核质量可用性编号": "G-123102",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-7",
    "资产类型考核质量可用性状态": "正常",
    "资产类型考核质量可用性时间": "2026-05-08 11:16:09",
    "资产类型考核质量可用性属性": "正常",
    "资产类型考核质量可用性创建时间": "2026-05-08 11:16:09",
    "资产类型考核质量可用性所属部门": "安全运维部",
    "资产类型考核质量可用性负责人": "张三",
    "资产类型考核质量可用性类型": "正常",
    "资产类型考核质量可用性规则": "正常",
  ...
  {
    "ID": 8,
    "资产类型考核质量可用性ID": "G-131021",
    "资产类型考核质量可用性编号": "G-131021",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-8",
    "资产类型考核质量可用性状态": "异常",
    "资产类型考核质量可用性时间": "2026-05-08 14:03:52",
    "资产类型考核质量可用性属性": "异常",
    "资产类型考核质量可用性创建时间": "2026-05-08 14:03:52",
    "资产类型考核质量可用性所属部门": "网络管理部",
    "资产类型考核质量可用性负责人": "李四",
    "资产类型考核质量可用性类型": "异常",
    "资产类型考核质量可用性规则": "异常",
  ...
  {
    "ID": 9,
    "资产类型考核质量可用性ID": "G-138940",
    "资产类型考核质量可用性编号": "G-138940",
    "资产类型考核质量可用性名称": "资产类型考核质量可用性指标管理-9",
    "资产类型考核质量可用性状态": "超时",
    "资产类型考核质量可用性时间": "2026-05-08 15:21:37",
    "资产类型考核质量可用性属性": "超时",
    "资产类型考核质量可用性创建时间": "2026-05-08 15:21:37",
    "资产类型考核质量可用性所属部门": "资产管理部",
    "资产类型考核质量可用性负责人": "王五",
    "资产类型考核质量可用性类型": "超时",
    "资产类型考核质量可用性规则": "超时",
...
const tableColumns = [
  ...
  {
    "prop": "资产类型考核质量可用性创建时间",
    "label": "资产类型考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产类型考核质量可用性所属部门",
    "label": "资产类型考核质量可用性所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
