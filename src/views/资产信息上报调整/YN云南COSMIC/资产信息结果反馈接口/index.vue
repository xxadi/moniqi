    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息结果反馈信息", "form")'>新增资产信息结果反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息结果反馈信息", "config")'>修改资产信息结果反馈信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息结果反馈信息")'>删除资产信息结果反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产信息结果反馈列表", "detail")'>查询资产信息结果反馈列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产信息结果反馈下发回传同步", "sync")'>资产信息结果反馈下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息结果反馈下发回传任务推送", "audit")'>资产信息结果反馈下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产信息结果反馈数据下发", "operation")'>资产信息结果反馈数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产信息结果反馈数据分析", "analysis")'>资产信息结果反馈数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产信息结果反馈数据上报", "operation")'>资产信息结果反馈数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产信息结果反馈名称": "处理失败",
    "新增资产信息结果反馈状态": "处理失败",
    "新增资产信息结果反馈时间": "2026-05-08 16:08:25",
    "反馈属性": "处理失败",
    "资产信息结果反馈创建时间": "2026-05-08 16:08:25",
    "资产信息结果反馈所属部门": "处理失败",
    "资产信息结果反馈负责人": "处理失败",
    "资产信息结果反馈类型": "处理失败",
    "资产信息结果反馈规则": "处理失败",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "已暂停",
    "新增资产信息结果反馈状态": "已暂停",
    "新增资产信息结果反馈时间": "2026-05-09 08:33:11",
    "反馈属性": "已暂停",
    "资产信息结果反馈创建时间": "2026-05-09 08:33:11",
    "资产信息结果反馈所属部门": "已暂停",
    "资产信息结果反馈负责人": "已暂停",
    "资产信息结果反馈类型": "已暂停",
    "资产信息结果反馈规则": "已暂停",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "已完成",
    "新增资产信息结果反馈状态": "已完成",
    "新增资产信息结果反馈时间": "2026-05-09 09:47:56",
    "反馈属性": "已完成",
    "资产信息结果反馈创建时间": "2026-05-09 09:47:56",
    "资产信息结果反馈所属部门": "已完成",
    "资产信息结果反馈负责人": "已完成",
    "资产信息结果反馈类型": "已完成",
    "资产信息结果反馈规则": "已完成",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "排队中",
    "新增资产信息结果反馈状态": "排队中",
    "新增资产信息结果反馈时间": "2026-05-08 09:12:18",
    "反馈属性": "排队中",
    "资产信息结果反馈创建时间": "2026-05-08 09:12:18",
    "资产信息结果反馈所属部门": "排队中",
    "资产信息结果反馈负责人": "排队中",
    "资产信息结果反馈类型": "排队中",
    "资产信息结果反馈规则": "排队中",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "部分完成",
    "新增资产信息结果反馈状态": "部分完成",
    "新增资产信息结果反馈时间": "2026-05-08 09:35:44",
    "反馈属性": "部分完成",
    "资产信息结果反馈创建时间": "2026-05-08 09:35:44",
    "资产信息结果反馈所属部门": "部分完成",
    "资产信息结果反馈负责人": "部分完成",
    "资产信息结果反馈类型": "部分完成",
    "资产信息结果反馈规则": "部分完成",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "已启用",
    "新增资产信息结果反馈状态": "已启用",
    "新增资产信息结果反馈时间": "2026-05-08 10:08:06",
    "反馈属性": "已启用",
    "资产信息结果反馈创建时间": "2026-05-08 10:08:06",
    "资产信息结果反馈所属部门": "已启用",
    "资产信息结果反馈负责人": "已启用",
    "资产信息结果反馈类型": "已启用",
    "资产信息结果反馈规则": "已启用",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "已停用",
    "新增资产信息结果反馈状态": "已停用",
    "新增资产信息结果反馈时间": "2026-05-08 10:42:31",
    "反馈属性": "已停用",
    "资产信息结果反馈创建时间": "2026-05-08 10:42:31",
    "资产信息结果反馈所属部门": "已停用",
    "资产信息结果反馈负责人": "已停用",
    "资产信息结果反馈类型": "已停用",
    "资产信息结果反馈规则": "已停用",
  ...
  },
  {
    ...
    "资产信息结果反馈名称": "正常",
    "新增资产信息结果反馈状态": "正常",
    "新增资产信息结果反馈时间": "2026-05-08 11:16:09",
    "反馈属性": "正常",
    "资产信息结果反馈创建时间": "2026-05-08 11:16:09",
    "资产信息结果反馈所属部门": "正常",
    "资产信息结果反馈负责人": "正常",
    "资产信息结果反馈类型": "正常",
    "资产信息结果反馈规则": "正常",
