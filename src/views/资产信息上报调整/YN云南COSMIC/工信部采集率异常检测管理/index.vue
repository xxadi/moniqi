    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义工信部采集率异常检测信息", "transform")'>定义工信部采集率异常检测信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率异常检测信息", "config")'>修改工信部采集率异常检测信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率异常检测信息")'>删除工信部采集率异常检测信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率异常检测数据获取", "transform")'>工信部采集率异常检测数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率异常检测数据上传", "form")'>工信部采集率异常检测数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率异常检测数据接口监控", "log")'>工信部采集率异常检测数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率异常检测汇总报告详情", "detail")'>查询工信部采集率异常检测汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率异常检测明细报告详情", "detail")'>查询工信部采集率异常检测明细报告详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部采集率异常检测ID": "E-67682",
    "工信部采集率异常检测编号": "E-67682",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-1",
    "定义工信部采集率异常检测状态": "待处理",
    "定义工信部采集率异常检测时间": "2026-05-08 10:08:06",
    "工信部采集率异常检测属性": "待处理",
    "工信部采集率异常检测创建时间": "2026-05-08 10:08:06",
    "工信部采集率异常检测所属部门": "资产管理部",
    "工信部采集率异常检测负责人": "王五",
    "工信部采集率异常检测类型": "待处理",
    "工信部采集率异常检测规则": "待处理",
    "名称": "工信部采集率异常检测管理-1"
  ...
  {
    "ID": 2,
    "工信部采集率异常检测ID": "E-75601",
    "工信部采集率异常检测编号": "E-75601",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-2",
    "定义工信部采集率异常检测状态": "处理失败",
    "定义工信部采集率异常检测时间": "2026-05-08 10:42:31",
    "工信部采集率异常检测属性": "处理失败",
    "工信部采集率异常检测创建时间": "2026-05-08 10:42:31",
    "工信部采集率异常检测所属部门": "信息安全部",
    "工信部采集率异常检测负责人": "赵六",
    "工信部采集率异常检测类型": "处理失败",
    "工信部采集率异常检测规则": "处理失败",
    "名称": "工信部采集率异常检测管理-2"
  ...
  {
    "ID": 3,
    "工信部采集率异常检测ID": "E-83520",
    "工信部采集率异常检测编号": "E-83520",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-3",
    "定义工信部采集率异常检测状态": "已暂停",
    "定义工信部采集率异常检测时间": "2026-05-08 11:16:09",
    "工信部采集率异常检测属性": "已暂停",
    "工信部采集率异常检测创建时间": "2026-05-08 11:16:09",
    "工信部采集率异常检测所属部门": "系统运维部",
    "工信部采集率异常检测负责人": "system",
    "工信部采集率异常检测类型": "已暂停",
    "工信部采集率异常检测规则": "已暂停",
    "名称": "工信部采集率异常检测管理-3"
  },
  {
    "ID": 4,
    "工信部采集率异常检测ID": "E-91439",
    "工信部采集率异常检测编号": "E-91439",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-4",
    "定义工信部采集率异常检测状态": "已完成",
    "定义工信部采集率异常检测时间": "2026-05-08 14:03:52",
    "工信部采集率异常检测属性": "已完成",
    "工信部采集率异常检测创建时间": "2026-05-08 14:03:52",
    "工信部采集率异常检测所属部门": "数据管理部",
    "工信部采集率异常检测负责人": "admin",
    "工信部采集率异常检测类型": "已完成",
    "工信部采集率异常检测规则": "已完成",
    "名称": "工信部采集率异常检测管理-4"
  ...
  {
    "ID": 5,
    "工信部采集率异常检测ID": "E-99358",
    "工信部采集率异常检测编号": "E-99358",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-5",
    "定义工信部采集率异常检测状态": "排队中",
    "定义工信部采集率异常检测时间": "2026-05-08 15:21:37",
    "工信部采集率异常检测属性": "排队中",
    "工信部采集率异常检测创建时间": "2026-05-08 15:21:37",
    "工信部采集率异常检测所属部门": "安全运维部",
    "工信部采集率异常检测负责人": "张三",
    "工信部采集率异常检测类型": "排队中",
    "工信部采集率异常检测规则": "排队中",
    "名称": "工信部采集率异常检测管理-5"
  ...
  {
    "ID": 6,
    "工信部采集率异常检测ID": "E-107277",
    "工信部采集率异常检测编号": "E-107277",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-6",
    "定义工信部采集率异常检测状态": "部分完成",
    "定义工信部采集率异常检测时间": "2026-05-08 16:08:25",
    "工信部采集率异常检测属性": "部分完成",
    "工信部采集率异常检测创建时间": "2026-05-08 16:08:25",
    "工信部采集率异常检测所属部门": "网络管理部",
    "工信部采集率异常检测负责人": "李四",
    "工信部采集率异常检测类型": "部分完成",
    "工信部采集率异常检测规则": "部分完成",
    "名称": "工信部采集率异常检测管理-6"
  ...
  {
    "ID": 7,
    "工信部采集率异常检测ID": "E-115196",
    "工信部采集率异常检测编号": "E-115196",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-7",
    "定义工信部采集率异常检测状态": "已启用",
    "定义工信部采集率异常检测时间": "2026-05-09 08:33:11",
    "工信部采集率异常检测属性": "已启用",
    "工信部采集率异常检测创建时间": "2026-05-09 08:33:11",
    "工信部采集率异常检测所属部门": "资产管理部",
    "工信部采集率异常检测负责人": "王五",
    "工信部采集率异常检测类型": "已启用",
    "工信部采集率异常检测规则": "已启用",
  ...
  {
    "ID": 8,
    "工信部采集率异常检测ID": "E-123115",
    "工信部采集率异常检测编号": "E-123115",
    "工信部采集率异常检测名称": "工信部采集率异常检测管理-8",
    "定义工信部采集率异常检测状态": "已停用",
    "定义工信部采集率异常检测时间": "2026-05-09 09:47:56",
    "工信部采集率异常检测属性": "已停用",
    "工信部采集率异常检测创建时间": "2026-05-09 09:47:56",
    "工信部采集率异常检测所属部门": "信息安全部",
    "工信部采集率异常检测负责人": "赵六",
    "工信部采集率异常检测类型": "已停用",
    "工信部采集率异常检测规则": "已停用",
