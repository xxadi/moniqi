    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部网络单元信息", "form")'>新增工信部网络单元信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部网络单元信息", "config")'>修改工信部网络单元信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部网络单元信息")'>删除工信部网络单元信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部网络单元监控", "log")'>工信部网络单元监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部网络单元监控告警", "alert")'>工信部网络单元监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部网络单元稽核", "audit")'>工信部网络单元稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部网络单元统计", "statistics")'>工信部网络单元统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部网络单元数据采集", "transform")'>工信部网络单元数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部网络单元数据预处理", "transform")'>工信部网络单元数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部网络单元ID": "M-95978",
    "工信部网络单元编号": "M-95978",
    "工信部网络单元名称": "工信部网络单元管理-1",
    "新增工信部网络单元状态": "正常",
    "新增工信部网络单元时间": "2026-05-09 08:33:11",
    "工信部网络单元属性": "正常",
    "工信部网络单元创建时间": "2026-05-09 08:33:11",
    "工信部网络单元所属部门": "资产管理部",
    "工信部网络单元负责人": "王五",
    "工信部网络单元类型": "正常",
    "工信部网络单元规则": "正常",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-103897",
    "工信部网络单元编号": "M-103897",
    "工信部网络单元名称": "工信部网络单元管理-2",
    "新增工信部网络单元状态": "异常",
    "新增工信部网络单元时间": "2026-05-09 09:47:56",
    "工信部网络单元属性": "异常",
    "工信部网络单元创建时间": "2026-05-09 09:47:56",
    "工信部网络单元所属部门": "信息安全部",
    "工信部网络单元负责人": "赵六",
    "工信部网络单元类型": "异常",
    "工信部网络单元规则": "异常",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-111816",
    "工信部网络单元编号": "M-111816",
    "工信部网络单元名称": "工信部网络单元管理-3",
    "新增工信部网络单元状态": "超时",
    "新增工信部网络单元时间": "2026-05-08 09:12:18",
    "工信部网络单元属性": "超时",
    "工信部网络单元创建时间": "2026-05-08 09:12:18",
    "工信部网络单元所属部门": "系统运维部",
    "工信部网络单元负责人": "system",
    "工信部网络单元类型": "超时",
    "工信部网络单元规则": "超时",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-119735",
    "工信部网络单元编号": "M-119735",
    "工信部网络单元名称": "工信部网络单元管理-4",
    "新增工信部网络单元状态": "已取消",
    "新增工信部网络单元时间": "2026-05-08 09:35:44",
    "工信部网络单元属性": "已取消",
    "工信部网络单元创建时间": "2026-05-08 09:35:44",
    "工信部网络单元所属部门": "数据管理部",
    "工信部网络单元负责人": "admin",
    "工信部网络单元类型": "已取消",
    "工信部网络单元规则": "已取消",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-127654",
    "工信部网络单元编号": "M-127654",
    "工信部网络单元名称": "工信部网络单元管理-5",
    "新增工信部网络单元状态": "已驳回",
    "新增工信部网络单元时间": "2026-05-08 10:08:06",
    "工信部网络单元属性": "已驳回",
    "工信部网络单元创建时间": "2026-05-08 10:08:06",
    "工信部网络单元所属部门": "安全运维部",
    "工信部网络单元负责人": "张三",
    "工信部网络单元类型": "已驳回",
    "工信部网络单元规则": "已驳回",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-135573",
    "工信部网络单元编号": "M-135573",
    "工信部网络单元名称": "工信部网络单元管理-6",
    "新增工信部网络单元状态": "待审核",
    "新增工信部网络单元时间": "2026-05-08 10:42:31",
    "工信部网络单元属性": "待审核",
    "工信部网络单元创建时间": "2026-05-08 10:42:31",
    "工信部网络单元所属部门": "网络管理部",
    "工信部网络单元负责人": "李四",
    "工信部网络单元类型": "待审核",
    "工信部网络单元规则": "待审核",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-143492",
    "工信部网络单元编号": "M-143492",
    "工信部网络单元名称": "工信部网络单元管理-7",
    "新增工信部网络单元状态": "已处理",
    "新增工信部网络单元时间": "2026-05-08 11:16:09",
    "工信部网络单元属性": "已处理",
    "工信部网络单元创建时间": "2026-05-08 11:16:09",
    "工信部网络单元所属部门": "资产管理部",
    "工信部网络单元负责人": "王五",
    "工信部网络单元类型": "已处理",
    "工信部网络单元规则": "已处理",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-151411",
    "工信部网络单元编号": "M-151411",
    "工信部网络单元名称": "工信部网络单元管理-8",
    "新增工信部网络单元状态": "处理中",
    "新增工信部网络单元时间": "2026-05-08 14:03:52",
    "工信部网络单元属性": "处理中",
    "工信部网络单元创建时间": "2026-05-08 14:03:52",
    "工信部网络单元所属部门": "信息安全部",
    "工信部网络单元负责人": "赵六",
    "工信部网络单元类型": "处理中",
    "工信部网络单元规则": "处理中",
  ...
  },
  {
    ...
    "工信部网络单元ID": "M-159330",
    "工信部网络单元编号": "M-159330",
    "工信部网络单元名称": "工信部网络单元管理-9",
    "新增工信部网络单元状态": "待处理",
    "新增工信部网络单元时间": "2026-05-08 15:21:37",
    "工信部网络单元属性": "待处理",
    "工信部网络单元创建时间": "2026-05-08 15:21:37",
    "工信部网络单元所属部门": "系统运维部",
    "工信部网络单元负责人": "system",
    "工信部网络单元类型": "待处理",
    "工信部网络单元规则": "待处理",
