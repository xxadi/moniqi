    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据感知", "transform")'>自动化采集率数据感知</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据识别", "transform")'>自动化采集率数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据审计", "transform")'>自动化采集率数据审计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率可视化展示", "detail")'>自动化采集率可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率查询接口", "detail")'>自动化采集率查询接口</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "自动化采集率数据感知资源ip": "部分完成",
    "自动化采集率数据感知资源类型": "部分完成",
    "自动化采集率数据感知编号": "N-12727",
    "自动化采集率数据感知分类": "部分完成",
    "自动化采集率数据感知时间": "2026-05-08 16:08:25",
    "自动化采集率数据感知操作人": "李四",
    "结果编码": "部分完成",
    "自动化采集率数据感知结果ip": "部分完成",
    "自动化采集率数据感知结果类型": "部分完成",
    "自动化采集率数据感知结果编号": "N-12727",
    "规则编码": "部分完成"
  },
  {
    "ID": 2,
    ...
    "自动化采集率数据感知资源ip": "已启用",
    "自动化采集率数据感知资源类型": "已启用",
    "自动化采集率数据感知编号": "N-20646",
    "自动化采集率数据感知分类": "已启用",
    "自动化采集率数据感知时间": "2026-05-09 08:33:11",
    "自动化采集率数据感知操作人": "王五",
    "结果编码": "已启用",
    "自动化采集率数据感知结果ip": "已启用",
    "自动化采集率数据感知结果类型": "已启用",
    "自动化采集率数据感知结果编号": "N-20646",
    "规则编码": "已启用"
  },
  {
    "ID": 3,
    ...
    "自动化采集率数据感知资源ip": "已停用",
    "自动化采集率数据感知资源类型": "已停用",
    "自动化采集率数据感知编号": "N-28565",
    "自动化采集率数据感知分类": "已停用",
    "自动化采集率数据感知时间": "2026-05-09 09:47:56",
    "自动化采集率数据感知操作人": "赵六",
    "结果编码": "已停用",
    "自动化采集率数据感知结果ip": "已停用",
    "自动化采集率数据感知结果类型": "已停用",
    "自动化采集率数据感知结果编号": "N-28565",
    "规则编码": "已停用"
  },
  {
    "ID": 4,
    ...
    "自动化采集率数据感知资源ip": "正常",
    "自动化采集率数据感知资源类型": "正常",
    "自动化采集率数据感知编号": "N-36484",
    "自动化采集率数据感知分类": "正常",
    "自动化采集率数据感知时间": "2026-05-08 09:12:18",
    "自动化采集率数据感知操作人": "system",
    "结果编码": "正常",
    "自动化采集率数据感知结果ip": "正常",
    "自动化采集率数据感知结果类型": "正常",
    "自动化采集率数据感知结果编号": "N-36484",
    "规则编码": "正常"
  },
  {
    "ID": 5,
    ...
    "自动化采集率数据感知资源ip": "异常",
    "自动化采集率数据感知资源类型": "异常",
    "自动化采集率数据感知编号": "N-44403",
    "自动化采集率数据感知分类": "异常",
    "自动化采集率数据感知时间": "2026-05-08 09:35:44",
    "自动化采集率数据感知操作人": "admin",
    "结果编码": "异常",
    "自动化采集率数据感知结果ip": "异常",
    "自动化采集率数据感知结果类型": "异常",
    "自动化采集率数据感知结果编号": "N-44403",
    "规则编码": "异常"
  },
  {
    "ID": 6,
    ...
    "自动化采集率数据感知资源ip": "超时",
    "自动化采集率数据感知资源类型": "超时",
    "自动化采集率数据感知编号": "N-52322",
    "自动化采集率数据感知分类": "超时",
    "自动化采集率数据感知时间": "2026-05-08 10:08:06",
    "自动化采集率数据感知操作人": "张三",
    "结果编码": "超时",
    "自动化采集率数据感知结果ip": "超时",
    "自动化采集率数据感知结果类型": "超时",
    "自动化采集率数据感知结果编号": "N-52322",
    "规则编码": "超时"
  },
  {
    "ID": 7,
    ...
    "自动化采集率数据感知资源ip": "已取消",
    "自动化采集率数据感知资源类型": "已取消",
    "自动化采集率数据感知编号": "N-60241",
    "自动化采集率数据感知分类": "已取消",
    "自动化采集率数据感知时间": "2026-05-08 10:42:31",
    "自动化采集率数据感知操作人": "李四",
    "结果编码": "已取消",
    "自动化采集率数据感知结果ip": "已取消",
    "自动化采集率数据感知结果类型": "已取消",
    "自动化采集率数据感知结果编号": "N-60241",
    "规则编码": "已取消"
  },
  {
    "ID": 8,
    ...
    "自动化采集率数据感知资源ip": "已驳回",
    "自动化采集率数据感知资源类型": "已驳回",
    "自动化采集率数据感知编号": "N-68160",
    "自动化采集率数据感知分类": "已驳回",
    "自动化采集率数据感知时间": "2026-05-08 11:16:09",
    "自动化采集率数据感知操作人": "王五",
    "结果编码": "已驳回",
    "自动化采集率数据感知结果ip": "已驳回",
    "自动化采集率数据感知结果类型": "已驳回",
    "自动化采集率数据感知结果编号": "N-68160",
    "规则编码": "已驳回"
  }
];
const tableColumns = [
