    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产补录查询接口信息")'>删除资产补录查询接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产补录查询接口监控", "log")'>资产补录查询接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产补录查询接口监控告警", "alert")'>资产补录查询接口监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产补录查询接口稽核", "detail")'>资产补录查询接口稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产补录查询接口统计", "statistics")'>资产补录查询接口统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产补录查询接口数据采集", "detail")'>资产补录查询接口数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产补录查询接口数据预处理", "detail")'>资产补录查询接口数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "删除流水号": "D-32243",
    "资产补录查询接口编号": "D-32243",
    "资产补录查询接口名称": "资产补录查询接口管理-1",
    "类型": "处理失败",
    "规则": "处理失败",
    "删除资产补录查询接口状态": "处理失败",
    "删除资产补录查询接口时间": "2026-05-08 10:42:31",
    "流水号": "D-32243",
    "删除时间": "2026-05-08 10:42:31",
    "编号": "D-32243",
    "名称": "资产补录查询接口管理-1"
  },
  {
    ...
    "删除流水号": "D-40162",
    "资产补录查询接口编号": "D-40162",
    "资产补录查询接口名称": "资产补录查询接口管理-2",
    "类型": "已暂停",
    "规则": "已暂停",
    "删除资产补录查询接口状态": "已暂停",
    "删除资产补录查询接口时间": "2026-05-08 11:16:09",
    "流水号": "D-40162",
    "删除时间": "2026-05-08 11:16:09",
    "编号": "D-40162",
    "名称": "资产补录查询接口管理-2"
  },
  {
    ...
    "删除流水号": "D-48081",
    "资产补录查询接口编号": "D-48081",
    "资产补录查询接口名称": "资产补录查询接口管理-3",
    "类型": "已完成",
    "规则": "已完成",
    "删除资产补录查询接口状态": "已完成",
    "删除资产补录查询接口时间": "2026-05-08 14:03:52",
    "流水号": "D-48081",
    "删除时间": "2026-05-08 14:03:52",
    "编号": "D-48081",
    "名称": "资产补录查询接口管理-3"
  },
  {
    ...
    "删除流水号": "D-56000",
    "资产补录查询接口编号": "D-56000",
    "资产补录查询接口名称": "资产补录查询接口管理-4",
    "类型": "排队中",
    "规则": "排队中",
    "删除资产补录查询接口状态": "排队中",
    "删除资产补录查询接口时间": "2026-05-08 15:21:37",
    "流水号": "D-56000",
    "删除时间": "2026-05-08 15:21:37",
    "编号": "D-56000",
    "名称": "资产补录查询接口管理-4"
  },
  {
    ...
    "删除流水号": "D-63919",
    "资产补录查询接口编号": "D-63919",
    "资产补录查询接口名称": "资产补录查询接口管理-5",
    "类型": "部分完成",
    "规则": "部分完成",
    "删除资产补录查询接口状态": "部分完成",
    "删除资产补录查询接口时间": "2026-05-08 16:08:25",
    "流水号": "D-63919",
    "删除时间": "2026-05-08 16:08:25",
    "编号": "D-63919",
    "名称": "资产补录查询接口管理-5"
  },
  {
    ...
    "删除流水号": "D-71838",
    "资产补录查询接口编号": "D-71838",
    "资产补录查询接口名称": "资产补录查询接口管理-6",
    "类型": "已启用",
    "规则": "已启用",
    "删除资产补录查询接口状态": "已启用",
    "删除资产补录查询接口时间": "2026-05-09 08:33:11",
    "流水号": "D-71838",
    "删除时间": "2026-05-09 08:33:11",
    "编号": "D-71838",
    "名称": "资产补录查询接口管理-6"
  },
  {
    ...
    "删除流水号": "D-79757",
    "资产补录查询接口编号": "D-79757",
    "资产补录查询接口名称": "资产补录查询接口管理-7",
    "类型": "已停用",
    "规则": "已停用",
    "删除资产补录查询接口状态": "已停用",
    "删除资产补录查询接口时间": "2026-05-09 09:47:56",
    "流水号": "D-79757",
    "删除时间": "2026-05-09 09:47:56",
    "编号": "D-79757",
    "名称": "资产补录查询接口管理-7"
  },
  {
    ...
    "删除流水号": "D-87676",
    "资产补录查询接口编号": "D-87676",
    "资产补录查询接口名称": "资产补录查询接口管理-8",
    "类型": "正常",
    "规则": "正常",
    "删除资产补录查询接口状态": "正常",
    "删除资产补录查询接口时间": "2026-05-08 09:12:18",
    "流水号": "D-87676",
    "删除时间": "2026-05-08 09:12:18",
    "编号": "D-87676",
    "名称": "资产补录查询接口管理-8"
  },
  {
    ...
    "删除流水号": "D-95595",
    "资产补录查询接口编号": "D-95595",
    "资产补录查询接口名称": "资产补录查询接口管理-9",
    "类型": "异常",
    "规则": "异常",
    "删除资产补录查询接口状态": "异常",
    "删除资产补录查询接口时间": "2026-05-08 09:35:44",
    "流水号": "D-95595",
    "删除时间": "2026-05-08 09:35:44",
    "编号": "D-95595",
    "名称": "资产补录查询接口管理-9"
  }
];
