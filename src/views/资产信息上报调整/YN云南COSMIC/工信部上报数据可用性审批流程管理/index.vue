    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部上报数据可用性审批流程", "workflow")'>发起工信部上报数据可用性审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据可用性审批指派信息", "form")'>新增工信部上报数据可用性审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据可用性审批流程节点", "form")'>新增工信部上报数据可用性审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部上报数据可用性审批流程节点信息", "config")'>修改工信部上报数据可用性审批流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批流程节点删除", "operation")'>工信部上报数据可用性审批流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批流程节点查询", "detail")'>工信部上报数据可用性审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批附件上传", "form")'>工信部上报数据可用性审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批流程图查看", "preview")'>工信部上报数据可用性审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批流程通知", "audit")'>工信部上报数据可用性审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批结果逐级审批", "audit")'>工信部上报数据可用性审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据可用性审批结果拒绝和驳回", "approval")'>工信部上报数据可用性审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部上报数据可用性审批ID": "Q-29968",
    "工信部上报数据可用性审批流程环节ID": "Q-29968",
    "工信部上报数据可用性审批编号": "Q-29968",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-1",
    "发起工信部上报数据可用性审批状态": "已处理",
    "发起工信部上报数据可用性审批时间": "2026-05-09 08:33:11",
    "工信部上报数据可用性审批属性": "已处理",
    "工信部上报数据可用性审批发起时间": "2026-05-09 08:33:11",
    "工信部上报数据可用性审批流程id": "已处理",
    "工信部上报数据可用性审批流程环节": "已处理",
    "工信部上报数据可用性审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 2,
    "工信部上报数据可用性审批ID": "Q-37887",
    "工信部上报数据可用性审批流程环节ID": "Q-37887",
    "工信部上报数据可用性审批编号": "Q-37887",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-2",
    "发起工信部上报数据可用性审批状态": "处理中",
    "发起工信部上报数据可用性审批时间": "2026-05-09 09:47:56",
    "工信部上报数据可用性审批属性": "处理中",
    "工信部上报数据可用性审批发起时间": "2026-05-09 09:47:56",
    "工信部上报数据可用性审批流程id": "处理中",
    "工信部上报数据可用性审批流程环节": "处理中",
    "工信部上报数据可用性审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 3,
    "工信部上报数据可用性审批ID": "Q-45806",
    "工信部上报数据可用性审批流程环节ID": "Q-45806",
    "工信部上报数据可用性审批编号": "Q-45806",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-3",
    "发起工信部上报数据可用性审批状态": "待处理",
    "发起工信部上报数据可用性审批时间": "2026-05-08 09:12:18",
    "工信部上报数据可用性审批属性": "待处理",
    "工信部上报数据可用性审批发起时间": "2026-05-08 09:12:18",
    "工信部上报数据可用性审批流程id": "待处理",
    "工信部上报数据可用性审批流程环节": "待处理",
    "工信部上报数据可用性审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 4,
    "工信部上报数据可用性审批ID": "Q-53725",
    "工信部上报数据可用性审批流程环节ID": "Q-53725",
    "工信部上报数据可用性审批编号": "Q-53725",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-4",
    "发起工信部上报数据可用性审批状态": "处理失败",
    "发起工信部上报数据可用性审批时间": "2026-05-08 09:35:44",
    "工信部上报数据可用性审批属性": "处理失败",
    "工信部上报数据可用性审批发起时间": "2026-05-08 09:35:44",
    "工信部上报数据可用性审批流程id": "处理失败",
    "工信部上报数据可用性审批流程环节": "处理失败",
    "工信部上报数据可用性审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 5,
    "工信部上报数据可用性审批ID": "Q-61644",
    "工信部上报数据可用性审批流程环节ID": "Q-61644",
    "工信部上报数据可用性审批编号": "Q-61644",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-5",
    "发起工信部上报数据可用性审批状态": "已暂停",
    "发起工信部上报数据可用性审批时间": "2026-05-08 10:08:06",
    "工信部上报数据可用性审批属性": "已暂停",
    "工信部上报数据可用性审批发起时间": "2026-05-08 10:08:06",
    "工信部上报数据可用性审批流程id": "已暂停",
    "工信部上报数据可用性审批流程环节": "已暂停",
    "工信部上报数据可用性审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 6,
    "工信部上报数据可用性审批ID": "Q-69563",
    "工信部上报数据可用性审批流程环节ID": "Q-69563",
    "工信部上报数据可用性审批编号": "Q-69563",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-6",
    "发起工信部上报数据可用性审批状态": "已完成",
    "发起工信部上报数据可用性审批时间": "2026-05-08 10:42:31",
    "工信部上报数据可用性审批属性": "已完成",
    "工信部上报数据可用性审批发起时间": "2026-05-08 10:42:31",
    "工信部上报数据可用性审批流程id": "已完成",
    "工信部上报数据可用性审批流程环节": "已完成",
    "工信部上报数据可用性审批创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 7,
    "工信部上报数据可用性审批ID": "Q-77482",
    "工信部上报数据可用性审批流程环节ID": "Q-77482",
    "工信部上报数据可用性审批编号": "Q-77482",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-7",
    "发起工信部上报数据可用性审批状态": "排队中",
    "发起工信部上报数据可用性审批时间": "2026-05-08 11:16:09",
    "工信部上报数据可用性审批属性": "排队中",
    "工信部上报数据可用性审批发起时间": "2026-05-08 11:16:09",
    "工信部上报数据可用性审批流程id": "排队中",
    "工信部上报数据可用性审批流程环节": "排队中",
    "工信部上报数据可用性审批创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 8,
    "工信部上报数据可用性审批ID": "Q-85401",
    "工信部上报数据可用性审批流程环节ID": "Q-85401",
    "工信部上报数据可用性审批编号": "Q-85401",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-8",
    "发起工信部上报数据可用性审批状态": "部分完成",
    "发起工信部上报数据可用性审批时间": "2026-05-08 14:03:52",
    "工信部上报数据可用性审批属性": "部分完成",
    "工信部上报数据可用性审批发起时间": "2026-05-08 14:03:52",
    "工信部上报数据可用性审批流程id": "部分完成",
    "工信部上报数据可用性审批流程环节": "部分完成",
    "工信部上报数据可用性审批创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 9,
    "工信部上报数据可用性审批ID": "Q-93320",
    "工信部上报数据可用性审批流程环节ID": "Q-93320",
    "工信部上报数据可用性审批编号": "Q-93320",
    "工信部上报数据可用性审批名称": "工信部上报数据可用性审批流程管理-9",
    "发起工信部上报数据可用性审批状态": "已启用",
    "发起工信部上报数据可用性审批时间": "2026-05-08 15:21:37",
    "工信部上报数据可用性审批属性": "已启用",
    "工信部上报数据可用性审批发起时间": "2026-05-08 15:21:37",
    "工信部上报数据可用性审批流程id": "已启用",
    "工信部上报数据可用性审批流程环节": "已启用",
    "工信部上报数据可用性审批创建时间": "2026-05-08 15:21:37"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部上报数据可用性审批ID",
    "label": "工信部上报数据可用性审批ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据可用性审批流程环节ID",
    "label": "工信部上报数据可用性审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部上报数据可用性审批名称",
    "label": "工信部上报数据可用性审批名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "发起工信部上报数据可用性审批状态",
    "label": "发起工信部上报数据可用性审批状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "发起工信部上报数据可用性审批时间",
    "label": "发起工信部上报数据可用性审批时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部上报数据可用性审批属性",
    "label": "工信部上报数据可用性审批属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据可用性审批发起时间",
    "label": "工信部上报数据可用性审批发起时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部上报数据可用性审批流程id",
    "label": "工信部上报数据可用性审批流程id",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据可用性审批流程环节",
    "label": "工信部上报数据可用性审批流程环节",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据可用性审批创建时间",
    "label": "工信部上报数据可用性审批创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
...
const importTemplateRow = {
  ...
  "工信部上报数据可用性审批流程环节": "",
  "工信部上报数据可用性审批创建时间": "",
  "导入来源": "工信部上报数据可用性审批流程管理导入模板.xlsx"
};
