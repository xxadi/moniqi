    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务信息表", "operation")'>拨测任务信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测任务", "form")'>新增拨测任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测任务模型", "form")'>新增拨测任务模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改拨测任务模型", "config")'>修改拨测任务模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除拨测任务模型")'>删除拨测任务模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务查询", "detail")'>拨测任务查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务可视化展示", "detail")'>拨测任务可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "拨测任务名称": "拨测任务管理-1",
    "拨测任务状态": "已驳回",
    "拨测任务时间": "2026-05-08 10:08:06",
    "拨测任务属性": "已驳回",
    "拨测任务创建时间": "2026-05-08 10:08:06",
    "拨测任务所属部门": "资产管理部",
    "拨测任务负责人": "王五",
    "拨测任务类型": "已驳回",
    "拨测任务模型": "已驳回",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-2",
    "拨测任务状态": "待审核",
    "拨测任务时间": "2026-05-08 10:42:31",
    "拨测任务属性": "待审核",
    "拨测任务创建时间": "2026-05-08 10:42:31",
    "拨测任务所属部门": "信息安全部",
    "拨测任务负责人": "赵六",
    "拨测任务类型": "待审核",
    "拨测任务模型": "待审核",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-3",
    "拨测任务状态": "已处理",
    "拨测任务时间": "2026-05-08 11:16:09",
    "拨测任务属性": "已处理",
    "拨测任务创建时间": "2026-05-08 11:16:09",
    "拨测任务所属部门": "系统运维部",
    "拨测任务负责人": "system",
    "拨测任务类型": "已处理",
    "拨测任务模型": "已处理",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-4",
    "拨测任务状态": "处理中",
    "拨测任务时间": "2026-05-08 14:03:52",
    "拨测任务属性": "处理中",
    "拨测任务创建时间": "2026-05-08 14:03:52",
    "拨测任务所属部门": "数据管理部",
    "拨测任务负责人": "admin",
    "拨测任务类型": "处理中",
    "拨测任务模型": "处理中",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-5",
    "拨测任务状态": "待处理",
    "拨测任务时间": "2026-05-08 15:21:37",
    "拨测任务属性": "待处理",
    "拨测任务创建时间": "2026-05-08 15:21:37",
    "拨测任务所属部门": "安全运维部",
    "拨测任务负责人": "张三",
    "拨测任务类型": "待处理",
    "拨测任务模型": "待处理",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-6",
    "拨测任务状态": "处理失败",
    "拨测任务时间": "2026-05-08 16:08:25",
    "拨测任务属性": "处理失败",
    "拨测任务创建时间": "2026-05-08 16:08:25",
    "拨测任务所属部门": "网络管理部",
    "拨测任务负责人": "李四",
    "拨测任务类型": "处理失败",
    "拨测任务模型": "处理失败",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-7",
    "拨测任务状态": "已暂停",
    "拨测任务时间": "2026-05-09 08:33:11",
    "拨测任务属性": "已暂停",
    "拨测任务创建时间": "2026-05-09 08:33:11",
    "拨测任务所属部门": "资产管理部",
    "拨测任务负责人": "王五",
    "拨测任务类型": "已暂停",
    "拨测任务模型": "已暂停",
  ...
  },
  {
    ...
    "拨测任务名称": "拨测任务管理-8",
    "拨测任务状态": "已完成",
    "拨测任务时间": "2026-05-09 09:47:56",
    "拨测任务属性": "已完成",
    "拨测任务创建时间": "2026-05-09 09:47:56",
    "拨测任务所属部门": "信息安全部",
    "拨测任务负责人": "赵六",
    "拨测任务类型": "已完成",
    "拨测任务模型": "已完成",
