    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部资产清单审批流程", "workflow")'>发起工信部资产清单审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产清单审批指派信息", "form")'>新增工信部资产清单审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产清单审批流程", "form")'>新增工信部资产清单审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产清单审批流程信息", "config")'>修改工信部资产清单审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批流程删除", "operation")'>工信部资产清单审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批流程查询", "detail")'>工信部资产清单审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批附件上传", "form")'>工信部资产清单审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批流程图查看", "preview")'>工信部资产清单审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批流程通知", "audit")'>工信部资产清单审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批结果逐级审批", "audit")'>工信部资产清单审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产清单审批结果拒绝和驳回", "approval")'>工信部资产清单审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部资产清单审批ID": "Y-27558",
    "工信部资产清单审批流程环节ID": "Y-27558",
    "工信部资产清单审批编号": "Y-27558",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-1",
    "发起工信部资产清单审批状态": "排队中",
    "发起工信部资产清单审批时间": "2026-05-09 08:33:11",
    "工信部资产清单审批属性": "排队中",
    "工信部资产清单审批发起时间": "2026-05-09 08:33:11",
    "工信部资产清单审批流程id": "排队中",
    "工信部资产清单审批流程环节": "排队中",
    "工信部资产清单审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 2,
    "工信部资产清单审批ID": "Y-35477",
    "工信部资产清单审批流程环节ID": "Y-35477",
    "工信部资产清单审批编号": "Y-35477",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-2",
    "发起工信部资产清单审批状态": "部分完成",
    "发起工信部资产清单审批时间": "2026-05-09 09:47:56",
    "工信部资产清单审批属性": "部分完成",
    "工信部资产清单审批发起时间": "2026-05-09 09:47:56",
    "工信部资产清单审批流程id": "部分完成",
    "工信部资产清单审批流程环节": "部分完成",
    "工信部资产清单审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 3,
    "工信部资产清单审批ID": "Y-43396",
    "工信部资产清单审批流程环节ID": "Y-43396",
    "工信部资产清单审批编号": "Y-43396",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-3",
    "发起工信部资产清单审批状态": "已启用",
    "发起工信部资产清单审批时间": "2026-05-08 09:12:18",
    "工信部资产清单审批属性": "已启用",
    "工信部资产清单审批发起时间": "2026-05-08 09:12:18",
    "工信部资产清单审批流程id": "已启用",
    "工信部资产清单审批流程环节": "已启用",
    "工信部资产清单审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 4,
    "工信部资产清单审批ID": "Y-51315",
    "工信部资产清单审批流程环节ID": "Y-51315",
    "工信部资产清单审批编号": "Y-51315",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-4",
    "发起工信部资产清单审批状态": "已停用",
    "发起工信部资产清单审批时间": "2026-05-08 09:35:44",
    "工信部资产清单审批属性": "已停用",
    "工信部资产清单审批发起时间": "2026-05-08 09:35:44",
    "工信部资产清单审批流程id": "已停用",
    "工信部资产清单审批流程环节": "已停用",
    "工信部资产清单审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 5,
    "工信部资产清单审批ID": "Y-59234",
    "工信部资产清单审批流程环节ID": "Y-59234",
    "工信部资产清单审批编号": "Y-59234",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-5",
    "发起工信部资产清单审批状态": "正常",
    "发起工信部资产清单审批时间": "2026-05-08 10:08:06",
    "工信部资产清单审批属性": "正常",
    "工信部资产清单审批发起时间": "2026-05-08 10:08:06",
    "工信部资产清单审批流程id": "正常",
    "工信部资产清单审批流程环节": "正常",
    "工信部资产清单审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 6,
    "工信部资产清单审批ID": "Y-67153",
    "工信部资产清单审批流程环节ID": "Y-67153",
    "工信部资产清单审批编号": "Y-67153",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-6",
    "发起工信部资产清单审批状态": "异常",
    "发起工信部资产清单审批时间": "2026-05-08 10:42:31",
    "工信部资产清单审批属性": "异常",
    "工信部资产清单审批发起时间": "2026-05-08 10:42:31",
    "工信部资产清单审批流程id": "异常",
    "工信部资产清单审批流程环节": "异常",
    "工信部资产清单审批创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 7,
    "工信部资产清单审批ID": "Y-75072",
    "工信部资产清单审批流程环节ID": "Y-75072",
    "工信部资产清单审批编号": "Y-75072",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-7",
    "发起工信部资产清单审批状态": "超时",
    "发起工信部资产清单审批时间": "2026-05-08 11:16:09",
    "工信部资产清单审批属性": "超时",
    "工信部资产清单审批发起时间": "2026-05-08 11:16:09",
    "工信部资产清单审批流程id": "超时",
    "工信部资产清单审批流程环节": "超时",
    "工信部资产清单审批创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 8,
    "工信部资产清单审批ID": "Y-82991",
    "工信部资产清单审批流程环节ID": "Y-82991",
    "工信部资产清单审批编号": "Y-82991",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-8",
    "发起工信部资产清单审批状态": "已取消",
    "发起工信部资产清单审批时间": "2026-05-08 14:03:52",
    "工信部资产清单审批属性": "已取消",
    "工信部资产清单审批发起时间": "2026-05-08 14:03:52",
    "工信部资产清单审批流程id": "已取消",
    "工信部资产清单审批流程环节": "已取消",
    "工信部资产清单审批创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 9,
    "工信部资产清单审批ID": "Y-90910",
    "工信部资产清单审批流程环节ID": "Y-90910",
    "工信部资产清单审批编号": "Y-90910",
    "工信部资产清单审批名称": "工信部资产清单审批流程管理-9",
    "发起工信部资产清单审批状态": "已驳回",
    "发起工信部资产清单审批时间": "2026-05-08 15:21:37",
    "工信部资产清单审批属性": "已驳回",
    "工信部资产清单审批发起时间": "2026-05-08 15:21:37",
    "工信部资产清单审批流程id": "已驳回",
    "工信部资产清单审批流程环节": "已驳回",
    "工信部资产清单审批创建时间": "2026-05-08 15:21:37"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部资产清单审批流程环节ID",
    "label": "工信部资产清单审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
