    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产省份考核准确性信息表", "operation")'>资产省份考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产归属考核准确性稽核数据上传", "form")'>资产归属考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属考核准确性稽核数据接口监控", "log")'>资产归属考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产所属部门考核准确性信息表", "operation")'>资产所属部门考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产组织考核准确性稽核数据上传", "form")'>资产组织考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组织考核准确性稽核数据接口监控", "log")'>资产组织考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产省份考核准确性ID": "K-7888",
    "资产省份考核准确性编号": "K-7888",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-1",
    "资产省份考核准确性状态": "已处理",
    "资产省份考核准确性时间": "2026-05-09 08:33:11",
    "资产省份考核准确性属性": "已处理",
    "资产省份考核准确性创建时间": "2026-05-09 08:33:11",
    "资产省份考核准确性所属部门": "系统运维部",
    "资产省份考核准确性负责人": "system",
    "资产省份考核准确性类型": "已处理",
    "资产省份考核准确性规则": "已处理",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-15807",
    "资产省份考核准确性编号": "K-15807",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-2",
    "资产省份考核准确性状态": "处理中",
    "资产省份考核准确性时间": "2026-05-09 09:47:56",
    "资产省份考核准确性属性": "处理中",
    "资产省份考核准确性创建时间": "2026-05-09 09:47:56",
    "资产省份考核准确性所属部门": "数据管理部",
    "资产省份考核准确性负责人": "admin",
    "资产省份考核准确性类型": "处理中",
    "资产省份考核准确性规则": "处理中",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-23726",
    "资产省份考核准确性编号": "K-23726",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-3",
    "资产省份考核准确性状态": "待处理",
    "资产省份考核准确性时间": "2026-05-08 09:12:18",
    "资产省份考核准确性属性": "待处理",
    "资产省份考核准确性创建时间": "2026-05-08 09:12:18",
    "资产省份考核准确性所属部门": "安全运维部",
    "资产省份考核准确性负责人": "张三",
    "资产省份考核准确性类型": "待处理",
    "资产省份考核准确性规则": "待处理",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-31645",
    "资产省份考核准确性编号": "K-31645",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-4",
    "资产省份考核准确性状态": "处理失败",
    "资产省份考核准确性时间": "2026-05-08 09:35:44",
    "资产省份考核准确性属性": "处理失败",
    "资产省份考核准确性创建时间": "2026-05-08 09:35:44",
    "资产省份考核准确性所属部门": "网络管理部",
    "资产省份考核准确性负责人": "李四",
    "资产省份考核准确性类型": "处理失败",
    "资产省份考核准确性规则": "处理失败",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-39564",
    "资产省份考核准确性编号": "K-39564",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-5",
    "资产省份考核准确性状态": "已暂停",
    "资产省份考核准确性时间": "2026-05-08 10:08:06",
    "资产省份考核准确性属性": "已暂停",
    "资产省份考核准确性创建时间": "2026-05-08 10:08:06",
    "资产省份考核准确性所属部门": "资产管理部",
    "资产省份考核准确性负责人": "王五",
    "资产省份考核准确性类型": "已暂停",
    "资产省份考核准确性规则": "已暂停",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-47483",
    "资产省份考核准确性编号": "K-47483",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-6",
    "资产省份考核准确性状态": "已完成",
    "资产省份考核准确性时间": "2026-05-08 10:42:31",
    "资产省份考核准确性属性": "已完成",
    "资产省份考核准确性创建时间": "2026-05-08 10:42:31",
    "资产省份考核准确性所属部门": "信息安全部",
    "资产省份考核准确性负责人": "赵六",
    "资产省份考核准确性类型": "已完成",
    "资产省份考核准确性规则": "已完成",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-55402",
    "资产省份考核准确性编号": "K-55402",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-7",
    "资产省份考核准确性状态": "排队中",
    "资产省份考核准确性时间": "2026-05-08 11:16:09",
    "资产省份考核准确性属性": "排队中",
    "资产省份考核准确性创建时间": "2026-05-08 11:16:09",
    "资产省份考核准确性所属部门": "系统运维部",
    "资产省份考核准确性负责人": "system",
    "资产省份考核准确性类型": "排队中",
    "资产省份考核准确性规则": "排队中",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-63321",
    "资产省份考核准确性编号": "K-63321",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-8",
    "资产省份考核准确性状态": "部分完成",
    "资产省份考核准确性时间": "2026-05-08 14:03:52",
    "资产省份考核准确性属性": "部分完成",
    "资产省份考核准确性创建时间": "2026-05-08 14:03:52",
    "资产省份考核准确性所属部门": "数据管理部",
    "资产省份考核准确性负责人": "admin",
    "资产省份考核准确性类型": "部分完成",
    "资产省份考核准确性规则": "部分完成",
  ...
  },
  {
    ...
    "资产省份考核准确性ID": "K-71240",
    "资产省份考核准确性编号": "K-71240",
    "资产省份考核准确性名称": "资产省份考核准确性指标管理-9",
    "资产省份考核准确性状态": "已启用",
    "资产省份考核准确性时间": "2026-05-08 15:21:37",
    "资产省份考核准确性属性": "已启用",
    "资产省份考核准确性创建时间": "2026-05-08 15:21:37",
    "资产省份考核准确性所属部门": "安全运维部",
    "资产省份考核准确性负责人": "张三",
    "资产省份考核准确性类型": "已启用",
    "资产省份考核准确性规则": "已启用",
