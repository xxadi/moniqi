    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增漏报端口汇总报表信息", "form")'>新增漏报端口汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增漏报端口明细报表信息", "form")'>新增漏报端口明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询漏报端口汇总报表详情", "detail")'>查询漏报端口汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询漏报端口明细报表详情", "detail")'>查询漏报端口明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("漏报端口汇总报表导出")'>漏报端口汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("漏报端口明细报表导出")'>漏报端口明细报表导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "漏报端口汇总报表属性": "处理中",
    "新增漏报端口汇总报表状态": "处理中",
    "新增漏报端口汇总报表时间": "2026-05-08 16:08:25",
    "漏报端口汇总报表创建时间": "2026-05-08 16:08:25",
    "汇总报表编号": "P-39457",
    "报表ID": "P-39457",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "漏报端口汇总报表属性": "待处理",
    "新增漏报端口汇总报表状态": "待处理",
    "新增漏报端口汇总报表时间": "2026-05-09 08:33:11",
    "漏报端口汇总报表创建时间": "2026-05-09 08:33:11",
    "汇总报表编号": "P-47376",
    "报表ID": "P-47376",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "漏报端口汇总报表属性": "处理失败",
    "新增漏报端口汇总报表状态": "处理失败",
    "新增漏报端口汇总报表时间": "2026-05-09 09:47:56",
    "漏报端口汇总报表创建时间": "2026-05-09 09:47:56",
    "汇总报表编号": "P-55295",
    "报表ID": "P-55295",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "漏报端口汇总报表属性": "已暂停",
    "新增漏报端口汇总报表状态": "已暂停",
    "新增漏报端口汇总报表时间": "2026-05-08 09:12:18",
    "漏报端口汇总报表创建时间": "2026-05-08 09:12:18",
    "汇总报表编号": "P-63214",
    "报表ID": "P-63214",
    "汇总报表所属部门": "系统运维部"
  },
  {
    ...
    "漏报端口汇总报表属性": "已完成",
    "新增漏报端口汇总报表状态": "已完成",
    "新增漏报端口汇总报表时间": "2026-05-08 09:35:44",
    "漏报端口汇总报表创建时间": "2026-05-08 09:35:44",
    "汇总报表编号": "P-71133",
    "报表ID": "P-71133",
    "汇总报表所属部门": "数据管理部"
  },
  {
    ...
    "漏报端口汇总报表属性": "排队中",
    "新增漏报端口汇总报表状态": "排队中",
    "新增漏报端口汇总报表时间": "2026-05-08 10:08:06",
    "漏报端口汇总报表创建时间": "2026-05-08 10:08:06",
    "汇总报表编号": "P-79052",
    "报表ID": "P-79052",
    "汇总报表所属部门": "安全运维部"
  },
  {
    ...
    "漏报端口汇总报表属性": "部分完成",
    "新增漏报端口汇总报表状态": "部分完成",
    "新增漏报端口汇总报表时间": "2026-05-08 10:42:31",
    "漏报端口汇总报表创建时间": "2026-05-08 10:42:31",
    "汇总报表编号": "P-86971",
    "报表ID": "P-86971",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "漏报端口汇总报表属性": "已启用",
    "新增漏报端口汇总报表状态": "已启用",
    "新增漏报端口汇总报表时间": "2026-05-08 11:16:09",
    "漏报端口汇总报表创建时间": "2026-05-08 11:16:09",
    "汇总报表编号": "P-94890",
    "报表ID": "P-94890",
    "汇总报表所属部门": "资产管理部"
  }
