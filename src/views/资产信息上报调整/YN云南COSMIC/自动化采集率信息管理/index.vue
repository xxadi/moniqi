    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率统计", "statistics")'>自动化采集率统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化采集率信息", "config")'>修改自动化采集率信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产自动采集率设置信息", "form")'>新增资产自动采集率设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产自动采集率设置信息", "config")'>修改资产自动采集率设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产自动采集率设置信息")'>删除资产自动采集率设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产自动采集率错误信息监控", "log")'>资产自动采集率错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产自动采集率错误事件通知", "transform")'>资产自动采集率错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产自动采集率错误事件通知删除", "operation")'>资产自动采集率错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产自动采集率错误事件通知查询", "detail")'>资产自动采集率错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产自动采集率防篡改信息", "form")'>新增资产自动采集率防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产自动采集率防篡改信息", "config")'>修改资产自动采集率防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产自动采集率防篡改信息")'>删除资产自动采集率防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动化采集率信息")'>删除自动化采集率信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率列表", "detail")'>查询自动化采集率列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率详情", "detail")'>查询自动化采集率详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入自动化采集率")'>批量导入自动化采集率</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("自动化采集率导出")'>自动化采集率导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "自动化采集率ID": "V-94947",
    "自动化采集率编号": "V-94947",
    "自动化采集率名称": "自动化采集率信息管理-1",
    "自动化采集率状态": "处理失败",
    "自动化采集率时间": "2026-05-08 16:08:25",
    "自动化采集率属性": "处理失败",
    "自动化采集率创建时间": "2026-05-08 16:08:25",
    "自动化采集率所属部门": "信息安全部",
    "自动化采集率负责人": "赵六",
    "自动化采集率类型": "处理失败",
    "自动化采集率规则": "处理失败",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-102866",
    "自动化采集率编号": "V-102866",
    "自动化采集率名称": "自动化采集率信息管理-2",
    "自动化采集率状态": "已暂停",
    "自动化采集率时间": "2026-05-09 08:33:11",
    "自动化采集率属性": "已暂停",
    "自动化采集率创建时间": "2026-05-09 08:33:11",
    "自动化采集率所属部门": "系统运维部",
    "自动化采集率负责人": "system",
    "自动化采集率类型": "已暂停",
    "自动化采集率规则": "已暂停",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-110785",
    "自动化采集率编号": "V-110785",
    "自动化采集率名称": "自动化采集率信息管理-3",
    "自动化采集率状态": "已完成",
    "自动化采集率时间": "2026-05-09 09:47:56",
    "自动化采集率属性": "已完成",
    "自动化采集率创建时间": "2026-05-09 09:47:56",
    "自动化采集率所属部门": "数据管理部",
    "自动化采集率负责人": "admin",
    "自动化采集率类型": "已完成",
    "自动化采集率规则": "已完成",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-118704",
    "自动化采集率编号": "V-118704",
    "自动化采集率名称": "自动化采集率信息管理-4",
    "自动化采集率状态": "排队中",
    "自动化采集率时间": "2026-05-08 09:12:18",
    "自动化采集率属性": "排队中",
    "自动化采集率创建时间": "2026-05-08 09:12:18",
    "自动化采集率所属部门": "安全运维部",
    "自动化采集率负责人": "张三",
    "自动化采集率类型": "排队中",
    "自动化采集率规则": "排队中",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-126623",
    "自动化采集率编号": "V-126623",
    "自动化采集率名称": "自动化采集率信息管理-5",
    "自动化采集率状态": "部分完成",
    "自动化采集率时间": "2026-05-08 09:35:44",
    "自动化采集率属性": "部分完成",
    "自动化采集率创建时间": "2026-05-08 09:35:44",
    "自动化采集率所属部门": "网络管理部",
    "自动化采集率负责人": "李四",
    "自动化采集率类型": "部分完成",
    "自动化采集率规则": "部分完成",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-134542",
    "自动化采集率编号": "V-134542",
    "自动化采集率名称": "自动化采集率信息管理-6",
    "自动化采集率状态": "已启用",
    "自动化采集率时间": "2026-05-08 10:08:06",
    "自动化采集率属性": "已启用",
    "自动化采集率创建时间": "2026-05-08 10:08:06",
    "自动化采集率所属部门": "资产管理部",
    "自动化采集率负责人": "王五",
    "自动化采集率类型": "已启用",
    "自动化采集率规则": "已启用",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-142461",
    "自动化采集率编号": "V-142461",
    "自动化采集率名称": "自动化采集率信息管理-7",
    "自动化采集率状态": "已停用",
    "自动化采集率时间": "2026-05-08 10:42:31",
    "自动化采集率属性": "已停用",
    "自动化采集率创建时间": "2026-05-08 10:42:31",
    "自动化采集率所属部门": "信息安全部",
    "自动化采集率负责人": "赵六",
    "自动化采集率类型": "已停用",
    "自动化采集率规则": "已停用",
  ...
  },
  {
    ...
    "自动化采集率ID": "V-150380",
    "自动化采集率编号": "V-150380",
    "自动化采集率名称": "自动化采集率信息管理-8",
    "自动化采集率状态": "正常",
    "自动化采集率时间": "2026-05-08 11:16:09",
    "自动化采集率属性": "正常",
    "自动化采集率创建时间": "2026-05-08 11:16:09",
    "自动化采集率所属部门": "系统运维部",
    "自动化采集率负责人": "system",
    "自动化采集率类型": "正常",
    "自动化采集率规则": "正常",
