    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起资产上报标签异常消除审批流程", "workflow")'>发起资产上报标签异常消除审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报标签异常消除审批指派信息", "form")'>新增资产上报标签异常消除审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报标签异常消除审批流程", "form")'>新增资产上报标签异常消除审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报标签异常消除审批流程信息", "config")'>修改资产上报标签异常消除审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批流程删除", "operation")'>资产上报标签异常消除审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批流程查询", "detail")'>资产上报标签异常消除审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批附件上传", "form")'>资产上报标签异常消除审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批流程图查看", "preview")'>资产上报标签异常消除审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批流程通知", "audit")'>资产上报标签异常消除审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批结果逐级审批", "audit")'>资产上报标签异常消除审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报标签异常消除审批结果拒绝和驳回", "approval")'>资产上报标签异常消除审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流程环节ID": "A-9646",
    "异常消除审批编号": "A-9646",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-1",
    "发起资产上报标签异常消除审批状态": "已驳回",
    "资产上报标签异常消除审批流程节点编号": "A-9646",
    "名称": "资产上报标签异常消除审批流程管理-1",
    "类型": "已驳回",
    "资产上报标签异常消除审批流程节点规则": "已驳回",
    "资产上报标签异常消除审批流程节点属性": "已驳回",
    "修改资产上报标签异常消除审批流程节点状态": "已驳回",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "消除审批ID": "A-17565",
    "流程环节ID": "A-17565",
    "异常消除审批编号": "A-17565",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-2",
    "发起资产上报标签异常消除审批状态": "待审核",
    "资产上报标签异常消除审批流程节点编号": "A-17565",
    "名称": "资产上报标签异常消除审批流程管理-2",
    "类型": "待审核",
    "资产上报标签异常消除审批流程节点规则": "待审核",
    "资产上报标签异常消除审批流程节点属性": "待审核",
    "修改资产上报标签异常消除审批流程节点状态": "待审核",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "消除审批ID": "A-25484",
    "流程环节ID": "A-25484",
    "异常消除审批编号": "A-25484",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-3",
    "发起资产上报标签异常消除审批状态": "已处理",
    "资产上报标签异常消除审批流程节点编号": "A-25484",
    "名称": "资产上报标签异常消除审批流程管理-3",
    "类型": "已处理",
    "资产上报标签异常消除审批流程节点规则": "已处理",
    "资产上报标签异常消除审批流程节点属性": "已处理",
    "修改资产上报标签异常消除审批流程节点状态": "已处理",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "消除审批ID": "A-33403",
    "流程环节ID": "A-33403",
    "异常消除审批编号": "A-33403",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-4",
    "发起资产上报标签异常消除审批状态": "处理中",
    "资产上报标签异常消除审批流程节点编号": "A-33403",
    "名称": "资产上报标签异常消除审批流程管理-4",
    "类型": "处理中",
    "资产上报标签异常消除审批流程节点规则": "处理中",
    "资产上报标签异常消除审批流程节点属性": "处理中",
    "修改资产上报标签异常消除审批流程节点状态": "处理中",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "消除审批ID": "A-41322",
    "流程环节ID": "A-41322",
    "异常消除审批编号": "A-41322",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-5",
    "发起资产上报标签异常消除审批状态": "待处理",
    "资产上报标签异常消除审批流程节点编号": "A-41322",
    "名称": "资产上报标签异常消除审批流程管理-5",
    "类型": "待处理",
    "资产上报标签异常消除审批流程节点规则": "待处理",
    "资产上报标签异常消除审批流程节点属性": "待处理",
    "修改资产上报标签异常消除审批流程节点状态": "待处理",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "消除审批ID": "A-49241",
    "流程环节ID": "A-49241",
    "异常消除审批编号": "A-49241",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-6",
    "发起资产上报标签异常消除审批状态": "处理失败",
    "资产上报标签异常消除审批流程节点编号": "A-49241",
    "名称": "资产上报标签异常消除审批流程管理-6",
    "类型": "处理失败",
    "资产上报标签异常消除审批流程节点规则": "处理失败",
    "资产上报标签异常消除审批流程节点属性": "处理失败",
    "修改资产上报标签异常消除审批流程节点状态": "处理失败",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "消除审批ID": "A-57160",
    "流程环节ID": "A-57160",
    "异常消除审批编号": "A-57160",
    "标签异常消除审批名称": "资产上报标签异常消除审批流程管理-7",
    "发起资产上报标签异常消除审批状态": "已暂停",
    "资产上报标签异常消除审批流程节点编号": "A-57160",
    "名称": "资产上报标签异常消除审批流程管理-7",
    "类型": "已暂停",
    "资产上报标签异常消除审批流程节点规则": "已暂停",
    "资产上报标签异常消除审批流程节点属性": "已暂停",
    "修改资产上报标签异常消除审批流程节点状态": "已暂停",
    "修改资产上报标签异常消除审批流程节点时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "发起资产上报标签异常消除审批状态",
    "label": "发起资产上报标签异常消除审批状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报标签异常消除审批流程节点编号",
    "label": "资产上报标签异常消除审批流程节点编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "资产上报标签异常消除审批流程节点规则",
    "label": "资产上报标签异常消除审批流程节点规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "资产上报标签异常消除审批流程节点属性",
    "label": "资产上报标签异常消除审批流程节点属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改资产上报标签异常消除审批流程节点状态",
    "label": "修改资产上报标签异常消除审批流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改资产上报标签异常消除审批流程节点时间",
    "label": "修改资产上报标签异常消除审批流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
...
const defaultRow = {
  ...
  "资产上报标签异常消除审批流程节点规则": "",
  "资产上报标签异常消除审批流程节点属性": "",
  "修改资产上报标签异常消除审批流程节点状态": "",
  "修改资产上报标签异常消除审批流程节点时间": ""
};
const importTemplateRow = {
  ...
  "修改资产上报标签异常消除审批流程节点状态": "",
  "修改资产上报标签异常消除审批流程节点时间": "",
  "导入来源": "资产上报标签异常消除审批流程管理导入模板.xlsx"
};
