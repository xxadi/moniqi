    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描分析信息表", "analysis")'>远程扫描分析信息表</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义远程扫描分析任务信息", "analysis")'>定义远程扫描分析任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改远程扫描分析任务信息", "config")'>修改远程扫描分析任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除远程扫描分析任务信息")'>删除远程扫描分析任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描分析任务数据获取", "analysis")'>远程扫描分析任务数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描分析任务数据上传", "analysis")'>远程扫描分析任务数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("远程扫描分析任务数据接口监控", "log")'>远程扫描分析任务数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询远程扫描分析任务汇总报告详情", "detail")'>查询远程扫描分析任务汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询远程扫描分析任务明细报告详情", "detail")'>查询远程扫描分析任务明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描分析任务", "form")'>新增远程扫描分析任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描分析模型", "form")'>新增远程扫描分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改远程扫描分析模型", "config")'>修改远程扫描分析模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除远程扫描分析模型")'>删除远程扫描分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描分析查询", "analysis")'>远程扫描分析查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描分析可视化展示", "analysis")'>远程扫描分析可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起远程扫描分析结果审批流程", "workflow")'>发起远程扫描分析结果审批流程</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-1",
    "远程扫描分析状态": "待处理",
    "远程扫描分析时间": "2026-05-09 08:33:11",
    "分析属性": "待处理",
    "远程扫描分析创建时间": "2026-05-09 08:33:11",
    "远程扫描分析所属部门": "资产管理部",
    "远程扫描分析负责人": "王五",
    "远程扫描分析类型": "待处理",
    "远程扫描分析模型": "待处理",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-2",
    "远程扫描分析状态": "处理失败",
    "远程扫描分析时间": "2026-05-09 09:47:56",
    "分析属性": "处理失败",
    "远程扫描分析创建时间": "2026-05-09 09:47:56",
    "远程扫描分析所属部门": "信息安全部",
    "远程扫描分析负责人": "赵六",
    "远程扫描分析类型": "处理失败",
    "远程扫描分析模型": "处理失败",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-3",
    "远程扫描分析状态": "已暂停",
    "远程扫描分析时间": "2026-05-08 09:12:18",
    "分析属性": "已暂停",
    "远程扫描分析创建时间": "2026-05-08 09:12:18",
    "远程扫描分析所属部门": "系统运维部",
    "远程扫描分析负责人": "system",
    "远程扫描分析类型": "已暂停",
    "远程扫描分析模型": "已暂停",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-4",
    "远程扫描分析状态": "已完成",
    "远程扫描分析时间": "2026-05-08 09:35:44",
    "分析属性": "已完成",
    "远程扫描分析创建时间": "2026-05-08 09:35:44",
    "远程扫描分析所属部门": "数据管理部",
    "远程扫描分析负责人": "admin",
    "远程扫描分析类型": "已完成",
    "远程扫描分析模型": "已完成",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-5",
    "远程扫描分析状态": "排队中",
    "远程扫描分析时间": "2026-05-08 10:08:06",
    "分析属性": "排队中",
    "远程扫描分析创建时间": "2026-05-08 10:08:06",
    "远程扫描分析所属部门": "安全运维部",
    "远程扫描分析负责人": "张三",
    "远程扫描分析类型": "排队中",
    "远程扫描分析模型": "排队中",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-6",
    "远程扫描分析状态": "部分完成",
    "远程扫描分析时间": "2026-05-08 10:42:31",
    "分析属性": "部分完成",
    "远程扫描分析创建时间": "2026-05-08 10:42:31",
    "远程扫描分析所属部门": "网络管理部",
    "远程扫描分析负责人": "李四",
    "远程扫描分析类型": "部分完成",
    "远程扫描分析模型": "部分完成",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-7",
    "远程扫描分析状态": "已启用",
    "远程扫描分析时间": "2026-05-08 11:16:09",
    "分析属性": "已启用",
    "远程扫描分析创建时间": "2026-05-08 11:16:09",
    "远程扫描分析所属部门": "资产管理部",
    "远程扫描分析负责人": "王五",
    "远程扫描分析类型": "已启用",
    "远程扫描分析模型": "已启用",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-8",
    "远程扫描分析状态": "已停用",
    "远程扫描分析时间": "2026-05-08 14:03:52",
    "分析属性": "已停用",
    "远程扫描分析创建时间": "2026-05-08 14:03:52",
    "远程扫描分析所属部门": "信息安全部",
    "远程扫描分析负责人": "赵六",
    "远程扫描分析类型": "已停用",
    "远程扫描分析模型": "已停用",
  ...
  },
  {
    ...
    "远程扫描分析名称": "远程扫描分析管理-9",
    "远程扫描分析状态": "正常",
    "远程扫描分析时间": "2026-05-08 15:21:37",
    "分析属性": "正常",
    "远程扫描分析创建时间": "2026-05-08 15:21:37",
    "远程扫描分析所属部门": "系统运维部",
    "远程扫描分析负责人": "system",
    "远程扫描分析类型": "正常",
    "远程扫描分析模型": "正常",
