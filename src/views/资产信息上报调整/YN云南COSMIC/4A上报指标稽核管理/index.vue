    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A上报指标稽核", "audit")'>4A上报指标稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A上报指标统计", "statistics")'>4A上报指标统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A指标差异汇总报表信息", "form")'>新增4A指标差异汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A指标差异明细报表信息", "form")'>新增4A指标差异明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A指标差异汇总报表详情", "detail")'>查询4A指标差异汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A指标差异明细报表详情", "detail")'>查询4A指标差异明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("4A指标差异汇总报表导出")'>4A指标差异汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("4A指标差异明细报表导出")'>4A指标差异明细报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A指标差异总表推送接口", "api")'>4A指标差异总表推送接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("4A指标差异简表修改推送接口", "api")'>4A指标差异简表修改推送接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("4A指标差异修改接口", "api")'>4A指标差异修改接口</el-button>
        </div>
      </div>
      <cs-pagetable
