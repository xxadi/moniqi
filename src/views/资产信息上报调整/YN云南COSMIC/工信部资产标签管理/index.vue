    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产标签信息", "form")'>新增工信部资产标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产标签信息", "config")'>修改工信部资产标签信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产标签信息")'>删除工信部资产标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产标签列表", "detail")'>查询工信部资产标签列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产标签下发回传同步", "sync")'>工信部资产标签下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产标签下发回传任务推送", "audit")'>工信部资产标签下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产标签数据下发", "operation")'>工信部资产标签数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产标签数据分析", "analysis")'>工信部资产标签数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产标签数据上报", "operation")'>工信部资产标签数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产标签ID": "Z-43627",
    "工信部资产标签编号": "Z-43627",
    "工信部资产标签名称": "工信部资产标签管理-1",
    "新增工信部资产标签状态": "异常",
    "新增工信部资产标签时间": "2026-05-08 16:08:25",
    "工信部资产标签属性": "异常",
    "告警时间": "2026-05-08 16:08:25",
    "告警用户": "李四",
    "告警系统工信部资产标签创建时间": "2026-05-08 16:08:25",
    "工信部资产标签所属部门": "网络管理部",
    "工信部资产标签负责人": "李四",
    "工信部资产标签类型": "异常"
  },
  {
    ...
    "工信部资产标签ID": "Z-51546",
    "工信部资产标签编号": "Z-51546",
    "工信部资产标签名称": "工信部资产标签管理-2",
    "新增工信部资产标签状态": "超时",
    "新增工信部资产标签时间": "2026-05-09 08:33:11",
    "工信部资产标签属性": "超时",
    "告警时间": "2026-05-09 08:33:11",
    "告警用户": "王五",
    "告警系统工信部资产标签创建时间": "2026-05-09 08:33:11",
    "工信部资产标签所属部门": "资产管理部",
    "工信部资产标签负责人": "王五",
    "工信部资产标签类型": "超时"
  },
  {
    ...
    "工信部资产标签ID": "Z-59465",
    "工信部资产标签编号": "Z-59465",
    "工信部资产标签名称": "工信部资产标签管理-3",
    "新增工信部资产标签状态": "已取消",
    "新增工信部资产标签时间": "2026-05-09 09:47:56",
    "工信部资产标签属性": "已取消",
    "告警时间": "2026-05-09 09:47:56",
    "告警用户": "赵六",
    "告警系统工信部资产标签创建时间": "2026-05-09 09:47:56",
    "工信部资产标签所属部门": "信息安全部",
    "工信部资产标签负责人": "赵六",
    "工信部资产标签类型": "已取消"
  },
  {
    ...
    "工信部资产标签ID": "Z-67384",
    "工信部资产标签编号": "Z-67384",
    "工信部资产标签名称": "工信部资产标签管理-4",
    "新增工信部资产标签状态": "已驳回",
    "新增工信部资产标签时间": "2026-05-08 09:12:18",
    "工信部资产标签属性": "已驳回",
    "告警时间": "2026-05-08 09:12:18",
    "告警用户": "system",
    "告警系统工信部资产标签创建时间": "2026-05-08 09:12:18",
    "工信部资产标签所属部门": "系统运维部",
    "工信部资产标签负责人": "system",
    "工信部资产标签类型": "已驳回"
  },
  {
    ...
    "工信部资产标签ID": "Z-75303",
    "工信部资产标签编号": "Z-75303",
    "工信部资产标签名称": "工信部资产标签管理-5",
    "新增工信部资产标签状态": "待审核",
    "新增工信部资产标签时间": "2026-05-08 09:35:44",
    "工信部资产标签属性": "待审核",
    "告警时间": "2026-05-08 09:35:44",
    "告警用户": "admin",
    "告警系统工信部资产标签创建时间": "2026-05-08 09:35:44",
    "工信部资产标签所属部门": "数据管理部",
    "工信部资产标签负责人": "admin",
    "工信部资产标签类型": "待审核"
  },
  {
    ...
    "工信部资产标签ID": "Z-83222",
    "工信部资产标签编号": "Z-83222",
    "工信部资产标签名称": "工信部资产标签管理-6",
    "新增工信部资产标签状态": "已处理",
    "新增工信部资产标签时间": "2026-05-08 10:08:06",
    "工信部资产标签属性": "已处理",
    "告警时间": "2026-05-08 10:08:06",
    "告警用户": "张三",
    "告警系统工信部资产标签创建时间": "2026-05-08 10:08:06",
    "工信部资产标签所属部门": "安全运维部",
    "工信部资产标签负责人": "张三",
    "工信部资产标签类型": "已处理"
  },
  {
    ...
    "工信部资产标签ID": "Z-91141",
    "工信部资产标签编号": "Z-91141",
    "工信部资产标签名称": "工信部资产标签管理-7",
    "新增工信部资产标签状态": "处理中",
    "新增工信部资产标签时间": "2026-05-08 10:42:31",
    "工信部资产标签属性": "处理中",
    "告警时间": "2026-05-08 10:42:31",
    "告警用户": "李四",
    "告警系统工信部资产标签创建时间": "2026-05-08 10:42:31",
    "工信部资产标签所属部门": "网络管理部",
    "工信部资产标签负责人": "李四",
    "工信部资产标签类型": "处理中"
  },
  {
    ...
    "工信部资产标签ID": "Z-99060",
    "工信部资产标签编号": "Z-99060",
    "工信部资产标签名称": "工信部资产标签管理-8",
    "新增工信部资产标签状态": "待处理",
    "新增工信部资产标签时间": "2026-05-08 11:16:09",
    "工信部资产标签属性": "待处理",
    "告警时间": "2026-05-08 11:16:09",
    "告警用户": "王五",
    "告警系统工信部资产标签创建时间": "2026-05-08 11:16:09",
    "工信部资产标签所属部门": "资产管理部",
    "工信部资产标签负责人": "王五",
    "工信部资产标签类型": "待处理"
  }
...
const tableColumns = [
  ...
  {
    "prop": "告警系统工信部资产标签创建时间",
    "label": "告警系统工信部资产标签创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
