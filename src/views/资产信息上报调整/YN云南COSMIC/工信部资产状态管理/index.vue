    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产设置信息", "form")'>新增工信部资产设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产设置信息", "config")'>修改工信部资产设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产设置信息")'>删除工信部资产设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产错误信息监控", "log")'>工信部资产错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产错误事件通知", "audit")'>工信部资产错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产错误事件通知删除", "operation")'>工信部资产错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产错误事件通知查询", "detail")'>工信部资产错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产防篡改信息", "form")'>新增工信部资产防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产防篡改信息", "config")'>修改工信部资产防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产防篡改信息")'>删除工信部资产防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产简表设置信息", "form")'>新增资产简表设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产简表设置信息", "config")'>修改资产简表设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产简表设置信息")'>删除资产简表设置信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "上级单位系统": "网络管理部",
    "操作流水号": "T-59455",
    "操作用户工信部资产名称": "工信部资产状态管理-1",
    "新增工信部资产状态": "待审核",
    "新增工信部资产时间": "2026-05-08 14:03:52",
    "新增工信部资产设置时间_": "2026-05-08 14:03:52",
    "工信部资产属性": "待审核",
    "工信部资产创建时间": "2026-05-08 14:03:52",
    "操作用户工信部资产编号": "T-59455",
    "新增工信部资产设置结果": "待审核"
  },
  {
    ...
    "上级单位系统": "资产管理部",
    "操作流水号": "T-67374",
    "操作用户工信部资产名称": "工信部资产状态管理-2",
    "新增工信部资产状态": "已处理",
    "新增工信部资产时间": "2026-05-08 15:21:37",
    "新增工信部资产设置时间_": "2026-05-08 15:21:37",
    "工信部资产属性": "已处理",
    "工信部资产创建时间": "2026-05-08 15:21:37",
    "操作用户工信部资产编号": "T-67374",
    "新增工信部资产设置结果": "已处理"
  },
  {
    ...
    "上级单位系统": "信息安全部",
    "操作流水号": "T-75293",
    "操作用户工信部资产名称": "工信部资产状态管理-3",
    "新增工信部资产状态": "处理中",
    "新增工信部资产时间": "2026-05-08 16:08:25",
    "新增工信部资产设置时间_": "2026-05-08 16:08:25",
    "工信部资产属性": "处理中",
    "工信部资产创建时间": "2026-05-08 16:08:25",
    "操作用户工信部资产编号": "T-75293",
    "新增工信部资产设置结果": "处理中"
  },
  {
    ...
    "上级单位系统": "系统运维部",
    "操作流水号": "T-83212",
    "操作用户工信部资产名称": "工信部资产状态管理-4",
    "新增工信部资产状态": "待处理",
    "新增工信部资产时间": "2026-05-09 08:33:11",
    "新增工信部资产设置时间_": "2026-05-09 08:33:11",
    "工信部资产属性": "待处理",
    "工信部资产创建时间": "2026-05-09 08:33:11",
    "操作用户工信部资产编号": "T-83212",
    "新增工信部资产设置结果": "待处理"
  },
  {
    ...
    "上级单位系统": "数据管理部",
    "操作流水号": "T-91131",
    "操作用户工信部资产名称": "工信部资产状态管理-5",
    "新增工信部资产状态": "处理失败",
    "新增工信部资产时间": "2026-05-09 09:47:56",
    "新增工信部资产设置时间_": "2026-05-09 09:47:56",
    "工信部资产属性": "处理失败",
    "工信部资产创建时间": "2026-05-09 09:47:56",
    "操作用户工信部资产编号": "T-91131",
    "新增工信部资产设置结果": "处理失败"
  },
  {
    ...
    "上级单位系统": "安全运维部",
    "操作流水号": "T-99050",
    "操作用户工信部资产名称": "工信部资产状态管理-6",
    "新增工信部资产状态": "已暂停",
    "新增工信部资产时间": "2026-05-08 09:12:18",
    "新增工信部资产设置时间_": "2026-05-08 09:12:18",
    "工信部资产属性": "已暂停",
    "工信部资产创建时间": "2026-05-08 09:12:18",
    "操作用户工信部资产编号": "T-99050",
    "新增工信部资产设置结果": "已暂停"
  }
];
