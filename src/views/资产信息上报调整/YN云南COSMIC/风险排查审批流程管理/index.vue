    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起风险排查审批流程", "workflow")'>发起风险排查审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增风险排查审批指派信息", "form")'>新增风险排查审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增风险排查审批流程", "form")'>新增风险排查审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改风险排查审批流程信息", "config")'>修改风险排查审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批流程删除", "operation")'>风险排查审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批流程查询", "detail")'>风险排查审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批附件上传", "form")'>风险排查审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批流程图查看", "preview")'>风险排查审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批流程通知", "audit")'>风险排查审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批结果逐级审批", "audit")'>风险排查审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("风险排查审批结果拒绝和驳回", "approval")'>风险排查审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "风险排查审批ID": "Z-82549",
    "风险排查审批流程环节ID": "Z-82549",
    "风险排查审批编号": "Z-82549",
    "风险排查审批名称": "风险排查审批流程管理-1",
    "发起风险排查审批状态": "已完成",
    "发起风险排查审批时间": "2026-05-09 09:47:56",
    "风险排查审批属性": "已完成",
    "风险排查审批发起时间": "2026-05-09 09:47:56",
    "风险排查审批流程id": "已完成",
    "风险排查审批流程环节": "已完成",
    "风险排查审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 2,
    "风险排查审批ID": "Z-90468",
    "风险排查审批流程环节ID": "Z-90468",
    "风险排查审批编号": "Z-90468",
    "风险排查审批名称": "风险排查审批流程管理-2",
    "发起风险排查审批状态": "排队中",
    "发起风险排查审批时间": "2026-05-08 09:12:18",
    "风险排查审批属性": "排队中",
    "风险排查审批发起时间": "2026-05-08 09:12:18",
    "风险排查审批流程id": "排队中",
    "风险排查审批流程环节": "排队中",
    "风险排查审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 3,
    "风险排查审批ID": "Z-98387",
    "风险排查审批流程环节ID": "Z-98387",
    "风险排查审批编号": "Z-98387",
    "风险排查审批名称": "风险排查审批流程管理-3",
    "发起风险排查审批状态": "部分完成",
    "发起风险排查审批时间": "2026-05-08 09:35:44",
    "风险排查审批属性": "部分完成",
    "风险排查审批发起时间": "2026-05-08 09:35:44",
    "风险排查审批流程id": "部分完成",
    "风险排查审批流程环节": "部分完成",
    "风险排查审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 4,
    "风险排查审批ID": "Z-106306",
    "风险排查审批流程环节ID": "Z-106306",
    "风险排查审批编号": "Z-106306",
    "风险排查审批名称": "风险排查审批流程管理-4",
    "发起风险排查审批状态": "已启用",
    "发起风险排查审批时间": "2026-05-08 10:08:06",
    "风险排查审批属性": "已启用",
    "风险排查审批发起时间": "2026-05-08 10:08:06",
    "风险排查审批流程id": "已启用",
    "风险排查审批流程环节": "已启用",
    "风险排查审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 5,
    "风险排查审批ID": "Z-114225",
    "风险排查审批流程环节ID": "Z-114225",
    "风险排查审批编号": "Z-114225",
    "风险排查审批名称": "风险排查审批流程管理-5",
    "发起风险排查审批状态": "已停用",
    "发起风险排查审批时间": "2026-05-08 10:42:31",
    "风险排查审批属性": "已停用",
    "风险排查审批发起时间": "2026-05-08 10:42:31",
    "风险排查审批流程id": "已停用",
    "风险排查审批流程环节": "已停用",
    "风险排查审批创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 6,
    "风险排查审批ID": "Z-122144",
    "风险排查审批流程环节ID": "Z-122144",
    "风险排查审批编号": "Z-122144",
    "风险排查审批名称": "风险排查审批流程管理-6",
    "发起风险排查审批状态": "正常",
    "发起风险排查审批时间": "2026-05-08 11:16:09",
    "风险排查审批属性": "正常",
    "风险排查审批发起时间": "2026-05-08 11:16:09",
    "风险排查审批流程id": "正常",
    "风险排查审批流程环节": "正常",
    "风险排查审批创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 7,
    "风险排查审批ID": "Z-130063",
    "风险排查审批流程环节ID": "Z-130063",
    "风险排查审批编号": "Z-130063",
    "风险排查审批名称": "风险排查审批流程管理-7",
    "发起风险排查审批状态": "异常",
    "发起风险排查审批时间": "2026-05-08 14:03:52",
    "风险排查审批属性": "异常",
    "风险排查审批发起时间": "2026-05-08 14:03:52",
    "风险排查审批流程id": "异常",
    "风险排查审批流程环节": "异常",
    "风险排查审批创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 8,
    "风险排查审批ID": "Z-137982",
    "风险排查审批流程环节ID": "Z-137982",
    "风险排查审批编号": "Z-137982",
    "风险排查审批名称": "风险排查审批流程管理-8",
    "发起风险排查审批状态": "超时",
    "发起风险排查审批时间": "2026-05-08 15:21:37",
    "风险排查审批属性": "超时",
    "风险排查审批发起时间": "2026-05-08 15:21:37",
    "风险排查审批流程id": "超时",
    "风险排查审批流程环节": "超时",
    "风险排查审批创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 9,
    "风险排查审批ID": "Z-145901",
    "风险排查审批流程环节ID": "Z-145901",
    "风险排查审批编号": "Z-145901",
    "风险排查审批名称": "风险排查审批流程管理-9",
    "发起风险排查审批状态": "已取消",
    "发起风险排查审批时间": "2026-05-08 16:08:25",
    "风险排查审批属性": "已取消",
    "风险排查审批发起时间": "2026-05-08 16:08:25",
    "风险排查审批流程id": "已取消",
    "风险排查审批流程环节": "已取消",
    "风险排查审批创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 10,
    "风险排查审批ID": "Z-153820",
    "风险排查审批流程环节ID": "Z-153820",
    "风险排查审批编号": "Z-153820",
    "风险排查审批名称": "风险排查审批流程管理-10",
    "发起风险排查审批状态": "已驳回",
    "发起风险排查审批时间": "2026-05-09 08:33:11",
    "风险排查审批属性": "已驳回",
    "风险排查审批发起时间": "2026-05-09 08:33:11",
    "风险排查审批流程id": "已驳回",
    "风险排查审批流程环节": "已驳回",
    "风险排查审批创建时间": "2026-05-09 08:33:11"
  }
];
const tableColumns = [
  {
