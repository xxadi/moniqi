    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("网段扫描稽核", "audit")'>网段扫描稽核</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网段扫描稽核信息", "config")'>修改网段扫描稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除网段扫描稽核信息")'>删除网段扫描稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网段扫描稽核列表", "detail")'>查询网段扫描稽核列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网段扫描稽核详情", "detail")'>查询网段扫描稽核详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入网段扫描稽核")'>批量导入网段扫描稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("网段扫描稽核导出")'>网段扫描稽核导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("网段扫描稽核监控", "log")'>网段扫描稽核监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("网段扫描稽核监控告警", "alert")'>网段扫描稽核监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-1",
    "新增网段扫描稽核状态": "已启用",
    "新增网段扫描稽核时间": "2026-05-08 15:21:37",
    "网段扫描稽核属性": "已启用",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-2",
    "新增网段扫描稽核状态": "已停用",
    "新增网段扫描稽核时间": "2026-05-08 16:08:25",
    "网段扫描稽核属性": "已停用",
    "网段扫描稽核创建时间": "2026-05-08 16:08:25",
    "网段扫描稽核所属部门": "数据管理部",
    "网段扫描稽核负责人": "admin",
    "网段扫描稽核类型": "已停用",
    "网段扫描稽核规则": "已停用",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-3",
    "新增网段扫描稽核状态": "正常",
    "新增网段扫描稽核时间": "2026-05-09 08:33:11",
    "网段扫描稽核属性": "正常",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-4",
    "新增网段扫描稽核状态": "异常",
    "新增网段扫描稽核时间": "2026-05-09 09:47:56",
    "网段扫描稽核属性": "异常",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-5",
    "新增网段扫描稽核状态": "超时",
    "新增网段扫描稽核时间": "2026-05-08 09:12:18",
    "网段扫描稽核属性": "超时",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-6",
    "新增网段扫描稽核状态": "已取消",
    "新增网段扫描稽核时间": "2026-05-08 09:35:44",
    "网段扫描稽核属性": "已取消",
  ...
  },
  {
    ...
    "网段扫描稽核名称": "网段扫描稽核管理-7",
    "新增网段扫描稽核状态": "已驳回",
    "新增网段扫描稽核时间": "2026-05-08 10:08:06",
    "网段扫描稽核属性": "已驳回",
