    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部上报数据完整性审批流程", "workflow")'>发起工信部上报数据完整性审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据完整性审批指派信息", "form")'>新增工信部上报数据完整性审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据完整性审批流程节点", "form")'>新增工信部上报数据完整性审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部上报数据完整性审批流程节点信息", "config")'>修改工信部上报数据完整性审批流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批流程节点删除", "operation")'>工信部上报数据完整性审批流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批流程节点查询", "detail")'>工信部上报数据完整性审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批附件上传", "form")'>工信部上报数据完整性审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批流程图查看", "preview")'>工信部上报数据完整性审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批流程通知", "audit")'>工信部上报数据完整性审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批结果逐级审批", "audit")'>工信部上报数据完整性审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据完整性审批结果拒绝和驳回", "approval")'>工信部上报数据完整性审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部上报数据完整性审批ID": "Z-76257",
    "工信部上报数据完整性审批流程环节ID": "Z-76257",
    "工信部上报数据完整性审批编号": "Z-76257",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-1",
    "发起工信部上报数据完整性审批状态": "处理中",
    "发起工信部上报数据完整性审批时间": "2026-05-08 16:08:25",
    "工信部上报数据完整性审批属性": "处理中",
    "工信部上报数据完整性审批发起时间": "2026-05-08 16:08:25",
    "工信部上报数据完整性审批流程id": "处理中",
    "工信部上报数据完整性审批流程环节": "处理中",
    "工信部上报数据完整性审批创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "工信部上报数据完整性审批ID": "Z-84176",
    "工信部上报数据完整性审批流程环节ID": "Z-84176",
    "工信部上报数据完整性审批编号": "Z-84176",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-2",
    "发起工信部上报数据完整性审批状态": "待处理",
    "发起工信部上报数据完整性审批时间": "2026-05-09 08:33:11",
    "工信部上报数据完整性审批属性": "待处理",
    "工信部上报数据完整性审批发起时间": "2026-05-09 08:33:11",
    "工信部上报数据完整性审批流程id": "待处理",
    "工信部上报数据完整性审批流程环节": "待处理",
    "工信部上报数据完整性审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "工信部上报数据完整性审批ID": "Z-92095",
    "工信部上报数据完整性审批流程环节ID": "Z-92095",
    "工信部上报数据完整性审批编号": "Z-92095",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-3",
    "发起工信部上报数据完整性审批状态": "处理失败",
    "发起工信部上报数据完整性审批时间": "2026-05-09 09:47:56",
    "工信部上报数据完整性审批属性": "处理失败",
    "工信部上报数据完整性审批发起时间": "2026-05-09 09:47:56",
    "工信部上报数据完整性审批流程id": "处理失败",
    "工信部上报数据完整性审批流程环节": "处理失败",
    "工信部上报数据完整性审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "工信部上报数据完整性审批ID": "Z-100014",
    "工信部上报数据完整性审批流程环节ID": "Z-100014",
    "工信部上报数据完整性审批编号": "Z-100014",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-4",
    "发起工信部上报数据完整性审批状态": "已暂停",
    "发起工信部上报数据完整性审批时间": "2026-05-08 09:12:18",
    "工信部上报数据完整性审批属性": "已暂停",
    "工信部上报数据完整性审批发起时间": "2026-05-08 09:12:18",
    "工信部上报数据完整性审批流程id": "已暂停",
    "工信部上报数据完整性审批流程环节": "已暂停",
    "工信部上报数据完整性审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "工信部上报数据完整性审批ID": "Z-107933",
    "工信部上报数据完整性审批流程环节ID": "Z-107933",
    "工信部上报数据完整性审批编号": "Z-107933",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-5",
    "发起工信部上报数据完整性审批状态": "已完成",
    "发起工信部上报数据完整性审批时间": "2026-05-08 09:35:44",
    "工信部上报数据完整性审批属性": "已完成",
    "工信部上报数据完整性审批发起时间": "2026-05-08 09:35:44",
    "工信部上报数据完整性审批流程id": "已完成",
    "工信部上报数据完整性审批流程环节": "已完成",
    "工信部上报数据完整性审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "工信部上报数据完整性审批ID": "Z-115852",
    "工信部上报数据完整性审批流程环节ID": "Z-115852",
    "工信部上报数据完整性审批编号": "Z-115852",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-6",
    "发起工信部上报数据完整性审批状态": "排队中",
    "发起工信部上报数据完整性审批时间": "2026-05-08 10:08:06",
    "工信部上报数据完整性审批属性": "排队中",
    "工信部上报数据完整性审批发起时间": "2026-05-08 10:08:06",
    "工信部上报数据完整性审批流程id": "排队中",
    "工信部上报数据完整性审批流程环节": "排队中",
    "工信部上报数据完整性审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "工信部上报数据完整性审批ID": "Z-123771",
    "工信部上报数据完整性审批流程环节ID": "Z-123771",
    "工信部上报数据完整性审批编号": "Z-123771",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-7",
    "发起工信部上报数据完整性审批状态": "部分完成",
    "发起工信部上报数据完整性审批时间": "2026-05-08 10:42:31",
    "工信部上报数据完整性审批属性": "部分完成",
    "工信部上报数据完整性审批发起时间": "2026-05-08 10:42:31",
    "工信部上报数据完整性审批流程id": "部分完成",
    "工信部上报数据完整性审批流程环节": "部分完成",
    "工信部上报数据完整性审批创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "工信部上报数据完整性审批ID": "Z-131690",
    "工信部上报数据完整性审批流程环节ID": "Z-131690",
    "工信部上报数据完整性审批编号": "Z-131690",
    "工信部上报数据完整性审批名称": "工信部上报数据完整性审批流程管理-8",
    "发起工信部上报数据完整性审批状态": "已启用",
    "发起工信部上报数据完整性审批时间": "2026-05-08 11:16:09",
    "工信部上报数据完整性审批属性": "已启用",
    "工信部上报数据完整性审批发起时间": "2026-05-08 11:16:09",
    "工信部上报数据完整性审批流程id": "已启用",
    "工信部上报数据完整性审批流程环节": "已启用",
    "工信部上报数据完整性审批创建时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部上报数据完整性审批ID",
    "label": "工信部上报数据完整性审批ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据完整性审批流程环节ID",
    "label": "工信部上报数据完整性审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部上报数据完整性审批名称",
    "label": "工信部上报数据完整性审批名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "发起工信部上报数据完整性审批状态",
    "label": "发起工信部上报数据完整性审批状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "发起工信部上报数据完整性审批时间",
    "label": "发起工信部上报数据完整性审批时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部上报数据完整性审批属性",
    "label": "工信部上报数据完整性审批属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据完整性审批发起时间",
    "label": "工信部上报数据完整性审批发起时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部上报数据完整性审批流程id",
    "label": "工信部上报数据完整性审批流程id",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据完整性审批流程环节",
    "label": "工信部上报数据完整性审批流程环节",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据完整性审批创建时间",
    "label": "工信部上报数据完整性审批创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
...
const importTemplateRow = {
  ...
  "工信部上报数据完整性审批流程环节": "",
  "工信部上报数据完整性审批创建时间": "",
  "导入来源": "工信部上报数据完整性审批流程管理导入模板.xlsx"
};
