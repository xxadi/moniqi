    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报物理位置稽核信息", "form")'>新增资产上报物理位置稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产Location信息", "form")'>新增工信部资产Location信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产Location信息", "config")'>修改工信部资产Location信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产Location信息")'>删除工信部资产Location信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产Location监控", "log")'>工信部资产Location监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部资产Location监控告警", "alert")'>工信部资产Location监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产Location稽核", "audit")'>工信部资产Location稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产Location统计", "statistics")'>工信部资产Location统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产Location数据采集", "transform")'>工信部资产Location数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产Location数据转换", "transform")'>工信部资产Location数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产Location数据预处理", "transform")'>工信部资产Location数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报物理位置稽核信息", "config")'>修改资产上报物理位置稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报物理位置稽核信息")'>删除资产上报物理位置稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报物理位置稽核列表", "detail")'>查询资产上报物理位置稽核列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报物理位置稽核详情", "detail")'>查询资产上报物理位置稽核详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报物理位置稽核")'>批量导入资产上报物理位置稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("资产上报物理位置稽核导出")'>资产上报物理位置稽核导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产上报物理位置稽核ID": "G-45948",
    "资产上报物理位置稽核编号": "G-45948",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-1",
    "新增资产上报物理位置稽核状态": "超时",
    "新增资产上报物理位置稽核时间": "2026-05-09 08:33:11",
    "资产上报物理位置稽核属性": "超时",
    "资产上报物理位置稽核创建时间": "2026-05-09 08:33:11",
    "资产上报物理位置稽核所属部门": "安全运维部",
    "资产上报物理位置稽核负责人": "张三",
    "资产上报物理位置稽核类型": "超时",
    "资产上报物理位置稽核规则": "超时",
    "工信部资产LocationID": "G-45948"
  },
  {
    "ID": 2,
    "资产上报物理位置稽核ID": "G-53867",
    "资产上报物理位置稽核编号": "G-53867",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-2",
    "新增资产上报物理位置稽核状态": "已取消",
    "新增资产上报物理位置稽核时间": "2026-05-09 09:47:56",
    "资产上报物理位置稽核属性": "已取消",
    "资产上报物理位置稽核创建时间": "2026-05-09 09:47:56",
    "资产上报物理位置稽核所属部门": "网络管理部",
    "资产上报物理位置稽核负责人": "李四",
    "资产上报物理位置稽核类型": "已取消",
    "资产上报物理位置稽核规则": "已取消",
    "工信部资产LocationID": "G-53867"
  },
  {
    "ID": 3,
    "资产上报物理位置稽核ID": "G-61786",
    "资产上报物理位置稽核编号": "G-61786",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-3",
    "新增资产上报物理位置稽核状态": "已驳回",
    "新增资产上报物理位置稽核时间": "2026-05-08 09:12:18",
    "资产上报物理位置稽核属性": "已驳回",
    "资产上报物理位置稽核创建时间": "2026-05-08 09:12:18",
    "资产上报物理位置稽核所属部门": "资产管理部",
    "资产上报物理位置稽核负责人": "王五",
    "资产上报物理位置稽核类型": "已驳回",
    "资产上报物理位置稽核规则": "已驳回",
    "工信部资产LocationID": "G-61786"
  },
  {
    "ID": 4,
    "资产上报物理位置稽核ID": "G-69705",
    "资产上报物理位置稽核编号": "G-69705",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-4",
    "新增资产上报物理位置稽核状态": "待审核",
    "新增资产上报物理位置稽核时间": "2026-05-08 09:35:44",
    "资产上报物理位置稽核属性": "待审核",
    "资产上报物理位置稽核创建时间": "2026-05-08 09:35:44",
    "资产上报物理位置稽核所属部门": "信息安全部",
    "资产上报物理位置稽核负责人": "赵六",
    "资产上报物理位置稽核类型": "待审核",
    "资产上报物理位置稽核规则": "待审核",
    "工信部资产LocationID": "G-69705"
  },
  {
    "ID": 5,
    "资产上报物理位置稽核ID": "G-77624",
    "资产上报物理位置稽核编号": "G-77624",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-5",
    "新增资产上报物理位置稽核状态": "已处理",
    "新增资产上报物理位置稽核时间": "2026-05-08 10:08:06",
    "资产上报物理位置稽核属性": "已处理",
    "资产上报物理位置稽核创建时间": "2026-05-08 10:08:06",
    "资产上报物理位置稽核所属部门": "系统运维部",
    "资产上报物理位置稽核负责人": "system",
    "资产上报物理位置稽核类型": "已处理",
    "资产上报物理位置稽核规则": "已处理",
    "工信部资产LocationID": "G-77624"
  },
  {
    "ID": 6,
    "资产上报物理位置稽核ID": "G-85543",
    "资产上报物理位置稽核编号": "G-85543",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-6",
    "新增资产上报物理位置稽核状态": "处理中",
    "新增资产上报物理位置稽核时间": "2026-05-08 10:42:31",
    "资产上报物理位置稽核属性": "处理中",
    "资产上报物理位置稽核创建时间": "2026-05-08 10:42:31",
    "资产上报物理位置稽核所属部门": "数据管理部",
    "资产上报物理位置稽核负责人": "admin",
    "资产上报物理位置稽核类型": "处理中",
    "资产上报物理位置稽核规则": "处理中",
    "工信部资产LocationID": "G-85543"
  },
  {
    "ID": 7,
    "资产上报物理位置稽核ID": "G-93462",
    "资产上报物理位置稽核编号": "G-93462",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-7",
    "新增资产上报物理位置稽核状态": "待处理",
    "新增资产上报物理位置稽核时间": "2026-05-08 11:16:09",
    "资产上报物理位置稽核属性": "待处理",
    "资产上报物理位置稽核创建时间": "2026-05-08 11:16:09",
    "资产上报物理位置稽核所属部门": "安全运维部",
    "资产上报物理位置稽核负责人": "张三",
    "资产上报物理位置稽核类型": "待处理",
    "资产上报物理位置稽核规则": "待处理",
    "工信部资产LocationID": "G-93462"
  },
  {
    "ID": 8,
    "资产上报物理位置稽核ID": "G-101381",
    "资产上报物理位置稽核编号": "G-101381",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-8",
    "新增资产上报物理位置稽核状态": "处理失败",
    "新增资产上报物理位置稽核时间": "2026-05-08 14:03:52",
    "资产上报物理位置稽核属性": "处理失败",
    "资产上报物理位置稽核创建时间": "2026-05-08 14:03:52",
    "资产上报物理位置稽核所属部门": "网络管理部",
    "资产上报物理位置稽核负责人": "李四",
    "资产上报物理位置稽核类型": "处理失败",
    "资产上报物理位置稽核规则": "处理失败",
    "工信部资产LocationID": "G-101381"
  },
  {
    "ID": 9,
    "资产上报物理位置稽核ID": "G-109300",
    "资产上报物理位置稽核编号": "G-109300",
    "资产上报物理位置稽核名称": "资产上报物理位置稽核管理-9",
    "新增资产上报物理位置稽核状态": "已暂停",
    "新增资产上报物理位置稽核时间": "2026-05-08 15:21:37",
    "资产上报物理位置稽核属性": "已暂停",
    "资产上报物理位置稽核创建时间": "2026-05-08 15:21:37",
    "资产上报物理位置稽核所属部门": "资产管理部",
    "资产上报物理位置稽核负责人": "王五",
    "资产上报物理位置稽核类型": "已暂停",
    "资产上报物理位置稽核规则": "已暂停",
    "工信部资产LocationID": "G-109300"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部资产LocationID",
    "label": "工信部资产LocationID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
