    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增指令信息字段模型", "form")'>新增指令信息字段模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改指令信息字段模型", "config")'>修改指令信息字段模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除指令信息字段模型")'>删除指令信息字段模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询指令信息字段列表", "detail")'>查询指令信息字段列表</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "指令信息字段名称": "指令信息字段管理-1",
    "新增指令信息字段状态": "已驳回",
    "新增指令信息字段时间": "2026-05-08 09:12:18",
    "指令信息字段属性": "已驳回",
    "操作流水号": "S-52590",
    "操作用户": "张三",
    "指令信息字段创建时间": "2026-05-08 09:12:18",
    "指令信息字段所属部门": "安全运维部",
    "指令信息字段负责人": "张三",
    "指令信息字段类型": "已驳回"
  },
  {
    ...
    "指令信息字段名称": "指令信息字段管理-2",
    "新增指令信息字段状态": "待审核",
    "新增指令信息字段时间": "2026-05-08 09:35:44",
    "指令信息字段属性": "待审核",
    "操作流水号": "S-60509",
    "操作用户": "李四",
    "指令信息字段创建时间": "2026-05-08 09:35:44",
    "指令信息字段所属部门": "网络管理部",
    "指令信息字段负责人": "李四",
    "指令信息字段类型": "待审核"
  },
  {
    ...
    "指令信息字段名称": "指令信息字段管理-3",
    "新增指令信息字段状态": "已处理",
    "新增指令信息字段时间": "2026-05-08 10:08:06",
    "指令信息字段属性": "已处理",
    "操作流水号": "S-68428",
    "操作用户": "王五",
    "指令信息字段创建时间": "2026-05-08 10:08:06",
    "指令信息字段所属部门": "资产管理部",
    "指令信息字段负责人": "王五",
    "指令信息字段类型": "已处理"
  },
  {
    ...
    "指令信息字段名称": "指令信息字段管理-4",
    "新增指令信息字段状态": "处理中",
    "新增指令信息字段时间": "2026-05-08 10:42:31",
    "指令信息字段属性": "处理中",
    "操作流水号": "S-76347",
    "操作用户": "赵六",
    "指令信息字段创建时间": "2026-05-08 10:42:31",
    "指令信息字段所属部门": "信息安全部",
    "指令信息字段负责人": "赵六",
    "指令信息字段类型": "处理中"
  },
  {
    ...
    "指令信息字段名称": "指令信息字段管理-5",
    "新增指令信息字段状态": "待处理",
    "新增指令信息字段时间": "2026-05-08 11:16:09",
    "指令信息字段属性": "待处理",
    "操作流水号": "S-84266",
    "操作用户": "system",
    "指令信息字段创建时间": "2026-05-08 11:16:09",
    "指令信息字段所属部门": "系统运维部",
    "指令信息字段负责人": "system",
    "指令信息字段类型": "待处理"
  },
  {
    ...
    "指令信息字段名称": "指令信息字段管理-6",
    "新增指令信息字段状态": "处理失败",
    "新增指令信息字段时间": "2026-05-08 14:03:52",
    "指令信息字段属性": "处理失败",
    "操作流水号": "S-92185",
    "操作用户": "admin",
    "指令信息字段创建时间": "2026-05-08 14:03:52",
    "指令信息字段所属部门": "数据管理部",
    "指令信息字段负责人": "admin",
    "指令信息字段类型": "处理失败"
  }
