    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增反馈结果数据上报设置信息", "form")'>新增反馈结果数据上报设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改反馈结果数据上报设置信息", "config")'>修改反馈结果数据上报设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除反馈结果数据上报设置信息")'>删除反馈结果数据上报设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("反馈结果数据上报错误信息监控", "feedback")'>反馈结果数据上报错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("反馈结果数据上报错误事件通知", "feedback")'>反馈结果数据上报错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("反馈结果数据上报错误事件删除", "feedback")'>反馈结果数据上报错误事件删除</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("反馈结果数据上报错误事件查询", "feedback")'>反馈结果数据上报错误事件查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增反馈结果数据上报防篡改信息", "form")'>新增反馈结果数据上报防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改反馈结果数据上报防篡改信息", "config")'>修改反馈结果数据上报防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除反馈结果数据上报防篡改信息")'>删除反馈结果数据上报防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "反馈结果数据上报名称": "待处理",
    "新增反馈结果数据上报状态": "待处理",
    "新增反馈结果数据上报时间": "2026-05-08 10:08:06",
    "新增反馈结果数据上报设置时间_": "2026-05-08 10:08:06",
    "反馈结果数据上报属性": "待处理",
    "反馈结果数据上报创建时间": "2026-05-08 10:08:06",
    "新增反馈结果数据上报设置结果": "待处理",
    "反馈结果数据上报所属部门": "待处理",
    "反馈结果数据上报负责人": "待处理",
    "反馈结果数据上报类型": "待处理"
  },
  {
    ...
    "反馈结果数据上报名称": "处理失败",
    "新增反馈结果数据上报状态": "处理失败",
    "新增反馈结果数据上报时间": "2026-05-08 10:42:31",
    "新增反馈结果数据上报设置时间_": "2026-05-08 10:42:31",
    "反馈结果数据上报属性": "处理失败",
    "反馈结果数据上报创建时间": "2026-05-08 10:42:31",
    "新增反馈结果数据上报设置结果": "处理失败",
    "反馈结果数据上报所属部门": "处理失败",
    "反馈结果数据上报负责人": "处理失败",
    "反馈结果数据上报类型": "处理失败"
  },
  {
    ...
    "反馈结果数据上报名称": "已暂停",
    "新增反馈结果数据上报状态": "已暂停",
    "新增反馈结果数据上报时间": "2026-05-08 11:16:09",
    "新增反馈结果数据上报设置时间_": "2026-05-08 11:16:09",
    "反馈结果数据上报属性": "已暂停",
    "反馈结果数据上报创建时间": "2026-05-08 11:16:09",
    "新增反馈结果数据上报设置结果": "已暂停",
    "反馈结果数据上报所属部门": "已暂停",
    "反馈结果数据上报负责人": "已暂停",
    "反馈结果数据上报类型": "已暂停"
  },
  {
    ...
    "反馈结果数据上报名称": "已完成",
    "新增反馈结果数据上报状态": "已完成",
    "新增反馈结果数据上报时间": "2026-05-08 14:03:52",
    "新增反馈结果数据上报设置时间_": "2026-05-08 14:03:52",
    "反馈结果数据上报属性": "已完成",
    "反馈结果数据上报创建时间": "2026-05-08 14:03:52",
    "新增反馈结果数据上报设置结果": "已完成",
    "反馈结果数据上报所属部门": "已完成",
    "反馈结果数据上报负责人": "已完成",
    "反馈结果数据上报类型": "已完成"
  },
  {
    ...
    "反馈结果数据上报名称": "排队中",
    "新增反馈结果数据上报状态": "排队中",
    "新增反馈结果数据上报时间": "2026-05-08 15:21:37",
    "新增反馈结果数据上报设置时间_": "2026-05-08 15:21:37",
    "反馈结果数据上报属性": "排队中",
    "反馈结果数据上报创建时间": "2026-05-08 15:21:37",
    "新增反馈结果数据上报设置结果": "排队中",
    "反馈结果数据上报所属部门": "排队中",
    "反馈结果数据上报负责人": "排队中",
    "反馈结果数据上报类型": "排队中"
  },
  {
    ...
    "反馈结果数据上报名称": "部分完成",
    "新增反馈结果数据上报状态": "部分完成",
    "新增反馈结果数据上报时间": "2026-05-08 16:08:25",
    "新增反馈结果数据上报设置时间_": "2026-05-08 16:08:25",
    "反馈结果数据上报属性": "部分完成",
    "反馈结果数据上报创建时间": "2026-05-08 16:08:25",
    "新增反馈结果数据上报设置结果": "部分完成",
    "反馈结果数据上报所属部门": "部分完成",
    "反馈结果数据上报负责人": "部分完成",
    "反馈结果数据上报类型": "部分完成"
  },
  {
    ...
    "反馈结果数据上报名称": "已启用",
    "新增反馈结果数据上报状态": "已启用",
    "新增反馈结果数据上报时间": "2026-05-09 08:33:11",
    "新增反馈结果数据上报设置时间_": "2026-05-09 08:33:11",
    "反馈结果数据上报属性": "已启用",
    "反馈结果数据上报创建时间": "2026-05-09 08:33:11",
    "新增反馈结果数据上报设置结果": "已启用",
    "反馈结果数据上报所属部门": "已启用",
    "反馈结果数据上报负责人": "已启用",
    "反馈结果数据上报类型": "已启用"
  },
  {
    ...
    "反馈结果数据上报名称": "已停用",
    "新增反馈结果数据上报状态": "已停用",
    "新增反馈结果数据上报时间": "2026-05-09 09:47:56",
    "新增反馈结果数据上报设置时间_": "2026-05-09 09:47:56",
    "反馈结果数据上报属性": "已停用",
    "反馈结果数据上报创建时间": "2026-05-09 09:47:56",
    "新增反馈结果数据上报设置结果": "已停用",
    "反馈结果数据上报所属部门": "已停用",
    "反馈结果数据上报负责人": "已停用",
    "反馈结果数据上报类型": "已停用"
...
const tableColumns = [
  ...
  {
    "prop": "新增反馈结果数据上报设置时间_",
    "label": "新增反馈结果数据上报设置时间。",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
