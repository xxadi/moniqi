    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类型考核准确性信息表", "operation")'>资产类型考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产类型考核准确性稽核数据上传", "form")'>资产类型考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类型考核准确性稽核数据接口监控", "log")'>资产类型考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产标签考核准确性信息表", "operation")'>资产标签考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产标签考核准确性稽核数据上传", "form")'>资产标签考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产标签考核准确性稽核数据接口监控", "log")'>资产标签考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产型号考核准确性信息表", "operation")'>资产型号考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产型号考核准确性稽核数据上传", "form")'>资产型号考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号考核准确性稽核数据接口监控", "log")'>资产型号考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产类型考核准确性ID": "I-60380",
    "资产类型考核准确性编号": "I-60380",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-1",
    "资产类型考核准确性状态": "超时",
    "资产类型考核准确性时间": "2026-05-08 09:12:18",
    "资产类型考核准确性属性": "超时",
    "资产类型考核准确性创建时间": "2026-05-08 09:12:18",
    "资产类型考核准确性所属部门": "资产管理部",
    "资产类型考核准确性负责人": "王五",
    "资产类型考核准确性类型": "超时",
    "资产类型考核准确性规则": "超时",
  ...
  },
  {
    ...
    "资产类型考核准确性ID": "I-68299",
    "资产类型考核准确性编号": "I-68299",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-2",
    "资产类型考核准确性状态": "已取消",
    "资产类型考核准确性时间": "2026-05-08 09:35:44",
    "资产类型考核准确性属性": "已取消",
    "资产类型考核准确性创建时间": "2026-05-08 09:35:44",
    "资产类型考核准确性所属部门": "信息安全部",
    "资产类型考核准确性负责人": "赵六",
    "资产类型考核准确性类型": "已取消",
    "资产类型考核准确性规则": "已取消",
  ...
  },
  {
    ...
    "资产类型考核准确性ID": "I-76218",
    "资产类型考核准确性编号": "I-76218",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-3",
    "资产类型考核准确性状态": "已驳回",
    "资产类型考核准确性时间": "2026-05-08 10:08:06",
    "资产类型考核准确性属性": "已驳回",
    "资产类型考核准确性创建时间": "2026-05-08 10:08:06",
    "资产类型考核准确性所属部门": "系统运维部",
    "资产类型考核准确性负责人": "system",
    "资产类型考核准确性类型": "已驳回",
    "资产类型考核准确性规则": "已驳回",
  ...
  },
  {
    ...
    "资产类型考核准确性ID": "I-84137",
    "资产类型考核准确性编号": "I-84137",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-4",
    "资产类型考核准确性状态": "待审核",
    "资产类型考核准确性时间": "2026-05-08 10:42:31",
    "资产类型考核准确性属性": "待审核",
    "资产类型考核准确性创建时间": "2026-05-08 10:42:31",
    "资产类型考核准确性所属部门": "数据管理部",
    "资产类型考核准确性负责人": "admin",
    "资产类型考核准确性类型": "待审核",
    "资产类型考核准确性规则": "待审核",
  ...
  },
  {
    ...
    "资产类型考核准确性ID": "I-92056",
    "资产类型考核准确性编号": "I-92056",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-5",
    "资产类型考核准确性状态": "已处理",
    "资产类型考核准确性时间": "2026-05-08 11:16:09",
    "资产类型考核准确性属性": "已处理",
    "资产类型考核准确性创建时间": "2026-05-08 11:16:09",
    "资产类型考核准确性所属部门": "安全运维部",
    "资产类型考核准确性负责人": "张三",
    "资产类型考核准确性类型": "已处理",
    "资产类型考核准确性规则": "已处理",
  ...
  },
  {
    ...
    "资产类型考核准确性ID": "I-99975",
    "资产类型考核准确性编号": "I-99975",
    "资产类型考核准确性名称": "资产类型考核准确性指标管理-6",
    "资产类型考核准确性状态": "处理中",
    "资产类型考核准确性时间": "2026-05-08 14:03:52",
    "资产类型考核准确性属性": "处理中",
    "资产类型考核准确性创建时间": "2026-05-08 14:03:52",
    "资产类型考核准确性所属部门": "网络管理部",
    "资产类型考核准确性负责人": "李四",
    "资产类型考核准确性类型": "处理中",
    "资产类型考核准确性规则": "处理中",
