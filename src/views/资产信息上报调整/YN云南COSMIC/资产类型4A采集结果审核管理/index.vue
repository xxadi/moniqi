    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型4A采集结果审核信息表", "transform")'>资产类型4A采集结果审核信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产类型4A采集结果审核任务", "form")'>新增资产类型4A采集结果审核任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产类型4A采集结果审核任务")'>删除资产类型4A采集结果审核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类型4A采集结果审核任务", "config")'>修改资产类型4A采集结果审核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型4A采集结果审核任务", "detail")'>查询资产类型4A采集结果审核任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型4A采集结果审核任务启用/禁用", "transform")'>资产类型4A采集结果审核任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "结果审核ID": "M-29860",
    "资产类型4A采集结果审核编号": "M-29860",
    "资产类型4A采集结果审核名称": "已暂停",
    "资产类型4A采集结果审核状态": "已暂停",
    "资产类型4A采集结果审核时间": "2026-05-08 09:12:18",
    "资产类型4A采集结果审核属性": "已暂停",
    "资产类型4A采集结果审核创建时间": "2026-05-08 09:12:18",
    "审核ID": "M-29860",
    "资产类型4A采集结果审核所属部门": "已暂停",
    "资产类型4A采集结果审核负责人": "已暂停",
    "资产类型4A采集结果审核类型": "已暂停",
    "资产类型4A采集结果审核规则": "已暂停"
  },
  {
    "ID": 2,
    "结果审核ID": "M-37779",
    "资产类型4A采集结果审核编号": "M-37779",
    "资产类型4A采集结果审核名称": "已完成",
    "资产类型4A采集结果审核状态": "已完成",
    "资产类型4A采集结果审核时间": "2026-05-08 09:35:44",
    "资产类型4A采集结果审核属性": "已完成",
    "资产类型4A采集结果审核创建时间": "2026-05-08 09:35:44",
    "审核ID": "M-37779",
    "资产类型4A采集结果审核所属部门": "已完成",
    "资产类型4A采集结果审核负责人": "已完成",
    "资产类型4A采集结果审核类型": "已完成",
    "资产类型4A采集结果审核规则": "已完成"
  },
  {
    "ID": 3,
    "结果审核ID": "M-45698",
    "资产类型4A采集结果审核编号": "M-45698",
    "资产类型4A采集结果审核名称": "排队中",
    "资产类型4A采集结果审核状态": "排队中",
    "资产类型4A采集结果审核时间": "2026-05-08 10:08:06",
    "资产类型4A采集结果审核属性": "排队中",
    "资产类型4A采集结果审核创建时间": "2026-05-08 10:08:06",
    "审核ID": "M-45698",
    "资产类型4A采集结果审核所属部门": "排队中",
    "资产类型4A采集结果审核负责人": "排队中",
    "资产类型4A采集结果审核类型": "排队中",
    "资产类型4A采集结果审核规则": "排队中"
  },
  {
    "ID": 4,
    "结果审核ID": "M-53617",
    "资产类型4A采集结果审核编号": "M-53617",
    "资产类型4A采集结果审核名称": "部分完成",
    "资产类型4A采集结果审核状态": "部分完成",
    "资产类型4A采集结果审核时间": "2026-05-08 10:42:31",
    "资产类型4A采集结果审核属性": "部分完成",
    "资产类型4A采集结果审核创建时间": "2026-05-08 10:42:31",
    "审核ID": "M-53617",
    "资产类型4A采集结果审核所属部门": "部分完成",
    "资产类型4A采集结果审核负责人": "部分完成",
    "资产类型4A采集结果审核类型": "部分完成",
    "资产类型4A采集结果审核规则": "部分完成"
  },
  {
    "ID": 5,
    "结果审核ID": "M-61536",
    "资产类型4A采集结果审核编号": "M-61536",
    "资产类型4A采集结果审核名称": "已启用",
    "资产类型4A采集结果审核状态": "已启用",
    "资产类型4A采集结果审核时间": "2026-05-08 11:16:09",
    "资产类型4A采集结果审核属性": "已启用",
    "资产类型4A采集结果审核创建时间": "2026-05-08 11:16:09",
    "审核ID": "M-61536",
    "资产类型4A采集结果审核所属部门": "已启用",
    "资产类型4A采集结果审核负责人": "已启用",
    "资产类型4A采集结果审核类型": "已启用",
    "资产类型4A采集结果审核规则": "已启用"
  },
  {
    "ID": 6,
    "结果审核ID": "M-69455",
    "资产类型4A采集结果审核编号": "M-69455",
    "资产类型4A采集结果审核名称": "已停用",
    "资产类型4A采集结果审核状态": "已停用",
    "资产类型4A采集结果审核时间": "2026-05-08 14:03:52",
    "资产类型4A采集结果审核属性": "已停用",
    "资产类型4A采集结果审核创建时间": "2026-05-08 14:03:52",
    "审核ID": "M-69455",
    "资产类型4A采集结果审核所属部门": "已停用",
    "资产类型4A采集结果审核负责人": "已停用",
    "资产类型4A采集结果审核类型": "已停用",
    "资产类型4A采集结果审核规则": "已停用"
  }
...
const tableColumns = [
  ...
  {
    "prop": "资产类型4A采集结果审核属性",
    "label": "资产类型4A采集结果审核属性",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产类型4A采集结果审核创建时间",
    "label": "资产类型4A采集结果审核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产类型4A采集结果审核所属部门",
    "label": "资产类型4A采集结果审核所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产类型4A采集结果审核负责人",
    "label": "资产类型4A采集结果审核负责人",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
