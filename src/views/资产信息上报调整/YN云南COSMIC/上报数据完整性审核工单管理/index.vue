    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据完整性审核工单信息", "form")'>新增上报数据完整性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据完整性审核工单信息", "config")'>修改上报数据完整性审核工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据完整性审核工单信息")'>删除上报数据完整性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看上报数据完整性审核工单信息", "detail")'>查看上报数据完整性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据完整性审核工单附件文件上传", "form")'>上报数据完整性审核工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据完整性审核工单附件文件删除", "operation")'>上报数据完整性审核工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据完整性审核工单信息审批", "audit")'>上报数据完整性审核工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据完整性审核工单信息撤回", "operation")'>上报数据完整性审核工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据完整性审核工单信息终止", "operation")'>上报数据完整性审核工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据完整性审核工单信息派发提醒", "audit")'>上报数据完整性审核工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "上报数据完整性审核ID": "A-81874",
    "上报数据完整性审核编号": "A-81874",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-1",
    "新增上报数据完整性审核状态": "待处理",
    "新增上报数据完整性审核时间": "2026-05-08 11:16:09",
    "上报数据完整性审核属性": "待处理",
    "上报数据完整性审核创建时间": "2026-05-08 11:16:09",
    "上报数据完整性审核所属部门": "系统运维部",
    "上报数据完整性审核负责人": "system",
    "上报数据完整性审核类型": "待处理",
    "上报数据完整性审核规则": "待处理",
  ...
  },
  {
    ...
    "上报数据完整性审核ID": "A-89793",
    "上报数据完整性审核编号": "A-89793",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-2",
    "新增上报数据完整性审核状态": "处理失败",
    "新增上报数据完整性审核时间": "2026-05-08 14:03:52",
    "上报数据完整性审核属性": "处理失败",
    "上报数据完整性审核创建时间": "2026-05-08 14:03:52",
    "上报数据完整性审核所属部门": "数据管理部",
    "上报数据完整性审核负责人": "admin",
    "上报数据完整性审核类型": "处理失败",
    "上报数据完整性审核规则": "处理失败",
  ...
  },
  {
    ...
    "上报数据完整性审核ID": "A-97712",
    "上报数据完整性审核编号": "A-97712",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-3",
    "新增上报数据完整性审核状态": "已暂停",
    "新增上报数据完整性审核时间": "2026-05-08 15:21:37",
    "上报数据完整性审核属性": "已暂停",
    "上报数据完整性审核创建时间": "2026-05-08 15:21:37",
    "上报数据完整性审核所属部门": "安全运维部",
    "上报数据完整性审核负责人": "张三",
    "上报数据完整性审核类型": "已暂停",
    "上报数据完整性审核规则": "已暂停",
  ...
  {
    "ID": 4,
    "上报数据完整性审核ID": "A-105631",
    "上报数据完整性审核编号": "A-105631",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-4",
    "新增上报数据完整性审核状态": "已完成",
    "新增上报数据完整性审核时间": "2026-05-08 16:08:25",
    "上报数据完整性审核属性": "已完成",
    "上报数据完整性审核创建时间": "2026-05-08 16:08:25",
    "上报数据完整性审核所属部门": "网络管理部",
    "上报数据完整性审核负责人": "李四",
    "上报数据完整性审核类型": "已完成",
    "上报数据完整性审核规则": "已完成",
  ...
  {
    "ID": 5,
    "上报数据完整性审核ID": "A-113550",
    "上报数据完整性审核编号": "A-113550",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-5",
    "新增上报数据完整性审核状态": "排队中",
    "新增上报数据完整性审核时间": "2026-05-09 08:33:11",
    "上报数据完整性审核属性": "排队中",
    "上报数据完整性审核创建时间": "2026-05-09 08:33:11",
    "上报数据完整性审核所属部门": "资产管理部",
    "上报数据完整性审核负责人": "王五",
    "上报数据完整性审核类型": "排队中",
    "上报数据完整性审核规则": "排队中",
  ...
  {
    "ID": 6,
    "上报数据完整性审核ID": "A-121469",
    "上报数据完整性审核编号": "A-121469",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-6",
    "新增上报数据完整性审核状态": "部分完成",
    "新增上报数据完整性审核时间": "2026-05-09 09:47:56",
    "上报数据完整性审核属性": "部分完成",
    "上报数据完整性审核创建时间": "2026-05-09 09:47:56",
    "上报数据完整性审核所属部门": "信息安全部",
    "上报数据完整性审核负责人": "赵六",
    "上报数据完整性审核类型": "部分完成",
    "上报数据完整性审核规则": "部分完成",
  ...
  {
    "ID": 7,
    "上报数据完整性审核ID": "A-129388",
    "上报数据完整性审核编号": "A-129388",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-7",
    "新增上报数据完整性审核状态": "已启用",
    "新增上报数据完整性审核时间": "2026-05-08 09:12:18",
    "上报数据完整性审核属性": "已启用",
    "上报数据完整性审核创建时间": "2026-05-08 09:12:18",
    "上报数据完整性审核所属部门": "系统运维部",
    "上报数据完整性审核负责人": "system",
    "上报数据完整性审核类型": "已启用",
    "上报数据完整性审核规则": "已启用",
  ...
  {
    "ID": 8,
    "上报数据完整性审核ID": "A-137307",
    "上报数据完整性审核编号": "A-137307",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-8",
    "新增上报数据完整性审核状态": "已停用",
    "新增上报数据完整性审核时间": "2026-05-08 09:35:44",
    "上报数据完整性审核属性": "已停用",
    "上报数据完整性审核创建时间": "2026-05-08 09:35:44",
    "上报数据完整性审核所属部门": "数据管理部",
    "上报数据完整性审核负责人": "admin",
    "上报数据完整性审核类型": "已停用",
    "上报数据完整性审核规则": "已停用",
  ...
  {
    "ID": 9,
    "上报数据完整性审核ID": "A-145226",
    "上报数据完整性审核编号": "A-145226",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-9",
    "新增上报数据完整性审核状态": "正常",
    "新增上报数据完整性审核时间": "2026-05-08 10:08:06",
    "上报数据完整性审核属性": "正常",
    "上报数据完整性审核创建时间": "2026-05-08 10:08:06",
    "上报数据完整性审核所属部门": "安全运维部",
    "上报数据完整性审核负责人": "张三",
    "上报数据完整性审核类型": "正常",
    "上报数据完整性审核规则": "正常",
  ...
  {
    "ID": 10,
    "上报数据完整性审核ID": "A-153145",
    "上报数据完整性审核编号": "A-153145",
    "上报数据完整性审核名称": "上报数据完整性审核工单管理-10",
    "新增上报数据完整性审核状态": "异常",
    "新增上报数据完整性审核时间": "2026-05-08 10:42:31",
    "上报数据完整性审核属性": "异常",
    "上报数据完整性审核创建时间": "2026-05-08 10:42:31",
    "上报数据完整性审核所属部门": "网络管理部",
    "上报数据完整性审核负责人": "李四",
    "上报数据完整性审核类型": "异常",
    "上报数据完整性审核规则": "异常",
