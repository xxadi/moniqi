    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产sign设置信息", "form")'>新增工信部资产sign设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产sign设置信息", "config")'>修改工信部资产sign设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产sign设置信息")'>删除工信部资产sign设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产sign错误信息监控", "log")'>工信部资产sign错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产sign错误事件通知", "audit")'>工信部资产sign错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产sign错误事件通知删除", "operation")'>工信部资产sign错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产sign错误事件通知查询", "detail")'>工信部资产sign错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产sign防篡改信息", "form")'>新增工信部资产sign防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产sign防篡改信息", "config")'>修改工信部资产sign防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产sign防篡改信息")'>删除工信部资产sign防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产sign编号": "D-20465",
    "新增工信部资产sign状态": "处理中",
    "sign时间": "2026-05-08 14:03:52",
    "工信部资产sign设置时间_": "2026-05-08 14:03:52",
    "工信部资产sign状态": "处理中",
    "删除工信部资产sign状态": "处理中",
    "工信部资产signID": "D-20465",
    "工信部资产sign名称": "工信部资产sign管理-1",
    "工信部资产sign类型": "处理中",
    "工信部资产sign规则": "处理中",
    "工信部资产sign属性": "处理中"
  },
  {
    ...
    "工信部资产sign编号": "D-28384",
    "新增工信部资产sign状态": "待处理",
    "sign时间": "2026-05-08 15:21:37",
    "工信部资产sign设置时间_": "2026-05-08 15:21:37",
    "工信部资产sign状态": "待处理",
    "删除工信部资产sign状态": "待处理",
    "工信部资产signID": "D-28384",
    "工信部资产sign名称": "工信部资产sign管理-2",
    "工信部资产sign类型": "待处理",
    "工信部资产sign规则": "待处理",
    "工信部资产sign属性": "待处理"
  },
  {
    ...
    "工信部资产sign编号": "D-36303",
    "新增工信部资产sign状态": "处理失败",
    "sign时间": "2026-05-08 16:08:25",
    "工信部资产sign设置时间_": "2026-05-08 16:08:25",
    "工信部资产sign状态": "处理失败",
    "删除工信部资产sign状态": "处理失败",
    "工信部资产signID": "D-36303",
    "工信部资产sign名称": "工信部资产sign管理-3",
    "工信部资产sign类型": "处理失败",
    "工信部资产sign规则": "处理失败",
    "工信部资产sign属性": "处理失败"
  },
  {
    ...
    "工信部资产sign编号": "D-44222",
    "新增工信部资产sign状态": "已暂停",
    "sign时间": "2026-05-09 08:33:11",
    "工信部资产sign设置时间_": "2026-05-09 08:33:11",
    "工信部资产sign状态": "已暂停",
    "删除工信部资产sign状态": "已暂停",
    "工信部资产signID": "D-44222",
    "工信部资产sign名称": "工信部资产sign管理-4",
    "工信部资产sign类型": "已暂停",
    "工信部资产sign规则": "已暂停",
    "工信部资产sign属性": "已暂停"
  },
  {
    ...
    "工信部资产sign编号": "D-52141",
    "新增工信部资产sign状态": "已完成",
    "sign时间": "2026-05-09 09:47:56",
    "工信部资产sign设置时间_": "2026-05-09 09:47:56",
    "工信部资产sign状态": "已完成",
    "删除工信部资产sign状态": "已完成",
    "工信部资产signID": "D-52141",
    "工信部资产sign名称": "工信部资产sign管理-5",
    "工信部资产sign类型": "已完成",
    "工信部资产sign规则": "已完成",
    "工信部资产sign属性": "已完成"
  },
  {
    ...
    "工信部资产sign编号": "D-60060",
    "新增工信部资产sign状态": "排队中",
    "sign时间": "2026-05-08 09:12:18",
    "工信部资产sign设置时间_": "2026-05-08 09:12:18",
    "工信部资产sign状态": "排队中",
    "删除工信部资产sign状态": "排队中",
    "工信部资产signID": "D-60060",
    "工信部资产sign名称": "工信部资产sign管理-6",
    "工信部资产sign类型": "排队中",
    "工信部资产sign规则": "排队中",
    "工信部资产sign属性": "排队中"
  }
