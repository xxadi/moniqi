    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起IP地址资产上报流程", "workflow")'>发起IP地址资产上报流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP地址资产上报指派信息", "form")'>新增IP地址资产上报指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP地址资产上报流程", "form")'>新增IP地址资产上报流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP地址资产上报流程信息", "config")'>修改IP地址资产上报流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址资产上报流程删除", "operation")'>IP地址资产上报流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址资产上报流程查询", "detail")'>IP地址资产上报流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址资产上报附件上传", "form")'>IP地址资产上报附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址资产上报流程图查看", "preview")'>IP地址资产上报流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址资产上报流程通知", "audit")'>IP地址资产上报流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址资产上报结果逐级审批", "audit")'>IP地址资产上报结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址资产上报结果拒绝和驳回", "approval")'>IP地址资产上报结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "IP地址资产上报编号": "K-17092",
    "资产上报状态": "已暂停",
    "发起IP地址资产上报时间": "2026-05-08 10:08:06",
    "IP地址资产上报流程节点编号": "K-17092",
    "名称": "IP地址资产上报流程管理-1",
    "类型": "已暂停",
    "IP地址资产上报流程节点规则": "172.20.1.80",
    "IP地址资产上报流程节点属性": "172.20.1.80",
    "修改IP地址资产上报流程节点状态": "已暂停",
    "修改IP地址资产上报流程节点时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 2,
    "资产上报ID": "K-25011",
    ...
    "IP地址资产上报编号": "K-25011",
    "资产上报状态": "已完成",
    "发起IP地址资产上报时间": "2026-05-08 10:42:31",
    "IP地址资产上报流程节点编号": "K-25011",
    "名称": "IP地址资产上报流程管理-2",
    "类型": "已完成",
    "IP地址资产上报流程节点规则": "10.0.0.254",
    "IP地址资产上报流程节点属性": "10.0.0.254",
    "修改IP地址资产上报流程节点状态": "已完成",
    "修改IP地址资产上报流程节点时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 3,
    "资产上报ID": "K-32930",
    ...
    "IP地址资产上报编号": "K-32930",
    "资产上报状态": "排队中",
    "发起IP地址资产上报时间": "2026-05-08 11:16:09",
    "IP地址资产上报流程节点编号": "K-32930",
    "名称": "IP地址资产上报流程管理-3",
    "类型": "排队中",
    "IP地址资产上报流程节点规则": "10.10.1.100",
    "IP地址资产上报流程节点属性": "10.10.1.100",
    "修改IP地址资产上报流程节点状态": "排队中",
    "修改IP地址资产上报流程节点时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 4,
    "资产上报ID": "K-40849",
    ...
    "IP地址资产上报编号": "K-40849",
    "资产上报状态": "部分完成",
    "发起IP地址资产上报时间": "2026-05-08 14:03:52",
    "IP地址资产上报流程节点编号": "K-40849",
    "名称": "IP地址资产上报流程管理-4",
    "类型": "部分完成",
    "IP地址资产上报流程节点规则": "172.16.0.50",
    "IP地址资产上报流程节点属性": "172.16.0.50",
    "修改IP地址资产上报流程节点状态": "部分完成",
    "修改IP地址资产上报流程节点时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 5,
    "资产上报ID": "K-48768",
    ...
    "IP地址资产上报编号": "K-48768",
    "资产上报状态": "已启用",
    "发起IP地址资产上报时间": "2026-05-08 15:21:37",
    "IP地址资产上报流程节点编号": "K-48768",
    "名称": "IP地址资产上报流程管理-5",
    "类型": "已启用",
    "IP地址资产上报流程节点规则": "192.168.1.200",
    "IP地址资产上报流程节点属性": "192.168.1.200",
    "修改IP地址资产上报流程节点状态": "已启用",
    "修改IP地址资产上报流程节点时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 6,
    "资产上报ID": "K-56687",
    ...
    "IP地址资产上报编号": "K-56687",
    "资产上报状态": "已停用",
    "发起IP地址资产上报时间": "2026-05-08 16:08:25",
    "IP地址资产上报流程节点编号": "K-56687",
    "名称": "IP地址资产上报流程管理-6",
    "类型": "已停用",
    "IP地址资产上报流程节点规则": "10.20.5.30",
    "IP地址资产上报流程节点属性": "10.20.5.30",
    "修改IP地址资产上报流程节点状态": "已停用",
    "修改IP地址资产上报流程节点时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 7,
    "资产上报ID": "K-64606",
    ...
    "IP地址资产上报编号": "K-64606",
    "资产上报状态": "正常",
    "发起IP地址资产上报时间": "2026-05-09 08:33:11",
    "IP地址资产上报流程节点编号": "K-64606",
    "名称": "IP地址资产上报流程管理-7",
    "类型": "正常",
    "IP地址资产上报流程节点规则": "172.20.1.80",
    "IP地址资产上报流程节点属性": "172.20.1.80",
    "修改IP地址资产上报流程节点状态": "正常",
    "修改IP地址资产上报流程节点时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 8,
    "资产上报ID": "K-72525",
    ...
    "IP地址资产上报编号": "K-72525",
    "资产上报状态": "异常",
    "发起IP地址资产上报时间": "2026-05-09 09:47:56",
    "IP地址资产上报流程节点编号": "K-72525",
    "名称": "IP地址资产上报流程管理-8",
    "类型": "异常",
    "IP地址资产上报流程节点规则": "10.0.0.254",
    "IP地址资产上报流程节点属性": "10.0.0.254",
    "修改IP地址资产上报流程节点状态": "异常",
    "修改IP地址资产上报流程节点时间": "2026-05-09 09:47:56"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "IP地址资产上报流程节点属性",
    "label": "IP地址资产上报流程节点属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改IP地址资产上报流程节点状态",
    "label": "修改IP地址资产上报流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改IP地址资产上报流程节点时间",
    "label": "修改IP地址资产上报流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
