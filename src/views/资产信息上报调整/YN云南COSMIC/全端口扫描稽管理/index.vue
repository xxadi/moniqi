    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核", "audit")'>全端口扫描稽核</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描稽核任务设置信息", "form")'>新增全端口扫描稽核任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全端口扫描稽核任务设置信息", "config")'>修改全端口扫描稽核任务设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除全端口扫描稽核任务设置信息")'>删除全端口扫描稽核任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("全端口扫描稽核任务错误信息监控", "log")'>全端口扫描稽核任务错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核任务错误事件通知", "audit")'>全端口扫描稽核任务错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核任务错误事件通知删除", "operation")'>全端口扫描稽核任务错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核任务错误事件通知查询", "detail")'>全端口扫描稽核任务错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全端口扫描稽核信息", "config")'>修改全端口扫描稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除全端口扫描稽核信息")'>删除全端口扫描稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询全端口扫描稽核列表", "detail")'>查询全端口扫描稽核列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询全端口扫描稽核详情", "detail")'>查询全端口扫描稽核详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入全端口扫描稽核")'>批量导入全端口扫描稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("全端口扫描稽核导出")'>全端口扫描稽核导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("全端口扫描稽核监控", "log")'>全端口扫描稽核监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("全端口扫描稽核监控告警", "alert")'>全端口扫描稽核监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增漏报IP认领信息", "form")'>新增漏报IP认领信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改漏报IP认领信息", "config")'>修改漏报IP认领信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除漏报IP认领信息")'>删除漏报IP认领信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询漏报IP认领列表", "detail")'>查询漏报IP认领列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询漏报IP认领详情", "detail")'>查询漏报IP认领详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入漏报IP认领")'>批量导入漏报IP认领</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("漏报IP认领导出")'>漏报IP认领导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("漏报IP认领监控", "log")'>漏报IP认领监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("漏报IP认领监控告警", "alert")'>漏报IP认领监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "全端口扫描稽核ID": "G-20546",
    "全端口扫描稽核编号": "G-20546",
    "全端口扫描稽核名称": "全端口扫描稽管理-1",
    "新增全端口扫描稽核状态": "待处理",
    "新增全端口扫描稽核时间": "2026-05-08 15:21:37",
    "稽核属性": "待处理",
    "全端口扫描稽核创建时间": "2026-05-08 15:21:37",
    "全端口扫描稽核所属部门": "资产管理部",
    "全端口扫描稽核负责人": "王五",
    "全端口扫描稽核类型": "待处理",
    "全端口扫描稽核规则": "待处理",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-28465",
    "全端口扫描稽核编号": "G-28465",
    "全端口扫描稽核名称": "全端口扫描稽管理-2",
    "新增全端口扫描稽核状态": "处理失败",
    "新增全端口扫描稽核时间": "2026-05-08 16:08:25",
    "稽核属性": "处理失败",
    "全端口扫描稽核创建时间": "2026-05-08 16:08:25",
    "全端口扫描稽核所属部门": "信息安全部",
    "全端口扫描稽核负责人": "赵六",
    "全端口扫描稽核类型": "处理失败",
    "全端口扫描稽核规则": "处理失败",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-36384",
    "全端口扫描稽核编号": "G-36384",
    "全端口扫描稽核名称": "全端口扫描稽管理-3",
    "新增全端口扫描稽核状态": "已暂停",
    "新增全端口扫描稽核时间": "2026-05-09 08:33:11",
    "稽核属性": "已暂停",
    "全端口扫描稽核创建时间": "2026-05-09 08:33:11",
    "全端口扫描稽核所属部门": "系统运维部",
    "全端口扫描稽核负责人": "system",
    "全端口扫描稽核类型": "已暂停",
    "全端口扫描稽核规则": "已暂停",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-44303",
    "全端口扫描稽核编号": "G-44303",
    "全端口扫描稽核名称": "全端口扫描稽管理-4",
    "新增全端口扫描稽核状态": "已完成",
    "新增全端口扫描稽核时间": "2026-05-09 09:47:56",
    "稽核属性": "已完成",
    "全端口扫描稽核创建时间": "2026-05-09 09:47:56",
    "全端口扫描稽核所属部门": "数据管理部",
    "全端口扫描稽核负责人": "admin",
    "全端口扫描稽核类型": "已完成",
    "全端口扫描稽核规则": "已完成",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-52222",
    "全端口扫描稽核编号": "G-52222",
    "全端口扫描稽核名称": "全端口扫描稽管理-5",
    "新增全端口扫描稽核状态": "排队中",
    "新增全端口扫描稽核时间": "2026-05-08 09:12:18",
    "稽核属性": "排队中",
    "全端口扫描稽核创建时间": "2026-05-08 09:12:18",
    "全端口扫描稽核所属部门": "安全运维部",
    "全端口扫描稽核负责人": "张三",
    "全端口扫描稽核类型": "排队中",
    "全端口扫描稽核规则": "排队中",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-60141",
    "全端口扫描稽核编号": "G-60141",
    "全端口扫描稽核名称": "全端口扫描稽管理-6",
    "新增全端口扫描稽核状态": "部分完成",
    "新增全端口扫描稽核时间": "2026-05-08 09:35:44",
    "稽核属性": "部分完成",
    "全端口扫描稽核创建时间": "2026-05-08 09:35:44",
    "全端口扫描稽核所属部门": "网络管理部",
    "全端口扫描稽核负责人": "李四",
    "全端口扫描稽核类型": "部分完成",
    "全端口扫描稽核规则": "部分完成",
  ...
  },
  {
    ...
    "全端口扫描稽核ID": "G-68060",
    "全端口扫描稽核编号": "G-68060",
    "全端口扫描稽核名称": "全端口扫描稽管理-7",
    "新增全端口扫描稽核状态": "已启用",
    "新增全端口扫描稽核时间": "2026-05-08 10:08:06",
    "稽核属性": "已启用",
    "全端口扫描稽核创建时间": "2026-05-08 10:08:06",
    "全端口扫描稽核所属部门": "资产管理部",
    "全端口扫描稽核负责人": "王五",
    "全端口扫描稽核类型": "已启用",
    "全端口扫描稽核规则": "已启用",
