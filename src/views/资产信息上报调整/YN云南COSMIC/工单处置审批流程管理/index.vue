    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工单处置审批流程", "workflow")'>发起工单处置审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工单处置审批指派信息", "form")'>新增工单处置审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工单处置审批流程", "form")'>新增工单处置审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工单处置审批流程信息", "config")'>修改工单处置审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批流程删除", "operation")'>工单处置审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批流程查询", "detail")'>工单处置审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批附件上传", "form")'>工单处置审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批流程图查看", "preview")'>工单处置审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批流程通知", "audit")'>工单处置审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批结果逐级审批", "audit")'>工单处置审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置审批结果拒绝和驳回", "approval")'>工单处置审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流程环节ID": "R-16449",
    "工单处置": "处理中",
    "工单处置审批名称": "工单处置审批流程管理-1",
    "发起工单处置审批状态": "处理中",
    "工单处置审批用户": "赵六",
    "工单处置审批编号": "R-16449",
    "新增工单处置审批状态": "处理中",
    "新增工单处置审批时间": "2026-05-09 09:47:56",
    "工单处置审批属性": "处理中",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-09 09:47:56",
    "工单处置审批部门": "信息安全部"
  },
  {
    "ID": 2,
    ...
    "流程环节ID": "R-24368",
    "工单处置": "待处理",
    "工单处置审批名称": "工单处置审批流程管理-2",
    "发起工单处置审批状态": "待处理",
    "工单处置审批用户": "system",
    "工单处置审批编号": "R-24368",
    "新增工单处置审批状态": "待处理",
    "新增工单处置审批时间": "2026-05-08 09:12:18",
    "工单处置审批属性": "待处理",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 09:12:18",
    "工单处置审批部门": "系统运维部"
  },
  {
    "ID": 3,
    ...
    "流程环节ID": "R-32287",
    "工单处置": "处理失败",
    "工单处置审批名称": "工单处置审批流程管理-3",
    "发起工单处置审批状态": "处理失败",
    "工单处置审批用户": "admin",
    "工单处置审批编号": "R-32287",
    "新增工单处置审批状态": "处理失败",
    "新增工单处置审批时间": "2026-05-08 09:35:44",
    "工单处置审批属性": "处理失败",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 09:35:44",
    "工单处置审批部门": "数据管理部"
  },
  {
    "ID": 4,
    ...
    "流程环节ID": "R-40206",
    "工单处置": "已暂停",
    "工单处置审批名称": "工单处置审批流程管理-4",
    "发起工单处置审批状态": "已暂停",
    "工单处置审批用户": "张三",
    "工单处置审批编号": "R-40206",
    "新增工单处置审批状态": "已暂停",
    "新增工单处置审批时间": "2026-05-08 10:08:06",
    "工单处置审批属性": "已暂停",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 10:08:06",
    "工单处置审批部门": "安全运维部"
  },
  {
    "ID": 5,
    ...
    "流程环节ID": "R-48125",
    "工单处置": "已完成",
    "工单处置审批名称": "工单处置审批流程管理-5",
    "发起工单处置审批状态": "已完成",
    "工单处置审批用户": "李四",
    "工单处置审批编号": "R-48125",
    "新增工单处置审批状态": "已完成",
    "新增工单处置审批时间": "2026-05-08 10:42:31",
    "工单处置审批属性": "已完成",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 10:42:31",
    "工单处置审批部门": "网络管理部"
  },
  {
    "ID": 6,
    ...
    "流程环节ID": "R-56044",
    "工单处置": "排队中",
    "工单处置审批名称": "工单处置审批流程管理-6",
    "发起工单处置审批状态": "排队中",
    "工单处置审批用户": "王五",
    "工单处置审批编号": "R-56044",
    "新增工单处置审批状态": "排队中",
    "新增工单处置审批时间": "2026-05-08 11:16:09",
    "工单处置审批属性": "排队中",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 11:16:09",
    "工单处置审批部门": "资产管理部"
  },
  {
    "ID": 7,
    ...
    "流程环节ID": "R-63963",
    "工单处置": "部分完成",
    "工单处置审批名称": "工单处置审批流程管理-7",
    "发起工单处置审批状态": "部分完成",
    "工单处置审批用户": "赵六",
    "工单处置审批编号": "R-63963",
    "新增工单处置审批状态": "部分完成",
    "新增工单处置审批时间": "2026-05-08 14:03:52",
    "工单处置审批属性": "部分完成",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 14:03:52",
    "工单处置审批部门": "信息安全部"
  },
  {
    "ID": 8,
    ...
    "流程环节ID": "R-71882",
    "工单处置": "已启用",
    "工单处置审批名称": "工单处置审批流程管理-8",
    "发起工单处置审批状态": "已启用",
    "工单处置审批用户": "system",
    "工单处置审批编号": "R-71882",
    "新增工单处置审批状态": "已启用",
    "新增工单处置审批时间": "2026-05-08 15:21:37",
    "工单处置审批属性": "已启用",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 15:21:37",
    "工单处置审批部门": "系统运维部"
  },
  {
    "ID": 9,
    ...
    "流程环节ID": "R-79801",
    "工单处置": "已停用",
    "工单处置审批名称": "工单处置审批流程管理-9",
    "发起工单处置审批状态": "已停用",
    "工单处置审批用户": "admin",
    "工单处置审批编号": "R-79801",
    "新增工单处置审批状态": "已停用",
    "新增工单处置审批时间": "2026-05-08 16:08:25",
    "工单处置审批属性": "已停用",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-08 16:08:25",
    "工单处置审批部门": "数据管理部"
  },
  {
    "ID": 10,
    ...
    "流程环节ID": "R-87720",
    "工单处置": "正常",
    "工单处置审批名称": "工单处置审批流程管理-10",
    "发起工单处置审批状态": "正常",
    "工单处置审批用户": "张三",
    "工单处置审批编号": "R-87720",
    "新增工单处置审批状态": "正常",
    "新增工单处置审批时间": "2026-05-09 08:33:11",
    "工单处置审批属性": "正常",
    "工单处置审批时间_工单处置审批创建时间": "2026-05-09 08:33:11",
    "工单处置审批部门": "安全运维部"
  }
];
const tableColumns = [
  ...
  {
    "prop": "工单处置审批时间_工单处置审批创建时间",
    "label": "工单处置审批时间。工单处置审批创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
