    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部备案稽核信息", "form")'>新增工信部备案稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产备案信息", "form")'>新增工信部资产备案信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产备案信息", "config")'>修改工信部资产备案信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产备案信息")'>删除工信部资产备案信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产备案列表", "detail")'>查询工信部资产备案列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产备案下发回传同步", "sync")'>工信部资产备案下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产备案下发回传任务推送", "audit")'>工信部资产备案下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产备案数据下发", "operation")'>工信部资产备案数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产备案数据分析", "analysis")'>工信部资产备案数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产备案数据上报", "operation")'>工信部资产备案数据上报</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部备案稽核信息", "config")'>修改工信部备案稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部备案稽核信息")'>删除工信部备案稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部备案稽核列表", "detail")'>查询工信部备案稽核列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部备案稽核详情", "detail")'>查询工信部备案稽核详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入工信部备案稽核")'>批量导入工信部备案稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("工信部备案稽核导出")'>工信部备案稽核导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部备案稽核ID": "J-72653",
    "工信部备案稽核编号": "J-72653",
    "工信部备案稽核名称": "工信部备案稽核管理-1",
    "新增工信部备案稽核状态": "已取消",
    "新增工信部备案稽核时间": "2026-05-08 10:42:31",
    "工信部备案稽核属性": "已取消",
    "工信部备案稽核创建时间": "2026-05-08 10:42:31",
    "工信部备案稽核所属部门": "数据管理部",
    "工信部备案稽核负责人": "admin",
    "工信部备案稽核类型": "已取消",
    "工信部备案稽核规则": "已取消",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-80572",
    "工信部备案稽核编号": "J-80572",
    "工信部备案稽核名称": "工信部备案稽核管理-2",
    "新增工信部备案稽核状态": "已驳回",
    "新增工信部备案稽核时间": "2026-05-08 11:16:09",
    "工信部备案稽核属性": "已驳回",
    "工信部备案稽核创建时间": "2026-05-08 11:16:09",
    "工信部备案稽核所属部门": "安全运维部",
    "工信部备案稽核负责人": "张三",
    "工信部备案稽核类型": "已驳回",
    "工信部备案稽核规则": "已驳回",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-88491",
    "工信部备案稽核编号": "J-88491",
    "工信部备案稽核名称": "工信部备案稽核管理-3",
    "新增工信部备案稽核状态": "待审核",
    "新增工信部备案稽核时间": "2026-05-08 14:03:52",
    "工信部备案稽核属性": "待审核",
    "工信部备案稽核创建时间": "2026-05-08 14:03:52",
    "工信部备案稽核所属部门": "网络管理部",
    "工信部备案稽核负责人": "李四",
    "工信部备案稽核类型": "待审核",
    "工信部备案稽核规则": "待审核",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-96410",
    "工信部备案稽核编号": "J-96410",
    "工信部备案稽核名称": "工信部备案稽核管理-4",
    "新增工信部备案稽核状态": "已处理",
    "新增工信部备案稽核时间": "2026-05-08 15:21:37",
    "工信部备案稽核属性": "已处理",
    "工信部备案稽核创建时间": "2026-05-08 15:21:37",
    "工信部备案稽核所属部门": "资产管理部",
    "工信部备案稽核负责人": "王五",
    "工信部备案稽核类型": "已处理",
    "工信部备案稽核规则": "已处理",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-104329",
    "工信部备案稽核编号": "J-104329",
    "工信部备案稽核名称": "工信部备案稽核管理-5",
    "新增工信部备案稽核状态": "处理中",
    "新增工信部备案稽核时间": "2026-05-08 16:08:25",
    "工信部备案稽核属性": "处理中",
    "工信部备案稽核创建时间": "2026-05-08 16:08:25",
    "工信部备案稽核所属部门": "信息安全部",
    "工信部备案稽核负责人": "赵六",
    "工信部备案稽核类型": "处理中",
    "工信部备案稽核规则": "处理中",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-112248",
    "工信部备案稽核编号": "J-112248",
    "工信部备案稽核名称": "工信部备案稽核管理-6",
    "新增工信部备案稽核状态": "待处理",
    "新增工信部备案稽核时间": "2026-05-09 08:33:11",
    "工信部备案稽核属性": "待处理",
    "工信部备案稽核创建时间": "2026-05-09 08:33:11",
    "工信部备案稽核所属部门": "系统运维部",
    "工信部备案稽核负责人": "system",
    "工信部备案稽核类型": "待处理",
    "工信部备案稽核规则": "待处理",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-120167",
    "工信部备案稽核编号": "J-120167",
    "工信部备案稽核名称": "工信部备案稽核管理-7",
    "新增工信部备案稽核状态": "处理失败",
    "新增工信部备案稽核时间": "2026-05-09 09:47:56",
    "工信部备案稽核属性": "处理失败",
    "工信部备案稽核创建时间": "2026-05-09 09:47:56",
    "工信部备案稽核所属部门": "数据管理部",
    "工信部备案稽核负责人": "admin",
    "工信部备案稽核类型": "处理失败",
    "工信部备案稽核规则": "处理失败",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-128086",
    "工信部备案稽核编号": "J-128086",
    "工信部备案稽核名称": "工信部备案稽核管理-8",
    "新增工信部备案稽核状态": "已暂停",
    "新增工信部备案稽核时间": "2026-05-08 09:12:18",
    "工信部备案稽核属性": "已暂停",
    "工信部备案稽核创建时间": "2026-05-08 09:12:18",
    "工信部备案稽核所属部门": "安全运维部",
    "工信部备案稽核负责人": "张三",
    "工信部备案稽核类型": "已暂停",
    "工信部备案稽核规则": "已暂停",
  ...
  },
  {
    ...
    "工信部备案稽核ID": "J-136005",
    "工信部备案稽核编号": "J-136005",
    "工信部备案稽核名称": "工信部备案稽核管理-9",
    "新增工信部备案稽核状态": "已完成",
    "新增工信部备案稽核时间": "2026-05-08 09:35:44",
    "工信部备案稽核属性": "已完成",
    "工信部备案稽核创建时间": "2026-05-08 09:35:44",
    "工信部备案稽核所属部门": "网络管理部",
    "工信部备案稽核负责人": "李四",
    "工信部备案稽核类型": "已完成",
    "工信部备案稽核规则": "已完成",
