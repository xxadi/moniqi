    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计配置添加", "operation")'>资产漏洞审计配置添加</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产漏洞审计配置修改", "operation")'>资产漏洞审计配置修改</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计配置删除", "operation")'>资产漏洞审计配置删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计配置查询", "detail")'>资产漏洞审计配置查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产漏洞审计配置导出")'>资产漏洞审计配置导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计结果展示", "detail")'>资产漏洞审计结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起资产漏洞审计流程", "workflow")'>发起资产漏洞审计流程</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "添加名称": "资产漏洞审计配置管理-1",
    "配置添加编号": "K-45016",
    "资产漏洞审计配置添加编号": "K-45016",
    "操作人": "system",
    "资产漏洞审计配置添加操作时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "添加编号": "K-52935",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-2",
    "资产漏洞审计配置添加类型": "已停用",
    "资产漏洞审计配置添加规则": "已停用",
    "资产漏洞审计配置添加属性": "已停用",
    "资产漏洞审计配置添加状态": "已停用",
    ...
    "添加名称": "资产漏洞审计配置管理-2",
    "配置添加编号": "K-52935",
    "资产漏洞审计配置添加编号": "K-52935",
    "操作人": "admin",
    "资产漏洞审计配置添加操作时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "添加编号": "K-60854",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-3",
    "资产漏洞审计配置添加类型": "正常",
    "资产漏洞审计配置添加规则": "正常",
    "资产漏洞审计配置添加属性": "正常",
    "资产漏洞审计配置添加状态": "正常",
    ...
    "添加名称": "资产漏洞审计配置管理-3",
    "配置添加编号": "K-60854",
    "资产漏洞审计配置添加编号": "K-60854",
    "操作人": "张三",
    "资产漏洞审计配置添加操作时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "添加编号": "K-68773",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-4",
    "资产漏洞审计配置添加类型": "异常",
    "资产漏洞审计配置添加规则": "异常",
    "资产漏洞审计配置添加属性": "异常",
    "资产漏洞审计配置添加状态": "异常",
    ...
    "添加名称": "资产漏洞审计配置管理-4",
    "配置添加编号": "K-68773",
    "资产漏洞审计配置添加编号": "K-68773",
    "操作人": "李四",
    "资产漏洞审计配置添加操作时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "添加编号": "K-76692",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-5",
    "资产漏洞审计配置添加类型": "超时",
    "资产漏洞审计配置添加规则": "超时",
    "资产漏洞审计配置添加属性": "超时",
    "资产漏洞审计配置添加状态": "超时",
    ...
    "添加名称": "资产漏洞审计配置管理-5",
    "配置添加编号": "K-76692",
    "资产漏洞审计配置添加编号": "K-76692",
    "操作人": "王五",
    "资产漏洞审计配置添加操作时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "添加编号": "K-84611",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-6",
    "资产漏洞审计配置添加类型": "已取消",
    "资产漏洞审计配置添加规则": "已取消",
    "资产漏洞审计配置添加属性": "已取消",
    "资产漏洞审计配置添加状态": "已取消",
    ...
    "添加名称": "资产漏洞审计配置管理-6",
    "配置添加编号": "K-84611",
    "资产漏洞审计配置添加编号": "K-84611",
    "操作人": "赵六",
    "资产漏洞审计配置添加操作时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "添加编号": "K-92530",
    "资产漏洞审计配置添加名称": "资产漏洞审计配置管理-7",
    "资产漏洞审计配置添加类型": "已驳回",
    "资产漏洞审计配置添加规则": "已驳回",
    "资产漏洞审计配置添加属性": "已驳回",
    "资产漏洞审计配置添加状态": "已驳回",
    ...
    "添加名称": "资产漏洞审计配置管理-7",
    "配置添加编号": "K-92530",
    "资产漏洞审计配置添加编号": "K-92530",
    "操作人": "system",
    "资产漏洞审计配置添加操作时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
