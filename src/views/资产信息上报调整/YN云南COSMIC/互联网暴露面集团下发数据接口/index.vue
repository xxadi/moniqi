    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("互联网暴露面集团统计", "statistics")'>互联网暴露面集团统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("互联网暴露面集团数据采集", "transform")'>互联网暴露面集团数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("互联网暴露面集团数据转换", "transform")'>互联网暴露面集团数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("互联网暴露面集团数据预处理", "transform")'>互联网暴露面集团数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面集团下发接口信息", "form")'>新增暴露面集团下发接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面集团下发接口信息", "config")'>修改暴露面集团下发接口信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除暴露面集团下发接口信息")'>删除暴露面集团下发接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("检索暴露面集团下发接口列表", "api")'>检索暴露面集团下发接口列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("暴露面集团下发接口下发回传同步", "sync")'>暴露面集团下发接口下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面集团下发接口下发回传任务推送", "api")'>暴露面集团下发接口下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("暴露面集团下发接口数据下发", "api")'>暴露面集团下发接口数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("暴露面集团下发接口数据分析", "analysis")'>暴露面集团下发接口数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("暴露面集团下发接口数据上报", "api")'>暴露面集团下发接口数据上报</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("互联网暴露面集团下发回传同步", "sync")'>互联网暴露面集团下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面集团下发回传任务推送", "audit")'>互联网暴露面集团下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("互联网暴露面集团下发回传任务信息新增", "operation")'>互联网暴露面集团下发回传任务信息新增</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("互联网暴露面集团下发回传任务信息修改", "operation")'>互联网暴露面集团下发回传任务信息修改</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("互联网暴露面集团下发回传任务信息查询", "detail")'>互联网暴露面集团下发回传任务信息查询</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("互联网暴露面集团下发回传任务信息监控", "log")'>互联网暴露面集团下发回传任务信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("互联网暴露面集团下发回传任务结果对比", "operation")'>互联网暴露面集团下发回传任务结果对比</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("互联网暴露面集团下发回传结果同步", "sync")'>互联网暴露面集团下发回传结果同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面集团下发回传任务告警推送", "audit")'>互联网暴露面集团下发回传任务告警推送</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面集团下发回传任务告警信息生成", "audit")'>互联网暴露面集团下发回传任务告警信息生成</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "统计编号": "V-34003",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-1",
    "互联网暴露面集团统计类型": "处理失败",
    "互联网暴露面集团统计规则": "处理失败",
    "互联网暴露面集团统计属性": "处理失败",
    "互联网暴露面集团统计状态": "处理失败",
    "编号": "V-34003",
    "互联网暴露面集团统计编号": "V-34003",
    "采集资源编码": "处理失败",
    "互联网暴露面集团数据采集资源ip": "处理失败",
    "互联网暴露面集团数据采集资源类型": "处理失败"
  },
  {
    "ID": 2,
    "统计编号": "V-41922",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-2",
    "互联网暴露面集团统计类型": "已暂停",
    "互联网暴露面集团统计规则": "已暂停",
    "互联网暴露面集团统计属性": "已暂停",
    "互联网暴露面集团统计状态": "已暂停",
    "编号": "V-41922",
    "互联网暴露面集团统计编号": "V-41922",
    "采集资源编码": "已暂停",
    "互联网暴露面集团数据采集资源ip": "已暂停",
    "互联网暴露面集团数据采集资源类型": "已暂停"
  },
  {
    "ID": 3,
    "统计编号": "V-49841",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-3",
    "互联网暴露面集团统计类型": "已完成",
    "互联网暴露面集团统计规则": "已完成",
    "互联网暴露面集团统计属性": "已完成",
    "互联网暴露面集团统计状态": "已完成",
    "编号": "V-49841",
    "互联网暴露面集团统计编号": "V-49841",
    "采集资源编码": "已完成",
    "互联网暴露面集团数据采集资源ip": "已完成",
    "互联网暴露面集团数据采集资源类型": "已完成"
  },
  {
    "ID": 4,
    "统计编号": "V-57760",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-4",
    "互联网暴露面集团统计类型": "排队中",
    "互联网暴露面集团统计规则": "排队中",
    "互联网暴露面集团统计属性": "排队中",
    "互联网暴露面集团统计状态": "排队中",
    "编号": "V-57760",
    "互联网暴露面集团统计编号": "V-57760",
    "采集资源编码": "排队中",
    "互联网暴露面集团数据采集资源ip": "排队中",
    "互联网暴露面集团数据采集资源类型": "排队中"
  },
  {
    "ID": 5,
    "统计编号": "V-65679",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-5",
    "互联网暴露面集团统计类型": "部分完成",
    "互联网暴露面集团统计规则": "部分完成",
    "互联网暴露面集团统计属性": "部分完成",
    "互联网暴露面集团统计状态": "部分完成",
    "编号": "V-65679",
    "互联网暴露面集团统计编号": "V-65679",
    "采集资源编码": "部分完成",
    "互联网暴露面集团数据采集资源ip": "部分完成",
    "互联网暴露面集团数据采集资源类型": "部分完成"
  },
  {
    "ID": 6,
    "统计编号": "V-73598",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-6",
    "互联网暴露面集团统计类型": "已启用",
    "互联网暴露面集团统计规则": "已启用",
    "互联网暴露面集团统计属性": "已启用",
    "互联网暴露面集团统计状态": "已启用",
    "编号": "V-73598",
    "互联网暴露面集团统计编号": "V-73598",
    "采集资源编码": "已启用",
    "互联网暴露面集团数据采集资源ip": "已启用",
    "互联网暴露面集团数据采集资源类型": "已启用"
  },
  {
    "ID": 7,
    "统计编号": "V-81517",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-7",
    "互联网暴露面集团统计类型": "已停用",
    "互联网暴露面集团统计规则": "已停用",
    "互联网暴露面集团统计属性": "已停用",
    "互联网暴露面集团统计状态": "已停用",
    "编号": "V-81517",
    "互联网暴露面集团统计编号": "V-81517",
    "采集资源编码": "已停用",
    "互联网暴露面集团数据采集资源ip": "已停用",
    "互联网暴露面集团数据采集资源类型": "已停用"
  },
  {
    "ID": 8,
    "统计编号": "V-89436",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-8",
    "互联网暴露面集团统计类型": "正常",
    "互联网暴露面集团统计规则": "正常",
    "互联网暴露面集团统计属性": "正常",
    "互联网暴露面集团统计状态": "正常",
    "编号": "V-89436",
    "互联网暴露面集团统计编号": "V-89436",
    "采集资源编码": "正常",
    "互联网暴露面集团数据采集资源ip": "正常",
    "互联网暴露面集团数据采集资源类型": "正常"
  },
  {
    "ID": 9,
    "统计编号": "V-97355",
    "互联网暴露面集团统计名称": "互联网暴露面集团下发数据接口-9",
    "互联网暴露面集团统计类型": "异常",
    "互联网暴露面集团统计规则": "异常",
    "互联网暴露面集团统计属性": "异常",
    "互联网暴露面集团统计状态": "异常",
    "编号": "V-97355",
    "互联网暴露面集团统计编号": "V-97355",
    "采集资源编码": "异常",
    "互联网暴露面集团数据采集资源ip": "异常",
    "互联网暴露面集团数据采集资源类型": "异常"
  }
...
const tableColumns = [
  ...
  {
    "prop": "互联网暴露面集团数据采集资源ip",
    "label": "互联网暴露面集团数据采集资源ip",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "互联网暴露面集团数据采集资源类型",
    "label": "互联网暴露面集团数据采集资源类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
