    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部资产补录流程", "workflow")'>发起工信部资产补录流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产补录指派信息", "form")'>新增工信部资产补录指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产补录流程", "form")'>新增工信部资产补录流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产补录流程信息", "config")'>修改工信部资产补录流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产补录流程删除", "operation")'>工信部资产补录流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产补录流程查询", "detail")'>工信部资产补录流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产补录附件上传", "form")'>工信部资产补录附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部资产补录流程图查看", "preview")'>工信部资产补录流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产补录流程通知", "audit")'>工信部资产补录流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产补录结果逐级审批", "audit")'>工信部资产补录结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产补录结果拒绝和驳回", "approval")'>工信部资产补录结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部资产补录ID": "U-68686",
    "工信部资产补录流程环节ID": "U-68686",
    "工信部资产补录编号": "U-68686",
    "工信部资产补录名称": "工信部资产补录流程管理-1",
    "发起工信部资产补录状态": "已驳回",
    "发起工信部资产补录时间": "2026-05-08 15:21:37",
    "工信部资产补录属性": "已驳回",
    "工信部资产补录发起时间": "2026-05-08 15:21:37",
    "工信部资产补录流程id": "已驳回",
    "工信部资产补录流程环节": "已驳回",
    "工信部资产补录创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "工信部资产补录ID": "U-76605",
    "工信部资产补录流程环节ID": "U-76605",
    "工信部资产补录编号": "U-76605",
    "工信部资产补录名称": "工信部资产补录流程管理-2",
    "发起工信部资产补录状态": "待审核",
    "发起工信部资产补录时间": "2026-05-08 16:08:25",
    "工信部资产补录属性": "待审核",
    "工信部资产补录发起时间": "2026-05-08 16:08:25",
    "工信部资产补录流程id": "待审核",
    "工信部资产补录流程环节": "待审核",
    "工信部资产补录创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "工信部资产补录ID": "U-84524",
    "工信部资产补录流程环节ID": "U-84524",
    "工信部资产补录编号": "U-84524",
    "工信部资产补录名称": "工信部资产补录流程管理-3",
    "发起工信部资产补录状态": "已处理",
    "发起工信部资产补录时间": "2026-05-09 08:33:11",
    "工信部资产补录属性": "已处理",
    "工信部资产补录发起时间": "2026-05-09 08:33:11",
    "工信部资产补录流程id": "已处理",
    "工信部资产补录流程环节": "已处理",
    "工信部资产补录创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "工信部资产补录ID": "U-92443",
    "工信部资产补录流程环节ID": "U-92443",
    "工信部资产补录编号": "U-92443",
    "工信部资产补录名称": "工信部资产补录流程管理-4",
    "发起工信部资产补录状态": "处理中",
    "发起工信部资产补录时间": "2026-05-09 09:47:56",
    "工信部资产补录属性": "处理中",
    "工信部资产补录发起时间": "2026-05-09 09:47:56",
    "工信部资产补录流程id": "处理中",
    "工信部资产补录流程环节": "处理中",
    "工信部资产补录创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "工信部资产补录ID": "U-100362",
    "工信部资产补录流程环节ID": "U-100362",
    "工信部资产补录编号": "U-100362",
    "工信部资产补录名称": "工信部资产补录流程管理-5",
    "发起工信部资产补录状态": "待处理",
    "发起工信部资产补录时间": "2026-05-08 09:12:18",
    "工信部资产补录属性": "待处理",
    "工信部资产补录发起时间": "2026-05-08 09:12:18",
    "工信部资产补录流程id": "待处理",
    "工信部资产补录流程环节": "待处理",
    "工信部资产补录创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "工信部资产补录ID": "U-108281",
    "工信部资产补录流程环节ID": "U-108281",
    "工信部资产补录编号": "U-108281",
    "工信部资产补录名称": "工信部资产补录流程管理-6",
    "发起工信部资产补录状态": "处理失败",
    "发起工信部资产补录时间": "2026-05-08 09:35:44",
    "工信部资产补录属性": "处理失败",
    "工信部资产补录发起时间": "2026-05-08 09:35:44",
    "工信部资产补录流程id": "处理失败",
    "工信部资产补录流程环节": "处理失败",
    "工信部资产补录创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "工信部资产补录ID": "U-116200",
    "工信部资产补录流程环节ID": "U-116200",
    "工信部资产补录编号": "U-116200",
    "工信部资产补录名称": "工信部资产补录流程管理-7",
    "发起工信部资产补录状态": "已暂停",
    "发起工信部资产补录时间": "2026-05-08 10:08:06",
    "工信部资产补录属性": "已暂停",
    "工信部资产补录发起时间": "2026-05-08 10:08:06",
    "工信部资产补录流程id": "已暂停",
    "工信部资产补录流程环节": "已暂停",
    "工信部资产补录创建时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
