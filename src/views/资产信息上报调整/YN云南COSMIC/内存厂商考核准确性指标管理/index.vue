    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存厂商考核准确性信息表", "operation")'>内存厂商考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增内存厂商考核准确性上传任务", "form")'>新增内存厂商考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除内存厂商考核准确性上传任务")'>删除内存厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改内存厂商考核准确性上传任务", "config")'>修改内存厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询内存厂商考核准确性上传任务", "detail")'>查询内存厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存厂商考核准确性上传任务启用/禁用", "form")'>内存厂商考核准确性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("内存厂商考核准确性稽核数据上传", "form")'>内存厂商考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("内存厂商考核准确性稽核数据接口监控", "log")'>内存厂商考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存型号考核准确性信息表", "operation")'>内存型号考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("内存型号考核准确性稽核数据上传", "form")'>内存型号考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("内存型号考核准确性稽核数据接口监控", "log")'>内存型号考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "内存厂商考核准确性ID": "S-90264",
    "内存厂商考核准确性编号": "S-90264",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-1",
    "内存厂商考核准确性状态": "已启用",
    "内存厂商考核准确性时间": "2026-05-08 11:16:09",
    "内存厂商考核准确性属性": "已启用",
    "内存厂商考核准确性创建时间": "2026-05-08 11:16:09",
    "内存厂商考核准确性所属部门": "安全运维部",
    "内存厂商考核准确性负责人": "张三",
    "内存厂商考核准确性类型": "已启用",
    "内存厂商考核准确性规则": "已启用",
    "内存厂商考核准确性校验ID": "S-90264"
  },
  {
    "ID": 2,
    "内存厂商考核准确性ID": "S-98183",
    "内存厂商考核准确性编号": "S-98183",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-2",
    "内存厂商考核准确性状态": "已停用",
    "内存厂商考核准确性时间": "2026-05-08 14:03:52",
    "内存厂商考核准确性属性": "已停用",
    "内存厂商考核准确性创建时间": "2026-05-08 14:03:52",
    "内存厂商考核准确性所属部门": "网络管理部",
    "内存厂商考核准确性负责人": "李四",
    "内存厂商考核准确性类型": "已停用",
    "内存厂商考核准确性规则": "已停用",
    "内存厂商考核准确性校验ID": "S-98183"
  },
  {
    "ID": 3,
    "内存厂商考核准确性ID": "S-106102",
    "内存厂商考核准确性编号": "S-106102",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-3",
    "内存厂商考核准确性状态": "正常",
    "内存厂商考核准确性时间": "2026-05-08 15:21:37",
    "内存厂商考核准确性属性": "正常",
    "内存厂商考核准确性创建时间": "2026-05-08 15:21:37",
    "内存厂商考核准确性所属部门": "资产管理部",
    "内存厂商考核准确性负责人": "王五",
    "内存厂商考核准确性类型": "正常",
    "内存厂商考核准确性规则": "正常",
    "内存厂商考核准确性校验ID": "S-106102"
  },
  {
    "ID": 4,
    "内存厂商考核准确性ID": "S-114021",
    "内存厂商考核准确性编号": "S-114021",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-4",
    "内存厂商考核准确性状态": "异常",
    "内存厂商考核准确性时间": "2026-05-08 16:08:25",
    "内存厂商考核准确性属性": "异常",
    "内存厂商考核准确性创建时间": "2026-05-08 16:08:25",
    "内存厂商考核准确性所属部门": "信息安全部",
    "内存厂商考核准确性负责人": "赵六",
    "内存厂商考核准确性类型": "异常",
    "内存厂商考核准确性规则": "异常",
    "内存厂商考核准确性校验ID": "S-114021"
  },
  {
    "ID": 5,
    "内存厂商考核准确性ID": "S-121940",
    "内存厂商考核准确性编号": "S-121940",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-5",
    "内存厂商考核准确性状态": "超时",
    "内存厂商考核准确性时间": "2026-05-09 08:33:11",
    "内存厂商考核准确性属性": "超时",
    "内存厂商考核准确性创建时间": "2026-05-09 08:33:11",
    "内存厂商考核准确性所属部门": "系统运维部",
    "内存厂商考核准确性负责人": "system",
    "内存厂商考核准确性类型": "超时",
    "内存厂商考核准确性规则": "超时",
    "内存厂商考核准确性校验ID": "S-121940"
  },
  {
    "ID": 6,
    "内存厂商考核准确性ID": "S-129859",
    "内存厂商考核准确性编号": "S-129859",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-6",
    "内存厂商考核准确性状态": "已取消",
    "内存厂商考核准确性时间": "2026-05-09 09:47:56",
    "内存厂商考核准确性属性": "已取消",
    "内存厂商考核准确性创建时间": "2026-05-09 09:47:56",
    "内存厂商考核准确性所属部门": "数据管理部",
    "内存厂商考核准确性负责人": "admin",
    "内存厂商考核准确性类型": "已取消",
    "内存厂商考核准确性规则": "已取消",
    "内存厂商考核准确性校验ID": "S-129859"
  },
  {
    "ID": 7,
    "内存厂商考核准确性ID": "S-137778",
    "内存厂商考核准确性编号": "S-137778",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-7",
    "内存厂商考核准确性状态": "已驳回",
    "内存厂商考核准确性时间": "2026-05-08 09:12:18",
    "内存厂商考核准确性属性": "已驳回",
    "内存厂商考核准确性创建时间": "2026-05-08 09:12:18",
    "内存厂商考核准确性所属部门": "安全运维部",
    "内存厂商考核准确性负责人": "张三",
    "内存厂商考核准确性类型": "已驳回",
    "内存厂商考核准确性规则": "已驳回",
    "内存厂商考核准确性校验ID": "S-137778"
  },
  {
    "ID": 8,
    "内存厂商考核准确性ID": "S-145697",
    "内存厂商考核准确性编号": "S-145697",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-8",
    "内存厂商考核准确性状态": "待审核",
    "内存厂商考核准确性时间": "2026-05-08 09:35:44",
    "内存厂商考核准确性属性": "待审核",
    "内存厂商考核准确性创建时间": "2026-05-08 09:35:44",
    "内存厂商考核准确性所属部门": "网络管理部",
    "内存厂商考核准确性负责人": "李四",
    "内存厂商考核准确性类型": "待审核",
    "内存厂商考核准确性规则": "待审核",
    "内存厂商考核准确性校验ID": "S-145697"
  },
  {
    "ID": 9,
    "内存厂商考核准确性ID": "S-153616",
    "内存厂商考核准确性编号": "S-153616",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-9",
    "内存厂商考核准确性状态": "已处理",
    "内存厂商考核准确性时间": "2026-05-08 10:08:06",
    "内存厂商考核准确性属性": "已处理",
    "内存厂商考核准确性创建时间": "2026-05-08 10:08:06",
    "内存厂商考核准确性所属部门": "资产管理部",
    "内存厂商考核准确性负责人": "王五",
    "内存厂商考核准确性类型": "已处理",
    "内存厂商考核准确性规则": "已处理",
    "内存厂商考核准确性校验ID": "S-153616"
  },
  {
    "ID": 10,
    "内存厂商考核准确性ID": "S-161535",
    "内存厂商考核准确性编号": "S-161535",
    "内存厂商考核准确性名称": "内存厂商考核准确性指标管理-10",
    "内存厂商考核准确性状态": "处理中",
    "内存厂商考核准确性时间": "2026-05-08 10:42:31",
    "内存厂商考核准确性属性": "处理中",
    "内存厂商考核准确性创建时间": "2026-05-08 10:42:31",
    "内存厂商考核准确性所属部门": "信息安全部",
    "内存厂商考核准确性负责人": "赵六",
    "内存厂商考核准确性类型": "处理中",
    "内存厂商考核准确性规则": "处理中",
    "内存厂商考核准确性校验ID": "S-161535"
  }
];
const tableColumns = [
  {
