    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产上报信息推送接口", "api")'>工信部资产上报信息推送接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产上报信息", "form")'>新增工信部资产上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产上报信息", "config")'>修改工信部资产上报信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产上报信息")'>删除工信部资产上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产上报汇总表", "detail")'>查询工信部资产上报汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产上报详情", "detail")'>查询工信部资产上报详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入工信部资产上报")'>批量导入工信部资产上报</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("工信部资产上报数据导出")'>工信部资产上报数据导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部资产上报信息推送ID": "Z-73839",
    "工信部资产上报信息推送编号": "Z-73839",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-1",
    "工信部资产上报信息推送状态": "待审核",
    "工信部资产上报信息推送时间": "2026-05-09 09:47:56",
    "工信部资产上报信息推送属性": "待审核",
    "工信部资产上报信息推送创建时间": "2026-05-09 09:47:56",
    "工信部资产上报信息推送所属部门": "信息安全部",
    "工信部资产上报信息推送负责人": "赵六",
    "工信部资产上报信息推送类型": "待审核",
    "工信部资产上报信息推送规则": "待审核",
    "工信部资产上报ID": "Z-73839"
  ...
  {
    "ID": 2,
    "工信部资产上报信息推送ID": "Z-81758",
    "工信部资产上报信息推送编号": "Z-81758",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-2",
    "工信部资产上报信息推送状态": "已处理",
    "工信部资产上报信息推送时间": "2026-05-08 09:12:18",
    "工信部资产上报信息推送属性": "已处理",
    "工信部资产上报信息推送创建时间": "2026-05-08 09:12:18",
    "工信部资产上报信息推送所属部门": "系统运维部",
    "工信部资产上报信息推送负责人": "system",
    "工信部资产上报信息推送类型": "已处理",
    "工信部资产上报信息推送规则": "已处理",
    "工信部资产上报ID": "Z-81758"
  },
  {
    "ID": 3,
    "工信部资产上报信息推送ID": "Z-89677",
    "工信部资产上报信息推送编号": "Z-89677",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-3",
    "工信部资产上报信息推送状态": "处理中",
    "工信部资产上报信息推送时间": "2026-05-08 09:35:44",
    "工信部资产上报信息推送属性": "处理中",
    "工信部资产上报信息推送创建时间": "2026-05-08 09:35:44",
    "工信部资产上报信息推送所属部门": "数据管理部",
    "工信部资产上报信息推送负责人": "admin",
    "工信部资产上报信息推送类型": "处理中",
    "工信部资产上报信息推送规则": "处理中",
    "工信部资产上报ID": "Z-89677"
  },
  {
    "ID": 4,
    "工信部资产上报信息推送ID": "Z-97596",
    "工信部资产上报信息推送编号": "Z-97596",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-4",
    "工信部资产上报信息推送状态": "待处理",
    "工信部资产上报信息推送时间": "2026-05-08 10:08:06",
    "工信部资产上报信息推送属性": "待处理",
    "工信部资产上报信息推送创建时间": "2026-05-08 10:08:06",
    "工信部资产上报信息推送所属部门": "安全运维部",
    "工信部资产上报信息推送负责人": "张三",
    "工信部资产上报信息推送类型": "待处理",
    "工信部资产上报信息推送规则": "待处理",
    "工信部资产上报ID": "Z-97596"
  ...
  {
    "ID": 5,
    "工信部资产上报信息推送ID": "Z-105515",
    "工信部资产上报信息推送编号": "Z-105515",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-5",
    "工信部资产上报信息推送状态": "处理失败",
    "工信部资产上报信息推送时间": "2026-05-08 10:42:31",
    "工信部资产上报信息推送属性": "处理失败",
    "工信部资产上报信息推送创建时间": "2026-05-08 10:42:31",
    "工信部资产上报信息推送所属部门": "网络管理部",
    "工信部资产上报信息推送负责人": "李四",
    "工信部资产上报信息推送类型": "处理失败",
    "工信部资产上报信息推送规则": "处理失败",
    "工信部资产上报ID": "Z-105515"
  ...
  {
    "ID": 6,
    "工信部资产上报信息推送ID": "Z-113434",
    "工信部资产上报信息推送编号": "Z-113434",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-6",
    "工信部资产上报信息推送状态": "已暂停",
    "工信部资产上报信息推送时间": "2026-05-08 11:16:09",
    "工信部资产上报信息推送属性": "已暂停",
    "工信部资产上报信息推送创建时间": "2026-05-08 11:16:09",
    "工信部资产上报信息推送所属部门": "资产管理部",
    "工信部资产上报信息推送负责人": "王五",
    "工信部资产上报信息推送类型": "已暂停",
    "工信部资产上报信息推送规则": "已暂停",
    "工信部资产上报ID": "Z-113434"
  ...
  {
    "ID": 7,
    "工信部资产上报信息推送ID": "Z-121353",
    "工信部资产上报信息推送编号": "Z-121353",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-7",
    "工信部资产上报信息推送状态": "已完成",
    "工信部资产上报信息推送时间": "2026-05-08 14:03:52",
    "工信部资产上报信息推送属性": "已完成",
    "工信部资产上报信息推送创建时间": "2026-05-08 14:03:52",
    "工信部资产上报信息推送所属部门": "信息安全部",
    "工信部资产上报信息推送负责人": "赵六",
    "工信部资产上报信息推送类型": "已完成",
    "工信部资产上报信息推送规则": "已完成",
  ...
  {
    "ID": 8,
    "工信部资产上报信息推送ID": "Z-129272",
    "工信部资产上报信息推送编号": "Z-129272",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-8",
    "工信部资产上报信息推送状态": "排队中",
    "工信部资产上报信息推送时间": "2026-05-08 15:21:37",
    "工信部资产上报信息推送属性": "排队中",
    "工信部资产上报信息推送创建时间": "2026-05-08 15:21:37",
    "工信部资产上报信息推送所属部门": "系统运维部",
    "工信部资产上报信息推送负责人": "system",
    "工信部资产上报信息推送类型": "排队中",
    "工信部资产上报信息推送规则": "排队中",
  ...
  {
    "ID": 9,
    "工信部资产上报信息推送ID": "Z-137191",
    "工信部资产上报信息推送编号": "Z-137191",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-9",
    "工信部资产上报信息推送状态": "部分完成",
    "工信部资产上报信息推送时间": "2026-05-08 16:08:25",
    "工信部资产上报信息推送属性": "部分完成",
    "工信部资产上报信息推送创建时间": "2026-05-08 16:08:25",
    "工信部资产上报信息推送所属部门": "数据管理部",
    "工信部资产上报信息推送负责人": "admin",
    "工信部资产上报信息推送类型": "部分完成",
    "工信部资产上报信息推送规则": "部分完成",
  ...
  {
    "ID": 10,
    "工信部资产上报信息推送ID": "Z-145110",
    "工信部资产上报信息推送编号": "Z-145110",
    "工信部资产上报信息推送名称": "工信部资产上报信息推送接口-10",
    "工信部资产上报信息推送状态": "已启用",
    "工信部资产上报信息推送时间": "2026-05-09 08:33:11",
    "工信部资产上报信息推送属性": "已启用",
    "工信部资产上报信息推送创建时间": "2026-05-09 08:33:11",
    "工信部资产上报信息推送所属部门": "安全运维部",
    "工信部资产上报信息推送负责人": "张三",
    "工信部资产上报信息推送类型": "已启用",
    "工信部资产上报信息推送规则": "已启用",
...
const tableColumns = [
  ...
  {
    "prop": "工信部资产上报信息推送创建时间",
    "label": "工信部资产上报信息推送创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部资产上报信息推送所属部门",
    "label": "工信部资产上报信息推送所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
