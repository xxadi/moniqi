    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("工信部指令信息下发接口", "api")'>工信部指令信息下发接口</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "操作用户": "李四",
    "工信部指令信息编号": "Z-54235",
    "工信部指令信息名称": "工信部指令信息下发接口-1",
    "工信部指令信息状态": "异常",
    "工信部指令信息下发时间": "2026-05-08 14:03:52",
    "工信部指令信息属性": "异常",
    "工信部指令信息创建时间": "2026-05-08 14:03:52",
    "工信部指令信息所属部门": "网络管理部",
    "工信部指令信息负责人": "李四",
    "工信部指令信息类型": "异常"
  },
  {
    ...
    "操作用户": "王五",
    "工信部指令信息编号": "Z-62154",
    "工信部指令信息名称": "工信部指令信息下发接口-2",
    "工信部指令信息状态": "超时",
    "工信部指令信息下发时间": "2026-05-08 15:21:37",
    "工信部指令信息属性": "超时",
    "工信部指令信息创建时间": "2026-05-08 15:21:37",
    "工信部指令信息所属部门": "资产管理部",
    "工信部指令信息负责人": "王五",
    "工信部指令信息类型": "超时"
  },
  {
    ...
    "操作用户": "赵六",
    "工信部指令信息编号": "Z-70073",
    "工信部指令信息名称": "工信部指令信息下发接口-3",
    "工信部指令信息状态": "已取消",
    "工信部指令信息下发时间": "2026-05-08 16:08:25",
    "工信部指令信息属性": "已取消",
    "工信部指令信息创建时间": "2026-05-08 16:08:25",
    "工信部指令信息所属部门": "信息安全部",
    "工信部指令信息负责人": "赵六",
    "工信部指令信息类型": "已取消"
  },
  {
    ...
    "操作用户": "system",
    "工信部指令信息编号": "Z-77992",
    "工信部指令信息名称": "工信部指令信息下发接口-4",
    "工信部指令信息状态": "已驳回",
    "工信部指令信息下发时间": "2026-05-09 08:33:11",
    "工信部指令信息属性": "已驳回",
    "工信部指令信息创建时间": "2026-05-09 08:33:11",
    "工信部指令信息所属部门": "系统运维部",
    "工信部指令信息负责人": "system",
    "工信部指令信息类型": "已驳回"
  },
  {
    ...
    "操作用户": "admin",
    "工信部指令信息编号": "Z-85911",
    "工信部指令信息名称": "工信部指令信息下发接口-5",
    "工信部指令信息状态": "待审核",
    "工信部指令信息下发时间": "2026-05-09 09:47:56",
    "工信部指令信息属性": "待审核",
    "工信部指令信息创建时间": "2026-05-09 09:47:56",
    "工信部指令信息所属部门": "数据管理部",
    "工信部指令信息负责人": "admin",
    "工信部指令信息类型": "待审核"
  },
  {
    ...
    "操作用户": "张三",
    "工信部指令信息编号": "Z-93830",
    "工信部指令信息名称": "工信部指令信息下发接口-6",
    "工信部指令信息状态": "已处理",
    "工信部指令信息下发时间": "2026-05-08 09:12:18",
    "工信部指令信息属性": "已处理",
    "工信部指令信息创建时间": "2026-05-08 09:12:18",
    "工信部指令信息所属部门": "安全运维部",
    "工信部指令信息负责人": "张三",
    "工信部指令信息类型": "已处理"
  }
