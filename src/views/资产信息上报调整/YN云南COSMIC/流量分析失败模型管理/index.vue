    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析失败few模型数据上传", "analysis")'>流量分析失败few模型数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("流量分析失败few模型数据接口监控", "log")'>流量分析失败few模型数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询流量分析失败few模型汇总报告详情", "detail")'>查询流量分析失败few模型汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别信息表", "validate")'>自动化识别信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化识别任务", "form")'>新增自动化识别任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化识别模型", "form")'>新增自动化识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化识别模型", "config")'>修改自动化识别模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动化识别模型")'>删除自动化识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别查询", "detail")'>自动化识别查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别可视化展示", "detail")'>自动化识别可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "上传资源类型": "异常",
    "上传编号": "P-89403",
    "流量分析失败few模型数据上传分类": "异常",
    "流量分析失败few模型数据上传时间": "2026-05-08 10:42:31",
    "流量分析失败few模型数据上传操作人": "赵六",
    "结果编码": "异常",
    "流量分析失败few模型数据上传结果ip": "异常",
    "结果类型": "异常",
    "上传规则": "异常",
    "流量分析失败few模型数据上传结果编号": "P-89403"
  },
  {
    "ID": 2,
    "数据上传资源编码": "超时",
    ...
    "上传资源类型": "超时",
    "上传编号": "P-97322",
    "流量分析失败few模型数据上传分类": "超时",
    "流量分析失败few模型数据上传时间": "2026-05-08 11:16:09",
    "流量分析失败few模型数据上传操作人": "system",
    "结果编码": "超时",
    "流量分析失败few模型数据上传结果ip": "超时",
    "结果类型": "超时",
    "上传规则": "超时",
    "流量分析失败few模型数据上传结果编号": "P-97322"
  },
  {
    "ID": 3,
    "数据上传资源编码": "已取消",
    ...
    "上传资源类型": "已取消",
    "上传编号": "P-105241",
    "流量分析失败few模型数据上传分类": "已取消",
    "流量分析失败few模型数据上传时间": "2026-05-08 14:03:52",
    "流量分析失败few模型数据上传操作人": "admin",
    "结果编码": "已取消",
    "流量分析失败few模型数据上传结果ip": "已取消",
    "结果类型": "已取消",
    "上传规则": "已取消",
    "流量分析失败few模型数据上传结果编号": "P-105241"
  },
  {
    "ID": 4,
    "数据上传资源编码": "已驳回",
    ...
    "上传资源类型": "已驳回",
    "上传编号": "P-113160",
    "流量分析失败few模型数据上传分类": "已驳回",
    "流量分析失败few模型数据上传时间": "2026-05-08 15:21:37",
    "流量分析失败few模型数据上传操作人": "张三",
    "结果编码": "已驳回",
    "流量分析失败few模型数据上传结果ip": "已驳回",
    "结果类型": "已驳回",
    "上传规则": "已驳回",
    "流量分析失败few模型数据上传结果编号": "P-113160"
  },
  {
    "ID": 5,
    "数据上传资源编码": "待审核",
    ...
    "上传资源类型": "待审核",
    "上传编号": "P-121079",
    "流量分析失败few模型数据上传分类": "待审核",
    "流量分析失败few模型数据上传时间": "2026-05-08 16:08:25",
    "流量分析失败few模型数据上传操作人": "李四",
    "结果编码": "待审核",
    "流量分析失败few模型数据上传结果ip": "待审核",
    "结果类型": "待审核",
    "上传规则": "待审核",
    "流量分析失败few模型数据上传结果编号": "P-121079"
  },
  {
    "ID": 6,
    "数据上传资源编码": "已处理",
    ...
    "上传资源类型": "已处理",
    "上传编号": "P-128998",
    "流量分析失败few模型数据上传分类": "已处理",
    "流量分析失败few模型数据上传时间": "2026-05-09 08:33:11",
    "流量分析失败few模型数据上传操作人": "王五",
    "结果编码": "已处理",
    "流量分析失败few模型数据上传结果ip": "已处理",
    "结果类型": "已处理",
    "上传规则": "已处理",
    "流量分析失败few模型数据上传结果编号": "P-128998"
  },
  {
    "ID": 7,
    "数据上传资源编码": "处理中",
    ...
    "上传资源类型": "处理中",
    "上传编号": "P-136917",
    "流量分析失败few模型数据上传分类": "处理中",
    "流量分析失败few模型数据上传时间": "2026-05-09 09:47:56",
    "流量分析失败few模型数据上传操作人": "赵六",
    "结果编码": "处理中",
    "流量分析失败few模型数据上传结果ip": "处理中",
    "结果类型": "处理中",
    "上传规则": "处理中",
    "流量分析失败few模型数据上传结果编号": "P-136917"
  },
  {
    "ID": 8,
    "数据上传资源编码": "待处理",
    ...
    "上传资源类型": "待处理",
    "上传编号": "P-144836",
    "流量分析失败few模型数据上传分类": "待处理",
    "流量分析失败few模型数据上传时间": "2026-05-08 09:12:18",
    "流量分析失败few模型数据上传操作人": "system",
    "结果编码": "待处理",
    "流量分析失败few模型数据上传结果ip": "待处理",
    "结果类型": "待处理",
    "上传规则": "待处理",
    "流量分析失败few模型数据上传结果编号": "P-144836"
  },
  {
    "ID": 9,
    "数据上传资源编码": "处理失败",
    ...
    "上传资源类型": "处理失败",
    "上传编号": "P-152755",
    "流量分析失败few模型数据上传分类": "处理失败",
    "流量分析失败few模型数据上传时间": "2026-05-08 09:35:44",
    "流量分析失败few模型数据上传操作人": "admin",
    "结果编码": "处理失败",
    "流量分析失败few模型数据上传结果ip": "处理失败",
    "结果类型": "处理失败",
    "上传规则": "处理失败",
    "流量分析失败few模型数据上传结果编号": "P-152755"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "流量分析失败few模型数据上传分类",
    "label": "流量分析失败few模型数据上传分类",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "流量分析失败few模型数据上传时间",
    "label": "流量分析失败few模型数据上传时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "流量分析失败few模型数据上传操作人",
    "label": "流量分析失败few模型数据上传操作人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "流量分析失败few模型数据上传结果ip",
    "label": "流量分析失败few模型数据上传结果ip",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "流量分析失败few模型数据上传结果编号",
    "label": "流量分析失败few模型数据上传结果编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
