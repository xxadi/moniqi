    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部AssetNM告警信息", "config")'>修改工信部AssetNM告警信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部AssetNM告警信息")'>删除工信部AssetNM告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部AssetNM告警监控", "log")'>工信部AssetNM告警监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部AssetNM告警监控告警", "alert")'>工信部AssetNM告警监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM告警稽核", "audit")'>工信部AssetNM告警稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM告警统计", "statistics")'>工信部AssetNM告警统计</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM告警数据采集", "transform")'>工信部AssetNM告警数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM告警数据转换", "transform")'>工信部AssetNM告警数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM告警数据预处理", "transform")'>工信部AssetNM告警数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("系统名称更新接口", "api")'>系统名称更新接口</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部AssetNM告警编号": "G-40644",
    "名称": "工信部AssetNM告警管理-1",
    "类型": "已暂停",
    "工信部AssetNM告警规则": "已暂停",
    "工信部AssetNM告警属性": "已暂停",
    "修改工信部AssetNM告警状态": "已暂停",
    "修改工信部AssetNM告警时间": "2026-05-08 11:16:09",
    "修改人": "已暂停",
    "工信部AssetNM告警ID": "G-40644",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-1",
    "工信部AssetNM告警类型": "已暂停"
  },
  {
    "ID": 2,
    "工信部AssetNM告警编号": "G-48563",
    "名称": "工信部AssetNM告警管理-2",
    "类型": "已完成",
    "工信部AssetNM告警规则": "已完成",
    "工信部AssetNM告警属性": "已完成",
    "修改工信部AssetNM告警状态": "已完成",
    "修改工信部AssetNM告警时间": "2026-05-08 14:03:52",
    "修改人": "已完成",
    "工信部AssetNM告警ID": "G-48563",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-2",
    "工信部AssetNM告警类型": "已完成"
  },
  {
    "ID": 3,
    "工信部AssetNM告警编号": "G-56482",
    "名称": "工信部AssetNM告警管理-3",
    "类型": "排队中",
    "工信部AssetNM告警规则": "排队中",
    "工信部AssetNM告警属性": "排队中",
    "修改工信部AssetNM告警状态": "排队中",
    "修改工信部AssetNM告警时间": "2026-05-08 15:21:37",
    "修改人": "排队中",
    "工信部AssetNM告警ID": "G-56482",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-3",
    "工信部AssetNM告警类型": "排队中"
  },
  {
    "ID": 4,
    "工信部AssetNM告警编号": "G-64401",
    "名称": "工信部AssetNM告警管理-4",
    "类型": "部分完成",
    "工信部AssetNM告警规则": "部分完成",
    "工信部AssetNM告警属性": "部分完成",
    "修改工信部AssetNM告警状态": "部分完成",
    "修改工信部AssetNM告警时间": "2026-05-08 16:08:25",
    "修改人": "部分完成",
    "工信部AssetNM告警ID": "G-64401",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-4",
    "工信部AssetNM告警类型": "部分完成"
  },
  {
    "ID": 5,
    "工信部AssetNM告警编号": "G-72320",
    "名称": "工信部AssetNM告警管理-5",
    "类型": "已启用",
    "工信部AssetNM告警规则": "已启用",
    "工信部AssetNM告警属性": "已启用",
    "修改工信部AssetNM告警状态": "已启用",
    "修改工信部AssetNM告警时间": "2026-05-09 08:33:11",
    "修改人": "已启用",
    "工信部AssetNM告警ID": "G-72320",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-5",
    "工信部AssetNM告警类型": "已启用"
  },
  {
    "ID": 6,
    "工信部AssetNM告警编号": "G-80239",
    "名称": "工信部AssetNM告警管理-6",
    "类型": "已停用",
    "工信部AssetNM告警规则": "已停用",
    "工信部AssetNM告警属性": "已停用",
    "修改工信部AssetNM告警状态": "已停用",
    "修改工信部AssetNM告警时间": "2026-05-09 09:47:56",
    "修改人": "已停用",
    "工信部AssetNM告警ID": "G-80239",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-6",
    "工信部AssetNM告警类型": "已停用"
  },
  {
    "ID": 7,
    "工信部AssetNM告警编号": "G-88158",
    "名称": "工信部AssetNM告警管理-7",
    "类型": "正常",
    "工信部AssetNM告警规则": "正常",
    "工信部AssetNM告警属性": "正常",
    "修改工信部AssetNM告警状态": "正常",
    "修改工信部AssetNM告警时间": "2026-05-08 09:12:18",
    "修改人": "正常",
    "工信部AssetNM告警ID": "G-88158",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-7",
    "工信部AssetNM告警类型": "正常"
  },
  {
    "ID": 8,
    "工信部AssetNM告警编号": "G-96077",
    "名称": "工信部AssetNM告警管理-8",
    "类型": "异常",
    "工信部AssetNM告警规则": "异常",
    "工信部AssetNM告警属性": "异常",
    "修改工信部AssetNM告警状态": "异常",
    "修改工信部AssetNM告警时间": "2026-05-08 09:35:44",
    "修改人": "异常",
    "工信部AssetNM告警ID": "G-96077",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-8",
    "工信部AssetNM告警类型": "异常"
  },
  {
    "ID": 9,
    "工信部AssetNM告警编号": "G-103996",
    "名称": "工信部AssetNM告警管理-9",
    "类型": "超时",
    "工信部AssetNM告警规则": "超时",
    "工信部AssetNM告警属性": "超时",
    "修改工信部AssetNM告警状态": "超时",
    "修改工信部AssetNM告警时间": "2026-05-08 10:08:06",
    "修改人": "超时",
    "工信部AssetNM告警ID": "G-103996",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-9",
    "工信部AssetNM告警类型": "超时"
  },
  {
    "ID": 10,
    "工信部AssetNM告警编号": "G-111915",
    "名称": "工信部AssetNM告警管理-10",
    "类型": "已取消",
    "工信部AssetNM告警规则": "已取消",
    "工信部AssetNM告警属性": "已取消",
    "修改工信部AssetNM告警状态": "已取消",
    "修改工信部AssetNM告警时间": "2026-05-08 10:42:31",
    "修改人": "已取消",
    "工信部AssetNM告警ID": "G-111915",
    "工信部AssetNM告警名称": "工信部AssetNM告警管理-10",
    "工信部AssetNM告警类型": "已取消"
  }
];
const tableColumns = [
  ...
  {
    "prop": "工信部AssetNM告警属性",
    "label": "工信部AssetNM告警属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改工信部AssetNM告警状态",
    "label": "修改工信部AssetNM告警状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改工信部AssetNM告警时间",
    "label": "修改工信部AssetNM告警时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
