    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描任务信息", "form")'>新增全端口扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全端口扫描任务信息", "config")'>修改全端口扫描任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除全端口扫描任务信息")'>删除全端口扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询全端口扫描任务列表", "detail")'>查询全端口扫描任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询全端口扫描任务详情", "detail")'>查询全端口扫描任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入全端口扫描任务")'>批量导入全端口扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("全端口扫描任务导出")'>全端口扫描任务导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("全端口扫描任务监控", "log")'>全端口扫描任务监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("全端口扫描任务监控告警", "alert")'>全端口扫描任务监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "全端口扫描任务ID": "H-34795",
    "全端口扫描任务编号": "H-34795",
    "全端口扫描任务名称": "全端口扫描任务管理-1",
    "新增全端口扫描任务状态": "异常",
    "新增全端口扫描任务时间": "2026-05-08 14:03:52",
    "全端口扫描任务属性": "异常",
    "全端口扫描任务创建时间": "2026-05-08 14:03:52",
    "全端口扫描任务所属部门": "网络管理部",
    "全端口扫描任务负责人": "李四",
    "全端口扫描任务类型": "异常",
    "全端口扫描任务规则": "异常",
  ...
  },
  {
    ...
    "全端口扫描任务ID": "H-42714",
    "全端口扫描任务编号": "H-42714",
    "全端口扫描任务名称": "全端口扫描任务管理-2",
    "新增全端口扫描任务状态": "超时",
    "新增全端口扫描任务时间": "2026-05-08 15:21:37",
    "全端口扫描任务属性": "超时",
    "全端口扫描任务创建时间": "2026-05-08 15:21:37",
    "全端口扫描任务所属部门": "资产管理部",
    "全端口扫描任务负责人": "王五",
    "全端口扫描任务类型": "超时",
    "全端口扫描任务规则": "超时",
  ...
  },
  {
    ...
    "全端口扫描任务ID": "H-50633",
    "全端口扫描任务编号": "H-50633",
    "全端口扫描任务名称": "全端口扫描任务管理-3",
    "新增全端口扫描任务状态": "已取消",
    "新增全端口扫描任务时间": "2026-05-08 16:08:25",
    "全端口扫描任务属性": "已取消",
    "全端口扫描任务创建时间": "2026-05-08 16:08:25",
    "全端口扫描任务所属部门": "信息安全部",
    "全端口扫描任务负责人": "赵六",
    "全端口扫描任务类型": "已取消",
    "全端口扫描任务规则": "已取消",
  ...
  },
  {
    ...
    "全端口扫描任务ID": "H-58552",
    "全端口扫描任务编号": "H-58552",
    "全端口扫描任务名称": "全端口扫描任务管理-4",
    "新增全端口扫描任务状态": "已驳回",
    "新增全端口扫描任务时间": "2026-05-09 08:33:11",
    "全端口扫描任务属性": "已驳回",
    "全端口扫描任务创建时间": "2026-05-09 08:33:11",
    "全端口扫描任务所属部门": "系统运维部",
    "全端口扫描任务负责人": "system",
    "全端口扫描任务类型": "已驳回",
    "全端口扫描任务规则": "已驳回",
  ...
  },
  {
    ...
    "全端口扫描任务ID": "H-66471",
    "全端口扫描任务编号": "H-66471",
    "全端口扫描任务名称": "全端口扫描任务管理-5",
    "新增全端口扫描任务状态": "待审核",
    "新增全端口扫描任务时间": "2026-05-09 09:47:56",
    "全端口扫描任务属性": "待审核",
    "全端口扫描任务创建时间": "2026-05-09 09:47:56",
    "全端口扫描任务所属部门": "数据管理部",
    "全端口扫描任务负责人": "admin",
    "全端口扫描任务类型": "待审核",
    "全端口扫描任务规则": "待审核",
  ...
  },
  {
    ...
    "全端口扫描任务ID": "H-74390",
    "全端口扫描任务编号": "H-74390",
    "全端口扫描任务名称": "全端口扫描任务管理-6",
    "新增全端口扫描任务状态": "已处理",
    "新增全端口扫描任务时间": "2026-05-08 09:12:18",
    "全端口扫描任务属性": "已处理",
    "全端口扫描任务创建时间": "2026-05-08 09:12:18",
    "全端口扫描任务所属部门": "安全运维部",
    "全端口扫描任务负责人": "张三",
    "全端口扫描任务类型": "已处理",
    "全端口扫描任务规则": "已处理",
