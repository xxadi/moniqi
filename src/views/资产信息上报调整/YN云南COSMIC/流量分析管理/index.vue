    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义网络流量分析任务信息", "analysis")'>定义网络流量分析任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络流量分析任务信息", "config")'>修改网络流量分析任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除网络流量分析任务信息")'>删除网络流量分析任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("网络流量分析任务数据获取", "analysis")'>网络流量分析任务数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("网络流量分析任务数据上传", "analysis")'>网络流量分析任务数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("网络流量分析任务数据接口监控", "log")'>网络流量分析任务数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网络流量分析任务汇总报告详情", "detail")'>查询网络流量分析任务汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网络流量分析任务明细报告详情", "detail")'>查询网络流量分析任务明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析任务", "form")'>新增流量分析任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析模型", "form")'>新增流量分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析模型", "config")'>修改流量分析模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量分析模型")'>删除流量分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析查询", "analysis")'>流量分析查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析可视化展示", "analysis")'>流量分析可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "网络流量分析任务名称": "流量分析管理-1",
    "定义网络流量分析任务状态": "已取消",
    "定义网络流量分析任务时间": "2026-05-08 16:08:25",
    "网络流量分析任务属性": "已取消",
    "网络流量分析任务创建时间": "2026-05-08 16:08:25",
    "网络流量分析任务所属部门": "数据管理部",
    "网络流量分析任务负责人": "admin",
    "网络流量分析任务类型": "已取消",
    "网络流量分析任务规则": "已取消",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-2",
    "定义网络流量分析任务状态": "已驳回",
    "定义网络流量分析任务时间": "2026-05-09 08:33:11",
    "网络流量分析任务属性": "已驳回",
    "网络流量分析任务创建时间": "2026-05-09 08:33:11",
    "网络流量分析任务所属部门": "安全运维部",
    "网络流量分析任务负责人": "张三",
    "网络流量分析任务类型": "已驳回",
    "网络流量分析任务规则": "已驳回",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-3",
    "定义网络流量分析任务状态": "待审核",
    "定义网络流量分析任务时间": "2026-05-09 09:47:56",
    "网络流量分析任务属性": "待审核",
    "网络流量分析任务创建时间": "2026-05-09 09:47:56",
    "网络流量分析任务所属部门": "网络管理部",
    "网络流量分析任务负责人": "李四",
    "网络流量分析任务类型": "待审核",
    "网络流量分析任务规则": "待审核",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-4",
    "定义网络流量分析任务状态": "已处理",
    "定义网络流量分析任务时间": "2026-05-08 09:12:18",
    "网络流量分析任务属性": "已处理",
    "网络流量分析任务创建时间": "2026-05-08 09:12:18",
    "网络流量分析任务所属部门": "资产管理部",
    "网络流量分析任务负责人": "王五",
    "网络流量分析任务类型": "已处理",
    "网络流量分析任务规则": "已处理",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-5",
    "定义网络流量分析任务状态": "处理中",
    "定义网络流量分析任务时间": "2026-05-08 09:35:44",
    "网络流量分析任务属性": "处理中",
    "网络流量分析任务创建时间": "2026-05-08 09:35:44",
    "网络流量分析任务所属部门": "信息安全部",
    "网络流量分析任务负责人": "赵六",
    "网络流量分析任务类型": "处理中",
    "网络流量分析任务规则": "处理中",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-6",
    "定义网络流量分析任务状态": "待处理",
    "定义网络流量分析任务时间": "2026-05-08 10:08:06",
    "网络流量分析任务属性": "待处理",
    "网络流量分析任务创建时间": "2026-05-08 10:08:06",
    "网络流量分析任务所属部门": "系统运维部",
    "网络流量分析任务负责人": "system",
    "网络流量分析任务类型": "待处理",
    "网络流量分析任务规则": "待处理",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-7",
    "定义网络流量分析任务状态": "处理失败",
    "定义网络流量分析任务时间": "2026-05-08 10:42:31",
    "网络流量分析任务属性": "处理失败",
    "网络流量分析任务创建时间": "2026-05-08 10:42:31",
    "网络流量分析任务所属部门": "数据管理部",
    "网络流量分析任务负责人": "admin",
    "网络流量分析任务类型": "处理失败",
    "网络流量分析任务规则": "处理失败",
  ...
  },
  {
    ...
    "网络流量分析任务名称": "流量分析管理-8",
    "定义网络流量分析任务状态": "已暂停",
    "定义网络流量分析任务时间": "2026-05-08 11:16:09",
    "网络流量分析任务属性": "已暂停",
    "网络流量分析任务创建时间": "2026-05-08 11:16:09",
    "网络流量分析任务所属部门": "安全运维部",
    "网络流量分析任务负责人": "张三",
    "网络流量分析任务类型": "已暂停",
    "网络流量分析任务规则": "已暂停",
