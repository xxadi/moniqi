    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义工信部采集率识别任务信息", "transform")'>定义工信部采集率识别任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率识别任务信息", "config")'>修改工信部采集率识别任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率识别任务信息")'>删除工信部采集率识别任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率识别任务数据获取", "transform")'>工信部采集率识别任务数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率识别任务数据上传", "form")'>工信部采集率识别任务数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率识别任务数据接口监控", "log")'>工信部采集率识别任务数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率识别任务汇总报告详情", "detail")'>查询工信部采集率识别任务汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率识别任务明细报告详情", "detail")'>查询工信部采集率识别任务明细报告详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部采集率识别任务ID": "G-84844",
    "工信部采集率识别任务编号": "G-84844",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-1",
    "新增工信部采集率识别任务状态": "超时",
    "新增工信部采集率识别任务时间": "2026-05-08 11:16:09",
    "工信部采集率识别任务属性": "超时",
    "工信部采集率识别任务创建时间": "2026-05-08 11:16:09",
    "工信部采集率识别任务所属部门": "系统运维部",
    "工信部采集率识别任务负责人": "system",
    "工信部采集率识别任务类型": "超时",
    "工信部采集率识别任务规则": "超时",
    "名称": "工信部采集率识别任务管理-1"
  },
  {
    "ID": 2,
    "工信部采集率识别任务ID": "G-92763",
    "工信部采集率识别任务编号": "G-92763",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-2",
    "新增工信部采集率识别任务状态": "已取消",
    "新增工信部采集率识别任务时间": "2026-05-08 14:03:52",
    "工信部采集率识别任务属性": "已取消",
    "工信部采集率识别任务创建时间": "2026-05-08 14:03:52",
    "工信部采集率识别任务所属部门": "数据管理部",
    "工信部采集率识别任务负责人": "admin",
    "工信部采集率识别任务类型": "已取消",
    "工信部采集率识别任务规则": "已取消",
    "名称": "工信部采集率识别任务管理-2"
  ...
  {
    "ID": 3,
    "工信部采集率识别任务ID": "G-100682",
    "工信部采集率识别任务编号": "G-100682",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-3",
    "新增工信部采集率识别任务状态": "已驳回",
    "新增工信部采集率识别任务时间": "2026-05-08 15:21:37",
    "工信部采集率识别任务属性": "已驳回",
    "工信部采集率识别任务创建时间": "2026-05-08 15:21:37",
    "工信部采集率识别任务所属部门": "安全运维部",
    "工信部采集率识别任务负责人": "张三",
    "工信部采集率识别任务类型": "已驳回",
    "工信部采集率识别任务规则": "已驳回",
    "名称": "工信部采集率识别任务管理-3"
  ...
  {
    "ID": 4,
    "工信部采集率识别任务ID": "G-108601",
    "工信部采集率识别任务编号": "G-108601",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-4",
    "新增工信部采集率识别任务状态": "待审核",
    "新增工信部采集率识别任务时间": "2026-05-08 16:08:25",
    "工信部采集率识别任务属性": "待审核",
    "工信部采集率识别任务创建时间": "2026-05-08 16:08:25",
    "工信部采集率识别任务所属部门": "网络管理部",
    "工信部采集率识别任务负责人": "李四",
    "工信部采集率识别任务类型": "待审核",
    "工信部采集率识别任务规则": "待审核",
    "名称": "工信部采集率识别任务管理-4"
  ...
  {
    "ID": 5,
    "工信部采集率识别任务ID": "G-116520",
    "工信部采集率识别任务编号": "G-116520",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-5",
    "新增工信部采集率识别任务状态": "已处理",
    "新增工信部采集率识别任务时间": "2026-05-09 08:33:11",
    "工信部采集率识别任务属性": "已处理",
    "工信部采集率识别任务创建时间": "2026-05-09 08:33:11",
    "工信部采集率识别任务所属部门": "资产管理部",
    "工信部采集率识别任务负责人": "王五",
    "工信部采集率识别任务类型": "已处理",
    "工信部采集率识别任务规则": "已处理",
    "名称": "工信部采集率识别任务管理-5"
  ...
  {
    "ID": 6,
    "工信部采集率识别任务ID": "G-124439",
    "工信部采集率识别任务编号": "G-124439",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-6",
    "新增工信部采集率识别任务状态": "处理中",
    "新增工信部采集率识别任务时间": "2026-05-09 09:47:56",
    "工信部采集率识别任务属性": "处理中",
    "工信部采集率识别任务创建时间": "2026-05-09 09:47:56",
    "工信部采集率识别任务所属部门": "信息安全部",
    "工信部采集率识别任务负责人": "赵六",
    "工信部采集率识别任务类型": "处理中",
    "工信部采集率识别任务规则": "处理中",
    "名称": "工信部采集率识别任务管理-6"
  ...
  {
    "ID": 7,
    "工信部采集率识别任务ID": "G-132358",
    "工信部采集率识别任务编号": "G-132358",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-7",
    "新增工信部采集率识别任务状态": "待处理",
    "新增工信部采集率识别任务时间": "2026-05-08 09:12:18",
    "工信部采集率识别任务属性": "待处理",
    "工信部采集率识别任务创建时间": "2026-05-08 09:12:18",
    "工信部采集率识别任务所属部门": "系统运维部",
    "工信部采集率识别任务负责人": "system",
    "工信部采集率识别任务类型": "待处理",
    "工信部采集率识别任务规则": "待处理",
  ...
  {
    "ID": 8,
    "工信部采集率识别任务ID": "G-140277",
    "工信部采集率识别任务编号": "G-140277",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-8",
    "新增工信部采集率识别任务状态": "处理失败",
    "新增工信部采集率识别任务时间": "2026-05-08 09:35:44",
    "工信部采集率识别任务属性": "处理失败",
    "工信部采集率识别任务创建时间": "2026-05-08 09:35:44",
    "工信部采集率识别任务所属部门": "数据管理部",
    "工信部采集率识别任务负责人": "admin",
    "工信部采集率识别任务类型": "处理失败",
    "工信部采集率识别任务规则": "处理失败",
  ...
  {
    "ID": 9,
    "工信部采集率识别任务ID": "G-148196",
    "工信部采集率识别任务编号": "G-148196",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-9",
    "新增工信部采集率识别任务状态": "已暂停",
    "新增工信部采集率识别任务时间": "2026-05-08 10:08:06",
    "工信部采集率识别任务属性": "已暂停",
    "工信部采集率识别任务创建时间": "2026-05-08 10:08:06",
    "工信部采集率识别任务所属部门": "安全运维部",
    "工信部采集率识别任务负责人": "张三",
    "工信部采集率识别任务类型": "已暂停",
    "工信部采集率识别任务规则": "已暂停",
  ...
  {
    "ID": 10,
    "工信部采集率识别任务ID": "G-156115",
    "工信部采集率识别任务编号": "G-156115",
    "工信部采集率识别任务名称": "工信部采集率识别任务管理-10",
    "新增工信部采集率识别任务状态": "已完成",
    "新增工信部采集率识别任务时间": "2026-05-08 10:42:31",
    "工信部采集率识别任务属性": "已完成",
    "工信部采集率识别任务创建时间": "2026-05-08 10:42:31",
    "工信部采集率识别任务所属部门": "网络管理部",
    "工信部采集率识别任务负责人": "李四",
    "工信部采集率识别任务类型": "已完成",
    "工信部采集率识别任务规则": "已完成",
