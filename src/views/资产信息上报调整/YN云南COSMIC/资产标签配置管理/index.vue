    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产标签配置信息", "form")'>新增资产标签配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产标签配置信息", "config")'>修改资产标签配置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产标签配置信息")'>删除资产标签配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产标签配置汇总表", "detail")'>查询资产标签配置汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产标签配置详情", "detail")'>查询资产标签配置详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产标签配置")'>批量导入资产标签配置</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产标签配置导出")'>资产标签配置导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产标签配置名称": "资产标签配置管理-1",
    "新增资产标签配置状态": "已处理",
    "新增资产标签配置时间": "2026-05-08 11:16:09",
    "资产标签配置属性": "已处理",
    "资产标签配置创建时间": "2026-05-08 11:16:09",
    "资产标签配置所属部门": "资产管理部",
    "资产标签配置负责人": "王五",
    "资产标签配置类型": "已处理",
    "资产标签配置规则": "已处理",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-2",
    "新增资产标签配置状态": "处理中",
    "新增资产标签配置时间": "2026-05-08 14:03:52",
    "资产标签配置属性": "处理中",
    "资产标签配置创建时间": "2026-05-08 14:03:52",
    "资产标签配置所属部门": "信息安全部",
    "资产标签配置负责人": "赵六",
    "资产标签配置类型": "处理中",
    "资产标签配置规则": "处理中",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-3",
    "新增资产标签配置状态": "待处理",
    "新增资产标签配置时间": "2026-05-08 15:21:37",
    "资产标签配置属性": "待处理",
    "资产标签配置创建时间": "2026-05-08 15:21:37",
    "资产标签配置所属部门": "系统运维部",
    "资产标签配置负责人": "system",
    "资产标签配置类型": "待处理",
    "资产标签配置规则": "待处理",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-4",
    "新增资产标签配置状态": "处理失败",
    "新增资产标签配置时间": "2026-05-08 16:08:25",
    "资产标签配置属性": "处理失败",
    "资产标签配置创建时间": "2026-05-08 16:08:25",
    "资产标签配置所属部门": "数据管理部",
    "资产标签配置负责人": "admin",
    "资产标签配置类型": "处理失败",
    "资产标签配置规则": "处理失败",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-5",
    "新增资产标签配置状态": "已暂停",
    "新增资产标签配置时间": "2026-05-09 08:33:11",
    "资产标签配置属性": "已暂停",
    "资产标签配置创建时间": "2026-05-09 08:33:11",
    "资产标签配置所属部门": "安全运维部",
    "资产标签配置负责人": "张三",
    "资产标签配置类型": "已暂停",
    "资产标签配置规则": "已暂停",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-6",
    "新增资产标签配置状态": "已完成",
    "新增资产标签配置时间": "2026-05-09 09:47:56",
    "资产标签配置属性": "已完成",
    "资产标签配置创建时间": "2026-05-09 09:47:56",
    "资产标签配置所属部门": "网络管理部",
    "资产标签配置负责人": "李四",
    "资产标签配置类型": "已完成",
    "资产标签配置规则": "已完成",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-7",
    "新增资产标签配置状态": "排队中",
    "新增资产标签配置时间": "2026-05-08 09:12:18",
    "资产标签配置属性": "排队中",
    "资产标签配置创建时间": "2026-05-08 09:12:18",
    "资产标签配置所属部门": "资产管理部",
    "资产标签配置负责人": "王五",
    "资产标签配置类型": "排队中",
    "资产标签配置规则": "排队中",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-8",
    "新增资产标签配置状态": "部分完成",
    "新增资产标签配置时间": "2026-05-08 09:35:44",
    "资产标签配置属性": "部分完成",
    "资产标签配置创建时间": "2026-05-08 09:35:44",
    "资产标签配置所属部门": "信息安全部",
    "资产标签配置负责人": "赵六",
    "资产标签配置类型": "部分完成",
    "资产标签配置规则": "部分完成",
  ...
  },
  {
    ...
    "资产标签配置名称": "资产标签配置管理-9",
    "新增资产标签配置状态": "已启用",
    "新增资产标签配置时间": "2026-05-08 10:08:06",
    "资产标签配置属性": "已启用",
    "资产标签配置创建时间": "2026-05-08 10:08:06",
    "资产标签配置所属部门": "系统运维部",
    "资产标签配置负责人": "system",
    "资产标签配置类型": "已启用",
    "资产标签配置规则": "已启用",
  ...
  },
  {
    ...
    "资产标签配置ID": "S-107975",
    "资产标签配置编号": "S-107975",
    "资产标签配置名称": "资产标签配置管理-10",
    "新增资产标签配置状态": "已停用",
    "新增资产标签配置时间": "2026-05-08 10:42:31",
    "资产标签配置属性": "已停用",
    "资产标签配置创建时间": "2026-05-08 10:42:31",
    "资产标签配置所属部门": "数据管理部",
    "资产标签配置负责人": "admin",
    "资产标签配置类型": "已停用",
    "资产标签配置规则": "已停用",
