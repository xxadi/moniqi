    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增组件漏洞扫描任务信息", "form")'>新增组件漏洞扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改组件漏洞扫描任务信息", "config")'>修改组件漏洞扫描任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除组件漏洞扫描任务信息")'>删除组件漏洞扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询组件漏洞扫描任务列表", "detail")'>查询组件漏洞扫描任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询组件漏洞扫描任务详情", "detail")'>查询组件漏洞扫描任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入组件漏洞扫描任务")'>批量导入组件漏洞扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("组件漏洞扫描任务导出")'>组件漏洞扫描任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "组件漏洞扫描任务ID": "M-70160",
    "组件漏洞扫描任务编号": "M-70160",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-1",
    "新增组件漏洞扫描任务状态": "已处理",
    "新增组件漏洞扫描任务时间": "2026-05-08 09:12:18",
    "扫描任务属性": "已处理",
    "组件漏洞扫描任务创建时间": "2026-05-08 09:12:18",
    "组件漏洞扫描任务所属部门": "资产管理部",
    "组件漏洞扫描任务负责人": "王五",
    "组件漏洞扫描任务类型": "已处理",
    "组件漏洞扫描任务规则": "已处理",
  ...
  },
  {
    ...
    "组件漏洞扫描任务ID": "M-78079",
    "组件漏洞扫描任务编号": "M-78079",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-2",
    "新增组件漏洞扫描任务状态": "处理中",
    "新增组件漏洞扫描任务时间": "2026-05-08 09:35:44",
    "扫描任务属性": "处理中",
    "组件漏洞扫描任务创建时间": "2026-05-08 09:35:44",
    "组件漏洞扫描任务所属部门": "信息安全部",
    "组件漏洞扫描任务负责人": "赵六",
    "组件漏洞扫描任务类型": "处理中",
    "组件漏洞扫描任务规则": "处理中",
  ...
  },
  {
    ...
    "组件漏洞扫描任务ID": "M-85998",
    "组件漏洞扫描任务编号": "M-85998",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-3",
    "新增组件漏洞扫描任务状态": "待处理",
    "新增组件漏洞扫描任务时间": "2026-05-08 10:08:06",
    "扫描任务属性": "待处理",
    "组件漏洞扫描任务创建时间": "2026-05-08 10:08:06",
    "组件漏洞扫描任务所属部门": "系统运维部",
    "组件漏洞扫描任务负责人": "system",
    "组件漏洞扫描任务类型": "待处理",
    "组件漏洞扫描任务规则": "待处理",
  ...
  },
  {
    ...
    "组件漏洞扫描任务ID": "M-93917",
    "组件漏洞扫描任务编号": "M-93917",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-4",
    "新增组件漏洞扫描任务状态": "处理失败",
    "新增组件漏洞扫描任务时间": "2026-05-08 10:42:31",
    "扫描任务属性": "处理失败",
    "组件漏洞扫描任务创建时间": "2026-05-08 10:42:31",
    "组件漏洞扫描任务所属部门": "数据管理部",
    "组件漏洞扫描任务负责人": "admin",
    "组件漏洞扫描任务类型": "处理失败",
    "组件漏洞扫描任务规则": "处理失败",
  ...
  },
  {
    ...
    "组件漏洞扫描任务ID": "M-101836",
    "组件漏洞扫描任务编号": "M-101836",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-5",
    "新增组件漏洞扫描任务状态": "已暂停",
    "新增组件漏洞扫描任务时间": "2026-05-08 11:16:09",
    "扫描任务属性": "已暂停",
    "组件漏洞扫描任务创建时间": "2026-05-08 11:16:09",
    "组件漏洞扫描任务所属部门": "安全运维部",
    "组件漏洞扫描任务负责人": "张三",
    "组件漏洞扫描任务类型": "已暂停",
    "组件漏洞扫描任务规则": "已暂停",
  ...
  },
  {
    ...
    "组件漏洞扫描任务ID": "M-109755",
    "组件漏洞扫描任务编号": "M-109755",
    "组件漏洞扫描任务名称": "组件漏洞扫描任务管理-6",
    "新增组件漏洞扫描任务状态": "已完成",
    "新增组件漏洞扫描任务时间": "2026-05-08 14:03:52",
    "扫描任务属性": "已完成",
    "组件漏洞扫描任务创建时间": "2026-05-08 14:03:52",
    "组件漏洞扫描任务所属部门": "网络管理部",
    "组件漏洞扫描任务负责人": "李四",
    "组件漏洞扫描任务类型": "已完成",
    "组件漏洞扫描任务规则": "已完成",
