    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率稽核", "transform")'>自动化采集率稽核</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动采集率稽核任务信息", "form")'>新增自动采集率稽核任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动采集率稽核任务信息", "config")'>修改自动采集率稽核任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动采集率稽核任务信息")'>删除自动采集率稽核任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动采集率稽核任务列表", "detail")'>查询自动采集率稽核任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动采集率稽核任务详情", "detail")'>查询自动采集率稽核任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入自动采集率稽核任务")'>批量导入自动采集率稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("自动采集率稽核任务导出")'>自动采集率稽核任务导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率汇总报告详情", "detail")'>查询自动化采集率汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率明细报告详情", "detail")'>查询自动化采集率明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据预处理", "transform")'>自动化采集率数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据下发", "transform")'>自动化采集率数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据分析", "analysis")'>自动化采集率数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据上报", "transform")'>自动化采集率数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
