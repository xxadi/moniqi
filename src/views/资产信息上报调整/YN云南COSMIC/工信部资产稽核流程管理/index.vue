    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部资产稽核流程", "workflow")'>发起工信部资产稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产稽核指派信息", "form")'>新增工信部资产稽核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产稽核流程", "form")'>新增工信部资产稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产稽核流程信息", "config")'>修改工信部资产稽核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核流程删除", "operation")'>工信部资产稽核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核流程查询", "detail")'>工信部资产稽核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核附件上传", "form")'>工信部资产稽核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核流程图查看", "preview")'>工信部资产稽核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核流程通知", "audit")'>工信部资产稽核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核结果逐级审批", "audit")'>工信部资产稽核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产稽核结果拒绝和驳回", "approval")'>工信部资产稽核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "稽核编号": "N-35737",
    "发起工信部资产稽核状态": "已停用",
    "工信部资产稽核流程节点编号": "N-35737",
    "名称": "工信部资产稽核流程管理-1",
    "类型": "已停用",
    "工信部资产稽核流程节点规则": "已停用",
    "工信部资产稽核流程节点属性": "已停用",
    "修改工信部资产稽核流程节点状态": "已停用",
    "修改工信部资产稽核流程节点时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "稽核ID": "N-43656",
    ...
    "稽核编号": "N-43656",
    "发起工信部资产稽核状态": "正常",
    "工信部资产稽核流程节点编号": "N-43656",
    "名称": "工信部资产稽核流程管理-2",
    "类型": "正常",
    "工信部资产稽核流程节点规则": "正常",
    "工信部资产稽核流程节点属性": "正常",
    "修改工信部资产稽核流程节点状态": "正常",
    "修改工信部资产稽核流程节点时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "稽核ID": "N-51575",
    ...
    "稽核编号": "N-51575",
    "发起工信部资产稽核状态": "异常",
    "工信部资产稽核流程节点编号": "N-51575",
    "名称": "工信部资产稽核流程管理-3",
    "类型": "异常",
    "工信部资产稽核流程节点规则": "异常",
    "工信部资产稽核流程节点属性": "异常",
    "修改工信部资产稽核流程节点状态": "异常",
    "修改工信部资产稽核流程节点时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "稽核ID": "N-59494",
    ...
    "稽核编号": "N-59494",
    "发起工信部资产稽核状态": "超时",
    "工信部资产稽核流程节点编号": "N-59494",
    "名称": "工信部资产稽核流程管理-4",
    "类型": "超时",
    "工信部资产稽核流程节点规则": "超时",
    "工信部资产稽核流程节点属性": "超时",
    "修改工信部资产稽核流程节点状态": "超时",
    "修改工信部资产稽核流程节点时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "稽核ID": "N-67413",
    ...
    "稽核编号": "N-67413",
    "发起工信部资产稽核状态": "已取消",
    "工信部资产稽核流程节点编号": "N-67413",
    "名称": "工信部资产稽核流程管理-5",
    "类型": "已取消",
    "工信部资产稽核流程节点规则": "已取消",
    "工信部资产稽核流程节点属性": "已取消",
    "修改工信部资产稽核流程节点状态": "已取消",
    "修改工信部资产稽核流程节点时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "稽核ID": "N-75332",
    ...
    "稽核编号": "N-75332",
    "发起工信部资产稽核状态": "已驳回",
    "工信部资产稽核流程节点编号": "N-75332",
    "名称": "工信部资产稽核流程管理-6",
    "类型": "已驳回",
    "工信部资产稽核流程节点规则": "已驳回",
    "工信部资产稽核流程节点属性": "已驳回",
    "修改工信部资产稽核流程节点状态": "已驳回",
    "修改工信部资产稽核流程节点时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "稽核ID": "N-83251",
    ...
    "稽核编号": "N-83251",
    "发起工信部资产稽核状态": "待审核",
    "工信部资产稽核流程节点编号": "N-83251",
    "名称": "工信部资产稽核流程管理-7",
    "类型": "待审核",
    "工信部资产稽核流程节点规则": "待审核",
    "工信部资产稽核流程节点属性": "待审核",
    "修改工信部资产稽核流程节点状态": "待审核",
    "修改工信部资产稽核流程节点时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "稽核ID": "N-91170",
    ...
    "稽核编号": "N-91170",
    "发起工信部资产稽核状态": "已处理",
    "工信部资产稽核流程节点编号": "N-91170",
    "名称": "工信部资产稽核流程管理-8",
    "类型": "已处理",
    "工信部资产稽核流程节点规则": "已处理",
    "工信部资产稽核流程节点属性": "已处理",
    "修改工信部资产稽核流程节点状态": "已处理",
    "修改工信部资产稽核流程节点时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "修改工信部资产稽核流程节点状态",
    "label": "修改工信部资产稽核流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改工信部资产稽核流程节点时间",
    "label": "修改工信部资产稽核流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
