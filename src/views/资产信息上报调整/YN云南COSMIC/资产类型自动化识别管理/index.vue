    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义资产类型自动化识别信息", "validate")'>定义资产类型自动化识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类型自动化识别信息", "config")'>修改资产类型自动化识别信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产类型自动化识别信息")'>删除资产类型自动化识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型自动化识别数据获取", "validate")'>资产类型自动化识别数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型自动化识别数据上传", "form")'>资产类型自动化识别数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类型自动化识别数据接口监控", "log")'>资产类型自动化识别数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型自动化识别汇总报告详情", "detail")'>查询资产类型自动化识别汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型自动化识别明细报告详情", "detail")'>查询资产类型自动化识别明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息稽核任务", "form")'>新增资产信息稽核任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息稽核任务")'>删除资产信息稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息稽核任务", "config")'>修改资产信息稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产信息稽核任务", "detail")'>查询资产信息稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息稽核任务启用/禁用", "audit")'>资产信息稽核任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("定义资产信息自动修改规则信息", "operation")'>定义资产信息自动修改规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息自动修改规则信息", "config")'>修改资产信息自动修改规则信息</el-button>
          <el-button plain type="danger" icon="el-icon-edit" @click='deleteByName("删除资产信息自动修改规则信息")'>删除资产信息自动修改规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产信息自动修改规则数据获取", "operation")'>资产信息自动修改规则数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产信息自动修改规则数据上传", "form")'>资产信息自动修改规则数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产信息自动修改规则数据接口监控", "log")'>资产信息自动修改规则数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查询资产信息自动修改规则汇总报告详情", "detail")'>查询资产信息自动修改规则汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查询资产信息自动修改规则明细报告详情", "detail")'>查询资产信息自动修改规则明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("展示已修改资产类型", "detail")'>展示已修改资产类型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产类型识别信息修改", "validate")'>资产类型识别信息修改</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产大类", "config")'>修改资产大类</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查询资产类型修改详细结果", "detail")'>查询资产类型修改详细结果</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("批量修改资产类型", "operation")'>批量修改资产类型</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产类型自动化识别ID": "T-28463",
    "资产类型自动化识别编号": "T-28463",
    "资产类型自动化识别名称": "资产类型自动化识别管理-1",
    "定义资产类型自动化识别状态": "待审核",
    "定义资产类型自动化识别时间": "2026-05-08 10:42:31",
    "资产类型自动化识别属性": "待审核",
    "资产类型自动化识别创建时间": "2026-05-08 10:42:31",
    "资产类型自动化识别所属部门": "数据管理部",
    "资产类型自动化识别负责人": "admin",
    "资产类型自动化识别类型": "待审核",
    "资产类型自动化识别规则": "待审核",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-36382",
    "资产类型自动化识别编号": "T-36382",
    "资产类型自动化识别名称": "资产类型自动化识别管理-2",
    "定义资产类型自动化识别状态": "已处理",
    "定义资产类型自动化识别时间": "2026-05-08 11:16:09",
    "资产类型自动化识别属性": "已处理",
    "资产类型自动化识别创建时间": "2026-05-08 11:16:09",
    "资产类型自动化识别所属部门": "安全运维部",
    "资产类型自动化识别负责人": "张三",
    "资产类型自动化识别类型": "已处理",
    "资产类型自动化识别规则": "已处理",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-44301",
    "资产类型自动化识别编号": "T-44301",
    "资产类型自动化识别名称": "资产类型自动化识别管理-3",
    "定义资产类型自动化识别状态": "处理中",
    "定义资产类型自动化识别时间": "2026-05-08 14:03:52",
    "资产类型自动化识别属性": "处理中",
    "资产类型自动化识别创建时间": "2026-05-08 14:03:52",
    "资产类型自动化识别所属部门": "网络管理部",
    "资产类型自动化识别负责人": "李四",
    "资产类型自动化识别类型": "处理中",
    "资产类型自动化识别规则": "处理中",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-52220",
    "资产类型自动化识别编号": "T-52220",
    "资产类型自动化识别名称": "资产类型自动化识别管理-4",
    "定义资产类型自动化识别状态": "待处理",
    "定义资产类型自动化识别时间": "2026-05-08 15:21:37",
    "资产类型自动化识别属性": "待处理",
    "资产类型自动化识别创建时间": "2026-05-08 15:21:37",
    "资产类型自动化识别所属部门": "资产管理部",
    "资产类型自动化识别负责人": "王五",
    "资产类型自动化识别类型": "待处理",
    "资产类型自动化识别规则": "待处理",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-60139",
    "资产类型自动化识别编号": "T-60139",
    "资产类型自动化识别名称": "资产类型自动化识别管理-5",
    "定义资产类型自动化识别状态": "处理失败",
    "定义资产类型自动化识别时间": "2026-05-08 16:08:25",
    "资产类型自动化识别属性": "处理失败",
    "资产类型自动化识别创建时间": "2026-05-08 16:08:25",
    "资产类型自动化识别所属部门": "信息安全部",
    "资产类型自动化识别负责人": "赵六",
    "资产类型自动化识别类型": "处理失败",
    "资产类型自动化识别规则": "处理失败",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-68058",
    "资产类型自动化识别编号": "T-68058",
    "资产类型自动化识别名称": "资产类型自动化识别管理-6",
    "定义资产类型自动化识别状态": "已暂停",
    "定义资产类型自动化识别时间": "2026-05-09 08:33:11",
    "资产类型自动化识别属性": "已暂停",
    "资产类型自动化识别创建时间": "2026-05-09 08:33:11",
    "资产类型自动化识别所属部门": "系统运维部",
    "资产类型自动化识别负责人": "system",
    "资产类型自动化识别类型": "已暂停",
    "资产类型自动化识别规则": "已暂停",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-75977",
    "资产类型自动化识别编号": "T-75977",
    "资产类型自动化识别名称": "资产类型自动化识别管理-7",
    "定义资产类型自动化识别状态": "已完成",
    "定义资产类型自动化识别时间": "2026-05-09 09:47:56",
    "资产类型自动化识别属性": "已完成",
    "资产类型自动化识别创建时间": "2026-05-09 09:47:56",
    "资产类型自动化识别所属部门": "数据管理部",
    "资产类型自动化识别负责人": "admin",
    "资产类型自动化识别类型": "已完成",
    "资产类型自动化识别规则": "已完成",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-83896",
    "资产类型自动化识别编号": "T-83896",
    "资产类型自动化识别名称": "资产类型自动化识别管理-8",
    "定义资产类型自动化识别状态": "排队中",
    "定义资产类型自动化识别时间": "2026-05-08 09:12:18",
    "资产类型自动化识别属性": "排队中",
    "资产类型自动化识别创建时间": "2026-05-08 09:12:18",
    "资产类型自动化识别所属部门": "安全运维部",
    "资产类型自动化识别负责人": "张三",
    "资产类型自动化识别类型": "排队中",
    "资产类型自动化识别规则": "排队中",
  ...
  },
  {
    ...
    "资产类型自动化识别ID": "T-91815",
    "资产类型自动化识别编号": "T-91815",
    "资产类型自动化识别名称": "资产类型自动化识别管理-9",
    "定义资产类型自动化识别状态": "部分完成",
    "定义资产类型自动化识别时间": "2026-05-08 09:35:44",
    "资产类型自动化识别属性": "部分完成",
    "资产类型自动化识别创建时间": "2026-05-08 09:35:44",
    "资产类型自动化识别所属部门": "网络管理部",
    "资产类型自动化识别负责人": "李四",
    "资产类型自动化识别类型": "部分完成",
    "资产类型自动化识别规则": "部分完成",
