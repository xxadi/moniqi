    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析采集任务信息", "form")'>新增流量分析采集任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析采集任务信息", "config")'>修改流量分析采集任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量分析采集任务信息")'>删除流量分析采集任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询流量分析采集任务列表", "detail")'>查询流量分析采集任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询流量分析采集任务详情", "detail")'>查询流量分析采集任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入流量分析采集任务")'>批量导入流量分析采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("流量分析采集任务导出")'>流量分析采集任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流量分析采集任务ID": "O-93666",
    "流量分析采集任务编号": "O-93666",
    "流量分析采集任务名称": "流量分析采集任务管理-1",
    "新增流量分析采集任务状态": "待处理",
    "新增流量分析采集任务时间": "2026-05-08 15:21:37",
    "流量分析采集任务属性": "待处理",
    "流量分析采集任务创建时间": "2026-05-08 15:21:37",
    "流量分析采集任务所属部门": "安全运维部",
    "流量分析采集任务负责人": "张三",
    "流量分析采集任务类型": "待处理",
    "流量分析采集任务规则": "待处理",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-101585",
    "流量分析采集任务编号": "O-101585",
    "流量分析采集任务名称": "流量分析采集任务管理-2",
    "新增流量分析采集任务状态": "处理失败",
    "新增流量分析采集任务时间": "2026-05-08 16:08:25",
    "流量分析采集任务属性": "处理失败",
    "流量分析采集任务创建时间": "2026-05-08 16:08:25",
    "流量分析采集任务所属部门": "网络管理部",
    "流量分析采集任务负责人": "李四",
    "流量分析采集任务类型": "处理失败",
    "流量分析采集任务规则": "处理失败",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-109504",
    "流量分析采集任务编号": "O-109504",
    "流量分析采集任务名称": "流量分析采集任务管理-3",
    "新增流量分析采集任务状态": "已暂停",
    "新增流量分析采集任务时间": "2026-05-09 08:33:11",
    "流量分析采集任务属性": "已暂停",
    "流量分析采集任务创建时间": "2026-05-09 08:33:11",
    "流量分析采集任务所属部门": "资产管理部",
    "流量分析采集任务负责人": "王五",
    "流量分析采集任务类型": "已暂停",
    "流量分析采集任务规则": "已暂停",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-117423",
    "流量分析采集任务编号": "O-117423",
    "流量分析采集任务名称": "流量分析采集任务管理-4",
    "新增流量分析采集任务状态": "已完成",
    "新增流量分析采集任务时间": "2026-05-09 09:47:56",
    "流量分析采集任务属性": "已完成",
    "流量分析采集任务创建时间": "2026-05-09 09:47:56",
    "流量分析采集任务所属部门": "信息安全部",
    "流量分析采集任务负责人": "赵六",
    "流量分析采集任务类型": "已完成",
    "流量分析采集任务规则": "已完成",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-125342",
    "流量分析采集任务编号": "O-125342",
    "流量分析采集任务名称": "流量分析采集任务管理-5",
    "新增流量分析采集任务状态": "排队中",
    "新增流量分析采集任务时间": "2026-05-08 09:12:18",
    "流量分析采集任务属性": "排队中",
    "流量分析采集任务创建时间": "2026-05-08 09:12:18",
    "流量分析采集任务所属部门": "系统运维部",
    "流量分析采集任务负责人": "system",
    "流量分析采集任务类型": "排队中",
    "流量分析采集任务规则": "排队中",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-133261",
    "流量分析采集任务编号": "O-133261",
    "流量分析采集任务名称": "流量分析采集任务管理-6",
    "新增流量分析采集任务状态": "部分完成",
    "新增流量分析采集任务时间": "2026-05-08 09:35:44",
    "流量分析采集任务属性": "部分完成",
    "流量分析采集任务创建时间": "2026-05-08 09:35:44",
    "流量分析采集任务所属部门": "数据管理部",
    "流量分析采集任务负责人": "admin",
    "流量分析采集任务类型": "部分完成",
    "流量分析采集任务规则": "部分完成",
  ...
  },
  {
    ...
    "流量分析采集任务ID": "O-141180",
    "流量分析采集任务编号": "O-141180",
    "流量分析采集任务名称": "流量分析采集任务管理-7",
    "新增流量分析采集任务状态": "已启用",
    "新增流量分析采集任务时间": "2026-05-08 10:08:06",
    "流量分析采集任务属性": "已启用",
    "流量分析采集任务创建时间": "2026-05-08 10:08:06",
    "流量分析采集任务所属部门": "安全运维部",
    "流量分析采集任务负责人": "张三",
    "流量分析采集任务类型": "已启用",
    "流量分析采集任务规则": "已启用",
