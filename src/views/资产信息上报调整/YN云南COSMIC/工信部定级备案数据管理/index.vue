    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部定级备案数据信息", "form")'>新增工信部定级备案数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部定级备案数据信息", "config")'>修改工信部定级备案数据信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部定级备案数据信息")'>删除工信部定级备案数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部定级备案数据列表", "detail")'>查询工信部定级备案数据列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部定级备案数据下发回传同步", "sync")'>工信部定级备案数据下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部定级备案数据下发回传任务推送", "audit")'>工信部定级备案数据下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部定级备案数据数据下发", "operation")'>工信部定级备案数据数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部定级备案数据数据分析", "analysis")'>工信部定级备案数据数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部定级备案数据数据上报", "operation")'>工信部定级备案数据数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "数据ID": "B-20125",
    "备案数据编号": "B-20125",
    "定级备案数据名称": "工信部定级备案数据管理-1",
    "新增工信部定级备案数据状态": "已取消",
    "新增工信部定级备案数据时间": "2026-05-08 14:03:52",
    "流水号": "B-20125",
    "工信部定级备案数据名称": "工信部定级备案数据管理-1",
    "工信部定级备案数据创建时间": "2026-05-08 14:03:52",
    "表类型": "已取消",
    "列表规则": "已取消",
    "列表属性": "已取消",
    "查询工信部定级备案数据列表状态": "已取消"
  },
  {
    ...
    "数据ID": "B-28044",
    "备案数据编号": "B-28044",
    "定级备案数据名称": "工信部定级备案数据管理-2",
    "新增工信部定级备案数据状态": "已驳回",
    "新增工信部定级备案数据时间": "2026-05-08 15:21:37",
    "流水号": "B-28044",
    "工信部定级备案数据名称": "工信部定级备案数据管理-2",
    "工信部定级备案数据创建时间": "2026-05-08 15:21:37",
    "表类型": "已驳回",
    "列表规则": "已驳回",
    "列表属性": "已驳回",
    "查询工信部定级备案数据列表状态": "已驳回"
  },
  {
    ...
    "数据ID": "B-35963",
    "备案数据编号": "B-35963",
    "定级备案数据名称": "工信部定级备案数据管理-3",
    "新增工信部定级备案数据状态": "待审核",
    "新增工信部定级备案数据时间": "2026-05-08 16:08:25",
    "流水号": "B-35963",
    "工信部定级备案数据名称": "工信部定级备案数据管理-3",
    "工信部定级备案数据创建时间": "2026-05-08 16:08:25",
    "表类型": "待审核",
    "列表规则": "待审核",
    "列表属性": "待审核",
    "查询工信部定级备案数据列表状态": "待审核"
  },
  {
    ...
    "数据ID": "B-43882",
    "备案数据编号": "B-43882",
    "定级备案数据名称": "工信部定级备案数据管理-4",
    "新增工信部定级备案数据状态": "已处理",
    "新增工信部定级备案数据时间": "2026-05-09 08:33:11",
    "流水号": "B-43882",
    "工信部定级备案数据名称": "工信部定级备案数据管理-4",
    "工信部定级备案数据创建时间": "2026-05-09 08:33:11",
    "表类型": "已处理",
    "列表规则": "已处理",
    "列表属性": "已处理",
    "查询工信部定级备案数据列表状态": "已处理"
  },
  {
    ...
    "数据ID": "B-51801",
    "备案数据编号": "B-51801",
    "定级备案数据名称": "工信部定级备案数据管理-5",
    "新增工信部定级备案数据状态": "处理中",
    "新增工信部定级备案数据时间": "2026-05-09 09:47:56",
    "流水号": "B-51801",
    "工信部定级备案数据名称": "工信部定级备案数据管理-5",
    "工信部定级备案数据创建时间": "2026-05-09 09:47:56",
    "表类型": "处理中",
    "列表规则": "处理中",
    "列表属性": "处理中",
    "查询工信部定级备案数据列表状态": "处理中"
  },
  {
    ...
    "数据ID": "B-59720",
    "备案数据编号": "B-59720",
    "定级备案数据名称": "工信部定级备案数据管理-6",
    "新增工信部定级备案数据状态": "待处理",
    "新增工信部定级备案数据时间": "2026-05-08 09:12:18",
    "流水号": "B-59720",
    "工信部定级备案数据名称": "工信部定级备案数据管理-6",
    "工信部定级备案数据创建时间": "2026-05-08 09:12:18",
    "表类型": "待处理",
    "列表规则": "待处理",
    "列表属性": "待处理",
    "查询工信部定级备案数据列表状态": "待处理"
...
const tableColumns = [
  ...
  {
    "prop": "查询工信部定级备案数据列表状态",
    "label": "查询工信部定级备案数据列表状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
