    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞自动化扫描计划信息", "form")'>新增资产漏洞自动化扫描计划信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞自动化扫描计划信息", "config")'>修改资产漏洞自动化扫描计划信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞自动化扫描计划信息")'>删除资产漏洞自动化扫描计划信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("检索资产漏洞自动化扫描计划列表", "schedule")'>检索资产漏洞自动化扫描计划列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞自动化扫描计划下发回传同步", "sync")'>资产漏洞自动化扫描计划下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞自动化扫描计划下发回传任务推送", "schedule")'>资产漏洞自动化扫描计划下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞自动化扫描计划数据下发", "schedule")'>资产漏洞自动化扫描计划数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产漏洞自动化扫描计划数据分析", "analysis")'>资产漏洞自动化扫描计划数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞自动化扫描计划数据上报", "schedule")'>资产漏洞自动化扫描计划数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产漏洞自动化扫描计划ID": "Q-87584",
    "资产漏洞自动化扫描计划编号": "Q-87584",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-1",
    "新增资产漏洞自动化扫描计划状态": "已处理",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 11:16:09",
    "资产漏洞自动化扫描计划属性": "已处理",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 11:16:09",
    "资产漏洞自动化扫描计划所属部门": "资产管理部",
    "资产漏洞自动化扫描计划负责人": "王五",
    "资产漏洞自动化扫描计划类型": "已处理",
    "资产漏洞自动化扫描计划规则": "已处理",
    "名称": "资产漏洞自动化扫描计划管理-1"
  ...
  {
    "ID": 2,
    "资产漏洞自动化扫描计划ID": "Q-95503",
    "资产漏洞自动化扫描计划编号": "Q-95503",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-2",
    "新增资产漏洞自动化扫描计划状态": "处理中",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 14:03:52",
    "资产漏洞自动化扫描计划属性": "处理中",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 14:03:52",
    "资产漏洞自动化扫描计划所属部门": "信息安全部",
    "资产漏洞自动化扫描计划负责人": "赵六",
    "资产漏洞自动化扫描计划类型": "处理中",
    "资产漏洞自动化扫描计划规则": "处理中",
    "名称": "资产漏洞自动化扫描计划管理-2"
  ...
  {
    "ID": 3,
    "资产漏洞自动化扫描计划ID": "Q-103422",
    "资产漏洞自动化扫描计划编号": "Q-103422",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-3",
    "新增资产漏洞自动化扫描计划状态": "待处理",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 15:21:37",
    "资产漏洞自动化扫描计划属性": "待处理",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 15:21:37",
    "资产漏洞自动化扫描计划所属部门": "系统运维部",
    "资产漏洞自动化扫描计划负责人": "system",
    "资产漏洞自动化扫描计划类型": "待处理",
    "资产漏洞自动化扫描计划规则": "待处理",
    "名称": "资产漏洞自动化扫描计划管理-3"
  },
  {
    "ID": 4,
    "资产漏洞自动化扫描计划ID": "Q-111341",
    "资产漏洞自动化扫描计划编号": "Q-111341",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-4",
    "新增资产漏洞自动化扫描计划状态": "处理失败",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 16:08:25",
    "资产漏洞自动化扫描计划属性": "处理失败",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 16:08:25",
    "资产漏洞自动化扫描计划所属部门": "数据管理部",
    "资产漏洞自动化扫描计划负责人": "admin",
    "资产漏洞自动化扫描计划类型": "处理失败",
    "资产漏洞自动化扫描计划规则": "处理失败",
    "名称": "资产漏洞自动化扫描计划管理-4"
  },
  {
    "ID": 5,
    "资产漏洞自动化扫描计划ID": "Q-119260",
    "资产漏洞自动化扫描计划编号": "Q-119260",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-5",
    "新增资产漏洞自动化扫描计划状态": "已暂停",
    "新增资产漏洞自动化扫描计划时间": "2026-05-09 08:33:11",
    "资产漏洞自动化扫描计划属性": "已暂停",
    "资产漏洞自动化扫描计划创建时间": "2026-05-09 08:33:11",
    "资产漏洞自动化扫描计划所属部门": "安全运维部",
    "资产漏洞自动化扫描计划负责人": "张三",
    "资产漏洞自动化扫描计划类型": "已暂停",
    "资产漏洞自动化扫描计划规则": "已暂停",
    "名称": "资产漏洞自动化扫描计划管理-5"
  ...
  {
    "ID": 6,
    "资产漏洞自动化扫描计划ID": "Q-127179",
    "资产漏洞自动化扫描计划编号": "Q-127179",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-6",
    "新增资产漏洞自动化扫描计划状态": "已完成",
    "新增资产漏洞自动化扫描计划时间": "2026-05-09 09:47:56",
    "资产漏洞自动化扫描计划属性": "已完成",
    "资产漏洞自动化扫描计划创建时间": "2026-05-09 09:47:56",
    "资产漏洞自动化扫描计划所属部门": "网络管理部",
    "资产漏洞自动化扫描计划负责人": "李四",
    "资产漏洞自动化扫描计划类型": "已完成",
    "资产漏洞自动化扫描计划规则": "已完成",
    "名称": "资产漏洞自动化扫描计划管理-6"
  ...
  {
    "ID": 7,
    "资产漏洞自动化扫描计划ID": "Q-135098",
    "资产漏洞自动化扫描计划编号": "Q-135098",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-7",
    "新增资产漏洞自动化扫描计划状态": "排队中",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 09:12:18",
    "资产漏洞自动化扫描计划属性": "排队中",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 09:12:18",
    "资产漏洞自动化扫描计划所属部门": "资产管理部",
    "资产漏洞自动化扫描计划负责人": "王五",
    "资产漏洞自动化扫描计划类型": "排队中",
    "资产漏洞自动化扫描计划规则": "排队中",
  ...
  {
    "ID": 8,
    "资产漏洞自动化扫描计划ID": "Q-143017",
    "资产漏洞自动化扫描计划编号": "Q-143017",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-8",
    "新增资产漏洞自动化扫描计划状态": "部分完成",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 09:35:44",
    "资产漏洞自动化扫描计划属性": "部分完成",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 09:35:44",
    "资产漏洞自动化扫描计划所属部门": "信息安全部",
    "资产漏洞自动化扫描计划负责人": "赵六",
    "资产漏洞自动化扫描计划类型": "部分完成",
    "资产漏洞自动化扫描计划规则": "部分完成",
  ...
  {
    "ID": 9,
    "资产漏洞自动化扫描计划ID": "Q-150936",
    "资产漏洞自动化扫描计划编号": "Q-150936",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-9",
    "新增资产漏洞自动化扫描计划状态": "已启用",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 10:08:06",
    "资产漏洞自动化扫描计划属性": "已启用",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 10:08:06",
    "资产漏洞自动化扫描计划所属部门": "系统运维部",
    "资产漏洞自动化扫描计划负责人": "system",
    "资产漏洞自动化扫描计划类型": "已启用",
    "资产漏洞自动化扫描计划规则": "已启用",
  ...
  {
    "ID": 10,
    "资产漏洞自动化扫描计划ID": "Q-158855",
    "资产漏洞自动化扫描计划编号": "Q-158855",
    "资产漏洞自动化扫描计划名称": "资产漏洞自动化扫描计划管理-10",
    "新增资产漏洞自动化扫描计划状态": "已停用",
    "新增资产漏洞自动化扫描计划时间": "2026-05-08 10:42:31",
    "资产漏洞自动化扫描计划属性": "已停用",
    "资产漏洞自动化扫描计划创建时间": "2026-05-08 10:42:31",
    "资产漏洞自动化扫描计划所属部门": "数据管理部",
    "资产漏洞自动化扫描计划负责人": "admin",
    "资产漏洞自动化扫描计划类型": "已停用",
    "资产漏洞自动化扫描计划规则": "已停用",
...
const tableColumns = [
  ...
  {
    "prop": "新增资产漏洞自动化扫描计划状态",
    "label": "新增资产漏洞自动化扫描计划状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增资产漏洞自动化扫描计划时间",
    "label": "新增资产漏洞自动化扫描计划时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产漏洞自动化扫描计划创建时间",
    "label": "资产漏洞自动化扫描计划创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产漏洞自动化扫描计划所属部门",
    "label": "资产漏洞自动化扫描计划所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
