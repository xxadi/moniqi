    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架考核项目完整性稽核规则", "form")'>新增开源框架考核项目完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架考核项目完整性上传任务", "form")'>新增开源框架考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除开源框架考核项目完整性上传任务")'>删除开源框架考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改开源框架考核项目完整性上传任务", "config")'>修改开源框架考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询开源框架考核项目完整性上传任务", "detail")'>查询开源框架考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("开源框架考核项目完整性上传任务启用/禁用", "form")'>开源框架考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("开源框架考核项目完整性稽核数据上传", "form")'>开源框架考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("开源框架考核项目完整性稽核数据接口监控", "log")'>开源框架考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增开源框架数据考核项目完整性字典信息", "form")'>新增开源框架数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改开源框架数据考核项目完整性字典信息", "config")'>修改开源框架数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除开源框架数据考核项目完整性字典信息")'>删除开源框架数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增产品界面语言考核项目完整性稽核规则", "form")'>新增产品界面语言考核项目完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增产品界面语言数据考核项目完整性字典信息", "form")'>新增产品界面语言数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改产品界面语言数据考核项目完整性字典信息", "config")'>修改产品界面语言数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除产品界面语言数据考核项目完整性字典信息")'>删除产品界面语言数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增操作系统类型数据考核项目完整性字典信息", "form")'>新增操作系统类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改操作系统类型数据考核项目完整性字典信息", "config")'>修改操作系统类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除操作系统类型数据考核项目完整性字典信息")'>删除操作系统类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增硬件环境数据考核项目完整性字典信息", "form")'>新增硬件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改硬件环境数据考核项目完整性字典信息", "config")'>修改硬件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除硬件环境数据考核项目完整性字典信息")'>删除硬件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增软件环境数据考核项目完整性字典信息", "form")'>新增软件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改软件环境数据考核项目完整性字典信息", "config")'>修改软件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除软件环境数据考核项目完整性字典信息")'>删除软件环境数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增网络单元类型数据考核项目完整性字典信息", "form")'>新增网络单元类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络单元类型数据考核项目完整性字典信息", "config")'>修改网络单元类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除网络单元类型数据考核项目完整性字典信息")'>删除网络单元类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象名称数据考核项目完整性字典信息", "form")'>新增定级对象名称数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象名称数据考核项目完整性字典信息", "config")'>修改定级对象名称数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除定级对象名称数据考核项目完整性字典信息")'>删除定级对象名称数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象名称考核项目完整性上传任务", "form")'>新增定级对象名称考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除定级对象名称考核项目完整性上传任务")'>删除定级对象名称考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象名称考核项目完整性上传任务", "config")'>修改定级对象名称考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象名称考核项目完整性上传任务", "detail")'>查询定级对象名称考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定级对象名称考核项目完整性上传任务启用/禁用", "form")'>定级对象名称考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象名称考核项目完整性稽核数据上传", "form")'>定级对象名称考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定级对象名称考核项目完整性稽核数据接口监控", "log")'>定级对象名称考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增所属安全域数据考核项目完整性字典信息", "form")'>新增所属安全域数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改所属安全域数据考核项目完整性字典信息", "config")'>修改所属安全域数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除所属安全域数据考核项目完整性字典信息")'>删除所属安全域数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增所属安全域考核项目完整性上传任务", "form")'>新增所属安全域考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除所属安全域考核项目完整性上传任务")'>删除所属安全域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改所属安全域考核项目完整性上传任务", "config")'>修改所属安全域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询所属安全域考核项目完整性上传任务", "detail")'>查询所属安全域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("所属安全域考核项目完整性上传任务启用/禁用", "form")'>所属安全域考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("所属安全域考核项目完整性稽核数据上传", "form")'>所属安全域考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("所属安全域考核项目完整性稽核数据接口监控", "log")'>所属安全域考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "开源框架考核项目完整性稽核ID": "U-78514",
    "开源框架考核项目完整性稽核编号": "U-78514",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-1",
    "新增开源框架考核项目完整性稽核状态": "待处理",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 11:16:09",
    "开源框架考核项目完整性稽核属性": "待处理",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 11:16:09",
    "开源框架考核项目完整性稽核所属部门": "系统运维部",
    "开源框架考核项目完整性稽核负责人": "system",
    "开源框架考核项目完整性稽核类型": "待处理",
    "开源框架考核项目完整性稽核规则": "待处理",
    "开源框架考核项目完整性校验ID": "U-78514"
  },
  {
    "ID": 2,
    "开源框架考核项目完整性稽核ID": "U-86433",
    "开源框架考核项目完整性稽核编号": "U-86433",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-2",
    "新增开源框架考核项目完整性稽核状态": "处理失败",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 14:03:52",
    "开源框架考核项目完整性稽核属性": "处理失败",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 14:03:52",
    "开源框架考核项目完整性稽核所属部门": "数据管理部",
    "开源框架考核项目完整性稽核负责人": "admin",
    "开源框架考核项目完整性稽核类型": "处理失败",
    "开源框架考核项目完整性稽核规则": "处理失败",
    "开源框架考核项目完整性校验ID": "U-86433"
  },
  {
    "ID": 3,
    "开源框架考核项目完整性稽核ID": "U-94352",
    "开源框架考核项目完整性稽核编号": "U-94352",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-3",
    "新增开源框架考核项目完整性稽核状态": "已暂停",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 15:21:37",
    "开源框架考核项目完整性稽核属性": "已暂停",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 15:21:37",
    "开源框架考核项目完整性稽核所属部门": "安全运维部",
    "开源框架考核项目完整性稽核负责人": "张三",
    "开源框架考核项目完整性稽核类型": "已暂停",
    "开源框架考核项目完整性稽核规则": "已暂停",
    "开源框架考核项目完整性校验ID": "U-94352"
  },
  {
    "ID": 4,
    "开源框架考核项目完整性稽核ID": "U-102271",
    "开源框架考核项目完整性稽核编号": "U-102271",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-4",
    "新增开源框架考核项目完整性稽核状态": "已完成",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 16:08:25",
    "开源框架考核项目完整性稽核属性": "已完成",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 16:08:25",
    "开源框架考核项目完整性稽核所属部门": "网络管理部",
    "开源框架考核项目完整性稽核负责人": "李四",
    "开源框架考核项目完整性稽核类型": "已完成",
    "开源框架考核项目完整性稽核规则": "已完成",
    "开源框架考核项目完整性校验ID": "U-102271"
  },
  {
    "ID": 5,
    "开源框架考核项目完整性稽核ID": "U-110190",
    "开源框架考核项目完整性稽核编号": "U-110190",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-5",
    "新增开源框架考核项目完整性稽核状态": "排队中",
    "新增开源框架考核项目完整性稽核时间": "2026-05-09 08:33:11",
    "开源框架考核项目完整性稽核属性": "排队中",
    "开源框架考核项目完整性稽核创建时间": "2026-05-09 08:33:11",
    "开源框架考核项目完整性稽核所属部门": "资产管理部",
    "开源框架考核项目完整性稽核负责人": "王五",
    "开源框架考核项目完整性稽核类型": "排队中",
    "开源框架考核项目完整性稽核规则": "排队中",
    "开源框架考核项目完整性校验ID": "U-110190"
  },
  {
    "ID": 6,
    "开源框架考核项目完整性稽核ID": "U-118109",
    "开源框架考核项目完整性稽核编号": "U-118109",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-6",
    "新增开源框架考核项目完整性稽核状态": "部分完成",
    "新增开源框架考核项目完整性稽核时间": "2026-05-09 09:47:56",
    "开源框架考核项目完整性稽核属性": "部分完成",
    "开源框架考核项目完整性稽核创建时间": "2026-05-09 09:47:56",
    "开源框架考核项目完整性稽核所属部门": "信息安全部",
    "开源框架考核项目完整性稽核负责人": "赵六",
    "开源框架考核项目完整性稽核类型": "部分完成",
    "开源框架考核项目完整性稽核规则": "部分完成",
    "开源框架考核项目完整性校验ID": "U-118109"
  },
  {
    "ID": 7,
    "开源框架考核项目完整性稽核ID": "U-126028",
    "开源框架考核项目完整性稽核编号": "U-126028",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-7",
    "新增开源框架考核项目完整性稽核状态": "已启用",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 09:12:18",
    "开源框架考核项目完整性稽核属性": "已启用",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 09:12:18",
    "开源框架考核项目完整性稽核所属部门": "系统运维部",
    "开源框架考核项目完整性稽核负责人": "system",
    "开源框架考核项目完整性稽核类型": "已启用",
    "开源框架考核项目完整性稽核规则": "已启用",
    "开源框架考核项目完整性校验ID": "U-126028"
  },
  {
    "ID": 8,
    "开源框架考核项目完整性稽核ID": "U-133947",
    "开源框架考核项目完整性稽核编号": "U-133947",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-8",
    "新增开源框架考核项目完整性稽核状态": "已停用",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 09:35:44",
    "开源框架考核项目完整性稽核属性": "已停用",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 09:35:44",
    "开源框架考核项目完整性稽核所属部门": "数据管理部",
    "开源框架考核项目完整性稽核负责人": "admin",
    "开源框架考核项目完整性稽核类型": "已停用",
    "开源框架考核项目完整性稽核规则": "已停用",
    "开源框架考核项目完整性校验ID": "U-133947"
  },
  {
    "ID": 9,
    "开源框架考核项目完整性稽核ID": "U-141866",
    "开源框架考核项目完整性稽核编号": "U-141866",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-9",
    "新增开源框架考核项目完整性稽核状态": "正常",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 10:08:06",
    "开源框架考核项目完整性稽核属性": "正常",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 10:08:06",
    "开源框架考核项目完整性稽核所属部门": "安全运维部",
    "开源框架考核项目完整性稽核负责人": "张三",
    "开源框架考核项目完整性稽核类型": "正常",
    "开源框架考核项目完整性稽核规则": "正常",
    "开源框架考核项目完整性校验ID": "U-141866"
  },
  {
    "ID": 10,
    "开源框架考核项目完整性稽核ID": "U-149785",
    "开源框架考核项目完整性稽核编号": "U-149785",
    "开源框架考核项目完整性稽核名称": "资产其他指标考核项目完整性稽核管理-10",
    "新增开源框架考核项目完整性稽核状态": "异常",
    "新增开源框架考核项目完整性稽核时间": "2026-05-08 10:42:31",
    "开源框架考核项目完整性稽核属性": "异常",
    "开源框架考核项目完整性稽核创建时间": "2026-05-08 10:42:31",
    "开源框架考核项目完整性稽核所属部门": "网络管理部",
    "开源框架考核项目完整性稽核负责人": "李四",
    "开源框架考核项目完整性稽核类型": "异常",
    "开源框架考核项目完整性稽核规则": "异常",
    "开源框架考核项目完整性校验ID": "U-149785"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "开源框架考核项目完整性稽核ID",
    "label": "开源框架考核项目完整性稽核ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核编号",
    "label": "开源框架考核项目完整性稽核编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核名称",
    "label": "开源框架考核项目完整性稽核名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增开源框架考核项目完整性稽核状态",
    "label": "新增开源框架考核项目完整性稽核状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增开源框架考核项目完整性稽核时间",
    "label": "新增开源框架考核项目完整性稽核时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "开源框架考核项目完整性稽核属性",
    "label": "开源框架考核项目完整性稽核属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核创建时间",
    "label": "开源框架考核项目完整性稽核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "开源框架考核项目完整性稽核所属部门",
    "label": "开源框架考核项目完整性稽核所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核负责人",
    "label": "开源框架考核项目完整性稽核负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核类型",
    "label": "开源框架考核项目完整性稽核类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性稽核规则",
    "label": "开源框架考核项目完整性稽核规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "开源框架考核项目完整性校验ID",
    "label": "开源框架考核项目完整性校验ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "开源框架考核项目完整性稽核规则": "",
  "开源框架考核项目完整性校验ID": "",
  "导入来源": "资产其他指标考核项目完整性稽核管理导入模板.xlsx"
};
