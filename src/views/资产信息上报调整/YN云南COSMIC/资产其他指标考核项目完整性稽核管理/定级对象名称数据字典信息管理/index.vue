    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增定级对象名称数据考核项目完整性字典信息')">新增定级对象名称数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改定级对象名称数据考核项目完整性字典信息')">修改定级对象名称数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除定级对象名称数据考核项目完整性字典信息')">删除定级对象名称数据考核项目完整性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "GOD-001", 字典名称: "核心业务系统", 字典类型: "定级对象名称", 字典值: "CoreBizSystem", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "GOD-002", 字典名称: "重要支撑系统", 字典类型: "定级对象名称", 字典值: "ImportantSupport", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "GOD-003", 字典名称: "一般业务系统", 字典类型: "定级对象名称", 字典值: "GeneralBizSystem", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "GOD-004", 字典名称: "基础网络设备", 字典类型: "定级对象名称", 字典值: "BasicNetworkDevice", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "GOD-005", 字典名称: "安全防护设备", 字典类型: "定级对象名称", 字典值: "SecurityDevice", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "定级对象名称", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_DingJiDuiXiangMingCheng_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
