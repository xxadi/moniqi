    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增所属安全域数据考核项目完整性字典信息')">新增所属安全域数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改所属安全域数据考核项目完整性字典信息')">修改所属安全域数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除所属安全域数据考核项目完整性字典信息')">删除所属安全域数据考核项目完整性字典信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 字典编号: "SAD-001", 字典名称: "互联网区", 字典类型: "所属安全域", 字典值: "InternetZone", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 字典编号: "SAD-002", 字典名称: "办公网区", 字典类型: "所属安全域", 字典值: "OfficeZone", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 字典编号: "SAD-003", 字典名称: "生产网区", 字典类型: "所属安全域", 字典值: "ProductionZone", 启用状态: "启用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 字典编号: "SAD-004", 字典名称: "开发测试区", 字典类型: "所属安全域", 字典值: "DevTestZone", 启用状态: "停用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 字典编号: "SAD-005", 字典名称: "管理网区", 字典类型: "所属安全域", 字典值: "ManagementZone", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
...
const defaultRow = { 字典编号: "", 字典名称: "", 字典类型: "所属安全域", 字典值: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "XiangMuWanZhengXing_SuoShuAnQuanYu_ZiDianXinXi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
