    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增产品界面语言数据考核项目完整性字典信息')">新增产品界面语言数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改产品界面语言数据考核项目完整性字典信息')">修改产品界面语言数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除产品界面语言数据考核项目完整性字典信息')">删除产品界面语言数据考核项目完整性字典信息</el-button>
        </div>
