    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部资产合规审批流程", "workflow")'>发起工信部资产合规审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产合规审批指派信息", "form")'>新增工信部资产合规审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产合规审批流程", "form")'>新增工信部资产合规审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产合规审批流程信息", "config")'>修改工信部资产合规审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批流程删除", "operation")'>工信部资产合规审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批流程查询", "detail")'>工信部资产合规审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批附件上传", "form")'>工信部资产合规审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批流程图查看", "preview")'>工信部资产合规审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批流程通知", "audit")'>工信部资产合规审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批结果逐级审批", "audit")'>工信部资产合规审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产合规审批结果拒绝和驳回", "approval")'>工信部资产合规审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "审批流程环节ID": "C-41810",
    "合规审批编号": "C-41810",
    "合规审批名称": "工信部资产合规审批流程管理-1",
    "发起工信部资产合规审批状态": "待处理",
    "工信部资产合规审批流程节点编号": "C-41810",
    "名称": "工信部资产合规审批流程管理-1",
    "类型": "待处理",
    "工信部资产合规审批流程节点规则": "待处理",
    "工信部资产合规审批流程节点属性": "待处理",
    "修改工信部资产合规审批流程节点状态": "待处理",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 2,
    "合规审批ID": "C-49729",
    "审批流程环节ID": "C-49729",
    "合规审批编号": "C-49729",
    "合规审批名称": "工信部资产合规审批流程管理-2",
    "发起工信部资产合规审批状态": "处理失败",
    "工信部资产合规审批流程节点编号": "C-49729",
    "名称": "工信部资产合规审批流程管理-2",
    "类型": "处理失败",
    "工信部资产合规审批流程节点规则": "处理失败",
    "工信部资产合规审批流程节点属性": "处理失败",
    "修改工信部资产合规审批流程节点状态": "处理失败",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 3,
    "合规审批ID": "C-57648",
    "审批流程环节ID": "C-57648",
    "合规审批编号": "C-57648",
    "合规审批名称": "工信部资产合规审批流程管理-3",
    "发起工信部资产合规审批状态": "已暂停",
    "工信部资产合规审批流程节点编号": "C-57648",
    "名称": "工信部资产合规审批流程管理-3",
    "类型": "已暂停",
    "工信部资产合规审批流程节点规则": "已暂停",
    "工信部资产合规审批流程节点属性": "已暂停",
    "修改工信部资产合规审批流程节点状态": "已暂停",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 4,
    "合规审批ID": "C-65567",
    "审批流程环节ID": "C-65567",
    "合规审批编号": "C-65567",
    "合规审批名称": "工信部资产合规审批流程管理-4",
    "发起工信部资产合规审批状态": "已完成",
    "工信部资产合规审批流程节点编号": "C-65567",
    "名称": "工信部资产合规审批流程管理-4",
    "类型": "已完成",
    "工信部资产合规审批流程节点规则": "已完成",
    "工信部资产合规审批流程节点属性": "已完成",
    "修改工信部资产合规审批流程节点状态": "已完成",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 5,
    "合规审批ID": "C-73486",
    "审批流程环节ID": "C-73486",
    "合规审批编号": "C-73486",
    "合规审批名称": "工信部资产合规审批流程管理-5",
    "发起工信部资产合规审批状态": "排队中",
    "工信部资产合规审批流程节点编号": "C-73486",
    "名称": "工信部资产合规审批流程管理-5",
    "类型": "排队中",
    "工信部资产合规审批流程节点规则": "排队中",
    "工信部资产合规审批流程节点属性": "排队中",
    "修改工信部资产合规审批流程节点状态": "排队中",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 6,
    "合规审批ID": "C-81405",
    "审批流程环节ID": "C-81405",
    "合规审批编号": "C-81405",
    "合规审批名称": "工信部资产合规审批流程管理-6",
    "发起工信部资产合规审批状态": "部分完成",
    "工信部资产合规审批流程节点编号": "C-81405",
    "名称": "工信部资产合规审批流程管理-6",
    "类型": "部分完成",
    "工信部资产合规审批流程节点规则": "部分完成",
    "工信部资产合规审批流程节点属性": "部分完成",
    "修改工信部资产合规审批流程节点状态": "部分完成",
    "修改工信部资产合规审批流程节点时间": "2026-05-08 14:03:52"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部资产合规审批流程节点编号",
    "label": "工信部资产合规审批流程节点编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部资产合规审批流程节点规则",
    "label": "工信部资产合规审批流程节点规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部资产合规审批流程节点属性",
    "label": "工信部资产合规审批流程节点属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改工信部资产合规审批流程节点状态",
    "label": "修改工信部资产合规审批流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改工信部资产合规审批流程节点时间",
    "label": "修改工信部资产合规审批流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
