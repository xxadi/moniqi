    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部采集率轮巡任务设置信息", "form")'>新增工信部采集率轮巡任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率轮巡任务设置信息", "config")'>修改工信部采集率轮巡任务设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率轮巡任务设置信息")'>删除工信部采集率轮巡任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率轮巡任务错误信息监控", "log")'>工信部采集率轮巡任务错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部采集率轮巡任务错误事件通知", "transform")'>工信部采集率轮巡任务错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部采集率轮巡任务错误事件通知删除", "operation")'>工信部采集率轮巡任务错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部采集率轮巡任务错误事件通知查询", "detail")'>工信部采集率轮巡任务错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部采集率轮巡任务防篡改信息", "form")'>新增工信部采集率轮巡任务防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率轮巡任务防篡改信息", "config")'>修改工信部采集率轮巡任务防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率轮巡任务防篡改信息")'>删除工信部采集率轮巡任务防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部采集率轮巡任务设置ID": "A-86138",
    "工信部采集率轮巡任务设置编号": "A-86138",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-1",
    "新增工信部采集率轮巡任务设置状态": "正常",
    "新增工信部采集率轮巡任务设置时间": "2026-05-09 08:33:11",
    "工信部采集率轮巡任务设置属性": "正常",
    "工信部采集率轮巡任务设置创建时间": "2026-05-09 08:33:11",
    "工信部采集率轮巡任务设置所属部门": "资产管理部",
    "工信部采集率轮巡任务设置负责人": "王五",
    "工信部采集率轮巡任务设置类型": "正常",
    "工信部采集率轮巡任务设置规则": "正常",
    "名称": "工信部采集率轮巡任务管理-1"
  ...
  {
    "ID": 2,
    "工信部采集率轮巡任务设置ID": "A-94057",
    "工信部采集率轮巡任务设置编号": "A-94057",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-2",
    "新增工信部采集率轮巡任务设置状态": "异常",
    "新增工信部采集率轮巡任务设置时间": "2026-05-09 09:47:56",
    "工信部采集率轮巡任务设置属性": "异常",
    "工信部采集率轮巡任务设置创建时间": "2026-05-09 09:47:56",
    "工信部采集率轮巡任务设置所属部门": "信息安全部",
    "工信部采集率轮巡任务设置负责人": "赵六",
    "工信部采集率轮巡任务设置类型": "异常",
    "工信部采集率轮巡任务设置规则": "异常",
    "名称": "工信部采集率轮巡任务管理-2"
  ...
  {
    "ID": 3,
    "工信部采集率轮巡任务设置ID": "A-101976",
    "工信部采集率轮巡任务设置编号": "A-101976",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-3",
    "新增工信部采集率轮巡任务设置状态": "超时",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 09:12:18",
    "工信部采集率轮巡任务设置属性": "超时",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 09:12:18",
    "工信部采集率轮巡任务设置所属部门": "系统运维部",
    "工信部采集率轮巡任务设置负责人": "system",
    "工信部采集率轮巡任务设置类型": "超时",
    "工信部采集率轮巡任务设置规则": "超时",
    "名称": "工信部采集率轮巡任务管理-3"
  },
  {
    "ID": 4,
    "工信部采集率轮巡任务设置ID": "A-109895",
    "工信部采集率轮巡任务设置编号": "A-109895",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-4",
    "新增工信部采集率轮巡任务设置状态": "已取消",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 09:35:44",
    "工信部采集率轮巡任务设置属性": "已取消",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 09:35:44",
    "工信部采集率轮巡任务设置所属部门": "数据管理部",
    "工信部采集率轮巡任务设置负责人": "admin",
    "工信部采集率轮巡任务设置类型": "已取消",
    "工信部采集率轮巡任务设置规则": "已取消",
    "名称": "工信部采集率轮巡任务管理-4"
  },
  {
    "ID": 5,
    "工信部采集率轮巡任务设置ID": "A-117814",
    "工信部采集率轮巡任务设置编号": "A-117814",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-5",
    "新增工信部采集率轮巡任务设置状态": "已驳回",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 10:08:06",
    "工信部采集率轮巡任务设置属性": "已驳回",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 10:08:06",
    "工信部采集率轮巡任务设置所属部门": "安全运维部",
    "工信部采集率轮巡任务设置负责人": "张三",
    "工信部采集率轮巡任务设置类型": "已驳回",
    "工信部采集率轮巡任务设置规则": "已驳回",
    "名称": "工信部采集率轮巡任务管理-5"
  ...
  {
    "ID": 6,
    "工信部采集率轮巡任务设置ID": "A-125733",
    "工信部采集率轮巡任务设置编号": "A-125733",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-6",
    "新增工信部采集率轮巡任务设置状态": "待审核",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 10:42:31",
    "工信部采集率轮巡任务设置属性": "待审核",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 10:42:31",
    "工信部采集率轮巡任务设置所属部门": "网络管理部",
    "工信部采集率轮巡任务设置负责人": "李四",
    "工信部采集率轮巡任务设置类型": "待审核",
    "工信部采集率轮巡任务设置规则": "待审核",
    "名称": "工信部采集率轮巡任务管理-6"
  ...
  {
    "ID": 7,
    "工信部采集率轮巡任务设置ID": "A-133652",
    "工信部采集率轮巡任务设置编号": "A-133652",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-7",
    "新增工信部采集率轮巡任务设置状态": "已处理",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 11:16:09",
    "工信部采集率轮巡任务设置属性": "已处理",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 11:16:09",
    "工信部采集率轮巡任务设置所属部门": "资产管理部",
    "工信部采集率轮巡任务设置负责人": "王五",
    "工信部采集率轮巡任务设置类型": "已处理",
    "工信部采集率轮巡任务设置规则": "已处理",
  ...
  {
    "ID": 8,
    "工信部采集率轮巡任务设置ID": "A-141571",
    "工信部采集率轮巡任务设置编号": "A-141571",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-8",
    "新增工信部采集率轮巡任务设置状态": "处理中",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 14:03:52",
    "工信部采集率轮巡任务设置属性": "处理中",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 14:03:52",
    "工信部采集率轮巡任务设置所属部门": "信息安全部",
    "工信部采集率轮巡任务设置负责人": "赵六",
    "工信部采集率轮巡任务设置类型": "处理中",
    "工信部采集率轮巡任务设置规则": "处理中",
  ...
  {
    "ID": 9,
    "工信部采集率轮巡任务设置ID": "A-149490",
    "工信部采集率轮巡任务设置编号": "A-149490",
    "工信部采集率轮巡任务设置名称": "工信部采集率轮巡任务管理-9",
    "新增工信部采集率轮巡任务设置状态": "待处理",
    "新增工信部采集率轮巡任务设置时间": "2026-05-08 15:21:37",
    "工信部采集率轮巡任务设置属性": "待处理",
    "工信部采集率轮巡任务设置创建时间": "2026-05-08 15:21:37",
    "工信部采集率轮巡任务设置所属部门": "系统运维部",
    "工信部采集率轮巡任务设置负责人": "system",
    "工信部采集率轮巡任务设置类型": "待处理",
    "工信部采集率轮巡任务设置规则": "待处理",
...
const tableColumns = [
  ...
  {
    "prop": "工信部采集率轮巡任务设置名称",
    "label": "工信部采集率轮巡任务设置名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增工信部采集率轮巡任务设置状态",
    "label": "新增工信部采集率轮巡任务设置状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增工信部采集率轮巡任务设置时间",
    "label": "新增工信部采集率轮巡任务设置时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部采集率轮巡任务设置属性",
    "label": "工信部采集率轮巡任务设置属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部采集率轮巡任务设置创建时间",
    "label": "工信部采集率轮巡任务设置创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部采集率轮巡任务设置所属部门",
    "label": "工信部采集率轮巡任务设置所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部采集率轮巡任务设置负责人",
    "label": "工信部采集率轮巡任务设置负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
