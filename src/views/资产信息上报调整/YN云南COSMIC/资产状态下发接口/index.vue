    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产状态下发下发接口", "api")'>资产状态下发下发接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产状态下发信息", "form")'>新增资产状态下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产状态下发信息", "config")'>修改资产状态下发信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产状态下发信息")'>删除资产状态下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产状态下发汇总表", "detail")'>查询资产状态下发汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产状态下发详情", "detail")'>查询资产状态下发详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产状态下发")'>批量导入资产状态下发</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产状态下发数据导出")'>资产状态下发数据导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产状态下发名称": "待处理",
    "资产状态下发状态": "待处理",
    "资产状态下发时间": "2026-05-08 10:08:06",
    "资产状态下发属性": "待处理",
    "资产状态下发创建时间": "2026-05-08 10:08:06",
    "资产状态下发所属部门": "待处理",
    "资产状态下发负责人": "待处理",
    "资产状态下发类型": "待处理",
    "资产状态下发规则": "待处理",
  ...
  },
  {
    ...
    "资产状态下发名称": "处理失败",
    "资产状态下发状态": "处理失败",
    "资产状态下发时间": "2026-05-08 10:42:31",
    "资产状态下发属性": "处理失败",
    "资产状态下发创建时间": "2026-05-08 10:42:31",
    "资产状态下发所属部门": "处理失败",
    "资产状态下发负责人": "处理失败",
    "资产状态下发类型": "处理失败",
    "资产状态下发规则": "处理失败",
  ...
  },
  {
    ...
    "资产状态下发名称": "已暂停",
    "资产状态下发状态": "已暂停",
    "资产状态下发时间": "2026-05-08 11:16:09",
    "资产状态下发属性": "已暂停",
    "资产状态下发创建时间": "2026-05-08 11:16:09",
    "资产状态下发所属部门": "已暂停",
    "资产状态下发负责人": "已暂停",
    "资产状态下发类型": "已暂停",
    "资产状态下发规则": "已暂停",
  ...
  },
  {
    ...
    "资产状态下发名称": "已完成",
    "资产状态下发状态": "已完成",
    "资产状态下发时间": "2026-05-08 14:03:52",
    "资产状态下发属性": "已完成",
    "资产状态下发创建时间": "2026-05-08 14:03:52",
    "资产状态下发所属部门": "已完成",
    "资产状态下发负责人": "已完成",
    "资产状态下发类型": "已完成",
    "资产状态下发规则": "已完成",
  ...
  },
  {
    ...
    "资产状态下发名称": "排队中",
    "资产状态下发状态": "排队中",
    "资产状态下发时间": "2026-05-08 15:21:37",
    "资产状态下发属性": "排队中",
    "资产状态下发创建时间": "2026-05-08 15:21:37",
    "资产状态下发所属部门": "排队中",
    "资产状态下发负责人": "排队中",
    "资产状态下发类型": "排队中",
    "资产状态下发规则": "排队中",
  ...
  },
  {
    ...
    "资产状态下发名称": "部分完成",
    "资产状态下发状态": "部分完成",
    "资产状态下发时间": "2026-05-08 16:08:25",
    "资产状态下发属性": "部分完成",
    "资产状态下发创建时间": "2026-05-08 16:08:25",
    "资产状态下发所属部门": "部分完成",
    "资产状态下发负责人": "部分完成",
    "资产状态下发类型": "部分完成",
    "资产状态下发规则": "部分完成",
  ...
  },
  {
    ...
    "资产状态下发名称": "已启用",
    "资产状态下发状态": "已启用",
    "资产状态下发时间": "2026-05-09 08:33:11",
    "资产状态下发属性": "已启用",
    "资产状态下发创建时间": "2026-05-09 08:33:11",
    "资产状态下发所属部门": "已启用",
    "资产状态下发负责人": "已启用",
    "资产状态下发类型": "已启用",
    "资产状态下发规则": "已启用",
  ...
  },
  {
    ...
    "资产状态下发名称": "已停用",
    "资产状态下发状态": "已停用",
    "资产状态下发时间": "2026-05-09 09:47:56",
    "资产状态下发属性": "已停用",
    "资产状态下发创建时间": "2026-05-09 09:47:56",
    "资产状态下发所属部门": "已停用",
    "资产状态下发负责人": "已停用",
    "资产状态下发类型": "已停用",
    "资产状态下发规则": "已停用",
