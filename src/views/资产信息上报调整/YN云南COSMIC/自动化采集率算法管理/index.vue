    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据分析算法", "analysis")'>自动化采集率数据分析算法</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义自动化采集率算法信息", "transform")'>定义自动化采集率算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化采集率算法信息", "config")'>修改自动化采集率算法信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动化采集率算法信息")'>删除自动化采集率算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率算法数据获取", "transform")'>自动化采集率算法数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率算法数据上传", "form")'>自动化采集率算法数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自动化采集率算法数据接口监控", "log")'>自动化采集率算法数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率算法汇总报告详情", "detail")'>查询自动化采集率算法汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率算法明细报告详情", "detail")'>查询自动化采集率算法明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率数据聚类算法", "transform")'>自动化采集率数据聚类算法</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "主叫省份": "处理失败",
    "主叫运营商": "处理失败",
    "自动化采集率响应时间": "2026-05-08 09:35:44",
    "自动化采集率数据分析结果入库时间": "2026-05-08 09:35:44",
    "自动化采集率算法ID": "D-6451",
    "自动化采集率算法编号": "D-6451",
    "自动化采集率算法名称": "自动化采集率算法管理-1",
    "新增自动化采集率算法状态": "处理失败",
    "新增自动化采集率算法时间": "2026-05-08 09:35:44",
    "自动化采集率算法属性": "处理失败"
  },
  {
    "ID": 2,
    ...
    "主叫省份": "已暂停",
    "主叫运营商": "已暂停",
    "自动化采集率响应时间": "2026-05-08 10:08:06",
    "自动化采集率数据分析结果入库时间": "2026-05-08 10:08:06",
    "自动化采集率算法ID": "D-14370",
    "自动化采集率算法编号": "D-14370",
    "自动化采集率算法名称": "自动化采集率算法管理-2",
    "新增自动化采集率算法状态": "已暂停",
    "新增自动化采集率算法时间": "2026-05-08 10:08:06",
    "自动化采集率算法属性": "已暂停"
  },
  {
    "ID": 3,
    ...
    "主叫省份": "已完成",
    "主叫运营商": "已完成",
    "自动化采集率响应时间": "2026-05-08 10:42:31",
    "自动化采集率数据分析结果入库时间": "2026-05-08 10:42:31",
    "自动化采集率算法ID": "D-22289",
    "自动化采集率算法编号": "D-22289",
    "自动化采集率算法名称": "自动化采集率算法管理-3",
    "新增自动化采集率算法状态": "已完成",
    "新增自动化采集率算法时间": "2026-05-08 10:42:31",
    "自动化采集率算法属性": "已完成"
  },
  {
    "ID": 4,
    ...
    "主叫省份": "排队中",
    "主叫运营商": "排队中",
    "自动化采集率响应时间": "2026-05-08 11:16:09",
    "自动化采集率数据分析结果入库时间": "2026-05-08 11:16:09",
    "自动化采集率算法ID": "D-30208",
    "自动化采集率算法编号": "D-30208",
    "自动化采集率算法名称": "自动化采集率算法管理-4",
    "新增自动化采集率算法状态": "排队中",
    "新增自动化采集率算法时间": "2026-05-08 11:16:09",
    "自动化采集率算法属性": "排队中"
  },
  {
    "ID": 5,
    ...
    "主叫省份": "部分完成",
    "主叫运营商": "部分完成",
    "自动化采集率响应时间": "2026-05-08 14:03:52",
    "自动化采集率数据分析结果入库时间": "2026-05-08 14:03:52",
    "自动化采集率算法ID": "D-38127",
    "自动化采集率算法编号": "D-38127",
    "自动化采集率算法名称": "自动化采集率算法管理-5",
    "新增自动化采集率算法状态": "部分完成",
    "新增自动化采集率算法时间": "2026-05-08 14:03:52",
    "自动化采集率算法属性": "部分完成"
  },
  {
    "ID": 6,
    ...
    "主叫省份": "已启用",
    "主叫运营商": "已启用",
    "自动化采集率响应时间": "2026-05-08 15:21:37",
    "自动化采集率数据分析结果入库时间": "2026-05-08 15:21:37",
    "自动化采集率算法ID": "D-46046",
    "自动化采集率算法编号": "D-46046",
    "自动化采集率算法名称": "自动化采集率算法管理-6",
    "新增自动化采集率算法状态": "已启用",
    "新增自动化采集率算法时间": "2026-05-08 15:21:37",
    "自动化采集率算法属性": "已启用"
  },
  {
    "ID": 7,
    ...
    "主叫省份": "已停用",
    "主叫运营商": "已停用",
    "自动化采集率响应时间": "2026-05-08 16:08:25",
    "自动化采集率数据分析结果入库时间": "2026-05-08 16:08:25",
    "自动化采集率算法ID": "D-53965",
    "自动化采集率算法编号": "D-53965",
    "自动化采集率算法名称": "自动化采集率算法管理-7",
    "新增自动化采集率算法状态": "已停用",
    "新增自动化采集率算法时间": "2026-05-08 16:08:25",
    "自动化采集率算法属性": "已停用"
  }
];
const tableColumns = [
  ...
  {
    "prop": "自动化采集率数据分析结果入库时间",
    "label": "自动化采集率数据分析结果入库时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
