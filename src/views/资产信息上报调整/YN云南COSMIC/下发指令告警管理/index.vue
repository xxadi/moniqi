    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令告警", "audit")'>下发指令告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令告警信息", "form")'>新增下发指令告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令告警信息", "config")'>修改下发指令告警信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令告警信息")'>删除下发指令告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询下发指令告警汇总表", "detail")'>查询下发指令告警汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询下发指令告警详情", "detail")'>查询下发指令告警详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入下发指令告警")'>批量导入下发指令告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("下发指令告警信息导出")'>下发指令告警信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "下发指令告警名称": "下发指令告警管理-1",
    "下发指令告警状态": "已暂停",
    "下发指令告警时间": "2026-05-09 08:33:11",
    "下发指令告警属性": "已暂停",
    "下发指令告警创建时间": "2026-05-09 08:33:11",
    "下发指令告警所属部门": "资产管理部",
    "下发指令告警负责人": "王五",
    "下发指令告警类型": "已暂停",
    "下发指令告警规则": "已暂停",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-2",
    "下发指令告警状态": "已完成",
    "下发指令告警时间": "2026-05-09 09:47:56",
    "下发指令告警属性": "已完成",
    "下发指令告警创建时间": "2026-05-09 09:47:56",
    "下发指令告警所属部门": "信息安全部",
    "下发指令告警负责人": "赵六",
    "下发指令告警类型": "已完成",
    "下发指令告警规则": "已完成",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-3",
    "下发指令告警状态": "排队中",
    "下发指令告警时间": "2026-05-08 09:12:18",
    "下发指令告警属性": "排队中",
    "下发指令告警创建时间": "2026-05-08 09:12:18",
    "下发指令告警所属部门": "系统运维部",
    "下发指令告警负责人": "system",
    "下发指令告警类型": "排队中",
    "下发指令告警规则": "排队中",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-4",
    "下发指令告警状态": "部分完成",
    "下发指令告警时间": "2026-05-08 09:35:44",
    "下发指令告警属性": "部分完成",
    "下发指令告警创建时间": "2026-05-08 09:35:44",
    "下发指令告警所属部门": "数据管理部",
    "下发指令告警负责人": "admin",
    "下发指令告警类型": "部分完成",
    "下发指令告警规则": "部分完成",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-5",
    "下发指令告警状态": "已启用",
    "下发指令告警时间": "2026-05-08 10:08:06",
    "下发指令告警属性": "已启用",
    "下发指令告警创建时间": "2026-05-08 10:08:06",
    "下发指令告警所属部门": "安全运维部",
    "下发指令告警负责人": "张三",
    "下发指令告警类型": "已启用",
    "下发指令告警规则": "已启用",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-6",
    "下发指令告警状态": "已停用",
    "下发指令告警时间": "2026-05-08 10:42:31",
    "下发指令告警属性": "已停用",
    "下发指令告警创建时间": "2026-05-08 10:42:31",
    "下发指令告警所属部门": "网络管理部",
    "下发指令告警负责人": "李四",
    "下发指令告警类型": "已停用",
    "下发指令告警规则": "已停用",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-7",
    "下发指令告警状态": "正常",
    "下发指令告警时间": "2026-05-08 11:16:09",
    "下发指令告警属性": "正常",
    "下发指令告警创建时间": "2026-05-08 11:16:09",
    "下发指令告警所属部门": "资产管理部",
    "下发指令告警负责人": "王五",
    "下发指令告警类型": "正常",
    "下发指令告警规则": "正常",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-8",
    "下发指令告警状态": "异常",
    "下发指令告警时间": "2026-05-08 14:03:52",
    "下发指令告警属性": "异常",
    "下发指令告警创建时间": "2026-05-08 14:03:52",
    "下发指令告警所属部门": "信息安全部",
    "下发指令告警负责人": "赵六",
    "下发指令告警类型": "异常",
    "下发指令告警规则": "异常",
  ...
  },
  {
    ...
    "下发指令告警名称": "下发指令告警管理-9",
    "下发指令告警状态": "超时",
    "下发指令告警时间": "2026-05-08 15:21:37",
    "下发指令告警属性": "超时",
    "下发指令告警创建时间": "2026-05-08 15:21:37",
    "下发指令告警所属部门": "系统运维部",
    "下发指令告警负责人": "system",
    "下发指令告警类型": "超时",
    "下发指令告警规则": "超时",
