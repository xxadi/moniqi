    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产信息上报接口", "api")'>资产信息上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息上报信息", "form")'>新增资产信息上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息上报信息", "config")'>修改资产信息上报信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息上报信息")'>删除资产信息上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产信息上报汇总表", "detail")'>查询资产信息上报汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产信息上报详情", "detail")'>查询资产信息上报详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产信息上报")'>批量导入资产信息上报</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产信息上报数据导出")'>资产信息上报数据导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产编号上报名称": "O-43850",
    "资产编号上报状态": "O-43850",
    "资产编号上报时间": "2026-05-08 09:12:18",
    "资产编号上报属性": "O-43850",
    "资产编号上报创建时间": "2026-05-08 09:12:18",
    "资产编号上报所属部门": "O-43850",
    "资产编号上报负责人": "O-43850",
    "资产编号上报类型": "O-43850",
    "资产编号上报规则": "O-43850",
  ...
  },
  {
    ...
    "资产编号上报名称": "O-51769",
    "资产编号上报状态": "O-51769",
    "资产编号上报时间": "2026-05-08 09:35:44",
    "资产编号上报属性": "O-51769",
    "资产编号上报创建时间": "2026-05-08 09:35:44",
    "资产编号上报所属部门": "O-51769",
    "资产编号上报负责人": "O-51769",
    "资产编号上报类型": "O-51769",
    "资产编号上报规则": "O-51769",
  ...
  },
  {
    ...
    "资产编号上报名称": "O-59688",
    "资产编号上报状态": "O-59688",
    "资产编号上报时间": "2026-05-08 10:08:06",
    "资产编号上报属性": "O-59688",
    "资产编号上报创建时间": "2026-05-08 10:08:06",
    "资产编号上报所属部门": "O-59688",
    "资产编号上报负责人": "O-59688",
    "资产编号上报类型": "O-59688",
    "资产编号上报规则": "O-59688",
  ...
  },
  {
    ...
    "资产编号上报名称": "O-67607",
    "资产编号上报状态": "O-67607",
    "资产编号上报时间": "2026-05-08 10:42:31",
    "资产编号上报属性": "O-67607",
    "资产编号上报创建时间": "2026-05-08 10:42:31",
    "资产编号上报所属部门": "O-67607",
    "资产编号上报负责人": "O-67607",
    "资产编号上报类型": "O-67607",
    "资产编号上报规则": "O-67607",
  ...
  },
  {
    ...
    "资产编号上报名称": "O-75526",
    "资产编号上报状态": "O-75526",
    "资产编号上报时间": "2026-05-08 11:16:09",
    "资产编号上报属性": "O-75526",
    "资产编号上报创建时间": "2026-05-08 11:16:09",
    "资产编号上报所属部门": "O-75526",
    "资产编号上报负责人": "O-75526",
    "资产编号上报类型": "O-75526",
    "资产编号上报规则": "O-75526",
  ...
  },
  {
    ...
    "资产编号上报名称": "O-83445",
    "资产编号上报状态": "O-83445",
    "资产编号上报时间": "2026-05-08 14:03:52",
    "资产编号上报属性": "O-83445",
    "资产编号上报创建时间": "2026-05-08 14:03:52",
    "资产编号上报所属部门": "O-83445",
    "资产编号上报负责人": "O-83445",
    "资产编号上报类型": "O-83445",
    "资产编号上报规则": "O-83445",
