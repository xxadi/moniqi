    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产省份考核项目完整性信息表", "operation")'>资产省份考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产归属考核项目完整性稽核数据上传", "form")'>资产归属考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属考核项目完整性稽核数据接口监控", "log")'>资产归属考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产所属部门考核项目完整性信息表", "operation")'>资产所属部门考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产组织考核项目完整性稽核数据上传", "form")'>资产组织考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组织考核项目完整性稽核数据接口监控", "log")'>资产组织考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产省份考核项目完整性ID": "X-86811",
    "资产省份考核项目完整性编号": "X-86811",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-1",
    "资产省份考核项目完整性状态": "异常",
    "资产省份考核项目完整性时间": "2026-05-08 09:35:44",
    "资产省份考核项目完整性属性": "异常",
    "资产省份考核项目完整性创建时间": "2026-05-08 09:35:44",
    "资产省份考核项目完整性所属部门": "信息安全部",
    "资产省份考核项目完整性负责人": "赵六",
    "资产省份考核项目完整性类型": "异常",
    "资产省份考核项目完整性规则": "异常",
    "数据上传资源编码": "异常"
  ...
  {
    "ID": 2,
    "资产省份考核项目完整性ID": "X-94730",
    "资产省份考核项目完整性编号": "X-94730",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-2",
    "资产省份考核项目完整性状态": "超时",
    "资产省份考核项目完整性时间": "2026-05-08 10:08:06",
    "资产省份考核项目完整性属性": "超时",
    "资产省份考核项目完整性创建时间": "2026-05-08 10:08:06",
    "资产省份考核项目完整性所属部门": "系统运维部",
    "资产省份考核项目完整性负责人": "system",
    "资产省份考核项目完整性类型": "超时",
    "资产省份考核项目完整性规则": "超时",
    "数据上传资源编码": "超时"
  },
  {
    "ID": 3,
    "资产省份考核项目完整性ID": "X-102649",
    "资产省份考核项目完整性编号": "X-102649",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-3",
    "资产省份考核项目完整性状态": "已取消",
    "资产省份考核项目完整性时间": "2026-05-08 10:42:31",
    "资产省份考核项目完整性属性": "已取消",
    "资产省份考核项目完整性创建时间": "2026-05-08 10:42:31",
    "资产省份考核项目完整性所属部门": "数据管理部",
    "资产省份考核项目完整性负责人": "admin",
    "资产省份考核项目完整性类型": "已取消",
    "资产省份考核项目完整性规则": "已取消",
    "数据上传资源编码": "已取消"
  },
  {
    "ID": 4,
    "资产省份考核项目完整性ID": "X-110568",
    "资产省份考核项目完整性编号": "X-110568",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-4",
    "资产省份考核项目完整性状态": "已驳回",
    "资产省份考核项目完整性时间": "2026-05-08 11:16:09",
    "资产省份考核项目完整性属性": "已驳回",
    "资产省份考核项目完整性创建时间": "2026-05-08 11:16:09",
    "资产省份考核项目完整性所属部门": "安全运维部",
    "资产省份考核项目完整性负责人": "张三",
    "资产省份考核项目完整性类型": "已驳回",
    "资产省份考核项目完整性规则": "已驳回",
    "数据上传资源编码": "已驳回"
  ...
  {
    "ID": 5,
    "资产省份考核项目完整性ID": "X-118487",
    "资产省份考核项目完整性编号": "X-118487",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-5",
    "资产省份考核项目完整性状态": "待审核",
    "资产省份考核项目完整性时间": "2026-05-08 14:03:52",
    "资产省份考核项目完整性属性": "待审核",
    "资产省份考核项目完整性创建时间": "2026-05-08 14:03:52",
    "资产省份考核项目完整性所属部门": "网络管理部",
    "资产省份考核项目完整性负责人": "李四",
    "资产省份考核项目完整性类型": "待审核",
    "资产省份考核项目完整性规则": "待审核",
    "数据上传资源编码": "待审核"
  ...
  {
    "ID": 6,
    "资产省份考核项目完整性ID": "X-126406",
    "资产省份考核项目完整性编号": "X-126406",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-6",
    "资产省份考核项目完整性状态": "已处理",
    "资产省份考核项目完整性时间": "2026-05-08 15:21:37",
    "资产省份考核项目完整性属性": "已处理",
    "资产省份考核项目完整性创建时间": "2026-05-08 15:21:37",
    "资产省份考核项目完整性所属部门": "资产管理部",
    "资产省份考核项目完整性负责人": "王五",
    "资产省份考核项目完整性类型": "已处理",
    "资产省份考核项目完整性规则": "已处理",
    "数据上传资源编码": "已处理"
  ...
  {
    "ID": 7,
    "资产省份考核项目完整性ID": "X-134325",
    "资产省份考核项目完整性编号": "X-134325",
    "资产省份考核项目完整性名称": "资产省份考核项目完整性指标管理-7",
    "资产省份考核项目完整性状态": "处理中",
    "资产省份考核项目完整性时间": "2026-05-08 16:08:25",
    "资产省份考核项目完整性属性": "处理中",
    "资产省份考核项目完整性创建时间": "2026-05-08 16:08:25",
    "资产省份考核项目完整性所属部门": "信息安全部",
    "资产省份考核项目完整性负责人": "赵六",
    "资产省份考核项目完整性类型": "处理中",
    "资产省份考核项目完整性规则": "处理中",
...
const tableColumns = [
  ...
  {
    "prop": "资产省份考核项目完整性创建时间",
    "label": "资产省份考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产省份考核项目完整性所属部门",
    "label": "资产省份考核项目完整性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
