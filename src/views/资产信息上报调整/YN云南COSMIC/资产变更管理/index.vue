    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更信息表", "operation")'>资产变更信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产变更任务", "form")'>新增资产变更任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产变更模型", "form")'>新增资产变更模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产变更模型", "config")'>修改资产变更模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产变更模型")'>删除资产变更模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更查询", "detail")'>资产变更查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更可视化展示", "detail")'>资产变更可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产变更名称": "资产变更管理-1",
    "资产变更状态": "已暂停",
    "资产变更时间": "2026-05-08 09:12:18",
    "资产变更属性": "已暂停",
    "资产变更创建时间": "2026-05-08 09:12:18",
    "资产变更所属部门": "系统运维部",
    "资产变更负责人": "system",
    "资产变更类型": "已暂停",
    "资产变更模型": "已暂停",
  ...
  },
  {
    ...
    "资产变更名称": "资产变更管理-2",
    "资产变更状态": "已完成",
    "资产变更时间": "2026-05-08 09:35:44",
    "资产变更属性": "已完成",
    "资产变更创建时间": "2026-05-08 09:35:44",
    "资产变更所属部门": "数据管理部",
    "资产变更负责人": "admin",
    "资产变更类型": "已完成",
    "资产变更模型": "已完成",
