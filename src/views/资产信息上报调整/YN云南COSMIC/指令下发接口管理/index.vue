...
const initialRows = [
  {
    ...
    "指令下发名称": "指令下发接口管理-1",
    "新增指令下发状态": "排队中",
    "新增指令下发时间": "2026-05-09 08:33:11",
    "新增指令下发设置时间_": "2026-05-09 08:33:11",
    "指令下发属性": "排队中",
    "指令下发创建时间": "2026-05-09 08:33:11",
    "新增指令下发设置结果": "排队中",
    "指令下发所属部门": "资产管理部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-2",
    "新增指令下发状态": "部分完成",
    "新增指令下发时间": "2026-05-09 09:47:56",
    "新增指令下发设置时间_": "2026-05-09 09:47:56",
    "指令下发属性": "部分完成",
    "指令下发创建时间": "2026-05-09 09:47:56",
    "新增指令下发设置结果": "部分完成",
    "指令下发所属部门": "信息安全部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-3",
    "新增指令下发状态": "已启用",
    "新增指令下发时间": "2026-05-08 09:12:18",
    "新增指令下发设置时间_": "2026-05-08 09:12:18",
    "指令下发属性": "已启用",
    "指令下发创建时间": "2026-05-08 09:12:18",
    "新增指令下发设置结果": "已启用",
    "指令下发所属部门": "系统运维部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-4",
    "新增指令下发状态": "已停用",
    "新增指令下发时间": "2026-05-08 09:35:44",
    "新增指令下发设置时间_": "2026-05-08 09:35:44",
    "指令下发属性": "已停用",
    "指令下发创建时间": "2026-05-08 09:35:44",
    "新增指令下发设置结果": "已停用",
    "指令下发所属部门": "数据管理部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-5",
    "新增指令下发状态": "正常",
    "新增指令下发时间": "2026-05-08 10:08:06",
    "新增指令下发设置时间_": "2026-05-08 10:08:06",
    "指令下发属性": "正常",
    "指令下发创建时间": "2026-05-08 10:08:06",
    "新增指令下发设置结果": "正常",
    "指令下发所属部门": "安全运维部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-6",
    "新增指令下发状态": "异常",
    "新增指令下发时间": "2026-05-08 10:42:31",
    "新增指令下发设置时间_": "2026-05-08 10:42:31",
    "指令下发属性": "异常",
    "指令下发创建时间": "2026-05-08 10:42:31",
    "新增指令下发设置结果": "异常",
    "指令下发所属部门": "网络管理部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-7",
    "新增指令下发状态": "超时",
    "新增指令下发时间": "2026-05-08 11:16:09",
    "新增指令下发设置时间_": "2026-05-08 11:16:09",
    "指令下发属性": "超时",
    "指令下发创建时间": "2026-05-08 11:16:09",
    "新增指令下发设置结果": "超时",
    "指令下发所属部门": "资产管理部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-8",
    "新增指令下发状态": "已取消",
    "新增指令下发时间": "2026-05-08 14:03:52",
    "新增指令下发设置时间_": "2026-05-08 14:03:52",
    "指令下发属性": "已取消",
    "指令下发创建时间": "2026-05-08 14:03:52",
    "新增指令下发设置结果": "已取消",
    "指令下发所属部门": "信息安全部"
  },
  {
    ...
    "指令下发名称": "指令下发接口管理-9",
    "新增指令下发状态": "已驳回",
    "新增指令下发时间": "2026-05-08 15:21:37",
    "新增指令下发设置时间_": "2026-05-08 15:21:37",
    "指令下发属性": "已驳回",
    "指令下发创建时间": "2026-05-08 15:21:37",
    "新增指令下发设置结果": "已驳回",
    "指令下发所属部门": "系统运维部"
  }
];
