    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产发现方式配置信息", "form")'>新增资产发现方式配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产发现方式配置信息", "config")'>修改资产发现方式配置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产发现方式配置信息")'>删除资产发现方式配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产发现方式配置汇总表", "detail")'>查询资产发现方式配置汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产发现方式配置详情", "detail")'>查询资产发现方式配置详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产发现方式配置")'>批量导入资产发现方式配置</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产发现方式配置导出")'>资产发现方式配置导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产发现方式配置ID": "W-77918",
    "资产发现方式配置编号": "W-77918",
    "资产发现方式配置名称": "资产发现方式配置管理-1",
    "新增资产发现方式配置状态": "已驳回",
    "新增资产发现方式配置时间": "2026-05-09 08:33:11",
    "资产发现方式配置属性": "已驳回",
    "资产发现方式配置创建时间": "2026-05-09 08:33:11",
    "资产发现方式配置所属部门": "资产管理部",
    "资产发现方式配置负责人": "王五",
    "资产发现方式配置类型": "已驳回",
    "资产发现方式配置规则": "已驳回",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-85837",
    "资产发现方式配置编号": "W-85837",
    "资产发现方式配置名称": "资产发现方式配置管理-2",
    "新增资产发现方式配置状态": "待审核",
    "新增资产发现方式配置时间": "2026-05-09 09:47:56",
    "资产发现方式配置属性": "待审核",
    "资产发现方式配置创建时间": "2026-05-09 09:47:56",
    "资产发现方式配置所属部门": "信息安全部",
    "资产发现方式配置负责人": "赵六",
    "资产发现方式配置类型": "待审核",
    "资产发现方式配置规则": "待审核",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-93756",
    "资产发现方式配置编号": "W-93756",
    "资产发现方式配置名称": "资产发现方式配置管理-3",
    "新增资产发现方式配置状态": "已处理",
    "新增资产发现方式配置时间": "2026-05-08 09:12:18",
    "资产发现方式配置属性": "已处理",
    "资产发现方式配置创建时间": "2026-05-08 09:12:18",
    "资产发现方式配置所属部门": "系统运维部",
    "资产发现方式配置负责人": "system",
    "资产发现方式配置类型": "已处理",
    "资产发现方式配置规则": "已处理",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-101675",
    "资产发现方式配置编号": "W-101675",
    "资产发现方式配置名称": "资产发现方式配置管理-4",
    "新增资产发现方式配置状态": "处理中",
    "新增资产发现方式配置时间": "2026-05-08 09:35:44",
    "资产发现方式配置属性": "处理中",
    "资产发现方式配置创建时间": "2026-05-08 09:35:44",
    "资产发现方式配置所属部门": "数据管理部",
    "资产发现方式配置负责人": "admin",
    "资产发现方式配置类型": "处理中",
    "资产发现方式配置规则": "处理中",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-109594",
    "资产发现方式配置编号": "W-109594",
    "资产发现方式配置名称": "资产发现方式配置管理-5",
    "新增资产发现方式配置状态": "待处理",
    "新增资产发现方式配置时间": "2026-05-08 10:08:06",
    "资产发现方式配置属性": "待处理",
    "资产发现方式配置创建时间": "2026-05-08 10:08:06",
    "资产发现方式配置所属部门": "安全运维部",
    "资产发现方式配置负责人": "张三",
    "资产发现方式配置类型": "待处理",
    "资产发现方式配置规则": "待处理",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-117513",
    "资产发现方式配置编号": "W-117513",
    "资产发现方式配置名称": "资产发现方式配置管理-6",
    "新增资产发现方式配置状态": "处理失败",
    "新增资产发现方式配置时间": "2026-05-08 10:42:31",
    "资产发现方式配置属性": "处理失败",
    "资产发现方式配置创建时间": "2026-05-08 10:42:31",
    "资产发现方式配置所属部门": "网络管理部",
    "资产发现方式配置负责人": "李四",
    "资产发现方式配置类型": "处理失败",
    "资产发现方式配置规则": "处理失败",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-125432",
    "资产发现方式配置编号": "W-125432",
    "资产发现方式配置名称": "资产发现方式配置管理-7",
    "新增资产发现方式配置状态": "已暂停",
    "新增资产发现方式配置时间": "2026-05-08 11:16:09",
    "资产发现方式配置属性": "已暂停",
    "资产发现方式配置创建时间": "2026-05-08 11:16:09",
    "资产发现方式配置所属部门": "资产管理部",
    "资产发现方式配置负责人": "王五",
    "资产发现方式配置类型": "已暂停",
    "资产发现方式配置规则": "已暂停",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-133351",
    "资产发现方式配置编号": "W-133351",
    "资产发现方式配置名称": "资产发现方式配置管理-8",
    "新增资产发现方式配置状态": "已完成",
    "新增资产发现方式配置时间": "2026-05-08 14:03:52",
    "资产发现方式配置属性": "已完成",
    "资产发现方式配置创建时间": "2026-05-08 14:03:52",
    "资产发现方式配置所属部门": "信息安全部",
    "资产发现方式配置负责人": "赵六",
    "资产发现方式配置类型": "已完成",
    "资产发现方式配置规则": "已完成",
  ...
  },
  {
    ...
    "资产发现方式配置ID": "W-141270",
    "资产发现方式配置编号": "W-141270",
    "资产发现方式配置名称": "资产发现方式配置管理-9",
    "新增资产发现方式配置状态": "排队中",
    "新增资产发现方式配置时间": "2026-05-08 15:21:37",
    "资产发现方式配置属性": "排队中",
    "资产发现方式配置创建时间": "2026-05-08 15:21:37",
    "资产发现方式配置所属部门": "系统运维部",
    "资产发现方式配置负责人": "system",
    "资产发现方式配置类型": "排队中",
    "资产发现方式配置规则": "排队中",
