    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增AssetIP设置信息", "form")'>新增AssetIP设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改AssetIP设置信息", "config")'>修改AssetIP设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除AssetIP设置信息")'>删除AssetIP设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("AssetIP错误信息监控", "log")'>AssetIP错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("AssetIP错误事件通知", "audit")'>AssetIP错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("AssetIP错误事件通知删除", "operation")'>AssetIP错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("AssetIP错误事件通知查询", "detail")'>AssetIP错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增AssetIP防篡改信息", "form")'>新增AssetIP防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改AssetIP防篡改信息", "config")'>修改AssetIP防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除AssetIP防篡改信息")'>删除AssetIP防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "AssetIP设置ID": "E-14876",
    "AssetIP设置编号": "E-14876",
    "AssetIP设置名称": "AssetIP管理-1",
    "新增AssetIP设置状态": "超时",
    "新增AssetIP设置时间": "2026-05-08 15:21:37",
    "AssetIP设置属性": "192.168.1.200",
    "AssetIP设置创建时间": "2026-05-08 15:21:37",
    "AssetIP设置所属部门": "资产管理部",
    "AssetIP设置负责人": "王五",
    "AssetIP设置类型": "192.168.1.200",
    "AssetIP设置规则": "192.168.1.200",
    "名称": "AssetIP管理-1"
  },
  {
    "ID": 2,
    "AssetIP设置ID": "E-22795",
    "AssetIP设置编号": "E-22795",
    "AssetIP设置名称": "AssetIP管理-2",
    "新增AssetIP设置状态": "已取消",
    "新增AssetIP设置时间": "2026-05-08 16:08:25",
    "AssetIP设置属性": "10.20.5.30",
    "AssetIP设置创建时间": "2026-05-08 16:08:25",
    "AssetIP设置所属部门": "信息安全部",
    "AssetIP设置负责人": "赵六",
    "AssetIP设置类型": "10.20.5.30",
    "AssetIP设置规则": "10.20.5.30",
    "名称": "AssetIP管理-2"
  },
  {
    "ID": 3,
    "AssetIP设置ID": "E-30714",
    "AssetIP设置编号": "E-30714",
    "AssetIP设置名称": "AssetIP管理-3",
    "新增AssetIP设置状态": "已驳回",
    "新增AssetIP设置时间": "2026-05-09 08:33:11",
    "AssetIP设置属性": "172.20.1.80",
    "AssetIP设置创建时间": "2026-05-09 08:33:11",
    "AssetIP设置所属部门": "系统运维部",
    "AssetIP设置负责人": "system",
    "AssetIP设置类型": "172.20.1.80",
    "AssetIP设置规则": "172.20.1.80",
    "名称": "AssetIP管理-3"
  },
  {
    "ID": 4,
    "AssetIP设置ID": "E-38633",
    "AssetIP设置编号": "E-38633",
    "AssetIP设置名称": "AssetIP管理-4",
    "新增AssetIP设置状态": "待审核",
    "新增AssetIP设置时间": "2026-05-09 09:47:56",
    "AssetIP设置属性": "10.0.0.254",
    "AssetIP设置创建时间": "2026-05-09 09:47:56",
    "AssetIP设置所属部门": "数据管理部",
    "AssetIP设置负责人": "admin",
    "AssetIP设置类型": "10.0.0.254",
    "AssetIP设置规则": "10.0.0.254",
    "名称": "AssetIP管理-4"
  },
  {
    "ID": 5,
    "AssetIP设置ID": "E-46552",
    "AssetIP设置编号": "E-46552",
    "AssetIP设置名称": "AssetIP管理-5",
    "新增AssetIP设置状态": "已处理",
    "新增AssetIP设置时间": "2026-05-08 09:12:18",
    "AssetIP设置属性": "10.10.1.100",
    "AssetIP设置创建时间": "2026-05-08 09:12:18",
    "AssetIP设置所属部门": "安全运维部",
    "AssetIP设置负责人": "张三",
    "AssetIP设置类型": "10.10.1.100",
    "AssetIP设置规则": "10.10.1.100",
    "名称": "AssetIP管理-5"
  },
  {
    "ID": 6,
    "AssetIP设置ID": "E-54471",
    "AssetIP设置编号": "E-54471",
    "AssetIP设置名称": "AssetIP管理-6",
    "新增AssetIP设置状态": "处理中",
    "新增AssetIP设置时间": "2026-05-08 09:35:44",
    "AssetIP设置属性": "172.16.0.50",
    "AssetIP设置创建时间": "2026-05-08 09:35:44",
    "AssetIP设置所属部门": "网络管理部",
    "AssetIP设置负责人": "李四",
    "AssetIP设置类型": "172.16.0.50",
    "AssetIP设置规则": "172.16.0.50",
    "名称": "AssetIP管理-6"
  },
  {
    "ID": 7,
    "AssetIP设置ID": "E-62390",
    "AssetIP设置编号": "E-62390",
    "AssetIP设置名称": "AssetIP管理-7",
    "新增AssetIP设置状态": "待处理",
    "新增AssetIP设置时间": "2026-05-08 10:08:06",
    "AssetIP设置属性": "192.168.1.200",
    "AssetIP设置创建时间": "2026-05-08 10:08:06",
    "AssetIP设置所属部门": "资产管理部",
    "AssetIP设置负责人": "王五",
    "AssetIP设置类型": "192.168.1.200",
    "AssetIP设置规则": "192.168.1.200",
