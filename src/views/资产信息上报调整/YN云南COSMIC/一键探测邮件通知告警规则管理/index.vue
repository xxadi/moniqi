    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增一键探测邮件通知告警规则", "form")'>新增一键探测邮件通知告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改一键探测邮件通知告警规则", "config")'>修改一键探测邮件通知告警规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除一键探测邮件通知告警规则")'>删除一键探测邮件通知告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("一键探测邮件通知稽核", "audit")'>一键探测邮件通知稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("一键探测邮件通知删除", "operation")'>一键探测邮件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("一键探测邮件通知查询", "detail")'>一键探测邮件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("一键探测邮件通知统计", "statistics")'>一键探测邮件通知统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全网端口扫描信息", "form")'>新增全网端口扫描信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全网端口扫描信息", "config")'>修改全网端口扫描信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除全网端口扫描信息")'>删除全网端口扫描信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("检索全网端口扫描列表", "operation")'>检索全网端口扫描列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全网端口扫描下发回传同步", "sync")'>全网端口扫描下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全网端口扫描下发回传任务推送", "audit")'>全网端口扫描下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全网端口扫描数据下发", "operation")'>全网端口扫描数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("全网端口扫描数据分析", "analysis")'>全网端口扫描数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全网端口扫描数据上报", "operation")'>全网端口扫描数据上报</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全网端口扫描结果邮件通知稽核", "audit")'>全网端口扫描结果邮件通知稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全网端口扫描结果邮件通知删除", "operation")'>全网端口扫描结果邮件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全网端口扫描结果邮件通知查询", "detail")'>全网端口扫描结果邮件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全网端口扫描结果邮件通知统计", "statistics")'>全网端口扫描结果邮件通知统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面探测通知任务信息", "form")'>新增暴露面探测通知任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面探测通知任务信息", "config")'>修改暴露面探测通知任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除暴露面探测通知任务信息")'>删除暴露面探测通知任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询暴露面探测通知任务列表", "detail")'>查询暴露面探测通知任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询暴露面探测通知任务详情", "detail")'>查询暴露面探测通知任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入暴露面探测通知任务")'>批量导入暴露面探测通知任务</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面探测通知任删除", "operation")'>暴露面探测通知任删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面探测通知任查询", "detail")'>暴露面探测通知任查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("暴露面探测通知任务导出")'>暴露面探测通知任务导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("互联网暴露面监控", "log")'>互联网暴露面监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("互联网暴露面监控告警", "alert")'>互联网暴露面监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "一键探测邮件通知编号": "S-48768",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-1",
    "告警规则类型": "已处理",
    "规则": "已处理",
    "一键探测邮件通知属性": "已处理",
    "新增一键探测邮件通知状态": "已处理",
    "新增一键探测邮件通知时间": "2026-05-09 08:33:11",
    "一键探测邮件通知ID": "S-48768",
    "告警规则": "已处理",
    "告警规则属性": "已处理",
    "新增一键探测邮件通知告警规则状态": "已处理",
    "属性": "已处理"
  },
  {
    "ID": 2,
    "一键探测邮件通知编号": "S-56687",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-2",
    "告警规则类型": "处理中",
    "规则": "处理中",
    "一键探测邮件通知属性": "处理中",
    "新增一键探测邮件通知状态": "处理中",
    "新增一键探测邮件通知时间": "2026-05-09 09:47:56",
    "一键探测邮件通知ID": "S-56687",
    "告警规则": "处理中",
    "告警规则属性": "处理中",
    "新增一键探测邮件通知告警规则状态": "处理中",
    "属性": "处理中"
  },
  {
    "ID": 3,
    "一键探测邮件通知编号": "S-64606",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-3",
    "告警规则类型": "待处理",
    "规则": "待处理",
    "一键探测邮件通知属性": "待处理",
    "新增一键探测邮件通知状态": "待处理",
    "新增一键探测邮件通知时间": "2026-05-08 09:12:18",
    "一键探测邮件通知ID": "S-64606",
    "告警规则": "待处理",
    "告警规则属性": "待处理",
    "新增一键探测邮件通知告警规则状态": "待处理",
    "属性": "待处理"
  },
  {
    "ID": 4,
    "一键探测邮件通知编号": "S-72525",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-4",
    "告警规则类型": "处理失败",
    "规则": "处理失败",
    "一键探测邮件通知属性": "处理失败",
    "新增一键探测邮件通知状态": "处理失败",
    "新增一键探测邮件通知时间": "2026-05-08 09:35:44",
    "一键探测邮件通知ID": "S-72525",
    "告警规则": "处理失败",
    "告警规则属性": "处理失败",
    "新增一键探测邮件通知告警规则状态": "处理失败",
    "属性": "处理失败"
  },
  {
    "ID": 5,
    "一键探测邮件通知编号": "S-80444",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-5",
    "告警规则类型": "已暂停",
    "规则": "已暂停",
    "一键探测邮件通知属性": "已暂停",
    "新增一键探测邮件通知状态": "已暂停",
    "新增一键探测邮件通知时间": "2026-05-08 10:08:06",
    "一键探测邮件通知ID": "S-80444",
    "告警规则": "已暂停",
    "告警规则属性": "已暂停",
    "新增一键探测邮件通知告警规则状态": "已暂停",
    "属性": "已暂停"
  },
  {
    "ID": 6,
    "一键探测邮件通知编号": "S-88363",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-6",
    "告警规则类型": "已完成",
    "规则": "已完成",
    "一键探测邮件通知属性": "已完成",
    "新增一键探测邮件通知状态": "已完成",
    "新增一键探测邮件通知时间": "2026-05-08 10:42:31",
    "一键探测邮件通知ID": "S-88363",
    "告警规则": "已完成",
    "告警规则属性": "已完成",
    "新增一键探测邮件通知告警规则状态": "已完成",
    "属性": "已完成"
  },
  {
    "ID": 7,
    "一键探测邮件通知编号": "S-96282",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-7",
    "告警规则类型": "排队中",
    "规则": "排队中",
    "一键探测邮件通知属性": "排队中",
    "新增一键探测邮件通知状态": "排队中",
    "新增一键探测邮件通知时间": "2026-05-08 11:16:09",
    "一键探测邮件通知ID": "S-96282",
    "告警规则": "排队中",
    "告警规则属性": "排队中",
    "新增一键探测邮件通知告警规则状态": "排队中",
    "属性": "排队中"
  },
  {
    "ID": 8,
    "一键探测邮件通知编号": "S-104201",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-8",
    "告警规则类型": "部分完成",
    "规则": "部分完成",
    "一键探测邮件通知属性": "部分完成",
    "新增一键探测邮件通知状态": "部分完成",
    "新增一键探测邮件通知时间": "2026-05-08 14:03:52",
    "一键探测邮件通知ID": "S-104201",
    "告警规则": "部分完成",
    "告警规则属性": "部分完成",
    "新增一键探测邮件通知告警规则状态": "部分完成",
    "属性": "部分完成"
  },
  {
    "ID": 9,
    "一键探测邮件通知编号": "S-112120",
    "一键探测邮件通知告警规则名称": "一键探测邮件通知告警规则管理-9",
    "告警规则类型": "已启用",
    "规则": "已启用",
    "一键探测邮件通知属性": "已启用",
    "新增一键探测邮件通知状态": "已启用",
    "新增一键探测邮件通知时间": "2026-05-08 15:21:37",
    "一键探测邮件通知ID": "S-112120",
    "告警规则": "已启用",
    "告警规则属性": "已启用",
    "新增一键探测邮件通知告警规则状态": "已启用",
    "属性": "已启用"
  }
];
const tableColumns = [
  ...
  {
    "prop": "新增一键探测邮件通知告警规则状态",
    "label": "新增一键探测邮件通知告警规则状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
