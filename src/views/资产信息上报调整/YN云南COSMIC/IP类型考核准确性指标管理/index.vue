    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP类型考核准确性信息表", "operation")'>IP类型考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核准确性字典信息", "form")'>新增IP类型数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核准确性模拟稽核信息", "form")'>新增IP类型数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP类型数据考核准确性模拟稽核信息", "config")'>修改IP类型数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP类型数据考核准确性模拟稽核信息")'>删除IP类型数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP类型考核准确性稽核数据上传", "form")'>IP类型考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP类型考核准确性稽核数据接口监控", "log")'>IP类型考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型考核准确性上传任务", "form")'>新增IP类型考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP类型考核准确性上传任务")'>删除IP类型考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP类型考核准确性上传任务", "config")'>修改IP类型考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP类型考核准确性上传任务", "detail")'>查询IP类型考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP类型考核准确性上传任务启用/禁用", "form")'>IP类型考核准确性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "IP类型考核准确性ID": "K-50424",
    "IP类型考核准确性编号": "K-50424",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-1",
    "IP类型考核准确性状态": "已启用",
    "IP类型考核准确性时间": "2026-05-08 11:16:09",
    "IP类型考核准确性属性": "10.10.1.100",
    "IP类型考核准确性创建时间": "2026-05-08 11:16:09",
    "IP类型考核准确性所属部门": "安全运维部",
    "IP类型考核准确性负责人": "张三",
    "IP类型考核准确性类型": "10.10.1.100",
    "IP类型考核准确性规则": "10.10.1.100",
    "IP类型数据考核准确性字典ID": "K-50424"
  },
  {
    "ID": 2,
    "IP类型考核准确性ID": "K-58343",
    "IP类型考核准确性编号": "K-58343",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-2",
    "IP类型考核准确性状态": "已停用",
    "IP类型考核准确性时间": "2026-05-08 14:03:52",
    "IP类型考核准确性属性": "172.16.0.50",
    "IP类型考核准确性创建时间": "2026-05-08 14:03:52",
    "IP类型考核准确性所属部门": "网络管理部",
    "IP类型考核准确性负责人": "李四",
    "IP类型考核准确性类型": "172.16.0.50",
    "IP类型考核准确性规则": "172.16.0.50",
    "IP类型数据考核准确性字典ID": "K-58343"
  },
  {
    "ID": 3,
    "IP类型考核准确性ID": "K-66262",
    "IP类型考核准确性编号": "K-66262",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-3",
    "IP类型考核准确性状态": "正常",
    "IP类型考核准确性时间": "2026-05-08 15:21:37",
    "IP类型考核准确性属性": "192.168.1.200",
    "IP类型考核准确性创建时间": "2026-05-08 15:21:37",
    "IP类型考核准确性所属部门": "资产管理部",
    "IP类型考核准确性负责人": "王五",
    "IP类型考核准确性类型": "192.168.1.200",
    "IP类型考核准确性规则": "192.168.1.200",
    "IP类型数据考核准确性字典ID": "K-66262"
  },
  {
    "ID": 4,
    "IP类型考核准确性ID": "K-74181",
    "IP类型考核准确性编号": "K-74181",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-4",
    "IP类型考核准确性状态": "异常",
    "IP类型考核准确性时间": "2026-05-08 16:08:25",
    "IP类型考核准确性属性": "10.20.5.30",
    "IP类型考核准确性创建时间": "2026-05-08 16:08:25",
    "IP类型考核准确性所属部门": "信息安全部",
    "IP类型考核准确性负责人": "赵六",
    "IP类型考核准确性类型": "10.20.5.30",
    "IP类型考核准确性规则": "10.20.5.30",
    "IP类型数据考核准确性字典ID": "K-74181"
  },
  {
    "ID": 5,
    "IP类型考核准确性ID": "K-82100",
    "IP类型考核准确性编号": "K-82100",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-5",
    "IP类型考核准确性状态": "超时",
    "IP类型考核准确性时间": "2026-05-09 08:33:11",
    "IP类型考核准确性属性": "172.20.1.80",
    "IP类型考核准确性创建时间": "2026-05-09 08:33:11",
    "IP类型考核准确性所属部门": "系统运维部",
    "IP类型考核准确性负责人": "system",
    "IP类型考核准确性类型": "172.20.1.80",
    "IP类型考核准确性规则": "172.20.1.80",
    "IP类型数据考核准确性字典ID": "K-82100"
  },
  {
    "ID": 6,
    "IP类型考核准确性ID": "K-90019",
    "IP类型考核准确性编号": "K-90019",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-6",
    "IP类型考核准确性状态": "已取消",
    "IP类型考核准确性时间": "2026-05-09 09:47:56",
    "IP类型考核准确性属性": "10.0.0.254",
    "IP类型考核准确性创建时间": "2026-05-09 09:47:56",
    "IP类型考核准确性所属部门": "数据管理部",
    "IP类型考核准确性负责人": "admin",
    "IP类型考核准确性类型": "10.0.0.254",
    "IP类型考核准确性规则": "10.0.0.254",
    "IP类型数据考核准确性字典ID": "K-90019"
  },
  {
    "ID": 7,
    "IP类型考核准确性ID": "K-97938",
    "IP类型考核准确性编号": "K-97938",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-7",
    "IP类型考核准确性状态": "已驳回",
    "IP类型考核准确性时间": "2026-05-08 09:12:18",
    "IP类型考核准确性属性": "10.10.1.100",
    "IP类型考核准确性创建时间": "2026-05-08 09:12:18",
    "IP类型考核准确性所属部门": "安全运维部",
    "IP类型考核准确性负责人": "张三",
    "IP类型考核准确性类型": "10.10.1.100",
    "IP类型考核准确性规则": "10.10.1.100",
    "IP类型数据考核准确性字典ID": "K-97938"
  },
  {
    "ID": 8,
    "IP类型考核准确性ID": "K-105857",
    "IP类型考核准确性编号": "K-105857",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-8",
    "IP类型考核准确性状态": "待审核",
    "IP类型考核准确性时间": "2026-05-08 09:35:44",
    "IP类型考核准确性属性": "172.16.0.50",
    "IP类型考核准确性创建时间": "2026-05-08 09:35:44",
    "IP类型考核准确性所属部门": "网络管理部",
    "IP类型考核准确性负责人": "李四",
    "IP类型考核准确性类型": "172.16.0.50",
    "IP类型考核准确性规则": "172.16.0.50",
    "IP类型数据考核准确性字典ID": "K-105857"
  },
  {
    "ID": 9,
    "IP类型考核准确性ID": "K-113776",
    "IP类型考核准确性编号": "K-113776",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-9",
    "IP类型考核准确性状态": "已处理",
    "IP类型考核准确性时间": "2026-05-08 10:08:06",
    "IP类型考核准确性属性": "192.168.1.200",
    "IP类型考核准确性创建时间": "2026-05-08 10:08:06",
    "IP类型考核准确性所属部门": "资产管理部",
    "IP类型考核准确性负责人": "王五",
    "IP类型考核准确性类型": "192.168.1.200",
    "IP类型考核准确性规则": "192.168.1.200",
    "IP类型数据考核准确性字典ID": "K-113776"
  },
  {
    "ID": 10,
    "IP类型考核准确性ID": "K-121695",
    "IP类型考核准确性编号": "K-121695",
    "IP类型考核准确性名称": "IP类型考核准确性指标管理-10",
    "IP类型考核准确性状态": "处理中",
    "IP类型考核准确性时间": "2026-05-08 10:42:31",
    "IP类型考核准确性属性": "10.20.5.30",
    "IP类型考核准确性创建时间": "2026-05-08 10:42:31",
    "IP类型考核准确性所属部门": "信息安全部",
    "IP类型考核准确性负责人": "赵六",
    "IP类型考核准确性类型": "10.20.5.30",
    "IP类型考核准确性规则": "10.20.5.30",
    "IP类型数据考核准确性字典ID": "K-121695"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "IP类型数据考核准确性字典ID",
    "label": "IP类型数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
