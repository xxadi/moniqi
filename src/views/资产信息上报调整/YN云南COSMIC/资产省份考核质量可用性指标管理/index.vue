    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产省份考核质量可用性信息表", "operation")'>资产省份考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产归属考核质量可用性稽核数据上传", "form")'>资产归属考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属考核质量可用性稽核数据接口监控", "log")'>资产归属考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产所属部门考核质量可用性信息表", "operation")'>资产所属部门考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产组织考核质量可用性稽核数据上传", "form")'>资产组织考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组织考核质量可用性稽核数据接口监控", "log")'>资产组织考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产省份考核质量可用性ID": "S-30776",
    "资产省份考核质量可用性编号": "S-30776",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-1",
    "资产省份考核质量可用性状态": "已启用",
    "资产省份考核质量可用性时间": "2026-05-08 15:21:37",
    "资产省份考核质量可用性属性": "已启用",
    "资产省份考核质量可用性创建时间": "2026-05-08 15:21:37",
    "资产省份考核质量可用性所属部门": "资产管理部",
    "资产省份考核质量可用性负责人": "王五",
    "资产省份考核质量可用性类型": "已启用",
    "资产省份考核质量可用性规则": "已启用",
    "数据上传资源编码": "已启用"
  ...
  {
    "ID": 2,
    "资产省份考核质量可用性ID": "S-38695",
    "资产省份考核质量可用性编号": "S-38695",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-2",
    "资产省份考核质量可用性状态": "已停用",
    "资产省份考核质量可用性时间": "2026-05-08 16:08:25",
    "资产省份考核质量可用性属性": "已停用",
    "资产省份考核质量可用性创建时间": "2026-05-08 16:08:25",
    "资产省份考核质量可用性所属部门": "信息安全部",
    "资产省份考核质量可用性负责人": "赵六",
    "资产省份考核质量可用性类型": "已停用",
    "资产省份考核质量可用性规则": "已停用",
    "数据上传资源编码": "已停用"
  ...
  {
    "ID": 3,
    "资产省份考核质量可用性ID": "S-46614",
    "资产省份考核质量可用性编号": "S-46614",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-3",
    "资产省份考核质量可用性状态": "正常",
    "资产省份考核质量可用性时间": "2026-05-09 08:33:11",
    "资产省份考核质量可用性属性": "正常",
    "资产省份考核质量可用性创建时间": "2026-05-09 08:33:11",
    "资产省份考核质量可用性所属部门": "系统运维部",
    "资产省份考核质量可用性负责人": "system",
    "资产省份考核质量可用性类型": "正常",
    "资产省份考核质量可用性规则": "正常",
    "数据上传资源编码": "正常"
  },
  {
    "ID": 4,
    "资产省份考核质量可用性ID": "S-54533",
    "资产省份考核质量可用性编号": "S-54533",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-4",
    "资产省份考核质量可用性状态": "异常",
    "资产省份考核质量可用性时间": "2026-05-09 09:47:56",
    "资产省份考核质量可用性属性": "异常",
    "资产省份考核质量可用性创建时间": "2026-05-09 09:47:56",
    "资产省份考核质量可用性所属部门": "数据管理部",
    "资产省份考核质量可用性负责人": "admin",
    "资产省份考核质量可用性类型": "异常",
    "资产省份考核质量可用性规则": "异常",
    "数据上传资源编码": "异常"
  },
  {
    "ID": 5,
    "资产省份考核质量可用性ID": "S-62452",
    "资产省份考核质量可用性编号": "S-62452",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-5",
    "资产省份考核质量可用性状态": "超时",
    "资产省份考核质量可用性时间": "2026-05-08 09:12:18",
    "资产省份考核质量可用性属性": "超时",
    "资产省份考核质量可用性创建时间": "2026-05-08 09:12:18",
    "资产省份考核质量可用性所属部门": "安全运维部",
    "资产省份考核质量可用性负责人": "张三",
    "资产省份考核质量可用性类型": "超时",
    "资产省份考核质量可用性规则": "超时",
    "数据上传资源编码": "超时"
  ...
  {
    "ID": 6,
    "资产省份考核质量可用性ID": "S-70371",
    "资产省份考核质量可用性编号": "S-70371",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-6",
    "资产省份考核质量可用性状态": "已取消",
    "资产省份考核质量可用性时间": "2026-05-08 09:35:44",
    "资产省份考核质量可用性属性": "已取消",
    "资产省份考核质量可用性创建时间": "2026-05-08 09:35:44",
    "资产省份考核质量可用性所属部门": "网络管理部",
    "资产省份考核质量可用性负责人": "李四",
    "资产省份考核质量可用性类型": "已取消",
    "资产省份考核质量可用性规则": "已取消",
    "数据上传资源编码": "已取消"
  ...
  {
    "ID": 7,
    "资产省份考核质量可用性ID": "S-78290",
    "资产省份考核质量可用性编号": "S-78290",
    "资产省份考核质量可用性名称": "资产省份考核质量可用性指标管理-7",
    "资产省份考核质量可用性状态": "已驳回",
    "资产省份考核质量可用性时间": "2026-05-08 10:08:06",
    "资产省份考核质量可用性属性": "已驳回",
    "资产省份考核质量可用性创建时间": "2026-05-08 10:08:06",
    "资产省份考核质量可用性所属部门": "资产管理部",
    "资产省份考核质量可用性负责人": "王五",
    "资产省份考核质量可用性类型": "已驳回",
    "资产省份考核质量可用性规则": "已驳回",
...
const tableColumns = [
  ...
  {
    "prop": "资产省份考核质量可用性创建时间",
    "label": "资产省份考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产省份考核质量可用性所属部门",
    "label": "资产省份考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
