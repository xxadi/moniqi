    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起拨测正确率审核流程", "initiate_audit")'>发起拨测正确率审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测正确率审核指派信息", "form")'>新增拨测正确率审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测正确率审核流程", "form")'>新增拨测正确率审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改拨测正确率审核流程信息", "config")'>修改拨测正确率审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率审核流程删除", "operation")'>拨测正确率审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率审核流程查询", "detail")'>拨测正确率审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率审核附件上传", "form")'>拨测正确率审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率审核流程图查看", "preview")'>拨测正确率审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测正确率审核流程通知", "audit")'>拨测正确率审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测正确率审核结果逐级审批", "audit")'>拨测正确率审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测正确率审核结果拒绝和驳回", "approval")'>拨测正确率审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "拨测正确率审核ID": "T-88575",
    "拨测正确率审核流程环节ID": "T-88575",
    "拨测正确率审核编号": "T-88575",
    "拨测正确率审核名称": "拨测正确率审核流程管理-1",
    "发起拨测正确率审核状态": "待审核",
    "发起拨测正确率审核时间": "2026-05-08 14:03:52",
    "拨测正确率审核属性": "待审核",
    "拨测正确率审核发起时间": "2026-05-08 14:03:52",
    "拨测正确率审核流程id": "待审核",
    "拨测正确率审核流程环节": "待审核",
    "拨测正确率审核创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 2,
    "拨测正确率审核ID": "T-96494",
    "拨测正确率审核流程环节ID": "T-96494",
    "拨测正确率审核编号": "T-96494",
    "拨测正确率审核名称": "拨测正确率审核流程管理-2",
    "发起拨测正确率审核状态": "已处理",
    "发起拨测正确率审核时间": "2026-05-08 15:21:37",
    "拨测正确率审核属性": "已处理",
    "拨测正确率审核发起时间": "2026-05-08 15:21:37",
    "拨测正确率审核流程id": "已处理",
    "拨测正确率审核流程环节": "已处理",
    "拨测正确率审核创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 3,
    "拨测正确率审核ID": "T-104413",
    "拨测正确率审核流程环节ID": "T-104413",
    "拨测正确率审核编号": "T-104413",
    "拨测正确率审核名称": "拨测正确率审核流程管理-3",
    "发起拨测正确率审核状态": "处理中",
    "发起拨测正确率审核时间": "2026-05-08 16:08:25",
    "拨测正确率审核属性": "处理中",
    "拨测正确率审核发起时间": "2026-05-08 16:08:25",
    "拨测正确率审核流程id": "处理中",
    "拨测正确率审核流程环节": "处理中",
    "拨测正确率审核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 4,
    "拨测正确率审核ID": "T-112332",
    "拨测正确率审核流程环节ID": "T-112332",
    "拨测正确率审核编号": "T-112332",
    "拨测正确率审核名称": "拨测正确率审核流程管理-4",
    "发起拨测正确率审核状态": "待处理",
    "发起拨测正确率审核时间": "2026-05-09 08:33:11",
    "拨测正确率审核属性": "待处理",
    "拨测正确率审核发起时间": "2026-05-09 08:33:11",
    "拨测正确率审核流程id": "待处理",
    "拨测正确率审核流程环节": "待处理",
    "拨测正确率审核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 5,
    "拨测正确率审核ID": "T-120251",
    "拨测正确率审核流程环节ID": "T-120251",
    "拨测正确率审核编号": "T-120251",
    "拨测正确率审核名称": "拨测正确率审核流程管理-5",
    "发起拨测正确率审核状态": "处理失败",
    "发起拨测正确率审核时间": "2026-05-09 09:47:56",
    "拨测正确率审核属性": "处理失败",
    "拨测正确率审核发起时间": "2026-05-09 09:47:56",
    "拨测正确率审核流程id": "处理失败",
    "拨测正确率审核流程环节": "处理失败",
    "拨测正确率审核创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 6,
    "拨测正确率审核ID": "T-128170",
    "拨测正确率审核流程环节ID": "T-128170",
    "拨测正确率审核编号": "T-128170",
    "拨测正确率审核名称": "拨测正确率审核流程管理-6",
    "发起拨测正确率审核状态": "已暂停",
    "发起拨测正确率审核时间": "2026-05-08 09:12:18",
    "拨测正确率审核属性": "已暂停",
    "拨测正确率审核发起时间": "2026-05-08 09:12:18",
    "拨测正确率审核流程id": "已暂停",
    "拨测正确率审核流程环节": "已暂停",
    "拨测正确率审核创建时间": "2026-05-08 09:12:18"
  }
];
const tableColumns = [
  {
