    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化采集率汇总报表信息", "form")'>新增自动化采集率汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自动化采集明细监控", "log")'>自动化采集明细监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("自动化采集明细监控告警", "alert")'>自动化采集明细监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集明细稽核", "transform")'>自动化采集明细稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集明细统计", "statistics")'>自动化采集明细统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集明细数据采集", "transform")'>自动化采集明细数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集明细数据转换", "transform")'>自动化采集明细数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集明细数据预处理", "transform")'>自动化采集明细数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化采集率明细报表信息", "form")'>新增自动化采集率明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率汇总报表详情", "detail")'>查询自动化采集率汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动化采集率明细报表详情", "detail")'>查询自动化采集率明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("自动化采集率汇总报表导出")'>自动化采集率汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("自动化采集率明细报表导出")'>自动化采集率明细报表导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "自动化采集率汇总报表ID": "A-44824",
    "自动化采集率汇总报表编号": "A-44824",
    "汇总报表名称": "自动化采集率报表管理-1",
    "自动化采集率汇总报表类型": "已启用",
    "自动化采集率汇总报表规则": "已启用",
    "自动化采集率汇总报表属性": "已启用",
    "新增自动化采集率汇总报表状态": "已启用",
    "新增自动化采集率汇总报表时间": "2026-05-08 11:16:09",
    "自动化采集率汇总报表创建时间": "2026-05-08 11:16:09",
    "汇总报表编号": "A-44824",
    "报表ID": "A-44824",
    "汇总报表所属部门": "系统运维部"
  },
  {
    "ID": 2,
    "自动化采集率汇总报表ID": "A-52743",
    "自动化采集率汇总报表编号": "A-52743",
    "汇总报表名称": "自动化采集率报表管理-2",
    "自动化采集率汇总报表类型": "已停用",
    "自动化采集率汇总报表规则": "已停用",
    "自动化采集率汇总报表属性": "已停用",
    "新增自动化采集率汇总报表状态": "已停用",
    "新增自动化采集率汇总报表时间": "2026-05-08 14:03:52",
    "自动化采集率汇总报表创建时间": "2026-05-08 14:03:52",
    "汇总报表编号": "A-52743",
    "报表ID": "A-52743",
    "汇总报表所属部门": "数据管理部"
  },
  {
    "ID": 3,
    "自动化采集率汇总报表ID": "A-60662",
    "自动化采集率汇总报表编号": "A-60662",
    "汇总报表名称": "自动化采集率报表管理-3",
    "自动化采集率汇总报表类型": "正常",
    "自动化采集率汇总报表规则": "正常",
    "自动化采集率汇总报表属性": "正常",
    "新增自动化采集率汇总报表状态": "正常",
    "新增自动化采集率汇总报表时间": "2026-05-08 15:21:37",
    "自动化采集率汇总报表创建时间": "2026-05-08 15:21:37",
    "汇总报表编号": "A-60662",
    "报表ID": "A-60662",
    "汇总报表所属部门": "安全运维部"
  },
  {
    "ID": 4,
    "自动化采集率汇总报表ID": "A-68581",
    "自动化采集率汇总报表编号": "A-68581",
    "汇总报表名称": "自动化采集率报表管理-4",
    "自动化采集率汇总报表类型": "异常",
    "自动化采集率汇总报表规则": "异常",
    "自动化采集率汇总报表属性": "异常",
    "新增自动化采集率汇总报表状态": "异常",
    "新增自动化采集率汇总报表时间": "2026-05-08 16:08:25",
    "自动化采集率汇总报表创建时间": "2026-05-08 16:08:25",
    "汇总报表编号": "A-68581",
    "报表ID": "A-68581",
    "汇总报表所属部门": "网络管理部"
  },
  {
    "ID": 5,
    "自动化采集率汇总报表ID": "A-76500",
    "自动化采集率汇总报表编号": "A-76500",
    "汇总报表名称": "自动化采集率报表管理-5",
    "自动化采集率汇总报表类型": "超时",
    "自动化采集率汇总报表规则": "超时",
    "自动化采集率汇总报表属性": "超时",
    "新增自动化采集率汇总报表状态": "超时",
    "新增自动化采集率汇总报表时间": "2026-05-09 08:33:11",
    "自动化采集率汇总报表创建时间": "2026-05-09 08:33:11",
    "汇总报表编号": "A-76500",
    "报表ID": "A-76500",
    "汇总报表所属部门": "资产管理部"
  },
  {
    "ID": 6,
    "自动化采集率汇总报表ID": "A-84419",
    "自动化采集率汇总报表编号": "A-84419",
    "汇总报表名称": "自动化采集率报表管理-6",
    "自动化采集率汇总报表类型": "已取消",
    "自动化采集率汇总报表规则": "已取消",
    "自动化采集率汇总报表属性": "已取消",
    "新增自动化采集率汇总报表状态": "已取消",
    "新增自动化采集率汇总报表时间": "2026-05-09 09:47:56",
    "自动化采集率汇总报表创建时间": "2026-05-09 09:47:56",
    "汇总报表编号": "A-84419",
    "报表ID": "A-84419",
    "汇总报表所属部门": "信息安全部"
  },
  {
    "ID": 7,
    "自动化采集率汇总报表ID": "A-92338",
    "自动化采集率汇总报表编号": "A-92338",
    "汇总报表名称": "自动化采集率报表管理-7",
    "自动化采集率汇总报表类型": "已驳回",
    "自动化采集率汇总报表规则": "已驳回",
    "自动化采集率汇总报表属性": "已驳回",
    "新增自动化采集率汇总报表状态": "已驳回",
    "新增自动化采集率汇总报表时间": "2026-05-08 09:12:18",
    "自动化采集率汇总报表创建时间": "2026-05-08 09:12:18",
    "汇总报表编号": "A-92338",
    "报表ID": "A-92338",
    "汇总报表所属部门": "系统运维部"
  },
  {
    "ID": 8,
    "自动化采集率汇总报表ID": "A-100257",
    "自动化采集率汇总报表编号": "A-100257",
    "汇总报表名称": "自动化采集率报表管理-8",
    "自动化采集率汇总报表类型": "待审核",
    "自动化采集率汇总报表规则": "待审核",
    "自动化采集率汇总报表属性": "待审核",
    "新增自动化采集率汇总报表状态": "待审核",
    "新增自动化采集率汇总报表时间": "2026-05-08 09:35:44",
    "自动化采集率汇总报表创建时间": "2026-05-08 09:35:44",
    "汇总报表编号": "A-100257",
    "报表ID": "A-100257",
    "汇总报表所属部门": "数据管理部"
  },
  {
    "ID": 9,
    "自动化采集率汇总报表ID": "A-108176",
    "自动化采集率汇总报表编号": "A-108176",
    "汇总报表名称": "自动化采集率报表管理-9",
    "自动化采集率汇总报表类型": "已处理",
    "自动化采集率汇总报表规则": "已处理",
    "自动化采集率汇总报表属性": "已处理",
    "新增自动化采集率汇总报表状态": "已处理",
    "新增自动化采集率汇总报表时间": "2026-05-08 10:08:06",
    "自动化采集率汇总报表创建时间": "2026-05-08 10:08:06",
    "汇总报表编号": "A-108176",
    "报表ID": "A-108176",
    "汇总报表所属部门": "安全运维部"
  },
  {
    "ID": 10,
    "自动化采集率汇总报表ID": "A-116095",
    "自动化采集率汇总报表编号": "A-116095",
    "汇总报表名称": "自动化采集率报表管理-10",
    "自动化采集率汇总报表类型": "处理中",
    "自动化采集率汇总报表规则": "处理中",
    "自动化采集率汇总报表属性": "处理中",
    "新增自动化采集率汇总报表状态": "处理中",
    "新增自动化采集率汇总报表时间": "2026-05-08 10:42:31",
    "自动化采集率汇总报表创建时间": "2026-05-08 10:42:31",
    "汇总报表编号": "A-116095",
    "报表ID": "A-116095",
    "汇总报表所属部门": "网络管理部"
  }
