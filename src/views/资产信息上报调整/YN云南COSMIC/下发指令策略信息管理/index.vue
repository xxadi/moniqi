    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令策略信息", "form")'>新增下发指令策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令策略信息", "config")'>修改下发指令策略信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令策略信息")'>删除下发指令策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("下发指令策略信息监控", "log")'>下发指令策略信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令策略信息监控告警", "alert")'>下发指令策略信息监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略信息稽核", "audit")'>下发指令策略信息稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("下发指令策略信息统计", "statistics")'>下发指令策略信息统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("下发指令策略信息数据采集", "transform")'>下发指令策略信息数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("下发指令策略信息数据预处理", "transform")'>下发指令策略信息数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起下发指令策略审批流程", "workflow")'>发起下发指令策略审批流程</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "下发指令策略信息ID": "L-8357",
    "下发指令策略信息编号": "L-8357",
    "下发指令策略信息名称": "下发指令策略信息管理-1",
    "新增下发指令策略信息状态": "已完成",
    "新增下发指令策略信息时间": "2026-05-08 16:08:25",
    "下发指令策略信息属性": "已完成",
    "下发指令策略信息创建时间": "2026-05-08 16:08:25",
    "下发指令策略信息所属部门": "数据管理部",
    "下发指令策略信息负责人": "admin",
    "下发指令策略信息类型": "已完成",
    "下发指令策略信息规则": "已完成",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-16276",
    "下发指令策略信息编号": "L-16276",
    "下发指令策略信息名称": "下发指令策略信息管理-2",
    "新增下发指令策略信息状态": "排队中",
    "新增下发指令策略信息时间": "2026-05-09 08:33:11",
    "下发指令策略信息属性": "排队中",
    "下发指令策略信息创建时间": "2026-05-09 08:33:11",
    "下发指令策略信息所属部门": "安全运维部",
    "下发指令策略信息负责人": "张三",
    "下发指令策略信息类型": "排队中",
    "下发指令策略信息规则": "排队中",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-24195",
    "下发指令策略信息编号": "L-24195",
    "下发指令策略信息名称": "下发指令策略信息管理-3",
    "新增下发指令策略信息状态": "部分完成",
    "新增下发指令策略信息时间": "2026-05-09 09:47:56",
    "下发指令策略信息属性": "部分完成",
    "下发指令策略信息创建时间": "2026-05-09 09:47:56",
    "下发指令策略信息所属部门": "网络管理部",
    "下发指令策略信息负责人": "李四",
    "下发指令策略信息类型": "部分完成",
    "下发指令策略信息规则": "部分完成",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-32114",
    "下发指令策略信息编号": "L-32114",
    "下发指令策略信息名称": "下发指令策略信息管理-4",
    "新增下发指令策略信息状态": "已启用",
    "新增下发指令策略信息时间": "2026-05-08 09:12:18",
    "下发指令策略信息属性": "已启用",
    "下发指令策略信息创建时间": "2026-05-08 09:12:18",
    "下发指令策略信息所属部门": "资产管理部",
    "下发指令策略信息负责人": "王五",
    "下发指令策略信息类型": "已启用",
    "下发指令策略信息规则": "已启用",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-40033",
    "下发指令策略信息编号": "L-40033",
    "下发指令策略信息名称": "下发指令策略信息管理-5",
    "新增下发指令策略信息状态": "已停用",
    "新增下发指令策略信息时间": "2026-05-08 09:35:44",
    "下发指令策略信息属性": "已停用",
    "下发指令策略信息创建时间": "2026-05-08 09:35:44",
    "下发指令策略信息所属部门": "信息安全部",
    "下发指令策略信息负责人": "赵六",
    "下发指令策略信息类型": "已停用",
    "下发指令策略信息规则": "已停用",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-47952",
    "下发指令策略信息编号": "L-47952",
    "下发指令策略信息名称": "下发指令策略信息管理-6",
    "新增下发指令策略信息状态": "正常",
    "新增下发指令策略信息时间": "2026-05-08 10:08:06",
    "下发指令策略信息属性": "正常",
    "下发指令策略信息创建时间": "2026-05-08 10:08:06",
    "下发指令策略信息所属部门": "系统运维部",
    "下发指令策略信息负责人": "system",
    "下发指令策略信息类型": "正常",
    "下发指令策略信息规则": "正常",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-55871",
    "下发指令策略信息编号": "L-55871",
    "下发指令策略信息名称": "下发指令策略信息管理-7",
    "新增下发指令策略信息状态": "异常",
    "新增下发指令策略信息时间": "2026-05-08 10:42:31",
    "下发指令策略信息属性": "异常",
    "下发指令策略信息创建时间": "2026-05-08 10:42:31",
    "下发指令策略信息所属部门": "数据管理部",
    "下发指令策略信息负责人": "admin",
    "下发指令策略信息类型": "异常",
    "下发指令策略信息规则": "异常",
  ...
  },
  {
    ...
    "下发指令策略信息ID": "L-63790",
    "下发指令策略信息编号": "L-63790",
    "下发指令策略信息名称": "下发指令策略信息管理-8",
    "新增下发指令策略信息状态": "超时",
    "新增下发指令策略信息时间": "2026-05-08 11:16:09",
    "下发指令策略信息属性": "超时",
    "下发指令策略信息创建时间": "2026-05-08 11:16:09",
    "下发指令策略信息所属部门": "安全运维部",
    "下发指令策略信息负责人": "张三",
    "下发指令策略信息类型": "超时",
    "下发指令策略信息规则": "超时",
