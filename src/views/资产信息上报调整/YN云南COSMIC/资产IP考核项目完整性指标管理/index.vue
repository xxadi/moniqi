    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核项目完整性信息表", "operation")'>资产IP考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核项目完整性稽核", "audit")'>资产IP考核项目完整性稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核项目完整性稽核数据上传", "form")'>资产IP考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产IP考核项目完整性稽核数据接口监控", "log")'>资产IP考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核项目完整性稽核汇总报告详情", "detail")'>查询资产IP考核项目完整性稽核汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产IP考核项目完整性上传任务", "form")'>新增资产IP考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产IP考核项目完整性上传任务")'>删除资产IP考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产IP考核项目完整性上传任务", "config")'>修改资产IP考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核项目完整性上传任务", "detail")'>查询资产IP考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核项目完整性上传任务启用/禁用", "form")'>资产IP考核项目完整性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产IP考核项目完整性ID": "G-49328",
    "资产IP考核项目完整性编号": "G-49328",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-1",
    "资产IP考核项目完整性状态": "已处理",
    "资产IP考核项目完整性时间": "2026-05-09 08:33:11",
    "资产IP考核项目完整性属性": "192.168.1.200",
    "资产IP考核项目完整性创建时间": "2026-05-09 08:33:11",
    "资产IP考核项目完整性所属部门": "资产管理部",
    "资产IP考核项目完整性负责人": "王五",
    "资产IP考核项目完整性类型": "192.168.1.200",
    "资产IP考核项目完整性规则": "192.168.1.200",
    "资产IP考核项目完整性稽核ID": "G-49328"
  },
  {
    "ID": 2,
    "资产IP考核项目完整性ID": "G-57247",
    "资产IP考核项目完整性编号": "G-57247",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-2",
    "资产IP考核项目完整性状态": "处理中",
    "资产IP考核项目完整性时间": "2026-05-09 09:47:56",
    "资产IP考核项目完整性属性": "10.20.5.30",
    "资产IP考核项目完整性创建时间": "2026-05-09 09:47:56",
    "资产IP考核项目完整性所属部门": "信息安全部",
    "资产IP考核项目完整性负责人": "赵六",
    "资产IP考核项目完整性类型": "10.20.5.30",
    "资产IP考核项目完整性规则": "10.20.5.30",
    "资产IP考核项目完整性稽核ID": "G-57247"
  },
  {
    "ID": 3,
    "资产IP考核项目完整性ID": "G-65166",
    "资产IP考核项目完整性编号": "G-65166",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-3",
    "资产IP考核项目完整性状态": "待处理",
    "资产IP考核项目完整性时间": "2026-05-08 09:12:18",
    "资产IP考核项目完整性属性": "172.20.1.80",
    "资产IP考核项目完整性创建时间": "2026-05-08 09:12:18",
    "资产IP考核项目完整性所属部门": "系统运维部",
    "资产IP考核项目完整性负责人": "system",
    "资产IP考核项目完整性类型": "172.20.1.80",
    "资产IP考核项目完整性规则": "172.20.1.80",
    "资产IP考核项目完整性稽核ID": "G-65166"
  },
  {
    "ID": 4,
    "资产IP考核项目完整性ID": "G-73085",
    "资产IP考核项目完整性编号": "G-73085",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-4",
    "资产IP考核项目完整性状态": "处理失败",
    "资产IP考核项目完整性时间": "2026-05-08 09:35:44",
    "资产IP考核项目完整性属性": "10.0.0.254",
    "资产IP考核项目完整性创建时间": "2026-05-08 09:35:44",
    "资产IP考核项目完整性所属部门": "数据管理部",
    "资产IP考核项目完整性负责人": "admin",
    "资产IP考核项目完整性类型": "10.0.0.254",
    "资产IP考核项目完整性规则": "10.0.0.254",
    "资产IP考核项目完整性稽核ID": "G-73085"
  },
  {
    "ID": 5,
    "资产IP考核项目完整性ID": "G-81004",
    "资产IP考核项目完整性编号": "G-81004",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-5",
    "资产IP考核项目完整性状态": "已暂停",
    "资产IP考核项目完整性时间": "2026-05-08 10:08:06",
    "资产IP考核项目完整性属性": "10.10.1.100",
    "资产IP考核项目完整性创建时间": "2026-05-08 10:08:06",
    "资产IP考核项目完整性所属部门": "安全运维部",
    "资产IP考核项目完整性负责人": "张三",
    "资产IP考核项目完整性类型": "10.10.1.100",
    "资产IP考核项目完整性规则": "10.10.1.100",
    "资产IP考核项目完整性稽核ID": "G-81004"
  },
  {
    "ID": 6,
    "资产IP考核项目完整性ID": "G-88923",
    "资产IP考核项目完整性编号": "G-88923",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-6",
    "资产IP考核项目完整性状态": "已完成",
    "资产IP考核项目完整性时间": "2026-05-08 10:42:31",
    "资产IP考核项目完整性属性": "172.16.0.50",
    "资产IP考核项目完整性创建时间": "2026-05-08 10:42:31",
    "资产IP考核项目完整性所属部门": "网络管理部",
    "资产IP考核项目完整性负责人": "李四",
    "资产IP考核项目完整性类型": "172.16.0.50",
    "资产IP考核项目完整性规则": "172.16.0.50",
    "资产IP考核项目完整性稽核ID": "G-88923"
  },
  {
    "ID": 7,
    "资产IP考核项目完整性ID": "G-96842",
    "资产IP考核项目完整性编号": "G-96842",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-7",
    "资产IP考核项目完整性状态": "排队中",
    "资产IP考核项目完整性时间": "2026-05-08 11:16:09",
    "资产IP考核项目完整性属性": "192.168.1.200",
    "资产IP考核项目完整性创建时间": "2026-05-08 11:16:09",
    "资产IP考核项目完整性所属部门": "资产管理部",
    "资产IP考核项目完整性负责人": "王五",
    "资产IP考核项目完整性类型": "192.168.1.200",
    "资产IP考核项目完整性规则": "192.168.1.200",
    "资产IP考核项目完整性稽核ID": "G-96842"
  },
  {
    "ID": 8,
    "资产IP考核项目完整性ID": "G-104761",
    "资产IP考核项目完整性编号": "G-104761",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-8",
    "资产IP考核项目完整性状态": "部分完成",
    "资产IP考核项目完整性时间": "2026-05-08 14:03:52",
    "资产IP考核项目完整性属性": "10.20.5.30",
    "资产IP考核项目完整性创建时间": "2026-05-08 14:03:52",
    "资产IP考核项目完整性所属部门": "信息安全部",
    "资产IP考核项目完整性负责人": "赵六",
    "资产IP考核项目完整性类型": "10.20.5.30",
    "资产IP考核项目完整性规则": "10.20.5.30",
    "资产IP考核项目完整性稽核ID": "G-104761"
  },
  {
    "ID": 9,
    "资产IP考核项目完整性ID": "G-112680",
    "资产IP考核项目完整性编号": "G-112680",
    "资产IP考核项目完整性名称": "资产IP考核项目完整性指标管理-9",
    "资产IP考核项目完整性状态": "已启用",
    "资产IP考核项目完整性时间": "2026-05-08 15:21:37",
    "资产IP考核项目完整性属性": "172.20.1.80",
    "资产IP考核项目完整性创建时间": "2026-05-08 15:21:37",
    "资产IP考核项目完整性所属部门": "系统运维部",
    "资产IP考核项目完整性负责人": "system",
    "资产IP考核项目完整性类型": "172.20.1.80",
    "资产IP考核项目完整性规则": "172.20.1.80",
    "资产IP考核项目完整性稽核ID": "G-112680"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "资产IP考核项目完整性创建时间",
    "label": "资产IP考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产IP考核项目完整性所属部门",
    "label": "资产IP考核项目完整性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "资产IP考核项目完整性稽核ID",
    "label": "资产IP考核项目完整性稽核ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
