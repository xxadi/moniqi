    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部管理指令下发设置信息", "form")'>新增工信部管理指令下发设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部管理指令下发设置信息", "config")'>修改工信部管理指令下发设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部管理指令下发设置信息")'>删除工信部管理指令下发设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部管理指令下发接口错误信息监控", "log")'>工信部管理指令下发接口错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部管理指令下发接口错误事件通知", "api")'>工信部管理指令下发接口错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("工信部管理指令下发接口错误事件删除", "operation")'>工信部管理指令下发接口错误事件删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("工信部管理指令下发接口错误事件查询", "detail")'>工信部管理指令下发接口错误事件查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部管理指令下发接口防篡改信息", "form")'>新增工信部管理指令下发接口防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部管理指令下发接口防篡改信息", "config")'>修改工信部管理指令下发接口防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部管理指令下发接口防篡改信息")'>删除工信部管理指令下发接口防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部管理指令下发ID": "R-91511",
    "工信部管理指令下发编号": "R-91511",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-1",
    "新增工信部管理指令下发状态": "部分完成",
    "新增工信部管理指令下发时间": "2026-05-08 09:35:44",
    "新增工信部管理指令下发设置时间_": "2026-05-08 09:35:44",
    "指令下发属性": "部分完成",
    "工信部管理指令下发创建时间": "2026-05-08 09:35:44",
    "新增工信部管理指令下发设置结果": "部分完成",
    "工信部管理指令下发所属部门": "数据管理部",
    "工信部管理指令下发负责人": "admin",
    "工信部管理指令下发类型": "部分完成"
  },
  {
    ...
    "工信部管理指令下发ID": "R-99430",
    "工信部管理指令下发编号": "R-99430",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-2",
    "新增工信部管理指令下发状态": "已启用",
    "新增工信部管理指令下发时间": "2026-05-08 10:08:06",
    "新增工信部管理指令下发设置时间_": "2026-05-08 10:08:06",
    "指令下发属性": "已启用",
    "工信部管理指令下发创建时间": "2026-05-08 10:08:06",
    "新增工信部管理指令下发设置结果": "已启用",
    "工信部管理指令下发所属部门": "安全运维部",
    "工信部管理指令下发负责人": "张三",
    "工信部管理指令下发类型": "已启用"
  ...
  {
    "ID": 3,
    "工信部管理指令下发ID": "R-107349",
    "工信部管理指令下发编号": "R-107349",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-3",
    "新增工信部管理指令下发状态": "已停用",
    "新增工信部管理指令下发时间": "2026-05-08 10:42:31",
    "新增工信部管理指令下发设置时间_": "2026-05-08 10:42:31",
    "指令下发属性": "已停用",
    "工信部管理指令下发创建时间": "2026-05-08 10:42:31",
    "新增工信部管理指令下发设置结果": "已停用",
    "工信部管理指令下发所属部门": "网络管理部",
    "工信部管理指令下发负责人": "李四",
    "工信部管理指令下发类型": "已停用"
  ...
  {
    "ID": 4,
    "工信部管理指令下发ID": "R-115268",
    "工信部管理指令下发编号": "R-115268",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-4",
    "新增工信部管理指令下发状态": "正常",
    "新增工信部管理指令下发时间": "2026-05-08 11:16:09",
    "新增工信部管理指令下发设置时间_": "2026-05-08 11:16:09",
    "指令下发属性": "正常",
    "工信部管理指令下发创建时间": "2026-05-08 11:16:09",
    "新增工信部管理指令下发设置结果": "正常",
    "工信部管理指令下发所属部门": "资产管理部",
    "工信部管理指令下发负责人": "王五",
    "工信部管理指令下发类型": "正常"
  ...
  {
    "ID": 5,
    "工信部管理指令下发ID": "R-123187",
    "工信部管理指令下发编号": "R-123187",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-5",
    "新增工信部管理指令下发状态": "异常",
    "新增工信部管理指令下发时间": "2026-05-08 14:03:52",
    "新增工信部管理指令下发设置时间_": "2026-05-08 14:03:52",
    "指令下发属性": "异常",
    "工信部管理指令下发创建时间": "2026-05-08 14:03:52",
    "新增工信部管理指令下发设置结果": "异常",
    "工信部管理指令下发所属部门": "信息安全部",
    "工信部管理指令下发负责人": "赵六",
    "工信部管理指令下发类型": "异常"
  ...
  {
    "ID": 6,
    "工信部管理指令下发ID": "R-131106",
    "工信部管理指令下发编号": "R-131106",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-6",
    "新增工信部管理指令下发状态": "超时",
    "新增工信部管理指令下发时间": "2026-05-08 15:21:37",
    "新增工信部管理指令下发设置时间_": "2026-05-08 15:21:37",
    "指令下发属性": "超时",
    "工信部管理指令下发创建时间": "2026-05-08 15:21:37",
    "新增工信部管理指令下发设置结果": "超时",
    "工信部管理指令下发所属部门": "系统运维部",
    "工信部管理指令下发负责人": "system",
    "工信部管理指令下发类型": "超时"
  ...
  {
    "ID": 7,
    "工信部管理指令下发ID": "R-139025",
    "工信部管理指令下发编号": "R-139025",
    "工信部管理指令下发名称": "工信部管理指令下发接口管理-7",
    "新增工信部管理指令下发状态": "已取消",
    "新增工信部管理指令下发时间": "2026-05-08 16:08:25",
    "新增工信部管理指令下发设置时间_": "2026-05-08 16:08:25",
    "指令下发属性": "已取消",
    "工信部管理指令下发创建时间": "2026-05-08 16:08:25",
    "新增工信部管理指令下发设置结果": "已取消",
    "工信部管理指令下发所属部门": "数据管理部",
    "工信部管理指令下发负责人": "admin",
    "工信部管理指令下发类型": "已取消"
...
const tableColumns = [
  ...
  {
    "prop": "新增工信部管理指令下发设置时间_",
    "label": "新增工信部管理指令下发设置时间。",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "新增工信部管理指令下发设置结果",
    "label": "新增工信部管理指令下发设置结果",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
