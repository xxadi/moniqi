    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产信息考核准确性信息表", "operation")'>资产信息考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息数据考核准确性字典信息", "form")'>新增资产信息数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息数据考核准确性字典信息", "config")'>修改资产信息数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息数据考核准确性字典信息")'>删除资产信息数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息数据考核准确性稽核数据上传", "form")'>资产信息数据考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产信息数据考核准确性稽核数据接口监控", "log")'>资产信息数据考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息数据考核准确性上传任务", "form")'>新增资产信息数据考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息数据考核准确性上传任务")'>删除资产信息数据考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息数据考核准确性上传任务", "config")'>修改资产信息数据考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产信息数据考核准确性上传任务", "detail")'>查询资产信息数据考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产信息数据考核准确性上传任务启用/禁用", "form")'>资产信息数据考核准确性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产名称考核准确性ID": "I-61758",
    "资产名称考核准确性编号": "I-61758",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-1",
    "资产名称考核准确性状态": "已驳回",
    "资产名称考核准确性时间": "2026-05-09 08:33:11",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-1",
    "资产名称考核准确性创建时间": "2026-05-09 08:33:11",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-1",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-1",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-1",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-1",
    "准确性字典ID": "I-61758"
  },
  {
    "ID": 2,
    "资产名称考核准确性ID": "I-69677",
    "资产名称考核准确性编号": "I-69677",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-2",
    "资产名称考核准确性状态": "待审核",
    "资产名称考核准确性时间": "2026-05-09 09:47:56",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-2",
    "资产名称考核准确性创建时间": "2026-05-09 09:47:56",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-2",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-2",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-2",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-2",
    "准确性字典ID": "I-69677"
  },
  {
    "ID": 3,
    "资产名称考核准确性ID": "I-77596",
    "资产名称考核准确性编号": "I-77596",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-3",
    "资产名称考核准确性状态": "已处理",
    "资产名称考核准确性时间": "2026-05-08 09:12:18",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-3",
    "资产名称考核准确性创建时间": "2026-05-08 09:12:18",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-3",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-3",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-3",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-3",
    "准确性字典ID": "I-77596"
  },
  {
    "ID": 4,
    "资产名称考核准确性ID": "I-85515",
    "资产名称考核准确性编号": "I-85515",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-4",
    "资产名称考核准确性状态": "处理中",
    "资产名称考核准确性时间": "2026-05-08 09:35:44",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-4",
    "资产名称考核准确性创建时间": "2026-05-08 09:35:44",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-4",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-4",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-4",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-4",
    "准确性字典ID": "I-85515"
  },
  {
    "ID": 5,
    "资产名称考核准确性ID": "I-93434",
    "资产名称考核准确性编号": "I-93434",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-5",
    "资产名称考核准确性状态": "待处理",
    "资产名称考核准确性时间": "2026-05-08 10:08:06",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-5",
    "资产名称考核准确性创建时间": "2026-05-08 10:08:06",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-5",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-5",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-5",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-5",
    "准确性字典ID": "I-93434"
  },
  {
    "ID": 6,
    "资产名称考核准确性ID": "I-101353",
    "资产名称考核准确性编号": "I-101353",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-6",
    "资产名称考核准确性状态": "处理失败",
    "资产名称考核准确性时间": "2026-05-08 10:42:31",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-6",
    "资产名称考核准确性创建时间": "2026-05-08 10:42:31",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-6",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-6",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-6",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-6",
    "准确性字典ID": "I-101353"
  },
  {
    "ID": 7,
    "资产名称考核准确性ID": "I-109272",
    "资产名称考核准确性编号": "I-109272",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-7",
    "资产名称考核准确性状态": "已暂停",
    "资产名称考核准确性时间": "2026-05-08 11:16:09",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-7",
    "资产名称考核准确性创建时间": "2026-05-08 11:16:09",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-7",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-7",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-7",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-7",
    "准确性字典ID": "I-109272"
  },
  {
    "ID": 8,
    "资产名称考核准确性ID": "I-117191",
    "资产名称考核准确性编号": "I-117191",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-8",
    "资产名称考核准确性状态": "已完成",
    "资产名称考核准确性时间": "2026-05-08 14:03:52",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-8",
    "资产名称考核准确性创建时间": "2026-05-08 14:03:52",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-8",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-8",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-8",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-8",
    "准确性字典ID": "I-117191"
  },
  {
    "ID": 9,
    "资产名称考核准确性ID": "I-125110",
    "资产名称考核准确性编号": "I-125110",
    "资产名称考核准确性名称": "资产信息考核准确性指标管理-9",
    "资产名称考核准确性状态": "排队中",
    "资产名称考核准确性时间": "2026-05-08 15:21:37",
    "资产名称考核准确性属性": "资产信息考核准确性指标管理-9",
    "资产名称考核准确性创建时间": "2026-05-08 15:21:37",
    "资产名称考核准确性所属部门": "资产信息考核准确性指标管理-9",
    "资产名称考核准确性负责人": "资产信息考核准确性指标管理-9",
    "资产名称考核准确性类型": "资产信息考核准确性指标管理-9",
    "资产名称考核准确性规则": "资产信息考核准确性指标管理-9",
    "准确性字典ID": "I-125110"
  }
];
const tableColumns = [
