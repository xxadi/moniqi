    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存厂商考核质量可用性信息表", "operation")'>内存厂商考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增内存厂商考核质量可用性上传任务", "form")'>新增内存厂商考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除内存厂商考核质量可用性上传任务")'>删除内存厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改内存厂商考核质量可用性上传任务", "config")'>修改内存厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询内存厂商考核质量可用性上传任务", "detail")'>查询内存厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存厂商考核质量可用性上传任务启用/禁用", "form")'>内存厂商考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("内存厂商考核质量可用性稽核数据上传", "form")'>内存厂商考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("内存厂商考核质量可用性稽核数据接口监控", "log")'>内存厂商考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("内存型号考核质量可用性信息表", "operation")'>内存型号考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("内存型号考核质量可用性稽核数据上传", "form")'>内存型号考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("内存型号考核质量可用性稽核数据接口监控", "log")'>内存型号考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "内存厂商考核质量可用性ID": "S-94112",
    "内存厂商考核质量可用性编号": "S-94112",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-1",
    "内存厂商考核质量可用性状态": "已处理",
    "内存厂商考核质量可用性时间": "2026-05-08 10:08:06",
    "内存厂商考核质量可用性属性": "已处理",
    "内存厂商考核质量可用性创建时间": "2026-05-08 10:08:06",
    "内存厂商考核质量可用性所属部门": "资产管理部",
    "内存厂商考核质量可用性负责人": "王五",
    "内存厂商考核质量可用性类型": "已处理",
    "内存厂商考核质量可用性规则": "已处理",
    "内存厂商考核质量可用性校验ID": "S-94112"
  },
  {
    "ID": 2,
    "内存厂商考核质量可用性ID": "S-102031",
    "内存厂商考核质量可用性编号": "S-102031",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-2",
    "内存厂商考核质量可用性状态": "处理中",
    "内存厂商考核质量可用性时间": "2026-05-08 10:42:31",
    "内存厂商考核质量可用性属性": "处理中",
    "内存厂商考核质量可用性创建时间": "2026-05-08 10:42:31",
    "内存厂商考核质量可用性所属部门": "信息安全部",
    "内存厂商考核质量可用性负责人": "赵六",
    "内存厂商考核质量可用性类型": "处理中",
    "内存厂商考核质量可用性规则": "处理中",
    "内存厂商考核质量可用性校验ID": "S-102031"
  },
  {
    "ID": 3,
    "内存厂商考核质量可用性ID": "S-109950",
    "内存厂商考核质量可用性编号": "S-109950",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-3",
    "内存厂商考核质量可用性状态": "待处理",
    "内存厂商考核质量可用性时间": "2026-05-08 11:16:09",
    "内存厂商考核质量可用性属性": "待处理",
    "内存厂商考核质量可用性创建时间": "2026-05-08 11:16:09",
    "内存厂商考核质量可用性所属部门": "系统运维部",
    "内存厂商考核质量可用性负责人": "system",
    "内存厂商考核质量可用性类型": "待处理",
    "内存厂商考核质量可用性规则": "待处理",
    "内存厂商考核质量可用性校验ID": "S-109950"
  },
  {
    "ID": 4,
    "内存厂商考核质量可用性ID": "S-117869",
    "内存厂商考核质量可用性编号": "S-117869",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-4",
    "内存厂商考核质量可用性状态": "处理失败",
    "内存厂商考核质量可用性时间": "2026-05-08 14:03:52",
    "内存厂商考核质量可用性属性": "处理失败",
    "内存厂商考核质量可用性创建时间": "2026-05-08 14:03:52",
    "内存厂商考核质量可用性所属部门": "数据管理部",
    "内存厂商考核质量可用性负责人": "admin",
    "内存厂商考核质量可用性类型": "处理失败",
    "内存厂商考核质量可用性规则": "处理失败",
    "内存厂商考核质量可用性校验ID": "S-117869"
  },
  {
    "ID": 5,
    "内存厂商考核质量可用性ID": "S-125788",
    "内存厂商考核质量可用性编号": "S-125788",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-5",
    "内存厂商考核质量可用性状态": "已暂停",
    "内存厂商考核质量可用性时间": "2026-05-08 15:21:37",
    "内存厂商考核质量可用性属性": "已暂停",
    "内存厂商考核质量可用性创建时间": "2026-05-08 15:21:37",
    "内存厂商考核质量可用性所属部门": "安全运维部",
    "内存厂商考核质量可用性负责人": "张三",
    "内存厂商考核质量可用性类型": "已暂停",
    "内存厂商考核质量可用性规则": "已暂停",
    "内存厂商考核质量可用性校验ID": "S-125788"
  },
  {
    "ID": 6,
    "内存厂商考核质量可用性ID": "S-133707",
    "内存厂商考核质量可用性编号": "S-133707",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-6",
    "内存厂商考核质量可用性状态": "已完成",
    "内存厂商考核质量可用性时间": "2026-05-08 16:08:25",
    "内存厂商考核质量可用性属性": "已完成",
    "内存厂商考核质量可用性创建时间": "2026-05-08 16:08:25",
    "内存厂商考核质量可用性所属部门": "网络管理部",
    "内存厂商考核质量可用性负责人": "李四",
    "内存厂商考核质量可用性类型": "已完成",
    "内存厂商考核质量可用性规则": "已完成",
    "内存厂商考核质量可用性校验ID": "S-133707"
  },
  {
    "ID": 7,
    "内存厂商考核质量可用性ID": "S-141626",
    "内存厂商考核质量可用性编号": "S-141626",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-7",
    "内存厂商考核质量可用性状态": "排队中",
    "内存厂商考核质量可用性时间": "2026-05-09 08:33:11",
    "内存厂商考核质量可用性属性": "排队中",
    "内存厂商考核质量可用性创建时间": "2026-05-09 08:33:11",
    "内存厂商考核质量可用性所属部门": "资产管理部",
    "内存厂商考核质量可用性负责人": "王五",
    "内存厂商考核质量可用性类型": "排队中",
    "内存厂商考核质量可用性规则": "排队中",
    "内存厂商考核质量可用性校验ID": "S-141626"
  },
  {
    "ID": 8,
    "内存厂商考核质量可用性ID": "S-149545",
    "内存厂商考核质量可用性编号": "S-149545",
    "内存厂商考核质量可用性名称": "内存厂商考核质量可用性指标管理-8",
    "内存厂商考核质量可用性状态": "部分完成",
    "内存厂商考核质量可用性时间": "2026-05-09 09:47:56",
    "内存厂商考核质量可用性属性": "部分完成",
    "内存厂商考核质量可用性创建时间": "2026-05-09 09:47:56",
    "内存厂商考核质量可用性所属部门": "信息安全部",
    "内存厂商考核质量可用性负责人": "赵六",
    "内存厂商考核质量可用性类型": "部分完成",
    "内存厂商考核质量可用性规则": "部分完成",
    "内存厂商考核质量可用性校验ID": "S-149545"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "内存厂商考核质量可用性创建时间",
    "label": "内存厂商考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "内存厂商考核质量可用性所属部门",
    "label": "内存厂商考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "内存厂商考核质量可用性校验ID",
    "label": "内存厂商考核质量可用性校验ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
