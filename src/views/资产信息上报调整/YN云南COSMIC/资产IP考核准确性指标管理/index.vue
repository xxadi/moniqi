    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核准确性信息表", "operation")'>资产IP考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核准确性稽核", "audit")'>资产IP考核准确性稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核准确性稽核数据上传", "form")'>资产IP考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产IP考核准确性稽核数据接口监控", "log")'>资产IP考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核准确性稽核汇总报告详情", "detail")'>查询资产IP考核准确性稽核汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产IP考核准确性上传任务", "form")'>新增资产IP考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产IP考核准确性上传任务")'>删除资产IP考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产IP考核准确性上传任务", "config")'>修改资产IP考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核准确性上传任务", "detail")'>查询资产IP考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核准确性上传任务启用/禁用", "form")'>资产IP考核准确性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产IP考核准确性ID": "J-29285",
    "资产IP考核准确性编号": "J-29285",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-1",
    "资产IP考核准确性状态": "已完成",
    "资产IP考核准确性时间": "2026-05-08 14:03:52",
    "资产IP考核准确性属性": "10.0.0.254",
    "资产IP考核准确性创建时间": "2026-05-08 14:03:52",
    "资产IP考核准确性所属部门": "数据管理部",
    "资产IP考核准确性负责人": "admin",
    "资产IP考核准确性类型": "10.0.0.254",
    "资产IP考核准确性规则": "10.0.0.254",
    "资产IP考核准确性稽核ID": "J-29285"
  },
  {
    "ID": 2,
    "资产IP考核准确性ID": "J-37204",
    "资产IP考核准确性编号": "J-37204",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-2",
    "资产IP考核准确性状态": "排队中",
    "资产IP考核准确性时间": "2026-05-08 15:21:37",
    "资产IP考核准确性属性": "10.10.1.100",
    "资产IP考核准确性创建时间": "2026-05-08 15:21:37",
    "资产IP考核准确性所属部门": "安全运维部",
    "资产IP考核准确性负责人": "张三",
    "资产IP考核准确性类型": "10.10.1.100",
    "资产IP考核准确性规则": "10.10.1.100",
    "资产IP考核准确性稽核ID": "J-37204"
  },
  {
    "ID": 3,
    "资产IP考核准确性ID": "J-45123",
    "资产IP考核准确性编号": "J-45123",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-3",
    "资产IP考核准确性状态": "部分完成",
    "资产IP考核准确性时间": "2026-05-08 16:08:25",
    "资产IP考核准确性属性": "172.16.0.50",
    "资产IP考核准确性创建时间": "2026-05-08 16:08:25",
    "资产IP考核准确性所属部门": "网络管理部",
    "资产IP考核准确性负责人": "李四",
    "资产IP考核准确性类型": "172.16.0.50",
    "资产IP考核准确性规则": "172.16.0.50",
    "资产IP考核准确性稽核ID": "J-45123"
  },
  {
    "ID": 4,
    "资产IP考核准确性ID": "J-53042",
    "资产IP考核准确性编号": "J-53042",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-4",
    "资产IP考核准确性状态": "已启用",
    "资产IP考核准确性时间": "2026-05-09 08:33:11",
    "资产IP考核准确性属性": "192.168.1.200",
    "资产IP考核准确性创建时间": "2026-05-09 08:33:11",
    "资产IP考核准确性所属部门": "资产管理部",
    "资产IP考核准确性负责人": "王五",
    "资产IP考核准确性类型": "192.168.1.200",
    "资产IP考核准确性规则": "192.168.1.200",
    "资产IP考核准确性稽核ID": "J-53042"
  },
  {
    "ID": 5,
    "资产IP考核准确性ID": "J-60961",
    "资产IP考核准确性编号": "J-60961",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-5",
    "资产IP考核准确性状态": "已停用",
    "资产IP考核准确性时间": "2026-05-09 09:47:56",
    "资产IP考核准确性属性": "10.20.5.30",
    "资产IP考核准确性创建时间": "2026-05-09 09:47:56",
    "资产IP考核准确性所属部门": "信息安全部",
    "资产IP考核准确性负责人": "赵六",
    "资产IP考核准确性类型": "10.20.5.30",
    "资产IP考核准确性规则": "10.20.5.30",
    "资产IP考核准确性稽核ID": "J-60961"
  },
  {
    "ID": 6,
    "资产IP考核准确性ID": "J-68880",
    "资产IP考核准确性编号": "J-68880",
    "资产IP考核准确性名称": "资产IP考核准确性指标管理-6",
    "资产IP考核准确性状态": "正常",
    "资产IP考核准确性时间": "2026-05-08 09:12:18",
    "资产IP考核准确性属性": "172.20.1.80",
    "资产IP考核准确性创建时间": "2026-05-08 09:12:18",
    "资产IP考核准确性所属部门": "系统运维部",
    "资产IP考核准确性负责人": "system",
    "资产IP考核准确性类型": "172.20.1.80",
    "资产IP考核准确性规则": "172.20.1.80",
    "资产IP考核准确性稽核ID": "J-68880"
  }
];
const tableColumns = [
  {
