    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产备份设置信息", "form")'>新增资产备份设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产备份设置信息", "config")'>修改资产备份设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产备份设置信息")'>删除资产备份设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产备份错误信息监控", "log")'>资产备份错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产备份错误事件通知", "audit")'>资产备份错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产备份错误事件通知删除", "operation")'>资产备份错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产备份错误事件通知查询", "detail")'>资产备份错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产备份防篡改信息", "form")'>新增资产备份防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产备份防篡改信息", "config")'>修改资产备份防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产备份防篡改信息")'>删除资产备份防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("工信部指令信息导出")'>工信部指令信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产备份名称": "资产备份管理-1",
    "新增资产备份状态": "已驳回",
    "新增资产备份时间": "2026-05-08 10:08:06",
    "新增资产备份设置时间_": "2026-05-08 10:08:06",
    "资产备份属性": "已驳回",
    "资产备份创建时间": "2026-05-08 10:08:06",
    "新增资产备份设置结果": "已驳回",
    "资产备份所属部门": "系统运维部",
    "资产备份负责人": "system",
    "资产备份类型": "已驳回"
  },
  {
    ...
    "资产备份名称": "资产备份管理-2",
    "新增资产备份状态": "待审核",
    "新增资产备份时间": "2026-05-08 10:42:31",
    "新增资产备份设置时间_": "2026-05-08 10:42:31",
    "资产备份属性": "待审核",
    "资产备份创建时间": "2026-05-08 10:42:31",
    "新增资产备份设置结果": "待审核",
    "资产备份所属部门": "数据管理部",
    "资产备份负责人": "admin",
    "资产备份类型": "待审核"
  },
  {
    ...
    "资产备份名称": "资产备份管理-3",
    "新增资产备份状态": "已处理",
    "新增资产备份时间": "2026-05-08 11:16:09",
    "新增资产备份设置时间_": "2026-05-08 11:16:09",
    "资产备份属性": "已处理",
    "资产备份创建时间": "2026-05-08 11:16:09",
    "新增资产备份设置结果": "已处理",
    "资产备份所属部门": "安全运维部",
    "资产备份负责人": "张三",
    "资产备份类型": "已处理"
  },
  {
    ...
    "资产备份名称": "资产备份管理-4",
    "新增资产备份状态": "处理中",
    "新增资产备份时间": "2026-05-08 14:03:52",
    "新增资产备份设置时间_": "2026-05-08 14:03:52",
    "资产备份属性": "处理中",
    "资产备份创建时间": "2026-05-08 14:03:52",
    "新增资产备份设置结果": "处理中",
    "资产备份所属部门": "网络管理部",
    "资产备份负责人": "李四",
    "资产备份类型": "处理中"
  },
  {
    ...
    "资产备份名称": "资产备份管理-5",
    "新增资产备份状态": "待处理",
    "新增资产备份时间": "2026-05-08 15:21:37",
    "新增资产备份设置时间_": "2026-05-08 15:21:37",
    "资产备份属性": "待处理",
    "资产备份创建时间": "2026-05-08 15:21:37",
    "新增资产备份设置结果": "待处理",
    "资产备份所属部门": "资产管理部",
    "资产备份负责人": "王五",
    "资产备份类型": "待处理"
  },
  {
    ...
    "资产备份名称": "资产备份管理-6",
    "新增资产备份状态": "处理失败",
    "新增资产备份时间": "2026-05-08 16:08:25",
    "新增资产备份设置时间_": "2026-05-08 16:08:25",
    "资产备份属性": "处理失败",
    "资产备份创建时间": "2026-05-08 16:08:25",
    "新增资产备份设置结果": "处理失败",
    "资产备份所属部门": "信息安全部",
    "资产备份负责人": "赵六",
    "资产备份类型": "处理失败"
  },
  {
    ...
    "资产备份名称": "资产备份管理-7",
    "新增资产备份状态": "已暂停",
    "新增资产备份时间": "2026-05-09 08:33:11",
    "新增资产备份设置时间_": "2026-05-09 08:33:11",
    "资产备份属性": "已暂停",
    "资产备份创建时间": "2026-05-09 08:33:11",
    "新增资产备份设置结果": "已暂停",
    "资产备份所属部门": "系统运维部",
    "资产备份负责人": "system",
    "资产备份类型": "已暂停"
  },
  {
    ...
    "资产备份名称": "资产备份管理-8",
    "新增资产备份状态": "已完成",
    "新增资产备份时间": "2026-05-09 09:47:56",
    "新增资产备份设置时间_": "2026-05-09 09:47:56",
    "资产备份属性": "已完成",
    "资产备份创建时间": "2026-05-09 09:47:56",
    "新增资产备份设置结果": "已完成",
    "资产备份所属部门": "数据管理部",
    "资产备份负责人": "admin",
    "资产备份类型": "已完成"
