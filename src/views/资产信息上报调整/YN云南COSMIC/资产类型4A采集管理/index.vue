    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型4A采集信息表", "transform")'>资产类型4A采集信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产类型4A采集任务", "form")'>新增资产类型4A采集任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产类型4A采集任务")'>删除资产类型4A采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类型4A采集任务", "config")'>修改资产类型4A采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型4A采集任务", "detail")'>查询资产类型4A采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型4A采集任务启用/禁用", "transform")'>资产类型4A采集任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产类型4A采集规则", "form")'>新增资产类型4A采集规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类型4A采集规则", "config")'>修改资产类型4A采集规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产类型4A采集规则")'>删除资产类型4A采集规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产类型4A采集查询", "detail")'>资产类型4A采集查询</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产类型4A采集ID": "O-69252",
    "资产类型4A采集编号": "O-69252",
    "资产类型4A采集名称": "资产类型4A采集管理-1",
    "资产类型4A采集状态": "已暂停",
    "资产类型4A采集时间": "2026-05-08 10:08:06",
    "4A采集属性": "已暂停",
    "资产类型4A采集创建时间": "2026-05-08 10:08:06",
    "资产类型4A采集所属部门": "安全运维部",
    "资产类型4A采集负责人": "张三",
    "资产类型4A采集类型": "已暂停",
    "资产类型4A采集规则": "已暂停",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-77171",
    "资产类型4A采集编号": "O-77171",
    "资产类型4A采集名称": "资产类型4A采集管理-2",
    "资产类型4A采集状态": "已完成",
    "资产类型4A采集时间": "2026-05-08 10:42:31",
    "4A采集属性": "已完成",
    "资产类型4A采集创建时间": "2026-05-08 10:42:31",
    "资产类型4A采集所属部门": "网络管理部",
    "资产类型4A采集负责人": "李四",
    "资产类型4A采集类型": "已完成",
    "资产类型4A采集规则": "已完成",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-85090",
    "资产类型4A采集编号": "O-85090",
    "资产类型4A采集名称": "资产类型4A采集管理-3",
    "资产类型4A采集状态": "排队中",
    "资产类型4A采集时间": "2026-05-08 11:16:09",
    "4A采集属性": "排队中",
    "资产类型4A采集创建时间": "2026-05-08 11:16:09",
    "资产类型4A采集所属部门": "资产管理部",
    "资产类型4A采集负责人": "王五",
    "资产类型4A采集类型": "排队中",
    "资产类型4A采集规则": "排队中",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-93009",
    "资产类型4A采集编号": "O-93009",
    "资产类型4A采集名称": "资产类型4A采集管理-4",
    "资产类型4A采集状态": "部分完成",
    "资产类型4A采集时间": "2026-05-08 14:03:52",
    "4A采集属性": "部分完成",
    "资产类型4A采集创建时间": "2026-05-08 14:03:52",
    "资产类型4A采集所属部门": "信息安全部",
    "资产类型4A采集负责人": "赵六",
    "资产类型4A采集类型": "部分完成",
    "资产类型4A采集规则": "部分完成",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-100928",
    "资产类型4A采集编号": "O-100928",
    "资产类型4A采集名称": "资产类型4A采集管理-5",
    "资产类型4A采集状态": "已启用",
    "资产类型4A采集时间": "2026-05-08 15:21:37",
    "4A采集属性": "已启用",
    "资产类型4A采集创建时间": "2026-05-08 15:21:37",
    "资产类型4A采集所属部门": "系统运维部",
    "资产类型4A采集负责人": "system",
    "资产类型4A采集类型": "已启用",
    "资产类型4A采集规则": "已启用",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-108847",
    "资产类型4A采集编号": "O-108847",
    "资产类型4A采集名称": "资产类型4A采集管理-6",
    "资产类型4A采集状态": "已停用",
    "资产类型4A采集时间": "2026-05-08 16:08:25",
    "4A采集属性": "已停用",
    "资产类型4A采集创建时间": "2026-05-08 16:08:25",
    "资产类型4A采集所属部门": "数据管理部",
    "资产类型4A采集负责人": "admin",
    "资产类型4A采集类型": "已停用",
    "资产类型4A采集规则": "已停用",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-116766",
    "资产类型4A采集编号": "O-116766",
    "资产类型4A采集名称": "资产类型4A采集管理-7",
    "资产类型4A采集状态": "正常",
    "资产类型4A采集时间": "2026-05-09 08:33:11",
    "4A采集属性": "正常",
    "资产类型4A采集创建时间": "2026-05-09 08:33:11",
    "资产类型4A采集所属部门": "安全运维部",
    "资产类型4A采集负责人": "张三",
    "资产类型4A采集类型": "正常",
    "资产类型4A采集规则": "正常",
  ...
  },
  {
    ...
    "资产类型4A采集ID": "O-124685",
    "资产类型4A采集编号": "O-124685",
    "资产类型4A采集名称": "资产类型4A采集管理-8",
    "资产类型4A采集状态": "异常",
    "资产类型4A采集时间": "2026-05-09 09:47:56",
    "4A采集属性": "异常",
    "资产类型4A采集创建时间": "2026-05-09 09:47:56",
    "资产类型4A采集所属部门": "网络管理部",
    "资产类型4A采集负责人": "李四",
    "资产类型4A采集类型": "异常",
    "资产类型4A采集规则": "异常",
