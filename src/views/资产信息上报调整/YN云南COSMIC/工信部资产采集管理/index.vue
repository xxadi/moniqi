    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产采集信息", "form")'>新增工信部资产采集信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产采集信息", "config")'>修改工信部资产采集信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产采集信息")'>删除工信部资产采集信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产采集监控", "monitor")'>工信部资产采集监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部资产采集监控告警", "alert")'>工信部资产采集监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产采集稽核", "transform")'>工信部资产采集稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产采集统计", "statistics")'>工信部资产采集统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产采集数据转换", "transform")'>工信部资产采集数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产采集数据预处理", "transform")'>工信部资产采集数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产采集ID": "V-61459",
    "工信部资产采集编号": "V-61459",
    "工信部资产采集名称": "工信部资产采集管理-1",
    "新增工信部资产采集状态": "处理失败",
    "新增工信部资产采集时间": "2026-05-09 09:47:56",
    "工信部资产采集属性": "处理失败",
    "工信部资产采集创建时间": "2026-05-09 09:47:56",
    "工信部资产采集所属部门": "网络管理部",
    "工信部资产采集负责人": "李四",
    "工信部资产采集类型": "处理失败",
    "工信部资产采集规则": "处理失败",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-69378",
    "工信部资产采集编号": "V-69378",
    "工信部资产采集名称": "工信部资产采集管理-2",
    "新增工信部资产采集状态": "已暂停",
    "新增工信部资产采集时间": "2026-05-08 09:12:18",
    "工信部资产采集属性": "已暂停",
    "工信部资产采集创建时间": "2026-05-08 09:12:18",
    "工信部资产采集所属部门": "资产管理部",
    "工信部资产采集负责人": "王五",
    "工信部资产采集类型": "已暂停",
    "工信部资产采集规则": "已暂停",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-77297",
    "工信部资产采集编号": "V-77297",
    "工信部资产采集名称": "工信部资产采集管理-3",
    "新增工信部资产采集状态": "已完成",
    "新增工信部资产采集时间": "2026-05-08 09:35:44",
    "工信部资产采集属性": "已完成",
    "工信部资产采集创建时间": "2026-05-08 09:35:44",
    "工信部资产采集所属部门": "信息安全部",
    "工信部资产采集负责人": "赵六",
    "工信部资产采集类型": "已完成",
    "工信部资产采集规则": "已完成",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-85216",
    "工信部资产采集编号": "V-85216",
    "工信部资产采集名称": "工信部资产采集管理-4",
    "新增工信部资产采集状态": "排队中",
    "新增工信部资产采集时间": "2026-05-08 10:08:06",
    "工信部资产采集属性": "排队中",
    "工信部资产采集创建时间": "2026-05-08 10:08:06",
    "工信部资产采集所属部门": "系统运维部",
    "工信部资产采集负责人": "system",
    "工信部资产采集类型": "排队中",
    "工信部资产采集规则": "排队中",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-93135",
    "工信部资产采集编号": "V-93135",
    "工信部资产采集名称": "工信部资产采集管理-5",
    "新增工信部资产采集状态": "部分完成",
    "新增工信部资产采集时间": "2026-05-08 10:42:31",
    "工信部资产采集属性": "部分完成",
    "工信部资产采集创建时间": "2026-05-08 10:42:31",
    "工信部资产采集所属部门": "数据管理部",
    "工信部资产采集负责人": "admin",
    "工信部资产采集类型": "部分完成",
    "工信部资产采集规则": "部分完成",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-101054",
    "工信部资产采集编号": "V-101054",
    "工信部资产采集名称": "工信部资产采集管理-6",
    "新增工信部资产采集状态": "已启用",
    "新增工信部资产采集时间": "2026-05-08 11:16:09",
    "工信部资产采集属性": "已启用",
    "工信部资产采集创建时间": "2026-05-08 11:16:09",
    "工信部资产采集所属部门": "安全运维部",
    "工信部资产采集负责人": "张三",
    "工信部资产采集类型": "已启用",
    "工信部资产采集规则": "已启用",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-108973",
    "工信部资产采集编号": "V-108973",
    "工信部资产采集名称": "工信部资产采集管理-7",
    "新增工信部资产采集状态": "已停用",
    "新增工信部资产采集时间": "2026-05-08 14:03:52",
    "工信部资产采集属性": "已停用",
    "工信部资产采集创建时间": "2026-05-08 14:03:52",
    "工信部资产采集所属部门": "网络管理部",
    "工信部资产采集负责人": "李四",
    "工信部资产采集类型": "已停用",
    "工信部资产采集规则": "已停用",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-116892",
    "工信部资产采集编号": "V-116892",
    "工信部资产采集名称": "工信部资产采集管理-8",
    "新增工信部资产采集状态": "正常",
    "新增工信部资产采集时间": "2026-05-08 15:21:37",
    "工信部资产采集属性": "正常",
    "工信部资产采集创建时间": "2026-05-08 15:21:37",
    "工信部资产采集所属部门": "资产管理部",
    "工信部资产采集负责人": "王五",
    "工信部资产采集类型": "正常",
    "工信部资产采集规则": "正常",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-124811",
    "工信部资产采集编号": "V-124811",
    "工信部资产采集名称": "工信部资产采集管理-9",
    "新增工信部资产采集状态": "异常",
    "新增工信部资产采集时间": "2026-05-08 16:08:25",
    "工信部资产采集属性": "异常",
    "工信部资产采集创建时间": "2026-05-08 16:08:25",
    "工信部资产采集所属部门": "信息安全部",
    "工信部资产采集负责人": "赵六",
    "工信部资产采集类型": "异常",
    "工信部资产采集规则": "异常",
  ...
  },
  {
    ...
    "工信部资产采集ID": "V-132730",
    "工信部资产采集编号": "V-132730",
    "工信部资产采集名称": "工信部资产采集管理-10",
    "新增工信部资产采集状态": "超时",
    "新增工信部资产采集时间": "2026-05-09 08:33:11",
    "工信部资产采集属性": "超时",
    "工信部资产采集创建时间": "2026-05-09 08:33:11",
    "工信部资产采集所属部门": "系统运维部",
    "工信部资产采集负责人": "system",
    "工信部资产采集类型": "超时",
    "工信部资产采集规则": "超时",
