    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警信息表", "audit")'>流量告警信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量告警任务", "form")'>新增流量告警任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量告警模型", "form")'>新增流量告警模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量告警模型", "config")'>修改流量告警模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量告警模型")'>删除流量告警模型</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警查询", "detail")'>流量告警查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警可视化展示", "detail")'>流量告警可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起流量告警审核流程", "initiate_audit")'>发起流量告警审核流程</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流量告警名称": "流量告警管理-1",
    "流量告警状态": "待审核",
    "流量告警时间": "2026-05-08 09:35:44",
    "流量告警属性": "待审核",
    "流量告警创建时间": "2026-05-08 09:35:44",
    "流量告警所属部门": "信息安全部",
    "流量告警负责人": "赵六",
    "流量告警类型": "待审核",
    "流量告警模型": "待审核",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-2",
    "流量告警状态": "已处理",
    "流量告警时间": "2026-05-08 10:08:06",
    "流量告警属性": "已处理",
    "流量告警创建时间": "2026-05-08 10:08:06",
    "流量告警所属部门": "系统运维部",
    "流量告警负责人": "system",
    "流量告警类型": "已处理",
    "流量告警模型": "已处理",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-3",
    "流量告警状态": "处理中",
    "流量告警时间": "2026-05-08 10:42:31",
    "流量告警属性": "处理中",
    "流量告警创建时间": "2026-05-08 10:42:31",
    "流量告警所属部门": "数据管理部",
    "流量告警负责人": "admin",
    "流量告警类型": "处理中",
    "流量告警模型": "处理中",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-4",
    "流量告警状态": "待处理",
    "流量告警时间": "2026-05-08 11:16:09",
    "流量告警属性": "待处理",
    "流量告警创建时间": "2026-05-08 11:16:09",
    "流量告警所属部门": "安全运维部",
    "流量告警负责人": "张三",
    "流量告警类型": "待处理",
    "流量告警模型": "待处理",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-5",
    "流量告警状态": "处理失败",
    "流量告警时间": "2026-05-08 14:03:52",
    "流量告警属性": "处理失败",
    "流量告警创建时间": "2026-05-08 14:03:52",
    "流量告警所属部门": "网络管理部",
    "流量告警负责人": "李四",
    "流量告警类型": "处理失败",
    "流量告警模型": "处理失败",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-6",
    "流量告警状态": "已暂停",
    "流量告警时间": "2026-05-08 15:21:37",
    "流量告警属性": "已暂停",
    "流量告警创建时间": "2026-05-08 15:21:37",
    "流量告警所属部门": "资产管理部",
    "流量告警负责人": "王五",
    "流量告警类型": "已暂停",
    "流量告警模型": "已暂停",
  ...
  },
  {
    ...
    "流量告警名称": "流量告警管理-7",
    "流量告警状态": "已完成",
    "流量告警时间": "2026-05-08 16:08:25",
    "流量告警属性": "已完成",
    "流量告警创建时间": "2026-05-08 16:08:25",
    "流量告警所属部门": "信息安全部",
    "流量告警负责人": "赵六",
    "流量告警类型": "已完成",
    "流量告警模型": "已完成",
