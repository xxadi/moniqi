    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增拨测周期计划任务')">新增拨测周期计划任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增拨测周期计划模型')">新增拨测周期计划模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改拨测周期计划模型')">修改拨测周期计划模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除拨测周期计划模型')">删除拨测周期计划模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click="handleFunction('拨测周期计划查询')">拨测周期计划查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click="handleFunction('拨测周期计划可视化展示')">拨测周期计划可视化展示</el-button>
        </div>
...
const rows = [
  { ID: 1, 计划编号: "BCP-001", 计划名称: "每日全量拨测计划", 计划周期: "每日", 执行时间: "02:00", 拨测范围: "全国", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 计划编号: "BCP-002", 计划名称: "每周抽样拨测计划", 计划周期: "每周", 执行时间: "03:00", 拨测范围: "重点城市", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 计划编号: "BCP-003", 计划名称: "每月全量拨测计划", 计划周期: "每月", 执行时间: "01:00", 拨测范围: "全国", 启用状态: "停用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 计划编号: "BCP-004", 计划名称: "节假日专项拨测计划", 计划周期: "节假日", 执行时间: "00:30", 拨测范围: "全国", 启用状态: "启用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 计划编号: "BCP-005", 计划名称: "实时拨测监控计划", 计划周期: "实时", 执行时间: "持续", 拨测范围: "核心节点", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
  { prop: "计划编号", label: "计划编号", type: "text", search: true },
  { prop: "计划名称", label: "计划名称", type: "text", search: true },
  { prop: "计划周期", label: "计划周期", type: "select", options: [{ value: "每日", label: "每日" }, { value: "每周", label: "每周" }, { value: "每月", label: "每月" }, { value: "实时", label: "实时" }], search: true },
  { prop: "执行时间", label: "执行时间", type: "text" },
  { prop: "拨测范围", label: "拨测范围", type: "text" },
...
const defaultRow = { 计划编号: "", 计划名称: "", 计划周期: "每日", 执行时间: "", 拨测范围: "", 启用状态: "启用", 更新时间: "" };

export default {
  name: "BoCeZhouQiJiHuaXinXiGuanLi",
  data() {
    return {
      searchData: {},
      searchConfig: [],
