    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象资产审批指派信息", "form")'>新增定级对象资产审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象资产审批流程节点", "form")'>新增定级对象资产审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象资产审批流程节点信息", "config")'>修改定级对象资产审批流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批流程节点删除", "operation")'>定级对象资产审批流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批流程节点查询", "detail")'>定级对象资产审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批附件上传", "form")'>定级对象资产审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批流程图查看", "preview")'>定级对象资产审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批流程通知", "audit")'>定级对象资产审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批结果逐级审批", "audit")'>定级对象资产审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产审批结果拒绝和驳回", "approval")'>定级对象资产审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "审批流程环节ID": "N-36543",
    "审批编号": "N-36543",
    "定级对象资产审批名称": "定级对象资产审批流程管理-1",
    "删除流水号": "N-36543",
    "定级对象资产审批流程节点编号": "N-36543",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-1",
    "类型": "待审核",
    "规则": "待审核",
    "删除定级对象资产审批流程节点状态": "待审核",
    "删除定级对象资产审批流程节点时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 2,
    "资产审批ID": "N-44462",
    "审批流程环节ID": "N-44462",
    "审批编号": "N-44462",
    "定级对象资产审批名称": "定级对象资产审批流程管理-2",
    "删除流水号": "N-44462",
    "定级对象资产审批流程节点编号": "N-44462",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-2",
    "类型": "已处理",
    "规则": "已处理",
    "删除定级对象资产审批流程节点状态": "已处理",
    "删除定级对象资产审批流程节点时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 3,
    "资产审批ID": "N-52381",
    "审批流程环节ID": "N-52381",
    "审批编号": "N-52381",
    "定级对象资产审批名称": "定级对象资产审批流程管理-3",
    "删除流水号": "N-52381",
    "定级对象资产审批流程节点编号": "N-52381",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-3",
    "类型": "处理中",
    "规则": "处理中",
    "删除定级对象资产审批流程节点状态": "处理中",
    "删除定级对象资产审批流程节点时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 4,
    "资产审批ID": "N-60300",
    "审批流程环节ID": "N-60300",
    "审批编号": "N-60300",
    "定级对象资产审批名称": "定级对象资产审批流程管理-4",
    "删除流水号": "N-60300",
    "定级对象资产审批流程节点编号": "N-60300",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-4",
    "类型": "待处理",
    "规则": "待处理",
    "删除定级对象资产审批流程节点状态": "待处理",
    "删除定级对象资产审批流程节点时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 5,
    "资产审批ID": "N-68219",
    "审批流程环节ID": "N-68219",
    "审批编号": "N-68219",
    "定级对象资产审批名称": "定级对象资产审批流程管理-5",
    "删除流水号": "N-68219",
    "定级对象资产审批流程节点编号": "N-68219",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-5",
    "类型": "处理失败",
    "规则": "处理失败",
    "删除定级对象资产审批流程节点状态": "处理失败",
    "删除定级对象资产审批流程节点时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 6,
    "资产审批ID": "N-76138",
    "审批流程环节ID": "N-76138",
    "审批编号": "N-76138",
    "定级对象资产审批名称": "定级对象资产审批流程管理-6",
    "删除流水号": "N-76138",
    "定级对象资产审批流程节点编号": "N-76138",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-6",
    "类型": "已暂停",
    "规则": "已暂停",
    "删除定级对象资产审批流程节点状态": "已暂停",
    "删除定级对象资产审批流程节点时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 7,
    "资产审批ID": "N-84057",
    "审批流程环节ID": "N-84057",
    "审批编号": "N-84057",
    "定级对象资产审批名称": "定级对象资产审批流程管理-7",
    "删除流水号": "N-84057",
    "定级对象资产审批流程节点编号": "N-84057",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-7",
    "类型": "已完成",
    "规则": "已完成",
    "删除定级对象资产审批流程节点状态": "已完成",
    "删除定级对象资产审批流程节点时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 8,
    "资产审批ID": "N-91976",
    "审批流程环节ID": "N-91976",
    "审批编号": "N-91976",
    "定级对象资产审批名称": "定级对象资产审批流程管理-8",
    "删除流水号": "N-91976",
    "定级对象资产审批流程节点编号": "N-91976",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-8",
    "类型": "排队中",
    "规则": "排队中",
    "删除定级对象资产审批流程节点状态": "排队中",
    "删除定级对象资产审批流程节点时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 9,
    "资产审批ID": "N-99895",
    "审批流程环节ID": "N-99895",
    "审批编号": "N-99895",
    "定级对象资产审批名称": "定级对象资产审批流程管理-9",
    "删除流水号": "N-99895",
    "定级对象资产审批流程节点编号": "N-99895",
    "定级对象资产审批流程节点名称": "定级对象资产审批流程管理-9",
    "类型": "部分完成",
    "规则": "部分完成",
    "删除定级对象资产审批流程节点状态": "部分完成",
    "删除定级对象资产审批流程节点时间": "2026-05-08 09:35:44"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "删除定级对象资产审批流程节点状态",
    "label": "删除定级对象资产审批流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "删除定级对象资产审批流程节点时间",
    "label": "删除定级对象资产审批流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
