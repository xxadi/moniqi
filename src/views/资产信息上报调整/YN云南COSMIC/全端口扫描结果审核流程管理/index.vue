    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起全端口扫描结果审核流程", "initiate_audit")'>发起全端口扫描结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描结果审核指派信息", "form")'>新增全端口扫描结果审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描结果审核流程", "form")'>新增全端口扫描结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全端口扫描结果审核流程信息", "config")'>修改全端口扫描结果审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全端口扫描结果审核流程删除", "operation")'>全端口扫描结果审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全端口扫描结果审核流程查询", "detail")'>全端口扫描结果审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全端口扫描结果审核附件上传", "form")'>全端口扫描结果审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("全端口扫描结果审核流程图查看", "preview")'>全端口扫描结果审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描结果审核流程通知", "audit")'>全端口扫描结果审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描结果审核结果逐级审批", "audit")'>全端口扫描结果审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描结果审核结果拒绝和驳回", "approval")'>全端口扫描结果审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "全端口扫描结果审核ID": "R-89743",
    "全端口扫描结果审核流程环节ID": "R-89743",
    "全端口扫描结果审核编号": "R-89743",
    "全端口扫描结果审核名称": "待审核",
    "发起全端口扫描结果审核状态": "待审核",
    "发起全端口扫描结果审核时间": "2026-05-08 10:42:31",
    "全端口扫描结果审核属性": "待审核",
    "全端口扫描结果审核发起时间": "2026-05-08 10:42:31",
    "全端口扫描结果审核流程id": "待审核",
    "全端口扫描结果审核流程环节": "待审核",
    "全端口扫描结果审核创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 2,
    "全端口扫描结果审核ID": "R-97662",
    "全端口扫描结果审核流程环节ID": "R-97662",
    "全端口扫描结果审核编号": "R-97662",
    "全端口扫描结果审核名称": "已处理",
    "发起全端口扫描结果审核状态": "已处理",
    "发起全端口扫描结果审核时间": "2026-05-08 11:16:09",
    "全端口扫描结果审核属性": "已处理",
    "全端口扫描结果审核发起时间": "2026-05-08 11:16:09",
    "全端口扫描结果审核流程id": "已处理",
    "全端口扫描结果审核流程环节": "已处理",
    "全端口扫描结果审核创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 3,
    "全端口扫描结果审核ID": "R-105581",
    "全端口扫描结果审核流程环节ID": "R-105581",
    "全端口扫描结果审核编号": "R-105581",
    "全端口扫描结果审核名称": "处理中",
    "发起全端口扫描结果审核状态": "处理中",
    "发起全端口扫描结果审核时间": "2026-05-08 14:03:52",
    "全端口扫描结果审核属性": "处理中",
    "全端口扫描结果审核发起时间": "2026-05-08 14:03:52",
    "全端口扫描结果审核流程id": "处理中",
    "全端口扫描结果审核流程环节": "处理中",
    "全端口扫描结果审核创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 4,
    "全端口扫描结果审核ID": "R-113500",
    "全端口扫描结果审核流程环节ID": "R-113500",
    "全端口扫描结果审核编号": "R-113500",
    "全端口扫描结果审核名称": "待处理",
    "发起全端口扫描结果审核状态": "待处理",
    "发起全端口扫描结果审核时间": "2026-05-08 15:21:37",
    "全端口扫描结果审核属性": "待处理",
    "全端口扫描结果审核发起时间": "2026-05-08 15:21:37",
    "全端口扫描结果审核流程id": "待处理",
    "全端口扫描结果审核流程环节": "待处理",
    "全端口扫描结果审核创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 5,
    "全端口扫描结果审核ID": "R-121419",
    "全端口扫描结果审核流程环节ID": "R-121419",
    "全端口扫描结果审核编号": "R-121419",
    "全端口扫描结果审核名称": "处理失败",
    "发起全端口扫描结果审核状态": "处理失败",
    "发起全端口扫描结果审核时间": "2026-05-08 16:08:25",
    "全端口扫描结果审核属性": "处理失败",
    "全端口扫描结果审核发起时间": "2026-05-08 16:08:25",
    "全端口扫描结果审核流程id": "处理失败",
    "全端口扫描结果审核流程环节": "处理失败",
    "全端口扫描结果审核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 6,
    "全端口扫描结果审核ID": "R-129338",
    "全端口扫描结果审核流程环节ID": "R-129338",
    "全端口扫描结果审核编号": "R-129338",
    "全端口扫描结果审核名称": "已暂停",
    "发起全端口扫描结果审核状态": "已暂停",
    "发起全端口扫描结果审核时间": "2026-05-09 08:33:11",
    "全端口扫描结果审核属性": "已暂停",
    "全端口扫描结果审核发起时间": "2026-05-09 08:33:11",
    "全端口扫描结果审核流程id": "已暂停",
    "全端口扫描结果审核流程环节": "已暂停",
    "全端口扫描结果审核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 7,
    "全端口扫描结果审核ID": "R-137257",
    "全端口扫描结果审核流程环节ID": "R-137257",
    "全端口扫描结果审核编号": "R-137257",
    "全端口扫描结果审核名称": "已完成",
    "发起全端口扫描结果审核状态": "已完成",
    "发起全端口扫描结果审核时间": "2026-05-09 09:47:56",
    "全端口扫描结果审核属性": "已完成",
    "全端口扫描结果审核发起时间": "2026-05-09 09:47:56",
    "全端口扫描结果审核流程id": "已完成",
    "全端口扫描结果审核流程环节": "已完成",
    "全端口扫描结果审核创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 8,
    "全端口扫描结果审核ID": "R-145176",
    "全端口扫描结果审核流程环节ID": "R-145176",
    "全端口扫描结果审核编号": "R-145176",
    "全端口扫描结果审核名称": "排队中",
    "发起全端口扫描结果审核状态": "排队中",
    "发起全端口扫描结果审核时间": "2026-05-08 09:12:18",
    "全端口扫描结果审核属性": "排队中",
    "全端口扫描结果审核发起时间": "2026-05-08 09:12:18",
    "全端口扫描结果审核流程id": "排队中",
    "全端口扫描结果审核流程环节": "排队中",
    "全端口扫描结果审核创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 9,
    "全端口扫描结果审核ID": "R-153095",
    "全端口扫描结果审核流程环节ID": "R-153095",
    "全端口扫描结果审核编号": "R-153095",
    "全端口扫描结果审核名称": "部分完成",
    "发起全端口扫描结果审核状态": "部分完成",
    "发起全端口扫描结果审核时间": "2026-05-08 09:35:44",
    "全端口扫描结果审核属性": "部分完成",
    "全端口扫描结果审核发起时间": "2026-05-08 09:35:44",
    "全端口扫描结果审核流程id": "部分完成",
    "全端口扫描结果审核流程环节": "部分完成",
    "全端口扫描结果审核创建时间": "2026-05-08 09:35:44"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "全端口扫描结果审核流程环节ID",
    "label": "全端口扫描结果审核流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
