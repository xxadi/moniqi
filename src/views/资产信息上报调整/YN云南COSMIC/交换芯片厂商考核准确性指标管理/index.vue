    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片厂商考核准确性信息表", "operation")'>交换芯片厂商考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增交换芯片厂商数据考核准确性字典信息", "form")'>新增交换芯片厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改交换芯片厂商数据考核准确性字典信息", "config")'>修改交换芯片厂商数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除交换芯片厂商数据考核准确性字典信息")'>删除交换芯片厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增交换芯片厂商考核准确性上传任务", "form")'>新增交换芯片厂商考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除交换芯片厂商考核准确性上传任务")'>删除交换芯片厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改交换芯片厂商考核准确性上传任务", "config")'>修改交换芯片厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询交换芯片厂商考核准确性上传任务", "detail")'>查询交换芯片厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片厂商考核准确性上传任务启用/禁用", "form")'>交换芯片厂商考核准确性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("交换芯片厂商考核准确性稽核数据上传", "form")'>交换芯片厂商考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("交换芯片厂商考核准确性稽核数据接口监控", "log")'>交换芯片厂商考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片型号考核准确性信息表", "operation")'>交换芯片型号考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("交换芯片型号考核准确性稽核数据上传", "form")'>交换芯片型号考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("交换芯片型号考核准确性稽核数据接口监控", "log")'>交换芯片型号考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "交换芯片厂商考核准确性ID": "Z-47605",
    "交换芯片厂商考核准确性编号": "Z-47605",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-1",
    "交换芯片厂商考核准确性状态": "已完成",
    "交换芯片厂商考核准确性时间": "2026-05-08 14:03:52",
    "交换芯片厂商考核准确性属性": "已完成",
    "交换芯片厂商考核准确性创建时间": "2026-05-08 14:03:52",
    "交换芯片厂商考核准确性所属部门": "网络管理部",
    "交换芯片厂商考核准确性负责人": "李四",
    "交换芯片厂商考核准确性类型": "已完成",
    "交换芯片厂商考核准确性规则": "已完成",
    "交换芯片厂商数据考核准确性字典ID": "Z-47605"
  },
  {
    "ID": 2,
    "交换芯片厂商考核准确性ID": "Z-55524",
    "交换芯片厂商考核准确性编号": "Z-55524",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-2",
    "交换芯片厂商考核准确性状态": "排队中",
    "交换芯片厂商考核准确性时间": "2026-05-08 15:21:37",
    "交换芯片厂商考核准确性属性": "排队中",
    "交换芯片厂商考核准确性创建时间": "2026-05-08 15:21:37",
    "交换芯片厂商考核准确性所属部门": "资产管理部",
    "交换芯片厂商考核准确性负责人": "王五",
    "交换芯片厂商考核准确性类型": "排队中",
    "交换芯片厂商考核准确性规则": "排队中",
    "交换芯片厂商数据考核准确性字典ID": "Z-55524"
  },
  {
    "ID": 3,
    "交换芯片厂商考核准确性ID": "Z-63443",
    "交换芯片厂商考核准确性编号": "Z-63443",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-3",
    "交换芯片厂商考核准确性状态": "部分完成",
    "交换芯片厂商考核准确性时间": "2026-05-08 16:08:25",
    "交换芯片厂商考核准确性属性": "部分完成",
    "交换芯片厂商考核准确性创建时间": "2026-05-08 16:08:25",
    "交换芯片厂商考核准确性所属部门": "信息安全部",
    "交换芯片厂商考核准确性负责人": "赵六",
    "交换芯片厂商考核准确性类型": "部分完成",
    "交换芯片厂商考核准确性规则": "部分完成",
    "交换芯片厂商数据考核准确性字典ID": "Z-63443"
  },
  {
    "ID": 4,
    "交换芯片厂商考核准确性ID": "Z-71362",
    "交换芯片厂商考核准确性编号": "Z-71362",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-4",
    "交换芯片厂商考核准确性状态": "已启用",
    "交换芯片厂商考核准确性时间": "2026-05-09 08:33:11",
    "交换芯片厂商考核准确性属性": "已启用",
    "交换芯片厂商考核准确性创建时间": "2026-05-09 08:33:11",
    "交换芯片厂商考核准确性所属部门": "系统运维部",
    "交换芯片厂商考核准确性负责人": "system",
    "交换芯片厂商考核准确性类型": "已启用",
    "交换芯片厂商考核准确性规则": "已启用",
    "交换芯片厂商数据考核准确性字典ID": "Z-71362"
  },
  {
    "ID": 5,
    "交换芯片厂商考核准确性ID": "Z-79281",
    "交换芯片厂商考核准确性编号": "Z-79281",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-5",
    "交换芯片厂商考核准确性状态": "已停用",
    "交换芯片厂商考核准确性时间": "2026-05-09 09:47:56",
    "交换芯片厂商考核准确性属性": "已停用",
    "交换芯片厂商考核准确性创建时间": "2026-05-09 09:47:56",
    "交换芯片厂商考核准确性所属部门": "数据管理部",
    "交换芯片厂商考核准确性负责人": "admin",
    "交换芯片厂商考核准确性类型": "已停用",
    "交换芯片厂商考核准确性规则": "已停用",
    "交换芯片厂商数据考核准确性字典ID": "Z-79281"
  },
  {
    "ID": 6,
    "交换芯片厂商考核准确性ID": "Z-87200",
    "交换芯片厂商考核准确性编号": "Z-87200",
    "交换芯片厂商考核准确性名称": "交换芯片厂商考核准确性指标管理-6",
    "交换芯片厂商考核准确性状态": "正常",
    "交换芯片厂商考核准确性时间": "2026-05-08 09:12:18",
    "交换芯片厂商考核准确性属性": "正常",
    "交换芯片厂商考核准确性创建时间": "2026-05-08 09:12:18",
    "交换芯片厂商考核准确性所属部门": "安全运维部",
    "交换芯片厂商考核准确性负责人": "张三",
    "交换芯片厂商考核准确性类型": "正常",
    "交换芯片厂商考核准确性规则": "正常",
    "交换芯片厂商数据考核准确性字典ID": "Z-87200"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "交换芯片厂商考核准确性创建时间",
    "label": "交换芯片厂商考核准确性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "交换芯片厂商考核准确性所属部门",
    "label": "交换芯片厂商考核准确性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "交换芯片厂商数据考核准确性字典ID",
    "label": "交换芯片厂商数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
