    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部采集率实时性监控信息", "form")'>新增工信部采集率实时性监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率实时性监控信息", "config")'>修改工信部采集率实时性监控信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率实时性监控信息")'>删除工信部采集率实时性监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控", "log")'>工信部采集率实时性监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部采集率实时性监控告警", "alert")'>工信部采集率实时性监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控稽核", "log")'>工信部采集率实时性监控稽核</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控统计", "log")'>工信部采集率实时性监控统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控数据采集", "log")'>工信部采集率实时性监控数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控数据转换", "log")'>工信部采集率实时性监控数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率实时性监控数据预处理", "log")'>工信部采集率实时性监控数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部采集率实时性监控ID": "U-32494",
    "工信部采集率实时性监控编号": "U-32494",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-1",
    "新增工信部采集率实时性监控状态": "已驳回",
    "新增工信部采集率实时性监控时间": "2026-05-08 11:16:09",
    "工信部采集率实时性监控属性": "已驳回",
    "工信部采集率实时性监控创建时间": "2026-05-08 11:16:09",
    "工信部采集率实时性监控所属部门": "系统运维部",
    "工信部采集率实时性监控负责人": "system",
    "工信部采集率实时性监控类型": "已驳回",
    "工信部采集率实时性监控规则": "已驳回",
    "名称": "工信部采集率实时性监控管理-1"
  },
  {
    "ID": 2,
    "工信部采集率实时性监控ID": "U-40413",
    "工信部采集率实时性监控编号": "U-40413",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-2",
    "新增工信部采集率实时性监控状态": "待审核",
    "新增工信部采集率实时性监控时间": "2026-05-08 14:03:52",
    "工信部采集率实时性监控属性": "待审核",
    "工信部采集率实时性监控创建时间": "2026-05-08 14:03:52",
    "工信部采集率实时性监控所属部门": "数据管理部",
    "工信部采集率实时性监控负责人": "admin",
    "工信部采集率实时性监控类型": "待审核",
    "工信部采集率实时性监控规则": "待审核",
    "名称": "工信部采集率实时性监控管理-2"
  },
  {
    "ID": 3,
    "工信部采集率实时性监控ID": "U-48332",
    "工信部采集率实时性监控编号": "U-48332",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-3",
    "新增工信部采集率实时性监控状态": "已处理",
    "新增工信部采集率实时性监控时间": "2026-05-08 15:21:37",
    "工信部采集率实时性监控属性": "已处理",
    "工信部采集率实时性监控创建时间": "2026-05-08 15:21:37",
    "工信部采集率实时性监控所属部门": "安全运维部",
    "工信部采集率实时性监控负责人": "张三",
    "工信部采集率实时性监控类型": "已处理",
    "工信部采集率实时性监控规则": "已处理",
    "名称": "工信部采集率实时性监控管理-3"
  ...
  {
    "ID": 4,
    "工信部采集率实时性监控ID": "U-56251",
    "工信部采集率实时性监控编号": "U-56251",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-4",
    "新增工信部采集率实时性监控状态": "处理中",
    "新增工信部采集率实时性监控时间": "2026-05-08 16:08:25",
    "工信部采集率实时性监控属性": "处理中",
    "工信部采集率实时性监控创建时间": "2026-05-08 16:08:25",
    "工信部采集率实时性监控所属部门": "网络管理部",
    "工信部采集率实时性监控负责人": "李四",
    "工信部采集率实时性监控类型": "处理中",
    "工信部采集率实时性监控规则": "处理中",
    "名称": "工信部采集率实时性监控管理-4"
  ...
  {
    "ID": 5,
    "工信部采集率实时性监控ID": "U-64170",
    "工信部采集率实时性监控编号": "U-64170",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-5",
    "新增工信部采集率实时性监控状态": "待处理",
    "新增工信部采集率实时性监控时间": "2026-05-09 08:33:11",
    "工信部采集率实时性监控属性": "待处理",
    "工信部采集率实时性监控创建时间": "2026-05-09 08:33:11",
    "工信部采集率实时性监控所属部门": "资产管理部",
    "工信部采集率实时性监控负责人": "王五",
    "工信部采集率实时性监控类型": "待处理",
    "工信部采集率实时性监控规则": "待处理",
    "名称": "工信部采集率实时性监控管理-5"
  ...
  {
    "ID": 6,
    "工信部采集率实时性监控ID": "U-72089",
    "工信部采集率实时性监控编号": "U-72089",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-6",
    "新增工信部采集率实时性监控状态": "处理失败",
    "新增工信部采集率实时性监控时间": "2026-05-09 09:47:56",
    "工信部采集率实时性监控属性": "处理失败",
    "工信部采集率实时性监控创建时间": "2026-05-09 09:47:56",
    "工信部采集率实时性监控所属部门": "信息安全部",
    "工信部采集率实时性监控负责人": "赵六",
    "工信部采集率实时性监控类型": "处理失败",
    "工信部采集率实时性监控规则": "处理失败",
    "名称": "工信部采集率实时性监控管理-6"
  ...
  {
    "ID": 7,
    "工信部采集率实时性监控ID": "U-80008",
    "工信部采集率实时性监控编号": "U-80008",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-7",
    "新增工信部采集率实时性监控状态": "已暂停",
    "新增工信部采集率实时性监控时间": "2026-05-08 09:12:18",
    "工信部采集率实时性监控属性": "已暂停",
    "工信部采集率实时性监控创建时间": "2026-05-08 09:12:18",
    "工信部采集率实时性监控所属部门": "系统运维部",
    "工信部采集率实时性监控负责人": "system",
    "工信部采集率实时性监控类型": "已暂停",
    "工信部采集率实时性监控规则": "已暂停",
  ...
  {
    "ID": 8,
    "工信部采集率实时性监控ID": "U-87927",
    "工信部采集率实时性监控编号": "U-87927",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-8",
    "新增工信部采集率实时性监控状态": "已完成",
    "新增工信部采集率实时性监控时间": "2026-05-08 09:35:44",
    "工信部采集率实时性监控属性": "已完成",
    "工信部采集率实时性监控创建时间": "2026-05-08 09:35:44",
    "工信部采集率实时性监控所属部门": "数据管理部",
    "工信部采集率实时性监控负责人": "admin",
    "工信部采集率实时性监控类型": "已完成",
    "工信部采集率实时性监控规则": "已完成",
  ...
  {
    "ID": 9,
    "工信部采集率实时性监控ID": "U-95846",
    "工信部采集率实时性监控编号": "U-95846",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-9",
    "新增工信部采集率实时性监控状态": "排队中",
    "新增工信部采集率实时性监控时间": "2026-05-08 10:08:06",
    "工信部采集率实时性监控属性": "排队中",
    "工信部采集率实时性监控创建时间": "2026-05-08 10:08:06",
    "工信部采集率实时性监控所属部门": "安全运维部",
    "工信部采集率实时性监控负责人": "张三",
    "工信部采集率实时性监控类型": "排队中",
    "工信部采集率实时性监控规则": "排队中",
  ...
  {
    "ID": 10,
    "工信部采集率实时性监控ID": "U-103765",
    "工信部采集率实时性监控编号": "U-103765",
    "工信部采集率实时性监控名称": "工信部采集率实时性监控管理-10",
    "新增工信部采集率实时性监控状态": "部分完成",
    "新增工信部采集率实时性监控时间": "2026-05-08 10:42:31",
    "工信部采集率实时性监控属性": "部分完成",
    "工信部采集率实时性监控创建时间": "2026-05-08 10:42:31",
    "工信部采集率实时性监控所属部门": "网络管理部",
    "工信部采集率实时性监控负责人": "李四",
    "工信部采集率实时性监控类型": "部分完成",
    "工信部采集率实时性监控规则": "部分完成",
...
const tableColumns = [
  ...
  {
    "prop": "新增工信部采集率实时性监控状态",
    "label": "新增工信部采集率实时性监控状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增工信部采集率实时性监控时间",
    "label": "新增工信部采集率实时性监控时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部采集率实时性监控创建时间",
    "label": "工信部采集率实时性监控创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部采集率实时性监控所属部门",
    "label": "工信部采集率实时性监控所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
