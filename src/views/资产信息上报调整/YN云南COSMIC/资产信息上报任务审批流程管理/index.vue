    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起资产信息上报任务审批流程", "workflow")'>发起资产信息上报任务审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息上报任务审批指派信息", "form")'>新增资产信息上报任务审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息上报任务审批流程", "form")'>新增资产信息上报任务审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息上报任务审批流程信息", "config")'>修改资产信息上报任务审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批流程删除", "operation")'>资产信息上报任务审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批流程查询", "detail")'>资产信息上报任务审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批附件上传", "form")'>资产信息上报任务审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批流程图查看", "preview")'>资产信息上报任务审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批流程通知", "audit")'>资产信息上报任务审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批结果逐级审批", "audit")'>资产信息上报任务审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务审批结果拒绝和驳回", "approval")'>资产信息上报任务审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产信息上报任务审批ID": "J-75097",
    "资产信息上报任务审批流程环节ID": "J-75097",
    "资产信息上报任务审批编号": "J-75097",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-1",
    "发起资产信息上报任务审批状态": "已停用",
    "发起资产信息上报任务审批时间": "2026-05-08 16:08:25",
    "资产信息上报任务审批属性": "已停用",
    "资产信息上报任务审批发起时间": "2026-05-08 16:08:25",
    "资产信息上报任务审批流程id": "已停用",
    "资产信息上报任务审批流程环节": "已停用",
    "资产信息上报任务审批创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "资产信息上报任务审批ID": "J-83016",
    "资产信息上报任务审批流程环节ID": "J-83016",
    "资产信息上报任务审批编号": "J-83016",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-2",
    "发起资产信息上报任务审批状态": "正常",
    "发起资产信息上报任务审批时间": "2026-05-09 08:33:11",
    "资产信息上报任务审批属性": "正常",
    "资产信息上报任务审批发起时间": "2026-05-09 08:33:11",
    "资产信息上报任务审批流程id": "正常",
    "资产信息上报任务审批流程环节": "正常",
    "资产信息上报任务审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "资产信息上报任务审批ID": "J-90935",
    "资产信息上报任务审批流程环节ID": "J-90935",
    "资产信息上报任务审批编号": "J-90935",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-3",
    "发起资产信息上报任务审批状态": "异常",
    "发起资产信息上报任务审批时间": "2026-05-09 09:47:56",
    "资产信息上报任务审批属性": "异常",
    "资产信息上报任务审批发起时间": "2026-05-09 09:47:56",
    "资产信息上报任务审批流程id": "异常",
    "资产信息上报任务审批流程环节": "异常",
    "资产信息上报任务审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "资产信息上报任务审批ID": "J-98854",
    "资产信息上报任务审批流程环节ID": "J-98854",
    "资产信息上报任务审批编号": "J-98854",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-4",
    "发起资产信息上报任务审批状态": "超时",
    "发起资产信息上报任务审批时间": "2026-05-08 09:12:18",
    "资产信息上报任务审批属性": "超时",
    "资产信息上报任务审批发起时间": "2026-05-08 09:12:18",
    "资产信息上报任务审批流程id": "超时",
    "资产信息上报任务审批流程环节": "超时",
    "资产信息上报任务审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "资产信息上报任务审批ID": "J-106773",
    "资产信息上报任务审批流程环节ID": "J-106773",
    "资产信息上报任务审批编号": "J-106773",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-5",
    "发起资产信息上报任务审批状态": "已取消",
    "发起资产信息上报任务审批时间": "2026-05-08 09:35:44",
    "资产信息上报任务审批属性": "已取消",
    "资产信息上报任务审批发起时间": "2026-05-08 09:35:44",
    "资产信息上报任务审批流程id": "已取消",
    "资产信息上报任务审批流程环节": "已取消",
    "资产信息上报任务审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "资产信息上报任务审批ID": "J-114692",
    "资产信息上报任务审批流程环节ID": "J-114692",
    "资产信息上报任务审批编号": "J-114692",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-6",
    "发起资产信息上报任务审批状态": "已驳回",
    "发起资产信息上报任务审批时间": "2026-05-08 10:08:06",
    "资产信息上报任务审批属性": "已驳回",
    "资产信息上报任务审批发起时间": "2026-05-08 10:08:06",
    "资产信息上报任务审批流程id": "已驳回",
    "资产信息上报任务审批流程环节": "已驳回",
    "资产信息上报任务审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "资产信息上报任务审批ID": "J-122611",
    "资产信息上报任务审批流程环节ID": "J-122611",
    "资产信息上报任务审批编号": "J-122611",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-7",
    "发起资产信息上报任务审批状态": "待审核",
    "发起资产信息上报任务审批时间": "2026-05-08 10:42:31",
    "资产信息上报任务审批属性": "待审核",
    "资产信息上报任务审批发起时间": "2026-05-08 10:42:31",
    "资产信息上报任务审批流程id": "待审核",
    "资产信息上报任务审批流程环节": "待审核",
    "资产信息上报任务审批创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "资产信息上报任务审批ID": "J-130530",
    "资产信息上报任务审批流程环节ID": "J-130530",
    "资产信息上报任务审批编号": "J-130530",
    "资产信息上报任务审批名称": "资产信息上报任务审批流程管理-8",
    "发起资产信息上报任务审批状态": "已处理",
    "发起资产信息上报任务审批时间": "2026-05-08 11:16:09",
    "资产信息上报任务审批属性": "已处理",
    "资产信息上报任务审批发起时间": "2026-05-08 11:16:09",
    "资产信息上报任务审批流程id": "已处理",
    "资产信息上报任务审批流程环节": "已处理",
    "资产信息上报任务审批创建时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "资产信息上报任务审批流程环节ID",
    "label": "资产信息上报任务审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
