    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起全端口扫描稽核流程", "workflow")'>发起全端口扫描稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描稽核指派信息", "form")'>新增全端口扫描稽核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增全端口扫描稽核流程", "form")'>新增全端口扫描稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改全端口扫描稽核流程信息", "config")'>修改全端口扫描稽核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核流程删除", "operation")'>全端口扫描稽核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核流程查询", "detail")'>全端口扫描稽核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核附件上传", "form")'>全端口扫描稽核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核流程图查看", "preview")'>全端口扫描稽核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核流程通知", "audit")'>全端口扫描稽核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核结果逐级审批", "audit")'>全端口扫描稽核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("全端口扫描稽核结果拒绝和驳回", "approval")'>全端口扫描稽核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "全端口扫描稽核ID": "C-17578",
    "全端口扫描稽核流程环节ID": "C-17578",
    "全端口扫描稽核编号": "C-17578",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-1",
    "发起全端口扫描稽核状态": "正常",
    "发起全端口扫描稽核时间": "2026-05-09 08:33:11",
    "全端口扫描稽核属性": "正常",
    "全端口扫描稽核发起时间": "2026-05-09 08:33:11",
    "全端口扫描稽核流程id": "正常",
    "全端口扫描稽核流程环节": "正常",
  ...
  },
  {
    "ID": 2,
    "全端口扫描稽核ID": "C-25497",
    "全端口扫描稽核流程环节ID": "C-25497",
    "全端口扫描稽核编号": "C-25497",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-2",
    "发起全端口扫描稽核状态": "异常",
    "发起全端口扫描稽核时间": "2026-05-09 09:47:56",
    "全端口扫描稽核属性": "异常",
    "全端口扫描稽核发起时间": "2026-05-09 09:47:56",
    "全端口扫描稽核流程id": "异常",
    "全端口扫描稽核流程环节": "异常",
  ...
  },
  {
    "ID": 3,
    "全端口扫描稽核ID": "C-33416",
    "全端口扫描稽核流程环节ID": "C-33416",
    "全端口扫描稽核编号": "C-33416",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-3",
    "发起全端口扫描稽核状态": "超时",
    "发起全端口扫描稽核时间": "2026-05-08 09:12:18",
    "全端口扫描稽核属性": "超时",
    "全端口扫描稽核发起时间": "2026-05-08 09:12:18",
    "全端口扫描稽核流程id": "超时",
    "全端口扫描稽核流程环节": "超时",
  ...
  },
  {
    "ID": 4,
    "全端口扫描稽核ID": "C-41335",
    "全端口扫描稽核流程环节ID": "C-41335",
    "全端口扫描稽核编号": "C-41335",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-4",
    "发起全端口扫描稽核状态": "已取消",
    "发起全端口扫描稽核时间": "2026-05-08 09:35:44",
    "全端口扫描稽核属性": "已取消",
    "全端口扫描稽核发起时间": "2026-05-08 09:35:44",
    "全端口扫描稽核流程id": "已取消",
    "全端口扫描稽核流程环节": "已取消",
  ...
  },
  {
    "ID": 5,
    "全端口扫描稽核ID": "C-49254",
    "全端口扫描稽核流程环节ID": "C-49254",
    "全端口扫描稽核编号": "C-49254",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-5",
    "发起全端口扫描稽核状态": "已驳回",
    "发起全端口扫描稽核时间": "2026-05-08 10:08:06",
    "全端口扫描稽核属性": "已驳回",
    "全端口扫描稽核发起时间": "2026-05-08 10:08:06",
    "全端口扫描稽核流程id": "已驳回",
    "全端口扫描稽核流程环节": "已驳回",
  ...
  },
  {
    "ID": 6,
    "全端口扫描稽核ID": "C-57173",
    "全端口扫描稽核流程环节ID": "C-57173",
    "全端口扫描稽核编号": "C-57173",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-6",
    "发起全端口扫描稽核状态": "待审核",
    "发起全端口扫描稽核时间": "2026-05-08 10:42:31",
    "全端口扫描稽核属性": "待审核",
    "全端口扫描稽核发起时间": "2026-05-08 10:42:31",
    "全端口扫描稽核流程id": "待审核",
    "全端口扫描稽核流程环节": "待审核",
    "全端口扫描稽核创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 7,
    "全端口扫描稽核ID": "C-65092",
    "全端口扫描稽核流程环节ID": "C-65092",
    "全端口扫描稽核编号": "C-65092",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-7",
    "发起全端口扫描稽核状态": "已处理",
    "发起全端口扫描稽核时间": "2026-05-08 11:16:09",
    "全端口扫描稽核属性": "已处理",
    "全端口扫描稽核发起时间": "2026-05-08 11:16:09",
    "全端口扫描稽核流程id": "已处理",
    "全端口扫描稽核流程环节": "已处理",
    "全端口扫描稽核创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 8,
    "全端口扫描稽核ID": "C-73011",
    "全端口扫描稽核流程环节ID": "C-73011",
    "全端口扫描稽核编号": "C-73011",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-8",
    "发起全端口扫描稽核状态": "处理中",
    "发起全端口扫描稽核时间": "2026-05-08 14:03:52",
    "全端口扫描稽核属性": "处理中",
    "全端口扫描稽核发起时间": "2026-05-08 14:03:52",
    "全端口扫描稽核流程id": "处理中",
    "全端口扫描稽核流程环节": "处理中",
    "全端口扫描稽核创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 9,
    "全端口扫描稽核ID": "C-80930",
    "全端口扫描稽核流程环节ID": "C-80930",
    "全端口扫描稽核编号": "C-80930",
    "全端口扫描稽核名称": "全端口扫描稽核流程管理-9",
    "发起全端口扫描稽核状态": "待处理",
    "发起全端口扫描稽核时间": "2026-05-08 15:21:37",
    "全端口扫描稽核属性": "待处理",
    "全端口扫描稽核发起时间": "2026-05-08 15:21:37",
    "全端口扫描稽核流程id": "待处理",
    "全端口扫描稽核流程环节": "待处理",
