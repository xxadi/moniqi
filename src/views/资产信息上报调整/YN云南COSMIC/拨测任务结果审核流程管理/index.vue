    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起拨测任务结果审核流程", "initiate_audit")'>发起拨测任务结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测任务结果审核指派信息", "form")'>新增拨测任务结果审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测任务结果审核流程", "form")'>新增拨测任务结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改拨测任务结果审核流程信息", "config")'>修改拨测任务结果审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务结果审核流程删除", "operation")'>拨测任务结果审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务结果审核流程查询", "detail")'>拨测任务结果审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务结果审核附件上传", "form")'>拨测任务结果审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测任务结果审核流程图查看", "preview")'>拨测任务结果审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测任务结果审核流程通知", "audit")'>拨测任务结果审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测任务结果审核结果逐级审批", "audit")'>拨测任务结果审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("拨测任务结果审核结果拒绝和驳回", "approval")'>拨测任务结果审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "拨测任务结果审核ID": "G-20312",
    "拨测任务结果审核流程环节ID": "G-20312",
    "拨测任务结果审核编号": "G-20312",
    "拨测任务结果审核名称": "已启用",
    "发起拨测任务结果审核状态": "已启用",
    "发起拨测任务结果审核时间": "2026-05-08 10:08:06",
    "拨测任务结果审核属性": "已启用",
    "拨测任务结果审核发起时间": "2026-05-08 10:08:06",
    "拨测任务结果审核流程id": "已启用",
    "拨测任务结果审核流程环节": "已启用",
    "拨测任务结果审核创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 2,
    "拨测任务结果审核ID": "G-28231",
    "拨测任务结果审核流程环节ID": "G-28231",
    "拨测任务结果审核编号": "G-28231",
    "拨测任务结果审核名称": "已停用",
    "发起拨测任务结果审核状态": "已停用",
    "发起拨测任务结果审核时间": "2026-05-08 10:42:31",
    "拨测任务结果审核属性": "已停用",
    "拨测任务结果审核发起时间": "2026-05-08 10:42:31",
    "拨测任务结果审核流程id": "已停用",
    "拨测任务结果审核流程环节": "已停用",
    "拨测任务结果审核创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 3,
    "拨测任务结果审核ID": "G-36150",
    "拨测任务结果审核流程环节ID": "G-36150",
    "拨测任务结果审核编号": "G-36150",
    "拨测任务结果审核名称": "正常",
    "发起拨测任务结果审核状态": "正常",
    "发起拨测任务结果审核时间": "2026-05-08 11:16:09",
    "拨测任务结果审核属性": "正常",
    "拨测任务结果审核发起时间": "2026-05-08 11:16:09",
    "拨测任务结果审核流程id": "正常",
    "拨测任务结果审核流程环节": "正常",
    "拨测任务结果审核创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 4,
    "拨测任务结果审核ID": "G-44069",
    "拨测任务结果审核流程环节ID": "G-44069",
    "拨测任务结果审核编号": "G-44069",
    "拨测任务结果审核名称": "异常",
    "发起拨测任务结果审核状态": "异常",
    "发起拨测任务结果审核时间": "2026-05-08 14:03:52",
    "拨测任务结果审核属性": "异常",
    "拨测任务结果审核发起时间": "2026-05-08 14:03:52",
    "拨测任务结果审核流程id": "异常",
    "拨测任务结果审核流程环节": "异常",
    "拨测任务结果审核创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 5,
    "拨测任务结果审核ID": "G-51988",
    "拨测任务结果审核流程环节ID": "G-51988",
    "拨测任务结果审核编号": "G-51988",
    "拨测任务结果审核名称": "超时",
    "发起拨测任务结果审核状态": "超时",
    "发起拨测任务结果审核时间": "2026-05-08 15:21:37",
    "拨测任务结果审核属性": "超时",
    "拨测任务结果审核发起时间": "2026-05-08 15:21:37",
    "拨测任务结果审核流程id": "超时",
    "拨测任务结果审核流程环节": "超时",
    "拨测任务结果审核创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 6,
    "拨测任务结果审核ID": "G-59907",
    "拨测任务结果审核流程环节ID": "G-59907",
    "拨测任务结果审核编号": "G-59907",
    "拨测任务结果审核名称": "已取消",
    "发起拨测任务结果审核状态": "已取消",
    "发起拨测任务结果审核时间": "2026-05-08 16:08:25",
    "拨测任务结果审核属性": "已取消",
    "拨测任务结果审核发起时间": "2026-05-08 16:08:25",
    "拨测任务结果审核流程id": "已取消",
    "拨测任务结果审核流程环节": "已取消",
    "拨测任务结果审核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 7,
    "拨测任务结果审核ID": "G-67826",
    "拨测任务结果审核流程环节ID": "G-67826",
    "拨测任务结果审核编号": "G-67826",
    "拨测任务结果审核名称": "已驳回",
    "发起拨测任务结果审核状态": "已驳回",
    "发起拨测任务结果审核时间": "2026-05-09 08:33:11",
    "拨测任务结果审核属性": "已驳回",
    "拨测任务结果审核发起时间": "2026-05-09 08:33:11",
    "拨测任务结果审核流程id": "已驳回",
    "拨测任务结果审核流程环节": "已驳回",
    "拨测任务结果审核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 8,
    "拨测任务结果审核ID": "G-75745",
    "拨测任务结果审核流程环节ID": "G-75745",
    "拨测任务结果审核编号": "G-75745",
    "拨测任务结果审核名称": "待审核",
    "发起拨测任务结果审核状态": "待审核",
    "发起拨测任务结果审核时间": "2026-05-09 09:47:56",
    "拨测任务结果审核属性": "待审核",
    "拨测任务结果审核发起时间": "2026-05-09 09:47:56",
    "拨测任务结果审核流程id": "待审核",
    "拨测任务结果审核流程环节": "待审核",
    "拨测任务结果审核创建时间": "2026-05-09 09:47:56"
  }
];
const tableColumns = [
  {
