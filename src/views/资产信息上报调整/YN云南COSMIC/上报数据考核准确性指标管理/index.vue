    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据考核准确性监控", "log")'>上报数据考核准确性监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("上报数据考核准确性监控告警", "alert")'>上报数据考核准确性监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据考核准确性告警规则", "form")'>新增上报数据考核准确性告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据考核准确性告警规则", "config")'>修改上报数据考核准确性告警规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据考核准确性告警规则")'>删除上报数据考核准确性告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据考核准确性稽核", "audit")'>上报数据考核准确性稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核准确性统计", "statistics")'>上报数据考核准确性统计</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "监控编号": "S-30646",
    "上报数据考核接口上报时间": "2026-05-08 15:21:37",
    "资产校验规则": "排队中",
    ...
    "上报数据考核准确性监控状态": "排队中",
    "上报数据考核准确性监控内容": "排队中",
    "上报数据考核准确性监控时间": "2026-05-08 15:21:37",
    "编号": "S-30646",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-1",
    "上报数据考核准确性监控编号": "S-30646"
  },
  {
    "ID": 2,
    "监控编号": "S-38565",
    "上报数据考核接口上报时间": "2026-05-08 16:08:25",
    "资产校验规则": "部分完成",
    ...
    "上报数据考核准确性监控状态": "部分完成",
    "上报数据考核准确性监控内容": "部分完成",
    "上报数据考核准确性监控时间": "2026-05-08 16:08:25",
    "编号": "S-38565",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-2",
    "上报数据考核准确性监控编号": "S-38565"
  },
  {
    "ID": 3,
    "监控编号": "S-46484",
    "上报数据考核接口上报时间": "2026-05-09 08:33:11",
    "资产校验规则": "已启用",
    "上传时间": "2026-05-09 08:33:11",
    "上传地址": "10.10.1.100",
    "控名称": "上报数据考核准确性指标管理-3",
    "上报数据考核准确性监控状态": "已启用",
    "上报数据考核准确性监控内容": "已启用",
    "上报数据考核准确性监控时间": "2026-05-09 08:33:11",
    "编号": "S-46484",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-3",
    "上报数据考核准确性监控编号": "S-46484"
  },
  {
    "ID": 4,
    "监控编号": "S-54403",
    "上报数据考核接口上报时间": "2026-05-09 09:47:56",
    "资产校验规则": "已停用",
    "上传时间": "2026-05-09 09:47:56",
    "上传地址": "172.16.0.50",
    "控名称": "上报数据考核准确性指标管理-4",
    "上报数据考核准确性监控状态": "已停用",
    "上报数据考核准确性监控内容": "已停用",
    "上报数据考核准确性监控时间": "2026-05-09 09:47:56",
    "编号": "S-54403",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-4",
    "上报数据考核准确性监控编号": "S-54403"
  },
  {
    "ID": 5,
    "监控编号": "S-62322",
    "上报数据考核接口上报时间": "2026-05-08 09:12:18",
    "资产校验规则": "正常",
    "上传时间": "2026-05-08 09:12:18",
    "上传地址": "192.168.1.200",
    "控名称": "上报数据考核准确性指标管理-5",
    "上报数据考核准确性监控状态": "正常",
    "上报数据考核准确性监控内容": "正常",
    "上报数据考核准确性监控时间": "2026-05-08 09:12:18",
    "编号": "S-62322",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-5",
    "上报数据考核准确性监控编号": "S-62322"
  },
  {
    "ID": 6,
    "监控编号": "S-70241",
    "上报数据考核接口上报时间": "2026-05-08 09:35:44",
    "资产校验规则": "异常",
    ...
    "上报数据考核准确性监控状态": "异常",
    "上报数据考核准确性监控内容": "异常",
    "上报数据考核准确性监控时间": "2026-05-08 09:35:44",
    "编号": "S-70241",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-6",
    "上报数据考核准确性监控编号": "S-70241"
  },
  {
    "ID": 7,
    "监控编号": "S-78160",
    "上报数据考核接口上报时间": "2026-05-08 10:08:06",
    "资产校验规则": "超时",
    ...
    "上报数据考核准确性监控状态": "超时",
    "上报数据考核准确性监控内容": "超时",
    "上报数据考核准确性监控时间": "2026-05-08 10:08:06",
    "编号": "S-78160",
    "上报数据考核准确性监控名称": "上报数据考核准确性指标管理-7",
    "上报数据考核准确性监控编号": "S-78160"
  }
];
const tableColumns = [
  {
