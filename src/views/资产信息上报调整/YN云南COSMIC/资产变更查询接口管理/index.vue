    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产变更查询接口信息", "config")'>修改资产变更查询接口信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产变更查询接口信息")'>删除资产变更查询接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产变更查询接口列表", "detail")'>查询资产变更查询接口列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产变更查询接口下发回传同步", "detail")'>资产变更查询接口下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产变更查询接口下发回传任务推送", "detail")'>资产变更查询接口下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产变更查询接口数据下发", "detail")'>资产变更查询接口数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产变更查询接口数据分析", "analysis")'>资产变更查询接口数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产变更查询接口数据上报", "detail")'>资产变更查询接口数据上报</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产补录查询接口信息", "config")'>修改资产补录查询接口信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产变更查询接口属性": "待审核",
    "修改资产变更查询接口状态": "待审核",
    "修改资产变更查询接口时间": "2026-05-08 09:35:44",
    "修改人": "待审核",
    "资产变更查询接口ID": "T-78591",
    "资产变更查询接口名称": "资产变更查询接口管理-1",
    "资产变更查询接口类型": "待审核"
  },
  {
    "ID": 2,
    ...
    "资产变更查询接口属性": "已处理",
    "修改资产变更查询接口状态": "已处理",
    "修改资产变更查询接口时间": "2026-05-08 10:08:06",
    "修改人": "已处理",
    "资产变更查询接口ID": "T-86510",
    "资产变更查询接口名称": "资产变更查询接口管理-2",
    "资产变更查询接口类型": "已处理"
  },
  {
    "ID": 3,
    ...
    "资产变更查询接口属性": "处理中",
    "修改资产变更查询接口状态": "处理中",
    "修改资产变更查询接口时间": "2026-05-08 10:42:31",
    "修改人": "处理中",
    "资产变更查询接口ID": "T-94429",
    "资产变更查询接口名称": "资产变更查询接口管理-3",
    "资产变更查询接口类型": "处理中"
  },
  {
    "ID": 4,
    ...
    "资产变更查询接口属性": "待处理",
    "修改资产变更查询接口状态": "待处理",
    "修改资产变更查询接口时间": "2026-05-08 11:16:09",
    "修改人": "待处理",
    "资产变更查询接口ID": "T-102348",
    "资产变更查询接口名称": "资产变更查询接口管理-4",
    "资产变更查询接口类型": "待处理"
  },
  {
    "ID": 5,
    ...
    "资产变更查询接口属性": "处理失败",
    "修改资产变更查询接口状态": "处理失败",
    "修改资产变更查询接口时间": "2026-05-08 14:03:52",
    "修改人": "处理失败",
    "资产变更查询接口ID": "T-110267",
    "资产变更查询接口名称": "资产变更查询接口管理-5",
    "资产变更查询接口类型": "处理失败"
  },
  {
    "ID": 6,
    ...
    "资产变更查询接口属性": "已暂停",
    "修改资产变更查询接口状态": "已暂停",
    "修改资产变更查询接口时间": "2026-05-08 15:21:37",
    "修改人": "已暂停",
    "资产变更查询接口ID": "T-118186",
    "资产变更查询接口名称": "资产变更查询接口管理-6",
    "资产变更查询接口类型": "已暂停"
  },
  {
    "ID": 7,
    ...
    "资产变更查询接口属性": "已完成",
    "修改资产变更查询接口状态": "已完成",
    "修改资产变更查询接口时间": "2026-05-08 16:08:25",
    "修改人": "已完成",
    "资产变更查询接口ID": "T-126105",
    "资产变更查询接口名称": "资产变更查询接口管理-7",
    "资产变更查询接口类型": "已完成"
  }
];
const tableColumns = [
