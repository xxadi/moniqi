    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集信息表", "transform")'>资产状态采集信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产状态采集任务", "form")'>新增资产状态采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产状态采集模型", "form")'>新增资产状态采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产状态采集模型", "config")'>修改资产状态采集模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产状态采集模型")'>删除资产状态采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集", "transform")'>资产状态采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集可视化展示", "detail")'>资产状态采集可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产状态采集名称": "待处理",
    "资产状态采集状态": "待处理",
    "资产状态采集时间": "2026-05-08 09:12:18",
    "资产状态采集属性": "待处理",
    "资产状态采集创建时间": "2026-05-08 09:12:18",
    "资产状态采集所属部门": "待处理",
    "资产状态采集负责人": "待处理",
    "资产状态采集类型": "待处理",
    "资产状态采集模型": "待处理",
  ...
  },
  {
    ...
    "资产状态采集名称": "处理失败",
    "资产状态采集状态": "处理失败",
    "资产状态采集时间": "2026-05-08 09:35:44",
    "资产状态采集属性": "处理失败",
    "资产状态采集创建时间": "2026-05-08 09:35:44",
    "资产状态采集所属部门": "处理失败",
    "资产状态采集负责人": "处理失败",
    "资产状态采集类型": "处理失败",
    "资产状态采集模型": "处理失败",
  ...
  },
  {
    ...
    "资产状态采集名称": "已暂停",
    "资产状态采集状态": "已暂停",
    "资产状态采集时间": "2026-05-08 10:08:06",
    "资产状态采集属性": "已暂停",
    "资产状态采集创建时间": "2026-05-08 10:08:06",
    "资产状态采集所属部门": "已暂停",
    "资产状态采集负责人": "已暂停",
    "资产状态采集类型": "已暂停",
    "资产状态采集模型": "已暂停",
  ...
  },
  {
    ...
    "资产状态采集名称": "已完成",
    "资产状态采集状态": "已完成",
    "资产状态采集时间": "2026-05-08 10:42:31",
    "资产状态采集属性": "已完成",
    "资产状态采集创建时间": "2026-05-08 10:42:31",
    "资产状态采集所属部门": "已完成",
    "资产状态采集负责人": "已完成",
    "资产状态采集类型": "已完成",
    "资产状态采集模型": "已完成",
  ...
  },
  {
    ...
    "资产状态采集名称": "排队中",
    "资产状态采集状态": "排队中",
    "资产状态采集时间": "2026-05-08 11:16:09",
    "资产状态采集属性": "排队中",
    "资产状态采集创建时间": "2026-05-08 11:16:09",
    "资产状态采集所属部门": "排队中",
    "资产状态采集负责人": "排队中",
    "资产状态采集类型": "排队中",
    "资产状态采集模型": "排队中",
  ...
  },
  {
    ...
    "资产状态采集名称": "部分完成",
    "资产状态采集状态": "部分完成",
    "资产状态采集时间": "2026-05-08 14:03:52",
    "资产状态采集属性": "部分完成",
    "资产状态采集创建时间": "2026-05-08 14:03:52",
    "资产状态采集所属部门": "部分完成",
    "资产状态采集负责人": "部分完成",
    "资产状态采集类型": "部分完成",
    "资产状态采集模型": "部分完成",
