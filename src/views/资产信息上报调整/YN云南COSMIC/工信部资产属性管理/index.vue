    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产属性设置信息", "config")'>修改工信部资产属性设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产属性设置信息")'>删除工信部资产属性设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产属性错误信息监控", "log")'>工信部资产属性错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产属性错误事件通知", "audit")'>工信部资产属性错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产属性错误事件通知删除", "operation")'>工信部资产属性错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产属性错误事件通知查询", "detail")'>工信部资产属性错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产属性防篡改信息", "form")'>新增工信部资产属性防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产属性防篡改信息", "config")'>修改工信部资产属性防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产属性防篡改信息")'>删除工信部资产属性防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产属性设置ID": "L-91453",
    "设置编号": "L-91453",
    "工信部资产属性设置名称": "工信部资产属性管理-1",
    "工信部资产属性设置状态": "已取消",
    "工信部资产属性设置时间": "2026-05-08 10:42:31",
    "工信部资产属性ID": "L-91453",
    "工信部资产属性编号": "L-91453",
    "工信部资产属性名称": "工信部资产属性管理-1",
    "工信部资产属性类型": "已取消",
    "工信部资产属性规则": "已取消",
    "工信部资产属性属性": "已取消",
    "工信部资产属性状态": "已取消"
  },
  {
    ...
    "资产属性设置ID": "L-99372",
    "设置编号": "L-99372",
    "工信部资产属性设置名称": "工信部资产属性管理-2",
    "工信部资产属性设置状态": "已驳回",
    "工信部资产属性设置时间": "2026-05-08 11:16:09",
    "工信部资产属性ID": "L-99372",
    "工信部资产属性编号": "L-99372",
    "工信部资产属性名称": "工信部资产属性管理-2",
    "工信部资产属性类型": "已驳回",
    "工信部资产属性规则": "已驳回",
    "工信部资产属性属性": "已驳回",
    "工信部资产属性状态": "已驳回"
  },
  {
    ...
    "资产属性设置ID": "L-107291",
    "设置编号": "L-107291",
    "工信部资产属性设置名称": "工信部资产属性管理-3",
    "工信部资产属性设置状态": "待审核",
    "工信部资产属性设置时间": "2026-05-08 14:03:52",
    "工信部资产属性ID": "L-107291",
    "工信部资产属性编号": "L-107291",
    "工信部资产属性名称": "工信部资产属性管理-3",
    "工信部资产属性类型": "待审核",
    "工信部资产属性规则": "待审核",
    "工信部资产属性属性": "待审核",
    "工信部资产属性状态": "待审核"
  },
  {
    ...
    "资产属性设置ID": "L-115210",
    "设置编号": "L-115210",
    "工信部资产属性设置名称": "工信部资产属性管理-4",
    "工信部资产属性设置状态": "已处理",
    "工信部资产属性设置时间": "2026-05-08 15:21:37",
    "工信部资产属性ID": "L-115210",
    "工信部资产属性编号": "L-115210",
    "工信部资产属性名称": "工信部资产属性管理-4",
    "工信部资产属性类型": "已处理",
    "工信部资产属性规则": "已处理",
    "工信部资产属性属性": "已处理",
    "工信部资产属性状态": "已处理"
  },
  {
    ...
    "资产属性设置ID": "L-123129",
    "设置编号": "L-123129",
    "工信部资产属性设置名称": "工信部资产属性管理-5",
    "工信部资产属性设置状态": "处理中",
    "工信部资产属性设置时间": "2026-05-08 16:08:25",
    "工信部资产属性ID": "L-123129",
    "工信部资产属性编号": "L-123129",
    "工信部资产属性名称": "工信部资产属性管理-5",
    "工信部资产属性类型": "处理中",
    "工信部资产属性规则": "处理中",
    "工信部资产属性属性": "处理中",
    "工信部资产属性状态": "处理中"
  },
  {
    ...
    "资产属性设置ID": "L-131048",
    "设置编号": "L-131048",
    "工信部资产属性设置名称": "工信部资产属性管理-6",
    "工信部资产属性设置状态": "待处理",
    "工信部资产属性设置时间": "2026-05-09 08:33:11",
    "工信部资产属性ID": "L-131048",
    "工信部资产属性编号": "L-131048",
    "工信部资产属性名称": "工信部资产属性管理-6",
    "工信部资产属性类型": "待处理",
    "工信部资产属性规则": "待处理",
    "工信部资产属性属性": "待处理",
    "工信部资产属性状态": "待处理"
  },
  {
    ...
    "资产属性设置ID": "L-138967",
    "设置编号": "L-138967",
    "工信部资产属性设置名称": "工信部资产属性管理-7",
    "工信部资产属性设置状态": "处理失败",
    "工信部资产属性设置时间": "2026-05-09 09:47:56",
    "工信部资产属性ID": "L-138967",
    "工信部资产属性编号": "L-138967",
    "工信部资产属性名称": "工信部资产属性管理-7",
    "工信部资产属性类型": "处理失败",
    "工信部资产属性规则": "处理失败",
    "工信部资产属性属性": "处理失败",
    "工信部资产属性状态": "处理失败"
  },
  {
    ...
    "资产属性设置ID": "L-146886",
    "设置编号": "L-146886",
    "工信部资产属性设置名称": "工信部资产属性管理-8",
    "工信部资产属性设置状态": "已暂停",
    "工信部资产属性设置时间": "2026-05-08 09:12:18",
    "工信部资产属性ID": "L-146886",
    "工信部资产属性编号": "L-146886",
    "工信部资产属性名称": "工信部资产属性管理-8",
    "工信部资产属性类型": "已暂停",
    "工信部资产属性规则": "已暂停",
    "工信部资产属性属性": "已暂停",
    "工信部资产属性状态": "已暂停"
  },
  {
    ...
    "资产属性设置ID": "L-154805",
    "设置编号": "L-154805",
    "工信部资产属性设置名称": "工信部资产属性管理-9",
    "工信部资产属性设置状态": "已完成",
    "工信部资产属性设置时间": "2026-05-08 09:35:44",
    "工信部资产属性ID": "L-154805",
    "工信部资产属性编号": "L-154805",
    "工信部资产属性名称": "工信部资产属性管理-9",
    "工信部资产属性类型": "已完成",
    "工信部资产属性规则": "已完成",
    "工信部资产属性属性": "已完成",
    "工信部资产属性状态": "已完成"
