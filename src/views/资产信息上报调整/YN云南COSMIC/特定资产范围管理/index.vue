    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增特定资产范围设置信息", "form")'>新增特定资产范围设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改特定资产范围设置信息", "config")'>修改特定资产范围设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除特定资产范围设置信息")'>删除特定资产范围设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("特定资产范围错误信息监控", "log")'>特定资产范围错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("特定资产范围错误事件通知", "audit")'>特定资产范围错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("特定资产范围错误事件通知删除", "operation")'>特定资产范围错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("特定资产范围错误事件通知查询", "detail")'>特定资产范围错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增特定资产范围防篡改信息", "form")'>新增特定资产范围防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改特定资产范围防篡改信息", "config")'>修改特定资产范围防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除特定资产范围防篡改信息")'>删除特定资产范围防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "特定资产范围名称": "特定资产范围管理-1",
    "新增特定资产范围状态": "正常",
    "新增特定资产范围时间": "2026-05-08 11:16:09",
    "新增特定资产范围设置时间_": "2026-05-08 11:16:09",
    "特定资产范围类型": "正常",
    "特定资产范围规则": "正常",
    "特定资产范围属性": "正常",
    "特定资产范围状态": "正常",
    "特定资产范围时间": "2026-05-08 11:16:09",
    "特定资产范围错误处理时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 2,
    "特定资产范围ID": "O-25353",
    ...
    "特定资产范围名称": "特定资产范围管理-2",
    "新增特定资产范围状态": "异常",
    "新增特定资产范围时间": "2026-05-08 14:03:52",
    "新增特定资产范围设置时间_": "2026-05-08 14:03:52",
    "特定资产范围类型": "异常",
    "特定资产范围规则": "异常",
    "特定资产范围属性": "异常",
    "特定资产范围状态": "异常",
    "特定资产范围时间": "2026-05-08 14:03:52",
    "特定资产范围错误处理时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 3,
    "特定资产范围ID": "O-33272",
    ...
    "特定资产范围名称": "特定资产范围管理-3",
    "新增特定资产范围状态": "超时",
    "新增特定资产范围时间": "2026-05-08 15:21:37",
    "新增特定资产范围设置时间_": "2026-05-08 15:21:37",
    "特定资产范围类型": "超时",
    "特定资产范围规则": "超时",
    "特定资产范围属性": "超时",
    "特定资产范围状态": "超时",
    "特定资产范围时间": "2026-05-08 15:21:37",
    "特定资产范围错误处理时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 4,
    "特定资产范围ID": "O-41191",
    ...
    "特定资产范围名称": "特定资产范围管理-4",
    "新增特定资产范围状态": "已取消",
    "新增特定资产范围时间": "2026-05-08 16:08:25",
    "新增特定资产范围设置时间_": "2026-05-08 16:08:25",
    "特定资产范围类型": "已取消",
    "特定资产范围规则": "已取消",
    "特定资产范围属性": "已取消",
    "特定资产范围状态": "已取消",
    "特定资产范围时间": "2026-05-08 16:08:25",
    "特定资产范围错误处理时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 5,
    "特定资产范围ID": "O-49110",
    ...
    "特定资产范围名称": "特定资产范围管理-5",
    "新增特定资产范围状态": "已驳回",
    "新增特定资产范围时间": "2026-05-09 08:33:11",
    "新增特定资产范围设置时间_": "2026-05-09 08:33:11",
    "特定资产范围类型": "已驳回",
    "特定资产范围规则": "已驳回",
    "特定资产范围属性": "已驳回",
    "特定资产范围状态": "已驳回",
    "特定资产范围时间": "2026-05-09 08:33:11",
    "特定资产范围错误处理时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 6,
    "特定资产范围ID": "O-57029",
    ...
    "特定资产范围名称": "特定资产范围管理-6",
    "新增特定资产范围状态": "待审核",
    "新增特定资产范围时间": "2026-05-09 09:47:56",
    "新增特定资产范围设置时间_": "2026-05-09 09:47:56",
    "特定资产范围类型": "待审核",
    "特定资产范围规则": "待审核",
    "特定资产范围属性": "待审核",
    "特定资产范围状态": "待审核",
    "特定资产范围时间": "2026-05-09 09:47:56",
    "特定资产范围错误处理时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 7,
    "特定资产范围ID": "O-64948",
    ...
    "特定资产范围名称": "特定资产范围管理-7",
    "新增特定资产范围状态": "已处理",
    "新增特定资产范围时间": "2026-05-08 09:12:18",
    "新增特定资产范围设置时间_": "2026-05-08 09:12:18",
    "特定资产范围类型": "已处理",
    "特定资产范围规则": "已处理",
    "特定资产范围属性": "已处理",
    "特定资产范围状态": "已处理",
    "特定资产范围时间": "2026-05-08 09:12:18",
    "特定资产范围错误处理时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 8,
    "特定资产范围ID": "O-72867",
    ...
    "特定资产范围名称": "特定资产范围管理-8",
    "新增特定资产范围状态": "处理中",
    "新增特定资产范围时间": "2026-05-08 09:35:44",
    "新增特定资产范围设置时间_": "2026-05-08 09:35:44",
    "特定资产范围类型": "处理中",
    "特定资产范围规则": "处理中",
    "特定资产范围属性": "处理中",
    "特定资产范围状态": "处理中",
    "特定资产范围时间": "2026-05-08 09:35:44",
    "特定资产范围错误处理时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 9,
    "特定资产范围ID": "O-80786",
    ...
    "特定资产范围名称": "特定资产范围管理-9",
    "新增特定资产范围状态": "待处理",
    "新增特定资产范围时间": "2026-05-08 10:08:06",
    "新增特定资产范围设置时间_": "2026-05-08 10:08:06",
    "特定资产范围类型": "待处理",
    "特定资产范围规则": "待处理",
    "特定资产范围属性": "待处理",
    "特定资产范围状态": "待处理",
    "特定资产范围时间": "2026-05-08 10:08:06",
    "特定资产范围错误处理时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 10,
    "特定资产范围ID": "O-88705",
    "特定资产范围编号": "O-88705",
    "特定资产范围名称": "特定资产范围管理-10",
    "新增特定资产范围状态": "处理失败",
    "新增特定资产范围时间": "2026-05-08 10:42:31",
    "新增特定资产范围设置时间_": "2026-05-08 10:42:31",
    "特定资产范围类型": "处理失败",
    "特定资产范围规则": "处理失败",
    "特定资产范围属性": "处理失败",
    "特定资产范围状态": "处理失败",
    "特定资产范围时间": "2026-05-08 10:42:31",
    "特定资产范围错误处理时间": "2026-05-08 10:42:31"
  }
];
const tableColumns = [
  {
