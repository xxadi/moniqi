    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令策略审批指派信息", "form")'>新增下发指令策略审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令策略审批流程", "form")'>新增下发指令策略审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令策略审批流程信息", "config")'>修改下发指令策略审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批流程删除", "operation")'>下发指令策略审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批流程查询", "detail")'>下发指令策略审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批附件上传", "form")'>下发指令策略审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批流程图查看", "preview")'>下发指令策略审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批流程通知", "audit")'>下发指令策略审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批结果逐级审批", "audit")'>下发指令策略审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令策略审批结果拒绝和驳回", "approval")'>下发指令策略审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "审批流程环节ID": "H-56089",
    "审批编号": "H-56089",
    "策略审批名称": "下发指令策略审批流程管理-1",
    "发起下发指令策略审批状态": "已停用",
    "发起下发指令策略审批时间": "2026-05-09 09:47:56",
    "下发指令策略审批ID": "H-56089",
    "下发指令策略审批用户": "李四",
    "下发指令策略审批编号": "H-56089",
    "下发指令策略审批名称": "下发指令策略审批流程管理-1",
    "新增下发指令策略审批状态": "已停用",
    "新增下发指令策略审批时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 2,
    "策略审批ID": "H-64008",
    "审批流程环节ID": "H-64008",
    "审批编号": "H-64008",
    "策略审批名称": "下发指令策略审批流程管理-2",
    "发起下发指令策略审批状态": "正常",
    "发起下发指令策略审批时间": "2026-05-08 09:12:18",
    "下发指令策略审批ID": "H-64008",
    "下发指令策略审批用户": "王五",
    "下发指令策略审批编号": "H-64008",
    "下发指令策略审批名称": "下发指令策略审批流程管理-2",
    "新增下发指令策略审批状态": "正常",
    "新增下发指令策略审批时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 3,
    "策略审批ID": "H-71927",
    "审批流程环节ID": "H-71927",
    "审批编号": "H-71927",
    "策略审批名称": "下发指令策略审批流程管理-3",
    "发起下发指令策略审批状态": "异常",
    "发起下发指令策略审批时间": "2026-05-08 09:35:44",
    "下发指令策略审批ID": "H-71927",
    "下发指令策略审批用户": "赵六",
    "下发指令策略审批编号": "H-71927",
    "下发指令策略审批名称": "下发指令策略审批流程管理-3",
    "新增下发指令策略审批状态": "异常",
    "新增下发指令策略审批时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 4,
    "策略审批ID": "H-79846",
    "审批流程环节ID": "H-79846",
    "审批编号": "H-79846",
    "策略审批名称": "下发指令策略审批流程管理-4",
    "发起下发指令策略审批状态": "超时",
    "发起下发指令策略审批时间": "2026-05-08 10:08:06",
    "下发指令策略审批ID": "H-79846",
    "下发指令策略审批用户": "system",
    "下发指令策略审批编号": "H-79846",
    "下发指令策略审批名称": "下发指令策略审批流程管理-4",
    "新增下发指令策略审批状态": "超时",
    "新增下发指令策略审批时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 5,
    "策略审批ID": "H-87765",
    "审批流程环节ID": "H-87765",
    "审批编号": "H-87765",
    "策略审批名称": "下发指令策略审批流程管理-5",
    "发起下发指令策略审批状态": "已取消",
    "发起下发指令策略审批时间": "2026-05-08 10:42:31",
    "下发指令策略审批ID": "H-87765",
    "下发指令策略审批用户": "admin",
    "下发指令策略审批编号": "H-87765",
    "下发指令策略审批名称": "下发指令策略审批流程管理-5",
    "新增下发指令策略审批状态": "已取消",
    "新增下发指令策略审批时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 6,
    "策略审批ID": "H-95684",
    "审批流程环节ID": "H-95684",
    "审批编号": "H-95684",
    "策略审批名称": "下发指令策略审批流程管理-6",
    "发起下发指令策略审批状态": "已驳回",
    "发起下发指令策略审批时间": "2026-05-08 11:16:09",
    "下发指令策略审批ID": "H-95684",
    "下发指令策略审批用户": "张三",
    "下发指令策略审批编号": "H-95684",
    "下发指令策略审批名称": "下发指令策略审批流程管理-6",
    "新增下发指令策略审批状态": "已驳回",
    "新增下发指令策略审批时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 7,
    "策略审批ID": "H-103603",
    "审批流程环节ID": "H-103603",
    "审批编号": "H-103603",
    "策略审批名称": "下发指令策略审批流程管理-7",
    "发起下发指令策略审批状态": "待审核",
    "发起下发指令策略审批时间": "2026-05-08 14:03:52",
    "下发指令策略审批ID": "H-103603",
    "下发指令策略审批用户": "李四",
    "下发指令策略审批编号": "H-103603",
    "下发指令策略审批名称": "下发指令策略审批流程管理-7",
    "新增下发指令策略审批状态": "待审核",
    "新增下发指令策略审批时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 8,
    "策略审批ID": "H-111522",
    "审批流程环节ID": "H-111522",
    "审批编号": "H-111522",
    "策略审批名称": "下发指令策略审批流程管理-8",
    "发起下发指令策略审批状态": "已处理",
    "发起下发指令策略审批时间": "2026-05-08 15:21:37",
    "下发指令策略审批ID": "H-111522",
    "下发指令策略审批用户": "王五",
    "下发指令策略审批编号": "H-111522",
    "下发指令策略审批名称": "下发指令策略审批流程管理-8",
    "新增下发指令策略审批状态": "已处理",
    "新增下发指令策略审批时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 9,
    "策略审批ID": "H-119441",
    "审批流程环节ID": "H-119441",
    "审批编号": "H-119441",
    "策略审批名称": "下发指令策略审批流程管理-9",
    "发起下发指令策略审批状态": "处理中",
    "发起下发指令策略审批时间": "2026-05-08 16:08:25",
    "下发指令策略审批ID": "H-119441",
    "下发指令策略审批用户": "赵六",
    "下发指令策略审批编号": "H-119441",
    "下发指令策略审批名称": "下发指令策略审批流程管理-9",
    "新增下发指令策略审批状态": "处理中",
    "新增下发指令策略审批时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 10,
    "策略审批ID": "H-127360",
    "审批流程环节ID": "H-127360",
    "审批编号": "H-127360",
    "策略审批名称": "下发指令策略审批流程管理-10",
    "发起下发指令策略审批状态": "待处理",
    "发起下发指令策略审批时间": "2026-05-09 08:33:11",
    "下发指令策略审批ID": "H-127360",
    "下发指令策略审批用户": "system",
    "下发指令策略审批编号": "H-127360",
    "下发指令策略审批名称": "下发指令策略审批流程管理-10",
    "新增下发指令策略审批状态": "待处理",
    "新增下发指令策略审批时间": "2026-05-09 08:33:11"
  }
];
const tableColumns = [
  {
