    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("Agent一键拨测信息表", "operation")'>Agent一键拨测信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增Agent一键拨测任务", "form")'>新增Agent一键拨测任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增Agent一键拨测模型", "form")'>新增Agent一键拨测模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改Agent一键拨测模型", "config")'>修改Agent一键拨测模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除Agent一键拨测模型")'>删除Agent一键拨测模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("Agent一键拨测查询", "detail")'>Agent一键拨测查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("Agent一键拨测可视化展示", "detail")'>Agent一键拨测可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "Agent一键拨测ID": "P-22843",
    "Agent一键拨测编号": "P-22843",
    "Agent一键拨测名称": "Agent一键拨测管理-1",
    "Agent一键拨测状态": "异常",
    "Agent一键拨测时间": "2026-05-08 10:42:31",
    "Agent一键拨测属性": "异常",
    "Agent一键拨测创建时间": "2026-05-08 10:42:31",
    "Agent一键拨测所属部门": "网络管理部",
    "Agent一键拨测负责人": "李四",
    "Agent一键拨测类型": "异常",
    "Agent一键拨测模型": "异常",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-30762",
    "Agent一键拨测编号": "P-30762",
    "Agent一键拨测名称": "Agent一键拨测管理-2",
    "Agent一键拨测状态": "超时",
    "Agent一键拨测时间": "2026-05-08 11:16:09",
    "Agent一键拨测属性": "超时",
    "Agent一键拨测创建时间": "2026-05-08 11:16:09",
    "Agent一键拨测所属部门": "资产管理部",
    "Agent一键拨测负责人": "王五",
    "Agent一键拨测类型": "超时",
    "Agent一键拨测模型": "超时",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-38681",
    "Agent一键拨测编号": "P-38681",
    "Agent一键拨测名称": "Agent一键拨测管理-3",
    "Agent一键拨测状态": "已取消",
    "Agent一键拨测时间": "2026-05-08 14:03:52",
    "Agent一键拨测属性": "已取消",
    "Agent一键拨测创建时间": "2026-05-08 14:03:52",
    "Agent一键拨测所属部门": "信息安全部",
    "Agent一键拨测负责人": "赵六",
    "Agent一键拨测类型": "已取消",
    "Agent一键拨测模型": "已取消",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-46600",
    "Agent一键拨测编号": "P-46600",
    "Agent一键拨测名称": "Agent一键拨测管理-4",
    "Agent一键拨测状态": "已驳回",
    "Agent一键拨测时间": "2026-05-08 15:21:37",
    "Agent一键拨测属性": "已驳回",
    "Agent一键拨测创建时间": "2026-05-08 15:21:37",
    "Agent一键拨测所属部门": "系统运维部",
    "Agent一键拨测负责人": "system",
    "Agent一键拨测类型": "已驳回",
    "Agent一键拨测模型": "已驳回",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-54519",
    "Agent一键拨测编号": "P-54519",
    "Agent一键拨测名称": "Agent一键拨测管理-5",
    "Agent一键拨测状态": "待审核",
    "Agent一键拨测时间": "2026-05-08 16:08:25",
    "Agent一键拨测属性": "待审核",
    "Agent一键拨测创建时间": "2026-05-08 16:08:25",
    "Agent一键拨测所属部门": "数据管理部",
    "Agent一键拨测负责人": "admin",
    "Agent一键拨测类型": "待审核",
    "Agent一键拨测模型": "待审核",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-62438",
    "Agent一键拨测编号": "P-62438",
    "Agent一键拨测名称": "Agent一键拨测管理-6",
    "Agent一键拨测状态": "已处理",
    "Agent一键拨测时间": "2026-05-09 08:33:11",
    "Agent一键拨测属性": "已处理",
    "Agent一键拨测创建时间": "2026-05-09 08:33:11",
    "Agent一键拨测所属部门": "安全运维部",
    "Agent一键拨测负责人": "张三",
    "Agent一键拨测类型": "已处理",
    "Agent一键拨测模型": "已处理",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-70357",
    "Agent一键拨测编号": "P-70357",
    "Agent一键拨测名称": "Agent一键拨测管理-7",
    "Agent一键拨测状态": "处理中",
    "Agent一键拨测时间": "2026-05-09 09:47:56",
    "Agent一键拨测属性": "处理中",
    "Agent一键拨测创建时间": "2026-05-09 09:47:56",
    "Agent一键拨测所属部门": "网络管理部",
    "Agent一键拨测负责人": "李四",
    "Agent一键拨测类型": "处理中",
    "Agent一键拨测模型": "处理中",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-78276",
    "Agent一键拨测编号": "P-78276",
    "Agent一键拨测名称": "Agent一键拨测管理-8",
    "Agent一键拨测状态": "待处理",
    "Agent一键拨测时间": "2026-05-08 09:12:18",
    "Agent一键拨测属性": "待处理",
    "Agent一键拨测创建时间": "2026-05-08 09:12:18",
    "Agent一键拨测所属部门": "资产管理部",
    "Agent一键拨测负责人": "王五",
    "Agent一键拨测类型": "待处理",
    "Agent一键拨测模型": "待处理",
  ...
  },
  {
    ...
    "Agent一键拨测ID": "P-86195",
    "Agent一键拨测编号": "P-86195",
    "Agent一键拨测名称": "Agent一键拨测管理-9",
    "Agent一键拨测状态": "处理失败",
    "Agent一键拨测时间": "2026-05-08 09:35:44",
    "Agent一键拨测属性": "处理失败",
    "Agent一键拨测创建时间": "2026-05-08 09:35:44",
    "Agent一键拨测所属部门": "信息安全部",
    "Agent一键拨测负责人": "赵六",
    "Agent一键拨测类型": "处理失败",
    "Agent一键拨测模型": "处理失败",
