    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A与工信部资产差异填报信息", "form")'>新增4A与工信部资产差异填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A与工信部资产差异填报信息", "config")'>修改4A与工信部资产差异填报信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A与工信部资产差异填报信息")'>删除4A与工信部资产差异填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A与工信部资产差异填报列表", "detail")'>查询4A与工信部资产差异填报列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A与工信部资产差异填报详情", "detail")'>查询4A与工信部资产差异填报详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入4A与工信部资产差异填报")'>批量导入4A与工信部资产差异填报</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("4A与工信部资产差异填报导出")'>4A与工信部资产差异填报导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "4A与工信部资产差异填报ID": "V-36577",
    "4A与工信部资产差异填报编号": "V-36577",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-1",
    "新增4A与工信部资产差异填报状态": "处理中",
    "新增4A与工信部资产差异填报时间": "2026-05-08 16:08:25",
    "4A与工信部资产差异填报属性": "处理中",
    "4A与工信部资产差异填报创建时间": "2026-05-08 16:08:25",
    "4A与工信部资产差异填报所属部门": "网络管理部",
    "4A与工信部资产差异填报负责人": "李四",
    "4A与工信部资产差异填报类型": "处理中",
    "4A与工信部资产差异填报规则": "处理中",
    "名称": "4A与工信部资产差异填报管理-1"
  ...
  {
    "ID": 2,
    "4A与工信部资产差异填报ID": "V-44496",
    "4A与工信部资产差异填报编号": "V-44496",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-2",
    "新增4A与工信部资产差异填报状态": "待处理",
    "新增4A与工信部资产差异填报时间": "2026-05-09 08:33:11",
    "4A与工信部资产差异填报属性": "待处理",
    "4A与工信部资产差异填报创建时间": "2026-05-09 08:33:11",
    "4A与工信部资产差异填报所属部门": "资产管理部",
    "4A与工信部资产差异填报负责人": "王五",
    "4A与工信部资产差异填报类型": "待处理",
    "4A与工信部资产差异填报规则": "待处理",
    "名称": "4A与工信部资产差异填报管理-2"
  ...
  {
    "ID": 3,
    "4A与工信部资产差异填报ID": "V-52415",
    "4A与工信部资产差异填报编号": "V-52415",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-3",
    "新增4A与工信部资产差异填报状态": "处理失败",
    "新增4A与工信部资产差异填报时间": "2026-05-09 09:47:56",
    "4A与工信部资产差异填报属性": "处理失败",
    "4A与工信部资产差异填报创建时间": "2026-05-09 09:47:56",
    "4A与工信部资产差异填报所属部门": "信息安全部",
    "4A与工信部资产差异填报负责人": "赵六",
    "4A与工信部资产差异填报类型": "处理失败",
    "4A与工信部资产差异填报规则": "处理失败",
    "名称": "4A与工信部资产差异填报管理-3"
  ...
  {
    "ID": 4,
    "4A与工信部资产差异填报ID": "V-60334",
    "4A与工信部资产差异填报编号": "V-60334",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-4",
    "新增4A与工信部资产差异填报状态": "已暂停",
    "新增4A与工信部资产差异填报时间": "2026-05-08 09:12:18",
    "4A与工信部资产差异填报属性": "已暂停",
    "4A与工信部资产差异填报创建时间": "2026-05-08 09:12:18",
    "4A与工信部资产差异填报所属部门": "系统运维部",
    "4A与工信部资产差异填报负责人": "system",
    "4A与工信部资产差异填报类型": "已暂停",
    "4A与工信部资产差异填报规则": "已暂停",
    "名称": "4A与工信部资产差异填报管理-4"
  },
  {
    "ID": 5,
    "4A与工信部资产差异填报ID": "V-68253",
    "4A与工信部资产差异填报编号": "V-68253",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-5",
    "新增4A与工信部资产差异填报状态": "已完成",
    "新增4A与工信部资产差异填报时间": "2026-05-08 09:35:44",
    "4A与工信部资产差异填报属性": "已完成",
    "4A与工信部资产差异填报创建时间": "2026-05-08 09:35:44",
    "4A与工信部资产差异填报所属部门": "数据管理部",
    "4A与工信部资产差异填报负责人": "admin",
    "4A与工信部资产差异填报类型": "已完成",
    "4A与工信部资产差异填报规则": "已完成",
    "名称": "4A与工信部资产差异填报管理-5"
  },
  {
    "ID": 6,
    "4A与工信部资产差异填报ID": "V-76172",
    "4A与工信部资产差异填报编号": "V-76172",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-6",
    "新增4A与工信部资产差异填报状态": "排队中",
    "新增4A与工信部资产差异填报时间": "2026-05-08 10:08:06",
    "4A与工信部资产差异填报属性": "排队中",
    "4A与工信部资产差异填报创建时间": "2026-05-08 10:08:06",
    "4A与工信部资产差异填报所属部门": "安全运维部",
    "4A与工信部资产差异填报负责人": "张三",
    "4A与工信部资产差异填报类型": "排队中",
    "4A与工信部资产差异填报规则": "排队中",
    "名称": "4A与工信部资产差异填报管理-6"
  ...
  {
    "ID": 7,
    "4A与工信部资产差异填报ID": "V-84091",
    "4A与工信部资产差异填报编号": "V-84091",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-7",
    "新增4A与工信部资产差异填报状态": "部分完成",
    "新增4A与工信部资产差异填报时间": "2026-05-08 10:42:31",
    "4A与工信部资产差异填报属性": "部分完成",
    "4A与工信部资产差异填报创建时间": "2026-05-08 10:42:31",
    "4A与工信部资产差异填报所属部门": "网络管理部",
    "4A与工信部资产差异填报负责人": "李四",
    "4A与工信部资产差异填报类型": "部分完成",
    "4A与工信部资产差异填报规则": "部分完成",
  ...
  {
    "ID": 8,
    "4A与工信部资产差异填报ID": "V-92010",
    "4A与工信部资产差异填报编号": "V-92010",
    "4A与工信部资产差异填报名称": "4A与工信部资产差异填报管理-8",
    "新增4A与工信部资产差异填报状态": "已启用",
    "新增4A与工信部资产差异填报时间": "2026-05-08 11:16:09",
    "4A与工信部资产差异填报属性": "已启用",
    "4A与工信部资产差异填报创建时间": "2026-05-08 11:16:09",
    "4A与工信部资产差异填报所属部门": "资产管理部",
    "4A与工信部资产差异填报负责人": "王五",
    "4A与工信部资产差异填报类型": "已启用",
    "4A与工信部资产差异填报规则": "已启用",
...
const tableColumns = [
  ...
  {
    "prop": "4A与工信部资产差异填报名称",
    "label": "4A与工信部资产差异填报名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增4A与工信部资产差异填报状态",
    "label": "新增4A与工信部资产差异填报状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增4A与工信部资产差异填报时间",
    "label": "新增4A与工信部资产差异填报时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "4A与工信部资产差异填报属性",
    "label": "4A与工信部资产差异填报属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "4A与工信部资产差异填报创建时间",
    "label": "4A与工信部资产差异填报创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "4A与工信部资产差异填报所属部门",
    "label": "4A与工信部资产差异填报所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "4A与工信部资产差异填报负责人",
    "label": "4A与工信部资产差异填报负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
