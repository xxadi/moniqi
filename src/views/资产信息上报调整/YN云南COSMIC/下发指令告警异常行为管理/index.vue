    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令告警异常行为设置信息", "form")'>新增下发指令告警异常行为设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令告警异常行为设置信息", "config")'>修改下发指令告警异常行为设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令告警异常行为设置信息")'>删除下发指令告警异常行为设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("下发指令告警异常行为错误信息监控", "log")'>下发指令告警异常行为错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令告警异常行为错误事件通知", "audit")'>下发指令告警异常行为错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令告警异常行为错误事件通知删除", "operation")'>下发指令告警异常行为错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令告警异常行为错误事件通知查询", "detail")'>下发指令告警异常行为错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令告警异常行为防篡改信息", "form")'>新增下发指令告警异常行为防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令告警异常行为防篡改信息", "config")'>修改下发指令告警异常行为防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令告警异常行为防篡改信息")'>删除下发指令告警异常行为防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "下发指令告警异常行为ID": "Q-2408",
    "下发指令告警异常行为编号": "Q-2408",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-1",
    "新增下发指令告警异常行为状态": "已启用",
    "新增下发指令告警异常行为时间": "2026-05-09 08:33:11",
    "新增下发指令告警异常行为设置时间_": "2026-05-09 08:33:11",
    "下发指令告警异常行为属性": "已启用",
    "告警时间": "2026-05-09 08:33:11",
    "告警用户": "王五",
    "告警系统": "已启用",
    "资产ip": "已启用",
    "下发指令告警异常行为创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 2,
    "下发指令告警异常行为ID": "Q-10327",
    "下发指令告警异常行为编号": "Q-10327",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-2",
    "新增下发指令告警异常行为状态": "已停用",
    "新增下发指令告警异常行为时间": "2026-05-09 09:47:56",
    "新增下发指令告警异常行为设置时间_": "2026-05-09 09:47:56",
    "下发指令告警异常行为属性": "已停用",
    "告警时间": "2026-05-09 09:47:56",
    "告警用户": "赵六",
    "告警系统": "已停用",
    "资产ip": "已停用",
    "下发指令告警异常行为创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 3,
    "下发指令告警异常行为ID": "Q-18246",
    "下发指令告警异常行为编号": "Q-18246",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-3",
    "新增下发指令告警异常行为状态": "正常",
    "新增下发指令告警异常行为时间": "2026-05-08 09:12:18",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 09:12:18",
    "下发指令告警异常行为属性": "正常",
    "告警时间": "2026-05-08 09:12:18",
    "告警用户": "system",
    "告警系统": "正常",
    "资产ip": "正常",
    "下发指令告警异常行为创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 4,
    "下发指令告警异常行为ID": "Q-26165",
    "下发指令告警异常行为编号": "Q-26165",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-4",
    "新增下发指令告警异常行为状态": "异常",
    "新增下发指令告警异常行为时间": "2026-05-08 09:35:44",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 09:35:44",
    "下发指令告警异常行为属性": "异常",
    "告警时间": "2026-05-08 09:35:44",
    "告警用户": "admin",
    "告警系统": "异常",
    "资产ip": "异常",
    "下发指令告警异常行为创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 5,
    "下发指令告警异常行为ID": "Q-34084",
    "下发指令告警异常行为编号": "Q-34084",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-5",
    "新增下发指令告警异常行为状态": "超时",
    "新增下发指令告警异常行为时间": "2026-05-08 10:08:06",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 10:08:06",
    "下发指令告警异常行为属性": "超时",
    "告警时间": "2026-05-08 10:08:06",
    "告警用户": "张三",
    "告警系统": "超时",
    "资产ip": "超时",
    "下发指令告警异常行为创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 6,
    "下发指令告警异常行为ID": "Q-42003",
    "下发指令告警异常行为编号": "Q-42003",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-6",
    "新增下发指令告警异常行为状态": "已取消",
    "新增下发指令告警异常行为时间": "2026-05-08 10:42:31",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 10:42:31",
    "下发指令告警异常行为属性": "已取消",
    "告警时间": "2026-05-08 10:42:31",
    "告警用户": "李四",
    "告警系统": "已取消",
    "资产ip": "已取消",
    "下发指令告警异常行为创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 7,
    "下发指令告警异常行为ID": "Q-49922",
    "下发指令告警异常行为编号": "Q-49922",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-7",
    "新增下发指令告警异常行为状态": "已驳回",
    "新增下发指令告警异常行为时间": "2026-05-08 11:16:09",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 11:16:09",
    "下发指令告警异常行为属性": "已驳回",
    "告警时间": "2026-05-08 11:16:09",
    "告警用户": "王五",
    "告警系统": "已驳回",
    "资产ip": "已驳回",
    "下发指令告警异常行为创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 8,
    "下发指令告警异常行为ID": "Q-57841",
    "下发指令告警异常行为编号": "Q-57841",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-8",
    "新增下发指令告警异常行为状态": "待审核",
    "新增下发指令告警异常行为时间": "2026-05-08 14:03:52",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 14:03:52",
    "下发指令告警异常行为属性": "待审核",
    "告警时间": "2026-05-08 14:03:52",
    "告警用户": "赵六",
    "告警系统": "待审核",
    "资产ip": "待审核",
    "下发指令告警异常行为创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 9,
    "下发指令告警异常行为ID": "Q-65760",
    "下发指令告警异常行为编号": "Q-65760",
    "下发指令告警异常行为名称": "下发指令告警异常行为管理-9",
    "新增下发指令告警异常行为状态": "已处理",
    "新增下发指令告警异常行为时间": "2026-05-08 15:21:37",
    "新增下发指令告警异常行为设置时间_": "2026-05-08 15:21:37",
    "下发指令告警异常行为属性": "已处理",
    "告警时间": "2026-05-08 15:21:37",
    "告警用户": "system",
    "告警系统": "已处理",
    "资产ip": "已处理",
    "下发指令告警异常行为创建时间": "2026-05-08 15:21:37"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "新增下发指令告警异常行为设置时间_",
    "label": "新增下发指令告警异常行为设置时间。",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
