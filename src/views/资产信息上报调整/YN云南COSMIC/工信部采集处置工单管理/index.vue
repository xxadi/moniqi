    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部采集处置工单信息", "form")'>新增工信部采集处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集处置工单信息", "config")'>修改工信部采集处置工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集处置工单信息")'>删除工信部采集处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看工信部采集处置工单信息", "detail")'>查看工信部采集处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集处置工单附件文件上传", "form")'>工信部采集处置工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集处置工单附件文件删除", "operation")'>工信部采集处置工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部采集处置工单信息审批", "transform")'>工信部采集处置工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集处置工单信息撤回", "transform")'>工信部采集处置工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集处置工单信息终止", "transform")'>工信部采集处置工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部采集处置工单信息派发提醒", "transform")'>工信部采集处置工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部采集处置ID": "W-67050",
    "工信部采集处置编号": "W-67050",
    "工信部采集处置名称": "工信部采集处置工单管理-1",
    "新增工信部采集处置状态": "正常",
    "新增工信部采集处置时间": "2026-05-08 09:12:18",
    "工信部采集处置属性": "正常",
    "工信部采集处置创建时间": "2026-05-08 09:12:18",
    "工信部采集处置所属部门": "安全运维部",
    "工信部采集处置负责人": "张三",
    "工信部采集处置类型": "正常",
    "工信部采集处置规则": "正常",
  ...
  },
  {
    ...
    "工信部采集处置ID": "W-74969",
    "工信部采集处置编号": "W-74969",
    "工信部采集处置名称": "工信部采集处置工单管理-2",
    "新增工信部采集处置状态": "异常",
    "新增工信部采集处置时间": "2026-05-08 09:35:44",
    "工信部采集处置属性": "异常",
    "工信部采集处置创建时间": "2026-05-08 09:35:44",
    "工信部采集处置所属部门": "网络管理部",
    "工信部采集处置负责人": "李四",
    "工信部采集处置类型": "异常",
    "工信部采集处置规则": "异常",
  ...
  },
  {
    ...
    "工信部采集处置ID": "W-82888",
    "工信部采集处置编号": "W-82888",
    "工信部采集处置名称": "工信部采集处置工单管理-3",
    "新增工信部采集处置状态": "超时",
    "新增工信部采集处置时间": "2026-05-08 10:08:06",
    "工信部采集处置属性": "超时",
    "工信部采集处置创建时间": "2026-05-08 10:08:06",
    "工信部采集处置所属部门": "资产管理部",
    "工信部采集处置负责人": "王五",
    "工信部采集处置类型": "超时",
    "工信部采集处置规则": "超时",
  ...
  },
  {
    ...
    "工信部采集处置ID": "W-90807",
    "工信部采集处置编号": "W-90807",
    "工信部采集处置名称": "工信部采集处置工单管理-4",
    "新增工信部采集处置状态": "已取消",
    "新增工信部采集处置时间": "2026-05-08 10:42:31",
    "工信部采集处置属性": "已取消",
    "工信部采集处置创建时间": "2026-05-08 10:42:31",
    "工信部采集处置所属部门": "信息安全部",
    "工信部采集处置负责人": "赵六",
    "工信部采集处置类型": "已取消",
    "工信部采集处置规则": "已取消",
  ...
  },
  {
    ...
    "工信部采集处置ID": "W-98726",
    "工信部采集处置编号": "W-98726",
    "工信部采集处置名称": "工信部采集处置工单管理-5",
    "新增工信部采集处置状态": "已驳回",
    "新增工信部采集处置时间": "2026-05-08 11:16:09",
    "工信部采集处置属性": "已驳回",
    "工信部采集处置创建时间": "2026-05-08 11:16:09",
    "工信部采集处置所属部门": "系统运维部",
    "工信部采集处置负责人": "system",
    "工信部采集处置类型": "已驳回",
    "工信部采集处置规则": "已驳回",
  ...
  },
  {
    ...
    "工信部采集处置ID": "W-106645",
    "工信部采集处置编号": "W-106645",
    "工信部采集处置名称": "工信部采集处置工单管理-6",
    "新增工信部采集处置状态": "待审核",
    "新增工信部采集处置时间": "2026-05-08 14:03:52",
    "工信部采集处置属性": "待审核",
    "工信部采集处置创建时间": "2026-05-08 14:03:52",
    "工信部采集处置所属部门": "数据管理部",
    "工信部采集处置负责人": "admin",
    "工信部采集处置类型": "待审核",
    "工信部采集处置规则": "待审核",
