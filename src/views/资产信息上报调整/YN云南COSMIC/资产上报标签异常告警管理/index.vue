    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产上报标签异常告警", "alert")'>资产上报标签异常告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报标签异常告警信息", "config")'>修改资产上报标签异常告警信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报标签异常告警信息")'>删除资产上报标签异常告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报标签异常告警汇总表", "detail")'>查询资产上报标签异常告警汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报标签异常告警详情", "detail")'>查询资产上报标签异常告警详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报标签异常告警")'>批量导入资产上报标签异常告警</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='exportRows("资产上报标签异常告警导出")'>资产上报标签异常告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "编号": "G-52812",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-1",
    "资产上报标签监控告警时间": "2026-05-08 10:08:06",
    "资产上报标签监控告警内容": "超时",
    "资产上报标签监控告警状态": "超时",
    "监控告警名称": "资产上报标签异常告警管理-1",
    "监控告警编号": "G-52812",
    "资产上报标签异常告警编号": "G-52812",
    "名称": "资产上报标签异常告警管理-1",
    "类型": "超时",
    "资产上报标签异常告警规则": "超时",
    "资产上报标签异常告警属性": "超时"
  },
  {
    "ID": 2,
    "编号": "G-60731",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-2",
    "资产上报标签监控告警时间": "2026-05-08 10:42:31",
    "资产上报标签监控告警内容": "已取消",
    "资产上报标签监控告警状态": "已取消",
    "监控告警名称": "资产上报标签异常告警管理-2",
    "监控告警编号": "G-60731",
    "资产上报标签异常告警编号": "G-60731",
    "名称": "资产上报标签异常告警管理-2",
    "类型": "已取消",
    "资产上报标签异常告警规则": "已取消",
    "资产上报标签异常告警属性": "已取消"
  },
  {
    "ID": 3,
    "编号": "G-68650",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-3",
    "资产上报标签监控告警时间": "2026-05-08 11:16:09",
    "资产上报标签监控告警内容": "已驳回",
    "资产上报标签监控告警状态": "已驳回",
    "监控告警名称": "资产上报标签异常告警管理-3",
    "监控告警编号": "G-68650",
    "资产上报标签异常告警编号": "G-68650",
    "名称": "资产上报标签异常告警管理-3",
    "类型": "已驳回",
    "资产上报标签异常告警规则": "已驳回",
    "资产上报标签异常告警属性": "已驳回"
  },
  {
    "ID": 4,
    "编号": "G-76569",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-4",
    "资产上报标签监控告警时间": "2026-05-08 14:03:52",
    "资产上报标签监控告警内容": "待审核",
    "资产上报标签监控告警状态": "待审核",
    "监控告警名称": "资产上报标签异常告警管理-4",
    "监控告警编号": "G-76569",
    "资产上报标签异常告警编号": "G-76569",
    "名称": "资产上报标签异常告警管理-4",
    "类型": "待审核",
    "资产上报标签异常告警规则": "待审核",
    "资产上报标签异常告警属性": "待审核"
  },
  {
    "ID": 5,
    "编号": "G-84488",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-5",
    "资产上报标签监控告警时间": "2026-05-08 15:21:37",
    "资产上报标签监控告警内容": "已处理",
    "资产上报标签监控告警状态": "已处理",
    "监控告警名称": "资产上报标签异常告警管理-5",
    "监控告警编号": "G-84488",
    "资产上报标签异常告警编号": "G-84488",
    "名称": "资产上报标签异常告警管理-5",
    "类型": "已处理",
    "资产上报标签异常告警规则": "已处理",
    "资产上报标签异常告警属性": "已处理"
  },
  {
    "ID": 6,
    "编号": "G-92407",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-6",
    "资产上报标签监控告警时间": "2026-05-08 16:08:25",
    "资产上报标签监控告警内容": "处理中",
    "资产上报标签监控告警状态": "处理中",
    "监控告警名称": "资产上报标签异常告警管理-6",
    "监控告警编号": "G-92407",
    "资产上报标签异常告警编号": "G-92407",
    "名称": "资产上报标签异常告警管理-6",
    "类型": "处理中",
    "资产上报标签异常告警规则": "处理中",
    "资产上报标签异常告警属性": "处理中"
  },
  {
    "ID": 7,
    "编号": "G-100326",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-7",
    "资产上报标签监控告警时间": "2026-05-09 08:33:11",
    "资产上报标签监控告警内容": "待处理",
    "资产上报标签监控告警状态": "待处理",
    "监控告警名称": "资产上报标签异常告警管理-7",
    "监控告警编号": "G-100326",
    "资产上报标签异常告警编号": "G-100326",
    "名称": "资产上报标签异常告警管理-7",
    "类型": "待处理",
    "资产上报标签异常告警规则": "待处理",
    "资产上报标签异常告警属性": "待处理"
  },
  {
    "ID": 8,
    "编号": "G-108245",
    "资产上报标签监控告警名称": "资产上报标签异常告警管理-8",
    "资产上报标签监控告警时间": "2026-05-09 09:47:56",
    "资产上报标签监控告警内容": "处理失败",
    "资产上报标签监控告警状态": "处理失败",
    "监控告警名称": "资产上报标签异常告警管理-8",
    "监控告警编号": "G-108245",
    "资产上报标签异常告警编号": "G-108245",
    "名称": "资产上报标签异常告警管理-8",
    "类型": "处理失败",
    "资产上报标签异常告警规则": "处理失败",
    "资产上报标签异常告警属性": "处理失败"
