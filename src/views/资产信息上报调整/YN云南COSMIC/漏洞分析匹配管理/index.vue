    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集任务漏洞分析匹配威胁情报", "analysis")'>登录采集任务漏洞分析匹配威胁情报</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集任务漏洞分析匹配通报漏洞", "analysis")'>登录采集任务漏洞分析匹配通报漏洞</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描采集任务漏洞分析匹配威胁情报", "analysis")'>远程扫描采集任务漏洞分析匹配威胁情报</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描采集任务漏洞分析匹配通报漏洞", "analysis")'>远程扫描采集任务漏洞分析匹配通报漏洞</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("漏洞情报配置添加", "operation")'>漏洞情报配置添加</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("漏洞情报配置修改", "operation")'>漏洞情报配置修改</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("漏洞情报配置删除", "operation")'>漏洞情报配置删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("漏洞情报配置查询", "detail")'>漏洞情报配置查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("漏洞情报配置导出")'>漏洞情报配置导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("漏洞情报配置结果展示", "detail")'>漏洞情报配置结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增漏洞匹配分析工单信息", "form")'>新增漏洞匹配分析工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改漏洞匹配分析工单信息", "config")'>修改漏洞匹配分析工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除漏洞匹配分析工单信息")'>删除漏洞匹配分析工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看漏洞匹配分析工单信息", "detail")'>查看漏洞匹配分析工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("漏洞匹配分析工单附件文件上传", "analysis")'>漏洞匹配分析工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("漏洞匹配分析工单附件文件删除", "analysis")'>漏洞匹配分析工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("漏洞匹配分析工单信息审批", "analysis")'>漏洞匹配分析工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("漏洞匹配分析工单信息撤回", "analysis")'>漏洞匹配分析工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("漏洞匹配分析工单信息终止", "analysis")'>漏洞匹配分析工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("漏洞匹配分析工单信息派发提醒", "analysis")'>漏洞匹配分析工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "分析匹配威胁情报编号": "S-70738",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-1",
    "登录采集任务漏洞分析匹配威胁情报类型": "待处理",
    "登录采集任务漏洞分析匹配威胁情报规则": "待处理",
    "登录采集任务漏洞分析匹配威胁情报属性": "待处理",
    "登录采集任务漏洞分析匹配威胁情报状态": "待处理",
    "威胁情报编号": "S-70738",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-70738",
    "匹配威胁情报编号": "S-70738",
    "操作人": "system",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-09 08:33:11",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "待处理"
  },
  {
    "ID": 2,
    "分析匹配威胁情报编号": "S-78657",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-2",
    "登录采集任务漏洞分析匹配威胁情报类型": "处理失败",
    "登录采集任务漏洞分析匹配威胁情报规则": "处理失败",
    "登录采集任务漏洞分析匹配威胁情报属性": "处理失败",
    "登录采集任务漏洞分析匹配威胁情报状态": "处理失败",
    "威胁情报编号": "S-78657",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-78657",
    "匹配威胁情报编号": "S-78657",
    "操作人": "admin",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-09 09:47:56",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "处理失败"
  },
  {
    "ID": 3,
    "分析匹配威胁情报编号": "S-86576",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-3",
    "登录采集任务漏洞分析匹配威胁情报类型": "已暂停",
    "登录采集任务漏洞分析匹配威胁情报规则": "已暂停",
    "登录采集任务漏洞分析匹配威胁情报属性": "已暂停",
    "登录采集任务漏洞分析匹配威胁情报状态": "已暂停",
    "威胁情报编号": "S-86576",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-86576",
    "匹配威胁情报编号": "S-86576",
    "操作人": "张三",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 09:12:18",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "已暂停"
  },
  {
    "ID": 4,
    "分析匹配威胁情报编号": "S-94495",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-4",
    "登录采集任务漏洞分析匹配威胁情报类型": "已完成",
    "登录采集任务漏洞分析匹配威胁情报规则": "已完成",
    "登录采集任务漏洞分析匹配威胁情报属性": "已完成",
    "登录采集任务漏洞分析匹配威胁情报状态": "已完成",
    "威胁情报编号": "S-94495",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-94495",
    "匹配威胁情报编号": "S-94495",
    "操作人": "李四",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 09:35:44",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "已完成"
  },
  {
    "ID": 5,
    "分析匹配威胁情报编号": "S-102414",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-5",
    "登录采集任务漏洞分析匹配威胁情报类型": "排队中",
    "登录采集任务漏洞分析匹配威胁情报规则": "排队中",
    "登录采集任务漏洞分析匹配威胁情报属性": "排队中",
    "登录采集任务漏洞分析匹配威胁情报状态": "排队中",
    "威胁情报编号": "S-102414",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-102414",
    "匹配威胁情报编号": "S-102414",
    "操作人": "王五",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 10:08:06",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "排队中"
  },
  {
    "ID": 6,
    "分析匹配威胁情报编号": "S-110333",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-6",
    "登录采集任务漏洞分析匹配威胁情报类型": "部分完成",
    "登录采集任务漏洞分析匹配威胁情报规则": "部分完成",
    "登录采集任务漏洞分析匹配威胁情报属性": "部分完成",
    "登录采集任务漏洞分析匹配威胁情报状态": "部分完成",
    "威胁情报编号": "S-110333",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-110333",
    "匹配威胁情报编号": "S-110333",
    "操作人": "赵六",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 10:42:31",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "部分完成"
  },
  {
    "ID": 7,
    "分析匹配威胁情报编号": "S-118252",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-7",
    "登录采集任务漏洞分析匹配威胁情报类型": "已启用",
    "登录采集任务漏洞分析匹配威胁情报规则": "已启用",
    "登录采集任务漏洞分析匹配威胁情报属性": "已启用",
    "登录采集任务漏洞分析匹配威胁情报状态": "已启用",
    "威胁情报编号": "S-118252",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-118252",
    "匹配威胁情报编号": "S-118252",
    "操作人": "system",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 11:16:09",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "已启用"
  },
  {
    "ID": 8,
    "分析匹配威胁情报编号": "S-126171",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-8",
    "登录采集任务漏洞分析匹配威胁情报类型": "已停用",
    "登录采集任务漏洞分析匹配威胁情报规则": "已停用",
    "登录采集任务漏洞分析匹配威胁情报属性": "已停用",
    "登录采集任务漏洞分析匹配威胁情报状态": "已停用",
    "威胁情报编号": "S-126171",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-126171",
    "匹配威胁情报编号": "S-126171",
    "操作人": "admin",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 14:03:52",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "已停用"
  },
  {
    "ID": 9,
    "分析匹配威胁情报编号": "S-134090",
    "登录采集任务漏洞分析匹配威胁情报名称": "漏洞分析匹配管理-9",
    "登录采集任务漏洞分析匹配威胁情报类型": "正常",
    "登录采集任务漏洞分析匹配威胁情报规则": "正常",
    "登录采集任务漏洞分析匹配威胁情报属性": "正常",
    "登录采集任务漏洞分析匹配威胁情报状态": "正常",
    "威胁情报编号": "S-134090",
    "登录采集任务漏洞分析匹配威胁情报编号": "S-134090",
    "匹配威胁情报编号": "S-134090",
    "操作人": "张三",
    "登录采集任务漏洞分析匹配威胁情报操作时间": "2026-05-08 15:21:37",
    "登录采集任务漏洞分析匹配威胁情报操作状态": "正常"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报名称",
    "label": "登录采集任务漏洞分析匹配威胁情报名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报类型",
    "label": "登录采集任务漏洞分析匹配威胁情报类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报规则",
    "label": "登录采集任务漏洞分析匹配威胁情报规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报属性",
    "label": "登录采集任务漏洞分析匹配威胁情报属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报状态",
    "label": "登录采集任务漏洞分析匹配威胁情报状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报编号",
    "label": "登录采集任务漏洞分析匹配威胁情报编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报操作时间",
    "label": "登录采集任务漏洞分析匹配威胁情报操作时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "登录采集任务漏洞分析匹配威胁情报操作状态",
    "label": "登录采集任务漏洞分析匹配威胁情报操作状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
...
const defaultRow = {
  ...
  "匹配威胁情报编号": "",
  "操作人": "",
  "登录采集任务漏洞分析匹配威胁情报操作时间": "",
  "登录采集任务漏洞分析匹配威胁情报操作状态": ""
};
