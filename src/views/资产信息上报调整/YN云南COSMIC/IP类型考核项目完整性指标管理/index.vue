    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP类型考核项目完整性信息表", "operation")'>IP类型考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核项目完整性字典信息", "form")'>新增IP类型数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核项目完整性模拟稽核信息", "form")'>新增IP类型数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP类型数据考核项目完整性模拟稽核信息", "config")'>修改IP类型数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP类型数据考核项目完整性模拟稽核信息")'>删除IP类型数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP类型考核项目完整性稽核数据上传", "form")'>IP类型考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP类型考核项目完整性稽核数据接口监控", "log")'>IP类型考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("其他IP考核项目完整性信息表", "operation")'>其他IP考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增其他IP数据考核项目完整性模拟稽核信息", "form")'>新增其他IP数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改其他IP数据考核项目完整性模拟稽核信息", "config")'>修改其他IP数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除其他IP数据考核项目完整性模拟稽核信息")'>删除其他IP数据考核项目完整性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("其他IP考核项目完整性稽核数据上传", "form")'>其他IP考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("其他IP考核项目完整性稽核数据接口监控", "log")'>其他IP考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "IP类型考核项目完整性ID": "Z-63907",
    "IP类型考核项目完整性编号": "Z-63907",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-1",
    "IP类型考核项目完整性状态": "处理失败",
    "IP类型考核项目完整性时间": "2026-05-08 16:08:25",
    "IP类型考核项目完整性属性": "172.16.0.50",
    "IP类型考核项目完整性创建时间": "2026-05-08 16:08:25",
    "IP类型考核项目完整性所属部门": "网络管理部",
    "IP类型考核项目完整性负责人": "李四",
    "IP类型考核项目完整性类型": "172.16.0.50",
    "IP类型考核项目完整性规则": "172.16.0.50",
    "完整性字典ID": "Z-63907"
  },
  {
    "ID": 2,
    "IP类型考核项目完整性ID": "Z-71826",
    "IP类型考核项目完整性编号": "Z-71826",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-2",
    "IP类型考核项目完整性状态": "已暂停",
    "IP类型考核项目完整性时间": "2026-05-09 08:33:11",
    "IP类型考核项目完整性属性": "192.168.1.200",
    "IP类型考核项目完整性创建时间": "2026-05-09 08:33:11",
    "IP类型考核项目完整性所属部门": "资产管理部",
    "IP类型考核项目完整性负责人": "王五",
    "IP类型考核项目完整性类型": "192.168.1.200",
    "IP类型考核项目完整性规则": "192.168.1.200",
    "完整性字典ID": "Z-71826"
  },
  {
    "ID": 3,
    "IP类型考核项目完整性ID": "Z-79745",
    "IP类型考核项目完整性编号": "Z-79745",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-3",
    "IP类型考核项目完整性状态": "已完成",
    "IP类型考核项目完整性时间": "2026-05-09 09:47:56",
    "IP类型考核项目完整性属性": "10.20.5.30",
    "IP类型考核项目完整性创建时间": "2026-05-09 09:47:56",
    "IP类型考核项目完整性所属部门": "信息安全部",
    "IP类型考核项目完整性负责人": "赵六",
    "IP类型考核项目完整性类型": "10.20.5.30",
    "IP类型考核项目完整性规则": "10.20.5.30",
    "完整性字典ID": "Z-79745"
  },
  {
    "ID": 4,
    "IP类型考核项目完整性ID": "Z-87664",
    "IP类型考核项目完整性编号": "Z-87664",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-4",
    "IP类型考核项目完整性状态": "排队中",
    "IP类型考核项目完整性时间": "2026-05-08 09:12:18",
    "IP类型考核项目完整性属性": "172.20.1.80",
    "IP类型考核项目完整性创建时间": "2026-05-08 09:12:18",
    "IP类型考核项目完整性所属部门": "系统运维部",
    "IP类型考核项目完整性负责人": "system",
    "IP类型考核项目完整性类型": "172.20.1.80",
    "IP类型考核项目完整性规则": "172.20.1.80",
    "完整性字典ID": "Z-87664"
  },
  {
    "ID": 5,
    "IP类型考核项目完整性ID": "Z-95583",
    "IP类型考核项目完整性编号": "Z-95583",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-5",
    "IP类型考核项目完整性状态": "部分完成",
    "IP类型考核项目完整性时间": "2026-05-08 09:35:44",
    "IP类型考核项目完整性属性": "10.0.0.254",
    "IP类型考核项目完整性创建时间": "2026-05-08 09:35:44",
    "IP类型考核项目完整性所属部门": "数据管理部",
    "IP类型考核项目完整性负责人": "admin",
    "IP类型考核项目完整性类型": "10.0.0.254",
    "IP类型考核项目完整性规则": "10.0.0.254",
    "完整性字典ID": "Z-95583"
  },
  {
    "ID": 6,
    "IP类型考核项目完整性ID": "Z-103502",
    "IP类型考核项目完整性编号": "Z-103502",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-6",
    "IP类型考核项目完整性状态": "已启用",
    "IP类型考核项目完整性时间": "2026-05-08 10:08:06",
    "IP类型考核项目完整性属性": "10.10.1.100",
    "IP类型考核项目完整性创建时间": "2026-05-08 10:08:06",
    "IP类型考核项目完整性所属部门": "安全运维部",
    "IP类型考核项目完整性负责人": "张三",
    "IP类型考核项目完整性类型": "10.10.1.100",
    "IP类型考核项目完整性规则": "10.10.1.100",
    "完整性字典ID": "Z-103502"
  },
  {
    "ID": 7,
    "IP类型考核项目完整性ID": "Z-111421",
    "IP类型考核项目完整性编号": "Z-111421",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-7",
    "IP类型考核项目完整性状态": "已停用",
    "IP类型考核项目完整性时间": "2026-05-08 10:42:31",
    "IP类型考核项目完整性属性": "172.16.0.50",
    "IP类型考核项目完整性创建时间": "2026-05-08 10:42:31",
    "IP类型考核项目完整性所属部门": "网络管理部",
    "IP类型考核项目完整性负责人": "李四",
    "IP类型考核项目完整性类型": "172.16.0.50",
    "IP类型考核项目完整性规则": "172.16.0.50",
  ...
  {
    "ID": 8,
    "IP类型考核项目完整性ID": "Z-119340",
    "IP类型考核项目完整性编号": "Z-119340",
    "IP类型考核项目完整性名称": "IP类型考核项目完整性指标管理-8",
    "IP类型考核项目完整性状态": "正常",
    "IP类型考核项目完整性时间": "2026-05-08 11:16:09",
    "IP类型考核项目完整性属性": "192.168.1.200",
    "IP类型考核项目完整性创建时间": "2026-05-08 11:16:09",
    "IP类型考核项目完整性所属部门": "资产管理部",
    "IP类型考核项目完整性负责人": "王五",
    "IP类型考核项目完整性类型": "192.168.1.200",
    "IP类型考核项目完整性规则": "192.168.1.200",
...
const tableColumns = [
  ...
  {
    "prop": "IP类型考核项目完整性创建时间",
    "label": "IP类型考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "IP类型考核项目完整性所属部门",
    "label": "IP类型考核项目完整性所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
