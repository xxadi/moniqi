    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部AssetNM设置信息", "form")'>新增工信部AssetNM设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部AssetNM设置信息", "config")'>修改工信部AssetNM设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部AssetNM设置信息")'>删除工信部AssetNM设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部AssetNM错误信息监控", "log")'>工信部AssetNM错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM错误事件通知", "audit")'>工信部AssetNM错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM错误事件通知删除", "operation")'>工信部AssetNM错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部AssetNM错误事件通知查询", "detail")'>工信部AssetNM错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部AssetNM防篡改信息", "form")'>新增工信部AssetNM防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部AssetNM防篡改信息", "config")'>修改工信部AssetNM防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部AssetNM防篡改信息")'>删除工信部AssetNM防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增系统名称更新信息", "form")'>新增系统名称更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改系统名称更新信息", "config")'>修改系统名称更新信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除系统名称更新信息")'>删除系统名称更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询系统名称更新汇总表", "detail")'>查询系统名称更新汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询系统名称更新详情", "detail")'>查询系统名称更新详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入系统名称更新")'>批量导入系统名称更新</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("系统名称更新数据导出")'>系统名称更新数据导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部AssetNM设置ID": "H-10849",
    "工信部AssetNM设置编号": "H-10849",
    "工信部AssetNM设置名称": "系统名称更新接口-1",
    "新增工信部AssetNM设置状态": "处理中",
    "新增工信部AssetNM设置时间": "2026-05-09 09:47:56",
    "工信部AssetNM设置属性": "处理中",
    "工信部AssetNM设置创建时间": "2026-05-09 09:47:56",
    "工信部AssetNM设置所属部门": "网络管理部",
    "工信部AssetNM设置负责人": "李四",
    "工信部AssetNM设置类型": "处理中",
    "工信部AssetNM设置规则": "处理中",
    "名称": "系统名称更新接口-1"
  ...
  {
    "ID": 2,
    "工信部AssetNM设置ID": "H-18768",
    "工信部AssetNM设置编号": "H-18768",
    "工信部AssetNM设置名称": "系统名称更新接口-2",
    "新增工信部AssetNM设置状态": "待处理",
    "新增工信部AssetNM设置时间": "2026-05-08 09:12:18",
    "工信部AssetNM设置属性": "待处理",
    "工信部AssetNM设置创建时间": "2026-05-08 09:12:18",
    "工信部AssetNM设置所属部门": "资产管理部",
    "工信部AssetNM设置负责人": "王五",
    "工信部AssetNM设置类型": "待处理",
    "工信部AssetNM设置规则": "待处理",
    "名称": "系统名称更新接口-2"
  ...
  {
    "ID": 3,
    "工信部AssetNM设置ID": "H-26687",
    "工信部AssetNM设置编号": "H-26687",
    "工信部AssetNM设置名称": "系统名称更新接口-3",
    "新增工信部AssetNM设置状态": "处理失败",
    "新增工信部AssetNM设置时间": "2026-05-08 09:35:44",
    "工信部AssetNM设置属性": "处理失败",
    "工信部AssetNM设置创建时间": "2026-05-08 09:35:44",
    "工信部AssetNM设置所属部门": "信息安全部",
    "工信部AssetNM设置负责人": "赵六",
    "工信部AssetNM设置类型": "处理失败",
    "工信部AssetNM设置规则": "处理失败",
    "名称": "系统名称更新接口-3"
  ...
  {
    "ID": 4,
    "工信部AssetNM设置ID": "H-34606",
    "工信部AssetNM设置编号": "H-34606",
    "工信部AssetNM设置名称": "系统名称更新接口-4",
    "新增工信部AssetNM设置状态": "已暂停",
    "新增工信部AssetNM设置时间": "2026-05-08 10:08:06",
    "工信部AssetNM设置属性": "已暂停",
    "工信部AssetNM设置创建时间": "2026-05-08 10:08:06",
    "工信部AssetNM设置所属部门": "系统运维部",
    "工信部AssetNM设置负责人": "system",
    "工信部AssetNM设置类型": "已暂停",
    "工信部AssetNM设置规则": "已暂停",
    "名称": "系统名称更新接口-4"
  },
  {
    "ID": 5,
    "工信部AssetNM设置ID": "H-42525",
    "工信部AssetNM设置编号": "H-42525",
    "工信部AssetNM设置名称": "系统名称更新接口-5",
    "新增工信部AssetNM设置状态": "已完成",
    "新增工信部AssetNM设置时间": "2026-05-08 10:42:31",
    "工信部AssetNM设置属性": "已完成",
    "工信部AssetNM设置创建时间": "2026-05-08 10:42:31",
    "工信部AssetNM设置所属部门": "数据管理部",
    "工信部AssetNM设置负责人": "admin",
    "工信部AssetNM设置类型": "已完成",
    "工信部AssetNM设置规则": "已完成",
    "名称": "系统名称更新接口-5"
  },
  {
    "ID": 6,
    "工信部AssetNM设置ID": "H-50444",
    "工信部AssetNM设置编号": "H-50444",
    "工信部AssetNM设置名称": "系统名称更新接口-6",
    "新增工信部AssetNM设置状态": "排队中",
    "新增工信部AssetNM设置时间": "2026-05-08 11:16:09",
    "工信部AssetNM设置属性": "排队中",
    "工信部AssetNM设置创建时间": "2026-05-08 11:16:09",
    "工信部AssetNM设置所属部门": "安全运维部",
    "工信部AssetNM设置负责人": "张三",
    "工信部AssetNM设置类型": "排队中",
    "工信部AssetNM设置规则": "排队中",
    "名称": "系统名称更新接口-6"
  ...
  {
    "ID": 7,
    "工信部AssetNM设置ID": "H-58363",
    "工信部AssetNM设置编号": "H-58363",
    "工信部AssetNM设置名称": "系统名称更新接口-7",
    "新增工信部AssetNM设置状态": "部分完成",
    "新增工信部AssetNM设置时间": "2026-05-08 14:03:52",
    "工信部AssetNM设置属性": "部分完成",
    "工信部AssetNM设置创建时间": "2026-05-08 14:03:52",
    "工信部AssetNM设置所属部门": "网络管理部",
    "工信部AssetNM设置负责人": "李四",
    "工信部AssetNM设置类型": "部分完成",
    "工信部AssetNM设置规则": "部分完成",
  ...
  {
    "ID": 8,
    "工信部AssetNM设置ID": "H-66282",
    "工信部AssetNM设置编号": "H-66282",
    "工信部AssetNM设置名称": "系统名称更新接口-8",
    "新增工信部AssetNM设置状态": "已启用",
    "新增工信部AssetNM设置时间": "2026-05-08 15:21:37",
    "工信部AssetNM设置属性": "已启用",
    "工信部AssetNM设置创建时间": "2026-05-08 15:21:37",
    "工信部AssetNM设置所属部门": "资产管理部",
    "工信部AssetNM设置负责人": "王五",
    "工信部AssetNM设置类型": "已启用",
    "工信部AssetNM设置规则": "已启用",
  ...
  {
    "ID": 9,
    "工信部AssetNM设置ID": "H-74201",
    "工信部AssetNM设置编号": "H-74201",
    "工信部AssetNM设置名称": "系统名称更新接口-9",
    "新增工信部AssetNM设置状态": "已停用",
    "新增工信部AssetNM设置时间": "2026-05-08 16:08:25",
    "工信部AssetNM设置属性": "已停用",
    "工信部AssetNM设置创建时间": "2026-05-08 16:08:25",
    "工信部AssetNM设置所属部门": "信息安全部",
    "工信部AssetNM设置负责人": "赵六",
    "工信部AssetNM设置类型": "已停用",
    "工信部AssetNM设置规则": "已停用",
  ...
  {
    "ID": 10,
    "工信部AssetNM设置ID": "H-82120",
    "工信部AssetNM设置编号": "H-82120",
    "工信部AssetNM设置名称": "系统名称更新接口-10",
    "新增工信部AssetNM设置状态": "正常",
    "新增工信部AssetNM设置时间": "2026-05-09 08:33:11",
    "工信部AssetNM设置属性": "正常",
    "工信部AssetNM设置创建时间": "2026-05-09 08:33:11",
    "工信部AssetNM设置所属部门": "系统运维部",
    "工信部AssetNM设置负责人": "system",
    "工信部AssetNM设置类型": "正常",
    "工信部AssetNM设置规则": "正常",
...
const tableColumns = [
  ...
  {
    "prop": "工信部AssetNM设置名称",
    "label": "工信部AssetNM设置名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增工信部AssetNM设置状态",
    "label": "新增工信部AssetNM设置状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增工信部AssetNM设置时间",
    "label": "新增工信部AssetNM设置时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部AssetNM设置属性",
    "label": "工信部AssetNM设置属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部AssetNM设置创建时间",
    "label": "工信部AssetNM设置创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部AssetNM设置所属部门",
    "label": "工信部AssetNM设置所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部AssetNM设置负责人",
    "label": "工信部AssetNM设置负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
