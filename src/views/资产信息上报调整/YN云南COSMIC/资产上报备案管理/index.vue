    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报备案信息", "form")'>新增资产上报备案信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报备案信息", "config")'>修改资产上报备案信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报备案信息")'>删除资产上报备案信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报备案列表", "detail")'>查询资产上报备案列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报备案详情", "detail")'>查询资产上报备案详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报备案")'>批量导入资产上报备案</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产上报备案导出")'>资产上报备案导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产上报备案名称": "资产上报备案管理-1",
    "新增资产上报备案状态": "已暂停",
    "新增资产上报备案时间": "2026-05-09 08:33:11",
    "资产上报备案属性": "已暂停",
    "资产上报备案创建时间": "2026-05-09 08:33:11",
    "资产上报备案所属部门": "资产管理部",
    "资产上报备案负责人": "王五",
    "资产上报备案类型": "已暂停",
    "资产上报备案规则": "已暂停",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-2",
    "新增资产上报备案状态": "已完成",
    "新增资产上报备案时间": "2026-05-09 09:47:56",
    "资产上报备案属性": "已完成",
    "资产上报备案创建时间": "2026-05-09 09:47:56",
    "资产上报备案所属部门": "信息安全部",
    "资产上报备案负责人": "赵六",
    "资产上报备案类型": "已完成",
    "资产上报备案规则": "已完成",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-3",
    "新增资产上报备案状态": "排队中",
    "新增资产上报备案时间": "2026-05-08 09:12:18",
    "资产上报备案属性": "排队中",
    "资产上报备案创建时间": "2026-05-08 09:12:18",
    "资产上报备案所属部门": "系统运维部",
    "资产上报备案负责人": "system",
    "资产上报备案类型": "排队中",
    "资产上报备案规则": "排队中",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-4",
    "新增资产上报备案状态": "部分完成",
    "新增资产上报备案时间": "2026-05-08 09:35:44",
    "资产上报备案属性": "部分完成",
    "资产上报备案创建时间": "2026-05-08 09:35:44",
    "资产上报备案所属部门": "数据管理部",
    "资产上报备案负责人": "admin",
    "资产上报备案类型": "部分完成",
    "资产上报备案规则": "部分完成",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-5",
    "新增资产上报备案状态": "已启用",
    "新增资产上报备案时间": "2026-05-08 10:08:06",
    "资产上报备案属性": "已启用",
    "资产上报备案创建时间": "2026-05-08 10:08:06",
    "资产上报备案所属部门": "安全运维部",
    "资产上报备案负责人": "张三",
    "资产上报备案类型": "已启用",
    "资产上报备案规则": "已启用",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-6",
    "新增资产上报备案状态": "已停用",
    "新增资产上报备案时间": "2026-05-08 10:42:31",
    "资产上报备案属性": "已停用",
    "资产上报备案创建时间": "2026-05-08 10:42:31",
    "资产上报备案所属部门": "网络管理部",
    "资产上报备案负责人": "李四",
    "资产上报备案类型": "已停用",
    "资产上报备案规则": "已停用",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-7",
    "新增资产上报备案状态": "正常",
    "新增资产上报备案时间": "2026-05-08 11:16:09",
    "资产上报备案属性": "正常",
    "资产上报备案创建时间": "2026-05-08 11:16:09",
    "资产上报备案所属部门": "资产管理部",
    "资产上报备案负责人": "王五",
    "资产上报备案类型": "正常",
    "资产上报备案规则": "正常",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-8",
    "新增资产上报备案状态": "异常",
    "新增资产上报备案时间": "2026-05-08 14:03:52",
    "资产上报备案属性": "异常",
    "资产上报备案创建时间": "2026-05-08 14:03:52",
    "资产上报备案所属部门": "信息安全部",
    "资产上报备案负责人": "赵六",
    "资产上报备案类型": "异常",
    "资产上报备案规则": "异常",
  ...
  },
  {
    ...
    "资产上报备案名称": "资产上报备案管理-9",
    "新增资产上报备案状态": "超时",
    "新增资产上报备案时间": "2026-05-08 15:21:37",
    "资产上报备案属性": "超时",
    "资产上报备案创建时间": "2026-05-08 15:21:37",
    "资产上报备案所属部门": "系统运维部",
    "资产上报备案负责人": "system",
    "资产上报备案类型": "超时",
    "资产上报备案规则": "超时",
