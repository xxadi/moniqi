    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产上报网络单元类型异常告警信息", "alert")'>资产上报网络单元类型异常告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产NetType信息", "form")'>新增工信部资产NetType信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产NetType信息", "config")'>修改工信部资产NetType信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产NetType信息")'>删除工信部资产NetType信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产NetType监控", "log")'>工信部资产NetType监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部资产NetType监控告警", "alert")'>工信部资产NetType监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产NetType稽核", "audit")'>工信部资产NetType稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产NetType统计", "statistics")'>工信部资产NetType统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产NetType数据采集", "transform")'>工信部资产NetType数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产NetType数据转换", "transform")'>工信部资产NetType数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产NetType数据预处理", "transform")'>工信部资产NetType数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报网络单元类型异常告警信息", "config")'>修改资产上报网络单元类型异常告警信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报网络单元类型异常告警信息")'>删除资产上报网络单元类型异常告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报网络单元类型异常告警汇总表", "detail")'>查询资产上报网络单元类型异常告警汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报网络单元类型异常告警详情", "detail")'>查询资产上报网络单元类型异常告警详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报网络单元类型异常告警")'>批量导入资产上报网络单元类型异常告警</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='exportRows("资产上报网络单元类型异常告警导出")'>资产上报网络单元类型异常告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产上报网络单元类型异常告警ID": "A-80990",
    "资产上报网络单元类型异常告警编号": "A-80990",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-1",
    "新增资产上报网络单元类型异常告警状态": "已驳回",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 09:12:18",
    "资产上报网络单元类型异常告警属性": "已驳回",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 09:12:18",
    "资产上报网络单元类型异常告警所属部门": "资产管理部",
    "资产上报网络单元类型异常告警负责人": "王五",
    "资产上报网络单元类型异常告警类型": "已驳回",
    "资产上报网络单元类型异常告警规则": "已驳回",
    "工信部资产NetTypeID": "A-80990"
  },
  {
    "ID": 2,
    "资产上报网络单元类型异常告警ID": "A-88909",
    "资产上报网络单元类型异常告警编号": "A-88909",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-2",
    "新增资产上报网络单元类型异常告警状态": "待审核",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 09:35:44",
    "资产上报网络单元类型异常告警属性": "待审核",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 09:35:44",
    "资产上报网络单元类型异常告警所属部门": "信息安全部",
    "资产上报网络单元类型异常告警负责人": "赵六",
    "资产上报网络单元类型异常告警类型": "待审核",
    "资产上报网络单元类型异常告警规则": "待审核",
    "工信部资产NetTypeID": "A-88909"
  },
  {
    "ID": 3,
    "资产上报网络单元类型异常告警ID": "A-96828",
    "资产上报网络单元类型异常告警编号": "A-96828",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-3",
    "新增资产上报网络单元类型异常告警状态": "已处理",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 10:08:06",
    "资产上报网络单元类型异常告警属性": "已处理",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 10:08:06",
    "资产上报网络单元类型异常告警所属部门": "系统运维部",
    "资产上报网络单元类型异常告警负责人": "system",
    "资产上报网络单元类型异常告警类型": "已处理",
    "资产上报网络单元类型异常告警规则": "已处理",
    "工信部资产NetTypeID": "A-96828"
  },
  {
    "ID": 4,
    "资产上报网络单元类型异常告警ID": "A-104747",
    "资产上报网络单元类型异常告警编号": "A-104747",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-4",
    "新增资产上报网络单元类型异常告警状态": "处理中",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 10:42:31",
    "资产上报网络单元类型异常告警属性": "处理中",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 10:42:31",
    "资产上报网络单元类型异常告警所属部门": "数据管理部",
    "资产上报网络单元类型异常告警负责人": "admin",
    "资产上报网络单元类型异常告警类型": "处理中",
    "资产上报网络单元类型异常告警规则": "处理中",
    "工信部资产NetTypeID": "A-104747"
  },
  {
    "ID": 5,
    "资产上报网络单元类型异常告警ID": "A-112666",
    "资产上报网络单元类型异常告警编号": "A-112666",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-5",
    "新增资产上报网络单元类型异常告警状态": "待处理",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 11:16:09",
    "资产上报网络单元类型异常告警属性": "待处理",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 11:16:09",
    "资产上报网络单元类型异常告警所属部门": "安全运维部",
    "资产上报网络单元类型异常告警负责人": "张三",
    "资产上报网络单元类型异常告警类型": "待处理",
    "资产上报网络单元类型异常告警规则": "待处理",
    "工信部资产NetTypeID": "A-112666"
  },
  {
    "ID": 6,
    "资产上报网络单元类型异常告警ID": "A-120585",
    "资产上报网络单元类型异常告警编号": "A-120585",
    "资产上报网络单元类型异常告警名称": "资产上报网络单元类型异常告警管理-6",
    "新增资产上报网络单元类型异常告警状态": "处理失败",
    "新增资产上报网络单元类型异常告警时间": "2026-05-08 14:03:52",
    "资产上报网络单元类型异常告警属性": "处理失败",
    "资产上报网络单元类型异常告警创建时间": "2026-05-08 14:03:52",
    "资产上报网络单元类型异常告警所属部门": "网络管理部",
    "资产上报网络单元类型异常告警负责人": "李四",
    "资产上报网络单元类型异常告警类型": "处理失败",
    "资产上报网络单元类型异常告警规则": "处理失败",
    "工信部资产NetTypeID": "A-120585"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "资产上报网络单元类型异常告警ID",
    "label": "资产上报网络单元类型异常告警ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警编号",
    "label": "资产上报网络单元类型异常告警编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警名称",
    "label": "资产上报网络单元类型异常告警名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增资产上报网络单元类型异常告警状态",
    "label": "新增资产上报网络单元类型异常告警状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增资产上报网络单元类型异常告警时间",
    "label": "新增资产上报网络单元类型异常告警时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产上报网络单元类型异常告警属性",
    "label": "资产上报网络单元类型异常告警属性",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警创建时间",
    "label": "资产上报网络单元类型异常告警创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产上报网络单元类型异常告警所属部门",
    "label": "资产上报网络单元类型异常告警所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警负责人",
    "label": "资产上报网络单元类型异常告警负责人",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警类型",
    "label": "资产上报网络单元类型异常告警类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "资产上报网络单元类型异常告警规则",
    "label": "资产上报网络单元类型异常告警规则",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "资产上报网络单元类型异常告警规则": "",
  "工信部资产NetTypeID": "",
  "导入来源": "资产上报网络单元类型异常告警管理导入模板.xlsx"
};
