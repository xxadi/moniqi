    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞数据信息", "form")'>新增资产漏洞数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞数据信息", "config")'>修改资产漏洞数据信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞数据信息")'>删除资产漏洞数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("检索资产漏洞数据列表", "operation")'>检索资产漏洞数据列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据下发回传同步", "sync")'>资产漏洞数据下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞数据下发回传任务推送", "audit")'>资产漏洞数据下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据数据下发", "operation")'>资产漏洞数据数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产漏洞数据数据分析", "analysis")'>资产漏洞数据数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据数据上报", "operation")'>资产漏洞数据数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-1",
    "新增资产漏洞数据状态": "已完成",
    "新增资产漏洞数据时间": "2026-05-08 16:08:25",
    "数据属性": "已完成",
    "资产漏洞数据创建时间": "2026-05-08 16:08:25",
    "资产漏洞数据所属部门": "网络管理部",
    "资产漏洞数据负责人": "李四",
    "资产漏洞数据类型": "已完成",
    "资产漏洞数据规则": "已完成",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-2",
    "新增资产漏洞数据状态": "排队中",
    "新增资产漏洞数据时间": "2026-05-09 08:33:11",
    "数据属性": "排队中",
    "资产漏洞数据创建时间": "2026-05-09 08:33:11",
    "资产漏洞数据所属部门": "资产管理部",
    "资产漏洞数据负责人": "王五",
    "资产漏洞数据类型": "排队中",
    "资产漏洞数据规则": "排队中",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-3",
    "新增资产漏洞数据状态": "部分完成",
    "新增资产漏洞数据时间": "2026-05-09 09:47:56",
    "数据属性": "部分完成",
    "资产漏洞数据创建时间": "2026-05-09 09:47:56",
    "资产漏洞数据所属部门": "信息安全部",
    "资产漏洞数据负责人": "赵六",
    "资产漏洞数据类型": "部分完成",
    "资产漏洞数据规则": "部分完成",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-4",
    "新增资产漏洞数据状态": "已启用",
    "新增资产漏洞数据时间": "2026-05-08 09:12:18",
    "数据属性": "已启用",
    "资产漏洞数据创建时间": "2026-05-08 09:12:18",
    "资产漏洞数据所属部门": "系统运维部",
    "资产漏洞数据负责人": "system",
    "资产漏洞数据类型": "已启用",
    "资产漏洞数据规则": "已启用",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-5",
    "新增资产漏洞数据状态": "已停用",
    "新增资产漏洞数据时间": "2026-05-08 09:35:44",
    "数据属性": "已停用",
    "资产漏洞数据创建时间": "2026-05-08 09:35:44",
    "资产漏洞数据所属部门": "数据管理部",
    "资产漏洞数据负责人": "admin",
    "资产漏洞数据类型": "已停用",
    "资产漏洞数据规则": "已停用",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-6",
    "新增资产漏洞数据状态": "正常",
    "新增资产漏洞数据时间": "2026-05-08 10:08:06",
    "数据属性": "正常",
    "资产漏洞数据创建时间": "2026-05-08 10:08:06",
    "资产漏洞数据所属部门": "安全运维部",
    "资产漏洞数据负责人": "张三",
    "资产漏洞数据类型": "正常",
    "资产漏洞数据规则": "正常",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-7",
    "新增资产漏洞数据状态": "异常",
    "新增资产漏洞数据时间": "2026-05-08 10:42:31",
    "数据属性": "异常",
    "资产漏洞数据创建时间": "2026-05-08 10:42:31",
    "资产漏洞数据所属部门": "网络管理部",
    "资产漏洞数据负责人": "李四",
    "资产漏洞数据类型": "异常",
    "资产漏洞数据规则": "异常",
  ...
  },
  {
    ...
    "资产漏洞数据名称": "资产漏洞数据管理-8",
    "新增资产漏洞数据状态": "超时",
    "新增资产漏洞数据时间": "2026-05-08 11:16:09",
    "数据属性": "超时",
    "资产漏洞数据创建时间": "2026-05-08 11:16:09",
    "资产漏洞数据所属部门": "资产管理部",
    "资产漏洞数据负责人": "王五",
    "资产漏洞数据类型": "超时",
    "资产漏洞数据规则": "超时",
