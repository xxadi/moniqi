    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起自动化识别结果审核流程", "initiate_audit")'>发起自动化识别结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化识别结果审核指派信息", "form")'>新增自动化识别结果审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化识别结果审核流程", "form")'>新增自动化识别结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化识别结果审核流程信息", "config")'>修改自动化识别结果审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别结果审核流程删除", "operation")'>自动化识别结果审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别结果审核流程查询", "detail")'>自动化识别结果审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别结果审核附件上传", "form")'>自动化识别结果审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化识别结果审核流程图查看", "preview")'>自动化识别结果审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化识别结果审核流程通知", "validate")'>自动化识别结果审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化识别结果审核结果逐级审批", "validate")'>自动化识别结果审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化识别结果审核结果拒绝和驳回", "approval")'>自动化识别结果审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "自动化识别结果审核ID": "C-85516",
    "自动化识别结果审核流程环节ID": "C-85516",
    "自动化识别结果审核编号": "C-85516",
    "自动化识别结果审核名称": "超时",
    "发起自动化识别结果审核状态": "超时",
    "发起自动化识别结果审核时间": "2026-05-08 15:21:37",
    "自动化识别结果审核属性": "超时",
    "自动化识别结果审核发起时间": "2026-05-08 15:21:37",
    "自动化识别结果审核流程id": "超时",
    "自动化识别结果审核流程环节": "超时",
    "自动化识别结果审核创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "自动化识别结果审核ID": "C-93435",
    "自动化识别结果审核流程环节ID": "C-93435",
    "自动化识别结果审核编号": "C-93435",
    "自动化识别结果审核名称": "已取消",
    "发起自动化识别结果审核状态": "已取消",
    "发起自动化识别结果审核时间": "2026-05-08 16:08:25",
    "自动化识别结果审核属性": "已取消",
    "自动化识别结果审核发起时间": "2026-05-08 16:08:25",
    "自动化识别结果审核流程id": "已取消",
    "自动化识别结果审核流程环节": "已取消",
    "自动化识别结果审核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "自动化识别结果审核ID": "C-101354",
    "自动化识别结果审核流程环节ID": "C-101354",
    "自动化识别结果审核编号": "C-101354",
    "自动化识别结果审核名称": "已驳回",
    "发起自动化识别结果审核状态": "已驳回",
    "发起自动化识别结果审核时间": "2026-05-09 08:33:11",
    "自动化识别结果审核属性": "已驳回",
    "自动化识别结果审核发起时间": "2026-05-09 08:33:11",
    "自动化识别结果审核流程id": "已驳回",
    "自动化识别结果审核流程环节": "已驳回",
    "自动化识别结果审核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "自动化识别结果审核ID": "C-109273",
    "自动化识别结果审核流程环节ID": "C-109273",
    "自动化识别结果审核编号": "C-109273",
    "自动化识别结果审核名称": "待审核",
    "发起自动化识别结果审核状态": "待审核",
    "发起自动化识别结果审核时间": "2026-05-09 09:47:56",
    "自动化识别结果审核属性": "待审核",
    "自动化识别结果审核发起时间": "2026-05-09 09:47:56",
    "自动化识别结果审核流程id": "待审核",
    "自动化识别结果审核流程环节": "待审核",
    "自动化识别结果审核创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "自动化识别结果审核ID": "C-117192",
    "自动化识别结果审核流程环节ID": "C-117192",
    "自动化识别结果审核编号": "C-117192",
    "自动化识别结果审核名称": "已处理",
    "发起自动化识别结果审核状态": "已处理",
    "发起自动化识别结果审核时间": "2026-05-08 09:12:18",
    "自动化识别结果审核属性": "已处理",
    "自动化识别结果审核发起时间": "2026-05-08 09:12:18",
    "自动化识别结果审核流程id": "已处理",
    "自动化识别结果审核流程环节": "已处理",
    "自动化识别结果审核创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "自动化识别结果审核ID": "C-125111",
    "自动化识别结果审核流程环节ID": "C-125111",
    "自动化识别结果审核编号": "C-125111",
    "自动化识别结果审核名称": "处理中",
    "发起自动化识别结果审核状态": "处理中",
    "发起自动化识别结果审核时间": "2026-05-08 09:35:44",
    "自动化识别结果审核属性": "处理中",
    "自动化识别结果审核发起时间": "2026-05-08 09:35:44",
    "自动化识别结果审核流程id": "处理中",
    "自动化识别结果审核流程环节": "处理中",
    "自动化识别结果审核创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "自动化识别结果审核ID": "C-133030",
    "自动化识别结果审核流程环节ID": "C-133030",
    "自动化识别结果审核编号": "C-133030",
    "自动化识别结果审核名称": "待处理",
    "发起自动化识别结果审核状态": "待处理",
    "发起自动化识别结果审核时间": "2026-05-08 10:08:06",
    "自动化识别结果审核属性": "待处理",
    "自动化识别结果审核发起时间": "2026-05-08 10:08:06",
    "自动化识别结果审核流程id": "待处理",
    "自动化识别结果审核流程环节": "待处理",
    "自动化识别结果审核创建时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "自动化识别结果审核流程环节ID",
    "label": "自动化识别结果审核流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
