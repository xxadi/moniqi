    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产简表错误信息监控", "log")'>资产简表错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产简表错误事件通知", "audit")'>资产简表错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产简表错误事件通知删除", "operation")'>资产简表错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产简表错误事件通知查询", "detail")'>资产简表错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产简表防篡改信息", "form")'>新增资产简表防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产简表防篡改信息", "config")'>修改资产简表防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产简表防篡改信息")'>删除资产简表防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产简表属性": "已处理",
    "资产简表状态": "已处理",
    "资产简表时间": "2026-05-08 15:21:37",
    "资产简表错误处理时间": "2026-05-08 15:21:37",
    "资产简表创建时间": "2026-05-08 15:21:37",
    "资产简表错误处理user": "已处理",
    "资产简表所属部门": "系统运维部"
  },
  {
    ...
    "资产简表属性": "处理中",
    "资产简表状态": "处理中",
    "资产简表时间": "2026-05-08 16:08:25",
    "资产简表错误处理时间": "2026-05-08 16:08:25",
    "资产简表创建时间": "2026-05-08 16:08:25",
    "资产简表错误处理user": "处理中",
    "资产简表所属部门": "数据管理部"
  },
  {
    ...
    "资产简表属性": "待处理",
    "资产简表状态": "待处理",
    "资产简表时间": "2026-05-09 08:33:11",
    "资产简表错误处理时间": "2026-05-09 08:33:11",
    "资产简表创建时间": "2026-05-09 08:33:11",
    "资产简表错误处理user": "待处理",
    "资产简表所属部门": "安全运维部"
  },
  {
    ...
    "资产简表属性": "处理失败",
    "资产简表状态": "处理失败",
    "资产简表时间": "2026-05-09 09:47:56",
    "资产简表错误处理时间": "2026-05-09 09:47:56",
    "资产简表创建时间": "2026-05-09 09:47:56",
    "资产简表错误处理user": "处理失败",
    "资产简表所属部门": "网络管理部"
  },
  {
    ...
    "资产简表属性": "已暂停",
    "资产简表状态": "已暂停",
    "资产简表时间": "2026-05-08 09:12:18",
    "资产简表错误处理时间": "2026-05-08 09:12:18",
    "资产简表创建时间": "2026-05-08 09:12:18",
    "资产简表错误处理user": "已暂停",
    "资产简表所属部门": "资产管理部"
  },
  {
    ...
    "资产简表属性": "已完成",
    "资产简表状态": "已完成",
    "资产简表时间": "2026-05-08 09:35:44",
    "资产简表错误处理时间": "2026-05-08 09:35:44",
    "资产简表创建时间": "2026-05-08 09:35:44",
    "资产简表错误处理user": "已完成",
    "资产简表所属部门": "信息安全部"
  },
  {
    ...
    "资产简表属性": "排队中",
    "资产简表状态": "排队中",
    "资产简表时间": "2026-05-08 10:08:06",
    "资产简表错误处理时间": "2026-05-08 10:08:06",
    "资产简表创建时间": "2026-05-08 10:08:06",
    "资产简表错误处理user": "排队中",
    "资产简表所属部门": "系统运维部"
  }
];
