    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("待执行命令信息添加", "operation")'>待执行命令信息添加</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("待执行命令信息修改", "operation")'>待执行命令信息修改</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞扫描任务设置信息", "form")'>新增资产漏洞扫描任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞扫描任务设置信息", "config")'>修改资产漏洞扫描任务设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞扫描任务设置信息")'>删除资产漏洞扫描任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产漏洞扫描任务错误信息监控", "log")'>资产漏洞扫描任务错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞扫描任务错误事件通知", "audit")'>资产漏洞扫描任务错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞扫描任务错误事件通知删除", "operation")'>资产漏洞扫描任务错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞扫描任务错误事件通知查询", "detail")'>资产漏洞扫描任务错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞扫描任务防篡改信息", "form")'>新增资产漏洞扫描任务防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞扫描任务防篡改信息", "config")'>修改资产漏洞扫描任务防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞扫描任务防篡改信息")'>删除资产漏洞扫描任务防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("待执行命令信息删除", "operation")'>待执行命令信息删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("待执行命令信息查询", "detail")'>待执行命令信息查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='openImport("待执行命令信息导入")'>待执行命令信息导入</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("待执行命令信息导出")'>待执行命令信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("用户输入命令执行", "operation")'>用户输入命令执行</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义资产漏洞分析规则信息", "analysis")'>定义资产漏洞分析规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞分析规则信息", "config")'>修改资产漏洞分析规则信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞分析规则信息")'>删除资产漏洞分析规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产漏洞分析规则数据获取", "analysis")'>资产漏洞分析规则数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产漏洞分析规则数据上传", "analysis")'>资产漏洞分析规则数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产漏洞分析规则数据接口监控", "log")'>资产漏洞分析规则数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产漏洞分析规则汇总报告详情", "detail")'>查询资产漏洞分析规则汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产漏洞分析规则明细报告详情", "detail")'>查询资产漏洞分析规则明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("用户选择命令执行", "operation")'>用户选择命令执行</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("命令执行与分析", "analysis")'>命令执行与分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("命令执行结果添加", "operation")'>命令执行结果添加</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产组件识别信息", "form")'>新增资产组件识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产组件识别信息", "config")'>修改资产组件识别信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产组件识别信息")'>删除资产组件识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组件识别结果监控", "monitor")'>资产组件识别结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("资产组件识别结果监控告警", "alert")'>资产组件识别结果监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产组件识别结果稽核", "validate")'>资产组件识别结果稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产组件识别结果统计", "statistics")'>资产组件识别结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产组件识别数据采集", "transform")'>资产组件识别数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产组件识别数据预处理", "transform")'>资产组件识别数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("命令执行结果修改", "operation")'>命令执行结果修改</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("命令执行结果删除", "operation")'>命令执行结果删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("命令执行结果查询", "detail")'>命令执行结果查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("命令执行结果导出")'>命令执行结果导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "执行ID": "Y-55586",
    "执行人": "待处理",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-1",
    "待执行命令信息添加操作人": "王五",
    "待执行命令信息添加操作时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "添加编号": "Y-63505",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-2",
    "待执行命令信息添加类型": "处理失败",
    "待执行命令信息添加规则": "处理失败",
    "待执行命令信息添加属性": "处理失败",
    "待执行命令信息添加状态": "处理失败",
    ...
    "执行ID": "Y-63505",
    "执行人": "处理失败",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-2",
    "待执行命令信息添加操作人": "赵六",
    "待执行命令信息添加操作时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "添加编号": "Y-71424",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-3",
    "待执行命令信息添加类型": "已暂停",
    "待执行命令信息添加规则": "已暂停",
    "待执行命令信息添加属性": "已暂停",
    "待执行命令信息添加状态": "已暂停",
    ...
    "执行ID": "Y-71424",
    "执行人": "已暂停",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-3",
    "待执行命令信息添加操作人": "system",
    "待执行命令信息添加操作时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "添加编号": "Y-79343",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-4",
    "待执行命令信息添加类型": "已完成",
    "待执行命令信息添加规则": "已完成",
    "待执行命令信息添加属性": "已完成",
    "待执行命令信息添加状态": "已完成",
    ...
    "执行ID": "Y-79343",
    "执行人": "已完成",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-4",
    "待执行命令信息添加操作人": "admin",
    "待执行命令信息添加操作时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "添加编号": "Y-87262",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-5",
    "待执行命令信息添加类型": "排队中",
    "待执行命令信息添加规则": "排队中",
    "待执行命令信息添加属性": "排队中",
    "待执行命令信息添加状态": "排队中",
    ...
    "执行ID": "Y-87262",
    "执行人": "排队中",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-5",
    "待执行命令信息添加操作人": "张三",
    "待执行命令信息添加操作时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "添加编号": "Y-95181",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-6",
    "待执行命令信息添加类型": "部分完成",
    "待执行命令信息添加规则": "部分完成",
    "待执行命令信息添加属性": "部分完成",
    "待执行命令信息添加状态": "部分完成",
    ...
    "执行ID": "Y-95181",
    "执行人": "部分完成",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-6",
    "待执行命令信息添加操作人": "李四",
    "待执行命令信息添加操作时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "添加编号": "Y-103100",
    "待执行命令信息添加名称": "漏洞组件自动化采集及风险排查-7",
    "待执行命令信息添加类型": "已启用",
    "待执行命令信息添加规则": "已启用",
    "待执行命令信息添加属性": "已启用",
    "待执行命令信息添加状态": "已启用",
    "待执行命令信息添加编号": "Y-103100",
    "执行ID": "Y-103100",
    "执行人": "已启用",
    "命令信息添加名称": "漏洞组件自动化采集及风险排查-7",
    "待执行命令信息添加操作人": "王五",
    "待执行命令信息添加操作时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
