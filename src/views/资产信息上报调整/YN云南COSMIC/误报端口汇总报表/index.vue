    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增误报端口汇总报表信息", "form")'>新增误报端口汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增误报端口明细报表信息", "form")'>新增误报端口明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询误报端口汇总报表详情", "detail")'>查询误报端口汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询误报端口明细报表详情", "detail")'>查询误报端口明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("误报端口汇总报表导出")'>误报端口汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("误报端口明细报表导出")'>误报端口明细报表导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "误报端口汇总报表属性": "处理中",
    "新增误报端口汇总报表状态": "处理中",
    "新增误报端口汇总报表时间": "2026-05-09 09:47:56",
    "误报端口汇总报表创建时间": "2026-05-09 09:47:56",
    "汇总报表编号": "Z-47969",
    "报表ID": "Z-47969",
    "汇总报表所属部门": "数据管理部"
  },
  {
    ...
    "误报端口汇总报表属性": "待处理",
    "新增误报端口汇总报表状态": "待处理",
    "新增误报端口汇总报表时间": "2026-05-08 09:12:18",
    "误报端口汇总报表创建时间": "2026-05-08 09:12:18",
    "汇总报表编号": "Z-55888",
    "报表ID": "Z-55888",
    "汇总报表所属部门": "安全运维部"
  },
  {
    ...
    "误报端口汇总报表属性": "处理失败",
    "新增误报端口汇总报表状态": "处理失败",
    "新增误报端口汇总报表时间": "2026-05-08 09:35:44",
    "误报端口汇总报表创建时间": "2026-05-08 09:35:44",
    "汇总报表编号": "Z-63807",
    "报表ID": "Z-63807",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "误报端口汇总报表属性": "已暂停",
    "新增误报端口汇总报表状态": "已暂停",
    "新增误报端口汇总报表时间": "2026-05-08 10:08:06",
    "误报端口汇总报表创建时间": "2026-05-08 10:08:06",
    "汇总报表编号": "Z-71726",
    "报表ID": "Z-71726",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "误报端口汇总报表属性": "已完成",
    "新增误报端口汇总报表状态": "已完成",
    "新增误报端口汇总报表时间": "2026-05-08 10:42:31",
    "误报端口汇总报表创建时间": "2026-05-08 10:42:31",
    "汇总报表编号": "Z-79645",
    "报表ID": "Z-79645",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "误报端口汇总报表属性": "排队中",
    "新增误报端口汇总报表状态": "排队中",
    "新增误报端口汇总报表时间": "2026-05-08 11:16:09",
    "误报端口汇总报表创建时间": "2026-05-08 11:16:09",
    "汇总报表编号": "Z-87564",
    "报表ID": "Z-87564",
    "汇总报表所属部门": "系统运维部"
  },
  {
    ...
    "误报端口汇总报表属性": "部分完成",
    "新增误报端口汇总报表状态": "部分完成",
    "新增误报端口汇总报表时间": "2026-05-08 14:03:52",
    "误报端口汇总报表创建时间": "2026-05-08 14:03:52",
    "汇总报表编号": "Z-95483",
    "报表ID": "Z-95483",
    "汇总报表所属部门": "数据管理部"
  },
  {
    ...
    "误报端口汇总报表属性": "已启用",
    "新增误报端口汇总报表状态": "已启用",
    "新增误报端口汇总报表时间": "2026-05-08 15:21:37",
    "误报端口汇总报表创建时间": "2026-05-08 15:21:37",
    "汇总报表编号": "Z-103402",
    "报表ID": "Z-103402",
    "汇总报表所属部门": "安全运维部"
  },
  {
    ...
    "误报端口汇总报表属性": "已停用",
    "新增误报端口汇总报表状态": "已停用",
    "新增误报端口汇总报表时间": "2026-05-08 16:08:25",
    "误报端口汇总报表创建时间": "2026-05-08 16:08:25",
    "汇总报表编号": "Z-111321",
    "报表ID": "Z-111321",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "误报端口汇总报表属性": "正常",
    "新增误报端口汇总报表状态": "正常",
    "新增误报端口汇总报表时间": "2026-05-09 08:33:11",
    "误报端口汇总报表创建时间": "2026-05-09 08:33:11",
    "汇总报表编号": "Z-119240",
    "报表ID": "Z-119240",
    "汇总报表所属部门": "资产管理部"
  }
