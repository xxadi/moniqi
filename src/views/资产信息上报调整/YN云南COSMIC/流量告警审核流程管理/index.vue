    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量告警审核指派信息", "form")'>新增流量告警审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量告警审核流程", "form")'>新增流量告警审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量告警审核流程信息", "config")'>修改流量告警审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核流程删除", "operation")'>流量告警审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核流程查询", "detail")'>流量告警审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核附件上传", "form")'>流量告警审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核流程图查看", "preview")'>流量告警审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核流程通知", "audit")'>流量告警审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核结果逐级审批", "audit")'>流量告警审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量告警审核结果拒绝和驳回", "approval")'>流量告警审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流量告警审核指派用户": "张三",
    "流量告警审核编号": "M-9840",
    "流量告警审核名称": "流量告警审核流程管理-1",
    "新增流量告警审核状态": "已处理",
    "新增流量告警审核时间": "2026-05-08 09:12:18",
    "流量告警审核属性": "已处理",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 09:12:18",
    "流量告警审核指派部门": "安全运维部",
    "流量告警审核负责人": "张三",
    "流量告警审核类型": "已处理",
    "流量告警审核规则": "已处理"
  },
  {
    ...
    "流量告警审核指派用户": "李四",
    "流量告警审核编号": "M-17759",
    "流量告警审核名称": "流量告警审核流程管理-2",
    "新增流量告警审核状态": "处理中",
    "新增流量告警审核时间": "2026-05-08 09:35:44",
    "流量告警审核属性": "处理中",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 09:35:44",
    "流量告警审核指派部门": "网络管理部",
    "流量告警审核负责人": "李四",
    "流量告警审核类型": "处理中",
    "流量告警审核规则": "处理中"
  },
  {
    ...
    "流量告警审核指派用户": "王五",
    "流量告警审核编号": "M-25678",
    "流量告警审核名称": "流量告警审核流程管理-3",
    "新增流量告警审核状态": "待处理",
    "新增流量告警审核时间": "2026-05-08 10:08:06",
    "流量告警审核属性": "待处理",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 10:08:06",
    "流量告警审核指派部门": "资产管理部",
    "流量告警审核负责人": "王五",
    "流量告警审核类型": "待处理",
    "流量告警审核规则": "待处理"
  },
  {
    ...
    "流量告警审核指派用户": "赵六",
    "流量告警审核编号": "M-33597",
    "流量告警审核名称": "流量告警审核流程管理-4",
    "新增流量告警审核状态": "处理失败",
    "新增流量告警审核时间": "2026-05-08 10:42:31",
    "流量告警审核属性": "处理失败",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 10:42:31",
    "流量告警审核指派部门": "信息安全部",
    "流量告警审核负责人": "赵六",
    "流量告警审核类型": "处理失败",
    "流量告警审核规则": "处理失败"
  },
  {
    ...
    "流量告警审核指派用户": "system",
    "流量告警审核编号": "M-41516",
    "流量告警审核名称": "流量告警审核流程管理-5",
    "新增流量告警审核状态": "已暂停",
    "新增流量告警审核时间": "2026-05-08 11:16:09",
    "流量告警审核属性": "已暂停",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 11:16:09",
    "流量告警审核指派部门": "系统运维部",
    "流量告警审核负责人": "system",
    "流量告警审核类型": "已暂停",
    "流量告警审核规则": "已暂停"
  },
  {
    ...
    "流量告警审核指派用户": "admin",
    "流量告警审核编号": "M-49435",
    "流量告警审核名称": "流量告警审核流程管理-6",
    "新增流量告警审核状态": "已完成",
    "新增流量告警审核时间": "2026-05-08 14:03:52",
    "流量告警审核属性": "已完成",
    "流量告警审核指派时间_流量告警审核创建时间": "2026-05-08 14:03:52",
    "流量告警审核指派部门": "数据管理部",
    "流量告警审核负责人": "admin",
    "流量告警审核类型": "已完成",
    "流量告警审核规则": "已完成"
...
const tableColumns = [
  ...
  {
    "prop": "流量告警审核指派时间_流量告警审核创建时间",
    "label": "流量告警审核指派时间。流量告警审核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
