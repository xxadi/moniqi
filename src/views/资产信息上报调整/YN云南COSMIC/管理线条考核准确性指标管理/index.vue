    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("管理线条考核准确性信息表", "operation")'>管理线条考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增管理线条数据考核准确性字典信息", "form")'>新增管理线条数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改管理线条数据考核准确性字典信息", "config")'>修改管理线条数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除管理线条数据考核准确性字典信息")'>删除管理线条数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("管理线条考核准确性稽核数据上传", "form")'>管理线条考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("管理线条考核准确性稽核数据接口监控", "log")'>管理线条考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增管理线条考核准确性上传任务", "form")'>新增管理线条考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除管理线条考核准确性上传任务")'>删除管理线条考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改管理线条考核准确性上传任务", "config")'>修改管理线条考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询管理线条考核准确性上传任务", "detail")'>查询管理线条考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("管理线条考核准确性上传任务启用/禁用", "form")'>管理线条考核准确性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "管理线条考核准确性ID": "I-32456",
    "管理线条考核准确性编号": "I-32456",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-1",
    "管理线条考核准确性状态": "已启用",
    "管理线条考核准确性时间": "2026-05-08 15:21:37",
    "管理线条考核准确性属性": "已启用",
    "管理线条考核准确性创建时间": "2026-05-08 15:21:37",
    "管理线条考核准确性所属部门": "资产管理部",
    "管理线条考核准确性负责人": "王五",
    "管理线条考核准确性类型": "已启用",
    "管理线条考核准确性规则": "已启用",
    "管理线条数据考核准确性字典ID": "I-32456"
  },
  {
    "ID": 2,
    "管理线条考核准确性ID": "I-40375",
    "管理线条考核准确性编号": "I-40375",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-2",
    "管理线条考核准确性状态": "已停用",
    "管理线条考核准确性时间": "2026-05-08 16:08:25",
    "管理线条考核准确性属性": "已停用",
    "管理线条考核准确性创建时间": "2026-05-08 16:08:25",
    "管理线条考核准确性所属部门": "信息安全部",
    "管理线条考核准确性负责人": "赵六",
    "管理线条考核准确性类型": "已停用",
    "管理线条考核准确性规则": "已停用",
    "管理线条数据考核准确性字典ID": "I-40375"
  },
  {
    "ID": 3,
    "管理线条考核准确性ID": "I-48294",
    "管理线条考核准确性编号": "I-48294",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-3",
    "管理线条考核准确性状态": "正常",
    "管理线条考核准确性时间": "2026-05-09 08:33:11",
    "管理线条考核准确性属性": "正常",
    "管理线条考核准确性创建时间": "2026-05-09 08:33:11",
    "管理线条考核准确性所属部门": "系统运维部",
    "管理线条考核准确性负责人": "system",
    "管理线条考核准确性类型": "正常",
    "管理线条考核准确性规则": "正常",
    "管理线条数据考核准确性字典ID": "I-48294"
  },
  {
    "ID": 4,
    "管理线条考核准确性ID": "I-56213",
    "管理线条考核准确性编号": "I-56213",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-4",
    "管理线条考核准确性状态": "异常",
    "管理线条考核准确性时间": "2026-05-09 09:47:56",
    "管理线条考核准确性属性": "异常",
    "管理线条考核准确性创建时间": "2026-05-09 09:47:56",
    "管理线条考核准确性所属部门": "数据管理部",
    "管理线条考核准确性负责人": "admin",
    "管理线条考核准确性类型": "异常",
    "管理线条考核准确性规则": "异常",
    "管理线条数据考核准确性字典ID": "I-56213"
  },
  {
    "ID": 5,
    "管理线条考核准确性ID": "I-64132",
    "管理线条考核准确性编号": "I-64132",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-5",
    "管理线条考核准确性状态": "超时",
    "管理线条考核准确性时间": "2026-05-08 09:12:18",
    "管理线条考核准确性属性": "超时",
    "管理线条考核准确性创建时间": "2026-05-08 09:12:18",
    "管理线条考核准确性所属部门": "安全运维部",
    "管理线条考核准确性负责人": "张三",
    "管理线条考核准确性类型": "超时",
    "管理线条考核准确性规则": "超时",
    "管理线条数据考核准确性字典ID": "I-64132"
  },
  {
    "ID": 6,
    "管理线条考核准确性ID": "I-72051",
    "管理线条考核准确性编号": "I-72051",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-6",
    "管理线条考核准确性状态": "已取消",
    "管理线条考核准确性时间": "2026-05-08 09:35:44",
    "管理线条考核准确性属性": "已取消",
    "管理线条考核准确性创建时间": "2026-05-08 09:35:44",
    "管理线条考核准确性所属部门": "网络管理部",
    "管理线条考核准确性负责人": "李四",
    "管理线条考核准确性类型": "已取消",
    "管理线条考核准确性规则": "已取消",
    "管理线条数据考核准确性字典ID": "I-72051"
  },
  {
    "ID": 7,
    "管理线条考核准确性ID": "I-79970",
    "管理线条考核准确性编号": "I-79970",
    "管理线条考核准确性名称": "管理线条考核准确性指标管理-7",
    "管理线条考核准确性状态": "已驳回",
    "管理线条考核准确性时间": "2026-05-08 10:08:06",
    "管理线条考核准确性属性": "已驳回",
    "管理线条考核准确性创建时间": "2026-05-08 10:08:06",
    "管理线条考核准确性所属部门": "资产管理部",
    "管理线条考核准确性负责人": "王五",
    "管理线条考核准确性类型": "已驳回",
    "管理线条考核准确性规则": "已驳回",
    "管理线条数据考核准确性字典ID": "I-79970"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "管理线条数据考核准确性字典ID",
    "label": "管理线条数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
