    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起告警白名单审核流程", "initiate_audit")'>发起告警白名单审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增告警白名单审核指派信息", "form")'>新增告警白名单审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增告警白名单审核流程", "form")'>新增告警白名单审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改告警白名单审核流程信息", "config")'>修改告警白名单审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核流程删除", "operation")'>告警白名单审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核流程查询", "detail")'>告警白名单审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核附件上传", "form")'>告警白名单审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核流程图查看", "preview")'>告警白名单审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核流程通知", "audit")'>告警白名单审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核结果逐级审批", "audit")'>告警白名单审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警白名单审核结果拒绝和驳回", "approval")'>告警白名单审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "告警白名单审核ID": "H-75407",
    "告警白名单审核流程环节ID": "H-75407",
    "告警白名单审核编号": "H-75407",
    "告警白名单审核名称": "告警白名单审核流程管理-1",
    "发起告警白名单审核状态": "待审核",
    "发起告警白名单审核时间": "2026-05-08 16:08:25",
    "告警白名单审核属性": "待审核",
    "告警白名单审核发起时间": "2026-05-08 16:08:25",
    "告警白名单审核流程id": "待审核",
    "告警白名单审核流程环节": "待审核",
    "告警白名单审核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "告警白名单审核ID": "H-83326",
    "告警白名单审核流程环节ID": "H-83326",
    "告警白名单审核编号": "H-83326",
    "告警白名单审核名称": "告警白名单审核流程管理-2",
    "发起告警白名单审核状态": "已处理",
    "发起告警白名单审核时间": "2026-05-09 08:33:11",
    "告警白名单审核属性": "已处理",
    "告警白名单审核发起时间": "2026-05-09 08:33:11",
    "告警白名单审核流程id": "已处理",
    "告警白名单审核流程环节": "已处理",
    "告警白名单审核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "告警白名单审核ID": "H-91245",
    "告警白名单审核流程环节ID": "H-91245",
    "告警白名单审核编号": "H-91245",
    "告警白名单审核名称": "告警白名单审核流程管理-3",
    "发起告警白名单审核状态": "处理中",
    "发起告警白名单审核时间": "2026-05-09 09:47:56",
    "告警白名单审核属性": "处理中",
    "告警白名单审核发起时间": "2026-05-09 09:47:56",
    "告警白名单审核流程id": "处理中",
    "告警白名单审核流程环节": "处理中",
    "告警白名单审核创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "告警白名单审核ID": "H-99164",
    "告警白名单审核流程环节ID": "H-99164",
    "告警白名单审核编号": "H-99164",
    "告警白名单审核名称": "告警白名单审核流程管理-4",
    "发起告警白名单审核状态": "待处理",
    "发起告警白名单审核时间": "2026-05-08 09:12:18",
    "告警白名单审核属性": "待处理",
    "告警白名单审核发起时间": "2026-05-08 09:12:18",
    "告警白名单审核流程id": "待处理",
    "告警白名单审核流程环节": "待处理",
    "告警白名单审核创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "告警白名单审核ID": "H-107083",
    "告警白名单审核流程环节ID": "H-107083",
    "告警白名单审核编号": "H-107083",
    "告警白名单审核名称": "告警白名单审核流程管理-5",
    "发起告警白名单审核状态": "处理失败",
    "发起告警白名单审核时间": "2026-05-08 09:35:44",
    "告警白名单审核属性": "处理失败",
    "告警白名单审核发起时间": "2026-05-08 09:35:44",
    "告警白名单审核流程id": "处理失败",
    "告警白名单审核流程环节": "处理失败",
    "告警白名单审核创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "告警白名单审核ID": "H-115002",
    "告警白名单审核流程环节ID": "H-115002",
    "告警白名单审核编号": "H-115002",
    "告警白名单审核名称": "告警白名单审核流程管理-6",
    "发起告警白名单审核状态": "已暂停",
    "发起告警白名单审核时间": "2026-05-08 10:08:06",
    "告警白名单审核属性": "已暂停",
    "告警白名单审核发起时间": "2026-05-08 10:08:06",
    "告警白名单审核流程id": "已暂停",
    "告警白名单审核流程环节": "已暂停",
    "告警白名单审核创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "告警白名单审核ID": "H-122921",
    "告警白名单审核流程环节ID": "H-122921",
    "告警白名单审核编号": "H-122921",
    "告警白名单审核名称": "告警白名单审核流程管理-7",
    "发起告警白名单审核状态": "已完成",
    "发起告警白名单审核时间": "2026-05-08 10:42:31",
    "告警白名单审核属性": "已完成",
    "告警白名单审核发起时间": "2026-05-08 10:42:31",
    "告警白名单审核流程id": "已完成",
    "告警白名单审核流程环节": "已完成",
    "告警白名单审核创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "告警白名单审核ID": "H-130840",
    "告警白名单审核流程环节ID": "H-130840",
    "告警白名单审核编号": "H-130840",
    "告警白名单审核名称": "告警白名单审核流程管理-8",
    "发起告警白名单审核状态": "排队中",
    "发起告警白名单审核时间": "2026-05-08 11:16:09",
    "告警白名单审核属性": "排队中",
    "告警白名单审核发起时间": "2026-05-08 11:16:09",
    "告警白名单审核流程id": "排队中",
    "告警白名单审核流程环节": "排队中",
    "告警白名单审核创建时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
