    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("展示资产类型告警信息", "detail")'>展示资产类型告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产类型告警信息", "audit")'>资产类型告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警处理内容填写", "audit")'>告警处理内容填写</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警处理信息审批", "audit")'>告警处理信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("告警处理流程统计", "statistics")'>告警处理流程统计</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("审核告警处理结果", "audit")'>审核告警处理结果</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "归属信息": "待审核",
    "告警信息编号": "X-51503",
    "展示资产类型告警信息名称": "资产类型告警数据处理-1",
    "展示资产类型告警信息类型": "待审核",
    "展示资产类型告警信息规则": "待审核",
    "展示资产类型告警信息属性": "待审核",
    "展示资产类型告警信息状态_sys_id": "待审核",
    "展示资产类型告警信息状态": "待审核"
  },
  {
    "ID": 2,
    ...
    "归属信息": "已处理",
    "告警信息编号": "X-59422",
    "展示资产类型告警信息名称": "资产类型告警数据处理-2",
    "展示资产类型告警信息类型": "已处理",
    "展示资产类型告警信息规则": "已处理",
    "展示资产类型告警信息属性": "已处理",
    "展示资产类型告警信息状态_sys_id": "已处理",
    "展示资产类型告警信息状态": "已处理"
  },
  {
    "ID": 3,
    ...
    "归属信息": "处理中",
    "告警信息编号": "X-67341",
    "展示资产类型告警信息名称": "资产类型告警数据处理-3",
    "展示资产类型告警信息类型": "处理中",
    "展示资产类型告警信息规则": "处理中",
    "展示资产类型告警信息属性": "处理中",
    "展示资产类型告警信息状态_sys_id": "处理中",
    "展示资产类型告警信息状态": "处理中"
  },
  {
    "ID": 4,
    ...
    "归属信息": "待处理",
    "告警信息编号": "X-75260",
    "展示资产类型告警信息名称": "资产类型告警数据处理-4",
    "展示资产类型告警信息类型": "待处理",
    "展示资产类型告警信息规则": "待处理",
    "展示资产类型告警信息属性": "待处理",
    "展示资产类型告警信息状态_sys_id": "待处理",
    "展示资产类型告警信息状态": "待处理"
  },
  {
    "ID": 5,
    ...
    "归属信息": "处理失败",
    "告警信息编号": "X-83179",
    "展示资产类型告警信息名称": "资产类型告警数据处理-5",
    "展示资产类型告警信息类型": "处理失败",
    "展示资产类型告警信息规则": "处理失败",
    "展示资产类型告警信息属性": "处理失败",
    "展示资产类型告警信息状态_sys_id": "处理失败",
    "展示资产类型告警信息状态": "处理失败"
  },
  {
    "ID": 6,
    ...
    "归属信息": "已暂停",
    "告警信息编号": "X-91098",
    "展示资产类型告警信息名称": "资产类型告警数据处理-6",
    "展示资产类型告警信息类型": "已暂停",
    "展示资产类型告警信息规则": "已暂停",
    "展示资产类型告警信息属性": "已暂停",
    "展示资产类型告警信息状态_sys_id": "已暂停",
    "展示资产类型告警信息状态": "已暂停"
  },
  {
    "ID": 7,
    ...
    "归属信息": "已完成",
    "告警信息编号": "X-99017",
    "展示资产类型告警信息名称": "资产类型告警数据处理-7",
    "展示资产类型告警信息类型": "已完成",
    "展示资产类型告警信息规则": "已完成",
    "展示资产类型告警信息属性": "已完成",
    "展示资产类型告警信息状态_sys_id": "已完成",
    "展示资产类型告警信息状态": "已完成"
  },
  {
    "ID": 8,
    ...
    "归属信息": "排队中",
    "告警信息编号": "X-106936",
    "展示资产类型告警信息名称": "资产类型告警数据处理-8",
    "展示资产类型告警信息类型": "排队中",
    "展示资产类型告警信息规则": "排队中",
    "展示资产类型告警信息属性": "排队中",
    "展示资产类型告警信息状态_sys_id": "排队中",
    "展示资产类型告警信息状态": "排队中"
  },
  {
    "ID": 9,
    ...
    "归属信息": "部分完成",
    "告警信息编号": "X-114855",
    "展示资产类型告警信息名称": "资产类型告警数据处理-9",
    "展示资产类型告警信息类型": "部分完成",
    "展示资产类型告警信息规则": "部分完成",
    "展示资产类型告警信息属性": "部分完成",
    "展示资产类型告警信息状态_sys_id": "部分完成",
    "展示资产类型告警信息状态": "部分完成"
  }
];
const tableColumns = [
  ...
  {
    "prop": "展示资产类型告警信息状态_sys_id",
    "label": "展示资产类型告警信息状态/sys_id",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
