    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象资产查询接口信息", "config")'>修改定级对象资产查询接口信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除定级对象资产查询接口信息")'>删除定级对象资产查询接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象资产查询接口列表", "detail")'>查询定级对象资产查询接口列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("定级对象资产查询接口下发回传同步", "detail")'>定级对象资产查询接口下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("定级对象资产查询接口下发回传任务推送", "detail")'>定级对象资产查询接口下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("定级对象资产查询接口数据下发", "detail")'>定级对象资产查询接口数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定级对象资产查询接口数据分析", "analysis")'>定级对象资产查询接口数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("定级对象资产查询接口数据上报", "detail")'>定级对象资产查询接口数据上报</el-button>
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起定级对象资产审批流程", "workflow")'>发起定级对象资产审批流程</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "定级对象资产查询接口编号": "I-43896",
    "资产": "已启用",
    "类型": "已启用",
    "定级对象资产查询接口规则": "已启用",
    "定级对象资产查询接口属性": "已启用",
    "修改定级对象资产查询接口状态": "已启用",
    "修改定级对象资产查询接口时间": "2026-05-08 15:21:37",
    "修改人": "已启用",
    "定级对象资产查询接口ID": "I-43896",
    "定级对象资产查询接口资产": "已启用",
    "定级对象资产查询接口类型": "已启用"
  },
  {
    "ID": 2,
    "定级对象资产查询接口编号": "I-51815",
    "资产": "已停用",
    "类型": "已停用",
    "定级对象资产查询接口规则": "已停用",
    "定级对象资产查询接口属性": "已停用",
    "修改定级对象资产查询接口状态": "已停用",
    "修改定级对象资产查询接口时间": "2026-05-08 16:08:25",
    "修改人": "已停用",
    "定级对象资产查询接口ID": "I-51815",
    "定级对象资产查询接口资产": "已停用",
    "定级对象资产查询接口类型": "已停用"
  },
  {
    "ID": 3,
    "定级对象资产查询接口编号": "I-59734",
    "资产": "正常",
    "类型": "正常",
    "定级对象资产查询接口规则": "正常",
    "定级对象资产查询接口属性": "正常",
    "修改定级对象资产查询接口状态": "正常",
    "修改定级对象资产查询接口时间": "2026-05-09 08:33:11",
    "修改人": "正常",
    "定级对象资产查询接口ID": "I-59734",
    "定级对象资产查询接口资产": "正常",
    "定级对象资产查询接口类型": "正常"
  },
  {
    "ID": 4,
    "定级对象资产查询接口编号": "I-67653",
    "资产": "异常",
    "类型": "异常",
    "定级对象资产查询接口规则": "异常",
    "定级对象资产查询接口属性": "异常",
    "修改定级对象资产查询接口状态": "异常",
    "修改定级对象资产查询接口时间": "2026-05-09 09:47:56",
    "修改人": "异常",
    "定级对象资产查询接口ID": "I-67653",
    "定级对象资产查询接口资产": "异常",
    "定级对象资产查询接口类型": "异常"
  },
  {
    "ID": 5,
    "定级对象资产查询接口编号": "I-75572",
    "资产": "超时",
    "类型": "超时",
    "定级对象资产查询接口规则": "超时",
    "定级对象资产查询接口属性": "超时",
    "修改定级对象资产查询接口状态": "超时",
    "修改定级对象资产查询接口时间": "2026-05-08 09:12:18",
    "修改人": "超时",
    "定级对象资产查询接口ID": "I-75572",
    "定级对象资产查询接口资产": "超时",
    "定级对象资产查询接口类型": "超时"
  },
  {
    "ID": 6,
    "定级对象资产查询接口编号": "I-83491",
    "资产": "已取消",
    "类型": "已取消",
    "定级对象资产查询接口规则": "已取消",
    "定级对象资产查询接口属性": "已取消",
    "修改定级对象资产查询接口状态": "已取消",
    "修改定级对象资产查询接口时间": "2026-05-08 09:35:44",
    "修改人": "已取消",
    "定级对象资产查询接口ID": "I-83491",
    "定级对象资产查询接口资产": "已取消",
    "定级对象资产查询接口类型": "已取消"
  },
  {
    "ID": 7,
    "定级对象资产查询接口编号": "I-91410",
    "资产": "已驳回",
    "类型": "已驳回",
    "定级对象资产查询接口规则": "已驳回",
    "定级对象资产查询接口属性": "已驳回",
    "修改定级对象资产查询接口状态": "已驳回",
    "修改定级对象资产查询接口时间": "2026-05-08 10:08:06",
    "修改人": "已驳回",
    "定级对象资产查询接口ID": "I-91410",
    "定级对象资产查询接口资产": "已驳回",
    "定级对象资产查询接口类型": "已驳回"
  }
];
