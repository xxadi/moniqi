    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部准确化新增能力化工具", "operation")'>工信部准确化新增能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("工信部准确化修改能力化工具", "operation")'>工信部准确化修改能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部准确化删除能力化工具", "operation")'>工信部准确化删除能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部准确化查询能力化工具", "detail")'>工信部准确化查询能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部提示告警规则", "form")'>新增工信部提示告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部提示告警规则", "config")'>修改工信部提示告警规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部提示告警规则")'>删除工信部提示告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部重要错误告警规则", "form")'>新增工信部重要错误告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部重要错误告警规则", "config")'>修改工信部重要错误告警规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部重要错误告警规则")'>删除工信部重要错误告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核准确性数据预处理", "transform")'>上报数据考核准确性数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据考核准确性数据下发", "operation")'>上报数据考核准确性数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核准确性数据分析", "analysis")'>上报数据考核准确性数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据考核准确性数据上报", "operation")'>上报数据考核准确性数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部准确化ID": "D-5021",
    "工信部准确化编接口上报时间": "2026-05-08 09:35:44",
    "资产校验规则": "已取消",
    "上传时间": "2026-05-08 09:35:44",
    "上传地址": "10.0.0.254",
    "号": "已取消",
    "工信部准确化名称": "工信部准确化修改能力工具-1",
    "工信部准确化新增状态": "已取消",
    "工信部准确化新增时间": "2026-05-08 09:35:44",
    "工信部准确化属性": "已取消",
    "工信部准确化创建时间": "2026-05-08 09:35:44",
    "工信部准确化编号": "D-5021"
  },
  {
    "ID": 2,
    "工信部准确化ID": "D-12940",
    "工信部准确化编接口上报时间": "2026-05-08 10:08:06",
    "资产校验规则": "已驳回",
    "上传时间": "2026-05-08 10:08:06",
    "上传地址": "10.10.1.100",
    "号": "已驳回",
    "工信部准确化名称": "工信部准确化修改能力工具-2",
    "工信部准确化新增状态": "已驳回",
    "工信部准确化新增时间": "2026-05-08 10:08:06",
    "工信部准确化属性": "已驳回",
    "工信部准确化创建时间": "2026-05-08 10:08:06",
    "工信部准确化编号": "D-12940"
  },
  {
    "ID": 3,
    "工信部准确化ID": "D-20859",
    "工信部准确化编接口上报时间": "2026-05-08 10:42:31",
    "资产校验规则": "待审核",
    "上传时间": "2026-05-08 10:42:31",
    "上传地址": "172.16.0.50",
    "号": "待审核",
    "工信部准确化名称": "工信部准确化修改能力工具-3",
    "工信部准确化新增状态": "待审核",
    "工信部准确化新增时间": "2026-05-08 10:42:31",
    "工信部准确化属性": "待审核",
    "工信部准确化创建时间": "2026-05-08 10:42:31",
    "工信部准确化编号": "D-20859"
  },
  {
    "ID": 4,
    "工信部准确化ID": "D-28778",
    "工信部准确化编接口上报时间": "2026-05-08 11:16:09",
    "资产校验规则": "已处理",
    "上传时间": "2026-05-08 11:16:09",
    "上传地址": "192.168.1.200",
    "号": "已处理",
    "工信部准确化名称": "工信部准确化修改能力工具-4",
    "工信部准确化新增状态": "已处理",
    "工信部准确化新增时间": "2026-05-08 11:16:09",
    "工信部准确化属性": "已处理",
    "工信部准确化创建时间": "2026-05-08 11:16:09",
    "工信部准确化编号": "D-28778"
  },
  {
    "ID": 5,
    "工信部准确化ID": "D-36697",
    "工信部准确化编接口上报时间": "2026-05-08 14:03:52",
    "资产校验规则": "处理中",
    "上传时间": "2026-05-08 14:03:52",
    "上传地址": "10.20.5.30",
    "号": "处理中",
    "工信部准确化名称": "工信部准确化修改能力工具-5",
    "工信部准确化新增状态": "处理中",
    "工信部准确化新增时间": "2026-05-08 14:03:52",
    "工信部准确化属性": "处理中",
    "工信部准确化创建时间": "2026-05-08 14:03:52",
    "工信部准确化编号": "D-36697"
  },
  {
    "ID": 6,
    "工信部准确化ID": "D-44616",
    "工信部准确化编接口上报时间": "2026-05-08 15:21:37",
    "资产校验规则": "待处理",
    "上传时间": "2026-05-08 15:21:37",
    "上传地址": "172.20.1.80",
    "号": "待处理",
    "工信部准确化名称": "工信部准确化修改能力工具-6",
    "工信部准确化新增状态": "待处理",
    "工信部准确化新增时间": "2026-05-08 15:21:37",
    "工信部准确化属性": "待处理",
    "工信部准确化创建时间": "2026-05-08 15:21:37",
    "工信部准确化编号": "D-44616"
  },
  {
    "ID": 7,
    "工信部准确化ID": "D-52535",
    "工信部准确化编接口上报时间": "2026-05-08 16:08:25",
    "资产校验规则": "处理失败",
    "上传时间": "2026-05-08 16:08:25",
    "上传地址": "10.0.0.254",
    "号": "处理失败",
    "工信部准确化名称": "工信部准确化修改能力工具-7",
    "工信部准确化新增状态": "处理失败",
    "工信部准确化新增时间": "2026-05-08 16:08:25",
    "工信部准确化属性": "处理失败",
    "工信部准确化创建时间": "2026-05-08 16:08:25",
    "工信部准确化编号": "D-52535"
  }
];
const tableColumns = [
