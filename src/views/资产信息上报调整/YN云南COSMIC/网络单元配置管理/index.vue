    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增网络单元配置信息", "form")'>新增网络单元配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络单元配置信息", "config")'>修改网络单元配置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除网络单元配置信息")'>删除网络单元配置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网络单元配置汇总表", "detail")'>查询网络单元配置汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网络单元配置详情", "detail")'>查询网络单元配置详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入网络单元配置")'>批量导入网络单元配置</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("网络单元配置导出")'>网络单元配置导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "网络单元配置名称": "网络单元配置管理-1",
    "新增网络单元配置状态": "待审核",
    "新增网络单元配置时间": "2026-05-08 14:03:52",
    "网络单元配置属性": "待审核",
    "网络单元配置创建时间": "2026-05-08 14:03:52",
    "网络单元配置所属部门": "网络管理部",
    "网络单元配置负责人": "李四",
    "网络单元配置类型": "待审核",
    "网络单元配置规则": "待审核",
  ...
  },
  {
    ...
    "网络单元配置名称": "网络单元配置管理-2",
    "新增网络单元配置状态": "已处理",
    "新增网络单元配置时间": "2026-05-08 15:21:37",
    "网络单元配置属性": "已处理",
    "网络单元配置创建时间": "2026-05-08 15:21:37",
    "网络单元配置所属部门": "资产管理部",
    "网络单元配置负责人": "王五",
    "网络单元配置类型": "已处理",
    "网络单元配置规则": "已处理",
  ...
  },
  {
    ...
    "网络单元配置名称": "网络单元配置管理-3",
    "新增网络单元配置状态": "处理中",
    "新增网络单元配置时间": "2026-05-08 16:08:25",
    "网络单元配置属性": "处理中",
    "网络单元配置创建时间": "2026-05-08 16:08:25",
    "网络单元配置所属部门": "信息安全部",
    "网络单元配置负责人": "赵六",
    "网络单元配置类型": "处理中",
    "网络单元配置规则": "处理中",
  ...
  },
  {
    ...
    "网络单元配置名称": "网络单元配置管理-4",
    "新增网络单元配置状态": "待处理",
    "新增网络单元配置时间": "2026-05-09 08:33:11",
    "网络单元配置属性": "待处理",
    "网络单元配置创建时间": "2026-05-09 08:33:11",
    "网络单元配置所属部门": "系统运维部",
    "网络单元配置负责人": "system",
    "网络单元配置类型": "待处理",
    "网络单元配置规则": "待处理",
  ...
  },
  {
    ...
    "网络单元配置名称": "网络单元配置管理-5",
    "新增网络单元配置状态": "处理失败",
    "新增网络单元配置时间": "2026-05-09 09:47:56",
    "网络单元配置属性": "处理失败",
    "网络单元配置创建时间": "2026-05-09 09:47:56",
    "网络单元配置所属部门": "数据管理部",
    "网络单元配置负责人": "admin",
    "网络单元配置类型": "处理失败",
    "网络单元配置规则": "处理失败",
  ...
  },
  {
    ...
    "网络单元配置名称": "网络单元配置管理-6",
    "新增网络单元配置状态": "已暂停",
    "新增网络单元配置时间": "2026-05-08 09:12:18",
    "网络单元配置属性": "已暂停",
    "网络单元配置创建时间": "2026-05-08 09:12:18",
    "网络单元配置所属部门": "安全运维部",
    "网络单元配置负责人": "张三",
    "网络单元配置类型": "已暂停",
    "网络单元配置规则": "已暂停",
