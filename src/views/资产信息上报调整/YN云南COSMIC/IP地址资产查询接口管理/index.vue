    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("IP地址资产查询接口信息表", "detail")'>IP地址资产查询接口信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP地址资产查询接口模型", "form")'>新增IP地址资产查询接口模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP地址资产查询接口模型", "config")'>修改IP地址资产查询接口模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP地址资产查询接口模型")'>删除IP地址资产查询接口模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("IP地址资产查询接口查询", "detail")'>IP地址资产查询接口查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("IP地址资产查询接口可视化展示", "detail")'>IP地址资产查询接口可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "IP地址资产查询接口ID": "A-5850",
    "IP地址资产查询接口编号": "A-5850",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-1",
    "IP地址资产查询接口状态": "正常",
    "IP地址资产查询接口时间": "2026-05-08 09:12:18",
    "IP地址资产查询接口属性": "10.10.1.100",
    "IP地址资产查询接口创建时间": "2026-05-08 09:12:18",
    "IP地址资产查询接口所属部门": "安全运维部",
    "IP地址资产查询接口负责人": "张三",
    "IP地址资产查询接口类型": "10.10.1.100",
    "IP地址资产查询接口模型": "10.10.1.100",
    "新增IP地址资产查询接口状态": "正常"
  },
  {
    "ID": 2,
    "IP地址资产查询接口ID": "A-13769",
    "IP地址资产查询接口编号": "A-13769",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-2",
    "IP地址资产查询接口状态": "异常",
    "IP地址资产查询接口时间": "2026-05-08 09:35:44",
    "IP地址资产查询接口属性": "172.16.0.50",
    "IP地址资产查询接口创建时间": "2026-05-08 09:35:44",
    "IP地址资产查询接口所属部门": "网络管理部",
    "IP地址资产查询接口负责人": "李四",
    "IP地址资产查询接口类型": "172.16.0.50",
    "IP地址资产查询接口模型": "172.16.0.50",
    "新增IP地址资产查询接口状态": "异常"
  },
  {
    "ID": 3,
    "IP地址资产查询接口ID": "A-21688",
    "IP地址资产查询接口编号": "A-21688",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-3",
    "IP地址资产查询接口状态": "超时",
    "IP地址资产查询接口时间": "2026-05-08 10:08:06",
    "IP地址资产查询接口属性": "192.168.1.200",
    "IP地址资产查询接口创建时间": "2026-05-08 10:08:06",
    "IP地址资产查询接口所属部门": "资产管理部",
    "IP地址资产查询接口负责人": "王五",
    "IP地址资产查询接口类型": "192.168.1.200",
    "IP地址资产查询接口模型": "192.168.1.200",
    "新增IP地址资产查询接口状态": "超时"
  },
  {
    "ID": 4,
    "IP地址资产查询接口ID": "A-29607",
    "IP地址资产查询接口编号": "A-29607",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-4",
    "IP地址资产查询接口状态": "已取消",
    "IP地址资产查询接口时间": "2026-05-08 10:42:31",
    "IP地址资产查询接口属性": "10.20.5.30",
    "IP地址资产查询接口创建时间": "2026-05-08 10:42:31",
    "IP地址资产查询接口所属部门": "信息安全部",
    "IP地址资产查询接口负责人": "赵六",
    "IP地址资产查询接口类型": "10.20.5.30",
    "IP地址资产查询接口模型": "10.20.5.30",
    "新增IP地址资产查询接口状态": "已取消"
  },
  {
    "ID": 5,
    "IP地址资产查询接口ID": "A-37526",
    "IP地址资产查询接口编号": "A-37526",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-5",
    "IP地址资产查询接口状态": "已驳回",
    "IP地址资产查询接口时间": "2026-05-08 11:16:09",
    "IP地址资产查询接口属性": "172.20.1.80",
    "IP地址资产查询接口创建时间": "2026-05-08 11:16:09",
    "IP地址资产查询接口所属部门": "系统运维部",
    "IP地址资产查询接口负责人": "system",
    "IP地址资产查询接口类型": "172.20.1.80",
    "IP地址资产查询接口模型": "172.20.1.80",
    "新增IP地址资产查询接口状态": "已驳回"
  },
  {
    "ID": 6,
    "IP地址资产查询接口ID": "A-45445",
    "IP地址资产查询接口编号": "A-45445",
    "IP地址资产查询接口名称": "IP地址资产查询接口管理-6",
    "IP地址资产查询接口状态": "待审核",
    "IP地址资产查询接口时间": "2026-05-08 14:03:52",
    "IP地址资产查询接口属性": "10.0.0.254",
    "IP地址资产查询接口创建时间": "2026-05-08 14:03:52",
    "IP地址资产查询接口所属部门": "数据管理部",
    "IP地址资产查询接口负责人": "admin",
    "IP地址资产查询接口类型": "10.0.0.254",
    "IP地址资产查询接口模型": "10.0.0.254",
    "新增IP地址资产查询接口状态": "待审核"
  }
];
const tableColumns = [
