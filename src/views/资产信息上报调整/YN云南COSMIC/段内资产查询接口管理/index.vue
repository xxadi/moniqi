    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改段内资产查询接口信息", "config")'>修改段内资产查询接口信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除段内资产查询接口信息")'>删除段内资产查询接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询段内资产查询接口列表", "detail")'>查询段内资产查询接口列表</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("段内资产查询接口下发回传同步", "detail")'>段内资产查询接口下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("段内资产查询接口下发回传任务推送", "detail")'>段内资产查询接口下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("段内资产查询接口数据下发", "detail")'>段内资产查询接口数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("段内资产查询接口数据分析", "analysis")'>段内资产查询接口数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("段内资产查询接口数据上报", "detail")'>段内资产查询接口数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "段内资产查询接口属性": "处理失败",
    "修改段内资产查询接口状态": "处理失败",
    "修改段内资产查询接口时间": "2026-05-08 10:42:31",
    "修改人": "处理失败",
    "段内资产查询接口ID": "L-67923",
    "段内资产查询接口名称": "段内资产查询接口管理-1",
    "段内资产查询接口类型": "处理失败"
  },
  {
    "ID": 2,
    ...
    "段内资产查询接口属性": "已暂停",
    "修改段内资产查询接口状态": "已暂停",
    "修改段内资产查询接口时间": "2026-05-08 11:16:09",
    "修改人": "已暂停",
    "段内资产查询接口ID": "L-75842",
    "段内资产查询接口名称": "段内资产查询接口管理-2",
    "段内资产查询接口类型": "已暂停"
  },
  {
    "ID": 3,
    ...
    "段内资产查询接口属性": "已完成",
    "修改段内资产查询接口状态": "已完成",
    "修改段内资产查询接口时间": "2026-05-08 14:03:52",
    "修改人": "已完成",
    "段内资产查询接口ID": "L-83761",
    "段内资产查询接口名称": "段内资产查询接口管理-3",
    "段内资产查询接口类型": "已完成"
  },
  {
    "ID": 4,
    ...
    "段内资产查询接口属性": "排队中",
    "修改段内资产查询接口状态": "排队中",
    "修改段内资产查询接口时间": "2026-05-08 15:21:37",
    "修改人": "排队中",
    "段内资产查询接口ID": "L-91680",
    "段内资产查询接口名称": "段内资产查询接口管理-4",
    "段内资产查询接口类型": "排队中"
  },
  {
    "ID": 5,
    ...
    "段内资产查询接口属性": "部分完成",
    "修改段内资产查询接口状态": "部分完成",
    "修改段内资产查询接口时间": "2026-05-08 16:08:25",
    "修改人": "部分完成",
    "段内资产查询接口ID": "L-99599",
    "段内资产查询接口名称": "段内资产查询接口管理-5",
    "段内资产查询接口类型": "部分完成"
  },
  {
    "ID": 6,
    ...
    "段内资产查询接口属性": "已启用",
    "修改段内资产查询接口状态": "已启用",
    "修改段内资产查询接口时间": "2026-05-09 08:33:11",
    "修改人": "已启用",
    "段内资产查询接口ID": "L-107518",
    "段内资产查询接口名称": "段内资产查询接口管理-6",
    "段内资产查询接口类型": "已启用"
  },
  {
    "ID": 7,
    ...
    "段内资产查询接口属性": "已停用",
    "修改段内资产查询接口状态": "已停用",
    "修改段内资产查询接口时间": "2026-05-09 09:47:56",
    "修改人": "已停用",
    "段内资产查询接口ID": "L-115437",
    "段内资产查询接口名称": "段内资产查询接口管理-7",
    "段内资产查询接口类型": "已停用"
  },
  {
    "ID": 8,
    ...
    "段内资产查询接口属性": "正常",
    "修改段内资产查询接口状态": "正常",
    "修改段内资产查询接口时间": "2026-05-08 09:12:18",
    "修改人": "正常",
    "段内资产查询接口ID": "L-123356",
    "段内资产查询接口名称": "段内资产查询接口管理-8",
    "段内资产查询接口类型": "正常"
  },
  {
    "ID": 9,
    ...
    "段内资产查询接口属性": "异常",
    "修改段内资产查询接口状态": "异常",
    "修改段内资产查询接口时间": "2026-05-08 09:35:44",
    "修改人": "异常",
    "段内资产查询接口ID": "L-131275",
    "段内资产查询接口名称": "段内资产查询接口管理-9",
    "段内资产查询接口类型": "异常"
  }
];
const tableColumns = [
