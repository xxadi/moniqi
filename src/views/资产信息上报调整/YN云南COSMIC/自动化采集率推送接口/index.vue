    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率总表推送接口", "transform")'>自动化采集率总表推送接口</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率简表推送接口", "transform")'>自动化采集率简表推送接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("自动化采集率修改接口", "transform")'>自动化采集率修改接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率下发回传同步", "transform")'>自动化采集率下发回传同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率下发回传任务推送", "transform")'>自动化采集率下发回传任务推送</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率下发回传任务信息新增", "transform")'>自动化采集率下发回传任务信息新增</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("自动化采集率下发回传任务信息修改", "transform")'>自动化采集率下发回传任务信息修改</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率下发回传任务信息查询", "detail")'>自动化采集率下发回传任务信息查询</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自动化采集率下发回传任务信息监控", "log")'>自动化采集率下发回传任务信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率下发回传任务结果对比", "transform")'>自动化采集率下发回传任务结果对比</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率下发回传结果同步", "transform")'>自动化采集率下发回传结果同步</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率下发回传任务告警推送", "transform")'>自动化采集率下发回传任务告警推送</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率下发回传任务告警信息生成", "transform")'>自动化采集率下发回传任务告警信息生成</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "推送编号": "T-31271",
    "序号": "部分完成",
    "新增自动化采集率总表名称": "自动化采集率推送接口-1",
    "新增自动化采集率总表类型": "部分完成",
    "新增自动化采集率总表规则": "部分完成",
    "新增自动化采集率总表属性": "部分完成",
    "新增自动化采集率总表状态": "部分完成",
    "拨测创建时间": "2026-05-08 09:35:44",
    "编号": "T-31271",
    "拨测操作人": "admin",
    "拨测接口返回时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 2,
    "推送编号": "T-39190",
    "序号": "已启用",
    "新增自动化采集率总表名称": "自动化采集率推送接口-2",
    "新增自动化采集率总表类型": "已启用",
    "新增自动化采集率总表规则": "已启用",
    "新增自动化采集率总表属性": "已启用",
    "新增自动化采集率总表状态": "已启用",
    "拨测创建时间": "2026-05-08 10:08:06",
    "编号": "T-39190",
    "拨测操作人": "张三",
    "拨测接口返回时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 3,
    "推送编号": "T-47109",
    "序号": "已停用",
    "新增自动化采集率总表名称": "自动化采集率推送接口-3",
    "新增自动化采集率总表类型": "已停用",
    "新增自动化采集率总表规则": "已停用",
    "新增自动化采集率总表属性": "已停用",
    "新增自动化采集率总表状态": "已停用",
    "拨测创建时间": "2026-05-08 10:42:31",
    "编号": "T-47109",
    "拨测操作人": "李四",
    "拨测接口返回时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 4,
    "推送编号": "T-55028",
    "序号": "正常",
    "新增自动化采集率总表名称": "自动化采集率推送接口-4",
    "新增自动化采集率总表类型": "正常",
    "新增自动化采集率总表规则": "正常",
    "新增自动化采集率总表属性": "正常",
    "新增自动化采集率总表状态": "正常",
    "拨测创建时间": "2026-05-08 11:16:09",
    "编号": "T-55028",
    "拨测操作人": "王五",
    "拨测接口返回时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 5,
    "推送编号": "T-62947",
    "序号": "异常",
    "新增自动化采集率总表名称": "自动化采集率推送接口-5",
    "新增自动化采集率总表类型": "异常",
    "新增自动化采集率总表规则": "异常",
    "新增自动化采集率总表属性": "异常",
    "新增自动化采集率总表状态": "异常",
    "拨测创建时间": "2026-05-08 14:03:52",
    "编号": "T-62947",
    "拨测操作人": "赵六",
    "拨测接口返回时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 6,
    "推送编号": "T-70866",
    "序号": "超时",
    "新增自动化采集率总表名称": "自动化采集率推送接口-6",
    "新增自动化采集率总表类型": "超时",
    "新增自动化采集率总表规则": "超时",
    "新增自动化采集率总表属性": "超时",
    "新增自动化采集率总表状态": "超时",
    "拨测创建时间": "2026-05-08 15:21:37",
    "编号": "T-70866",
    "拨测操作人": "system",
    "拨测接口返回时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 7,
    "推送编号": "T-78785",
    "序号": "已取消",
    "新增自动化采集率总表名称": "自动化采集率推送接口-7",
    "新增自动化采集率总表类型": "已取消",
    "新增自动化采集率总表规则": "已取消",
    "新增自动化采集率总表属性": "已取消",
    "新增自动化采集率总表状态": "已取消",
    "拨测创建时间": "2026-05-08 16:08:25",
    "编号": "T-78785",
    "拨测操作人": "admin",
    "拨测接口返回时间": "2026-05-08 16:08:25"
  }
];
const tableColumns = [
  {
