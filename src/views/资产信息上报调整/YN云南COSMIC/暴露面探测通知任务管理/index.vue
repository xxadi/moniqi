    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增互联网暴露面告警设置信息", "form")'>新增互联网暴露面告警设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改互联网暴露面告警设置信息", "config")'>修改互联网暴露面告警设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除互联网暴露面告警设置信息")'>删除互联网暴露面告警设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("互联网暴露面告警错误信息监控", "log")'>互联网暴露面告警错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面告警错误事件通知", "audit")'>互联网暴露面告警错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面告警错误事件通知删除", "operation")'>互联网暴露面告警错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("互联网暴露面告警错误事件通知查询", "detail")'>互联网暴露面告警错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增互联网暴露面告警防篡改信息", "form")'>新增互联网暴露面告警防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改互联网暴露面告警防篡改信息", "config")'>修改互联网暴露面告警防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除互联网暴露面告警防篡改信息")'>删除互联网暴露面告警防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "互联网暴露面告警ID": "D-39523",
    "互联网暴露面告警编号": "D-39523",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-1",
    "新增互联网暴露面告警状态": "处理失败",
    "新增互联网暴露面告警时间": "2026-05-08 10:42:31",
    "新增互联网暴露面告警设置时间_": "2026-05-08 10:42:31",
    "互联网暴露面告警属性": "处理失败",
    "互联网暴露面告警创建时间": "2026-05-08 10:42:31",
    "新增互联网暴露面告警设置结果": "处理失败",
    "告警ID": "D-39523",
    "互联网暴露面告警所属部门": "网络管理部",
    "互联网暴露面告警负责人": "李四"
  },
  {
    ...
    "互联网暴露面告警ID": "D-47442",
    "互联网暴露面告警编号": "D-47442",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-2",
    "新增互联网暴露面告警状态": "已暂停",
    "新增互联网暴露面告警时间": "2026-05-08 11:16:09",
    "新增互联网暴露面告警设置时间_": "2026-05-08 11:16:09",
    "互联网暴露面告警属性": "已暂停",
    "互联网暴露面告警创建时间": "2026-05-08 11:16:09",
    "新增互联网暴露面告警设置结果": "已暂停",
    "告警ID": "D-47442",
    "互联网暴露面告警所属部门": "资产管理部",
    "互联网暴露面告警负责人": "王五"
  },
  {
    ...
    "互联网暴露面告警ID": "D-55361",
    "互联网暴露面告警编号": "D-55361",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-3",
    "新增互联网暴露面告警状态": "已完成",
    "新增互联网暴露面告警时间": "2026-05-08 14:03:52",
    "新增互联网暴露面告警设置时间_": "2026-05-08 14:03:52",
    "互联网暴露面告警属性": "已完成",
    "互联网暴露面告警创建时间": "2026-05-08 14:03:52",
    "新增互联网暴露面告警设置结果": "已完成",
    "告警ID": "D-55361",
    "互联网暴露面告警所属部门": "信息安全部",
    "互联网暴露面告警负责人": "赵六"
  },
  {
    ...
    "互联网暴露面告警ID": "D-63280",
    "互联网暴露面告警编号": "D-63280",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-4",
    "新增互联网暴露面告警状态": "排队中",
    "新增互联网暴露面告警时间": "2026-05-08 15:21:37",
    "新增互联网暴露面告警设置时间_": "2026-05-08 15:21:37",
    "互联网暴露面告警属性": "排队中",
    "互联网暴露面告警创建时间": "2026-05-08 15:21:37",
    "新增互联网暴露面告警设置结果": "排队中",
    "告警ID": "D-63280",
    "互联网暴露面告警所属部门": "系统运维部",
    "互联网暴露面告警负责人": "system"
  },
  {
    ...
    "互联网暴露面告警ID": "D-71199",
    "互联网暴露面告警编号": "D-71199",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-5",
    "新增互联网暴露面告警状态": "部分完成",
    "新增互联网暴露面告警时间": "2026-05-08 16:08:25",
    "新增互联网暴露面告警设置时间_": "2026-05-08 16:08:25",
    "互联网暴露面告警属性": "部分完成",
    "互联网暴露面告警创建时间": "2026-05-08 16:08:25",
    "新增互联网暴露面告警设置结果": "部分完成",
    "告警ID": "D-71199",
    "互联网暴露面告警所属部门": "数据管理部",
    "互联网暴露面告警负责人": "admin"
  },
  {
    ...
    "互联网暴露面告警ID": "D-79118",
    "互联网暴露面告警编号": "D-79118",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-6",
    "新增互联网暴露面告警状态": "已启用",
    "新增互联网暴露面告警时间": "2026-05-09 08:33:11",
    "新增互联网暴露面告警设置时间_": "2026-05-09 08:33:11",
    "互联网暴露面告警属性": "已启用",
    "互联网暴露面告警创建时间": "2026-05-09 08:33:11",
    "新增互联网暴露面告警设置结果": "已启用",
    "告警ID": "D-79118",
    "互联网暴露面告警所属部门": "安全运维部",
    "互联网暴露面告警负责人": "张三"
  },
  {
    ...
    "互联网暴露面告警ID": "D-87037",
    "互联网暴露面告警编号": "D-87037",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-7",
    "新增互联网暴露面告警状态": "已停用",
    "新增互联网暴露面告警时间": "2026-05-09 09:47:56",
    "新增互联网暴露面告警设置时间_": "2026-05-09 09:47:56",
    "互联网暴露面告警属性": "已停用",
    "互联网暴露面告警创建时间": "2026-05-09 09:47:56",
    "新增互联网暴露面告警设置结果": "已停用",
    "告警ID": "D-87037",
    "互联网暴露面告警所属部门": "网络管理部",
    "互联网暴露面告警负责人": "李四"
  },
  {
    ...
    "互联网暴露面告警ID": "D-94956",
    "互联网暴露面告警编号": "D-94956",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-8",
    "新增互联网暴露面告警状态": "正常",
    "新增互联网暴露面告警时间": "2026-05-08 09:12:18",
    "新增互联网暴露面告警设置时间_": "2026-05-08 09:12:18",
    "互联网暴露面告警属性": "正常",
    "互联网暴露面告警创建时间": "2026-05-08 09:12:18",
    "新增互联网暴露面告警设置结果": "正常",
    "告警ID": "D-94956",
    "互联网暴露面告警所属部门": "资产管理部",
    "互联网暴露面告警负责人": "王五"
  },
  {
    ...
    "互联网暴露面告警ID": "D-102875",
    "互联网暴露面告警编号": "D-102875",
    "互联网暴露面告警名称": "暴露面探测通知任务管理-9",
    "新增互联网暴露面告警状态": "异常",
    "新增互联网暴露面告警时间": "2026-05-08 09:35:44",
    "新增互联网暴露面告警设置时间_": "2026-05-08 09:35:44",
    "互联网暴露面告警属性": "异常",
    "互联网暴露面告警创建时间": "2026-05-08 09:35:44",
    "新增互联网暴露面告警设置结果": "异常",
    "告警ID": "D-102875",
    "互联网暴露面告警所属部门": "信息安全部",
    "互联网暴露面告警负责人": "赵六"
...
const tableColumns = [
  ...
  {
    "prop": "新增互联网暴露面告警设置时间_",
    "label": "新增互联网暴露面告警设置时间。",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
