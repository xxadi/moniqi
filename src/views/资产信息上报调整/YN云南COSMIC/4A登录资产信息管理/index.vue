    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A登录资产信息查询", "detail")'>4A登录资产信息查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A登录资产信息任务", "form")'>新增4A登录资产信息任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义4A资产登录信息", "operation")'>定义4A资产登录信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A资产登录信息", "config")'>修改4A资产登录信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A资产登录信息")'>删除4A资产登录信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A资产登录数据获取", "operation")'>4A资产登录数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A资产登录数据上传", "form")'>4A资产登录数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A资产登录数据接口监控", "log")'>4A资产登录数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A资产登录汇总报告详情", "detail")'>查询4A资产登录汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A资产登录明细报告详情", "detail")'>查询4A资产登录明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A登录资产信息模型", "form")'>新增4A登录资产信息模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A登录资产信息模型", "config")'>修改4A登录资产信息模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A登录资产信息模型")'>删除4A登录资产信息模型</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "流水号": "X-67389",
    "4A登录资产信息名称": "4A登录资产信息管理-1",
    "4A登录资产信息创建时间": "2026-05-09 09:47:56",
    "表类型": "已取消",
    "列表模型": "已取消",
    "列表属性": "已取消",
    "查询4A登录资产信息列表状态": "已取消",
    "编号": "X-67389",
    "查询时间": "2026-05-09 09:47:56",
    "4A登录资产信息列表名称": "4A登录资产信息管理-1",
    "查询主信息": "已取消",
    "4A登录资产信息列表模型": "已取消"
  },
  {
    "ID": 2,
    "流水号": "X-75308",
    "4A登录资产信息名称": "4A登录资产信息管理-2",
    "4A登录资产信息创建时间": "2026-05-08 09:12:18",
    "表类型": "已驳回",
    "列表模型": "已驳回",
    "列表属性": "已驳回",
    "查询4A登录资产信息列表状态": "已驳回",
    "编号": "X-75308",
    "查询时间": "2026-05-08 09:12:18",
    "4A登录资产信息列表名称": "4A登录资产信息管理-2",
    "查询主信息": "已驳回",
    "4A登录资产信息列表模型": "已驳回"
  },
  {
    "ID": 3,
    "流水号": "X-83227",
    "4A登录资产信息名称": "4A登录资产信息管理-3",
    "4A登录资产信息创建时间": "2026-05-08 09:35:44",
    "表类型": "待审核",
    "列表模型": "待审核",
    "列表属性": "待审核",
    "查询4A登录资产信息列表状态": "待审核",
    "编号": "X-83227",
    "查询时间": "2026-05-08 09:35:44",
    "4A登录资产信息列表名称": "4A登录资产信息管理-3",
    "查询主信息": "待审核",
    "4A登录资产信息列表模型": "待审核"
  },
  {
    "ID": 4,
    "流水号": "X-91146",
    "4A登录资产信息名称": "4A登录资产信息管理-4",
    "4A登录资产信息创建时间": "2026-05-08 10:08:06",
    "表类型": "已处理",
    "列表模型": "已处理",
    "列表属性": "已处理",
    "查询4A登录资产信息列表状态": "已处理",
    "编号": "X-91146",
    "查询时间": "2026-05-08 10:08:06",
    "4A登录资产信息列表名称": "4A登录资产信息管理-4",
    "查询主信息": "已处理",
    "4A登录资产信息列表模型": "已处理"
  },
  {
    "ID": 5,
    "流水号": "X-99065",
    "4A登录资产信息名称": "4A登录资产信息管理-5",
    "4A登录资产信息创建时间": "2026-05-08 10:42:31",
    "表类型": "处理中",
    "列表模型": "处理中",
    "列表属性": "处理中",
    "查询4A登录资产信息列表状态": "处理中",
    "编号": "X-99065",
    "查询时间": "2026-05-08 10:42:31",
    "4A登录资产信息列表名称": "4A登录资产信息管理-5",
    "查询主信息": "处理中",
    "4A登录资产信息列表模型": "处理中"
  },
  {
    "ID": 6,
    "流水号": "X-106984",
    "4A登录资产信息名称": "4A登录资产信息管理-6",
    "4A登录资产信息创建时间": "2026-05-08 11:16:09",
    "表类型": "待处理",
    "列表模型": "待处理",
    "列表属性": "待处理",
    "查询4A登录资产信息列表状态": "待处理",
    "编号": "X-106984",
    "查询时间": "2026-05-08 11:16:09",
    "4A登录资产信息列表名称": "4A登录资产信息管理-6",
    "查询主信息": "待处理",
    "4A登录资产信息列表模型": "待处理"
  },
  {
    "ID": 7,
    "流水号": "X-114903",
    "4A登录资产信息名称": "4A登录资产信息管理-7",
    "4A登录资产信息创建时间": "2026-05-08 14:03:52",
    "表类型": "处理失败",
    "列表模型": "处理失败",
    "列表属性": "处理失败",
    "查询4A登录资产信息列表状态": "处理失败",
    "编号": "X-114903",
    "查询时间": "2026-05-08 14:03:52",
    "4A登录资产信息列表名称": "4A登录资产信息管理-7",
    "查询主信息": "处理失败",
    "4A登录资产信息列表模型": "处理失败"
  },
  {
    "ID": 8,
    "流水号": "X-122822",
    "4A登录资产信息名称": "4A登录资产信息管理-8",
    "4A登录资产信息创建时间": "2026-05-08 15:21:37",
    "表类型": "已暂停",
    "列表模型": "已暂停",
    "列表属性": "已暂停",
    "查询4A登录资产信息列表状态": "已暂停",
    "编号": "X-122822",
    "查询时间": "2026-05-08 15:21:37",
    "4A登录资产信息列表名称": "4A登录资产信息管理-8",
    "查询主信息": "已暂停",
    "4A登录资产信息列表模型": "已暂停"
  },
  {
    "ID": 9,
    "流水号": "X-130741",
    "4A登录资产信息名称": "4A登录资产信息管理-9",
    "4A登录资产信息创建时间": "2026-05-08 16:08:25",
    "表类型": "已完成",
    "列表模型": "已完成",
    "列表属性": "已完成",
    "查询4A登录资产信息列表状态": "已完成",
    "编号": "X-130741",
    "查询时间": "2026-05-08 16:08:25",
    "4A登录资产信息列表名称": "4A登录资产信息管理-9",
    "查询主信息": "已完成",
    "4A登录资产信息列表模型": "已完成"
  },
  {
    "ID": 10,
    "流水号": "X-138660",
    "4A登录资产信息名称": "4A登录资产信息管理-10",
    "4A登录资产信息创建时间": "2026-05-09 08:33:11",
    "表类型": "排队中",
    "列表模型": "排队中",
    "列表属性": "排队中",
    "查询4A登录资产信息列表状态": "排队中",
    "编号": "X-138660",
    "查询时间": "2026-05-09 08:33:11",
    "4A登录资产信息列表名称": "4A登录资产信息管理-10",
    "查询主信息": "排队中",
    "4A登录资产信息列表模型": "排队中"
  }
];
