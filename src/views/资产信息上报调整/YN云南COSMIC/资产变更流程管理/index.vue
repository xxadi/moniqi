    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起资产变更流程", "workflow")'>发起资产变更流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产变更指派信息", "form")'>新增资产变更指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产变更流程", "form")'>新增资产变更流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产变更流程信息", "config")'>修改资产变更流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更流程删除", "operation")'>资产变更流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更流程查询", "detail")'>资产变更流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更附件上传", "form")'>资产变更附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产变更流程图查看", "preview")'>资产变更流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产变更流程通知", "audit")'>资产变更流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产变更结果逐级审批", "audit")'>资产变更结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产变更结果拒绝和驳回", "approval")'>资产变更结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产变更名称": "资产变更流程管理-1",
    "发起资产变更状态": "已驳回",
    "发起资产变更时间": "2026-05-08 10:08:06",
    "资产变更属性": "已驳回",
    "资产变更发起时间": "2026-05-08 10:08:06",
    "资产变更流程id": "已驳回",
    "资产变更流程环节": "已驳回",
    "资产变更创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 2,
    "资产变更ID": "S-11421",
    ...
    "资产变更名称": "资产变更流程管理-2",
    "发起资产变更状态": "待审核",
    "发起资产变更时间": "2026-05-08 10:42:31",
    "资产变更属性": "待审核",
    "资产变更发起时间": "2026-05-08 10:42:31",
    "资产变更流程id": "待审核",
    "资产变更流程环节": "待审核",
    "资产变更创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 3,
    "资产变更ID": "S-19340",
    ...
    "资产变更名称": "资产变更流程管理-3",
    "发起资产变更状态": "已处理",
    "发起资产变更时间": "2026-05-08 11:16:09",
    "资产变更属性": "已处理",
    "资产变更发起时间": "2026-05-08 11:16:09",
    "资产变更流程id": "已处理",
    "资产变更流程环节": "已处理",
    "资产变更创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 4,
    "资产变更ID": "S-27259",
    ...
    "资产变更名称": "资产变更流程管理-4",
    "发起资产变更状态": "处理中",
    "发起资产变更时间": "2026-05-08 14:03:52",
    "资产变更属性": "处理中",
    "资产变更发起时间": "2026-05-08 14:03:52",
    "资产变更流程id": "处理中",
    "资产变更流程环节": "处理中",
    "资产变更创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 5,
    "资产变更ID": "S-35178",
    ...
    "资产变更名称": "资产变更流程管理-5",
    "发起资产变更状态": "待处理",
    "发起资产变更时间": "2026-05-08 15:21:37",
    "资产变更属性": "待处理",
    "资产变更发起时间": "2026-05-08 15:21:37",
    "资产变更流程id": "待处理",
    "资产变更流程环节": "待处理",
    "资产变更创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 6,
    "资产变更ID": "S-43097",
    ...
    "资产变更名称": "资产变更流程管理-6",
    "发起资产变更状态": "处理失败",
    "发起资产变更时间": "2026-05-08 16:08:25",
    "资产变更属性": "处理失败",
    "资产变更发起时间": "2026-05-08 16:08:25",
    "资产变更流程id": "处理失败",
    "资产变更流程环节": "处理失败",
    "资产变更创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 7,
    "资产变更ID": "S-51016",
    ...
    "资产变更名称": "资产变更流程管理-7",
    "发起资产变更状态": "已暂停",
    "发起资产变更时间": "2026-05-09 08:33:11",
    "资产变更属性": "已暂停",
    "资产变更发起时间": "2026-05-09 08:33:11",
    "资产变更流程id": "已暂停",
    "资产变更流程环节": "已暂停",
    "资产变更创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 8,
    "资产变更ID": "S-58935",
    ...
    "资产变更名称": "资产变更流程管理-8",
    "发起资产变更状态": "已完成",
    "发起资产变更时间": "2026-05-09 09:47:56",
    "资产变更属性": "已完成",
    "资产变更发起时间": "2026-05-09 09:47:56",
    "资产变更流程id": "已完成",
    "资产变更流程环节": "已完成",
    "资产变更创建时间": "2026-05-09 09:47:56"
  }
];
const tableColumns = [
  {
