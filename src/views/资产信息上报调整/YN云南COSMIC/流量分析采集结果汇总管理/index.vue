    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析采集结果汇总信息表", "analysis")'>流量分析采集结果汇总信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析采集结果汇总模型", "form")'>新增流量分析采集结果汇总模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析采集结果汇总模型", "config")'>修改流量分析采集结果汇总模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量分析采集结果汇总模型")'>删除流量分析采集结果汇总模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析采集结果汇总查询", "analysis")'>流量分析采集结果汇总查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析采集结果汇总可视化展示", "analysis")'>流量分析采集结果汇总可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起流量分析结果审核流程", "initiate_audit")'>发起流量分析结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析结果审核指派信息", "form")'>新增流量分析结果审核指派信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "流量分析采集结果汇总ID": "B-48569",
    "流量分析采集结果汇总编号": "B-48569",
    "流量分析采集结果汇总名称": "已停用",
    "流量分析采集结果汇总状态": "已停用",
    "流量分析采集结果汇总时间": "2026-05-09 09:47:56",
    "流量分析采集结果汇总属性": "已停用",
    "流量分析采集结果汇总创建时间": "2026-05-09 09:47:56",
    "流量分析采集结果汇总所属部门": "已停用",
    "流量分析采集结果汇总负责人": "已停用",
    "流量分析采集结果汇总类型": "已停用",
    "流量分析采集结果汇总模型": "已停用",
  ...
  {
    "ID": 2,
    "流量分析采集结果汇总ID": "B-56488",
    "流量分析采集结果汇总编号": "B-56488",
    "流量分析采集结果汇总名称": "正常",
    "流量分析采集结果汇总状态": "正常",
    "流量分析采集结果汇总时间": "2026-05-08 09:12:18",
    "流量分析采集结果汇总属性": "正常",
    "流量分析采集结果汇总创建时间": "2026-05-08 09:12:18",
    "流量分析采集结果汇总所属部门": "正常",
    "流量分析采集结果汇总负责人": "正常",
    "流量分析采集结果汇总类型": "正常",
    "流量分析采集结果汇总模型": "正常",
  ...
  {
    "ID": 3,
    "流量分析采集结果汇总ID": "B-64407",
    "流量分析采集结果汇总编号": "B-64407",
    "流量分析采集结果汇总名称": "异常",
    "流量分析采集结果汇总状态": "异常",
    "流量分析采集结果汇总时间": "2026-05-08 09:35:44",
    "流量分析采集结果汇总属性": "异常",
    "流量分析采集结果汇总创建时间": "2026-05-08 09:35:44",
    "流量分析采集结果汇总所属部门": "异常",
    "流量分析采集结果汇总负责人": "异常",
    "流量分析采集结果汇总类型": "异常",
    "流量分析采集结果汇总模型": "异常",
  ...
  {
    "ID": 4,
    "流量分析采集结果汇总ID": "B-72326",
    "流量分析采集结果汇总编号": "B-72326",
    "流量分析采集结果汇总名称": "超时",
    "流量分析采集结果汇总状态": "超时",
    "流量分析采集结果汇总时间": "2026-05-08 10:08:06",
    "流量分析采集结果汇总属性": "超时",
    "流量分析采集结果汇总创建时间": "2026-05-08 10:08:06",
    "流量分析采集结果汇总所属部门": "超时",
    "流量分析采集结果汇总负责人": "超时",
    "流量分析采集结果汇总类型": "超时",
    "流量分析采集结果汇总模型": "超时",
  ...
  {
    "ID": 5,
    "流量分析采集结果汇总ID": "B-80245",
    "流量分析采集结果汇总编号": "B-80245",
    "流量分析采集结果汇总名称": "已取消",
    "流量分析采集结果汇总状态": "已取消",
    "流量分析采集结果汇总时间": "2026-05-08 10:42:31",
    "流量分析采集结果汇总属性": "已取消",
    "流量分析采集结果汇总创建时间": "2026-05-08 10:42:31",
    "流量分析采集结果汇总所属部门": "已取消",
    "流量分析采集结果汇总负责人": "已取消",
    "流量分析采集结果汇总类型": "已取消",
    "流量分析采集结果汇总模型": "已取消",
  ...
  {
    "ID": 6,
    "流量分析采集结果汇总ID": "B-88164",
    "流量分析采集结果汇总编号": "B-88164",
    "流量分析采集结果汇总名称": "已驳回",
    "流量分析采集结果汇总状态": "已驳回",
    "流量分析采集结果汇总时间": "2026-05-08 11:16:09",
    "流量分析采集结果汇总属性": "已驳回",
    "流量分析采集结果汇总创建时间": "2026-05-08 11:16:09",
    "流量分析采集结果汇总所属部门": "已驳回",
    "流量分析采集结果汇总负责人": "已驳回",
    "流量分析采集结果汇总类型": "已驳回",
    "流量分析采集结果汇总模型": "已驳回",
  ...
  {
    "ID": 7,
    "流量分析采集结果汇总ID": "B-96083",
    "流量分析采集结果汇总编号": "B-96083",
    "流量分析采集结果汇总名称": "待审核",
    "流量分析采集结果汇总状态": "待审核",
    "流量分析采集结果汇总时间": "2026-05-08 14:03:52",
    "流量分析采集结果汇总属性": "待审核",
    "流量分析采集结果汇总创建时间": "2026-05-08 14:03:52",
    "流量分析采集结果汇总所属部门": "待审核",
    "流量分析采集结果汇总负责人": "待审核",
    "流量分析采集结果汇总类型": "待审核",
    "流量分析采集结果汇总模型": "待审核",
  ...
  {
    "ID": 8,
    "流量分析采集结果汇总ID": "B-104002",
    "流量分析采集结果汇总编号": "B-104002",
    "流量分析采集结果汇总名称": "已处理",
    "流量分析采集结果汇总状态": "已处理",
    "流量分析采集结果汇总时间": "2026-05-08 15:21:37",
    "流量分析采集结果汇总属性": "已处理",
    "流量分析采集结果汇总创建时间": "2026-05-08 15:21:37",
    "流量分析采集结果汇总所属部门": "已处理",
    "流量分析采集结果汇总负责人": "已处理",
    "流量分析采集结果汇总类型": "已处理",
    "流量分析采集结果汇总模型": "已处理",
  ...
  {
    "ID": 9,
    "流量分析采集结果汇总ID": "B-111921",
    "流量分析采集结果汇总编号": "B-111921",
    "流量分析采集结果汇总名称": "处理中",
    "流量分析采集结果汇总状态": "处理中",
    "流量分析采集结果汇总时间": "2026-05-08 16:08:25",
    "流量分析采集结果汇总属性": "处理中",
    "流量分析采集结果汇总创建时间": "2026-05-08 16:08:25",
    "流量分析采集结果汇总所属部门": "处理中",
    "流量分析采集结果汇总负责人": "处理中",
    "流量分析采集结果汇总类型": "处理中",
    "流量分析采集结果汇总模型": "处理中",
  ...
  {
    "ID": 10,
    "流量分析采集结果汇总ID": "B-119840",
    "流量分析采集结果汇总编号": "B-119840",
    "流量分析采集结果汇总名称": "待处理",
    "流量分析采集结果汇总状态": "待处理",
    "流量分析采集结果汇总时间": "2026-05-09 08:33:11",
    "流量分析采集结果汇总属性": "待处理",
    "流量分析采集结果汇总创建时间": "2026-05-09 08:33:11",
    "流量分析采集结果汇总所属部门": "待处理",
    "流量分析采集结果汇总负责人": "待处理",
    "流量分析采集结果汇总类型": "待处理",
    "流量分析采集结果汇总模型": "待处理",
