    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增高危端口汇总报表信息", "form")'>新增高危端口汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增高危端口明细报表信息", "form")'>新增高危端口明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询高危端口汇总报表详情", "detail")'>查询高危端口汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询高危端口明细报表详情", "detail")'>查询高危端口明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("高危端口汇总报表导出")'>高危端口汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("高危端口明细报表导出")'>高危端口明细报表导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "高危端口汇总报表属性": "已暂停",
    "新增高危端口汇总报表状态": "已暂停",
    "新增高危端口汇总报表时间": "2026-05-08 11:16:09",
    "高危端口汇总报表创建时间": "2026-05-08 11:16:09",
    "汇总报表编号": "E-83204",
    "报表ID": "E-83204",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "高危端口汇总报表属性": "已完成",
    "新增高危端口汇总报表状态": "已完成",
    "新增高危端口汇总报表时间": "2026-05-08 14:03:52",
    "高危端口汇总报表创建时间": "2026-05-08 14:03:52",
    "汇总报表编号": "E-91123",
    "报表ID": "E-91123",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "高危端口汇总报表属性": "排队中",
    "新增高危端口汇总报表状态": "排队中",
    "新增高危端口汇总报表时间": "2026-05-08 15:21:37",
    "高危端口汇总报表创建时间": "2026-05-08 15:21:37",
    "汇总报表编号": "E-99042",
    "报表ID": "E-99042",
    "汇总报表所属部门": "系统运维部"
  },
  {
    ...
    "高危端口汇总报表属性": "部分完成",
    "新增高危端口汇总报表状态": "部分完成",
    "新增高危端口汇总报表时间": "2026-05-08 16:08:25",
    "高危端口汇总报表创建时间": "2026-05-08 16:08:25",
    "汇总报表编号": "E-106961",
    "报表ID": "E-106961",
    "汇总报表所属部门": "数据管理部"
  },
  {
    ...
    "高危端口汇总报表属性": "已启用",
    "新增高危端口汇总报表状态": "已启用",
    "新增高危端口汇总报表时间": "2026-05-09 08:33:11",
    "高危端口汇总报表创建时间": "2026-05-09 08:33:11",
    "汇总报表编号": "E-114880",
    "报表ID": "E-114880",
    "汇总报表所属部门": "安全运维部"
  },
  {
    ...
    "高危端口汇总报表属性": "已停用",
    "新增高危端口汇总报表状态": "已停用",
    "新增高危端口汇总报表时间": "2026-05-09 09:47:56",
    "高危端口汇总报表创建时间": "2026-05-09 09:47:56",
    "汇总报表编号": "E-122799",
    "报表ID": "E-122799",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "高危端口汇总报表属性": "正常",
    "新增高危端口汇总报表状态": "正常",
    "新增高危端口汇总报表时间": "2026-05-08 09:12:18",
    "高危端口汇总报表创建时间": "2026-05-08 09:12:18",
    "汇总报表编号": "E-130718",
    "报表ID": "E-130718",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "高危端口汇总报表属性": "异常",
    "新增高危端口汇总报表状态": "异常",
    "新增高危端口汇总报表时间": "2026-05-08 09:35:44",
    "高危端口汇总报表创建时间": "2026-05-08 09:35:44",
    "汇总报表编号": "E-138637",
    "报表ID": "E-138637",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "高危端口汇总报表属性": "超时",
    "新增高危端口汇总报表状态": "超时",
    "新增高危端口汇总报表时间": "2026-05-08 10:08:06",
    "高危端口汇总报表创建时间": "2026-05-08 10:08:06",
    "汇总报表编号": "E-146556",
    "报表ID": "E-146556",
    "汇总报表所属部门": "系统运维部"
  },
  {
    ...
    "高危端口汇总报表属性": "已取消",
    "新增高危端口汇总报表状态": "已取消",
    "新增高危端口汇总报表时间": "2026-05-08 10:42:31",
    "高危端口汇总报表创建时间": "2026-05-08 10:42:31",
    "汇总报表编号": "E-154475",
    "报表ID": "E-154475",
    "汇总报表所属部门": "数据管理部"
  }
