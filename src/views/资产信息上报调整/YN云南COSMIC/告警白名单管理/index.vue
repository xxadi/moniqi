    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增告警白名单信息", "form")'>新增告警白名单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改告警白名单信息", "config")'>修改告警白名单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除告警白名单信息")'>删除告警白名单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询告警白名单列表", "detail")'>查询告警白名单列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询告警白名单详情", "detail")'>查询告警白名单详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入告警白名单")'>批量导入告警白名单</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("告警白名单导出")'>告警白名单导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("告警白名单监控", "log")'>告警白名单监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("告警白名单监控告警", "alert")'>告警白名单监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "告警白名单名称": "告警白名单管理-1",
    "新增告警白名单状态": "已驳回",
    "新增告警白名单时间": "2026-05-09 08:33:11",
    "告警白名单属性": "已驳回",
    "告警白名单创建时间": "2026-05-09 08:33:11",
    "告警白名单所属部门": "安全运维部",
    "告警白名单负责人": "张三",
    "告警白名单类型": "已驳回",
    "告警白名单规则": "已驳回",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-2",
    "新增告警白名单状态": "待审核",
    "新增告警白名单时间": "2026-05-09 09:47:56",
    "告警白名单属性": "待审核",
    "告警白名单创建时间": "2026-05-09 09:47:56",
    "告警白名单所属部门": "网络管理部",
    "告警白名单负责人": "李四",
    "告警白名单类型": "待审核",
    "告警白名单规则": "待审核",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-3",
    "新增告警白名单状态": "已处理",
    "新增告警白名单时间": "2026-05-08 09:12:18",
    "告警白名单属性": "已处理",
    "告警白名单创建时间": "2026-05-08 09:12:18",
    "告警白名单所属部门": "资产管理部",
    "告警白名单负责人": "王五",
    "告警白名单类型": "已处理",
    "告警白名单规则": "已处理",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-4",
    "新增告警白名单状态": "处理中",
    "新增告警白名单时间": "2026-05-08 09:35:44",
    "告警白名单属性": "处理中",
    "告警白名单创建时间": "2026-05-08 09:35:44",
    "告警白名单所属部门": "信息安全部",
    "告警白名单负责人": "赵六",
    "告警白名单类型": "处理中",
    "告警白名单规则": "处理中",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-5",
    "新增告警白名单状态": "待处理",
    "新增告警白名单时间": "2026-05-08 10:08:06",
    "告警白名单属性": "待处理",
    "告警白名单创建时间": "2026-05-08 10:08:06",
    "告警白名单所属部门": "系统运维部",
    "告警白名单负责人": "system",
    "告警白名单类型": "待处理",
    "告警白名单规则": "待处理",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-6",
    "新增告警白名单状态": "处理失败",
    "新增告警白名单时间": "2026-05-08 10:42:31",
    "告警白名单属性": "处理失败",
    "告警白名单创建时间": "2026-05-08 10:42:31",
    "告警白名单所属部门": "数据管理部",
    "告警白名单负责人": "admin",
    "告警白名单类型": "处理失败",
    "告警白名单规则": "处理失败",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-7",
    "新增告警白名单状态": "已暂停",
    "新增告警白名单时间": "2026-05-08 11:16:09",
    "告警白名单属性": "已暂停",
    "告警白名单创建时间": "2026-05-08 11:16:09",
    "告警白名单所属部门": "安全运维部",
    "告警白名单负责人": "张三",
    "告警白名单类型": "已暂停",
    "告警白名单规则": "已暂停",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-8",
    "新增告警白名单状态": "已完成",
    "新增告警白名单时间": "2026-05-08 14:03:52",
    "告警白名单属性": "已完成",
    "告警白名单创建时间": "2026-05-08 14:03:52",
    "告警白名单所属部门": "网络管理部",
    "告警白名单负责人": "李四",
    "告警白名单类型": "已完成",
    "告警白名单规则": "已完成",
  ...
  },
  {
    ...
    "告警白名单名称": "告警白名单管理-9",
    "新增告警白名单状态": "排队中",
    "新增告警白名单时间": "2026-05-08 15:21:37",
    "告警白名单属性": "排队中",
    "告警白名单创建时间": "2026-05-08 15:21:37",
    "告警白名单所属部门": "资产管理部",
    "告警白名单负责人": "王五",
    "告警白名单类型": "排队中",
    "告警白名单规则": "排队中",
