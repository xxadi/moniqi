    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核项目完整性信息表", "operation")'>设备厂商考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备厂商数据考核项目完整性字典信息", "form")'>新增设备厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商数据考核项目完整性字典信息", "config")'>修改设备厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商数据考核项目完整性字典信息")'>删除设备厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备厂商考核项目完整性上传任务", "form")'>新增设备厂商考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商考核项目完整性上传任务")'>删除设备厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商考核项目完整性上传任务", "config")'>修改设备厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询设备厂商考核项目完整性上传任务", "detail")'>查询设备厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核项目完整性上传任务启用/禁用", "form")'>设备厂商考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备厂商考核项目完整性稽核数据上传", "form")'>设备厂商考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备厂商考核项目完整性稽核数据接口监控", "log")'>设备厂商考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "完整性ID": "H-78189",
    "考核项目完整性编号": "H-78189",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-1",
    "设备厂商考核项目完整性状态": "已取消",
    "设备厂商考核项目完整性时间": "2026-05-09 09:47:56",
    "删除流水号": "H-78189",
    "设备厂商数据考核项目完整性字典编号": "H-78189",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-1",
    "类型": "已取消",
    "规则": "已取消",
    "删除设备厂商数据考核项目完整性字典状态": "已取消"
  },
  {
    "ID": 2,
    "完整性ID": "H-86108",
    "考核项目完整性编号": "H-86108",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-2",
    "设备厂商考核项目完整性状态": "已驳回",
    "设备厂商考核项目完整性时间": "2026-05-08 09:12:18",
    "删除流水号": "H-86108",
    "设备厂商数据考核项目完整性字典编号": "H-86108",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-2",
    "类型": "已驳回",
    "规则": "已驳回",
    "删除设备厂商数据考核项目完整性字典状态": "已驳回"
  },
  {
    "ID": 3,
    "完整性ID": "H-94027",
    "考核项目完整性编号": "H-94027",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-3",
    "设备厂商考核项目完整性状态": "待审核",
    "设备厂商考核项目完整性时间": "2026-05-08 09:35:44",
    "删除流水号": "H-94027",
    "设备厂商数据考核项目完整性字典编号": "H-94027",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-3",
    "类型": "待审核",
    "规则": "待审核",
    "删除设备厂商数据考核项目完整性字典状态": "待审核"
  },
  {
    "ID": 4,
    "完整性ID": "H-101946",
    "考核项目完整性编号": "H-101946",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-4",
    "设备厂商考核项目完整性状态": "已处理",
    "设备厂商考核项目完整性时间": "2026-05-08 10:08:06",
    "删除流水号": "H-101946",
    "设备厂商数据考核项目完整性字典编号": "H-101946",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-4",
    "类型": "已处理",
    "规则": "已处理",
    "删除设备厂商数据考核项目完整性字典状态": "已处理"
  },
  {
    "ID": 5,
    "完整性ID": "H-109865",
    "考核项目完整性编号": "H-109865",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-5",
    "设备厂商考核项目完整性状态": "处理中",
    "设备厂商考核项目完整性时间": "2026-05-08 10:42:31",
    "删除流水号": "H-109865",
    "设备厂商数据考核项目完整性字典编号": "H-109865",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-5",
    "类型": "处理中",
    "规则": "处理中",
    "删除设备厂商数据考核项目完整性字典状态": "处理中"
  },
  {
    "ID": 6,
    "完整性ID": "H-117784",
    "考核项目完整性编号": "H-117784",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-6",
    "设备厂商考核项目完整性状态": "待处理",
    "设备厂商考核项目完整性时间": "2026-05-08 11:16:09",
    "删除流水号": "H-117784",
    "设备厂商数据考核项目完整性字典编号": "H-117784",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-6",
    "类型": "待处理",
    "规则": "待处理",
    "删除设备厂商数据考核项目完整性字典状态": "待处理"
  },
  {
    "ID": 7,
    "完整性ID": "H-125703",
    "考核项目完整性编号": "H-125703",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-7",
    "设备厂商考核项目完整性状态": "处理失败",
    "设备厂商考核项目完整性时间": "2026-05-08 14:03:52",
    "删除流水号": "H-125703",
    "设备厂商数据考核项目完整性字典编号": "H-125703",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-7",
    "类型": "处理失败",
    "规则": "处理失败",
    "删除设备厂商数据考核项目完整性字典状态": "处理失败"
  },
  {
    "ID": 8,
    "完整性ID": "H-133622",
    "考核项目完整性编号": "H-133622",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-8",
    "设备厂商考核项目完整性状态": "已暂停",
    "设备厂商考核项目完整性时间": "2026-05-08 15:21:37",
    "删除流水号": "H-133622",
    "设备厂商数据考核项目完整性字典编号": "H-133622",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-8",
    "类型": "已暂停",
    "规则": "已暂停",
    "删除设备厂商数据考核项目完整性字典状态": "已暂停"
  },
  {
    "ID": 9,
    "完整性ID": "H-141541",
    "考核项目完整性编号": "H-141541",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-9",
    "设备厂商考核项目完整性状态": "已完成",
    "设备厂商考核项目完整性时间": "2026-05-08 16:08:25",
    "删除流水号": "H-141541",
    "设备厂商数据考核项目完整性字典编号": "H-141541",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-9",
    "类型": "已完成",
    "规则": "已完成",
    "删除设备厂商数据考核项目完整性字典状态": "已完成"
  },
  {
    "ID": 10,
    "完整性ID": "H-149460",
    "考核项目完整性编号": "H-149460",
    "考核项目完整性名称": "设备厂商考核项目完整性指标管理-10",
    "设备厂商考核项目完整性状态": "排队中",
    "设备厂商考核项目完整性时间": "2026-05-09 08:33:11",
    "删除流水号": "H-149460",
    "设备厂商数据考核项目完整性字典编号": "H-149460",
    "设备厂商数据考核项目完整性字典名称": "设备厂商考核项目完整性指标管理-10",
    "类型": "排队中",
    "规则": "排队中",
    "删除设备厂商数据考核项目完整性字典状态": "排队中"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "设备厂商数据考核项目完整性字典编号",
    "label": "设备厂商数据考核项目完整性字典编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "设备厂商数据考核项目完整性字典名称",
    "label": "设备厂商数据考核项目完整性字典名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "删除设备厂商数据考核项目完整性字典状态",
    "label": "删除设备厂商数据考核项目完整性字典状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
