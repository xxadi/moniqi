    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片厂商考核质量可用性信息表", "operation")'>交换芯片厂商考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增交换芯片厂商数据考核质量可用性字典信息", "form")'>新增交换芯片厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改交换芯片厂商数据考核质量可用性字典信息", "config")'>修改交换芯片厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除交换芯片厂商数据考核质量可用性字典信息")'>删除交换芯片厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增交换芯片厂商考核质量可用性上传任务", "form")'>新增交换芯片厂商考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除交换芯片厂商考核质量可用性上传任务")'>删除交换芯片厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改交换芯片厂商考核质量可用性上传任务", "config")'>修改交换芯片厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询交换芯片厂商考核质量可用性上传任务", "detail")'>查询交换芯片厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片厂商考核质量可用性上传任务启用/禁用", "form")'>交换芯片厂商考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("交换芯片厂商考核质量可用性稽核数据上传", "form")'>交换芯片厂商考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("交换芯片厂商考核质量可用性稽核数据接口监控", "log")'>交换芯片厂商考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("交换芯片型号考核质量可用性信息表", "operation")'>交换芯片型号考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("交换芯片型号考核质量可用性稽核数据上传", "form")'>交换芯片型号考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("交换芯片型号考核质量可用性稽核数据接口监控", "log")'>交换芯片型号考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "交换芯片厂商考核质量可用性ID": "N-98813",
    "交换芯片厂商考核质量可用性编号": "N-98813",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-1",
    "交换芯片厂商考核质量可用性状态": "已取消",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 10:42:31",
    "交换芯片厂商考核质量可用性属性": "已取消",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 10:42:31",
    "交换芯片厂商考核质量可用性所属部门": "数据管理部",
    "交换芯片厂商考核质量可用性负责人": "admin",
    "交换芯片厂商考核质量可用性类型": "已取消",
    "交换芯片厂商考核质量可用性规则": "已取消",
    "质量可用性字典ID": "N-98813"
  },
  {
    "ID": 2,
    "交换芯片厂商考核质量可用性ID": "N-106732",
    "交换芯片厂商考核质量可用性编号": "N-106732",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-2",
    "交换芯片厂商考核质量可用性状态": "已驳回",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 11:16:09",
    "交换芯片厂商考核质量可用性属性": "已驳回",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 11:16:09",
    "交换芯片厂商考核质量可用性所属部门": "安全运维部",
    "交换芯片厂商考核质量可用性负责人": "张三",
    "交换芯片厂商考核质量可用性类型": "已驳回",
    "交换芯片厂商考核质量可用性规则": "已驳回",
    "质量可用性字典ID": "N-106732"
  ...
  {
    "ID": 3,
    "交换芯片厂商考核质量可用性ID": "N-114651",
    "交换芯片厂商考核质量可用性编号": "N-114651",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-3",
    "交换芯片厂商考核质量可用性状态": "待审核",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 14:03:52",
    "交换芯片厂商考核质量可用性属性": "待审核",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 14:03:52",
    "交换芯片厂商考核质量可用性所属部门": "网络管理部",
    "交换芯片厂商考核质量可用性负责人": "李四",
    "交换芯片厂商考核质量可用性类型": "待审核",
    "交换芯片厂商考核质量可用性规则": "待审核",
    "质量可用性字典ID": "N-114651"
  ...
  {
    "ID": 4,
    "交换芯片厂商考核质量可用性ID": "N-122570",
    "交换芯片厂商考核质量可用性编号": "N-122570",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-4",
    "交换芯片厂商考核质量可用性状态": "已处理",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 15:21:37",
    "交换芯片厂商考核质量可用性属性": "已处理",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 15:21:37",
    "交换芯片厂商考核质量可用性所属部门": "资产管理部",
    "交换芯片厂商考核质量可用性负责人": "王五",
    "交换芯片厂商考核质量可用性类型": "已处理",
    "交换芯片厂商考核质量可用性规则": "已处理",
    "质量可用性字典ID": "N-122570"
  ...
  {
    "ID": 5,
    "交换芯片厂商考核质量可用性ID": "N-130489",
    "交换芯片厂商考核质量可用性编号": "N-130489",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-5",
    "交换芯片厂商考核质量可用性状态": "处理中",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 16:08:25",
    "交换芯片厂商考核质量可用性属性": "处理中",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 16:08:25",
    "交换芯片厂商考核质量可用性所属部门": "信息安全部",
    "交换芯片厂商考核质量可用性负责人": "赵六",
    "交换芯片厂商考核质量可用性类型": "处理中",
    "交换芯片厂商考核质量可用性规则": "处理中",
    "质量可用性字典ID": "N-130489"
  ...
  {
    "ID": 6,
    "交换芯片厂商考核质量可用性ID": "N-138408",
    "交换芯片厂商考核质量可用性编号": "N-138408",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-6",
    "交换芯片厂商考核质量可用性状态": "待处理",
    "交换芯片厂商考核质量可用性时间": "2026-05-09 08:33:11",
    "交换芯片厂商考核质量可用性属性": "待处理",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-09 08:33:11",
    "交换芯片厂商考核质量可用性所属部门": "系统运维部",
    "交换芯片厂商考核质量可用性负责人": "system",
    "交换芯片厂商考核质量可用性类型": "待处理",
    "交换芯片厂商考核质量可用性规则": "待处理",
    "质量可用性字典ID": "N-138408"
  },
  {
    "ID": 7,
    "交换芯片厂商考核质量可用性ID": "N-146327",
    "交换芯片厂商考核质量可用性编号": "N-146327",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-7",
    "交换芯片厂商考核质量可用性状态": "处理失败",
    "交换芯片厂商考核质量可用性时间": "2026-05-09 09:47:56",
    "交换芯片厂商考核质量可用性属性": "处理失败",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-09 09:47:56",
    "交换芯片厂商考核质量可用性所属部门": "数据管理部",
    "交换芯片厂商考核质量可用性负责人": "admin",
    "交换芯片厂商考核质量可用性类型": "处理失败",
    "交换芯片厂商考核质量可用性规则": "处理失败",
    "质量可用性字典ID": "N-146327"
  },
  {
    "ID": 8,
    "交换芯片厂商考核质量可用性ID": "N-154246",
    "交换芯片厂商考核质量可用性编号": "N-154246",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-8",
    "交换芯片厂商考核质量可用性状态": "已暂停",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 09:12:18",
    "交换芯片厂商考核质量可用性属性": "已暂停",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 09:12:18",
    "交换芯片厂商考核质量可用性所属部门": "安全运维部",
    "交换芯片厂商考核质量可用性负责人": "张三",
    "交换芯片厂商考核质量可用性类型": "已暂停",
    "交换芯片厂商考核质量可用性规则": "已暂停",
  ...
  {
    "ID": 9,
    "交换芯片厂商考核质量可用性ID": "N-162165",
    "交换芯片厂商考核质量可用性编号": "N-162165",
    "交换芯片厂商考核质量可用性名称": "交换芯片厂商考核质量可用性指标管理-9",
    "交换芯片厂商考核质量可用性状态": "已完成",
    "交换芯片厂商考核质量可用性时间": "2026-05-08 09:35:44",
    "交换芯片厂商考核质量可用性属性": "已完成",
    "交换芯片厂商考核质量可用性创建时间": "2026-05-08 09:35:44",
    "交换芯片厂商考核质量可用性所属部门": "网络管理部",
    "交换芯片厂商考核质量可用性负责人": "李四",
    "交换芯片厂商考核质量可用性类型": "已完成",
    "交换芯片厂商考核质量可用性规则": "已完成",
...
const tableColumns = [
  ...
  {
    "prop": "交换芯片厂商考核质量可用性ID",
    "label": "交换芯片厂商考核质量可用性ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性编号",
    "label": "交换芯片厂商考核质量可用性编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性名称",
    "label": "交换芯片厂商考核质量可用性名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性状态",
    "label": "交换芯片厂商考核质量可用性状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性时间",
    "label": "交换芯片厂商考核质量可用性时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "交换芯片厂商考核质量可用性属性",
    "label": "交换芯片厂商考核质量可用性属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性创建时间",
    "label": "交换芯片厂商考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "交换芯片厂商考核质量可用性所属部门",
    "label": "交换芯片厂商考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性负责人",
    "label": "交换芯片厂商考核质量可用性负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性类型",
    "label": "交换芯片厂商考核质量可用性类型",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "交换芯片厂商考核质量可用性规则",
    "label": "交换芯片厂商考核质量可用性规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "交换芯片厂商考核质量可用性规则": "",
  "质量可用性字典ID": "",
  "导入来源": "交换芯片厂商考核质量可用性指标管理导入模板.xlsx"
};
