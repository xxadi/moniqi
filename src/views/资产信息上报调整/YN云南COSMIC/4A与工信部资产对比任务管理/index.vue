    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A与工信部资产对比任务信息", "form")'>新增4A与工信部资产对比任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A与工信部资产对比任务信息", "config")'>修改4A与工信部资产对比任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A与工信部资产对比任务信息")'>删除4A与工信部资产对比任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A与工信部资产对比任务列表", "detail")'>查询4A与工信部资产对比任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A与工信部资产对比任务详情", "detail")'>查询4A与工信部资产对比任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入4A与工信部资产对比任务")'>批量导入4A与工信部资产对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("4A与工信部资产对比任务导出")'>4A与工信部资产对比任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产对比任务ID": "E-12692",
    "4A与工信部资产对比任务编号": "E-12692",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-1",
    "新增4A与工信部资产对比任务状态": "已暂停",
    "新增4A与工信部资产对比任务时间": "2026-05-08 10:08:06",
    "任务属性": "已暂停",
    "4A与工信部资产对比任务创建时间": "2026-05-08 10:08:06",
    "4A与工信部资产对比任务ID": "E-12692",
    "4A与工信部资产对比任务所属部门": "资产管理部",
    "4A与工信部资产对比任务负责人": "王五",
    "4A与工信部资产对比任务类型": "已暂停",
    "4A与工信部资产对比任务规则": "已暂停"
  },
  {
    "ID": 2,
    "资产对比任务ID": "E-20611",
    "4A与工信部资产对比任务编号": "E-20611",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-2",
    "新增4A与工信部资产对比任务状态": "已完成",
    "新增4A与工信部资产对比任务时间": "2026-05-08 10:42:31",
    "任务属性": "已完成",
    "4A与工信部资产对比任务创建时间": "2026-05-08 10:42:31",
    "4A与工信部资产对比任务ID": "E-20611",
    "4A与工信部资产对比任务所属部门": "信息安全部",
    "4A与工信部资产对比任务负责人": "赵六",
    "4A与工信部资产对比任务类型": "已完成",
    "4A与工信部资产对比任务规则": "已完成"
  },
  {
    "ID": 3,
    "资产对比任务ID": "E-28530",
    "4A与工信部资产对比任务编号": "E-28530",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-3",
    "新增4A与工信部资产对比任务状态": "排队中",
    "新增4A与工信部资产对比任务时间": "2026-05-08 11:16:09",
    "任务属性": "排队中",
    "4A与工信部资产对比任务创建时间": "2026-05-08 11:16:09",
    "4A与工信部资产对比任务ID": "E-28530",
    "4A与工信部资产对比任务所属部门": "系统运维部",
    "4A与工信部资产对比任务负责人": "system",
    "4A与工信部资产对比任务类型": "排队中",
    "4A与工信部资产对比任务规则": "排队中"
  },
  {
    "ID": 4,
    "资产对比任务ID": "E-36449",
    "4A与工信部资产对比任务编号": "E-36449",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-4",
    "新增4A与工信部资产对比任务状态": "部分完成",
    "新增4A与工信部资产对比任务时间": "2026-05-08 14:03:52",
    "任务属性": "部分完成",
    "4A与工信部资产对比任务创建时间": "2026-05-08 14:03:52",
    "4A与工信部资产对比任务ID": "E-36449",
    "4A与工信部资产对比任务所属部门": "数据管理部",
    "4A与工信部资产对比任务负责人": "admin",
    "4A与工信部资产对比任务类型": "部分完成",
    "4A与工信部资产对比任务规则": "部分完成"
  },
  {
    "ID": 5,
    "资产对比任务ID": "E-44368",
    "4A与工信部资产对比任务编号": "E-44368",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-5",
    "新增4A与工信部资产对比任务状态": "已启用",
    "新增4A与工信部资产对比任务时间": "2026-05-08 15:21:37",
    "任务属性": "已启用",
    "4A与工信部资产对比任务创建时间": "2026-05-08 15:21:37",
    "4A与工信部资产对比任务ID": "E-44368",
    "4A与工信部资产对比任务所属部门": "安全运维部",
    "4A与工信部资产对比任务负责人": "张三",
    "4A与工信部资产对比任务类型": "已启用",
    "4A与工信部资产对比任务规则": "已启用"
  },
  {
    "ID": 6,
    "资产对比任务ID": "E-52287",
    "4A与工信部资产对比任务编号": "E-52287",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-6",
    "新增4A与工信部资产对比任务状态": "已停用",
    "新增4A与工信部资产对比任务时间": "2026-05-08 16:08:25",
    "任务属性": "已停用",
    "4A与工信部资产对比任务创建时间": "2026-05-08 16:08:25",
    "4A与工信部资产对比任务ID": "E-52287",
    "4A与工信部资产对比任务所属部门": "网络管理部",
    "4A与工信部资产对比任务负责人": "李四",
    "4A与工信部资产对比任务类型": "已停用",
    "4A与工信部资产对比任务规则": "已停用"
  },
  {
    "ID": 7,
    "资产对比任务ID": "E-60206",
    "4A与工信部资产对比任务编号": "E-60206",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-7",
    "新增4A与工信部资产对比任务状态": "正常",
    "新增4A与工信部资产对比任务时间": "2026-05-09 08:33:11",
    "任务属性": "正常",
    "4A与工信部资产对比任务创建时间": "2026-05-09 08:33:11",
    "4A与工信部资产对比任务ID": "E-60206",
    "4A与工信部资产对比任务所属部门": "资产管理部",
    "4A与工信部资产对比任务负责人": "王五",
    "4A与工信部资产对比任务类型": "正常",
    "4A与工信部资产对比任务规则": "正常"
  },
  {
    "ID": 8,
    "资产对比任务ID": "E-68125",
    "4A与工信部资产对比任务编号": "E-68125",
    "4A与工信部资产对比任务名称": "4A与工信部资产对比任务管理-8",
    "新增4A与工信部资产对比任务状态": "异常",
    "新增4A与工信部资产对比任务时间": "2026-05-09 09:47:56",
    "任务属性": "异常",
    "4A与工信部资产对比任务创建时间": "2026-05-09 09:47:56",
    "4A与工信部资产对比任务ID": "E-68125",
    "4A与工信部资产对比任务所属部门": "信息安全部",
    "4A与工信部资产对比任务负责人": "赵六",
    "4A与工信部资产对比任务类型": "异常",
    "4A与工信部资产对比任务规则": "异常"
...
const tableColumns = [
  ...
  {
    "prop": "4A与工信部资产对比任务名称",
    "label": "4A与工信部资产对比任务名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增4A与工信部资产对比任务状态",
    "label": "新增4A与工信部资产对比任务状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "新增4A与工信部资产对比任务时间",
    "label": "新增4A与工信部资产对比任务时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "4A与工信部资产对比任务创建时间",
    "label": "4A与工信部资产对比任务创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "4A与工信部资产对比任务ID",
    "label": "4A与工信部资产对比任务ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "4A与工信部资产对比任务所属部门",
    "label": "4A与工信部资产对比任务所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "4A与工信部资产对比任务负责人",
    "label": "4A与工信部资产对比任务负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
