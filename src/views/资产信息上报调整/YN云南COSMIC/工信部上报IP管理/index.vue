    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报IP信息", "form")'>新增工信部上报IP信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部上报IP信息", "config")'>修改工信部上报IP信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部上报IP信息")'>删除工信部上报IP信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部上报IP监控", "log")'>工信部上报IP监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("工信部上报IP监控告警", "alert")'>工信部上报IP监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP稽核", "audit")'>工信部上报IP稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部上报IP统计", "statistics")'>工信部上报IP统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部上报IP数据采集", "transform")'>工信部上报IP数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部上报IP数据转换", "transform")'>工信部上报IP数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部上报IP数据预处理", "transform")'>工信部上报IP数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入工信部指令信息")'>批量导入工信部指令信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部上报IPID": "L-92467",
    "工信部上报IP编号": "L-92467",
    "工信部上报IP名称": "工信部上报IP管理-1",
    "新增工信部上报IP状态": "处理失败",
    "新增工信部上报IP时间": "2026-05-08 16:08:25",
    "工信部上报IP属性": "172.16.0.50",
    "工信部上报IP创建时间": "2026-05-08 16:08:25",
    "工信部上报IP所属部门": "网络管理部",
    "工信部上报IP负责人": "李四",
    "工信部上报IP类型": "172.16.0.50",
    "工信部上报IP规则": "172.16.0.50",
    "名称": "工信部上报IP管理-1"
  },
  {
    "ID": 2,
    "工信部上报IPID": "L-100386",
    "工信部上报IP编号": "L-100386",
    "工信部上报IP名称": "工信部上报IP管理-2",
    "新增工信部上报IP状态": "已暂停",
    "新增工信部上报IP时间": "2026-05-09 08:33:11",
    "工信部上报IP属性": "192.168.1.200",
    "工信部上报IP创建时间": "2026-05-09 08:33:11",
    "工信部上报IP所属部门": "资产管理部",
    "工信部上报IP负责人": "王五",
    "工信部上报IP类型": "192.168.1.200",
    "工信部上报IP规则": "192.168.1.200",
    "名称": "工信部上报IP管理-2"
  },
  {
    "ID": 3,
    "工信部上报IPID": "L-108305",
    "工信部上报IP编号": "L-108305",
    "工信部上报IP名称": "工信部上报IP管理-3",
    "新增工信部上报IP状态": "已完成",
    "新增工信部上报IP时间": "2026-05-09 09:47:56",
    "工信部上报IP属性": "10.20.5.30",
    "工信部上报IP创建时间": "2026-05-09 09:47:56",
    "工信部上报IP所属部门": "信息安全部",
    "工信部上报IP负责人": "赵六",
    "工信部上报IP类型": "10.20.5.30",
    "工信部上报IP规则": "10.20.5.30",
    "名称": "工信部上报IP管理-3"
  },
  {
    "ID": 4,
    "工信部上报IPID": "L-116224",
    "工信部上报IP编号": "L-116224",
    "工信部上报IP名称": "工信部上报IP管理-4",
    "新增工信部上报IP状态": "排队中",
    "新增工信部上报IP时间": "2026-05-08 09:12:18",
    "工信部上报IP属性": "172.20.1.80",
    "工信部上报IP创建时间": "2026-05-08 09:12:18",
    "工信部上报IP所属部门": "系统运维部",
    "工信部上报IP负责人": "system",
    "工信部上报IP类型": "172.20.1.80",
    "工信部上报IP规则": "172.20.1.80",
    "名称": "工信部上报IP管理-4"
  },
  {
    "ID": 5,
    "工信部上报IPID": "L-124143",
    "工信部上报IP编号": "L-124143",
    "工信部上报IP名称": "工信部上报IP管理-5",
    "新增工信部上报IP状态": "部分完成",
    "新增工信部上报IP时间": "2026-05-08 09:35:44",
    "工信部上报IP属性": "10.0.0.254",
    "工信部上报IP创建时间": "2026-05-08 09:35:44",
    "工信部上报IP所属部门": "数据管理部",
    "工信部上报IP负责人": "admin",
    "工信部上报IP类型": "10.0.0.254",
    "工信部上报IP规则": "10.0.0.254",
    "名称": "工信部上报IP管理-5"
  },
  {
    "ID": 6,
    "工信部上报IPID": "L-132062",
    "工信部上报IP编号": "L-132062",
    "工信部上报IP名称": "工信部上报IP管理-6",
    "新增工信部上报IP状态": "已启用",
    "新增工信部上报IP时间": "2026-05-08 10:08:06",
    "工信部上报IP属性": "10.10.1.100",
    "工信部上报IP创建时间": "2026-05-08 10:08:06",
    "工信部上报IP所属部门": "安全运维部",
    "工信部上报IP负责人": "张三",
    "工信部上报IP类型": "10.10.1.100",
    "工信部上报IP规则": "10.10.1.100",
    "名称": "工信部上报IP管理-6"
  },
  {
    "ID": 7,
    "工信部上报IPID": "L-139981",
    "工信部上报IP编号": "L-139981",
    "工信部上报IP名称": "工信部上报IP管理-7",
    "新增工信部上报IP状态": "已停用",
    "新增工信部上报IP时间": "2026-05-08 10:42:31",
    "工信部上报IP属性": "172.16.0.50",
    "工信部上报IP创建时间": "2026-05-08 10:42:31",
    "工信部上报IP所属部门": "网络管理部",
    "工信部上报IP负责人": "李四",
    "工信部上报IP类型": "172.16.0.50",
    "工信部上报IP规则": "172.16.0.50",
  ...
  },
  {
    ...
    "工信部上报IPID": "L-147900",
    "工信部上报IP编号": "L-147900",
    "工信部上报IP名称": "工信部上报IP管理-8",
    "新增工信部上报IP状态": "正常",
    "新增工信部上报IP时间": "2026-05-08 11:16:09",
    "工信部上报IP属性": "192.168.1.200",
    "工信部上报IP创建时间": "2026-05-08 11:16:09",
    "工信部上报IP所属部门": "资产管理部",
    "工信部上报IP负责人": "王五",
    "工信部上报IP类型": "192.168.1.200",
    "工信部上报IP规则": "192.168.1.200",
