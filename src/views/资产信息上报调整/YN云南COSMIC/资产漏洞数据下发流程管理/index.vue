    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起资产漏洞数据下发流程", "workflow")'>发起资产漏洞数据下发流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞数据下发指派信息", "form")'>新增资产漏洞数据下发指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞数据下发流程", "form")'>新增资产漏洞数据下发流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞数据下发流程信息", "config")'>修改资产漏洞数据下发流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据下发流程删除", "operation")'>资产漏洞数据下发流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据下发流程查询", "detail")'>资产漏洞数据下发流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据下发附件上传", "form")'>资产漏洞数据下发附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞数据下发流程图查看", "preview")'>资产漏洞数据下发流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞数据下发流程通知", "audit")'>资产漏洞数据下发流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞数据下发结果逐级审批", "audit")'>资产漏洞数据下发结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞数据下发结果拒绝和驳回", "approval")'>资产漏洞数据下发结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产漏洞数据下发ID": "P-38885",
    "资产漏洞数据下发流程环节ID": "P-38885",
    "资产漏洞数据下发编号": "P-38885",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-1",
    "发起资产漏洞数据下发状态": "已完成",
    "发起资产漏洞数据下发时间": "2026-05-08 14:03:52",
    "资产漏洞数据下发属性": "已完成",
    "资产漏洞数据下发发起时间": "2026-05-08 14:03:52",
    "资产漏洞数据下发流程id": "已完成",
    "资产漏洞数据下发流程环节": "已完成",
    "资产漏洞数据下发创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 2,
    "资产漏洞数据下发ID": "P-46804",
    "资产漏洞数据下发流程环节ID": "P-46804",
    "资产漏洞数据下发编号": "P-46804",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-2",
    "发起资产漏洞数据下发状态": "排队中",
    "发起资产漏洞数据下发时间": "2026-05-08 15:21:37",
    "资产漏洞数据下发属性": "排队中",
    "资产漏洞数据下发发起时间": "2026-05-08 15:21:37",
    "资产漏洞数据下发流程id": "排队中",
    "资产漏洞数据下发流程环节": "排队中",
    "资产漏洞数据下发创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 3,
    "资产漏洞数据下发ID": "P-54723",
    "资产漏洞数据下发流程环节ID": "P-54723",
    "资产漏洞数据下发编号": "P-54723",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-3",
    "发起资产漏洞数据下发状态": "部分完成",
    "发起资产漏洞数据下发时间": "2026-05-08 16:08:25",
    "资产漏洞数据下发属性": "部分完成",
    "资产漏洞数据下发发起时间": "2026-05-08 16:08:25",
    "资产漏洞数据下发流程id": "部分完成",
    "资产漏洞数据下发流程环节": "部分完成",
    "资产漏洞数据下发创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 4,
    "资产漏洞数据下发ID": "P-62642",
    "资产漏洞数据下发流程环节ID": "P-62642",
    "资产漏洞数据下发编号": "P-62642",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-4",
    "发起资产漏洞数据下发状态": "已启用",
    "发起资产漏洞数据下发时间": "2026-05-09 08:33:11",
    "资产漏洞数据下发属性": "已启用",
    "资产漏洞数据下发发起时间": "2026-05-09 08:33:11",
    "资产漏洞数据下发流程id": "已启用",
    "资产漏洞数据下发流程环节": "已启用",
    "资产漏洞数据下发创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 5,
    "资产漏洞数据下发ID": "P-70561",
    "资产漏洞数据下发流程环节ID": "P-70561",
    "资产漏洞数据下发编号": "P-70561",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-5",
    "发起资产漏洞数据下发状态": "已停用",
    "发起资产漏洞数据下发时间": "2026-05-09 09:47:56",
    "资产漏洞数据下发属性": "已停用",
    "资产漏洞数据下发发起时间": "2026-05-09 09:47:56",
    "资产漏洞数据下发流程id": "已停用",
    "资产漏洞数据下发流程环节": "已停用",
    "资产漏洞数据下发创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 6,
    "资产漏洞数据下发ID": "P-78480",
    "资产漏洞数据下发流程环节ID": "P-78480",
    "资产漏洞数据下发编号": "P-78480",
    "资产漏洞数据下发名称": "资产漏洞数据下发流程管理-6",
    "发起资产漏洞数据下发状态": "正常",
    "发起资产漏洞数据下发时间": "2026-05-08 09:12:18",
    "资产漏洞数据下发属性": "正常",
    "资产漏洞数据下发发起时间": "2026-05-08 09:12:18",
    "资产漏洞数据下发流程id": "正常",
    "资产漏洞数据下发流程环节": "正常",
    "资产漏洞数据下发创建时间": "2026-05-08 09:12:18"
  }
];
const tableColumns = [
  {
