    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核质量可用性信息表", "operation")'>设备厂商考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备厂商数据考核质量可用性字典信息", "form")'>新增设备厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商数据考核质量可用性字典信息", "config")'>修改设备厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商数据考核质量可用性字典信息")'>删除设备厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商考核质量可用性上传任务")'>删除设备厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商考核质量可用性上传任务", "config")'>修改设备厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询设备厂商考核质量可用性上传任务", "detail")'>查询设备厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核质量可用性上传任务启用/禁用", "form")'>设备厂商考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备厂商考核质量可用性稽核数据上传", "form")'>设备厂商考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备厂商考核质量可用性稽核数据接口监控", "log")'>设备厂商考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备品牌考核质量可用性信息表", "operation")'>设备品牌考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备品牌考核质量可用性稽核数据上传", "form")'>设备品牌考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备品牌考核质量可用性稽核数据接口监控", "log")'>设备品牌考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("品牌区域考核质量可用性信息表", "operation")'>品牌区域考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增品牌区域考核质量可用性上传任务", "form")'>新增品牌区域考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除品牌区域考核质量可用性上传任务")'>删除品牌区域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改品牌区域考核质量可用性上传任务", "config")'>修改品牌区域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询品牌区域考核质量可用性上传任务", "detail")'>查询品牌区域考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("品牌区域考核质量可用性上传任务启用/禁用", "form")'>品牌区域考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("品牌区域考核质量可用性稽核数据上传", "form")'>品牌区域考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("品牌区域考核质量可用性稽核数据接口监控", "log")'>品牌区域考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "设备厂商考核质量可用性ID": "C-22154",
    "设备厂商考核质量可用性编号": "C-22154",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-1",
    "设备厂商考核质量可用性状态": "正常",
    "设备厂商考核质量可用性时间": "2026-05-08 11:16:09",
    "设备厂商考核质量可用性属性": "正常",
    "设备厂商考核质量可用性创建时间": "2026-05-08 11:16:09",
    "设备厂商考核质量可用性所属部门": "资产管理部",
    "设备厂商考核质量可用性负责人": "王五",
    "设备厂商考核质量可用性类型": "正常",
    "设备厂商考核质量可用性规则": "正常",
    "设备厂商数据考核质量可用性字典ID": "C-22154"
  },
  {
    "ID": 2,
    "设备厂商考核质量可用性ID": "C-30073",
    "设备厂商考核质量可用性编号": "C-30073",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-2",
    "设备厂商考核质量可用性状态": "异常",
    "设备厂商考核质量可用性时间": "2026-05-08 14:03:52",
    "设备厂商考核质量可用性属性": "异常",
    "设备厂商考核质量可用性创建时间": "2026-05-08 14:03:52",
    "设备厂商考核质量可用性所属部门": "信息安全部",
    "设备厂商考核质量可用性负责人": "赵六",
    "设备厂商考核质量可用性类型": "异常",
    "设备厂商考核质量可用性规则": "异常",
    "设备厂商数据考核质量可用性字典ID": "C-30073"
  },
  {
    "ID": 3,
    "设备厂商考核质量可用性ID": "C-37992",
    "设备厂商考核质量可用性编号": "C-37992",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-3",
    "设备厂商考核质量可用性状态": "超时",
    "设备厂商考核质量可用性时间": "2026-05-08 15:21:37",
    "设备厂商考核质量可用性属性": "超时",
    "设备厂商考核质量可用性创建时间": "2026-05-08 15:21:37",
    "设备厂商考核质量可用性所属部门": "系统运维部",
    "设备厂商考核质量可用性负责人": "system",
    "设备厂商考核质量可用性类型": "超时",
    "设备厂商考核质量可用性规则": "超时",
    "设备厂商数据考核质量可用性字典ID": "C-37992"
  },
  {
    "ID": 4,
    "设备厂商考核质量可用性ID": "C-45911",
    "设备厂商考核质量可用性编号": "C-45911",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-4",
    "设备厂商考核质量可用性状态": "已取消",
    "设备厂商考核质量可用性时间": "2026-05-08 16:08:25",
    "设备厂商考核质量可用性属性": "已取消",
    "设备厂商考核质量可用性创建时间": "2026-05-08 16:08:25",
    "设备厂商考核质量可用性所属部门": "数据管理部",
    "设备厂商考核质量可用性负责人": "admin",
    "设备厂商考核质量可用性类型": "已取消",
    "设备厂商考核质量可用性规则": "已取消",
    "设备厂商数据考核质量可用性字典ID": "C-45911"
  },
  {
    "ID": 5,
    "设备厂商考核质量可用性ID": "C-53830",
    "设备厂商考核质量可用性编号": "C-53830",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-5",
    "设备厂商考核质量可用性状态": "已驳回",
    "设备厂商考核质量可用性时间": "2026-05-09 08:33:11",
    "设备厂商考核质量可用性属性": "已驳回",
    "设备厂商考核质量可用性创建时间": "2026-05-09 08:33:11",
    "设备厂商考核质量可用性所属部门": "安全运维部",
    "设备厂商考核质量可用性负责人": "张三",
    "设备厂商考核质量可用性类型": "已驳回",
    "设备厂商考核质量可用性规则": "已驳回",
    "设备厂商数据考核质量可用性字典ID": "C-53830"
  },
  {
    "ID": 6,
    "设备厂商考核质量可用性ID": "C-61749",
    "设备厂商考核质量可用性编号": "C-61749",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-6",
    "设备厂商考核质量可用性状态": "待审核",
    "设备厂商考核质量可用性时间": "2026-05-09 09:47:56",
    "设备厂商考核质量可用性属性": "待审核",
    "设备厂商考核质量可用性创建时间": "2026-05-09 09:47:56",
    "设备厂商考核质量可用性所属部门": "网络管理部",
    "设备厂商考核质量可用性负责人": "李四",
    "设备厂商考核质量可用性类型": "待审核",
    "设备厂商考核质量可用性规则": "待审核",
    "设备厂商数据考核质量可用性字典ID": "C-61749"
  },
  {
    "ID": 7,
    "设备厂商考核质量可用性ID": "C-69668",
    "设备厂商考核质量可用性编号": "C-69668",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-7",
    "设备厂商考核质量可用性状态": "已处理",
    "设备厂商考核质量可用性时间": "2026-05-08 09:12:18",
    "设备厂商考核质量可用性属性": "已处理",
    "设备厂商考核质量可用性创建时间": "2026-05-08 09:12:18",
    "设备厂商考核质量可用性所属部门": "资产管理部",
    "设备厂商考核质量可用性负责人": "王五",
    "设备厂商考核质量可用性类型": "已处理",
    "设备厂商考核质量可用性规则": "已处理",
    "设备厂商数据考核质量可用性字典ID": "C-69668"
  },
  {
    "ID": 8,
    "设备厂商考核质量可用性ID": "C-77587",
    "设备厂商考核质量可用性编号": "C-77587",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-8",
    "设备厂商考核质量可用性状态": "处理中",
    "设备厂商考核质量可用性时间": "2026-05-08 09:35:44",
    "设备厂商考核质量可用性属性": "处理中",
    "设备厂商考核质量可用性创建时间": "2026-05-08 09:35:44",
    "设备厂商考核质量可用性所属部门": "信息安全部",
    "设备厂商考核质量可用性负责人": "赵六",
    "设备厂商考核质量可用性类型": "处理中",
    "设备厂商考核质量可用性规则": "处理中",
    "设备厂商数据考核质量可用性字典ID": "C-77587"
  },
  {
    "ID": 9,
    "设备厂商考核质量可用性ID": "C-85506",
    "设备厂商考核质量可用性编号": "C-85506",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-9",
    "设备厂商考核质量可用性状态": "待处理",
    "设备厂商考核质量可用性时间": "2026-05-08 10:08:06",
    "设备厂商考核质量可用性属性": "待处理",
    "设备厂商考核质量可用性创建时间": "2026-05-08 10:08:06",
    "设备厂商考核质量可用性所属部门": "系统运维部",
    "设备厂商考核质量可用性负责人": "system",
    "设备厂商考核质量可用性类型": "待处理",
    "设备厂商考核质量可用性规则": "待处理",
    "设备厂商数据考核质量可用性字典ID": "C-85506"
  },
  {
    "ID": 10,
    "设备厂商考核质量可用性ID": "C-93425",
    "设备厂商考核质量可用性编号": "C-93425",
    "设备厂商考核质量可用性名称": "设备厂商考核质量可用性指标管理-10",
    "设备厂商考核质量可用性状态": "处理失败",
    "设备厂商考核质量可用性时间": "2026-05-08 10:42:31",
    "设备厂商考核质量可用性属性": "处理失败",
    "设备厂商考核质量可用性创建时间": "2026-05-08 10:42:31",
    "设备厂商考核质量可用性所属部门": "数据管理部",
    "设备厂商考核质量可用性负责人": "admin",
    "设备厂商考核质量可用性类型": "处理失败",
    "设备厂商考核质量可用性规则": "处理失败",
    "设备厂商数据考核质量可用性字典ID": "C-93425"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "设备厂商考核质量可用性创建时间",
    "label": "设备厂商考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "设备厂商考核质量可用性所属部门",
    "label": "设备厂商考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "设备厂商数据考核质量可用性字典ID",
    "label": "设备厂商数据考核质量可用性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
