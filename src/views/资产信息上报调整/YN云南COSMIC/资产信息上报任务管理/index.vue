    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息上报任务设置信息", "form")'>新增资产信息上报任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息上报任务设置信息", "config")'>修改资产信息上报任务设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息上报任务设置信息")'>删除资产信息上报任务设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产信息上报任务错误信息监控", "log")'>资产信息上报任务错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务错误事件通知", "audit")'>资产信息上报任务错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务错误事件通知删除", "operation")'>资产信息上报任务错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产信息上报任务错误事件通知查询", "detail")'>资产信息上报任务错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产信息上报任务防篡改信息", "form")'>新增资产信息上报任务防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产信息上报任务防篡改信息", "config")'>修改资产信息上报任务防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产信息上报任务防篡改信息")'>删除资产信息上报任务防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产信息上报任务设置ID": "N-46839",
    "资产信息上报任务设置编号": "N-46839",
    "资产信息上报任务设置名称": "资产信息上报任务管理-1",
    "新增资产信息上报任务设置状态": "部分完成",
    "新增资产信息上报任务设置时间": "2026-05-09 09:47:56",
    "资产信息上报任务设置属性": "部分完成",
    "资产信息上报任务设置创建时间": "2026-05-09 09:47:56",
    "资产信息上报任务设置所属部门": "信息安全部",
    "资产信息上报任务设置负责人": "赵六",
    "资产信息上报任务设置类型": "部分完成",
    "资产信息上报任务设置规则": "部分完成",
    "名称": "资产信息上报任务管理-1"
  ...
  {
    "ID": 2,
    "资产信息上报任务设置ID": "N-54758",
    "资产信息上报任务设置编号": "N-54758",
    "资产信息上报任务设置名称": "资产信息上报任务管理-2",
    "新增资产信息上报任务设置状态": "已启用",
    "新增资产信息上报任务设置时间": "2026-05-08 09:12:18",
    "资产信息上报任务设置属性": "已启用",
    "资产信息上报任务设置创建时间": "2026-05-08 09:12:18",
    "资产信息上报任务设置所属部门": "系统运维部",
    "资产信息上报任务设置负责人": "system",
    "资产信息上报任务设置类型": "已启用",
    "资产信息上报任务设置规则": "已启用",
    "名称": "资产信息上报任务管理-2"
  },
  {
    "ID": 3,
    "资产信息上报任务设置ID": "N-62677",
    "资产信息上报任务设置编号": "N-62677",
    "资产信息上报任务设置名称": "资产信息上报任务管理-3",
    "新增资产信息上报任务设置状态": "已停用",
    "新增资产信息上报任务设置时间": "2026-05-08 09:35:44",
    "资产信息上报任务设置属性": "已停用",
    "资产信息上报任务设置创建时间": "2026-05-08 09:35:44",
    "资产信息上报任务设置所属部门": "数据管理部",
    "资产信息上报任务设置负责人": "admin",
    "资产信息上报任务设置类型": "已停用",
    "资产信息上报任务设置规则": "已停用",
    "名称": "资产信息上报任务管理-3"
  ...
  {
    "ID": 4,
    "资产信息上报任务设置ID": "N-70596",
    "资产信息上报任务设置编号": "N-70596",
    "资产信息上报任务设置名称": "资产信息上报任务管理-4",
    "新增资产信息上报任务设置状态": "正常",
    "新增资产信息上报任务设置时间": "2026-05-08 10:08:06",
    "资产信息上报任务设置属性": "正常",
    "资产信息上报任务设置创建时间": "2026-05-08 10:08:06",
    "资产信息上报任务设置所属部门": "安全运维部",
    "资产信息上报任务设置负责人": "张三",
    "资产信息上报任务设置类型": "正常",
    "资产信息上报任务设置规则": "正常",
    "名称": "资产信息上报任务管理-4"
  ...
  {
    "ID": 5,
    "资产信息上报任务设置ID": "N-78515",
    "资产信息上报任务设置编号": "N-78515",
    "资产信息上报任务设置名称": "资产信息上报任务管理-5",
    "新增资产信息上报任务设置状态": "异常",
    "新增资产信息上报任务设置时间": "2026-05-08 10:42:31",
    "资产信息上报任务设置属性": "异常",
    "资产信息上报任务设置创建时间": "2026-05-08 10:42:31",
    "资产信息上报任务设置所属部门": "网络管理部",
    "资产信息上报任务设置负责人": "李四",
    "资产信息上报任务设置类型": "异常",
    "资产信息上报任务设置规则": "异常",
    "名称": "资产信息上报任务管理-5"
  ...
  {
    "ID": 6,
    "资产信息上报任务设置ID": "N-86434",
    "资产信息上报任务设置编号": "N-86434",
    "资产信息上报任务设置名称": "资产信息上报任务管理-6",
    "新增资产信息上报任务设置状态": "超时",
    "新增资产信息上报任务设置时间": "2026-05-08 11:16:09",
    "资产信息上报任务设置属性": "超时",
    "资产信息上报任务设置创建时间": "2026-05-08 11:16:09",
    "资产信息上报任务设置所属部门": "资产管理部",
    "资产信息上报任务设置负责人": "王五",
    "资产信息上报任务设置类型": "超时",
    "资产信息上报任务设置规则": "超时",
    "名称": "资产信息上报任务管理-6"
  ...
  {
    "ID": 7,
    "资产信息上报任务设置ID": "N-94353",
    "资产信息上报任务设置编号": "N-94353",
    "资产信息上报任务设置名称": "资产信息上报任务管理-7",
    "新增资产信息上报任务设置状态": "已取消",
    "新增资产信息上报任务设置时间": "2026-05-08 14:03:52",
    "资产信息上报任务设置属性": "已取消",
    "资产信息上报任务设置创建时间": "2026-05-08 14:03:52",
    "资产信息上报任务设置所属部门": "信息安全部",
    "资产信息上报任务设置负责人": "赵六",
    "资产信息上报任务设置类型": "已取消",
    "资产信息上报任务设置规则": "已取消",
  ...
  {
    "ID": 8,
    "资产信息上报任务设置ID": "N-102272",
    "资产信息上报任务设置编号": "N-102272",
    "资产信息上报任务设置名称": "资产信息上报任务管理-8",
    "新增资产信息上报任务设置状态": "已驳回",
    "新增资产信息上报任务设置时间": "2026-05-08 15:21:37",
    "资产信息上报任务设置属性": "已驳回",
    "资产信息上报任务设置创建时间": "2026-05-08 15:21:37",
    "资产信息上报任务设置所属部门": "系统运维部",
    "资产信息上报任务设置负责人": "system",
    "资产信息上报任务设置类型": "已驳回",
    "资产信息上报任务设置规则": "已驳回",
  ...
  {
    "ID": 9,
    "资产信息上报任务设置ID": "N-110191",
    "资产信息上报任务设置编号": "N-110191",
    "资产信息上报任务设置名称": "资产信息上报任务管理-9",
    "新增资产信息上报任务设置状态": "待审核",
    "新增资产信息上报任务设置时间": "2026-05-08 16:08:25",
    "资产信息上报任务设置属性": "待审核",
    "资产信息上报任务设置创建时间": "2026-05-08 16:08:25",
    "资产信息上报任务设置所属部门": "数据管理部",
    "资产信息上报任务设置负责人": "admin",
    "资产信息上报任务设置类型": "待审核",
    "资产信息上报任务设置规则": "待审核",
  ...
  {
    "ID": 10,
    "资产信息上报任务设置ID": "N-118110",
    "资产信息上报任务设置编号": "N-118110",
    "资产信息上报任务设置名称": "资产信息上报任务管理-10",
    "新增资产信息上报任务设置状态": "已处理",
    "新增资产信息上报任务设置时间": "2026-05-09 08:33:11",
    "资产信息上报任务设置属性": "已处理",
    "资产信息上报任务设置创建时间": "2026-05-09 08:33:11",
    "资产信息上报任务设置所属部门": "安全运维部",
    "资产信息上报任务设置负责人": "张三",
    "资产信息上报任务设置类型": "已处理",
    "资产信息上报任务设置规则": "已处理",
