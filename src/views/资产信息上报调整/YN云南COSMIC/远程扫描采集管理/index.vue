    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描采集模型", "form")'>新增远程扫描采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改远程扫描采集模型", "config")'>修改远程扫描采集模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除远程扫描采集模型")'>删除远程扫描采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描采集查询", "detail")'>远程扫描采集查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("远程扫描采集可视化展示", "detail")'>远程扫描采集可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("远程扫描监控信息表", "log")'>远程扫描监控信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描监控任务", "form")'>新增远程扫描监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描监控模型", "form")'>新增远程扫描监控模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改远程扫描监控模型", "config")'>修改远程扫描监控模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除远程扫描监控模型")'>删除远程扫描监控模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("远程扫描监控查询", "log")'>远程扫描监控查询</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("远程扫描监控可视化展示", "log")'>远程扫描监控可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-1",
    "新增远程扫描采集状态": "部分完成",
    "新增远程扫描采集时间": "2026-05-08 14:03:52",
    "采集属性": "部分完成",
    "远程扫描采集创建时间": "2026-05-08 14:03:52",
    "远程扫描采集所属部门": "信息安全部",
    "远程扫描采集负责人": "赵六",
    "远程扫描采集类型": "部分完成",
    "远程扫描采集模型": "部分完成",
  ...
  },
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-2",
    "新增远程扫描采集状态": "已启用",
    "新增远程扫描采集时间": "2026-05-08 15:21:37",
    "采集属性": "已启用",
    "远程扫描采集创建时间": "2026-05-08 15:21:37",
    "远程扫描采集所属部门": "系统运维部",
    "远程扫描采集负责人": "system",
    "远程扫描采集类型": "已启用",
    "远程扫描采集模型": "已启用",
  ...
  },
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-3",
    "新增远程扫描采集状态": "已停用",
    "新增远程扫描采集时间": "2026-05-08 16:08:25",
    "采集属性": "已停用",
    "远程扫描采集创建时间": "2026-05-08 16:08:25",
    "远程扫描采集所属部门": "数据管理部",
    "远程扫描采集负责人": "admin",
    "远程扫描采集类型": "已停用",
    "远程扫描采集模型": "已停用",
  ...
  },
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-4",
    "新增远程扫描采集状态": "正常",
    "新增远程扫描采集时间": "2026-05-09 08:33:11",
    "采集属性": "正常",
    "远程扫描采集创建时间": "2026-05-09 08:33:11",
    "远程扫描采集所属部门": "安全运维部",
    "远程扫描采集负责人": "张三",
    "远程扫描采集类型": "正常",
    "远程扫描采集模型": "正常",
  ...
  },
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-5",
    "新增远程扫描采集状态": "异常",
    "新增远程扫描采集时间": "2026-05-09 09:47:56",
    "采集属性": "异常",
    "远程扫描采集创建时间": "2026-05-09 09:47:56",
    "远程扫描采集所属部门": "网络管理部",
    "远程扫描采集负责人": "李四",
    "远程扫描采集类型": "异常",
    "远程扫描采集模型": "异常",
  ...
  },
  {
    ...
    "远程扫描采集名称": "远程扫描采集管理-6",
    "新增远程扫描采集状态": "超时",
    "新增远程扫描采集时间": "2026-05-08 09:12:18",
    "采集属性": "超时",
    "远程扫描采集创建时间": "2026-05-08 09:12:18",
    "远程扫描采集所属部门": "资产管理部",
    "远程扫描采集负责人": "王五",
    "远程扫描采集类型": "超时",
    "远程扫描采集模型": "超时",
