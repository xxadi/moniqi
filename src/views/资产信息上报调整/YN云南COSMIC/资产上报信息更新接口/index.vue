    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产上报信息更新接口", "api")'>资产上报信息更新接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报信息更新信息", "form")'>新增资产上报信息更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报信息更新信息", "config")'>修改资产上报信息更新信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报信息更新信息")'>删除资产上报信息更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报信息更新汇总表", "detail")'>查询资产上报信息更新汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报信息更新详情", "detail")'>查询资产上报信息更新详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报信息更新")'>批量导入资产上报信息更新</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产属性设置信息", "form")'>新增工信部资产属性设置信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产ip": "排队中",
    "资产上报信息更新编号": "M-18758",
    "资产上报信息更新名称": "资产上报信息更新接口-1",
    "资产上报信息更新状态": "排队中",
    "资产上报信息更新时间": "2026-05-09 08:33:11",
    "资产上报信息更新属性": "排队中",
    "资产上报信息更新创建时间": "2026-05-09 08:33:11",
    "资产上报信息更新所属部门": "资产管理部"
  },
  {
    "ID": 2,
    ...
    "资产ip": "部分完成",
    "资产上报信息更新编号": "M-26677",
    "资产上报信息更新名称": "资产上报信息更新接口-2",
    "资产上报信息更新状态": "部分完成",
    "资产上报信息更新时间": "2026-05-09 09:47:56",
    "资产上报信息更新属性": "部分完成",
    "资产上报信息更新创建时间": "2026-05-09 09:47:56",
    "资产上报信息更新所属部门": "信息安全部"
  },
  {
    "ID": 3,
    ...
    "资产ip": "已启用",
    "资产上报信息更新编号": "M-34596",
    "资产上报信息更新名称": "资产上报信息更新接口-3",
    "资产上报信息更新状态": "已启用",
    "资产上报信息更新时间": "2026-05-08 09:12:18",
    "资产上报信息更新属性": "已启用",
    "资产上报信息更新创建时间": "2026-05-08 09:12:18",
    "资产上报信息更新所属部门": "系统运维部"
  },
  {
    "ID": 4,
    ...
    "资产ip": "已停用",
    "资产上报信息更新编号": "M-42515",
    "资产上报信息更新名称": "资产上报信息更新接口-4",
    "资产上报信息更新状态": "已停用",
    "资产上报信息更新时间": "2026-05-08 09:35:44",
    "资产上报信息更新属性": "已停用",
    "资产上报信息更新创建时间": "2026-05-08 09:35:44",
    "资产上报信息更新所属部门": "数据管理部"
  },
  {
    "ID": 5,
    ...
    "资产ip": "正常",
    "资产上报信息更新编号": "M-50434",
    "资产上报信息更新名称": "资产上报信息更新接口-5",
    "资产上报信息更新状态": "正常",
    "资产上报信息更新时间": "2026-05-08 10:08:06",
    "资产上报信息更新属性": "正常",
    "资产上报信息更新创建时间": "2026-05-08 10:08:06",
    "资产上报信息更新所属部门": "安全运维部"
  },
  {
    "ID": 6,
    ...
    "资产ip": "异常",
    "资产上报信息更新编号": "M-58353",
    "资产上报信息更新名称": "资产上报信息更新接口-6",
    "资产上报信息更新状态": "异常",
    "资产上报信息更新时间": "2026-05-08 10:42:31",
    "资产上报信息更新属性": "异常",
    "资产上报信息更新创建时间": "2026-05-08 10:42:31",
    "资产上报信息更新所属部门": "网络管理部"
  },
  {
    "ID": 7,
    ...
    "资产ip": "超时",
    "资产上报信息更新编号": "M-66272",
    "资产上报信息更新名称": "资产上报信息更新接口-7",
    "资产上报信息更新状态": "超时",
    "资产上报信息更新时间": "2026-05-08 11:16:09",
    "资产上报信息更新属性": "超时",
    "资产上报信息更新创建时间": "2026-05-08 11:16:09",
    "资产上报信息更新所属部门": "资产管理部"
  },
  {
    "ID": 8,
    ...
    "资产ip": "已取消",
    "资产上报信息更新编号": "M-74191",
    "资产上报信息更新名称": "资产上报信息更新接口-8",
    "资产上报信息更新状态": "已取消",
    "资产上报信息更新时间": "2026-05-08 14:03:52",
    "资产上报信息更新属性": "已取消",
    "资产上报信息更新创建时间": "2026-05-08 14:03:52",
    "资产上报信息更新所属部门": "信息安全部"
  },
  {
    "ID": 9,
    ...
    "资产ip": "已驳回",
    "资产上报信息更新编号": "M-82110",
    "资产上报信息更新名称": "资产上报信息更新接口-9",
    "资产上报信息更新状态": "已驳回",
    "资产上报信息更新时间": "2026-05-08 15:21:37",
    "资产上报信息更新属性": "已驳回",
    "资产上报信息更新创建时间": "2026-05-08 15:21:37",
    "资产上报信息更新所属部门": "系统运维部"
  }
];
const tableColumns = [
