    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部数据上报流程", "workflow")'>发起工信部数据上报流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部数据上报指派信息", "form")'>新增工信部数据上报指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部数据上报流程", "form")'>新增工信部数据上报流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部数据上报流程信息", "config")'>修改工信部数据上报流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部数据上报流程删除", "operation")'>工信部数据上报流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部数据上报流程查询", "detail")'>工信部数据上报流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部数据上报附件上传", "form")'>工信部数据上报附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部数据上报流程图查看", "preview")'>工信部数据上报流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部数据上报流程通知", "audit")'>工信部数据上报流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部数据上报结果逐级审批", "audit")'>工信部数据上报结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部数据上报结果拒绝和驳回", "approval")'>工信部数据上报结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部数据上报ID": "O-31188",
    "工信部数据上报流程环节ID": "O-31188",
    "工信部数据上报编号": "O-31188",
    "工信部数据上报名称": "工信部数据上报流程管理-1",
    "发起工信部数据上报状态": "已暂停",
    "发起工信部数据上报时间": "2026-05-09 08:33:11",
    "工信部数据上报属性": "已暂停",
    "工信部数据上报发起时间": "2026-05-09 08:33:11",
    "工信部数据上报流程id": "已暂停",
    "工信部数据上报流程环节": "已暂停",
    "工信部数据上报创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 2,
    "工信部数据上报ID": "O-39107",
    "工信部数据上报流程环节ID": "O-39107",
    "工信部数据上报编号": "O-39107",
    "工信部数据上报名称": "工信部数据上报流程管理-2",
    "发起工信部数据上报状态": "已完成",
    "发起工信部数据上报时间": "2026-05-09 09:47:56",
    "工信部数据上报属性": "已完成",
    "工信部数据上报发起时间": "2026-05-09 09:47:56",
    "工信部数据上报流程id": "已完成",
    "工信部数据上报流程环节": "已完成",
    "工信部数据上报创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 3,
    "工信部数据上报ID": "O-47026",
    "工信部数据上报流程环节ID": "O-47026",
    "工信部数据上报编号": "O-47026",
    "工信部数据上报名称": "工信部数据上报流程管理-3",
    "发起工信部数据上报状态": "排队中",
    "发起工信部数据上报时间": "2026-05-08 09:12:18",
    "工信部数据上报属性": "排队中",
    "工信部数据上报发起时间": "2026-05-08 09:12:18",
    "工信部数据上报流程id": "排队中",
    "工信部数据上报流程环节": "排队中",
    "工信部数据上报创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 4,
    "工信部数据上报ID": "O-54945",
    "工信部数据上报流程环节ID": "O-54945",
    "工信部数据上报编号": "O-54945",
    "工信部数据上报名称": "工信部数据上报流程管理-4",
    "发起工信部数据上报状态": "部分完成",
    "发起工信部数据上报时间": "2026-05-08 09:35:44",
    "工信部数据上报属性": "部分完成",
    "工信部数据上报发起时间": "2026-05-08 09:35:44",
    "工信部数据上报流程id": "部分完成",
    "工信部数据上报流程环节": "部分完成",
    "工信部数据上报创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 5,
    "工信部数据上报ID": "O-62864",
    "工信部数据上报流程环节ID": "O-62864",
    "工信部数据上报编号": "O-62864",
    "工信部数据上报名称": "工信部数据上报流程管理-5",
    "发起工信部数据上报状态": "已启用",
    "发起工信部数据上报时间": "2026-05-08 10:08:06",
    "工信部数据上报属性": "已启用",
    "工信部数据上报发起时间": "2026-05-08 10:08:06",
    "工信部数据上报流程id": "已启用",
    "工信部数据上报流程环节": "已启用",
    "工信部数据上报创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 6,
    "工信部数据上报ID": "O-70783",
    "工信部数据上报流程环节ID": "O-70783",
    "工信部数据上报编号": "O-70783",
    "工信部数据上报名称": "工信部数据上报流程管理-6",
    "发起工信部数据上报状态": "已停用",
    "发起工信部数据上报时间": "2026-05-08 10:42:31",
    "工信部数据上报属性": "已停用",
    "工信部数据上报发起时间": "2026-05-08 10:42:31",
    "工信部数据上报流程id": "已停用",
    "工信部数据上报流程环节": "已停用",
    "工信部数据上报创建时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 7,
    "工信部数据上报ID": "O-78702",
    "工信部数据上报流程环节ID": "O-78702",
    "工信部数据上报编号": "O-78702",
    "工信部数据上报名称": "工信部数据上报流程管理-7",
    "发起工信部数据上报状态": "正常",
    "发起工信部数据上报时间": "2026-05-08 11:16:09",
    "工信部数据上报属性": "正常",
    "工信部数据上报发起时间": "2026-05-08 11:16:09",
    "工信部数据上报流程id": "正常",
    "工信部数据上报流程环节": "正常",
    "工信部数据上报创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 8,
    "工信部数据上报ID": "O-86621",
    "工信部数据上报流程环节ID": "O-86621",
    "工信部数据上报编号": "O-86621",
    "工信部数据上报名称": "工信部数据上报流程管理-8",
    "发起工信部数据上报状态": "异常",
    "发起工信部数据上报时间": "2026-05-08 14:03:52",
    "工信部数据上报属性": "异常",
    "工信部数据上报发起时间": "2026-05-08 14:03:52",
    "工信部数据上报流程id": "异常",
    "工信部数据上报流程环节": "异常",
    "工信部数据上报创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 9,
    "工信部数据上报ID": "O-94540",
    "工信部数据上报流程环节ID": "O-94540",
    "工信部数据上报编号": "O-94540",
    "工信部数据上报名称": "工信部数据上报流程管理-9",
    "发起工信部数据上报状态": "超时",
    "发起工信部数据上报时间": "2026-05-08 15:21:37",
    "工信部数据上报属性": "超时",
    "工信部数据上报发起时间": "2026-05-08 15:21:37",
    "工信部数据上报流程id": "超时",
    "工信部数据上报流程环节": "超时",
    "工信部数据上报创建时间": "2026-05-08 15:21:37"
  }
];
const tableColumns = [
  {
