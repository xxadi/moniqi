    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部上报数据准确性审批流程", "workflow")'>发起工信部上报数据准确性审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据准确性审批指派信息", "form")'>新增工信部上报数据准确性审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报数据准确性审批流程", "form")'>新增工信部上报数据准确性审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部上报数据准确性审批流程信息", "config")'>修改工信部上报数据准确性审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批流程删除", "operation")'>工信部上报数据准确性审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批流程查询", "detail")'>工信部上报数据准确性审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批附件上传", "form")'>工信部上报数据准确性审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批流程图查看", "preview")'>工信部上报数据准确性审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批流程通知", "audit")'>工信部上报数据准确性审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批结果逐级审批", "audit")'>工信部上报数据准确性审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报数据准确性审批结果拒绝和驳回", "approval")'>工信部上报数据准确性审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "审批ID": "L-50113",
    "审批流程环节ID": "L-50113",
    "工信部上报数据准确性审批编号": "L-50113",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-1",
    "发起工信部上报数据准确性审批状态": "处理中",
    "工信部上报数据准确性审批流程节点编号": "L-50113",
    "名称": "工信部上报数据准确性审批流程管理-1",
    "类型": "处理中",
    "工信部上报数据准确性审批流程节点规则": "处理中",
    "工信部上报数据准确性审批流程节点属性": "处理中",
    "修改工信部上报数据准确性审批流程节点状态": "处理中",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 2,
    "审批ID": "L-58032",
    "审批流程环节ID": "L-58032",
    "工信部上报数据准确性审批编号": "L-58032",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-2",
    "发起工信部上报数据准确性审批状态": "待处理",
    "工信部上报数据准确性审批流程节点编号": "L-58032",
    "名称": "工信部上报数据准确性审批流程管理-2",
    "类型": "待处理",
    "工信部上报数据准确性审批流程节点规则": "待处理",
    "工信部上报数据准确性审批流程节点属性": "待处理",
    "修改工信部上报数据准确性审批流程节点状态": "待处理",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 3,
    "审批ID": "L-65951",
    "审批流程环节ID": "L-65951",
    "工信部上报数据准确性审批编号": "L-65951",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-3",
    "发起工信部上报数据准确性审批状态": "处理失败",
    "工信部上报数据准确性审批流程节点编号": "L-65951",
    "名称": "工信部上报数据准确性审批流程管理-3",
    "类型": "处理失败",
    "工信部上报数据准确性审批流程节点规则": "处理失败",
    "工信部上报数据准确性审批流程节点属性": "处理失败",
    "修改工信部上报数据准确性审批流程节点状态": "处理失败",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 4,
    "审批ID": "L-73870",
    "审批流程环节ID": "L-73870",
    "工信部上报数据准确性审批编号": "L-73870",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-4",
    "发起工信部上报数据准确性审批状态": "已暂停",
    "工信部上报数据准确性审批流程节点编号": "L-73870",
    "名称": "工信部上报数据准确性审批流程管理-4",
    "类型": "已暂停",
    "工信部上报数据准确性审批流程节点规则": "已暂停",
    "工信部上报数据准确性审批流程节点属性": "已暂停",
    "修改工信部上报数据准确性审批流程节点状态": "已暂停",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 5,
    "审批ID": "L-81789",
    "审批流程环节ID": "L-81789",
    "工信部上报数据准确性审批编号": "L-81789",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-5",
    "发起工信部上报数据准确性审批状态": "已完成",
    "工信部上报数据准确性审批流程节点编号": "L-81789",
    "名称": "工信部上报数据准确性审批流程管理-5",
    "类型": "已完成",
    "工信部上报数据准确性审批流程节点规则": "已完成",
    "工信部上报数据准确性审批流程节点属性": "已完成",
    "修改工信部上报数据准确性审批流程节点状态": "已完成",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 6,
    "审批ID": "L-89708",
    "审批流程环节ID": "L-89708",
    "工信部上报数据准确性审批编号": "L-89708",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-6",
    "发起工信部上报数据准确性审批状态": "排队中",
    "工信部上报数据准确性审批流程节点编号": "L-89708",
    "名称": "工信部上报数据准确性审批流程管理-6",
    "类型": "排队中",
    "工信部上报数据准确性审批流程节点规则": "排队中",
    "工信部上报数据准确性审批流程节点属性": "排队中",
    "修改工信部上报数据准确性审批流程节点状态": "排队中",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 7,
    "审批ID": "L-97627",
    "审批流程环节ID": "L-97627",
    "工信部上报数据准确性审批编号": "L-97627",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-7",
    "发起工信部上报数据准确性审批状态": "部分完成",
    "工信部上报数据准确性审批流程节点编号": "L-97627",
    "名称": "工信部上报数据准确性审批流程管理-7",
    "类型": "部分完成",
    "工信部上报数据准确性审批流程节点规则": "部分完成",
    "工信部上报数据准确性审批流程节点属性": "部分完成",
    "修改工信部上报数据准确性审批流程节点状态": "部分完成",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 8,
    "审批ID": "L-105546",
    "审批流程环节ID": "L-105546",
    "工信部上报数据准确性审批编号": "L-105546",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-8",
    "发起工信部上报数据准确性审批状态": "已启用",
    "工信部上报数据准确性审批流程节点编号": "L-105546",
    "名称": "工信部上报数据准确性审批流程管理-8",
    "类型": "已启用",
    "工信部上报数据准确性审批流程节点规则": "已启用",
    "工信部上报数据准确性审批流程节点属性": "已启用",
    "修改工信部上报数据准确性审批流程节点状态": "已启用",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 9,
    "审批ID": "L-113465",
    "审批流程环节ID": "L-113465",
    "工信部上报数据准确性审批编号": "L-113465",
    "工信部上报数据准确性审批名称": "工信部上报数据准确性审批流程管理-9",
    "发起工信部上报数据准确性审批状态": "已停用",
    "工信部上报数据准确性审批流程节点编号": "L-113465",
    "名称": "工信部上报数据准确性审批流程管理-9",
    "类型": "已停用",
    "工信部上报数据准确性审批流程节点规则": "已停用",
    "工信部上报数据准确性审批流程节点属性": "已停用",
    "修改工信部上报数据准确性审批流程节点状态": "已停用",
    "修改工信部上报数据准确性审批流程节点时间": "2026-05-08 09:35:44"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部上报数据准确性审批名称",
    "label": "工信部上报数据准确性审批名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "发起工信部上报数据准确性审批状态",
    "label": "发起工信部上报数据准确性审批状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据准确性审批流程节点编号",
    "label": "工信部上报数据准确性审批流程节点编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部上报数据准确性审批流程节点规则",
    "label": "工信部上报数据准确性审批流程节点规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报数据准确性审批流程节点属性",
    "label": "工信部上报数据准确性审批流程节点属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改工信部上报数据准确性审批流程节点状态",
    "label": "修改工信部上报数据准确性审批流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "修改工信部上报数据准确性审批流程节点时间",
    "label": "修改工信部上报数据准确性审批流程节点时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
...
const defaultRow = {
  ...
  "工信部上报数据准确性审批流程节点规则": "",
  "工信部上报数据准确性审批流程节点属性": "",
  "修改工信部上报数据准确性审批流程节点状态": "",
  "修改工信部上报数据准确性审批流程节点时间": ""
};
const importTemplateRow = {
  ...
  "修改工信部上报数据准确性审批流程节点状态": "",
  "修改工信部上报数据准确性审批流程节点时间": "",
  "导入来源": "工信部上报数据准确性审批流程管理导入模板.xlsx"
};
