    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP类型考核质量可用性信息表", "operation")'>IP类型考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核质量可用性字典信息", "form")'>新增IP类型数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP类型数据考核质量可用性模拟稽核信息", "form")'>新增IP类型数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP类型数据考核质量可用性模拟稽核信息", "config")'>修改IP类型数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP类型数据考核质量可用性模拟稽核信息")'>删除IP类型数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP类型考核质量可用性稽核数据上传", "form")'>IP类型考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP类型考核质量可用性稽核数据接口监控", "log")'>IP类型考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("其他IP考核质量可用性信息表", "operation")'>其他IP考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增其他IP数据考核质量可用性模拟稽核信息", "form")'>新增其他IP数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改其他IP数据考核质量可用性模拟稽核信息", "config")'>修改其他IP数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除其他IP数据考核质量可用性模拟稽核信息")'>删除其他IP数据考核质量可用性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("其他IP考核质量可用性稽核数据上传", "form")'>其他IP考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("其他IP考核质量可用性稽核数据接口监控", "log")'>其他IP考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "IP类型考核质量可用性ID": "U-7872",
    "IP类型考核质量可用性编号": "U-7872",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-1",
    "IP类型考核质量可用性状态": "已处理",
    "IP类型考核质量可用性时间": "2026-05-08 10:08:06",
    "IP类型考核质量可用性属性": "10.10.1.100",
    "IP类型考核质量可用性创建时间": "2026-05-08 10:08:06",
    "IP类型考核质量可用性所属部门": "安全运维部",
    "IP类型考核质量可用性负责人": "张三",
    "IP类型考核质量可用性类型": "10.10.1.100",
    "IP类型考核质量可用性规则": "10.10.1.100",
    "字典ID": "U-7872"
  },
  {
    "ID": 2,
    "IP类型考核质量可用性ID": "U-15791",
    "IP类型考核质量可用性编号": "U-15791",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-2",
    "IP类型考核质量可用性状态": "处理中",
    "IP类型考核质量可用性时间": "2026-05-08 10:42:31",
    "IP类型考核质量可用性属性": "172.16.0.50",
    "IP类型考核质量可用性创建时间": "2026-05-08 10:42:31",
    "IP类型考核质量可用性所属部门": "网络管理部",
    "IP类型考核质量可用性负责人": "李四",
    "IP类型考核质量可用性类型": "172.16.0.50",
    "IP类型考核质量可用性规则": "172.16.0.50",
    "字典ID": "U-15791"
  },
  {
    "ID": 3,
    "IP类型考核质量可用性ID": "U-23710",
    "IP类型考核质量可用性编号": "U-23710",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-3",
    "IP类型考核质量可用性状态": "待处理",
    "IP类型考核质量可用性时间": "2026-05-08 11:16:09",
    "IP类型考核质量可用性属性": "192.168.1.200",
    "IP类型考核质量可用性创建时间": "2026-05-08 11:16:09",
    "IP类型考核质量可用性所属部门": "资产管理部",
    "IP类型考核质量可用性负责人": "王五",
    "IP类型考核质量可用性类型": "192.168.1.200",
    "IP类型考核质量可用性规则": "192.168.1.200",
    "字典ID": "U-23710"
  },
  {
    "ID": 4,
    "IP类型考核质量可用性ID": "U-31629",
    "IP类型考核质量可用性编号": "U-31629",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-4",
    "IP类型考核质量可用性状态": "处理失败",
    "IP类型考核质量可用性时间": "2026-05-08 14:03:52",
    "IP类型考核质量可用性属性": "10.20.5.30",
    "IP类型考核质量可用性创建时间": "2026-05-08 14:03:52",
    "IP类型考核质量可用性所属部门": "信息安全部",
    "IP类型考核质量可用性负责人": "赵六",
    "IP类型考核质量可用性类型": "10.20.5.30",
    "IP类型考核质量可用性规则": "10.20.5.30",
    "字典ID": "U-31629"
  },
  {
    "ID": 5,
    "IP类型考核质量可用性ID": "U-39548",
    "IP类型考核质量可用性编号": "U-39548",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-5",
    "IP类型考核质量可用性状态": "已暂停",
    "IP类型考核质量可用性时间": "2026-05-08 15:21:37",
    "IP类型考核质量可用性属性": "172.20.1.80",
    "IP类型考核质量可用性创建时间": "2026-05-08 15:21:37",
    "IP类型考核质量可用性所属部门": "系统运维部",
    "IP类型考核质量可用性负责人": "system",
    "IP类型考核质量可用性类型": "172.20.1.80",
    "IP类型考核质量可用性规则": "172.20.1.80",
    "字典ID": "U-39548"
  },
  {
    "ID": 6,
    "IP类型考核质量可用性ID": "U-47467",
    "IP类型考核质量可用性编号": "U-47467",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-6",
    "IP类型考核质量可用性状态": "已完成",
    "IP类型考核质量可用性时间": "2026-05-08 16:08:25",
    "IP类型考核质量可用性属性": "10.0.0.254",
    "IP类型考核质量可用性创建时间": "2026-05-08 16:08:25",
    "IP类型考核质量可用性所属部门": "数据管理部",
    "IP类型考核质量可用性负责人": "admin",
    "IP类型考核质量可用性类型": "10.0.0.254",
    "IP类型考核质量可用性规则": "10.0.0.254",
    "字典ID": "U-47467"
  },
  {
    "ID": 7,
    "IP类型考核质量可用性ID": "U-55386",
    "IP类型考核质量可用性编号": "U-55386",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-7",
    "IP类型考核质量可用性状态": "排队中",
    "IP类型考核质量可用性时间": "2026-05-09 08:33:11",
    "IP类型考核质量可用性属性": "10.10.1.100",
    "IP类型考核质量可用性创建时间": "2026-05-09 08:33:11",
    "IP类型考核质量可用性所属部门": "安全运维部",
    "IP类型考核质量可用性负责人": "张三",
    "IP类型考核质量可用性类型": "10.10.1.100",
    "IP类型考核质量可用性规则": "10.10.1.100",
  ...
  {
    "ID": 8,
    "IP类型考核质量可用性ID": "U-63305",
    "IP类型考核质量可用性编号": "U-63305",
    "IP类型考核质量可用性名称": "IP类型考核质量可用性指标管理-8",
    "IP类型考核质量可用性状态": "部分完成",
    "IP类型考核质量可用性时间": "2026-05-09 09:47:56",
    "IP类型考核质量可用性属性": "172.16.0.50",
    "IP类型考核质量可用性创建时间": "2026-05-09 09:47:56",
    "IP类型考核质量可用性所属部门": "网络管理部",
    "IP类型考核质量可用性负责人": "李四",
    "IP类型考核质量可用性类型": "172.16.0.50",
    "IP类型考核质量可用性规则": "172.16.0.50",
...
const tableColumns = [
  ...
  {
    "prop": "IP类型考核质量可用性创建时间",
    "label": "IP类型考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "IP类型考核质量可用性所属部门",
    "label": "IP类型考核质量可用性所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
