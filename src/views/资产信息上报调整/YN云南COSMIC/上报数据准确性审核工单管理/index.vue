    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据准确性审核工单信息", "form")'>新增上报数据准确性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据准确性审核工单信息", "config")'>修改上报数据准确性审核工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据准确性审核工单信息")'>删除上报数据准确性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看上报数据准确性审核工单信息", "detail")'>查看上报数据准确性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据准确性审核工单附件文件上传", "form")'>上报数据准确性审核工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据准确性审核工单附件文件删除", "operation")'>上报数据准确性审核工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据准确性审核工单信息审批", "audit")'>上报数据准确性审核工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据准确性审核工单信息撤回", "operation")'>上报数据准确性审核工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据准确性审核工单信息终止", "operation")'>上报数据准确性审核工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据准确性审核工单信息派发提醒", "audit")'>上报数据准确性审核工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "上报数据准确性审核ID": "M-55730",
    "上报数据准确性审核编号": "M-55730",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-1",
    "新增上报数据准确性审核状态": "待处理",
    "新增上报数据准确性审核时间": "2026-05-08 09:12:18",
    "上报数据准确性审核属性": "待处理",
    "上报数据准确性审核创建时间": "2026-05-08 09:12:18",
    "上报数据准确性审核所属部门": "资产管理部",
    "上报数据准确性审核负责人": "王五",
    "上报数据准确性审核类型": "待处理",
    "上报数据准确性审核规则": "待处理",
  ...
  },
  {
    ...
    "上报数据准确性审核ID": "M-63649",
    "上报数据准确性审核编号": "M-63649",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-2",
    "新增上报数据准确性审核状态": "处理失败",
    "新增上报数据准确性审核时间": "2026-05-08 09:35:44",
    "上报数据准确性审核属性": "处理失败",
    "上报数据准确性审核创建时间": "2026-05-08 09:35:44",
    "上报数据准确性审核所属部门": "信息安全部",
    "上报数据准确性审核负责人": "赵六",
    "上报数据准确性审核类型": "处理失败",
    "上报数据准确性审核规则": "处理失败",
  ...
  },
  {
    ...
    "上报数据准确性审核ID": "M-71568",
    "上报数据准确性审核编号": "M-71568",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-3",
    "新增上报数据准确性审核状态": "已暂停",
    "新增上报数据准确性审核时间": "2026-05-08 10:08:06",
    "上报数据准确性审核属性": "已暂停",
    "上报数据准确性审核创建时间": "2026-05-08 10:08:06",
    "上报数据准确性审核所属部门": "系统运维部",
    "上报数据准确性审核负责人": "system",
    "上报数据准确性审核类型": "已暂停",
    "上报数据准确性审核规则": "已暂停",
  ...
  },
  {
    ...
    "上报数据准确性审核ID": "M-79487",
    "上报数据准确性审核编号": "M-79487",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-4",
    "新增上报数据准确性审核状态": "已完成",
    "新增上报数据准确性审核时间": "2026-05-08 10:42:31",
    "上报数据准确性审核属性": "已完成",
    "上报数据准确性审核创建时间": "2026-05-08 10:42:31",
    "上报数据准确性审核所属部门": "数据管理部",
    "上报数据准确性审核负责人": "admin",
    "上报数据准确性审核类型": "已完成",
    "上报数据准确性审核规则": "已完成",
  ...
  },
  {
    ...
    "上报数据准确性审核ID": "M-87406",
    "上报数据准确性审核编号": "M-87406",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-5",
    "新增上报数据准确性审核状态": "排队中",
    "新增上报数据准确性审核时间": "2026-05-08 11:16:09",
    "上报数据准确性审核属性": "排队中",
    "上报数据准确性审核创建时间": "2026-05-08 11:16:09",
    "上报数据准确性审核所属部门": "安全运维部",
    "上报数据准确性审核负责人": "张三",
    "上报数据准确性审核类型": "排队中",
    "上报数据准确性审核规则": "排队中",
  ...
  },
  {
    ...
    "上报数据准确性审核ID": "M-95325",
    "上报数据准确性审核编号": "M-95325",
    "上报数据准确性审核名称": "上报数据准确性审核工单管理-6",
    "新增上报数据准确性审核状态": "部分完成",
    "新增上报数据准确性审核时间": "2026-05-08 14:03:52",
    "上报数据准确性审核属性": "部分完成",
    "上报数据准确性审核创建时间": "2026-05-08 14:03:52",
    "上报数据准确性审核所属部门": "网络管理部",
    "上报数据准确性审核负责人": "李四",
    "上报数据准确性审核类型": "部分完成",
    "上报数据准确性审核规则": "部分完成",
