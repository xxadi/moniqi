    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据考核项目完整性监控", "log")'>上报数据考核项目完整性监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("上报数据考核项目完整性监控告警", "alert")'>上报数据考核项目完整性监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据考核项目完整性告警规则", "form")'>新增上报数据考核项目完整性告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据考核项目完整性告警规则", "config")'>修改上报数据考核项目完整性告警规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据考核项目完整性告警规则")'>删除上报数据考核项目完整性告警规则</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据考核项目完整性稽核", "audit")'>上报数据考核项目完整性稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核项目完整性统计", "statistics")'>上报数据考核项目完整性统计</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "监控编号": "X-57249",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-1",
    "上报数据考核项目完整性监控状态": "处理中",
    "上报数据考核项目完整性监控内容": "处理中",
    "上报数据考核项目完整性监控时间": "2026-05-09 09:47:56",
    "编号": "X-57249",
    "上报数据考核项目完整性监控编号": "X-57249",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-1",
    "上报数据考核项目完整性监控告警时间": "2026-05-09 09:47:56",
    "上报数据考核项目完整性监控告警内容": "处理中",
    "上报数据考核项目完整性监控告警状态": "处理中",
    "监控告警名称": "上报数据考核项目完整性指标管理-1"
  },
  {
    "ID": 2,
    "监控编号": "X-65168",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-2",
    "上报数据考核项目完整性监控状态": "待处理",
    "上报数据考核项目完整性监控内容": "待处理",
    "上报数据考核项目完整性监控时间": "2026-05-08 09:12:18",
    "编号": "X-65168",
    "上报数据考核项目完整性监控编号": "X-65168",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-2",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 09:12:18",
    "上报数据考核项目完整性监控告警内容": "待处理",
    "上报数据考核项目完整性监控告警状态": "待处理",
    "监控告警名称": "上报数据考核项目完整性指标管理-2"
  },
  {
    "ID": 3,
    "监控编号": "X-73087",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-3",
    "上报数据考核项目完整性监控状态": "处理失败",
    "上报数据考核项目完整性监控内容": "处理失败",
    "上报数据考核项目完整性监控时间": "2026-05-08 09:35:44",
    "编号": "X-73087",
    "上报数据考核项目完整性监控编号": "X-73087",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-3",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 09:35:44",
    "上报数据考核项目完整性监控告警内容": "处理失败",
    "上报数据考核项目完整性监控告警状态": "处理失败",
    "监控告警名称": "上报数据考核项目完整性指标管理-3"
  },
  {
    "ID": 4,
    "监控编号": "X-81006",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-4",
    "上报数据考核项目完整性监控状态": "已暂停",
    "上报数据考核项目完整性监控内容": "已暂停",
    "上报数据考核项目完整性监控时间": "2026-05-08 10:08:06",
    "编号": "X-81006",
    "上报数据考核项目完整性监控编号": "X-81006",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-4",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 10:08:06",
    "上报数据考核项目完整性监控告警内容": "已暂停",
    "上报数据考核项目完整性监控告警状态": "已暂停",
    "监控告警名称": "上报数据考核项目完整性指标管理-4"
  },
  {
    "ID": 5,
    "监控编号": "X-88925",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-5",
    "上报数据考核项目完整性监控状态": "已完成",
    "上报数据考核项目完整性监控内容": "已完成",
    "上报数据考核项目完整性监控时间": "2026-05-08 10:42:31",
    "编号": "X-88925",
    "上报数据考核项目完整性监控编号": "X-88925",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-5",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 10:42:31",
    "上报数据考核项目完整性监控告警内容": "已完成",
    "上报数据考核项目完整性监控告警状态": "已完成",
    "监控告警名称": "上报数据考核项目完整性指标管理-5"
  },
  {
    "ID": 6,
    "监控编号": "X-96844",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-6",
    "上报数据考核项目完整性监控状态": "排队中",
    "上报数据考核项目完整性监控内容": "排队中",
    "上报数据考核项目完整性监控时间": "2026-05-08 11:16:09",
    "编号": "X-96844",
    "上报数据考核项目完整性监控编号": "X-96844",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-6",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 11:16:09",
    "上报数据考核项目完整性监控告警内容": "排队中",
    "上报数据考核项目完整性监控告警状态": "排队中",
    "监控告警名称": "上报数据考核项目完整性指标管理-6"
  },
  {
    "ID": 7,
    "监控编号": "X-104763",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-7",
    "上报数据考核项目完整性监控状态": "部分完成",
    "上报数据考核项目完整性监控内容": "部分完成",
    "上报数据考核项目完整性监控时间": "2026-05-08 14:03:52",
    "编号": "X-104763",
    "上报数据考核项目完整性监控编号": "X-104763",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-7",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 14:03:52",
    "上报数据考核项目完整性监控告警内容": "部分完成",
    "上报数据考核项目完整性监控告警状态": "部分完成",
    "监控告警名称": "上报数据考核项目完整性指标管理-7"
  },
  {
    "ID": 8,
    "监控编号": "X-112682",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-8",
    "上报数据考核项目完整性监控状态": "已启用",
    "上报数据考核项目完整性监控内容": "已启用",
    "上报数据考核项目完整性监控时间": "2026-05-08 15:21:37",
    "编号": "X-112682",
    "上报数据考核项目完整性监控编号": "X-112682",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-8",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 15:21:37",
    "上报数据考核项目完整性监控告警内容": "已启用",
    "上报数据考核项目完整性监控告警状态": "已启用",
    "监控告警名称": "上报数据考核项目完整性指标管理-8"
  },
  {
    "ID": 9,
    "监控编号": "X-120601",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-9",
    "上报数据考核项目完整性监控状态": "已停用",
    "上报数据考核项目完整性监控内容": "已停用",
    "上报数据考核项目完整性监控时间": "2026-05-08 16:08:25",
    "编号": "X-120601",
    "上报数据考核项目完整性监控编号": "X-120601",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-9",
    "上报数据考核项目完整性监控告警时间": "2026-05-08 16:08:25",
    "上报数据考核项目完整性监控告警内容": "已停用",
    "上报数据考核项目完整性监控告警状态": "已停用",
    "监控告警名称": "上报数据考核项目完整性指标管理-9"
  },
  {
    "ID": 10,
    "监控编号": "X-128520",
    "上报数据考核项目完整性监控名称": "上报数据考核项目完整性指标管理-10",
    "上报数据考核项目完整性监控状态": "正常",
    "上报数据考核项目完整性监控内容": "正常",
    "上报数据考核项目完整性监控时间": "2026-05-09 08:33:11",
    "编号": "X-128520",
    "上报数据考核项目完整性监控编号": "X-128520",
    "上报数据考核项目完整性监控告警名称": "上报数据考核项目完整性指标管理-10",
    "上报数据考核项目完整性监控告警时间": "2026-05-09 08:33:11",
    "上报数据考核项目完整性监控告警内容": "正常",
    "上报数据考核项目完整性监控告警状态": "正常",
    "监控告警名称": "上报数据考核项目完整性指标管理-10"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "上报数据考核项目完整性监控名称",
    "label": "上报数据考核项目完整性监控名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控状态",
    "label": "上报数据考核项目完整性监控状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控内容",
    "label": "上报数据考核项目完整性监控内容",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控时间",
    "label": "上报数据考核项目完整性监控时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "上报数据考核项目完整性监控编号",
    "label": "上报数据考核项目完整性监控编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控告警名称",
    "label": "上报数据考核项目完整性监控告警名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控告警时间",
    "label": "上报数据考核项目完整性监控告警时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "上报数据考核项目完整性监控告警内容",
    "label": "上报数据考核项目完整性监控告警内容",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "上报数据考核项目完整性监控告警状态",
    "label": "上报数据考核项目完整性监控告警状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
