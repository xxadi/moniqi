    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起暴露面一键探测审批流程", "workflow")'>发起暴露面一键探测审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面一键探测审批指派信息", "form")'>新增暴露面一键探测审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面一键探测审批流程", "form")'>新增暴露面一键探测审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面一键探测审批流程信息", "config")'>修改暴露面一键探测审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批流程删除", "operation")'>暴露面一键探测审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批流程查询", "detail")'>暴露面一键探测审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批附件上传", "form")'>暴露面一键探测审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批流程图查看", "preview")'>暴露面一键探测审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批流程通知", "audit")'>暴露面一键探测审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批结果逐级审批", "audit")'>暴露面一键探测审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面一键探测审批结果拒绝和驳回", "approval")'>暴露面一键探测审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "暴露面一键探测审批ID": "I-18754",
    "暴露面一键探测审批流程环节ID": "I-18754",
    "暴露面一键探测审批编号": "I-18754",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-1",
    "发起暴露面一键探测审批状态": "待处理",
    "发起暴露面一键探测审批时间": "2026-05-08 11:16:09",
    "暴露面一键探测审批属性": "待处理",
    "暴露面一键探测审批发起时间": "2026-05-08 11:16:09",
    "暴露面一键探测审批流程id": "待处理",
    "暴露面一键探测审批流程环节": "待处理",
    "暴露面一键探测审批创建时间": "2026-05-08 11:16:09"
  },
  {
    "ID": 2,
    "暴露面一键探测审批ID": "I-26673",
    "暴露面一键探测审批流程环节ID": "I-26673",
    "暴露面一键探测审批编号": "I-26673",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-2",
    "发起暴露面一键探测审批状态": "处理失败",
    "发起暴露面一键探测审批时间": "2026-05-08 14:03:52",
    "暴露面一键探测审批属性": "处理失败",
    "暴露面一键探测审批发起时间": "2026-05-08 14:03:52",
    "暴露面一键探测审批流程id": "处理失败",
    "暴露面一键探测审批流程环节": "处理失败",
    "暴露面一键探测审批创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 3,
    "暴露面一键探测审批ID": "I-34592",
    "暴露面一键探测审批流程环节ID": "I-34592",
    "暴露面一键探测审批编号": "I-34592",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-3",
    "发起暴露面一键探测审批状态": "已暂停",
    "发起暴露面一键探测审批时间": "2026-05-08 15:21:37",
    "暴露面一键探测审批属性": "已暂停",
    "暴露面一键探测审批发起时间": "2026-05-08 15:21:37",
    "暴露面一键探测审批流程id": "已暂停",
    "暴露面一键探测审批流程环节": "已暂停",
    "暴露面一键探测审批创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 4,
    "暴露面一键探测审批ID": "I-42511",
    "暴露面一键探测审批流程环节ID": "I-42511",
    "暴露面一键探测审批编号": "I-42511",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-4",
    "发起暴露面一键探测审批状态": "已完成",
    "发起暴露面一键探测审批时间": "2026-05-08 16:08:25",
    "暴露面一键探测审批属性": "已完成",
    "暴露面一键探测审批发起时间": "2026-05-08 16:08:25",
    "暴露面一键探测审批流程id": "已完成",
    "暴露面一键探测审批流程环节": "已完成",
    "暴露面一键探测审批创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 5,
    "暴露面一键探测审批ID": "I-50430",
    "暴露面一键探测审批流程环节ID": "I-50430",
    "暴露面一键探测审批编号": "I-50430",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-5",
    "发起暴露面一键探测审批状态": "排队中",
    "发起暴露面一键探测审批时间": "2026-05-09 08:33:11",
    "暴露面一键探测审批属性": "排队中",
    "暴露面一键探测审批发起时间": "2026-05-09 08:33:11",
    "暴露面一键探测审批流程id": "排队中",
    "暴露面一键探测审批流程环节": "排队中",
    "暴露面一键探测审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 6,
    "暴露面一键探测审批ID": "I-58349",
    "暴露面一键探测审批流程环节ID": "I-58349",
    "暴露面一键探测审批编号": "I-58349",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-6",
    "发起暴露面一键探测审批状态": "部分完成",
    "发起暴露面一键探测审批时间": "2026-05-09 09:47:56",
    "暴露面一键探测审批属性": "部分完成",
    "暴露面一键探测审批发起时间": "2026-05-09 09:47:56",
    "暴露面一键探测审批流程id": "部分完成",
    "暴露面一键探测审批流程环节": "部分完成",
    "暴露面一键探测审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 7,
    "暴露面一键探测审批ID": "I-66268",
    "暴露面一键探测审批流程环节ID": "I-66268",
    "暴露面一键探测审批编号": "I-66268",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-7",
    "发起暴露面一键探测审批状态": "已启用",
    "发起暴露面一键探测审批时间": "2026-05-08 09:12:18",
    "暴露面一键探测审批属性": "已启用",
    "暴露面一键探测审批发起时间": "2026-05-08 09:12:18",
    "暴露面一键探测审批流程id": "已启用",
    "暴露面一键探测审批流程环节": "已启用",
    "暴露面一键探测审批创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 8,
    "暴露面一键探测审批ID": "I-74187",
    "暴露面一键探测审批流程环节ID": "I-74187",
    "暴露面一键探测审批编号": "I-74187",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-8",
    "发起暴露面一键探测审批状态": "已停用",
    "发起暴露面一键探测审批时间": "2026-05-08 09:35:44",
    "暴露面一键探测审批属性": "已停用",
    "暴露面一键探测审批发起时间": "2026-05-08 09:35:44",
    "暴露面一键探测审批流程id": "已停用",
    "暴露面一键探测审批流程环节": "已停用",
    "暴露面一键探测审批创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 9,
    "暴露面一键探测审批ID": "I-82106",
    "暴露面一键探测审批流程环节ID": "I-82106",
    "暴露面一键探测审批编号": "I-82106",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-9",
    "发起暴露面一键探测审批状态": "正常",
    "发起暴露面一键探测审批时间": "2026-05-08 10:08:06",
    "暴露面一键探测审批属性": "正常",
    "暴露面一键探测审批发起时间": "2026-05-08 10:08:06",
    "暴露面一键探测审批流程id": "正常",
    "暴露面一键探测审批流程环节": "正常",
    "暴露面一键探测审批创建时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 10,
    "暴露面一键探测审批ID": "I-90025",
    "暴露面一键探测审批流程环节ID": "I-90025",
    "暴露面一键探测审批编号": "I-90025",
    "暴露面一键探测审批名称": "暴露面一键探测审批流程管理-10",
    "发起暴露面一键探测审批状态": "异常",
    "发起暴露面一键探测审批时间": "2026-05-08 10:42:31",
    "暴露面一键探测审批属性": "异常",
    "暴露面一键探测审批发起时间": "2026-05-08 10:42:31",
    "暴露面一键探测审批流程id": "异常",
    "暴露面一键探测审批流程环节": "异常",
    "暴露面一键探测审批创建时间": "2026-05-08 10:42:31"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "暴露面一键探测审批流程环节ID",
    "label": "暴露面一键探测审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
