    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核项目完整性信息表", "operation")'>CPU厂商考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商数据考核项目完整性字典信息", "form")'>新增CPU厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商数据考核项目完整性字典信息", "config")'>修改CPU厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商数据考核项目完整性字典信息")'>删除CPU厂商数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商考核项目完整性上传任务", "form")'>新增CPU厂商考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商考核项目完整性上传任务")'>删除CPU厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商考核项目完整性上传任务", "config")'>修改CPU厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询CPU厂商考核项目完整性上传任务", "detail")'>查询CPU厂商考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核项目完整性上传任务启用/禁用", "form")'>CPU厂商考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU厂商考核项目完整性稽核数据上传", "form")'>CPU厂商考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU厂商考核项目完整性稽核数据接口监控", "log")'>CPU厂商考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU型号考核项目完整性信息表", "operation")'>CPU型号考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU型号考核项目完整性稽核数据上传", "form")'>CPU型号考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU型号考核项目完整性稽核数据接口监控", "log")'>CPU型号考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "CPU厂商考核项目完整性ID": "S-75886",
    "CPU厂商考核项目完整性编号": "S-75886",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-1",
    "CPU厂商考核项目完整性状态": "已驳回",
    "CPU厂商考核项目完整性时间": "2026-05-08 15:21:37",
    "CPU厂商考核项目完整性属性": "已驳回",
    "CPU厂商考核项目完整性创建时间": "2026-05-08 15:21:37",
    "CPU厂商考核项目完整性所属部门": "系统运维部",
    "CPU厂商考核项目完整性负责人": "system",
    "CPU厂商考核项目完整性类型": "已驳回",
    "CPU厂商考核项目完整性规则": "已驳回",
    "CPU厂商数据考核项目完整性字典ID": "S-75886"
  },
  {
    "ID": 2,
    "CPU厂商考核项目完整性ID": "S-83805",
    "CPU厂商考核项目完整性编号": "S-83805",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-2",
    "CPU厂商考核项目完整性状态": "待审核",
    "CPU厂商考核项目完整性时间": "2026-05-08 16:08:25",
    "CPU厂商考核项目完整性属性": "待审核",
    "CPU厂商考核项目完整性创建时间": "2026-05-08 16:08:25",
    "CPU厂商考核项目完整性所属部门": "数据管理部",
    "CPU厂商考核项目完整性负责人": "admin",
    "CPU厂商考核项目完整性类型": "待审核",
    "CPU厂商考核项目完整性规则": "待审核",
    "CPU厂商数据考核项目完整性字典ID": "S-83805"
  },
  {
    "ID": 3,
    "CPU厂商考核项目完整性ID": "S-91724",
    "CPU厂商考核项目完整性编号": "S-91724",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-3",
    "CPU厂商考核项目完整性状态": "已处理",
    "CPU厂商考核项目完整性时间": "2026-05-09 08:33:11",
    "CPU厂商考核项目完整性属性": "已处理",
    "CPU厂商考核项目完整性创建时间": "2026-05-09 08:33:11",
    "CPU厂商考核项目完整性所属部门": "安全运维部",
    "CPU厂商考核项目完整性负责人": "张三",
    "CPU厂商考核项目完整性类型": "已处理",
    "CPU厂商考核项目完整性规则": "已处理",
    "CPU厂商数据考核项目完整性字典ID": "S-91724"
  },
  {
    "ID": 4,
    "CPU厂商考核项目完整性ID": "S-99643",
    "CPU厂商考核项目完整性编号": "S-99643",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-4",
    "CPU厂商考核项目完整性状态": "处理中",
    "CPU厂商考核项目完整性时间": "2026-05-09 09:47:56",
    "CPU厂商考核项目完整性属性": "处理中",
    "CPU厂商考核项目完整性创建时间": "2026-05-09 09:47:56",
    "CPU厂商考核项目完整性所属部门": "网络管理部",
    "CPU厂商考核项目完整性负责人": "李四",
    "CPU厂商考核项目完整性类型": "处理中",
    "CPU厂商考核项目完整性规则": "处理中",
    "CPU厂商数据考核项目完整性字典ID": "S-99643"
  },
  {
    "ID": 5,
    "CPU厂商考核项目完整性ID": "S-107562",
    "CPU厂商考核项目完整性编号": "S-107562",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-5",
    "CPU厂商考核项目完整性状态": "待处理",
    "CPU厂商考核项目完整性时间": "2026-05-08 09:12:18",
    "CPU厂商考核项目完整性属性": "待处理",
    "CPU厂商考核项目完整性创建时间": "2026-05-08 09:12:18",
    "CPU厂商考核项目完整性所属部门": "资产管理部",
    "CPU厂商考核项目完整性负责人": "王五",
    "CPU厂商考核项目完整性类型": "待处理",
    "CPU厂商考核项目完整性规则": "待处理",
    "CPU厂商数据考核项目完整性字典ID": "S-107562"
  },
  {
    "ID": 6,
    "CPU厂商考核项目完整性ID": "S-115481",
    "CPU厂商考核项目完整性编号": "S-115481",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-6",
    "CPU厂商考核项目完整性状态": "处理失败",
    "CPU厂商考核项目完整性时间": "2026-05-08 09:35:44",
    "CPU厂商考核项目完整性属性": "处理失败",
    "CPU厂商考核项目完整性创建时间": "2026-05-08 09:35:44",
    "CPU厂商考核项目完整性所属部门": "信息安全部",
    "CPU厂商考核项目完整性负责人": "赵六",
    "CPU厂商考核项目完整性类型": "处理失败",
    "CPU厂商考核项目完整性规则": "处理失败",
    "CPU厂商数据考核项目完整性字典ID": "S-115481"
  },
  {
    "ID": 7,
    "CPU厂商考核项目完整性ID": "S-123400",
    "CPU厂商考核项目完整性编号": "S-123400",
    "CPU厂商考核项目完整性名称": "CPU厂商考核项目完整性指标管理-7",
    "CPU厂商考核项目完整性状态": "已暂停",
    "CPU厂商考核项目完整性时间": "2026-05-08 10:08:06",
    "CPU厂商考核项目完整性属性": "已暂停",
    "CPU厂商考核项目完整性创建时间": "2026-05-08 10:08:06",
    "CPU厂商考核项目完整性所属部门": "系统运维部",
    "CPU厂商考核项目完整性负责人": "system",
    "CPU厂商考核项目完整性类型": "已暂停",
    "CPU厂商考核项目完整性规则": "已暂停",
    "CPU厂商数据考核项目完整性字典ID": "S-123400"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "CPU厂商考核项目完整性属性",
    "label": "CPU厂商考核项目完整性属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "CPU厂商考核项目完整性创建时间",
    "label": "CPU厂商考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "CPU厂商考核项目完整性所属部门",
    "label": "CPU厂商考核项目完整性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "CPU厂商考核项目完整性负责人",
    "label": "CPU厂商考核项目完整性负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  ...
  {
    "prop": "CPU厂商考核项目完整性规则",
    "label": "CPU厂商考核项目完整性规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "CPU厂商数据考核项目完整性字典ID",
    "label": "CPU厂商数据考核项目完整性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "CPU厂商考核项目完整性规则": "",
  "CPU厂商数据考核项目完整性字典ID": "",
  "导入来源": "CPU厂商考核项目完整性指标管理导入模板.xlsx"
};
