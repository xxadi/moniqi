    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产物理位置稽核工单信息", "form")'>新增资产物理位置稽核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产物理位置稽核工单信息", "config")'>修改资产物理位置稽核工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产物理位置稽核工单信息")'>删除资产物理位置稽核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产物理位置稽核工单信息", "detail")'>查看资产物理位置稽核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单附件文件上传", "form")'>资产物理位置稽核工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单附件文件删除", "operation")'>资产物理位置稽核工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单信息审批", "audit")'>资产物理位置稽核工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单信息撤回", "audit")'>资产物理位置稽核工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单信息终止", "audit")'>资产物理位置稽核工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产物理位置稽核工单信息派发提醒", "audit")'>资产物理位置稽核工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产物理位置稽核ID": "T-11537",
    "资产物理位置稽核编号": "T-11537",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-1",
    "新增资产物理位置稽核状态": "处理中",
    "新增资产物理位置稽核时间": "2026-05-08 16:08:25",
    "资产物理位置稽核属性": "处理中",
    "资产物理位置稽核创建时间": "2026-05-08 16:08:25",
    "资产物理位置稽核所属部门": "数据管理部",
    "资产物理位置稽核负责人": "admin",
    "资产物理位置稽核类型": "处理中",
    "资产物理位置稽核规则": "处理中",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-19456",
    "资产物理位置稽核编号": "T-19456",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-2",
    "新增资产物理位置稽核状态": "待处理",
    "新增资产物理位置稽核时间": "2026-05-09 08:33:11",
    "资产物理位置稽核属性": "待处理",
    "资产物理位置稽核创建时间": "2026-05-09 08:33:11",
    "资产物理位置稽核所属部门": "安全运维部",
    "资产物理位置稽核负责人": "张三",
    "资产物理位置稽核类型": "待处理",
    "资产物理位置稽核规则": "待处理",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-27375",
    "资产物理位置稽核编号": "T-27375",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-3",
    "新增资产物理位置稽核状态": "处理失败",
    "新增资产物理位置稽核时间": "2026-05-09 09:47:56",
    "资产物理位置稽核属性": "处理失败",
    "资产物理位置稽核创建时间": "2026-05-09 09:47:56",
    "资产物理位置稽核所属部门": "网络管理部",
    "资产物理位置稽核负责人": "李四",
    "资产物理位置稽核类型": "处理失败",
    "资产物理位置稽核规则": "处理失败",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-35294",
    "资产物理位置稽核编号": "T-35294",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-4",
    "新增资产物理位置稽核状态": "已暂停",
    "新增资产物理位置稽核时间": "2026-05-08 09:12:18",
    "资产物理位置稽核属性": "已暂停",
    "资产物理位置稽核创建时间": "2026-05-08 09:12:18",
    "资产物理位置稽核所属部门": "资产管理部",
    "资产物理位置稽核负责人": "王五",
    "资产物理位置稽核类型": "已暂停",
    "资产物理位置稽核规则": "已暂停",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-43213",
    "资产物理位置稽核编号": "T-43213",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-5",
    "新增资产物理位置稽核状态": "已完成",
    "新增资产物理位置稽核时间": "2026-05-08 09:35:44",
    "资产物理位置稽核属性": "已完成",
    "资产物理位置稽核创建时间": "2026-05-08 09:35:44",
    "资产物理位置稽核所属部门": "信息安全部",
    "资产物理位置稽核负责人": "赵六",
    "资产物理位置稽核类型": "已完成",
    "资产物理位置稽核规则": "已完成",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-51132",
    "资产物理位置稽核编号": "T-51132",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-6",
    "新增资产物理位置稽核状态": "排队中",
    "新增资产物理位置稽核时间": "2026-05-08 10:08:06",
    "资产物理位置稽核属性": "排队中",
    "资产物理位置稽核创建时间": "2026-05-08 10:08:06",
    "资产物理位置稽核所属部门": "系统运维部",
    "资产物理位置稽核负责人": "system",
    "资产物理位置稽核类型": "排队中",
    "资产物理位置稽核规则": "排队中",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-59051",
    "资产物理位置稽核编号": "T-59051",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-7",
    "新增资产物理位置稽核状态": "部分完成",
    "新增资产物理位置稽核时间": "2026-05-08 10:42:31",
    "资产物理位置稽核属性": "部分完成",
    "资产物理位置稽核创建时间": "2026-05-08 10:42:31",
    "资产物理位置稽核所属部门": "数据管理部",
    "资产物理位置稽核负责人": "admin",
    "资产物理位置稽核类型": "部分完成",
    "资产物理位置稽核规则": "部分完成",
  ...
  },
  {
    ...
    "资产物理位置稽核ID": "T-66970",
    "资产物理位置稽核编号": "T-66970",
    "资产物理位置稽核名称": "资产物理位置稽核工单管理-8",
    "新增资产物理位置稽核状态": "已启用",
    "新增资产物理位置稽核时间": "2026-05-08 11:16:09",
    "资产物理位置稽核属性": "已启用",
    "资产物理位置稽核创建时间": "2026-05-08 11:16:09",
    "资产物理位置稽核所属部门": "安全运维部",
    "资产物理位置稽核负责人": "张三",
    "资产物理位置稽核类型": "已启用",
    "资产物理位置稽核规则": "已启用",
