    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备品牌考核准确性信息表", "operation")'>设备品牌考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备品牌数据考核准确性字典信息", "form")'>新增设备品牌数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备品牌数据考核准确性字典信息", "config")'>修改设备品牌数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备品牌数据考核准确性字典信息")'>删除设备品牌数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备品牌考核准确性稽核数据上传", "form")'>设备品牌考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备品牌考核准确性稽核数据接口监控", "log")'>设备品牌考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("品牌区域考核准确性信息表", "operation")'>品牌区域考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("品牌区域考核准确性稽核数据上传", "form")'>品牌区域考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("品牌区域考核准确性稽核数据接口监控", "log")'>品牌区域考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "设备品牌考核准确性ID": "F-74235",
    "设备品牌考核准确性编号": "F-74235",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-1",
    "设备品牌考核准确性状态": "异常",
    "设备品牌考核准确性时间": "2026-05-08 14:03:52",
    "设备品牌考核准确性属性": "异常",
    "设备品牌考核准确性创建时间": "2026-05-08 14:03:52",
    "设备品牌考核准确性所属部门": "信息安全部",
    "设备品牌考核准确性负责人": "赵六",
    "设备品牌考核准确性类型": "异常",
    "设备品牌考核准确性规则": "异常",
    "设备品牌数据考核准确性字典ID": "F-74235"
  },
  {
    "ID": 2,
    "设备品牌考核准确性ID": "F-82154",
    "设备品牌考核准确性编号": "F-82154",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-2",
    "设备品牌考核准确性状态": "超时",
    "设备品牌考核准确性时间": "2026-05-08 15:21:37",
    "设备品牌考核准确性属性": "超时",
    "设备品牌考核准确性创建时间": "2026-05-08 15:21:37",
    "设备品牌考核准确性所属部门": "系统运维部",
    "设备品牌考核准确性负责人": "system",
    "设备品牌考核准确性类型": "超时",
    "设备品牌考核准确性规则": "超时",
    "设备品牌数据考核准确性字典ID": "F-82154"
  },
  {
    "ID": 3,
    "设备品牌考核准确性ID": "F-90073",
    "设备品牌考核准确性编号": "F-90073",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-3",
    "设备品牌考核准确性状态": "已取消",
    "设备品牌考核准确性时间": "2026-05-08 16:08:25",
    "设备品牌考核准确性属性": "已取消",
    "设备品牌考核准确性创建时间": "2026-05-08 16:08:25",
    "设备品牌考核准确性所属部门": "数据管理部",
    "设备品牌考核准确性负责人": "admin",
    "设备品牌考核准确性类型": "已取消",
    "设备品牌考核准确性规则": "已取消",
    "设备品牌数据考核准确性字典ID": "F-90073"
  },
  {
    "ID": 4,
    "设备品牌考核准确性ID": "F-97992",
    "设备品牌考核准确性编号": "F-97992",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-4",
    "设备品牌考核准确性状态": "已驳回",
    "设备品牌考核准确性时间": "2026-05-09 08:33:11",
    "设备品牌考核准确性属性": "已驳回",
    "设备品牌考核准确性创建时间": "2026-05-09 08:33:11",
    "设备品牌考核准确性所属部门": "安全运维部",
    "设备品牌考核准确性负责人": "张三",
    "设备品牌考核准确性类型": "已驳回",
    "设备品牌考核准确性规则": "已驳回",
    "设备品牌数据考核准确性字典ID": "F-97992"
  },
  {
    "ID": 5,
    "设备品牌考核准确性ID": "F-105911",
    "设备品牌考核准确性编号": "F-105911",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-5",
    "设备品牌考核准确性状态": "待审核",
    "设备品牌考核准确性时间": "2026-05-09 09:47:56",
    "设备品牌考核准确性属性": "待审核",
    "设备品牌考核准确性创建时间": "2026-05-09 09:47:56",
    "设备品牌考核准确性所属部门": "网络管理部",
    "设备品牌考核准确性负责人": "李四",
    "设备品牌考核准确性类型": "待审核",
    "设备品牌考核准确性规则": "待审核",
    "设备品牌数据考核准确性字典ID": "F-105911"
  },
  {
    "ID": 6,
    "设备品牌考核准确性ID": "F-113830",
    "设备品牌考核准确性编号": "F-113830",
    "设备品牌考核准确性名称": "设备品牌考核准确性指标管理-6",
    "设备品牌考核准确性状态": "已处理",
    "设备品牌考核准确性时间": "2026-05-08 09:12:18",
    "设备品牌考核准确性属性": "已处理",
    "设备品牌考核准确性创建时间": "2026-05-08 09:12:18",
    "设备品牌考核准确性所属部门": "资产管理部",
    "设备品牌考核准确性负责人": "王五",
    "设备品牌考核准确性类型": "已处理",
    "设备品牌考核准确性规则": "已处理",
    "设备品牌数据考核准确性字典ID": "F-113830"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "设备品牌数据考核准确性字典ID",
    "label": "设备品牌数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
