    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产编号跟踪信息", "form")'>新增工信部资产编号跟踪信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产编号跟踪信息", "config")'>修改工信部资产编号跟踪信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产编号跟踪信息")'>删除工信部资产编号跟踪信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产编号跟踪数据采集", "detail")'>工信部资产编号跟踪数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产编号跟踪数据转换", "detail")'>工信部资产编号跟踪数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产编号跟踪数据预处理", "detail")'>工信部资产编号跟踪数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产编号跟踪汇总报表详情", "detail")'>查询工信部资产编号跟踪汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产编号跟踪明细报表详情", "detail")'>查询工信部资产编号跟踪明细报表详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "跟踪名称": "工信部资产编号跟踪管理-1",
    "工信部资产编号跟踪状态": "U-60704",
    "工信部资产编号跟踪时间": "2026-05-08 11:16:09",
    "编码": "已处理",
    "工信部资产编号跟踪数据采集资源ip": "U-60704",
    "资源类型": "已处理",
    "采集编号": "U-60704",
    "工信部资产编号跟踪数据采集分类": "U-60704",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 11:16:09",
    "工信部资产编号跟踪数据采集操作人": "U-60704"
  },
  {
    "ID": 2,
    "资产编号跟踪ID": "U-68623",
    ...
    "跟踪名称": "工信部资产编号跟踪管理-2",
    "工信部资产编号跟踪状态": "U-68623",
    "工信部资产编号跟踪时间": "2026-05-08 14:03:52",
    "编码": "处理中",
    "工信部资产编号跟踪数据采集资源ip": "U-68623",
    "资源类型": "处理中",
    "采集编号": "U-68623",
    "工信部资产编号跟踪数据采集分类": "U-68623",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 14:03:52",
    "工信部资产编号跟踪数据采集操作人": "U-68623"
  },
  {
    "ID": 3,
    "资产编号跟踪ID": "U-76542",
    ...
    "跟踪名称": "工信部资产编号跟踪管理-3",
    "工信部资产编号跟踪状态": "U-76542",
    "工信部资产编号跟踪时间": "2026-05-08 15:21:37",
    "编码": "待处理",
    "工信部资产编号跟踪数据采集资源ip": "U-76542",
    "资源类型": "待处理",
    "采集编号": "U-76542",
    "工信部资产编号跟踪数据采集分类": "U-76542",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 15:21:37",
    "工信部资产编号跟踪数据采集操作人": "U-76542"
  },
  {
    "ID": 4,
    "资产编号跟踪ID": "U-84461",
    ...
    "跟踪名称": "工信部资产编号跟踪管理-4",
    "工信部资产编号跟踪状态": "U-84461",
    "工信部资产编号跟踪时间": "2026-05-08 16:08:25",
    "编码": "处理失败",
    "工信部资产编号跟踪数据采集资源ip": "U-84461",
    "资源类型": "处理失败",
    "采集编号": "U-84461",
    "工信部资产编号跟踪数据采集分类": "U-84461",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 16:08:25",
    "工信部资产编号跟踪数据采集操作人": "U-84461"
  },
  {
    "ID": 5,
    "资产编号跟踪ID": "U-92380",
    ...
    "跟踪名称": "工信部资产编号跟踪管理-5",
    "工信部资产编号跟踪状态": "U-92380",
    "工信部资产编号跟踪时间": "2026-05-09 08:33:11",
    "编码": "已暂停",
    "工信部资产编号跟踪数据采集资源ip": "U-92380",
    "资源类型": "已暂停",
    "采集编号": "U-92380",
    "工信部资产编号跟踪数据采集分类": "U-92380",
    "工信部资产编号跟踪数据采集时间": "2026-05-09 08:33:11",
    "工信部资产编号跟踪数据采集操作人": "U-92380"
  },
  {
    "ID": 6,
    "资产编号跟踪ID": "U-100299",
    "资产编号跟踪编号": "U-100299",
    "跟踪名称": "工信部资产编号跟踪管理-6",
    "工信部资产编号跟踪状态": "U-100299",
    "工信部资产编号跟踪时间": "2026-05-09 09:47:56",
    "编码": "已完成",
    "工信部资产编号跟踪数据采集资源ip": "U-100299",
    "资源类型": "已完成",
    "采集编号": "U-100299",
    "工信部资产编号跟踪数据采集分类": "U-100299",
    "工信部资产编号跟踪数据采集时间": "2026-05-09 09:47:56",
    "工信部资产编号跟踪数据采集操作人": "U-100299"
  },
  {
    "ID": 7,
    "资产编号跟踪ID": "U-108218",
    "资产编号跟踪编号": "U-108218",
    "跟踪名称": "工信部资产编号跟踪管理-7",
    "工信部资产编号跟踪状态": "U-108218",
    "工信部资产编号跟踪时间": "2026-05-08 09:12:18",
    "编码": "排队中",
    "工信部资产编号跟踪数据采集资源ip": "U-108218",
    "资源类型": "排队中",
    "采集编号": "U-108218",
    "工信部资产编号跟踪数据采集分类": "U-108218",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 09:12:18",
    "工信部资产编号跟踪数据采集操作人": "U-108218"
  },
  {
    "ID": 8,
    "资产编号跟踪ID": "U-116137",
    "资产编号跟踪编号": "U-116137",
    "跟踪名称": "工信部资产编号跟踪管理-8",
    "工信部资产编号跟踪状态": "U-116137",
    "工信部资产编号跟踪时间": "2026-05-08 09:35:44",
    "编码": "部分完成",
    "工信部资产编号跟踪数据采集资源ip": "U-116137",
    "资源类型": "部分完成",
    "采集编号": "U-116137",
    "工信部资产编号跟踪数据采集分类": "U-116137",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 09:35:44",
    "工信部资产编号跟踪数据采集操作人": "U-116137"
  },
  {
    "ID": 9,
    "资产编号跟踪ID": "U-124056",
    "资产编号跟踪编号": "U-124056",
    "跟踪名称": "工信部资产编号跟踪管理-9",
    "工信部资产编号跟踪状态": "U-124056",
    "工信部资产编号跟踪时间": "2026-05-08 10:08:06",
    "编码": "已启用",
    "工信部资产编号跟踪数据采集资源ip": "U-124056",
    "资源类型": "已启用",
    "采集编号": "U-124056",
    "工信部资产编号跟踪数据采集分类": "U-124056",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 10:08:06",
    "工信部资产编号跟踪数据采集操作人": "U-124056"
  },
  {
    "ID": 10,
    "资产编号跟踪ID": "U-131975",
    "资产编号跟踪编号": "U-131975",
    "跟踪名称": "工信部资产编号跟踪管理-10",
    "工信部资产编号跟踪状态": "U-131975",
    "工信部资产编号跟踪时间": "2026-05-08 10:42:31",
    "编码": "已停用",
    "工信部资产编号跟踪数据采集资源ip": "U-131975",
    "资源类型": "已停用",
    "采集编号": "U-131975",
    "工信部资产编号跟踪数据采集分类": "U-131975",
    "工信部资产编号跟踪数据采集时间": "2026-05-08 10:42:31",
    "工信部资产编号跟踪数据采集操作人": "U-131975"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部资产编号跟踪数据采集资源ip",
    "label": "工信部资产编号跟踪数据采集资源ip",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部资产编号跟踪数据采集分类",
    "label": "工信部资产编号跟踪数据采集分类",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "工信部资产编号跟踪数据采集时间",
    "label": "工信部资产编号跟踪数据采集时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "工信部资产编号跟踪数据采集操作人",
    "label": "工信部资产编号跟踪数据采集操作人",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
