    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工单处置指令设置信息", "form")'>新增工单处置指令设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工单处置指令设置信息", "config")'>修改工单处置指令设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工单处置指令设置信息")'>删除工单处置指令设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工单处置指令错误信息监控", "log")'>工单处置指令错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置指令错误事件通知", "audit")'>工单处置指令错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置指令错误事件通知删除", "operation")'>工单处置指令错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工单处置指令错误事件通知查询", "detail")'>工单处置指令错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工单处置指令防篡改信息", "form")'>新增工单处置指令防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工单处置指令防篡改信息", "config")'>修改工单处置指令防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工单处置指令防篡改信息")'>删除工单处置指令防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工单处置指令名称": "工单处置指令管理-1",
    "新增工单处置指令状态": "超时",
    "新增工单处置指令时间": "2026-05-09 08:33:11",
    "新增工单处置指令设置时间_": "2026-05-09 08:33:11",
    "工单处置指令属性": "超时",
    "工单处置指令创建时间": "2026-05-09 08:33:11",
    "新增工单处置指令设置结果": "超时",
    "工单处置指令所属部门": "资产管理部",
    "工单处置指令负责人": "王五",
    "工单处置指令类型": "超时"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-2",
    "新增工单处置指令状态": "已取消",
    "新增工单处置指令时间": "2026-05-09 09:47:56",
    "新增工单处置指令设置时间_": "2026-05-09 09:47:56",
    "工单处置指令属性": "已取消",
    "工单处置指令创建时间": "2026-05-09 09:47:56",
    "新增工单处置指令设置结果": "已取消",
    "工单处置指令所属部门": "信息安全部",
    "工单处置指令负责人": "赵六",
    "工单处置指令类型": "已取消"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-3",
    "新增工单处置指令状态": "已驳回",
    "新增工单处置指令时间": "2026-05-08 09:12:18",
    "新增工单处置指令设置时间_": "2026-05-08 09:12:18",
    "工单处置指令属性": "已驳回",
    "工单处置指令创建时间": "2026-05-08 09:12:18",
    "新增工单处置指令设置结果": "已驳回",
    "工单处置指令所属部门": "系统运维部",
    "工单处置指令负责人": "system",
    "工单处置指令类型": "已驳回"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-4",
    "新增工单处置指令状态": "待审核",
    "新增工单处置指令时间": "2026-05-08 09:35:44",
    "新增工单处置指令设置时间_": "2026-05-08 09:35:44",
    "工单处置指令属性": "待审核",
    "工单处置指令创建时间": "2026-05-08 09:35:44",
    "新增工单处置指令设置结果": "待审核",
    "工单处置指令所属部门": "数据管理部",
    "工单处置指令负责人": "admin",
    "工单处置指令类型": "待审核"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-5",
    "新增工单处置指令状态": "已处理",
    "新增工单处置指令时间": "2026-05-08 10:08:06",
    "新增工单处置指令设置时间_": "2026-05-08 10:08:06",
    "工单处置指令属性": "已处理",
    "工单处置指令创建时间": "2026-05-08 10:08:06",
    "新增工单处置指令设置结果": "已处理",
    "工单处置指令所属部门": "安全运维部",
    "工单处置指令负责人": "张三",
    "工单处置指令类型": "已处理"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-6",
    "新增工单处置指令状态": "处理中",
    "新增工单处置指令时间": "2026-05-08 10:42:31",
    "新增工单处置指令设置时间_": "2026-05-08 10:42:31",
    "工单处置指令属性": "处理中",
    "工单处置指令创建时间": "2026-05-08 10:42:31",
    "新增工单处置指令设置结果": "处理中",
    "工单处置指令所属部门": "网络管理部",
    "工单处置指令负责人": "李四",
    "工单处置指令类型": "处理中"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-7",
    "新增工单处置指令状态": "待处理",
    "新增工单处置指令时间": "2026-05-08 11:16:09",
    "新增工单处置指令设置时间_": "2026-05-08 11:16:09",
    "工单处置指令属性": "待处理",
    "工单处置指令创建时间": "2026-05-08 11:16:09",
    "新增工单处置指令设置结果": "待处理",
    "工单处置指令所属部门": "资产管理部",
    "工单处置指令负责人": "王五",
    "工单处置指令类型": "待处理"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-8",
    "新增工单处置指令状态": "处理失败",
    "新增工单处置指令时间": "2026-05-08 14:03:52",
    "新增工单处置指令设置时间_": "2026-05-08 14:03:52",
    "工单处置指令属性": "处理失败",
    "工单处置指令创建时间": "2026-05-08 14:03:52",
    "新增工单处置指令设置结果": "处理失败",
    "工单处置指令所属部门": "信息安全部",
    "工单处置指令负责人": "赵六",
    "工单处置指令类型": "处理失败"
  },
  {
    ...
    "工单处置指令名称": "工单处置指令管理-9",
    "新增工单处置指令状态": "已暂停",
    "新增工单处置指令时间": "2026-05-08 15:21:37",
    "新增工单处置指令设置时间_": "2026-05-08 15:21:37",
    "工单处置指令属性": "已暂停",
    "工单处置指令创建时间": "2026-05-08 15:21:37",
    "新增工单处置指令设置结果": "已暂停",
    "工单处置指令所属部门": "系统运维部",
    "工单处置指令负责人": "system",
    "工单处置指令类型": "已暂停"
