    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集入库任务", "form")'>新增登录采集入库任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集入库模型", "form")'>新增登录采集入库模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改登录采集入库模型", "config")'>修改登录采集入库模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除登录采集入库模型")'>删除登录采集入库模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库查询", "detail")'>登录采集入库查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库可视化展示", "detail")'>登录采集入库可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起登录采集入库审核流程", "initiate_audit")'>发起登录采集入库审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集入库审核指派信息", "form")'>新增登录采集入库审核指派信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "新增登录采集入库状态": "超时",
    "登录采集入库任务ID": "S-17932",
    "新增登录采集入库时间": "2026-05-08 10:08:06",
    "属性": "超时",
    "登录采集入库创建时间": "2026-05-08 10:08:06",
    "读取登录采集入库任务状态": "超时",
    "登录采集入库所属部门": "系统运维部",
    "登录采集入库负责人": "system",
    "登录采集入库类型": "超时"
  },
  {
    ...
    "新增登录采集入库状态": "已取消",
    "登录采集入库任务ID": "S-25851",
    "新增登录采集入库时间": "2026-05-08 10:42:31",
    "属性": "已取消",
    "登录采集入库创建时间": "2026-05-08 10:42:31",
    "读取登录采集入库任务状态": "已取消",
    "登录采集入库所属部门": "数据管理部",
    "登录采集入库负责人": "admin",
    "登录采集入库类型": "已取消"
  },
  {
    ...
    "新增登录采集入库状态": "已驳回",
    "登录采集入库任务ID": "S-33770",
    "新增登录采集入库时间": "2026-05-08 11:16:09",
    "属性": "已驳回",
    "登录采集入库创建时间": "2026-05-08 11:16:09",
    "读取登录采集入库任务状态": "已驳回",
    "登录采集入库所属部门": "安全运维部",
    "登录采集入库负责人": "张三",
    "登录采集入库类型": "已驳回"
  },
  {
    ...
    "新增登录采集入库状态": "待审核",
    "登录采集入库任务ID": "S-41689",
    "新增登录采集入库时间": "2026-05-08 14:03:52",
    "属性": "待审核",
    "登录采集入库创建时间": "2026-05-08 14:03:52",
    "读取登录采集入库任务状态": "待审核",
    "登录采集入库所属部门": "网络管理部",
    "登录采集入库负责人": "李四",
    "登录采集入库类型": "待审核"
  },
  {
    ...
    "新增登录采集入库状态": "已处理",
    "登录采集入库任务ID": "S-49608",
    "新增登录采集入库时间": "2026-05-08 15:21:37",
    "属性": "已处理",
    "登录采集入库创建时间": "2026-05-08 15:21:37",
    "读取登录采集入库任务状态": "已处理",
    "登录采集入库所属部门": "资产管理部",
    "登录采集入库负责人": "王五",
    "登录采集入库类型": "已处理"
  },
  {
    ...
    "新增登录采集入库状态": "处理中",
    "登录采集入库任务ID": "S-57527",
    "新增登录采集入库时间": "2026-05-08 16:08:25",
    "属性": "处理中",
    "登录采集入库创建时间": "2026-05-08 16:08:25",
    "读取登录采集入库任务状态": "处理中",
    "登录采集入库所属部门": "信息安全部",
    "登录采集入库负责人": "赵六",
    "登录采集入库类型": "处理中"
  },
  {
    ...
    "新增登录采集入库状态": "待处理",
    "登录采集入库任务ID": "S-65446",
    "新增登录采集入库时间": "2026-05-09 08:33:11",
    "属性": "待处理",
    "登录采集入库创建时间": "2026-05-09 08:33:11",
    "读取登录采集入库任务状态": "待处理",
    "登录采集入库所属部门": "系统运维部",
    "登录采集入库负责人": "system",
    "登录采集入库类型": "待处理"
  },
  {
    ...
    "新增登录采集入库状态": "处理失败",
    "登录采集入库任务ID": "S-73365",
    "新增登录采集入库时间": "2026-05-09 09:47:56",
    "属性": "处理失败",
    "登录采集入库创建时间": "2026-05-09 09:47:56",
    "读取登录采集入库任务状态": "处理失败",
    "登录采集入库所属部门": "数据管理部",
    "登录采集入库负责人": "admin",
    "登录采集入库类型": "处理失败"
