    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产等级考核准确性信息表", "operation")'>资产等级考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产等级考核准确性稽核数据上传", "form")'>资产等级考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产等级考核准确性稽核数据接口监控", "log")'>资产等级考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产等级考核准确性ID": "G-73326",
    "资产等级考核准确性编号": "G-73326",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-1",
    "资产等级考核准确性状态": "已驳回",
    "资产等级考核准确性时间": "2026-05-08 15:21:37",
    "资产等级考核准确性属性": "已驳回",
    "资产等级考核准确性创建时间": "2026-05-08 15:21:37",
    "资产等级考核准确性所属部门": "安全运维部",
    "资产等级考核准确性负责人": "张三",
    "资产等级考核准确性类型": "已驳回",
    "资产等级考核准确性规则": "已驳回",
  ...
  },
  {
    ...
    "资产等级考核准确性ID": "G-81245",
    "资产等级考核准确性编号": "G-81245",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-2",
    "资产等级考核准确性状态": "待审核",
    "资产等级考核准确性时间": "2026-05-08 16:08:25",
    "资产等级考核准确性属性": "待审核",
    "资产等级考核准确性创建时间": "2026-05-08 16:08:25",
    "资产等级考核准确性所属部门": "网络管理部",
    "资产等级考核准确性负责人": "李四",
    "资产等级考核准确性类型": "待审核",
    "资产等级考核准确性规则": "待审核",
  ...
  },
  {
    ...
    "资产等级考核准确性ID": "G-89164",
    "资产等级考核准确性编号": "G-89164",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-3",
    "资产等级考核准确性状态": "已处理",
    "资产等级考核准确性时间": "2026-05-09 08:33:11",
    "资产等级考核准确性属性": "已处理",
    "资产等级考核准确性创建时间": "2026-05-09 08:33:11",
    "资产等级考核准确性所属部门": "资产管理部",
    "资产等级考核准确性负责人": "王五",
    "资产等级考核准确性类型": "已处理",
    "资产等级考核准确性规则": "已处理",
  ...
  },
  {
    ...
    "资产等级考核准确性ID": "G-97083",
    "资产等级考核准确性编号": "G-97083",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-4",
    "资产等级考核准确性状态": "处理中",
    "资产等级考核准确性时间": "2026-05-09 09:47:56",
    "资产等级考核准确性属性": "处理中",
    "资产等级考核准确性创建时间": "2026-05-09 09:47:56",
    "资产等级考核准确性所属部门": "信息安全部",
    "资产等级考核准确性负责人": "赵六",
    "资产等级考核准确性类型": "处理中",
    "资产等级考核准确性规则": "处理中",
  ...
  {
    "ID": 5,
    "资产等级考核准确性ID": "G-105002",
    "资产等级考核准确性编号": "G-105002",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-5",
    "资产等级考核准确性状态": "待处理",
    "资产等级考核准确性时间": "2026-05-08 09:12:18",
    "资产等级考核准确性属性": "待处理",
    "资产等级考核准确性创建时间": "2026-05-08 09:12:18",
    "资产等级考核准确性所属部门": "系统运维部",
    "资产等级考核准确性负责人": "system",
    "资产等级考核准确性类型": "待处理",
    "资产等级考核准确性规则": "待处理",
  ...
  {
    "ID": 6,
    "资产等级考核准确性ID": "G-112921",
    "资产等级考核准确性编号": "G-112921",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-6",
    "资产等级考核准确性状态": "处理失败",
    "资产等级考核准确性时间": "2026-05-08 09:35:44",
    "资产等级考核准确性属性": "处理失败",
    "资产等级考核准确性创建时间": "2026-05-08 09:35:44",
    "资产等级考核准确性所属部门": "数据管理部",
    "资产等级考核准确性负责人": "admin",
    "资产等级考核准确性类型": "处理失败",
    "资产等级考核准确性规则": "处理失败",
  ...
  {
    "ID": 7,
    "资产等级考核准确性ID": "G-120840",
    "资产等级考核准确性编号": "G-120840",
    "资产等级考核准确性名称": "资产等级考核准确性指标管理-7",
    "资产等级考核准确性状态": "已暂停",
    "资产等级考核准确性时间": "2026-05-08 10:08:06",
    "资产等级考核准确性属性": "已暂停",
    "资产等级考核准确性创建时间": "2026-05-08 10:08:06",
    "资产等级考核准确性所属部门": "安全运维部",
    "资产等级考核准确性负责人": "张三",
    "资产等级考核准确性类型": "已暂停",
    "资产等级考核准确性规则": "已暂停",
