    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析对比模型", "form")'>新增流量分析对比模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析对比模型", "config")'>修改流量分析对比模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量分析对比模型")'>删除流量分析对比模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析对比查询", "analysis")'>流量分析对比查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析对比可视化展示", "analysis")'>流量分析对比可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义流量分析失败few模型信息", "analysis")'>定义流量分析失败few模型信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析失败few模型信息", "config")'>修改流量分析失败few模型信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除流量分析失败few模型信息")'>删除流量分析失败few模型信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流量分析对比名称": "流量分析对比管理-1",
    "新增流量分析对比状态": "已启用",
    "新增流量分析对比时间": "2026-05-08 15:21:37",
    "流量分析对比属性": "已启用",
    "流量分析对比创建时间": "2026-05-08 15:21:37",
    "流量分析对比所属部门": "安全运维部",
    "流量分析对比负责人": "张三",
    "流量分析对比类型": "已启用",
    "流量分析对比模型": "已启用",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-2",
    "新增流量分析对比状态": "已停用",
    "新增流量分析对比时间": "2026-05-08 16:08:25",
    "流量分析对比属性": "已停用",
    "流量分析对比创建时间": "2026-05-08 16:08:25",
    "流量分析对比所属部门": "网络管理部",
    "流量分析对比负责人": "李四",
    "流量分析对比类型": "已停用",
    "流量分析对比模型": "已停用",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-3",
    "新增流量分析对比状态": "正常",
    "新增流量分析对比时间": "2026-05-09 08:33:11",
    "流量分析对比属性": "正常",
    "流量分析对比创建时间": "2026-05-09 08:33:11",
    "流量分析对比所属部门": "资产管理部",
    "流量分析对比负责人": "王五",
    "流量分析对比类型": "正常",
    "流量分析对比模型": "正常",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-4",
    "新增流量分析对比状态": "异常",
    "新增流量分析对比时间": "2026-05-09 09:47:56",
    "流量分析对比属性": "异常",
    "流量分析对比创建时间": "2026-05-09 09:47:56",
    "流量分析对比所属部门": "信息安全部",
    "流量分析对比负责人": "赵六",
    "流量分析对比类型": "异常",
    "流量分析对比模型": "异常",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-5",
    "新增流量分析对比状态": "超时",
    "新增流量分析对比时间": "2026-05-08 09:12:18",
    "流量分析对比属性": "超时",
    "流量分析对比创建时间": "2026-05-08 09:12:18",
    "流量分析对比所属部门": "系统运维部",
    "流量分析对比负责人": "system",
    "流量分析对比类型": "超时",
    "流量分析对比模型": "超时",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-6",
    "新增流量分析对比状态": "已取消",
    "新增流量分析对比时间": "2026-05-08 09:35:44",
    "流量分析对比属性": "已取消",
    "流量分析对比创建时间": "2026-05-08 09:35:44",
    "流量分析对比所属部门": "数据管理部",
    "流量分析对比负责人": "admin",
    "流量分析对比类型": "已取消",
    "流量分析对比模型": "已取消",
  ...
  },
  {
    ...
    "流量分析对比名称": "流量分析对比管理-7",
    "新增流量分析对比状态": "已驳回",
    "新增流量分析对比时间": "2026-05-08 10:08:06",
    "流量分析对比属性": "已驳回",
    "流量分析对比创建时间": "2026-05-08 10:08:06",
    "流量分析对比所属部门": "安全运维部",
    "流量分析对比负责人": "张三",
    "流量分析对比类型": "已驳回",
    "流量分析对比模型": "已驳回",
