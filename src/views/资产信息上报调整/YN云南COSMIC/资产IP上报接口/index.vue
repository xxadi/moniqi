    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产IP上报接口", "api")'>资产IP上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产IP上报信息", "form")'>新增资产IP上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产IP上报信息", "config")'>修改资产IP上报信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产IP上报信息")'>删除资产IP上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP上报汇总表", "detail")'>查询资产IP上报汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP上报详情", "detail")'>查询资产IP上报详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产IP上报")'>批量导入资产IP上报</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产IP上报数据导出")'>资产IP上报数据导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产IP上报名称": "资产IP上报接口-1",
    "资产IP上报状态": "处理失败",
    "资产IP上报时间": "2026-05-08 16:08:25",
    "资产IP上报属性": "10.0.0.254",
    "资产IP上报创建时间": "2026-05-08 16:08:25",
    "资产IP上报ID告警时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 2,
    "资产IP上报ID": "F-89746",
    ...
    "资产IP上报名称": "资产IP上报接口-2",
    "资产IP上报状态": "已暂停",
    "资产IP上报时间": "2026-05-09 08:33:11",
    "资产IP上报属性": "10.10.1.100",
    "资产IP上报创建时间": "2026-05-09 08:33:11",
    "资产IP上报ID告警时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 3,
    "资产IP上报ID": "F-97665",
    ...
    "资产IP上报名称": "资产IP上报接口-3",
    "资产IP上报状态": "已完成",
    "资产IP上报时间": "2026-05-09 09:47:56",
    "资产IP上报属性": "172.16.0.50",
    "资产IP上报创建时间": "2026-05-09 09:47:56",
    "资产IP上报ID告警时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 4,
    "资产IP上报ID": "F-105584",
    ...
    "资产IP上报名称": "资产IP上报接口-4",
    "资产IP上报状态": "排队中",
    "资产IP上报时间": "2026-05-08 09:12:18",
    "资产IP上报属性": "192.168.1.200",
    "资产IP上报创建时间": "2026-05-08 09:12:18",
    "资产IP上报ID告警时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 5,
    "资产IP上报ID": "F-113503",
    ...
    "资产IP上报名称": "资产IP上报接口-5",
    "资产IP上报状态": "部分完成",
    "资产IP上报时间": "2026-05-08 09:35:44",
    "资产IP上报属性": "10.20.5.30",
    "资产IP上报创建时间": "2026-05-08 09:35:44",
    "资产IP上报ID告警时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 6,
    "资产IP上报ID": "F-121422",
    ...
    "资产IP上报名称": "资产IP上报接口-6",
    "资产IP上报状态": "已启用",
    "资产IP上报时间": "2026-05-08 10:08:06",
    "资产IP上报属性": "172.20.1.80",
    "资产IP上报创建时间": "2026-05-08 10:08:06",
    "资产IP上报ID告警时间": "2026-05-08 10:08:06"
  },
  {
    "ID": 7,
    "资产IP上报ID": "F-129341",
    ...
    "资产IP上报名称": "资产IP上报接口-7",
    "资产IP上报状态": "已停用",
    "资产IP上报时间": "2026-05-08 10:42:31",
    "资产IP上报属性": "10.0.0.254",
    "资产IP上报创建时间": "2026-05-08 10:42:31",
    "资产IP上报ID告警时间": "2026-05-08 10:42:31"
  },
  {
    "ID": 8,
    "资产IP上报ID": "F-137260",
    ...
    "资产IP上报名称": "资产IP上报接口-8",
    "资产IP上报状态": "正常",
    "资产IP上报时间": "2026-05-08 11:16:09",
    "资产IP上报属性": "10.10.1.100",
    "资产IP上报创建时间": "2026-05-08 11:16:09",
    "资产IP上报ID告警时间": "2026-05-08 11:16:09"
  }
];
const tableColumns = [
  {
