    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP地址资产信息", "form")'>新增IP地址资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP地址资产信息", "config")'>修改IP地址资产信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP地址资产信息")'>删除IP地址资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP地址资产监控", "log")'>IP地址资产监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("IP地址资产监控告警", "alert")'>IP地址资产监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址资产稽核", "audit")'>IP地址资产稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP地址资产统计", "statistics")'>IP地址资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP地址资产数据采集", "transform")'>IP地址资产数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP地址资产数据转换", "transform")'>IP地址资产数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP地址资产数据预处理", "transform")'>IP地址资产数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "IP地址资产名称": "IP地址资产管理-1",
    "新增IP地址资产状态": "待审核",
    "新增IP地址资产时间": "2026-05-09 09:47:56",
    "IP地址资产属性": "172.16.0.50",
    "IP地址资产创建时间": "2026-05-09 09:47:56",
    "IP地址资产所属部门": "网络管理部",
    "IP地址资产负责人": "李四",
    "IP地址资产类型": "172.16.0.50",
    "IP地址资产规则": "172.16.0.50",
    "名称": "IP地址资产管理-1"
  },
  {
    "ID": 2,
    ...
    "IP地址资产名称": "IP地址资产管理-2",
    "新增IP地址资产状态": "已处理",
    "新增IP地址资产时间": "2026-05-08 09:12:18",
    "IP地址资产属性": "192.168.1.200",
    "IP地址资产创建时间": "2026-05-08 09:12:18",
    "IP地址资产所属部门": "资产管理部",
    "IP地址资产负责人": "王五",
    "IP地址资产类型": "192.168.1.200",
    "IP地址资产规则": "192.168.1.200",
    "名称": "IP地址资产管理-2"
  },
  {
    "ID": 3,
    ...
    "IP地址资产名称": "IP地址资产管理-3",
    "新增IP地址资产状态": "处理中",
    "新增IP地址资产时间": "2026-05-08 09:35:44",
    "IP地址资产属性": "10.20.5.30",
    "IP地址资产创建时间": "2026-05-08 09:35:44",
    "IP地址资产所属部门": "信息安全部",
    "IP地址资产负责人": "赵六",
    "IP地址资产类型": "10.20.5.30",
    "IP地址资产规则": "10.20.5.30",
  ...
  },
  {
    ...
    "IP地址资产名称": "IP地址资产管理-4",
    "新增IP地址资产状态": "待处理",
    "新增IP地址资产时间": "2026-05-08 10:08:06",
    "IP地址资产属性": "172.20.1.80",
    "IP地址资产创建时间": "2026-05-08 10:08:06",
    "IP地址资产所属部门": "系统运维部",
    "IP地址资产负责人": "system",
    "IP地址资产类型": "172.20.1.80",
    "IP地址资产规则": "172.20.1.80",
    "名称": "IP地址资产管理-4"
  },
  {
    "ID": 5,
    ...
    "IP地址资产名称": "IP地址资产管理-5",
    "新增IP地址资产状态": "处理失败",
    "新增IP地址资产时间": "2026-05-08 10:42:31",
    "IP地址资产属性": "10.0.0.254",
    "IP地址资产创建时间": "2026-05-08 10:42:31",
    "IP地址资产所属部门": "数据管理部",
    "IP地址资产负责人": "admin",
    "IP地址资产类型": "10.0.0.254",
    "IP地址资产规则": "10.0.0.254",
  ...
  },
  {
    ...
    "IP地址资产名称": "IP地址资产管理-6",
    "新增IP地址资产状态": "已暂停",
    "新增IP地址资产时间": "2026-05-08 11:16:09",
    "IP地址资产属性": "10.10.1.100",
    "IP地址资产创建时间": "2026-05-08 11:16:09",
    "IP地址资产所属部门": "安全运维部",
    "IP地址资产负责人": "张三",
    "IP地址资产类型": "10.10.1.100",
    "IP地址资产规则": "10.10.1.100",
    "名称": "IP地址资产管理-6"
  },
  {
    "ID": 7,
    ...
    "IP地址资产名称": "IP地址资产管理-7",
    "新增IP地址资产状态": "已完成",
    "新增IP地址资产时间": "2026-05-08 14:03:52",
    "IP地址资产属性": "172.16.0.50",
    "IP地址资产创建时间": "2026-05-08 14:03:52",
    "IP地址资产所属部门": "网络管理部",
    "IP地址资产负责人": "李四",
    "IP地址资产类型": "172.16.0.50",
    "IP地址资产规则": "172.16.0.50",
  ...
  },
  {
    ...
    "IP地址资产名称": "IP地址资产管理-8",
    "新增IP地址资产状态": "排队中",
    "新增IP地址资产时间": "2026-05-08 15:21:37",
    "IP地址资产属性": "192.168.1.200",
    "IP地址资产创建时间": "2026-05-08 15:21:37",
    "IP地址资产所属部门": "资产管理部",
    "IP地址资产负责人": "王五",
    "IP地址资产类型": "192.168.1.200",
    "IP地址资产规则": "192.168.1.200",
  ...
  },
  {
    ...
    "IP地址资产名称": "IP地址资产管理-9",
    "新增IP地址资产状态": "部分完成",
    "新增IP地址资产时间": "2026-05-08 16:08:25",
    "IP地址资产属性": "10.20.5.30",
    "IP地址资产创建时间": "2026-05-08 16:08:25",
    "IP地址资产所属部门": "信息安全部",
    "IP地址资产负责人": "赵六",
    "IP地址资产类型": "10.20.5.30",
    "IP地址资产规则": "10.20.5.30",
  ...
  },
  {
    ...
    "IP地址资产ID": "V-133510",
    "IP地址资产编号": "V-133510",
    "IP地址资产名称": "IP地址资产管理-10",
    "新增IP地址资产状态": "已启用",
    "新增IP地址资产时间": "2026-05-09 08:33:11",
    "IP地址资产属性": "172.20.1.80",
    "IP地址资产创建时间": "2026-05-09 08:33:11",
    "IP地址资产所属部门": "系统运维部",
    "IP地址资产负责人": "system",
    "IP地址资产类型": "172.20.1.80",
    "IP地址资产规则": "172.20.1.80",
