    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核准确性信息表", "operation")'>CPU厂商考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商数据考核准确性字典信息", "form")'>新增CPU厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商数据考核准确性字典信息", "config")'>修改CPU厂商数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商数据考核准确性字典信息")'>删除CPU厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商考核准确性上传任务", "form")'>新增CPU厂商考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商考核准确性上传任务")'>删除CPU厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商考核准确性上传任务", "config")'>修改CPU厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询CPU厂商考核准确性上传任务", "detail")'>查询CPU厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核准确性上传任务启用/禁用", "form")'>CPU厂商考核准确性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU厂商考核准确性稽核数据上传", "form")'>CPU厂商考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU厂商考核准确性稽核数据接口监控", "log")'>CPU厂商考核准确性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU型号考核准确性信息表", "operation")'>CPU型号考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU型号考核准确性稽核数据上传", "form")'>CPU型号考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU型号考核准确性稽核数据接口监控", "log")'>CPU型号考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "CPU厂商考核准确性ID": "X-4963",
    "CPU厂商考核准确性编号": "X-4963",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-1",
    "CPU厂商考核准确性状态": "处理失败",
    "CPU厂商考核准确性时间": "2026-05-08 10:42:31",
    "CPU厂商考核准确性属性": "处理失败",
    "CPU厂商考核准确性创建时间": "2026-05-08 10:42:31",
    "CPU厂商考核准确性所属部门": "网络管理部",
    "CPU厂商考核准确性负责人": "李四",
    "CPU厂商考核准确性类型": "处理失败",
    "CPU厂商考核准确性规则": "处理失败",
    "CPU厂商数据考核准确性字典ID": "X-4963"
  },
  {
    "ID": 2,
    "CPU厂商考核准确性ID": "X-12882",
    "CPU厂商考核准确性编号": "X-12882",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-2",
    "CPU厂商考核准确性状态": "已暂停",
    "CPU厂商考核准确性时间": "2026-05-08 11:16:09",
    "CPU厂商考核准确性属性": "已暂停",
    "CPU厂商考核准确性创建时间": "2026-05-08 11:16:09",
    "CPU厂商考核准确性所属部门": "资产管理部",
    "CPU厂商考核准确性负责人": "王五",
    "CPU厂商考核准确性类型": "已暂停",
    "CPU厂商考核准确性规则": "已暂停",
    "CPU厂商数据考核准确性字典ID": "X-12882"
  },
  {
    "ID": 3,
    "CPU厂商考核准确性ID": "X-20801",
    "CPU厂商考核准确性编号": "X-20801",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-3",
    "CPU厂商考核准确性状态": "已完成",
    "CPU厂商考核准确性时间": "2026-05-08 14:03:52",
    "CPU厂商考核准确性属性": "已完成",
    "CPU厂商考核准确性创建时间": "2026-05-08 14:03:52",
    "CPU厂商考核准确性所属部门": "信息安全部",
    "CPU厂商考核准确性负责人": "赵六",
    "CPU厂商考核准确性类型": "已完成",
    "CPU厂商考核准确性规则": "已完成",
    "CPU厂商数据考核准确性字典ID": "X-20801"
  },
  {
    "ID": 4,
    "CPU厂商考核准确性ID": "X-28720",
    "CPU厂商考核准确性编号": "X-28720",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-4",
    "CPU厂商考核准确性状态": "排队中",
    "CPU厂商考核准确性时间": "2026-05-08 15:21:37",
    "CPU厂商考核准确性属性": "排队中",
    "CPU厂商考核准确性创建时间": "2026-05-08 15:21:37",
    "CPU厂商考核准确性所属部门": "系统运维部",
    "CPU厂商考核准确性负责人": "system",
    "CPU厂商考核准确性类型": "排队中",
    "CPU厂商考核准确性规则": "排队中",
    "CPU厂商数据考核准确性字典ID": "X-28720"
  },
  {
    "ID": 5,
    "CPU厂商考核准确性ID": "X-36639",
    "CPU厂商考核准确性编号": "X-36639",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-5",
    "CPU厂商考核准确性状态": "部分完成",
    "CPU厂商考核准确性时间": "2026-05-08 16:08:25",
    "CPU厂商考核准确性属性": "部分完成",
    "CPU厂商考核准确性创建时间": "2026-05-08 16:08:25",
    "CPU厂商考核准确性所属部门": "数据管理部",
    "CPU厂商考核准确性负责人": "admin",
    "CPU厂商考核准确性类型": "部分完成",
    "CPU厂商考核准确性规则": "部分完成",
    "CPU厂商数据考核准确性字典ID": "X-36639"
  },
  {
    "ID": 6,
    "CPU厂商考核准确性ID": "X-44558",
    "CPU厂商考核准确性编号": "X-44558",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-6",
    "CPU厂商考核准确性状态": "已启用",
    "CPU厂商考核准确性时间": "2026-05-09 08:33:11",
    "CPU厂商考核准确性属性": "已启用",
    "CPU厂商考核准确性创建时间": "2026-05-09 08:33:11",
    "CPU厂商考核准确性所属部门": "安全运维部",
    "CPU厂商考核准确性负责人": "张三",
    "CPU厂商考核准确性类型": "已启用",
    "CPU厂商考核准确性规则": "已启用",
    "CPU厂商数据考核准确性字典ID": "X-44558"
  },
  {
    "ID": 7,
    "CPU厂商考核准确性ID": "X-52477",
    "CPU厂商考核准确性编号": "X-52477",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-7",
    "CPU厂商考核准确性状态": "已停用",
    "CPU厂商考核准确性时间": "2026-05-09 09:47:56",
    "CPU厂商考核准确性属性": "已停用",
    "CPU厂商考核准确性创建时间": "2026-05-09 09:47:56",
    "CPU厂商考核准确性所属部门": "网络管理部",
    "CPU厂商考核准确性负责人": "李四",
    "CPU厂商考核准确性类型": "已停用",
    "CPU厂商考核准确性规则": "已停用",
    "CPU厂商数据考核准确性字典ID": "X-52477"
  },
  {
    "ID": 8,
    "CPU厂商考核准确性ID": "X-60396",
    "CPU厂商考核准确性编号": "X-60396",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-8",
    "CPU厂商考核准确性状态": "正常",
    "CPU厂商考核准确性时间": "2026-05-08 09:12:18",
    "CPU厂商考核准确性属性": "正常",
    "CPU厂商考核准确性创建时间": "2026-05-08 09:12:18",
    "CPU厂商考核准确性所属部门": "资产管理部",
    "CPU厂商考核准确性负责人": "王五",
    "CPU厂商考核准确性类型": "正常",
    "CPU厂商考核准确性规则": "正常",
    "CPU厂商数据考核准确性字典ID": "X-60396"
  },
  {
    "ID": 9,
    "CPU厂商考核准确性ID": "X-68315",
    "CPU厂商考核准确性编号": "X-68315",
    "CPU厂商考核准确性名称": "CPU厂商考核准确性指标管理-9",
    "CPU厂商考核准确性状态": "异常",
    "CPU厂商考核准确性时间": "2026-05-08 09:35:44",
    "CPU厂商考核准确性属性": "异常",
    "CPU厂商考核准确性创建时间": "2026-05-08 09:35:44",
    "CPU厂商考核准确性所属部门": "信息安全部",
    "CPU厂商考核准确性负责人": "赵六",
    "CPU厂商考核准确性类型": "异常",
    "CPU厂商考核准确性规则": "异常",
    "CPU厂商数据考核准确性字典ID": "X-68315"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "CPU厂商数据考核准确性字典ID",
    "label": "CPU厂商数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
