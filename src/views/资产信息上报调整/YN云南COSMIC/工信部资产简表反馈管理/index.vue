    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产简表反馈设置信息", "form")'>新增工信部资产简表反馈设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产简表反馈设置信息", "config")'>修改工信部资产简表反馈设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产简表反馈设置信息")'>删除工信部资产简表反馈设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产简表反馈错误信息监控", "log")'>工信部资产简表反馈错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产简表反馈错误事件通知", "audit")'>工信部资产简表反馈错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产简表反馈错误事件通知删除", "operation")'>工信部资产简表反馈错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部资产简表反馈错误事件通知查询", "detail")'>工信部资产简表反馈错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产简表反馈防篡改信息", "form")'>新增工信部资产简表反馈防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产简表反馈防篡改信息", "config")'>修改工信部资产简表反馈防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产简表反馈防篡改信息")'>删除工信部资产简表反馈防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部资产": "部分完成",
    "新增工信部资产简表反馈状态": "部分完成",
    "新增工信部资产简表反馈设置时间_": "2026-05-08 14:03:52",
    "工信部资产简表反馈ID": "N-93015",
    "工信部资产简表反馈编号": "N-93015",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-1",
    "工信部资产简表反馈类型": "部分完成",
    "工信部资产简表反馈规则": "部分完成",
    "工信部资产简表反馈属性": "部分完成",
    "工信部资产简表反馈状态": "部分完成"
  },
  {
    ...
    "工信部资产": "已启用",
    "新增工信部资产简表反馈状态": "已启用",
    "新增工信部资产简表反馈设置时间_": "2026-05-08 15:21:37",
    "工信部资产简表反馈ID": "N-100934",
    "工信部资产简表反馈编号": "N-100934",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-2",
    "工信部资产简表反馈类型": "已启用",
    "工信部资产简表反馈规则": "已启用",
    "工信部资产简表反馈属性": "已启用",
    "工信部资产简表反馈状态": "已启用"
  },
  {
    ...
    "工信部资产": "已停用",
    "新增工信部资产简表反馈状态": "已停用",
    "新增工信部资产简表反馈设置时间_": "2026-05-08 16:08:25",
    "工信部资产简表反馈ID": "N-108853",
    "工信部资产简表反馈编号": "N-108853",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-3",
    "工信部资产简表反馈类型": "已停用",
    "工信部资产简表反馈规则": "已停用",
    "工信部资产简表反馈属性": "已停用",
    "工信部资产简表反馈状态": "已停用"
  },
  {
    ...
    "工信部资产": "正常",
    "新增工信部资产简表反馈状态": "正常",
    "新增工信部资产简表反馈设置时间_": "2026-05-09 08:33:11",
    "工信部资产简表反馈ID": "N-116772",
    "工信部资产简表反馈编号": "N-116772",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-4",
    "工信部资产简表反馈类型": "正常",
    "工信部资产简表反馈规则": "正常",
    "工信部资产简表反馈属性": "正常",
    "工信部资产简表反馈状态": "正常"
  },
  {
    ...
    "工信部资产": "异常",
    "新增工信部资产简表反馈状态": "异常",
    "新增工信部资产简表反馈设置时间_": "2026-05-09 09:47:56",
    "工信部资产简表反馈ID": "N-124691",
    "工信部资产简表反馈编号": "N-124691",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-5",
    "工信部资产简表反馈类型": "异常",
    "工信部资产简表反馈规则": "异常",
    "工信部资产简表反馈属性": "异常",
    "工信部资产简表反馈状态": "异常"
  },
  {
    ...
    "工信部资产": "超时",
    "新增工信部资产简表反馈状态": "超时",
    "新增工信部资产简表反馈设置时间_": "2026-05-08 09:12:18",
    "工信部资产简表反馈ID": "N-132610",
    "工信部资产简表反馈编号": "N-132610",
    "工信部资产简表反馈名称": "工信部资产简表反馈管理-6",
    "工信部资产简表反馈类型": "超时",
    "工信部资产简表反馈规则": "超时",
    "工信部资产简表反馈属性": "超时",
    "工信部资产简表反馈状态": "超时"
...
const tableColumns = [
  ...
  {
    "prop": "新增工信部资产简表反馈设置时间_",
    "label": "新增工信部资产简表反馈设置时间。",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
