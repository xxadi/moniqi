    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞审计指派信息", "form")'>新增资产漏洞审计指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞审计流程", "form")'>新增资产漏洞审计流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞审计流程信息", "config")'>修改资产漏洞审计流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计流程删除", "operation")'>资产漏洞审计流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计流程查询", "detail")'>资产漏洞审计流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计附件上传", "form")'>资产漏洞审计附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产漏洞审计流程图查看", "preview")'>资产漏洞审计流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞审计流程通知", "audit")'>资产漏洞审计流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞审计结果逐级审批", "audit")'>资产漏洞审计结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞审计结果拒绝和驳回", "approval")'>资产漏洞审计结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产漏洞审计指派用户": "李四",
    "资产漏洞审计编号": "Z-8449",
    "资产漏洞审计名称": "资产漏洞审计流程管理-1",
    "新增资产漏洞审计状态": "处理中",
    "新增资产漏洞审计时间": "2026-05-09 09:47:56",
    "资产漏洞审计属性": "处理中",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-09 09:47:56",
    "资产漏洞审计指派部门": "网络管理部",
    "资产漏洞审计负责人": "李四",
    "资产漏洞审计类型": "处理中",
    "资产漏洞审计规则": "处理中"
  },
  {
    ...
    "资产漏洞审计指派用户": "王五",
    "资产漏洞审计编号": "Z-16368",
    "资产漏洞审计名称": "资产漏洞审计流程管理-2",
    "新增资产漏洞审计状态": "待处理",
    "新增资产漏洞审计时间": "2026-05-08 09:12:18",
    "资产漏洞审计属性": "待处理",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 09:12:18",
    "资产漏洞审计指派部门": "资产管理部",
    "资产漏洞审计负责人": "王五",
    "资产漏洞审计类型": "待处理",
    "资产漏洞审计规则": "待处理"
  },
  {
    ...
    "资产漏洞审计指派用户": "赵六",
    "资产漏洞审计编号": "Z-24287",
    "资产漏洞审计名称": "资产漏洞审计流程管理-3",
    "新增资产漏洞审计状态": "处理失败",
    "新增资产漏洞审计时间": "2026-05-08 09:35:44",
    "资产漏洞审计属性": "处理失败",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 09:35:44",
    "资产漏洞审计指派部门": "信息安全部",
    "资产漏洞审计负责人": "赵六",
    "资产漏洞审计类型": "处理失败",
    "资产漏洞审计规则": "处理失败"
  },
  {
    ...
    "资产漏洞审计指派用户": "system",
    "资产漏洞审计编号": "Z-32206",
    "资产漏洞审计名称": "资产漏洞审计流程管理-4",
    "新增资产漏洞审计状态": "已暂停",
    "新增资产漏洞审计时间": "2026-05-08 10:08:06",
    "资产漏洞审计属性": "已暂停",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 10:08:06",
    "资产漏洞审计指派部门": "系统运维部",
    "资产漏洞审计负责人": "system",
    "资产漏洞审计类型": "已暂停",
    "资产漏洞审计规则": "已暂停"
  },
  {
    ...
    "资产漏洞审计指派用户": "admin",
    "资产漏洞审计编号": "Z-40125",
    "资产漏洞审计名称": "资产漏洞审计流程管理-5",
    "新增资产漏洞审计状态": "已完成",
    "新增资产漏洞审计时间": "2026-05-08 10:42:31",
    "资产漏洞审计属性": "已完成",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 10:42:31",
    "资产漏洞审计指派部门": "数据管理部",
    "资产漏洞审计负责人": "admin",
    "资产漏洞审计类型": "已完成",
    "资产漏洞审计规则": "已完成"
  },
  {
    ...
    "资产漏洞审计指派用户": "张三",
    "资产漏洞审计编号": "Z-48044",
    "资产漏洞审计名称": "资产漏洞审计流程管理-6",
    "新增资产漏洞审计状态": "排队中",
    "新增资产漏洞审计时间": "2026-05-08 11:16:09",
    "资产漏洞审计属性": "排队中",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 11:16:09",
    "资产漏洞审计指派部门": "安全运维部",
    "资产漏洞审计负责人": "张三",
    "资产漏洞审计类型": "排队中",
    "资产漏洞审计规则": "排队中"
  },
  {
    ...
    "资产漏洞审计指派用户": "李四",
    "资产漏洞审计编号": "Z-55963",
    "资产漏洞审计名称": "资产漏洞审计流程管理-7",
    "新增资产漏洞审计状态": "部分完成",
    "新增资产漏洞审计时间": "2026-05-08 14:03:52",
    "资产漏洞审计属性": "部分完成",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 14:03:52",
    "资产漏洞审计指派部门": "网络管理部",
    "资产漏洞审计负责人": "李四",
    "资产漏洞审计类型": "部分完成",
    "资产漏洞审计规则": "部分完成"
  },
  {
    ...
    "资产漏洞审计指派用户": "王五",
    "资产漏洞审计编号": "Z-63882",
    "资产漏洞审计名称": "资产漏洞审计流程管理-8",
    "新增资产漏洞审计状态": "已启用",
    "新增资产漏洞审计时间": "2026-05-08 15:21:37",
    "资产漏洞审计属性": "已启用",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 15:21:37",
    "资产漏洞审计指派部门": "资产管理部",
    "资产漏洞审计负责人": "王五",
    "资产漏洞审计类型": "已启用",
    "资产漏洞审计规则": "已启用"
  },
  {
    ...
    "资产漏洞审计指派用户": "赵六",
    "资产漏洞审计编号": "Z-71801",
    "资产漏洞审计名称": "资产漏洞审计流程管理-9",
    "新增资产漏洞审计状态": "已停用",
    "新增资产漏洞审计时间": "2026-05-08 16:08:25",
    "资产漏洞审计属性": "已停用",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-08 16:08:25",
    "资产漏洞审计指派部门": "信息安全部",
    "资产漏洞审计负责人": "赵六",
    "资产漏洞审计类型": "已停用",
    "资产漏洞审计规则": "已停用"
  },
  {
    ...
    "资产漏洞审计指派用户": "system",
    "资产漏洞审计编号": "Z-79720",
    "资产漏洞审计名称": "资产漏洞审计流程管理-10",
    "新增资产漏洞审计状态": "正常",
    "新增资产漏洞审计时间": "2026-05-09 08:33:11",
    "资产漏洞审计属性": "正常",
    "资产漏洞审计指派时间_资产漏洞审计创建时间": "2026-05-09 08:33:11",
    "资产漏洞审计指派部门": "系统运维部",
    "资产漏洞审计负责人": "system",
    "资产漏洞审计类型": "正常",
    "资产漏洞审计规则": "正常"
...
const tableColumns = [
  ...
  {
    "prop": "资产漏洞审计指派时间_资产漏洞审计创建时间",
    "label": "资产漏洞审计指派时间。资产漏洞审计创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
