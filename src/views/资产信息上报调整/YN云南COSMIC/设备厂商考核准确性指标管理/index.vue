    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核准确性信息表", "operation")'>设备厂商考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备厂商数据考核准确性字典信息", "form")'>新增设备厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商数据考核准确性字典信息", "config")'>修改设备厂商数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商数据考核准确性字典信息")'>删除设备厂商数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增设备厂商考核准确性上传任务", "form")'>新增设备厂商考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除设备厂商考核准确性上传任务")'>删除设备厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备厂商考核准确性上传任务", "config")'>修改设备厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询设备厂商考核准确性上传任务", "detail")'>查询设备厂商考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备厂商考核准确性上传任务启用/禁用", "form")'>设备厂商考核准确性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备厂商考核准确性稽核数据上传", "form")'>设备厂商考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备厂商考核准确性稽核数据接口监控", "log")'>设备厂商考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "设备厂商考核准确性ID": "E-13186",
    "设备厂商考核准确性编号": "E-13186",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-1",
    "设备厂商考核准确性状态": "待处理",
    "设备厂商考核准确性时间": "2026-05-08 15:21:37",
    "设备厂商考核准确性属性": "待处理",
    "设备厂商考核准确性创建时间": "2026-05-08 15:21:37",
    "设备厂商考核准确性所属部门": "系统运维部",
    "设备厂商考核准确性负责人": "system",
    "设备厂商考核准确性类型": "待处理",
    "设备厂商考核准确性规则": "待处理",
    "设备厂商数据考核准确性字典ID": "E-13186"
  },
  {
    "ID": 2,
    "设备厂商考核准确性ID": "E-21105",
    "设备厂商考核准确性编号": "E-21105",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-2",
    "设备厂商考核准确性状态": "处理失败",
    "设备厂商考核准确性时间": "2026-05-08 16:08:25",
    "设备厂商考核准确性属性": "处理失败",
    "设备厂商考核准确性创建时间": "2026-05-08 16:08:25",
    "设备厂商考核准确性所属部门": "数据管理部",
    "设备厂商考核准确性负责人": "admin",
    "设备厂商考核准确性类型": "处理失败",
    "设备厂商考核准确性规则": "处理失败",
    "设备厂商数据考核准确性字典ID": "E-21105"
  },
  {
    "ID": 3,
    "设备厂商考核准确性ID": "E-29024",
    "设备厂商考核准确性编号": "E-29024",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-3",
    "设备厂商考核准确性状态": "已暂停",
    "设备厂商考核准确性时间": "2026-05-09 08:33:11",
    "设备厂商考核准确性属性": "已暂停",
    "设备厂商考核准确性创建时间": "2026-05-09 08:33:11",
    "设备厂商考核准确性所属部门": "安全运维部",
    "设备厂商考核准确性负责人": "张三",
    "设备厂商考核准确性类型": "已暂停",
    "设备厂商考核准确性规则": "已暂停",
    "设备厂商数据考核准确性字典ID": "E-29024"
  },
  {
    "ID": 4,
    "设备厂商考核准确性ID": "E-36943",
    "设备厂商考核准确性编号": "E-36943",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-4",
    "设备厂商考核准确性状态": "已完成",
    "设备厂商考核准确性时间": "2026-05-09 09:47:56",
    "设备厂商考核准确性属性": "已完成",
    "设备厂商考核准确性创建时间": "2026-05-09 09:47:56",
    "设备厂商考核准确性所属部门": "网络管理部",
    "设备厂商考核准确性负责人": "李四",
    "设备厂商考核准确性类型": "已完成",
    "设备厂商考核准确性规则": "已完成",
    "设备厂商数据考核准确性字典ID": "E-36943"
  },
  {
    "ID": 5,
    "设备厂商考核准确性ID": "E-44862",
    "设备厂商考核准确性编号": "E-44862",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-5",
    "设备厂商考核准确性状态": "排队中",
    "设备厂商考核准确性时间": "2026-05-08 09:12:18",
    "设备厂商考核准确性属性": "排队中",
    "设备厂商考核准确性创建时间": "2026-05-08 09:12:18",
    "设备厂商考核准确性所属部门": "资产管理部",
    "设备厂商考核准确性负责人": "王五",
    "设备厂商考核准确性类型": "排队中",
    "设备厂商考核准确性规则": "排队中",
    "设备厂商数据考核准确性字典ID": "E-44862"
  },
  {
    "ID": 6,
    "设备厂商考核准确性ID": "E-52781",
    "设备厂商考核准确性编号": "E-52781",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-6",
    "设备厂商考核准确性状态": "部分完成",
    "设备厂商考核准确性时间": "2026-05-08 09:35:44",
    "设备厂商考核准确性属性": "部分完成",
    "设备厂商考核准确性创建时间": "2026-05-08 09:35:44",
    "设备厂商考核准确性所属部门": "信息安全部",
    "设备厂商考核准确性负责人": "赵六",
    "设备厂商考核准确性类型": "部分完成",
    "设备厂商考核准确性规则": "部分完成",
    "设备厂商数据考核准确性字典ID": "E-52781"
  },
  {
    "ID": 7,
    "设备厂商考核准确性ID": "E-60700",
    "设备厂商考核准确性编号": "E-60700",
    "设备厂商考核准确性名称": "设备厂商考核准确性指标管理-7",
    "设备厂商考核准确性状态": "已启用",
    "设备厂商考核准确性时间": "2026-05-08 10:08:06",
    "设备厂商考核准确性属性": "已启用",
    "设备厂商考核准确性创建时间": "2026-05-08 10:08:06",
    "设备厂商考核准确性所属部门": "系统运维部",
    "设备厂商考核准确性负责人": "system",
    "设备厂商考核准确性类型": "已启用",
    "设备厂商考核准确性规则": "已启用",
    "设备厂商数据考核准确性字典ID": "E-60700"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "设备厂商数据考核准确性字典ID",
    "label": "设备厂商数据考核准确性字典ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
