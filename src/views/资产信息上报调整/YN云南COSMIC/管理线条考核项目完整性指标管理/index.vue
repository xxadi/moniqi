    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("管理线条考核项目完整性信息表", "operation")'>管理线条考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增管理线条数据考核项目完整性字典信息", "form")'>新增管理线条数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改管理线条数据考核项目完整性字典信息", "config")'>修改管理线条数据考核项目完整性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除管理线条数据考核项目完整性字典信息")'>删除管理线条数据考核项目完整性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("管理线条考核项目完整性稽核数据上传", "form")'>管理线条考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("管理线条考核项目完整性稽核数据接口监控", "log")'>管理线条考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增管理线条考核项目完整性上传任务", "form")'>新增管理线条考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除管理线条考核项目完整性上传任务")'>删除管理线条考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改管理线条考核项目完整性上传任务", "config")'>修改管理线条考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询管理线条考核项目完整性上传任务", "detail")'>查询管理线条考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("管理线条考核项目完整性上传任务启用/禁用", "form")'>管理线条考核项目完整性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "管理线条考核项目完整性ID": "R-96659",
    "管理线条考核项目完整性编号": "R-96659",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-1",
    "管理线条考核项目完整性状态": "处理失败",
    "管理线条考核项目完整性时间": "2026-05-09 09:47:56",
    "管理线条考核项目完整性属性": "处理失败",
    "管理线条考核项目完整性创建时间": "2026-05-09 09:47:56",
    "管理线条考核项目完整性所属部门": "数据管理部",
    "管理线条考核项目完整性负责人": "admin",
    "管理线条考核项目完整性类型": "处理失败",
    "管理线条考核项目完整性规则": "处理失败",
    "考核项目完整性字典ID": "R-96659"
  },
  {
    "ID": 2,
    "管理线条考核项目完整性ID": "R-104578",
    "管理线条考核项目完整性编号": "R-104578",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-2",
    "管理线条考核项目完整性状态": "已暂停",
    "管理线条考核项目完整性时间": "2026-05-08 09:12:18",
    "管理线条考核项目完整性属性": "已暂停",
    "管理线条考核项目完整性创建时间": "2026-05-08 09:12:18",
    "管理线条考核项目完整性所属部门": "安全运维部",
    "管理线条考核项目完整性负责人": "张三",
    "管理线条考核项目完整性类型": "已暂停",
    "管理线条考核项目完整性规则": "已暂停",
    "考核项目完整性字典ID": "R-104578"
  },
  {
    "ID": 3,
    "管理线条考核项目完整性ID": "R-112497",
    "管理线条考核项目完整性编号": "R-112497",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-3",
    "管理线条考核项目完整性状态": "已完成",
    "管理线条考核项目完整性时间": "2026-05-08 09:35:44",
    "管理线条考核项目完整性属性": "已完成",
    "管理线条考核项目完整性创建时间": "2026-05-08 09:35:44",
    "管理线条考核项目完整性所属部门": "网络管理部",
    "管理线条考核项目完整性负责人": "李四",
    "管理线条考核项目完整性类型": "已完成",
    "管理线条考核项目完整性规则": "已完成",
    "考核项目完整性字典ID": "R-112497"
  },
  {
    "ID": 4,
    "管理线条考核项目完整性ID": "R-120416",
    "管理线条考核项目完整性编号": "R-120416",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-4",
    "管理线条考核项目完整性状态": "排队中",
    "管理线条考核项目完整性时间": "2026-05-08 10:08:06",
    "管理线条考核项目完整性属性": "排队中",
    "管理线条考核项目完整性创建时间": "2026-05-08 10:08:06",
    "管理线条考核项目完整性所属部门": "资产管理部",
    "管理线条考核项目完整性负责人": "王五",
    "管理线条考核项目完整性类型": "排队中",
    "管理线条考核项目完整性规则": "排队中",
    "考核项目完整性字典ID": "R-120416"
  },
  {
    "ID": 5,
    "管理线条考核项目完整性ID": "R-128335",
    "管理线条考核项目完整性编号": "R-128335",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-5",
    "管理线条考核项目完整性状态": "部分完成",
    "管理线条考核项目完整性时间": "2026-05-08 10:42:31",
    "管理线条考核项目完整性属性": "部分完成",
    "管理线条考核项目完整性创建时间": "2026-05-08 10:42:31",
    "管理线条考核项目完整性所属部门": "信息安全部",
    "管理线条考核项目完整性负责人": "赵六",
    "管理线条考核项目完整性类型": "部分完成",
    "管理线条考核项目完整性规则": "部分完成",
    "考核项目完整性字典ID": "R-128335"
  },
  {
    "ID": 6,
    "管理线条考核项目完整性ID": "R-136254",
    "管理线条考核项目完整性编号": "R-136254",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-6",
    "管理线条考核项目完整性状态": "已启用",
    "管理线条考核项目完整性时间": "2026-05-08 11:16:09",
    "管理线条考核项目完整性属性": "已启用",
    "管理线条考核项目完整性创建时间": "2026-05-08 11:16:09",
    "管理线条考核项目完整性所属部门": "系统运维部",
    "管理线条考核项目完整性负责人": "system",
    "管理线条考核项目完整性类型": "已启用",
    "管理线条考核项目完整性规则": "已启用",
    "考核项目完整性字典ID": "R-136254"
  },
  {
    "ID": 7,
    "管理线条考核项目完整性ID": "R-144173",
    "管理线条考核项目完整性编号": "R-144173",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-7",
    "管理线条考核项目完整性状态": "已停用",
    "管理线条考核项目完整性时间": "2026-05-08 14:03:52",
    "管理线条考核项目完整性属性": "已停用",
    "管理线条考核项目完整性创建时间": "2026-05-08 14:03:52",
    "管理线条考核项目完整性所属部门": "数据管理部",
    "管理线条考核项目完整性负责人": "admin",
    "管理线条考核项目完整性类型": "已停用",
    "管理线条考核项目完整性规则": "已停用",
    "考核项目完整性字典ID": "R-144173"
  },
  {
    "ID": 8,
    "管理线条考核项目完整性ID": "R-152092",
    "管理线条考核项目完整性编号": "R-152092",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-8",
    "管理线条考核项目完整性状态": "正常",
    "管理线条考核项目完整性时间": "2026-05-08 15:21:37",
    "管理线条考核项目完整性属性": "正常",
    "管理线条考核项目完整性创建时间": "2026-05-08 15:21:37",
    "管理线条考核项目完整性所属部门": "安全运维部",
    "管理线条考核项目完整性负责人": "张三",
    "管理线条考核项目完整性类型": "正常",
    "管理线条考核项目完整性规则": "正常",
    "考核项目完整性字典ID": "R-152092"
  },
  {
    "ID": 9,
    "管理线条考核项目完整性ID": "R-160011",
    "管理线条考核项目完整性编号": "R-160011",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-9",
    "管理线条考核项目完整性状态": "异常",
    "管理线条考核项目完整性时间": "2026-05-08 16:08:25",
    "管理线条考核项目完整性属性": "异常",
    "管理线条考核项目完整性创建时间": "2026-05-08 16:08:25",
    "管理线条考核项目完整性所属部门": "网络管理部",
    "管理线条考核项目完整性负责人": "李四",
    "管理线条考核项目完整性类型": "异常",
    "管理线条考核项目完整性规则": "异常",
    "考核项目完整性字典ID": "R-160011"
  },
  {
    "ID": 10,
    "管理线条考核项目完整性ID": "R-167930",
    "管理线条考核项目完整性编号": "R-167930",
    "管理线条考核项目完整性名称": "管理线条考核项目完整性指标管理-10",
    "管理线条考核项目完整性状态": "超时",
    "管理线条考核项目完整性时间": "2026-05-09 08:33:11",
    "管理线条考核项目完整性属性": "超时",
    "管理线条考核项目完整性创建时间": "2026-05-09 08:33:11",
    "管理线条考核项目完整性所属部门": "资产管理部",
    "管理线条考核项目完整性负责人": "王五",
    "管理线条考核项目完整性类型": "超时",
    "管理线条考核项目完整性规则": "超时",
    "考核项目完整性字典ID": "R-167930"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "管理线条考核项目完整性创建时间",
    "label": "管理线条考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "管理线条考核项目完整性所属部门",
    "label": "管理线条考核项目完整性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
