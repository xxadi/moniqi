    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核质量可用性信息表", "operation")'>CPU厂商考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商数据考核质量可用性字典信息", "form")'>新增CPU厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商数据考核质量可用性字典信息", "config")'>修改CPU厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商数据考核质量可用性字典信息")'>删除CPU厂商数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增CPU厂商考核质量可用性上传任务", "form")'>新增CPU厂商考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除CPU厂商考核质量可用性上传任务")'>删除CPU厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改CPU厂商考核质量可用性上传任务", "config")'>修改CPU厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询CPU厂商考核质量可用性上传任务", "detail")'>查询CPU厂商考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU厂商考核质量可用性上传任务启用/禁用", "form")'>CPU厂商考核质量可用性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU厂商考核质量可用性稽核数据上传", "form")'>CPU厂商考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU厂商考核质量可用性稽核数据接口监控", "log")'>CPU厂商考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("CPU型号考核质量可用性信息表", "operation")'>CPU型号考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("CPU型号考核质量可用性稽核数据上传", "form")'>CPU型号考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("CPU型号考核质量可用性稽核数据接口监控", "log")'>CPU型号考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "CPU厂商考核质量可用性ID": "N-19851",
    "CPU厂商考核质量可用性编号": "N-19851",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-1",
    "CPU厂商考核质量可用性状态": "异常",
    "CPU厂商考核质量可用性时间": "2026-05-08 09:35:44",
    "CPU厂商考核质量可用性属性": "异常",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 09:35:44",
    "CPU厂商考核质量可用性所属部门": "信息安全部",
    "CPU厂商考核质量可用性负责人": "赵六",
    "CPU厂商考核质量可用性类型": "异常",
    "CPU厂商考核质量可用性规则": "异常",
    "可用性字典ID": "N-19851"
  ...
  {
    "ID": 2,
    "CPU厂商考核质量可用性ID": "N-27770",
    "CPU厂商考核质量可用性编号": "N-27770",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-2",
    "CPU厂商考核质量可用性状态": "超时",
    "CPU厂商考核质量可用性时间": "2026-05-08 10:08:06",
    "CPU厂商考核质量可用性属性": "超时",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 10:08:06",
    "CPU厂商考核质量可用性所属部门": "系统运维部",
    "CPU厂商考核质量可用性负责人": "system",
    "CPU厂商考核质量可用性类型": "超时",
    "CPU厂商考核质量可用性规则": "超时",
    "可用性字典ID": "N-27770"
  },
  {
    "ID": 3,
    "CPU厂商考核质量可用性ID": "N-35689",
    "CPU厂商考核质量可用性编号": "N-35689",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-3",
    "CPU厂商考核质量可用性状态": "已取消",
    "CPU厂商考核质量可用性时间": "2026-05-08 10:42:31",
    "CPU厂商考核质量可用性属性": "已取消",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 10:42:31",
    "CPU厂商考核质量可用性所属部门": "数据管理部",
    "CPU厂商考核质量可用性负责人": "admin",
    "CPU厂商考核质量可用性类型": "已取消",
    "CPU厂商考核质量可用性规则": "已取消",
    "可用性字典ID": "N-35689"
  },
  {
    "ID": 4,
    "CPU厂商考核质量可用性ID": "N-43608",
    "CPU厂商考核质量可用性编号": "N-43608",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-4",
    "CPU厂商考核质量可用性状态": "已驳回",
    "CPU厂商考核质量可用性时间": "2026-05-08 11:16:09",
    "CPU厂商考核质量可用性属性": "已驳回",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 11:16:09",
    "CPU厂商考核质量可用性所属部门": "安全运维部",
    "CPU厂商考核质量可用性负责人": "张三",
    "CPU厂商考核质量可用性类型": "已驳回",
    "CPU厂商考核质量可用性规则": "已驳回",
    "可用性字典ID": "N-43608"
  ...
  {
    "ID": 5,
    "CPU厂商考核质量可用性ID": "N-51527",
    "CPU厂商考核质量可用性编号": "N-51527",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-5",
    "CPU厂商考核质量可用性状态": "待审核",
    "CPU厂商考核质量可用性时间": "2026-05-08 14:03:52",
    "CPU厂商考核质量可用性属性": "待审核",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 14:03:52",
    "CPU厂商考核质量可用性所属部门": "网络管理部",
    "CPU厂商考核质量可用性负责人": "李四",
    "CPU厂商考核质量可用性类型": "待审核",
    "CPU厂商考核质量可用性规则": "待审核",
    "可用性字典ID": "N-51527"
  ...
  {
    "ID": 6,
    "CPU厂商考核质量可用性ID": "N-59446",
    "CPU厂商考核质量可用性编号": "N-59446",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-6",
    "CPU厂商考核质量可用性状态": "已处理",
    "CPU厂商考核质量可用性时间": "2026-05-08 15:21:37",
    "CPU厂商考核质量可用性属性": "已处理",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 15:21:37",
    "CPU厂商考核质量可用性所属部门": "资产管理部",
    "CPU厂商考核质量可用性负责人": "王五",
    "CPU厂商考核质量可用性类型": "已处理",
    "CPU厂商考核质量可用性规则": "已处理",
    "可用性字典ID": "N-59446"
  ...
  {
    "ID": 7,
    "CPU厂商考核质量可用性ID": "N-67365",
    "CPU厂商考核质量可用性编号": "N-67365",
    "CPU厂商考核质量可用性名称": "CPU厂商考核质量可用性指标管理-7",
    "CPU厂商考核质量可用性状态": "处理中",
    "CPU厂商考核质量可用性时间": "2026-05-08 16:08:25",
    "CPU厂商考核质量可用性属性": "处理中",
    "CPU厂商考核质量可用性创建时间": "2026-05-08 16:08:25",
    "CPU厂商考核质量可用性所属部门": "信息安全部",
    "CPU厂商考核质量可用性负责人": "赵六",
    "CPU厂商考核质量可用性类型": "处理中",
    "CPU厂商考核质量可用性规则": "处理中",
...
const tableColumns = [
  ...
  {
    "prop": "CPU厂商考核质量可用性属性",
    "label": "CPU厂商考核质量可用性属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "CPU厂商考核质量可用性创建时间",
    "label": "CPU厂商考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "CPU厂商考核质量可用性所属部门",
    "label": "CPU厂商考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "CPU厂商考核质量可用性负责人",
    "label": "CPU厂商考核质量可用性负责人",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
...
const importTemplateRow = {
  ...
  "CPU厂商考核质量可用性规则": "",
  "可用性字典ID": "",
  "导入来源": "CPU厂商考核质量可用性指标管理导入模板.xlsx"
};
