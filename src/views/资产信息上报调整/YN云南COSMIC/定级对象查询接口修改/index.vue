    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增定级对象查询信息", "form")'>新增定级对象查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象查询信息", "config")'>修改定级对象查询信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除定级对象查询信息")'>删除定级对象查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象查询列表", "detail")'>查询定级对象查询列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象查询详情", "detail")'>查询定级对象查询详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "定级对象查询ID": "N-64571",
    "定级对象查询编号": "N-64571",
    "定级对象查询名称": "定级对象查询接口修改-1",
    "新增定级对象查询状态": "异常",
    "新增定级对象查询时间": "2026-05-08 09:35:44",
    "定级对象查询属性": "异常",
    "定级对象查询创建时间": "2026-05-08 09:35:44",
    "定级对象查询所属部门": "数据管理部",
    "定级对象查询负责人": "admin",
    "定级对象查询类型": "异常",
    "定级对象查询规则": "异常",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-72490",
    "定级对象查询编号": "N-72490",
    "定级对象查询名称": "定级对象查询接口修改-2",
    "新增定级对象查询状态": "超时",
    "新增定级对象查询时间": "2026-05-08 10:08:06",
    "定级对象查询属性": "超时",
    "定级对象查询创建时间": "2026-05-08 10:08:06",
    "定级对象查询所属部门": "安全运维部",
    "定级对象查询负责人": "张三",
    "定级对象查询类型": "超时",
    "定级对象查询规则": "超时",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-80409",
    "定级对象查询编号": "N-80409",
    "定级对象查询名称": "定级对象查询接口修改-3",
    "新增定级对象查询状态": "已取消",
    "新增定级对象查询时间": "2026-05-08 10:42:31",
    "定级对象查询属性": "已取消",
    "定级对象查询创建时间": "2026-05-08 10:42:31",
    "定级对象查询所属部门": "网络管理部",
    "定级对象查询负责人": "李四",
    "定级对象查询类型": "已取消",
    "定级对象查询规则": "已取消",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-88328",
    "定级对象查询编号": "N-88328",
    "定级对象查询名称": "定级对象查询接口修改-4",
    "新增定级对象查询状态": "已驳回",
    "新增定级对象查询时间": "2026-05-08 11:16:09",
    "定级对象查询属性": "已驳回",
    "定级对象查询创建时间": "2026-05-08 11:16:09",
    "定级对象查询所属部门": "资产管理部",
    "定级对象查询负责人": "王五",
    "定级对象查询类型": "已驳回",
    "定级对象查询规则": "已驳回",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-96247",
    "定级对象查询编号": "N-96247",
    "定级对象查询名称": "定级对象查询接口修改-5",
    "新增定级对象查询状态": "待审核",
    "新增定级对象查询时间": "2026-05-08 14:03:52",
    "定级对象查询属性": "待审核",
    "定级对象查询创建时间": "2026-05-08 14:03:52",
    "定级对象查询所属部门": "信息安全部",
    "定级对象查询负责人": "赵六",
    "定级对象查询类型": "待审核",
    "定级对象查询规则": "待审核",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-104166",
    "定级对象查询编号": "N-104166",
    "定级对象查询名称": "定级对象查询接口修改-6",
    "新增定级对象查询状态": "已处理",
    "新增定级对象查询时间": "2026-05-08 15:21:37",
    "定级对象查询属性": "已处理",
    "定级对象查询创建时间": "2026-05-08 15:21:37",
    "定级对象查询所属部门": "系统运维部",
    "定级对象查询负责人": "system",
    "定级对象查询类型": "已处理",
    "定级对象查询规则": "已处理",
  ...
  },
  {
    ...
    "定级对象查询ID": "N-112085",
    "定级对象查询编号": "N-112085",
    "定级对象查询名称": "定级对象查询接口修改-7",
    "新增定级对象查询状态": "处理中",
    "新增定级对象查询时间": "2026-05-08 16:08:25",
    "定级对象查询属性": "处理中",
    "定级对象查询创建时间": "2026-05-08 16:08:25",
    "定级对象查询所属部门": "数据管理部",
    "定级对象查询负责人": "admin",
    "定级对象查询类型": "处理中",
    "定级对象查询规则": "处理中",
