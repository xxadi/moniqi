    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描分析结果审批指派信息", "form")'>新增远程扫描分析结果审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增远程扫描分析结果审批流程", "form")'>新增远程扫描分析结果审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改远程扫描分析结果审批流程信息", "config")'>修改远程扫描分析结果审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批流程删除", "analysis")'>远程扫描分析结果审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批流程查询", "analysis")'>远程扫描分析结果审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批附件上传", "analysis")'>远程扫描分析结果审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批流程图查看", "analysis")'>远程扫描分析结果审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批流程通知", "analysis")'>远程扫描分析结果审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批结果逐级审批", "analysis")'>远程扫描分析结果审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("远程扫描分析结果审批结果拒绝和驳回", "analysis")'>远程扫描分析结果审批结果拒绝和驳回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析信息表", "analysis")'>流量分析信息表</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "远程扫描分析结果审批ID": "X-65517",
    "远程扫描分析结果审批指派用户": "已取消",
    "远程扫描分析结果审批编号": "X-65517",
    "远程扫描分析结果审批名称": "已取消",
    "新增远程扫描分析结果审批状态": "已取消",
    "新增远程扫描分析结果审批时间": "2026-05-08 16:08:25",
    "远程扫描分析结果审批属性": "已取消",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 16:08:25",
    "远程扫描分析结果审批指派部门": "已取消",
    "远程扫描分析结果审批负责人": "已取消",
    "远程扫描分析结果审批类型": "已取消",
    "远程扫描分析结果审批规则": "已取消"
  ...
  {
    "ID": 2,
    "远程扫描分析结果审批ID": "X-73436",
    "远程扫描分析结果审批指派用户": "已驳回",
    "远程扫描分析结果审批编号": "X-73436",
    "远程扫描分析结果审批名称": "已驳回",
    "新增远程扫描分析结果审批状态": "已驳回",
    "新增远程扫描分析结果审批时间": "2026-05-09 08:33:11",
    "远程扫描分析结果审批属性": "已驳回",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-09 08:33:11",
    "远程扫描分析结果审批指派部门": "已驳回",
    "远程扫描分析结果审批负责人": "已驳回",
    "远程扫描分析结果审批类型": "已驳回",
    "远程扫描分析结果审批规则": "已驳回"
  ...
  {
    "ID": 3,
    "远程扫描分析结果审批ID": "X-81355",
    "远程扫描分析结果审批指派用户": "待审核",
    "远程扫描分析结果审批编号": "X-81355",
    "远程扫描分析结果审批名称": "待审核",
    "新增远程扫描分析结果审批状态": "待审核",
    "新增远程扫描分析结果审批时间": "2026-05-09 09:47:56",
    "远程扫描分析结果审批属性": "待审核",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-09 09:47:56",
    "远程扫描分析结果审批指派部门": "待审核",
    "远程扫描分析结果审批负责人": "待审核",
    "远程扫描分析结果审批类型": "待审核",
    "远程扫描分析结果审批规则": "待审核"
  ...
  {
    "ID": 4,
    "远程扫描分析结果审批ID": "X-89274",
    "远程扫描分析结果审批指派用户": "已处理",
    "远程扫描分析结果审批编号": "X-89274",
    "远程扫描分析结果审批名称": "已处理",
    "新增远程扫描分析结果审批状态": "已处理",
    "新增远程扫描分析结果审批时间": "2026-05-08 09:12:18",
    "远程扫描分析结果审批属性": "已处理",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 09:12:18",
    "远程扫描分析结果审批指派部门": "已处理",
    "远程扫描分析结果审批负责人": "已处理",
    "远程扫描分析结果审批类型": "已处理",
    "远程扫描分析结果审批规则": "已处理"
  ...
  {
    "ID": 5,
    "远程扫描分析结果审批ID": "X-97193",
    "远程扫描分析结果审批指派用户": "处理中",
    "远程扫描分析结果审批编号": "X-97193",
    "远程扫描分析结果审批名称": "处理中",
    "新增远程扫描分析结果审批状态": "处理中",
    "新增远程扫描分析结果审批时间": "2026-05-08 09:35:44",
    "远程扫描分析结果审批属性": "处理中",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 09:35:44",
    "远程扫描分析结果审批指派部门": "处理中",
    "远程扫描分析结果审批负责人": "处理中",
    "远程扫描分析结果审批类型": "处理中",
    "远程扫描分析结果审批规则": "处理中"
  ...
  {
    "ID": 6,
    "远程扫描分析结果审批ID": "X-105112",
    "远程扫描分析结果审批指派用户": "待处理",
    "远程扫描分析结果审批编号": "X-105112",
    "远程扫描分析结果审批名称": "待处理",
    "新增远程扫描分析结果审批状态": "待处理",
    "新增远程扫描分析结果审批时间": "2026-05-08 10:08:06",
    "远程扫描分析结果审批属性": "待处理",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 10:08:06",
    "远程扫描分析结果审批指派部门": "待处理",
    "远程扫描分析结果审批负责人": "待处理",
    "远程扫描分析结果审批类型": "待处理",
    "远程扫描分析结果审批规则": "待处理"
  ...
  {
    "ID": 7,
    "远程扫描分析结果审批ID": "X-113031",
    "远程扫描分析结果审批指派用户": "处理失败",
    "远程扫描分析结果审批编号": "X-113031",
    "远程扫描分析结果审批名称": "处理失败",
    "新增远程扫描分析结果审批状态": "处理失败",
    "新增远程扫描分析结果审批时间": "2026-05-08 10:42:31",
    "远程扫描分析结果审批属性": "处理失败",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 10:42:31",
    "远程扫描分析结果审批指派部门": "处理失败",
    "远程扫描分析结果审批负责人": "处理失败",
    "远程扫描分析结果审批类型": "处理失败",
    "远程扫描分析结果审批规则": "处理失败"
  ...
  {
    "ID": 8,
    "远程扫描分析结果审批ID": "X-120950",
    "远程扫描分析结果审批指派用户": "已暂停",
    "远程扫描分析结果审批编号": "X-120950",
    "远程扫描分析结果审批名称": "已暂停",
    "新增远程扫描分析结果审批状态": "已暂停",
    "新增远程扫描分析结果审批时间": "2026-05-08 11:16:09",
    "远程扫描分析结果审批属性": "已暂停",
    "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间": "2026-05-08 11:16:09",
    "远程扫描分析结果审批指派部门": "已暂停",
    "远程扫描分析结果审批负责人": "已暂停",
    "远程扫描分析结果审批类型": "已暂停",
    "远程扫描分析结果审批规则": "已暂停"
...
const tableColumns = [
  ...
  {
    "prop": "远程扫描分析结果审批指派时间_远程扫描分析结果审批创建时间",
    "label": "远程扫描分析结果审批指派时间。远程扫描分析结果审批创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
