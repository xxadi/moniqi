    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增一键探测任务信息", "form")'>新增一键探测任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改一键探测任务信息", "config")'>修改一键探测任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除一键探测任务信息")'>删除一键探测任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询一键探测任务列表", "detail")'>查询一键探测任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询一键探测任务详情", "detail")'>查询一键探测任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入一键探测任务")'>批量导入一键探测任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("一键探测任务导出")'>一键探测任务导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("一键探测任务监控", "log")'>一键探测任务监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("一键探测任务监控告警", "alert")'>一键探测任务监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "一键探测任务ID": "R-69047",
    "一键探测任务编号": "R-69047",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-1",
    "新增一键探测任务状态": "部分完成",
    "新增一键探测任务时间": "2026-05-08 16:08:25",
    "一键探测任务属性": "部分完成",
    "一键探测任务创建时间": "2026-05-08 16:08:25",
    "一键探测任务所属部门": "数据管理部",
    "一键探测任务负责人": "admin",
    "一键探测任务类型": "部分完成",
    "一键探测任务规则": "部分完成",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-76966",
    "一键探测任务编号": "R-76966",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-2",
    "新增一键探测任务状态": "已启用",
    "新增一键探测任务时间": "2026-05-09 08:33:11",
    "一键探测任务属性": "已启用",
    "一键探测任务创建时间": "2026-05-09 08:33:11",
    "一键探测任务所属部门": "安全运维部",
    "一键探测任务负责人": "张三",
    "一键探测任务类型": "已启用",
    "一键探测任务规则": "已启用",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-84885",
    "一键探测任务编号": "R-84885",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-3",
    "新增一键探测任务状态": "已停用",
    "新增一键探测任务时间": "2026-05-09 09:47:56",
    "一键探测任务属性": "已停用",
    "一键探测任务创建时间": "2026-05-09 09:47:56",
    "一键探测任务所属部门": "网络管理部",
    "一键探测任务负责人": "李四",
    "一键探测任务类型": "已停用",
    "一键探测任务规则": "已停用",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-92804",
    "一键探测任务编号": "R-92804",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-4",
    "新增一键探测任务状态": "正常",
    "新增一键探测任务时间": "2026-05-08 09:12:18",
    "一键探测任务属性": "正常",
    "一键探测任务创建时间": "2026-05-08 09:12:18",
    "一键探测任务所属部门": "资产管理部",
    "一键探测任务负责人": "王五",
    "一键探测任务类型": "正常",
    "一键探测任务规则": "正常",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-100723",
    "一键探测任务编号": "R-100723",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-5",
    "新增一键探测任务状态": "异常",
    "新增一键探测任务时间": "2026-05-08 09:35:44",
    "一键探测任务属性": "异常",
    "一键探测任务创建时间": "2026-05-08 09:35:44",
    "一键探测任务所属部门": "信息安全部",
    "一键探测任务负责人": "赵六",
    "一键探测任务类型": "异常",
    "一键探测任务规则": "异常",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-108642",
    "一键探测任务编号": "R-108642",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-6",
    "新增一键探测任务状态": "超时",
    "新增一键探测任务时间": "2026-05-08 10:08:06",
    "一键探测任务属性": "超时",
    "一键探测任务创建时间": "2026-05-08 10:08:06",
    "一键探测任务所属部门": "系统运维部",
    "一键探测任务负责人": "system",
    "一键探测任务类型": "超时",
    "一键探测任务规则": "超时",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-116561",
    "一键探测任务编号": "R-116561",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-7",
    "新增一键探测任务状态": "已取消",
    "新增一键探测任务时间": "2026-05-08 10:42:31",
    "一键探测任务属性": "已取消",
    "一键探测任务创建时间": "2026-05-08 10:42:31",
    "一键探测任务所属部门": "数据管理部",
    "一键探测任务负责人": "admin",
    "一键探测任务类型": "已取消",
    "一键探测任务规则": "已取消",
  ...
  },
  {
    ...
    "一键探测任务ID": "R-124480",
    "一键探测任务编号": "R-124480",
    "一键探测任务名称": "互联网暴露面一键探测任务管理-8",
    "新增一键探测任务状态": "已驳回",
    "新增一键探测任务时间": "2026-05-08 11:16:09",
    "一键探测任务属性": "已驳回",
    "一键探测任务创建时间": "2026-05-08 11:16:09",
    "一键探测任务所属部门": "安全运维部",
    "一键探测任务负责人": "张三",
    "一键探测任务类型": "已驳回",
    "一键探测任务规则": "已驳回",
