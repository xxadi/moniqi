    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增IP地址变更工单信息", "form")'>新增IP地址变更工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP地址变更工单信息", "config")'>修改IP地址变更工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除IP地址变更工单信息")'>删除IP地址变更工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看IP地址变更工单信息", "detail")'>查看IP地址变更工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址变更工单附件文件上传", "form")'>IP地址变更工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址变更工单附件文件删除", "operation")'>IP地址变更工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址变更工单信息审批", "audit")'>IP地址变更工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址变更工单信息撤回", "operation")'>IP地址变更工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP地址变更工单信息终止", "operation")'>IP地址变更工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("IP地址变更工单信息派发提醒", "audit")'>IP地址变更工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "IP地址变更ID": "E-15240",
    "IP地址变更编号": "E-15240",
    "IP地址变更名称": "IP地址变更工单管理-1",
    "新增IP地址变更状态": "已启用",
    "新增IP地址变更时间": "2026-05-08 09:12:18",
    "IP地址变更属性": "10.10.1.100",
    "IP地址变更创建时间": "2026-05-08 09:12:18",
    "IP地址变更所属部门": "安全运维部",
    "IP地址变更负责人": "张三",
    "IP地址变更类型": "10.10.1.100",
    "IP地址变更规则": "10.10.1.100",
    "名称": "IP地址变更工单管理-1"
  },
  {
    "ID": 2,
    "IP地址变更ID": "E-23159",
    "IP地址变更编号": "E-23159",
    "IP地址变更名称": "IP地址变更工单管理-2",
    "新增IP地址变更状态": "已停用",
    "新增IP地址变更时间": "2026-05-08 09:35:44",
    "IP地址变更属性": "172.16.0.50",
    "IP地址变更创建时间": "2026-05-08 09:35:44",
    "IP地址变更所属部门": "网络管理部",
    "IP地址变更负责人": "李四",
    "IP地址变更类型": "172.16.0.50",
    "IP地址变更规则": "172.16.0.50",
    "名称": "IP地址变更工单管理-2"
  },
  {
    "ID": 3,
    "IP地址变更ID": "E-31078",
    "IP地址变更编号": "E-31078",
    "IP地址变更名称": "IP地址变更工单管理-3",
    "新增IP地址变更状态": "正常",
    "新增IP地址变更时间": "2026-05-08 10:08:06",
    "IP地址变更属性": "192.168.1.200",
    "IP地址变更创建时间": "2026-05-08 10:08:06",
    "IP地址变更所属部门": "资产管理部",
    "IP地址变更负责人": "王五",
    "IP地址变更类型": "192.168.1.200",
    "IP地址变更规则": "192.168.1.200",
    "名称": "IP地址变更工单管理-3"
  },
  {
    "ID": 4,
    "IP地址变更ID": "E-38997",
    "IP地址变更编号": "E-38997",
    "IP地址变更名称": "IP地址变更工单管理-4",
    "新增IP地址变更状态": "异常",
    "新增IP地址变更时间": "2026-05-08 10:42:31",
    "IP地址变更属性": "10.20.5.30",
    "IP地址变更创建时间": "2026-05-08 10:42:31",
    "IP地址变更所属部门": "信息安全部",
    "IP地址变更负责人": "赵六",
    "IP地址变更类型": "10.20.5.30",
    "IP地址变更规则": "10.20.5.30",
  ...
  },
  {
    ...
    "IP地址变更ID": "E-46916",
    "IP地址变更编号": "E-46916",
    "IP地址变更名称": "IP地址变更工单管理-5",
    "新增IP地址变更状态": "超时",
    "新增IP地址变更时间": "2026-05-08 11:16:09",
    "IP地址变更属性": "172.20.1.80",
    "IP地址变更创建时间": "2026-05-08 11:16:09",
    "IP地址变更所属部门": "系统运维部",
    "IP地址变更负责人": "system",
    "IP地址变更类型": "172.20.1.80",
    "IP地址变更规则": "172.20.1.80",
    "名称": "IP地址变更工单管理-5"
  },
  {
    "ID": 6,
    "IP地址变更ID": "E-54835",
    "IP地址变更编号": "E-54835",
    "IP地址变更名称": "IP地址变更工单管理-6",
    "新增IP地址变更状态": "已取消",
    "新增IP地址变更时间": "2026-05-08 14:03:52",
    "IP地址变更属性": "10.0.0.254",
    "IP地址变更创建时间": "2026-05-08 14:03:52",
    "IP地址变更所属部门": "数据管理部",
    "IP地址变更负责人": "admin",
    "IP地址变更类型": "10.0.0.254",
    "IP地址变更规则": "10.0.0.254",
