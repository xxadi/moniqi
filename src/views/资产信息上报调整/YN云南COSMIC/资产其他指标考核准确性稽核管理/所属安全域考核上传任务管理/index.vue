    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增所属安全域考核准确性上传任务')">新增所属安全域考核准确性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除所属安全域考核准确性上传任务')">删除所属安全域考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改所属安全域考核准确性上传任务')">修改所属安全域考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-search" @click="handleFunction('查询所属安全域考核准确性上传任务')">查询所属安全域考核准确性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-refresh" @click="handleFunction('所属安全域考核准确性上传任务启用/禁用')">所属安全域考核准确性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-upload" @click="handleFunction('所属安全域考核准确性稽核数据上传')">所属安全域考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-monitor" @click="handleFunction('所属安全域考核准确性稽核数据接口监控')">所属安全域考核准确性稽核数据接口监控</el-button>
        </div>
  ...
  methods: {
    ...
    handleFunction(name) {
      ...
      if (/新增/.test(name)) {
        ...
        this.$message.success("所属安全域考核准确性稽核数据上传 - 上传演示成功，数据已提交处理");
      } else if (/监控/.test(name)) {
        this.$message.info("所属安全域考核准确性稽核数据接口监控 - 接口监控演示：当前监控接口3个，全部正常运行");
      } else {
