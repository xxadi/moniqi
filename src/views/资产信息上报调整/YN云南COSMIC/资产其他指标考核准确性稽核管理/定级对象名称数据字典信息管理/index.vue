    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click="handleFunction('新增定级对象名称数据考核准确性字典信息')">新增定级对象名称数据考核准确性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click="handleFunction('修改定级对象名称数据考核准确性字典信息')">修改定级对象名称数据考核准确性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click="handleFunction('删除定级对象名称数据考核准确性字典信息')">删除定级对象名称数据考核准确性字典信息</el-button>
        </div>
