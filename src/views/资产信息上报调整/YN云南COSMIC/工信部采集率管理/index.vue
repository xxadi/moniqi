    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义工信部采集率信息", "transform")'>定义工信部采集率信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部采集率信息", "config")'>修改工信部采集率信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部采集率信息")'>删除工信部采集率信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率数据获取", "transform")'>工信部采集率数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部采集率数据上传", "form")'>工信部采集率数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部采集率数据接口监控", "log")'>工信部采集率数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率汇总报告详情", "detail")'>查询工信部采集率汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部采集率明细报告详情", "detail")'>查询工信部采集率明细报告详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部采集率名称": "工信部采集率管理-1",
    "定义工信部采集率状态": "处理中",
    "定义工信部采集率时间": "2026-05-08 14:03:52",
    "工信部采集率属性": "处理中",
    "工信部采集率创建时间": "2026-05-08 14:03:52",
    "工信部采集率所属部门": "信息安全部",
    "工信部采集率负责人": "赵六",
    "工信部采集率类型": "处理中",
    "工信部采集率规则": "处理中",
  ...
  },
  {
    ...
    "工信部采集率名称": "工信部采集率管理-2",
    "定义工信部采集率状态": "待处理",
    "定义工信部采集率时间": "2026-05-08 15:21:37",
    "工信部采集率属性": "待处理",
    "工信部采集率创建时间": "2026-05-08 15:21:37",
    "工信部采集率所属部门": "系统运维部",
    "工信部采集率负责人": "system",
    "工信部采集率类型": "待处理",
    "工信部采集率规则": "待处理",
  ...
  },
  {
    ...
    "工信部采集率名称": "工信部采集率管理-3",
    "定义工信部采集率状态": "处理失败",
    "定义工信部采集率时间": "2026-05-08 16:08:25",
    "工信部采集率属性": "处理失败",
    "工信部采集率创建时间": "2026-05-08 16:08:25",
    "工信部采集率所属部门": "数据管理部",
    "工信部采集率负责人": "admin",
    "工信部采集率类型": "处理失败",
    "工信部采集率规则": "处理失败",
  ...
  },
  {
    ...
    "工信部采集率名称": "工信部采集率管理-4",
    "定义工信部采集率状态": "已暂停",
    "定义工信部采集率时间": "2026-05-09 08:33:11",
    "工信部采集率属性": "已暂停",
    "工信部采集率创建时间": "2026-05-09 08:33:11",
    "工信部采集率所属部门": "安全运维部",
    "工信部采集率负责人": "张三",
    "工信部采集率类型": "已暂停",
    "工信部采集率规则": "已暂停",
  ...
  },
  {
    ...
    "工信部采集率名称": "工信部采集率管理-5",
    "定义工信部采集率状态": "已完成",
    "定义工信部采集率时间": "2026-05-09 09:47:56",
    "工信部采集率属性": "已完成",
    "工信部采集率创建时间": "2026-05-09 09:47:56",
    "工信部采集率所属部门": "网络管理部",
    "工信部采集率负责人": "李四",
    "工信部采集率类型": "已完成",
    "工信部采集率规则": "已完成",
  ...
  },
  {
    ...
    "工信部采集率名称": "工信部采集率管理-6",
    "定义工信部采集率状态": "排队中",
    "定义工信部采集率时间": "2026-05-08 09:12:18",
    "工信部采集率属性": "排队中",
    "工信部采集率创建时间": "2026-05-08 09:12:18",
    "工信部采集率所属部门": "资产管理部",
    "工信部采集率负责人": "王五",
    "工信部采集率类型": "排队中",
    "工信部采集率规则": "排队中",
