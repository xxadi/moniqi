    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-check" @click='handleFunction("发起资产状态采集结果审核流程", "initiate_audit")'>发起资产状态采集结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产状态采集结果审核指派信息", "form")'>新增资产状态采集结果审核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产状态采集结果审核流程", "form")'>新增资产状态采集结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产状态采集结果审核流程信息", "config")'>修改资产状态采集结果审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集结果审核流程删除", "operation")'>资产状态采集结果审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集结果审核流程查询", "detail")'>资产状态采集结果审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集结果审核附件上传", "form")'>资产状态采集结果审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产状态采集结果审核流程图查看", "preview")'>资产状态采集结果审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产状态采集结果审核流程通知", "transform")'>资产状态采集结果审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产状态采集结果审核结果逐级审批", "transform")'>资产状态采集结果审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产状态采集结果审核结果拒绝和驳回", "approval")'>资产状态采集结果审核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产状态采集结果审核ID": "I-12540",
    "采集ID": "I-12540",
    "审核者ID": "I-12540",
    "审核时间": "2026-05-08 09:12:18",
    "审核结果": "超时",
    "审核意见": "超时",
    "审核状态": "超时",
    "结果审核ID": "I-12540",
  ...
  {
    "ID": 2,
    "资产状态采集结果审核ID": "I-20459",
    "采集ID": "I-20459",
    "审核者ID": "I-20459",
    "审核时间": "2026-05-08 09:35:44",
    "审核结果": "已取消",
    "审核意见": "已取消",
    "审核状态": "已取消",
    "结果审核ID": "I-20459",
  ...
  {
    "ID": 3,
    "资产状态采集结果审核ID": "I-28378",
    "采集ID": "I-28378",
    "审核者ID": "I-28378",
    "审核时间": "2026-05-08 10:08:06",
    "审核结果": "已驳回",
    "审核意见": "已驳回",
    "审核状态": "已驳回",
    "结果审核ID": "I-28378",
  ...
  {
    "ID": 4,
    "资产状态采集结果审核ID": "I-36297",
    "采集ID": "I-36297",
    "审核者ID": "I-36297",
    "审核时间": "2026-05-08 10:42:31",
    "审核结果": "待审核",
    "审核意见": "待审核",
    "审核状态": "待审核",
    "结果审核ID": "I-36297",
  ...
  {
    "ID": 5,
    "资产状态采集结果审核ID": "I-44216",
    "采集ID": "I-44216",
    "审核者ID": "I-44216",
    "审核时间": "2026-05-08 11:16:09",
    "审核结果": "已处理",
    "审核意见": "已处理",
    "审核状态": "已处理",
    "结果审核ID": "I-44216",
  ...
  {
    "ID": 6,
    "资产状态采集结果审核ID": "I-52135",
    "采集ID": "I-52135",
    "审核者ID": "I-52135",
    "审核时间": "2026-05-08 14:03:52",
    "审核结果": "处理中",
    "审核意见": "处理中",
    "审核状态": "处理中",
    "结果审核ID": "I-52135",
