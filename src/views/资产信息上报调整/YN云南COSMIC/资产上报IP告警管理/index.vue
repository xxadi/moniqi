    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产上报IP告警下发接口", "api")'>资产上报IP告警下发接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产上报IP告警信息", "form")'>新增资产上报IP告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产上报IP告警信息", "config")'>修改资产上报IP告警信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产上报IP告警信息")'>删除资产上报IP告警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报IP告警汇总表", "detail")'>查询资产上报IP告警汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产上报IP告警详情", "detail")'>查询资产上报IP告警详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产上报IP告警")'>批量导入资产上报IP告警</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='exportRows("资产上报IP告警导出")'>资产上报IP告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产上报IP告警ID": "I-91398",
    "资产上报IP告警编号": "I-91398",
    "资产上报IP告警名称": "资产上报IP告警管理-1",
    "资产上报IP告警状态": "排队中",
    "资产上报IP告警时间": "2026-05-09 08:33:11",
    "资产上报IP告警属性": "10.10.1.100",
    "资产上报IP告警创建时间": "2026-05-09 08:33:11",
    "资产上报IP告警所属部门": "安全运维部",
    "资产上报IP告警负责人": "张三",
    "资产上报IP告警类型": "10.10.1.100",
    "资产上报IP告警规则": "10.10.1.100",
    "资产IP上报告警ID": "I-91398"
  },
  {
    "ID": 2,
    "资产上报IP告警ID": "I-99317",
    "资产上报IP告警编号": "I-99317",
    "资产上报IP告警名称": "资产上报IP告警管理-2",
    "资产上报IP告警状态": "部分完成",
    "资产上报IP告警时间": "2026-05-09 09:47:56",
    "资产上报IP告警属性": "172.16.0.50",
    "资产上报IP告警创建时间": "2026-05-09 09:47:56",
    "资产上报IP告警所属部门": "网络管理部",
    "资产上报IP告警负责人": "李四",
    "资产上报IP告警类型": "172.16.0.50",
    "资产上报IP告警规则": "172.16.0.50",
    "资产IP上报告警ID": "I-99317"
  },
  {
    "ID": 3,
    "资产上报IP告警ID": "I-107236",
    "资产上报IP告警编号": "I-107236",
    "资产上报IP告警名称": "资产上报IP告警管理-3",
    "资产上报IP告警状态": "已启用",
    "资产上报IP告警时间": "2026-05-08 09:12:18",
    "资产上报IP告警属性": "192.168.1.200",
    "资产上报IP告警创建时间": "2026-05-08 09:12:18",
    "资产上报IP告警所属部门": "资产管理部",
    "资产上报IP告警负责人": "王五",
    "资产上报IP告警类型": "192.168.1.200",
    "资产上报IP告警规则": "192.168.1.200",
    "资产IP上报告警ID": "I-107236"
  },
  {
    "ID": 4,
    "资产上报IP告警ID": "I-115155",
    "资产上报IP告警编号": "I-115155",
    "资产上报IP告警名称": "资产上报IP告警管理-4",
    "资产上报IP告警状态": "已停用",
    "资产上报IP告警时间": "2026-05-08 09:35:44",
    "资产上报IP告警属性": "10.20.5.30",
    "资产上报IP告警创建时间": "2026-05-08 09:35:44",
    "资产上报IP告警所属部门": "信息安全部",
    "资产上报IP告警负责人": "赵六",
    "资产上报IP告警类型": "10.20.5.30",
    "资产上报IP告警规则": "10.20.5.30",
    "资产IP上报告警ID": "I-115155"
  },
  {
    "ID": 5,
    "资产上报IP告警ID": "I-123074",
    "资产上报IP告警编号": "I-123074",
    "资产上报IP告警名称": "资产上报IP告警管理-5",
    "资产上报IP告警状态": "正常",
    "资产上报IP告警时间": "2026-05-08 10:08:06",
    "资产上报IP告警属性": "172.20.1.80",
    "资产上报IP告警创建时间": "2026-05-08 10:08:06",
    "资产上报IP告警所属部门": "系统运维部",
    "资产上报IP告警负责人": "system",
    "资产上报IP告警类型": "172.20.1.80",
    "资产上报IP告警规则": "172.20.1.80",
    "资产IP上报告警ID": "I-123074"
  },
  {
    "ID": 6,
    "资产上报IP告警ID": "I-130993",
    "资产上报IP告警编号": "I-130993",
    "资产上报IP告警名称": "资产上报IP告警管理-6",
    "资产上报IP告警状态": "异常",
    "资产上报IP告警时间": "2026-05-08 10:42:31",
    "资产上报IP告警属性": "10.0.0.254",
    "资产上报IP告警创建时间": "2026-05-08 10:42:31",
    "资产上报IP告警所属部门": "数据管理部",
    "资产上报IP告警负责人": "admin",
    "资产上报IP告警类型": "10.0.0.254",
    "资产上报IP告警规则": "10.0.0.254",
    "资产IP上报告警ID": "I-130993"
  },
  {
    "ID": 7,
    "资产上报IP告警ID": "I-138912",
    "资产上报IP告警编号": "I-138912",
    "资产上报IP告警名称": "资产上报IP告警管理-7",
    "资产上报IP告警状态": "超时",
    "资产上报IP告警时间": "2026-05-08 11:16:09",
    "资产上报IP告警属性": "10.10.1.100",
    "资产上报IP告警创建时间": "2026-05-08 11:16:09",
    "资产上报IP告警所属部门": "安全运维部",
    "资产上报IP告警负责人": "张三",
    "资产上报IP告警类型": "10.10.1.100",
    "资产上报IP告警规则": "10.10.1.100",
  ...
  },
  {
    ...
    "资产上报IP告警ID": "I-146831",
    "资产上报IP告警编号": "I-146831",
    "资产上报IP告警名称": "资产上报IP告警管理-8",
    "资产上报IP告警状态": "已取消",
    "资产上报IP告警时间": "2026-05-08 14:03:52",
    "资产上报IP告警属性": "172.16.0.50",
    "资产上报IP告警创建时间": "2026-05-08 14:03:52",
    "资产上报IP告警所属部门": "网络管理部",
    "资产上报IP告警负责人": "李四",
    "资产上报IP告警类型": "172.16.0.50",
    "资产上报IP告警规则": "172.16.0.50",
  ...
  },
  {
    ...
    "资产上报IP告警ID": "I-154750",
    "资产上报IP告警编号": "I-154750",
    "资产上报IP告警名称": "资产上报IP告警管理-9",
    "资产上报IP告警状态": "已驳回",
    "资产上报IP告警时间": "2026-05-08 15:21:37",
    "资产上报IP告警属性": "192.168.1.200",
    "资产上报IP告警创建时间": "2026-05-08 15:21:37",
    "资产上报IP告警所属部门": "资产管理部",
    "资产上报IP告警负责人": "王五",
    "资产上报IP告警类型": "192.168.1.200",
    "资产上报IP告警规则": "192.168.1.200",
