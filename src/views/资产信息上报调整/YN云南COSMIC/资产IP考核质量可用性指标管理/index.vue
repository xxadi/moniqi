    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核质量可用性信息表", "operation")'>资产IP考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核质量可用性稽核", "audit")'>资产IP考核质量可用性稽核</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产IP考核质量可用性稽核数据上传", "form")'>资产IP考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产IP考核质量可用性稽核数据接口监控", "log")'>资产IP考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核质量可用性稽核汇总报告详情", "detail")'>查询资产IP考核质量可用性稽核汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核质量可用性稽核明细报告详情", "detail")'>查询资产IP考核质量可用性稽核明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产IP考核质量可用性上传任务", "form")'>新增资产IP考核质量可用性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产IP考核质量可用性上传任务")'>删除资产IP考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产IP考核质量可用性上传任务", "config")'>修改资产IP考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产IP考核质量可用性上传任务", "detail")'>查询资产IP考核质量可用性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产IP考核质量可用性上传任务启用/禁用", "form")'>资产IP考核质量可用性上传任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产IP考核质量可用性ID": "F-93293",
    "资产IP考核质量可用性编号": "F-93293",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-1",
    "资产IP考核质量可用性状态": "已取消",
    "资产IP考核质量可用性时间": "2026-05-08 10:42:31",
    "资产IP考核质量可用性属性": "10.0.0.254",
    "资产IP考核质量可用性创建时间": "2026-05-08 10:42:31",
    "资产IP考核质量可用性所属部门": "数据管理部",
    "资产IP考核质量可用性负责人": "admin",
    "资产IP考核质量可用性类型": "10.0.0.254",
    "资产IP考核质量可用性规则": "10.0.0.254",
    "可用性稽核ID": "F-93293"
  },
  {
    "ID": 2,
    "资产IP考核质量可用性ID": "F-101212",
    "资产IP考核质量可用性编号": "F-101212",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-2",
    "资产IP考核质量可用性状态": "已驳回",
    "资产IP考核质量可用性时间": "2026-05-08 11:16:09",
    "资产IP考核质量可用性属性": "10.10.1.100",
    "资产IP考核质量可用性创建时间": "2026-05-08 11:16:09",
    "资产IP考核质量可用性所属部门": "安全运维部",
    "资产IP考核质量可用性负责人": "张三",
    "资产IP考核质量可用性类型": "10.10.1.100",
    "资产IP考核质量可用性规则": "10.10.1.100",
    "可用性稽核ID": "F-101212"
  },
  {
    "ID": 3,
    "资产IP考核质量可用性ID": "F-109131",
    "资产IP考核质量可用性编号": "F-109131",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-3",
    "资产IP考核质量可用性状态": "待审核",
    "资产IP考核质量可用性时间": "2026-05-08 14:03:52",
    "资产IP考核质量可用性属性": "172.16.0.50",
    "资产IP考核质量可用性创建时间": "2026-05-08 14:03:52",
    "资产IP考核质量可用性所属部门": "网络管理部",
    "资产IP考核质量可用性负责人": "李四",
    "资产IP考核质量可用性类型": "172.16.0.50",
    "资产IP考核质量可用性规则": "172.16.0.50",
    "可用性稽核ID": "F-109131"
  },
  {
    "ID": 4,
    "资产IP考核质量可用性ID": "F-117050",
    "资产IP考核质量可用性编号": "F-117050",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-4",
    "资产IP考核质量可用性状态": "已处理",
    "资产IP考核质量可用性时间": "2026-05-08 15:21:37",
    "资产IP考核质量可用性属性": "192.168.1.200",
    "资产IP考核质量可用性创建时间": "2026-05-08 15:21:37",
    "资产IP考核质量可用性所属部门": "资产管理部",
    "资产IP考核质量可用性负责人": "王五",
    "资产IP考核质量可用性类型": "192.168.1.200",
    "资产IP考核质量可用性规则": "192.168.1.200",
    "可用性稽核ID": "F-117050"
  },
  {
    "ID": 5,
    "资产IP考核质量可用性ID": "F-124969",
    "资产IP考核质量可用性编号": "F-124969",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-5",
    "资产IP考核质量可用性状态": "处理中",
    "资产IP考核质量可用性时间": "2026-05-08 16:08:25",
    "资产IP考核质量可用性属性": "10.20.5.30",
    "资产IP考核质量可用性创建时间": "2026-05-08 16:08:25",
    "资产IP考核质量可用性所属部门": "信息安全部",
    "资产IP考核质量可用性负责人": "赵六",
    "资产IP考核质量可用性类型": "10.20.5.30",
    "资产IP考核质量可用性规则": "10.20.5.30",
    "可用性稽核ID": "F-124969"
  },
  {
    "ID": 6,
    "资产IP考核质量可用性ID": "F-132888",
    "资产IP考核质量可用性编号": "F-132888",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-6",
    "资产IP考核质量可用性状态": "待处理",
    "资产IP考核质量可用性时间": "2026-05-09 08:33:11",
    "资产IP考核质量可用性属性": "172.20.1.80",
    "资产IP考核质量可用性创建时间": "2026-05-09 08:33:11",
    "资产IP考核质量可用性所属部门": "系统运维部",
    "资产IP考核质量可用性负责人": "system",
    "资产IP考核质量可用性类型": "172.20.1.80",
    "资产IP考核质量可用性规则": "172.20.1.80",
    "可用性稽核ID": "F-132888"
  },
  {
    "ID": 7,
    "资产IP考核质量可用性ID": "F-140807",
    "资产IP考核质量可用性编号": "F-140807",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-7",
    "资产IP考核质量可用性状态": "处理失败",
    "资产IP考核质量可用性时间": "2026-05-09 09:47:56",
    "资产IP考核质量可用性属性": "10.0.0.254",
    "资产IP考核质量可用性创建时间": "2026-05-09 09:47:56",
    "资产IP考核质量可用性所属部门": "数据管理部",
    "资产IP考核质量可用性负责人": "admin",
    "资产IP考核质量可用性类型": "10.0.0.254",
    "资产IP考核质量可用性规则": "10.0.0.254",
  ...
  {
    "ID": 8,
    "资产IP考核质量可用性ID": "F-148726",
    "资产IP考核质量可用性编号": "F-148726",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-8",
    "资产IP考核质量可用性状态": "已暂停",
    "资产IP考核质量可用性时间": "2026-05-08 09:12:18",
    "资产IP考核质量可用性属性": "10.10.1.100",
    "资产IP考核质量可用性创建时间": "2026-05-08 09:12:18",
    "资产IP考核质量可用性所属部门": "安全运维部",
    "资产IP考核质量可用性负责人": "张三",
    "资产IP考核质量可用性类型": "10.10.1.100",
    "资产IP考核质量可用性规则": "10.10.1.100",
  ...
  {
    "ID": 9,
    "资产IP考核质量可用性ID": "F-156645",
    "资产IP考核质量可用性编号": "F-156645",
    "资产IP考核质量可用性名称": "资产IP考核质量可用性指标管理-9",
    "资产IP考核质量可用性状态": "已完成",
    "资产IP考核质量可用性时间": "2026-05-08 09:35:44",
    "资产IP考核质量可用性属性": "172.16.0.50",
    "资产IP考核质量可用性创建时间": "2026-05-08 09:35:44",
    "资产IP考核质量可用性所属部门": "网络管理部",
    "资产IP考核质量可用性负责人": "李四",
    "资产IP考核质量可用性类型": "172.16.0.50",
    "资产IP考核质量可用性规则": "172.16.0.50",
...
const tableColumns = [
  ...
  {
    "prop": "资产IP考核质量可用性创建时间",
    "label": "资产IP考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产IP考核质量可用性所属部门",
    "label": "资产IP考核质量可用性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
