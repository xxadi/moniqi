    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动化采集率处置工单信息", "form")'>新增自动化采集率处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化采集率处置工单信息", "config")'>修改自动化采集率处置工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动化采集率处置工单信息")'>删除自动化采集率处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看自动化采集率处置工单信息", "detail")'>查看自动化采集率处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率处置工单附件文件上传", "form")'>自动化采集率处置工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率处置工单附件文件删除", "operation")'>自动化采集率处置工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率处置工单信息审批", "transform")'>自动化采集率处置工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率处置工单信息撤回", "transform")'>自动化采集率处置工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("自动化采集率处置工单信息终止", "transform")'>自动化采集率处置工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("自动化采集率处置工单信息派发提醒", "transform")'>自动化采集率处置工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "处置名称": "自动化采集率处置工单管理-1",
    "自动化采集率处置状态": "待审核",
    "自动化采集率处置时间": "2026-05-08 09:35:44",
    "自动化采集率处置查看时间": "2026-05-08 09:35:44",
    "自动化采集率处置名称": "自动化采集率处置工单管理-1",
    "自动化采集率处置类型": "待审核",
    "自动化采集率处置规则": "待审核",
    "自动化采集率处置属性": "待审核",
    "查看自动化采集率处置状态": "待审核"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-2",
    "自动化采集率处置状态": "已处理",
    "自动化采集率处置时间": "2026-05-08 10:08:06",
    "自动化采集率处置查看时间": "2026-05-08 10:08:06",
    "自动化采集率处置名称": "自动化采集率处置工单管理-2",
    "自动化采集率处置类型": "已处理",
    "自动化采集率处置规则": "已处理",
    "自动化采集率处置属性": "已处理",
    "查看自动化采集率处置状态": "已处理"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-3",
    "自动化采集率处置状态": "处理中",
    "自动化采集率处置时间": "2026-05-08 10:42:31",
    "自动化采集率处置查看时间": "2026-05-08 10:42:31",
    "自动化采集率处置名称": "自动化采集率处置工单管理-3",
    "自动化采集率处置类型": "处理中",
    "自动化采集率处置规则": "处理中",
    "自动化采集率处置属性": "处理中",
    "查看自动化采集率处置状态": "处理中"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-4",
    "自动化采集率处置状态": "待处理",
    "自动化采集率处置时间": "2026-05-08 11:16:09",
    "自动化采集率处置查看时间": "2026-05-08 11:16:09",
    "自动化采集率处置名称": "自动化采集率处置工单管理-4",
    "自动化采集率处置类型": "待处理",
    "自动化采集率处置规则": "待处理",
    "自动化采集率处置属性": "待处理",
    "查看自动化采集率处置状态": "待处理"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-5",
    "自动化采集率处置状态": "处理失败",
    "自动化采集率处置时间": "2026-05-08 14:03:52",
    "自动化采集率处置查看时间": "2026-05-08 14:03:52",
    "自动化采集率处置名称": "自动化采集率处置工单管理-5",
    "自动化采集率处置类型": "处理失败",
    "自动化采集率处置规则": "处理失败",
    "自动化采集率处置属性": "处理失败",
    "查看自动化采集率处置状态": "处理失败"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-6",
    "自动化采集率处置状态": "已暂停",
    "自动化采集率处置时间": "2026-05-08 15:21:37",
    "自动化采集率处置查看时间": "2026-05-08 15:21:37",
    "自动化采集率处置名称": "自动化采集率处置工单管理-6",
    "自动化采集率处置类型": "已暂停",
    "自动化采集率处置规则": "已暂停",
    "自动化采集率处置属性": "已暂停",
    "查看自动化采集率处置状态": "已暂停"
  },
  {
    ...
    "处置名称": "自动化采集率处置工单管理-7",
    "自动化采集率处置状态": "已完成",
    "自动化采集率处置时间": "2026-05-08 16:08:25",
    "自动化采集率处置查看时间": "2026-05-08 16:08:25",
    "自动化采集率处置名称": "自动化采集率处置工单管理-7",
    "自动化采集率处置类型": "已完成",
    "自动化采集率处置规则": "已完成",
    "自动化采集率处置属性": "已完成",
    "查看自动化采集率处置状态": "已完成"
