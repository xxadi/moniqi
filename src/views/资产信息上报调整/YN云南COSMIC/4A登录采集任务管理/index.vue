    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A登录采集任务信息表", "transform")'>4A登录采集任务信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A登录采集任务", "form")'>新增4A登录采集任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A登录采集任务模型", "form")'>新增4A登录采集任务模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A登录采集任务模型", "config")'>修改4A登录采集任务模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A登录采集任务模型")'>删除4A登录采集任务模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A登录采集任务查询", "detail")'>4A登录采集任务查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A登录采集任务可视化展示", "detail")'>4A登录采集任务可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集入库信息表", "transform")'>登录采集入库信息表</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "4A登录采集任务ID": "Z-56913",
    "4A登录采集任务编号": "Z-56913",
    "4A登录采集任务名称": "4A登录采集任务管理-1",
    "4A登录采集任务状态": "处理中",
    "4A登录采集任务时间": "2026-05-08 10:42:31",
    "任务属性": "处理中",
    "4A登录采集任务创建时间": "2026-05-08 10:42:31",
    "4A登录采集任务所属部门": "信息安全部",
    "4A登录采集任务负责人": "赵六",
    "4A登录采集任务类型": "处理中",
    "4A登录采集任务模型": "处理中",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-64832",
    "4A登录采集任务编号": "Z-64832",
    "4A登录采集任务名称": "4A登录采集任务管理-2",
    "4A登录采集任务状态": "待处理",
    "4A登录采集任务时间": "2026-05-08 11:16:09",
    "任务属性": "待处理",
    "4A登录采集任务创建时间": "2026-05-08 11:16:09",
    "4A登录采集任务所属部门": "系统运维部",
    "4A登录采集任务负责人": "system",
    "4A登录采集任务类型": "待处理",
    "4A登录采集任务模型": "待处理",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-72751",
    "4A登录采集任务编号": "Z-72751",
    "4A登录采集任务名称": "4A登录采集任务管理-3",
    "4A登录采集任务状态": "处理失败",
    "4A登录采集任务时间": "2026-05-08 14:03:52",
    "任务属性": "处理失败",
    "4A登录采集任务创建时间": "2026-05-08 14:03:52",
    "4A登录采集任务所属部门": "数据管理部",
    "4A登录采集任务负责人": "admin",
    "4A登录采集任务类型": "处理失败",
    "4A登录采集任务模型": "处理失败",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-80670",
    "4A登录采集任务编号": "Z-80670",
    "4A登录采集任务名称": "4A登录采集任务管理-4",
    "4A登录采集任务状态": "已暂停",
    "4A登录采集任务时间": "2026-05-08 15:21:37",
    "任务属性": "已暂停",
    "4A登录采集任务创建时间": "2026-05-08 15:21:37",
    "4A登录采集任务所属部门": "安全运维部",
    "4A登录采集任务负责人": "张三",
    "4A登录采集任务类型": "已暂停",
    "4A登录采集任务模型": "已暂停",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-88589",
    "4A登录采集任务编号": "Z-88589",
    "4A登录采集任务名称": "4A登录采集任务管理-5",
    "4A登录采集任务状态": "已完成",
    "4A登录采集任务时间": "2026-05-08 16:08:25",
    "任务属性": "已完成",
    "4A登录采集任务创建时间": "2026-05-08 16:08:25",
    "4A登录采集任务所属部门": "网络管理部",
    "4A登录采集任务负责人": "李四",
    "4A登录采集任务类型": "已完成",
    "4A登录采集任务模型": "已完成",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-96508",
    "4A登录采集任务编号": "Z-96508",
    "4A登录采集任务名称": "4A登录采集任务管理-6",
    "4A登录采集任务状态": "排队中",
    "4A登录采集任务时间": "2026-05-09 08:33:11",
    "任务属性": "排队中",
    "4A登录采集任务创建时间": "2026-05-09 08:33:11",
    "4A登录采集任务所属部门": "资产管理部",
    "4A登录采集任务负责人": "王五",
    "4A登录采集任务类型": "排队中",
    "4A登录采集任务模型": "排队中",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-104427",
    "4A登录采集任务编号": "Z-104427",
    "4A登录采集任务名称": "4A登录采集任务管理-7",
    "4A登录采集任务状态": "部分完成",
    "4A登录采集任务时间": "2026-05-09 09:47:56",
    "任务属性": "部分完成",
    "4A登录采集任务创建时间": "2026-05-09 09:47:56",
    "4A登录采集任务所属部门": "信息安全部",
    "4A登录采集任务负责人": "赵六",
    "4A登录采集任务类型": "部分完成",
    "4A登录采集任务模型": "部分完成",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-112346",
    "4A登录采集任务编号": "Z-112346",
    "4A登录采集任务名称": "4A登录采集任务管理-8",
    "4A登录采集任务状态": "已启用",
    "4A登录采集任务时间": "2026-05-08 09:12:18",
    "任务属性": "已启用",
    "4A登录采集任务创建时间": "2026-05-08 09:12:18",
    "4A登录采集任务所属部门": "系统运维部",
    "4A登录采集任务负责人": "system",
    "4A登录采集任务类型": "已启用",
    "4A登录采集任务模型": "已启用",
  ...
  },
  {
    ...
    "4A登录采集任务ID": "Z-120265",
    "4A登录采集任务编号": "Z-120265",
    "4A登录采集任务名称": "4A登录采集任务管理-9",
    "4A登录采集任务状态": "已停用",
    "4A登录采集任务时间": "2026-05-08 09:35:44",
    "任务属性": "已停用",
    "4A登录采集任务创建时间": "2026-05-08 09:35:44",
    "4A登录采集任务所属部门": "数据管理部",
    "4A登录采集任务负责人": "admin",
    "4A登录采集任务类型": "已停用",
    "4A登录采集任务模型": "已停用",
