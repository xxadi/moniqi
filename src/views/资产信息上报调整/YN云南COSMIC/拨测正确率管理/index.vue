    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率信息表", "operation")'>拨测正确率信息表</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("拨测正确率统计", "statistics")'>拨测正确率统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增拨测正确率模型", "form")'>新增拨测正确率模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改拨测正确率模型", "config")'>修改拨测正确率模型</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除拨测正确率模型")'>删除拨测正确率模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率查询", "detail")'>拨测正确率查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("拨测正确率可视化展示", "detail")'>拨测正确率可视化展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "拨测正确率名称": "拨测正确率管理-1",
    "拨测正确率状态": "已驳回",
    "拨测正确率时间": "2026-05-08 15:21:37",
    "拨测正确率属性": "已驳回",
    "拨测正确率创建时间": "2026-05-08 15:21:37",
    "拨测正确率所属部门": "资产管理部",
    "拨测正确率负责人": "王五",
    "拨测正确率类型": "已驳回",
    "拨测正确率模型": "已驳回",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-2",
    "拨测正确率状态": "待审核",
    "拨测正确率时间": "2026-05-08 16:08:25",
    "拨测正确率属性": "待审核",
    "拨测正确率创建时间": "2026-05-08 16:08:25",
    "拨测正确率所属部门": "信息安全部",
    "拨测正确率负责人": "赵六",
    "拨测正确率类型": "待审核",
    "拨测正确率模型": "待审核",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-3",
    "拨测正确率状态": "已处理",
    "拨测正确率时间": "2026-05-09 08:33:11",
    "拨测正确率属性": "已处理",
    "拨测正确率创建时间": "2026-05-09 08:33:11",
    "拨测正确率所属部门": "系统运维部",
    "拨测正确率负责人": "system",
    "拨测正确率类型": "已处理",
    "拨测正确率模型": "已处理",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-4",
    "拨测正确率状态": "处理中",
    "拨测正确率时间": "2026-05-09 09:47:56",
    "拨测正确率属性": "处理中",
    "拨测正确率创建时间": "2026-05-09 09:47:56",
    "拨测正确率所属部门": "数据管理部",
    "拨测正确率负责人": "admin",
    "拨测正确率类型": "处理中",
    "拨测正确率模型": "处理中",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-5",
    "拨测正确率状态": "待处理",
    "拨测正确率时间": "2026-05-08 09:12:18",
    "拨测正确率属性": "待处理",
    "拨测正确率创建时间": "2026-05-08 09:12:18",
    "拨测正确率所属部门": "安全运维部",
    "拨测正确率负责人": "张三",
    "拨测正确率类型": "待处理",
    "拨测正确率模型": "待处理",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-6",
    "拨测正确率状态": "处理失败",
    "拨测正确率时间": "2026-05-08 09:35:44",
    "拨测正确率属性": "处理失败",
    "拨测正确率创建时间": "2026-05-08 09:35:44",
    "拨测正确率所属部门": "网络管理部",
    "拨测正确率负责人": "李四",
    "拨测正确率类型": "处理失败",
    "拨测正确率模型": "处理失败",
  ...
  },
  {
    ...
    "拨测正确率名称": "拨测正确率管理-7",
    "拨测正确率状态": "已暂停",
    "拨测正确率时间": "2026-05-08 10:08:06",
    "拨测正确率属性": "已暂停",
    "拨测正确率创建时间": "2026-05-08 10:08:06",
    "拨测正确率所属部门": "资产管理部",
    "拨测正确率负责人": "王五",
    "拨测正确率类型": "已暂停",
    "拨测正确率模型": "已暂停",
