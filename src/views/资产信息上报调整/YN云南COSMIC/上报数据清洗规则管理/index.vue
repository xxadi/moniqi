    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据清洗规则信息", "form")'>新增上报数据清洗规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义上报数据清洗模型信息", "operation")'>定义上报数据清洗模型信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据清洗模型信息", "config")'>修改上报数据清洗模型信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据清洗模型信息")'>删除上报数据清洗模型信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗模型数据获取", "operation")'>上报数据清洗模型数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗模型数据上传", "form")'>上报数据清洗模型数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据清洗模型数据接口监控", "log")'>上报数据清洗模型数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据清洗模型汇总报告详情", "detail")'>查询上报数据清洗模型汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据清洗模型明细报告详情", "detail")'>查询上报数据清洗模型明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据清洗规则信息", "config")'>修改上报数据清洗规则信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据清洗规则信息")'>删除上报数据清洗规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据清洗规则列表", "detail")'>查询上报数据清洗规则列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据清洗规则详情", "detail")'>查询上报数据清洗规则详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入上报数据清洗规则")'>批量导入上报数据清洗规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据清洗规则监控", "log")'>上报数据清洗规则监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("上报数据清洗规则监控告警", "alert")'>上报数据清洗规则监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据清洗工单信息", "form")'>新增上报数据清洗工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据清洗工单信息", "config")'>修改上报数据清洗工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除上报数据清洗工单信息")'>删除上报数据清洗工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看上报数据清洗工单信息", "detail")'>查看上报数据清洗工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗工单附件文件上传", "form")'>上报数据清洗工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗工单附件文件删除", "operation")'>上报数据清洗工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据清洗工单信息审批", "audit")'>上报数据清洗工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗工单信息撤回", "operation")'>上报数据清洗工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据清洗工单信息终止", "operation")'>上报数据清洗工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("上报数据清洗工单信息派发提醒", "audit")'>上报数据清洗工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "上报数据清洗规则ID": "L-99461",
    "上报数据清洗规则编号": "L-99461",
    "上报数据清洗规则名称": "上报数据清洗规则管理-1",
    "新增上报数据清洗规则状态": "已完成",
    "新增上报数据清洗规则时间": "2026-05-08 09:35:44",
    "洗规则属性": "已完成",
    "上报数据清洗规则创建时间": "2026-05-08 09:35:44",
    "上报数据清洗规则所属部门": "数据管理部",
    "上报数据清洗规则负责人": "admin",
    "上报数据清洗规则类型": "已完成",
    "上报数据清洗规则规则": "已完成",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-107380",
    "上报数据清洗规则编号": "L-107380",
    "上报数据清洗规则名称": "上报数据清洗规则管理-2",
    "新增上报数据清洗规则状态": "排队中",
    "新增上报数据清洗规则时间": "2026-05-08 10:08:06",
    "洗规则属性": "排队中",
    "上报数据清洗规则创建时间": "2026-05-08 10:08:06",
    "上报数据清洗规则所属部门": "安全运维部",
    "上报数据清洗规则负责人": "张三",
    "上报数据清洗规则类型": "排队中",
    "上报数据清洗规则规则": "排队中",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-115299",
    "上报数据清洗规则编号": "L-115299",
    "上报数据清洗规则名称": "上报数据清洗规则管理-3",
    "新增上报数据清洗规则状态": "部分完成",
    "新增上报数据清洗规则时间": "2026-05-08 10:42:31",
    "洗规则属性": "部分完成",
    "上报数据清洗规则创建时间": "2026-05-08 10:42:31",
    "上报数据清洗规则所属部门": "网络管理部",
    "上报数据清洗规则负责人": "李四",
    "上报数据清洗规则类型": "部分完成",
    "上报数据清洗规则规则": "部分完成",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-123218",
    "上报数据清洗规则编号": "L-123218",
    "上报数据清洗规则名称": "上报数据清洗规则管理-4",
    "新增上报数据清洗规则状态": "已启用",
    "新增上报数据清洗规则时间": "2026-05-08 11:16:09",
    "洗规则属性": "已启用",
    "上报数据清洗规则创建时间": "2026-05-08 11:16:09",
    "上报数据清洗规则所属部门": "资产管理部",
    "上报数据清洗规则负责人": "王五",
    "上报数据清洗规则类型": "已启用",
    "上报数据清洗规则规则": "已启用",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-131137",
    "上报数据清洗规则编号": "L-131137",
    "上报数据清洗规则名称": "上报数据清洗规则管理-5",
    "新增上报数据清洗规则状态": "已停用",
    "新增上报数据清洗规则时间": "2026-05-08 14:03:52",
    "洗规则属性": "已停用",
    "上报数据清洗规则创建时间": "2026-05-08 14:03:52",
    "上报数据清洗规则所属部门": "信息安全部",
    "上报数据清洗规则负责人": "赵六",
    "上报数据清洗规则类型": "已停用",
    "上报数据清洗规则规则": "已停用",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-139056",
    "上报数据清洗规则编号": "L-139056",
    "上报数据清洗规则名称": "上报数据清洗规则管理-6",
    "新增上报数据清洗规则状态": "正常",
    "新增上报数据清洗规则时间": "2026-05-08 15:21:37",
    "洗规则属性": "正常",
    "上报数据清洗规则创建时间": "2026-05-08 15:21:37",
    "上报数据清洗规则所属部门": "系统运维部",
    "上报数据清洗规则负责人": "system",
    "上报数据清洗规则类型": "正常",
    "上报数据清洗规则规则": "正常",
  ...
  },
  {
    ...
    "上报数据清洗规则ID": "L-146975",
    "上报数据清洗规则编号": "L-146975",
    "上报数据清洗规则名称": "上报数据清洗规则管理-7",
    "新增上报数据清洗规则状态": "异常",
    "新增上报数据清洗规则时间": "2026-05-08 16:08:25",
    "洗规则属性": "异常",
    "上报数据清洗规则创建时间": "2026-05-08 16:08:25",
    "上报数据清洗规则所属部门": "数据管理部",
    "上报数据清洗规则负责人": "admin",
    "上报数据清洗规则类型": "异常",
    "上报数据清洗规则规则": "异常",
