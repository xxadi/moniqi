    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增自动采集率对比任务信息", "form")'>新增自动采集率对比任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动采集率对比任务信息", "config")'>修改自动采集率对比任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除自动采集率对比任务信息")'>删除自动采集率对比任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动采集率对比任务列表", "detail")'>查询自动采集率对比任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自动采集率对比任务详情", "detail")'>查询自动采集率对比任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入自动采集率对比任务")'>批量导入自动采集率对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("自动采集率对比任务导出")'>自动采集率对比任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "自动采集率对比任务ID": "Y-77712",
    "自动采集率对比任务编号": "Y-77712",
    "自动采集率对比任务名称": "自动采集率对比任务管理-1",
    "新增自动采集率对比任务状态": "已处理",
    "新增自动采集率对比任务时间": "2026-05-08 10:08:06",
    "自动采集率对比任务属性": "已处理",
    "自动采集率对比任务创建时间": "2026-05-08 10:08:06",
    "自动采集率对比任务所属部门": "安全运维部",
    "自动采集率对比任务负责人": "张三",
    "自动采集率对比任务类型": "已处理",
    "自动采集率对比任务规则": "已处理",
  ...
  },
  {
    ...
    "自动采集率对比任务ID": "Y-85631",
    "自动采集率对比任务编号": "Y-85631",
    "自动采集率对比任务名称": "自动采集率对比任务管理-2",
    "新增自动采集率对比任务状态": "处理中",
    "新增自动采集率对比任务时间": "2026-05-08 10:42:31",
    "自动采集率对比任务属性": "处理中",
    "自动采集率对比任务创建时间": "2026-05-08 10:42:31",
    "自动采集率对比任务所属部门": "网络管理部",
    "自动采集率对比任务负责人": "李四",
    "自动采集率对比任务类型": "处理中",
    "自动采集率对比任务规则": "处理中",
  ...
  },
  {
    ...
    "自动采集率对比任务ID": "Y-93550",
    "自动采集率对比任务编号": "Y-93550",
    "自动采集率对比任务名称": "自动采集率对比任务管理-3",
    "新增自动采集率对比任务状态": "待处理",
    "新增自动采集率对比任务时间": "2026-05-08 11:16:09",
    "自动采集率对比任务属性": "待处理",
    "自动采集率对比任务创建时间": "2026-05-08 11:16:09",
    "自动采集率对比任务所属部门": "资产管理部",
    "自动采集率对比任务负责人": "王五",
    "自动采集率对比任务类型": "待处理",
    "自动采集率对比任务规则": "待处理",
  ...
  {
    "ID": 4,
    "自动采集率对比任务ID": "Y-101469",
    "自动采集率对比任务编号": "Y-101469",
    "自动采集率对比任务名称": "自动采集率对比任务管理-4",
    "新增自动采集率对比任务状态": "处理失败",
    "新增自动采集率对比任务时间": "2026-05-08 14:03:52",
    "自动采集率对比任务属性": "处理失败",
    "自动采集率对比任务创建时间": "2026-05-08 14:03:52",
    "自动采集率对比任务所属部门": "信息安全部",
    "自动采集率对比任务负责人": "赵六",
    "自动采集率对比任务类型": "处理失败",
    "自动采集率对比任务规则": "处理失败",
  ...
  {
    "ID": 5,
    "自动采集率对比任务ID": "Y-109388",
    "自动采集率对比任务编号": "Y-109388",
    "自动采集率对比任务名称": "自动采集率对比任务管理-5",
    "新增自动采集率对比任务状态": "已暂停",
    "新增自动采集率对比任务时间": "2026-05-08 15:21:37",
    "自动采集率对比任务属性": "已暂停",
    "自动采集率对比任务创建时间": "2026-05-08 15:21:37",
    "自动采集率对比任务所属部门": "系统运维部",
    "自动采集率对比任务负责人": "system",
    "自动采集率对比任务类型": "已暂停",
    "自动采集率对比任务规则": "已暂停",
  ...
  {
    "ID": 6,
    "自动采集率对比任务ID": "Y-117307",
    "自动采集率对比任务编号": "Y-117307",
    "自动采集率对比任务名称": "自动采集率对比任务管理-6",
    "新增自动采集率对比任务状态": "已完成",
    "新增自动采集率对比任务时间": "2026-05-08 16:08:25",
    "自动采集率对比任务属性": "已完成",
    "自动采集率对比任务创建时间": "2026-05-08 16:08:25",
    "自动采集率对比任务所属部门": "数据管理部",
    "自动采集率对比任务负责人": "admin",
    "自动采集率对比任务类型": "已完成",
    "自动采集率对比任务规则": "已完成",
  ...
  {
    "ID": 7,
    "自动采集率对比任务ID": "Y-125226",
    "自动采集率对比任务编号": "Y-125226",
    "自动采集率对比任务名称": "自动采集率对比任务管理-7",
    "新增自动采集率对比任务状态": "排队中",
    "新增自动采集率对比任务时间": "2026-05-09 08:33:11",
    "自动采集率对比任务属性": "排队中",
    "自动采集率对比任务创建时间": "2026-05-09 08:33:11",
    "自动采集率对比任务所属部门": "安全运维部",
    "自动采集率对比任务负责人": "张三",
    "自动采集率对比任务类型": "排队中",
    "自动采集率对比任务规则": "排队中",
  ...
  {
    "ID": 8,
    "自动采集率对比任务ID": "Y-133145",
    "自动采集率对比任务编号": "Y-133145",
    "自动采集率对比任务名称": "自动采集率对比任务管理-8",
    "新增自动采集率对比任务状态": "部分完成",
    "新增自动采集率对比任务时间": "2026-05-09 09:47:56",
    "自动采集率对比任务属性": "部分完成",
    "自动采集率对比任务创建时间": "2026-05-09 09:47:56",
    "自动采集率对比任务所属部门": "网络管理部",
    "自动采集率对比任务负责人": "李四",
    "自动采集率对比任务类型": "部分完成",
    "自动采集率对比任务规则": "部分完成",
