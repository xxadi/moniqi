    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A同步资产汇总信息表", "sync")'>4A同步资产汇总信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A同步资产汇总任务", "form")'>新增4A同步资产汇总任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A同步资产汇总规则", "form")'>新增4A同步资产汇总规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A同步资产汇总规则", "config")'>修改4A同步资产汇总规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除4A同步资产汇总规则")'>删除4A同步资产汇总规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A同步资产汇总查询", "detail")'>4A同步资产汇总查询</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "4A同步资产汇总ID": "K-76450",
    "4A同步资产汇总编号": "K-76450",
    "4A同步资产汇总名称": "4A同步资产汇总管理-1",
    "4A同步资产汇总状态": "待处理",
    "4A同步资产汇总时间": "2026-05-08 09:12:18",
    "资产汇总属性": "待处理",
    "4A同步资产汇总创建时间": "2026-05-08 09:12:18",
    "4A同步资产汇总所属部门": "系统运维部",
    "4A同步资产汇总负责人": "system",
    "4A同步资产汇总类型": "待处理",
    "4A同步资产汇总规则": "待处理",
  ...
  },
  {
    ...
    "4A同步资产汇总ID": "K-84369",
    "4A同步资产汇总编号": "K-84369",
    "4A同步资产汇总名称": "4A同步资产汇总管理-2",
    "4A同步资产汇总状态": "处理失败",
    "4A同步资产汇总时间": "2026-05-08 09:35:44",
    "资产汇总属性": "处理失败",
    "4A同步资产汇总创建时间": "2026-05-08 09:35:44",
    "4A同步资产汇总所属部门": "数据管理部",
    "4A同步资产汇总负责人": "admin",
    "4A同步资产汇总类型": "处理失败",
    "4A同步资产汇总规则": "处理失败",
  ...
  },
  {
    ...
    "4A同步资产汇总ID": "K-92288",
    "4A同步资产汇总编号": "K-92288",
    "4A同步资产汇总名称": "4A同步资产汇总管理-3",
    "4A同步资产汇总状态": "已暂停",
    "4A同步资产汇总时间": "2026-05-08 10:08:06",
    "资产汇总属性": "已暂停",
    "4A同步资产汇总创建时间": "2026-05-08 10:08:06",
    "4A同步资产汇总所属部门": "安全运维部",
    "4A同步资产汇总负责人": "张三",
    "4A同步资产汇总类型": "已暂停",
    "4A同步资产汇总规则": "已暂停",
  ...
  },
  {
    ...
    "4A同步资产汇总ID": "K-100207",
    "4A同步资产汇总编号": "K-100207",
    "4A同步资产汇总名称": "4A同步资产汇总管理-4",
    "4A同步资产汇总状态": "已完成",
    "4A同步资产汇总时间": "2026-05-08 10:42:31",
    "资产汇总属性": "已完成",
    "4A同步资产汇总创建时间": "2026-05-08 10:42:31",
    "4A同步资产汇总所属部门": "网络管理部",
    "4A同步资产汇总负责人": "李四",
    "4A同步资产汇总类型": "已完成",
    "4A同步资产汇总规则": "已完成",
  ...
  },
  {
    ...
    "4A同步资产汇总ID": "K-108126",
    "4A同步资产汇总编号": "K-108126",
    "4A同步资产汇总名称": "4A同步资产汇总管理-5",
    "4A同步资产汇总状态": "排队中",
    "4A同步资产汇总时间": "2026-05-08 11:16:09",
    "资产汇总属性": "排队中",
    "4A同步资产汇总创建时间": "2026-05-08 11:16:09",
    "4A同步资产汇总所属部门": "资产管理部",
    "4A同步资产汇总负责人": "王五",
    "4A同步资产汇总类型": "排队中",
    "4A同步资产汇总规则": "排队中",
  ...
  },
  {
    ...
    "4A同步资产汇总ID": "K-116045",
    "4A同步资产汇总编号": "K-116045",
    "4A同步资产汇总名称": "4A同步资产汇总管理-6",
    "4A同步资产汇总状态": "部分完成",
    "4A同步资产汇总时间": "2026-05-08 14:03:52",
    "资产汇总属性": "部分完成",
    "4A同步资产汇总创建时间": "2026-05-08 14:03:52",
    "4A同步资产汇总所属部门": "信息安全部",
    "4A同步资产汇总负责人": "赵六",
    "4A同步资产汇总类型": "部分完成",
    "4A同步资产汇总规则": "部分完成",
