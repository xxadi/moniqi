    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("暴露面风险上报数据监控", "log")'>暴露面风险上报数据监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("暴露面风险上报数据监控告警", "alert")'>暴露面风险上报数据监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("暴露面风险上报", "operation")'>暴露面风险上报</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面风险上报数据监控规则", "form")'>新增暴露面风险上报数据监控规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面风险上报数据监控规则", "config")'>修改暴露面风险上报数据监控规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除暴露面风险上报数据监控规则")'>删除暴露面风险上报数据监控规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("暴露面风险上报数据监控规则配置", "log")'>暴露面风险上报数据监控规则配置</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "监控编号": "E-68046",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-1",
    "暴露面风险上报数据监控状态": "已驳回",
    "暴露面风险上报数据监控内容": "已驳回",
    "暴露面风险上报数据监控时间": "2026-05-08 15:21:37",
    "编号": "E-68046",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-68046",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-1",
    "暴露面风险上报数据监控告警时间": "2026-05-08 15:21:37",
    "暴露面风险上报数据监控告警内容": "已驳回",
    "暴露面风险上报数据监控告警状态": "已驳回",
    "监控告警编号": "E-68046"
  },
  {
    "ID": 2,
    "监控编号": "E-75965",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-2",
    "暴露面风险上报数据监控状态": "待审核",
    "暴露面风险上报数据监控内容": "待审核",
    "暴露面风险上报数据监控时间": "2026-05-08 16:08:25",
    "编号": "E-75965",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-75965",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-2",
    "暴露面风险上报数据监控告警时间": "2026-05-08 16:08:25",
    "暴露面风险上报数据监控告警内容": "待审核",
    "暴露面风险上报数据监控告警状态": "待审核",
    "监控告警编号": "E-75965"
  },
  {
    "ID": 3,
    "监控编号": "E-83884",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-3",
    "暴露面风险上报数据监控状态": "已处理",
    "暴露面风险上报数据监控内容": "已处理",
    "暴露面风险上报数据监控时间": "2026-05-09 08:33:11",
    "编号": "E-83884",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-83884",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-3",
    "暴露面风险上报数据监控告警时间": "2026-05-09 08:33:11",
    "暴露面风险上报数据监控告警内容": "已处理",
    "暴露面风险上报数据监控告警状态": "已处理",
    "监控告警编号": "E-83884"
  },
  {
    "ID": 4,
    "监控编号": "E-91803",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-4",
    "暴露面风险上报数据监控状态": "处理中",
    "暴露面风险上报数据监控内容": "处理中",
    "暴露面风险上报数据监控时间": "2026-05-09 09:47:56",
    "编号": "E-91803",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-91803",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-4",
    "暴露面风险上报数据监控告警时间": "2026-05-09 09:47:56",
    "暴露面风险上报数据监控告警内容": "处理中",
    "暴露面风险上报数据监控告警状态": "处理中",
    "监控告警编号": "E-91803"
  },
  {
    "ID": 5,
    "监控编号": "E-99722",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-5",
    "暴露面风险上报数据监控状态": "待处理",
    "暴露面风险上报数据监控内容": "待处理",
    "暴露面风险上报数据监控时间": "2026-05-08 09:12:18",
    "编号": "E-99722",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-99722",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-5",
    "暴露面风险上报数据监控告警时间": "2026-05-08 09:12:18",
    "暴露面风险上报数据监控告警内容": "待处理",
    "暴露面风险上报数据监控告警状态": "待处理",
    "监控告警编号": "E-99722"
  },
  {
    "ID": 6,
    "监控编号": "E-107641",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-6",
    "暴露面风险上报数据监控状态": "处理失败",
    "暴露面风险上报数据监控内容": "处理失败",
    "暴露面风险上报数据监控时间": "2026-05-08 09:35:44",
    "编号": "E-107641",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-107641",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-6",
    "暴露面风险上报数据监控告警时间": "2026-05-08 09:35:44",
    "暴露面风险上报数据监控告警内容": "处理失败",
    "暴露面风险上报数据监控告警状态": "处理失败",
    "监控告警编号": "E-107641"
  },
  {
    "ID": 7,
    "监控编号": "E-115560",
    "暴露面风险上报数据监控名称": "暴露面风险上报数据监控-7",
    "暴露面风险上报数据监控状态": "已暂停",
    "暴露面风险上报数据监控内容": "已暂停",
    "暴露面风险上报数据监控时间": "2026-05-08 10:08:06",
    "编号": "E-115560",
    "暴露面风险上报数据监控编号暴露面风险上报数据监控状态": "E-115560",
    "暴露面风险上报数据监控告警名称": "暴露面风险上报数据监控-7",
    "暴露面风险上报数据监控告警时间": "2026-05-08 10:08:06",
    "暴露面风险上报数据监控告警内容": "已暂停",
    "暴露面风险上报数据监控告警状态": "已暂停",
    "监控告警编号": "E-115560"
  }
...
const tableColumns = [
  ...
  {
    "prop": "暴露面风险上报数据监控编号暴露面风险上报数据监控状态",
    "label": "暴露面风险上报数据监控编号暴露面风险上报数据监控状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "暴露面风险上报数据监控告警名称",
    "label": "暴露面风险上报数据监控告警名称",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  {
    "prop": "暴露面风险上报数据监控告警时间",
    "label": "暴露面风险上报数据监控告警时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "暴露面风险上报数据监控告警内容",
    "label": "暴露面风险上报数据监控告警内容",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "暴露面风险上报数据监控告警状态",
    "label": "暴露面风险上报数据监控告警状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
