    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产总数汇总报表信息", "form")'>新增资产总数汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产总数明细报表信息", "form")'>新增资产总数明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产总数汇总报表详情", "detail")'>查询资产总数汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产总数明细报表详情", "detail")'>查询资产总数明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产总数汇总报表导出")'>资产总数汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产总数明细报表导出")'>资产总数明细报表导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产总数汇总报表属性": "待审核",
    "新增资产总数汇总报表状态": "待审核",
    "新增资产总数汇总报表时间": "2026-05-09 09:47:56",
    "资产总数汇总报表创建时间": "2026-05-09 09:47:56",
    "汇总报表编号": "D-24079",
    "报表ID": "D-24079",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "资产总数汇总报表属性": "已处理",
    "新增资产总数汇总报表状态": "已处理",
    "新增资产总数汇总报表时间": "2026-05-08 09:12:18",
    "资产总数汇总报表创建时间": "2026-05-08 09:12:18",
    "汇总报表编号": "D-31998",
    "报表ID": "D-31998",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "资产总数汇总报表属性": "处理中",
    "新增资产总数汇总报表状态": "处理中",
    "新增资产总数汇总报表时间": "2026-05-08 09:35:44",
    "资产总数汇总报表创建时间": "2026-05-08 09:35:44",
    "汇总报表编号": "D-39917",
    "报表ID": "D-39917",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "资产总数汇总报表属性": "待处理",
    "新增资产总数汇总报表状态": "待处理",
    "新增资产总数汇总报表时间": "2026-05-08 10:08:06",
    "资产总数汇总报表创建时间": "2026-05-08 10:08:06",
    "汇总报表编号": "D-47836",
    "报表ID": "D-47836",
    "汇总报表所属部门": "系统运维部"
  },
  {
    ...
    "资产总数汇总报表属性": "处理失败",
    "新增资产总数汇总报表状态": "处理失败",
    "新增资产总数汇总报表时间": "2026-05-08 10:42:31",
    "资产总数汇总报表创建时间": "2026-05-08 10:42:31",
    "汇总报表编号": "D-55755",
    "报表ID": "D-55755",
    "汇总报表所属部门": "数据管理部"
  },
  {
    ...
    "资产总数汇总报表属性": "已暂停",
    "新增资产总数汇总报表状态": "已暂停",
    "新增资产总数汇总报表时间": "2026-05-08 11:16:09",
    "资产总数汇总报表创建时间": "2026-05-08 11:16:09",
    "汇总报表编号": "D-63674",
    "报表ID": "D-63674",
    "汇总报表所属部门": "安全运维部"
  },
  {
    ...
    "资产总数汇总报表属性": "已完成",
    "新增资产总数汇总报表状态": "已完成",
    "新增资产总数汇总报表时间": "2026-05-08 14:03:52",
    "资产总数汇总报表创建时间": "2026-05-08 14:03:52",
    "汇总报表编号": "D-71593",
    "报表ID": "D-71593",
    "汇总报表所属部门": "网络管理部"
  },
  {
    ...
    "资产总数汇总报表属性": "排队中",
    "新增资产总数汇总报表状态": "排队中",
    "新增资产总数汇总报表时间": "2026-05-08 15:21:37",
    "资产总数汇总报表创建时间": "2026-05-08 15:21:37",
    "汇总报表编号": "D-79512",
    "报表ID": "D-79512",
    "汇总报表所属部门": "资产管理部"
  },
  {
    ...
    "资产总数汇总报表属性": "部分完成",
    "新增资产总数汇总报表状态": "部分完成",
    "新增资产总数汇总报表时间": "2026-05-08 16:08:25",
    "资产总数汇总报表创建时间": "2026-05-08 16:08:25",
    "汇总报表编号": "D-87431",
    "报表ID": "D-87431",
    "汇总报表所属部门": "信息安全部"
  },
  {
    ...
    "资产总数汇总报表属性": "已启用",
    "新增资产总数汇总报表状态": "已启用",
    "新增资产总数汇总报表时间": "2026-05-09 08:33:11",
    "资产总数汇总报表创建时间": "2026-05-09 08:33:11",
    "汇总报表编号": "D-95350",
    "报表ID": "D-95350",
    "汇总报表所属部门": "系统运维部"
  }
