    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部上报IP数据审批流程", "workflow")'>发起工信部上报IP数据审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报IP数据审批指派信息", "form")'>新增工信部上报IP数据审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部上报IP数据审批流程节点", "form")'>新增工信部上报IP数据审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部上报IP数据审批流程节点信息", "config")'>修改工信部上报IP数据审批流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批流程节点删除", "operation")'>工信部上报IP数据审批流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批流程节点查询", "detail")'>工信部上报IP数据审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批附件上传", "form")'>工信部上报IP数据审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批流程图查看", "preview")'>工信部上报IP数据审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批流程通知", "audit")'>工信部上报IP数据审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批结果逐级审批", "audit")'>工信部上报IP数据审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部上报IP数据审批结果拒绝和驳回", "approval")'>工信部上报IP数据审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "数据审批流程环节ID": "H-65267",
    "数据审批编号": "H-65267",
    "审批名称": "工信部上报IP数据审批流程管理-1",
    "发起工信部上报IP数据审批状态": "处理失败",
    "工信部上报IP数据审批流程节点编号": "H-65267",
    "修改人": "处理失败",
    "名称": "工信部上报IP数据审批流程管理-1",
    "工信部上报IP数据审批流程节点规则": "10.0.0.254",
    "工信部上报IP数据审批流程节点属性": "10.0.0.254",
    "修改工信部上报IP数据审批流程节点状态": "处理失败"
  },
  {
    "ID": 2,
    "数据审批ID": "H-73186",
    "数据审批流程环节ID": "H-73186",
    "数据审批编号": "H-73186",
    "审批名称": "工信部上报IP数据审批流程管理-2",
    "发起工信部上报IP数据审批状态": "已暂停",
    "工信部上报IP数据审批流程节点编号": "H-73186",
    "修改人": "已暂停",
    "名称": "工信部上报IP数据审批流程管理-2",
    "工信部上报IP数据审批流程节点规则": "10.10.1.100",
    "工信部上报IP数据审批流程节点属性": "10.10.1.100",
    "修改工信部上报IP数据审批流程节点状态": "已暂停"
  },
  {
    "ID": 3,
    "数据审批ID": "H-81105",
    "数据审批流程环节ID": "H-81105",
    "数据审批编号": "H-81105",
    "审批名称": "工信部上报IP数据审批流程管理-3",
    "发起工信部上报IP数据审批状态": "已完成",
    "工信部上报IP数据审批流程节点编号": "H-81105",
    "修改人": "已完成",
    "名称": "工信部上报IP数据审批流程管理-3",
    "工信部上报IP数据审批流程节点规则": "172.16.0.50",
    "工信部上报IP数据审批流程节点属性": "172.16.0.50",
    "修改工信部上报IP数据审批流程节点状态": "已完成"
  },
  {
    "ID": 4,
    "数据审批ID": "H-89024",
    "数据审批流程环节ID": "H-89024",
    "数据审批编号": "H-89024",
    "审批名称": "工信部上报IP数据审批流程管理-4",
    "发起工信部上报IP数据审批状态": "排队中",
    "工信部上报IP数据审批流程节点编号": "H-89024",
    "修改人": "排队中",
    "名称": "工信部上报IP数据审批流程管理-4",
    "工信部上报IP数据审批流程节点规则": "192.168.1.200",
    "工信部上报IP数据审批流程节点属性": "192.168.1.200",
    "修改工信部上报IP数据审批流程节点状态": "排队中"
  },
  {
    "ID": 5,
    "数据审批ID": "H-96943",
    "数据审批流程环节ID": "H-96943",
    "数据审批编号": "H-96943",
    "审批名称": "工信部上报IP数据审批流程管理-5",
    "发起工信部上报IP数据审批状态": "部分完成",
    "工信部上报IP数据审批流程节点编号": "H-96943",
    "修改人": "部分完成",
    "名称": "工信部上报IP数据审批流程管理-5",
    "工信部上报IP数据审批流程节点规则": "10.20.5.30",
    "工信部上报IP数据审批流程节点属性": "10.20.5.30",
    "修改工信部上报IP数据审批流程节点状态": "部分完成"
  },
  {
    "ID": 6,
    "数据审批ID": "H-104862",
    "数据审批流程环节ID": "H-104862",
    "数据审批编号": "H-104862",
    "审批名称": "工信部上报IP数据审批流程管理-6",
    "发起工信部上报IP数据审批状态": "已启用",
    "工信部上报IP数据审批流程节点编号": "H-104862",
    "修改人": "已启用",
    "名称": "工信部上报IP数据审批流程管理-6",
    "工信部上报IP数据审批流程节点规则": "172.20.1.80",
    "工信部上报IP数据审批流程节点属性": "172.20.1.80",
    "修改工信部上报IP数据审批流程节点状态": "已启用"
  },
  {
    "ID": 7,
    "数据审批ID": "H-112781",
    "数据审批流程环节ID": "H-112781",
    "数据审批编号": "H-112781",
    "审批名称": "工信部上报IP数据审批流程管理-7",
    "发起工信部上报IP数据审批状态": "已停用",
    "工信部上报IP数据审批流程节点编号": "H-112781",
    "修改人": "已停用",
    "名称": "工信部上报IP数据审批流程管理-7",
    "工信部上报IP数据审批流程节点规则": "10.0.0.254",
    "工信部上报IP数据审批流程节点属性": "10.0.0.254",
    "修改工信部上报IP数据审批流程节点状态": "已停用"
  },
  {
    "ID": 8,
    "数据审批ID": "H-120700",
    "数据审批流程环节ID": "H-120700",
    "数据审批编号": "H-120700",
    "审批名称": "工信部上报IP数据审批流程管理-8",
    "发起工信部上报IP数据审批状态": "正常",
    "工信部上报IP数据审批流程节点编号": "H-120700",
    "修改人": "正常",
    "名称": "工信部上报IP数据审批流程管理-8",
    "工信部上报IP数据审批流程节点规则": "10.10.1.100",
    "工信部上报IP数据审批流程节点属性": "10.10.1.100",
    "修改工信部上报IP数据审批流程节点状态": "正常"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "发起工信部上报IP数据审批状态",
    "label": "发起工信部上报IP数据审批状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部上报IP数据审批流程节点编号",
    "label": "工信部上报IP数据审批流程节点编号",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
  ...
  {
    "prop": "工信部上报IP数据审批流程节点规则",
    "label": "工信部上报IP数据审批流程节点规则",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "工信部上报IP数据审批流程节点属性",
    "label": "工信部上报IP数据审批流程节点属性",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
  {
    "prop": "修改工信部上报IP数据审批流程节点状态",
    "label": "修改工信部上报IP数据审批流程节点状态",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
