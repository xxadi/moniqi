    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令威胁情报设置信息", "form")'>新增下发指令威胁情报设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令威胁情报设置信息", "config")'>修改下发指令威胁情报设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令威胁情报设置信息")'>删除下发指令威胁情报设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("下发指令威胁情报错误信息监控", "log")'>下发指令威胁情报错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令威胁情报错误事件通知", "audit")'>下发指令威胁情报错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令威胁情报错误事件通知删除", "operation")'>下发指令威胁情报错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("下发指令威胁情报错误事件通知查询", "detail")'>下发指令威胁情报错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令威胁情报防篡改信息", "form")'>新增下发指令威胁情报防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令威胁情报防篡改信息", "config")'>修改下发指令威胁情报防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令威胁情报防篡改信息")'>删除下发指令威胁情报防篡改信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "威胁情报ID": "A-22152",
    "情报编号": "A-22152",
    "下发指令威胁情报名称": "下发指令威胁情报管理-1",
    "威胁情报状态": "已启用",
    "下发指令威胁情报时间": "2026-05-08 10:08:06",
    "下发指令威胁情报设置时间_": "2026-05-08 10:08:06",
    "下发指令威胁情报ID": "A-22152",
    "下发指令威胁情报编号": "A-22152",
    "下发指令威胁情报类型": "已启用",
    "下发指令威胁情报规则": "已启用",
  ...
  },
  {
    ...
    "威胁情报ID": "A-30071",
    "情报编号": "A-30071",
    "下发指令威胁情报名称": "下发指令威胁情报管理-2",
    "威胁情报状态": "已停用",
    "下发指令威胁情报时间": "2026-05-08 10:42:31",
    "下发指令威胁情报设置时间_": "2026-05-08 10:42:31",
    "下发指令威胁情报ID": "A-30071",
    "下发指令威胁情报编号": "A-30071",
    "下发指令威胁情报类型": "已停用",
    "下发指令威胁情报规则": "已停用",
  ...
  },
  {
    ...
    "威胁情报ID": "A-37990",
    "情报编号": "A-37990",
    "下发指令威胁情报名称": "下发指令威胁情报管理-3",
    "威胁情报状态": "正常",
    "下发指令威胁情报时间": "2026-05-08 11:16:09",
    "下发指令威胁情报设置时间_": "2026-05-08 11:16:09",
    "下发指令威胁情报ID": "A-37990",
    "下发指令威胁情报编号": "A-37990",
    "下发指令威胁情报类型": "正常",
    "下发指令威胁情报规则": "正常",
  ...
  },
  {
    ...
    "威胁情报ID": "A-45909",
    "情报编号": "A-45909",
    "下发指令威胁情报名称": "下发指令威胁情报管理-4",
    "威胁情报状态": "异常",
    "下发指令威胁情报时间": "2026-05-08 14:03:52",
    "下发指令威胁情报设置时间_": "2026-05-08 14:03:52",
    "下发指令威胁情报ID": "A-45909",
    "下发指令威胁情报编号": "A-45909",
    "下发指令威胁情报类型": "异常",
    "下发指令威胁情报规则": "异常",
  ...
  },
  {
    ...
    "威胁情报ID": "A-53828",
    "情报编号": "A-53828",
    "下发指令威胁情报名称": "下发指令威胁情报管理-5",
    "威胁情报状态": "超时",
    "下发指令威胁情报时间": "2026-05-08 15:21:37",
    "下发指令威胁情报设置时间_": "2026-05-08 15:21:37",
    "下发指令威胁情报ID": "A-53828",
    "下发指令威胁情报编号": "A-53828",
    "下发指令威胁情报类型": "超时",
    "下发指令威胁情报规则": "超时",
  ...
  },
  {
    ...
    "威胁情报ID": "A-61747",
    "情报编号": "A-61747",
    "下发指令威胁情报名称": "下发指令威胁情报管理-6",
    "威胁情报状态": "已取消",
    "下发指令威胁情报时间": "2026-05-08 16:08:25",
    "下发指令威胁情报设置时间_": "2026-05-08 16:08:25",
    "下发指令威胁情报ID": "A-61747",
    "下发指令威胁情报编号": "A-61747",
    "下发指令威胁情报类型": "已取消",
    "下发指令威胁情报规则": "已取消",
  ...
  },
  {
    ...
    "威胁情报ID": "A-69666",
    "情报编号": "A-69666",
    "下发指令威胁情报名称": "下发指令威胁情报管理-7",
    "威胁情报状态": "已驳回",
    "下发指令威胁情报时间": "2026-05-09 08:33:11",
    "下发指令威胁情报设置时间_": "2026-05-09 08:33:11",
    "下发指令威胁情报ID": "A-69666",
    "下发指令威胁情报编号": "A-69666",
    "下发指令威胁情报类型": "已驳回",
    "下发指令威胁情报规则": "已驳回",
  ...
  },
  {
    ...
    "威胁情报ID": "A-77585",
    "情报编号": "A-77585",
    "下发指令威胁情报名称": "下发指令威胁情报管理-8",
    "威胁情报状态": "待审核",
    "下发指令威胁情报时间": "2026-05-09 09:47:56",
    "下发指令威胁情报设置时间_": "2026-05-09 09:47:56",
    "下发指令威胁情报ID": "A-77585",
    "下发指令威胁情报编号": "A-77585",
    "下发指令威胁情报类型": "待审核",
    "下发指令威胁情报规则": "待审核",
