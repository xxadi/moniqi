    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析结果审核流程", "form")'>新增流量分析结果审核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改流量分析结果审核流程信息", "config")'>修改流量分析结果审核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析结果审核流程删除", "analysis")'>流量分析结果审核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析结果审核流程查询", "analysis")'>流量分析结果审核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析结果审核附件上传", "analysis")'>流量分析结果审核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析结果审核流程图查看", "analysis")'>流量分析结果审核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量分析结果审核流程通知", "analysis")'>流量分析结果审核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量分析结果审核结果逐级审批", "analysis")'>流量分析结果审核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("流量分析结果审核结果拒绝和驳回", "analysis")'>流量分析结果审核结果拒绝和驳回</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("流量分析对比信息表", "analysis")'>流量分析对比信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增流量分析对比任务", "form")'>新增流量分析对比任务</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "流量分析结果审核名称": "排队中",
    "新增流量分析结果审核状态": "排队中",
    "新增流量分析结果审核时间": "2026-05-08 11:16:09",
    "流量分析结果审核属性": "排队中",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 11:16:09",
    "流量分析结果审核部门": "排队中",
    "流量分析结果审核负责人": "排队中",
    "流量分析结果审核类型": "排队中",
    "流量分析结果审核规则": "排队中"
  },
  {
    ...
    "流量分析结果审核名称": "部分完成",
    "新增流量分析结果审核状态": "部分完成",
    "新增流量分析结果审核时间": "2026-05-08 14:03:52",
    "流量分析结果审核属性": "部分完成",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 14:03:52",
    "流量分析结果审核部门": "部分完成",
    "流量分析结果审核负责人": "部分完成",
    "流量分析结果审核类型": "部分完成",
    "流量分析结果审核规则": "部分完成"
  },
  {
    ...
    "流量分析结果审核名称": "已启用",
    "新增流量分析结果审核状态": "已启用",
    "新增流量分析结果审核时间": "2026-05-08 15:21:37",
    "流量分析结果审核属性": "已启用",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 15:21:37",
    "流量分析结果审核部门": "已启用",
    "流量分析结果审核负责人": "已启用",
    "流量分析结果审核类型": "已启用",
    "流量分析结果审核规则": "已启用"
  },
  {
    ...
    "流量分析结果审核名称": "已停用",
    "新增流量分析结果审核状态": "已停用",
    "新增流量分析结果审核时间": "2026-05-08 16:08:25",
    "流量分析结果审核属性": "已停用",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 16:08:25",
    "流量分析结果审核部门": "已停用",
    "流量分析结果审核负责人": "已停用",
    "流量分析结果审核类型": "已停用",
    "流量分析结果审核规则": "已停用"
  },
  {
    ...
    "流量分析结果审核名称": "正常",
    "新增流量分析结果审核状态": "正常",
    "新增流量分析结果审核时间": "2026-05-09 08:33:11",
    "流量分析结果审核属性": "正常",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-09 08:33:11",
    "流量分析结果审核部门": "正常",
    "流量分析结果审核负责人": "正常",
    "流量分析结果审核类型": "正常",
    "流量分析结果审核规则": "正常"
  },
  {
    ...
    "流量分析结果审核名称": "异常",
    "新增流量分析结果审核状态": "异常",
    "新增流量分析结果审核时间": "2026-05-09 09:47:56",
    "流量分析结果审核属性": "异常",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-09 09:47:56",
    "流量分析结果审核部门": "异常",
    "流量分析结果审核负责人": "异常",
    "流量分析结果审核类型": "异常",
    "流量分析结果审核规则": "异常"
  },
  {
    ...
    "流量分析结果审核名称": "超时",
    "新增流量分析结果审核状态": "超时",
    "新增流量分析结果审核时间": "2026-05-08 09:12:18",
    "流量分析结果审核属性": "超时",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 09:12:18",
    "流量分析结果审核部门": "超时",
    "流量分析结果审核负责人": "超时",
    "流量分析结果审核类型": "超时",
    "流量分析结果审核规则": "超时"
  },
  {
    ...
    "流量分析结果审核名称": "已取消",
    "新增流量分析结果审核状态": "已取消",
    "新增流量分析结果审核时间": "2026-05-08 09:35:44",
    "流量分析结果审核属性": "已取消",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 09:35:44",
    "流量分析结果审核部门": "已取消",
    "流量分析结果审核负责人": "已取消",
    "流量分析结果审核类型": "已取消",
    "流量分析结果审核规则": "已取消"
  },
  {
    ...
    "流量分析结果审核名称": "已驳回",
    "新增流量分析结果审核状态": "已驳回",
    "新增流量分析结果审核时间": "2026-05-08 10:08:06",
    "流量分析结果审核属性": "已驳回",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 10:08:06",
    "流量分析结果审核部门": "已驳回",
    "流量分析结果审核负责人": "已驳回",
    "流量分析结果审核类型": "已驳回",
    "流量分析结果审核规则": "已驳回"
  },
  {
    ...
    "流量分析结果审核名称": "待审核",
    "新增流量分析结果审核状态": "待审核",
    "新增流量分析结果审核时间": "2026-05-08 10:42:31",
    "流量分析结果审核属性": "待审核",
    "流量分析结果审核时间_流量分析结果审核创建时间": "2026-05-08 10:42:31",
    "流量分析结果审核部门": "待审核",
    "流量分析结果审核负责人": "待审核",
    "流量分析结果审核类型": "待审核",
    "流量分析结果审核规则": "待审核"
...
const tableColumns = [
  ...
  {
    "prop": "流量分析结果审核时间_流量分析结果审核创建时间",
    "label": "流量分析结果审核时间。流量分析结果审核创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
