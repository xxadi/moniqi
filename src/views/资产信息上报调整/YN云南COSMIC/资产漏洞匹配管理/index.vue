    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("登录采集资产指纹存储", "transform")'>登录采集资产指纹存储</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("添加资产匹配漏洞信息", "operation")'>添加资产匹配漏洞信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("添加资产匹配漏洞启动用户", "operation")'>添加资产匹配漏洞启动用户</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("添加资产匹配漏洞名", "operation")'>添加资产匹配漏洞名</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("添加资产匹配漏洞启动端口", "operation")'>添加资产匹配漏洞启动端口</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("添加资产匹配漏洞启动", "operation")'>添加资产匹配漏洞启动</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询匹配漏洞信息", "detail")'>查询匹配漏洞信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞匹配设置信息", "form")'>新增资产漏洞匹配设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞匹配设置信息", "config")'>修改资产漏洞匹配设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞匹配设置信息")'>删除资产漏洞匹配设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产漏洞匹配错误信息监控", "log")'>资产漏洞匹配错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞匹配错误事件通知", "audit")'>资产漏洞匹配错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞匹配错误事件通知删除", "operation")'>资产漏洞匹配错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产漏洞匹配错误事件通知查询", "detail")'>资产漏洞匹配错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产漏洞匹配防篡改信息", "form")'>新增资产漏洞匹配防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产漏洞匹配防篡改信息", "config")'>修改资产漏洞匹配防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产漏洞匹配防篡改信息")'>删除资产漏洞匹配防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产匹配漏洞大数据分页展示", "detail")'>资产匹配漏洞大数据分页展示</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改匹配漏洞信息", "config")'>修改匹配漏洞信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产匹配漏洞信息")'>删除资产匹配漏洞信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("创建资产匹配任务", "form")'>创建资产匹配任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("记录匹配结束时间", "operation")'>记录匹配结束时间</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("记录资产IP", "operation")'>记录资产IP</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("记录资产漏洞号", "operation")'>记录资产漏洞号</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("记录资产漏洞", "operation")'>记录资产漏洞</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "编号": "X-9227",
    "登录采集资产分类存储操作人": "admin",
    "登录采集资产分类存储操作时间": "2026-05-08 16:08:25",
    "登录采集资产分类存储操作状态": "异常"
  },
  {
    "ID": 2,
    "登录采集资产分类存储编号": "X-17146",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-2",
    "登录采集资产分类存储类型": "超时",
    "登录采集资产分类存储规则": "超时",
    "登录采集资产分类存储属性": "超时",
    "登录采集资产分类存储状态": "超时",
    ...
    "编号": "X-17146",
    "登录采集资产分类存储操作人": "张三",
    "登录采集资产分类存储操作时间": "2026-05-09 08:33:11",
    "登录采集资产分类存储操作状态": "超时"
  },
  {
    "ID": 3,
    "登录采集资产分类存储编号": "X-25065",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-3",
    "登录采集资产分类存储类型": "已取消",
    "登录采集资产分类存储规则": "已取消",
    "登录采集资产分类存储属性": "已取消",
    "登录采集资产分类存储状态": "已取消",
    ...
    "编号": "X-25065",
    "登录采集资产分类存储操作人": "李四",
    "登录采集资产分类存储操作时间": "2026-05-09 09:47:56",
    "登录采集资产分类存储操作状态": "已取消"
  },
  {
    "ID": 4,
    "登录采集资产分类存储编号": "X-32984",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-4",
    "登录采集资产分类存储类型": "已驳回",
    "登录采集资产分类存储规则": "已驳回",
    "登录采集资产分类存储属性": "已驳回",
    "登录采集资产分类存储状态": "已驳回",
    ...
    "编号": "X-32984",
    "登录采集资产分类存储操作人": "王五",
    "登录采集资产分类存储操作时间": "2026-05-08 09:12:18",
    "登录采集资产分类存储操作状态": "已驳回"
  },
  {
    "ID": 5,
    "登录采集资产分类存储编号": "X-40903",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-5",
    "登录采集资产分类存储类型": "待审核",
    "登录采集资产分类存储规则": "待审核",
    "登录采集资产分类存储属性": "待审核",
    "登录采集资产分类存储状态": "待审核",
    ...
    "编号": "X-40903",
    "登录采集资产分类存储操作人": "赵六",
    "登录采集资产分类存储操作时间": "2026-05-08 09:35:44",
    "登录采集资产分类存储操作状态": "待审核"
  },
  {
    "ID": 6,
    "登录采集资产分类存储编号": "X-48822",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-6",
    "登录采集资产分类存储类型": "已处理",
    "登录采集资产分类存储规则": "已处理",
    "登录采集资产分类存储属性": "已处理",
    "登录采集资产分类存储状态": "已处理",
    ...
    "存储编号": "X-48822",
    "编号": "X-48822",
    "登录采集资产分类存储操作人": "system",
    "登录采集资产分类存储操作时间": "2026-05-08 10:08:06",
    "登录采集资产分类存储操作状态": "已处理"
  },
  {
    "ID": 7,
    "登录采集资产分类存储编号": "X-56741",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-7",
    "登录采集资产分类存储类型": "处理中",
    "登录采集资产分类存储规则": "处理中",
    "登录采集资产分类存储属性": "处理中",
    "登录采集资产分类存储状态": "处理中",
    ...
    "编号": "X-56741",
    "登录采集资产分类存储操作人": "admin",
    "登录采集资产分类存储操作时间": "2026-05-08 10:42:31",
    "登录采集资产分类存储操作状态": "处理中"
  },
  {
    "ID": 8,
    "登录采集资产分类存储编号": "X-64660",
    "登录采集资产分类存储名称": "资产漏洞匹配管理-8",
    "登录采集资产分类存储类型": "待处理",
    "登录采集资产分类存储规则": "待处理",
    "登录采集资产分类存储属性": "待处理",
    "登录采集资产分类存储状态": "待处理",
    ...
    "编号": "X-64660",
    "登录采集资产分类存储操作人": "张三",
    "登录采集资产分类存储操作时间": "2026-05-08 11:16:09",
    "登录采集资产分类存储操作状态": "待处理"
  }
];
const tableColumns = [
