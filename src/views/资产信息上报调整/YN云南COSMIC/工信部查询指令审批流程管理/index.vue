    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起工信部查询指令审批流程", "workflow")'>发起工信部查询指令审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部查询指令审批流程", "form")'>新增工信部查询指令审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部查询指令审批流程信息", "config")'>修改工信部查询指令审批流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批流程删除", "operation")'>工信部查询指令审批流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批流程查询", "detail")'>工信部查询指令审批流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批附件上传", "detail")'>工信部查询指令审批附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批流程图查看", "preview")'>工信部查询指令审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批流程通知", "detail")'>工信部查询指令审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批结果逐级审批", "detail")'>工信部查询指令审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部查询指令审批结果拒绝和驳回", "approval")'>工信部查询指令审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "工信部查询指令审批ID": "R-82125",
    "工信部查询指令审批流程环节ID": "R-82125",
    "工信部查询指令审批编号": "R-82125",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-1",
    "发起工信部查询指令审批状态": "已取消",
    "发起工信部查询指令审批时间": "2026-05-08 14:03:52",
    "工信部查询指令审批属性": "已取消",
    "工信部查询指令审批发起时间": "2026-05-08 14:03:52",
    "工信部查询指令审批流程id": "已取消",
    "工信部查询指令审批流程环节": "已取消",
    "工信部查询指令审批创建时间": "2026-05-08 14:03:52"
  },
  {
    "ID": 2,
    "工信部查询指令审批ID": "R-90044",
    "工信部查询指令审批流程环节ID": "R-90044",
    "工信部查询指令审批编号": "R-90044",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-2",
    "发起工信部查询指令审批状态": "已驳回",
    "发起工信部查询指令审批时间": "2026-05-08 15:21:37",
    "工信部查询指令审批属性": "已驳回",
    "工信部查询指令审批发起时间": "2026-05-08 15:21:37",
    "工信部查询指令审批流程id": "已驳回",
    "工信部查询指令审批流程环节": "已驳回",
    "工信部查询指令审批创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 3,
    "工信部查询指令审批ID": "R-97963",
    "工信部查询指令审批流程环节ID": "R-97963",
    "工信部查询指令审批编号": "R-97963",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-3",
    "发起工信部查询指令审批状态": "待审核",
    "发起工信部查询指令审批时间": "2026-05-08 16:08:25",
    "工信部查询指令审批属性": "待审核",
    "工信部查询指令审批发起时间": "2026-05-08 16:08:25",
    "工信部查询指令审批流程id": "待审核",
    "工信部查询指令审批流程环节": "待审核",
    "工信部查询指令审批创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 4,
    "工信部查询指令审批ID": "R-105882",
    "工信部查询指令审批流程环节ID": "R-105882",
    "工信部查询指令审批编号": "R-105882",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-4",
    "发起工信部查询指令审批状态": "已处理",
    "发起工信部查询指令审批时间": "2026-05-09 08:33:11",
    "工信部查询指令审批属性": "已处理",
    "工信部查询指令审批发起时间": "2026-05-09 08:33:11",
    "工信部查询指令审批流程id": "已处理",
    "工信部查询指令审批流程环节": "已处理",
    "工信部查询指令审批创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 5,
    "工信部查询指令审批ID": "R-113801",
    "工信部查询指令审批流程环节ID": "R-113801",
    "工信部查询指令审批编号": "R-113801",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-5",
    "发起工信部查询指令审批状态": "处理中",
    "发起工信部查询指令审批时间": "2026-05-09 09:47:56",
    "工信部查询指令审批属性": "处理中",
    "工信部查询指令审批发起时间": "2026-05-09 09:47:56",
    "工信部查询指令审批流程id": "处理中",
    "工信部查询指令审批流程环节": "处理中",
    "工信部查询指令审批创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 6,
    "工信部查询指令审批ID": "R-121720",
    "工信部查询指令审批流程环节ID": "R-121720",
    "工信部查询指令审批编号": "R-121720",
    "工信部查询指令审批名称": "工信部查询指令审批流程管理-6",
    "发起工信部查询指令审批状态": "待处理",
    "发起工信部查询指令审批时间": "2026-05-08 09:12:18",
    "工信部查询指令审批属性": "待处理",
    "工信部查询指令审批发起时间": "2026-05-08 09:12:18",
    "工信部查询指令审批流程id": "待处理",
    "工信部查询指令审批流程环节": "待处理",
    "工信部查询指令审批创建时间": "2026-05-08 09:12:18"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "工信部查询指令审批流程环节ID",
    "label": "工信部查询指令审批流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
