    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("设备品牌考核项目完整性信息表", "operation")'>设备品牌考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("设备品牌考核项目完整性稽核数据上传", "form")'>设备品牌考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备品牌考核项目完整性稽核数据接口监控", "log")'>设备品牌考核项目完整性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("品牌区域考核项目完整性信息表", "operation")'>品牌区域考核项目完整性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增品牌区域考核项目完整性上传任务", "form")'>新增品牌区域考核项目完整性上传任务</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除品牌区域考核项目完整性上传任务")'>删除品牌区域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改品牌区域考核项目完整性上传任务", "config")'>修改品牌区域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询品牌区域考核项目完整性上传任务", "detail")'>查询品牌区域考核项目完整性上传任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("品牌区域考核项目完整性上传任务启用/禁用", "form")'>品牌区域考核项目完整性上传任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("品牌区域考核项目完整性稽核数据上传", "form")'>品牌区域考核项目完整性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("品牌区域考核项目完整性稽核数据接口监控", "log")'>品牌区域考核项目完整性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "设备品牌考核项目完整性ID": "Y-46278",
    "设备品牌考核项目完整性编号": "Y-46278",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-1",
    "设备品牌考核项目完整性状态": "排队中",
    "设备品牌考核项目完整性时间": "2026-05-09 08:33:11",
    "设备品牌考核项目完整性属性": "排队中",
    "设备品牌考核项目完整性创建时间": "2026-05-09 08:33:11",
    "设备品牌考核项目完整性所属部门": "安全运维部",
    "设备品牌考核项目完整性负责人": "张三",
    "设备品牌考核项目完整性类型": "排队中",
    "设备品牌考核项目完整性规则": "排队中",
    "数据上传资源编码": "排队中"
  ...
  {
    "ID": 2,
    "设备品牌考核项目完整性ID": "Y-54197",
    "设备品牌考核项目完整性编号": "Y-54197",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-2",
    "设备品牌考核项目完整性状态": "部分完成",
    "设备品牌考核项目完整性时间": "2026-05-09 09:47:56",
    "设备品牌考核项目完整性属性": "部分完成",
    "设备品牌考核项目完整性创建时间": "2026-05-09 09:47:56",
    "设备品牌考核项目完整性所属部门": "网络管理部",
    "设备品牌考核项目完整性负责人": "李四",
    "设备品牌考核项目完整性类型": "部分完成",
    "设备品牌考核项目完整性规则": "部分完成",
    "数据上传资源编码": "部分完成"
  ...
  {
    "ID": 3,
    "设备品牌考核项目完整性ID": "Y-62116",
    "设备品牌考核项目完整性编号": "Y-62116",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-3",
    "设备品牌考核项目完整性状态": "已启用",
    "设备品牌考核项目完整性时间": "2026-05-08 09:12:18",
    "设备品牌考核项目完整性属性": "已启用",
    "设备品牌考核项目完整性创建时间": "2026-05-08 09:12:18",
    "设备品牌考核项目完整性所属部门": "资产管理部",
    "设备品牌考核项目完整性负责人": "王五",
    "设备品牌考核项目完整性类型": "已启用",
    "设备品牌考核项目完整性规则": "已启用",
    "数据上传资源编码": "已启用"
  ...
  {
    "ID": 4,
    "设备品牌考核项目完整性ID": "Y-70035",
    "设备品牌考核项目完整性编号": "Y-70035",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-4",
    "设备品牌考核项目完整性状态": "已停用",
    "设备品牌考核项目完整性时间": "2026-05-08 09:35:44",
    "设备品牌考核项目完整性属性": "已停用",
    "设备品牌考核项目完整性创建时间": "2026-05-08 09:35:44",
    "设备品牌考核项目完整性所属部门": "信息安全部",
    "设备品牌考核项目完整性负责人": "赵六",
    "设备品牌考核项目完整性类型": "已停用",
    "设备品牌考核项目完整性规则": "已停用",
    "数据上传资源编码": "已停用"
  ...
  {
    "ID": 5,
    "设备品牌考核项目完整性ID": "Y-77954",
    "设备品牌考核项目完整性编号": "Y-77954",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-5",
    "设备品牌考核项目完整性状态": "正常",
    "设备品牌考核项目完整性时间": "2026-05-08 10:08:06",
    "设备品牌考核项目完整性属性": "正常",
    "设备品牌考核项目完整性创建时间": "2026-05-08 10:08:06",
    "设备品牌考核项目完整性所属部门": "系统运维部",
    "设备品牌考核项目完整性负责人": "system",
    "设备品牌考核项目完整性类型": "正常",
    "设备品牌考核项目完整性规则": "正常",
    "数据上传资源编码": "正常"
  },
  {
    "ID": 6,
    "设备品牌考核项目完整性ID": "Y-85873",
    "设备品牌考核项目完整性编号": "Y-85873",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-6",
    "设备品牌考核项目完整性状态": "异常",
    "设备品牌考核项目完整性时间": "2026-05-08 10:42:31",
    "设备品牌考核项目完整性属性": "异常",
    "设备品牌考核项目完整性创建时间": "2026-05-08 10:42:31",
    "设备品牌考核项目完整性所属部门": "数据管理部",
    "设备品牌考核项目完整性负责人": "admin",
    "设备品牌考核项目完整性类型": "异常",
    "设备品牌考核项目完整性规则": "异常",
    "数据上传资源编码": "异常"
  },
  {
    "ID": 7,
    "设备品牌考核项目完整性ID": "Y-93792",
    "设备品牌考核项目完整性编号": "Y-93792",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-7",
    "设备品牌考核项目完整性状态": "超时",
    "设备品牌考核项目完整性时间": "2026-05-08 11:16:09",
    "设备品牌考核项目完整性属性": "超时",
    "设备品牌考核项目完整性创建时间": "2026-05-08 11:16:09",
    "设备品牌考核项目完整性所属部门": "安全运维部",
    "设备品牌考核项目完整性负责人": "张三",
    "设备品牌考核项目完整性类型": "超时",
    "设备品牌考核项目完整性规则": "超时",
  ...
  {
    "ID": 8,
    "设备品牌考核项目完整性ID": "Y-101711",
    "设备品牌考核项目完整性编号": "Y-101711",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-8",
    "设备品牌考核项目完整性状态": "已取消",
    "设备品牌考核项目完整性时间": "2026-05-08 14:03:52",
    "设备品牌考核项目完整性属性": "已取消",
    "设备品牌考核项目完整性创建时间": "2026-05-08 14:03:52",
    "设备品牌考核项目完整性所属部门": "网络管理部",
    "设备品牌考核项目完整性负责人": "李四",
    "设备品牌考核项目完整性类型": "已取消",
    "设备品牌考核项目完整性规则": "已取消",
  ...
  {
    "ID": 9,
    "设备品牌考核项目完整性ID": "Y-109630",
    "设备品牌考核项目完整性编号": "Y-109630",
    "设备品牌考核项目完整性名称": "设备品牌考核项目完整性指标管理-9",
    "设备品牌考核项目完整性状态": "已驳回",
    "设备品牌考核项目完整性时间": "2026-05-08 15:21:37",
    "设备品牌考核项目完整性属性": "已驳回",
    "设备品牌考核项目完整性创建时间": "2026-05-08 15:21:37",
    "设备品牌考核项目完整性所属部门": "资产管理部",
    "设备品牌考核项目完整性负责人": "王五",
    "设备品牌考核项目完整性类型": "已驳回",
    "设备品牌考核项目完整性规则": "已驳回",
...
const tableColumns = [
  ...
  {
    "prop": "设备品牌考核项目完整性创建时间",
    "label": "设备品牌考核项目完整性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "设备品牌考核项目完整性所属部门",
    "label": "设备品牌考核项目完整性所属部门",
    "type": "text",
    "search": false,
    "showTooltip": true
  },
