    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增数据质量可用性审核工单信息", "form")'>新增数据质量可用性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改数据质量可用性审核工单信息", "config")'>修改数据质量可用性审核工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除数据质量可用性审核工单信息")'>删除数据质量可用性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看数据质量可用性审核工单信息", "detail")'>查看数据质量可用性审核工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("数据质量可用性审核工单附件文件上传", "form")'>数据质量可用性审核工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("数据质量可用性审核工单附件文件删除", "operation")'>数据质量可用性审核工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("数据质量可用性审核工单信息审批", "audit")'>数据质量可用性审核工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("数据质量可用性审核工单信息撤回", "operation")'>数据质量可用性审核工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("数据质量可用性审核工单信息终止", "operation")'>数据质量可用性审核工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("数据质量可用性审核工单信息派发提醒", "audit")'>数据质量可用性审核工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "审核ID": "N-6357",
    "数据质量可用性审核编号": "N-6357",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-1",
    "新增数据质量可用性审核状态": "已完成",
    "新增数据质量可用性审核时间": "2026-05-08 16:08:25",
    "属性": "已完成",
    "数据质量可用性审核创建时间": "2026-05-08 16:08:25",
    "数据质量可用性审核ID": "N-6357",
    "数据质量可用性审核所属部门": "信息安全部",
    "数据质量可用性审核负责人": "赵六",
    "数据质量可用性审核类型": "已完成",
  ...
  },
  {
    ...
    "审核ID": "N-14276",
    "数据质量可用性审核编号": "N-14276",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-2",
    "新增数据质量可用性审核状态": "排队中",
    "新增数据质量可用性审核时间": "2026-05-09 08:33:11",
    "属性": "排队中",
    "数据质量可用性审核创建时间": "2026-05-09 08:33:11",
    "数据质量可用性审核ID": "N-14276",
    "数据质量可用性审核所属部门": "系统运维部",
    "数据质量可用性审核负责人": "system",
    "数据质量可用性审核类型": "排队中",
  ...
  },
  {
    ...
    "审核ID": "N-22195",
    "数据质量可用性审核编号": "N-22195",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-3",
    "新增数据质量可用性审核状态": "部分完成",
    "新增数据质量可用性审核时间": "2026-05-09 09:47:56",
    "属性": "部分完成",
    "数据质量可用性审核创建时间": "2026-05-09 09:47:56",
    "数据质量可用性审核ID": "N-22195",
    "数据质量可用性审核所属部门": "数据管理部",
    "数据质量可用性审核负责人": "admin",
    "数据质量可用性审核类型": "部分完成",
  ...
  },
  {
    ...
    "审核ID": "N-30114",
    "数据质量可用性审核编号": "N-30114",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-4",
    "新增数据质量可用性审核状态": "已启用",
    "新增数据质量可用性审核时间": "2026-05-08 09:12:18",
    "属性": "已启用",
    "数据质量可用性审核创建时间": "2026-05-08 09:12:18",
    "数据质量可用性审核ID": "N-30114",
    "数据质量可用性审核所属部门": "安全运维部",
    "数据质量可用性审核负责人": "张三",
    "数据质量可用性审核类型": "已启用",
  ...
  },
  {
    ...
    "审核ID": "N-38033",
    "数据质量可用性审核编号": "N-38033",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-5",
    "新增数据质量可用性审核状态": "已停用",
    "新增数据质量可用性审核时间": "2026-05-08 09:35:44",
    "属性": "已停用",
    "数据质量可用性审核创建时间": "2026-05-08 09:35:44",
    "数据质量可用性审核ID": "N-38033",
    "数据质量可用性审核所属部门": "网络管理部",
    "数据质量可用性审核负责人": "李四",
    "数据质量可用性审核类型": "已停用",
  ...
  },
  {
    ...
    "审核ID": "N-45952",
    "数据质量可用性审核编号": "N-45952",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-6",
    "新增数据质量可用性审核状态": "正常",
    "新增数据质量可用性审核时间": "2026-05-08 10:08:06",
    "属性": "正常",
    "数据质量可用性审核创建时间": "2026-05-08 10:08:06",
    "数据质量可用性审核ID": "N-45952",
    "数据质量可用性审核所属部门": "资产管理部",
    "数据质量可用性审核负责人": "王五",
    "数据质量可用性审核类型": "正常",
  ...
  },
  {
    ...
    "审核ID": "N-53871",
    "数据质量可用性审核编号": "N-53871",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-7",
    "新增数据质量可用性审核状态": "异常",
    "新增数据质量可用性审核时间": "2026-05-08 10:42:31",
    "属性": "异常",
    "数据质量可用性审核创建时间": "2026-05-08 10:42:31",
    "数据质量可用性审核ID": "N-53871",
    "数据质量可用性审核所属部门": "信息安全部",
    "数据质量可用性审核负责人": "赵六",
    "数据质量可用性审核类型": "异常",
  ...
  },
  {
    ...
    "审核ID": "N-61790",
    "数据质量可用性审核编号": "N-61790",
    "数据质量可用性审核名称": "数据质量可用性审核工单管理-8",
    "新增数据质量可用性审核状态": "超时",
    "新增数据质量可用性审核时间": "2026-05-08 11:16:09",
    "属性": "超时",
    "数据质量可用性审核创建时间": "2026-05-08 11:16:09",
    "数据质量可用性审核ID": "N-61790",
    "数据质量可用性审核所属部门": "系统运维部",
    "数据质量可用性审核负责人": "system",
    "数据质量可用性审核类型": "超时",
