    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义采集率一致性信息", "transform")'>定义采集率一致性信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集率一致性信息", "config")'>修改采集率一致性信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除采集率一致性信息")'>删除采集率一致性信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("采集率一致性数据获取", "transform")'>采集率一致性数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("采集率一致性数据上传", "form")'>采集率一致性数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("采集率一致性数据接口监控", "log")'>采集率一致性数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询采集率一致性汇总报告详情", "detail")'>查询采集率一致性汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询采集率一致性明细报告详情", "detail")'>查询采集率一致性明细报告详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "采集率一致性名称": "采集率一致性管理-1",
    "新增采集率一致性状态": "已处理",
    "新增采集率一致性时间": "2026-05-08 11:16:09",
    "采集率一致性属性": "已处理",
    "采集率一致性创建时间": "2026-05-08 11:16:09",
    "采集率一致性所属部门": "安全运维部",
    "采集率一致性负责人": "张三",
    "采集率一致性类型": "已处理",
    "采集率一致性规则": "已处理",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-2",
    "新增采集率一致性状态": "处理中",
    "新增采集率一致性时间": "2026-05-08 14:03:52",
    "采集率一致性属性": "处理中",
    "采集率一致性创建时间": "2026-05-08 14:03:52",
    "采集率一致性所属部门": "网络管理部",
    "采集率一致性负责人": "李四",
    "采集率一致性类型": "处理中",
    "采集率一致性规则": "处理中",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-3",
    "新增采集率一致性状态": "待处理",
    "新增采集率一致性时间": "2026-05-08 15:21:37",
    "采集率一致性属性": "待处理",
    "采集率一致性创建时间": "2026-05-08 15:21:37",
    "采集率一致性所属部门": "资产管理部",
    "采集率一致性负责人": "王五",
    "采集率一致性类型": "待处理",
    "采集率一致性规则": "待处理",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-4",
    "新增采集率一致性状态": "处理失败",
    "新增采集率一致性时间": "2026-05-08 16:08:25",
    "采集率一致性属性": "处理失败",
    "采集率一致性创建时间": "2026-05-08 16:08:25",
    "采集率一致性所属部门": "信息安全部",
    "采集率一致性负责人": "赵六",
    "采集率一致性类型": "处理失败",
    "采集率一致性规则": "处理失败",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-5",
    "新增采集率一致性状态": "已暂停",
    "新增采集率一致性时间": "2026-05-09 08:33:11",
    "采集率一致性属性": "已暂停",
    "采集率一致性创建时间": "2026-05-09 08:33:11",
    "采集率一致性所属部门": "系统运维部",
    "采集率一致性负责人": "system",
    "采集率一致性类型": "已暂停",
    "采集率一致性规则": "已暂停",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-6",
    "新增采集率一致性状态": "已完成",
    "新增采集率一致性时间": "2026-05-09 09:47:56",
    "采集率一致性属性": "已完成",
    "采集率一致性创建时间": "2026-05-09 09:47:56",
    "采集率一致性所属部门": "数据管理部",
    "采集率一致性负责人": "admin",
    "采集率一致性类型": "已完成",
    "采集率一致性规则": "已完成",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-7",
    "新增采集率一致性状态": "排队中",
    "新增采集率一致性时间": "2026-05-08 09:12:18",
    "采集率一致性属性": "排队中",
    "采集率一致性创建时间": "2026-05-08 09:12:18",
    "采集率一致性所属部门": "安全运维部",
    "采集率一致性负责人": "张三",
    "采集率一致性类型": "排队中",
    "采集率一致性规则": "排队中",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-8",
    "新增采集率一致性状态": "部分完成",
    "新增采集率一致性时间": "2026-05-08 09:35:44",
    "采集率一致性属性": "部分完成",
    "采集率一致性创建时间": "2026-05-08 09:35:44",
    "采集率一致性所属部门": "网络管理部",
    "采集率一致性负责人": "李四",
    "采集率一致性类型": "部分完成",
    "采集率一致性规则": "部分完成",
  ...
  },
  {
    ...
    "采集率一致性名称": "采集率一致性管理-9",
    "新增采集率一致性状态": "已启用",
    "新增采集率一致性时间": "2026-05-08 10:08:06",
    "采集率一致性属性": "已启用",
    "采集率一致性创建时间": "2026-05-08 10:08:06",
    "采集率一致性所属部门": "资产管理部",
    "采集率一致性负责人": "王五",
    "采集率一致性类型": "已启用",
    "采集率一致性规则": "已启用",
  ...
  },
  {
    ...
    "采集率一致性ID": "E-119895",
    "采集率一致性编号": "E-119895",
    "采集率一致性名称": "采集率一致性管理-10",
    "新增采集率一致性状态": "已停用",
    "新增采集率一致性时间": "2026-05-08 10:42:31",
    "采集率一致性属性": "已停用",
    "采集率一致性创建时间": "2026-05-08 10:42:31",
    "采集率一致性所属部门": "信息安全部",
    "采集率一致性负责人": "赵六",
    "采集率一致性类型": "已停用",
    "采集率一致性规则": "已停用",
