    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部完整化新增能力化工具", "operation")'>工信部完整化新增能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("工信部完整化修改能力化工具", "operation")'>工信部完整化修改能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部完整化删除能力化工具", "operation")'>工信部完整化删除能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部完整化查询能力化工具", "detail")'>工信部完整化查询能力化工具</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核项目完整性数据预处理", "transform")'>上报数据考核项目完整性数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据考核项目完整性数据下发", "operation")'>上报数据考核项目完整性数据下发</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("上报数据考核项目完整性数据分析", "analysis")'>上报数据考核项目完整性数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据考核项目完整性数据上报", "operation")'>上报数据考核项目完整性数据上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "工信部完整化ID": "R-31165",
    "工信部完整化编号": "R-31165",
    "工信部完整化名称": "工信部完整化修改能力工具-1",
    "工信部完整化新增状态": "已取消",
    "工信部完整化新增时间": "2026-05-08 14:03:52",
    "工信部完整化属性": "已取消",
    "工信部完整化创建时间": "2026-05-08 14:03:52",
    "工信部完整化所属部门": "网络管理部",
    "工信部完整化负责人": "李四",
    "工信部完整化类型": "已取消",
    "工信部完整化规则": "已取消",
  ...
  },
  {
    ...
    "工信部完整化ID": "R-39084",
    "工信部完整化编号": "R-39084",
    "工信部完整化名称": "工信部完整化修改能力工具-2",
    "工信部完整化新增状态": "已驳回",
    "工信部完整化新增时间": "2026-05-08 15:21:37",
    "工信部完整化属性": "已驳回",
    "工信部完整化创建时间": "2026-05-08 15:21:37",
    "工信部完整化所属部门": "资产管理部",
    "工信部完整化负责人": "王五",
    "工信部完整化类型": "已驳回",
    "工信部完整化规则": "已驳回",
  ...
  },
  {
    ...
    "工信部完整化ID": "R-47003",
    "工信部完整化编号": "R-47003",
    "工信部完整化名称": "工信部完整化修改能力工具-3",
    "工信部完整化新增状态": "待审核",
    "工信部完整化新增时间": "2026-05-08 16:08:25",
    "工信部完整化属性": "待审核",
    "工信部完整化创建时间": "2026-05-08 16:08:25",
    "工信部完整化所属部门": "信息安全部",
    "工信部完整化负责人": "赵六",
    "工信部完整化类型": "待审核",
    "工信部完整化规则": "待审核",
  ...
  },
  {
    ...
    "工信部完整化ID": "R-54922",
    "工信部完整化编号": "R-54922",
    "工信部完整化名称": "工信部完整化修改能力工具-4",
    "工信部完整化新增状态": "已处理",
    "工信部完整化新增时间": "2026-05-09 08:33:11",
    "工信部完整化属性": "已处理",
    "工信部完整化创建时间": "2026-05-09 08:33:11",
    "工信部完整化所属部门": "系统运维部",
    "工信部完整化负责人": "system",
    "工信部完整化类型": "已处理",
    "工信部完整化规则": "已处理",
  ...
  },
  {
    ...
    "工信部完整化ID": "R-62841",
    "工信部完整化编号": "R-62841",
    "工信部完整化名称": "工信部完整化修改能力工具-5",
    "工信部完整化新增状态": "处理中",
    "工信部完整化新增时间": "2026-05-09 09:47:56",
    "工信部完整化属性": "处理中",
    "工信部完整化创建时间": "2026-05-09 09:47:56",
    "工信部完整化所属部门": "数据管理部",
    "工信部完整化负责人": "admin",
    "工信部完整化类型": "处理中",
    "工信部完整化规则": "处理中",
  ...
  },
  {
    ...
    "工信部完整化ID": "R-70760",
    "工信部完整化编号": "R-70760",
    "工信部完整化名称": "工信部完整化修改能力工具-6",
    "工信部完整化新增状态": "待处理",
    "工信部完整化新增时间": "2026-05-08 09:12:18",
    "工信部完整化属性": "待处理",
    "工信部完整化创建时间": "2026-05-08 09:12:18",
    "工信部完整化所属部门": "安全运维部",
    "工信部完整化负责人": "张三",
    "工信部完整化类型": "待处理",
    "工信部完整化规则": "待处理",
