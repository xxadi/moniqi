    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增下发指令异常告警处置工单信息", "form")'>新增下发指令异常告警处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改下发指令异常告警处置工单信息", "config")'>修改下发指令异常告警处置工单信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除下发指令异常告警处置工单信息")'>删除下发指令异常告警处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看下发指令异常告警处置工单信息", "detail")'>查看下发指令异常告警处置工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单附件文件上传", "alert")'>下发指令异常告警处置工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单附件文件删除", "alert")'>下发指令异常告警处置工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单信息审批", "alert")'>下发指令异常告警处置工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单信息撤回", "alert")'>下发指令异常告警处置工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单信息终止", "alert")'>下发指令异常告警处置工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("下发指令异常告警处置工单信息派发提醒", "alert")'>下发指令异常告警处置工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "告警处置ID": "A-32500",
    "告警处置编号": "A-32500",
    "告警处置名称": "下发指令异常告警处置工单管理-1",
    "新增下发指令异常告警处置状态": "已暂停",
    "新增下发指令异常告警处置时间": "2026-05-08 09:12:18",
    "下发指令异常告警处置属性": "已暂停",
    "下发指令异常告警处置创建时间": "2026-05-08 09:12:18",
    "下发指令异常告警处置编号": "A-32500",
    "下发指令异常告警处置ID": "A-32500",
    "下发指令异常告警处置所属部门": "系统运维部",
    "下发指令异常告警处置负责人": "system",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-1"
  },
  {
    "ID": 2,
    "告警处置ID": "A-40419",
    "告警处置编号": "A-40419",
    "告警处置名称": "下发指令异常告警处置工单管理-2",
    "新增下发指令异常告警处置状态": "已完成",
    "新增下发指令异常告警处置时间": "2026-05-08 09:35:44",
    "下发指令异常告警处置属性": "已完成",
    "下发指令异常告警处置创建时间": "2026-05-08 09:35:44",
    "下发指令异常告警处置编号": "A-40419",
    "下发指令异常告警处置ID": "A-40419",
    "下发指令异常告警处置所属部门": "数据管理部",
    "下发指令异常告警处置负责人": "admin",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-2"
  },
  {
    "ID": 3,
    "告警处置ID": "A-48338",
    "告警处置编号": "A-48338",
    "告警处置名称": "下发指令异常告警处置工单管理-3",
    "新增下发指令异常告警处置状态": "排队中",
    "新增下发指令异常告警处置时间": "2026-05-08 10:08:06",
    "下发指令异常告警处置属性": "排队中",
    "下发指令异常告警处置创建时间": "2026-05-08 10:08:06",
    "下发指令异常告警处置编号": "A-48338",
    "下发指令异常告警处置ID": "A-48338",
    "下发指令异常告警处置所属部门": "安全运维部",
    "下发指令异常告警处置负责人": "张三",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-3"
  },
  {
    "ID": 4,
    "告警处置ID": "A-56257",
    "告警处置编号": "A-56257",
    "告警处置名称": "下发指令异常告警处置工单管理-4",
    "新增下发指令异常告警处置状态": "部分完成",
    "新增下发指令异常告警处置时间": "2026-05-08 10:42:31",
    "下发指令异常告警处置属性": "部分完成",
    "下发指令异常告警处置创建时间": "2026-05-08 10:42:31",
    "下发指令异常告警处置编号": "A-56257",
    "下发指令异常告警处置ID": "A-56257",
    "下发指令异常告警处置所属部门": "网络管理部",
    "下发指令异常告警处置负责人": "李四",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-4"
  },
  {
    "ID": 5,
    "告警处置ID": "A-64176",
    "告警处置编号": "A-64176",
    "告警处置名称": "下发指令异常告警处置工单管理-5",
    "新增下发指令异常告警处置状态": "已启用",
    "新增下发指令异常告警处置时间": "2026-05-08 11:16:09",
    "下发指令异常告警处置属性": "已启用",
    "下发指令异常告警处置创建时间": "2026-05-08 11:16:09",
    "下发指令异常告警处置编号": "A-64176",
    "下发指令异常告警处置ID": "A-64176",
    "下发指令异常告警处置所属部门": "资产管理部",
    "下发指令异常告警处置负责人": "王五",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-5"
  },
  {
    "ID": 6,
    "告警处置ID": "A-72095",
    "告警处置编号": "A-72095",
    "告警处置名称": "下发指令异常告警处置工单管理-6",
    "新增下发指令异常告警处置状态": "已停用",
    "新增下发指令异常告警处置时间": "2026-05-08 14:03:52",
    "下发指令异常告警处置属性": "已停用",
    "下发指令异常告警处置创建时间": "2026-05-08 14:03:52",
    "下发指令异常告警处置编号": "A-72095",
    "下发指令异常告警处置ID": "A-72095",
    "下发指令异常告警处置所属部门": "信息安全部",
    "下发指令异常告警处置负责人": "赵六",
    "下发指令异常告警处置名称": "下发指令异常告警处置工单管理-6"
  }
];
const tableColumns = [
  {
