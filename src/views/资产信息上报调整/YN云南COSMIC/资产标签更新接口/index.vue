    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-promotion" @click='handleFunction("资产标签更新接口", "api")'>资产标签更新接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部资产标签验证信息", "form")'>新增工信部资产标签验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部资产标签验证信息", "config")'>修改工信部资产标签验证信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除工信部资产标签验证信息")'>删除工信部资产标签验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产标签验证数据采集", "transform")'>工信部资产标签验证数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产标签验证数据预处理", "transform")'>工信部资产标签验证数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产标签验证汇总报表详情", "detail")'>查询工信部资产标签验证汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部资产标签验证明细报表详情", "detail")'>查询工信部资产标签验证明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产标签更新信息", "form")'>新增资产标签更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产标签更新信息", "config")'>修改资产标签更新信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产标签更新信息")'>删除资产标签更新信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产标签更新汇总表", "detail")'>查询资产标签更新汇总表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产标签更新详情", "detail")'>查询资产标签更新详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入资产标签更新")'>批量导入资产标签更新</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='exportRows("资产标签更新数据导出")'>资产标签更新数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部AssetNM告警信息", "form")'>新增工信部AssetNM告警信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "资产标签更新名称": "资产标签更新接口-1",
    "资产标签更新状态": "已暂停",
    "资产标签更新时间": "2026-05-08 15:21:37",
    "资产标签更新属性": "已暂停",
    "资产标签更新创建时间": "2026-05-08 15:21:37",
    "资产标签更新所属部门": "资产管理部",
    "资产标签更新负责人": "王五",
    "资产标签更新类型": "已暂停",
    "资产标签更新规则": "已暂停",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-2",
    "资产标签更新状态": "已完成",
    "资产标签更新时间": "2026-05-08 16:08:25",
    "资产标签更新属性": "已完成",
    "资产标签更新创建时间": "2026-05-08 16:08:25",
    "资产标签更新所属部门": "信息安全部",
    "资产标签更新负责人": "赵六",
    "资产标签更新类型": "已完成",
    "资产标签更新规则": "已完成",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-3",
    "资产标签更新状态": "排队中",
    "资产标签更新时间": "2026-05-09 08:33:11",
    "资产标签更新属性": "排队中",
    "资产标签更新创建时间": "2026-05-09 08:33:11",
    "资产标签更新所属部门": "系统运维部",
    "资产标签更新负责人": "system",
    "资产标签更新类型": "排队中",
    "资产标签更新规则": "排队中",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-4",
    "资产标签更新状态": "部分完成",
    "资产标签更新时间": "2026-05-09 09:47:56",
    "资产标签更新属性": "部分完成",
    "资产标签更新创建时间": "2026-05-09 09:47:56",
    "资产标签更新所属部门": "数据管理部",
    "资产标签更新负责人": "admin",
    "资产标签更新类型": "部分完成",
    "资产标签更新规则": "部分完成",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-5",
    "资产标签更新状态": "已启用",
    "资产标签更新时间": "2026-05-08 09:12:18",
    "资产标签更新属性": "已启用",
    "资产标签更新创建时间": "2026-05-08 09:12:18",
    "资产标签更新所属部门": "安全运维部",
    "资产标签更新负责人": "张三",
    "资产标签更新类型": "已启用",
    "资产标签更新规则": "已启用",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-6",
    "资产标签更新状态": "已停用",
    "资产标签更新时间": "2026-05-08 09:35:44",
    "资产标签更新属性": "已停用",
    "资产标签更新创建时间": "2026-05-08 09:35:44",
    "资产标签更新所属部门": "网络管理部",
    "资产标签更新负责人": "李四",
    "资产标签更新类型": "已停用",
    "资产标签更新规则": "已停用",
  ...
  },
  {
    ...
    "资产标签更新名称": "资产标签更新接口-7",
    "资产标签更新状态": "正常",
    "资产标签更新时间": "2026-05-08 10:08:06",
    "资产标签更新属性": "正常",
    "资产标签更新创建时间": "2026-05-08 10:08:06",
    "资产标签更新所属部门": "资产管理部",
    "资产标签更新负责人": "王五",
    "资产标签更新类型": "正常",
    "资产标签更新规则": "正常",
