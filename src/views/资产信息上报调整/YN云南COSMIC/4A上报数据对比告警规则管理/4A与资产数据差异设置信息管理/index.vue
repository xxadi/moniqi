    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A资产数据差异设置信息", "form")'>新增4A资产数据差异设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A资产数据差异设置信息", "form")'>修改4A资产数据差异设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A资产数据差异设置信息", "delete")'>删除4A资产数据差异设置信息</el-button>
        </div>
...
const rows = [
  { ID: 1, 设置编号: "CY-SZ-001", 设置名称: "4A与资产数据差异字段映射", 差异类型: "字段差异", 对比维度: "资产编号", 启用状态: "启用", 更新时间: "2026-06-01 10:00:00" },
  { ID: 2, 设置编号: "CY-SZ-002", 设置名称: "4A与资产数据差异阈值设置", 差异类型: "数量差异", 对比维度: "资产总数", 启用状态: "启用", 更新时间: "2026-06-02 14:30:00" },
  { ID: 3, 设置编号: "CY-SZ-003", 设置名称: "4A与资产数据差异过滤设置", 差异类型: "状态差异", 对比维度: "资产状态", 启用状态: "停用", 更新时间: "2026-06-03 09:15:00" },
  { ID: 4, 设置编号: "CY-SZ-004", 设置名称: "4A与资产数据差异同步设置", 差异类型: "时间差异", 对比维度: "更新时间", 启用状态: "启用", 更新时间: "2026-06-04 16:20:00" },
  { ID: 5, 设置编号: "CY-SZ-005", 设置名称: "4A与资产数据差异告警设置", 差异类型: "综合差异", 对比维度: "综合评分", 启用状态: "启用", 更新时间: "2026-06-05 08:45:00" },
];
const cols = [
  { prop: "设置编号", label: "设置编号", type: "text", search: true },
  { prop: "设置名称", label: "设置名称", type: "text", search: true },
  { prop: "差异类型", label: "差异类型", type: "select", options: [{ value: "字段差异", label: "字段差异" }, { value: "数量差异", label: "数量差异" }, { value: "状态差异", label: "状态差异" }, { value: "时间差异", label: "时间差异" }, { value: "综合差异", label: "综合差异" }], search: true },
  { prop: "对比维度", label: "对比维度", type: "text" },
...
const defaultRow = { 设置编号: "", 设置名称: "", 差异类型: "字段差异", 对比维度: "", 启用状态: "启用", 更新时间: "" };
...
export default {
  name: "4AYN_4AYuZiChanShuJuChaYiSheZhiXinXiGuanLi",
  data() {
    return {
  ...
  methods: {
    ...
    add() { this.formMode = "add"; this.formTitle = "新增差异设置"; this.formData = { ...defaultRow }; this.formVisible = true; },
    edit(row) { this.formMode = "edit"; this.formTitle = "修改差异设置"; this.formData = { ...row }; this.formVisible = true; },
    detail(row) { this.formMode = "detail"; this.formTitle = "差异设置详情"; this.formData = { ...row }; this.formVisible = true; },
    submitForm() {
