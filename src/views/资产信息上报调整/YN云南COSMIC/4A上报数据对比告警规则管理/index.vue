    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增上报数据对比规则")'>新增上报数据对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义上报数据对比规则库信息")'>定义上报数据对比规则库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报数据对比规则库信息")'>修改上报数据对比规则库信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除上报数据对比规则库信息")'>删除上报数据对比规则库信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据对比规则库数据查询")'>上报数据对比规则库数据查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报数据对比规则库数据上传")'>上报数据对比规则库数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据对比规则库数据接口监控")'>上报数据对比规则库数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据对比规则库汇总报告详情")'>查询上报数据对比规则库汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据对比规则库明细报告详情")'>查询上报数据对比规则库明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A上报数据对比监控")'>4A上报数据对比监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("4A上报数据对比监控告警")'>4A上报数据对比监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义4A数据录入规则库信息")'>定义4A数据录入规则库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A数据录入规则库信息")'>修改4A数据录入规则库信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A数据录入规则库信息")'>删除4A数据录入规则库信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A数据录入规则库数据查询")'>4A数据录入规则库数据查询</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A数据录入规则库数据上传")'>4A数据录入规则库数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A数据录入规则库数据接口监控")'>4A数据录入规则库数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A数据录入规则库汇总报告详情")'>查询4A数据录入规则库汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A数据录入规则库明细报告详情")'>查询4A数据录入规则库明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A上报数据对比设置信息")'>新增4A上报数据对比设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A上报数据对比设置信息")'>修改4A上报数据对比设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A上报数据对比设置信息")'>删除4A上报数据对比设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A上报数据对比错误信息监控")'>4A上报数据对比错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A上报数据对比错误事件通知")'>4A上报数据对比错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A上报数据对比错误事件通知删除")'>4A上报数据对比错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A上报数据对比错误事件通知查询")'>4A上报数据对比错误事件通知查询</el-button>
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部与4A数据对比错误信息监控")'>工信部与4A数据对比错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部与4A数据对比错误事件通知")'>工信部与4A数据对比错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部与4A数据对比错误事件通知删除")'>工信部与4A数据对比错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("工信部与4A数据对比错误事件通知查询")'>工信部与4A数据对比错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增工信部与4A数据对比防篡改信息")'>新增工信部与4A数据对比防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部与4A数据对比防篡改信息")'>修改工信部与4A数据对比防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除工信部与4A数据对比防篡改信息")'>删除工信部与4A数据对比防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A上报数据对比稽核")'>4A上报数据对比稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A上报数据对比统计")'>4A上报数据对比统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A上报数据对比数据采集")'>4A上报数据对比数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义工信部与4A关系对比库信息")'>定义工信部与4A关系对比库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部与4A关系对比库信息")'>修改工信部与4A关系对比库信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除工信部与4A关系对比库信息")'>删除工信部与4A关系对比库信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部与4A关系对比库数据获取")'>工信部与4A关系对比库数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部与4A关系对比库数据上传")'>工信部与4A关系对比库数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部与4A关系对比库数据接口监控")'>工信部与4A关系对比库数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部与4A关系对比库汇总报告详情")'>查询工信部与4A关系对比库汇总报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部与4A关系对比库明细报告详情")'>查询工信部与4A关系对比库明细报告详情</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A上报数据对比数据预处理")'>4A上报数据对比数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据对比规则列表")'>查询上报数据对比规则列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报数据对比规则详情")'>查询上报数据对比规则详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("上报数据对比结果监控")'>上报数据对比结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("上报数据对比结果监控告警")'>上报数据对比结果监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A与资产数据差异监控")'>4A与资产数据差异监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("4A与资产数据差异监控告警")'>4A与资产数据差异监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A资产数据差异设置信息")'>新增4A资产数据差异设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A资产数据差异设置信息")'>修改4A资产数据差异设置信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A资产数据差异设置信息")'>删除4A资产数据差异设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A资产数据差异错误信息监控")'>4A资产数据差异错误信息监控</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A资产数据差异错误事件通知")'>4A资产数据差异错误事件通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A资产数据差异错误事件通知删除")'>4A资产数据差异错误事件通知删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A资产数据差异错误事件通知查询")'>4A资产数据差异错误事件通知查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A资产数据差异防篡改信息")'>新增4A资产数据差异防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A资产数据差异防篡改信息")'>修改4A资产数据差异防篡改信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A资产数据差异防篡改信息")'>删除4A资产数据差异防篡改信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A与资产数据差异监控规则")'>新增4A与资产数据差异监控规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A与资产数据差异监控规则")'>修改4A与资产数据差异监控规则</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A与资产数据差异监控规则")'>删除4A与资产数据差异监控规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A与资产数据差异监控规则配置")'>4A与资产数据差异监控规则配置</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A与资产数据差异稽核")'>4A与资产数据差异稽核</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A与资产数据差异统计")'>4A与资产数据差异统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A与资产数据差异数据采集")'>4A与资产数据差异数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("4A与资产数据差异数据预处理")'>4A与资产数据差异数据预处理</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A资产数据差异汇总报表信息")'>新增4A资产数据差异汇总报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A资产数据差异明细报表信息")'>新增4A资产数据差异明细报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A资产数据差异汇总报表详情")'>查询4A资产数据差异汇总报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A资产数据差异明细报表详情")'>查询4A资产数据差异明细报表详情</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A资产数据差异汇总报表导出")'>4A资产数据差异汇总报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A资产数据差异明细报表导出")'>4A资产数据差异明细报表导出</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("4A资产数据差异总表推送")'>4A资产数据差异总表推送</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增4A上报指标信息")'>新增4A上报指标信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改4A上报指标信息")'>修改4A上报指标信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='handleFunction("删除4A上报指标信息")'>删除4A上报指标信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A上报指标列表")'>查询4A上报指标列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询4A上报指标详情")'>查询4A上报指标详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("批量导入4A上报指标")'>批量导入4A上报指标</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("4A上报指标导出")'>4A上报指标导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("4A上报指标监控")'>4A上报指标监控</el-button>
          <el-button plain type="primary" icon="el-icon-warning" @click='handleFunction("4A上报指标监控告警")'>4A上报指标监控告警</el-button>
        </div>
      </div>
      <cs-pagetable
...
export default {
  ...
  methods: {
    ...
    handleFunction(functionName, extraType) {
      // 如果传入了特定类型则使用，否则通过 getActionType 自动推导
      const actionType = extraType || getActionType(functionName);
      ...
      if (actionType === "delete") {
        ...
        this.$confirm("确定要执行【" + functionName + "】删除选中的 " + this.selectedRows.length + " 条记录吗？", "提示", {
      ...
      const dialogType = dialogTypeMap[actionType] || "operation";
