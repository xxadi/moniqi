    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("其他IP考核准确性信息表", "operation")'>其他IP考核准确性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增其他IP数据考核准确性模拟稽核信息", "form")'>新增其他IP数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改其他IP数据考核准确性模拟稽核信息", "config")'>修改其他IP数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除其他IP数据考核准确性模拟稽核信息")'>删除其他IP数据考核准确性模拟稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("其他IP考核准确性稽核数据上传", "form")'>其他IP考核准确性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("其他IP考核准确性稽核数据接口监控", "log")'>其他IP考核准确性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "其他IP考核准确性ID": "O-15432",
    "其他IP考核准确性编号": "O-15432",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-1",
    "其他IP考核准确性状态": "已启用",
    "其他IP考核准确性时间": "2026-05-08 10:08:06",
    "其他IP考核准确性属性": "10.10.1.100",
    "其他IP考核准确性创建时间": "2026-05-08 10:08:06",
    "其他IP考核准确性所属部门": "安全运维部",
    "其他IP考核准确性负责人": "张三",
    "其他IP考核准确性类型": "10.10.1.100",
    "其他IP考核准确性规则": "10.10.1.100",
    "其他IP数据考核准确性模拟稽核ID": "O-15432"
  },
  {
    "ID": 2,
    "其他IP考核准确性ID": "O-23351",
    "其他IP考核准确性编号": "O-23351",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-2",
    "其他IP考核准确性状态": "已停用",
    "其他IP考核准确性时间": "2026-05-08 10:42:31",
    "其他IP考核准确性属性": "172.16.0.50",
    "其他IP考核准确性创建时间": "2026-05-08 10:42:31",
    "其他IP考核准确性所属部门": "网络管理部",
    "其他IP考核准确性负责人": "李四",
    "其他IP考核准确性类型": "172.16.0.50",
    "其他IP考核准确性规则": "172.16.0.50",
    "其他IP数据考核准确性模拟稽核ID": "O-23351"
  },
  {
    "ID": 3,
    "其他IP考核准确性ID": "O-31270",
    "其他IP考核准确性编号": "O-31270",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-3",
    "其他IP考核准确性状态": "正常",
    "其他IP考核准确性时间": "2026-05-08 11:16:09",
    "其他IP考核准确性属性": "192.168.1.200",
    "其他IP考核准确性创建时间": "2026-05-08 11:16:09",
    "其他IP考核准确性所属部门": "资产管理部",
    "其他IP考核准确性负责人": "王五",
    "其他IP考核准确性类型": "192.168.1.200",
    "其他IP考核准确性规则": "192.168.1.200",
    "其他IP数据考核准确性模拟稽核ID": "O-31270"
  },
  {
    "ID": 4,
    "其他IP考核准确性ID": "O-39189",
    "其他IP考核准确性编号": "O-39189",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-4",
    "其他IP考核准确性状态": "异常",
    "其他IP考核准确性时间": "2026-05-08 14:03:52",
    "其他IP考核准确性属性": "10.20.5.30",
    "其他IP考核准确性创建时间": "2026-05-08 14:03:52",
    "其他IP考核准确性所属部门": "信息安全部",
    "其他IP考核准确性负责人": "赵六",
    "其他IP考核准确性类型": "10.20.5.30",
    "其他IP考核准确性规则": "10.20.5.30",
    "其他IP数据考核准确性模拟稽核ID": "O-39189"
  },
  {
    "ID": 5,
    "其他IP考核准确性ID": "O-47108",
    "其他IP考核准确性编号": "O-47108",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-5",
    "其他IP考核准确性状态": "超时",
    "其他IP考核准确性时间": "2026-05-08 15:21:37",
    "其他IP考核准确性属性": "172.20.1.80",
    "其他IP考核准确性创建时间": "2026-05-08 15:21:37",
    "其他IP考核准确性所属部门": "系统运维部",
    "其他IP考核准确性负责人": "system",
    "其他IP考核准确性类型": "172.20.1.80",
    "其他IP考核准确性规则": "172.20.1.80",
    "其他IP数据考核准确性模拟稽核ID": "O-47108"
  },
  {
    "ID": 6,
    "其他IP考核准确性ID": "O-55027",
    "其他IP考核准确性编号": "O-55027",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-6",
    "其他IP考核准确性状态": "已取消",
    "其他IP考核准确性时间": "2026-05-08 16:08:25",
    "其他IP考核准确性属性": "10.0.0.254",
    "其他IP考核准确性创建时间": "2026-05-08 16:08:25",
    "其他IP考核准确性所属部门": "数据管理部",
    "其他IP考核准确性负责人": "admin",
    "其他IP考核准确性类型": "10.0.0.254",
    "其他IP考核准确性规则": "10.0.0.254",
    "其他IP数据考核准确性模拟稽核ID": "O-55027"
  },
  {
    "ID": 7,
    "其他IP考核准确性ID": "O-62946",
    "其他IP考核准确性编号": "O-62946",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-7",
    "其他IP考核准确性状态": "已驳回",
    "其他IP考核准确性时间": "2026-05-09 08:33:11",
    "其他IP考核准确性属性": "10.10.1.100",
    "其他IP考核准确性创建时间": "2026-05-09 08:33:11",
    "其他IP考核准确性所属部门": "安全运维部",
    "其他IP考核准确性负责人": "张三",
    "其他IP考核准确性类型": "10.10.1.100",
    "其他IP考核准确性规则": "10.10.1.100",
    "其他IP数据考核准确性模拟稽核ID": "O-62946"
  },
  {
    "ID": 8,
    "其他IP考核准确性ID": "O-70865",
    "其他IP考核准确性编号": "O-70865",
    "其他IP考核准确性名称": "其他IP考核准确性指标管理-8",
    "其他IP考核准确性状态": "待审核",
    "其他IP考核准确性时间": "2026-05-09 09:47:56",
    "其他IP考核准确性属性": "172.16.0.50",
    "其他IP考核准确性创建时间": "2026-05-09 09:47:56",
    "其他IP考核准确性所属部门": "网络管理部",
    "其他IP考核准确性负责人": "李四",
    "其他IP考核准确性类型": "172.16.0.50",
    "其他IP考核准确性规则": "172.16.0.50",
    "其他IP数据考核准确性模拟稽核ID": "O-70865"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "其他IP数据考核准确性模拟稽核ID",
    "label": "其他IP数据考核准确性模拟稽核ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
