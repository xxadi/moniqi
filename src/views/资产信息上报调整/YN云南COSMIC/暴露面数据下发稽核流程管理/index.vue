    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-claim" @click='handleFunction("发起暴露面数据下发稽核流程", "workflow")'>发起暴露面数据下发稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面数据下发稽核指派信息", "form")'>新增暴露面数据下发稽核指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增暴露面数据下发稽核流程", "form")'>新增暴露面数据下发稽核流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面数据下发稽核流程信息", "config")'>修改暴露面数据下发稽核流程信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核流程删除", "operation")'>暴露面数据下发稽核流程删除</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核流程查询", "detail")'>暴露面数据下发稽核流程查询</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核附件上传", "form")'>暴露面数据下发稽核附件上传</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核流程图查看", "preview")'>暴露面数据下发稽核流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核流程通知", "audit")'>暴露面数据下发稽核流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核结果逐级审批", "audit")'>暴露面数据下发稽核结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("暴露面数据下发稽核结果拒绝和驳回", "approval")'>暴露面数据下发稽核结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "暴露面数据下发稽核ID": "K-23826",
    "暴露面数据下发稽核流程环节ID": "K-23826",
    "暴露面数据下发稽核编号": "K-23826",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-1",
    "发起暴露面数据下发稽核状态": "待处理",
    "发起暴露面数据下发稽核时间": "2026-05-08 15:21:37",
    "暴露面数据下发稽核属性": "待处理",
    "暴露面数据下发稽核发起时间": "2026-05-08 15:21:37",
    "暴露面数据下发稽核流程id": "待处理",
    "暴露面数据下发稽核流程环节": "待处理",
    "暴露面数据下发稽核创建时间": "2026-05-08 15:21:37"
  },
  {
    "ID": 2,
    "暴露面数据下发稽核ID": "K-31745",
    "暴露面数据下发稽核流程环节ID": "K-31745",
    "暴露面数据下发稽核编号": "K-31745",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-2",
    "发起暴露面数据下发稽核状态": "处理失败",
    "发起暴露面数据下发稽核时间": "2026-05-08 16:08:25",
    "暴露面数据下发稽核属性": "处理失败",
    "暴露面数据下发稽核发起时间": "2026-05-08 16:08:25",
    "暴露面数据下发稽核流程id": "处理失败",
    "暴露面数据下发稽核流程环节": "处理失败",
    "暴露面数据下发稽核创建时间": "2026-05-08 16:08:25"
  },
  {
    "ID": 3,
    "暴露面数据下发稽核ID": "K-39664",
    "暴露面数据下发稽核流程环节ID": "K-39664",
    "暴露面数据下发稽核编号": "K-39664",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-3",
    "发起暴露面数据下发稽核状态": "已暂停",
    "发起暴露面数据下发稽核时间": "2026-05-09 08:33:11",
    "暴露面数据下发稽核属性": "已暂停",
    "暴露面数据下发稽核发起时间": "2026-05-09 08:33:11",
    "暴露面数据下发稽核流程id": "已暂停",
    "暴露面数据下发稽核流程环节": "已暂停",
    "暴露面数据下发稽核创建时间": "2026-05-09 08:33:11"
  },
  {
    "ID": 4,
    "暴露面数据下发稽核ID": "K-47583",
    "暴露面数据下发稽核流程环节ID": "K-47583",
    "暴露面数据下发稽核编号": "K-47583",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-4",
    "发起暴露面数据下发稽核状态": "已完成",
    "发起暴露面数据下发稽核时间": "2026-05-09 09:47:56",
    "暴露面数据下发稽核属性": "已完成",
    "暴露面数据下发稽核发起时间": "2026-05-09 09:47:56",
    "暴露面数据下发稽核流程id": "已完成",
    "暴露面数据下发稽核流程环节": "已完成",
    "暴露面数据下发稽核创建时间": "2026-05-09 09:47:56"
  },
  {
    "ID": 5,
    "暴露面数据下发稽核ID": "K-55502",
    "暴露面数据下发稽核流程环节ID": "K-55502",
    "暴露面数据下发稽核编号": "K-55502",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-5",
    "发起暴露面数据下发稽核状态": "排队中",
    "发起暴露面数据下发稽核时间": "2026-05-08 09:12:18",
    "暴露面数据下发稽核属性": "排队中",
    "暴露面数据下发稽核发起时间": "2026-05-08 09:12:18",
    "暴露面数据下发稽核流程id": "排队中",
    "暴露面数据下发稽核流程环节": "排队中",
    "暴露面数据下发稽核创建时间": "2026-05-08 09:12:18"
  },
  {
    "ID": 6,
    "暴露面数据下发稽核ID": "K-63421",
    "暴露面数据下发稽核流程环节ID": "K-63421",
    "暴露面数据下发稽核编号": "K-63421",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-6",
    "发起暴露面数据下发稽核状态": "部分完成",
    "发起暴露面数据下发稽核时间": "2026-05-08 09:35:44",
    "暴露面数据下发稽核属性": "部分完成",
    "暴露面数据下发稽核发起时间": "2026-05-08 09:35:44",
    "暴露面数据下发稽核流程id": "部分完成",
    "暴露面数据下发稽核流程环节": "部分完成",
    "暴露面数据下发稽核创建时间": "2026-05-08 09:35:44"
  },
  {
    "ID": 7,
    "暴露面数据下发稽核ID": "K-71340",
    "暴露面数据下发稽核流程环节ID": "K-71340",
    "暴露面数据下发稽核编号": "K-71340",
    "暴露面数据下发稽核名称": "暴露面数据下发稽核流程管理-7",
    "发起暴露面数据下发稽核状态": "已启用",
    "发起暴露面数据下发稽核时间": "2026-05-08 10:08:06",
    "暴露面数据下发稽核属性": "已启用",
    "暴露面数据下发稽核发起时间": "2026-05-08 10:08:06",
    "暴露面数据下发稽核流程id": "已启用",
    "暴露面数据下发稽核流程环节": "已启用",
    "暴露面数据下发稽核创建时间": "2026-05-08 10:08:06"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "暴露面数据下发稽核流程环节ID",
    "label": "暴露面数据下发稽核流程环节ID",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
