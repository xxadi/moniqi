    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产名称考核质量可用性信息表", "operation")'>资产名称考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增资产名称数据考核质量可用性字典信息", "form")'>新增资产名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产名称数据考核质量可用性字典信息", "config")'>修改资产名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除资产名称数据考核质量可用性字典信息")'>删除资产名称数据考核质量可用性字典信息</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产名称数据考核质量可用性稽核数据上传", "form")'>资产名称数据考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称数据考核质量可用性稽核数据接口监控", "log")'>资产名称数据考核质量可用性稽核数据接口监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产等级考核质量可用性信息表", "operation")'>资产等级考核质量可用性信息表</el-button>
          <el-button plain type="primary" icon="el-icon-bell" @click='handleFunction("资产等级考核质量可用性稽核数据上传", "form")'>资产等级考核质量可用性稽核数据上传</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产等级考核质量可用性稽核数据接口监控", "log")'>资产等级考核质量可用性稽核数据接口监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产名称考核质量可用性ID": "D-86193",
    "资产名称考核质量可用性编号": "D-86193",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-1",
    "资产名称考核质量可用性状态": "处理中",
    "资产名称考核质量可用性时间": "2026-05-08 10:42:31",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-1",
    "资产名称考核质量可用性创建时间": "2026-05-08 10:42:31",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-1",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-1",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-1",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-1",
    "考核质量可用性字典ID": "D-86193"
  },
  {
    "ID": 2,
    "资产名称考核质量可用性ID": "D-94112",
    "资产名称考核质量可用性编号": "D-94112",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-2",
    "资产名称考核质量可用性状态": "待处理",
    "资产名称考核质量可用性时间": "2026-05-08 11:16:09",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-2",
    "资产名称考核质量可用性创建时间": "2026-05-08 11:16:09",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-2",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-2",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-2",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-2",
    "考核质量可用性字典ID": "D-94112"
  },
  {
    "ID": 3,
    "资产名称考核质量可用性ID": "D-102031",
    "资产名称考核质量可用性编号": "D-102031",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-3",
    "资产名称考核质量可用性状态": "处理失败",
    "资产名称考核质量可用性时间": "2026-05-08 14:03:52",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-3",
    "资产名称考核质量可用性创建时间": "2026-05-08 14:03:52",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-3",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-3",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-3",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-3",
    "考核质量可用性字典ID": "D-102031"
  },
  {
    "ID": 4,
    "资产名称考核质量可用性ID": "D-109950",
    "资产名称考核质量可用性编号": "D-109950",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-4",
    "资产名称考核质量可用性状态": "已暂停",
    "资产名称考核质量可用性时间": "2026-05-08 15:21:37",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-4",
    "资产名称考核质量可用性创建时间": "2026-05-08 15:21:37",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-4",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-4",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-4",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-4",
    "考核质量可用性字典ID": "D-109950"
  },
  {
    "ID": 5,
    "资产名称考核质量可用性ID": "D-117869",
    "资产名称考核质量可用性编号": "D-117869",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-5",
    "资产名称考核质量可用性状态": "已完成",
    "资产名称考核质量可用性时间": "2026-05-08 16:08:25",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-5",
    "资产名称考核质量可用性创建时间": "2026-05-08 16:08:25",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-5",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-5",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-5",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-5",
    "考核质量可用性字典ID": "D-117869"
  },
  {
    "ID": 6,
    "资产名称考核质量可用性ID": "D-125788",
    "资产名称考核质量可用性编号": "D-125788",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-6",
    "资产名称考核质量可用性状态": "排队中",
    "资产名称考核质量可用性时间": "2026-05-09 08:33:11",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-6",
    "资产名称考核质量可用性创建时间": "2026-05-09 08:33:11",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-6",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-6",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-6",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-6",
    "考核质量可用性字典ID": "D-125788"
  },
  {
    "ID": 7,
    "资产名称考核质量可用性ID": "D-133707",
    "资产名称考核质量可用性编号": "D-133707",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-7",
    "资产名称考核质量可用性状态": "部分完成",
    "资产名称考核质量可用性时间": "2026-05-09 09:47:56",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-7",
    "资产名称考核质量可用性创建时间": "2026-05-09 09:47:56",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-7",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-7",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-7",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-7",
    "考核质量可用性字典ID": "D-133707"
  },
  {
    "ID": 8,
    "资产名称考核质量可用性ID": "D-141626",
    "资产名称考核质量可用性编号": "D-141626",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-8",
    "资产名称考核质量可用性状态": "已启用",
    "资产名称考核质量可用性时间": "2026-05-08 09:12:18",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-8",
    "资产名称考核质量可用性创建时间": "2026-05-08 09:12:18",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-8",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-8",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-8",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-8",
    "考核质量可用性字典ID": "D-141626"
  },
  {
    "ID": 9,
    "资产名称考核质量可用性ID": "D-149545",
    "资产名称考核质量可用性编号": "D-149545",
    "资产名称考核质量可用性名称": "资产名称考核质量可用性指标管理-9",
    "资产名称考核质量可用性状态": "已停用",
    "资产名称考核质量可用性时间": "2026-05-08 09:35:44",
    "资产名称考核质量可用性属性": "资产名称考核质量可用性指标管理-9",
    "资产名称考核质量可用性创建时间": "2026-05-08 09:35:44",
    "资产名称考核质量可用性所属部门": "资产名称考核质量可用性指标管理-9",
    "资产名称考核质量可用性负责人": "资产名称考核质量可用性指标管理-9",
    "资产名称考核质量可用性类型": "资产名称考核质量可用性指标管理-9",
    "资产名称考核质量可用性规则": "资产名称考核质量可用性指标管理-9",
    "考核质量可用性字典ID": "D-149545"
  }
];
const tableColumns = [
  {
  ...
  {
    "prop": "资产名称考核质量可用性创建时间",
    "label": "资产名称考核质量可用性创建时间",
    "type": "text",
    "search": false,
    "showTooltip": true,
    "width": 170
  ...
  {
    "prop": "资产名称考核质量可用性所属部门",
    "label": "资产名称考核质量可用性所属部门",
    "type": "text",
    "search": true,
    "showTooltip": true
  },
