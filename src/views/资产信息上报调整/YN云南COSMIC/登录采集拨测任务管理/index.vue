    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='handleFunction("新增登录采集拨测任务信息", "form")'>新增登录采集拨测任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改登录采集拨测任务信息", "config")'>修改登录采集拨测任务信息</el-button>
          <el-button plain type="danger" icon="el-icon-delete" @click='deleteByName("删除登录采集拨测任务信息")'>删除登录采集拨测任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询登录采集拨测任务列表", "detail")'>查询登录采集拨测任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询登录采集拨测任务详情", "detail")'>查询登录采集拨测任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-edit-outline" @click='openImport("批量导入登录采集拨测任务")'>批量导入登录采集拨测任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='exportRows("登录采集拨测任务导出")'>登录采集拨测任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    ...
    "登录采集拨测任务ID": "V-27815",
    "登录采集拨测任务编号": "V-27815",
    "登录采集拨测任务名称": "登录采集拨测任务管理-1",
    "新增登录采集拨测任务状态": "部分完成",
    "新增登录采集拨测任务时间": "2026-05-08 14:03:52",
    "登录采集拨测任务属性": "部分完成",
    "登录采集拨测任务创建时间": "2026-05-08 14:03:52",
    "登录采集拨测任务所属部门": "数据管理部",
    "登录采集拨测任务负责人": "admin",
    "登录采集拨测任务类型": "部分完成",
    "登录采集拨测任务规则": "部分完成",
  ...
  },
  {
    ...
    "登录采集拨测任务ID": "V-35734",
    "登录采集拨测任务编号": "V-35734",
    "登录采集拨测任务名称": "登录采集拨测任务管理-2",
    "新增登录采集拨测任务状态": "已启用",
    "新增登录采集拨测任务时间": "2026-05-08 15:21:37",
    "登录采集拨测任务属性": "已启用",
    "登录采集拨测任务创建时间": "2026-05-08 15:21:37",
    "登录采集拨测任务所属部门": "安全运维部",
    "登录采集拨测任务负责人": "张三",
    "登录采集拨测任务类型": "已启用",
    "登录采集拨测任务规则": "已启用",
  ...
  },
  {
    ...
    "登录采集拨测任务ID": "V-43653",
    "登录采集拨测任务编号": "V-43653",
    "登录采集拨测任务名称": "登录采集拨测任务管理-3",
    "新增登录采集拨测任务状态": "已停用",
    "新增登录采集拨测任务时间": "2026-05-08 16:08:25",
    "登录采集拨测任务属性": "已停用",
    "登录采集拨测任务创建时间": "2026-05-08 16:08:25",
    "登录采集拨测任务所属部门": "网络管理部",
    "登录采集拨测任务负责人": "李四",
    "登录采集拨测任务类型": "已停用",
    "登录采集拨测任务规则": "已停用",
  ...
  },
  {
    ...
    "登录采集拨测任务ID": "V-51572",
    "登录采集拨测任务编号": "V-51572",
    "登录采集拨测任务名称": "登录采集拨测任务管理-4",
    "新增登录采集拨测任务状态": "正常",
    "新增登录采集拨测任务时间": "2026-05-09 08:33:11",
    "登录采集拨测任务属性": "正常",
    "登录采集拨测任务创建时间": "2026-05-09 08:33:11",
    "登录采集拨测任务所属部门": "资产管理部",
    "登录采集拨测任务负责人": "王五",
    "登录采集拨测任务类型": "正常",
    "登录采集拨测任务规则": "正常",
  ...
  },
  {
    ...
    "登录采集拨测任务ID": "V-59491",
    "登录采集拨测任务编号": "V-59491",
    "登录采集拨测任务名称": "登录采集拨测任务管理-5",
    "新增登录采集拨测任务状态": "异常",
    "新增登录采集拨测任务时间": "2026-05-09 09:47:56",
    "登录采集拨测任务属性": "异常",
    "登录采集拨测任务创建时间": "2026-05-09 09:47:56",
    "登录采集拨测任务所属部门": "信息安全部",
    "登录采集拨测任务负责人": "赵六",
    "登录采集拨测任务类型": "异常",
    "登录采集拨测任务规则": "异常",
  ...
  },
  {
    ...
    "登录采集拨测任务ID": "V-67410",
    "登录采集拨测任务编号": "V-67410",
    "登录采集拨测任务名称": "登录采集拨测任务管理-6",
    "新增登录采集拨测任务状态": "超时",
    "新增登录采集拨测任务时间": "2026-05-08 09:12:18",
    "登录采集拨测任务属性": "超时",
    "登录采集拨测任务创建时间": "2026-05-08 09:12:18",
    "登录采集拨测任务所属部门": "系统运维部",
    "登录采集拨测任务负责人": "system",
    "登录采集拨测任务类型": "超时",
    "登录采集拨测任务规则": "超时",
