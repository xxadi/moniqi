  ...
  >
    ...
    >
      ...
      <el-form-item label="规则名称" prop="规则名称">
        <el-input v-model="editFormData.规则名称" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      <el-form-item label="规则类型" prop="规则类型">
        <el-input v-model="editFormData.规则类型" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      <el-form-item label="生效范围" prop="生效范围">
        <el-input v-model="editFormData.生效范围" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      ...
      <el-form-item label="时间" prop="时间">
        <el-date-picker v-model="editFormData.时间" type="datetime" :disabled="dialogTitle === '详情'" clearable></el-date-picker>
      </el-form-item>
