    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("发起单IP扫描流程", "add")'>发起单IP扫描流程</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增单IP扫描指派信息", "add")'>新增单IP扫描指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增单IP扫描流程节点", "add")'>新增单IP扫描流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改单IP扫描流程节点信息", "edit")'>修改单IP扫描流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("单IP扫描流程节点删除", "delete")'>单IP扫描流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("单IP扫描流程节点查询", "detail")'>单IP扫描流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("上传单IP扫描信息", "import")'>上传单IP扫描信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("单IP扫描流程图查看", "detail")'>单IP扫描流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("单IP扫描流程通知", "operation")'>单IP扫描流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("单IP扫描结果逐级审批", "edit")'>单IP扫描结果逐级审批</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-586127-100-9165",
    "扫描对象": "单IP扫描流程管理-部侧联动-01-586127",
    "扫描节点": "节点-09-27",
    "资产数量": 2376,
    "异常数量": 3892,
    "扫描状态": "已同步-127"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-586127-101-7096",
    "扫描对象": "区公司单IP扫描流程管理-异常复核-02-586127",
    "扫描节点": "节点-02-27",
    "资产数量": 1000,
    "异常数量": 2431,
    "扫描状态": "已同步-127"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-586127-102-2343",
    "扫描对象": "单IP扫描流程管理-异常复核-03-586127",
    "扫描节点": "节点-05-27",
    "资产数量": 1775,
    "异常数量": 3425,
    "扫描状态": "待处理-127"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-586127-103-3156",
    "扫描对象": "单IP扫描流程管理-数据上报-04-586127",
    "扫描节点": "节点-06-27",
    "资产数量": 4701,
    "异常数量": 2154,
    "扫描状态": "处理中-127"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-586127-104-2581",
    "扫描对象": "区公司单IP扫描流程管理-异常复核-05-586127",
    "扫描节点": "节点-01-27",
    "资产数量": 3065,
    "异常数量": 752,
    "扫描状态": "处理中-127"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-586127-105-5098",
    "扫描对象": "单IP扫描流程管理-数据上报-06-586127",
    "扫描节点": "节点-06-27",
    "资产数量": 1411,
    "异常数量": 2309,
    "扫描状态": "已完成-127"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-586127-106-2320",
    "扫描对象": "区公司单IP扫描流程管理-异常复核-07-586127",
    "扫描节点": "区公司节点-07-27",
    "资产数量": 4283,
    "异常数量": 4094,
    "扫描状态": "已完成-127"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-586127-107-9595",
    "扫描对象": "单IP扫描流程管理-数据上报-08-586127",
    "扫描节点": "节点-08-27",
    "资产数量": 1674,
    "异常数量": 147,
    "扫描状态": "待处理-127"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-586127-108-8805",
    "扫描对象": "单IP扫描流程管理-资产纳管-09-586127",
    "扫描节点": "节点-04-27",
    "资产数量": 1455,
    "异常数量": 862,
    "扫描状态": "异常-127"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-586127-109-4729",
    "扫描对象": "单IP扫描流程管理-扩容核查-10-586127",
    "扫描节点": "节点-09-27",
    "资产数量": 3024,
    "异常数量": 2214,
    "扫描状态": "待处理-127"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "单IP扫描流程管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "单IP扫描流程管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "单IP扫描流程管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "单IP扫描流程管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "单IP扫描流程管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
