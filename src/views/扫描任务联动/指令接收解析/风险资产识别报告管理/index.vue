    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加风险资产识别报告信息", "add")'>添加风险资产识别报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑风险资产识别报告信息", "edit")'>编辑风险资产识别报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除风险资产识别报告信息", "delete")'>删除风险资产识别报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询风险资产识别报告", "detail")'>查询风险资产识别报告</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("风险资产识别报告统计", "analysis")'>风险资产识别报告统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("风险资产识别报告信息下载", "export")'>风险资产识别报告信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-908459-100-6702",
    "资产名称": "风险资产识别报告管理-扩容核查-01-908459",
    "资产类型": "资产资源-自动化-908",
    "所属区域": "-资产资源-风险资产识别报告管理-数据上报-908459-001",
    "纳管状态": "异常-459",
    "最近同步": "2026-05-13 16:00:45"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-908459-101-9224",
    "资产名称": "风险资产识别报告管理-部侧联动-02-908459",
    "资产类型": "资产资源-省侧-908",
    "所属区域": "-资产资源-风险资产识别报告管理-扩容核查-908459-002",
    "纳管状态": "待处理-459",
    "最近同步": "2026-05-19 16:53:07"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-908459-102-9287",
    "资产名称": "风险资产识别报告管理-异常复核-03-908459",
    "资产类型": "资产资源-省侧-908",
    "所属区域": "-资产资源-风险资产识别报告管理-扩容核查-908459-003",
    "纳管状态": "处理中-459",
    "最近同步": "2026-05-15 11:32:16"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-908459-103-6741",
    "资产名称": "风险资产识别报告管理-部侧联动-04-908459",
    "资产类型": "资产资源-省侧-908",
    "所属区域": "-资产资源-风险资产识别报告管理-扩容核查-908459-004",
    "纳管状态": "已同步-459",
    "最近同步": "2026-05-13 15:59:53"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-908459-104-1636",
    "资产名称": "风险资产识别报告管理-资产纳管-05-908459",
    "资产类型": "资产资源-边界-908",
    "所属区域": "-资产资源-风险资产识别报告管理-数据上报-908459-005",
    "纳管状态": "异常-459",
    "最近同步": "2026-05-14 14:27:44"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-908459-105-8292",
    "资产名称": "风险资产识别报告管理-数据上报-06-908459",
    "资产类型": "资产资源-自动化-908",
    "所属区域": "区公司-资产资源-风险资产识别报告管理-数据上报-908459-006",
    "纳管状态": "已完成-459",
    "最近同步": "2026-05-13 15:30:38"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-908459-106-6364",
    "资产名称": "风险资产识别报告管理-部侧联动-07-908459",
    "资产类型": "资产资源-自动化-908",
    "所属区域": "-资产资源-风险资产识别报告管理-自动采集-908459-007",
    "纳管状态": "已完成-459",
    "最近同步": "2026-05-19 10:12:43"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-908459-107-9347",
    "资产名称": "区公司风险资产识别报告管理-异常复核-08-908459",
    "资产类型": "资产资源-边界-908",
    "所属区域": "-资产资源-风险资产识别报告管理-部侧联动-908459-008",
    "纳管状态": "处理中-459",
    "最近同步": "2026-05-12 10:26:21"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-908459-108-8485",
    "资产名称": "风险资产识别报告管理-扩容核查-09-908459",
    "资产类型": "资产资源-省侧-908",
    "所属区域": "-资产资源-风险资产识别报告管理-自动采集-908459-009",
    "纳管状态": "待处理-459",
    "最近同步": "2026-05-12 13:09:56"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-908459-109-9240",
    "资产名称": "风险资产识别报告管理-异常复核-10-908459",
    "资产类型": "资产资源-边界-908",
    "所属区域": "-资产资源-风险资产识别报告管理-自动采集-908459-010",
    "纳管状态": "已同步-459",
    "最近同步": "2026-05-14 09:34:02"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "风险资产识别报告管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "风险资产识别报告管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "风险资产识别报告管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "风险资产识别报告管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "风险资产识别报告管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
