    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("云虚拟资源纳管审批申请创建", "edit")'>云虚拟资源纳管审批申请创建</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增云虚拟资源纳管指派信息", "add")'>新增云虚拟资源纳管指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增云虚拟资源纳管流程节点", "add")'>新增云虚拟资源纳管流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改云虚拟资源纳管流程节点信息", "edit")'>修改云虚拟资源纳管流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("云虚拟资源纳管流程节点删除", "delete")'>云虚拟资源纳管流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("云虚拟资源纳管流程节点查询", "add")'>云虚拟资源纳管流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("上传云虚拟资源纳管附件", "import")'>上传云虚拟资源纳管附件</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("云虚拟资源纳管流程图查看", "add")'>云虚拟资源纳管流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("云虚拟资源纳管流程通知", "add")'>云虚拟资源纳管流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("云虚拟资源纳管结果逐级审批", "edit")'>云虚拟资源纳管结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("云虚拟资源纳管结果拒绝和驳回", "add")'>云虚拟资源纳管结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-957859-100-8810",
    "资产名称": "云虚拟资源纳管流程管理-资产纳管-01-957859",
    "资产类型": "资产资源-核心-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-数据上报-957859-001",
    "纳管状态": "已完成-859",
    "最近同步": "2026-05-24 14:00:22"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-957859-101-1288",
    "资产名称": "区公司云虚拟资源纳管流程管理-异常复核-02-957859",
    "资产类型": "资产资源-核心-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-扩容核查-957859-002",
    "纳管状态": "待处理-859",
    "最近同步": "2026-05-24 13:33:47"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-957859-102-5525",
    "资产名称": "云虚拟资源纳管流程管理-自动采集-03-957859",
    "资产类型": "资产资源-核心-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-数据上报-957859-003",
    "纳管状态": "待复核-859",
    "最近同步": "2026-05-17 16:48:19"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-957859-103-6592",
    "资产名称": "区公司云虚拟资源纳管流程管理-自动采集-04-957859",
    "资产类型": "资产资源-省侧-957",
    "所属区域": "区公司-资产资源-云虚拟资源纳管流程管理-自动采集-957859-004",
    "纳管状态": "已同步-859",
    "最近同步": "2026-05-10 14:40:22"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-957859-104-6076",
    "资产名称": "区公司云虚拟资源纳管流程管理-异常复核-05-957859",
    "资产类型": "资产资源-复核-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-部侧联动-957859-005",
    "纳管状态": "待复核-859",
    "最近同步": "2026-05-20 16:17:34"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-957859-105-9283",
    "资产名称": "云虚拟资源纳管流程管理-自动采集-06-957859",
    "资产类型": "资产资源-复核-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-扩容核查-957859-006",
    "纳管状态": "异常-859",
    "最近同步": "2026-05-16 15:38:32"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-957859-106-8176",
    "资产名称": "云虚拟资源纳管流程管理-数据上报-07-957859",
    "资产类型": "资产资源-自动化-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-部侧联动-957859-007",
    "纳管状态": "异常-859",
    "最近同步": "2026-05-25 17:26:45"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-957859-107-6016",
    "资产名称": "云虚拟资源纳管流程管理-扩容核查-08-957859",
    "资产类型": "资产资源-核心-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-部侧联动-957859-008",
    "纳管状态": "已同步-859",
    "最近同步": "2026-05-10 14:25:32"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-957859-108-5402",
    "资产名称": "云虚拟资源纳管流程管理-异常复核-09-957859",
    "资产类型": "资产资源-复核-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-数据上报-957859-009",
    "纳管状态": "已完成-859",
    "最近同步": "2026-05-11 11:47:12"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-957859-109-5649",
    "资产名称": "云虚拟资源纳管流程管理-自动采集-10-957859",
    "资产类型": "资产资源-复核-957",
    "所属区域": "-资产资源-云虚拟资源纳管流程管理-资产纳管-957859-010",
    "纳管状态": "已完成-859",
    "最近同步": "2026-05-25 08:14:30"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "云虚拟资源纳管流程管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "云虚拟资源纳管流程管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "云虚拟资源纳管流程管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "云虚拟资源纳管流程管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "云虚拟资源纳管流程管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
