    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增模拟采集资产信息", "add")'>新增模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改模拟采集资产信息", "edit")'>修改模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除模拟采集资产信息", "delete")'>删除模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看模拟采集资产信息", "add")'>查看模拟采集资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产数据提取", "add")'>模拟采集资产数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产数据识别", "add")'>模拟采集资产数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产清洗", "add")'>模拟采集资产清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产分级", "add")'>模拟采集资产分级</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产实时计算", "add")'>模拟采集资产实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产聚合", "add")'>模拟采集资产聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("模拟采集资产信息导出", "export")'>模拟采集资产信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产可视化展示", "add")'>模拟采集资产可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("模拟采集资产数据审查", "add")'>模拟采集资产数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "模拟采集资产报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "模拟采集资产报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "模拟采集资产报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "模拟采集资产报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "模拟采集资产报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
