    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组件状态查询接口", "detail")'>资产组件状态查询接口</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产组件状态查询数据分析", "detail")'>资产组件状态查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产组件状态查询信息", "detail")'>查看资产组件状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产组件状态查询数据导出", "export")'>资产组件状态查询数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产组件状态查询信息", "add")'>新增资产组件状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输入资产组件状态查询请求任务", "detail")'>输入资产组件状态查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输出资产组件状态查询反馈信息", "detail")'>输出资产组件状态查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控资产组件状态查询状态信息", "detail")'>监控资产组件状态查询状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("统计资产组件状态查询调用信息", "detail")'>统计资产组件状态查询调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-793133-100-9359",
    "接口名称": "资产组件状态查询接口-异常复核-01-793133",
    "对接系统": "集团资产平台-7931",
    "调用状态": "已完成-133",
    "平均耗时": "55ms-33",
    "最近调用": "2026-05-24 12:05:49"
  },
  {
    "ID": 2,
    "接口编号": "API-793133-101-1219",
    "接口名称": "资产组件状态查询接口-自动采集-02-793133",
    "对接系统": "资产安全平台-7931",
    "调用状态": "异常-133",
    "平均耗时": "404ms-33",
    "最近调用": "2026-05-15 13:02:02"
  },
  {
    "ID": 3,
    "接口编号": "API-793133-102-3650",
    "接口名称": "资产组件状态查询接口-资产纳管-03-793133",
    "对接系统": "集团资产平台-7931",
    "调用状态": "异常-133",
    "平均耗时": "424ms-33",
    "最近调用": "2026-05-22 10:22:42"
  },
  {
    "ID": 4,
    "接口编号": "API-793133-103-7662",
    "接口名称": "资产组件状态查询接口-异常复核-04-793133",
    "对接系统": "CMDB资源库-7931",
    "调用状态": "处理中-133",
    "平均耗时": "448ms-33",
    "最近调用": "2026-05-25 13:01:36"
  },
  {
    "ID": 5,
    "接口编号": "API-793133-104-6176",
    "接口名称": "资产组件状态查询接口-资产纳管-05-793133",
    "对接系统": "工信部对接平台-7931",
    "调用状态": "已同步-133",
    "平均耗时": "203ms-33",
    "最近调用": "2026-05-14 15:29:52"
  },
  {
    "ID": 6,
    "接口编号": "API-793133-105-1957",
    "接口名称": "资产组件状态查询接口-部侧联动-06-793133",
    "对接系统": "资产安全平台-7931",
    "调用状态": "异常-133",
    "平均耗时": "207ms-33",
    "最近调用": "2026-05-18 16:39:43"
  },
  {
    "ID": 7,
    "接口编号": "API-793133-106-6640",
    "接口名称": "资产组件状态查询接口-扩容核查-07-793133",
    "对接系统": "调度中心-7931",
    "调用状态": "待复核-133",
    "平均耗时": "233ms-33",
    "最近调用": "2026-05-09 14:33:39"
  },
  {
    "ID": 8,
    "接口编号": "API-793133-107-2017",
    "接口名称": "资产组件状态查询接口-扩容核查-08-793133",
    "对接系统": "集团资产平台-7931",
    "调用状态": "已同步-133",
    "平均耗时": "472ms-33",
    "最近调用": "2026-05-08 10:44:51"
  },
  {
    "ID": 9,
    "接口编号": "API-793133-108-2133",
    "接口名称": "资产组件状态查询接口-数据上报-09-793133",
    "对接系统": "集团资产平台-7931",
    "调用状态": "异常-133",
    "平均耗时": "628ms-33",
    "最近调用": "2026-05-13 12:58:09"
  },
  {
    "ID": 10,
    "接口编号": "API-793133-109-4292",
    "接口名称": "资产组件状态查询接口-扩容核查-10-793133",
    "对接系统": "CMDB资源库-7931",
    "调用状态": "异常-133",
    "平均耗时": "220ms-33",
    "最近调用": "2026-05-19 13:17:07"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产组件状态查询接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产组件状态查询接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产组件状态查询接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产组件状态查询接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产组件状态查询接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
