    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产预警", "analysis")'>工信部资产预警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("工信部资产预警结果查看", "detail")'>工信部资产预警结果查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("工信部资产预警结果编辑", "edit")'>工信部资产预警结果编辑</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("工信部资产预警结果删除", "delete")'>工信部资产预警结果删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产预警结果统计", "analysis")'>工信部资产预警结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产预警结果推送", "analysis")'>工信部资产预警结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("工信部资产预警结果归档", "analysis")'>工信部资产预警结果归档</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-200194-100-5337",
    "资产名称": "区公司工信部资产预警管理-部侧联动-01-200194",
    "资产类型": "资产资源-复核-200",
    "所属区域": "-资产资源-工信部资产预警管理-数据上报-200194-001",
    "纳管状态": "待复核-194",
    "最近同步": "2026-05-25 11:46:54"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-200194-101-5513",
    "资产名称": "工信部资产预警管理-数据上报-02-200194",
    "资产类型": "资产资源-边界-200",
    "所属区域": "区公司-资产资源-工信部资产预警管理-扩容核查-200194-002",
    "纳管状态": "已完成-194",
    "最近同步": "2026-05-09 10:34:34"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-200194-102-6274",
    "资产名称": "区公司工信部资产预警管理-资产纳管-03-200194",
    "资产类型": "资产资源-核心-200",
    "所属区域": "-资产资源-工信部资产预警管理-扩容核查-200194-003",
    "纳管状态": "异常-194",
    "最近同步": "2026-05-18 09:47:17"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-200194-103-3672",
    "资产名称": "工信部资产预警管理-数据上报-04-200194",
    "资产类型": "资产资源-核心-200",
    "所属区域": "区公司-资产资源-工信部资产预警管理-自动采集-200194-004",
    "纳管状态": "处理中-194",
    "最近同步": "2026-05-20 12:10:59"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-200194-104-5874",
    "资产名称": "区公司工信部资产预警管理-扩容核查-05-200194",
    "资产类型": "资产资源-省侧-200",
    "所属区域": "-资产资源-工信部资产预警管理-自动采集-200194-005",
    "纳管状态": "处理中-194",
    "最近同步": "2026-05-25 12:18:50"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-200194-105-2939",
    "资产名称": "工信部资产预警管理-扩容核查-06-200194",
    "资产类型": "资产资源-省侧-200",
    "所属区域": "-资产资源-工信部资产预警管理-异常复核-200194-006",
    "纳管状态": "异常-194",
    "最近同步": "2026-05-24 14:19:36"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-200194-106-3680",
    "资产名称": "工信部资产预警管理-部侧联动-07-200194",
    "资产类型": "资产资源-部侧-200",
    "所属区域": "-资产资源-工信部资产预警管理-自动采集-200194-007",
    "纳管状态": "已同步-194",
    "最近同步": "2026-05-23 09:08:43"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-200194-107-2834",
    "资产名称": "工信部资产预警管理-部侧联动-08-200194",
    "资产类型": "资产资源-边界-200",
    "所属区域": "-资产资源-工信部资产预警管理-扩容核查-200194-008",
    "纳管状态": "已同步-194",
    "最近同步": "2026-05-09 16:53:42"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-200194-108-3238",
    "资产名称": "工信部资产预警管理-扩容核查-09-200194",
    "资产类型": "资产资源-部侧-200",
    "所属区域": "-资产资源-工信部资产预警管理-部侧联动-200194-009",
    "纳管状态": "处理中-194",
    "最近同步": "2026-05-25 10:11:51"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-200194-109-6904",
    "资产名称": "工信部资产预警管理-扩容核查-10-200194",
    "资产类型": "资产资源-核心-200",
    "所属区域": "-资产资源-工信部资产预警管理-资产纳管-200194-010",
    "纳管状态": "待复核-194",
    "最近同步": "2026-05-22 14:22:18"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "工信部资产预警管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "工信部资产预警管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "工信部资产预警管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "工信部资产预警管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "工信部资产预警管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
