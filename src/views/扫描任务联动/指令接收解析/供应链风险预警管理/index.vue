    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("供应链风险预警", "analysis")'>供应链风险预警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("供应链风险预警结果查看", "detail")'>供应链风险预警结果查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("供应链风险预警结果修改", "edit")'>供应链风险预警结果修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("供应链风险预警结果删除", "delete")'>供应链风险预警结果删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("供应链风险预警结果统计", "analysis")'>供应链风险预警结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("供应链风险预警结果推送", "analysis")'>供应链风险预警结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("供应链风险预警结果归档", "analysis")'>供应链风险预警结果归档</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-782279-100-4609",
    "事件类型": "监控告警-自动化-782",
    "事件级别": "中",
    "关联对象": "供应链风险预警管理-自动采集-01-782279",
    "发生时间": "2026-05-23 08:11:56",
    "处置状态": "待处理-279"
  },
  {
    "ID": 2,
    "事件编号": "EVT-782279-101-5953",
    "事件类型": "监控告警-部侧-782",
    "事件级别": "中",
    "关联对象": "供应链风险预警管理-扩容核查-02-782279",
    "发生时间": "2026-05-19 09:57:16",
    "处置状态": "已完成-279"
  },
  {
    "ID": 3,
    "事件编号": "EVT-782279-102-7657",
    "事件类型": "监控告警-部侧-782",
    "事件级别": "中",
    "关联对象": "供应链风险预警管理-资产纳管-03-782279",
    "发生时间": "2026-05-17 11:37:33",
    "处置状态": "已同步-279"
  },
  {
    "ID": 4,
    "事件编号": "EVT-782279-103-2696",
    "事件类型": "监控告警-复核-782",
    "事件级别": "紧急",
    "关联对象": "供应链风险预警管理-自动采集-04-782279",
    "发生时间": "2026-05-23 11:03:29",
    "处置状态": "异常-279"
  },
  {
    "ID": 5,
    "事件编号": "EVT-782279-104-6172",
    "事件类型": "监控告警-省侧-782",
    "事件级别": "高",
    "关联对象": "供应链风险预警管理-资产纳管-05-782279",
    "发生时间": "2026-05-10 13:37:35",
    "处置状态": "已完成-279"
  },
  {
    "ID": 6,
    "事件编号": "EVT-782279-105-5341",
    "事件类型": "监控告警-自动化-782",
    "事件级别": "紧急",
    "关联对象": "供应链风险预警管理-扩容核查-06-782279",
    "发生时间": "2026-05-23 10:45:26",
    "处置状态": "待复核-279"
  },
  {
    "ID": 7,
    "事件编号": "EVT-782279-106-2650",
    "事件类型": "监控告警-部侧-782",
    "事件级别": "一般",
    "关联对象": "区公司供应链风险预警管理-数据上报-07-782279",
    "发生时间": "2026-05-18 17:35:36",
    "处置状态": "异常-279"
  },
  {
    "ID": 8,
    "事件编号": "EVT-782279-107-2065",
    "事件类型": "监控告警-复核-782",
    "事件级别": "一般",
    "关联对象": "供应链风险预警管理-部侧联动-08-782279",
    "发生时间": "2026-05-20 16:18:05",
    "处置状态": "待复核-279"
  },
  {
    "ID": 9,
    "事件编号": "EVT-782279-108-3132",
    "事件类型": "监控告警-边界-782",
    "事件级别": "高",
    "关联对象": "供应链风险预警管理-异常复核-09-782279",
    "发生时间": "2026-05-13 17:48:56",
    "处置状态": "异常-279"
  },
  {
    "ID": 10,
    "事件编号": "EVT-782279-109-1426",
    "事件类型": "监控告警-核心-782",
    "事件级别": "中",
    "关联对象": "供应链风险预警管理-异常复核-10-782279",
    "发生时间": "2026-05-13 13:42:38",
    "处置状态": "处理中-279"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "供应链风险预警管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "供应链风险预警管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "供应链风险预警管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "供应链风险预警管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "供应链风险预警管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
