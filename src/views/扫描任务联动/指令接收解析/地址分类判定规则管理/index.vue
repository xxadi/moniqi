    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加地址分类判定规则", "add")'>添加地址分类判定规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑地址分类判定规则", "edit")'>编辑地址分类判定规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除地址分类判定规则", "delete")'>删除地址分类判定规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询地址分类判定规则", "detail")'>查询地址分类判定规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("地址分类判定规则启用/禁用", "operation")'>地址分类判定规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("地址分类判定规则运行效果评估", "analysis")'>地址分类判定规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("地址分类判定规则分析", "analysis")'>地址分类判定规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("地址分类判定规则分析结果展示", "detail")'>地址分类判定规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("地址分类判定规则分析结果下载", "export")'>地址分类判定规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("地址分类判定规则分析结果上报", "analysis")'>地址分类判定规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-434641-100-3042",
    "规则名称": "地址分类判定规则管理-资产纳管-01-434641",
    "规则类型": "规则策略-部侧-434",
    "启用状态": "处理中-641",
    "命中次数": 564,
    "更新时间": "2026-05-08 16:42:19"
  },
  {
    "ID": 2,
    "规则编号": "RULE-434641-101-9671",
    "规则名称": "地址分类判定规则管理-部侧联动-02-434641",
    "规则类型": "规则策略-省侧-434",
    "启用状态": "异常-641",
    "命中次数": 483,
    "更新时间": "2026-05-08 13:06:35"
  },
  {
    "ID": 3,
    "规则编号": "RULE-434641-102-6363",
    "规则名称": "地址分类判定规则管理-资产纳管-03-434641",
    "规则类型": "规则策略-核心-434",
    "启用状态": "处理中-641",
    "命中次数": 1197,
    "更新时间": "2026-05-18 14:00:48"
  },
  {
    "ID": 4,
    "规则编号": "RULE-434641-103-7806",
    "规则名称": "地址分类判定规则管理-部侧联动-04-434641",
    "规则类型": "规则策略-边界-434",
    "启用状态": "待处理-641",
    "命中次数": 576,
    "更新时间": "2026-05-13 08:38:33"
  },
  {
    "ID": 5,
    "规则编号": "RULE-434641-104-3977",
    "规则名称": "地址分类判定规则管理-异常复核-05-434641",
    "规则类型": "规则策略-部侧-434",
    "启用状态": "待复核-641",
    "命中次数": 3611,
    "更新时间": "2026-05-24 17:51:19"
  },
  {
    "ID": 6,
    "规则编号": "RULE-434641-105-8948",
    "规则名称": "地址分类判定规则管理-部侧联动-06-434641",
    "规则类型": "规则策略-边界-434",
    "启用状态": "异常-641",
    "命中次数": 2323,
    "更新时间": "2026-05-09 14:54:34"
  },
  {
    "ID": 7,
    "规则编号": "RULE-434641-106-9957",
    "规则名称": "地址分类判定规则管理-资产纳管-07-434641",
    "规则类型": "规则策略-省侧-434",
    "启用状态": "待处理-641",
    "命中次数": 3904,
    "更新时间": "2026-05-20 15:32:11"
  },
  {
    "ID": 8,
    "规则编号": "RULE-434641-107-2132",
    "规则名称": "区公司地址分类判定规则管理-异常复核-08-434641",
    "规则类型": "规则策略-自动化-434",
    "启用状态": "待处理-641",
    "命中次数": 678,
    "更新时间": "2026-05-20 11:05:26"
  },
  {
    "ID": 9,
    "规则编号": "RULE-434641-108-3341",
    "规则名称": "地址分类判定规则管理-部侧联动-09-434641",
    "规则类型": "规则策略-自动化-434",
    "启用状态": "处理中-641",
    "命中次数": 1040,
    "更新时间": "2026-05-13 13:32:01"
  },
  {
    "ID": 10,
    "规则编号": "RULE-434641-109-2276",
    "规则名称": "地址分类判定规则管理-部侧联动-10-434641",
    "规则类型": "规则策略-自动化-434",
    "启用状态": "处理中-641",
    "命中次数": 2671,
    "更新时间": "2026-05-15 15:21:04"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "地址分类判定规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "地址分类判定规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "地址分类判定规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "地址分类判定规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "地址分类判定规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
