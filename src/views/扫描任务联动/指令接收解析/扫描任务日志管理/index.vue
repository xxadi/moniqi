    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增扫描任务日志信息", "add")'>新增扫描任务日志信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改扫描任务日志信息", "edit")'>修改扫描任务日志信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描任务日志信息", "delete")'>删除扫描任务日志信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描任务日志列表", "detail")'>查询扫描任务日志列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描任务日志详情", "detail")'>查询扫描任务日志详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入扫描任务日志信息", "import")'>批量导入扫描任务日志信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描任务日志信息导出", "export")'>扫描任务日志信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-918249-100-3527",
    "扫描对象": "扫描任务日志管理-部侧联动-01-918249",
    "扫描节点": "节点-09-49",
    "资产数量": 407,
    "异常数量": 2035,
    "扫描状态": "已完成-249"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-918249-101-8637",
    "扫描对象": "扫描任务日志管理-异常复核-02-918249",
    "扫描节点": "节点-06-49",
    "资产数量": 4763,
    "异常数量": 3432,
    "扫描状态": "异常-249"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-918249-102-1303",
    "扫描对象": "扫描任务日志管理-数据上报-03-918249",
    "扫描节点": "节点-01-49",
    "资产数量": 3601,
    "异常数量": 818,
    "扫描状态": "待复核-249"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-918249-103-8729",
    "扫描对象": "扫描任务日志管理-资产纳管-04-918249",
    "扫描节点": "节点-09-49",
    "资产数量": 2616,
    "异常数量": 3389,
    "扫描状态": "处理中-249"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-918249-104-4254",
    "扫描对象": "扫描任务日志管理-部侧联动-05-918249",
    "扫描节点": "节点-09-49",
    "资产数量": 3979,
    "异常数量": 3842,
    "扫描状态": "处理中-249"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-918249-105-1134",
    "扫描对象": "区公司扫描任务日志管理-资产纳管-06-918249",
    "扫描节点": "区公司节点-09-49",
    "资产数量": 996,
    "异常数量": 4228,
    "扫描状态": "处理中-249"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-918249-106-8802",
    "扫描对象": "扫描任务日志管理-异常复核-07-918249",
    "扫描节点": "区公司节点-03-49",
    "资产数量": 1868,
    "异常数量": 4733,
    "扫描状态": "已完成-249"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-918249-107-2569",
    "扫描对象": "扫描任务日志管理-部侧联动-08-918249",
    "扫描节点": "节点-07-49",
    "资产数量": 3187,
    "异常数量": 2859,
    "扫描状态": "已同步-249"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-918249-108-6320",
    "扫描对象": "区公司扫描任务日志管理-异常复核-09-918249",
    "扫描节点": "节点-08-49",
    "资产数量": 2217,
    "异常数量": 3018,
    "扫描状态": "已完成-249"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-918249-109-2328",
    "扫描对象": "扫描任务日志管理-资产纳管-10-918249",
    "扫描节点": "节点-04-49",
    "资产数量": 2265,
    "异常数量": 2421,
    "扫描状态": "已同步-249"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描任务日志管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描任务日志管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描任务日志管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描任务日志管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描任务日志管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
