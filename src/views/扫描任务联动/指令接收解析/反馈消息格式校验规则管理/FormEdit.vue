<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="规则名称" prop="规则名称">
        <el-input v-model="editFormData.规则名称" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="规则类型" prop="规则类型">
        <el-input v-model="editFormData.规则类型" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="生效范围" prop="生效范围">
        <el-input v-model="editFormData.生效范围" :disabled="dialogTitle === '详情'" />
      </el-form-item>
