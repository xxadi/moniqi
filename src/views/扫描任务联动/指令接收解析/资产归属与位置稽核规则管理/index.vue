    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产归属与位置稽核规则", "add")'>新增资产归属与位置稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产归属与位置稽核规则", "edit")'>修改资产归属与位置稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产归属与位置稽核规则", "delete")'>删除资产归属与位置稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产归属与位置稽核规则", "detail")'>查询资产归属与位置稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属与位置稽核规则启用/禁用", "detail")'>资产归属与位置稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属与位置稽核规则运行效果评估", "detail")'>资产归属与位置稽核规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属与位置稽核规则分析", "detail")'>资产归属与位置稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属与位置稽核规则分析结果展示", "detail")'>资产归属与位置稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产归属与位置稽核规则分析结果下载", "export")'>资产归属与位置稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归属与位置稽核规则分析结果上报", "detail")'>资产归属与位置稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-287763-100-4417",
    "规则名称": "资产归属与位置稽核规则管理-异常复核-01-287763",
    "规则类型": "规则策略-自动化-287",
    "启用状态": "处理中-763",
    "命中次数": 3179,
    "更新时间": "2026-05-15 14:29:31"
  },
  {
    "ID": 2,
    "规则编号": "RULE-287763-101-6060",
    "规则名称": "资产归属与位置稽核规则管理-资产纳管-02-287763",
    "规则类型": "规则策略-核心-287",
    "启用状态": "待处理-763",
    "命中次数": 3145,
    "更新时间": "2026-05-15 12:29:50"
  },
  {
    "ID": 3,
    "规则编号": "RULE-287763-102-7338",
    "规则名称": "资产归属与位置稽核规则管理-异常复核-03-287763",
    "规则类型": "规则策略-省侧-287",
    "启用状态": "待处理-763",
    "命中次数": 824,
    "更新时间": "2026-05-16 16:07:25"
  },
  {
    "ID": 4,
    "规则编号": "RULE-287763-103-1481",
    "规则名称": "资产归属与位置稽核规则管理-扩容核查-04-287763",
    "规则类型": "规则策略-自动化-287",
    "启用状态": "异常-763",
    "命中次数": 2359,
    "更新时间": "2026-05-16 09:13:48"
  },
  {
    "ID": 5,
    "规则编号": "RULE-287763-104-7344",
    "规则名称": "资产归属与位置稽核规则管理-异常复核-05-287763",
    "规则类型": "规则策略-复核-287",
    "启用状态": "已同步-763",
    "命中次数": 3479,
    "更新时间": "2026-05-11 08:51:01"
  },
  {
    "ID": 6,
    "规则编号": "RULE-287763-105-5898",
    "规则名称": "区公司资产归属与位置稽核规则管理-自动采集-06-287763",
    "规则类型": "规则策略-边界-287",
    "启用状态": "已完成-763",
    "命中次数": 2303,
    "更新时间": "2026-05-08 14:30:56"
  },
  {
    "ID": 7,
    "规则编号": "RULE-287763-106-5227",
    "规则名称": "资产归属与位置稽核规则管理-部侧联动-07-287763",
    "规则类型": "规则策略-部侧-287",
    "启用状态": "已完成-763",
    "命中次数": 1935,
    "更新时间": "2026-05-11 12:39:58"
  },
  {
    "ID": 8,
    "规则编号": "RULE-287763-107-4579",
    "规则名称": "区公司资产归属与位置稽核规则管理-部侧联动-08-287763",
    "规则类型": "规则策略-省侧-287",
    "启用状态": "已同步-763",
    "命中次数": 1083,
    "更新时间": "2026-05-16 17:11:06"
  },
  {
    "ID": 9,
    "规则编号": "RULE-287763-108-7440",
    "规则名称": "资产归属与位置稽核规则管理-资产纳管-09-287763",
    "规则类型": "规则策略-复核-287",
    "启用状态": "待处理-763",
    "命中次数": 2876,
    "更新时间": "2026-05-18 08:05:50"
  },
  {
    "ID": 10,
    "规则编号": "RULE-287763-109-1174",
    "规则名称": "资产归属与位置稽核规则管理-数据上报-10-287763",
    "规则类型": "规则策略-核心-287",
    "启用状态": "待复核-763",
    "命中次数": 88,
    "更新时间": "2026-05-13 15:10:06"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产归属与位置稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产归属与位置稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产归属与位置稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产归属与位置稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产归属与位置稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "资产归属与位置稽核规则管理" },
