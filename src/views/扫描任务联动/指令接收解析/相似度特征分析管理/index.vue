    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("相似度特征分析", "analysis")'>相似度特征分析</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改相似度特征分析结果", "edit")'>修改相似度特征分析结果</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除相似度特征分析结果", "delete")'>删除相似度特征分析结果</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询相似度特征分析结果列表", "detail")'>查询相似度特征分析结果列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询相似度特征分析结果详情", "detail")'>查询相似度特征分析结果详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入相似度特征分析结果", "import")'>批量导入相似度特征分析结果</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("相似度特征分析结果导出", "export")'>相似度特征分析结果导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "报表编号": "RPT-467325-100-4471",
    "报表名称": "相似度特征分析管理-扩容核查-01-467325",
    "统计周期": "区公司-统计分析-相似度特征分析管理-数据上报-467325-001",
    "生成状态": "已同步-325",
    "生成时间": "2026-05-22 17:42:43",
    "导出次数": 2344
  },
  {
    "ID": 2,
    "报表编号": "RPT-467325-101-7414",
    "报表名称": "相似度特征分析管理-扩容核查-02-467325",
    "统计周期": "-统计分析-相似度特征分析管理-资产纳管-467325-002",
    "生成状态": "已完成-325",
    "生成时间": "2026-05-23 11:49:51",
    "导出次数": 4592
  },
  {
    "ID": 3,
    "报表编号": "RPT-467325-102-2111",
    "报表名称": "相似度特征分析管理-资产纳管-03-467325",
    "统计周期": "-统计分析-相似度特征分析管理-资产纳管-467325-003",
    "生成状态": "已完成-325",
    "生成时间": "2026-05-13 09:47:19",
    "导出次数": 2587
  },
  {
    "ID": 4,
    "报表编号": "RPT-467325-103-2815",
    "报表名称": "相似度特征分析管理-资产纳管-04-467325",
    "统计周期": "-统计分析-相似度特征分析管理-部侧联动-467325-004",
    "生成状态": "已完成-325",
    "生成时间": "2026-05-22 10:57:51",
    "导出次数": 3326
  },
  {
    "ID": 5,
    "报表编号": "RPT-467325-104-6470",
    "报表名称": "相似度特征分析管理-异常复核-05-467325",
    "统计周期": "-统计分析-相似度特征分析管理-扩容核查-467325-005",
    "生成状态": "已同步-325",
    "生成时间": "2026-05-25 13:35:47",
    "导出次数": 1903
  },
  {
    "ID": 6,
    "报表编号": "RPT-467325-105-1468",
    "报表名称": "相似度特征分析管理-部侧联动-06-467325",
    "统计周期": "-统计分析-相似度特征分析管理-异常复核-467325-006",
    "生成状态": "已完成-325",
    "生成时间": "2026-05-19 14:08:54",
    "导出次数": 727
  },
  {
    "ID": 7,
    "报表编号": "RPT-467325-106-7165",
    "报表名称": "区公司相似度特征分析管理-异常复核-07-467325",
    "统计周期": "-统计分析-相似度特征分析管理-数据上报-467325-007",
    "生成状态": "处理中-325",
    "生成时间": "2026-05-22 13:24:04",
    "导出次数": 4156
  },
  {
    "ID": 8,
    "报表编号": "RPT-467325-107-4423",
    "报表名称": "相似度特征分析管理-资产纳管-08-467325",
    "统计周期": "-统计分析-相似度特征分析管理-扩容核查-467325-008",
    "生成状态": "待处理-325",
    "生成时间": "2026-05-19 08:20:15",
    "导出次数": 4838
  },
  {
    "ID": 9,
    "报表编号": "RPT-467325-108-3551",
    "报表名称": "相似度特征分析管理-异常复核-09-467325",
    "统计周期": "-统计分析-相似度特征分析管理-部侧联动-467325-009",
    "生成状态": "异常-325",
    "生成时间": "2026-05-21 08:02:25",
    "导出次数": 1490
  },
  {
    "ID": 10,
    "报表编号": "RPT-467325-109-2478",
    "报表名称": "相似度特征分析管理-资产纳管-10-467325",
    "统计周期": "-统计分析-相似度特征分析管理-资产纳管-467325-010",
    "生成状态": "待处理-325",
    "生成时间": "2026-05-17 13:59:36",
    "导出次数": 1818
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "相似度特征分析管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "相似度特征分析管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "相似度特征分析管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "相似度特征分析管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "相似度特征分析管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
