    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增设备在线状态识别信息", "add")'>新增设备在线状态识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改设备在线状态识别信息", "edit")'>修改设备在线状态识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除设备在线状态识别信息", "delete")'>删除设备在线状态识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询设备在线状态识别列表", "detail")'>查询设备在线状态识别列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询设备在线状态识别详情", "detail")'>查询设备在线状态识别详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入设备在线状态识别信息", "import")'>批量导入设备在线状态识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("设备在线状态识别信息导出", "export")'>设备在线状态识别信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-222923-100-1882",
    "资产名称": "设备在线状态识别管理-数据上报-01-222923",
    "资产类型": "资产资源-边界-222",
    "所属区域": "区公司-资产资源-设备在线状态识别管理-部侧联动-222923-001",
    "纳管状态": "待复核-923",
    "最近同步": "2026-05-11 14:27:35"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-222923-101-9360",
    "资产名称": "设备在线状态识别管理-自动采集-02-222923",
    "资产类型": "资产资源-部侧-222",
    "所属区域": "-资产资源-设备在线状态识别管理-扩容核查-222923-002",
    "纳管状态": "异常-923",
    "最近同步": "2026-05-10 11:46:36"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-222923-102-4278",
    "资产名称": "区公司设备在线状态识别管理-部侧联动-03-222923",
    "资产类型": "资产资源-自动化-222",
    "所属区域": "-资产资源-设备在线状态识别管理-自动采集-222923-003",
    "纳管状态": "处理中-923",
    "最近同步": "2026-05-11 13:53:17"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-222923-103-5981",
    "资产名称": "设备在线状态识别管理-自动采集-04-222923",
    "资产类型": "资产资源-自动化-222",
    "所属区域": "-资产资源-设备在线状态识别管理-资产纳管-222923-004",
    "纳管状态": "待复核-923",
    "最近同步": "2026-05-14 09:07:04"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-222923-104-2599",
    "资产名称": "设备在线状态识别管理-异常复核-05-222923",
    "资产类型": "资产资源-核心-222",
    "所属区域": "-资产资源-设备在线状态识别管理-异常复核-222923-005",
    "纳管状态": "已同步-923",
    "最近同步": "2026-05-13 14:51:13"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-222923-105-4192",
    "资产名称": "设备在线状态识别管理-自动采集-06-222923",
    "资产类型": "资产资源-自动化-222",
    "所属区域": "-资产资源-设备在线状态识别管理-数据上报-222923-006",
    "纳管状态": "已完成-923",
    "最近同步": "2026-05-11 15:38:19"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-222923-106-6325",
    "资产名称": "设备在线状态识别管理-部侧联动-07-222923",
    "资产类型": "资产资源-复核-222",
    "所属区域": "-资产资源-设备在线状态识别管理-资产纳管-222923-007",
    "纳管状态": "异常-923",
    "最近同步": "2026-05-17 14:29:05"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-222923-107-8343",
    "资产名称": "设备在线状态识别管理-扩容核查-08-222923",
    "资产类型": "资产资源-复核-222",
    "所属区域": "-资产资源-设备在线状态识别管理-扩容核查-222923-008",
    "纳管状态": "异常-923",
    "最近同步": "2026-05-13 11:40:27"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-222923-108-4260",
    "资产名称": "设备在线状态识别管理-数据上报-09-222923",
    "资产类型": "资产资源-边界-222",
    "所属区域": "-资产资源-设备在线状态识别管理-扩容核查-222923-009",
    "纳管状态": "待复核-923",
    "最近同步": "2026-05-08 08:42:45"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-222923-109-9635",
    "资产名称": "区公司设备在线状态识别管理-数据上报-10-222923",
    "资产类型": "资产资源-省侧-222",
    "所属区域": "-资产资源-设备在线状态识别管理-扩容核查-222923-010",
    "纳管状态": "待复核-923",
    "最近同步": "2026-05-10 08:07:44"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "设备在线状态识别管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "设备在线状态识别管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "设备在线状态识别管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "设备在线状态识别管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "设备在线状态识别管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
