    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加资产描述冗余审查信息", "add")'>添加资产描述冗余审查信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑资产描述冗余审查信息", "edit")'>编辑资产描述冗余审查信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产描述冗余审查信息", "delete")'>删除资产描述冗余审查信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产描述冗余审查", "detail")'>查询资产描述冗余审查</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产描述冗余审查统计", "detail")'>资产描述冗余审查统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产描述冗余审查信息下载", "export")'>资产描述冗余审查信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-787587-100-5148",
    "资产名称": "资产描述冗余审查管理-部侧联动-01-787587",
    "资产类型": "资产资源-复核-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-资产纳管-787587-001",
    "纳管状态": "待复核-587",
    "最近同步": "2026-05-25 08:23:19"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-787587-101-2191",
    "资产名称": "资产描述冗余审查管理-异常复核-02-787587",
    "资产类型": "资产资源-边界-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-扩容核查-787587-002",
    "纳管状态": "已同步-587",
    "最近同步": "2026-05-16 11:32:03"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-787587-102-9672",
    "资产名称": "资产描述冗余审查管理-异常复核-03-787587",
    "资产类型": "资产资源-核心-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-资产纳管-787587-003",
    "纳管状态": "待处理-587",
    "最近同步": "2026-05-20 08:44:33"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-787587-103-7915",
    "资产名称": "资产描述冗余审查管理-自动采集-04-787587",
    "资产类型": "资产资源-部侧-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-扩容核查-787587-004",
    "纳管状态": "异常-587",
    "最近同步": "2026-05-12 16:45:13"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-787587-104-2111",
    "资产名称": "区公司资产描述冗余审查管理-数据上报-05-787587",
    "资产类型": "资产资源-核心-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-异常复核-787587-005",
    "纳管状态": "已同步-587",
    "最近同步": "2026-05-24 17:53:50"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-787587-105-8770",
    "资产名称": "资产描述冗余审查管理-数据上报-06-787587",
    "资产类型": "资产资源-边界-787",
    "所属区域": "区公司-资产资源-资产描述冗余审查管理-部侧联动-787587-006",
    "纳管状态": "待复核-587",
    "最近同步": "2026-05-20 08:32:23"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-787587-106-4016",
    "资产名称": "资产描述冗余审查管理-扩容核查-07-787587",
    "资产类型": "资产资源-部侧-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-资产纳管-787587-007",
    "纳管状态": "已完成-587",
    "最近同步": "2026-05-15 08:41:37"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-787587-107-7937",
    "资产名称": "区公司资产描述冗余审查管理-自动采集-08-787587",
    "资产类型": "资产资源-复核-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-扩容核查-787587-008",
    "纳管状态": "待复核-587",
    "最近同步": "2026-05-14 13:07:55"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-787587-108-7100",
    "资产名称": "资产描述冗余审查管理-部侧联动-09-787587",
    "资产类型": "资产资源-部侧-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-部侧联动-787587-009",
    "纳管状态": "异常-587",
    "最近同步": "2026-05-12 14:11:16"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-787587-109-2124",
    "资产名称": "资产描述冗余审查管理-资产纳管-10-787587",
    "资产类型": "资产资源-省侧-787",
    "所属区域": "-资产资源-资产描述冗余审查管理-扩容核查-787587-010",
    "纳管状态": "异常-587",
    "最近同步": "2026-05-21 16:36:37"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产描述冗余审查管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产描述冗余审查管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产描述冗余审查管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产描述冗余审查管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产描述冗余审查管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
