    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增部侧扫描数据清洗任务", "add")'>新增部侧扫描数据清洗任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧扫描数据清洗任务", "delete")'>删除部侧扫描数据清洗任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改部侧扫描数据清洗任务", "edit")'>修改部侧扫描数据清洗任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧扫描数据清洗任务", "detail")'>查询部侧扫描数据清洗任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("部侧扫描数据清洗任务启用/禁用", "operation")'>部侧扫描数据清洗任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描数据清洗告警", "analysis")'>部侧扫描数据清洗告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描数据清洗结果统计", "analysis")'>部侧扫描数据清洗结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("部侧扫描数据清洗数据提取", "operation")'>部侧扫描数据清洗数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描数据清洗运行分析", "analysis")'>部侧扫描数据清洗运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧扫描数据清洗分析结果展示", "detail")'>部侧扫描数据清洗分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧扫描数据清洗分析结果下载", "export")'>部侧扫描数据清洗分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描数据清洗分析结果上报", "analysis")'>部侧扫描数据清洗分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-738434-100-8828",
    "扫描对象": "区公司部侧扫描数据清洗任务管理-数据上报-01-738434",
    "扫描节点": "节点-04-34",
    "资产数量": 1325,
    "异常数量": 3700,
    "扫描状态": "异常-434"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-738434-101-2784",
    "扫描对象": "部侧扫描数据清洗任务管理-扩容核查-02-738434",
    "扫描节点": "节点-07-34",
    "资产数量": 1201,
    "异常数量": 2403,
    "扫描状态": "待复核-434"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-738434-102-5024",
    "扫描对象": "部侧扫描数据清洗任务管理-资产纳管-03-738434",
    "扫描节点": "节点-04-34",
    "资产数量": 1272,
    "异常数量": 3779,
    "扫描状态": "待处理-434"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-738434-103-3245",
    "扫描对象": "区公司部侧扫描数据清洗任务管理-数据上报-04-738434",
    "扫描节点": "区公司节点-03-34",
    "资产数量": 2162,
    "异常数量": 2664,
    "扫描状态": "已同步-434"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-738434-104-5144",
    "扫描对象": "部侧扫描数据清洗任务管理-资产纳管-05-738434",
    "扫描节点": "节点-01-34",
    "资产数量": 994,
    "异常数量": 409,
    "扫描状态": "异常-434"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-738434-105-6298",
    "扫描对象": "部侧扫描数据清洗任务管理-资产纳管-06-738434",
    "扫描节点": "区公司节点-03-34",
    "资产数量": 4221,
    "异常数量": 518,
    "扫描状态": "待复核-434"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-738434-106-6403",
    "扫描对象": "部侧扫描数据清洗任务管理-自动采集-07-738434",
    "扫描节点": "节点-07-34",
    "资产数量": 3901,
    "异常数量": 1056,
    "扫描状态": "已完成-434"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-738434-107-1825",
    "扫描对象": "部侧扫描数据清洗任务管理-扩容核查-08-738434",
    "扫描节点": "区公司节点-04-34",
    "资产数量": 815,
    "异常数量": 4723,
    "扫描状态": "待处理-434"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-738434-108-8949",
    "扫描对象": "部侧扫描数据清洗任务管理-扩容核查-09-738434",
    "扫描节点": "节点-06-34",
    "资产数量": 3480,
    "异常数量": 2006,
    "扫描状态": "待处理-434"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-738434-109-9340",
    "扫描对象": "区公司部侧扫描数据清洗任务管理-自动采集-10-738434",
    "扫描节点": "节点-08-34",
    "资产数量": 1548,
    "异常数量": 576,
    "扫描状态": "处理中-434"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧扫描数据清洗任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧扫描数据清洗任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧扫描数据清洗任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧扫描数据清洗任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧扫描数据清洗任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
