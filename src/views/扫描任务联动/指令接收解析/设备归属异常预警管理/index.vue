    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("设备归属异常预警", "analysis")'>设备归属异常预警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("设备归属异常预警结果查看", "detail")'>设备归属异常预警结果查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("设备归属异常预警结果修改", "edit")'>设备归属异常预警结果修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("设备归属异常预警结果删除", "delete")'>设备归属异常预警结果删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("设备归属异常预警结果统计", "analysis")'>设备归属异常预警结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("设备归属异常预警结果推送", "analysis")'>设备归属异常预警结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("设备归属异常预警结果归档", "analysis")'>设备归属异常预警结果归档</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-120568-100-2893",
    "资产名称": "设备归属异常预警管理-数据上报-01-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "-资产资源-设备归属异常预警管理-资产纳管-120568-001",
    "纳管状态": "待处理-568",
    "最近同步": "2026-05-10 17:52:52"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-120568-101-7473",
    "资产名称": "设备归属异常预警管理-资产纳管-02-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "区公司-资产资源-设备归属异常预警管理-数据上报-120568-002",
    "纳管状态": "已完成-568",
    "最近同步": "2026-05-15 09:19:45"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-120568-102-4323",
    "资产名称": "区公司设备归属异常预警管理-资产纳管-03-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "-资产资源-设备归属异常预警管理-自动采集-120568-003",
    "纳管状态": "待复核-568",
    "最近同步": "2026-05-12 09:52:02"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-120568-103-7152",
    "资产名称": "设备归属异常预警管理-数据上报-04-120568",
    "资产类型": "资产资源-省侧-120",
    "所属区域": "-资产资源-设备归属异常预警管理-部侧联动-120568-004",
    "纳管状态": "已同步-568",
    "最近同步": "2026-05-19 12:41:08"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-120568-104-9754",
    "资产名称": "设备归属异常预警管理-异常复核-05-120568",
    "资产类型": "资产资源-复核-120",
    "所属区域": "-资产资源-设备归属异常预警管理-资产纳管-120568-005",
    "纳管状态": "待处理-568",
    "最近同步": "2026-05-17 12:54:48"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-120568-105-3803",
    "资产名称": "设备归属异常预警管理-资产纳管-06-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "-资产资源-设备归属异常预警管理-扩容核查-120568-006",
    "纳管状态": "处理中-568",
    "最近同步": "2026-05-19 14:28:21"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-120568-106-9058",
    "资产名称": "设备归属异常预警管理-自动采集-07-120568",
    "资产类型": "资产资源-核心-120",
    "所属区域": "-资产资源-设备归属异常预警管理-数据上报-120568-007",
    "纳管状态": "异常-568",
    "最近同步": "2026-05-21 13:20:24"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-120568-107-7269",
    "资产名称": "区公司设备归属异常预警管理-异常复核-08-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "区公司-资产资源-设备归属异常预警管理-扩容核查-120568-008",
    "纳管状态": "处理中-568",
    "最近同步": "2026-05-20 13:59:11"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-120568-108-8298",
    "资产名称": "区公司设备归属异常预警管理-数据上报-09-120568",
    "资产类型": "资产资源-省侧-120",
    "所属区域": "-资产资源-设备归属异常预警管理-数据上报-120568-009",
    "纳管状态": "已完成-568",
    "最近同步": "2026-05-25 16:38:46"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-120568-109-7000",
    "资产名称": "设备归属异常预警管理-数据上报-10-120568",
    "资产类型": "资产资源-边界-120",
    "所属区域": "-资产资源-设备归属异常预警管理-部侧联动-120568-010",
    "纳管状态": "异常-568",
    "最近同步": "2026-05-15 10:56:13"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "设备归属异常预警管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "设备归属异常预警管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "设备归属异常预警管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "设备归属异常预警管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "设备归属异常预警管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
