    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源异常监控", "add")'>新增虚拟资源异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源异常监控", "delete")'>删除虚拟资源异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源异常监控", "edit")'>修改虚拟资源异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源异常监控", "detail")'>查询虚拟资源异常监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控启用/禁用", "detail")'>虚拟资源异常监控启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控运行效果评估", "detail")'>虚拟资源异常监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控分析", "detail")'>虚拟资源异常监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控分析结果展示", "detail")'>虚拟资源异常监控分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源异常监控分析结果下载", "export")'>虚拟资源异常监控分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源异常监控分析结果上报", "detail")'>虚拟资源异常监控分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-244209-100-8618",
    "资产名称": "区公司虚拟资源异常监控-部侧联动-01-244209",
    "资产类型": "资产资源-部侧-244",
    "所属区域": "-资产资源-虚拟资源异常监控-自动采集-244209-001",
    "纳管状态": "处理中-209",
    "最近同步": "2026-05-13 11:51:53"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-244209-101-5422",
    "资产名称": "虚拟资源异常监控-数据上报-02-244209",
    "资产类型": "资产资源-核心-244",
    "所属区域": "区公司-资产资源-虚拟资源异常监控-扩容核查-244209-002",
    "纳管状态": "待处理-209",
    "最近同步": "2026-05-12 16:17:06"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-244209-102-3214",
    "资产名称": "虚拟资源异常监控-异常复核-03-244209",
    "资产类型": "资产资源-自动化-244",
    "所属区域": "-资产资源-虚拟资源异常监控-数据上报-244209-003",
    "纳管状态": "待处理-209",
    "最近同步": "2026-05-14 17:34:26"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-244209-103-1144",
    "资产名称": "区公司虚拟资源异常监控-扩容核查-04-244209",
    "资产类型": "资产资源-省侧-244",
    "所属区域": "-资产资源-虚拟资源异常监控-扩容核查-244209-004",
    "纳管状态": "处理中-209",
    "最近同步": "2026-05-09 08:16:07"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-244209-104-5421",
    "资产名称": "虚拟资源异常监控-部侧联动-05-244209",
    "资产类型": "资产资源-自动化-244",
    "所属区域": "-资产资源-虚拟资源异常监控-资产纳管-244209-005",
    "纳管状态": "已完成-209",
    "最近同步": "2026-05-15 14:42:10"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-244209-105-3138",
    "资产名称": "虚拟资源异常监控-部侧联动-06-244209",
    "资产类型": "资产资源-省侧-244",
    "所属区域": "区公司-资产资源-虚拟资源异常监控-扩容核查-244209-006",
    "纳管状态": "待处理-209",
    "最近同步": "2026-05-16 13:15:19"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-244209-106-2891",
    "资产名称": "虚拟资源异常监控-扩容核查-07-244209",
    "资产类型": "资产资源-自动化-244",
    "所属区域": "-资产资源-虚拟资源异常监控-自动采集-244209-007",
    "纳管状态": "待复核-209",
    "最近同步": "2026-05-23 15:46:42"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-244209-107-2005",
    "资产名称": "虚拟资源异常监控-扩容核查-08-244209",
    "资产类型": "资产资源-自动化-244",
    "所属区域": "-资产资源-虚拟资源异常监控-资产纳管-244209-008",
    "纳管状态": "待处理-209",
    "最近同步": "2026-05-25 15:37:26"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-244209-108-1770",
    "资产名称": "虚拟资源异常监控-扩容核查-09-244209",
    "资产类型": "资产资源-省侧-244",
    "所属区域": "区公司-资产资源-虚拟资源异常监控-异常复核-244209-009",
    "纳管状态": "异常-209",
    "最近同步": "2026-05-22 15:06:07"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-244209-109-4519",
    "资产名称": "虚拟资源异常监控-数据上报-10-244209",
    "资产类型": "资产资源-自动化-244",
    "所属区域": "-资产资源-虚拟资源异常监控-数据上报-244209-010",
    "纳管状态": "处理中-209",
    "最近同步": "2026-05-20 17:47:31"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源异常监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源异常监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源异常监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源异常监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源异常监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
