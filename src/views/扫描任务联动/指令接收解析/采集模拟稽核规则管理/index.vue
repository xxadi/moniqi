    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集模拟稽核规则", "add")'>新增采集模拟稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集模拟稽核规则", "edit")'>修改采集模拟稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集模拟稽核规则", "delete")'>删除采集模拟稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集模拟稽核规则", "add")'>查询采集模拟稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集模拟稽核规则启用/禁用", "add")'>采集模拟稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集模拟稽核规则运行效果评估", "add")'>采集模拟稽核规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集模拟稽核规则分析", "add")'>采集模拟稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集模拟稽核规则分析结果展示", "add")'>采集模拟稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集模拟稽核规则分析结果下载", "export")'>采集模拟稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集模拟稽核规则分析结果上报", "add")'>采集模拟稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-839824-100-4970",
    "规则名称": "采集模拟稽核规则管理-自动采集-01-839824",
    "规则类型": "规则策略-核心-839",
    "启用状态": "异常-824",
    "命中次数": 2182,
    "更新时间": "2026-05-14 10:34:47"
  },
  {
    "ID": 2,
    "规则编号": "RULE-839824-101-5812",
    "规则名称": "采集模拟稽核规则管理-资产纳管-02-839824",
    "规则类型": "规则策略-复核-839",
    "启用状态": "已同步-824",
    "命中次数": 2891,
    "更新时间": "2026-05-10 09:05:40"
  },
  {
    "ID": 3,
    "规则编号": "RULE-839824-102-4998",
    "规则名称": "区公司采集模拟稽核规则管理-数据上报-03-839824",
    "规则类型": "规则策略-边界-839",
    "启用状态": "异常-824",
    "命中次数": 3017,
    "更新时间": "2026-05-18 16:47:27"
  },
  {
    "ID": 4,
    "规则编号": "RULE-839824-103-1720",
    "规则名称": "采集模拟稽核规则管理-资产纳管-04-839824",
    "规则类型": "规则策略-边界-839",
    "启用状态": "异常-824",
    "命中次数": 3282,
    "更新时间": "2026-05-21 14:48:48"
  },
  {
    "ID": 5,
    "规则编号": "RULE-839824-104-5850",
    "规则名称": "采集模拟稽核规则管理-异常复核-05-839824",
    "规则类型": "规则策略-复核-839",
    "启用状态": "异常-824",
    "命中次数": 1127,
    "更新时间": "2026-05-18 15:43:36"
  },
  {
    "ID": 6,
    "规则编号": "RULE-839824-105-4155",
    "规则名称": "采集模拟稽核规则管理-扩容核查-06-839824",
    "规则类型": "规则策略-核心-839",
    "启用状态": "待复核-824",
    "命中次数": 2290,
    "更新时间": "2026-05-22 16:48:35"
  },
  {
    "ID": 7,
    "规则编号": "RULE-839824-106-5323",
    "规则名称": "采集模拟稽核规则管理-异常复核-07-839824",
    "规则类型": "规则策略-自动化-839",
    "启用状态": "处理中-824",
    "命中次数": 2018,
    "更新时间": "2026-05-10 16:20:36"
  },
  {
    "ID": 8,
    "规则编号": "RULE-839824-107-1819",
    "规则名称": "采集模拟稽核规则管理-自动采集-08-839824",
    "规则类型": "规则策略-复核-839",
    "启用状态": "已同步-824",
    "命中次数": 2371,
    "更新时间": "2026-05-08 14:15:09"
  },
  {
    "ID": 9,
    "规则编号": "RULE-839824-108-6689",
    "规则名称": "采集模拟稽核规则管理-扩容核查-09-839824",
    "规则类型": "规则策略-边界-839",
    "启用状态": "待处理-824",
    "命中次数": 2658,
    "更新时间": "2026-05-22 08:44:11"
  },
  {
    "ID": 10,
    "规则编号": "RULE-839824-109-2153",
    "规则名称": "采集模拟稽核规则管理-部侧联动-10-839824",
    "规则类型": "规则策略-省侧-839",
    "启用状态": "待复核-824",
    "命中次数": 2313,
    "更新时间": "2026-05-24 15:35:50"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集模拟稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集模拟稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集模拟稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集模拟稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集模拟稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
