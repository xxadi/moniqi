    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加暴露面资产纳管对比任务", "add")'>添加暴露面资产纳管对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除暴露面资产纳管对比任务", "delete")'>删除暴露面资产纳管对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑暴露面资产纳管对比任务", "edit")'>编辑暴露面资产纳管对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询暴露面资产纳管对比任务", "add")'>查询暴露面资产纳管对比任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比任务启用/禁用", "add")'>暴露面资产纳管对比任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比告警", "add")'>暴露面资产纳管对比告警</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比结果统计", "add")'>暴露面资产纳管对比结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比数据提取", "add")'>暴露面资产纳管对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比运行分析", "add")'>暴露面资产纳管对比运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比分析结果展示", "add")'>暴露面资产纳管对比分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("暴露面资产纳管对比分析结果下载", "export")'>暴露面资产纳管对比分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管对比分析结果上报", "add")'>暴露面资产纳管对比分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-016839-100-3490",
    "资产名称": "暴露面资产纳管对比任务管理-数据上报-01-016839",
    "资产类型": "资产资源-复核-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-部侧联动-016839-001",
    "纳管状态": "处理中-839",
    "最近同步": "2026-05-15 14:22:13"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-016839-101-3248",
    "资产名称": "暴露面资产纳管对比任务管理-资产纳管-02-016839",
    "资产类型": "资产资源-自动化-016",
    "所属区域": "区公司-资产资源-暴露面资产纳管对比任务管理-自动采集-016839-002",
    "纳管状态": "待处理-839",
    "最近同步": "2026-05-21 13:43:49"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-016839-102-1813",
    "资产名称": "区公司暴露面资产纳管对比任务管理-部侧联动-03-016839",
    "资产类型": "资产资源-边界-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-异常复核-016839-003",
    "纳管状态": "待复核-839",
    "最近同步": "2026-05-17 17:29:44"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-016839-103-8567",
    "资产名称": "暴露面资产纳管对比任务管理-数据上报-04-016839",
    "资产类型": "资产资源-复核-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-异常复核-016839-004",
    "纳管状态": "处理中-839",
    "最近同步": "2026-05-16 12:40:57"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-016839-104-2525",
    "资产名称": "暴露面资产纳管对比任务管理-部侧联动-05-016839",
    "资产类型": "资产资源-复核-016",
    "所属区域": "区公司-资产资源-暴露面资产纳管对比任务管理-异常复核-016839-005",
    "纳管状态": "已完成-839",
    "最近同步": "2026-05-18 15:33:46"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-016839-105-5028",
    "资产名称": "暴露面资产纳管对比任务管理-自动采集-06-016839",
    "资产类型": "资产资源-边界-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-异常复核-016839-006",
    "纳管状态": "处理中-839",
    "最近同步": "2026-05-19 13:14:13"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-016839-106-7159",
    "资产名称": "暴露面资产纳管对比任务管理-数据上报-07-016839",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-数据上报-016839-007",
    "纳管状态": "待复核-839",
    "最近同步": "2026-05-08 12:34:33"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-016839-107-5116",
    "资产名称": "暴露面资产纳管对比任务管理-数据上报-08-016839",
    "资产类型": "资产资源-边界-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-自动采集-016839-008",
    "纳管状态": "待复核-839",
    "最近同步": "2026-05-15 11:41:11"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-016839-108-9267",
    "资产名称": "区公司暴露面资产纳管对比任务管理-扩容核查-09-016839",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "区公司-资产资源-暴露面资产纳管对比任务管理-数据上报-016839-009",
    "纳管状态": "待复核-839",
    "最近同步": "2026-05-19 16:45:09"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-016839-109-9543",
    "资产名称": "暴露面资产纳管对比任务管理-数据上报-10-016839",
    "资产类型": "资产资源-核心-016",
    "所属区域": "-资产资源-暴露面资产纳管对比任务管理-资产纳管-016839-010",
    "纳管状态": "异常-839",
    "最近同步": "2026-05-09 09:44:22"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "暴露面资产纳管对比任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "暴露面资产纳管对比任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "暴露面资产纳管对比任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "暴露面资产纳管对比任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "暴露面资产纳管对比任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "暴露面资产纳管对比任务管理" },
