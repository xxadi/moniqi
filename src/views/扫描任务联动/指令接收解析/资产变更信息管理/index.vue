    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("新增资产变更信息", "edit")'>新增资产变更信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产变更信息", "edit")'>修改资产变更信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产变更信息", "delete")'>删除资产变更信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查询资产变更信息列表", "edit")'>查询资产变更信息列表</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查询资产变更信息详情", "edit")'>查询资产变更信息详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入资产变更信息", "import")'>批量导入资产变更信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产变更信息导出", "export")'>资产变更信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-535182-100-4242",
    "资产名称": "资产变更信息管理-扩容核查-01-535182",
    "资产类型": "资产资源-边界-535",
    "所属区域": "-资产资源-资产变更信息管理-资产纳管-535182-001",
    "纳管状态": "异常-182",
    "最近同步": "2026-05-23 15:31:22"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-535182-101-7598",
    "资产名称": "资产变更信息管理-部侧联动-02-535182",
    "资产类型": "资产资源-核心-535",
    "所属区域": "-资产资源-资产变更信息管理-数据上报-535182-002",
    "纳管状态": "已同步-182",
    "最近同步": "2026-05-08 15:23:19"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-535182-102-3653",
    "资产名称": "资产变更信息管理-资产纳管-03-535182",
    "资产类型": "资产资源-核心-535",
    "所属区域": "-资产资源-资产变更信息管理-异常复核-535182-003",
    "纳管状态": "待处理-182",
    "最近同步": "2026-05-13 10:05:06"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-535182-103-1414",
    "资产名称": "资产变更信息管理-异常复核-04-535182",
    "资产类型": "资产资源-省侧-535",
    "所属区域": "-资产资源-资产变更信息管理-数据上报-535182-004",
    "纳管状态": "已完成-182",
    "最近同步": "2026-05-21 13:01:39"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-535182-104-8612",
    "资产名称": "资产变更信息管理-部侧联动-05-535182",
    "资产类型": "资产资源-部侧-535",
    "所属区域": "-资产资源-资产变更信息管理-异常复核-535182-005",
    "纳管状态": "已同步-182",
    "最近同步": "2026-05-15 10:29:10"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-535182-105-9734",
    "资产名称": "资产变更信息管理-资产纳管-06-535182",
    "资产类型": "资产资源-边界-535",
    "所属区域": "-资产资源-资产变更信息管理-资产纳管-535182-006",
    "纳管状态": "已同步-182",
    "最近同步": "2026-05-13 13:30:43"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-535182-106-9624",
    "资产名称": "资产变更信息管理-自动采集-07-535182",
    "资产类型": "资产资源-自动化-535",
    "所属区域": "-资产资源-资产变更信息管理-异常复核-535182-007",
    "纳管状态": "异常-182",
    "最近同步": "2026-05-09 15:03:17"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-535182-107-6929",
    "资产名称": "资产变更信息管理-自动采集-08-535182",
    "资产类型": "资产资源-边界-535",
    "所属区域": "-资产资源-资产变更信息管理-数据上报-535182-008",
    "纳管状态": "异常-182",
    "最近同步": "2026-05-10 12:25:39"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-535182-108-6330",
    "资产名称": "资产变更信息管理-资产纳管-09-535182",
    "资产类型": "资产资源-核心-535",
    "所属区域": "-资产资源-资产变更信息管理-数据上报-535182-009",
    "纳管状态": "已完成-182",
    "最近同步": "2026-05-14 15:35:09"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-535182-109-4530",
    "资产名称": "资产变更信息管理-异常复核-10-535182",
    "资产类型": "资产资源-边界-535",
    "所属区域": "-资产资源-资产变更信息管理-资产纳管-535182-010",
    "纳管状态": "异常-182",
    "最近同步": "2026-05-17 14:04:43"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产变更信息管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产变更信息管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产变更信息管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产变更信息管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产变更信息管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
