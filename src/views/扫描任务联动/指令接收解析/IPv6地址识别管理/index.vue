    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv6地址识别信息", "add")'>新增IPv6地址识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv6地址识别信息", "edit")'>修改IPv6地址识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6地址识别信息", "delete")'>删除IPv6地址识别信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6地址识别", "detail")'>查询IPv6地址识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6地址识别统计", "analysis")'>IPv6地址识别统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6地址识别信息下载", "export")'>IPv6地址识别信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-520705-100-6821",
    "业务名称": "IPv6地址识别管理-扩容核查-01-520705",
    "业务类型": "业务联动-部侧-520",
    "处理状态": "异常-705",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-10 15:05:24"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-520705-101-8933",
    "业务名称": "IPv6地址识别管理-部侧联动-02-520705",
    "业务类型": "业务联动-边界-520",
    "处理状态": "异常-705",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-25 14:47:14"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-520705-102-9519",
    "业务名称": "IPv6地址识别管理-异常复核-03-520705",
    "业务类型": "业务联动-自动化-520",
    "处理状态": "异常-705",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-16 09:45:04"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-520705-103-6245",
    "业务名称": "IPv6地址识别管理-自动采集-04-520705",
    "业务类型": "业务联动-边界-520",
    "处理状态": "已完成-705",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-08 16:39:00"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-520705-104-2945",
    "业务名称": "IPv6地址识别管理-资产纳管-05-520705",
    "业务类型": "业务联动-复核-520",
    "处理状态": "待复核-705",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-14 11:26:56"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-520705-105-6954",
    "业务名称": "IPv6地址识别管理-资产纳管-06-520705",
    "业务类型": "业务联动-省侧-520",
    "处理状态": "异常-705",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-15 11:20:52"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-520705-106-6920",
    "业务名称": "IPv6地址识别管理-数据上报-07-520705",
    "业务类型": "业务联动-边界-520",
    "处理状态": "待复核-705",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-20 16:52:39"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-520705-107-3491",
    "业务名称": "IPv6地址识别管理-自动采集-08-520705",
    "业务类型": "业务联动-部侧-520",
    "处理状态": "已同步-705",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-18 10:48:36"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-520705-108-4309",
    "业务名称": "IPv6地址识别管理-部侧联动-09-520705",
    "业务类型": "业务联动-省侧-520",
    "处理状态": "处理中-705",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-11 12:54:28"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-520705-109-6783",
    "业务名称": "IPv6地址识别管理-扩容核查-10-520705",
    "业务类型": "业务联动-复核-520",
    "处理状态": "已完成-705",
    "负责人": "接口运维员-区公司",
    "更新时间": "2026-05-18 17:30:00"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6地址识别管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6地址识别管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6地址识别管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6地址识别管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6地址识别管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
