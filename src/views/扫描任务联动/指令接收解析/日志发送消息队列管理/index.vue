    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增日志发送消息队列信息", "add")'>新增日志发送消息队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改日志发送消息队列信息", "edit")'>修改日志发送消息队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除日志发送消息队列信息", "delete")'>删除日志发送消息队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询日志发送消息队列列表", "detail")'>查询日志发送消息队列列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询日志发送消息队列详情", "detail")'>查询日志发送消息队列详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入日志发送消息队列信息", "import")'>批量导入日志发送消息队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("日志发送消息队列信息导出", "export")'>日志发送消息队列信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-233330-100-4286",
    "事件类型": "监控告警-复核-233",
    "事件级别": "中",
    "关联对象": "日志发送消息队列管理-资产纳管-01-233330",
    "发生时间": "2026-05-21 13:57:58",
    "处置状态": "处理中-330"
  },
  {
    "ID": 2,
    "事件编号": "EVT-233330-101-9081",
    "事件类型": "监控告警-边界-233",
    "事件级别": "紧急",
    "关联对象": "日志发送消息队列管理-部侧联动-02-233330",
    "发生时间": "2026-05-16 12:42:02",
    "处置状态": "已完成-330"
  },
  {
    "ID": 3,
    "事件编号": "EVT-233330-102-1245",
    "事件类型": "监控告警-核心-233",
    "事件级别": "中",
    "关联对象": "日志发送消息队列管理-部侧联动-03-233330",
    "发生时间": "2026-05-15 10:03:47",
    "处置状态": "待复核-330"
  },
  {
    "ID": 4,
    "事件编号": "EVT-233330-103-6889",
    "事件类型": "监控告警-省侧-233",
    "事件级别": "中",
    "关联对象": "日志发送消息队列管理-数据上报-04-233330",
    "发生时间": "2026-05-12 09:54:26",
    "处置状态": "待处理-330"
  },
  {
    "ID": 5,
    "事件编号": "EVT-233330-104-3075",
    "事件类型": "监控告警-核心-233",
    "事件级别": "低",
    "关联对象": "日志发送消息队列管理-自动采集-05-233330",
    "发生时间": "2026-05-24 14:40:45",
    "处置状态": "已同步-330"
  },
  {
    "ID": 6,
    "事件编号": "EVT-233330-105-9353",
    "事件类型": "监控告警-边界-233",
    "事件级别": "一般",
    "关联对象": "日志发送消息队列管理-异常复核-06-233330",
    "发生时间": "2026-05-16 09:22:14",
    "处置状态": "异常-330"
  },
  {
    "ID": 7,
    "事件编号": "EVT-233330-106-2244",
    "事件类型": "监控告警-核心-233",
    "事件级别": "低",
    "关联对象": "日志发送消息队列管理-数据上报-07-233330",
    "发生时间": "2026-05-20 15:41:58",
    "处置状态": "已同步-330"
  },
  {
    "ID": 8,
    "事件编号": "EVT-233330-107-1067",
    "事件类型": "监控告警-部侧-233",
    "事件级别": "紧急",
    "关联对象": "日志发送消息队列管理-异常复核-08-233330",
    "发生时间": "2026-05-16 14:45:43",
    "处置状态": "待复核-330"
  },
  {
    "ID": 9,
    "事件编号": "EVT-233330-108-4475",
    "事件类型": "监控告警-省侧-233",
    "事件级别": "低",
    "关联对象": "区公司日志发送消息队列管理-资产纳管-09-233330",
    "发生时间": "2026-05-12 08:20:58",
    "处置状态": "待复核-330"
  },
  {
    "ID": 10,
    "事件编号": "EVT-233330-109-2428",
    "事件类型": "监控告警-边界-233",
    "事件级别": "低",
    "关联对象": "日志发送消息队列管理-资产纳管-10-233330",
    "发生时间": "2026-05-25 17:36:53",
    "处置状态": "待处理-330"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "日志发送消息队列管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "日志发送消息队列管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "日志发送消息队列管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "日志发送消息队列管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "日志发送消息队列管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
