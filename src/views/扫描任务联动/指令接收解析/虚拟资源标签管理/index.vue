    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源标签信息", "add")'>新增虚拟资源标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源标签信息", "edit")'>修改虚拟资源标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源标签信息", "delete")'>删除虚拟资源标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源标签列表", "detail")'>查询虚拟资源标签列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源标签详情", "detail")'>查询虚拟资源标签详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资源标签信息", "import")'>批量导入虚拟资源标签信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源标签信息导出", "export")'>虚拟资源标签信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-303897-100-2600",
    "资产名称": "虚拟资源标签管理-资产纳管-01-303897",
    "资产类型": "资产资源-复核-303",
    "所属区域": "-资产资源-虚拟资源标签管理-异常复核-303897-001",
    "纳管状态": "处理中-897",
    "最近同步": "2026-05-24 13:07:23"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-303897-101-6998",
    "资产名称": "虚拟资源标签管理-异常复核-02-303897",
    "资产类型": "资产资源-复核-303",
    "所属区域": "区公司-资产资源-虚拟资源标签管理-部侧联动-303897-002",
    "纳管状态": "已完成-897",
    "最近同步": "2026-05-12 11:41:07"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-303897-102-2780",
    "资产名称": "虚拟资源标签管理-异常复核-03-303897",
    "资产类型": "资产资源-部侧-303",
    "所属区域": "-资产资源-虚拟资源标签管理-数据上报-303897-003",
    "纳管状态": "已完成-897",
    "最近同步": "2026-05-08 13:51:13"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-303897-103-7597",
    "资产名称": "虚拟资源标签管理-数据上报-04-303897",
    "资产类型": "资产资源-自动化-303",
    "所属区域": "-资产资源-虚拟资源标签管理-资产纳管-303897-004",
    "纳管状态": "异常-897",
    "最近同步": "2026-05-13 10:46:58"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-303897-104-8632",
    "资产名称": "区公司虚拟资源标签管理-自动采集-05-303897",
    "资产类型": "资产资源-自动化-303",
    "所属区域": "-资产资源-虚拟资源标签管理-扩容核查-303897-005",
    "纳管状态": "异常-897",
    "最近同步": "2026-05-11 12:30:04"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-303897-105-3078",
    "资产名称": "虚拟资源标签管理-自动采集-06-303897",
    "资产类型": "资产资源-复核-303",
    "所属区域": "-资产资源-虚拟资源标签管理-数据上报-303897-006",
    "纳管状态": "已同步-897",
    "最近同步": "2026-05-17 09:53:36"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-303897-106-6466",
    "资产名称": "虚拟资源标签管理-资产纳管-07-303897",
    "资产类型": "资产资源-核心-303",
    "所属区域": "-资产资源-虚拟资源标签管理-扩容核查-303897-007",
    "纳管状态": "已完成-897",
    "最近同步": "2026-05-15 11:57:11"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-303897-107-5672",
    "资产名称": "虚拟资源标签管理-资产纳管-08-303897",
    "资产类型": "资产资源-省侧-303",
    "所属区域": "-资产资源-虚拟资源标签管理-自动采集-303897-008",
    "纳管状态": "待复核-897",
    "最近同步": "2026-05-13 13:50:57"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-303897-108-8544",
    "资产名称": "区公司虚拟资源标签管理-资产纳管-09-303897",
    "资产类型": "资产资源-自动化-303",
    "所属区域": "-资产资源-虚拟资源标签管理-资产纳管-303897-009",
    "纳管状态": "已完成-897",
    "最近同步": "2026-05-08 09:52:16"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-303897-109-5662",
    "资产名称": "虚拟资源标签管理-自动采集-10-303897",
    "资产类型": "资产资源-部侧-303",
    "所属区域": "-资产资源-虚拟资源标签管理-数据上报-303897-010",
    "纳管状态": "已完成-897",
    "最近同步": "2026-05-13 12:19:56"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源标签管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源标签管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源标签管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源标签管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源标签管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
