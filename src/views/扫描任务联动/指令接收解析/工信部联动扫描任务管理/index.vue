    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增工信部扫描任务", "add")'>新增工信部扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除工信部扫描任务", "delete")'>删除工信部扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部扫描任务", "edit")'>修改工信部扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部扫描任务", "detail")'>查询工信部扫描任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("工信部扫描任务启用/禁用", "operation")'>工信部扫描任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增工信部联动扫描任务信息", "add")'>新增工信部联动扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部联动扫描任务信息", "edit")'>修改工信部联动扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除工信部联动扫描任务信息", "delete")'>删除工信部联动扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部联动扫描任务列表", "detail")'>查询工信部联动扫描任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部联动扫描任务详情", "detail")'>查询工信部联动扫描任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入工信部联动扫描任务信息", "import")'>批量导入工信部联动扫描任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("工信部联动扫描任务信息导出", "export")'>工信部联动扫描任务信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-506467-100-3946",
    "扫描对象": "工信部联动扫描任务管理-数据上报-01-506467",
    "扫描节点": "节点-05-67",
    "资产数量": 3230,
    "异常数量": 2783,
    "扫描状态": "已同步-467"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-506467-101-2972",
    "扫描对象": "工信部联动扫描任务管理-资产纳管-02-506467",
    "扫描节点": "区公司节点-03-67",
    "资产数量": 2149,
    "异常数量": 3006,
    "扫描状态": "异常-467"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-506467-102-8283",
    "扫描对象": "区公司工信部联动扫描任务管理-资产纳管-03-506467",
    "扫描节点": "节点-04-67",
    "资产数量": 3766,
    "异常数量": 3797,
    "扫描状态": "已完成-467"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-506467-103-5185",
    "扫描对象": "工信部联动扫描任务管理-自动采集-04-506467",
    "扫描节点": "节点-08-67",
    "资产数量": 4080,
    "异常数量": 1661,
    "扫描状态": "待复核-467"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-506467-104-1841",
    "扫描对象": "工信部联动扫描任务管理-异常复核-05-506467",
    "扫描节点": "节点-02-67",
    "资产数量": 2154,
    "异常数量": 2216,
    "扫描状态": "待复核-467"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-506467-105-5264",
    "扫描对象": "工信部联动扫描任务管理-数据上报-06-506467",
    "扫描节点": "节点-09-67",
    "资产数量": 3550,
    "异常数量": 207,
    "扫描状态": "待复核-467"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-506467-106-7136",
    "扫描对象": "工信部联动扫描任务管理-扩容核查-07-506467",
    "扫描节点": "节点-08-67",
    "资产数量": 86,
    "异常数量": 3907,
    "扫描状态": "异常-467"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-506467-107-2621",
    "扫描对象": "工信部联动扫描任务管理-部侧联动-08-506467",
    "扫描节点": "节点-04-67",
    "资产数量": 571,
    "异常数量": 3702,
    "扫描状态": "异常-467"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-506467-108-6795",
    "扫描对象": "工信部联动扫描任务管理-部侧联动-09-506467",
    "扫描节点": "节点-04-67",
    "资产数量": 928,
    "异常数量": 445,
    "扫描状态": "已完成-467"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-506467-109-8593",
    "扫描对象": "工信部联动扫描任务管理-部侧联动-10-506467",
    "扫描节点": "节点-07-67",
    "资产数量": 4456,
    "异常数量": 2198,
    "扫描状态": "已同步-467"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "工信部联动扫描任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "工信部联动扫描任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "工信部联动扫描任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "工信部联动扫描任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "工信部联动扫描任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
