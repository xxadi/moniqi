    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增结果上报工信部接口协议", "add")'>新增结果上报工信部接口协议</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义结果上报工信部信息", "operation")'>定义结果上报工信部信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("结果上报工信部结果监控", "detail")'>结果上报工信部结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("更新结果上报工信部接口数据", "edit")'>更新结果上报工信部接口数据</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看结果上报工信部接口请求信息", "detail")'>查看结果上报工信部接口请求信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("结果上报工信部运行监控", "detail")'>结果上报工信部运行监控</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-465904-100-6282",
    "接口名称": "结果上报工信部接口-扩容核查-01-465904",
    "对接系统": "调度中心-4659",
    "调用状态": "异常-904",
    "平均耗时": "677ms-04",
    "最近调用": "2026-05-08 15:55:47"
  },
  {
    "ID": 2,
    "接口编号": "API-465904-101-1110",
    "接口名称": "区公司结果上报工信部接口-自动采集-02-465904",
    "对接系统": "集团资产平台-4659",
    "调用状态": "待处理-904",
    "平均耗时": "186ms-04",
    "最近调用": "2026-05-16 16:13:32"
  },
  {
    "ID": 3,
    "接口编号": "API-465904-102-5065",
    "接口名称": "结果上报工信部接口-异常复核-03-465904",
    "对接系统": "调度中心-4659",
    "调用状态": "异常-904",
    "平均耗时": "201ms-04",
    "最近调用": "2026-05-14 15:04:14"
  },
  {
    "ID": 4,
    "接口编号": "API-465904-103-6549",
    "接口名称": "区公司结果上报工信部接口-数据上报-04-465904",
    "对接系统": "资产安全平台-4659",
    "调用状态": "待复核-904",
    "平均耗时": "240ms-04",
    "最近调用": "2026-05-19 13:35:35"
  },
  {
    "ID": 5,
    "接口编号": "API-465904-104-3288",
    "接口名称": "区公司结果上报工信部接口-资产纳管-05-465904",
    "对接系统": "集团资产平台-4659",
    "调用状态": "待处理-904",
    "平均耗时": "84ms-04",
    "最近调用": "2026-05-23 08:11:28"
  },
  {
    "ID": 6,
    "接口编号": "API-465904-105-8019",
    "接口名称": "结果上报工信部接口-异常复核-06-465904",
    "对接系统": "工信部对接平台-4659",
    "调用状态": "异常-904",
    "平均耗时": "648ms-04",
    "最近调用": "2026-05-15 10:03:48"
  },
  {
    "ID": 7,
    "接口编号": "API-465904-106-2264",
    "接口名称": "结果上报工信部接口-异常复核-07-465904",
    "对接系统": "资产安全平台-4659",
    "调用状态": "待复核-904",
    "平均耗时": "674ms-04",
    "最近调用": "2026-05-22 14:42:11"
  },
  {
    "ID": 8,
    "接口编号": "API-465904-107-6527",
    "接口名称": "结果上报工信部接口-自动采集-08-465904",
    "对接系统": "集团资产平台-4659",
    "调用状态": "待处理-904",
    "平均耗时": "667ms-04",
    "最近调用": "2026-05-20 09:22:58"
  },
  {
    "ID": 9,
    "接口编号": "API-465904-108-2747",
    "接口名称": "结果上报工信部接口-扩容核查-09-465904",
    "对接系统": "资产安全平台-4659",
    "调用状态": "待处理-904",
    "平均耗时": "129ms-04",
    "最近调用": "2026-05-25 13:02:40"
  },
  {
    "ID": 10,
    "接口编号": "API-465904-109-8925",
    "接口名称": "区公司结果上报工信部接口-自动采集-10-465904",
    "对接系统": "资产安全平台-4659",
    "调用状态": "已完成-904",
    "平均耗时": "356ms-04",
    "最近调用": "2026-05-21 10:05:39"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "结果上报工信部接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "结果上报工信部接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "结果上报工信部接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "结果上报工信部接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "结果上报工信部接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
