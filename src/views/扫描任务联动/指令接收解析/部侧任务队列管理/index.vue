    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增部侧任务队列信息", "add")'>新增部侧任务队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改部侧任务队列信息", "edit")'>修改部侧任务队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧任务队列信息", "delete")'>删除部侧任务队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧任务队列列表", "detail")'>查询部侧任务队列列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧任务队列详情", "detail")'>查询部侧任务队列详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入部侧任务队列信息", "import")'>批量导入部侧任务队列信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧任务队列信息导出", "export")'>部侧任务队列信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-868036-100-4584",
    "业务名称": "部侧任务队列管理-异常复核-01-868036",
    "业务类型": "业务联动-部侧-868",
    "处理状态": "异常-036",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-10 13:47:40"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-868036-101-7401",
    "业务名称": "部侧任务队列管理-资产纳管-02-868036",
    "业务类型": "业务联动-复核-868",
    "处理状态": "待复核-036",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 11:27:39"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-868036-102-4382",
    "业务名称": "部侧任务队列管理-部侧联动-03-868036",
    "业务类型": "业务联动-复核-868",
    "处理状态": "已同步-036",
    "负责人": "接口运维员-区公司",
    "更新时间": "2026-05-20 12:17:48"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-868036-103-3168",
    "业务名称": "部侧任务队列管理-自动采集-04-868036",
    "业务类型": "业务联动-省侧-868",
    "处理状态": "待处理-036",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-09 14:50:39"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-868036-104-9932",
    "业务名称": "区公司部侧任务队列管理-自动采集-05-868036",
    "业务类型": "业务联动-边界-868",
    "处理状态": "待复核-036",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-18 10:39:15"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-868036-105-4374",
    "业务名称": "部侧任务队列管理-数据上报-06-868036",
    "业务类型": "业务联动-自动化-868",
    "处理状态": "处理中-036",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-16 16:36:32"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-868036-106-2821",
    "业务名称": "部侧任务队列管理-自动采集-07-868036",
    "业务类型": "业务联动-省侧-868",
    "处理状态": "待复核-036",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-20 12:50:20"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-868036-107-2871",
    "业务名称": "部侧任务队列管理-扩容核查-08-868036",
    "业务类型": "业务联动-复核-868",
    "处理状态": "异常-036",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-21 11:08:28"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-868036-108-5352",
    "业务名称": "部侧任务队列管理-扩容核查-09-868036",
    "业务类型": "业务联动-自动化-868",
    "处理状态": "异常-036",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-22 13:00:38"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-868036-109-6265",
    "业务名称": "部侧任务队列管理-数据上报-10-868036",
    "业务类型": "业务联动-自动化-868",
    "处理状态": "异常-036",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-18 09:38:01"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧任务队列管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧任务队列管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧任务队列管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧任务队列管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧任务队列管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
