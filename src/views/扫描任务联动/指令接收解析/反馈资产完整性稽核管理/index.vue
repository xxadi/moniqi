    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增反馈资产完整性稽核信息", "add")'>新增反馈资产完整性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改反馈资产完整性稽核信息", "edit")'>修改反馈资产完整性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除反馈资产完整性稽核信息", "delete")'>删除反馈资产完整性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询反馈资产完整性稽核记录列表", "detail")'>查询反馈资产完整性稽核记录列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询反馈资产完整性稽核记录详情", "detail")'>查询反馈资产完整性稽核记录详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入反馈资产完整性稽核信息", "import")'>批量导入反馈资产完整性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("反馈资产完整性稽核信息导出", "export")'>反馈资产完整性稽核信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-487383-100-3433",
    "资产名称": "反馈资产完整性稽核管理-数据上报-01-487383",
    "资产类型": "资产资源-核心-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-资产纳管-487383-001",
    "纳管状态": "处理中-383",
    "最近同步": "2026-05-25 11:15:58"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-487383-101-1512",
    "资产名称": "反馈资产完整性稽核管理-异常复核-02-487383",
    "资产类型": "资产资源-复核-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-扩容核查-487383-002",
    "纳管状态": "处理中-383",
    "最近同步": "2026-05-19 16:45:42"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-487383-102-2210",
    "资产名称": "反馈资产完整性稽核管理-数据上报-03-487383",
    "资产类型": "资产资源-自动化-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-扩容核查-487383-003",
    "纳管状态": "异常-383",
    "最近同步": "2026-05-19 08:40:31"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-487383-103-1432",
    "资产名称": "区公司反馈资产完整性稽核管理-自动采集-04-487383",
    "资产类型": "资产资源-省侧-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-扩容核查-487383-004",
    "纳管状态": "处理中-383",
    "最近同步": "2026-05-14 10:41:54"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-487383-104-8710",
    "资产名称": "反馈资产完整性稽核管理-部侧联动-05-487383",
    "资产类型": "资产资源-自动化-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-异常复核-487383-005",
    "纳管状态": "已完成-383",
    "最近同步": "2026-05-25 14:03:58"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-487383-105-8345",
    "资产名称": "反馈资产完整性稽核管理-自动采集-06-487383",
    "资产类型": "资产资源-复核-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-资产纳管-487383-006",
    "纳管状态": "待处理-383",
    "最近同步": "2026-05-09 11:57:04"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-487383-106-4983",
    "资产名称": "反馈资产完整性稽核管理-部侧联动-07-487383",
    "资产类型": "资产资源-核心-487",
    "所属区域": "区公司-资产资源-反馈资产完整性稽核管理-资产纳管-487383-007",
    "纳管状态": "处理中-383",
    "最近同步": "2026-05-12 10:20:28"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-487383-107-3795",
    "资产名称": "反馈资产完整性稽核管理-扩容核查-08-487383",
    "资产类型": "资产资源-边界-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-扩容核查-487383-008",
    "纳管状态": "异常-383",
    "最近同步": "2026-05-14 12:56:13"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-487383-108-8219",
    "资产名称": "反馈资产完整性稽核管理-自动采集-09-487383",
    "资产类型": "资产资源-省侧-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-部侧联动-487383-009",
    "纳管状态": "待处理-383",
    "最近同步": "2026-05-23 13:14:33"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-487383-109-5965",
    "资产名称": "反馈资产完整性稽核管理-部侧联动-10-487383",
    "资产类型": "资产资源-核心-487",
    "所属区域": "-资产资源-反馈资产完整性稽核管理-异常复核-487383-010",
    "纳管状态": "待复核-383",
    "最近同步": "2026-05-20 13:27:03"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "反馈资产完整性稽核管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "反馈资产完整性稽核管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "反馈资产完整性稽核管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "反馈资产完整性稽核管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "反馈资产完整性稽核管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
