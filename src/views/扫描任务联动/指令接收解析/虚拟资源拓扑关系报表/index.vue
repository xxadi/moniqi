    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源拓扑关系信息", "add")'>新增虚拟资源拓扑关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源拓扑关系信息", "edit")'>修改虚拟资源拓扑关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源拓扑关系信息", "delete")'>删除虚拟资源拓扑关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看虚拟资源拓扑关系信息", "detail")'>查看虚拟资源拓扑关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源拓扑关系数据提取", "operation")'>虚拟资源拓扑关系数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源拓扑关系数据识别", "analysis")'>虚拟资源拓扑关系数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源拓扑关系清洗", "operation")'>虚拟资源拓扑关系清洗</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源拓扑关系分级", "operation")'>虚拟资源拓扑关系分级</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源拓扑关系实时计算", "operation")'>虚拟资源拓扑关系实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源拓扑关系聚合", "operation")'>虚拟资源拓扑关系聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源拓扑关系信息导出", "export")'>虚拟资源拓扑关系信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源拓扑关系可视化展示", "detail")'>虚拟资源拓扑关系可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源拓扑关系数据审查", "detail")'>虚拟资源拓扑关系数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-576032-100-1321",
    "资产名称": "虚拟资源拓扑关系报表-部侧联动-01-576032",
    "资产类型": "资产资源-边界-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-数据上报-576032-001",
    "纳管状态": "待处理-032",
    "最近同步": "2026-05-24 08:09:15"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-576032-101-5381",
    "资产名称": "虚拟资源拓扑关系报表-自动采集-02-576032",
    "资产类型": "资产资源-复核-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-资产纳管-576032-002",
    "纳管状态": "已同步-032",
    "最近同步": "2026-05-17 14:50:38"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-576032-102-7184",
    "资产名称": "虚拟资源拓扑关系报表-扩容核查-03-576032",
    "资产类型": "资产资源-省侧-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-资产纳管-576032-003",
    "纳管状态": "处理中-032",
    "最近同步": "2026-05-20 17:16:52"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-576032-103-7028",
    "资产名称": "虚拟资源拓扑关系报表-部侧联动-04-576032",
    "资产类型": "资产资源-复核-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-资产纳管-576032-004",
    "纳管状态": "已完成-032",
    "最近同步": "2026-05-13 17:52:33"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-576032-104-4928",
    "资产名称": "虚拟资源拓扑关系报表-部侧联动-05-576032",
    "资产类型": "资产资源-部侧-576",
    "所属区域": "区公司-资产资源-虚拟资源拓扑关系报表-自动采集-576032-005",
    "纳管状态": "异常-032",
    "最近同步": "2026-05-19 11:25:06"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-576032-105-2193",
    "资产名称": "虚拟资源拓扑关系报表-数据上报-06-576032",
    "资产类型": "资产资源-核心-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-扩容核查-576032-006",
    "纳管状态": "待处理-032",
    "最近同步": "2026-05-19 13:48:27"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-576032-106-8568",
    "资产名称": "虚拟资源拓扑关系报表-异常复核-07-576032",
    "资产类型": "资产资源-边界-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-自动采集-576032-007",
    "纳管状态": "待复核-032",
    "最近同步": "2026-05-18 10:59:23"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-576032-107-1099",
    "资产名称": "虚拟资源拓扑关系报表-资产纳管-08-576032",
    "资产类型": "资产资源-复核-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-自动采集-576032-008",
    "纳管状态": "待复核-032",
    "最近同步": "2026-05-16 15:53:09"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-576032-108-8795",
    "资产名称": "虚拟资源拓扑关系报表-数据上报-09-576032",
    "资产类型": "资产资源-省侧-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-扩容核查-576032-009",
    "纳管状态": "异常-032",
    "最近同步": "2026-05-21 12:59:56"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-576032-109-8537",
    "资产名称": "虚拟资源拓扑关系报表-扩容核查-10-576032",
    "资产类型": "资产资源-复核-576",
    "所属区域": "-资产资源-虚拟资源拓扑关系报表-自动采集-576032-010",
    "纳管状态": "已同步-032",
    "最近同步": "2026-05-11 09:43:57"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源拓扑关系报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源拓扑关系报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源拓扑关系报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源拓扑关系报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源拓扑关系报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
