    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增三方资源库信息", "add")'>新增三方资源库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改三方资源库信息", "edit")'>修改三方资源库信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除三方资源库信息", "delete")'>删除三方资源库信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询三方资源库列表", "detail")'>查询三方资源库列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询三方资源库详情", "detail")'>查询三方资源库详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入三方资源库信息", "import")'>批量导入三方资源库信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("三方资源库信息导出", "export")'>三方资源库信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-170968-100-1958",
    "资产名称": "三方资源库管理-异常复核-01-170968",
    "资产类型": "资产资源-部侧-170",
    "所属区域": "-资产资源-三方资源库管理-扩容核查-170968-001",
    "纳管状态": "处理中-968",
    "最近同步": "2026-05-21 16:32:39"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-170968-101-1366",
    "资产名称": "三方资源库管理-扩容核查-02-170968",
    "资产类型": "资产资源-边界-170",
    "所属区域": "-资产资源-三方资源库管理-扩容核查-170968-002",
    "纳管状态": "待复核-968",
    "最近同步": "2026-05-18 10:42:54"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-170968-102-3744",
    "资产名称": "三方资源库管理-数据上报-03-170968",
    "资产类型": "资产资源-复核-170",
    "所属区域": "-资产资源-三方资源库管理-数据上报-170968-003",
    "纳管状态": "处理中-968",
    "最近同步": "2026-05-23 15:23:45"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-170968-103-4432",
    "资产名称": "三方资源库管理-异常复核-04-170968",
    "资产类型": "资产资源-边界-170",
    "所属区域": "-资产资源-三方资源库管理-自动采集-170968-004",
    "纳管状态": "处理中-968",
    "最近同步": "2026-05-23 13:29:40"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-170968-104-3675",
    "资产名称": "三方资源库管理-部侧联动-05-170968",
    "资产类型": "资产资源-边界-170",
    "所属区域": "-资产资源-三方资源库管理-部侧联动-170968-005",
    "纳管状态": "待处理-968",
    "最近同步": "2026-05-23 13:47:24"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-170968-105-8388",
    "资产名称": "三方资源库管理-资产纳管-06-170968",
    "资产类型": "资产资源-复核-170",
    "所属区域": "-资产资源-三方资源库管理-数据上报-170968-006",
    "纳管状态": "异常-968",
    "最近同步": "2026-05-16 09:41:04"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-170968-106-3751",
    "资产名称": "三方资源库管理-异常复核-07-170968",
    "资产类型": "资产资源-边界-170",
    "所属区域": "-资产资源-三方资源库管理-自动采集-170968-007",
    "纳管状态": "待复核-968",
    "最近同步": "2026-05-20 12:17:06"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-170968-107-8218",
    "资产名称": "三方资源库管理-自动采集-08-170968",
    "资产类型": "资产资源-自动化-170",
    "所属区域": "-资产资源-三方资源库管理-扩容核查-170968-008",
    "纳管状态": "已完成-968",
    "最近同步": "2026-05-20 15:10:38"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-170968-108-5305",
    "资产名称": "区公司三方资源库管理-异常复核-09-170968",
    "资产类型": "资产资源-核心-170",
    "所属区域": "-资产资源-三方资源库管理-扩容核查-170968-009",
    "纳管状态": "处理中-968",
    "最近同步": "2026-05-09 12:05:46"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-170968-109-9470",
    "资产名称": "三方资源库管理-异常复核-10-170968",
    "资产类型": "资产资源-核心-170",
    "所属区域": "-资产资源-三方资源库管理-扩容核查-170968-010",
    "纳管状态": "已同步-968",
    "最近同步": "2026-05-18 15:02:30"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "三方资源库管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "三方资源库管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "三方资源库管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "三方资源库管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "三方资源库管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
