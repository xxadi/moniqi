    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产未纳管预警", "add")'>暴露面资产未纳管预警</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面资产未纳管预警记录", "edit")'>修改暴露面资产未纳管预警记录</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除暴露面资产未纳管预警记录", "delete")'>删除暴露面资产未纳管预警记录</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询暴露面资产未纳管预警记录", "add")'>查询暴露面资产未纳管预警记录</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产未纳管预警结果推送", "add")'>暴露面资产未纳管预警结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("上传暴露面资产未纳管预警记录", "import")'>上传暴露面资产未纳管预警记录</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("下载暴露面资产未纳管预警记录", "export")'>下载暴露面资产未纳管预警记录</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看暴露面资产未纳管预警信息", "add")'>查看暴露面资产未纳管预警信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-159372-100-4816",
    "资产名称": "暴露面资产未纳管预警管理-异常复核-01-159372",
    "资产类型": "资产资源-自动化-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-异常复核-159372-001",
    "纳管状态": "处理中-372",
    "最近同步": "2026-05-25 11:06:29"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-159372-101-9750",
    "资产名称": "暴露面资产未纳管预警管理-扩容核查-02-159372",
    "资产类型": "资产资源-核心-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-部侧联动-159372-002",
    "纳管状态": "待复核-372",
    "最近同步": "2026-05-23 13:36:07"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-159372-102-4058",
    "资产名称": "暴露面资产未纳管预警管理-异常复核-03-159372",
    "资产类型": "资产资源-复核-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-数据上报-159372-003",
    "纳管状态": "待处理-372",
    "最近同步": "2026-05-14 10:11:16"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-159372-103-8215",
    "资产名称": "暴露面资产未纳管预警管理-数据上报-04-159372",
    "资产类型": "资产资源-核心-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-自动采集-159372-004",
    "纳管状态": "待处理-372",
    "最近同步": "2026-05-11 14:55:30"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-159372-104-4840",
    "资产名称": "暴露面资产未纳管预警管理-资产纳管-05-159372",
    "资产类型": "资产资源-边界-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-数据上报-159372-005",
    "纳管状态": "待处理-372",
    "最近同步": "2026-05-10 13:52:29"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-159372-105-4236",
    "资产名称": "暴露面资产未纳管预警管理-异常复核-06-159372",
    "资产类型": "资产资源-边界-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-异常复核-159372-006",
    "纳管状态": "已完成-372",
    "最近同步": "2026-05-11 13:35:42"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-159372-106-2384",
    "资产名称": "区公司暴露面资产未纳管预警管理-异常复核-07-159372",
    "资产类型": "资产资源-边界-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-资产纳管-159372-007",
    "纳管状态": "处理中-372",
    "最近同步": "2026-05-22 14:35:45"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-159372-107-4310",
    "资产名称": "暴露面资产未纳管预警管理-扩容核查-08-159372",
    "资产类型": "资产资源-省侧-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-异常复核-159372-008",
    "纳管状态": "处理中-372",
    "最近同步": "2026-05-19 08:15:43"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-159372-108-4979",
    "资产名称": "暴露面资产未纳管预警管理-部侧联动-09-159372",
    "资产类型": "资产资源-复核-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-自动采集-159372-009",
    "纳管状态": "待处理-372",
    "最近同步": "2026-05-09 12:14:45"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-159372-109-6533",
    "资产名称": "暴露面资产未纳管预警管理-扩容核查-10-159372",
    "资产类型": "资产资源-部侧-159",
    "所属区域": "-资产资源-暴露面资产未纳管预警管理-部侧联动-159372-010",
    "纳管状态": "已同步-372",
    "最近同步": "2026-05-15 15:11:45"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "暴露面资产未纳管预警管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "暴露面资产未纳管预警管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "暴露面资产未纳管预警管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "暴露面资产未纳管预警管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "暴露面资产未纳管预警管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
