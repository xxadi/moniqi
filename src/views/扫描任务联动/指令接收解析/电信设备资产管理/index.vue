    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增电信设备资产信息", "add")'>新增电信设备资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改电信设备资产信息", "edit")'>修改电信设备资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除电信设备资产信息", "delete")'>删除电信设备资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询电信设备资产", "detail")'>查询电信设备资产</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("电信设备资产统计", "analysis")'>电信设备资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("电信设备资产信息下载", "export")'>电信设备资产信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-180667-100-9906",
    "资产名称": "电信设备资产管理-扩容核查-01-180667",
    "资产类型": "资产资源-自动化-180",
    "所属区域": "-资产资源-电信设备资产管理-自动采集-180667-001",
    "纳管状态": "待复核-667",
    "最近同步": "2026-05-15 13:46:20"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-180667-101-4402",
    "资产名称": "电信设备资产管理-异常复核-02-180667",
    "资产类型": "资产资源-复核-180",
    "所属区域": "-资产资源-电信设备资产管理-资产纳管-180667-002",
    "纳管状态": "处理中-667",
    "最近同步": "2026-05-09 12:21:16"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-180667-102-2595",
    "资产名称": "电信设备资产管理-扩容核查-03-180667",
    "资产类型": "资产资源-自动化-180",
    "所属区域": "-资产资源-电信设备资产管理-数据上报-180667-003",
    "纳管状态": "已完成-667",
    "最近同步": "2026-05-09 14:23:41"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-180667-103-1335",
    "资产名称": "区公司电信设备资产管理-自动采集-04-180667",
    "资产类型": "资产资源-核心-180",
    "所属区域": "-资产资源-电信设备资产管理-扩容核查-180667-004",
    "纳管状态": "处理中-667",
    "最近同步": "2026-05-20 12:20:10"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-180667-104-8896",
    "资产名称": "区公司电信设备资产管理-扩容核查-05-180667",
    "资产类型": "资产资源-自动化-180",
    "所属区域": "-资产资源-电信设备资产管理-异常复核-180667-005",
    "纳管状态": "已完成-667",
    "最近同步": "2026-05-08 08:07:15"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-180667-105-7034",
    "资产名称": "电信设备资产管理-数据上报-06-180667",
    "资产类型": "资产资源-部侧-180",
    "所属区域": "区公司-资产资源-电信设备资产管理-异常复核-180667-006",
    "纳管状态": "待复核-667",
    "最近同步": "2026-05-25 13:38:02"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-180667-106-7825",
    "资产名称": "电信设备资产管理-扩容核查-07-180667",
    "资产类型": "资产资源-自动化-180",
    "所属区域": "-资产资源-电信设备资产管理-扩容核查-180667-007",
    "纳管状态": "处理中-667",
    "最近同步": "2026-05-20 13:46:07"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-180667-107-8736",
    "资产名称": "电信设备资产管理-扩容核查-08-180667",
    "资产类型": "资产资源-自动化-180",
    "所属区域": "-资产资源-电信设备资产管理-异常复核-180667-008",
    "纳管状态": "待处理-667",
    "最近同步": "2026-05-16 13:59:46"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-180667-108-4207",
    "资产名称": "区公司电信设备资产管理-部侧联动-09-180667",
    "资产类型": "资产资源-省侧-180",
    "所属区域": "-资产资源-电信设备资产管理-资产纳管-180667-009",
    "纳管状态": "处理中-667",
    "最近同步": "2026-05-08 10:28:30"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-180667-109-5817",
    "资产名称": "电信设备资产管理-数据上报-10-180667",
    "资产类型": "资产资源-部侧-180",
    "所属区域": "-资产资源-电信设备资产管理-部侧联动-180667-010",
    "纳管状态": "异常-667",
    "最近同步": "2026-05-19 14:44:56"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "电信设备资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "电信设备资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "电信设备资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "电信设备资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "电信设备资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
