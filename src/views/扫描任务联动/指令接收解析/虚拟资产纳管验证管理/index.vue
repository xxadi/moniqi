    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资产纳管验证信息", "add")'>新增虚拟资产纳管验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资产纳管验证信息", "edit")'>修改虚拟资产纳管验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资产纳管验证信息", "delete")'>删除虚拟资产纳管验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询虚拟资产纳管验证列表", "add")'>查询虚拟资产纳管验证列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询虚拟资产纳管验证详情", "add")'>查询虚拟资产纳管验证详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资产纳管验证信息", "import")'>批量导入虚拟资产纳管验证信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资产纳管验证信息导出", "export")'>虚拟资产纳管验证信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-204862-100-9612",
    "资产名称": "虚拟资产纳管验证管理-扩容核查-01-204862",
    "资产类型": "资产资源-部侧-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-扩容核查-204862-001",
    "纳管状态": "待复核-862",
    "最近同步": "2026-05-09 14:15:04"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-204862-101-3755",
    "资产名称": "虚拟资产纳管验证管理-资产纳管-02-204862",
    "资产类型": "资产资源-省侧-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-数据上报-204862-002",
    "纳管状态": "已完成-862",
    "最近同步": "2026-05-13 11:57:38"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-204862-102-9721",
    "资产名称": "虚拟资产纳管验证管理-部侧联动-03-204862",
    "资产类型": "资产资源-省侧-204",
    "所属区域": "区公司-资产资源-虚拟资产纳管验证管理-数据上报-204862-003",
    "纳管状态": "处理中-862",
    "最近同步": "2026-05-10 16:59:28"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-204862-103-3025",
    "资产名称": "虚拟资产纳管验证管理-扩容核查-04-204862",
    "资产类型": "资产资源-边界-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-异常复核-204862-004",
    "纳管状态": "待复核-862",
    "最近同步": "2026-05-16 17:00:37"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-204862-104-2084",
    "资产名称": "区公司虚拟资产纳管验证管理-部侧联动-05-204862",
    "资产类型": "资产资源-核心-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-数据上报-204862-005",
    "纳管状态": "异常-862",
    "最近同步": "2026-05-22 11:35:47"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-204862-105-9698",
    "资产名称": "虚拟资产纳管验证管理-异常复核-06-204862",
    "资产类型": "资产资源-边界-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-异常复核-204862-006",
    "纳管状态": "已完成-862",
    "最近同步": "2026-05-19 11:57:39"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-204862-106-5527",
    "资产名称": "虚拟资产纳管验证管理-扩容核查-07-204862",
    "资产类型": "资产资源-复核-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-异常复核-204862-007",
    "纳管状态": "处理中-862",
    "最近同步": "2026-05-15 17:05:26"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-204862-107-7407",
    "资产名称": "区公司虚拟资产纳管验证管理-自动采集-08-204862",
    "资产类型": "资产资源-部侧-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-异常复核-204862-008",
    "纳管状态": "待复核-862",
    "最近同步": "2026-05-19 09:46:03"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-204862-108-9596",
    "资产名称": "虚拟资产纳管验证管理-数据上报-09-204862",
    "资产类型": "资产资源-省侧-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-部侧联动-204862-009",
    "纳管状态": "已同步-862",
    "最近同步": "2026-05-24 12:32:17"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-204862-109-3535",
    "资产名称": "虚拟资产纳管验证管理-部侧联动-10-204862",
    "资产类型": "资产资源-核心-204",
    "所属区域": "-资产资源-虚拟资产纳管验证管理-数据上报-204862-010",
    "纳管状态": "已同步-862",
    "最近同步": "2026-05-22 15:16:54"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资产纳管验证管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资产纳管验证管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资产纳管验证管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资产纳管验证管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资产纳管验证管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
