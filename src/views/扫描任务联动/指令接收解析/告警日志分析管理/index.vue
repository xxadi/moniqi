    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("定义告警日志分析信息", "analysis")'>定义告警日志分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改告警日志分析信息", "edit")'>修改告警日志分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除告警日志分析信息", "delete")'>删除告警日志分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("告警日志分析数据查看", "detail")'>告警日志分析数据查看</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("告警日志分析数据锁定", "analysis")'>告警日志分析数据锁定</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("告警日志分析数据激活", "analysis")'>告警日志分析数据激活</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询告警日志分析汇总报告详情", "detail")'>查询告警日志分析汇总报告详情</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-749821-100-2461",
    "事件类型": "监控告警-边界-749",
    "事件级别": "紧急",
    "关联对象": "告警日志分析管理-异常复核-01-749821",
    "发生时间": "2026-05-09 13:35:31",
    "处置状态": "待复核-821"
  },
  {
    "ID": 2,
    "事件编号": "EVT-749821-101-9439",
    "事件类型": "监控告警-部侧-749",
    "事件级别": "一般",
    "关联对象": "告警日志分析管理-异常复核-02-749821",
    "发生时间": "2026-05-11 10:49:46",
    "处置状态": "已同步-821"
  },
  {
    "ID": 3,
    "事件编号": "EVT-749821-102-1023",
    "事件类型": "监控告警-边界-749",
    "事件级别": "低",
    "关联对象": "告警日志分析管理-自动采集-03-749821",
    "发生时间": "2026-05-14 10:23:55",
    "处置状态": "异常-821"
  },
  {
    "ID": 4,
    "事件编号": "EVT-749821-103-6083",
    "事件类型": "监控告警-核心-749",
    "事件级别": "一般",
    "关联对象": "告警日志分析管理-扩容核查-04-749821",
    "发生时间": "2026-05-18 17:38:23",
    "处置状态": "待处理-821"
  },
  {
    "ID": 5,
    "事件编号": "EVT-749821-104-5109",
    "事件类型": "监控告警-部侧-749",
    "事件级别": "中",
    "关联对象": "告警日志分析管理-异常复核-05-749821",
    "发生时间": "2026-05-10 13:17:54",
    "处置状态": "已完成-821"
  },
  {
    "ID": 6,
    "事件编号": "EVT-749821-105-6106",
    "事件类型": "监控告警-复核-749",
    "事件级别": "一般",
    "关联对象": "告警日志分析管理-异常复核-06-749821",
    "发生时间": "2026-05-19 13:49:40",
    "处置状态": "异常-821"
  },
  {
    "ID": 7,
    "事件编号": "EVT-749821-106-1860",
    "事件类型": "监控告警-复核-749",
    "事件级别": "中",
    "关联对象": "告警日志分析管理-自动采集-07-749821",
    "发生时间": "2026-05-25 08:54:54",
    "处置状态": "待处理-821"
  },
  {
    "ID": 8,
    "事件编号": "EVT-749821-107-2727",
    "事件类型": "监控告警-复核-749",
    "事件级别": "中",
    "关联对象": "告警日志分析管理-自动采集-08-749821",
    "发生时间": "2026-05-25 09:53:47",
    "处置状态": "已完成-821"
  },
  {
    "ID": 9,
    "事件编号": "EVT-749821-108-9736",
    "事件类型": "监控告警-部侧-749",
    "事件级别": "中",
    "关联对象": "告警日志分析管理-异常复核-09-749821",
    "发生时间": "2026-05-24 10:18:05",
    "处置状态": "已完成-821"
  },
  {
    "ID": 10,
    "事件编号": "EVT-749821-109-3220",
    "事件类型": "监控告警-核心-749",
    "事件级别": "紧急",
    "关联对象": "告警日志分析管理-异常复核-10-749821",
    "发生时间": "2026-05-21 14:16:05",
    "处置状态": "待复核-821"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "告警日志分析管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "告警日志分析管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "告警日志分析管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "告警日志分析管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "告警日志分析管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
