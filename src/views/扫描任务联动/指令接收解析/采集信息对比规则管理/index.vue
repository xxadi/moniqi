    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集信息对比规则", "add")'>新增采集信息对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集信息对比规则", "edit")'>修改采集信息对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集信息对比规则", "delete")'>删除采集信息对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集信息对比规则", "add")'>查询采集信息对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比规则启用/禁用", "add")'>采集信息对比规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比监控告警", "add")'>采集信息对比监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比结果统计", "add")'>采集信息对比结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比数据提取", "add")'>采集信息对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比规则分析", "add")'>采集信息对比规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比规则分析结果展示", "add")'>采集信息对比规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集信息对比规则分析结果下载", "export")'>采集信息对比规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集信息对比规则分析结果上报", "add")'>采集信息对比规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-622984-100-5673",
    "规则名称": "采集信息对比规则管理-异常复核-01-622984",
    "规则类型": "规则策略-省侧-622",
    "启用状态": "处理中-984",
    "命中次数": 1442,
    "更新时间": "2026-05-15 17:01:57"
  },
  {
    "ID": 2,
    "规则编号": "RULE-622984-101-1933",
    "规则名称": "采集信息对比规则管理-资产纳管-02-622984",
    "规则类型": "规则策略-核心-622",
    "启用状态": "已完成-984",
    "命中次数": 3314,
    "更新时间": "2026-05-14 16:46:33"
  },
  {
    "ID": 3,
    "规则编号": "RULE-622984-102-7630",
    "规则名称": "采集信息对比规则管理-数据上报-03-622984",
    "规则类型": "规则策略-省侧-622",
    "启用状态": "异常-984",
    "命中次数": 3307,
    "更新时间": "2026-05-25 11:44:42"
  },
  {
    "ID": 4,
    "规则编号": "RULE-622984-103-5266",
    "规则名称": "采集信息对比规则管理-资产纳管-04-622984",
    "规则类型": "规则策略-边界-622",
    "启用状态": "待处理-984",
    "命中次数": 537,
    "更新时间": "2026-05-18 17:21:08"
  },
  {
    "ID": 5,
    "规则编号": "RULE-622984-104-3814",
    "规则名称": "采集信息对比规则管理-数据上报-05-622984",
    "规则类型": "规则策略-边界-622",
    "启用状态": "异常-984",
    "命中次数": 4105,
    "更新时间": "2026-05-22 10:05:15"
  },
  {
    "ID": 6,
    "规则编号": "RULE-622984-105-4175",
    "规则名称": "区公司采集信息对比规则管理-扩容核查-06-622984",
    "规则类型": "规则策略-自动化-622",
    "启用状态": "待处理-984",
    "命中次数": 3081,
    "更新时间": "2026-05-23 15:59:18"
  },
  {
    "ID": 7,
    "规则编号": "RULE-622984-106-3521",
    "规则名称": "区公司采集信息对比规则管理-数据上报-07-622984",
    "规则类型": "规则策略-边界-622",
    "启用状态": "待处理-984",
    "命中次数": 4937,
    "更新时间": "2026-05-21 12:30:40"
  },
  {
    "ID": 8,
    "规则编号": "RULE-622984-107-5815",
    "规则名称": "采集信息对比规则管理-资产纳管-08-622984",
    "规则类型": "规则策略-省侧-622",
    "启用状态": "待复核-984",
    "命中次数": 171,
    "更新时间": "2026-05-08 08:23:38"
  },
  {
    "ID": 9,
    "规则编号": "RULE-622984-108-2735",
    "规则名称": "采集信息对比规则管理-自动采集-09-622984",
    "规则类型": "规则策略-部侧-622",
    "启用状态": "异常-984",
    "命中次数": 1271,
    "更新时间": "2026-05-14 12:10:50"
  },
  {
    "ID": 10,
    "规则编号": "RULE-622984-109-3060",
    "规则名称": "采集信息对比规则管理-部侧联动-10-622984",
    "规则类型": "规则策略-省侧-622",
    "启用状态": "待处理-984",
    "命中次数": 2534,
    "更新时间": "2026-05-24 11:32:50"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集信息对比规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集信息对比规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集信息对比规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集信息对比规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集信息对比规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
