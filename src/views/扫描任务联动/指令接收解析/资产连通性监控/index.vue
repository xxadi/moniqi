    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定义资产连通性监控项", "detail")'>定义资产连通性监控项</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产连通性监控项修改", "edit")'>资产连通性监控项修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("资产连通性监控项删除", "delete")'>资产连通性监控项删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产连通性", "detail")'>查询资产连通性</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产连通性监控信息采集", "add")'>资产连通性监控信息采集</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产连通性监控", "detail")'>资产连通性监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产连通性监控数据展示", "detail")'>资产连通性监控数据展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产连通性告警", "analysis")'>资产连通性告警</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产连通性告警导出", "export")'>资产连通性告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-196934-100-1018",
    "资产名称": "资产连通性监控-部侧联动-01-196934",
    "资产类型": "资产资源-核心-196",
    "所属区域": "-资产资源-资产连通性监控-资产纳管-196934-001",
    "纳管状态": "异常-934",
    "最近同步": "2026-05-08 14:13:03"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-196934-101-5591",
    "资产名称": "资产连通性监控-异常复核-02-196934",
    "资产类型": "资产资源-部侧-196",
    "所属区域": "-资产资源-资产连通性监控-资产纳管-196934-002",
    "纳管状态": "异常-934",
    "最近同步": "2026-05-11 17:41:34"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-196934-102-3991",
    "资产名称": "资产连通性监控-资产纳管-03-196934",
    "资产类型": "资产资源-边界-196",
    "所属区域": "-资产资源-资产连通性监控-部侧联动-196934-003",
    "纳管状态": "已完成-934",
    "最近同步": "2026-05-18 15:21:03"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-196934-103-3380",
    "资产名称": "区公司资产连通性监控-扩容核查-04-196934",
    "资产类型": "资产资源-部侧-196",
    "所属区域": "-资产资源-资产连通性监控-异常复核-196934-004",
    "纳管状态": "待复核-934",
    "最近同步": "2026-05-21 10:19:09"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-196934-104-7532",
    "资产名称": "资产连通性监控-数据上报-05-196934",
    "资产类型": "资产资源-部侧-196",
    "所属区域": "区公司-资产资源-资产连通性监控-资产纳管-196934-005",
    "纳管状态": "处理中-934",
    "最近同步": "2026-05-20 09:11:08"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-196934-105-7482",
    "资产名称": "资产连通性监控-扩容核查-06-196934",
    "资产类型": "资产资源-复核-196",
    "所属区域": "区公司-资产资源-资产连通性监控-扩容核查-196934-006",
    "纳管状态": "待处理-934",
    "最近同步": "2026-05-19 17:01:51"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-196934-106-2571",
    "资产名称": "资产连通性监控-异常复核-07-196934",
    "资产类型": "资产资源-省侧-196",
    "所属区域": "-资产资源-资产连通性监控-扩容核查-196934-007",
    "纳管状态": "待复核-934",
    "最近同步": "2026-05-19 12:23:03"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-196934-107-7176",
    "资产名称": "资产连通性监控-扩容核查-08-196934",
    "资产类型": "资产资源-省侧-196",
    "所属区域": "-资产资源-资产连通性监控-自动采集-196934-008",
    "纳管状态": "已完成-934",
    "最近同步": "2026-05-19 15:25:08"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-196934-108-9838",
    "资产名称": "资产连通性监控-自动采集-09-196934",
    "资产类型": "资产资源-部侧-196",
    "所属区域": "-资产资源-资产连通性监控-部侧联动-196934-009",
    "纳管状态": "待复核-934",
    "最近同步": "2026-05-19 16:42:22"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-196934-109-6236",
    "资产名称": "区公司资产连通性监控-数据上报-10-196934",
    "资产类型": "资产资源-部侧-196",
    "所属区域": "-资产资源-资产连通性监控-自动采集-196934-010",
    "纳管状态": "已同步-934",
    "最近同步": "2026-05-10 14:04:41"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产连通性监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产连通性监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产连通性监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产连通性监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产连通性监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
