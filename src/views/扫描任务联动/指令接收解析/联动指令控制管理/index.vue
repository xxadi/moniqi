    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增联动指令控制信息", "add")'>新增联动指令控制信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改联动指令控制信息", "edit")'>修改联动指令控制信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除联动指令控制信息", "delete")'>删除联动指令控制信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询联动指令控制列表", "detail")'>查询联动指令控制列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询联动指令控制详情", "detail")'>查询联动指令控制详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入联动指令控制信息", "import")'>批量导入联动指令控制信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("联动指令控制信息导出", "export")'>联动指令控制信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-540341-100-7086",
    "业务名称": "区公司联动指令控制管理-扩容核查-01-540341",
    "业务类型": "业务联动-自动化-540",
    "处理状态": "已完成-341",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-18 14:41:20"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-540341-101-4465",
    "业务名称": "联动指令控制管理-数据上报-02-540341",
    "业务类型": "业务联动-核心-540",
    "处理状态": "处理中-341",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-08 12:11:27"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-540341-102-1078",
    "业务名称": "联动指令控制管理-异常复核-03-540341",
    "业务类型": "业务联动-自动化-540",
    "处理状态": "处理中-341",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-16 08:36:01"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-540341-103-8594",
    "业务名称": "联动指令控制管理-数据上报-04-540341",
    "业务类型": "业务联动-复核-540",
    "处理状态": "待处理-341",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-11 14:02:15"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-540341-104-9596",
    "业务名称": "联动指令控制管理-资产纳管-05-540341",
    "业务类型": "业务联动-复核-540",
    "处理状态": "处理中-341",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-20 10:23:57"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-540341-105-9467",
    "业务名称": "联动指令控制管理-部侧联动-06-540341",
    "业务类型": "业务联动-部侧-540",
    "处理状态": "已完成-341",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-19 15:46:00"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-540341-106-5463",
    "业务名称": "联动指令控制管理-扩容核查-07-540341",
    "业务类型": "业务联动-自动化-540",
    "处理状态": "已完成-341",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-17 17:43:53"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-540341-107-4549",
    "业务名称": "联动指令控制管理-数据上报-08-540341",
    "业务类型": "业务联动-自动化-540",
    "处理状态": "待复核-341",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-20 09:03:59"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-540341-108-5626",
    "业务名称": "联动指令控制管理-部侧联动-09-540341",
    "业务类型": "业务联动-复核-540",
    "处理状态": "已同步-341",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-11 13:32:54"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-540341-109-7730",
    "业务名称": "联动指令控制管理-自动采集-10-540341",
    "业务类型": "业务联动-复核-540",
    "处理状态": "待复核-341",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-21 15:03:19"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "联动指令控制管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "联动指令控制管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "联动指令控制管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "联动指令控制管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "联动指令控制管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
