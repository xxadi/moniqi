    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增纳管模拟核查规则信息", "add")'>新增纳管模拟核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改纳管模拟核查规则信息", "edit")'>修改纳管模拟核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除纳管模拟核查规则信息", "delete")'>删除纳管模拟核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询纳管模拟核查规则列表", "add")'>查询纳管模拟核查规则列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询纳管模拟核查规则详情", "add")'>查询纳管模拟核查规则详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入纳管模拟核查规则信息", "import")'>批量导入纳管模拟核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("纳管模拟核查规则信息导出", "export")'>纳管模拟核查规则信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-643667-100-9179",
    "规则名称": "纳管模拟核查规则管理-异常复核-01-643667",
    "规则类型": "规则策略-复核-643",
    "启用状态": "已完成-667",
    "命中次数": 4941,
    "更新时间": "2026-05-19 08:03:36"
  },
  {
    "ID": 2,
    "规则编号": "RULE-643667-101-5299",
    "规则名称": "纳管模拟核查规则管理-异常复核-02-643667",
    "规则类型": "规则策略-省侧-643",
    "启用状态": "处理中-667",
    "命中次数": 3202,
    "更新时间": "2026-05-22 14:27:26"
  },
  {
    "ID": 3,
    "规则编号": "RULE-643667-102-2190",
    "规则名称": "纳管模拟核查规则管理-异常复核-03-643667",
    "规则类型": "规则策略-核心-643",
    "启用状态": "待处理-667",
    "命中次数": 2713,
    "更新时间": "2026-05-14 11:02:02"
  },
  {
    "ID": 4,
    "规则编号": "RULE-643667-103-7843",
    "规则名称": "纳管模拟核查规则管理-异常复核-04-643667",
    "规则类型": "规则策略-省侧-643",
    "启用状态": "已同步-667",
    "命中次数": 3564,
    "更新时间": "2026-05-11 13:17:59"
  },
  {
    "ID": 5,
    "规则编号": "RULE-643667-104-7365",
    "规则名称": "纳管模拟核查规则管理-异常复核-05-643667",
    "规则类型": "规则策略-复核-643",
    "启用状态": "已完成-667",
    "命中次数": 4399,
    "更新时间": "2026-05-23 16:04:45"
  },
  {
    "ID": 6,
    "规则编号": "RULE-643667-105-5551",
    "规则名称": "纳管模拟核查规则管理-部侧联动-06-643667",
    "规则类型": "规则策略-复核-643",
    "启用状态": "异常-667",
    "命中次数": 1540,
    "更新时间": "2026-05-15 13:22:15"
  },
  {
    "ID": 7,
    "规则编号": "RULE-643667-106-3002",
    "规则名称": "纳管模拟核查规则管理-资产纳管-07-643667",
    "规则类型": "规则策略-部侧-643",
    "启用状态": "待复核-667",
    "命中次数": 2955,
    "更新时间": "2026-05-22 10:29:48"
  },
  {
    "ID": 8,
    "规则编号": "RULE-643667-107-2904",
    "规则名称": "区公司纳管模拟核查规则管理-自动采集-08-643667",
    "规则类型": "规则策略-边界-643",
    "启用状态": "已完成-667",
    "命中次数": 4856,
    "更新时间": "2026-05-25 11:36:16"
  },
  {
    "ID": 9,
    "规则编号": "RULE-643667-108-9685",
    "规则名称": "纳管模拟核查规则管理-资产纳管-09-643667",
    "规则类型": "规则策略-边界-643",
    "启用状态": "处理中-667",
    "命中次数": 4350,
    "更新时间": "2026-05-15 09:44:19"
  },
  {
    "ID": 10,
    "规则编号": "RULE-643667-109-7152",
    "规则名称": "纳管模拟核查规则管理-扩容核查-10-643667",
    "规则类型": "规则策略-复核-643",
    "启用状态": "已完成-667",
    "命中次数": 3407,
    "更新时间": "2026-05-20 14:13:07"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "纳管模拟核查规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "纳管模拟核查规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "纳管模拟核查规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "纳管模拟核查规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "纳管模拟核查规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
