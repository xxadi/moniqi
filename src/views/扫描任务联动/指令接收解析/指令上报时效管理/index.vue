    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增指令上报时效信息", "add")'>新增指令上报时效信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改指令上报时效信息", "edit")'>修改指令上报时效信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除指令上报时效信息", "delete")'>删除指令上报时效信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询指令上报时效信息", "detail")'>查询指令上报时效信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("指令上报时效监控", "detail")'>指令上报时效监控</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令上报时效告警", "analysis")'>指令上报时效告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("指令上报时效查看", "detail")'>指令上报时效查看</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令上报时效分析", "analysis")'>指令上报时效分析</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("指令上报时效信息导出", "export")'>指令上报时效信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增指令上报时效状态查询信息", "add")'>新增指令上报时效状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改指令上报时效状态查询信息", "edit")'>修改指令上报时效状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除指令上报时效状态查询信息", "delete")'>删除指令上报时效状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("新增指令上报时效参数设置信息", "edit")'>新增指令上报时效参数设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改指令上报时效参数设置信息", "edit")'>修改指令上报时效参数设置信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除指令上报时效参数设置信息", "delete")'>删除指令上报时效参数设置信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-996007-100-3232",
    "业务名称": "指令上报时效管理-异常复核-01-996007",
    "业务类型": "业务联动-复核-996",
    "处理状态": "待复核-007",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-11 08:54:29"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-996007-101-4859",
    "业务名称": "指令上报时效管理-异常复核-02-996007",
    "业务类型": "业务联动-核心-996",
    "处理状态": "处理中-007",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-18 08:17:04"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-996007-102-7597",
    "业务名称": "指令上报时效管理-异常复核-03-996007",
    "业务类型": "业务联动-省侧-996",
    "处理状态": "已完成-007",
    "负责人": "接口运维员-区公司",
    "更新时间": "2026-05-23 15:10:24"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-996007-103-5951",
    "业务名称": "指令上报时效管理-部侧联动-04-996007",
    "业务类型": "业务联动-部侧-996",
    "处理状态": "处理中-007",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 14:09:33"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-996007-104-5648",
    "业务名称": "区公司指令上报时效管理-数据上报-05-996007",
    "业务类型": "业务联动-部侧-996",
    "处理状态": "已同步-007",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-15 17:51:10"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-996007-105-7407",
    "业务名称": "指令上报时效管理-资产纳管-06-996007",
    "业务类型": "业务联动-边界-996",
    "处理状态": "已同步-007",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-21 16:24:52"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-996007-106-7831",
    "业务名称": "指令上报时效管理-资产纳管-07-996007",
    "业务类型": "业务联动-边界-996",
    "处理状态": "待处理-007",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-23 12:23:55"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-996007-107-2293",
    "业务名称": "指令上报时效管理-扩容核查-08-996007",
    "业务类型": "业务联动-自动化-996",
    "处理状态": "处理中-007",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-22 16:05:57"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-996007-108-3189",
    "业务名称": "区公司指令上报时效管理-数据上报-09-996007",
    "业务类型": "业务联动-核心-996",
    "处理状态": "处理中-007",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-22 17:23:54"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-996007-109-6566",
    "业务名称": "指令上报时效管理-数据上报-10-996007",
    "业务类型": "业务联动-核心-996",
    "处理状态": "已同步-007",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 12:26:14"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "指令上报时效管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "指令上报时效管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "指令上报时效管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "指令上报时效管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "指令上报时效管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
