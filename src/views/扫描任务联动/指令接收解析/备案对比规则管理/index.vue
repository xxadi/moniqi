    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增备案对比规则", "add")'>新增备案对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改备案对比规则", "edit")'>修改备案对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除备案对比规则", "delete")'>删除备案对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询备案对比规则", "detail")'>查询备案对比规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("备案对比规则启用/禁用", "operation")'>备案对比规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比告警", "analysis")'>备案对比告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比结果统计", "analysis")'>备案对比结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("备案对比数据提取", "operation")'>备案对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比规则分析", "analysis")'>备案对比规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("备案对比规则分析结果展示", "detail")'>备案对比规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("备案对比规则分析结果下载", "export")'>备案对比规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("备案对比规则分析结果上报", "analysis")'>备案对比规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-242578-100-4375",
    "规则名称": "备案对比规则管理-资产纳管-01-242578",
    "规则类型": "规则策略-边界-242",
    "启用状态": "处理中-578",
    "命中次数": 1941,
    "更新时间": "2026-05-10 14:08:18"
  },
  {
    "ID": 2,
    "规则编号": "RULE-242578-101-1844",
    "规则名称": "区公司备案对比规则管理-异常复核-02-242578",
    "规则类型": "规则策略-自动化-242",
    "启用状态": "已同步-578",
    "命中次数": 3286,
    "更新时间": "2026-05-25 08:57:39"
  },
  {
    "ID": 3,
    "规则编号": "RULE-242578-102-5176",
    "规则名称": "备案对比规则管理-自动采集-03-242578",
    "规则类型": "规则策略-边界-242",
    "启用状态": "已完成-578",
    "命中次数": 1412,
    "更新时间": "2026-05-24 09:50:20"
  },
  {
    "ID": 4,
    "规则编号": "RULE-242578-103-4882",
    "规则名称": "区公司备案对比规则管理-数据上报-04-242578",
    "规则类型": "规则策略-部侧-242",
    "启用状态": "处理中-578",
    "命中次数": 4714,
    "更新时间": "2026-05-23 15:21:01"
  },
  {
    "ID": 5,
    "规则编号": "RULE-242578-104-7007",
    "规则名称": "备案对比规则管理-数据上报-05-242578",
    "规则类型": "规则策略-省侧-242",
    "启用状态": "已同步-578",
    "命中次数": 3317,
    "更新时间": "2026-05-16 09:13:26"
  },
  {
    "ID": 6,
    "规则编号": "RULE-242578-105-8567",
    "规则名称": "备案对比规则管理-数据上报-06-242578",
    "规则类型": "规则策略-核心-242",
    "启用状态": "处理中-578",
    "命中次数": 3843,
    "更新时间": "2026-05-24 09:13:24"
  },
  {
    "ID": 7,
    "规则编号": "RULE-242578-106-4157",
    "规则名称": "区公司备案对比规则管理-资产纳管-07-242578",
    "规则类型": "规则策略-复核-242",
    "启用状态": "待处理-578",
    "命中次数": 2474,
    "更新时间": "2026-05-08 11:45:18"
  },
  {
    "ID": 8,
    "规则编号": "RULE-242578-107-6893",
    "规则名称": "备案对比规则管理-部侧联动-08-242578",
    "规则类型": "规则策略-核心-242",
    "启用状态": "已同步-578",
    "命中次数": 433,
    "更新时间": "2026-05-21 10:30:04"
  },
  {
    "ID": 9,
    "规则编号": "RULE-242578-108-6512",
    "规则名称": "备案对比规则管理-扩容核查-09-242578",
    "规则类型": "规则策略-自动化-242",
    "启用状态": "已完成-578",
    "命中次数": 4113,
    "更新时间": "2026-05-12 15:34:15"
  },
  {
    "ID": 10,
    "规则编号": "RULE-242578-109-5382",
    "规则名称": "备案对比规则管理-部侧联动-10-242578",
    "规则类型": "规则策略-省侧-242",
    "启用状态": "已完成-578",
    "命中次数": 1575,
    "更新时间": "2026-05-09 16:36:53"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "备案对比规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "备案对比规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "备案对比规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "备案对比规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "备案对比规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
