    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加部侧资产汇总信息", "add")'>添加部侧资产汇总信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑部侧资产汇总信息", "edit")'>编辑部侧资产汇总信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧资产汇总信息", "delete")'>删除部侧资产汇总信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧资产汇总信息列表", "detail")'>查询部侧资产汇总信息列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧资产汇总信息详情", "detail")'>查询部侧资产汇总信息详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入部侧资产汇总信息", "import")'>批量导入部侧资产汇总信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧资产汇总信息导出", "export")'>部侧资产汇总信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-796873-100-6229",
    "资产名称": "部侧资产汇总信息管理-部侧联动-01-796873",
    "资产类型": "资产资源-自动化-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-资产纳管-796873-001",
    "纳管状态": "已同步-873",
    "最近同步": "2026-05-17 16:17:08"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-796873-101-2386",
    "资产名称": "部侧资产汇总信息管理-资产纳管-02-796873",
    "资产类型": "资产资源-边界-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-部侧联动-796873-002",
    "纳管状态": "异常-873",
    "最近同步": "2026-05-12 08:00:06"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-796873-102-2647",
    "资产名称": "部侧资产汇总信息管理-自动采集-03-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-扩容核查-796873-003",
    "纳管状态": "已完成-873",
    "最近同步": "2026-05-15 13:43:48"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-796873-103-9954",
    "资产名称": "区公司部侧资产汇总信息管理-自动采集-04-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-异常复核-796873-004",
    "纳管状态": "待处理-873",
    "最近同步": "2026-05-21 11:43:10"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-796873-104-5660",
    "资产名称": "区公司部侧资产汇总信息管理-数据上报-05-796873",
    "资产类型": "资产资源-自动化-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-部侧联动-796873-005",
    "纳管状态": "待复核-873",
    "最近同步": "2026-05-18 14:37:21"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-796873-105-1551",
    "资产名称": "部侧资产汇总信息管理-数据上报-06-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-部侧联动-796873-006",
    "纳管状态": "处理中-873",
    "最近同步": "2026-05-25 08:06:54"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-796873-106-1597",
    "资产名称": "区公司部侧资产汇总信息管理-数据上报-07-796873",
    "资产类型": "资产资源-省侧-796",
    "所属区域": "区公司-资产资源-部侧资产汇总信息管理-扩容核查-796873-007",
    "纳管状态": "异常-873",
    "最近同步": "2026-05-19 08:04:28"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-796873-107-5566",
    "资产名称": "部侧资产汇总信息管理-部侧联动-08-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-异常复核-796873-008",
    "纳管状态": "待处理-873",
    "最近同步": "2026-05-15 09:55:53"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-796873-108-1262",
    "资产名称": "部侧资产汇总信息管理-资产纳管-09-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "-资产资源-部侧资产汇总信息管理-资产纳管-796873-009",
    "纳管状态": "已同步-873",
    "最近同步": "2026-05-24 17:28:42"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-796873-109-6555",
    "资产名称": "部侧资产汇总信息管理-异常复核-10-796873",
    "资产类型": "资产资源-复核-796",
    "所属区域": "区公司-资产资源-部侧资产汇总信息管理-扩容核查-796873-010",
    "纳管状态": "待复核-873",
    "最近同步": "2026-05-15 13:48:57"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧资产汇总信息管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧资产汇总信息管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧资产汇总信息管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧资产汇总信息管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧资产汇总信息管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
