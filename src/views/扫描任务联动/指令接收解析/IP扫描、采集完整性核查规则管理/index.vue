    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP扫描/采集完整性核查规则信息", "add")'>新增IP扫描/采集完整性核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP扫描/采集完整性核查规则信息", "edit")'>修改IP扫描/采集完整性核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP扫描/采集完整性核查规则信息", "delete")'>删除IP扫描/采集完整性核查规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性核查监控", "add")'>IP扫描/采集完整性核查监控</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性核查监控告警", "add")'>IP扫描/采集完整性核查监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性核查稽核", "add")'>IP扫描/采集完整性核查稽核</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性核查结果统计", "add")'>IP扫描/采集完整性核查结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性数据采集", "add")'>IP扫描/采集完整性数据采集</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性数据转换", "add")'>IP扫描/采集完整性数据转换</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("IP扫描/采集完整性数据预处理", "add")'>IP扫描/采集完整性数据预处理</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-008731-100-4196",
    "规则名称": "区公司IP扫描、采集完整性核查规则管理-自动采集-01-008731",
    "规则类型": "规则策略-省侧-008",
    "启用状态": "已完成-731",
    "命中次数": 4792,
    "更新时间": "2026-05-10 16:47:49"
  },
  {
    "ID": 2,
    "规则编号": "RULE-008731-101-1533",
    "规则名称": "IP扫描、采集完整性核查规则管理-资产纳管-02-008731",
    "规则类型": "规则策略-省侧-008",
    "启用状态": "异常-731",
    "命中次数": 2023,
    "更新时间": "2026-05-15 14:59:07"
  },
  {
    "ID": 3,
    "规则编号": "RULE-008731-102-1871",
    "规则名称": "IP扫描、采集完整性核查规则管理-资产纳管-03-008731",
    "规则类型": "规则策略-复核-008",
    "启用状态": "已同步-731",
    "命中次数": 3151,
    "更新时间": "2026-05-16 17:05:20"
  },
  {
    "ID": 4,
    "规则编号": "RULE-008731-103-9528",
    "规则名称": "IP扫描、采集完整性核查规则管理-扩容核查-04-008731",
    "规则类型": "规则策略-部侧-008",
    "启用状态": "处理中-731",
    "命中次数": 2264,
    "更新时间": "2026-05-22 13:44:08"
  },
  {
    "ID": 5,
    "规则编号": "RULE-008731-104-3404",
    "规则名称": "区公司IP扫描、采集完整性核查规则管理-自动采集-05-008731",
    "规则类型": "规则策略-自动化-008",
    "启用状态": "已同步-731",
    "命中次数": 3987,
    "更新时间": "2026-05-21 12:05:05"
  },
  {
    "ID": 6,
    "规则编号": "RULE-008731-105-9276",
    "规则名称": "区公司IP扫描、采集完整性核查规则管理-自动采集-06-008731",
    "规则类型": "规则策略-省侧-008",
    "启用状态": "异常-731",
    "命中次数": 2178,
    "更新时间": "2026-05-20 11:30:24"
  },
  {
    "ID": 7,
    "规则编号": "RULE-008731-106-3822",
    "规则名称": "区公司IP扫描、采集完整性核查规则管理-数据上报-07-008731",
    "规则类型": "规则策略-核心-008",
    "启用状态": "处理中-731",
    "命中次数": 890,
    "更新时间": "2026-05-15 08:38:00"
  },
  {
    "ID": 8,
    "规则编号": "RULE-008731-107-5196",
    "规则名称": "IP扫描、采集完整性核查规则管理-异常复核-08-008731",
    "规则类型": "规则策略-省侧-008",
    "启用状态": "待复核-731",
    "命中次数": 4113,
    "更新时间": "2026-05-23 11:26:49"
  },
  {
    "ID": 9,
    "规则编号": "RULE-008731-108-1292",
    "规则名称": "IP扫描、采集完整性核查规则管理-异常复核-09-008731",
    "规则类型": "规则策略-部侧-008",
    "启用状态": "处理中-731",
    "命中次数": 1625,
    "更新时间": "2026-05-10 10:27:55"
  },
  {
    "ID": 10,
    "规则编号": "RULE-008731-109-2053",
    "规则名称": "IP扫描、采集完整性核查规则管理-资产纳管-10-008731",
    "规则类型": "规则策略-核心-008",
    "启用状态": "已完成-731",
    "命中次数": 3975,
    "更新时间": "2026-05-19 15:05:12"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP扫描/采集完整性核查规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP扫描/采集完整性核查规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP扫描/采集完整性核查规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP扫描/采集完整性核查规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP扫描/采集完整性核查规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IP扫描/采集完整性核查规则管理" },
