    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("指令上报接口", "operation")'>指令上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令上报接口数据分析", "analysis")'>指令上报接口数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看指令上报接口信息", "detail")'>查看指令上报接口信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("指令上报接口数据导出", "export")'>指令上报接口数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输入指令上报接口请求任务", "operation")'>输入指令上报接口请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输出指令上报接口反馈信息", "operation")'>输出指令上报接口反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控指令上报接口状态信息", "detail")'>监控指令上报接口状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计指令上报接口调用信息", "analysis")'>统计指令上报接口调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-833462-100-7918",
    "接口名称": "区公司指令上报接口-异常复核-01-833462",
    "对接系统": "调度中心-8334",
    "调用状态": "已完成-462",
    "平均耗时": "342ms-62",
    "最近调用": "2026-05-23 13:07:33"
  },
  {
    "ID": 2,
    "接口编号": "API-833462-101-2445",
    "接口名称": "指令上报接口-数据上报-02-833462",
    "对接系统": "集团资产平台-8334",
    "调用状态": "待处理-462",
    "平均耗时": "665ms-62",
    "最近调用": "2026-05-11 08:29:43"
  },
  {
    "ID": 3,
    "接口编号": "API-833462-102-9117",
    "接口名称": "指令上报接口-自动采集-03-833462",
    "对接系统": "工信部对接平台-8334",
    "调用状态": "待复核-462",
    "平均耗时": "495ms-62",
    "最近调用": "2026-05-10 10:47:37"
  },
  {
    "ID": 4,
    "接口编号": "API-833462-103-1152",
    "接口名称": "指令上报接口-数据上报-04-833462",
    "对接系统": "资产安全平台-8334",
    "调用状态": "已完成-462",
    "平均耗时": "389ms-62",
    "最近调用": "2026-05-12 15:03:36"
  },
  {
    "ID": 5,
    "接口编号": "API-833462-104-6618",
    "接口名称": "区公司指令上报接口-自动采集-05-833462",
    "对接系统": "工信部对接平台-8334",
    "调用状态": "待处理-462",
    "平均耗时": "120ms-62",
    "最近调用": "2026-05-13 11:50:32"
  },
  {
    "ID": 6,
    "接口编号": "API-833462-105-8953",
    "接口名称": "区公司指令上报接口-异常复核-06-833462",
    "对接系统": "调度中心-8334",
    "调用状态": "异常-462",
    "平均耗时": "510ms-62",
    "最近调用": "2026-05-09 11:40:26"
  },
  {
    "ID": 7,
    "接口编号": "API-833462-106-3234",
    "接口名称": "指令上报接口-部侧联动-07-833462",
    "对接系统": "资产安全平台-8334",
    "调用状态": "待复核-462",
    "平均耗时": "399ms-62",
    "最近调用": "2026-05-25 09:29:37"
  },
  {
    "ID": 8,
    "接口编号": "API-833462-107-5142",
    "接口名称": "指令上报接口-自动采集-08-833462",
    "对接系统": "资产安全平台-8334",
    "调用状态": "处理中-462",
    "平均耗时": "678ms-62",
    "最近调用": "2026-05-08 10:03:20"
  },
  {
    "ID": 9,
    "接口编号": "API-833462-108-1811",
    "接口名称": "指令上报接口-异常复核-09-833462",
    "对接系统": "工信部对接平台-8334",
    "调用状态": "处理中-462",
    "平均耗时": "531ms-62",
    "最近调用": "2026-05-19 15:26:12"
  },
  {
    "ID": 10,
    "接口编号": "API-833462-109-1872",
    "接口名称": "指令上报接口-资产纳管-10-833462",
    "对接系统": "工信部对接平台-8334",
    "调用状态": "已同步-462",
    "平均耗时": "199ms-62",
    "最近调用": "2026-05-19 08:14:57"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "指令上报接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "指令上报接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "指令上报接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "指令上报接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "指令上报接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
