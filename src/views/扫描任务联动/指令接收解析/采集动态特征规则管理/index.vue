    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集动态特征规则", "add")'>新增采集动态特征规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集动态特征规则", "edit")'>修改采集动态特征规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集动态特征规则", "delete")'>删除采集动态特征规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集动态特征规则", "add")'>查询采集动态特征规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集动态特征规则启用/禁用", "add")'>采集动态特征规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集动态特征规则运行效果评估", "add")'>采集动态特征规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集动态特征规则分析", "add")'>采集动态特征规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集动态特征规则分析结果展示", "add")'>采集动态特征规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集动态特征规则分析结果下载", "export")'>采集动态特征规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集动态特征规则分析结果上报", "add")'>采集动态特征规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-896704-100-5398",
    "规则名称": "采集动态特征规则管理-自动采集-01-896704",
    "规则类型": "规则策略-自动化-896",
    "启用状态": "已完成-704",
    "命中次数": 4190,
    "更新时间": "2026-05-09 16:42:05"
  },
  {
    "ID": 2,
    "规则编号": "RULE-896704-101-3088",
    "规则名称": "采集动态特征规则管理-资产纳管-02-896704",
    "规则类型": "规则策略-省侧-896",
    "启用状态": "处理中-704",
    "命中次数": 4768,
    "更新时间": "2026-05-09 09:18:44"
  },
  {
    "ID": 3,
    "规则编号": "RULE-896704-102-3581",
    "规则名称": "区公司采集动态特征规则管理-自动采集-03-896704",
    "规则类型": "规则策略-自动化-896",
    "启用状态": "已完成-704",
    "命中次数": 4641,
    "更新时间": "2026-05-16 17:17:03"
  },
  {
    "ID": 4,
    "规则编号": "RULE-896704-103-3281",
    "规则名称": "区公司采集动态特征规则管理-异常复核-04-896704",
    "规则类型": "规则策略-自动化-896",
    "启用状态": "待复核-704",
    "命中次数": 1724,
    "更新时间": "2026-05-09 17:40:25"
  },
  {
    "ID": 5,
    "规则编号": "RULE-896704-104-1259",
    "规则名称": "采集动态特征规则管理-扩容核查-05-896704",
    "规则类型": "规则策略-核心-896",
    "启用状态": "已完成-704",
    "命中次数": 1061,
    "更新时间": "2026-05-12 16:32:25"
  },
  {
    "ID": 6,
    "规则编号": "RULE-896704-105-3230",
    "规则名称": "采集动态特征规则管理-异常复核-06-896704",
    "规则类型": "规则策略-边界-896",
    "启用状态": "已完成-704",
    "命中次数": 2741,
    "更新时间": "2026-05-22 17:06:25"
  },
  {
    "ID": 7,
    "规则编号": "RULE-896704-106-3923",
    "规则名称": "采集动态特征规则管理-部侧联动-07-896704",
    "规则类型": "规则策略-核心-896",
    "启用状态": "待复核-704",
    "命中次数": 1502,
    "更新时间": "2026-05-14 10:37:24"
  },
  {
    "ID": 8,
    "规则编号": "RULE-896704-107-1932",
    "规则名称": "采集动态特征规则管理-资产纳管-08-896704",
    "规则类型": "规则策略-省侧-896",
    "启用状态": "已完成-704",
    "命中次数": 1607,
    "更新时间": "2026-05-21 10:00:22"
  },
  {
    "ID": 9,
    "规则编号": "RULE-896704-108-6685",
    "规则名称": "采集动态特征规则管理-数据上报-09-896704",
    "规则类型": "规则策略-自动化-896",
    "启用状态": "已完成-704",
    "命中次数": 4497,
    "更新时间": "2026-05-23 17:00:01"
  },
  {
    "ID": 10,
    "规则编号": "RULE-896704-109-3808",
    "规则名称": "采集动态特征规则管理-资产纳管-10-896704",
    "规则类型": "规则策略-部侧-896",
    "启用状态": "待处理-704",
    "命中次数": 5007,
    "更新时间": "2026-05-08 15:46:50"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集动态特征规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集动态特征规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集动态特征规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集动态特征规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集动态特征规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
