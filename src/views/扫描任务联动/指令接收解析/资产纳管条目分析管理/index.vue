    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产纳管条目分析信息", "add")'>新增资产纳管条目分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产纳管条目分析信息", "edit")'>修改资产纳管条目分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产纳管条目分析信息", "delete")'>删除资产纳管条目分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询资产纳管条目分析列表", "add")'>查询资产纳管条目分析列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询资产纳管条目分析详情", "add")'>查询资产纳管条目分析详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入资产纳管条目分析信息", "import")'>批量导入资产纳管条目分析信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产纳管条目分析信息导出", "export")'>资产纳管条目分析信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-666319-100-1927",
    "资产名称": "资产纳管条目分析管理-自动采集-01-666319",
    "资产类型": "资产资源-复核-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-数据上报-666319-001",
    "纳管状态": "处理中-319",
    "最近同步": "2026-05-18 12:11:45"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-666319-101-9332",
    "资产名称": "资产纳管条目分析管理-资产纳管-02-666319",
    "资产类型": "资产资源-省侧-666",
    "所属区域": "区公司-资产资源-资产纳管条目分析管理-异常复核-666319-002",
    "纳管状态": "异常-319",
    "最近同步": "2026-05-15 14:25:21"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-666319-102-6139",
    "资产名称": "资产纳管条目分析管理-异常复核-03-666319",
    "资产类型": "资产资源-边界-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-扩容核查-666319-003",
    "纳管状态": "已完成-319",
    "最近同步": "2026-05-16 10:43:00"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-666319-103-4506",
    "资产名称": "区公司资产纳管条目分析管理-部侧联动-04-666319",
    "资产类型": "资产资源-省侧-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-部侧联动-666319-004",
    "纳管状态": "已同步-319",
    "最近同步": "2026-05-21 17:57:55"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-666319-104-7323",
    "资产名称": "资产纳管条目分析管理-数据上报-05-666319",
    "资产类型": "资产资源-部侧-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-异常复核-666319-005",
    "纳管状态": "已完成-319",
    "最近同步": "2026-05-25 16:19:45"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-666319-105-3037",
    "资产名称": "资产纳管条目分析管理-部侧联动-06-666319",
    "资产类型": "资产资源-部侧-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-扩容核查-666319-006",
    "纳管状态": "待处理-319",
    "最近同步": "2026-05-16 12:46:58"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-666319-106-2717",
    "资产名称": "资产纳管条目分析管理-部侧联动-07-666319",
    "资产类型": "资产资源-核心-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-扩容核查-666319-007",
    "纳管状态": "待处理-319",
    "最近同步": "2026-05-23 16:02:53"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-666319-107-8115",
    "资产名称": "资产纳管条目分析管理-数据上报-08-666319",
    "资产类型": "资产资源-自动化-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-部侧联动-666319-008",
    "纳管状态": "待复核-319",
    "最近同步": "2026-05-16 13:43:57"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-666319-108-6299",
    "资产名称": "资产纳管条目分析管理-数据上报-09-666319",
    "资产类型": "资产资源-复核-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-自动采集-666319-009",
    "纳管状态": "已完成-319",
    "最近同步": "2026-05-23 13:54:55"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-666319-109-8024",
    "资产名称": "资产纳管条目分析管理-数据上报-10-666319",
    "资产类型": "资产资源-边界-666",
    "所属区域": "-资产资源-资产纳管条目分析管理-自动采集-666319-010",
    "纳管状态": "已同步-319",
    "最近同步": "2026-05-16 16:29:11"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产纳管条目分析管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产纳管条目分析管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产纳管条目分析管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产纳管条目分析管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产纳管条目分析管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
