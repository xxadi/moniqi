    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定义敏感虚拟资源监控项", "detail")'>定义敏感虚拟资源监控项</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("敏感虚拟资源监控项修改", "edit")'>敏感虚拟资源监控项修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("敏感虚拟资源监控项删除", "delete")'>敏感虚拟资源监控项删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询敏感虚拟资源", "detail")'>查询敏感虚拟资源</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("敏感虚拟资源监控信息采集", "add")'>敏感虚拟资源监控信息采集</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("敏感虚拟资源监控", "detail")'>敏感虚拟资源监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("敏感虚拟资源监控数据展示", "detail")'>敏感虚拟资源监控数据展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("敏感虚拟资源告警", "analysis")'>敏感虚拟资源告警</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("敏感虚拟资源告警记录导出", "export")'>敏感虚拟资源告警记录导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-884549-100-9554",
    "资产名称": "敏感虚拟资源监控-部侧联动-01-884549",
    "资产类型": "资产资源-部侧-884",
    "所属区域": "区公司-资产资源-敏感虚拟资源监控-扩容核查-884549-001",
    "纳管状态": "待复核-549",
    "最近同步": "2026-05-13 11:02:20"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-884549-101-6625",
    "资产名称": "区公司敏感虚拟资源监控-数据上报-02-884549",
    "资产类型": "资产资源-边界-884",
    "所属区域": "区公司-资产资源-敏感虚拟资源监控-资产纳管-884549-002",
    "纳管状态": "已同步-549",
    "最近同步": "2026-05-14 14:05:41"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-884549-102-4352",
    "资产名称": "敏感虚拟资源监控-数据上报-03-884549",
    "资产类型": "资产资源-省侧-884",
    "所属区域": "区公司-资产资源-敏感虚拟资源监控-数据上报-884549-003",
    "纳管状态": "异常-549",
    "最近同步": "2026-05-08 14:53:50"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-884549-103-9466",
    "资产名称": "敏感虚拟资源监控-数据上报-04-884549",
    "资产类型": "资产资源-核心-884",
    "所属区域": "-资产资源-敏感虚拟资源监控-资产纳管-884549-004",
    "纳管状态": "已完成-549",
    "最近同步": "2026-05-10 15:53:54"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-884549-104-3228",
    "资产名称": "敏感虚拟资源监控-数据上报-05-884549",
    "资产类型": "资产资源-省侧-884",
    "所属区域": "-资产资源-敏感虚拟资源监控-异常复核-884549-005",
    "纳管状态": "处理中-549",
    "最近同步": "2026-05-23 14:52:49"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-884549-105-5528",
    "资产名称": "敏感虚拟资源监控-自动采集-06-884549",
    "资产类型": "资产资源-核心-884",
    "所属区域": "区公司-资产资源-敏感虚拟资源监控-异常复核-884549-006",
    "纳管状态": "待处理-549",
    "最近同步": "2026-05-13 13:31:19"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-884549-106-6067",
    "资产名称": "敏感虚拟资源监控-扩容核查-07-884549",
    "资产类型": "资产资源-核心-884",
    "所属区域": "区公司-资产资源-敏感虚拟资源监控-部侧联动-884549-007",
    "纳管状态": "已同步-549",
    "最近同步": "2026-05-19 15:44:54"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-884549-107-2094",
    "资产名称": "敏感虚拟资源监控-自动采集-08-884549",
    "资产类型": "资产资源-核心-884",
    "所属区域": "-资产资源-敏感虚拟资源监控-扩容核查-884549-008",
    "纳管状态": "已完成-549",
    "最近同步": "2026-05-22 10:04:06"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-884549-108-5158",
    "资产名称": "敏感虚拟资源监控-部侧联动-09-884549",
    "资产类型": "资产资源-自动化-884",
    "所属区域": "-资产资源-敏感虚拟资源监控-自动采集-884549-009",
    "纳管状态": "已完成-549",
    "最近同步": "2026-05-16 15:27:13"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-884549-109-2054",
    "资产名称": "敏感虚拟资源监控-数据上报-10-884549",
    "资产类型": "资产资源-复核-884",
    "所属区域": "-资产资源-敏感虚拟资源监控-异常复核-884549-010",
    "纳管状态": "待复核-549",
    "最近同步": "2026-05-19 17:40:19"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "敏感虚拟资源监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "敏感虚拟资源监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "敏感虚拟资源监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "敏感虚拟资源监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "敏感虚拟资源监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
