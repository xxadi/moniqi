    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产归一化稽核任务", "add")'>新增资产归一化稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产归一化稽核任务", "delete")'>删除资产归一化稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产归一化稽核任务", "edit")'>修改资产归一化稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产归一化稽核任务", "detail")'>查询资产归一化稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核任务启用/禁用", "detail")'>资产归一化稽核任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核告警", "detail")'>资产归一化稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核结果统计", "detail")'>资产归一化稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核数据提取", "detail")'>资产归一化稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核运行分析", "detail")'>资产归一化稽核运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核分析结果展示", "detail")'>资产归一化稽核分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产归一化稽核分析结果下载", "export")'>资产归一化稽核分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产归一化稽核分析结果上报", "detail")'>资产归一化稽核分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-732449-100-9646",
    "资产名称": "资产归一化稽核任务管理-资产纳管-01-732449",
    "资产类型": "资产资源-省侧-732",
    "所属区域": "区公司-资产资源-资产归一化稽核任务管理-扩容核查-732449-001",
    "纳管状态": "待处理-449",
    "最近同步": "2026-05-22 10:39:26"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-732449-101-6379",
    "资产名称": "资产归一化稽核任务管理-自动采集-02-732449",
    "资产类型": "资产资源-复核-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-扩容核查-732449-002",
    "纳管状态": "待处理-449",
    "最近同步": "2026-05-11 14:45:25"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-732449-102-7283",
    "资产名称": "资产归一化稽核任务管理-异常复核-03-732449",
    "资产类型": "资产资源-省侧-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-异常复核-732449-003",
    "纳管状态": "处理中-449",
    "最近同步": "2026-05-11 10:28:52"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-732449-103-7493",
    "资产名称": "资产归一化稽核任务管理-数据上报-04-732449",
    "资产类型": "资产资源-复核-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-自动采集-732449-004",
    "纳管状态": "处理中-449",
    "最近同步": "2026-05-15 11:16:00"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-732449-104-2207",
    "资产名称": "资产归一化稽核任务管理-资产纳管-05-732449",
    "资产类型": "资产资源-核心-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-资产纳管-732449-005",
    "纳管状态": "已同步-449",
    "最近同步": "2026-05-14 13:20:08"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-732449-105-1677",
    "资产名称": "资产归一化稽核任务管理-部侧联动-06-732449",
    "资产类型": "资产资源-自动化-732",
    "所属区域": "区公司-资产资源-资产归一化稽核任务管理-数据上报-732449-006",
    "纳管状态": "已同步-449",
    "最近同步": "2026-05-18 14:59:55"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-732449-106-7637",
    "资产名称": "资产归一化稽核任务管理-扩容核查-07-732449",
    "资产类型": "资产资源-边界-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-资产纳管-732449-007",
    "纳管状态": "已完成-449",
    "最近同步": "2026-05-09 16:47:04"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-732449-107-5782",
    "资产名称": "资产归一化稽核任务管理-异常复核-08-732449",
    "资产类型": "资产资源-自动化-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-数据上报-732449-008",
    "纳管状态": "异常-449",
    "最近同步": "2026-05-21 08:25:45"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-732449-108-7530",
    "资产名称": "资产归一化稽核任务管理-部侧联动-09-732449",
    "资产类型": "资产资源-省侧-732",
    "所属区域": "-资产资源-资产归一化稽核任务管理-扩容核查-732449-009",
    "纳管状态": "已同步-449",
    "最近同步": "2026-05-08 13:08:52"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-732449-109-1214",
    "资产名称": "资产归一化稽核任务管理-扩容核查-10-732449",
    "资产类型": "资产资源-边界-732",
    "所属区域": "区公司-资产资源-资产归一化稽核任务管理-扩容核查-732449-010",
    "纳管状态": "待处理-449",
    "最近同步": "2026-05-21 17:14:42"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产归一化稽核任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产归一化稽核任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产归一化稽核任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产归一化稽核任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产归一化稽核任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
