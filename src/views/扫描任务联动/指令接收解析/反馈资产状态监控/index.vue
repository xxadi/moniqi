    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("反馈资产状态监控运行效果评估", "detail")'>反馈资产状态监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("反馈资产状态监控分析", "detail")'>反馈资产状态监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("反馈资产状态监控分析结果展示", "detail")'>反馈资产状态监控分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("反馈资产状态监控分析结果下载", "export")'>反馈资产状态监控分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("反馈资产状态监控分析结果上报", "detail")'>反馈资产状态监控分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-135909-100-1695",
    "资产名称": "反馈资产状态监控-自动采集-01-135909",
    "资产类型": "资产资源-边界-135",
    "所属区域": "-资产资源-反馈资产状态监控-资产纳管-135909-001",
    "纳管状态": "待复核-909",
    "最近同步": "2026-05-18 15:23:08"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-135909-101-2752",
    "资产名称": "反馈资产状态监控-部侧联动-02-135909",
    "资产类型": "资产资源-复核-135",
    "所属区域": "-资产资源-反馈资产状态监控-扩容核查-135909-002",
    "纳管状态": "待处理-909",
    "最近同步": "2026-05-14 11:47:55"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-135909-102-2763",
    "资产名称": "反馈资产状态监控-数据上报-03-135909",
    "资产类型": "资产资源-省侧-135",
    "所属区域": "-资产资源-反馈资产状态监控-扩容核查-135909-003",
    "纳管状态": "待复核-909",
    "最近同步": "2026-05-22 13:09:26"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-135909-103-2279",
    "资产名称": "反馈资产状态监控-资产纳管-04-135909",
    "资产类型": "资产资源-部侧-135",
    "所属区域": "-资产资源-反馈资产状态监控-自动采集-135909-004",
    "纳管状态": "处理中-909",
    "最近同步": "2026-05-08 14:39:57"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-135909-104-9630",
    "资产名称": "反馈资产状态监控-自动采集-05-135909",
    "资产类型": "资产资源-边界-135",
    "所属区域": "-资产资源-反馈资产状态监控-资产纳管-135909-005",
    "纳管状态": "处理中-909",
    "最近同步": "2026-05-13 12:11:00"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-135909-105-2100",
    "资产名称": "区公司反馈资产状态监控-资产纳管-06-135909",
    "资产类型": "资产资源-核心-135",
    "所属区域": "-资产资源-反馈资产状态监控-扩容核查-135909-006",
    "纳管状态": "已同步-909",
    "最近同步": "2026-05-08 10:48:27"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-135909-106-2998",
    "资产名称": "反馈资产状态监控-异常复核-07-135909",
    "资产类型": "资产资源-核心-135",
    "所属区域": "区公司-资产资源-反馈资产状态监控-自动采集-135909-007",
    "纳管状态": "已同步-909",
    "最近同步": "2026-05-16 12:29:51"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-135909-107-1575",
    "资产名称": "反馈资产状态监控-资产纳管-08-135909",
    "资产类型": "资产资源-核心-135",
    "所属区域": "-资产资源-反馈资产状态监控-异常复核-135909-008",
    "纳管状态": "已完成-909",
    "最近同步": "2026-05-15 09:50:05"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-135909-108-1888",
    "资产名称": "反馈资产状态监控-部侧联动-09-135909",
    "资产类型": "资产资源-部侧-135",
    "所属区域": "区公司-资产资源-反馈资产状态监控-资产纳管-135909-009",
    "纳管状态": "待复核-909",
    "最近同步": "2026-05-09 15:02:12"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-135909-109-5551",
    "资产名称": "区公司反馈资产状态监控-部侧联动-10-135909",
    "资产类型": "资产资源-边界-135",
    "所属区域": "-资产资源-反馈资产状态监控-数据上报-135909-010",
    "纳管状态": "待处理-909",
    "最近同步": "2026-05-16 13:44:39"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "反馈资产状态监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "反馈资产状态监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "反馈资产状态监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "反馈资产状态监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "反馈资产状态监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
