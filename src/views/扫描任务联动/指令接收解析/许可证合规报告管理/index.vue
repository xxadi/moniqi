    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增许可证合规报告信息", "add")'>新增许可证合规报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改许可证合规报告信息", "edit")'>修改许可证合规报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除许可证合规报告信息", "delete")'>删除许可证合规报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询许可证合规报告列表信息", "detail")'>查询许可证合规报告列表信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("许可证合规报告结果推送", "analysis")'>许可证合规报告结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("上传许可证合规报告信息", "import")'>上传许可证合规报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("下载许可证合规报告信息", "export")'>下载许可证合规报告信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看许可证合规报告详情信息", "detail")'>查看许可证合规报告详情信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-533504-100-9890",
    "资产名称": "许可证合规报告管理-扩容核查-01-533504",
    "资产类型": "资产资源-复核-533",
    "所属区域": "-资产资源-许可证合规报告管理-数据上报-533504-001",
    "纳管状态": "已完成-504",
    "最近同步": "2026-05-09 09:32:20"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-533504-101-6918",
    "资产名称": "许可证合规报告管理-资产纳管-02-533504",
    "资产类型": "资产资源-核心-533",
    "所属区域": "-资产资源-许可证合规报告管理-异常复核-533504-002",
    "纳管状态": "待处理-504",
    "最近同步": "2026-05-23 11:20:27"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-533504-102-6478",
    "资产名称": "许可证合规报告管理-部侧联动-03-533504",
    "资产类型": "资产资源-部侧-533",
    "所属区域": "-资产资源-许可证合规报告管理-资产纳管-533504-003",
    "纳管状态": "待复核-504",
    "最近同步": "2026-05-24 08:57:04"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-533504-103-4026",
    "资产名称": "许可证合规报告管理-异常复核-04-533504",
    "资产类型": "资产资源-自动化-533",
    "所属区域": "-资产资源-许可证合规报告管理-资产纳管-533504-004",
    "纳管状态": "待复核-504",
    "最近同步": "2026-05-11 11:31:33"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-533504-104-6541",
    "资产名称": "许可证合规报告管理-数据上报-05-533504",
    "资产类型": "资产资源-部侧-533",
    "所属区域": "-资产资源-许可证合规报告管理-数据上报-533504-005",
    "纳管状态": "处理中-504",
    "最近同步": "2026-05-25 17:48:32"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-533504-105-4186",
    "资产名称": "许可证合规报告管理-异常复核-06-533504",
    "资产类型": "资产资源-复核-533",
    "所属区域": "-资产资源-许可证合规报告管理-自动采集-533504-006",
    "纳管状态": "待复核-504",
    "最近同步": "2026-05-12 11:28:43"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-533504-106-9627",
    "资产名称": "许可证合规报告管理-部侧联动-07-533504",
    "资产类型": "资产资源-省侧-533",
    "所属区域": "-资产资源-许可证合规报告管理-部侧联动-533504-007",
    "纳管状态": "已同步-504",
    "最近同步": "2026-05-13 16:16:46"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-533504-107-4202",
    "资产名称": "许可证合规报告管理-资产纳管-08-533504",
    "资产类型": "资产资源-复核-533",
    "所属区域": "区公司-资产资源-许可证合规报告管理-部侧联动-533504-008",
    "纳管状态": "异常-504",
    "最近同步": "2026-05-22 09:00:23"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-533504-108-1711",
    "资产名称": "许可证合规报告管理-自动采集-09-533504",
    "资产类型": "资产资源-自动化-533",
    "所属区域": "-资产资源-许可证合规报告管理-数据上报-533504-009",
    "纳管状态": "处理中-504",
    "最近同步": "2026-05-24 11:40:26"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-533504-109-8799",
    "资产名称": "许可证合规报告管理-异常复核-10-533504",
    "资产类型": "资产资源-部侧-533",
    "所属区域": "-资产资源-许可证合规报告管理-异常复核-533504-010",
    "纳管状态": "已同步-504",
    "最近同步": "2026-05-23 15:15:17"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "许可证合规报告管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "许可证合规报告管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "许可证合规报告管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "许可证合规报告管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "许可证合规报告管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
