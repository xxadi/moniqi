    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产依赖查询接口", "detail")'>资产依赖查询接口</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产依赖查询数据分析", "detail")'>资产依赖查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产依赖查询信息", "detail")'>查看资产依赖查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产依赖查询数据导出", "export")'>资产依赖查询数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产依赖查询下发信息", "add")'>新增资产依赖查询下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输入资产依赖查询请求任务", "detail")'>输入资产依赖查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输出资产依赖查询反馈信息", "detail")'>输出资产依赖查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控资产依赖查询状态信息", "detail")'>监控资产依赖查询状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("统计资产依赖查询调用信息", "detail")'>统计资产依赖查询调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-175293-100-7572",
    "接口名称": "资产依赖查询接口-自动采集-01-175293",
    "对接系统": "资产安全平台-1752",
    "调用状态": "待处理-293",
    "平均耗时": "348ms-93",
    "最近调用": "2026-05-22 13:47:21"
  },
  {
    "ID": 2,
    "接口编号": "API-175293-101-2871",
    "接口名称": "资产依赖查询接口-扩容核查-02-175293",
    "对接系统": "调度中心-1752",
    "调用状态": "已同步-293",
    "平均耗时": "365ms-93",
    "最近调用": "2026-05-13 16:30:47"
  },
  {
    "ID": 3,
    "接口编号": "API-175293-102-6748",
    "接口名称": "资产依赖查询接口-自动采集-03-175293",
    "对接系统": "资产安全平台-1752",
    "调用状态": "已同步-293",
    "平均耗时": "153ms-93",
    "最近调用": "2026-05-11 15:24:38"
  },
  {
    "ID": 4,
    "接口编号": "API-175293-103-4790",
    "接口名称": "资产依赖查询接口-异常复核-04-175293",
    "对接系统": "CMDB资源库-1752",
    "调用状态": "已完成-293",
    "平均耗时": "157ms-93",
    "最近调用": "2026-05-09 08:07:25"
  },
  {
    "ID": 5,
    "接口编号": "API-175293-104-9989",
    "接口名称": "资产依赖查询接口-扩容核查-05-175293",
    "对接系统": "调度中心-1752",
    "调用状态": "待复核-293",
    "平均耗时": "346ms-93",
    "最近调用": "2026-05-15 08:24:57"
  },
  {
    "ID": 6,
    "接口编号": "API-175293-105-8663",
    "接口名称": "资产依赖查询接口-异常复核-06-175293",
    "对接系统": "工信部对接平台-1752",
    "调用状态": "已完成-293",
    "平均耗时": "430ms-93",
    "最近调用": "2026-05-11 15:53:53"
  },
  {
    "ID": 7,
    "接口编号": "API-175293-106-5135",
    "接口名称": "资产依赖查询接口-数据上报-07-175293",
    "对接系统": "调度中心-1752",
    "调用状态": "异常-293",
    "平均耗时": "546ms-93",
    "最近调用": "2026-05-24 17:28:02"
  },
  {
    "ID": 8,
    "接口编号": "API-175293-107-6314",
    "接口名称": "资产依赖查询接口-部侧联动-08-175293",
    "对接系统": "工信部对接平台-1752",
    "调用状态": "已同步-293",
    "平均耗时": "502ms-93",
    "最近调用": "2026-05-21 11:50:02"
  },
  {
    "ID": 9,
    "接口编号": "API-175293-108-4801",
    "接口名称": "资产依赖查询接口-资产纳管-09-175293",
    "对接系统": "资产安全平台-1752",
    "调用状态": "已完成-293",
    "平均耗时": "101ms-93",
    "最近调用": "2026-05-24 10:27:26"
  },
  {
    "ID": 10,
    "接口编号": "API-175293-109-2209",
    "接口名称": "区公司资产依赖查询接口-自动采集-10-175293",
    "对接系统": "工信部对接平台-1752",
    "调用状态": "待复核-293",
    "平均耗时": "251ms-93",
    "最近调用": "2026-05-19 09:50:00"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产依赖查询接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产依赖查询接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产依赖查询接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产依赖查询接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产依赖查询接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
