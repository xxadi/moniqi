    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加扫描任务回溯信息", "add")'>添加扫描任务回溯信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑扫描任务回溯信息", "edit")'>编辑扫描任务回溯信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描任务回溯信息", "delete")'>删除扫描任务回溯信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描任务回溯列表", "detail")'>查询扫描任务回溯列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描任务回溯详情", "detail")'>查询扫描任务回溯详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入扫描任务回溯信息", "import")'>批量导入扫描任务回溯信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描任务回溯信息导出", "export")'>扫描任务回溯信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-204294-100-8843",
    "扫描对象": "扫描任务回溯管理-数据上报-01-204294",
    "扫描节点": "节点-05-94",
    "资产数量": 803,
    "异常数量": 4400,
    "扫描状态": "处理中-294"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-204294-101-1073",
    "扫描对象": "扫描任务回溯管理-异常复核-02-204294",
    "扫描节点": "节点-06-94",
    "资产数量": 1173,
    "异常数量": 518,
    "扫描状态": "异常-294"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-204294-102-4574",
    "扫描对象": "扫描任务回溯管理-自动采集-03-204294",
    "扫描节点": "区公司节点-06-94",
    "资产数量": 2761,
    "异常数量": 2442,
    "扫描状态": "待复核-294"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-204294-103-4294",
    "扫描对象": "扫描任务回溯管理-异常复核-04-204294",
    "扫描节点": "区公司节点-05-94",
    "资产数量": 1400,
    "异常数量": 4594,
    "扫描状态": "已同步-294"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-204294-104-8772",
    "扫描对象": "扫描任务回溯管理-资产纳管-05-204294",
    "扫描节点": "节点-08-94",
    "资产数量": 1969,
    "异常数量": 4753,
    "扫描状态": "已完成-294"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-204294-105-1433",
    "扫描对象": "扫描任务回溯管理-数据上报-06-204294",
    "扫描节点": "区公司节点-02-94",
    "资产数量": 4829,
    "异常数量": 4787,
    "扫描状态": "待复核-294"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-204294-106-5571",
    "扫描对象": "扫描任务回溯管理-异常复核-07-204294",
    "扫描节点": "节点-01-94",
    "资产数量": 4958,
    "异常数量": 2893,
    "扫描状态": "待复核-294"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-204294-107-4765",
    "扫描对象": "扫描任务回溯管理-数据上报-08-204294",
    "扫描节点": "节点-01-94",
    "资产数量": 2770,
    "异常数量": 3405,
    "扫描状态": "待复核-294"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-204294-108-6731",
    "扫描对象": "扫描任务回溯管理-数据上报-09-204294",
    "扫描节点": "节点-06-94",
    "资产数量": 2304,
    "异常数量": 633,
    "扫描状态": "处理中-294"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-204294-109-7882",
    "扫描对象": "扫描任务回溯管理-数据上报-10-204294",
    "扫描节点": "节点-03-94",
    "资产数量": 3145,
    "异常数量": 1000,
    "扫描状态": "异常-294"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描任务回溯管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描任务回溯管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描任务回溯管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描任务回溯管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描任务回溯管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
