    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv6活跃地址检测任务", "add")'>新增IPv6活跃地址检测任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6活跃地址检测任务", "delete")'>删除IPv6活跃地址检测任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv6活跃地址检测任务", "edit")'>修改IPv6活跃地址检测任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6活跃地址检测任务", "detail")'>查询IPv6活跃地址检测任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IPv6活跃地址检测任务启用/禁用", "operation")'>IPv6活跃地址检测任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6活跃地址检测告警", "analysis")'>IPv6活跃地址检测告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6活跃地址检测结果统计", "analysis")'>IPv6活跃地址检测结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IPv6活跃地址检测数据提取", "operation")'>IPv6活跃地址检测数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6活跃地址检测运行分析", "analysis")'>IPv6活跃地址检测运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IPv6活跃地址检测分析结果展示", "detail")'>IPv6活跃地址检测分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6活跃地址检测分析结果下载", "export")'>IPv6活跃地址检测分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6活跃地址检测分析结果上报", "analysis")'>IPv6活跃地址检测分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-216973-100-2737",
    "业务名称": "IPv6活跃地址检测任务管理-资产纳管-01-216973",
    "业务类型": "业务联动-边界-216",
    "处理状态": "待复核-973",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-14 08:01:28"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-216973-101-1729",
    "业务名称": "IPv6活跃地址检测任务管理-异常复核-02-216973",
    "业务类型": "业务联动-省侧-216",
    "处理状态": "已完成-973",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-15 17:42:40"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-216973-102-2319",
    "业务名称": "IPv6活跃地址检测任务管理-部侧联动-03-216973",
    "业务类型": "业务联动-自动化-216",
    "处理状态": "已同步-973",
    "负责人": "任务调度员-区公司",
    "更新时间": "2026-05-08 17:52:43"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-216973-103-1119",
    "业务名称": "IPv6活跃地址检测任务管理-数据上报-04-216973",
    "业务类型": "业务联动-核心-216",
    "处理状态": "已完成-973",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-16 11:49:21"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-216973-104-3436",
    "业务名称": "区公司IPv6活跃地址检测任务管理-异常复核-05-216973",
    "业务类型": "业务联动-核心-216",
    "处理状态": "已同步-973",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-09 08:06:13"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-216973-105-2888",
    "业务名称": "IPv6活跃地址检测任务管理-异常复核-06-216973",
    "业务类型": "业务联动-边界-216",
    "处理状态": "已同步-973",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-23 14:30:17"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-216973-106-7056",
    "业务名称": "IPv6活跃地址检测任务管理-部侧联动-07-216973",
    "业务类型": "业务联动-复核-216",
    "处理状态": "已同步-973",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-16 10:54:11"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-216973-107-5365",
    "业务名称": "区公司IPv6活跃地址检测任务管理-资产纳管-08-216973",
    "业务类型": "业务联动-边界-216",
    "处理状态": "异常-973",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-18 15:02:08"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-216973-108-2432",
    "业务名称": "区公司IPv6活跃地址检测任务管理-自动采集-09-216973",
    "业务类型": "业务联动-省侧-216",
    "处理状态": "处理中-973",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-08 11:16:14"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-216973-109-3265",
    "业务名称": "IPv6活跃地址检测任务管理-数据上报-10-216973",
    "业务类型": "业务联动-自动化-216",
    "处理状态": "已完成-973",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-25 17:25:06"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6活跃地址检测任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6活跃地址检测任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6活跃地址检测任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6活跃地址检测任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6活跃地址检测任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IPv6活跃地址检测任务管理" },
