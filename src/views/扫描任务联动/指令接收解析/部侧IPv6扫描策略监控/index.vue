    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增部侧IPv6扫描策略监控", "add")'>新增部侧IPv6扫描策略监控</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧IPv6扫描策略监控", "delete")'>删除部侧IPv6扫描策略监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改部侧IPv6扫描策略监控", "edit")'>修改部侧IPv6扫描策略监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧IPv6扫描策略监控", "detail")'>查询部侧IPv6扫描策略监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧IPv6扫描策略监控启用/禁用", "detail")'>部侧IPv6扫描策略监控启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧IPv6扫描策略监控运行效果评估", "detail")'>部侧IPv6扫描策略监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧IPv6扫描策略监控分析", "detail")'>部侧IPv6扫描策略监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧IPv6扫描策略监控分析结果展示", "detail")'>部侧IPv6扫描策略监控分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧IPv6扫描策略监控分析结果下载", "export")'>部侧IPv6扫描策略监控分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧IPv6扫描策略监控分析结果上报", "detail")'>部侧IPv6扫描策略监控分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-009131-100-7176",
    "规则名称": "部侧IPv6扫描策略监控-资产纳管-01-009131",
    "规则类型": "规则策略-自动化-009",
    "启用状态": "待处理-131",
    "命中次数": 2964,
    "更新时间": "2026-05-15 14:15:16"
  },
  {
    "ID": 2,
    "规则编号": "RULE-009131-101-8688",
    "规则名称": "部侧IPv6扫描策略监控-异常复核-02-009131",
    "规则类型": "规则策略-复核-009",
    "启用状态": "已同步-131",
    "命中次数": 2009,
    "更新时间": "2026-05-14 14:42:03"
  },
  {
    "ID": 3,
    "规则编号": "RULE-009131-102-4546",
    "规则名称": "部侧IPv6扫描策略监控-资产纳管-03-009131",
    "规则类型": "规则策略-边界-009",
    "启用状态": "待复核-131",
    "命中次数": 2918,
    "更新时间": "2026-05-11 17:33:56"
  },
  {
    "ID": 4,
    "规则编号": "RULE-009131-103-6064",
    "规则名称": "部侧IPv6扫描策略监控-自动采集-04-009131",
    "规则类型": "规则策略-复核-009",
    "启用状态": "待处理-131",
    "命中次数": 3942,
    "更新时间": "2026-05-18 17:59:50"
  },
  {
    "ID": 5,
    "规则编号": "RULE-009131-104-8137",
    "规则名称": "区公司部侧IPv6扫描策略监控-资产纳管-05-009131",
    "规则类型": "规则策略-核心-009",
    "启用状态": "待处理-131",
    "命中次数": 3308,
    "更新时间": "2026-05-25 09:57:13"
  },
  {
    "ID": 6,
    "规则编号": "RULE-009131-105-8599",
    "规则名称": "部侧IPv6扫描策略监控-异常复核-06-009131",
    "规则类型": "规则策略-复核-009",
    "启用状态": "待处理-131",
    "命中次数": 2421,
    "更新时间": "2026-05-18 12:25:34"
  },
  {
    "ID": 7,
    "规则编号": "RULE-009131-106-4593",
    "规则名称": "部侧IPv6扫描策略监控-自动采集-07-009131",
    "规则类型": "规则策略-边界-009",
    "启用状态": "待处理-131",
    "命中次数": 111,
    "更新时间": "2026-05-19 09:19:25"
  },
  {
    "ID": 8,
    "规则编号": "RULE-009131-107-6826",
    "规则名称": "部侧IPv6扫描策略监控-自动采集-08-009131",
    "规则类型": "规则策略-复核-009",
    "启用状态": "已同步-131",
    "命中次数": 492,
    "更新时间": "2026-05-12 10:11:35"
  },
  {
    "ID": 9,
    "规则编号": "RULE-009131-108-3450",
    "规则名称": "区公司部侧IPv6扫描策略监控-部侧联动-09-009131",
    "规则类型": "规则策略-部侧-009",
    "启用状态": "异常-131",
    "命中次数": 4362,
    "更新时间": "2026-05-09 16:29:34"
  },
  {
    "ID": 10,
    "规则编号": "RULE-009131-109-4619",
    "规则名称": "部侧IPv6扫描策略监控-部侧联动-10-009131",
    "规则类型": "规则策略-部侧-009",
    "启用状态": "待复核-131",
    "命中次数": 3881,
    "更新时间": "2026-05-10 16:56:28"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧IPv6扫描策略监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧IPv6扫描策略监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧IPv6扫描策略监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧IPv6扫描策略监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧IPv6扫描策略监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
