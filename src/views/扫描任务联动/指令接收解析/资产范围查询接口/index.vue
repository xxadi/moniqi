    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产范围查询接口", "detail")'>资产范围查询接口</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产范围查询数据分析", "detail")'>资产范围查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产范围查询信息", "detail")'>查看资产范围查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产范围查询数据导出", "export")'>资产范围查询数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产范围查询下发信息", "add")'>新增资产范围查询下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输入资产范围查询请求任务", "detail")'>输入资产范围查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("输出资产范围查询反馈信息", "detail")'>输出资产范围查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控资产范围查询状态信息", "detail")'>监控资产范围查询状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("统计资产范围查询调用信息", "detail")'>统计资产范围查询调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-336629-100-2929",
    "接口名称": "资产范围查询接口-异常复核-01-336629",
    "对接系统": "工信部对接平台-3366",
    "调用状态": "已完成-629",
    "平均耗时": "213ms-29",
    "最近调用": "2026-05-23 13:03:44"
  },
  {
    "ID": 2,
    "接口编号": "API-336629-101-8531",
    "接口名称": "资产范围查询接口-异常复核-02-336629",
    "对接系统": "资产安全平台-3366",
    "调用状态": "待复核-629",
    "平均耗时": "51ms-29",
    "最近调用": "2026-05-24 09:20:28"
  },
  {
    "ID": 3,
    "接口编号": "API-336629-102-1176",
    "接口名称": "资产范围查询接口-自动采集-03-336629",
    "对接系统": "集团资产平台-3366",
    "调用状态": "已同步-629",
    "平均耗时": "592ms-29",
    "最近调用": "2026-05-08 09:09:19"
  },
  {
    "ID": 4,
    "接口编号": "API-336629-103-2326",
    "接口名称": "资产范围查询接口-自动采集-04-336629",
    "对接系统": "调度中心-3366",
    "调用状态": "待处理-629",
    "平均耗时": "436ms-29",
    "最近调用": "2026-05-18 15:34:38"
  },
  {
    "ID": 5,
    "接口编号": "API-336629-104-5779",
    "接口名称": "资产范围查询接口-部侧联动-05-336629",
    "对接系统": "调度中心-3366",
    "调用状态": "已完成-629",
    "平均耗时": "524ms-29",
    "最近调用": "2026-05-14 13:39:16"
  },
  {
    "ID": 6,
    "接口编号": "API-336629-105-1021",
    "接口名称": "区公司资产范围查询接口-部侧联动-06-336629",
    "对接系统": "CMDB资源库-3366",
    "调用状态": "已完成-629",
    "平均耗时": "115ms-29",
    "最近调用": "2026-05-20 16:43:53"
  },
  {
    "ID": 7,
    "接口编号": "API-336629-106-9310",
    "接口名称": "资产范围查询接口-扩容核查-07-336629",
    "对接系统": "CMDB资源库-3366",
    "调用状态": "处理中-629",
    "平均耗时": "594ms-29",
    "最近调用": "2026-05-13 17:31:19"
  },
  {
    "ID": 8,
    "接口编号": "API-336629-107-3645",
    "接口名称": "资产范围查询接口-资产纳管-08-336629",
    "对接系统": "调度中心-3366",
    "调用状态": "异常-629",
    "平均耗时": "663ms-29",
    "最近调用": "2026-05-25 16:21:38"
  },
  {
    "ID": 9,
    "接口编号": "API-336629-108-2316",
    "接口名称": "资产范围查询接口-扩容核查-09-336629",
    "对接系统": "工信部对接平台-3366",
    "调用状态": "处理中-629",
    "平均耗时": "253ms-29",
    "最近调用": "2026-05-13 14:37:15"
  },
  {
    "ID": 10,
    "接口编号": "API-336629-109-2145",
    "接口名称": "资产范围查询接口-扩容核查-10-336629",
    "对接系统": "工信部对接平台-3366",
    "调用状态": "已同步-629",
    "平均耗时": "52ms-29",
    "最近调用": "2026-05-11 08:47:35"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产范围查询接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产范围查询接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产范围查询接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产范围查询接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产范围查询接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
