    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增工信部支持组件信息", "add")'>新增工信部支持组件信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部支持组件信息", "edit")'>修改工信部支持组件信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除工信部支持组件信息", "delete")'>删除工信部支持组件信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部支持组件列表", "detail")'>查询工信部支持组件列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部支持组件详情", "detail")'>查询工信部支持组件详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入工信部支持组件信息", "import")'>批量导入工信部支持组件信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("工信部支持组件信息导出", "export")'>工信部支持组件信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-816235-100-4469",
    "资产名称": "区公司工信部支持组件管理-部侧联动-01-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-资产纳管-816235-001",
    "纳管状态": "异常-235",
    "最近同步": "2026-05-18 10:34:36"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-816235-101-1952",
    "资产名称": "工信部支持组件管理-自动采集-02-816235",
    "资产类型": "资产资源-部侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-部侧联动-816235-002",
    "纳管状态": "处理中-235",
    "最近同步": "2026-05-21 15:54:25"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-816235-102-1570",
    "资产名称": "工信部支持组件管理-数据上报-03-816235",
    "资产类型": "资产资源-部侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-数据上报-816235-003",
    "纳管状态": "已完成-235",
    "最近同步": "2026-05-20 15:56:51"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-816235-103-2927",
    "资产名称": "工信部支持组件管理-部侧联动-04-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-扩容核查-816235-004",
    "纳管状态": "已完成-235",
    "最近同步": "2026-05-08 11:57:49"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-816235-104-2010",
    "资产名称": "工信部支持组件管理-异常复核-05-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-资产纳管-816235-005",
    "纳管状态": "待处理-235",
    "最近同步": "2026-05-20 09:03:54"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-816235-105-4691",
    "资产名称": "工信部支持组件管理-数据上报-06-816235",
    "资产类型": "资产资源-部侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-扩容核查-816235-006",
    "纳管状态": "处理中-235",
    "最近同步": "2026-05-21 16:29:46"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-816235-106-9176",
    "资产名称": "工信部支持组件管理-扩容核查-07-816235",
    "资产类型": "资产资源-自动化-816",
    "所属区域": "-资产资源-工信部支持组件管理-异常复核-816235-007",
    "纳管状态": "异常-235",
    "最近同步": "2026-05-11 13:11:38"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-816235-107-1253",
    "资产名称": "区公司工信部支持组件管理-自动采集-08-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-部侧联动-816235-008",
    "纳管状态": "已完成-235",
    "最近同步": "2026-05-24 17:00:23"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-816235-108-4420",
    "资产名称": "区公司工信部支持组件管理-部侧联动-09-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-异常复核-816235-009",
    "纳管状态": "异常-235",
    "最近同步": "2026-05-25 17:35:46"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-816235-109-3023",
    "资产名称": "区公司工信部支持组件管理-资产纳管-10-816235",
    "资产类型": "资产资源-省侧-816",
    "所属区域": "-资产资源-工信部支持组件管理-数据上报-816235-010",
    "纳管状态": "处理中-235",
    "最近同步": "2026-05-14 11:21:02"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "工信部支持组件管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "工信部支持组件管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "工信部支持组件管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "工信部支持组件管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "工信部支持组件管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
