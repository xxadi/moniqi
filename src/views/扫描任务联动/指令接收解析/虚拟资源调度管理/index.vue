    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源调度任务", "add")'>新增虚拟资源调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源调度任务", "edit")'>修改虚拟资源调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源调度任务", "delete")'>删除虚拟资源调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源调度任务列表", "detail")'>查询虚拟资源调度任务列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源调度任务详情", "detail")'>查询虚拟资源调度任务详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资源调度任务", "import")'>批量导入虚拟资源调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源调度任务导出", "export")'>虚拟资源调度任务导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-584677-100-3487",
    "资产名称": "虚拟资源调度管理-部侧联动-01-584677",
    "资产类型": "资产资源-自动化-584",
    "所属区域": "区公司-资产资源-虚拟资源调度管理-异常复核-584677-001",
    "纳管状态": "处理中-677",
    "最近同步": "2026-05-24 09:28:25"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-584677-101-5561",
    "资产名称": "虚拟资源调度管理-异常复核-02-584677",
    "资产类型": "资产资源-部侧-584",
    "所属区域": "-资产资源-虚拟资源调度管理-异常复核-584677-002",
    "纳管状态": "已同步-677",
    "最近同步": "2026-05-23 17:28:01"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-584677-102-4938",
    "资产名称": "虚拟资源调度管理-自动采集-03-584677",
    "资产类型": "资产资源-部侧-584",
    "所属区域": "区公司-资产资源-虚拟资源调度管理-异常复核-584677-003",
    "纳管状态": "已同步-677",
    "最近同步": "2026-05-17 14:46:26"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-584677-103-2439",
    "资产名称": "虚拟资源调度管理-部侧联动-04-584677",
    "资产类型": "资产资源-核心-584",
    "所属区域": "-资产资源-虚拟资源调度管理-部侧联动-584677-004",
    "纳管状态": "异常-677",
    "最近同步": "2026-05-08 13:51:04"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-584677-104-7150",
    "资产名称": "虚拟资源调度管理-自动采集-05-584677",
    "资产类型": "资产资源-核心-584",
    "所属区域": "-资产资源-虚拟资源调度管理-扩容核查-584677-005",
    "纳管状态": "已同步-677",
    "最近同步": "2026-05-09 17:12:37"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-584677-105-1862",
    "资产名称": "虚拟资源调度管理-异常复核-06-584677",
    "资产类型": "资产资源-省侧-584",
    "所属区域": "-资产资源-虚拟资源调度管理-数据上报-584677-006",
    "纳管状态": "待复核-677",
    "最近同步": "2026-05-08 11:59:58"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-584677-106-4343",
    "资产名称": "虚拟资源调度管理-数据上报-07-584677",
    "资产类型": "资产资源-部侧-584",
    "所属区域": "-资产资源-虚拟资源调度管理-扩容核查-584677-007",
    "纳管状态": "处理中-677",
    "最近同步": "2026-05-15 11:44:51"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-584677-107-2446",
    "资产名称": "虚拟资源调度管理-资产纳管-08-584677",
    "资产类型": "资产资源-部侧-584",
    "所属区域": "-资产资源-虚拟资源调度管理-资产纳管-584677-008",
    "纳管状态": "处理中-677",
    "最近同步": "2026-05-21 15:36:35"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-584677-108-2165",
    "资产名称": "虚拟资源调度管理-数据上报-09-584677",
    "资产类型": "资产资源-核心-584",
    "所属区域": "-资产资源-虚拟资源调度管理-扩容核查-584677-009",
    "纳管状态": "处理中-677",
    "最近同步": "2026-05-08 17:41:20"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-584677-109-2647",
    "资产名称": "虚拟资源调度管理-部侧联动-10-584677",
    "资产类型": "资产资源-省侧-584",
    "所属区域": "-资产资源-虚拟资源调度管理-扩容核查-584677-010",
    "纳管状态": "待处理-677",
    "最近同步": "2026-05-16 14:36:12"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源调度管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源调度管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源调度管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源调度管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源调度管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
