    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增许可证使用规则", "add")'>新增许可证使用规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改许可证使用规则", "edit")'>修改许可证使用规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除许可证使用规则", "delete")'>删除许可证使用规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询许可证使用规则", "detail")'>查询许可证使用规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("许可证使用规则启用/禁用", "operation")'>许可证使用规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("许可证使用规则运行效果评估", "analysis")'>许可证使用规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("许可证使用规则分析", "analysis")'>许可证使用规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("许可证使用规则分析结果展示", "detail")'>许可证使用规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("许可证使用规则分析结果下载", "export")'>许可证使用规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("许可证使用规则分析结果上报", "analysis")'>许可证使用规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-160271-100-8453",
    "规则名称": "许可证使用规则管理-部侧联动-01-160271",
    "规则类型": "规则策略-核心-160",
    "启用状态": "待复核-271",
    "命中次数": 4544,
    "更新时间": "2026-05-18 11:16:25"
  },
  {
    "ID": 2,
    "规则编号": "RULE-160271-101-4203",
    "规则名称": "许可证使用规则管理-部侧联动-02-160271",
    "规则类型": "规则策略-复核-160",
    "启用状态": "已完成-271",
    "命中次数": 4522,
    "更新时间": "2026-05-12 09:15:31"
  },
  {
    "ID": 3,
    "规则编号": "RULE-160271-102-7591",
    "规则名称": "许可证使用规则管理-数据上报-03-160271",
    "规则类型": "规则策略-省侧-160",
    "启用状态": "异常-271",
    "命中次数": 4311,
    "更新时间": "2026-05-10 13:44:37"
  },
  {
    "ID": 4,
    "规则编号": "RULE-160271-103-9428",
    "规则名称": "许可证使用规则管理-异常复核-04-160271",
    "规则类型": "规则策略-边界-160",
    "启用状态": "处理中-271",
    "命中次数": 4378,
    "更新时间": "2026-05-14 16:09:08"
  },
  {
    "ID": 5,
    "规则编号": "RULE-160271-104-9214",
    "规则名称": "许可证使用规则管理-资产纳管-05-160271",
    "规则类型": "规则策略-边界-160",
    "启用状态": "已完成-271",
    "命中次数": 4952,
    "更新时间": "2026-05-20 14:22:10"
  },
  {
    "ID": 6,
    "规则编号": "RULE-160271-105-9837",
    "规则名称": "许可证使用规则管理-部侧联动-06-160271",
    "规则类型": "规则策略-复核-160",
    "启用状态": "待复核-271",
    "命中次数": 627,
    "更新时间": "2026-05-10 16:11:52"
  },
  {
    "ID": 7,
    "规则编号": "RULE-160271-106-3115",
    "规则名称": "许可证使用规则管理-数据上报-07-160271",
    "规则类型": "规则策略-自动化-160",
    "启用状态": "待复核-271",
    "命中次数": 3433,
    "更新时间": "2026-05-09 17:39:00"
  },
  {
    "ID": 8,
    "规则编号": "RULE-160271-107-2983",
    "规则名称": "许可证使用规则管理-自动采集-08-160271",
    "规则类型": "规则策略-边界-160",
    "启用状态": "异常-271",
    "命中次数": 3944,
    "更新时间": "2026-05-13 09:20:48"
  },
  {
    "ID": 9,
    "规则编号": "RULE-160271-108-4989",
    "规则名称": "许可证使用规则管理-数据上报-09-160271",
    "规则类型": "规则策略-核心-160",
    "启用状态": "已同步-271",
    "命中次数": 4197,
    "更新时间": "2026-05-14 13:03:22"
  },
  {
    "ID": 10,
    "规则编号": "RULE-160271-109-1340",
    "规则名称": "许可证使用规则管理-扩容核查-10-160271",
    "规则类型": "规则策略-部侧-160",
    "启用状态": "待复核-271",
    "命中次数": 2419,
    "更新时间": "2026-05-15 10:20:30"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "许可证使用规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "许可证使用规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "许可证使用规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "许可证使用规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "许可证使用规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
