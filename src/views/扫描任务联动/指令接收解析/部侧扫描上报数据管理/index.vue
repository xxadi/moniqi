    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增部侧扫描上报数据信息", "add")'>新增部侧扫描上报数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改部侧扫描上报数据信息", "edit")'>修改部侧扫描上报数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧扫描上报数据信息", "delete")'>删除部侧扫描上报数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧扫描上报数据列表", "detail")'>查询部侧扫描上报数据列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧扫描上报数据详情", "detail")'>查询部侧扫描上报数据详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入部侧扫描上报数据信息", "import")'>批量导入部侧扫描上报数据信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧扫描上报数据信息导出", "export")'>部侧扫描上报数据信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-879647-100-1532",
    "扫描对象": "部侧扫描上报数据管理-自动采集-01-879647",
    "扫描节点": "节点-01-47",
    "资产数量": 4820,
    "异常数量": 3286,
    "扫描状态": "已完成-647"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-879647-101-1567",
    "扫描对象": "部侧扫描上报数据管理-数据上报-02-879647",
    "扫描节点": "区公司节点-02-47",
    "资产数量": 3150,
    "异常数量": 3735,
    "扫描状态": "已完成-647"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-879647-102-5050",
    "扫描对象": "部侧扫描上报数据管理-异常复核-03-879647",
    "扫描节点": "节点-01-47",
    "资产数量": 1013,
    "异常数量": 4868,
    "扫描状态": "异常-647"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-879647-103-2353",
    "扫描对象": "部侧扫描上报数据管理-扩容核查-04-879647",
    "扫描节点": "节点-09-47",
    "资产数量": 3190,
    "异常数量": 1743,
    "扫描状态": "已完成-647"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-879647-104-3204",
    "扫描对象": "部侧扫描上报数据管理-资产纳管-05-879647",
    "扫描节点": "节点-07-47",
    "资产数量": 2955,
    "异常数量": 1077,
    "扫描状态": "处理中-647"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-879647-105-4358",
    "扫描对象": "部侧扫描上报数据管理-部侧联动-06-879647",
    "扫描节点": "区公司节点-02-47",
    "资产数量": 183,
    "异常数量": 1117,
    "扫描状态": "已完成-647"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-879647-106-4088",
    "扫描对象": "部侧扫描上报数据管理-数据上报-07-879647",
    "扫描节点": "节点-04-47",
    "资产数量": 2525,
    "异常数量": 1992,
    "扫描状态": "已完成-647"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-879647-107-5538",
    "扫描对象": "部侧扫描上报数据管理-数据上报-08-879647",
    "扫描节点": "区公司节点-01-47",
    "资产数量": 2589,
    "异常数量": 2529,
    "扫描状态": "待复核-647"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-879647-108-5694",
    "扫描对象": "部侧扫描上报数据管理-数据上报-09-879647",
    "扫描节点": "区公司节点-09-47",
    "资产数量": 3010,
    "异常数量": 3766,
    "扫描状态": "异常-647"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-879647-109-8218",
    "扫描对象": "部侧扫描上报数据管理-数据上报-10-879647",
    "扫描节点": "节点-07-47",
    "资产数量": 3455,
    "异常数量": 4981,
    "扫描状态": "处理中-647"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧扫描上报数据管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧扫描上报数据管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧扫描上报数据管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧扫描上报数据管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧扫描上报数据管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
