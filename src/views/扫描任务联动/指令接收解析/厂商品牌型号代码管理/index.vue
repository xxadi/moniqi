    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加厂商品牌型号代码信息", "add")'>添加厂商品牌型号代码信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑厂商品牌型号代码信息", "edit")'>编辑厂商品牌型号代码信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除厂商品牌型号代码信息", "delete")'>删除厂商品牌型号代码信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询厂商品牌型号代码列表", "detail")'>查询厂商品牌型号代码列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询厂商品牌型号代码详情", "detail")'>查询厂商品牌型号代码详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入厂商品牌型号代码信息", "import")'>批量导入厂商品牌型号代码信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("厂商品牌型号代码信息导出", "export")'>厂商品牌型号代码信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-513096-100-1099",
    "业务名称": "厂商品牌型号代码管理-自动采集-01-513096",
    "业务类型": "业务联动-复核-513",
    "处理状态": "已同步-096",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-15 10:05:25"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-513096-101-4483",
    "业务名称": "厂商品牌型号代码管理-部侧联动-02-513096",
    "业务类型": "业务联动-核心-513",
    "处理状态": "已同步-096",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-19 09:38:05"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-513096-102-9383",
    "业务名称": "区公司厂商品牌型号代码管理-数据上报-03-513096",
    "业务类型": "业务联动-自动化-513",
    "处理状态": "待复核-096",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-11 09:09:25"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-513096-103-1560",
    "业务名称": "厂商品牌型号代码管理-异常复核-04-513096",
    "业务类型": "业务联动-核心-513",
    "处理状态": "异常-096",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-14 16:00:40"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-513096-104-2490",
    "业务名称": "厂商品牌型号代码管理-部侧联动-05-513096",
    "业务类型": "业务联动-核心-513",
    "处理状态": "待复核-096",
    "负责人": "数据复核员-区公司",
    "更新时间": "2026-05-19 14:57:30"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-513096-105-2455",
    "业务名称": "厂商品牌型号代码管理-异常复核-06-513096",
    "业务类型": "业务联动-边界-513",
    "处理状态": "已完成-096",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-23 09:45:14"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-513096-106-2526",
    "业务名称": "厂商品牌型号代码管理-异常复核-07-513096",
    "业务类型": "业务联动-核心-513",
    "处理状态": "已同步-096",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-22 16:57:11"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-513096-107-4528",
    "业务名称": "厂商品牌型号代码管理-部侧联动-08-513096",
    "业务类型": "业务联动-核心-513",
    "处理状态": "处理中-096",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-13 13:19:29"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-513096-108-9919",
    "业务名称": "厂商品牌型号代码管理-资产纳管-09-513096",
    "业务类型": "业务联动-省侧-513",
    "处理状态": "待复核-096",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-22 16:55:14"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-513096-109-4428",
    "业务名称": "厂商品牌型号代码管理-部侧联动-10-513096",
    "业务类型": "业务联动-部侧-513",
    "处理状态": "已完成-096",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-23 09:27:16"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "厂商品牌型号代码管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "厂商品牌型号代码管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "厂商品牌型号代码管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "厂商品牌型号代码管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "厂商品牌型号代码管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
