    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加虚拟资源自动分类模型", "add")'>添加虚拟资源自动分类模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑虚拟资源自动分类模型", "edit")'>编辑虚拟资源自动分类模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源自动分类模型", "delete")'>删除虚拟资源自动分类模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源自动分类模型", "detail")'>查询虚拟资源自动分类模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源自动分类模型启用/禁用", "operation")'>虚拟资源自动分类模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源自动分类模型运行效果评估", "analysis")'>虚拟资源自动分类模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源自动分类模型分析", "analysis")'>虚拟资源自动分类模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源自动分类模型分析结果展示", "detail")'>虚拟资源自动分类模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源自动分类模型分析结果下载", "export")'>虚拟资源自动分类模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源自动分类模型分析结果上报", "analysis")'>虚拟资源自动分类模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-807401-100-3630",
    "规则名称": "虚拟资源自动分类模型管理-资产纳管-01-807401",
    "规则类型": "规则策略-省侧-807",
    "启用状态": "待处理-401",
    "命中次数": 103,
    "更新时间": "2026-05-23 13:36:35"
  },
  {
    "ID": 2,
    "规则编号": "RULE-807401-101-3794",
    "规则名称": "虚拟资源自动分类模型管理-扩容核查-02-807401",
    "规则类型": "规则策略-核心-807",
    "启用状态": "待处理-401",
    "命中次数": 3792,
    "更新时间": "2026-05-15 13:35:00"
  },
  {
    "ID": 3,
    "规则编号": "RULE-807401-102-3452",
    "规则名称": "区公司虚拟资源自动分类模型管理-部侧联动-03-807401",
    "规则类型": "规则策略-自动化-807",
    "启用状态": "已同步-401",
    "命中次数": 2053,
    "更新时间": "2026-05-19 12:41:54"
  },
  {
    "ID": 4,
    "规则编号": "RULE-807401-103-5187",
    "规则名称": "虚拟资源自动分类模型管理-自动采集-04-807401",
    "规则类型": "规则策略-省侧-807",
    "启用状态": "待处理-401",
    "命中次数": 559,
    "更新时间": "2026-05-25 08:16:31"
  },
  {
    "ID": 5,
    "规则编号": "RULE-807401-104-6057",
    "规则名称": "虚拟资源自动分类模型管理-自动采集-05-807401",
    "规则类型": "规则策略-核心-807",
    "启用状态": "待处理-401",
    "命中次数": 636,
    "更新时间": "2026-05-11 13:30:00"
  },
  {
    "ID": 6,
    "规则编号": "RULE-807401-105-6280",
    "规则名称": "虚拟资源自动分类模型管理-资产纳管-06-807401",
    "规则类型": "规则策略-部侧-807",
    "启用状态": "待处理-401",
    "命中次数": 2321,
    "更新时间": "2026-05-23 16:07:02"
  },
  {
    "ID": 7,
    "规则编号": "RULE-807401-106-2539",
    "规则名称": "虚拟资源自动分类模型管理-数据上报-07-807401",
    "规则类型": "规则策略-自动化-807",
    "启用状态": "处理中-401",
    "命中次数": 1774,
    "更新时间": "2026-05-15 12:54:14"
  },
  {
    "ID": 8,
    "规则编号": "RULE-807401-107-1728",
    "规则名称": "区公司虚拟资源自动分类模型管理-自动采集-08-807401",
    "规则类型": "规则策略-复核-807",
    "启用状态": "待处理-401",
    "命中次数": 2043,
    "更新时间": "2026-05-11 10:05:17"
  },
  {
    "ID": 9,
    "规则编号": "RULE-807401-108-6735",
    "规则名称": "虚拟资源自动分类模型管理-部侧联动-09-807401",
    "规则类型": "规则策略-自动化-807",
    "启用状态": "处理中-401",
    "命中次数": 3467,
    "更新时间": "2026-05-22 10:08:15"
  },
  {
    "ID": 10,
    "规则编号": "RULE-807401-109-4463",
    "规则名称": "区公司虚拟资源自动分类模型管理-自动采集-10-807401",
    "规则类型": "规则策略-边界-807",
    "启用状态": "处理中-401",
    "命中次数": 104,
    "更新时间": "2026-05-24 10:05:55"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源自动分类模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源自动分类模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源自动分类模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源自动分类模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源自动分类模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
