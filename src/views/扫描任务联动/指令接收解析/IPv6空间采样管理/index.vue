    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv6空间采样信息", "add")'>新增IPv6空间采样信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv6空间采样信息", "edit")'>修改IPv6空间采样信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6空间采样信息", "delete")'>删除IPv6空间采样信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6空间采样列表", "detail")'>查询IPv6空间采样列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6空间采样详情", "detail")'>查询IPv6空间采样详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入IPv6空间采样信息", "import")'>批量导入IPv6空间采样信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6空间采样信息导出", "export")'>IPv6空间采样信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-120174-100-2423",
    "业务名称": "区公司IPv6空间采样管理-自动采集-01-120174",
    "业务类型": "业务联动-自动化-120",
    "处理状态": "已完成-174",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-23 10:31:32"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-120174-101-4827",
    "业务名称": "IPv6空间采样管理-数据上报-02-120174",
    "业务类型": "业务联动-核心-120",
    "处理状态": "待复核-174",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-23 12:51:42"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-120174-102-2438",
    "业务名称": "IPv6空间采样管理-自动采集-03-120174",
    "业务类型": "业务联动-部侧-120",
    "处理状态": "异常-174",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-13 15:13:36"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-120174-103-8519",
    "业务名称": "IPv6空间采样管理-数据上报-04-120174",
    "业务类型": "业务联动-边界-120",
    "处理状态": "待处理-174",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-08 12:03:10"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-120174-104-7133",
    "业务名称": "IPv6空间采样管理-数据上报-05-120174",
    "业务类型": "业务联动-核心-120",
    "处理状态": "已完成-174",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-23 11:36:38"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-120174-105-1822",
    "业务名称": "区公司IPv6空间采样管理-资产纳管-06-120174",
    "业务类型": "业务联动-复核-120",
    "处理状态": "待复核-174",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-17 08:57:29"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-120174-106-2345",
    "业务名称": "IPv6空间采样管理-扩容核查-07-120174",
    "业务类型": "业务联动-省侧-120",
    "处理状态": "待复核-174",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-25 13:58:18"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-120174-107-1937",
    "业务名称": "IPv6空间采样管理-数据上报-08-120174",
    "业务类型": "业务联动-边界-120",
    "处理状态": "待复核-174",
    "负责人": "资产安全管理员-区公司",
    "更新时间": "2026-05-19 08:09:47"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-120174-108-8447",
    "业务名称": "IPv6空间采样管理-部侧联动-09-120174",
    "业务类型": "业务联动-核心-120",
    "处理状态": "异常-174",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-20 14:41:22"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-120174-109-1641",
    "业务名称": "IPv6空间采样管理-扩容核查-10-120174",
    "业务类型": "业务联动-核心-120",
    "处理状态": "待处理-174",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-20 11:16:53"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6空间采样管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6空间采样管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6空间采样管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6空间采样管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6空间采样管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
