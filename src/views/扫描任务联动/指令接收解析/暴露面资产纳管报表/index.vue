    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增暴露面资产纳管报表信息", "add")'>新增暴露面资产纳管报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面资产纳管报表信息", "edit")'>修改暴露面资产纳管报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除暴露面资产纳管报表信息", "delete")'>删除暴露面资产纳管报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看暴露面资产纳管报表信息", "add")'>查看暴露面资产纳管报表信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表数据提取", "add")'>暴露面资产纳管报表数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表数据识别", "add")'>暴露面资产纳管报表数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表清洗", "add")'>暴露面资产纳管报表清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表分级", "add")'>暴露面资产纳管报表分级</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表实时计算", "add")'>暴露面资产纳管报表实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表聚合", "add")'>暴露面资产纳管报表聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("暴露面资产纳管报表信息导出", "export")'>暴露面资产纳管报表信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表可视化展示", "add")'>暴露面资产纳管报表可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("暴露面资产纳管报表数据审查", "add")'>暴露面资产纳管报表数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-220560-100-7590",
    "资产名称": "暴露面资产纳管报表-部侧联动-01-220560",
    "资产类型": "资产资源-核心-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-自动采集-220560-001",
    "纳管状态": "已同步-560",
    "最近同步": "2026-05-16 16:02:05"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-220560-101-9966",
    "资产名称": "暴露面资产纳管报表-资产纳管-02-220560",
    "资产类型": "资产资源-部侧-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-部侧联动-220560-002",
    "纳管状态": "待复核-560",
    "最近同步": "2026-05-17 17:35:45"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-220560-102-3159",
    "资产名称": "暴露面资产纳管报表-异常复核-03-220560",
    "资产类型": "资产资源-核心-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-扩容核查-220560-003",
    "纳管状态": "待复核-560",
    "最近同步": "2026-05-19 09:43:53"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-220560-103-3713",
    "资产名称": "暴露面资产纳管报表-扩容核查-04-220560",
    "资产类型": "资产资源-自动化-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-数据上报-220560-004",
    "纳管状态": "待处理-560",
    "最近同步": "2026-05-22 10:52:50"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-220560-104-2655",
    "资产名称": "暴露面资产纳管报表-部侧联动-05-220560",
    "资产类型": "资产资源-部侧-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-自动采集-220560-005",
    "纳管状态": "待复核-560",
    "最近同步": "2026-05-22 17:39:31"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-220560-105-6389",
    "资产名称": "暴露面资产纳管报表-部侧联动-06-220560",
    "资产类型": "资产资源-核心-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-数据上报-220560-006",
    "纳管状态": "待处理-560",
    "最近同步": "2026-05-15 15:01:39"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-220560-106-3105",
    "资产名称": "暴露面资产纳管报表-异常复核-07-220560",
    "资产类型": "资产资源-部侧-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-资产纳管-220560-007",
    "纳管状态": "已完成-560",
    "最近同步": "2026-05-19 12:28:53"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-220560-107-6312",
    "资产名称": "区公司暴露面资产纳管报表-数据上报-08-220560",
    "资产类型": "资产资源-复核-220",
    "所属区域": "-资产资源-暴露面资产纳管报表-数据上报-220560-008",
    "纳管状态": "已完成-560",
    "最近同步": "2026-05-16 14:35:58"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-220560-108-6407",
    "资产名称": "暴露面资产纳管报表-部侧联动-09-220560",
    "资产类型": "资产资源-边界-220",
    "所属区域": "区公司-资产资源-暴露面资产纳管报表-异常复核-220560-009",
    "纳管状态": "已同步-560",
    "最近同步": "2026-05-14 11:54:29"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-220560-109-5242",
    "资产名称": "暴露面资产纳管报表-部侧联动-10-220560",
    "资产类型": "资产资源-核心-220",
    "所属区域": "区公司-资产资源-暴露面资产纳管报表-资产纳管-220560-010",
    "纳管状态": "已完成-560",
    "最近同步": "2026-05-25 13:00:11"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "暴露面资产纳管报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "暴露面资产纳管报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "暴露面资产纳管报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "暴露面资产纳管报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "暴露面资产纳管报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
