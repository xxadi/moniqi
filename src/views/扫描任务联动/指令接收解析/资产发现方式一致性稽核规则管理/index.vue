    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产发现方式一致性稽核规则", "add")'>新增资产发现方式一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产发现方式一致性稽核规则", "edit")'>修改资产发现方式一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产发现方式一致性稽核规则", "delete")'>删除资产发现方式一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产发现方式一致性稽核规则", "detail")'>查询资产发现方式一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核规则启用/禁用", "detail")'>资产发现方式一致性稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核告警", "detail")'>资产发现方式一致性稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核结果统计", "detail")'>资产发现方式一致性稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核数据提取", "detail")'>资产发现方式一致性稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核规则分析", "detail")'>资产发现方式一致性稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核规则分析结果展示", "detail")'>资产发现方式一致性稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产发现方式一致性稽核规则分析结果下载", "export")'>资产发现方式一致性稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式一致性稽核规则分析结果上报", "detail")'>资产发现方式一致性稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-016628-100-1976",
    "规则名称": "资产发现方式一致性稽核规则管理-自动采集-01-016628",
    "规则类型": "规则策略-省侧-016",
    "启用状态": "异常-628",
    "命中次数": 3082,
    "更新时间": "2026-05-12 15:30:21"
  },
  {
    "ID": 2,
    "规则编号": "RULE-016628-101-9516",
    "规则名称": "资产发现方式一致性稽核规则管理-自动采集-02-016628",
    "规则类型": "规则策略-核心-016",
    "启用状态": "已同步-628",
    "命中次数": 2300,
    "更新时间": "2026-05-25 10:23:32"
  },
  {
    "ID": 3,
    "规则编号": "RULE-016628-102-2509",
    "规则名称": "资产发现方式一致性稽核规则管理-自动采集-03-016628",
    "规则类型": "规则策略-边界-016",
    "启用状态": "已完成-628",
    "命中次数": 4006,
    "更新时间": "2026-05-08 16:34:49"
  },
  {
    "ID": 4,
    "规则编号": "RULE-016628-103-9018",
    "规则名称": "资产发现方式一致性稽核规则管理-部侧联动-04-016628",
    "规则类型": "规则策略-自动化-016",
    "启用状态": "已同步-628",
    "命中次数": 4286,
    "更新时间": "2026-05-10 08:40:54"
  },
  {
    "ID": 5,
    "规则编号": "RULE-016628-104-3301",
    "规则名称": "资产发现方式一致性稽核规则管理-异常复核-05-016628",
    "规则类型": "规则策略-部侧-016",
    "启用状态": "异常-628",
    "命中次数": 2956,
    "更新时间": "2026-05-22 08:03:22"
  },
  {
    "ID": 6,
    "规则编号": "RULE-016628-105-1879",
    "规则名称": "资产发现方式一致性稽核规则管理-自动采集-06-016628",
    "规则类型": "规则策略-自动化-016",
    "启用状态": "待处理-628",
    "命中次数": 4534,
    "更新时间": "2026-05-09 14:06:53"
  },
  {
    "ID": 7,
    "规则编号": "RULE-016628-106-3952",
    "规则名称": "区公司资产发现方式一致性稽核规则管理-数据上报-07-016628",
    "规则类型": "规则策略-边界-016",
    "启用状态": "待处理-628",
    "命中次数": 1021,
    "更新时间": "2026-05-08 13:42:24"
  },
  {
    "ID": 8,
    "规则编号": "RULE-016628-107-5339",
    "规则名称": "区公司资产发现方式一致性稽核规则管理-部侧联动-08-016628",
    "规则类型": "规则策略-边界-016",
    "启用状态": "处理中-628",
    "命中次数": 2081,
    "更新时间": "2026-05-20 14:53:36"
  },
  {
    "ID": 9,
    "规则编号": "RULE-016628-108-3634",
    "规则名称": "资产发现方式一致性稽核规则管理-部侧联动-09-016628",
    "规则类型": "规则策略-复核-016",
    "启用状态": "异常-628",
    "命中次数": 3256,
    "更新时间": "2026-05-21 13:59:22"
  },
  {
    "ID": 10,
    "规则编号": "RULE-016628-109-6835",
    "规则名称": "资产发现方式一致性稽核规则管理-自动采集-10-016628",
    "规则类型": "规则策略-部侧-016",
    "启用状态": "异常-628",
    "命中次数": 3915,
    "更新时间": "2026-05-23 17:50:11"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产发现方式一致性稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产发现方式一致性稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产发现方式一致性稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产发现方式一致性稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产发现方式一致性稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "资产发现方式一致性稽核规则管理" },
