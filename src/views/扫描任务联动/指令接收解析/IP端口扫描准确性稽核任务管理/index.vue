    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP端口扫描准确性稽核任务", "add")'>新增IP端口扫描准确性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP端口扫描准确性稽核任务", "delete")'>删除IP端口扫描准确性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP端口扫描准确性稽核任务", "edit")'>修改IP端口扫描准确性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP端口扫描准确性稽核任务", "detail")'>查询IP端口扫描准确性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核任务启用/禁用", "detail")'>IP端口扫描准确性稽核任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核告警", "detail")'>IP端口扫描准确性稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核结果统计", "detail")'>IP端口扫描准确性稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核数据提取", "detail")'>IP端口扫描准确性稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核运行分析", "detail")'>IP端口扫描准确性稽核运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核分析结果展示", "detail")'>IP端口扫描准确性稽核分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP端口扫描准确性稽核分析结果下载", "export")'>IP端口扫描准确性稽核分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP端口扫描准确性稽核分析结果上报", "detail")'>IP端口扫描准确性稽核分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-500460-100-5844",
    "扫描对象": "IP端口扫描准确性稽核任务管理-扩容核查-01-500460",
    "扫描节点": "节点-09-60",
    "资产数量": 1332,
    "异常数量": 4166,
    "扫描状态": "已完成-460"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-500460-101-1213",
    "扫描对象": "IP端口扫描准确性稽核任务管理-自动采集-02-500460",
    "扫描节点": "节点-03-60",
    "资产数量": 1126,
    "异常数量": 3015,
    "扫描状态": "异常-460"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-500460-102-2359",
    "扫描对象": "IP端口扫描准确性稽核任务管理-扩容核查-03-500460",
    "扫描节点": "节点-08-60",
    "资产数量": 1338,
    "异常数量": 2507,
    "扫描状态": "处理中-460"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-500460-103-5495",
    "扫描对象": "IP端口扫描准确性稽核任务管理-数据上报-04-500460",
    "扫描节点": "节点-09-60",
    "资产数量": 4541,
    "异常数量": 1831,
    "扫描状态": "异常-460"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-500460-104-9649",
    "扫描对象": "IP端口扫描准确性稽核任务管理-资产纳管-05-500460",
    "扫描节点": "区公司节点-09-60",
    "资产数量": 3229,
    "异常数量": 2433,
    "扫描状态": "异常-460"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-500460-105-8386",
    "扫描对象": "IP端口扫描准确性稽核任务管理-数据上报-06-500460",
    "扫描节点": "节点-03-60",
    "资产数量": 1784,
    "异常数量": 1342,
    "扫描状态": "已完成-460"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-500460-106-8551",
    "扫描对象": "区公司IP端口扫描准确性稽核任务管理-部侧联动-07-500460",
    "扫描节点": "节点-09-60",
    "资产数量": 1303,
    "异常数量": 3910,
    "扫描状态": "处理中-460"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-500460-107-8165",
    "扫描对象": "区公司IP端口扫描准确性稽核任务管理-数据上报-08-500460",
    "扫描节点": "节点-02-60",
    "资产数量": 4841,
    "异常数量": 704,
    "扫描状态": "待处理-460"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-500460-108-3713",
    "扫描对象": "区公司IP端口扫描准确性稽核任务管理-资产纳管-09-500460",
    "扫描节点": "节点-04-60",
    "资产数量": 3333,
    "异常数量": 1959,
    "扫描状态": "处理中-460"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-500460-109-3488",
    "扫描对象": "IP端口扫描准确性稽核任务管理-异常复核-10-500460",
    "扫描节点": "节点-07-60",
    "资产数量": 3649,
    "异常数量": 3202,
    "扫描状态": "待处理-460"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP端口扫描准确性稽核任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP端口扫描准确性稽核任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP端口扫描准确性稽核任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP端口扫描准确性稽核任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP端口扫描准确性稽核任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IP端口扫描准确性稽核任务管理" },
