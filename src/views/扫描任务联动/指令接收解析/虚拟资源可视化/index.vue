    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源折线图展示", "detail")'>虚拟资源折线图展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看虚拟资源详情", "detail")'>查看虚拟资源详情</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源TOP10展示", "detail")'>虚拟资源TOP10展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源百分比展示", "detail")'>虚拟资源百分比展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源饼图展示", "detail")'>虚拟资源饼图展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源柱状图展示", "detail")'>虚拟资源柱状图展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源数据展示", "detail")'>虚拟资源数据展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源热力图展示", "detail")'>虚拟资源热力图展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-047016-100-1214",
    "资产名称": "区公司虚拟资源可视化-部侧联动-01-047016",
    "资产类型": "资产资源-部侧-047",
    "所属区域": "-资产资源-虚拟资源可视化-部侧联动-047016-001",
    "纳管状态": "已完成-016",
    "最近同步": "2026-05-16 11:21:32"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-047016-101-2352",
    "资产名称": "区公司虚拟资源可视化-异常复核-02-047016",
    "资产类型": "资产资源-边界-047",
    "所属区域": "-资产资源-虚拟资源可视化-数据上报-047016-002",
    "纳管状态": "异常-016",
    "最近同步": "2026-05-20 15:41:18"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-047016-102-9638",
    "资产名称": "虚拟资源可视化-自动采集-03-047016",
    "资产类型": "资产资源-部侧-047",
    "所属区域": "-资产资源-虚拟资源可视化-扩容核查-047016-003",
    "纳管状态": "已完成-016",
    "最近同步": "2026-05-14 14:46:36"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-047016-103-2813",
    "资产名称": "虚拟资源可视化-资产纳管-04-047016",
    "资产类型": "资产资源-省侧-047",
    "所属区域": "-资产资源-虚拟资源可视化-部侧联动-047016-004",
    "纳管状态": "已完成-016",
    "最近同步": "2026-05-14 11:23:12"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-047016-104-8516",
    "资产名称": "区公司虚拟资源可视化-自动采集-05-047016",
    "资产类型": "资产资源-自动化-047",
    "所属区域": "-资产资源-虚拟资源可视化-资产纳管-047016-005",
    "纳管状态": "已完成-016",
    "最近同步": "2026-05-18 15:03:50"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-047016-105-5213",
    "资产名称": "虚拟资源可视化-数据上报-06-047016",
    "资产类型": "资产资源-边界-047",
    "所属区域": "-资产资源-虚拟资源可视化-数据上报-047016-006",
    "纳管状态": "已同步-016",
    "最近同步": "2026-05-25 08:59:49"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-047016-106-1370",
    "资产名称": "虚拟资源可视化-部侧联动-07-047016",
    "资产类型": "资产资源-核心-047",
    "所属区域": "-资产资源-虚拟资源可视化-异常复核-047016-007",
    "纳管状态": "处理中-016",
    "最近同步": "2026-05-12 12:28:16"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-047016-107-6946",
    "资产名称": "区公司虚拟资源可视化-资产纳管-08-047016",
    "资产类型": "资产资源-部侧-047",
    "所属区域": "-资产资源-虚拟资源可视化-数据上报-047016-008",
    "纳管状态": "待处理-016",
    "最近同步": "2026-05-21 15:17:42"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-047016-108-7219",
    "资产名称": "虚拟资源可视化-自动采集-09-047016",
    "资产类型": "资产资源-边界-047",
    "所属区域": "-资产资源-虚拟资源可视化-扩容核查-047016-009",
    "纳管状态": "待处理-016",
    "最近同步": "2026-05-08 14:13:57"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-047016-109-7485",
    "资产名称": "区公司虚拟资源可视化-部侧联动-10-047016",
    "资产类型": "资产资源-自动化-047",
    "所属区域": "-资产资源-虚拟资源可视化-数据上报-047016-010",
    "纳管状态": "处理中-016",
    "最近同步": "2026-05-11 11:38:52"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源可视化导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源可视化调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源可视化异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源可视化业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源可视化复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
