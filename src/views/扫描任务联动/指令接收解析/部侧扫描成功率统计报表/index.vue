    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加部侧扫描成功率统计信息", "add")'>添加部侧扫描成功率统计信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑部侧扫描成功率统计信息", "edit")'>编辑部侧扫描成功率统计信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧扫描成功率统计信息", "delete")'>删除部侧扫描成功率统计信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看部侧扫描成功率统计信息", "detail")'>查看部侧扫描成功率统计信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计数据提取", "analysis")'>部侧扫描成功率统计数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计数据识别", "analysis")'>部侧扫描成功率统计数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计清洗", "analysis")'>部侧扫描成功率统计清洗</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计分级", "analysis")'>部侧扫描成功率统计分级</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计实时计算", "analysis")'>部侧扫描成功率统计实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧扫描成功率统计聚合", "analysis")'>部侧扫描成功率统计聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧扫描成功率统计信息导出", "export")'>部侧扫描成功率统计信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧扫描成功率统计可视化展示", "detail")'>部侧扫描成功率统计可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧扫描成功率统计数据审查", "detail")'>部侧扫描成功率统计数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-722190-100-3135",
    "扫描对象": "部侧扫描成功率统计报表-扩容核查-01-722190",
    "扫描节点": "节点-05-90",
    "资产数量": 3205,
    "异常数量": 1530,
    "扫描状态": "已完成-190"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-722190-101-1569",
    "扫描对象": "部侧扫描成功率统计报表-自动采集-02-722190",
    "扫描节点": "节点-04-90",
    "资产数量": 288,
    "异常数量": 1622,
    "扫描状态": "待复核-190"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-722190-102-8270",
    "扫描对象": "部侧扫描成功率统计报表-自动采集-03-722190",
    "扫描节点": "节点-04-90",
    "资产数量": 284,
    "异常数量": 4218,
    "扫描状态": "已同步-190"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-722190-103-6043",
    "扫描对象": "部侧扫描成功率统计报表-资产纳管-04-722190",
    "扫描节点": "节点-01-90",
    "资产数量": 1967,
    "异常数量": 4142,
    "扫描状态": "处理中-190"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-722190-104-5917",
    "扫描对象": "部侧扫描成功率统计报表-扩容核查-05-722190",
    "扫描节点": "节点-03-90",
    "资产数量": 95,
    "异常数量": 3644,
    "扫描状态": "已同步-190"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-722190-105-6020",
    "扫描对象": "部侧扫描成功率统计报表-扩容核查-06-722190",
    "扫描节点": "节点-08-90",
    "资产数量": 1556,
    "异常数量": 3915,
    "扫描状态": "已完成-190"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-722190-106-1109",
    "扫描对象": "部侧扫描成功率统计报表-自动采集-07-722190",
    "扫描节点": "节点-07-90",
    "资产数量": 796,
    "异常数量": 2094,
    "扫描状态": "已完成-190"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-722190-107-6891",
    "扫描对象": "区公司部侧扫描成功率统计报表-资产纳管-08-722190",
    "扫描节点": "节点-05-90",
    "资产数量": 1358,
    "异常数量": 1364,
    "扫描状态": "异常-190"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-722190-108-3171",
    "扫描对象": "部侧扫描成功率统计报表-资产纳管-09-722190",
    "扫描节点": "节点-05-90",
    "资产数量": 4228,
    "异常数量": 1592,
    "扫描状态": "异常-190"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-722190-109-5871",
    "扫描对象": "部侧扫描成功率统计报表-自动采集-10-722190",
    "扫描节点": "节点-04-90",
    "资产数量": 418,
    "异常数量": 2539,
    "扫描状态": "待复核-190"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧扫描成功率统计报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧扫描成功率统计报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧扫描成功率统计报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧扫描成功率统计报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧扫描成功率统计报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
