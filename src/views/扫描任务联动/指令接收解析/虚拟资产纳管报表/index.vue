    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资产纳管信息", "add")'>新增虚拟资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资产纳管信息", "edit")'>修改虚拟资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资产纳管信息", "delete")'>删除虚拟资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看虚拟资产纳管信息", "add")'>查看虚拟资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管数据提取", "add")'>虚拟资产纳管数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管数据识别", "add")'>虚拟资产纳管数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管清洗", "add")'>虚拟资产纳管清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管分级", "add")'>虚拟资产纳管分级</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管实时计算", "add")'>虚拟资产纳管实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管聚合", "add")'>虚拟资产纳管聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资产纳管信息导出", "export")'>虚拟资产纳管信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管可视化展示", "add")'>虚拟资产纳管可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("虚拟资产纳管数据审查", "add")'>虚拟资产纳管数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-342275-100-3573",
    "资产名称": "虚拟资产纳管报表-异常复核-01-342275",
    "资产类型": "资产资源-边界-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-数据上报-342275-001",
    "纳管状态": "待复核-275",
    "最近同步": "2026-05-25 11:39:59"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-342275-101-7326",
    "资产名称": "虚拟资产纳管报表-自动采集-02-342275",
    "资产类型": "资产资源-复核-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-自动采集-342275-002",
    "纳管状态": "已完成-275",
    "最近同步": "2026-05-14 10:30:46"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-342275-102-5024",
    "资产名称": "区公司虚拟资产纳管报表-资产纳管-03-342275",
    "资产类型": "资产资源-省侧-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-部侧联动-342275-003",
    "纳管状态": "异常-275",
    "最近同步": "2026-05-08 08:41:14"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-342275-103-3998",
    "资产名称": "虚拟资产纳管报表-数据上报-04-342275",
    "资产类型": "资产资源-部侧-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-异常复核-342275-004",
    "纳管状态": "处理中-275",
    "最近同步": "2026-05-14 17:37:41"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-342275-104-2390",
    "资产名称": "虚拟资产纳管报表-资产纳管-05-342275",
    "资产类型": "资产资源-部侧-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-数据上报-342275-005",
    "纳管状态": "待处理-275",
    "最近同步": "2026-05-18 12:06:20"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-342275-105-9816",
    "资产名称": "虚拟资产纳管报表-异常复核-06-342275",
    "资产类型": "资产资源-复核-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-扩容核查-342275-006",
    "纳管状态": "待复核-275",
    "最近同步": "2026-05-12 15:00:35"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-342275-106-4029",
    "资产名称": "虚拟资产纳管报表-扩容核查-07-342275",
    "资产类型": "资产资源-自动化-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-数据上报-342275-007",
    "纳管状态": "已完成-275",
    "最近同步": "2026-05-22 16:03:35"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-342275-107-2676",
    "资产名称": "虚拟资产纳管报表-自动采集-08-342275",
    "资产类型": "资产资源-省侧-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-扩容核查-342275-008",
    "纳管状态": "待处理-275",
    "最近同步": "2026-05-12 12:35:38"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-342275-108-7065",
    "资产名称": "虚拟资产纳管报表-异常复核-09-342275",
    "资产类型": "资产资源-省侧-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-数据上报-342275-009",
    "纳管状态": "已同步-275",
    "最近同步": "2026-05-24 08:29:57"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-342275-109-4143",
    "资产名称": "虚拟资产纳管报表-数据上报-10-342275",
    "资产类型": "资产资源-边界-342",
    "所属区域": "-资产资源-虚拟资产纳管报表-部侧联动-342275-010",
    "纳管状态": "已完成-275",
    "最近同步": "2026-05-13 13:09:15"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资产纳管报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资产纳管报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资产纳管报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资产纳管报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资产纳管报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
