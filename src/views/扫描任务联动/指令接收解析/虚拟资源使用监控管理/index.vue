    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源使用监控任务信息", "add")'>新增虚拟资源使用监控任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源使用监控任务信息", "edit")'>修改虚拟资源使用监控任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源使用监控任务信息", "delete")'>删除虚拟资源使用监控任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源使用监控任务", "detail")'>查询虚拟资源使用监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源使用监控统计", "detail")'>虚拟资源使用监控统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源使用监控信息下载", "export")'>虚拟资源使用监控信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-235883-100-4599",
    "资产名称": "虚拟资源使用监控管理-扩容核查-01-235883",
    "资产类型": "资产资源-复核-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-部侧联动-235883-001",
    "纳管状态": "已完成-883",
    "最近同步": "2026-05-24 14:24:48"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-235883-101-4121",
    "资产名称": "区公司虚拟资源使用监控管理-数据上报-02-235883",
    "资产类型": "资产资源-核心-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-自动采集-235883-002",
    "纳管状态": "已完成-883",
    "最近同步": "2026-05-19 13:35:46"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-235883-102-2129",
    "资产名称": "虚拟资源使用监控管理-数据上报-03-235883",
    "资产类型": "资产资源-核心-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-资产纳管-235883-003",
    "纳管状态": "待复核-883",
    "最近同步": "2026-05-09 11:12:00"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-235883-103-3689",
    "资产名称": "虚拟资源使用监控管理-数据上报-04-235883",
    "资产类型": "资产资源-部侧-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-数据上报-235883-004",
    "纳管状态": "待处理-883",
    "最近同步": "2026-05-25 15:15:46"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-235883-104-6451",
    "资产名称": "虚拟资源使用监控管理-异常复核-05-235883",
    "资产类型": "资产资源-复核-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-异常复核-235883-005",
    "纳管状态": "已同步-883",
    "最近同步": "2026-05-12 13:08:19"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-235883-105-5497",
    "资产名称": "虚拟资源使用监控管理-自动采集-06-235883",
    "资产类型": "资产资源-省侧-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-自动采集-235883-006",
    "纳管状态": "已完成-883",
    "最近同步": "2026-05-17 10:00:17"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-235883-106-6162",
    "资产名称": "虚拟资源使用监控管理-异常复核-07-235883",
    "资产类型": "资产资源-部侧-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-资产纳管-235883-007",
    "纳管状态": "已完成-883",
    "最近同步": "2026-05-14 13:51:07"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-235883-107-4371",
    "资产名称": "区公司虚拟资源使用监控管理-异常复核-08-235883",
    "资产类型": "资产资源-省侧-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-部侧联动-235883-008",
    "纳管状态": "异常-883",
    "最近同步": "2026-05-24 08:27:30"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-235883-108-7590",
    "资产名称": "虚拟资源使用监控管理-扩容核查-09-235883",
    "资产类型": "资产资源-省侧-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-自动采集-235883-009",
    "纳管状态": "已完成-883",
    "最近同步": "2026-05-18 15:58:00"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-235883-109-1163",
    "资产名称": "虚拟资源使用监控管理-扩容核查-10-235883",
    "资产类型": "资产资源-核心-235",
    "所属区域": "-资产资源-虚拟资源使用监控管理-数据上报-235883-010",
    "纳管状态": "待处理-883",
    "最近同步": "2026-05-08 13:12:08"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源使用监控管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源使用监控管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源使用监控管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源使用监控管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源使用监控管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
