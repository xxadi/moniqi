    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增组件库信息", "add")'>新增组件库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改组件库信息", "edit")'>修改组件库信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除组件库信息", "delete")'>删除组件库信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询组件库", "detail")'>查询组件库</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("组件库统计", "analysis")'>组件库统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("组件库信息下载", "export")'>组件库信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-272144-100-6101",
    "资产名称": "组件库管理-自动采集-01-272144",
    "资产类型": "资产资源-自动化-272",
    "所属区域": "-资产资源-组件库管理-资产纳管-272144-001",
    "纳管状态": "已完成-144",
    "最近同步": "2026-05-24 17:53:56"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-272144-101-3023",
    "资产名称": "组件库管理-数据上报-02-272144",
    "资产类型": "资产资源-复核-272",
    "所属区域": "-资产资源-组件库管理-自动采集-272144-002",
    "纳管状态": "处理中-144",
    "最近同步": "2026-05-23 17:51:23"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-272144-102-4573",
    "资产名称": "组件库管理-异常复核-03-272144",
    "资产类型": "资产资源-自动化-272",
    "所属区域": "-资产资源-组件库管理-扩容核查-272144-003",
    "纳管状态": "已同步-144",
    "最近同步": "2026-05-16 14:37:51"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-272144-103-1467",
    "资产名称": "组件库管理-资产纳管-04-272144",
    "资产类型": "资产资源-核心-272",
    "所属区域": "-资产资源-组件库管理-扩容核查-272144-004",
    "纳管状态": "处理中-144",
    "最近同步": "2026-05-20 13:18:57"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-272144-104-7433",
    "资产名称": "组件库管理-部侧联动-05-272144",
    "资产类型": "资产资源-自动化-272",
    "所属区域": "-资产资源-组件库管理-部侧联动-272144-005",
    "纳管状态": "已完成-144",
    "最近同步": "2026-05-09 16:58:40"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-272144-105-8524",
    "资产名称": "组件库管理-部侧联动-06-272144",
    "资产类型": "资产资源-边界-272",
    "所属区域": "-资产资源-组件库管理-自动采集-272144-006",
    "纳管状态": "异常-144",
    "最近同步": "2026-05-21 16:14:53"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-272144-106-6565",
    "资产名称": "组件库管理-异常复核-07-272144",
    "资产类型": "资产资源-部侧-272",
    "所属区域": "-资产资源-组件库管理-部侧联动-272144-007",
    "纳管状态": "已同步-144",
    "最近同步": "2026-05-14 10:14:59"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-272144-107-5791",
    "资产名称": "区公司组件库管理-扩容核查-08-272144",
    "资产类型": "资产资源-自动化-272",
    "所属区域": "-资产资源-组件库管理-异常复核-272144-008",
    "纳管状态": "待处理-144",
    "最近同步": "2026-05-21 15:04:38"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-272144-108-9692",
    "资产名称": "组件库管理-异常复核-09-272144",
    "资产类型": "资产资源-核心-272",
    "所属区域": "-资产资源-组件库管理-自动采集-272144-009",
    "纳管状态": "已完成-144",
    "最近同步": "2026-05-10 08:19:28"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-272144-109-8673",
    "资产名称": "组件库管理-数据上报-10-272144",
    "资产类型": "资产资源-边界-272",
    "所属区域": "-资产资源-组件库管理-异常复核-272144-010",
    "纳管状态": "待处理-144",
    "最近同步": "2026-05-22 12:09:52"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "组件库管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "组件库管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "组件库管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "组件库管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "组件库管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
