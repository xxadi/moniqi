    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增云资源日志任务", "add")'>新增云资源日志任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除云资源日志任务", "delete")'>删除云资源日志任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改云资源日志任务", "edit")'>修改云资源日志任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询云资源日志任务", "detail")'>查询云资源日志任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("云资源日志任务启用/禁用", "operation")'>云资源日志任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("云资源日志监控告警", "detail")'>云资源日志监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("云资源日志结果统计", "analysis")'>云资源日志结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("云资源日志数据提取", "operation")'>云资源日志数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("云资源日志运行分析", "analysis")'>云资源日志运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("云资源日志分析结果展示", "detail")'>云资源日志分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-878164-100-5793",
    "资产名称": "云资源日志任务管理-异常复核-01-878164",
    "资产类型": "资产资源-自动化-878",
    "所属区域": "-资产资源-云资源日志任务管理-部侧联动-878164-001",
    "纳管状态": "已同步-164",
    "最近同步": "2026-05-21 17:34:19"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-878164-101-8022",
    "资产名称": "云资源日志任务管理-资产纳管-02-878164",
    "资产类型": "资产资源-边界-878",
    "所属区域": "-资产资源-云资源日志任务管理-自动采集-878164-002",
    "纳管状态": "异常-164",
    "最近同步": "2026-05-24 17:23:57"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-878164-102-3542",
    "资产名称": "云资源日志任务管理-数据上报-03-878164",
    "资产类型": "资产资源-复核-878",
    "所属区域": "-资产资源-云资源日志任务管理-异常复核-878164-003",
    "纳管状态": "处理中-164",
    "最近同步": "2026-05-21 11:39:32"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-878164-103-4003",
    "资产名称": "云资源日志任务管理-自动采集-04-878164",
    "资产类型": "资产资源-核心-878",
    "所属区域": "区公司-资产资源-云资源日志任务管理-资产纳管-878164-004",
    "纳管状态": "已完成-164",
    "最近同步": "2026-05-16 13:09:33"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-878164-104-4832",
    "资产名称": "云资源日志任务管理-部侧联动-05-878164",
    "资产类型": "资产资源-自动化-878",
    "所属区域": "-资产资源-云资源日志任务管理-扩容核查-878164-005",
    "纳管状态": "已同步-164",
    "最近同步": "2026-05-18 13:58:05"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-878164-105-4425",
    "资产名称": "云资源日志任务管理-数据上报-06-878164",
    "资产类型": "资产资源-省侧-878",
    "所属区域": "-资产资源-云资源日志任务管理-数据上报-878164-006",
    "纳管状态": "已同步-164",
    "最近同步": "2026-05-11 16:28:54"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-878164-106-9554",
    "资产名称": "云资源日志任务管理-异常复核-07-878164",
    "资产类型": "资产资源-省侧-878",
    "所属区域": "-资产资源-云资源日志任务管理-自动采集-878164-007",
    "纳管状态": "待复核-164",
    "最近同步": "2026-05-08 17:18:28"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-878164-107-8506",
    "资产名称": "云资源日志任务管理-异常复核-08-878164",
    "资产类型": "资产资源-核心-878",
    "所属区域": "-资产资源-云资源日志任务管理-资产纳管-878164-008",
    "纳管状态": "待复核-164",
    "最近同步": "2026-05-22 13:39:12"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-878164-108-5739",
    "资产名称": "云资源日志任务管理-自动采集-09-878164",
    "资产类型": "资产资源-复核-878",
    "所属区域": "-资产资源-云资源日志任务管理-自动采集-878164-009",
    "纳管状态": "待处理-164",
    "最近同步": "2026-05-08 11:27:45"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-878164-109-1876",
    "资产名称": "区公司云资源日志任务管理-资产纳管-10-878164",
    "资产类型": "资产资源-核心-878",
    "所属区域": "区公司-资产资源-云资源日志任务管理-资产纳管-878164-010",
    "纳管状态": "已同步-164",
    "最近同步": "2026-05-17 10:43:05"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "云资源日志任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "云资源日志任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "云资源日志任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "云资源日志任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "云资源日志任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
