    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加部侧联动超时处置策略信息", "add")'>添加部侧联动超时处置策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑部侧联动超时处置策略信息", "edit")'>编辑部侧联动超时处置策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除部侧联动超时处置策略信息", "delete")'>删除部侧联动超时处置策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询部侧联动超时处置策略", "detail")'>查询部侧联动超时处置策略</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("部侧联动超时处置策略统计", "analysis")'>部侧联动超时处置策略统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("部侧联动超时处置策略信息下载", "export")'>部侧联动超时处置策略信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-393819-100-8884",
    "业务名称": "部侧联动超时处置管理-数据上报-01-393819",
    "业务类型": "业务联动-核心-393",
    "处理状态": "待复核-819",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-17 09:23:32"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-393819-101-8516",
    "业务名称": "部侧联动超时处置管理-扩容核查-02-393819",
    "业务类型": "业务联动-边界-393",
    "处理状态": "异常-819",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-09 15:59:34"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-393819-102-4442",
    "业务名称": "部侧联动超时处置管理-数据上报-03-393819",
    "业务类型": "业务联动-复核-393",
    "处理状态": "已完成-819",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-17 10:55:18"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-393819-103-9867",
    "业务名称": "部侧联动超时处置管理-异常复核-04-393819",
    "业务类型": "业务联动-自动化-393",
    "处理状态": "处理中-819",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-23 12:02:10"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-393819-104-2043",
    "业务名称": "部侧联动超时处置管理-异常复核-05-393819",
    "业务类型": "业务联动-边界-393",
    "处理状态": "待处理-819",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-23 15:08:50"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-393819-105-3887",
    "业务名称": "部侧联动超时处置管理-扩容核查-06-393819",
    "业务类型": "业务联动-核心-393",
    "处理状态": "已完成-819",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 12:18:14"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-393819-106-9379",
    "业务名称": "部侧联动超时处置管理-扩容核查-07-393819",
    "业务类型": "业务联动-省侧-393",
    "处理状态": "待复核-819",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-19 09:06:17"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-393819-107-2115",
    "业务名称": "部侧联动超时处置管理-自动采集-08-393819",
    "业务类型": "业务联动-复核-393",
    "处理状态": "待复核-819",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-14 09:41:24"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-393819-108-6403",
    "业务名称": "部侧联动超时处置管理-扩容核查-09-393819",
    "业务类型": "业务联动-复核-393",
    "处理状态": "已完成-819",
    "负责人": "任务调度员-区公司",
    "更新时间": "2026-05-20 14:51:18"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-393819-109-5320",
    "业务名称": "部侧联动超时处置管理-自动采集-10-393819",
    "业务类型": "业务联动-边界-393",
    "处理状态": "已完成-819",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-24 13:11:45"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧联动超时处置管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧联动超时处置管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧联动超时处置管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧联动超时处置管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧联动超时处置管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
