    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加扫描结果分析规则", "add")'>添加扫描结果分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑扫描结果分析规则", "edit")'>编辑扫描结果分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描结果分析规则", "delete")'>删除扫描结果分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描结果分析规则", "detail")'>查询扫描结果分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描结果分析规则启用/禁用", "analysis")'>扫描结果分析规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描结果分析规则运行效果评估", "analysis")'>扫描结果分析规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描结果分析规则分析", "analysis")'>扫描结果分析规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("扫描结果分析规则分析结果展示", "detail")'>扫描结果分析规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描结果分析规则分析结果下载", "export")'>扫描结果分析规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描结果分析规则分析结果上报", "analysis")'>扫描结果分析规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-476979-100-4024",
    "规则名称": "扫描结果分析规则管理-异常复核-01-476979",
    "规则类型": "规则策略-复核-476",
    "启用状态": "异常-979",
    "命中次数": 4660,
    "更新时间": "2026-05-15 12:26:55"
  },
  {
    "ID": 2,
    "规则编号": "RULE-476979-101-4797",
    "规则名称": "扫描结果分析规则管理-部侧联动-02-476979",
    "规则类型": "规则策略-部侧-476",
    "启用状态": "处理中-979",
    "命中次数": 888,
    "更新时间": "2026-05-12 14:29:02"
  },
  {
    "ID": 3,
    "规则编号": "RULE-476979-102-5951",
    "规则名称": "扫描结果分析规则管理-数据上报-03-476979",
    "规则类型": "规则策略-边界-476",
    "启用状态": "待处理-979",
    "命中次数": 4791,
    "更新时间": "2026-05-18 14:36:45"
  },
  {
    "ID": 4,
    "规则编号": "RULE-476979-103-5630",
    "规则名称": "扫描结果分析规则管理-自动采集-04-476979",
    "规则类型": "规则策略-复核-476",
    "启用状态": "异常-979",
    "命中次数": 3515,
    "更新时间": "2026-05-22 16:25:00"
  },
  {
    "ID": 5,
    "规则编号": "RULE-476979-104-4994",
    "规则名称": "扫描结果分析规则管理-自动采集-05-476979",
    "规则类型": "规则策略-省侧-476",
    "启用状态": "处理中-979",
    "命中次数": 955,
    "更新时间": "2026-05-24 15:51:48"
  },
  {
    "ID": 6,
    "规则编号": "RULE-476979-105-7774",
    "规则名称": "扫描结果分析规则管理-异常复核-06-476979",
    "规则类型": "规则策略-边界-476",
    "启用状态": "处理中-979",
    "命中次数": 486,
    "更新时间": "2026-05-20 15:25:49"
  },
  {
    "ID": 7,
    "规则编号": "RULE-476979-106-1089",
    "规则名称": "扫描结果分析规则管理-数据上报-07-476979",
    "规则类型": "规则策略-边界-476",
    "启用状态": "异常-979",
    "命中次数": 261,
    "更新时间": "2026-05-24 16:36:10"
  },
  {
    "ID": 8,
    "规则编号": "RULE-476979-107-6358",
    "规则名称": "扫描结果分析规则管理-数据上报-08-476979",
    "规则类型": "规则策略-边界-476",
    "启用状态": "处理中-979",
    "命中次数": 4564,
    "更新时间": "2026-05-13 14:23:07"
  },
  {
    "ID": 9,
    "规则编号": "RULE-476979-108-3599",
    "规则名称": "扫描结果分析规则管理-自动采集-09-476979",
    "规则类型": "规则策略-边界-476",
    "启用状态": "处理中-979",
    "命中次数": 4724,
    "更新时间": "2026-05-19 08:30:47"
  },
  {
    "ID": 10,
    "规则编号": "RULE-476979-109-3156",
    "规则名称": "扫描结果分析规则管理-资产纳管-10-476979",
    "规则类型": "规则策略-复核-476",
    "启用状态": "已完成-979",
    "命中次数": 4307,
    "更新时间": "2026-05-15 16:01:36"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描结果分析规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描结果分析规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描结果分析规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描结果分析规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描结果分析规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
