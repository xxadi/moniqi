    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产型号一致性稽核任务", "add")'>新增资产型号一致性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产型号一致性稽核任务", "delete")'>删除资产型号一致性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产型号一致性稽核任务", "edit")'>修改资产型号一致性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产型号一致性稽核任务", "detail")'>查询资产型号一致性稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核任务启用/禁用", "detail")'>资产型号一致性稽核任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核告警", "detail")'>资产型号一致性稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核结果统计", "detail")'>资产型号一致性稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核数据提取", "detail")'>资产型号一致性稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核运行分析", "detail")'>资产型号一致性稽核运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核分析结果展示", "detail")'>资产型号一致性稽核分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产型号一致性稽核分析结果下载", "export")'>资产型号一致性稽核分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产型号一致性稽核分析结果上报", "detail")'>资产型号一致性稽核分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-673406-100-9789",
    "资产名称": "资产型号一致性稽核任务管理-资产纳管-01-673406",
    "资产类型": "资产资源-边界-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-异常复核-673406-001",
    "纳管状态": "待复核-406",
    "最近同步": "2026-05-13 11:51:14"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-673406-101-8853",
    "资产名称": "资产型号一致性稽核任务管理-部侧联动-02-673406",
    "资产类型": "资产资源-核心-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-数据上报-673406-002",
    "纳管状态": "处理中-406",
    "最近同步": "2026-05-19 17:33:22"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-673406-102-9657",
    "资产名称": "资产型号一致性稽核任务管理-自动采集-03-673406",
    "资产类型": "资产资源-自动化-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-部侧联动-673406-003",
    "纳管状态": "异常-406",
    "最近同步": "2026-05-24 09:58:38"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-673406-103-3574",
    "资产名称": "资产型号一致性稽核任务管理-数据上报-04-673406",
    "资产类型": "资产资源-自动化-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-自动采集-673406-004",
    "纳管状态": "异常-406",
    "最近同步": "2026-05-12 13:56:51"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-673406-104-7417",
    "资产名称": "资产型号一致性稽核任务管理-异常复核-05-673406",
    "资产类型": "资产资源-省侧-673",
    "所属区域": "区公司-资产资源-资产型号一致性稽核任务管理-资产纳管-673406-005",
    "纳管状态": "已同步-406",
    "最近同步": "2026-05-15 10:00:45"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-673406-105-8637",
    "资产名称": "资产型号一致性稽核任务管理-异常复核-06-673406",
    "资产类型": "资产资源-自动化-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-自动采集-673406-006",
    "纳管状态": "已完成-406",
    "最近同步": "2026-05-09 14:52:05"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-673406-106-3192",
    "资产名称": "资产型号一致性稽核任务管理-扩容核查-07-673406",
    "资产类型": "资产资源-边界-673",
    "所属区域": "区公司-资产资源-资产型号一致性稽核任务管理-资产纳管-673406-007",
    "纳管状态": "已同步-406",
    "最近同步": "2026-05-10 08:38:08"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-673406-107-8024",
    "资产名称": "资产型号一致性稽核任务管理-扩容核查-08-673406",
    "资产类型": "资产资源-核心-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-异常复核-673406-008",
    "纳管状态": "已完成-406",
    "最近同步": "2026-05-13 13:24:39"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-673406-108-8538",
    "资产名称": "资产型号一致性稽核任务管理-异常复核-09-673406",
    "资产类型": "资产资源-自动化-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-部侧联动-673406-009",
    "纳管状态": "已完成-406",
    "最近同步": "2026-05-10 11:42:35"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-673406-109-2810",
    "资产名称": "资产型号一致性稽核任务管理-异常复核-10-673406",
    "资产类型": "资产资源-部侧-673",
    "所属区域": "-资产资源-资产型号一致性稽核任务管理-资产纳管-673406-010",
    "纳管状态": "待复核-406",
    "最近同步": "2026-05-21 12:02:24"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产型号一致性稽核任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产型号一致性稽核任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产型号一致性稽核任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产型号一致性稽核任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产型号一致性稽核任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "资产型号一致性稽核任务管理" },
