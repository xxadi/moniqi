    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增SFTP传输通道监控任务", "add")'>新增SFTP传输通道监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除SFTP传输通道监控任务", "delete")'>删除SFTP传输通道监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改SFTP传输通道监控任务", "edit")'>修改SFTP传输通道监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询SFTP传输通道监控任务", "detail")'>查询SFTP传输通道监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控任务启用/禁用", "detail")'>SFTP传输通道监控任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控运行效果评估", "detail")'>SFTP传输通道监控运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控分析", "detail")'>SFTP传输通道监控分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控分析结果展示", "detail")'>SFTP传输通道监控分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("SFTP传输通道监控分析结果下载", "export")'>SFTP传输通道监控分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("SFTP传输通道监控分析结果上报", "detail")'>SFTP传输通道监控分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-065555-100-3918",
    "接口名称": "SFTP传输通道监控-数据上报-01-065555",
    "对接系统": "CMDB资源库-0655",
    "调用状态": "已同步-555",
    "平均耗时": "429ms-55",
    "最近调用": "2026-05-24 13:44:06"
  },
  {
    "ID": 2,
    "接口编号": "API-065555-101-9360",
    "接口名称": "SFTP传输通道监控-资产纳管-02-065555",
    "对接系统": "集团资产平台-0655",
    "调用状态": "已完成-555",
    "平均耗时": "486ms-55",
    "最近调用": "2026-05-13 15:03:59"
  },
  {
    "ID": 3,
    "接口编号": "API-065555-102-1790",
    "接口名称": "区公司SFTP传输通道监控-数据上报-03-065555",
    "对接系统": "集团资产平台-0655",
    "调用状态": "处理中-555",
    "平均耗时": "206ms-55",
    "最近调用": "2026-05-14 15:24:02"
  },
  {
    "ID": 4,
    "接口编号": "API-065555-103-4194",
    "接口名称": "SFTP传输通道监控-扩容核查-04-065555",
    "对接系统": "集团资产平台-0655",
    "调用状态": "待复核-555",
    "平均耗时": "539ms-55",
    "最近调用": "2026-05-20 16:53:59"
  },
  {
    "ID": 5,
    "接口编号": "API-065555-104-5297",
    "接口名称": "SFTP传输通道监控-资产纳管-05-065555",
    "对接系统": "调度中心-0655",
    "调用状态": "已完成-555",
    "平均耗时": "274ms-55",
    "最近调用": "2026-05-08 10:13:07"
  },
  {
    "ID": 6,
    "接口编号": "API-065555-105-7383",
    "接口名称": "SFTP传输通道监控-部侧联动-06-065555",
    "对接系统": "CMDB资源库-0655",
    "调用状态": "已同步-555",
    "平均耗时": "569ms-55",
    "最近调用": "2026-05-25 14:19:55"
  },
  {
    "ID": 7,
    "接口编号": "API-065555-106-3928",
    "接口名称": "SFTP传输通道监控-资产纳管-07-065555",
    "对接系统": "资产安全平台-0655",
    "调用状态": "异常-555",
    "平均耗时": "400ms-55",
    "最近调用": "2026-05-10 12:30:19"
  },
  {
    "ID": 8,
    "接口编号": "API-065555-107-4990",
    "接口名称": "SFTP传输通道监控-扩容核查-08-065555",
    "对接系统": "调度中心-0655",
    "调用状态": "异常-555",
    "平均耗时": "557ms-55",
    "最近调用": "2026-05-09 15:23:11"
  },
  {
    "ID": 9,
    "接口编号": "API-065555-108-6869",
    "接口名称": "SFTP传输通道监控-资产纳管-09-065555",
    "对接系统": "资产安全平台-0655",
    "调用状态": "已完成-555",
    "平均耗时": "408ms-55",
    "最近调用": "2026-05-12 08:29:53"
  },
  {
    "ID": 10,
    "接口编号": "API-065555-109-4459",
    "接口名称": "SFTP传输通道监控-资产纳管-10-065555",
    "对接系统": "调度中心-0655",
    "调用状态": "待处理-555",
    "平均耗时": "200ms-55",
    "最近调用": "2026-05-17 15:47:54"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "SFTP传输通道监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "SFTP传输通道监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "SFTP传输通道监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "SFTP传输通道监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "SFTP传输通道监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
