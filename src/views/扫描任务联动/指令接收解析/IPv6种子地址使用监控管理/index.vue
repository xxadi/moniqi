    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加IPv6种子地址使用监控信息", "add")'>添加IPv6种子地址使用监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑IPv6种子地址使用监控信息", "edit")'>编辑IPv6种子地址使用监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6种子地址使用监控信息", "delete")'>删除IPv6种子地址使用监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6种子地址使用监控列表", "detail")'>查询IPv6种子地址使用监控列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6种子地址使用监控详情", "detail")'>查询IPv6种子地址使用监控详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入IPv6种子地址使用监控信息", "import")'>批量导入IPv6种子地址使用监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6种子地址使用监控信息导出", "export")'>IPv6种子地址使用监控信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-326224-100-9115",
    "事件类型": "监控告警-边界-326",
    "事件级别": "低",
    "关联对象": "IPv6种子地址使用监控管理-资产纳管-01-326224",
    "发生时间": "2026-05-20 11:43:06",
    "处置状态": "已完成-224"
  },
  {
    "ID": 2,
    "事件编号": "EVT-326224-101-9159",
    "事件类型": "监控告警-部侧-326",
    "事件级别": "低",
    "关联对象": "IPv6种子地址使用监控管理-资产纳管-02-326224",
    "发生时间": "2026-05-10 13:27:55",
    "处置状态": "待复核-224"
  },
  {
    "ID": 3,
    "事件编号": "EVT-326224-102-5743",
    "事件类型": "监控告警-部侧-326",
    "事件级别": "高",
    "关联对象": "IPv6种子地址使用监控管理-部侧联动-03-326224",
    "发生时间": "2026-05-15 16:50:58",
    "处置状态": "已完成-224"
  },
  {
    "ID": 4,
    "事件编号": "EVT-326224-103-2985",
    "事件类型": "监控告警-核心-326",
    "事件级别": "低",
    "关联对象": "IPv6种子地址使用监控管理-自动采集-04-326224",
    "发生时间": "2026-05-13 14:51:18",
    "处置状态": "待处理-224"
  },
  {
    "ID": 5,
    "事件编号": "EVT-326224-104-4062",
    "事件类型": "监控告警-核心-326",
    "事件级别": "一般",
    "关联对象": "区公司IPv6种子地址使用监控管理-自动采集-05-326224",
    "发生时间": "2026-05-11 14:57:28",
    "处置状态": "待处理-224"
  },
  {
    "ID": 6,
    "事件编号": "EVT-326224-105-9939",
    "事件类型": "监控告警-部侧-326",
    "事件级别": "高",
    "关联对象": "IPv6种子地址使用监控管理-资产纳管-06-326224",
    "发生时间": "2026-05-18 09:14:14",
    "处置状态": "已完成-224"
  },
  {
    "ID": 7,
    "事件编号": "EVT-326224-106-5560",
    "事件类型": "监控告警-自动化-326",
    "事件级别": "低",
    "关联对象": "IPv6种子地址使用监控管理-扩容核查-07-326224",
    "发生时间": "2026-05-23 12:22:52",
    "处置状态": "已完成-224"
  },
  {
    "ID": 8,
    "事件编号": "EVT-326224-107-7239",
    "事件类型": "监控告警-省侧-326",
    "事件级别": "一般",
    "关联对象": "IPv6种子地址使用监控管理-部侧联动-08-326224",
    "发生时间": "2026-05-08 10:04:07",
    "处置状态": "异常-224"
  },
  {
    "ID": 9,
    "事件编号": "EVT-326224-108-2521",
    "事件类型": "监控告警-核心-326",
    "事件级别": "高",
    "关联对象": "IPv6种子地址使用监控管理-部侧联动-09-326224",
    "发生时间": "2026-05-20 11:43:40",
    "处置状态": "异常-224"
  },
  {
    "ID": 10,
    "事件编号": "EVT-326224-109-8079",
    "事件类型": "监控告警-边界-326",
    "事件级别": "高",
    "关联对象": "区公司IPv6种子地址使用监控管理-扩容核查-10-326224",
    "发生时间": "2026-05-10 13:23:27",
    "处置状态": "异常-224"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6种子地址使用监控管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6种子地址使用监控管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6种子地址使用监控管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6种子地址使用监控管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6种子地址使用监控管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IPv6种子地址使用监控管理" },
