    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增私有镜像仓库同步接口", "add")'>新增私有镜像仓库同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("定义私有镜像仓库同步信息", "add")'>定义私有镜像仓库同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("私有镜像仓库同步数据查看", "add")'>私有镜像仓库同步数据查看</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增私有镜像仓库同步状态查询信息", "add")'>新增私有镜像仓库同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("私有镜像仓库同步结果监控", "add")'>私有镜像仓库同步结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("更新私有镜像仓库同步接口数据", "edit")'>更新私有镜像仓库同步接口数据</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看私有镜像仓库同步接口请求信息", "add")'>查看私有镜像仓库同步接口请求信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("私有镜像仓库同步接口数据清洗", "add")'>私有镜像仓库同步接口数据清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("私有镜像仓库同步运行监控", "add")'>私有镜像仓库同步运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("反馈私有镜像仓库同步接口信息", "add")'>反馈私有镜像仓库同步接口信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-094294-100-4666",
    "接口名称": "私有镜像仓库同步接口-部侧联动-01-094294",
    "对接系统": "调度中心-0942",
    "调用状态": "已同步-294",
    "平均耗时": "147ms-94",
    "最近调用": "2026-05-20 09:54:35"
  },
  {
    "ID": 2,
    "接口编号": "API-094294-101-9941",
    "接口名称": "私有镜像仓库同步接口-资产纳管-02-094294",
    "对接系统": "资产安全平台-0942",
    "调用状态": "已完成-294",
    "平均耗时": "377ms-94",
    "最近调用": "2026-05-25 15:51:45"
  },
  {
    "ID": 3,
    "接口编号": "API-094294-102-6638",
    "接口名称": "私有镜像仓库同步接口-自动采集-03-094294",
    "对接系统": "CMDB资源库-0942",
    "调用状态": "已同步-294",
    "平均耗时": "294ms-94",
    "最近调用": "2026-05-16 16:37:35"
  },
  {
    "ID": 4,
    "接口编号": "API-094294-103-2737",
    "接口名称": "区公司私有镜像仓库同步接口-扩容核查-04-094294",
    "对接系统": "资产安全平台-0942",
    "调用状态": "异常-294",
    "平均耗时": "425ms-94",
    "最近调用": "2026-05-09 12:33:45"
  },
  {
    "ID": 5,
    "接口编号": "API-094294-104-6335",
    "接口名称": "私有镜像仓库同步接口-部侧联动-05-094294",
    "对接系统": "调度中心-0942",
    "调用状态": "已完成-294",
    "平均耗时": "627ms-94",
    "最近调用": "2026-05-20 17:40:13"
  },
  {
    "ID": 6,
    "接口编号": "API-094294-105-1201",
    "接口名称": "私有镜像仓库同步接口-自动采集-06-094294",
    "对接系统": "资产安全平台-0942",
    "调用状态": "已同步-294",
    "平均耗时": "332ms-94",
    "最近调用": "2026-05-13 08:32:24"
  },
  {
    "ID": 7,
    "接口编号": "API-094294-106-4759",
    "接口名称": "私有镜像仓库同步接口-扩容核查-07-094294",
    "对接系统": "集团资产平台-0942",
    "调用状态": "已完成-294",
    "平均耗时": "96ms-94",
    "最近调用": "2026-05-12 14:10:04"
  },
  {
    "ID": 8,
    "接口编号": "API-094294-107-2714",
    "接口名称": "私有镜像仓库同步接口-数据上报-08-094294",
    "对接系统": "集团资产平台-0942",
    "调用状态": "待处理-294",
    "平均耗时": "348ms-94",
    "最近调用": "2026-05-24 13:55:28"
  },
  {
    "ID": 9,
    "接口编号": "API-094294-108-2258",
    "接口名称": "私有镜像仓库同步接口-扩容核查-09-094294",
    "对接系统": "工信部对接平台-0942",
    "调用状态": "待处理-294",
    "平均耗时": "95ms-94",
    "最近调用": "2026-05-09 11:21:40"
  },
  {
    "ID": 10,
    "接口编号": "API-094294-109-5218",
    "接口名称": "私有镜像仓库同步接口-资产纳管-10-094294",
    "对接系统": "资产安全平台-0942",
    "调用状态": "待复核-294",
    "平均耗时": "174ms-94",
    "最近调用": "2026-05-14 08:24:48"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "私有镜像仓库同步接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "私有镜像仓库同步接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "私有镜像仓库同步接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "私有镜像仓库同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "私有镜像仓库同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
