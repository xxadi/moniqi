    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加虚拟资源填报信息", "add")'>添加虚拟资源填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑虚拟资源填报信息", "edit")'>编辑虚拟资源填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源填报信息", "delete")'>删除虚拟资源填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询虚拟资源填报列表", "add")'>查询虚拟资源填报列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询虚拟资源填报详情", "add")'>查询虚拟资源填报详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资源填报信息", "import")'>批量导入虚拟资源填报信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源填报信息导出", "export")'>虚拟资源填报信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-633476-100-7011",
    "资产名称": "虚拟资源填报管理-异常复核-01-633476",
    "资产类型": "资产资源-复核-633",
    "所属区域": "-资产资源-虚拟资源填报管理-自动采集-633476-001",
    "纳管状态": "已同步-476",
    "最近同步": "2026-05-15 13:31:44"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-633476-101-9544",
    "资产名称": "虚拟资源填报管理-自动采集-02-633476",
    "资产类型": "资产资源-自动化-633",
    "所属区域": "区公司-资产资源-虚拟资源填报管理-自动采集-633476-002",
    "纳管状态": "处理中-476",
    "最近同步": "2026-05-15 15:59:39"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-633476-102-7560",
    "资产名称": "虚拟资源填报管理-自动采集-03-633476",
    "资产类型": "资产资源-复核-633",
    "所属区域": "-资产资源-虚拟资源填报管理-自动采集-633476-003",
    "纳管状态": "异常-476",
    "最近同步": "2026-05-11 11:01:00"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-633476-103-8791",
    "资产名称": "虚拟资源填报管理-异常复核-04-633476",
    "资产类型": "资产资源-核心-633",
    "所属区域": "-资产资源-虚拟资源填报管理-自动采集-633476-004",
    "纳管状态": "待复核-476",
    "最近同步": "2026-05-13 14:39:02"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-633476-104-8818",
    "资产名称": "虚拟资源填报管理-部侧联动-05-633476",
    "资产类型": "资产资源-省侧-633",
    "所属区域": "-资产资源-虚拟资源填报管理-数据上报-633476-005",
    "纳管状态": "异常-476",
    "最近同步": "2026-05-13 13:09:04"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-633476-105-4147",
    "资产名称": "虚拟资源填报管理-扩容核查-06-633476",
    "资产类型": "资产资源-核心-633",
    "所属区域": "-资产资源-虚拟资源填报管理-异常复核-633476-006",
    "纳管状态": "已完成-476",
    "最近同步": "2026-05-21 13:19:04"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-633476-106-9170",
    "资产名称": "虚拟资源填报管理-异常复核-07-633476",
    "资产类型": "资产资源-部侧-633",
    "所属区域": "-资产资源-虚拟资源填报管理-异常复核-633476-007",
    "纳管状态": "异常-476",
    "最近同步": "2026-05-13 13:47:36"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-633476-107-1820",
    "资产名称": "虚拟资源填报管理-扩容核查-08-633476",
    "资产类型": "资产资源-边界-633",
    "所属区域": "-资产资源-虚拟资源填报管理-数据上报-633476-008",
    "纳管状态": "已同步-476",
    "最近同步": "2026-05-19 09:54:28"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-633476-108-1318",
    "资产名称": "虚拟资源填报管理-部侧联动-09-633476",
    "资产类型": "资产资源-复核-633",
    "所属区域": "-资产资源-虚拟资源填报管理-资产纳管-633476-009",
    "纳管状态": "处理中-476",
    "最近同步": "2026-05-22 14:52:49"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-633476-109-1595",
    "资产名称": "虚拟资源填报管理-部侧联动-10-633476",
    "资产类型": "资产资源-核心-633",
    "所属区域": "-资产资源-虚拟资源填报管理-自动采集-633476-010",
    "纳管状态": "已完成-476",
    "最近同步": "2026-05-22 12:10:30"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源填报管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源填报管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源填报管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源填报管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源填报管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
