    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增内网资产识别模型", "add")'>新增内网资产识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改内网资产识别模型", "edit")'>修改内网资产识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除内网资产识别模型", "delete")'>删除内网资产识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询内网资产识别模型", "detail")'>查询内网资产识别模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型启用/禁用", "analysis")'>内网资产识别模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型运行效果评估", "analysis")'>内网资产识别模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型分析", "analysis")'>内网资产识别模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("内网资产识别模型分析结果展示", "detail")'>内网资产识别模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("内网资产识别模型分析结果下载", "export")'>内网资产识别模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("内网资产识别模型分析结果上报", "analysis")'>内网资产识别模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-461303-100-9189",
    "规则名称": "内网资产识别模型管理-部侧联动-01-461303",
    "规则类型": "规则策略-核心-461",
    "启用状态": "待处理-303",
    "命中次数": 2048,
    "更新时间": "2026-05-10 16:46:54"
  },
  {
    "ID": 2,
    "规则编号": "RULE-461303-101-9114",
    "规则名称": "内网资产识别模型管理-自动采集-02-461303",
    "规则类型": "规则策略-复核-461",
    "启用状态": "已完成-303",
    "命中次数": 4106,
    "更新时间": "2026-05-14 09:49:53"
  },
  {
    "ID": 3,
    "规则编号": "RULE-461303-102-9624",
    "规则名称": "内网资产识别模型管理-部侧联动-03-461303",
    "规则类型": "规则策略-自动化-461",
    "启用状态": "待复核-303",
    "命中次数": 4818,
    "更新时间": "2026-05-13 11:18:59"
  },
  {
    "ID": 4,
    "规则编号": "RULE-461303-103-8738",
    "规则名称": "内网资产识别模型管理-异常复核-04-461303",
    "规则类型": "规则策略-核心-461",
    "启用状态": "已完成-303",
    "命中次数": 1145,
    "更新时间": "2026-05-08 17:33:24"
  },
  {
    "ID": 5,
    "规则编号": "RULE-461303-104-8406",
    "规则名称": "内网资产识别模型管理-部侧联动-05-461303",
    "规则类型": "规则策略-自动化-461",
    "启用状态": "已完成-303",
    "命中次数": 125,
    "更新时间": "2026-05-19 14:48:15"
  },
  {
    "ID": 6,
    "规则编号": "RULE-461303-105-1506",
    "规则名称": "内网资产识别模型管理-扩容核查-06-461303",
    "规则类型": "规则策略-复核-461",
    "启用状态": "异常-303",
    "命中次数": 1228,
    "更新时间": "2026-05-24 12:32:02"
  },
  {
    "ID": 7,
    "规则编号": "RULE-461303-106-3860",
    "规则名称": "区公司内网资产识别模型管理-扩容核查-07-461303",
    "规则类型": "规则策略-核心-461",
    "启用状态": "已完成-303",
    "命中次数": 638,
    "更新时间": "2026-05-15 15:17:12"
  },
  {
    "ID": 8,
    "规则编号": "RULE-461303-107-3266",
    "规则名称": "内网资产识别模型管理-异常复核-08-461303",
    "规则类型": "规则策略-省侧-461",
    "启用状态": "待复核-303",
    "命中次数": 152,
    "更新时间": "2026-05-17 15:37:18"
  },
  {
    "ID": 9,
    "规则编号": "RULE-461303-108-7904",
    "规则名称": "内网资产识别模型管理-部侧联动-09-461303",
    "规则类型": "规则策略-部侧-461",
    "启用状态": "异常-303",
    "命中次数": 2251,
    "更新时间": "2026-05-17 11:55:52"
  },
  {
    "ID": 10,
    "规则编号": "RULE-461303-109-6382",
    "规则名称": "内网资产识别模型管理-自动采集-10-461303",
    "规则类型": "规则策略-复核-461",
    "启用状态": "已同步-303",
    "命中次数": 2279,
    "更新时间": "2026-05-12 12:06:03"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "内网资产识别模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "内网资产识别模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "内网资产识别模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "内网资产识别模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "内网资产识别模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
