    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增扫描任务进度追踪任务", "add")'>新增扫描任务进度追踪任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改扫描任务进度追踪任务", "edit")'>修改扫描任务进度追踪任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描任务进度追踪任务", "delete")'>删除扫描任务进度追踪任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描任务进度追踪", "detail")'>查询扫描任务进度追踪</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("扫描任务进度追踪统计", "detail")'>扫描任务进度追踪统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描任务进度追踪信息下载", "export")'>扫描任务进度追踪信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-875679-100-2244",
    "扫描对象": "区公司扫描任务进度追踪管理-部侧联动-01-875679",
    "扫描节点": "节点-05-79",
    "资产数量": 331,
    "异常数量": 4016,
    "扫描状态": "处理中-679"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-875679-101-4291",
    "扫描对象": "扫描任务进度追踪管理-资产纳管-02-875679",
    "扫描节点": "节点-02-79",
    "资产数量": 2693,
    "异常数量": 4108,
    "扫描状态": "已同步-679"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-875679-102-2477",
    "扫描对象": "扫描任务进度追踪管理-异常复核-03-875679",
    "扫描节点": "节点-09-79",
    "资产数量": 1049,
    "异常数量": 2277,
    "扫描状态": "待复核-679"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-875679-103-1430",
    "扫描对象": "扫描任务进度追踪管理-异常复核-04-875679",
    "扫描节点": "节点-05-79",
    "资产数量": 938,
    "异常数量": 2620,
    "扫描状态": "异常-679"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-875679-104-2072",
    "扫描对象": "区公司扫描任务进度追踪管理-数据上报-05-875679",
    "扫描节点": "节点-08-79",
    "资产数量": 1057,
    "异常数量": 2497,
    "扫描状态": "处理中-679"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-875679-105-2164",
    "扫描对象": "扫描任务进度追踪管理-自动采集-06-875679",
    "扫描节点": "区公司节点-02-79",
    "资产数量": 4092,
    "异常数量": 4883,
    "扫描状态": "已完成-679"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-875679-106-5381",
    "扫描对象": "扫描任务进度追踪管理-扩容核查-07-875679",
    "扫描节点": "节点-01-79",
    "资产数量": 3603,
    "异常数量": 1111,
    "扫描状态": "已同步-679"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-875679-107-4122",
    "扫描对象": "扫描任务进度追踪管理-部侧联动-08-875679",
    "扫描节点": "区公司节点-05-79",
    "资产数量": 4596,
    "异常数量": 3873,
    "扫描状态": "待复核-679"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-875679-108-3280",
    "扫描对象": "扫描任务进度追踪管理-数据上报-09-875679",
    "扫描节点": "节点-08-79",
    "资产数量": 1530,
    "异常数量": 4950,
    "扫描状态": "已完成-679"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-875679-109-4660",
    "扫描对象": "扫描任务进度追踪管理-扩容核查-10-875679",
    "扫描节点": "节点-02-79",
    "资产数量": 4377,
    "异常数量": 4691,
    "扫描状态": "待复核-679"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描任务进度追踪管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描任务进度追踪管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描任务进度追踪管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描任务进度追踪管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描任务进度追踪管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
