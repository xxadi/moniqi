    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加资产备案任务", "add")'>添加资产备案任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产备案任务", "delete")'>删除资产备案任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑资产备案任务", "edit")'>编辑资产备案任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产备案任务", "detail")'>查询资产备案任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产备案任务启用/禁用", "operation")'>资产备案任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案告警", "analysis")'>资产备案告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案结果统计", "analysis")'>资产备案结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产备案数据提取", "operation")'>资产备案数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案运行分析", "analysis")'>资产备案运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产备案分析结果展示", "detail")'>资产备案分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产备案分析结果下载", "export")'>资产备案分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产备案分析结果上报", "analysis")'>资产备案分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-932413-100-4008",
    "资产名称": "资产备案任务管理-异常复核-01-932413",
    "资产类型": "资产资源-省侧-932",
    "所属区域": "-资产资源-资产备案任务管理-数据上报-932413-001",
    "纳管状态": "处理中-413",
    "最近同步": "2026-05-16 13:01:13"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-932413-101-1528",
    "资产名称": "资产备案任务管理-数据上报-02-932413",
    "资产类型": "资产资源-自动化-932",
    "所属区域": "-资产资源-资产备案任务管理-扩容核查-932413-002",
    "纳管状态": "待处理-413",
    "最近同步": "2026-05-23 12:31:00"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-932413-102-6324",
    "资产名称": "资产备案任务管理-异常复核-03-932413",
    "资产类型": "资产资源-核心-932",
    "所属区域": "-资产资源-资产备案任务管理-自动采集-932413-003",
    "纳管状态": "待处理-413",
    "最近同步": "2026-05-16 13:00:33"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-932413-103-6701",
    "资产名称": "资产备案任务管理-资产纳管-04-932413",
    "资产类型": "资产资源-核心-932",
    "所属区域": "-资产资源-资产备案任务管理-部侧联动-932413-004",
    "纳管状态": "待复核-413",
    "最近同步": "2026-05-15 12:56:32"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-932413-104-5282",
    "资产名称": "资产备案任务管理-自动采集-05-932413",
    "资产类型": "资产资源-省侧-932",
    "所属区域": "区公司-资产资源-资产备案任务管理-数据上报-932413-005",
    "纳管状态": "处理中-413",
    "最近同步": "2026-05-17 15:10:39"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-932413-105-2298",
    "资产名称": "资产备案任务管理-扩容核查-06-932413",
    "资产类型": "资产资源-边界-932",
    "所属区域": "-资产资源-资产备案任务管理-资产纳管-932413-006",
    "纳管状态": "处理中-413",
    "最近同步": "2026-05-25 10:58:48"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-932413-106-9491",
    "资产名称": "资产备案任务管理-部侧联动-07-932413",
    "资产类型": "资产资源-核心-932",
    "所属区域": "区公司-资产资源-资产备案任务管理-自动采集-932413-007",
    "纳管状态": "已完成-413",
    "最近同步": "2026-05-10 16:52:21"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-932413-107-3217",
    "资产名称": "区公司资产备案任务管理-自动采集-08-932413",
    "资产类型": "资产资源-自动化-932",
    "所属区域": "-资产资源-资产备案任务管理-资产纳管-932413-008",
    "纳管状态": "待处理-413",
    "最近同步": "2026-05-23 11:45:16"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-932413-108-7416",
    "资产名称": "资产备案任务管理-数据上报-09-932413",
    "资产类型": "资产资源-部侧-932",
    "所属区域": "-资产资源-资产备案任务管理-扩容核查-932413-009",
    "纳管状态": "已完成-413",
    "最近同步": "2026-05-22 09:12:25"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-932413-109-8024",
    "资产名称": "资产备案任务管理-部侧联动-10-932413",
    "资产类型": "资产资源-核心-932",
    "所属区域": "-资产资源-资产备案任务管理-资产纳管-932413-010",
    "纳管状态": "已完成-413",
    "最近同步": "2026-05-23 17:43:42"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产备案任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产备案任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产备案任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产备案任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产备案任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
