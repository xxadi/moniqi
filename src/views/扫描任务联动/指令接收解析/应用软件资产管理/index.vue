    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加应用软件资产信息", "add")'>添加应用软件资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑应用软件资产信息", "edit")'>编辑应用软件资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除应用软件资产信息", "delete")'>删除应用软件资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询应用软件资产", "detail")'>查询应用软件资产</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("应用软件资产统计", "analysis")'>应用软件资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("应用软件资产信息下载", "export")'>应用软件资产信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-547439-100-6429",
    "资产名称": "应用软件资产管理-资产纳管-01-547439",
    "资产类型": "资产资源-边界-547",
    "所属区域": "-资产资源-应用软件资产管理-异常复核-547439-001",
    "纳管状态": "待复核-439",
    "最近同步": "2026-05-15 11:03:48"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-547439-101-8190",
    "资产名称": "应用软件资产管理-数据上报-02-547439",
    "资产类型": "资产资源-部侧-547",
    "所属区域": "-资产资源-应用软件资产管理-异常复核-547439-002",
    "纳管状态": "已完成-439",
    "最近同步": "2026-05-24 15:27:16"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-547439-102-4738",
    "资产名称": "应用软件资产管理-自动采集-03-547439",
    "资产类型": "资产资源-核心-547",
    "所属区域": "-资产资源-应用软件资产管理-资产纳管-547439-003",
    "纳管状态": "异常-439",
    "最近同步": "2026-05-14 15:11:07"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-547439-103-4775",
    "资产名称": "区公司应用软件资产管理-扩容核查-04-547439",
    "资产类型": "资产资源-边界-547",
    "所属区域": "区公司-资产资源-应用软件资产管理-部侧联动-547439-004",
    "纳管状态": "待处理-439",
    "最近同步": "2026-05-22 10:13:33"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-547439-104-9444",
    "资产名称": "区公司应用软件资产管理-资产纳管-05-547439",
    "资产类型": "资产资源-核心-547",
    "所属区域": "-资产资源-应用软件资产管理-资产纳管-547439-005",
    "纳管状态": "已同步-439",
    "最近同步": "2026-05-15 08:52:42"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-547439-105-6868",
    "资产名称": "应用软件资产管理-数据上报-06-547439",
    "资产类型": "资产资源-复核-547",
    "所属区域": "-资产资源-应用软件资产管理-部侧联动-547439-006",
    "纳管状态": "待复核-439",
    "最近同步": "2026-05-20 17:44:21"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-547439-106-2563",
    "资产名称": "应用软件资产管理-自动采集-07-547439",
    "资产类型": "资产资源-部侧-547",
    "所属区域": "-资产资源-应用软件资产管理-部侧联动-547439-007",
    "纳管状态": "待处理-439",
    "最近同步": "2026-05-19 13:27:12"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-547439-107-6434",
    "资产名称": "应用软件资产管理-异常复核-08-547439",
    "资产类型": "资产资源-省侧-547",
    "所属区域": "-资产资源-应用软件资产管理-自动采集-547439-008",
    "纳管状态": "已完成-439",
    "最近同步": "2026-05-17 11:48:16"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-547439-108-1568",
    "资产名称": "应用软件资产管理-数据上报-09-547439",
    "资产类型": "资产资源-部侧-547",
    "所属区域": "-资产资源-应用软件资产管理-自动采集-547439-009",
    "纳管状态": "已完成-439",
    "最近同步": "2026-05-10 12:39:33"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-547439-109-2736",
    "资产名称": "应用软件资产管理-自动采集-10-547439",
    "资产类型": "资产资源-核心-547",
    "所属区域": "-资产资源-应用软件资产管理-自动采集-547439-010",
    "纳管状态": "异常-439",
    "最近同步": "2026-05-16 08:43:43"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "应用软件资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "应用软件资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "应用软件资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "应用软件资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "应用软件资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
