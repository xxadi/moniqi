    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv6扫描器调度任务信息", "add")'>新增IPv6扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv6扫描器调度任务信息", "edit")'>修改IPv6扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6扫描器调度任务信息", "delete")'>删除IPv6扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6扫描器调度任务", "detail")'>查询IPv6扫描器调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv6扫描器调度任务统计", "analysis")'>IPv6扫描器调度任务统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6扫描器调度任务信息下载", "export")'>IPv6扫描器调度任务信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-363327-100-4242",
    "扫描对象": "IPv6扫描器调度任务管理-部侧联动-01-363327",
    "扫描节点": "节点-07-27",
    "资产数量": 3428,
    "异常数量": 1217,
    "扫描状态": "待处理-327"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-363327-101-1652",
    "扫描对象": "IPv6扫描器调度任务管理-自动采集-02-363327",
    "扫描节点": "节点-07-27",
    "资产数量": 3719,
    "异常数量": 4948,
    "扫描状态": "异常-327"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-363327-102-5901",
    "扫描对象": "IPv6扫描器调度任务管理-异常复核-03-363327",
    "扫描节点": "节点-02-27",
    "资产数量": 1835,
    "异常数量": 2533,
    "扫描状态": "处理中-327"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-363327-103-3431",
    "扫描对象": "IPv6扫描器调度任务管理-自动采集-04-363327",
    "扫描节点": "节点-09-27",
    "资产数量": 687,
    "异常数量": 1549,
    "扫描状态": "已完成-327"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-363327-104-6376",
    "扫描对象": "IPv6扫描器调度任务管理-资产纳管-05-363327",
    "扫描节点": "节点-08-27",
    "资产数量": 924,
    "异常数量": 208,
    "扫描状态": "待复核-327"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-363327-105-8395",
    "扫描对象": "IPv6扫描器调度任务管理-部侧联动-06-363327",
    "扫描节点": "区公司节点-09-27",
    "资产数量": 4554,
    "异常数量": 1995,
    "扫描状态": "待处理-327"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-363327-106-7533",
    "扫描对象": "IPv6扫描器调度任务管理-资产纳管-07-363327",
    "扫描节点": "节点-02-27",
    "资产数量": 2114,
    "异常数量": 2692,
    "扫描状态": "已完成-327"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-363327-107-5437",
    "扫描对象": "IPv6扫描器调度任务管理-自动采集-08-363327",
    "扫描节点": "节点-01-27",
    "资产数量": 1418,
    "异常数量": 3117,
    "扫描状态": "异常-327"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-363327-108-1783",
    "扫描对象": "IPv6扫描器调度任务管理-扩容核查-09-363327",
    "扫描节点": "节点-01-27",
    "资产数量": 149,
    "异常数量": 237,
    "扫描状态": "待处理-327"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-363327-109-4051",
    "扫描对象": "区公司IPv6扫描器调度任务管理-扩容核查-10-363327",
    "扫描节点": "节点-04-27",
    "资产数量": 4416,
    "异常数量": 3934,
    "扫描状态": "处理中-327"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6扫描器调度任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6扫描器调度任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6扫描器调度任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6扫描器调度任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6扫描器调度任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IPv6扫描器调度任务管理" },
