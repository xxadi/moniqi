    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增特定资产范围枚举信息", "add")'>新增特定资产范围枚举信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改特定资产范围枚举信息", "edit")'>修改特定资产范围枚举信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除特定资产范围枚举信息", "delete")'>删除特定资产范围枚举信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询特定资产范围枚举", "detail")'>查询特定资产范围枚举</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("特定资产范围枚举统计", "analysis")'>特定资产范围枚举统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("特定资产范围枚举信息下载", "export")'>特定资产范围枚举信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-483030-100-9360",
    "资产名称": "特定资产范围枚举管理-数据上报-01-483030",
    "资产类型": "资产资源-复核-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-异常复核-483030-001",
    "纳管状态": "待复核-030",
    "最近同步": "2026-05-08 09:52:06"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-483030-101-3806",
    "资产名称": "特定资产范围枚举管理-部侧联动-02-483030",
    "资产类型": "资产资源-部侧-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-扩容核查-483030-002",
    "纳管状态": "待处理-030",
    "最近同步": "2026-05-18 16:34:10"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-483030-102-2914",
    "资产名称": "特定资产范围枚举管理-数据上报-03-483030",
    "资产类型": "资产资源-核心-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-异常复核-483030-003",
    "纳管状态": "待复核-030",
    "最近同步": "2026-05-12 09:58:53"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-483030-103-4080",
    "资产名称": "特定资产范围枚举管理-扩容核查-04-483030",
    "资产类型": "资产资源-自动化-483",
    "所属区域": "区公司-资产资源-特定资产范围枚举管理-自动采集-483030-004",
    "纳管状态": "处理中-030",
    "最近同步": "2026-05-23 12:16:10"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-483030-104-7380",
    "资产名称": "特定资产范围枚举管理-扩容核查-05-483030",
    "资产类型": "资产资源-部侧-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-部侧联动-483030-005",
    "纳管状态": "已同步-030",
    "最近同步": "2026-05-09 09:57:33"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-483030-105-5454",
    "资产名称": "特定资产范围枚举管理-资产纳管-06-483030",
    "资产类型": "资产资源-省侧-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-数据上报-483030-006",
    "纳管状态": "待复核-030",
    "最近同步": "2026-05-09 10:26:53"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-483030-106-4121",
    "资产名称": "区公司特定资产范围枚举管理-数据上报-07-483030",
    "资产类型": "资产资源-复核-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-资产纳管-483030-007",
    "纳管状态": "处理中-030",
    "最近同步": "2026-05-10 13:44:24"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-483030-107-6617",
    "资产名称": "区公司特定资产范围枚举管理-数据上报-08-483030",
    "资产类型": "资产资源-边界-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-自动采集-483030-008",
    "纳管状态": "待复核-030",
    "最近同步": "2026-05-25 14:08:55"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-483030-108-8294",
    "资产名称": "特定资产范围枚举管理-数据上报-09-483030",
    "资产类型": "资产资源-复核-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-扩容核查-483030-009",
    "纳管状态": "已同步-030",
    "最近同步": "2026-05-20 17:18:05"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-483030-109-7752",
    "资产名称": "特定资产范围枚举管理-自动采集-10-483030",
    "资产类型": "资产资源-省侧-483",
    "所属区域": "-资产资源-特定资产范围枚举管理-自动采集-483030-010",
    "纳管状态": "已同步-030",
    "最近同步": "2026-05-16 11:37:35"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "特定资产范围枚举管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "特定资产范围枚举管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "特定资产范围枚举管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "特定资产范围枚举管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "特定资产范围枚举管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
