    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产名称稽核规则", "add")'>新增资产名称稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产名称稽核规则", "edit")'>修改资产名称稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产名称稽核规则", "delete")'>删除资产名称稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产名称稽核规则", "detail")'>查询资产名称稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称稽核规则启用/禁用", "detail")'>资产名称稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称稽核规则运行效果评估", "detail")'>资产名称稽核规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称稽核规则分析", "detail")'>资产名称稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称稽核规则分析结果展示", "detail")'>资产名称稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产名称稽核规则分析结果下载", "export")'>资产名称稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产名称稽核规则分析结果上报", "detail")'>资产名称稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-450373-100-9416",
    "规则名称": "资产名称稽核规则管理-自动采集-01-450373",
    "规则类型": "规则策略-自动化-450",
    "启用状态": "已完成-373",
    "命中次数": 2740,
    "更新时间": "2026-05-18 16:40:30"
  },
  {
    "ID": 2,
    "规则编号": "RULE-450373-101-9888",
    "规则名称": "资产名称稽核规则管理-扩容核查-02-450373",
    "规则类型": "规则策略-边界-450",
    "启用状态": "处理中-373",
    "命中次数": 3450,
    "更新时间": "2026-05-17 15:22:19"
  },
  {
    "ID": 3,
    "规则编号": "RULE-450373-102-7088",
    "规则名称": "资产名称稽核规则管理-资产纳管-03-450373",
    "规则类型": "规则策略-自动化-450",
    "启用状态": "异常-373",
    "命中次数": 3478,
    "更新时间": "2026-05-12 09:43:34"
  },
  {
    "ID": 4,
    "规则编号": "RULE-450373-103-7973",
    "规则名称": "资产名称稽核规则管理-数据上报-04-450373",
    "规则类型": "规则策略-部侧-450",
    "启用状态": "已同步-373",
    "命中次数": 4218,
    "更新时间": "2026-05-15 08:11:28"
  },
  {
    "ID": 5,
    "规则编号": "RULE-450373-104-4649",
    "规则名称": "资产名称稽核规则管理-扩容核查-05-450373",
    "规则类型": "规则策略-复核-450",
    "启用状态": "异常-373",
    "命中次数": 2174,
    "更新时间": "2026-05-13 15:42:55"
  },
  {
    "ID": 6,
    "规则编号": "RULE-450373-105-9012",
    "规则名称": "资产名称稽核规则管理-部侧联动-06-450373",
    "规则类型": "规则策略-复核-450",
    "启用状态": "异常-373",
    "命中次数": 2188,
    "更新时间": "2026-05-11 17:19:01"
  },
  {
    "ID": 7,
    "规则编号": "RULE-450373-106-8385",
    "规则名称": "资产名称稽核规则管理-异常复核-07-450373",
    "规则类型": "规则策略-自动化-450",
    "启用状态": "待处理-373",
    "命中次数": 752,
    "更新时间": "2026-05-08 10:11:34"
  },
  {
    "ID": 8,
    "规则编号": "RULE-450373-107-8517",
    "规则名称": "资产名称稽核规则管理-自动采集-08-450373",
    "规则类型": "规则策略-省侧-450",
    "启用状态": "处理中-373",
    "命中次数": 984,
    "更新时间": "2026-05-19 16:09:35"
  },
  {
    "ID": 9,
    "规则编号": "RULE-450373-108-6971",
    "规则名称": "资产名称稽核规则管理-数据上报-09-450373",
    "规则类型": "规则策略-复核-450",
    "启用状态": "已同步-373",
    "命中次数": 4960,
    "更新时间": "2026-05-12 10:19:31"
  },
  {
    "ID": 10,
    "规则编号": "RULE-450373-109-7862",
    "规则名称": "资产名称稽核规则管理-扩容核查-10-450373",
    "规则类型": "规则策略-部侧-450",
    "启用状态": "已同步-373",
    "命中次数": 1569,
    "更新时间": "2026-05-10 14:31:32"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产名称稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产名称稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产名称稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产名称稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产名称稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
