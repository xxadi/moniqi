    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP扫描指令稽核规则", "add")'>新增IP扫描指令稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP扫描指令稽核规则", "edit")'>修改IP扫描指令稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP扫描指令稽核规则", "delete")'>删除IP扫描指令稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描指令稽核规则", "detail")'>查询IP扫描指令稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP扫描指令稽核规则启用/禁用", "detail")'>IP扫描指令稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP扫描指令稽核规则运行效果评估", "detail")'>IP扫描指令稽核规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP扫描指令稽核规则分析", "detail")'>IP扫描指令稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP扫描指令稽核规则分析结果展示", "detail")'>IP扫描指令稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP扫描指令稽核规则分析结果下载", "export")'>IP扫描指令稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP扫描指令稽核规则分析结果上报", "detail")'>IP扫描指令稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-277713-100-7682",
    "规则名称": "IP扫描指令稽核规则管理-资产纳管-01-277713",
    "规则类型": "规则策略-复核-277",
    "启用状态": "已完成-713",
    "命中次数": 3758,
    "更新时间": "2026-05-13 15:21:20"
  },
  {
    "ID": 2,
    "规则编号": "RULE-277713-101-3154",
    "规则名称": "IP扫描指令稽核规则管理-扩容核查-02-277713",
    "规则类型": "规则策略-复核-277",
    "启用状态": "已同步-713",
    "命中次数": 1522,
    "更新时间": "2026-05-17 08:30:35"
  },
  {
    "ID": 3,
    "规则编号": "RULE-277713-102-1380",
    "规则名称": "IP扫描指令稽核规则管理-异常复核-03-277713",
    "规则类型": "规则策略-省侧-277",
    "启用状态": "待复核-713",
    "命中次数": 2311,
    "更新时间": "2026-05-25 10:24:52"
  },
  {
    "ID": 4,
    "规则编号": "RULE-277713-103-9722",
    "规则名称": "IP扫描指令稽核规则管理-数据上报-04-277713",
    "规则类型": "规则策略-省侧-277",
    "启用状态": "待复核-713",
    "命中次数": 3869,
    "更新时间": "2026-05-11 11:32:43"
  },
  {
    "ID": 5,
    "规则编号": "RULE-277713-104-6526",
    "规则名称": "IP扫描指令稽核规则管理-扩容核查-05-277713",
    "规则类型": "规则策略-边界-277",
    "启用状态": "已完成-713",
    "命中次数": 4136,
    "更新时间": "2026-05-23 14:41:42"
  },
  {
    "ID": 6,
    "规则编号": "RULE-277713-105-5774",
    "规则名称": "IP扫描指令稽核规则管理-资产纳管-06-277713",
    "规则类型": "规则策略-自动化-277",
    "启用状态": "待处理-713",
    "命中次数": 4995,
    "更新时间": "2026-05-09 10:04:31"
  },
  {
    "ID": 7,
    "规则编号": "RULE-277713-106-7786",
    "规则名称": "IP扫描指令稽核规则管理-资产纳管-07-277713",
    "规则类型": "规则策略-部侧-277",
    "启用状态": "待处理-713",
    "命中次数": 1049,
    "更新时间": "2026-05-12 15:21:54"
  },
  {
    "ID": 8,
    "规则编号": "RULE-277713-107-9000",
    "规则名称": "IP扫描指令稽核规则管理-自动采集-08-277713",
    "规则类型": "规则策略-自动化-277",
    "启用状态": "待处理-713",
    "命中次数": 2635,
    "更新时间": "2026-05-17 15:28:46"
  },
  {
    "ID": 9,
    "规则编号": "RULE-277713-108-6929",
    "规则名称": "区公司IP扫描指令稽核规则管理-资产纳管-09-277713",
    "规则类型": "规则策略-自动化-277",
    "启用状态": "异常-713",
    "命中次数": 2870,
    "更新时间": "2026-05-12 11:19:54"
  },
  {
    "ID": 10,
    "规则编号": "RULE-277713-109-4016",
    "规则名称": "IP扫描指令稽核规则管理-部侧联动-10-277713",
    "规则类型": "规则策略-复核-277",
    "启用状态": "已同步-713",
    "命中次数": 641,
    "更新时间": "2026-05-11 13:19:54"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP扫描指令稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP扫描指令稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP扫描指令稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP扫描指令稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP扫描指令稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
