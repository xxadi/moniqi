    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv6网络拓扑信息", "add")'>新增IPv6网络拓扑信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv6网络拓扑信息", "edit")'>修改IPv6网络拓扑信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv6网络拓扑信息", "delete")'>删除IPv6网络拓扑信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6网络拓扑列表", "detail")'>查询IPv6网络拓扑列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv6网络拓扑详情", "detail")'>查询IPv6网络拓扑详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入IPv6网络拓扑信息", "import")'>批量导入IPv6网络拓扑信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv6网络拓扑信息导出", "export")'>IPv6网络拓扑信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-310103-100-9024",
    "业务名称": "IPv6网络拓扑管理-扩容核查-01-310103",
    "业务类型": "业务联动-部侧-310",
    "处理状态": "待复核-103",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-15 13:03:07"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-310103-101-7017",
    "业务名称": "IPv6网络拓扑管理-异常复核-02-310103",
    "业务类型": "业务联动-核心-310",
    "处理状态": "待复核-103",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-19 15:42:22"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-310103-102-2783",
    "业务名称": "IPv6网络拓扑管理-扩容核查-03-310103",
    "业务类型": "业务联动-自动化-310",
    "处理状态": "已同步-103",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-24 17:12:33"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-310103-103-2870",
    "业务名称": "IPv6网络拓扑管理-扩容核查-04-310103",
    "业务类型": "业务联动-复核-310",
    "处理状态": "处理中-103",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 14:26:41"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-310103-104-1352",
    "业务名称": "IPv6网络拓扑管理-资产纳管-05-310103",
    "业务类型": "业务联动-自动化-310",
    "处理状态": "已完成-103",
    "负责人": "数据复核员-区公司",
    "更新时间": "2026-05-17 08:17:54"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-310103-105-9680",
    "业务名称": "IPv6网络拓扑管理-数据上报-06-310103",
    "业务类型": "业务联动-核心-310",
    "处理状态": "待处理-103",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-16 16:41:03"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-310103-106-9809",
    "业务名称": "IPv6网络拓扑管理-异常复核-07-310103",
    "业务类型": "业务联动-边界-310",
    "处理状态": "处理中-103",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-23 14:06:36"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-310103-107-5959",
    "业务名称": "IPv6网络拓扑管理-异常复核-08-310103",
    "业务类型": "业务联动-省侧-310",
    "处理状态": "待处理-103",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-17 09:26:58"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-310103-108-7037",
    "业务名称": "IPv6网络拓扑管理-扩容核查-09-310103",
    "业务类型": "业务联动-自动化-310",
    "处理状态": "已完成-103",
    "负责人": "数据复核员-区公司",
    "更新时间": "2026-05-15 14:45:12"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-310103-109-8093",
    "业务名称": "IPv6网络拓扑管理-自动采集-10-310103",
    "业务类型": "业务联动-省侧-310",
    "处理状态": "异常-103",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-10 16:43:06"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv6网络拓扑管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv6网络拓扑管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv6网络拓扑管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv6网络拓扑管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv6网络拓扑管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
