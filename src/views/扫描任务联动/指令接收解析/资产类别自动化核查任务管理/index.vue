    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产类别自动化核查任务", "add")'>新增资产类别自动化核查任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产类别自动化核查任务", "delete")'>删除资产类别自动化核查任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类别自动化核查任务", "edit")'>修改资产类别自动化核查任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类别自动化核查任务", "detail")'>查询资产类别自动化核查任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查任务启用/禁用", "detail")'>资产类别自动化核查任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查告警", "detail")'>资产类别自动化核查告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查结果统计", "detail")'>资产类别自动化核查结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查数据提取", "detail")'>资产类别自动化核查数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查运行分析", "detail")'>资产类别自动化核查运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查分析结果展示", "detail")'>资产类别自动化核查分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产类别自动化核查分析结果下载", "export")'>资产类别自动化核查分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别自动化核查分析结果上报", "detail")'>资产类别自动化核查分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-788233-100-6816",
    "资产名称": "资产类别自动化核查任务管理-异常复核-01-788233",
    "资产类型": "资产资源-省侧-788",
    "所属区域": "区公司-资产资源-资产类别自动化核查任务管理-部侧联动-788233-001",
    "纳管状态": "已同步-233",
    "最近同步": "2026-05-23 13:28:59"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-788233-101-4445",
    "资产名称": "资产类别自动化核查任务管理-资产纳管-02-788233",
    "资产类型": "资产资源-部侧-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-扩容核查-788233-002",
    "纳管状态": "异常-233",
    "最近同步": "2026-05-10 16:13:03"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-788233-102-7049",
    "资产名称": "资产类别自动化核查任务管理-资产纳管-03-788233",
    "资产类型": "资产资源-省侧-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-数据上报-788233-003",
    "纳管状态": "处理中-233",
    "最近同步": "2026-05-20 15:24:25"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-788233-103-4961",
    "资产名称": "资产类别自动化核查任务管理-自动采集-04-788233",
    "资产类型": "资产资源-自动化-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-自动采集-788233-004",
    "纳管状态": "已完成-233",
    "最近同步": "2026-05-11 13:54:49"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-788233-104-1974",
    "资产名称": "资产类别自动化核查任务管理-异常复核-05-788233",
    "资产类型": "资产资源-自动化-788",
    "所属区域": "区公司-资产资源-资产类别自动化核查任务管理-数据上报-788233-005",
    "纳管状态": "待处理-233",
    "最近同步": "2026-05-14 16:42:29"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-788233-105-5960",
    "资产名称": "资产类别自动化核查任务管理-扩容核查-06-788233",
    "资产类型": "资产资源-部侧-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-资产纳管-788233-006",
    "纳管状态": "待复核-233",
    "最近同步": "2026-05-14 09:24:54"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-788233-106-7261",
    "资产名称": "资产类别自动化核查任务管理-资产纳管-07-788233",
    "资产类型": "资产资源-核心-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-部侧联动-788233-007",
    "纳管状态": "处理中-233",
    "最近同步": "2026-05-15 12:36:49"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-788233-107-4448",
    "资产名称": "资产类别自动化核查任务管理-自动采集-08-788233",
    "资产类型": "资产资源-复核-788",
    "所属区域": "区公司-资产资源-资产类别自动化核查任务管理-数据上报-788233-008",
    "纳管状态": "已完成-233",
    "最近同步": "2026-05-23 16:45:34"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-788233-108-6762",
    "资产名称": "资产类别自动化核查任务管理-部侧联动-09-788233",
    "资产类型": "资产资源-省侧-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-异常复核-788233-009",
    "纳管状态": "待复核-233",
    "最近同步": "2026-05-23 17:41:44"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-788233-109-8248",
    "资产名称": "资产类别自动化核查任务管理-部侧联动-10-788233",
    "资产类型": "资产资源-复核-788",
    "所属区域": "-资产资源-资产类别自动化核查任务管理-自动采集-788233-010",
    "纳管状态": "待处理-233",
    "最近同步": "2026-05-25 15:16:58"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产类别自动化核查任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产类别自动化核查任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产类别自动化核查任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产类别自动化核查任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产类别自动化核查任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "资产类别自动化核查任务管理" },
