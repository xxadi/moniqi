    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增自动化采集率统计规则信息", "add")'>新增自动化采集率统计规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自动化采集率统计规则信息", "edit")'>修改自动化采集率统计规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除自动化采集率统计规则信息", "delete")'>删除自动化采集率统计规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询自动化采集率统计规则列表", "add")'>查询自动化采集率统计规则列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询自动化采集率统计规则详情", "add")'>查询自动化采集率统计规则详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入自动化采集率统计规则信息", "import")'>批量导入自动化采集率统计规则信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("自动化采集率统计规则信息导出", "export")'>自动化采集率统计规则信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-115946-100-8440",
    "规则名称": "区公司自动化采集率统计规则管理-扩容核查-01-115946",
    "规则类型": "规则策略-自动化-115",
    "启用状态": "待复核-946",
    "命中次数": 2672,
    "更新时间": "2026-05-19 08:07:25"
  },
  {
    "ID": 2,
    "规则编号": "RULE-115946-101-1333",
    "规则名称": "区公司自动化采集率统计规则管理-数据上报-02-115946",
    "规则类型": "规则策略-自动化-115",
    "启用状态": "待复核-946",
    "命中次数": 573,
    "更新时间": "2026-05-19 12:56:05"
  },
  {
    "ID": 3,
    "规则编号": "RULE-115946-102-1221",
    "规则名称": "自动化采集率统计规则管理-数据上报-03-115946",
    "规则类型": "规则策略-边界-115",
    "启用状态": "已同步-946",
    "命中次数": 129,
    "更新时间": "2026-05-17 15:09:36"
  },
  {
    "ID": 4,
    "规则编号": "RULE-115946-103-2423",
    "规则名称": "区公司自动化采集率统计规则管理-扩容核查-04-115946",
    "规则类型": "规则策略-边界-115",
    "启用状态": "待处理-946",
    "命中次数": 4672,
    "更新时间": "2026-05-23 09:01:01"
  },
  {
    "ID": 5,
    "规则编号": "RULE-115946-104-8430",
    "规则名称": "自动化采集率统计规则管理-部侧联动-05-115946",
    "规则类型": "规则策略-自动化-115",
    "启用状态": "待复核-946",
    "命中次数": 4466,
    "更新时间": "2026-05-13 12:31:40"
  },
  {
    "ID": 6,
    "规则编号": "RULE-115946-105-1041",
    "规则名称": "自动化采集率统计规则管理-资产纳管-06-115946",
    "规则类型": "规则策略-边界-115",
    "启用状态": "异常-946",
    "命中次数": 3698,
    "更新时间": "2026-05-16 09:09:46"
  },
  {
    "ID": 7,
    "规则编号": "RULE-115946-106-3059",
    "规则名称": "自动化采集率统计规则管理-自动采集-07-115946",
    "规则类型": "规则策略-复核-115",
    "启用状态": "异常-946",
    "命中次数": 4913,
    "更新时间": "2026-05-23 10:45:47"
  },
  {
    "ID": 8,
    "规则编号": "RULE-115946-107-9920",
    "规则名称": "自动化采集率统计规则管理-资产纳管-08-115946",
    "规则类型": "规则策略-核心-115",
    "启用状态": "处理中-946",
    "命中次数": 1205,
    "更新时间": "2026-05-21 14:37:38"
  },
  {
    "ID": 9,
    "规则编号": "RULE-115946-108-6718",
    "规则名称": "自动化采集率统计规则管理-扩容核查-09-115946",
    "规则类型": "规则策略-部侧-115",
    "启用状态": "已完成-946",
    "命中次数": 65,
    "更新时间": "2026-05-16 09:21:34"
  },
  {
    "ID": 10,
    "规则编号": "RULE-115946-109-9779",
    "规则名称": "自动化采集率统计规则管理-自动采集-10-115946",
    "规则类型": "规则策略-部侧-115",
    "启用状态": "异常-946",
    "命中次数": 3967,
    "更新时间": "2026-05-11 16:38:42"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "自动化采集率统计规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "自动化采集率统计规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "自动化采集率统计规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "自动化采集率统计规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "自动化采集率统计规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
