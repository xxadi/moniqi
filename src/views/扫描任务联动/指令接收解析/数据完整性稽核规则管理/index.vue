    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增数据完整性稽核规则", "add")'>新增数据完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改数据完整性稽核规则", "edit")'>修改数据完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除数据完整性稽核规则", "delete")'>删除数据完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询数据完整性稽核规则", "detail")'>查询数据完整性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核规则启用/禁用", "detail")'>数据完整性稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核告警", "detail")'>数据完整性稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核结果统计", "detail")'>数据完整性稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核数据提取", "detail")'>数据完整性稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核规则分析", "detail")'>数据完整性稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核规则分析结果展示", "detail")'>数据完整性稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("数据完整性稽核规则分析结果下载", "export")'>数据完整性稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据完整性稽核规则分析结果上报", "detail")'>数据完整性稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-142090-100-9486",
    "规则名称": "数据完整性稽核规则管理-自动采集-01-142090",
    "规则类型": "规则策略-边界-142",
    "启用状态": "处理中-090",
    "命中次数": 3372,
    "更新时间": "2026-05-11 16:20:48"
  },
  {
    "ID": 2,
    "规则编号": "RULE-142090-101-1743",
    "规则名称": "数据完整性稽核规则管理-部侧联动-02-142090",
    "规则类型": "规则策略-自动化-142",
    "启用状态": "已同步-090",
    "命中次数": 4907,
    "更新时间": "2026-05-18 16:50:46"
  },
  {
    "ID": 3,
    "规则编号": "RULE-142090-102-5602",
    "规则名称": "区公司数据完整性稽核规则管理-扩容核查-03-142090",
    "规则类型": "规则策略-部侧-142",
    "启用状态": "待处理-090",
    "命中次数": 4270,
    "更新时间": "2026-05-24 13:03:44"
  },
  {
    "ID": 4,
    "规则编号": "RULE-142090-103-7722",
    "规则名称": "数据完整性稽核规则管理-自动采集-04-142090",
    "规则类型": "规则策略-部侧-142",
    "启用状态": "待复核-090",
    "命中次数": 4791,
    "更新时间": "2026-05-25 15:03:16"
  },
  {
    "ID": 5,
    "规则编号": "RULE-142090-104-6888",
    "规则名称": "区公司数据完整性稽核规则管理-部侧联动-05-142090",
    "规则类型": "规则策略-自动化-142",
    "启用状态": "处理中-090",
    "命中次数": 922,
    "更新时间": "2026-05-10 09:42:25"
  },
  {
    "ID": 6,
    "规则编号": "RULE-142090-105-5310",
    "规则名称": "数据完整性稽核规则管理-异常复核-06-142090",
    "规则类型": "规则策略-边界-142",
    "启用状态": "待复核-090",
    "命中次数": 4511,
    "更新时间": "2026-05-09 10:47:17"
  },
  {
    "ID": 7,
    "规则编号": "RULE-142090-106-8955",
    "规则名称": "数据完整性稽核规则管理-数据上报-07-142090",
    "规则类型": "规则策略-核心-142",
    "启用状态": "已完成-090",
    "命中次数": 2005,
    "更新时间": "2026-05-16 15:36:43"
  },
  {
    "ID": 8,
    "规则编号": "RULE-142090-107-7046",
    "规则名称": "数据完整性稽核规则管理-数据上报-08-142090",
    "规则类型": "规则策略-复核-142",
    "启用状态": "待复核-090",
    "命中次数": 2630,
    "更新时间": "2026-05-11 16:06:10"
  },
  {
    "ID": 9,
    "规则编号": "RULE-142090-108-7826",
    "规则名称": "数据完整性稽核规则管理-异常复核-09-142090",
    "规则类型": "规则策略-边界-142",
    "启用状态": "待复核-090",
    "命中次数": 3106,
    "更新时间": "2026-05-21 17:20:55"
  },
  {
    "ID": 10,
    "规则编号": "RULE-142090-109-1259",
    "规则名称": "数据完整性稽核规则管理-部侧联动-10-142090",
    "规则类型": "规则策略-核心-142",
    "启用状态": "处理中-090",
    "命中次数": 2483,
    "更新时间": "2026-05-22 08:49:03"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "数据完整性稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "数据完整性稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "数据完整性稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "数据完整性稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "数据完整性稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
