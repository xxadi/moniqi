    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加物理资产管理信息", "add")'>添加物理资产管理信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑物理资产管理信息", "edit")'>编辑物理资产管理信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除物理资产管理信息", "delete")'>删除物理资产管理信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询物理资产管理列表", "detail")'>查询物理资产管理列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询物理资产管理详情", "detail")'>查询物理资产管理详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入物理资产管理信息", "import")'>批量导入物理资产管理信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("物理资产管理信息导出", "export")'>物理资产管理信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-836273-100-2620",
    "资产名称": "物理资产管理-部侧联动-01-836273",
    "资产类型": "资产资源-复核-836",
    "所属区域": "区公司-资产资源-物理资产管理-扩容核查-836273-001",
    "纳管状态": "处理中-273",
    "最近同步": "2026-05-15 08:14:48"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-836273-101-6567",
    "资产名称": "物理资产管理-异常复核-02-836273",
    "资产类型": "资产资源-核心-836",
    "所属区域": "-资产资源-物理资产管理-异常复核-836273-002",
    "纳管状态": "待复核-273",
    "最近同步": "2026-05-10 11:42:04"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-836273-102-6957",
    "资产名称": "物理资产管理-异常复核-03-836273",
    "资产类型": "资产资源-省侧-836",
    "所属区域": "-资产资源-物理资产管理-资产纳管-836273-003",
    "纳管状态": "已同步-273",
    "最近同步": "2026-05-20 10:38:40"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-836273-103-5988",
    "资产名称": "物理资产管理-资产纳管-04-836273",
    "资产类型": "资产资源-边界-836",
    "所属区域": "-资产资源-物理资产管理-数据上报-836273-004",
    "纳管状态": "处理中-273",
    "最近同步": "2026-05-12 14:16:43"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-836273-104-4956",
    "资产名称": "物理资产管理-部侧联动-05-836273",
    "资产类型": "资产资源-核心-836",
    "所属区域": "-资产资源-物理资产管理-资产纳管-836273-005",
    "纳管状态": "异常-273",
    "最近同步": "2026-05-25 15:19:52"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-836273-105-7264",
    "资产名称": "物理资产管理-扩容核查-06-836273",
    "资产类型": "资产资源-省侧-836",
    "所属区域": "-资产资源-物理资产管理-自动采集-836273-006",
    "纳管状态": "待复核-273",
    "最近同步": "2026-05-20 10:25:11"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-836273-106-3797",
    "资产名称": "物理资产管理-自动采集-07-836273",
    "资产类型": "资产资源-部侧-836",
    "所属区域": "-资产资源-物理资产管理-自动采集-836273-007",
    "纳管状态": "异常-273",
    "最近同步": "2026-05-09 11:14:53"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-836273-107-3322",
    "资产名称": "物理资产管理-资产纳管-08-836273",
    "资产类型": "资产资源-核心-836",
    "所属区域": "-资产资源-物理资产管理-数据上报-836273-008",
    "纳管状态": "已完成-273",
    "最近同步": "2026-05-25 09:05:32"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-836273-108-2737",
    "资产名称": "物理资产管理-部侧联动-09-836273",
    "资产类型": "资产资源-边界-836",
    "所属区域": "-资产资源-物理资产管理-异常复核-836273-009",
    "纳管状态": "待复核-273",
    "最近同步": "2026-05-10 16:15:23"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-836273-109-3898",
    "资产名称": "区公司物理资产管理-扩容核查-10-836273",
    "资产类型": "资产资源-省侧-836",
    "所属区域": "-资产资源-物理资产管理-扩容核查-836273-010",
    "纳管状态": "已完成-273",
    "最近同步": "2026-05-19 13:16:16"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "物理资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "物理资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "物理资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "物理资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "物理资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
