    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增自定义项一致性稽核规则", "add")'>新增自定义项一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自定义项一致性稽核规则", "edit")'>修改自定义项一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除自定义项一致性稽核规则", "delete")'>删除自定义项一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自定义项一致性稽核规则", "detail")'>查询自定义项一致性稽核规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项一致性稽核规则启用/禁用", "detail")'>自定义项一致性稽核规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项一致性稽核规则运行效果评估", "detail")'>自定义项一致性稽核规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项一致性稽核规则分析", "detail")'>自定义项一致性稽核规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项一致性稽核规则分析结果展示", "detail")'>自定义项一致性稽核规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("自定义项一致性稽核规则分析结果下载", "export")'>自定义项一致性稽核规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项一致性稽核规则分析结果上报", "detail")'>自定义项一致性稽核规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-526018-100-8132",
    "规则名称": "自定义项一致性稽核规则管理-异常复核-01-526018",
    "规则类型": "规则策略-复核-526",
    "启用状态": "异常-018",
    "命中次数": 1035,
    "更新时间": "2026-05-13 16:54:12"
  },
  {
    "ID": 2,
    "规则编号": "RULE-526018-101-8482",
    "规则名称": "自定义项一致性稽核规则管理-自动采集-02-526018",
    "规则类型": "规则策略-省侧-526",
    "启用状态": "已同步-018",
    "命中次数": 1042,
    "更新时间": "2026-05-21 11:41:43"
  },
  {
    "ID": 3,
    "规则编号": "RULE-526018-102-5776",
    "规则名称": "自定义项一致性稽核规则管理-数据上报-03-526018",
    "规则类型": "规则策略-边界-526",
    "启用状态": "待复核-018",
    "命中次数": 1226,
    "更新时间": "2026-05-08 08:38:18"
  },
  {
    "ID": 4,
    "规则编号": "RULE-526018-103-4326",
    "规则名称": "自定义项一致性稽核规则管理-资产纳管-04-526018",
    "规则类型": "规则策略-省侧-526",
    "启用状态": "待处理-018",
    "命中次数": 2739,
    "更新时间": "2026-05-24 17:27:18"
  },
  {
    "ID": 5,
    "规则编号": "RULE-526018-104-6559",
    "规则名称": "自定义项一致性稽核规则管理-自动采集-05-526018",
    "规则类型": "规则策略-复核-526",
    "启用状态": "已同步-018",
    "命中次数": 2633,
    "更新时间": "2026-05-23 08:37:48"
  },
  {
    "ID": 6,
    "规则编号": "RULE-526018-105-1483",
    "规则名称": "自定义项一致性稽核规则管理-自动采集-06-526018",
    "规则类型": "规则策略-复核-526",
    "启用状态": "处理中-018",
    "命中次数": 963,
    "更新时间": "2026-05-08 17:46:47"
  },
  {
    "ID": 7,
    "规则编号": "RULE-526018-106-8660",
    "规则名称": "自定义项一致性稽核规则管理-部侧联动-07-526018",
    "规则类型": "规则策略-部侧-526",
    "启用状态": "异常-018",
    "命中次数": 2035,
    "更新时间": "2026-05-20 10:57:55"
  },
  {
    "ID": 8,
    "规则编号": "RULE-526018-107-8804",
    "规则名称": "自定义项一致性稽核规则管理-自动采集-08-526018",
    "规则类型": "规则策略-省侧-526",
    "启用状态": "处理中-018",
    "命中次数": 844,
    "更新时间": "2026-05-14 09:17:51"
  },
  {
    "ID": 9,
    "规则编号": "RULE-526018-108-1392",
    "规则名称": "自定义项一致性稽核规则管理-部侧联动-09-526018",
    "规则类型": "规则策略-自动化-526",
    "启用状态": "待处理-018",
    "命中次数": 3534,
    "更新时间": "2026-05-14 09:27:38"
  },
  {
    "ID": 10,
    "规则编号": "RULE-526018-109-5844",
    "规则名称": "自定义项一致性稽核规则管理-扩容核查-10-526018",
    "规则类型": "规则策略-边界-526",
    "启用状态": "处理中-018",
    "命中次数": 2382,
    "更新时间": "2026-05-17 15:57:28"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "自定义项一致性稽核规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "自定义项一致性稽核规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "自定义项一致性稽核规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "自定义项一致性稽核规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "自定义项一致性稽核规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "自定义项一致性稽核规则管理" },
