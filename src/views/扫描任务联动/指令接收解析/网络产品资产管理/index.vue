    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增网络产品资产信息", "add")'>新增网络产品资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络产品资产信息", "edit")'>修改网络产品资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除网络产品资产信息", "delete")'>删除网络产品资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询网络产品资产", "detail")'>查询网络产品资产</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("网络产品资产统计", "analysis")'>网络产品资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("网络产品资产信息下载", "export")'>网络产品资产信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-066795-100-8277",
    "资产名称": "网络产品资产管理-数据上报-01-066795",
    "资产类型": "资产资源-自动化-066",
    "所属区域": "-资产资源-网络产品资产管理-部侧联动-066795-001",
    "纳管状态": "已同步-795",
    "最近同步": "2026-05-23 09:13:35"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-066795-101-4550",
    "资产名称": "网络产品资产管理-异常复核-02-066795",
    "资产类型": "资产资源-边界-066",
    "所属区域": "区公司-资产资源-网络产品资产管理-异常复核-066795-002",
    "纳管状态": "已同步-795",
    "最近同步": "2026-05-08 12:11:34"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-066795-102-2936",
    "资产名称": "网络产品资产管理-异常复核-03-066795",
    "资产类型": "资产资源-部侧-066",
    "所属区域": "区公司-资产资源-网络产品资产管理-数据上报-066795-003",
    "纳管状态": "处理中-795",
    "最近同步": "2026-05-21 11:11:52"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-066795-103-8018",
    "资产名称": "网络产品资产管理-数据上报-04-066795",
    "资产类型": "资产资源-省侧-066",
    "所属区域": "-资产资源-网络产品资产管理-自动采集-066795-004",
    "纳管状态": "待处理-795",
    "最近同步": "2026-05-23 12:35:12"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-066795-104-2271",
    "资产名称": "区公司网络产品资产管理-资产纳管-05-066795",
    "资产类型": "资产资源-省侧-066",
    "所属区域": "-资产资源-网络产品资产管理-资产纳管-066795-005",
    "纳管状态": "已完成-795",
    "最近同步": "2026-05-22 16:26:22"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-066795-105-3936",
    "资产名称": "网络产品资产管理-异常复核-06-066795",
    "资产类型": "资产资源-边界-066",
    "所属区域": "区公司-资产资源-网络产品资产管理-部侧联动-066795-006",
    "纳管状态": "处理中-795",
    "最近同步": "2026-05-21 15:24:59"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-066795-106-2593",
    "资产名称": "网络产品资产管理-资产纳管-07-066795",
    "资产类型": "资产资源-省侧-066",
    "所属区域": "-资产资源-网络产品资产管理-扩容核查-066795-007",
    "纳管状态": "待处理-795",
    "最近同步": "2026-05-08 12:07:00"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-066795-107-7581",
    "资产名称": "网络产品资产管理-部侧联动-08-066795",
    "资产类型": "资产资源-省侧-066",
    "所属区域": "-资产资源-网络产品资产管理-自动采集-066795-008",
    "纳管状态": "处理中-795",
    "最近同步": "2026-05-24 12:43:52"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-066795-108-2157",
    "资产名称": "网络产品资产管理-部侧联动-09-066795",
    "资产类型": "资产资源-自动化-066",
    "所属区域": "-资产资源-网络产品资产管理-数据上报-066795-009",
    "纳管状态": "已同步-795",
    "最近同步": "2026-05-08 17:44:33"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-066795-109-2441",
    "资产名称": "网络产品资产管理-部侧联动-10-066795",
    "资产类型": "资产资源-自动化-066",
    "所属区域": "-资产资源-网络产品资产管理-扩容核查-066795-010",
    "纳管状态": "待处理-795",
    "最近同步": "2026-05-15 08:03:17"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "网络产品资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "网络产品资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "网络产品资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "网络产品资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "网络产品资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
