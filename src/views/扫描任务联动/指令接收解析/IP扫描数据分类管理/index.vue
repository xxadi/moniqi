    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加IP扫描数据分类信息", "add")'>添加IP扫描数据分类信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑IP扫描数据分类信息", "edit")'>编辑IP扫描数据分类信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP扫描数据分类信息", "delete")'>删除IP扫描数据分类信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描数据分类", "detail")'>查询IP扫描数据分类</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP扫描数据分类统计", "analysis")'>IP扫描数据分类统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP扫描数据分类下载", "export")'>IP扫描数据分类下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-395633-100-3905",
    "扫描对象": "IP扫描数据分类管理-扩容核查-01-395633",
    "扫描节点": "节点-02-33",
    "资产数量": 1062,
    "异常数量": 4326,
    "扫描状态": "已同步-633"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-395633-101-1719",
    "扫描对象": "IP扫描数据分类管理-异常复核-02-395633",
    "扫描节点": "节点-04-33",
    "资产数量": 512,
    "异常数量": 1274,
    "扫描状态": "异常-633"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-395633-102-3978",
    "扫描对象": "IP扫描数据分类管理-部侧联动-03-395633",
    "扫描节点": "区公司节点-06-33",
    "资产数量": 2156,
    "异常数量": 3921,
    "扫描状态": "已同步-633"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-395633-103-6653",
    "扫描对象": "区公司IP扫描数据分类管理-异常复核-04-395633",
    "扫描节点": "节点-04-33",
    "资产数量": 2915,
    "异常数量": 486,
    "扫描状态": "已同步-633"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-395633-104-7537",
    "扫描对象": "IP扫描数据分类管理-自动采集-05-395633",
    "扫描节点": "节点-07-33",
    "资产数量": 319,
    "异常数量": 2263,
    "扫描状态": "待处理-633"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-395633-105-7885",
    "扫描对象": "IP扫描数据分类管理-资产纳管-06-395633",
    "扫描节点": "区公司节点-09-33",
    "资产数量": 3628,
    "异常数量": 1509,
    "扫描状态": "处理中-633"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-395633-106-5720",
    "扫描对象": "IP扫描数据分类管理-部侧联动-07-395633",
    "扫描节点": "节点-02-33",
    "资产数量": 4877,
    "异常数量": 513,
    "扫描状态": "已同步-633"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-395633-107-1107",
    "扫描对象": "区公司IP扫描数据分类管理-数据上报-08-395633",
    "扫描节点": "节点-08-33",
    "资产数量": 150,
    "异常数量": 2389,
    "扫描状态": "已同步-633"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-395633-108-9674",
    "扫描对象": "IP扫描数据分类管理-异常复核-09-395633",
    "扫描节点": "节点-08-33",
    "资产数量": 1786,
    "异常数量": 4442,
    "扫描状态": "待复核-633"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-395633-109-8372",
    "扫描对象": "IP扫描数据分类管理-资产纳管-10-395633",
    "扫描节点": "节点-09-33",
    "资产数量": 3368,
    "异常数量": 476,
    "扫描状态": "处理中-633"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP扫描数据分类管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP扫描数据分类管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP扫描数据分类管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP扫描数据分类管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP扫描数据分类管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
