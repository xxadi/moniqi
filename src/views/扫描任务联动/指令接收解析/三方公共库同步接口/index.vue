    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增三方公共库同步接口", "add")'>新增三方公共库同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("定义三方公共库同步信息", "add")'>定义三方公共库同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("三方公共库同步数据查看", "add")'>三方公共库同步数据查看</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增三方公共库同步状态查询信息", "add")'>新增三方公共库同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("三方公共库同步结果监控", "add")'>三方公共库同步结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("更新三方公共库同步接口数据", "edit")'>更新三方公共库同步接口数据</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看三方公共库同步接口请求信息", "add")'>查看三方公共库同步接口请求信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("三方公共库同步接口数据清洗", "add")'>三方公共库同步接口数据清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("三方公共库同步运行监控", "add")'>三方公共库同步运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("反馈三方公共库同步接口信息", "add")'>反馈三方公共库同步接口信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-456653-100-8429",
    "接口名称": "三方公共库同步接口-资产纳管-01-456653",
    "对接系统": "调度中心-4566",
    "调用状态": "处理中-653",
    "平均耗时": "456ms-53",
    "最近调用": "2026-05-10 09:14:46"
  },
  {
    "ID": 2,
    "接口编号": "API-456653-101-7686",
    "接口名称": "区公司三方公共库同步接口-扩容核查-02-456653",
    "对接系统": "集团资产平台-4566",
    "调用状态": "待处理-653",
    "平均耗时": "359ms-53",
    "最近调用": "2026-05-15 11:24:32"
  },
  {
    "ID": 3,
    "接口编号": "API-456653-102-6496",
    "接口名称": "三方公共库同步接口-资产纳管-03-456653",
    "对接系统": "调度中心-4566",
    "调用状态": "待处理-653",
    "平均耗时": "174ms-53",
    "最近调用": "2026-05-19 09:06:56"
  },
  {
    "ID": 4,
    "接口编号": "API-456653-103-1211",
    "接口名称": "区公司三方公共库同步接口-异常复核-04-456653",
    "对接系统": "CMDB资源库-4566",
    "调用状态": "待复核-653",
    "平均耗时": "286ms-53",
    "最近调用": "2026-05-22 12:13:25"
  },
  {
    "ID": 5,
    "接口编号": "API-456653-104-8166",
    "接口名称": "三方公共库同步接口-资产纳管-05-456653",
    "对接系统": "工信部对接平台-4566",
    "调用状态": "异常-653",
    "平均耗时": "622ms-53",
    "最近调用": "2026-05-09 13:41:40"
  },
  {
    "ID": 6,
    "接口编号": "API-456653-105-5308",
    "接口名称": "三方公共库同步接口-部侧联动-06-456653",
    "对接系统": "工信部对接平台-4566",
    "调用状态": "已同步-653",
    "平均耗时": "112ms-53",
    "最近调用": "2026-05-15 14:02:35"
  },
  {
    "ID": 7,
    "接口编号": "API-456653-106-3253",
    "接口名称": "区公司三方公共库同步接口-资产纳管-07-456653",
    "对接系统": "资产安全平台-4566",
    "调用状态": "处理中-653",
    "平均耗时": "398ms-53",
    "最近调用": "2026-05-10 12:20:37"
  },
  {
    "ID": 8,
    "接口编号": "API-456653-107-5835",
    "接口名称": "三方公共库同步接口-异常复核-08-456653",
    "对接系统": "调度中心-4566",
    "调用状态": "待处理-653",
    "平均耗时": "586ms-53",
    "最近调用": "2026-05-20 10:49:25"
  },
  {
    "ID": 9,
    "接口编号": "API-456653-108-9264",
    "接口名称": "三方公共库同步接口-扩容核查-09-456653",
    "对接系统": "资产安全平台-4566",
    "调用状态": "已同步-653",
    "平均耗时": "428ms-53",
    "最近调用": "2026-05-17 10:54:07"
  },
  {
    "ID": 10,
    "接口编号": "API-456653-109-6158",
    "接口名称": "三方公共库同步接口-异常复核-10-456653",
    "对接系统": "资产安全平台-4566",
    "调用状态": "已同步-653",
    "平均耗时": "413ms-53",
    "最近调用": "2026-05-24 09:48:35"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "三方公共库同步接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "三方公共库同步接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "三方公共库同步接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "三方公共库同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "三方公共库同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
