    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增探针数据识别规则", "add")'>新增探针数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改探针数据识别规则", "edit")'>修改探针数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除探针数据识别规则", "delete")'>删除探针数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询探针数据识别规则", "detail")'>查询探针数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别规则启用/禁用", "analysis")'>探针数据识别规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别告警", "analysis")'>探针数据识别告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别结果统计", "analysis")'>探针数据识别结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别数据提取", "analysis")'>探针数据识别数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别规则分析", "analysis")'>探针数据识别规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("探针数据识别规则分析结果展示", "detail")'>探针数据识别规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("探针数据识别规则分析结果下载", "export")'>探针数据识别规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("探针数据识别规则分析结果上报", "analysis")'>探针数据识别规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-576803-100-9104",
    "规则名称": "探针数据识别规则管理-异常复核-01-576803",
    "规则类型": "规则策略-核心-576",
    "启用状态": "处理中-803",
    "命中次数": 1255,
    "更新时间": "2026-05-22 08:01:49"
  },
  {
    "ID": 2,
    "规则编号": "RULE-576803-101-3342",
    "规则名称": "探针数据识别规则管理-自动采集-02-576803",
    "规则类型": "规则策略-复核-576",
    "启用状态": "异常-803",
    "命中次数": 4344,
    "更新时间": "2026-05-12 09:14:48"
  },
  {
    "ID": 3,
    "规则编号": "RULE-576803-102-8545",
    "规则名称": "探针数据识别规则管理-扩容核查-03-576803",
    "规则类型": "规则策略-核心-576",
    "启用状态": "异常-803",
    "命中次数": 1801,
    "更新时间": "2026-05-18 13:47:23"
  },
  {
    "ID": 4,
    "规则编号": "RULE-576803-103-1430",
    "规则名称": "探针数据识别规则管理-异常复核-04-576803",
    "规则类型": "规则策略-边界-576",
    "启用状态": "处理中-803",
    "命中次数": 2201,
    "更新时间": "2026-05-12 11:58:14"
  },
  {
    "ID": 5,
    "规则编号": "RULE-576803-104-3349",
    "规则名称": "探针数据识别规则管理-扩容核查-05-576803",
    "规则类型": "规则策略-复核-576",
    "启用状态": "异常-803",
    "命中次数": 884,
    "更新时间": "2026-05-25 12:55:20"
  },
  {
    "ID": 6,
    "规则编号": "RULE-576803-105-7876",
    "规则名称": "探针数据识别规则管理-部侧联动-06-576803",
    "规则类型": "规则策略-自动化-576",
    "启用状态": "处理中-803",
    "命中次数": 1536,
    "更新时间": "2026-05-15 15:42:26"
  },
  {
    "ID": 7,
    "规则编号": "RULE-576803-106-6630",
    "规则名称": "探针数据识别规则管理-部侧联动-07-576803",
    "规则类型": "规则策略-边界-576",
    "启用状态": "异常-803",
    "命中次数": 2797,
    "更新时间": "2026-05-22 10:25:05"
  },
  {
    "ID": 8,
    "规则编号": "RULE-576803-107-2236",
    "规则名称": "探针数据识别规则管理-异常复核-08-576803",
    "规则类型": "规则策略-复核-576",
    "启用状态": "待处理-803",
    "命中次数": 2483,
    "更新时间": "2026-05-09 12:10:44"
  },
  {
    "ID": 9,
    "规则编号": "RULE-576803-108-5025",
    "规则名称": "探针数据识别规则管理-自动采集-09-576803",
    "规则类型": "规则策略-核心-576",
    "启用状态": "待复核-803",
    "命中次数": 4211,
    "更新时间": "2026-05-16 15:56:37"
  },
  {
    "ID": 10,
    "规则编号": "RULE-576803-109-5488",
    "规则名称": "探针数据识别规则管理-部侧联动-10-576803",
    "规则类型": "规则策略-自动化-576",
    "启用状态": "处理中-803",
    "命中次数": 2128,
    "更新时间": "2026-05-18 12:44:29"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "探针数据识别规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "探针数据识别规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "探针数据识别规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "探针数据识别规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "探针数据识别规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
