    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("新增部侧上传通道信息", "import")'>新增部侧上传通道信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("修改部侧上传通道信息", "import")'>修改部侧上传通道信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("删除部侧上传通道信息", "import")'>删除部侧上传通道信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("查询部侧上传通道列表", "import")'>查询部侧上传通道列表</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("查询部侧上传通道详情", "import")'>查询部侧上传通道详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入部侧上传通道信息", "import")'>批量导入部侧上传通道信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("部侧上传通道信息导出", "import")'>部侧上传通道信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-756035-100-7951",
    "接口名称": "部侧上传通道管理-资产纳管-01-756035",
    "对接系统": "调度中心-7560",
    "调用状态": "已完成-035",
    "平均耗时": "252ms-35",
    "最近调用": "2026-05-10 08:20:50"
  },
  {
    "ID": 2,
    "接口编号": "API-756035-101-1660",
    "接口名称": "部侧上传通道管理-数据上报-02-756035",
    "对接系统": "CMDB资源库-7560",
    "调用状态": "处理中-035",
    "平均耗时": "386ms-35",
    "最近调用": "2026-05-17 08:46:45"
  },
  {
    "ID": 3,
    "接口编号": "API-756035-102-2577",
    "接口名称": "部侧上传通道管理-自动采集-03-756035",
    "对接系统": "资产安全平台-7560",
    "调用状态": "待处理-035",
    "平均耗时": "137ms-35",
    "最近调用": "2026-05-25 12:13:00"
  },
  {
    "ID": 4,
    "接口编号": "API-756035-103-5831",
    "接口名称": "区公司部侧上传通道管理-数据上报-04-756035",
    "对接系统": "CMDB资源库-7560",
    "调用状态": "已同步-035",
    "平均耗时": "485ms-35",
    "最近调用": "2026-05-23 15:24:26"
  },
  {
    "ID": 5,
    "接口编号": "API-756035-104-7451",
    "接口名称": "部侧上传通道管理-数据上报-05-756035",
    "对接系统": "调度中心-7560",
    "调用状态": "处理中-035",
    "平均耗时": "214ms-35",
    "最近调用": "2026-05-13 12:49:25"
  },
  {
    "ID": 6,
    "接口编号": "API-756035-105-9092",
    "接口名称": "部侧上传通道管理-异常复核-06-756035",
    "对接系统": "CMDB资源库-7560",
    "调用状态": "已完成-035",
    "平均耗时": "474ms-35",
    "最近调用": "2026-05-13 12:52:34"
  },
  {
    "ID": 7,
    "接口编号": "API-756035-106-2820",
    "接口名称": "部侧上传通道管理-资产纳管-07-756035",
    "对接系统": "集团资产平台-7560",
    "调用状态": "待处理-035",
    "平均耗时": "615ms-35",
    "最近调用": "2026-05-10 17:12:43"
  },
  {
    "ID": 8,
    "接口编号": "API-756035-107-9778",
    "接口名称": "部侧上传通道管理-扩容核查-08-756035",
    "对接系统": "集团资产平台-7560",
    "调用状态": "处理中-035",
    "平均耗时": "566ms-35",
    "最近调用": "2026-05-20 17:12:20"
  },
  {
    "ID": 9,
    "接口编号": "API-756035-108-8886",
    "接口名称": "部侧上传通道管理-部侧联动-09-756035",
    "对接系统": "工信部对接平台-7560",
    "调用状态": "已同步-035",
    "平均耗时": "54ms-35",
    "最近调用": "2026-05-12 12:24:34"
  },
  {
    "ID": 10,
    "接口编号": "API-756035-109-6748",
    "接口名称": "部侧上传通道管理-异常复核-10-756035",
    "对接系统": "资产安全平台-7560",
    "调用状态": "待处理-035",
    "平均耗时": "106ms-35",
    "最近调用": "2026-05-10 10:17:11"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧上传通道管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧上传通道管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧上传通道管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧上传通道管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧上传通道管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
