    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加工信部采集策略信息", "add")'>添加工信部采集策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑工信部采集策略信息", "edit")'>编辑工信部采集策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除工信部采集策略信息", "delete")'>删除工信部采集策略信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询工信部采集策略", "add")'>查询工信部采集策略</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("工信部采集策略统计", "add")'>工信部采集策略统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("工信部采集策略信息下载", "export")'>工信部采集策略信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-302497-100-2668",
    "规则名称": "工信部采集策略管理-数据上报-01-302497",
    "规则类型": "规则策略-边界-302",
    "启用状态": "待处理-497",
    "命中次数": 3427,
    "更新时间": "2026-05-24 10:16:11"
  },
  {
    "ID": 2,
    "规则编号": "RULE-302497-101-4863",
    "规则名称": "区公司工信部采集策略管理-数据上报-02-302497",
    "规则类型": "规则策略-核心-302",
    "启用状态": "已同步-497",
    "命中次数": 2845,
    "更新时间": "2026-05-22 17:49:17"
  },
  {
    "ID": 3,
    "规则编号": "RULE-302497-102-3392",
    "规则名称": "工信部采集策略管理-异常复核-03-302497",
    "规则类型": "规则策略-省侧-302",
    "启用状态": "处理中-497",
    "命中次数": 1892,
    "更新时间": "2026-05-10 10:36:57"
  },
  {
    "ID": 4,
    "规则编号": "RULE-302497-103-1227",
    "规则名称": "工信部采集策略管理-资产纳管-04-302497",
    "规则类型": "规则策略-边界-302",
    "启用状态": "处理中-497",
    "命中次数": 1004,
    "更新时间": "2026-05-12 11:48:57"
  },
  {
    "ID": 5,
    "规则编号": "RULE-302497-104-5321",
    "规则名称": "工信部采集策略管理-扩容核查-05-302497",
    "规则类型": "规则策略-复核-302",
    "启用状态": "已同步-497",
    "命中次数": 3910,
    "更新时间": "2026-05-25 15:19:27"
  },
  {
    "ID": 6,
    "规则编号": "RULE-302497-105-9583",
    "规则名称": "工信部采集策略管理-数据上报-06-302497",
    "规则类型": "规则策略-自动化-302",
    "启用状态": "已完成-497",
    "命中次数": 3894,
    "更新时间": "2026-05-17 13:22:48"
  },
  {
    "ID": 7,
    "规则编号": "RULE-302497-106-4016",
    "规则名称": "工信部采集策略管理-部侧联动-07-302497",
    "规则类型": "规则策略-边界-302",
    "启用状态": "已同步-497",
    "命中次数": 1687,
    "更新时间": "2026-05-17 11:50:06"
  },
  {
    "ID": 8,
    "规则编号": "RULE-302497-107-9430",
    "规则名称": "工信部采集策略管理-扩容核查-08-302497",
    "规则类型": "规则策略-复核-302",
    "启用状态": "已同步-497",
    "命中次数": 2613,
    "更新时间": "2026-05-18 12:45:40"
  },
  {
    "ID": 9,
    "规则编号": "RULE-302497-108-2060",
    "规则名称": "区公司工信部采集策略管理-扩容核查-09-302497",
    "规则类型": "规则策略-省侧-302",
    "启用状态": "已同步-497",
    "命中次数": 3974,
    "更新时间": "2026-05-23 11:50:33"
  },
  {
    "ID": 10,
    "规则编号": "RULE-302497-109-9308",
    "规则名称": "工信部采集策略管理-资产纳管-10-302497",
    "规则类型": "规则策略-自动化-302",
    "启用状态": "处理中-497",
    "命中次数": 1117,
    "更新时间": "2026-05-08 08:18:05"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "工信部采集策略管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "工信部采集策略管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "工信部采集策略管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "工信部采集策略管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "工信部采集策略管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
