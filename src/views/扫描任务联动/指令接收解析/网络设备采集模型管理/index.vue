    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增网络设备采集模型", "add")'>新增网络设备采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改网络设备采集模型", "edit")'>修改网络设备采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除网络设备采集模型", "delete")'>删除网络设备采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询网络设备采集模型", "add")'>查询网络设备采集模型</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("网络设备采集模型启用/禁用", "add")'>网络设备采集模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("网络设备采集模型运行效果评估", "add")'>网络设备采集模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("网络设备采集模型分析", "add")'>网络设备采集模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("网络设备采集模型分析结果展示", "add")'>网络设备采集模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("网络设备采集模型分析结果下载", "export")'>网络设备采集模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("网络设备采集模型分析结果上报", "add")'>网络设备采集模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-068904-100-6499",
    "规则名称": "网络设备采集模型管理-部侧联动-01-068904",
    "规则类型": "规则策略-自动化-068",
    "启用状态": "已完成-904",
    "命中次数": 442,
    "更新时间": "2026-05-25 16:07:21"
  },
  {
    "ID": 2,
    "规则编号": "RULE-068904-101-2007",
    "规则名称": "网络设备采集模型管理-部侧联动-02-068904",
    "规则类型": "规则策略-边界-068",
    "启用状态": "待复核-904",
    "命中次数": 1129,
    "更新时间": "2026-05-22 09:36:46"
  },
  {
    "ID": 3,
    "规则编号": "RULE-068904-102-2974",
    "规则名称": "区公司网络设备采集模型管理-自动采集-03-068904",
    "规则类型": "规则策略-部侧-068",
    "启用状态": "异常-904",
    "命中次数": 2976,
    "更新时间": "2026-05-19 08:59:31"
  },
  {
    "ID": 4,
    "规则编号": "RULE-068904-103-8160",
    "规则名称": "网络设备采集模型管理-资产纳管-04-068904",
    "规则类型": "规则策略-边界-068",
    "启用状态": "已完成-904",
    "命中次数": 4796,
    "更新时间": "2026-05-25 12:00:25"
  },
  {
    "ID": 5,
    "规则编号": "RULE-068904-104-9354",
    "规则名称": "区公司网络设备采集模型管理-数据上报-05-068904",
    "规则类型": "规则策略-部侧-068",
    "启用状态": "待复核-904",
    "命中次数": 905,
    "更新时间": "2026-05-14 16:38:25"
  },
  {
    "ID": 6,
    "规则编号": "RULE-068904-105-7277",
    "规则名称": "网络设备采集模型管理-扩容核查-06-068904",
    "规则类型": "规则策略-省侧-068",
    "启用状态": "处理中-904",
    "命中次数": 918,
    "更新时间": "2026-05-20 14:35:12"
  },
  {
    "ID": 7,
    "规则编号": "RULE-068904-106-4293",
    "规则名称": "网络设备采集模型管理-部侧联动-07-068904",
    "规则类型": "规则策略-复核-068",
    "启用状态": "待复核-904",
    "命中次数": 2926,
    "更新时间": "2026-05-08 16:55:26"
  },
  {
    "ID": 8,
    "规则编号": "RULE-068904-107-1275",
    "规则名称": "网络设备采集模型管理-自动采集-08-068904",
    "规则类型": "规则策略-边界-068",
    "启用状态": "待复核-904",
    "命中次数": 842,
    "更新时间": "2026-05-23 10:10:39"
  },
  {
    "ID": 9,
    "规则编号": "RULE-068904-108-1530",
    "规则名称": "网络设备采集模型管理-扩容核查-09-068904",
    "规则类型": "规则策略-部侧-068",
    "启用状态": "待处理-904",
    "命中次数": 2744,
    "更新时间": "2026-05-20 17:29:56"
  },
  {
    "ID": 10,
    "规则编号": "RULE-068904-109-9133",
    "规则名称": "区公司网络设备采集模型管理-部侧联动-10-068904",
    "规则类型": "规则策略-复核-068",
    "启用状态": "待处理-904",
    "命中次数": 1011,
    "更新时间": "2026-05-23 08:45:45"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "网络设备采集模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "网络设备采集模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "网络设备采集模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "网络设备采集模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "网络设备采集模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
