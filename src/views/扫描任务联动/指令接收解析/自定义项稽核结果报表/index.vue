    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增自定义项稽核结果信息", "add")'>新增自定义项稽核结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自定义项稽核结果信息", "edit")'>修改自定义项稽核结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除自定义项稽核结果信息", "delete")'>删除自定义项稽核结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看自定义项稽核结果信息", "detail")'>查看自定义项稽核结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果数据提取", "detail")'>自定义项稽核结果数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果数据识别", "detail")'>自定义项稽核结果数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果清洗", "detail")'>自定义项稽核结果清洗</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果分级", "detail")'>自定义项稽核结果分级</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果实时计算", "detail")'>自定义项稽核结果实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果聚合", "detail")'>自定义项稽核结果聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("自定义项稽核结果信息导出", "export")'>自定义项稽核结果信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果可视化展示", "detail")'>自定义项稽核结果可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("自定义项稽核结果数据审查", "detail")'>自定义项稽核结果数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "自定义项稽核结果报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "自定义项稽核结果报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "自定义项稽核结果报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "自定义项稽核结果报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "自定义项稽核结果报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
