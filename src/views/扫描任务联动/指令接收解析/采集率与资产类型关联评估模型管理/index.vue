    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集率与资产类型关联评估模型", "add")'>新增采集率与资产类型关联评估模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集率与资产类型关联评估模型", "edit")'>修改采集率与资产类型关联评估模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集率与资产类型关联评估模型", "delete")'>删除采集率与资产类型关联评估模型</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集率与资产类型关联评估模型", "add")'>查询采集率与资产类型关联评估模型</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集率与资产类型关联评估模型启用/禁用", "add")'>采集率与资产类型关联评估模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集率与资产类型关联评估模型运行效果评估", "add")'>采集率与资产类型关联评估模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集率与资产类型关联评估模型分析", "add")'>采集率与资产类型关联评估模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集率与资产类型关联评估模型分析结果展示", "add")'>采集率与资产类型关联评估模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集率与资产类型关联评估模型分析结果下载", "export")'>采集率与资产类型关联评估模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集率与资产类型关联评估模型分析结果上报", "add")'>采集率与资产类型关联评估模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-387251-100-6408",
    "规则名称": "区公司采集率与资产类型关联评估模型管理-部侧联动-01-387251",
    "规则类型": "规则策略-复核-387",
    "启用状态": "处理中-251",
    "命中次数": 4681,
    "更新时间": "2026-05-24 10:41:24"
  },
  {
    "ID": 2,
    "规则编号": "RULE-387251-101-2931",
    "规则名称": "采集率与资产类型关联评估模型管理-资产纳管-02-387251",
    "规则类型": "规则策略-复核-387",
    "启用状态": "处理中-251",
    "命中次数": 812,
    "更新时间": "2026-05-12 15:39:23"
  },
  {
    "ID": 3,
    "规则编号": "RULE-387251-102-8519",
    "规则名称": "采集率与资产类型关联评估模型管理-异常复核-03-387251",
    "规则类型": "规则策略-部侧-387",
    "启用状态": "待复核-251",
    "命中次数": 4109,
    "更新时间": "2026-05-15 10:08:11"
  },
  {
    "ID": 4,
    "规则编号": "RULE-387251-103-6580",
    "规则名称": "采集率与资产类型关联评估模型管理-资产纳管-04-387251",
    "规则类型": "规则策略-省侧-387",
    "启用状态": "已完成-251",
    "命中次数": 4272,
    "更新时间": "2026-05-14 10:49:42"
  },
  {
    "ID": 5,
    "规则编号": "RULE-387251-104-8926",
    "规则名称": "采集率与资产类型关联评估模型管理-部侧联动-05-387251",
    "规则类型": "规则策略-边界-387",
    "启用状态": "异常-251",
    "命中次数": 3824,
    "更新时间": "2026-05-13 13:24:50"
  },
  {
    "ID": 6,
    "规则编号": "RULE-387251-105-7203",
    "规则名称": "采集率与资产类型关联评估模型管理-资产纳管-06-387251",
    "规则类型": "规则策略-省侧-387",
    "启用状态": "异常-251",
    "命中次数": 221,
    "更新时间": "2026-05-11 11:17:34"
  },
  {
    "ID": 7,
    "规则编号": "RULE-387251-106-4805",
    "规则名称": "采集率与资产类型关联评估模型管理-资产纳管-07-387251",
    "规则类型": "规则策略-复核-387",
    "启用状态": "已完成-251",
    "命中次数": 1739,
    "更新时间": "2026-05-19 17:05:13"
  },
  {
    "ID": 8,
    "规则编号": "RULE-387251-107-9395",
    "规则名称": "采集率与资产类型关联评估模型管理-异常复核-08-387251",
    "规则类型": "规则策略-自动化-387",
    "启用状态": "已完成-251",
    "命中次数": 948,
    "更新时间": "2026-05-15 16:24:45"
  },
  {
    "ID": 9,
    "规则编号": "RULE-387251-108-8157",
    "规则名称": "采集率与资产类型关联评估模型管理-资产纳管-09-387251",
    "规则类型": "规则策略-核心-387",
    "启用状态": "待复核-251",
    "命中次数": 2068,
    "更新时间": "2026-05-17 13:03:44"
  },
  {
    "ID": 10,
    "规则编号": "RULE-387251-109-9122",
    "规则名称": "采集率与资产类型关联评估模型管理-数据上报-10-387251",
    "规则类型": "规则策略-部侧-387",
    "启用状态": "处理中-251",
    "命中次数": 2267,
    "更新时间": "2026-05-24 11:03:54"
  }
];
const tableColumns = [
  {
...
const actionOrdinalMap = {
  ...
  "采集率与资产类型关联评估模型分析结果展示": {
    "actionType": "add",
    "order": 6
  },
  "采集率与资产类型关联评估模型分析结果上报": {
    "actionType": "add",
    "order": 7
  }
};
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集率与资产类型关联评估模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集率与资产类型关联评估模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集率与资产类型关联评估模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集率与资产类型关联评估模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集率与资产类型关联评估模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "采集率与资产类型关联评估模型管理" },
