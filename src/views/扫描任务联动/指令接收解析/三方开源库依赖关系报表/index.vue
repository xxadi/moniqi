    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增三方开源库依赖关系信息", "add")'>新增三方开源库依赖关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改三方开源库依赖关系信息", "edit")'>修改三方开源库依赖关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除三方开源库依赖关系信息", "delete")'>删除三方开源库依赖关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看三方开源库依赖关系信息", "detail")'>查看三方开源库依赖关系信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("三方开源库依赖关系信息导出", "export")'>三方开源库依赖关系信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("三方开源库依赖关系可视化展示", "detail")'>三方开源库依赖关系可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("三方开源库依赖关系数据审查", "detail")'>三方开源库依赖关系数据审查</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("三方开源库依赖关系数据提取", "operation")'>三方开源库依赖关系数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("三方开源库依赖关系数据识别", "analysis")'>三方开源库依赖关系数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("三方开源库依赖关系清洗", "operation")'>三方开源库依赖关系清洗</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("三方开源库依赖关系分级", "operation")'>三方开源库依赖关系分级</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("三方开源库依赖关系实时计算", "operation")'>三方开源库依赖关系实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("三方开源库依赖关系聚合", "operation")'>三方开源库依赖关系聚合</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "报表编号": "RPT-695371-100-4272",
    "报表名称": "三方开源库依赖关系报表-异常复核-01-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-扩容核查-695371-001",
    "生成状态": "已同步-371",
    "生成时间": "2026-05-08 09:47:14",
    "导出次数": 2800
  },
  {
    "ID": 2,
    "报表编号": "RPT-695371-101-2731",
    "报表名称": "三方开源库依赖关系报表-扩容核查-02-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-资产纳管-695371-002",
    "生成状态": "异常-371",
    "生成时间": "2026-05-20 08:19:05",
    "导出次数": 4433
  },
  {
    "ID": 3,
    "报表编号": "RPT-695371-102-8723",
    "报表名称": "三方开源库依赖关系报表-部侧联动-03-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-资产纳管-695371-003",
    "生成状态": "处理中-371",
    "生成时间": "2026-05-15 11:15:13",
    "导出次数": 4360
  },
  {
    "ID": 4,
    "报表编号": "RPT-695371-103-3560",
    "报表名称": "三方开源库依赖关系报表-扩容核查-04-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-资产纳管-695371-004",
    "生成状态": "异常-371",
    "生成时间": "2026-05-24 11:28:23",
    "导出次数": 410
  },
  {
    "ID": 5,
    "报表编号": "RPT-695371-104-3344",
    "报表名称": "三方开源库依赖关系报表-部侧联动-05-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-自动采集-695371-005",
    "生成状态": "已同步-371",
    "生成时间": "2026-05-09 16:37:07",
    "导出次数": 4763
  },
  {
    "ID": 6,
    "报表编号": "RPT-695371-105-3328",
    "报表名称": "三方开源库依赖关系报表-数据上报-06-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-异常复核-695371-006",
    "生成状态": "处理中-371",
    "生成时间": "2026-05-16 08:42:01",
    "导出次数": 3628
  },
  {
    "ID": 7,
    "报表编号": "RPT-695371-106-7143",
    "报表名称": "三方开源库依赖关系报表-自动采集-07-695371",
    "统计周期": "区公司-统计分析-三方开源库依赖关系报表-资产纳管-695371-007",
    "生成状态": "已同步-371",
    "生成时间": "2026-05-10 16:05:50",
    "导出次数": 2522
  },
  {
    "ID": 8,
    "报表编号": "RPT-695371-107-2610",
    "报表名称": "三方开源库依赖关系报表-扩容核查-08-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-异常复核-695371-008",
    "生成状态": "已同步-371",
    "生成时间": "2026-05-14 16:50:16",
    "导出次数": 4306
  },
  {
    "ID": 9,
    "报表编号": "RPT-695371-108-9885",
    "报表名称": "三方开源库依赖关系报表-扩容核查-09-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-异常复核-695371-009",
    "生成状态": "异常-371",
    "生成时间": "2026-05-17 16:23:09",
    "导出次数": 2046
  },
  {
    "ID": 10,
    "报表编号": "RPT-695371-109-6432",
    "报表名称": "三方开源库依赖关系报表-异常复核-10-695371",
    "统计周期": "-统计分析-三方开源库依赖关系报表-扩容核查-695371-010",
    "生成状态": "待处理-371",
    "生成时间": "2026-05-08 12:16:11",
    "导出次数": 164
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "三方开源库依赖关系报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "三方开源库依赖关系报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "三方开源库依赖关系报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "三方开源库依赖关系报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "三方开源库依赖关系报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
