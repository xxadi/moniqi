    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加资产分类结构识别规则", "add")'>添加资产分类结构识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑资产分类结构识别规则", "edit")'>编辑资产分类结构识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产分类结构识别规则", "delete")'>删除资产分类结构识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产分类结构识别规则", "detail")'>查询资产分类结构识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别规则启用/禁用", "analysis")'>资产分类结构识别规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别告警", "analysis")'>资产分类结构识别告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别结果统计", "analysis")'>资产分类结构识别结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别数据提取", "analysis")'>资产分类结构识别数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别规则分析", "analysis")'>资产分类结构识别规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产分类结构识别规则分析结果展示", "detail")'>资产分类结构识别规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产分类结构识别规则分析结果下载", "export")'>资产分类结构识别规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类结构识别规则分析结果上报", "analysis")'>资产分类结构识别规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-313218-100-2354",
    "规则名称": "资产分类结构识别规则管理-部侧联动-01-313218",
    "规则类型": "规则策略-边界-313",
    "启用状态": "已完成-218",
    "命中次数": 3744,
    "更新时间": "2026-05-23 11:51:43"
  },
  {
    "ID": 2,
    "规则编号": "RULE-313218-101-9522",
    "规则名称": "区公司资产分类结构识别规则管理-数据上报-02-313218",
    "规则类型": "规则策略-自动化-313",
    "启用状态": "已同步-218",
    "命中次数": 1227,
    "更新时间": "2026-05-13 09:54:11"
  },
  {
    "ID": 3,
    "规则编号": "RULE-313218-102-4377",
    "规则名称": "资产分类结构识别规则管理-自动采集-03-313218",
    "规则类型": "规则策略-省侧-313",
    "启用状态": "待复核-218",
    "命中次数": 1445,
    "更新时间": "2026-05-18 13:58:55"
  },
  {
    "ID": 4,
    "规则编号": "RULE-313218-103-6295",
    "规则名称": "资产分类结构识别规则管理-自动采集-04-313218",
    "规则类型": "规则策略-核心-313",
    "启用状态": "处理中-218",
    "命中次数": 463,
    "更新时间": "2026-05-25 09:29:19"
  },
  {
    "ID": 5,
    "规则编号": "RULE-313218-104-1082",
    "规则名称": "资产分类结构识别规则管理-资产纳管-05-313218",
    "规则类型": "规则策略-自动化-313",
    "启用状态": "待复核-218",
    "命中次数": 3779,
    "更新时间": "2026-05-18 11:41:42"
  },
  {
    "ID": 6,
    "规则编号": "RULE-313218-105-7841",
    "规则名称": "资产分类结构识别规则管理-部侧联动-06-313218",
    "规则类型": "规则策略-自动化-313",
    "启用状态": "待处理-218",
    "命中次数": 77,
    "更新时间": "2026-05-19 11:49:55"
  },
  {
    "ID": 7,
    "规则编号": "RULE-313218-106-2754",
    "规则名称": "区公司资产分类结构识别规则管理-部侧联动-07-313218",
    "规则类型": "规则策略-复核-313",
    "启用状态": "已完成-218",
    "命中次数": 1536,
    "更新时间": "2026-05-11 13:49:24"
  },
  {
    "ID": 8,
    "规则编号": "RULE-313218-107-3665",
    "规则名称": "资产分类结构识别规则管理-自动采集-08-313218",
    "规则类型": "规则策略-自动化-313",
    "启用状态": "待处理-218",
    "命中次数": 2504,
    "更新时间": "2026-05-25 13:36:32"
  },
  {
    "ID": 9,
    "规则编号": "RULE-313218-108-9397",
    "规则名称": "区公司资产分类结构识别规则管理-部侧联动-09-313218",
    "规则类型": "规则策略-部侧-313",
    "启用状态": "待处理-218",
    "命中次数": 4915,
    "更新时间": "2026-05-13 17:42:41"
  },
  {
    "ID": 10,
    "规则编号": "RULE-313218-109-6630",
    "规则名称": "资产分类结构识别规则管理-资产纳管-10-313218",
    "规则类型": "规则策略-省侧-313",
    "启用状态": "待复核-218",
    "命中次数": 4214,
    "更新时间": "2026-05-17 12:11:15"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产分类结构识别规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产分类结构识别规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产分类结构识别规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产分类结构识别规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产分类结构识别规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
