    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务日志上报接口", "add")'>采集任务日志上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务日志上报数据分析", "add")'>采集任务日志上报数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看采集任务日志上报信息", "add")'>查看采集任务日志上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集任务日志上报数据导出", "export")'>采集任务日志上报数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集任务日志上报信息", "add")'>新增采集任务日志上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("输入采集任务日志上报请求任务", "add")'>输入采集任务日志上报请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("输出采集任务日志上报反馈信息", "add")'>输出采集任务日志上报反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("监控采集任务日志上报状态信息", "add")'>监控采集任务日志上报状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("统计采集任务日志上报调用信息", "add")'>统计采集任务日志上报调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-874000-100-3046",
    "接口名称": "采集任务日志上报接口-资产纳管-01-874000",
    "对接系统": "工信部对接平台-8740",
    "调用状态": "已完成-000",
    "平均耗时": "471ms-00",
    "最近调用": "2026-05-14 13:53:50"
  },
  {
    "ID": 2,
    "接口编号": "API-874000-101-9975",
    "接口名称": "采集任务日志上报接口-异常复核-02-874000",
    "对接系统": "集团资产平台-8740",
    "调用状态": "已同步-000",
    "平均耗时": "427ms-00",
    "最近调用": "2026-05-15 11:19:27"
  },
  {
    "ID": 3,
    "接口编号": "API-874000-102-6025",
    "接口名称": "区公司采集任务日志上报接口-部侧联动-03-874000",
    "对接系统": "工信部对接平台-8740",
    "调用状态": "已同步-000",
    "平均耗时": "659ms-00",
    "最近调用": "2026-05-20 10:58:10"
  },
  {
    "ID": 4,
    "接口编号": "API-874000-103-5813",
    "接口名称": "采集任务日志上报接口-资产纳管-04-874000",
    "对接系统": "工信部对接平台-8740",
    "调用状态": "处理中-000",
    "平均耗时": "641ms-00",
    "最近调用": "2026-05-22 17:37:00"
  },
  {
    "ID": 5,
    "接口编号": "API-874000-104-1327",
    "接口名称": "采集任务日志上报接口-扩容核查-05-874000",
    "对接系统": "CMDB资源库-8740",
    "调用状态": "待处理-000",
    "平均耗时": "233ms-00",
    "最近调用": "2026-05-24 13:03:45"
  },
  {
    "ID": 6,
    "接口编号": "API-874000-105-4776",
    "接口名称": "采集任务日志上报接口-扩容核查-06-874000",
    "对接系统": "集团资产平台-8740",
    "调用状态": "已完成-000",
    "平均耗时": "554ms-00",
    "最近调用": "2026-05-18 14:46:49"
  },
  {
    "ID": 7,
    "接口编号": "API-874000-106-4936",
    "接口名称": "采集任务日志上报接口-部侧联动-07-874000",
    "对接系统": "CMDB资源库-8740",
    "调用状态": "异常-000",
    "平均耗时": "608ms-00",
    "最近调用": "2026-05-11 14:51:36"
  },
  {
    "ID": 8,
    "接口编号": "API-874000-107-7472",
    "接口名称": "采集任务日志上报接口-资产纳管-08-874000",
    "对接系统": "工信部对接平台-8740",
    "调用状态": "处理中-000",
    "平均耗时": "693ms-00",
    "最近调用": "2026-05-18 16:17:07"
  },
  {
    "ID": 9,
    "接口编号": "API-874000-108-6268",
    "接口名称": "采集任务日志上报接口-资产纳管-09-874000",
    "对接系统": "调度中心-8740",
    "调用状态": "已同步-000",
    "平均耗时": "652ms-00",
    "最近调用": "2026-05-12 08:45:20"
  },
  {
    "ID": 10,
    "接口编号": "API-874000-109-1060",
    "接口名称": "区公司采集任务日志上报接口-异常复核-10-874000",
    "对接系统": "调度中心-8740",
    "调用状态": "异常-000",
    "平均耗时": "434ms-00",
    "最近调用": "2026-05-24 13:31:23"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集任务日志上报接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集任务日志上报接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集任务日志上报接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集任务日志上报接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集任务日志上报接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
