    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加扫描器云资源", "add")'>添加扫描器云资源</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描器云资源", "delete")'>删除扫描器云资源</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑扫描器云资源", "edit")'>编辑扫描器云资源</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描器云资源", "detail")'>查询扫描器云资源</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("扫描器云资源启用/禁用", "operation")'>扫描器云资源启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描器云资源运行效果评估", "analysis")'>扫描器云资源运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描器云资源分析", "analysis")'>扫描器云资源分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("扫描器云资源分析结果展示", "detail")'>扫描器云资源分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描器云资源分析结果下载", "export")'>扫描器云资源分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描器云资源分析结果上报", "analysis")'>扫描器云资源分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-735481-100-4280",
    "扫描对象": "扫描器云资源-资产纳管-01-735481",
    "扫描节点": "节点-01-81",
    "资产数量": 1383,
    "异常数量": 4437,
    "扫描状态": "已完成-481"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-735481-101-4765",
    "扫描对象": "扫描器云资源-自动采集-02-735481",
    "扫描节点": "节点-03-81",
    "资产数量": 1125,
    "异常数量": 2768,
    "扫描状态": "已完成-481"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-735481-102-3850",
    "扫描对象": "扫描器云资源-异常复核-03-735481",
    "扫描节点": "节点-02-81",
    "资产数量": 708,
    "异常数量": 644,
    "扫描状态": "异常-481"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-735481-103-2661",
    "扫描对象": "扫描器云资源-资产纳管-04-735481",
    "扫描节点": "节点-01-81",
    "资产数量": 4723,
    "异常数量": 1171,
    "扫描状态": "已完成-481"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-735481-104-5989",
    "扫描对象": "扫描器云资源-资产纳管-05-735481",
    "扫描节点": "节点-04-81",
    "资产数量": 2947,
    "异常数量": 4330,
    "扫描状态": "待复核-481"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-735481-105-7648",
    "扫描对象": "扫描器云资源-自动采集-06-735481",
    "扫描节点": "节点-09-81",
    "资产数量": 3602,
    "异常数量": 1510,
    "扫描状态": "处理中-481"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-735481-106-5495",
    "扫描对象": "扫描器云资源-自动采集-07-735481",
    "扫描节点": "区公司节点-02-81",
    "资产数量": 533,
    "异常数量": 2931,
    "扫描状态": "待复核-481"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-735481-107-9566",
    "扫描对象": "扫描器云资源-部侧联动-08-735481",
    "扫描节点": "区公司节点-05-81",
    "资产数量": 2677,
    "异常数量": 2214,
    "扫描状态": "异常-481"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-735481-108-6432",
    "扫描对象": "扫描器云资源-数据上报-09-735481",
    "扫描节点": "节点-09-81",
    "资产数量": 2982,
    "异常数量": 2574,
    "扫描状态": "待复核-481"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-735481-109-1702",
    "扫描对象": "区公司扫描器云资源-部侧联动-10-735481",
    "扫描节点": "节点-07-81",
    "资产数量": 2615,
    "异常数量": 2323,
    "扫描状态": "处理中-481"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描器云资源导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描器云资源调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描器云资源异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描器云资源业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描器云资源复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
