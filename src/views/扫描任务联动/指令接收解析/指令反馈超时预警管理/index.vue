    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增指令反馈超时预警信息", "add")'>新增指令反馈超时预警信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改指令反馈超时预警信息", "edit")'>修改指令反馈超时预警信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除指令反馈超时预警信息", "delete")'>删除指令反馈超时预警信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询指令反馈超时预警", "detail")'>查询指令反馈超时预警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令反馈超时预警统计", "analysis")'>指令反馈超时预警统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("指令反馈超时预警信息下载", "export")'>指令反馈超时预警信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-662264-100-4442",
    "事件类型": "监控告警-复核-662",
    "事件级别": "高",
    "关联对象": "区公司指令反馈超时预警管理-自动采集-01-662264",
    "发生时间": "2026-05-09 08:02:52",
    "处置状态": "已同步-264"
  },
  {
    "ID": 2,
    "事件编号": "EVT-662264-101-4108",
    "事件类型": "监控告警-边界-662",
    "事件级别": "高",
    "关联对象": "指令反馈超时预警管理-自动采集-02-662264",
    "发生时间": "2026-05-22 12:14:58",
    "处置状态": "已完成-264"
  },
  {
    "ID": 3,
    "事件编号": "EVT-662264-102-2787",
    "事件类型": "监控告警-边界-662",
    "事件级别": "高",
    "关联对象": "指令反馈超时预警管理-部侧联动-03-662264",
    "发生时间": "2026-05-15 10:02:52",
    "处置状态": "已完成-264"
  },
  {
    "ID": 4,
    "事件编号": "EVT-662264-103-6515",
    "事件类型": "监控告警-边界-662",
    "事件级别": "低",
    "关联对象": "指令反馈超时预警管理-扩容核查-04-662264",
    "发生时间": "2026-05-16 08:51:59",
    "处置状态": "待复核-264"
  },
  {
    "ID": 5,
    "事件编号": "EVT-662264-104-5844",
    "事件类型": "监控告警-自动化-662",
    "事件级别": "中",
    "关联对象": "指令反馈超时预警管理-数据上报-05-662264",
    "发生时间": "2026-05-21 10:32:12",
    "处置状态": "处理中-264"
  },
  {
    "ID": 6,
    "事件编号": "EVT-662264-105-2981",
    "事件类型": "监控告警-部侧-662",
    "事件级别": "紧急",
    "关联对象": "指令反馈超时预警管理-自动采集-06-662264",
    "发生时间": "2026-05-22 08:15:56",
    "处置状态": "异常-264"
  },
  {
    "ID": 7,
    "事件编号": "EVT-662264-106-3108",
    "事件类型": "监控告警-边界-662",
    "事件级别": "中",
    "关联对象": "指令反馈超时预警管理-异常复核-07-662264",
    "发生时间": "2026-05-19 09:21:54",
    "处置状态": "已同步-264"
  },
  {
    "ID": 8,
    "事件编号": "EVT-662264-107-1628",
    "事件类型": "监控告警-复核-662",
    "事件级别": "低",
    "关联对象": "指令反馈超时预警管理-异常复核-08-662264",
    "发生时间": "2026-05-11 08:09:44",
    "处置状态": "异常-264"
  },
  {
    "ID": 9,
    "事件编号": "EVT-662264-108-2252",
    "事件类型": "监控告警-省侧-662",
    "事件级别": "中",
    "关联对象": "指令反馈超时预警管理-扩容核查-09-662264",
    "发生时间": "2026-05-09 17:06:39",
    "处置状态": "待处理-264"
  },
  {
    "ID": 10,
    "事件编号": "EVT-662264-109-9311",
    "事件类型": "监控告警-自动化-662",
    "事件级别": "低",
    "关联对象": "指令反馈超时预警管理-部侧联动-10-662264",
    "发生时间": "2026-05-15 17:53:23",
    "处置状态": "已同步-264"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "指令反馈超时预警管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "指令反馈超时预警管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "指令反馈超时预警管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "指令反馈超时预警管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "指令反馈超时预警管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
