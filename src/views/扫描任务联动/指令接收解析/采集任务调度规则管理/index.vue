    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集任务调度规则", "add")'>新增采集任务调度规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集任务调度规则", "delete")'>删除采集任务调度规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集任务调度规则", "edit")'>修改采集任务调度规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集任务调度规则", "add")'>查询采集任务调度规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务调度规则启用/禁用", "add")'>采集任务调度规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务调度规则运行效果评估", "add")'>采集任务调度规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务调度规则分析", "add")'>采集任务调度规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务调度规则分析结果展示", "add")'>采集任务调度规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集任务调度规则分析结果下载", "export")'>采集任务调度规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务调度规则分析结果上报", "add")'>采集任务调度规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-410164-100-7372",
    "规则名称": "采集任务调度规则管理-异常复核-01-410164",
    "规则类型": "规则策略-边界-410",
    "启用状态": "待复核-164",
    "命中次数": 4783,
    "更新时间": "2026-05-15 10:19:44"
  },
  {
    "ID": 2,
    "规则编号": "RULE-410164-101-3055",
    "规则名称": "采集任务调度规则管理-数据上报-02-410164",
    "规则类型": "规则策略-省侧-410",
    "启用状态": "已完成-164",
    "命中次数": 3182,
    "更新时间": "2026-05-08 08:15:32"
  },
  {
    "ID": 3,
    "规则编号": "RULE-410164-102-3620",
    "规则名称": "区公司采集任务调度规则管理-自动采集-03-410164",
    "规则类型": "规则策略-部侧-410",
    "启用状态": "处理中-164",
    "命中次数": 349,
    "更新时间": "2026-05-23 10:12:18"
  },
  {
    "ID": 4,
    "规则编号": "RULE-410164-103-7144",
    "规则名称": "采集任务调度规则管理-数据上报-04-410164",
    "规则类型": "规则策略-自动化-410",
    "启用状态": "已完成-164",
    "命中次数": 330,
    "更新时间": "2026-05-11 09:30:04"
  },
  {
    "ID": 5,
    "规则编号": "RULE-410164-104-3058",
    "规则名称": "区公司采集任务调度规则管理-扩容核查-05-410164",
    "规则类型": "规则策略-边界-410",
    "启用状态": "异常-164",
    "命中次数": 3494,
    "更新时间": "2026-05-18 16:14:47"
  },
  {
    "ID": 6,
    "规则编号": "RULE-410164-105-4797",
    "规则名称": "采集任务调度规则管理-数据上报-06-410164",
    "规则类型": "规则策略-复核-410",
    "启用状态": "已同步-164",
    "命中次数": 1595,
    "更新时间": "2026-05-12 14:29:04"
  },
  {
    "ID": 7,
    "规则编号": "RULE-410164-106-4361",
    "规则名称": "区公司采集任务调度规则管理-异常复核-07-410164",
    "规则类型": "规则策略-部侧-410",
    "启用状态": "待处理-164",
    "命中次数": 3193,
    "更新时间": "2026-05-20 12:04:42"
  },
  {
    "ID": 8,
    "规则编号": "RULE-410164-107-6516",
    "规则名称": "采集任务调度规则管理-异常复核-08-410164",
    "规则类型": "规则策略-自动化-410",
    "启用状态": "待复核-164",
    "命中次数": 1591,
    "更新时间": "2026-05-15 16:23:46"
  },
  {
    "ID": 9,
    "规则编号": "RULE-410164-108-2382",
    "规则名称": "采集任务调度规则管理-数据上报-09-410164",
    "规则类型": "规则策略-部侧-410",
    "启用状态": "异常-164",
    "命中次数": 4994,
    "更新时间": "2026-05-22 14:39:08"
  },
  {
    "ID": 10,
    "规则编号": "RULE-410164-109-3250",
    "规则名称": "采集任务调度规则管理-异常复核-10-410164",
    "规则类型": "规则策略-核心-410",
    "启用状态": "待复核-164",
    "命中次数": 2132,
    "更新时间": "2026-05-22 14:00:40"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集任务调度规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集任务调度规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集任务调度规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集任务调度规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集任务调度规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
