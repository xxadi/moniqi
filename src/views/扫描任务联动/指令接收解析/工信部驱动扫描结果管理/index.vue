    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增工信部驱动扫描结果信息", "add")'>新增工信部驱动扫描结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改工信部驱动扫描结果信息", "edit")'>修改工信部驱动扫描结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除工信部驱动扫描结果信息", "delete")'>删除工信部驱动扫描结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部驱动扫描结果列表", "detail")'>查询工信部驱动扫描结果列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询工信部驱动扫描结果详情", "detail")'>查询工信部驱动扫描结果详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入工信部驱动扫描结果信息", "import")'>批量导入工信部驱动扫描结果信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("工信部驱动扫描结果信息导出", "export")'>工信部驱动扫描结果信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-956373-100-8854",
    "扫描对象": "工信部驱动扫描结果管理-数据上报-01-956373",
    "扫描节点": "区公司节点-06-73",
    "资产数量": 791,
    "异常数量": 2828,
    "扫描状态": "异常-373"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-956373-101-6929",
    "扫描对象": "区公司工信部驱动扫描结果管理-数据上报-02-956373",
    "扫描节点": "节点-09-73",
    "资产数量": 3398,
    "异常数量": 4797,
    "扫描状态": "待处理-373"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-956373-102-5361",
    "扫描对象": "工信部驱动扫描结果管理-异常复核-03-956373",
    "扫描节点": "节点-05-73",
    "资产数量": 1619,
    "异常数量": 3768,
    "扫描状态": "处理中-373"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-956373-103-1716",
    "扫描对象": "工信部驱动扫描结果管理-资产纳管-04-956373",
    "扫描节点": "节点-04-73",
    "资产数量": 2739,
    "异常数量": 2442,
    "扫描状态": "待复核-373"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-956373-104-6059",
    "扫描对象": "工信部驱动扫描结果管理-部侧联动-05-956373",
    "扫描节点": "区公司节点-04-73",
    "资产数量": 1429,
    "异常数量": 2170,
    "扫描状态": "待处理-373"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-956373-105-1350",
    "扫描对象": "工信部驱动扫描结果管理-异常复核-06-956373",
    "扫描节点": "区公司节点-07-73",
    "资产数量": 4979,
    "异常数量": 4459,
    "扫描状态": "异常-373"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-956373-106-9716",
    "扫描对象": "工信部驱动扫描结果管理-扩容核查-07-956373",
    "扫描节点": "节点-06-73",
    "资产数量": 3680,
    "异常数量": 1863,
    "扫描状态": "异常-373"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-956373-107-4554",
    "扫描对象": "工信部驱动扫描结果管理-部侧联动-08-956373",
    "扫描节点": "节点-08-73",
    "资产数量": 1748,
    "异常数量": 5047,
    "扫描状态": "异常-373"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-956373-108-6761",
    "扫描对象": "工信部驱动扫描结果管理-扩容核查-09-956373",
    "扫描节点": "节点-04-73",
    "资产数量": 4946,
    "异常数量": 1367,
    "扫描状态": "异常-373"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-956373-109-7474",
    "扫描对象": "工信部驱动扫描结果管理-数据上报-10-956373",
    "扫描节点": "节点-06-73",
    "资产数量": 3820,
    "异常数量": 2212,
    "扫描状态": "待复核-373"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "工信部驱动扫描结果管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "工信部驱动扫描结果管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "工信部驱动扫描结果管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "工信部驱动扫描结果管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "工信部驱动扫描结果管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
