    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("扫描任务日志上报接口", "operation")'>扫描任务日志上报接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("扫描任务日志上报数据分析", "analysis")'>扫描任务日志上报数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看扫描任务日志上报记录", "detail")'>查看扫描任务日志上报记录</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描任务日志上报数据导出", "export")'>扫描任务日志上报数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增扫描任务日志上报信息", "add")'>新增扫描任务日志上报信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输入扫描任务日志上报请求任务", "operation")'>输入扫描任务日志上报请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输出扫描任务日志上报反馈信息", "operation")'>输出扫描任务日志上报反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控扫描任务日志上报状态信息", "detail")'>监控扫描任务日志上报状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计扫描任务日志上报调用信息", "analysis")'>统计扫描任务日志上报调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-950187-100-3310",
    "接口名称": "扫描任务日志上报接口-自动采集-01-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "处理中-187",
    "平均耗时": "662ms-87",
    "最近调用": "2026-05-15 16:18:59"
  },
  {
    "ID": 2,
    "接口编号": "API-950187-101-9272",
    "接口名称": "扫描任务日志上报接口-资产纳管-02-950187",
    "对接系统": "调度中心-9501",
    "调用状态": "异常-187",
    "平均耗时": "512ms-87",
    "最近调用": "2026-05-25 14:36:14"
  },
  {
    "ID": 3,
    "接口编号": "API-950187-102-9808",
    "接口名称": "扫描任务日志上报接口-异常复核-03-950187",
    "对接系统": "集团资产平台-9501",
    "调用状态": "已同步-187",
    "平均耗时": "200ms-87",
    "最近调用": "2026-05-08 08:40:59"
  },
  {
    "ID": 4,
    "接口编号": "API-950187-103-4188",
    "接口名称": "扫描任务日志上报接口-异常复核-04-950187",
    "对接系统": "CMDB资源库-9501",
    "调用状态": "异常-187",
    "平均耗时": "253ms-87",
    "最近调用": "2026-05-17 15:59:49"
  },
  {
    "ID": 5,
    "接口编号": "API-950187-104-3134",
    "接口名称": "扫描任务日志上报接口-部侧联动-05-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "待复核-187",
    "平均耗时": "421ms-87",
    "最近调用": "2026-05-20 10:56:02"
  },
  {
    "ID": 6,
    "接口编号": "API-950187-105-8686",
    "接口名称": "扫描任务日志上报接口-数据上报-06-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "已同步-187",
    "平均耗时": "252ms-87",
    "最近调用": "2026-05-18 09:13:57"
  },
  {
    "ID": 7,
    "接口编号": "API-950187-106-6958",
    "接口名称": "区公司扫描任务日志上报接口-扩容核查-07-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "已完成-187",
    "平均耗时": "55ms-87",
    "最近调用": "2026-05-10 17:22:01"
  },
  {
    "ID": 8,
    "接口编号": "API-950187-107-6527",
    "接口名称": "扫描任务日志上报接口-异常复核-08-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "已同步-187",
    "平均耗时": "604ms-87",
    "最近调用": "2026-05-24 08:59:23"
  },
  {
    "ID": 9,
    "接口编号": "API-950187-108-3273",
    "接口名称": "扫描任务日志上报接口-扩容核查-09-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "异常-187",
    "平均耗时": "427ms-87",
    "最近调用": "2026-05-14 09:46:22"
  },
  {
    "ID": 10,
    "接口编号": "API-950187-109-8075",
    "接口名称": "扫描任务日志上报接口-数据上报-10-950187",
    "对接系统": "工信部对接平台-9501",
    "调用状态": "已同步-187",
    "平均耗时": "685ms-87",
    "最近调用": "2026-05-22 15:16:57"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描任务日志上报接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描任务日志上报接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描任务日志上报接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描任务日志上报接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描任务日志上报接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
