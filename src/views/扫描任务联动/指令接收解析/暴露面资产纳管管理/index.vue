    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增暴露面资产纳管信息", "add")'>新增暴露面资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改暴露面资产纳管信息", "edit")'>修改暴露面资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除暴露面资产纳管信息", "delete")'>删除暴露面资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询暴露面资产纳管列表", "add")'>查询暴露面资产纳管列表</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询暴露面资产纳管详情", "add")'>查询暴露面资产纳管详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入暴露面资产纳管信息", "import")'>批量导入暴露面资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("暴露面资产纳管信息导出", "export")'>暴露面资产纳管信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-069270-100-7173",
    "资产名称": "暴露面资产纳管管理-部侧联动-01-069270",
    "资产类型": "资产资源-复核-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-异常复核-069270-001",
    "纳管状态": "已完成-270",
    "最近同步": "2026-05-22 10:11:15"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-069270-101-2289",
    "资产名称": "暴露面资产纳管管理-扩容核查-02-069270",
    "资产类型": "资产资源-复核-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-数据上报-069270-002",
    "纳管状态": "待处理-270",
    "最近同步": "2026-05-18 08:43:21"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-069270-102-3718",
    "资产名称": "暴露面资产纳管管理-数据上报-03-069270",
    "资产类型": "资产资源-复核-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-扩容核查-069270-003",
    "纳管状态": "已同步-270",
    "最近同步": "2026-05-08 15:00:19"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-069270-103-1674",
    "资产名称": "暴露面资产纳管管理-部侧联动-04-069270",
    "资产类型": "资产资源-复核-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-扩容核查-069270-004",
    "纳管状态": "已同步-270",
    "最近同步": "2026-05-12 13:32:16"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-069270-104-8593",
    "资产名称": "暴露面资产纳管管理-部侧联动-05-069270",
    "资产类型": "资产资源-省侧-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-资产纳管-069270-005",
    "纳管状态": "异常-270",
    "最近同步": "2026-05-18 11:39:40"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-069270-105-3173",
    "资产名称": "暴露面资产纳管管理-数据上报-06-069270",
    "资产类型": "资产资源-省侧-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-异常复核-069270-006",
    "纳管状态": "待复核-270",
    "最近同步": "2026-05-25 12:05:53"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-069270-106-5316",
    "资产名称": "暴露面资产纳管管理-自动采集-07-069270",
    "资产类型": "资产资源-复核-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-扩容核查-069270-007",
    "纳管状态": "异常-270",
    "最近同步": "2026-05-19 11:43:34"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-069270-107-1999",
    "资产名称": "区公司暴露面资产纳管管理-扩容核查-08-069270",
    "资产类型": "资产资源-部侧-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-资产纳管-069270-008",
    "纳管状态": "异常-270",
    "最近同步": "2026-05-09 14:37:23"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-069270-108-8728",
    "资产名称": "暴露面资产纳管管理-资产纳管-09-069270",
    "资产类型": "资产资源-核心-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-资产纳管-069270-009",
    "纳管状态": "已同步-270",
    "最近同步": "2026-05-19 14:50:08"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-069270-109-7542",
    "资产名称": "暴露面资产纳管管理-异常复核-10-069270",
    "资产类型": "资产资源-部侧-069",
    "所属区域": "-资产资源-暴露面资产纳管管理-数据上报-069270-010",
    "纳管状态": "已完成-270",
    "最近同步": "2026-05-16 10:47:53"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "暴露面资产纳管管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "暴露面资产纳管管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "暴露面资产纳管管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "暴露面资产纳管管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "暴露面资产纳管管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
