    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加外网资产分析模型", "add")'>添加外网资产分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑外网资产分析模型", "edit")'>编辑外网资产分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除外网资产分析模型", "delete")'>删除外网资产分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询外网资产分析模型", "detail")'>查询外网资产分析模型</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("外网资产分析模型启用/禁用", "analysis")'>外网资产分析模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("外网资产分析模型运行效果评估", "analysis")'>外网资产分析模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("外网资产分析模型分析", "analysis")'>外网资产分析模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("外网资产分析模型分析结果展示", "detail")'>外网资产分析模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("外网资产分析模型分析结果下载", "export")'>外网资产分析模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("外网资产分析模型分析结果上报", "analysis")'>外网资产分析模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-002353-100-8588",
    "规则名称": "外网资产分析模型管理-资产纳管-01-002353",
    "规则类型": "规则策略-自动化-002",
    "启用状态": "异常-353",
    "命中次数": 2004,
    "更新时间": "2026-05-19 12:08:07"
  },
  {
    "ID": 2,
    "规则编号": "RULE-002353-101-8892",
    "规则名称": "外网资产分析模型管理-部侧联动-02-002353",
    "规则类型": "规则策略-边界-002",
    "启用状态": "已完成-353",
    "命中次数": 1683,
    "更新时间": "2026-05-08 13:40:22"
  },
  {
    "ID": 3,
    "规则编号": "RULE-002353-102-3202",
    "规则名称": "外网资产分析模型管理-部侧联动-03-002353",
    "规则类型": "规则策略-复核-002",
    "启用状态": "待处理-353",
    "命中次数": 4326,
    "更新时间": "2026-05-23 11:22:05"
  },
  {
    "ID": 4,
    "规则编号": "RULE-002353-103-8531",
    "规则名称": "外网资产分析模型管理-部侧联动-04-002353",
    "规则类型": "规则策略-省侧-002",
    "启用状态": "异常-353",
    "命中次数": 4018,
    "更新时间": "2026-05-08 14:07:44"
  },
  {
    "ID": 5,
    "规则编号": "RULE-002353-104-4048",
    "规则名称": "外网资产分析模型管理-资产纳管-05-002353",
    "规则类型": "规则策略-核心-002",
    "启用状态": "处理中-353",
    "命中次数": 4195,
    "更新时间": "2026-05-20 17:37:36"
  },
  {
    "ID": 6,
    "规则编号": "RULE-002353-105-7521",
    "规则名称": "外网资产分析模型管理-数据上报-06-002353",
    "规则类型": "规则策略-复核-002",
    "启用状态": "已同步-353",
    "命中次数": 312,
    "更新时间": "2026-05-20 09:48:09"
  },
  {
    "ID": 7,
    "规则编号": "RULE-002353-106-9258",
    "规则名称": "区公司外网资产分析模型管理-资产纳管-07-002353",
    "规则类型": "规则策略-部侧-002",
    "启用状态": "已同步-353",
    "命中次数": 3973,
    "更新时间": "2026-05-11 16:10:14"
  },
  {
    "ID": 8,
    "规则编号": "RULE-002353-107-7563",
    "规则名称": "外网资产分析模型管理-自动采集-08-002353",
    "规则类型": "规则策略-复核-002",
    "启用状态": "处理中-353",
    "命中次数": 3760,
    "更新时间": "2026-05-25 09:14:20"
  },
  {
    "ID": 9,
    "规则编号": "RULE-002353-108-7727",
    "规则名称": "外网资产分析模型管理-资产纳管-09-002353",
    "规则类型": "规则策略-省侧-002",
    "启用状态": "待处理-353",
    "命中次数": 431,
    "更新时间": "2026-05-25 10:23:58"
  },
  {
    "ID": 10,
    "规则编号": "RULE-002353-109-3012",
    "规则名称": "外网资产分析模型管理-扩容核查-10-002353",
    "规则类型": "规则策略-部侧-002",
    "启用状态": "已同步-353",
    "命中次数": 3160,
    "更新时间": "2026-05-18 15:29:12"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "外网资产分析模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "外网资产分析模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "外网资产分析模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "外网资产分析模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "外网资产分析模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
