    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP扫描器资源池信息", "add")'>新增IP扫描器资源池信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP扫描器资源池信息", "edit")'>修改IP扫描器资源池信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP扫描器资源池信息", "delete")'>删除IP扫描器资源池信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描器资源池列表", "detail")'>查询IP扫描器资源池列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描器资源池详情", "detail")'>查询IP扫描器资源池详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入IP扫描器资源池信息", "import")'>批量导入IP扫描器资源池信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP扫描器资源池信息导出", "export")'>IP扫描器资源池信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-040116-100-1753",
    "扫描对象": "IP扫描器资源池管理-数据上报-01-040116",
    "扫描节点": "节点-05-16",
    "资产数量": 4910,
    "异常数量": 291,
    "扫描状态": "处理中-116"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-040116-101-3648",
    "扫描对象": "区公司IP扫描器资源池管理-异常复核-02-040116",
    "扫描节点": "节点-06-16",
    "资产数量": 500,
    "异常数量": 4502,
    "扫描状态": "已完成-116"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-040116-102-7063",
    "扫描对象": "区公司IP扫描器资源池管理-部侧联动-03-040116",
    "扫描节点": "节点-07-16",
    "资产数量": 140,
    "异常数量": 51,
    "扫描状态": "待处理-116"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-040116-103-3458",
    "扫描对象": "IP扫描器资源池管理-资产纳管-04-040116",
    "扫描节点": "节点-08-16",
    "资产数量": 4955,
    "异常数量": 2633,
    "扫描状态": "待处理-116"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-040116-104-9641",
    "扫描对象": "IP扫描器资源池管理-部侧联动-05-040116",
    "扫描节点": "节点-03-16",
    "资产数量": 4851,
    "异常数量": 2490,
    "扫描状态": "已同步-116"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-040116-105-4528",
    "扫描对象": "IP扫描器资源池管理-资产纳管-06-040116",
    "扫描节点": "节点-06-16",
    "资产数量": 3450,
    "异常数量": 4626,
    "扫描状态": "异常-116"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-040116-106-2778",
    "扫描对象": "IP扫描器资源池管理-部侧联动-07-040116",
    "扫描节点": "节点-06-16",
    "资产数量": 2552,
    "异常数量": 793,
    "扫描状态": "待复核-116"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-040116-107-6739",
    "扫描对象": "IP扫描器资源池管理-自动采集-08-040116",
    "扫描节点": "区公司节点-08-16",
    "资产数量": 2035,
    "异常数量": 1757,
    "扫描状态": "已完成-116"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-040116-108-6090",
    "扫描对象": "IP扫描器资源池管理-自动采集-09-040116",
    "扫描节点": "节点-04-16",
    "资产数量": 3906,
    "异常数量": 2300,
    "扫描状态": "异常-116"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-040116-109-6449",
    "扫描对象": "IP扫描器资源池管理-异常复核-10-040116",
    "扫描节点": "节点-05-16",
    "资产数量": 691,
    "异常数量": 2497,
    "扫描状态": "待复核-116"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP扫描器资源池管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP扫描器资源池管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP扫描器资源池管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP扫描器资源池管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP扫描器资源池管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
