    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产IP纳管模拟稽核任务", "add")'>新增资产IP纳管模拟稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产IP纳管模拟稽核任务", "delete")'>删除资产IP纳管模拟稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产IP纳管模拟稽核任务", "edit")'>修改资产IP纳管模拟稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询资产IP纳管模拟稽核任务", "add")'>查询资产IP纳管模拟稽核任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核任务启用/禁用", "add")'>资产IP纳管模拟稽核任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核告警", "add")'>资产IP纳管模拟稽核告警</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核结果统计", "add")'>资产IP纳管模拟稽核结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核数据提取", "add")'>资产IP纳管模拟稽核数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核运行分析", "add")'>资产IP纳管模拟稽核运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核分析结果展示", "add")'>资产IP纳管模拟稽核分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产IP纳管模拟稽核分析结果下载", "export")'>资产IP纳管模拟稽核分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("资产IP纳管模拟稽核分析结果上报", "add")'>资产IP纳管模拟稽核分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-945466-100-4271",
    "资产名称": "资产IP纳管模拟稽核任务管理-资产纳管-01-945466",
    "资产类型": "资产资源-部侧-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-异常复核-945466-001",
    "纳管状态": "处理中-466",
    "最近同步": "2026-05-25 13:23:13"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-945466-101-8512",
    "资产名称": "资产IP纳管模拟稽核任务管理-异常复核-02-945466",
    "资产类型": "资产资源-复核-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-异常复核-945466-002",
    "纳管状态": "已同步-466",
    "最近同步": "2026-05-17 13:32:02"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-945466-102-8244",
    "资产名称": "区公司资产IP纳管模拟稽核任务管理-部侧联动-03-945466",
    "资产类型": "资产资源-边界-945",
    "所属区域": "区公司-资产资源-资产IP纳管模拟稽核任务管理-扩容核查-945466-003",
    "纳管状态": "处理中-466",
    "最近同步": "2026-05-14 08:11:39"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-945466-103-2160",
    "资产名称": "区公司资产IP纳管模拟稽核任务管理-自动采集-04-945466",
    "资产类型": "资产资源-核心-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-部侧联动-945466-004",
    "纳管状态": "已完成-466",
    "最近同步": "2026-05-13 09:03:32"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-945466-104-7627",
    "资产名称": "资产IP纳管模拟稽核任务管理-自动采集-05-945466",
    "资产类型": "资产资源-复核-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-扩容核查-945466-005",
    "纳管状态": "待处理-466",
    "最近同步": "2026-05-17 15:24:37"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-945466-105-1558",
    "资产名称": "资产IP纳管模拟稽核任务管理-异常复核-06-945466",
    "资产类型": "资产资源-边界-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-自动采集-945466-006",
    "纳管状态": "待复核-466",
    "最近同步": "2026-05-23 17:53:12"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-945466-106-9712",
    "资产名称": "资产IP纳管模拟稽核任务管理-数据上报-07-945466",
    "资产类型": "资产资源-自动化-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-资产纳管-945466-007",
    "纳管状态": "待复核-466",
    "最近同步": "2026-05-18 16:40:28"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-945466-107-6579",
    "资产名称": "资产IP纳管模拟稽核任务管理-异常复核-08-945466",
    "资产类型": "资产资源-部侧-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-自动采集-945466-008",
    "纳管状态": "已同步-466",
    "最近同步": "2026-05-14 12:28:54"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-945466-108-7441",
    "资产名称": "区公司资产IP纳管模拟稽核任务管理-部侧联动-09-945466",
    "资产类型": "资产资源-核心-945",
    "所属区域": "区公司-资产资源-资产IP纳管模拟稽核任务管理-扩容核查-945466-009",
    "纳管状态": "待处理-466",
    "最近同步": "2026-05-10 14:41:12"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-945466-109-9639",
    "资产名称": "资产IP纳管模拟稽核任务管理-自动采集-10-945466",
    "资产类型": "资产资源-部侧-945",
    "所属区域": "-资产资源-资产IP纳管模拟稽核任务管理-扩容核查-945466-010",
    "纳管状态": "已完成-466",
    "最近同步": "2026-05-10 11:59:42"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产IP纳管模拟稽核任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产IP纳管模拟稽核任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产IP纳管模拟稽核任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产IP纳管模拟稽核任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产IP纳管模拟稽核任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "资产IP纳管模拟稽核任务管理" },
