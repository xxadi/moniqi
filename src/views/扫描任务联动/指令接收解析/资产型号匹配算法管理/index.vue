    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产型号匹配算法信息", "add")'>新增资产型号匹配算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产型号匹配算法信息", "edit")'>修改资产型号匹配算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产型号匹配算法信息", "delete")'>删除资产型号匹配算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产型号匹配算法列表", "detail")'>查询资产型号匹配算法列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产型号匹配算法详情", "detail")'>查询资产型号匹配算法详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入资产型号匹配算法信息", "import")'>批量导入资产型号匹配算法信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产型号匹配算法信息导出", "export")'>资产型号匹配算法信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-169426-100-7360",
    "规则名称": "资产型号匹配算法管理-部侧联动-01-169426",
    "规则类型": "规则策略-省侧-169",
    "启用状态": "待处理-426",
    "命中次数": 793,
    "更新时间": "2026-05-17 13:55:14"
  },
  {
    "ID": 2,
    "规则编号": "RULE-169426-101-2098",
    "规则名称": "资产型号匹配算法管理-自动采集-02-169426",
    "规则类型": "规则策略-部侧-169",
    "启用状态": "处理中-426",
    "命中次数": 4081,
    "更新时间": "2026-05-17 08:01:43"
  },
  {
    "ID": 3,
    "规则编号": "RULE-169426-102-1697",
    "规则名称": "资产型号匹配算法管理-部侧联动-03-169426",
    "规则类型": "规则策略-复核-169",
    "启用状态": "待处理-426",
    "命中次数": 3906,
    "更新时间": "2026-05-10 08:40:35"
  },
  {
    "ID": 4,
    "规则编号": "RULE-169426-103-2026",
    "规则名称": "资产型号匹配算法管理-资产纳管-04-169426",
    "规则类型": "规则策略-核心-169",
    "启用状态": "异常-426",
    "命中次数": 1715,
    "更新时间": "2026-05-10 17:54:10"
  },
  {
    "ID": 5,
    "规则编号": "RULE-169426-104-9761",
    "规则名称": "区公司资产型号匹配算法管理-数据上报-05-169426",
    "规则类型": "规则策略-部侧-169",
    "启用状态": "处理中-426",
    "命中次数": 4397,
    "更新时间": "2026-05-08 12:37:59"
  },
  {
    "ID": 6,
    "规则编号": "RULE-169426-105-2499",
    "规则名称": "资产型号匹配算法管理-部侧联动-06-169426",
    "规则类型": "规则策略-边界-169",
    "启用状态": "待处理-426",
    "命中次数": 4224,
    "更新时间": "2026-05-22 14:52:57"
  },
  {
    "ID": 7,
    "规则编号": "RULE-169426-106-8850",
    "规则名称": "资产型号匹配算法管理-异常复核-07-169426",
    "规则类型": "规则策略-部侧-169",
    "启用状态": "已同步-426",
    "命中次数": 1905,
    "更新时间": "2026-05-22 14:08:47"
  },
  {
    "ID": 8,
    "规则编号": "RULE-169426-107-4239",
    "规则名称": "资产型号匹配算法管理-异常复核-08-169426",
    "规则类型": "规则策略-自动化-169",
    "启用状态": "处理中-426",
    "命中次数": 3412,
    "更新时间": "2026-05-14 16:07:38"
  },
  {
    "ID": 9,
    "规则编号": "RULE-169426-108-9279",
    "规则名称": "资产型号匹配算法管理-自动采集-09-169426",
    "规则类型": "规则策略-核心-169",
    "启用状态": "待处理-426",
    "命中次数": 1899,
    "更新时间": "2026-05-10 12:03:28"
  },
  {
    "ID": 10,
    "规则编号": "RULE-169426-109-1059",
    "规则名称": "资产型号匹配算法管理-数据上报-10-169426",
    "规则类型": "规则策略-省侧-169",
    "启用状态": "异常-426",
    "命中次数": 2970,
    "更新时间": "2026-05-19 08:04:12"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产型号匹配算法管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产型号匹配算法管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产型号匹配算法管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产型号匹配算法管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产型号匹配算法管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
