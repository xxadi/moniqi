    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定义许可证安全监控项", "detail")'>定义许可证安全监控项</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("许可证安全监控项修改", "edit")'>许可证安全监控项修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("许可证安全监控项删除", "delete")'>许可证安全监控项删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询许可证安全", "detail")'>查询许可证安全</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("许可证安全监控信息采集", "add")'>许可证安全监控信息采集</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("许可证安全监控", "detail")'>许可证安全监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("许可证安全监控数据展示", "detail")'>许可证安全监控数据展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("许可证安全告警", "analysis")'>许可证安全告警</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("许可证安全告警导出", "export")'>许可证安全告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-864845-100-8875",
    "资产名称": "许可证安全监控-扩容核查-01-864845",
    "资产类型": "资产资源-部侧-864",
    "所属区域": "-资产资源-许可证安全监控-部侧联动-864845-001",
    "纳管状态": "已完成-845",
    "最近同步": "2026-05-12 13:41:42"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-864845-101-2918",
    "资产名称": "区公司许可证安全监控-数据上报-02-864845",
    "资产类型": "资产资源-省侧-864",
    "所属区域": "-资产资源-许可证安全监控-扩容核查-864845-002",
    "纳管状态": "待处理-845",
    "最近同步": "2026-05-18 10:35:14"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-864845-102-4948",
    "资产名称": "许可证安全监控-异常复核-03-864845",
    "资产类型": "资产资源-复核-864",
    "所属区域": "-资产资源-许可证安全监控-资产纳管-864845-003",
    "纳管状态": "已完成-845",
    "最近同步": "2026-05-08 14:43:49"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-864845-103-4045",
    "资产名称": "许可证安全监控-扩容核查-04-864845",
    "资产类型": "资产资源-自动化-864",
    "所属区域": "-资产资源-许可证安全监控-部侧联动-864845-004",
    "纳管状态": "待复核-845",
    "最近同步": "2026-05-09 08:27:16"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-864845-104-1880",
    "资产名称": "许可证安全监控-异常复核-05-864845",
    "资产类型": "资产资源-部侧-864",
    "所属区域": "-资产资源-许可证安全监控-异常复核-864845-005",
    "纳管状态": "待复核-845",
    "最近同步": "2026-05-24 09:44:42"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-864845-105-3577",
    "资产名称": "区公司许可证安全监控-部侧联动-06-864845",
    "资产类型": "资产资源-核心-864",
    "所属区域": "区公司-资产资源-许可证安全监控-自动采集-864845-006",
    "纳管状态": "已同步-845",
    "最近同步": "2026-05-23 10:55:22"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-864845-106-9969",
    "资产名称": "许可证安全监控-资产纳管-07-864845",
    "资产类型": "资产资源-边界-864",
    "所属区域": "-资产资源-许可证安全监控-扩容核查-864845-007",
    "纳管状态": "已完成-845",
    "最近同步": "2026-05-14 15:12:56"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-864845-107-9912",
    "资产名称": "许可证安全监控-扩容核查-08-864845",
    "资产类型": "资产资源-核心-864",
    "所属区域": "-资产资源-许可证安全监控-资产纳管-864845-008",
    "纳管状态": "已同步-845",
    "最近同步": "2026-05-19 14:47:44"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-864845-108-3802",
    "资产名称": "许可证安全监控-资产纳管-09-864845",
    "资产类型": "资产资源-边界-864",
    "所属区域": "-资产资源-许可证安全监控-部侧联动-864845-009",
    "纳管状态": "处理中-845",
    "最近同步": "2026-05-25 16:02:08"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-864845-109-4716",
    "资产名称": "许可证安全监控-部侧联动-10-864845",
    "资产类型": "资产资源-部侧-864",
    "所属区域": "-资产资源-许可证安全监控-部侧联动-864845-010",
    "纳管状态": "处理中-845",
    "最近同步": "2026-05-15 16:04:41"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "许可证安全监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "许可证安全监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "许可证安全监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "许可证安全监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "许可证安全监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
