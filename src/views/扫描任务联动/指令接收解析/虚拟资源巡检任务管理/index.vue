    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源巡检任务", "add")'>新增虚拟资源巡检任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源巡检任务", "delete")'>删除虚拟资源巡检任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源巡检任务", "edit")'>修改虚拟资源巡检任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源巡检任务", "detail")'>查询虚拟资源巡检任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源巡检任务启用/禁用", "operation")'>虚拟资源巡检任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源巡检监控告警", "detail")'>虚拟资源巡检监控告警</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源巡检结果统计", "analysis")'>虚拟资源巡检结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资源巡检数据提取", "operation")'>虚拟资源巡检数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资源巡检运行分析", "analysis")'>虚拟资源巡检运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资源巡检分析结果展示", "detail")'>虚拟资源巡检分析结果展示</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-406973-100-6599",
    "资产名称": "虚拟资源巡检任务管理-资产纳管-01-406973",
    "资产类型": "资产资源-自动化-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-异常复核-406973-001",
    "纳管状态": "异常-973",
    "最近同步": "2026-05-16 16:25:52"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-406973-101-1251",
    "资产名称": "虚拟资源巡检任务管理-部侧联动-02-406973",
    "资产类型": "资产资源-边界-406",
    "所属区域": "区公司-资产资源-虚拟资源巡检任务管理-资产纳管-406973-002",
    "纳管状态": "处理中-973",
    "最近同步": "2026-05-16 10:51:52"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-406973-102-4345",
    "资产名称": "虚拟资源巡检任务管理-部侧联动-03-406973",
    "资产类型": "资产资源-边界-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-扩容核查-406973-003",
    "纳管状态": "待处理-973",
    "最近同步": "2026-05-14 15:22:57"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-406973-103-7145",
    "资产名称": "虚拟资源巡检任务管理-资产纳管-04-406973",
    "资产类型": "资产资源-部侧-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-数据上报-406973-004",
    "纳管状态": "处理中-973",
    "最近同步": "2026-05-21 09:29:28"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-406973-104-5002",
    "资产名称": "虚拟资源巡检任务管理-异常复核-05-406973",
    "资产类型": "资产资源-核心-406",
    "所属区域": "区公司-资产资源-虚拟资源巡检任务管理-数据上报-406973-005",
    "纳管状态": "处理中-973",
    "最近同步": "2026-05-13 14:17:51"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-406973-105-1247",
    "资产名称": "虚拟资源巡检任务管理-数据上报-06-406973",
    "资产类型": "资产资源-核心-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-自动采集-406973-006",
    "纳管状态": "已同步-973",
    "最近同步": "2026-05-23 15:36:19"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-406973-106-7258",
    "资产名称": "区公司虚拟资源巡检任务管理-部侧联动-07-406973",
    "资产类型": "资产资源-边界-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-数据上报-406973-007",
    "纳管状态": "处理中-973",
    "最近同步": "2026-05-17 15:15:51"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-406973-107-3956",
    "资产名称": "虚拟资源巡检任务管理-扩容核查-08-406973",
    "资产类型": "资产资源-核心-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-异常复核-406973-008",
    "纳管状态": "待复核-973",
    "最近同步": "2026-05-24 10:17:18"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-406973-108-9472",
    "资产名称": "虚拟资源巡检任务管理-异常复核-09-406973",
    "资产类型": "资产资源-省侧-406",
    "所属区域": "区公司-资产资源-虚拟资源巡检任务管理-扩容核查-406973-009",
    "纳管状态": "待处理-973",
    "最近同步": "2026-05-18 10:40:03"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-406973-109-8190",
    "资产名称": "虚拟资源巡检任务管理-资产纳管-10-406973",
    "资产类型": "资产资源-部侧-406",
    "所属区域": "-资产资源-虚拟资源巡检任务管理-数据上报-406973-010",
    "纳管状态": "已完成-973",
    "最近同步": "2026-05-24 09:50:52"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源巡检任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源巡检任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源巡检任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源巡检任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源巡检任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
