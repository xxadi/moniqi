    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP段扫描规则", "add")'>新增IP段扫描规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP段扫描规则", "edit")'>修改IP段扫描规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP段扫描规则", "delete")'>删除IP段扫描规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP段扫描规则", "detail")'>查询IP段扫描规则</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP段扫描规则启用/禁用", "operation")'>IP段扫描规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP段扫描规则运行效果评估", "analysis")'>IP段扫描规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP段扫描规则分析", "analysis")'>IP段扫描规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP段扫描规则分析结果展示", "detail")'>IP段扫描规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP段扫描规则分析结果下载", "export")'>IP段扫描规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP段扫描规则分析结果上报", "analysis")'>IP段扫描规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-043750-100-2617",
    "规则名称": "IP段扫描规则管理-资产纳管-01-043750",
    "规则类型": "规则策略-核心-043",
    "启用状态": "待处理-750",
    "命中次数": 4379,
    "更新时间": "2026-05-20 11:48:12"
  },
  {
    "ID": 2,
    "规则编号": "RULE-043750-101-1180",
    "规则名称": "IP段扫描规则管理-部侧联动-02-043750",
    "规则类型": "规则策略-边界-043",
    "启用状态": "处理中-750",
    "命中次数": 2070,
    "更新时间": "2026-05-13 10:10:05"
  },
  {
    "ID": 3,
    "规则编号": "RULE-043750-102-5786",
    "规则名称": "IP段扫描规则管理-部侧联动-03-043750",
    "规则类型": "规则策略-核心-043",
    "启用状态": "异常-750",
    "命中次数": 716,
    "更新时间": "2026-05-21 11:33:25"
  },
  {
    "ID": 4,
    "规则编号": "RULE-043750-103-2369",
    "规则名称": "IP段扫描规则管理-资产纳管-04-043750",
    "规则类型": "规则策略-复核-043",
    "启用状态": "待复核-750",
    "命中次数": 3839,
    "更新时间": "2026-05-19 14:29:01"
  },
  {
    "ID": 5,
    "规则编号": "RULE-043750-104-6093",
    "规则名称": "IP段扫描规则管理-资产纳管-05-043750",
    "规则类型": "规则策略-核心-043",
    "启用状态": "待复核-750",
    "命中次数": 2462,
    "更新时间": "2026-05-19 10:48:52"
  },
  {
    "ID": 6,
    "规则编号": "RULE-043750-105-8930",
    "规则名称": "IP段扫描规则管理-部侧联动-06-043750",
    "规则类型": "规则策略-省侧-043",
    "启用状态": "处理中-750",
    "命中次数": 4883,
    "更新时间": "2026-05-17 10:21:22"
  },
  {
    "ID": 7,
    "规则编号": "RULE-043750-106-7073",
    "规则名称": "IP段扫描规则管理-自动采集-07-043750",
    "规则类型": "规则策略-省侧-043",
    "启用状态": "已完成-750",
    "命中次数": 1529,
    "更新时间": "2026-05-14 13:01:08"
  },
  {
    "ID": 8,
    "规则编号": "RULE-043750-107-6392",
    "规则名称": "IP段扫描规则管理-异常复核-08-043750",
    "规则类型": "规则策略-核心-043",
    "启用状态": "处理中-750",
    "命中次数": 51,
    "更新时间": "2026-05-08 13:58:08"
  },
  {
    "ID": 9,
    "规则编号": "RULE-043750-108-5927",
    "规则名称": "IP段扫描规则管理-异常复核-09-043750",
    "规则类型": "规则策略-边界-043",
    "启用状态": "待处理-750",
    "命中次数": 3092,
    "更新时间": "2026-05-16 14:59:29"
  },
  {
    "ID": 10,
    "规则编号": "RULE-043750-109-5389",
    "规则名称": "IP段扫描规则管理-异常复核-10-043750",
    "规则类型": "规则策略-边界-043",
    "启用状态": "已完成-750",
    "命中次数": 1628,
    "更新时间": "2026-05-24 14:36:10"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP段扫描规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP段扫描规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP段扫描规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP段扫描规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP段扫描规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
