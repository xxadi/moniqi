    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("定义缺陷问题监控项", "detail")'>定义缺陷问题监控项</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("缺陷问题监控项修改", "edit")'>缺陷问题监控项修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("缺陷问题监控项删除", "delete")'>缺陷问题监控项删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询缺陷问题", "detail")'>查询缺陷问题</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("缺陷问题监控信息采集", "add")'>缺陷问题监控信息采集</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("缺陷问题监控", "detail")'>缺陷问题监控</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("缺陷问题监控数据展示", "detail")'>缺陷问题监控数据展示</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("缺陷问题告警", "analysis")'>缺陷问题告警</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("缺陷问题告警导出", "export")'>缺陷问题告警导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "事件编号": "EVT-537945-100-6065",
    "事件类型": "监控告警-部侧-537",
    "事件级别": "中",
    "关联对象": "区公司缺陷问题监控-数据上报-01-537945",
    "发生时间": "2026-05-09 09:09:02",
    "处置状态": "处理中-945"
  },
  {
    "ID": 2,
    "事件编号": "EVT-537945-101-3791",
    "事件类型": "监控告警-省侧-537",
    "事件级别": "中",
    "关联对象": "缺陷问题监控-资产纳管-02-537945",
    "发生时间": "2026-05-20 10:14:16",
    "处置状态": "已同步-945"
  },
  {
    "ID": 3,
    "事件编号": "EVT-537945-102-8490",
    "事件类型": "监控告警-复核-537",
    "事件级别": "紧急",
    "关联对象": "缺陷问题监控-资产纳管-03-537945",
    "发生时间": "2026-05-15 11:04:51",
    "处置状态": "处理中-945"
  },
  {
    "ID": 4,
    "事件编号": "EVT-537945-103-2290",
    "事件类型": "监控告警-边界-537",
    "事件级别": "低",
    "关联对象": "缺陷问题监控-数据上报-04-537945",
    "发生时间": "2026-05-21 17:46:45",
    "处置状态": "已同步-945"
  },
  {
    "ID": 5,
    "事件编号": "EVT-537945-104-8306",
    "事件类型": "监控告警-省侧-537",
    "事件级别": "中",
    "关联对象": "缺陷问题监控-扩容核查-05-537945",
    "发生时间": "2026-05-13 12:14:45",
    "处置状态": "已完成-945"
  },
  {
    "ID": 6,
    "事件编号": "EVT-537945-105-8325",
    "事件类型": "监控告警-省侧-537",
    "事件级别": "高",
    "关联对象": "区公司缺陷问题监控-资产纳管-06-537945",
    "发生时间": "2026-05-23 16:33:13",
    "处置状态": "异常-945"
  },
  {
    "ID": 7,
    "事件编号": "EVT-537945-106-7470",
    "事件类型": "监控告警-部侧-537",
    "事件级别": "中",
    "关联对象": "缺陷问题监控-资产纳管-07-537945",
    "发生时间": "2026-05-21 16:43:36",
    "处置状态": "异常-945"
  },
  {
    "ID": 8,
    "事件编号": "EVT-537945-107-6639",
    "事件类型": "监控告警-核心-537",
    "事件级别": "中",
    "关联对象": "缺陷问题监控-异常复核-08-537945",
    "发生时间": "2026-05-21 09:56:28",
    "处置状态": "待处理-945"
  },
  {
    "ID": 9,
    "事件编号": "EVT-537945-108-4294",
    "事件类型": "监控告警-自动化-537",
    "事件级别": "中",
    "关联对象": "缺陷问题监控-数据上报-09-537945",
    "发生时间": "2026-05-17 16:11:07",
    "处置状态": "已同步-945"
  },
  {
    "ID": 10,
    "事件编号": "EVT-537945-109-2149",
    "事件类型": "监控告警-复核-537",
    "事件级别": "一般",
    "关联对象": "缺陷问题监控-扩容核查-10-537945",
    "发生时间": "2026-05-12 09:07:47",
    "处置状态": "已同步-945"
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "缺陷问题监控导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "缺陷问题监控调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "缺陷问题监控异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "缺陷问题监控业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "缺陷问题监控复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
