    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加依赖智能推荐模型", "add")'>添加依赖智能推荐模型</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑依赖智能推荐模型", "edit")'>编辑依赖智能推荐模型</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除依赖智能推荐模型", "delete")'>删除依赖智能推荐模型</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询依赖智能推荐模型", "detail")'>查询依赖智能推荐模型</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("依赖智能推荐模型启用/禁用", "operation")'>依赖智能推荐模型启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("依赖智能推荐模型运行效果评估", "analysis")'>依赖智能推荐模型运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("依赖智能推荐模型分析", "analysis")'>依赖智能推荐模型分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("依赖智能推荐模型分析结果展示", "detail")'>依赖智能推荐模型分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("依赖智能推荐模型分析结果下载", "export")'>依赖智能推荐模型分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("依赖智能推荐模型分析结果上报", "analysis")'>依赖智能推荐模型分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-045193-100-5356",
    "规则名称": "依赖智能推荐模型管理-扩容核查-01-045193",
    "规则类型": "规则策略-部侧-045",
    "启用状态": "已同步-193",
    "命中次数": 2455,
    "更新时间": "2026-05-17 16:20:09"
  },
  {
    "ID": 2,
    "规则编号": "RULE-045193-101-9949",
    "规则名称": "依赖智能推荐模型管理-自动采集-02-045193",
    "规则类型": "规则策略-自动化-045",
    "启用状态": "待处理-193",
    "命中次数": 2666,
    "更新时间": "2026-05-14 15:24:26"
  },
  {
    "ID": 3,
    "规则编号": "RULE-045193-102-7698",
    "规则名称": "依赖智能推荐模型管理-资产纳管-03-045193",
    "规则类型": "规则策略-部侧-045",
    "启用状态": "待处理-193",
    "命中次数": 801,
    "更新时间": "2026-05-22 14:30:09"
  },
  {
    "ID": 4,
    "规则编号": "RULE-045193-103-4290",
    "规则名称": "区公司依赖智能推荐模型管理-扩容核查-04-045193",
    "规则类型": "规则策略-自动化-045",
    "启用状态": "已同步-193",
    "命中次数": 3675,
    "更新时间": "2026-05-10 17:02:48"
  },
  {
    "ID": 5,
    "规则编号": "RULE-045193-104-8518",
    "规则名称": "区公司依赖智能推荐模型管理-资产纳管-05-045193",
    "规则类型": "规则策略-省侧-045",
    "启用状态": "已同步-193",
    "命中次数": 3589,
    "更新时间": "2026-05-18 13:39:20"
  },
  {
    "ID": 6,
    "规则编号": "RULE-045193-105-7980",
    "规则名称": "依赖智能推荐模型管理-部侧联动-06-045193",
    "规则类型": "规则策略-自动化-045",
    "启用状态": "待处理-193",
    "命中次数": 4778,
    "更新时间": "2026-05-13 10:39:29"
  },
  {
    "ID": 7,
    "规则编号": "RULE-045193-106-3736",
    "规则名称": "依赖智能推荐模型管理-异常复核-07-045193",
    "规则类型": "规则策略-边界-045",
    "启用状态": "待处理-193",
    "命中次数": 551,
    "更新时间": "2026-05-21 08:43:14"
  },
  {
    "ID": 8,
    "规则编号": "RULE-045193-107-8534",
    "规则名称": "依赖智能推荐模型管理-扩容核查-08-045193",
    "规则类型": "规则策略-复核-045",
    "启用状态": "已同步-193",
    "命中次数": 1910,
    "更新时间": "2026-05-08 16:06:18"
  },
  {
    "ID": 9,
    "规则编号": "RULE-045193-108-5640",
    "规则名称": "依赖智能推荐模型管理-自动采集-09-045193",
    "规则类型": "规则策略-自动化-045",
    "启用状态": "已完成-193",
    "命中次数": 1373,
    "更新时间": "2026-05-22 11:27:10"
  },
  {
    "ID": 10,
    "规则编号": "RULE-045193-109-3501",
    "规则名称": "依赖智能推荐模型管理-异常复核-10-045193",
    "规则类型": "规则策略-边界-045",
    "启用状态": "处理中-193",
    "命中次数": 1425,
    "更新时间": "2026-05-13 17:11:34"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "依赖智能推荐模型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "依赖智能推荐模型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "依赖智能推荐模型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "依赖智能推荐模型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "依赖智能推荐模型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
