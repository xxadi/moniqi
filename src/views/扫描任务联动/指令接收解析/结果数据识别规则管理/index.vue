    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增结果数据识别规则", "add")'>新增结果数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改结果数据识别规则", "edit")'>修改结果数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除结果数据识别规则", "delete")'>删除结果数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询结果数据识别规则", "detail")'>查询结果数据识别规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("结果数据识别规则启用/禁用", "analysis")'>结果数据识别规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("结果数据识别规则运行效果评估", "analysis")'>结果数据识别规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("结果数据识别规则分析", "analysis")'>结果数据识别规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("结果数据识别规则分析结果展示", "detail")'>结果数据识别规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("结果数据识别规则分析结果下载", "export")'>结果数据识别规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("结果数据识别规则分析结果上报", "analysis")'>结果数据识别规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-220782-100-3709",
    "规则名称": "区公司结果数据识别规则管理-异常复核-01-220782",
    "规则类型": "规则策略-部侧-220",
    "启用状态": "待处理-782",
    "命中次数": 199,
    "更新时间": "2026-05-14 13:16:16"
  },
  {
    "ID": 2,
    "规则编号": "RULE-220782-101-2632",
    "规则名称": "结果数据识别规则管理-数据上报-02-220782",
    "规则类型": "规则策略-核心-220",
    "启用状态": "待复核-782",
    "命中次数": 2928,
    "更新时间": "2026-05-19 17:01:26"
  },
  {
    "ID": 3,
    "规则编号": "RULE-220782-102-2089",
    "规则名称": "区公司结果数据识别规则管理-资产纳管-03-220782",
    "规则类型": "规则策略-部侧-220",
    "启用状态": "异常-782",
    "命中次数": 4995,
    "更新时间": "2026-05-23 13:50:09"
  },
  {
    "ID": 4,
    "规则编号": "RULE-220782-103-3095",
    "规则名称": "结果数据识别规则管理-自动采集-04-220782",
    "规则类型": "规则策略-部侧-220",
    "启用状态": "已同步-782",
    "命中次数": 3779,
    "更新时间": "2026-05-25 17:59:42"
  },
  {
    "ID": 5,
    "规则编号": "RULE-220782-104-5162",
    "规则名称": "结果数据识别规则管理-扩容核查-05-220782",
    "规则类型": "规则策略-复核-220",
    "启用状态": "待复核-782",
    "命中次数": 1052,
    "更新时间": "2026-05-12 08:15:18"
  },
  {
    "ID": 6,
    "规则编号": "RULE-220782-105-4241",
    "规则名称": "区公司结果数据识别规则管理-数据上报-06-220782",
    "规则类型": "规则策略-核心-220",
    "启用状态": "异常-782",
    "命中次数": 193,
    "更新时间": "2026-05-21 10:05:10"
  },
  {
    "ID": 7,
    "规则编号": "RULE-220782-106-2787",
    "规则名称": "结果数据识别规则管理-资产纳管-07-220782",
    "规则类型": "规则策略-复核-220",
    "启用状态": "待复核-782",
    "命中次数": 1043,
    "更新时间": "2026-05-16 13:26:05"
  },
  {
    "ID": 8,
    "规则编号": "RULE-220782-107-4827",
    "规则名称": "区公司结果数据识别规则管理-数据上报-08-220782",
    "规则类型": "规则策略-边界-220",
    "启用状态": "已完成-782",
    "命中次数": 209,
    "更新时间": "2026-05-24 11:48:51"
  },
  {
    "ID": 9,
    "规则编号": "RULE-220782-108-4550",
    "规则名称": "结果数据识别规则管理-扩容核查-09-220782",
    "规则类型": "规则策略-核心-220",
    "启用状态": "已同步-782",
    "命中次数": 770,
    "更新时间": "2026-05-24 13:24:04"
  },
  {
    "ID": 10,
    "规则编号": "RULE-220782-109-8598",
    "规则名称": "区公司结果数据识别规则管理-异常复核-10-220782",
    "规则类型": "规则策略-部侧-220",
    "启用状态": "处理中-782",
    "命中次数": 3501,
    "更新时间": "2026-05-20 13:59:52"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "结果数据识别规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "结果数据识别规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "结果数据识别规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "结果数据识别规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "结果数据识别规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
