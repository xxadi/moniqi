    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IPv4扫描器调度任务信息", "add")'>新增IPv4扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IPv4扫描器调度任务信息", "edit")'>修改IPv4扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IPv4扫描器调度任务信息", "delete")'>删除IPv4扫描器调度任务信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IPv4扫描器调度任务", "detail")'>查询IPv4扫描器调度任务</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IPv4扫描器调度任务统计", "analysis")'>IPv4扫描器调度任务统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IPv4扫描器调度任务信息下载", "export")'>IPv4扫描器调度任务信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-368717-100-4755",
    "扫描对象": "区公司IPv4扫描器调度任务管理-资产纳管-01-368717",
    "扫描节点": "区公司节点-01-17",
    "资产数量": 3683,
    "异常数量": 2159,
    "扫描状态": "处理中-717"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-368717-101-3551",
    "扫描对象": "区公司IPv4扫描器调度任务管理-扩容核查-02-368717",
    "扫描节点": "节点-09-17",
    "资产数量": 2237,
    "异常数量": 4411,
    "扫描状态": "处理中-717"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-368717-102-3783",
    "扫描对象": "IPv4扫描器调度任务管理-自动采集-03-368717",
    "扫描节点": "节点-07-17",
    "资产数量": 3489,
    "异常数量": 3513,
    "扫描状态": "异常-717"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-368717-103-9298",
    "扫描对象": "IPv4扫描器调度任务管理-自动采集-04-368717",
    "扫描节点": "节点-06-17",
    "资产数量": 3889,
    "异常数量": 3835,
    "扫描状态": "处理中-717"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-368717-104-9276",
    "扫描对象": "IPv4扫描器调度任务管理-异常复核-05-368717",
    "扫描节点": "节点-06-17",
    "资产数量": 2211,
    "异常数量": 4468,
    "扫描状态": "已同步-717"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-368717-105-6338",
    "扫描对象": "IPv4扫描器调度任务管理-资产纳管-06-368717",
    "扫描节点": "节点-07-17",
    "资产数量": 531,
    "异常数量": 3009,
    "扫描状态": "已完成-717"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-368717-106-6096",
    "扫描对象": "IPv4扫描器调度任务管理-资产纳管-07-368717",
    "扫描节点": "节点-05-17",
    "资产数量": 4915,
    "异常数量": 919,
    "扫描状态": "待处理-717"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-368717-107-4097",
    "扫描对象": "IPv4扫描器调度任务管理-异常复核-08-368717",
    "扫描节点": "节点-05-17",
    "资产数量": 2844,
    "异常数量": 1575,
    "扫描状态": "异常-717"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-368717-108-9282",
    "扫描对象": "IPv4扫描器调度任务管理-数据上报-09-368717",
    "扫描节点": "节点-01-17",
    "资产数量": 3465,
    "异常数量": 732,
    "扫描状态": "待复核-717"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-368717-109-5391",
    "扫描对象": "IPv4扫描器调度任务管理-数据上报-10-368717",
    "扫描节点": "节点-02-17",
    "资产数量": 4165,
    "异常数量": 192,
    "扫描状态": "处理中-717"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IPv4扫描器调度任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IPv4扫描器调度任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IPv4扫描器调度任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IPv4扫描器调度任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IPv4扫描器调度任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "三级模块", value: "IPv4扫描器调度任务管理" },
