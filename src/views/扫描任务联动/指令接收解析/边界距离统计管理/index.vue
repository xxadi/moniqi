    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("边界距离统计", "analysis")'>边界距离统计</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改边界距离统计结果", "edit")'>修改边界距离统计结果</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除边界距离统计结果", "delete")'>删除边界距离统计结果</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询边界距离统计结果列表", "detail")'>查询边界距离统计结果列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询边界距离统计结果详情", "detail")'>查询边界距离统计结果详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入边界距离统计结果", "import")'>批量导入边界距离统计结果</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("边界距离统计结果导出", "export")'>边界距离统计结果导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "报表编号": "RPT-156766-100-1555",
    "报表名称": "边界距离统计管理-异常复核-01-156766",
    "统计周期": "-统计分析-边界距离统计管理-部侧联动-156766-001",
    "生成状态": "待处理-766",
    "生成时间": "2026-05-17 11:15:56",
    "导出次数": 631
  },
  {
    "ID": 2,
    "报表编号": "RPT-156766-101-7339",
    "报表名称": "边界距离统计管理-数据上报-02-156766",
    "统计周期": "区公司-统计分析-边界距离统计管理-异常复核-156766-002",
    "生成状态": "处理中-766",
    "生成时间": "2026-05-12 13:23:51",
    "导出次数": 4036
  },
  {
    "ID": 3,
    "报表编号": "RPT-156766-102-7891",
    "报表名称": "边界距离统计管理-扩容核查-03-156766",
    "统计周期": "-统计分析-边界距离统计管理-部侧联动-156766-003",
    "生成状态": "异常-766",
    "生成时间": "2026-05-21 09:04:06",
    "导出次数": 4706
  },
  {
    "ID": 4,
    "报表编号": "RPT-156766-103-9610",
    "报表名称": "区公司边界距离统计管理-扩容核查-04-156766",
    "统计周期": "-统计分析-边界距离统计管理-扩容核查-156766-004",
    "生成状态": "已完成-766",
    "生成时间": "2026-05-14 11:12:31",
    "导出次数": 5037
  },
  {
    "ID": 5,
    "报表编号": "RPT-156766-104-5347",
    "报表名称": "区公司边界距离统计管理-部侧联动-05-156766",
    "统计周期": "-统计分析-边界距离统计管理-自动采集-156766-005",
    "生成状态": "待处理-766",
    "生成时间": "2026-05-14 08:39:22",
    "导出次数": 339
  },
  {
    "ID": 6,
    "报表编号": "RPT-156766-105-6583",
    "报表名称": "区公司边界距离统计管理-自动采集-06-156766",
    "统计周期": "-统计分析-边界距离统计管理-数据上报-156766-006",
    "生成状态": "待复核-766",
    "生成时间": "2026-05-24 13:54:31",
    "导出次数": 1657
  },
  {
    "ID": 7,
    "报表编号": "RPT-156766-106-8803",
    "报表名称": "边界距离统计管理-异常复核-07-156766",
    "统计周期": "-统计分析-边界距离统计管理-异常复核-156766-007",
    "生成状态": "已同步-766",
    "生成时间": "2026-05-19 17:36:57",
    "导出次数": 595
  },
  {
    "ID": 8,
    "报表编号": "RPT-156766-107-4236",
    "报表名称": "边界距离统计管理-扩容核查-08-156766",
    "统计周期": "-统计分析-边界距离统计管理-异常复核-156766-008",
    "生成状态": "已同步-766",
    "生成时间": "2026-05-10 16:59:12",
    "导出次数": 1701
  },
  {
    "ID": 9,
    "报表编号": "RPT-156766-108-1595",
    "报表名称": "边界距离统计管理-异常复核-09-156766",
    "统计周期": "-统计分析-边界距离统计管理-异常复核-156766-009",
    "生成状态": "待处理-766",
    "生成时间": "2026-05-11 10:38:42",
    "导出次数": 4348
  },
  {
    "ID": 10,
    "报表编号": "RPT-156766-109-8923",
    "报表名称": "边界距离统计管理-自动采集-10-156766",
    "统计周期": "-统计分析-边界距离统计管理-部侧联动-156766-010",
    "生成状态": "处理中-766",
    "生成时间": "2026-05-11 13:48:46",
    "导出次数": 1471
  }
];
const tableColumns = [
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "边界距离统计管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "边界距离统计管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "边界距离统计管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "边界距离统计管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "边界距离统计管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
