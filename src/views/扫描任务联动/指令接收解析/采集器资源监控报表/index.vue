    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加采集器资源监控信息", "add")'>添加采集器资源监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看采集器资源监控信息", "add")'>查看采集器资源监控信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集器资源监控数据提取", "add")'>采集器资源监控数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集器资源监控数据识别", "add")'>采集器资源监控数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集器资源监控清洗", "add")'>采集器资源监控清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集器资源监控分级", "add")'>采集器资源监控分级</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集器资源监控实时计算", "add")'>采集器资源监控实时计算</el-button>
        </div>
      </div>
      <cs-pagetable
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集器资源监控报表导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集器资源监控报表调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集器资源监控报表异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集器资源监控报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集器资源监控报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
