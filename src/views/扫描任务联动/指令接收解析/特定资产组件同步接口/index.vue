    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("特定资产组件同步接口", "add")'>特定资产组件同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("特定资产组件同步数据分析", "add")'>特定资产组件同步数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看特定资产组件同步信息", "add")'>查看特定资产组件同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("特定资产组件同步数据导出", "export")'>特定资产组件同步数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增特定资产组件同步信息", "add")'>新增特定资产组件同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("输入特定资产组件同步请求任务", "add")'>输入特定资产组件同步请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("输出特定资产组件同步反馈信息", "add")'>输出特定资产组件同步反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("监控特定资产组件同步状态信息", "add")'>监控特定资产组件同步状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("统计特定资产组件同步调用信息", "add")'>统计特定资产组件同步调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-334151-100-6711",
    "接口名称": "区公司特定资产组件同步接口-异常复核-01-334151",
    "对接系统": "调度中心-3341",
    "调用状态": "处理中-151",
    "平均耗时": "508ms-51",
    "最近调用": "2026-05-24 15:40:28"
  },
  {
    "ID": 2,
    "接口编号": "API-334151-101-5030",
    "接口名称": "特定资产组件同步接口-数据上报-02-334151",
    "对接系统": "CMDB资源库-3341",
    "调用状态": "已完成-151",
    "平均耗时": "220ms-51",
    "最近调用": "2026-05-12 08:57:57"
  },
  {
    "ID": 3,
    "接口编号": "API-334151-102-4604",
    "接口名称": "区公司特定资产组件同步接口-异常复核-03-334151",
    "对接系统": "资产安全平台-3341",
    "调用状态": "待复核-151",
    "平均耗时": "75ms-51",
    "最近调用": "2026-05-17 17:33:51"
  },
  {
    "ID": 4,
    "接口编号": "API-334151-103-3309",
    "接口名称": "特定资产组件同步接口-资产纳管-04-334151",
    "对接系统": "资产安全平台-3341",
    "调用状态": "待复核-151",
    "平均耗时": "636ms-51",
    "最近调用": "2026-05-16 13:19:20"
  },
  {
    "ID": 5,
    "接口编号": "API-334151-104-2471",
    "接口名称": "特定资产组件同步接口-部侧联动-05-334151",
    "对接系统": "CMDB资源库-3341",
    "调用状态": "已同步-151",
    "平均耗时": "557ms-51",
    "最近调用": "2026-05-11 08:50:04"
  },
  {
    "ID": 6,
    "接口编号": "API-334151-105-5056",
    "接口名称": "特定资产组件同步接口-资产纳管-06-334151",
    "对接系统": "资产安全平台-3341",
    "调用状态": "已完成-151",
    "平均耗时": "59ms-51",
    "最近调用": "2026-05-14 10:58:16"
  },
  {
    "ID": 7,
    "接口编号": "API-334151-106-9564",
    "接口名称": "特定资产组件同步接口-部侧联动-07-334151",
    "对接系统": "CMDB资源库-3341",
    "调用状态": "异常-151",
    "平均耗时": "650ms-51",
    "最近调用": "2026-05-18 17:48:28"
  },
  {
    "ID": 8,
    "接口编号": "API-334151-107-7388",
    "接口名称": "特定资产组件同步接口-扩容核查-08-334151",
    "对接系统": "调度中心-3341",
    "调用状态": "已完成-151",
    "平均耗时": "501ms-51",
    "最近调用": "2026-05-18 09:57:32"
  },
  {
    "ID": 9,
    "接口编号": "API-334151-108-7607",
    "接口名称": "特定资产组件同步接口-资产纳管-09-334151",
    "对接系统": "资产安全平台-3341",
    "调用状态": "已完成-151",
    "平均耗时": "53ms-51",
    "最近调用": "2026-05-24 13:11:13"
  },
  {
    "ID": 10,
    "接口编号": "API-334151-109-2349",
    "接口名称": "特定资产组件同步接口-扩容核查-10-334151",
    "对接系统": "资产安全平台-3341",
    "调用状态": "待处理-151",
    "平均耗时": "546ms-51",
    "最近调用": "2026-05-15 16:58:17"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "特定资产组件同步接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "特定资产组件同步接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "特定资产组件同步接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "特定资产组件同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "特定资产组件同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
