    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP扫描数据源信息", "add")'>新增IP扫描数据源信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP扫描数据源信息", "edit")'>修改IP扫描数据源信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP扫描数据源信息", "delete")'>删除IP扫描数据源信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描数据源列表", "detail")'>查询IP扫描数据源列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询IP扫描数据源详情", "detail")'>查询IP扫描数据源详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入IP扫描数据源信息", "import")'>批量导入IP扫描数据源信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP扫描数据源信息导出", "export")'>IP扫描数据源信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-621140-100-1834",
    "扫描对象": "IP扫描数据源管理-部侧联动-01-621140",
    "扫描节点": "节点-08-40",
    "资产数量": 754,
    "异常数量": 1140,
    "扫描状态": "待复核-140"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-621140-101-1164",
    "扫描对象": "IP扫描数据源管理-数据上报-02-621140",
    "扫描节点": "节点-01-40",
    "资产数量": 4855,
    "异常数量": 4592,
    "扫描状态": "待处理-140"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-621140-102-6228",
    "扫描对象": "IP扫描数据源管理-异常复核-03-621140",
    "扫描节点": "节点-05-40",
    "资产数量": 1639,
    "异常数量": 2491,
    "扫描状态": "处理中-140"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-621140-103-4394",
    "扫描对象": "IP扫描数据源管理-数据上报-04-621140",
    "扫描节点": "节点-02-40",
    "资产数量": 2034,
    "异常数量": 3259,
    "扫描状态": "处理中-140"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-621140-104-6539",
    "扫描对象": "IP扫描数据源管理-数据上报-05-621140",
    "扫描节点": "节点-01-40",
    "资产数量": 3942,
    "异常数量": 4695,
    "扫描状态": "已同步-140"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-621140-105-1416",
    "扫描对象": "IP扫描数据源管理-自动采集-06-621140",
    "扫描节点": "区公司节点-08-40",
    "资产数量": 2444,
    "异常数量": 2448,
    "扫描状态": "已完成-140"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-621140-106-2310",
    "扫描对象": "IP扫描数据源管理-异常复核-07-621140",
    "扫描节点": "节点-03-40",
    "资产数量": 2074,
    "异常数量": 2968,
    "扫描状态": "处理中-140"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-621140-107-6884",
    "扫描对象": "IP扫描数据源管理-异常复核-08-621140",
    "扫描节点": "节点-02-40",
    "资产数量": 4193,
    "异常数量": 3863,
    "扫描状态": "已同步-140"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-621140-108-4929",
    "扫描对象": "IP扫描数据源管理-异常复核-09-621140",
    "扫描节点": "区公司节点-01-40",
    "资产数量": 2064,
    "异常数量": 1114,
    "扫描状态": "异常-140"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-621140-109-7563",
    "扫描对象": "IP扫描数据源管理-自动采集-10-621140",
    "扫描节点": "节点-07-40",
    "资产数量": 2657,
    "异常数量": 403,
    "扫描状态": "已完成-140"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP扫描数据源管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP扫描数据源管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP扫描数据源管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP扫描数据源管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP扫描数据源管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
