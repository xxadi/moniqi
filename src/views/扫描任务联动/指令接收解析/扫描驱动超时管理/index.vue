    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增扫描驱动超时策略", "add")'>新增扫描驱动超时策略</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改扫描驱动超时策略", "edit")'>修改扫描驱动超时策略</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除扫描驱动超时策略", "delete")'>删除扫描驱动超时策略</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描驱动超时记录列表", "detail")'>查询扫描驱动超时记录列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询扫描驱动超时记录详情", "detail")'>查询扫描驱动超时记录详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入扫描驱动超时记录信息", "import")'>批量导入扫描驱动超时记录信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("扫描驱动超时记录信息导出", "export")'>扫描驱动超时记录信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "扫描批次": "SCAN-899751-100-2123",
    "扫描对象": "扫描驱动超时管理-资产纳管-01-899751",
    "扫描节点": "节点-09-51",
    "资产数量": 4843,
    "异常数量": 441,
    "扫描状态": "待复核-751"
  ...
  {
    "ID": 2,
    "扫描批次": "SCAN-899751-101-2419",
    "扫描对象": "扫描驱动超时管理-异常复核-02-899751",
    "扫描节点": "节点-02-51",
    "资产数量": 2037,
    "异常数量": 2111,
    "扫描状态": "处理中-751"
  ...
  {
    "ID": 3,
    "扫描批次": "SCAN-899751-102-5660",
    "扫描对象": "扫描驱动超时管理-部侧联动-03-899751",
    "扫描节点": "节点-08-51",
    "资产数量": 2329,
    "异常数量": 2159,
    "扫描状态": "已完成-751"
  ...
  {
    "ID": 4,
    "扫描批次": "SCAN-899751-103-9785",
    "扫描对象": "区公司扫描驱动超时管理-部侧联动-04-899751",
    "扫描节点": "节点-03-51",
    "资产数量": 1766,
    "异常数量": 3484,
    "扫描状态": "待处理-751"
  ...
  {
    "ID": 5,
    "扫描批次": "SCAN-899751-104-3588",
    "扫描对象": "区公司扫描驱动超时管理-自动采集-05-899751",
    "扫描节点": "节点-03-51",
    "资产数量": 653,
    "异常数量": 3091,
    "扫描状态": "待处理-751"
  ...
  {
    "ID": 6,
    "扫描批次": "SCAN-899751-105-6957",
    "扫描对象": "扫描驱动超时管理-异常复核-06-899751",
    "扫描节点": "节点-02-51",
    "资产数量": 2693,
    "异常数量": 2291,
    "扫描状态": "待复核-751"
  ...
  {
    "ID": 7,
    "扫描批次": "SCAN-899751-106-3313",
    "扫描对象": "扫描驱动超时管理-异常复核-07-899751",
    "扫描节点": "节点-06-51",
    "资产数量": 5012,
    "异常数量": 2717,
    "扫描状态": "异常-751"
  ...
  {
    "ID": 8,
    "扫描批次": "SCAN-899751-107-9633",
    "扫描对象": "区公司扫描驱动超时管理-扩容核查-08-899751",
    "扫描节点": "节点-09-51",
    "资产数量": 3236,
    "异常数量": 4688,
    "扫描状态": "待处理-751"
  ...
  {
    "ID": 9,
    "扫描批次": "SCAN-899751-108-1748",
    "扫描对象": "扫描驱动超时管理-数据上报-09-899751",
    "扫描节点": "节点-04-51",
    "资产数量": 2338,
    "异常数量": 1718,
    "扫描状态": "处理中-751"
  ...
  {
    "ID": 10,
    "扫描批次": "SCAN-899751-109-4998",
    "扫描对象": "扫描驱动超时管理-资产纳管-10-899751",
    "扫描节点": "节点-08-51",
    "资产数量": 1021,
    "异常数量": 935,
    "扫描状态": "待复核-751"
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "扫描驱动超时管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "扫描驱动超时管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "扫描驱动超时管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "扫描驱动超时管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "扫描驱动超时管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
