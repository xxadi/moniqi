    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产设备品牌信息", "add")'>新增资产设备品牌信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产设备品牌信息", "edit")'>修改资产设备品牌信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产设备品牌信息", "delete")'>删除资产设备品牌信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产设备品牌列表", "detail")'>查询资产设备品牌列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产设备品牌详情", "detail")'>查询资产设备品牌详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入资产设备品牌信息", "import")'>批量导入资产设备品牌信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产设备品牌信息导出", "export")'>资产设备品牌信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-282060-100-1333",
    "资产名称": "资产设备品牌管理-自动采集-01-282060",
    "资产类型": "资产资源-核心-282",
    "所属区域": "-资产资源-资产设备品牌管理-资产纳管-282060-001",
    "纳管状态": "已完成-060",
    "最近同步": "2026-05-15 12:56:41"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-282060-101-1623",
    "资产名称": "资产设备品牌管理-异常复核-02-282060",
    "资产类型": "资产资源-边界-282",
    "所属区域": "-资产资源-资产设备品牌管理-扩容核查-282060-002",
    "纳管状态": "处理中-060",
    "最近同步": "2026-05-19 10:31:04"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-282060-102-8895",
    "资产名称": "区公司资产设备品牌管理-自动采集-03-282060",
    "资产类型": "资产资源-部侧-282",
    "所属区域": "-资产资源-资产设备品牌管理-部侧联动-282060-003",
    "纳管状态": "已同步-060",
    "最近同步": "2026-05-24 08:00:39"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-282060-103-2082",
    "资产名称": "资产设备品牌管理-扩容核查-04-282060",
    "资产类型": "资产资源-省侧-282",
    "所属区域": "-资产资源-资产设备品牌管理-资产纳管-282060-004",
    "纳管状态": "待复核-060",
    "最近同步": "2026-05-23 09:33:11"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-282060-104-9499",
    "资产名称": "资产设备品牌管理-扩容核查-05-282060",
    "资产类型": "资产资源-自动化-282",
    "所属区域": "-资产资源-资产设备品牌管理-数据上报-282060-005",
    "纳管状态": "处理中-060",
    "最近同步": "2026-05-21 08:42:42"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-282060-105-5879",
    "资产名称": "资产设备品牌管理-自动采集-06-282060",
    "资产类型": "资产资源-边界-282",
    "所属区域": "-资产资源-资产设备品牌管理-扩容核查-282060-006",
    "纳管状态": "处理中-060",
    "最近同步": "2026-05-14 08:27:47"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-282060-106-6189",
    "资产名称": "资产设备品牌管理-资产纳管-07-282060",
    "资产类型": "资产资源-边界-282",
    "所属区域": "-资产资源-资产设备品牌管理-部侧联动-282060-007",
    "纳管状态": "已同步-060",
    "最近同步": "2026-05-11 17:38:13"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-282060-107-3139",
    "资产名称": "资产设备品牌管理-部侧联动-08-282060",
    "资产类型": "资产资源-核心-282",
    "所属区域": "-资产资源-资产设备品牌管理-资产纳管-282060-008",
    "纳管状态": "异常-060",
    "最近同步": "2026-05-18 08:08:53"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-282060-108-1317",
    "资产名称": "资产设备品牌管理-数据上报-09-282060",
    "资产类型": "资产资源-复核-282",
    "所属区域": "-资产资源-资产设备品牌管理-部侧联动-282060-009",
    "纳管状态": "异常-060",
    "最近同步": "2026-05-25 14:19:14"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-282060-109-6192",
    "资产名称": "资产设备品牌管理-数据上报-10-282060",
    "资产类型": "资产资源-边界-282",
    "所属区域": "区公司-资产资源-资产设备品牌管理-部侧联动-282060-010",
    "纳管状态": "处理中-060",
    "最近同步": "2026-05-24 16:10:42"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产设备品牌管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产设备品牌管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产设备品牌管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产设备品牌管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产设备品牌管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
