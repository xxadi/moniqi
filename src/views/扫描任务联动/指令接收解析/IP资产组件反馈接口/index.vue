    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP资产组件反馈接口", "operation")'>IP资产组件反馈接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("IP资产组件反馈数据分析", "analysis")'>IP资产组件反馈数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看IP资产组件反馈信息", "detail")'>查看IP资产组件反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP资产组件反馈数据导出", "export")'>IP资产组件反馈数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加IP资产组件反馈信息", "add")'>添加IP资产组件反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输入IP资产组件反馈请求任务", "operation")'>输入IP资产组件反馈请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("输出IP资产组件反馈反馈信息", "operation")'>输出IP资产组件反馈反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控IP资产组件反馈状态信息", "detail")'>监控IP资产组件反馈状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("统计IP资产组件反馈调用信息", "analysis")'>统计IP资产组件反馈调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-209027-100-7793",
    "接口名称": "IP资产组件反馈接口-部侧联动-01-209027",
    "对接系统": "调度中心-2090",
    "调用状态": "待处理-027",
    "平均耗时": "270ms-27",
    "最近调用": "2026-05-16 15:32:15"
  },
  {
    "ID": 2,
    "接口编号": "API-209027-101-1309",
    "接口名称": "IP资产组件反馈接口-部侧联动-02-209027",
    "对接系统": "调度中心-2090",
    "调用状态": "待复核-027",
    "平均耗时": "105ms-27",
    "最近调用": "2026-05-15 09:06:11"
  },
  {
    "ID": 3,
    "接口编号": "API-209027-102-7302",
    "接口名称": "IP资产组件反馈接口-部侧联动-03-209027",
    "对接系统": "CMDB资源库-2090",
    "调用状态": "已完成-027",
    "平均耗时": "372ms-27",
    "最近调用": "2026-05-22 11:59:18"
  },
  {
    "ID": 4,
    "接口编号": "API-209027-103-5428",
    "接口名称": "IP资产组件反馈接口-数据上报-04-209027",
    "对接系统": "资产安全平台-2090",
    "调用状态": "异常-027",
    "平均耗时": "56ms-27",
    "最近调用": "2026-05-16 17:28:46"
  },
  {
    "ID": 5,
    "接口编号": "API-209027-104-1864",
    "接口名称": "IP资产组件反馈接口-扩容核查-05-209027",
    "对接系统": "工信部对接平台-2090",
    "调用状态": "异常-027",
    "平均耗时": "436ms-27",
    "最近调用": "2026-05-23 17:01:25"
  },
  {
    "ID": 6,
    "接口编号": "API-209027-105-6943",
    "接口名称": "IP资产组件反馈接口-部侧联动-06-209027",
    "对接系统": "工信部对接平台-2090",
    "调用状态": "已完成-027",
    "平均耗时": "114ms-27",
    "最近调用": "2026-05-12 11:08:46"
  },
  {
    "ID": 7,
    "接口编号": "API-209027-106-1463",
    "接口名称": "IP资产组件反馈接口-异常复核-07-209027",
    "对接系统": "CMDB资源库-2090",
    "调用状态": "已同步-027",
    "平均耗时": "626ms-27",
    "最近调用": "2026-05-10 13:54:35"
  },
  {
    "ID": 8,
    "接口编号": "API-209027-107-4576",
    "接口名称": "区公司IP资产组件反馈接口-资产纳管-08-209027",
    "对接系统": "CMDB资源库-2090",
    "调用状态": "已同步-027",
    "平均耗时": "377ms-27",
    "最近调用": "2026-05-18 15:53:17"
  },
  {
    "ID": 9,
    "接口编号": "API-209027-108-3769",
    "接口名称": "IP资产组件反馈接口-自动采集-09-209027",
    "对接系统": "资产安全平台-2090",
    "调用状态": "异常-027",
    "平均耗时": "619ms-27",
    "最近调用": "2026-05-09 13:24:52"
  },
  {
    "ID": 10,
    "接口编号": "API-209027-109-5699",
    "接口名称": "IP资产组件反馈接口-数据上报-10-209027",
    "对接系统": "CMDB资源库-2090",
    "调用状态": "已完成-027",
    "平均耗时": "155ms-27",
    "最近调用": "2026-05-25 16:00:24"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "IP资产组件反馈接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "IP资产组件反馈接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "IP资产组件反馈接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP资产组件反馈接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP资产组件反馈接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
