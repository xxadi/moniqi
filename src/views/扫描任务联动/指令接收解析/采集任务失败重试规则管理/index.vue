    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增采集任务失败重试规则", "add")'>新增采集任务失败重试规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除采集任务失败重试规则", "delete")'>删除采集任务失败重试规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改采集任务失败重试规则", "edit")'>修改采集任务失败重试规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询采集任务失败重试规则", "add")'>查询采集任务失败重试规则</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务失败重试规则启用/禁用", "add")'>采集任务失败重试规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务失败重试规则运行效果评估", "add")'>采集任务失败重试规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务失败重试规则分析", "add")'>采集任务失败重试规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务失败重试规则分析结果展示", "add")'>采集任务失败重试规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("采集任务失败重试规则分析结果下载", "export")'>采集任务失败重试规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集任务失败重试规则分析结果上报", "add")'>采集任务失败重试规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-057129-100-9658",
    "规则名称": "采集任务失败重试规则管理-异常复核-01-057129",
    "规则类型": "规则策略-边界-057",
    "启用状态": "已同步-129",
    "命中次数": 2627,
    "更新时间": "2026-05-17 14:06:02"
  },
  {
    "ID": 2,
    "规则编号": "RULE-057129-101-9637",
    "规则名称": "采集任务失败重试规则管理-扩容核查-02-057129",
    "规则类型": "规则策略-省侧-057",
    "启用状态": "异常-129",
    "命中次数": 5039,
    "更新时间": "2026-05-22 16:10:35"
  },
  {
    "ID": 3,
    "规则编号": "RULE-057129-102-9394",
    "规则名称": "采集任务失败重试规则管理-资产纳管-03-057129",
    "规则类型": "规则策略-边界-057",
    "启用状态": "异常-129",
    "命中次数": 2528,
    "更新时间": "2026-05-21 10:15:55"
  },
  {
    "ID": 4,
    "规则编号": "RULE-057129-103-7189",
    "规则名称": "采集任务失败重试规则管理-资产纳管-04-057129",
    "规则类型": "规则策略-边界-057",
    "启用状态": "待处理-129",
    "命中次数": 2800,
    "更新时间": "2026-05-08 14:50:44"
  },
  {
    "ID": 5,
    "规则编号": "RULE-057129-104-4582",
    "规则名称": "采集任务失败重试规则管理-资产纳管-05-057129",
    "规则类型": "规则策略-省侧-057",
    "启用状态": "待复核-129",
    "命中次数": 2195,
    "更新时间": "2026-05-21 13:37:50"
  },
  {
    "ID": 6,
    "规则编号": "RULE-057129-105-2048",
    "规则名称": "区公司采集任务失败重试规则管理-异常复核-06-057129",
    "规则类型": "规则策略-自动化-057",
    "启用状态": "异常-129",
    "命中次数": 3423,
    "更新时间": "2026-05-08 17:38:45"
  },
  {
    "ID": 7,
    "规则编号": "RULE-057129-106-1617",
    "规则名称": "采集任务失败重试规则管理-数据上报-07-057129",
    "规则类型": "规则策略-部侧-057",
    "启用状态": "待复核-129",
    "命中次数": 2067,
    "更新时间": "2026-05-16 15:27:52"
  },
  {
    "ID": 8,
    "规则编号": "RULE-057129-107-8183",
    "规则名称": "采集任务失败重试规则管理-数据上报-08-057129",
    "规则类型": "规则策略-省侧-057",
    "启用状态": "待处理-129",
    "命中次数": 655,
    "更新时间": "2026-05-22 11:25:02"
  },
  {
    "ID": 9,
    "规则编号": "RULE-057129-108-2190",
    "规则名称": "采集任务失败重试规则管理-部侧联动-09-057129",
    "规则类型": "规则策略-边界-057",
    "启用状态": "已完成-129",
    "命中次数": 2718,
    "更新时间": "2026-05-21 16:13:45"
  },
  {
    "ID": 10,
    "规则编号": "RULE-057129-109-9227",
    "规则名称": "采集任务失败重试规则管理-自动采集-10-057129",
    "规则类型": "规则策略-边界-057",
    "启用状态": "异常-129",
    "命中次数": 545,
    "更新时间": "2026-05-10 08:57:14"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集任务失败重试规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集任务失败重试规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集任务失败重试规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集任务失败重试规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集任务失败重试规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
