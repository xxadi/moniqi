    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增大模型资产信息", "add")'>新增大模型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改大模型资产信息", "edit")'>修改大模型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除大模型资产信息", "delete")'>删除大模型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询大模型资产", "detail")'>查询大模型资产</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("大模型资产统计", "analysis")'>大模型资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("大模型资产信息下载", "export")'>大模型资产信息下载</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-164211-100-3113",
    "规则名称": "大模型资产管理-扩容核查-01-164211",
    "规则类型": "规则策略-自动化-164",
    "启用状态": "异常-211",
    "命中次数": 3309,
    "更新时间": "2026-05-24 14:36:59"
  },
  {
    "ID": 2,
    "规则编号": "RULE-164211-101-9604",
    "规则名称": "大模型资产管理-数据上报-02-164211",
    "规则类型": "规则策略-部侧-164",
    "启用状态": "异常-211",
    "命中次数": 4446,
    "更新时间": "2026-05-16 10:36:41"
  },
  {
    "ID": 3,
    "规则编号": "RULE-164211-102-2896",
    "规则名称": "大模型资产管理-异常复核-03-164211",
    "规则类型": "规则策略-复核-164",
    "启用状态": "异常-211",
    "命中次数": 3770,
    "更新时间": "2026-05-21 15:35:01"
  },
  {
    "ID": 4,
    "规则编号": "RULE-164211-103-8539",
    "规则名称": "大模型资产管理-资产纳管-04-164211",
    "规则类型": "规则策略-复核-164",
    "启用状态": "待处理-211",
    "命中次数": 111,
    "更新时间": "2026-05-19 11:11:18"
  },
  {
    "ID": 5,
    "规则编号": "RULE-164211-104-4188",
    "规则名称": "大模型资产管理-数据上报-05-164211",
    "规则类型": "规则策略-复核-164",
    "启用状态": "待处理-211",
    "命中次数": 1890,
    "更新时间": "2026-05-25 09:06:48"
  },
  {
    "ID": 6,
    "规则编号": "RULE-164211-105-5815",
    "规则名称": "大模型资产管理-部侧联动-06-164211",
    "规则类型": "规则策略-省侧-164",
    "启用状态": "处理中-211",
    "命中次数": 1508,
    "更新时间": "2026-05-14 10:20:37"
  },
  {
    "ID": 7,
    "规则编号": "RULE-164211-106-8913",
    "规则名称": "大模型资产管理-扩容核查-07-164211",
    "规则类型": "规则策略-复核-164",
    "启用状态": "异常-211",
    "命中次数": 4019,
    "更新时间": "2026-05-21 15:25:35"
  },
  {
    "ID": 8,
    "规则编号": "RULE-164211-107-1749",
    "规则名称": "大模型资产管理-数据上报-08-164211",
    "规则类型": "规则策略-部侧-164",
    "启用状态": "处理中-211",
    "命中次数": 4839,
    "更新时间": "2026-05-22 17:58:48"
  },
  {
    "ID": 9,
    "规则编号": "RULE-164211-108-9232",
    "规则名称": "大模型资产管理-异常复核-09-164211",
    "规则类型": "规则策略-部侧-164",
    "启用状态": "待复核-211",
    "命中次数": 1218,
    "更新时间": "2026-05-22 14:28:14"
  },
  {
    "ID": 10,
    "规则编号": "RULE-164211-109-2674",
    "规则名称": "大模型资产管理-异常复核-10-164211",
    "规则类型": "规则策略-省侧-164",
    "启用状态": "处理中-211",
    "命中次数": 3471,
    "更新时间": "2026-05-11 17:09:38"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "大模型资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "大模型资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "大模型资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "大模型资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "大模型资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
