    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("发起虚拟资源变更审批流程", "edit")'>发起虚拟资源变更审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑虚拟资源变更审批流程", "edit")'>编辑虚拟资源变更审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查看虚拟资源变更审批流程", "edit")'>查看虚拟资源变更审批流程</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程待办信息提醒", "edit")'>虚拟资源变更审批流程待办信息提醒</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程催办", "edit")'>虚拟资源变更审批流程催办</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程处理结果通知", "edit")'>虚拟资源变更审批流程处理结果通知</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程数据分析", "edit")'>虚拟资源变更审批流程数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程数据分析结果推送", "edit")'>虚拟资源变更审批流程数据分析结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源变更审批流程数据分析结果导出", "export")'>虚拟资源变更审批流程数据分析结果导出</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("添加虚拟资源变更审批指派信息", "edit")'>添加虚拟资源变更审批指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("添加虚拟资源变更审批流程节点", "edit")'>添加虚拟资源变更审批流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑虚拟资源变更审批流程节点信息", "edit")'>编辑虚拟资源变更审批流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("虚拟资源变更审批流程节点删除", "delete")'>虚拟资源变更审批流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程节点查询", "edit")'>虚拟资源变更审批流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程图查看", "edit")'>虚拟资源变更审批流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批流程通知", "edit")'>虚拟资源变更审批流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批结果逐级审批", "edit")'>虚拟资源变更审批结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源变更审批结果拒绝和驳回", "edit")'>虚拟资源变更审批结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-166350-100-3490",
    "资产名称": "虚拟资源变更审批流程管理-资产纳管-01-166350",
    "资产类型": "资产资源-边界-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-数据上报-166350-001",
    "纳管状态": "处理中-350",
    "最近同步": "2026-05-14 13:38:54"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-166350-101-1918",
    "资产名称": "虚拟资源变更审批流程管理-扩容核查-02-166350",
    "资产类型": "资产资源-部侧-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-资产纳管-166350-002",
    "纳管状态": "已完成-350",
    "最近同步": "2026-05-24 13:01:00"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-166350-102-3254",
    "资产名称": "区公司虚拟资源变更审批流程管理-资产纳管-03-166350",
    "资产类型": "资产资源-自动化-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-异常复核-166350-003",
    "纳管状态": "待复核-350",
    "最近同步": "2026-05-25 12:21:54"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-166350-103-6438",
    "资产名称": "区公司虚拟资源变更审批流程管理-数据上报-04-166350",
    "资产类型": "资产资源-自动化-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-资产纳管-166350-004",
    "纳管状态": "待复核-350",
    "最近同步": "2026-05-20 10:05:25"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-166350-104-1974",
    "资产名称": "虚拟资源变更审批流程管理-部侧联动-05-166350",
    "资产类型": "资产资源-部侧-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-扩容核查-166350-005",
    "纳管状态": "待复核-350",
    "最近同步": "2026-05-11 15:12:58"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-166350-105-6491",
    "资产名称": "虚拟资源变更审批流程管理-自动采集-06-166350",
    "资产类型": "资产资源-部侧-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-异常复核-166350-006",
    "纳管状态": "处理中-350",
    "最近同步": "2026-05-22 11:02:33"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-166350-106-3889",
    "资产名称": "虚拟资源变更审批流程管理-资产纳管-07-166350",
    "资产类型": "资产资源-自动化-166",
    "所属区域": "区公司-资产资源-虚拟资源变更审批流程管理-扩容核查-166350-007",
    "纳管状态": "待处理-350",
    "最近同步": "2026-05-08 09:02:30"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-166350-107-5325",
    "资产名称": "虚拟资源变更审批流程管理-扩容核查-08-166350",
    "资产类型": "资产资源-核心-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-自动采集-166350-008",
    "纳管状态": "已同步-350",
    "最近同步": "2026-05-13 09:32:15"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-166350-108-9510",
    "资产名称": "虚拟资源变更审批流程管理-异常复核-09-166350",
    "资产类型": "资产资源-复核-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-自动采集-166350-009",
    "纳管状态": "异常-350",
    "最近同步": "2026-05-10 10:46:31"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-166350-109-3775",
    "资产名称": "虚拟资源变更审批流程管理-扩容核查-10-166350",
    "资产类型": "资产资源-边界-166",
    "所属区域": "-资产资源-虚拟资源变更审批流程管理-数据上报-166350-010",
    "纳管状态": "已同步-350",
    "最近同步": "2026-05-22 09:59:46"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源变更审批流程管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源变更审批流程管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源变更审批流程管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源变更审批流程管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源变更审批流程管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
