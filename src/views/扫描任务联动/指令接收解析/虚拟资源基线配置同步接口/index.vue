    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源基线配置同步接口", "edit")'>虚拟资源基线配置同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("定义虚拟资源基线配置同步信息", "edit")'>定义虚拟资源基线配置同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源基线配置同步数据查看", "edit")'>虚拟资源基线配置同步数据查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("添加虚拟资源基线配置同步状态查询信息", "edit")'>添加虚拟资源基线配置同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源基线配置同步结果监控", "edit")'>虚拟资源基线配置同步结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("更新虚拟资源基线配置同步接口数据", "edit")'>更新虚拟资源基线配置同步接口数据</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查看虚拟资源基线配置同步接口请求信息", "edit")'>查看虚拟资源基线配置同步接口请求信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源基线配置同步接口数据清洗", "edit")'>虚拟资源基线配置同步接口数据清洗</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("虚拟资源基线配置同步运行监控", "edit")'>虚拟资源基线配置同步运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("反馈虚拟资源基线配置同步接口信息", "edit")'>反馈虚拟资源基线配置同步接口信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-319008-100-2376",
    "接口名称": "虚拟资源基线配置同步接口-扩容核查-01-319008",
    "对接系统": "CMDB资源库-3190",
    "调用状态": "已完成-008",
    "平均耗时": "127ms-08",
    "最近调用": "2026-05-09 16:54:09"
  },
  {
    "ID": 2,
    "接口编号": "API-319008-101-5261",
    "接口名称": "虚拟资源基线配置同步接口-扩容核查-02-319008",
    "对接系统": "CMDB资源库-3190",
    "调用状态": "已同步-008",
    "平均耗时": "461ms-08",
    "最近调用": "2026-05-10 09:26:17"
  },
  {
    "ID": 3,
    "接口编号": "API-319008-102-3646",
    "接口名称": "虚拟资源基线配置同步接口-资产纳管-03-319008",
    "对接系统": "资产安全平台-3190",
    "调用状态": "待处理-008",
    "平均耗时": "153ms-08",
    "最近调用": "2026-05-12 16:12:05"
  },
  {
    "ID": 4,
    "接口编号": "API-319008-103-4653",
    "接口名称": "虚拟资源基线配置同步接口-资产纳管-04-319008",
    "对接系统": "调度中心-3190",
    "调用状态": "待复核-008",
    "平均耗时": "300ms-08",
    "最近调用": "2026-05-13 12:40:09"
  },
  {
    "ID": 5,
    "接口编号": "API-319008-104-6036",
    "接口名称": "虚拟资源基线配置同步接口-资产纳管-05-319008",
    "对接系统": "集团资产平台-3190",
    "调用状态": "待复核-008",
    "平均耗时": "313ms-08",
    "最近调用": "2026-05-17 13:59:44"
  },
  {
    "ID": 6,
    "接口编号": "API-319008-105-8485",
    "接口名称": "区公司虚拟资源基线配置同步接口-数据上报-06-319008",
    "对接系统": "工信部对接平台-3190",
    "调用状态": "已完成-008",
    "平均耗时": "390ms-08",
    "最近调用": "2026-05-19 13:56:38"
  },
  {
    "ID": 7,
    "接口编号": "API-319008-106-4377",
    "接口名称": "虚拟资源基线配置同步接口-数据上报-07-319008",
    "对接系统": "集团资产平台-3190",
    "调用状态": "异常-008",
    "平均耗时": "339ms-08",
    "最近调用": "2026-05-14 14:44:22"
  },
  {
    "ID": 8,
    "接口编号": "API-319008-107-8165",
    "接口名称": "区公司虚拟资源基线配置同步接口-部侧联动-08-319008",
    "对接系统": "工信部对接平台-3190",
    "调用状态": "异常-008",
    "平均耗时": "648ms-08",
    "最近调用": "2026-05-25 09:27:43"
  },
  {
    "ID": 9,
    "接口编号": "API-319008-108-1270",
    "接口名称": "虚拟资源基线配置同步接口-数据上报-09-319008",
    "对接系统": "资产安全平台-3190",
    "调用状态": "已同步-008",
    "平均耗时": "338ms-08",
    "最近调用": "2026-05-12 17:50:56"
  },
  {
    "ID": 10,
    "接口编号": "API-319008-109-5135",
    "接口名称": "虚拟资源基线配置同步接口-自动采集-10-319008",
    "对接系统": "集团资产平台-3190",
    "调用状态": "已同步-008",
    "平均耗时": "571ms-08",
    "最近调用": "2026-05-16 13:11:25"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源基线配置同步接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源基线配置同步接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源基线配置同步接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源基线配置同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源基线配置同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
