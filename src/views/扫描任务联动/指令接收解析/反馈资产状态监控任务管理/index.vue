    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加反馈资产状态监控任务", "add")'>添加反馈资产状态监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除反馈资产状态监控任务", "delete")'>删除反馈资产状态监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑反馈资产状态监控任务", "edit")'>编辑反馈资产状态监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询反馈资产状态监控任务", "detail")'>查询反馈资产状态监控任务</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("反馈资产状态监控任务启用/禁用", "detail")'>反馈资产状态监控任务启用/禁用</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-371050-100-2295",
    "资产名称": "反馈资产状态监控任务管理-异常复核-01-371050",
    "资产类型": "资产资源-部侧-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-异常复核-371050-001",
    "纳管状态": "处理中-050",
    "最近同步": "2026-05-13 09:42:27"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-371050-101-6798",
    "资产名称": "区公司反馈资产状态监控任务管理-自动采集-02-371050",
    "资产类型": "资产资源-自动化-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-数据上报-371050-002",
    "纳管状态": "待处理-050",
    "最近同步": "2026-05-17 10:30:33"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-371050-102-4323",
    "资产名称": "区公司反馈资产状态监控任务管理-资产纳管-03-371050",
    "资产类型": "资产资源-核心-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-扩容核查-371050-003",
    "纳管状态": "已完成-050",
    "最近同步": "2026-05-12 11:50:48"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-371050-103-2782",
    "资产名称": "反馈资产状态监控任务管理-异常复核-04-371050",
    "资产类型": "资产资源-省侧-371",
    "所属区域": "区公司-资产资源-反馈资产状态监控任务管理-部侧联动-371050-004",
    "纳管状态": "处理中-050",
    "最近同步": "2026-05-22 16:30:12"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-371050-104-9355",
    "资产名称": "反馈资产状态监控任务管理-数据上报-05-371050",
    "资产类型": "资产资源-复核-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-扩容核查-371050-005",
    "纳管状态": "处理中-050",
    "最近同步": "2026-05-19 08:32:34"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-371050-105-4741",
    "资产名称": "反馈资产状态监控任务管理-自动采集-06-371050",
    "资产类型": "资产资源-复核-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-数据上报-371050-006",
    "纳管状态": "待复核-050",
    "最近同步": "2026-05-17 08:12:19"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-371050-106-3707",
    "资产名称": "区公司反馈资产状态监控任务管理-扩容核查-07-371050",
    "资产类型": "资产资源-自动化-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-扩容核查-371050-007",
    "纳管状态": "已完成-050",
    "最近同步": "2026-05-21 14:09:40"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-371050-107-2847",
    "资产名称": "反馈资产状态监控任务管理-自动采集-08-371050",
    "资产类型": "资产资源-自动化-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-异常复核-371050-008",
    "纳管状态": "处理中-050",
    "最近同步": "2026-05-19 11:50:47"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-371050-108-8346",
    "资产名称": "反馈资产状态监控任务管理-资产纳管-09-371050",
    "资产类型": "资产资源-部侧-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-异常复核-371050-009",
    "纳管状态": "已同步-050",
    "最近同步": "2026-05-13 16:03:56"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-371050-109-4771",
    "资产名称": "反馈资产状态监控任务管理-数据上报-10-371050",
    "资产类型": "资产资源-核心-371",
    "所属区域": "-资产资源-反馈资产状态监控任务管理-数据上报-371050-010",
    "纳管状态": "已同步-050",
    "最近同步": "2026-05-18 14:32:13"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "反馈资产状态监控任务管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "反馈资产状态监控任务管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "反馈资产状态监控任务管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "反馈资产状态监控任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "反馈资产状态监控任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
