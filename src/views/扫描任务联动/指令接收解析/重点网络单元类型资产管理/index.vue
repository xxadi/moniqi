    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增重点网络单元类型资产信息", "add")'>新增重点网络单元类型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改重点网络单元类型资产信息", "edit")'>修改重点网络单元类型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除重点网络单元类型资产信息", "delete")'>删除重点网络单元类型资产信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询重点网络单元类型资产", "detail")'>查询重点网络单元类型资产</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("重点网络单元类型资产统计", "analysis")'>重点网络单元类型资产统计</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("重点网络单元类型资产信息下载", "export")'>重点网络单元类型资产信息下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增重点网络单元类型指纹信息", "add")'>新增重点网络单元类型指纹信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改重点网络单元类型指纹信息", "edit")'>修改重点网络单元类型指纹信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除重点网络单元类型指纹信息", "delete")'>删除重点网络单元类型指纹信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询重点网络单元类型指纹列表", "detail")'>查询重点网络单元类型指纹列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询重点网络单元类型指纹详情", "detail")'>查询重点网络单元类型指纹详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入重点网络单元类型指纹信息", "import")'>批量导入重点网络单元类型指纹信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("重点网络单元类型指纹信息导出", "export")'>重点网络单元类型指纹信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-016627-100-3569",
    "资产名称": "重点网络单元类型资产管理-异常复核-01-016627",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-部侧联动-016627-001",
    "纳管状态": "异常-627",
    "最近同步": "2026-05-23 09:54:07"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-016627-101-3016",
    "资产名称": "区公司重点网络单元类型资产管理-扩容核查-02-016627",
    "资产类型": "资产资源-复核-016",
    "所属区域": "区公司-资产资源-重点网络单元类型资产管理-扩容核查-016627-002",
    "纳管状态": "待处理-627",
    "最近同步": "2026-05-12 14:07:56"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-016627-102-7878",
    "资产名称": "重点网络单元类型资产管理-资产纳管-03-016627",
    "资产类型": "资产资源-边界-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-数据上报-016627-003",
    "纳管状态": "待复核-627",
    "最近同步": "2026-05-10 13:13:21"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-016627-103-5151",
    "资产名称": "重点网络单元类型资产管理-数据上报-04-016627",
    "资产类型": "资产资源-核心-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-扩容核查-016627-004",
    "纳管状态": "异常-627",
    "最近同步": "2026-05-09 10:44:05"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-016627-104-8137",
    "资产名称": "区公司重点网络单元类型资产管理-异常复核-05-016627",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-数据上报-016627-005",
    "纳管状态": "处理中-627",
    "最近同步": "2026-05-22 15:32:53"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-016627-105-2720",
    "资产名称": "区公司重点网络单元类型资产管理-自动采集-06-016627",
    "资产类型": "资产资源-自动化-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-扩容核查-016627-006",
    "纳管状态": "已同步-627",
    "最近同步": "2026-05-17 16:15:07"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-016627-106-4959",
    "资产名称": "重点网络单元类型资产管理-数据上报-07-016627",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-异常复核-016627-007",
    "纳管状态": "已同步-627",
    "最近同步": "2026-05-19 16:15:23"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-016627-107-2274",
    "资产名称": "重点网络单元类型资产管理-异常复核-08-016627",
    "资产类型": "资产资源-自动化-016",
    "所属区域": "区公司-资产资源-重点网络单元类型资产管理-自动采集-016627-008",
    "纳管状态": "待复核-627",
    "最近同步": "2026-05-09 10:31:37"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-016627-108-5702",
    "资产名称": "区公司重点网络单元类型资产管理-数据上报-09-016627",
    "资产类型": "资产资源-核心-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-数据上报-016627-009",
    "纳管状态": "待处理-627",
    "最近同步": "2026-05-21 09:28:59"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-016627-109-7318",
    "资产名称": "重点网络单元类型资产管理-异常复核-10-016627",
    "资产类型": "资产资源-部侧-016",
    "所属区域": "-资产资源-重点网络单元类型资产管理-部侧联动-016627-010",
    "纳管状态": "待复核-627",
    "最近同步": "2026-05-17 10:53:48"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "重点网络单元类型资产管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "重点网络单元类型资产管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "重点网络单元类型资产管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "重点网络单元类型资产管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "重点网络单元类型资产管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
