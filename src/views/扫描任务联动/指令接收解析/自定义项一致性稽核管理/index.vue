    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增自定义项一致性稽核信息", "add")'>新增自定义项一致性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改自定义项一致性稽核信息", "edit")'>修改自定义项一致性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除自定义项一致性稽核信息", "delete")'>删除自定义项一致性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自定义项一致性稽核列表", "detail")'>查询自定义项一致性稽核列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询自定义项一致性稽核详情", "detail")'>查询自定义项一致性稽核详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入自定义项一致性稽核信息", "import")'>批量导入自定义项一致性稽核信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("自定义项一致性稽核信息导出", "export")'>自定义项一致性稽核信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-523461-100-7000",
    "业务名称": "自定义项一致性稽核管理-异常复核-01-523461",
    "业务类型": "业务联动-边界-523",
    "处理状态": "处理中-461",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-20 08:14:44"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-523461-101-3177",
    "业务名称": "自定义项一致性稽核管理-异常复核-02-523461",
    "业务类型": "业务联动-自动化-523",
    "处理状态": "异常-461",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-08 14:12:59"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-523461-102-3274",
    "业务名称": "自定义项一致性稽核管理-资产纳管-03-523461",
    "业务类型": "业务联动-自动化-523",
    "处理状态": "已同步-461",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-10 14:28:00"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-523461-103-6578",
    "业务名称": "自定义项一致性稽核管理-部侧联动-04-523461",
    "业务类型": "业务联动-复核-523",
    "处理状态": "异常-461",
    "负责人": "任务调度员-区公司",
    "更新时间": "2026-05-22 15:35:55"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-523461-104-9357",
    "业务名称": "自定义项一致性稽核管理-自动采集-05-523461",
    "业务类型": "业务联动-核心-523",
    "处理状态": "处理中-461",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-21 12:21:39"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-523461-105-3485",
    "业务名称": "自定义项一致性稽核管理-部侧联动-06-523461",
    "业务类型": "业务联动-复核-523",
    "处理状态": "已同步-461",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-16 11:44:58"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-523461-106-3097",
    "业务名称": "自定义项一致性稽核管理-自动采集-07-523461",
    "业务类型": "业务联动-省侧-523",
    "处理状态": "处理中-461",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-08 15:27:34"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-523461-107-3271",
    "业务名称": "自定义项一致性稽核管理-数据上报-08-523461",
    "业务类型": "业务联动-部侧-523",
    "处理状态": "待复核-461",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-20 10:00:07"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-523461-108-2570",
    "业务名称": "自定义项一致性稽核管理-异常复核-09-523461",
    "业务类型": "业务联动-省侧-523",
    "处理状态": "异常-461",
    "负责人": "任务调度员-区公司",
    "更新时间": "2026-05-23 09:45:47"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-523461-109-5533",
    "业务名称": "自定义项一致性稽核管理-自动采集-10-523461",
    "业务类型": "业务联动-核心-523",
    "处理状态": "待复核-461",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-18 08:23:37"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "自定义项一致性稽核管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "自定义项一致性稽核管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "自定义项一致性稽核管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "自定义项一致性稽核管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "自定义项一致性稽核管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
