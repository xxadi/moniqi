    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源使用审计规则", "add")'>新增虚拟资源使用审计规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源使用审计规则", "edit")'>修改虚拟资源使用审计规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源使用审计规则", "delete")'>删除虚拟资源使用审计规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源使用审计规则列表", "detail")'>查询虚拟资源使用审计规则列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源使用审计规则详情", "detail")'>查询虚拟资源使用审计规则详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资源使用审计规则", "import")'>批量导入虚拟资源使用审计规则</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源使用审计规则导出", "export")'>虚拟资源使用审计规则导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-570697-100-9763",
    "资产名称": "虚拟资源使用审计管理-部侧联动-01-570697",
    "资产类型": "资产资源-省侧-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-数据上报-570697-001",
    "纳管状态": "已同步-697",
    "最近同步": "2026-05-09 16:35:42"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-570697-101-8280",
    "资产名称": "虚拟资源使用审计管理-自动采集-02-570697",
    "资产类型": "资产资源-核心-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-资产纳管-570697-002",
    "纳管状态": "异常-697",
    "最近同步": "2026-05-16 08:47:36"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-570697-102-7014",
    "资产名称": "虚拟资源使用审计管理-自动采集-03-570697",
    "资产类型": "资产资源-部侧-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-扩容核查-570697-003",
    "纳管状态": "处理中-697",
    "最近同步": "2026-05-20 17:09:14"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-570697-103-6286",
    "资产名称": "虚拟资源使用审计管理-扩容核查-04-570697",
    "资产类型": "资产资源-核心-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-部侧联动-570697-004",
    "纳管状态": "待复核-697",
    "最近同步": "2026-05-18 13:34:02"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-570697-104-8599",
    "资产名称": "虚拟资源使用审计管理-异常复核-05-570697",
    "资产类型": "资产资源-核心-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-部侧联动-570697-005",
    "纳管状态": "待复核-697",
    "最近同步": "2026-05-15 17:12:41"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-570697-105-2191",
    "资产名称": "虚拟资源使用审计管理-部侧联动-06-570697",
    "资产类型": "资产资源-部侧-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-资产纳管-570697-006",
    "纳管状态": "待处理-697",
    "最近同步": "2026-05-24 09:28:03"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-570697-106-9795",
    "资产名称": "虚拟资源使用审计管理-自动采集-07-570697",
    "资产类型": "资产资源-核心-570",
    "所属区域": "区公司-资产资源-虚拟资源使用审计管理-数据上报-570697-007",
    "纳管状态": "已同步-697",
    "最近同步": "2026-05-09 14:37:16"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-570697-107-4711",
    "资产名称": "虚拟资源使用审计管理-数据上报-08-570697",
    "资产类型": "资产资源-省侧-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-自动采集-570697-008",
    "纳管状态": "处理中-697",
    "最近同步": "2026-05-25 11:20:34"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-570697-108-1282",
    "资产名称": "虚拟资源使用审计管理-数据上报-09-570697",
    "资产类型": "资产资源-自动化-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-扩容核查-570697-009",
    "纳管状态": "待处理-697",
    "最近同步": "2026-05-19 16:05:44"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-570697-109-1172",
    "资产名称": "区公司虚拟资源使用审计管理-异常复核-10-570697",
    "资产类型": "资产资源-核心-570",
    "所属区域": "-资产资源-虚拟资源使用审计管理-资产纳管-570697-010",
    "纳管状态": "已完成-697",
    "最近同步": "2026-05-12 16:28:40"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源使用审计管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源使用审计管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源使用审计管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源使用审计管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源使用审计管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
