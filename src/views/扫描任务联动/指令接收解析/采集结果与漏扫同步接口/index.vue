    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加采集结果与漏扫同步接口协议", "add")'>添加采集结果与漏扫同步接口协议</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("定义采集结果与漏扫同步信息", "add")'>定义采集结果与漏扫同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集结果与漏扫同步数据查看", "add")'>采集结果与漏扫同步数据查看</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加采集结果与漏扫同步状态查询信息", "add")'>添加采集结果与漏扫同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集结果与漏扫同步结果监控", "add")'>采集结果与漏扫同步结果监控</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("更新采集结果与漏扫同步接口数据", "edit")'>更新采集结果与漏扫同步接口数据</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查看采集结果与漏扫同步接口请求信息", "add")'>查看采集结果与漏扫同步接口请求信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集结果与漏扫同步接口数据清洗", "add")'>采集结果与漏扫同步接口数据清洗</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("采集结果与漏扫同步运行监控", "add")'>采集结果与漏扫同步运行监控</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("反馈采集结果与漏扫同步接口信息", "add")'>反馈采集结果与漏扫同步接口信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-737865-100-9941",
    "接口名称": "区公司采集结果与漏扫同步接口-部侧联动-01-737865",
    "对接系统": "工信部对接平台-7378",
    "调用状态": "已完成-865",
    "平均耗时": "439ms-65",
    "最近调用": "2026-05-22 17:59:36"
  },
  {
    "ID": 2,
    "接口编号": "API-737865-101-1343",
    "接口名称": "采集结果与漏扫同步接口-自动采集-02-737865",
    "对接系统": "集团资产平台-7378",
    "调用状态": "待复核-865",
    "平均耗时": "307ms-65",
    "最近调用": "2026-05-08 14:41:03"
  },
  {
    "ID": 3,
    "接口编号": "API-737865-102-6283",
    "接口名称": "采集结果与漏扫同步接口-自动采集-03-737865",
    "对接系统": "工信部对接平台-7378",
    "调用状态": "待处理-865",
    "平均耗时": "429ms-65",
    "最近调用": "2026-05-25 13:18:53"
  },
  {
    "ID": 4,
    "接口编号": "API-737865-103-7666",
    "接口名称": "采集结果与漏扫同步接口-部侧联动-04-737865",
    "对接系统": "资产安全平台-7378",
    "调用状态": "处理中-865",
    "平均耗时": "672ms-65",
    "最近调用": "2026-05-20 10:38:55"
  },
  {
    "ID": 5,
    "接口编号": "API-737865-104-3865",
    "接口名称": "采集结果与漏扫同步接口-异常复核-05-737865",
    "对接系统": "资产安全平台-7378",
    "调用状态": "异常-865",
    "平均耗时": "678ms-65",
    "最近调用": "2026-05-12 11:21:56"
  },
  {
    "ID": 6,
    "接口编号": "API-737865-105-7174",
    "接口名称": "采集结果与漏扫同步接口-自动采集-06-737865",
    "对接系统": "工信部对接平台-7378",
    "调用状态": "待处理-865",
    "平均耗时": "634ms-65",
    "最近调用": "2026-05-19 08:13:33"
  },
  {
    "ID": 7,
    "接口编号": "API-737865-106-8032",
    "接口名称": "区公司采集结果与漏扫同步接口-自动采集-07-737865",
    "对接系统": "工信部对接平台-7378",
    "调用状态": "异常-865",
    "平均耗时": "293ms-65",
    "最近调用": "2026-05-22 12:34:03"
  },
  {
    "ID": 8,
    "接口编号": "API-737865-107-6199",
    "接口名称": "采集结果与漏扫同步接口-自动采集-08-737865",
    "对接系统": "集团资产平台-7378",
    "调用状态": "已同步-865",
    "平均耗时": "57ms-65",
    "最近调用": "2026-05-20 16:07:32"
  },
  {
    "ID": 9,
    "接口编号": "API-737865-108-7778",
    "接口名称": "采集结果与漏扫同步接口-数据上报-09-737865",
    "对接系统": "集团资产平台-7378",
    "调用状态": "处理中-865",
    "平均耗时": "685ms-65",
    "最近调用": "2026-05-17 17:56:42"
  },
  {
    "ID": 10,
    "接口编号": "API-737865-109-9408",
    "接口名称": "采集结果与漏扫同步接口-资产纳管-10-737865",
    "对接系统": "工信部对接平台-7378",
    "调用状态": "已同步-865",
    "平均耗时": "398ms-65",
    "最近调用": "2026-05-20 09:29:10"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "采集结果与漏扫同步接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "采集结果与漏扫同步接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "采集结果与漏扫同步接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "采集结果与漏扫同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "采集结果与漏扫同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
