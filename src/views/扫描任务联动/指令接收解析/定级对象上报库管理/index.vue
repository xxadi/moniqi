    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增定级对象上报库信息", "add")'>新增定级对象上报库信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改定级对象上报库信息", "edit")'>修改定级对象上报库信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除定级对象上报库信息", "delete")'>删除定级对象上报库信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象上报库列表", "detail")'>查询定级对象上报库列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询定级对象上报库详情", "detail")'>查询定级对象上报库详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入定级对象上报库信息", "import")'>批量导入定级对象上报库信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("定级对象上报库信息导出", "export")'>定级对象上报库信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-458866-100-7325",
    "业务名称": "区公司定级对象上报库管理-自动采集-01-458866",
    "业务类型": "业务联动-核心-458",
    "处理状态": "异常-866",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-21 09:08:34"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-458866-101-4485",
    "业务名称": "定级对象上报库管理-资产纳管-02-458866",
    "业务类型": "业务联动-复核-458",
    "处理状态": "异常-866",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-09 13:41:02"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-458866-102-3693",
    "业务名称": "定级对象上报库管理-异常复核-03-458866",
    "业务类型": "业务联动-复核-458",
    "处理状态": "已同步-866",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-16 09:30:33"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-458866-103-4958",
    "业务名称": "定级对象上报库管理-数据上报-04-458866",
    "业务类型": "业务联动-边界-458",
    "处理状态": "已完成-866",
    "负责人": "接口运维员-区公司",
    "更新时间": "2026-05-16 08:51:10"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-458866-104-2675",
    "业务名称": "定级对象上报库管理-扩容核查-05-458866",
    "业务类型": "业务联动-复核-458",
    "处理状态": "待复核-866",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-13 15:35:45"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-458866-105-4302",
    "业务名称": "定级对象上报库管理-数据上报-06-458866",
    "业务类型": "业务联动-自动化-458",
    "处理状态": "已同步-866",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-19 14:03:45"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-458866-106-3776",
    "业务名称": "定级对象上报库管理-资产纳管-07-458866",
    "业务类型": "业务联动-自动化-458",
    "处理状态": "待复核-866",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-21 14:44:17"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-458866-107-4665",
    "业务名称": "定级对象上报库管理-异常复核-08-458866",
    "业务类型": "业务联动-边界-458",
    "处理状态": "异常-866",
    "负责人": "规则管理员-区公司",
    "更新时间": "2026-05-08 14:35:54"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-458866-108-7280",
    "业务名称": "定级对象上报库管理-部侧联动-09-458866",
    "业务类型": "业务联动-省侧-458",
    "处理状态": "待处理-866",
    "负责人": "数据复核员-区公司",
    "更新时间": "2026-05-16 12:27:18"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-458866-109-7544",
    "业务名称": "定级对象上报库管理-扩容核查-10-458866",
    "业务类型": "业务联动-复核-458",
    "处理状态": "待处理-866",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-13 11:44:22"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "定级对象上报库管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "定级对象上报库管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "定级对象上报库管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "定级对象上报库管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "定级对象上报库管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
