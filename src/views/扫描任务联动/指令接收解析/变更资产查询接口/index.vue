    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("变更资产查询接口", "edit")'>变更资产查询接口</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("变更资产查询数据分析", "edit")'>变更资产查询数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("查看变更资产查询信息", "edit")'>查看变更资产查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("变更资产查询数据导出", "export")'>变更资产查询数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("添加变更资产查询下发信息", "edit")'>添加变更资产查询下发信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("输入变更资产查询请求任务", "edit")'>输入变更资产查询请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("输出变更资产查询反馈信息", "edit")'>输出变更资产查询反馈信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("监控变更资产查询状态信息", "edit")'>监控变更资产查询状态信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("统计变更资产查询调用信息", "edit")'>统计变更资产查询调用信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-763346-100-7957",
    "接口名称": "变更资产查询接口-数据上报-01-763346",
    "对接系统": "工信部对接平台-7633",
    "调用状态": "异常-346",
    "平均耗时": "381ms-46",
    "最近调用": "2026-05-25 12:26:23"
  },
  {
    "ID": 2,
    "接口编号": "API-763346-101-5020",
    "接口名称": "变更资产查询接口-扩容核查-02-763346",
    "对接系统": "资产安全平台-7633",
    "调用状态": "已完成-346",
    "平均耗时": "549ms-46",
    "最近调用": "2026-05-22 16:22:29"
  },
  {
    "ID": 3,
    "接口编号": "API-763346-102-9476",
    "接口名称": "变更资产查询接口-自动采集-03-763346",
    "对接系统": "集团资产平台-7633",
    "调用状态": "待复核-346",
    "平均耗时": "686ms-46",
    "最近调用": "2026-05-10 14:29:50"
  },
  {
    "ID": 4,
    "接口编号": "API-763346-103-9969",
    "接口名称": "变更资产查询接口-自动采集-04-763346",
    "对接系统": "调度中心-7633",
    "调用状态": "处理中-346",
    "平均耗时": "124ms-46",
    "最近调用": "2026-05-11 15:27:26"
  },
  {
    "ID": 5,
    "接口编号": "API-763346-104-5641",
    "接口名称": "变更资产查询接口-扩容核查-05-763346",
    "对接系统": "资产安全平台-7633",
    "调用状态": "已完成-346",
    "平均耗时": "425ms-46",
    "最近调用": "2026-05-15 12:47:59"
  },
  {
    "ID": 6,
    "接口编号": "API-763346-105-1609",
    "接口名称": "变更资产查询接口-部侧联动-06-763346",
    "对接系统": "工信部对接平台-7633",
    "调用状态": "处理中-346",
    "平均耗时": "165ms-46",
    "最近调用": "2026-05-09 09:23:23"
  },
  {
    "ID": 7,
    "接口编号": "API-763346-106-1297",
    "接口名称": "变更资产查询接口-数据上报-07-763346",
    "对接系统": "调度中心-7633",
    "调用状态": "待复核-346",
    "平均耗时": "491ms-46",
    "最近调用": "2026-05-19 08:04:04"
  },
  {
    "ID": 8,
    "接口编号": "API-763346-107-1295",
    "接口名称": "变更资产查询接口-数据上报-08-763346",
    "对接系统": "工信部对接平台-7633",
    "调用状态": "异常-346",
    "平均耗时": "234ms-46",
    "最近调用": "2026-05-24 13:45:54"
  },
  {
    "ID": 9,
    "接口编号": "API-763346-108-6058",
    "接口名称": "变更资产查询接口-扩容核查-09-763346",
    "对接系统": "资产安全平台-7633",
    "调用状态": "处理中-346",
    "平均耗时": "684ms-46",
    "最近调用": "2026-05-12 12:29:21"
  },
  {
    "ID": 10,
    "接口编号": "API-763346-109-9707",
    "接口名称": "变更资产查询接口-资产纳管-10-763346",
    "对接系统": "集团资产平台-7633",
    "调用状态": "已完成-346",
    "平均耗时": "428ms-46",
    "最近调用": "2026-05-09 13:57:41"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "变更资产查询接口导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "变更资产查询接口调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "变更资产查询接口异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "变更资产查询接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "变更资产查询接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
