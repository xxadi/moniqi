  ...
  >
    ...
    >
      <el-form-item label="ID" prop="ID">
        <el-input v-model="editFormData.ID" :disabled="dialogTitle !== '新增'"></el-input>
      </el-form-item>
      <el-form-item label="编号" prop="编号">
        <el-input v-model="editFormData.编号"></el-input>
      </el-form-item>
      <el-form-item label="名称" prop="名称">
        <el-input v-model="editFormData.名称"></el-input>
      </el-form-item>
      <el-form-item label="类型" prop="类型">
        <el-input v-model="editFormData.类型"></el-input>
      </el-form-item>
      <el-form-item label="状态" prop="状态">
        <el-select v-model="editFormData.状态">
      ...
      <el-form-item label="所属部门" prop="所属部门">
        <el-input v-model="editFormData.所属部门"></el-input>
      </el-form-item>
      <el-form-item label="负责人" prop="负责人">
        <el-input v-model="editFormData.负责人"></el-input>
      </el-form-item>
    </cs-editform>
  </el-dialog>
</template>
