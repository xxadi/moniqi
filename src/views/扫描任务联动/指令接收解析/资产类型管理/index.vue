    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产类型信息", "add")'>新增资产类型信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类型信息", "edit")'>修改资产类型信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产类型信息", "delete")'>删除资产类型信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型列表", "detail")'>查询资产类型列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产类型详情", "detail")'>查询资产类型详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入资产类型信息", "import")'>批量导入资产类型信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产类型信息导出", "export")'>资产类型信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-347056-100-3080",
    "资产名称": "资产类型管理-自动采集-01-347056",
    "资产类型": "资产资源-复核-347",
    "所属区域": "-资产资源-资产类型管理-资产纳管-347056-001",
    "纳管状态": "异常-056",
    "最近同步": "2026-05-12 17:39:27"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-347056-101-5125",
    "资产名称": "区公司资产类型管理-数据上报-02-347056",
    "资产类型": "资产资源-边界-347",
    "所属区域": "-资产资源-资产类型管理-扩容核查-347056-002",
    "纳管状态": "待复核-056",
    "最近同步": "2026-05-24 17:57:27"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-347056-102-5640",
    "资产名称": "资产类型管理-自动采集-03-347056",
    "资产类型": "资产资源-部侧-347",
    "所属区域": "-资产资源-资产类型管理-资产纳管-347056-003",
    "纳管状态": "处理中-056",
    "最近同步": "2026-05-25 08:43:25"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-347056-103-2941",
    "资产名称": "区公司资产类型管理-异常复核-04-347056",
    "资产类型": "资产资源-边界-347",
    "所属区域": "-资产资源-资产类型管理-自动采集-347056-004",
    "纳管状态": "待复核-056",
    "最近同步": "2026-05-16 08:04:42"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-347056-104-4800",
    "资产名称": "资产类型管理-自动采集-05-347056",
    "资产类型": "资产资源-部侧-347",
    "所属区域": "区公司-资产资源-资产类型管理-扩容核查-347056-005",
    "纳管状态": "待处理-056",
    "最近同步": "2026-05-24 13:20:21"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-347056-105-2508",
    "资产名称": "区公司资产类型管理-异常复核-06-347056",
    "资产类型": "资产资源-省侧-347",
    "所属区域": "-资产资源-资产类型管理-自动采集-347056-006",
    "纳管状态": "已同步-056",
    "最近同步": "2026-05-12 10:34:37"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-347056-106-7190",
    "资产名称": "资产类型管理-数据上报-07-347056",
    "资产类型": "资产资源-复核-347",
    "所属区域": "-资产资源-资产类型管理-自动采集-347056-007",
    "纳管状态": "已同步-056",
    "最近同步": "2026-05-21 10:26:39"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-347056-107-2789",
    "资产名称": "资产类型管理-异常复核-08-347056",
    "资产类型": "资产资源-边界-347",
    "所属区域": "-资产资源-资产类型管理-扩容核查-347056-008",
    "纳管状态": "待处理-056",
    "最近同步": "2026-05-12 10:28:35"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-347056-108-6328",
    "资产名称": "资产类型管理-部侧联动-09-347056",
    "资产类型": "资产资源-复核-347",
    "所属区域": "-资产资源-资产类型管理-异常复核-347056-009",
    "纳管状态": "已完成-056",
    "最近同步": "2026-05-24 11:16:37"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-347056-109-3344",
    "资产名称": "区公司资产类型管理-自动采集-10-347056",
    "资产类型": "资产资源-自动化-347",
    "所属区域": "-资产资源-资产类型管理-异常复核-347056-010",
    "纳管状态": "已完成-056",
    "最近同步": "2026-05-25 17:26:28"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产类型管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产类型管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产类型管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产类型管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产类型管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
