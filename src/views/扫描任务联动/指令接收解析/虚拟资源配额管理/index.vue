    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资源配额信息", "add")'>新增虚拟资源配额信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资源配额信息", "edit")'>修改虚拟资源配额信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资源配额信息", "delete")'>删除虚拟资源配额信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源配额列表", "detail")'>查询虚拟资源配额列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资源配额详情", "detail")'>查询虚拟资源配额详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入虚拟资源配额信息", "import")'>批量导入虚拟资源配额信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资源配额信息导出", "export")'>虚拟资源配额信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "资产编号": "ASSET-763830-100-7235",
    "资产名称": "虚拟资源配额管理-资产纳管-01-763830",
    "资产类型": "资产资源-省侧-763",
    "所属区域": "-资产资源-虚拟资源配额管理-异常复核-763830-001",
    "纳管状态": "异常-830",
    "最近同步": "2026-05-09 13:47:44"
  },
  {
    "ID": 2,
    "资产编号": "ASSET-763830-101-6617",
    "资产名称": "区公司虚拟资源配额管理-资产纳管-02-763830",
    "资产类型": "资产资源-省侧-763",
    "所属区域": "-资产资源-虚拟资源配额管理-扩容核查-763830-002",
    "纳管状态": "待处理-830",
    "最近同步": "2026-05-16 08:10:44"
  },
  {
    "ID": 3,
    "资产编号": "ASSET-763830-102-1347",
    "资产名称": "虚拟资源配额管理-扩容核查-03-763830",
    "资产类型": "资产资源-省侧-763",
    "所属区域": "-资产资源-虚拟资源配额管理-部侧联动-763830-003",
    "纳管状态": "已完成-830",
    "最近同步": "2026-05-15 10:12:29"
  },
  {
    "ID": 4,
    "资产编号": "ASSET-763830-103-9571",
    "资产名称": "区公司虚拟资源配额管理-自动采集-04-763830",
    "资产类型": "资产资源-部侧-763",
    "所属区域": "区公司-资产资源-虚拟资源配额管理-自动采集-763830-004",
    "纳管状态": "处理中-830",
    "最近同步": "2026-05-18 13:56:04"
  },
  {
    "ID": 5,
    "资产编号": "ASSET-763830-104-8659",
    "资产名称": "虚拟资源配额管理-数据上报-05-763830",
    "资产类型": "资产资源-核心-763",
    "所属区域": "区公司-资产资源-虚拟资源配额管理-数据上报-763830-005",
    "纳管状态": "异常-830",
    "最近同步": "2026-05-17 11:17:41"
  },
  {
    "ID": 6,
    "资产编号": "ASSET-763830-105-6469",
    "资产名称": "虚拟资源配额管理-资产纳管-06-763830",
    "资产类型": "资产资源-省侧-763",
    "所属区域": "-资产资源-虚拟资源配额管理-扩容核查-763830-006",
    "纳管状态": "已完成-830",
    "最近同步": "2026-05-13 17:59:50"
  },
  {
    "ID": 7,
    "资产编号": "ASSET-763830-106-1051",
    "资产名称": "虚拟资源配额管理-扩容核查-07-763830",
    "资产类型": "资产资源-部侧-763",
    "所属区域": "-资产资源-虚拟资源配额管理-异常复核-763830-007",
    "纳管状态": "异常-830",
    "最近同步": "2026-05-22 09:20:53"
  },
  {
    "ID": 8,
    "资产编号": "ASSET-763830-107-7123",
    "资产名称": "虚拟资源配额管理-异常复核-08-763830",
    "资产类型": "资产资源-部侧-763",
    "所属区域": "区公司-资产资源-虚拟资源配额管理-资产纳管-763830-008",
    "纳管状态": "待复核-830",
    "最近同步": "2026-05-17 09:03:52"
  },
  {
    "ID": 9,
    "资产编号": "ASSET-763830-108-6833",
    "资产名称": "虚拟资源配额管理-资产纳管-09-763830",
    "资产类型": "资产资源-自动化-763",
    "所属区域": "区公司-资产资源-虚拟资源配额管理-部侧联动-763830-009",
    "纳管状态": "异常-830",
    "最近同步": "2026-05-16 17:00:38"
  },
  {
    "ID": 10,
    "资产编号": "ASSET-763830-109-3180",
    "资产名称": "虚拟资源配额管理-异常复核-10-763830",
    "资产类型": "资产资源-部侧-763",
    "所属区域": "区公司-资产资源-虚拟资源配额管理-扩容核查-763830-010",
    "纳管状态": "待处理-830",
    "最近同步": "2026-05-20 11:35:16"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "虚拟资源配额管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资源配额管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "虚拟资源配额管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资源配额管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资源配额管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
