    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加资产特征分析规则", "add")'>添加资产特征分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑资产特征分析规则", "edit")'>编辑资产特征分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产特征分析规则", "delete")'>删除资产特征分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询资产特征分析规则", "detail")'>查询资产特征分析规则</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产特征分析规则启用/禁用", "analysis")'>资产特征分析规则启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产特征分析规则运行效果评估", "analysis")'>资产特征分析规则运行效果评估</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产特征分析规则分析", "analysis")'>资产特征分析规则分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产特征分析规则分析结果展示", "detail")'>资产特征分析规则分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产特征分析规则分析结果下载", "export")'>资产特征分析规则分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产特征分析规则分析结果上报", "analysis")'>资产特征分析规则分析结果上报</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "规则编号": "RULE-680997-100-8827",
    "规则名称": "区公司资产特征分析规则管理-自动采集-01-680997",
    "规则类型": "规则策略-自动化-680",
    "启用状态": "异常-997",
    "命中次数": 2691,
    "更新时间": "2026-05-17 17:46:08"
  },
  {
    "ID": 2,
    "规则编号": "RULE-680997-101-4312",
    "规则名称": "资产特征分析规则管理-资产纳管-02-680997",
    "规则类型": "规则策略-省侧-680",
    "启用状态": "待复核-997",
    "命中次数": 3688,
    "更新时间": "2026-05-20 08:30:56"
  },
  {
    "ID": 3,
    "规则编号": "RULE-680997-102-7572",
    "规则名称": "资产特征分析规则管理-自动采集-03-680997",
    "规则类型": "规则策略-部侧-680",
    "启用状态": "待处理-997",
    "命中次数": 4355,
    "更新时间": "2026-05-08 08:52:10"
  },
  {
    "ID": 4,
    "规则编号": "RULE-680997-103-3556",
    "规则名称": "资产特征分析规则管理-自动采集-04-680997",
    "规则类型": "规则策略-部侧-680",
    "启用状态": "处理中-997",
    "命中次数": 694,
    "更新时间": "2026-05-13 12:54:34"
  },
  {
    "ID": 5,
    "规则编号": "RULE-680997-104-4892",
    "规则名称": "资产特征分析规则管理-资产纳管-05-680997",
    "规则类型": "规则策略-部侧-680",
    "启用状态": "待复核-997",
    "命中次数": 3925,
    "更新时间": "2026-05-13 14:11:33"
  },
  {
    "ID": 6,
    "规则编号": "RULE-680997-105-2299",
    "规则名称": "资产特征分析规则管理-自动采集-06-680997",
    "规则类型": "规则策略-核心-680",
    "启用状态": "待复核-997",
    "命中次数": 859,
    "更新时间": "2026-05-11 11:52:26"
  },
  {
    "ID": 7,
    "规则编号": "RULE-680997-106-9758",
    "规则名称": "资产特征分析规则管理-资产纳管-07-680997",
    "规则类型": "规则策略-自动化-680",
    "启用状态": "处理中-997",
    "命中次数": 3120,
    "更新时间": "2026-05-09 17:07:55"
  },
  {
    "ID": 8,
    "规则编号": "RULE-680997-107-2222",
    "规则名称": "区公司资产特征分析规则管理-部侧联动-08-680997",
    "规则类型": "规则策略-复核-680",
    "启用状态": "待复核-997",
    "命中次数": 4208,
    "更新时间": "2026-05-17 10:00:20"
  },
  {
    "ID": 9,
    "规则编号": "RULE-680997-108-8946",
    "规则名称": "资产特征分析规则管理-自动采集-09-680997",
    "规则类型": "规则策略-边界-680",
    "启用状态": "已同步-997",
    "命中次数": 3149,
    "更新时间": "2026-05-22 10:05:51"
  },
  {
    "ID": 10,
    "规则编号": "RULE-680997-109-8073",
    "规则名称": "资产特征分析规则管理-数据上报-10-680997",
    "规则类型": "规则策略-核心-680",
    "启用状态": "异常-997",
    "命中次数": 1566,
    "更新时间": "2026-05-19 14:47:10"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "资产特征分析规则管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "资产特征分析规则管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "资产特征分析规则管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产特征分析规则管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产特征分析规则管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
