    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("发起部侧上报失败处置流程", "add")'>发起部侧上报失败处置流程</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加部侧上报失败处置指派信息", "add")'>添加部侧上报失败处置指派信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("添加部侧上报失败处置流程节点", "add")'>添加部侧上报失败处置流程节点</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("编辑部侧上报失败处置流程节点信息", "edit")'>编辑部侧上报失败处置流程节点信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("部侧上报失败处置流程节点删除", "delete")'>部侧上报失败处置流程节点删除</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧上报失败处置流程节点查询", "detail")'>部侧上报失败处置流程节点查询</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("上传部侧上报失败处置附件", "import")'>上传部侧上报失败处置附件</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("部侧上报失败处置流程图查看", "detail")'>部侧上报失败处置流程图查看</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("部侧上报失败处置流程通知", "operation")'>部侧上报失败处置流程通知</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("部侧上报失败处置结果逐级审批", "edit")'>部侧上报失败处置结果逐级审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("部侧上报失败处置结果拒绝和驳回", "operation")'>部侧上报失败处置结果拒绝和驳回</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "业务编号": "BIZ-997427-100-6733",
    "业务名称": "部侧上报失败处置流程管理-部侧联动-01-997427",
    "业务类型": "业务联动-边界-997",
    "处理状态": "待处理-427",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-15 12:14:07"
  },
  {
    "ID": 2,
    "业务编号": "BIZ-997427-101-6287",
    "业务名称": "部侧上报失败处置流程管理-扩容核查-02-997427",
    "业务类型": "业务联动-省侧-997",
    "处理状态": "已同步-427",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-24 08:19:31"
  },
  {
    "ID": 3,
    "业务编号": "BIZ-997427-102-5291",
    "业务名称": "区公司部侧上报失败处置流程管理-异常复核-03-997427",
    "业务类型": "业务联动-部侧-997",
    "处理状态": "已同步-427",
    "负责人": "规则管理员-",
    "更新时间": "2026-05-18 15:02:25"
  },
  {
    "ID": 4,
    "业务编号": "BIZ-997427-103-7568",
    "业务名称": "部侧上报失败处置流程管理-异常复核-04-997427",
    "业务类型": "业务联动-核心-997",
    "处理状态": "待处理-427",
    "负责人": "资产安全管理员-",
    "更新时间": "2026-05-15 09:06:09"
  },
  {
    "ID": 5,
    "业务编号": "BIZ-997427-104-2705",
    "业务名称": "部侧上报失败处置流程管理-自动采集-05-997427",
    "业务类型": "业务联动-部侧-997",
    "处理状态": "待复核-427",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-22 13:05:17"
  },
  {
    "ID": 6,
    "业务编号": "BIZ-997427-105-8704",
    "业务名称": "部侧上报失败处置流程管理-扩容核查-06-997427",
    "业务类型": "业务联动-自动化-997",
    "处理状态": "处理中-427",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-16 12:16:13"
  },
  {
    "ID": 7,
    "业务编号": "BIZ-997427-106-6495",
    "业务名称": "部侧上报失败处置流程管理-数据上报-07-997427",
    "业务类型": "业务联动-省侧-997",
    "处理状态": "待复核-427",
    "负责人": "接口运维员-",
    "更新时间": "2026-05-25 11:16:12"
  },
  {
    "ID": 8,
    "业务编号": "BIZ-997427-107-3358",
    "业务名称": "区公司部侧上报失败处置流程管理-部侧联动-08-997427",
    "业务类型": "业务联动-省侧-997",
    "处理状态": "已同步-427",
    "负责人": "数据复核员-",
    "更新时间": "2026-05-13 11:18:25"
  },
  {
    "ID": 9,
    "业务编号": "BIZ-997427-108-8021",
    "业务名称": "部侧上报失败处置流程管理-扩容核查-09-997427",
    "业务类型": "业务联动-边界-997",
    "处理状态": "异常-427",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-18 15:53:45"
  },
  {
    "ID": 10,
    "业务编号": "BIZ-997427-109-2183",
    "业务名称": "部侧上报失败处置流程管理-部侧联动-10-997427",
    "业务类型": "业务联动-复核-997",
    "处理状态": "已完成-427",
    "负责人": "任务调度员-",
    "更新时间": "2026-05-24 10:12:16"
  }
];
const tableColumns = [
  {
...
export default {
  ...
  methods: {
    ...
    exportRows(functionName) {
      exportXLSX(this.buildExportRows(functionName), functionName || "部侧上报失败处置流程管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志|监控/.test(functionName)) {
        return [
          ...
          { 名称: "部侧上报失败处置流程管理调度任务", 状态: "执行中", 日志: "等待节点返回执行结果" },
          { 名称: "部侧上报失败处置流程管理异常检查", 状态: "已告警", 日志: "发现超时记录，已进入重试队列" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "部侧上报失败处置流程管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "部侧上报失败处置流程管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
