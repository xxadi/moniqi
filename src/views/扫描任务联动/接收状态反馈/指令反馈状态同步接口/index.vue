    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("指令反馈状态同步接口", "operation")'>指令反馈状态同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("指令反馈状态同步数据分析", "analysis")'>指令反馈状态同步数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看指令反馈状态同步信息", "detail")'>查看指令反馈状态同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("指令反馈状态同步数据导出", "export")'>指令反馈状态同步数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("指令反馈状态同步反馈下发", "operation")'>指令反馈状态同步反馈下发</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增指令反馈状态同步反馈下发请求任务", "add")'>新增指令反馈状态同步反馈下发请求任务</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("指令反馈状态同步反馈下发结果反馈", "operation")'>指令反馈状态同步反馈下发结果反馈</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("导出指令反馈状态同步反馈下发任务执行状态与日志", "export")'>导出指令反馈状态同步反馈下发任务执行状态与日志</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("监控指令反馈状态同步反馈下发状态", "detail")'>监控指令反馈状态同步反馈下发状态</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除指令反馈状态同步参数信息", "delete")'>删除指令反馈状态同步参数信息</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "指令反馈状态同步接口状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "指令反馈状态同步接口回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "指令反馈状态同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "指令反馈状态同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
