  ...
  >
    ...
    >
      <el-form-item label="ID" prop="ID">
        <el-input v-model="editFormData.ID" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="编号" prop="编号">
        <el-input v-model="editFormData.编号" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="任务名称" prop="任务名称">
        <el-input v-model="editFormData.任务名称" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="任务类型" prop="任务类型">
        <el-input v-model="editFormData.任务类型" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      <el-form-item label="执行周期" prop="执行周期">
        <el-input v-model="editFormData.执行周期" :disabled="dialogTitle === '详情'" />
      </el-form-item>
      ...
      <el-form-item label="负责人" prop="负责人">
        <el-input v-model="editFormData.负责人" :disabled="dialogTitle === '详情'" />
      </el-form-item>
    </cs-editform>
  </el-dialog>
</template>
