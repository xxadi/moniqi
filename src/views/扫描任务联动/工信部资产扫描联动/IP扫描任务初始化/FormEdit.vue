  ...
  >
    ...
    >
      ...
      <el-form-item label="任务名称" prop="任务名称">
        <el-input v-model="editFormData.任务名称" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="任务类型" prop="任务类型">
        <el-input v-model="editFormData.任务类型" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="执行周期" prop="执行周期">
        <el-input v-model="editFormData.执行周期" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
