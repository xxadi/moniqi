    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增文件命名与归档信息", "add")'>新增文件命名与归档信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改文件命名与归档信息", "edit")'>修改文件命名与归档信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除文件命名与归档信息", "delete")'>删除文件命名与归档信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询文件命名与归档列表", "detail")'>查询文件命名与归档列表</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询文件命名与归档详情", "detail")'>查询文件命名与归档详情</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("批量导入文件命名与归档信息", "import")'>批量导入文件命名与归档信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("文件命名与归档信息导出", "export")'>文件命名与归档信息导出</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "文件命名与归档管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "文件命名与归档管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "文件命名与归档管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "文件命名与归档管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
