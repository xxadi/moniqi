    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增数据同步信息", "add")'>新增数据同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改数据同步信息", "edit")'>修改数据同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除数据同步信息", "delete")'>删除数据同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询数据同步信息", "detail")'>查询数据同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据同步监控", "detail")'>数据同步监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("数据同步告警", "operation")'>数据同步告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("数据同步查看", "detail")'>数据同步查看</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("数据同步分析", "analysis")'>数据同步分析</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("数据同步信息导出", "export")'>数据同步信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增数据同步状态查询信息", "add")'>新增数据同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改数据同步状态查询信息", "edit")'>修改数据同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除数据同步状态查询信息", "delete")'>删除数据同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增数据同步参数信息", "add")'>新增数据同步参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改数据同步参数信息", "edit")'>修改数据同步参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除数据同步参数信息", "delete")'>删除数据同步参数信息</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "数据同步管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "数据同步管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "数据同步管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "数据同步管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
