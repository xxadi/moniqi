    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增处置下发工单信息", "add")'>新增处置下发工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改处置下发工单信息", "edit")'>修改处置下发工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除处置下发工单信息", "delete")'>删除处置下发工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看处置下发工单信息", "detail")'>查看处置下发工单信息</el-button>
          <el-button plain type="primary" icon="el-icon-upload2" @click='handleFunction("处置下发工单附件文件上传", "import")'>处置下发工单附件文件上传</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("处置下发工单附件文件删除", "delete")'>处置下发工单附件文件删除</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("处置下发工单信息审批", "operation")'>处置下发工单信息审批</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("处置下发工单信息撤回", "operation")'>处置下发工单信息撤回</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("处置下发工单信息终止", "operation")'>处置下发工单信息终止</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("处置下发工单信息派发提醒", "operation")'>处置下发工单信息派发提醒</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "处置下发工单管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "处置下发工单管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "处置下发工单管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "处置下发工单管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
