  ...
  >
    ...
    >
      ...
      <el-form-item label="接口名称" prop="接口名称">
        <el-input v-model="editFormData.接口名称" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      <el-form-item label="接口地址" prop="接口地址">
        <el-input v-model="editFormData.接口地址" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      <el-form-item label="调用方式" prop="调用方式">
        <el-input v-model="editFormData.调用方式" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
