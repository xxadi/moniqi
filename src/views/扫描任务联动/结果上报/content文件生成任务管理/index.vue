    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增content文件生成任务", "add")'>新增content文件生成任务</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除content文件生成任务", "delete")'>删除content文件生成任务</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改content文件生成任务", "edit")'>修改content文件生成任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("查询content文件生成任务", "add")'>查询content文件生成任务</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成任务启用/禁用", "add")'>content文件生成任务启用/禁用</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成失败告警", "add")'>content文件生成失败告警</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成结果统计", "add")'>content文件生成结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成数据提取", "add")'>content文件生成数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成运行分析", "add")'>content文件生成运行分析</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成分析结果展示", "add")'>content文件生成分析结果展示</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("content文件生成分析结果下载", "export")'>content文件生成分析结果下载</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成分析结果上报", "add")'>content文件生成分析结果上报</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("content文件生成推送", "add")'>content文件生成推送</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "content文件生成任务管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "content文件生成任务管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "content文件生成任务管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "content文件生成任务管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
