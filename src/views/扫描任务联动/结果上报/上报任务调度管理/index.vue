    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("定义上报任务调度信息", "operation")'>定义上报任务调度信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报任务调度信息", "edit")'>修改上报任务调度信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除上报任务调度信息", "delete")'>删除上报任务调度信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报任务调度数据获取", "operation")'>上报任务调度数据获取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报任务调度数据锁定", "operation")'>上报任务调度数据锁定</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("上报任务调度数据激活", "operation")'>上报任务调度数据激活</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询上报任务调度报告", "detail")'>查询上报任务调度报告</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增上报任务调度状态查询信息", "add")'>新增上报任务调度状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报任务调度状态查询信息", "edit")'>修改上报任务调度状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除上报任务调度状态查询信息", "delete")'>删除上报任务调度状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增上报任务调度参数信息", "add")'>新增上报任务调度参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改上报任务调度参数信息", "edit")'>修改上报任务调度参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除上报任务调度参数信息", "delete")'>删除上报任务调度参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增上报任务调度错误处理信息", "add")'>新增上报任务调度错误处理信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增上报任务调度错误事件通知规则", "add")'>新增上报任务调度错误事件通知规则</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "上报任务调度管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "上报任务调度管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "上报任务调度管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "上报任务调度管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
