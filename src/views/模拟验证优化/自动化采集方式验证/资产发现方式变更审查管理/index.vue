    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产发现方式变更审查", "operation")'>资产发现方式变更审查</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产发现方式变更审查结果查看", "detail")'>资产发现方式变更审查结果查看</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("资产发现方式变更审查结果修改", "edit")'>资产发现方式变更审查结果修改</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("资产发现方式变更审查结果删除", "delete")'>资产发现方式变更审查结果删除</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产发现方式变更审查结果统计", "analysis")'>资产发现方式变更审查结果统计</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产发现方式变更审查结果推送", "operation")'>资产发现方式变更审查结果推送</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产发现方式变更审查结果归档", "operation")'>资产发现方式变更审查结果归档</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "资产发现方式变更审查管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "资产发现方式变更审查管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产发现方式变更审查管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产发现方式变更审查管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
