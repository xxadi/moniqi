    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          ...
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查询虚拟资产纳管信息", "detail")'>查询虚拟资产纳管信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资产纳管监控", "detail")'>虚拟资产纳管监控</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("虚拟资产纳管告警", "operation")'>虚拟资产纳管告警</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("虚拟资产纳管查看", "detail")'>虚拟资产纳管查看</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("虚拟资产纳管分析", "analysis")'>虚拟资产纳管分析</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("虚拟资产纳管信息导出", "export")'>虚拟资产纳管信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资产纳管状态查询信息", "add")'>新增虚拟资产纳管状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资产纳管状态查询信息", "edit")'>修改虚拟资产纳管状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资产纳管状态查询信息", "delete")'>删除虚拟资产纳管状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增虚拟资产纳管参数信息", "add")'>新增虚拟资产纳管参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改虚拟资产纳管参数信息", "edit")'>修改虚拟资产纳管参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除虚拟资产纳管参数信息", "delete")'>删除虚拟资产纳管参数信息</el-button>
        </div>
      </div>
      <cs-pagetable
...
const importTemplateRow = {
  ...
  "创建时间": "2026-05-08 16:08:25",
  "ID": "",
  "导入来源": "虚拟资产纳管管理导入模板.xlsx"
};

export default {
  name: "GeneratedFeaturePage287",
  data() {
    return {
      searchData: {},
      searchConfig: [],
  ...
  methods: {
    ...
    exportRows(functionName) {
      ...
      exportXLSX(rows, functionName || "虚拟资产纳管管理导出");
    ...
    buildExportRows(functionName) {
      ...
      if (/执行状态|日志/.test(functionName)) {
        return [
          ...
          { 名称: "虚拟资产纳管管理任务调度", 状态: "执行中", 日志: "正在等待节点返回执行结果" },
          { 名称: "虚拟资产纳管管理异常检查", 状态: "已告警", 日志: "发现1条超时记录，已进入重试队列" },
        ];
      }
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "虚拟资产纳管管理状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "虚拟资产纳管管理回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "虚拟资产纳管管理业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "虚拟资产纳管管理复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
    ...
    buildBusinessDetail(functionName) {
      ...
      const fields = [
        ...
        { label: "所属页面", value: "虚拟资产纳管管理" },
        { label: "一级模块", value: "模拟验证优化" },
        { label: "二级模块", value: "虚拟资产纳管验证" },
      ];
