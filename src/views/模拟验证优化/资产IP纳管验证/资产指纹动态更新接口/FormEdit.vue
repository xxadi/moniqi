  ...
  >
    ...
    >
      <el-form-item label="ID" prop="ID">
        <el-input v-model="editFormData.ID" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="编号" prop="编号">
        <el-input v-model="editFormData.编号" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="接口名称" prop="接口名称">
        <el-input v-model="editFormData.接口名称" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="接口地址" prop="接口地址">
        <el-input v-model="editFormData.接口地址" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      <el-form-item label="调用方式" prop="调用方式">
        <el-input v-model="editFormData.调用方式" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
      ...
      <el-form-item label="时间" prop="时间">
        <el-date-picker v-model="editFormData.时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss" :disabled="dialogTitle === '详情'"></el-date-picker>
      </el-form-item>
      <el-form-item label="负责人" prop="负责人">
        <el-input v-model="editFormData.负责人" :disabled="dialogTitle === '详情'"></el-input>
      </el-form-item>
    </cs-editform>
  </el-dialog>
</template>
