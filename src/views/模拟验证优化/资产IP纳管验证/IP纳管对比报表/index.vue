    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增IP纳管对比信息", "add")'>新增IP纳管对比信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改IP纳管对比信息", "edit")'>修改IP纳管对比信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除IP纳管对比信息", "delete")'>删除IP纳管对比信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看IP纳管对比信息", "detail")'>查看IP纳管对比信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比数据提取", "operation")'>IP纳管对比数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比数据识别", "operation")'>IP纳管对比数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比清洗", "operation")'>IP纳管对比清洗</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比分级", "operation")'>IP纳管对比分级</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比实时计算", "operation")'>IP纳管对比实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比聚合", "operation")'>IP纳管对比聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("IP纳管对比信息导出", "export")'>IP纳管对比信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("IP纳管对比可视化展示", "detail")'>IP纳管对比可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("IP纳管对比数据审查", "operation")'>IP纳管对比数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "IP纳管对比报表状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "IP纳管对比报表回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "IP纳管对比报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "IP纳管对比报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
