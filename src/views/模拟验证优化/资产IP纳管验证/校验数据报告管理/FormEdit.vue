<template>
  ...
  >
    ...
    >
      ...
      <el-form-item label="统计维度" prop="统计维度">
        <el-input v-model="editFormData.统计维度" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
      <el-form-item label="统计周期" prop="统计周期">
        <el-input v-model="editFormData.统计周期" :disabled="dialogTitle === '详情'" clearable />
      </el-form-item>
