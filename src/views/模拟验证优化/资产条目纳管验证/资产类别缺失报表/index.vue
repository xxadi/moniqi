    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产类别缺失信息", "add")'>新增资产类别缺失信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产类别缺失信息", "edit")'>修改资产类别缺失信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产类别缺失信息", "delete")'>删除资产类别缺失信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产类别缺失信息", "detail")'>查看资产类别缺失信息</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失数据提取", "operation")'>资产类别缺失数据提取</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失数据识别", "operation")'>资产类别缺失数据识别</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失清洗", "operation")'>资产类别缺失清洗</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失分级", "operation")'>资产类别缺失分级</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失实时计算", "operation")'>资产类别缺失实时计算</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失聚合", "operation")'>资产类别缺失聚合</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产类别缺失信息导出", "export")'>资产类别缺失信息导出</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产类别缺失可视化展示", "detail")'>资产类别缺失可视化展示</el-button>
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产类别缺失数据审查", "operation")'>资产类别缺失数据审查</el-button>
        </div>
      </div>
      <cs-pagetable
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "资产类别缺失报表状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "资产类别缺失报表回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产类别缺失报表业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产类别缺失报表复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
