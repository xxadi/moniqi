    ...
    <div class="mt10 crud-container">
      <div class="mb10 operate-container">
        <div class="function-actions">
          <el-button plain type="primary" icon="el-icon-s-operation" @click='handleFunction("资产分类信息同步接口", "operation")'>资产分类信息同步接口</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类信息同步数据分析", "analysis")'>资产分类信息同步数据分析</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("查看资产分类信息同步信息", "detail")'>查看资产分类信息同步信息</el-button>
          <el-button plain type="primary" icon="el-icon-download" @click='handleFunction("资产分类信息同步数据导出", "export")'>资产分类信息同步数据导出</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产分类信息同步状态查询信息", "add")'>新增资产分类信息同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产分类信息同步状态查询信息", "edit")'>修改资产分类信息同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产分类信息同步状态查询信息", "delete")'>删除资产分类信息同步状态查询信息</el-button>
          <el-button plain type="primary" icon="el-icon-plus" @click='handleFunction("新增资产分类信息同步参数信息", "add")'>新增资产分类信息同步参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-edit" @click='handleFunction("修改资产分类信息同步参数信息", "edit")'>修改资产分类信息同步参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-delete" @click='handleFunction("删除资产分类信息同步参数信息", "delete")'>删除资产分类信息同步参数信息</el-button>
          <el-button plain type="primary" icon="el-icon-view" @click='handleFunction("资产分类信息同步接口调用查询", "detail")'>资产分类信息同步接口调用查询</el-button>
          <el-button plain type="primary" icon="el-icon-data-analysis" @click='handleFunction("资产分类信息同步调用统计", "analysis")'>资产分类信息同步调用统计</el-button>
        </div>
      </div>
      <cs-pagetable
...
const initialRows = [
  {
    "ID": 1,
    "接口编号": "API-138711",
    "接口名称": "资产分类信息同步接口-回调接口",
    "请求方式": "POST",
    "调用状态": "403 禁止访问",
    "平均耗时": "215ms",
    "最近调用": "2026-05-08 10:42:31"
  },
  {
    "ID": 2,
    "接口编号": "API-146630",
    "接口名称": "资产分类信息同步接口-批量接口",
    "请求方式": "GET",
    "调用状态": "500 服务异常",
    "平均耗时": "342ms",
    "最近调用": "2026-05-08 11:16:09"
  },
  {
    "ID": 3,
    "接口编号": "API-154549",
    "接口名称": "资产分类信息同步接口-鉴权接口",
    "请求方式": "POST",
    "调用状态": "408 请求超时",
    "平均耗时": "392ms",
    "最近调用": "2026-05-08 14:03:52"
  },
  {
    "ID": 4,
    "接口编号": "API-162468",
    "接口名称": "资产分类信息同步接口-查询接口",
    "请求方式": "POST",
    "调用状态": "200 OK",
    "平均耗时": "23ms",
    "最近调用": "2026-05-08 15:21:37"
  },
  {
    "ID": 5,
    "接口编号": "API-170387",
    "接口名称": "资产分类信息同步接口-下发接口",
    "请求方式": "GET",
    "调用状态": "202 ACCEPTED",
    "平均耗时": "56ms",
    "最近调用": "2026-05-08 16:08:25"
  },
  {
    "ID": 6,
    "接口编号": "API-178306",
    "接口名称": "资产分类信息同步接口-回执接口",
    "请求方式": "PUT",
    "调用状态": "超时重试",
    "平均耗时": "86ms",
    "最近调用": "2026-05-09 08:33:11"
  },
  {
    "ID": 7,
    "接口编号": "API-186225",
    "接口名称": "资产分类信息同步接口-同步接口",
    "请求方式": "DELETE",
    "调用状态": "参数异常",
    "平均耗时": "143ms",
    "最近调用": "2026-05-09 09:47:56"
  },
  {
    "ID": 8,
    "接口编号": "API-194144",
    "接口名称": "资产分类信息同步接口-推送接口",
    "请求方式": "PATCH",
    "调用状态": "401 未授权",
    "平均耗时": "189ms",
    "最近调用": "2026-05-08 09:12:18"
  },
  {
    "ID": 9,
    "接口编号": "API-202063",
    ...
    buildExportRows(functionName) {
      ...
      if (/接口|调用/.test(functionName)) {
        return [
          ...
          { 接口名称: "资产分类信息同步接口状态同步接口", 请求方式: "GET", 调用状态: "200 OK", 平均耗时: "93ms" },
          { 接口名称: "资产分类信息同步接口回执接口", 请求方式: "POST", 调用状态: "202 ACCEPTED", 平均耗时: "141ms" },
        ];
      }
      ...
      return [
        ...
        { 业务名称: "资产分类信息同步接口业务记录", 业务状态: "已处理", 处理时间: "2026-05-08 10:05:00", 说明: "模拟业务记录" },
        { 业务名称: "资产分类信息同步接口复核记录", 业务状态: "待复核", 处理时间: "2026-05-08 10:10:00", 说明: "等待人工确认" },
      ];
    },
    openDetail(row) {
      this.detailTitle = "详情";
