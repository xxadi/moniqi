...
files.forEach(filePath => {
  ...
  // 2. Add dialog template if missing
  if (!content.includes("审批指派信息弹窗")) {
  ...
  // 3. Add data properties if missing
  if (!content.includes("assignPeople:")) {
